...
instance locally_of_finite_type_comp {X Y Z : SchemeCat} (f : X ⟶ Y) (g : Y ⟶ Z) [hf : LocallyOfFiniteType f]
...
theorem locally_of_finite_type_of_comp {X Y Z : SchemeCat} (f : X ⟶ Y) (g : Y ⟶ Z) [hf : LocallyOfFiniteType (f ≫ g)] :
...
#align algebraic_geometry.locally_of_finite_type_of_comp AlgebraicGeometry.locally_of_finite_type_of_comp
