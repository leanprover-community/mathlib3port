...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `AffineTargetMorphismProperty.IsLocal.affine_openCover_tFAE [])
      (Command.declSig
            ...
            («term∃_,_»
             ...
             (Lean.explicitBinders
              [(Lean.bracketedExplicitBinders
                ...
                [(Lean.binderIdent `𝒰)]
                ":"
                (Term.app (Term.explicitUniv `Scheme.OpenCover ".{" [`u] "}") [`Y])
                ")")
               (Lean.bracketedExplicitBinders
                "("
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `PropertyIsLocalAtTarget.openCover_tFAE [])
      (Command.declSig
       [(Term.implicitBinder "{" [`P] [":" (Term.app `MorphismProperty [`Scheme])] "}")
            ...
            [(Tactic.intro "intro" [`H `U])
             ...
             (Tactic.tacticErw__
              ...
              (Tactic.rwRuleSeq
               ...
               [(Tactic.rwRule
                 []
                 (Term.proj (Term.proj `hP "." (fieldIdx "1")) "." `cancel_left_isIso))]
               "]")
              [])
             []
             (Tactic.apply "apply" `H)])
      ...
      tfae_have 2 → 1
        ...
        ·
          intro H U g hg
            ...
            apply H
        tfae_have 5 → 4
        · intro H U erw [ hP . 1 . cancel_left_isIso ] apply H
        tfae_have 4 → 6
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `AffineTargetMorphismProperty.IsLocal.diagonal_affine_openCover_tFAE [])
      (Command.declSig
       [(Term.implicitBinder "{" [`P] [":" `AffineTargetMorphismProperty] "}")
        (Term.explicitBinder "(" [`hP] [":" (Term.proj `P "." `IsLocal)] [] ")")
        (Term.implicitBinder "{" [`X `Y] [":" (Term.explicitUniv `Scheme ".{" [`u] "}")] "}")
              ...
              [(Lean.bracketedExplicitBinders
               ...
               (Lean.bracketedExplicitBinders
                ...
                (Term.forall
                 ...
                 ","
                 (Term.app
                  (Term.explicitUniv `Scheme.OpenCover ".{" [`u] "}")
          ...
          targetAffineLocally P . diagonal f
            ...
            ∃
              ( 𝒰 : Scheme.OpenCover .{ u } Y )
                ...
                ( 𝒰' : ∀ i , Scheme.OpenCover .{ u } pullback f 𝒰 . map i )
