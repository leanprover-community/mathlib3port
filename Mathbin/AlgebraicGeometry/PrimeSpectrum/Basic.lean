...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `is_irreducible_zero_locus_iff_of_radical [])
      (Command.declSig
       [(Term.explicitBinder "(" [`I] [":" (Term.app `Ideal [`R])] [] ")")
        (Term.explicitBinder "(" [`hI] [":" (Term.proj `I "." `IsRadical)] [] ")")]
       (Term.typeSpec
        ":"
        («term_↔_»
         (Term.app
          `IsIrreducible
          [(Term.app `zeroLocus [(Term.typeAscription "(" `I ":" [(Term.app `Set [`R])] ")")])])
         "↔"
         (Term.proj `I "." `IsPrime))))
        ...
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(Tactic.rwSeq
            ...
            (Tactic.rwRuleSeq
             "["
             [(Tactic.rwRule [] `Ideal.is_prime_iff) "," (Tactic.rwRule [] `IsIrreducible)]
             "]")
            [])
           []
           (Tactic.apply "apply" `and_congr)
           []
           (tactic__
            ...
            [(Tactic.rwSeq
              ...
              (Tactic.rwRuleSeq
               "["
               [(Tactic.rwRule [] `Set.nonempty_iff_ne_empty)
                ","
                (Tactic.rwRule [] `Ne.def)
                ","
                (Tactic.rwRule [] `zero_locus_empty_iff_eq_top)]
               "]")
              [])])
           []
           (tactic__
            ...
            [(Mathlib.Tactic.tacticTrans___
              ...
              [(Term.forall
                ...
                (Term.arrow
                 («term_⊆_»
                  (PrimeSpectrum.AlgebraicGeometry.PrimeSpectrum.Basic.«termZ(_)» "Z(" `I ")")
                  "⊆"
                  («term_∪_»
                   (PrimeSpectrum.AlgebraicGeometry.PrimeSpectrum.Basic.«termZ(_)» "Z(" `x ")")
                   "∪"
                   (PrimeSpectrum.AlgebraicGeometry.PrimeSpectrum.Basic.«termZ(_)» "Z(" `y ")")))
                 "→"
                 («term_∨_»
                  («term_⊆_»
                   (PrimeSpectrum.AlgebraicGeometry.PrimeSpectrum.Basic.«termZ(_)» "Z(" `I ")")
                  ...
                  («term_⊆_»
                   (PrimeSpectrum.AlgebraicGeometry.PrimeSpectrum.Basic.«termZ(_)» "Z(" `I ")")
                   "⊆"
                   (PrimeSpectrum.AlgebraicGeometry.PrimeSpectrum.Basic.«termZ(_)»
                    "Z("
                    `y
                    ")")))))])
             []
             (tactic__
              ...
              [(Mathlib.Tactic.tacticSimp_rw__
                ...
                (Tactic.rwRuleSeq
                 "["
                 [(Tactic.rwRule [] `is_preirreducible_iff_closed_union_closed)
                  ","
                  (Tactic.rwRule [] `is_closed_iff_zero_locus_ideal)]
                 "]")
                [])
               []
               ...
               (tactic__
                ...
                [(Std.Tactic.rintro
                  ...
                  [])
                 []
                 (Tactic.exact "exact" (Term.app `h [`x `y]))])])
             []
             (tactic__
              (cdotTk (patternIgnore (token.«· » "·")))
              [(Mathlib.Tactic.tacticSimp_rw__
                ...
                (Tactic.rwRuleSeq
                 "["
                 [(Tactic.rwRule [(patternIgnore (token.«← » "←"))] `zero_locus_inf)
                  ","
                  (Tactic.rwRule [] `subset_zero_locus_iff_le_vanishing_ideal)
                  ","
                  (Tactic.rwRule [] `vanishing_ideal_zero_locus_eq_radical)
                  ","
                  (Tactic.rwRule [] `hI.radical)]
                 "]")
                [])
               []
               (Tactic.constructor "constructor")
               ...
               (tactic__
                ...
                [(Mathlib.Tactic.tacticSimp_rw__
                  ...
                  (Tactic.rwRuleSeq
                   "["
                   [(Tactic.rwRule [(patternIgnore (token.«← » "←"))] `SetLike.mem_coe)
                    ","
                    (Tactic.rwRule [(patternIgnore (token.«← » "←"))] `Set.singleton_subset_iff)
                    ","
                    (Tactic.rwRule [(patternIgnore (token.«← » "←"))] `Ideal.span_le)
                    ","
                    (Tactic.rwRule
                     [(patternIgnore (token.«← » "←"))]
                 ...
                 (Tactic.rwSeq
                  ...
                  (Tactic.rwRuleSeq
                   "["
                   [(Tactic.rwRule [(patternIgnore (token.«← » "←"))] `hI.radical_le_iff)]
                   "]")
                  [(Tactic.location
                    "at"
                 ...
                 (Std.Tactic.Simpa.simpa
                  ...
                  (Std.Tactic.Simpa.simpaArgsRest
                   ...
                   [(Tactic.simpArgs
                     "["
                     [(Tactic.simpLemma [] [] `Ideal.radical_inf)
                      ","
                      (Tactic.simpLemma [] [] `Ideal.radical_mul)]
                     "]")]
                   ["using" `h']))])
               []
               (tactic__
                ...
                [(Mathlib.Tactic.tacticSimp_rw__
                  ...
                  (Tactic.rwRuleSeq
                   "["
                   [(Tactic.rwRule [] `or_iff_not_imp_left)
                    ","
                    (Tactic.rwRule [] `SetLike.not_le_iff_exists)]
                   "]")
                  [])
                 []
                 (Std.Tactic.rintro
                  ...
                  [(Std.Tactic.RCases.rintroPat.one (Std.Tactic.RCases.rcasesPat.one `h))
                   ...
                   (Std.Tactic.RCases.rintroPat.one
                    (Std.Tactic.RCases.rcasesPat.tuple
                     ...
                     "⟩"))
                   (Std.Tactic.RCases.rintroPat.one (Std.Tactic.RCases.rcasesPat.one `y))
                   (Std.Tactic.RCases.rintroPat.one (Std.Tactic.RCases.rcasesPat.one `hy))]
                  [])
                 []
                 (Tactic.exact
                  "exact"
                  (Term.app
                   ...
                   [(Term.app
                     ...
                     [(Term.anonymousCtor
                       "⟨"
                       [(Term.app `Ideal.mul_mem_right [(Term.hole "_") (Term.hole "_") `hx])
                        ","
                        (Term.app `Ideal.mul_mem_left [(Term.hole "_") (Term.hole "_") `hy])]
                       "⟩")])
                    `hx']))])])])])))
       [])
      []
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Mathlib.Tactic.tacticSimp_rw__
       ...
       (Tactic.rwRuleSeq
        "["
        [(Tactic.rwRule [] `or_iff_not_imp_left) "," (Tactic.rwRule [] `SetLike.not_le_iff_exists)]
        "]")
       [])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (PrimeSpectrum.AlgebraicGeometry.PrimeSpectrum.Basic.«termZ(_)» "Z(" `y ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'PrimeSpectrum.AlgebraicGeometry.PrimeSpectrum.Basic.«termZ(_)»', expected 'PrimeSpectrum.AlgebraicGeometry.PrimeSpectrum.Basic.termZ(_)._@.AlgebraicGeometry.PrimeSpectrum.Basic._hyg.19'
...
theorem
  ...
  ( I : Ideal R ) ( hI : I . IsRadical ) : IsIrreducible zeroLocus ( I : Set R ) ↔ I . IsPrime
  :=
    by
