...
#align_import tactic.generalizes from "leanprover-community/mathlib"@"8f6fd1b69096c6a587f745d354306c0d46396915"
...
unsafe def step2 (md : Transparency) (to_generalize : List (Name × expr × expr)) :
  ...
  to_generalize.mapM fun ⟨n, j, k⟩ => do
    ...
    let sort u ← infer_type K |
      throwError "generalizes'/step2: expected the type of {← K} to be a sort"
