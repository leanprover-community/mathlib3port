...
-- ././Mathport/Syntax/Translate/Basic.lean:833:9: unsupported derive handler bounded
-- ././Mathport/Syntax/Translate/Basic.lean:833:9: unsupported derive handler prog
/-- 
...
def numeral.of_fintype [Fintype α] : Parser α := do
  ...
  pure $ Nat.binCast c deriving [anonymous], [anonymous], [anonymous]
...
def numeral.from_one : Parser α := do
  ...
  pure $ Nat.binCast (c - 1)deriving [anonymous], [anonymous], [anonymous]
...
-- ././Mathport/Syntax/Translate/Basic.lean:833:9: unsupported derive handler mono
-- ././Mathport/Syntax/Translate/Basic.lean:833:9: unsupported derive handler bounded
-- ././Mathport/Syntax/Translate/Basic.lean:833:9: unsupported derive handler err_static
-- ././Mathport/Syntax/Translate/Basic.lean:833:9: unsupported derive handler step
/-- 
...
def numeral.char (fromc toc : Charₓ) : Parser α := do
  ...
  pure $ Nat.binCast (c.to_nat - fromc.to_nat)deriving [anonymous], [anonymous], [anonymous], [anonymous]
