...
theorem mul_num_denom (q r : ℚ) : (q*r) = (q.num*r.num) /. «expr↑ » (q.denom*r.denom) :=
  have hq' : («expr↑ » q.denom : ℤ) ≠ 0 :=
    by 
      have  := denom_ne_zero q <;> simpa 
  have hr' : («expr↑ » r.denom : ℤ) ≠ 0 :=
    by 
      have  := denom_ne_zero r <;> simpa 
  suffices ((q.num /. «expr↑ » q.denom)*r.num /. «expr↑ » r.denom) = (q.num*r.num) /. «expr↑ » (q.denom*r.denom)by 
    simpa using this 
  by 
...
-- error in Data.Rat.Basic: ././Mathport/Syntax/Translate/Basic.lean:340:40: in repeat: ././Mathport/Syntax/Translate/Tactic/Basic.lean:41:45: missing argument
...
-- error in Data.Rat.Basic: ././Mathport/Syntax/Translate/Basic.lean:340:40: in conv: ././Mathport/Syntax/Translate/Basic.lean:384:40: in for: ././Mathport/Syntax/Translate/Basic.lean:340:40: in rw: ././Mathport/Syntax/Translate/Tactic/Basic.lean:41:45: missing argument
