...
| ⟨n, d, h, c⟩ =>
  by 
    ...
    conv  => toRHS rw [coe_int_eq_mk, Rat.le_def zero_lt_one h', mul_oneₓ]
...
-- error in Data.Rat.Floor: ././Mathport/Syntax/Translate/Basic.lean:176:17: failed to parenthesize: no declaration of attribute [parenthesizer] found for 'Lean.Meta.solveByElim'
