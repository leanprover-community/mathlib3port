...
instance smul_comm_class_left {M N : Type _} [MulAction ℝ≥0∞ N] [SMul M N]
...
instance smul_comm_class_right {M N : Type _} [MulAction ℝ≥0∞ N] [SMul M N]
...
#align ennreal.of_real_of_nonpos Ennreal.of_real_of_nonpos
