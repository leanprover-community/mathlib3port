...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  ...
  (Command.optDeclSig
   [(Term.explicitBinder "(" [`v] [":" (Term.app (Term.explicitUniv `Typevec ".{" [`u] "}") [`n])] [] ")")]
   [(Term.typeSpec ":" (Term.type "Type" [`u]))])
  (Command.declValSimple
   ":="
   (Init.Data.Sigma.Basic.«termΣ_,_»
    "Σ"
    (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `α)] [":" `A]))
    ", "
    (Term.app `F [`α `v]))
   [])
  []
...
/--
    Dependent sum of of an `n`-ary functor. The sum can range over
    data types like `ℕ` or over `Type.{u-1}` -/
  def Sigma ( v : Typevec .{ u } n ) : Type u := Σ α : A , F α v
...
instance : Mvfunctor ( Sigma F ) where map α β f ⟨ a , x ⟩ := ⟨ a , f <$$> x ⟩
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " polynomial functor representation of a dependent sum -/")]
  []
 ...
 (Command.def
  "def"
  (Command.declId `P [])
  (Command.optDeclSig [] [(Term.typeSpec ":" (Term.app `Mvpfunctor [`n]))])
  (Command.declValSimple
   ":="
   (Term.anonymousCtor
    "⟨"
    [(Init.Data.Sigma.Basic.«termΣ_,_»
      ...
      ", "
      (Term.proj (Term.app `P [(Term.app `F [`a])]) "." `A))
     ","
     (Term.fun
      "fun"
      (Term.basicFun
       ...
       "=>"
       (Term.app
        (Term.proj (Term.app `P [(Term.app `F [(Term.proj `x "." (fieldIdx "1"))])]) "." `B)
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `P [(Term.app `F [(Term.proj `x "." (fieldIdx "1"))])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `P [(Term.paren "(" [(Term.app `F [(Term.proj `x "." (fieldIdx "1"))]) []] ")")]) []]
 ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `P [(Term.paren "(" [(Term.app `F [`a]) []] ")")]) []]
 ")")
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.def', expected 'Lean.Parser.Command.structure.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.def', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
/-- polynomial functor representation of a dependent sum -/ protected
  def P : Mvpfunctor n := ⟨ Σ a , P F a . A , fun x => P F x . 1 . B x . 2 ⟩
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " polynomial functor representation of a dependent product -/")]
  []
  [(Command.protected "protected")]
  []
  []
 ...
 (Command.def
  ...
  (Command.declValSimple
   ...
   (Term.anonymousCtor
    "⟨"
    [(Term.forall "∀" [(Term.simpleBinder [`a] [])] "," (Term.proj (Term.app `P [(Term.app `F [`a])]) "." `A))
     ","
     (Term.fun
      "fun"
      (Term.basicFun
       [(Term.simpleBinder [`x `i] [])]
       "=>"
       (Init.Data.Sigma.Basic.«termΣ_,_»
        "Σ"
        (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `a)] [":" `A]))
        ", "
        (Term.app (Term.proj (Term.app `P [(Term.app `F [`a])]) "." `B) [(Term.app `x [`a]) `i]))))]
    "⟩")
   [])
  []
  []
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `P [(Term.app `F [`a])]) "." `B)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `P [(Term.app `F [`a])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.def', expected 'Lean.Parser.Command.structure.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.def', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
/-- polynomial functor representation of a dependent product -/ protected
  def P : Mvpfunctor n := ⟨ ∀ a , P F a . A , fun x i => Σ a : A , P F a . B x a i ⟩
