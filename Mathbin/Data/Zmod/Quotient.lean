...
def quotient_zmultiples_nat_equiv_zmod : Quotientₓ (AddSubgroup.zmultiples (n : ℤ)) ≃+ Zmod n :=
...
def quotient_zmultiples_equiv_zmod (a : ℤ) : Quotientₓ (AddSubgroup.zmultiples a) ≃+ Zmod a.nat_abs :=
...
def quotient_span_nat_equiv_zmod : (Ideal.span {«expr↑ » n}).Quotient ≃+* Zmod n :=
...
def quotient_span_equiv_zmod (a : ℤ) : (Ideal.span ({a} : Set ℤ)).Quotient ≃+* Zmod a.nat_abs :=
