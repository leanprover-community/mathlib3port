...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `mk_preimage_tprod [])
  (Command.declSig
   []
   (Term.typeSpec
    ":"
    (Term.forall
     "∀"
     [(Term.simpleBinder [`l] [(Term.typeSpec ":" (Term.app `List [`ι]))])
      (Term.simpleBinder
       [`t]
       [(Term.typeSpec ":" (Term.forall "∀" [(Term.simpleBinder [`i] [])] "," (Term.app `Set [(Term.app `α [`i])])))])]
     ","
     («term_=_»
      (Set.Data.Set.Basic.«term_⁻¹'_» (Term.app `tprod.mk [`l]) " ⁻¹' " (Term.app `Set.Tprodₓ [`l `t]))
      "="
      (Term.app (Term.proj (Set.«term{_|_}» "{" `i "|" (Init.Core.«term_∈_» `i " ∈ " `l) "}") "." `pi) [`t])))))
  (Command.declValEqns
       ...
       (Term.byTactic
        ...
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(group (Tactic.simp "simp" [] [] ["[" [(Tactic.simpLemma [] [] `Set.Tprodₓ)] "]"] []) [])]))))
      (Term.matchAlt
       "|"
       [(«term_::_» `i "::" `l) "," `t]
       "=>"
          ...
          [(group (Tactic.ext "ext" [(Tactic.rcasesPat.one `f)] []) [])
               ...
               [(Term.typeSpec
                 ...
                 («term_↔_»
                  ...
                  (Init.Core.«term_∈_»
                   ...
                   " ∈ "
                   (Term.app
                    (Term.proj (Set.«term{_|_}» "{" `x "|" (Init.Core.«term_∈_» `x " ∈ " `l) "}") "." `pi)
                    [`t]))))]
               ":="
               (Term.byTactic
                "by"
                 ...
                 (Tactic.tacticSeq1Indented
                  [(group
                    (Tactic.rwSeq
                     "rw"
                     []
                     (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] (Term.app `mk_preimage_tprod [`l `t]))] "]")
                     [])
                    [])]))))))
            [])
           (group
            (Tactic.change
             "change"
             («term_↔_»
              (Init.Core.«term_∈_» (Term.app `tprod.mk [`l `f]) " ∈ " (Term.app `Set.Tprodₓ [`l `t]))
              "↔"
              (Term.forall
               "∀"
               ...
               ","
               (Term.arrow
                (Init.Core.«term_∈_» `i " ∈ " `l)
                "→"
                (Init.Core.«term_∈_» (Term.app `f [`i]) " ∈ " (Term.app `t [`i])))))
           ...
           (group
            (Tactic.rwSeq
             ...
             (Tactic.rwRuleSeq
              "["
              [(Tactic.rwRule [] `Set.Tprodₓ)
               ","
               (Tactic.rwRule [] `tprod.mk)
               ","
               (Tactic.rwRule [] `mem_preimage)
               ","
               (Tactic.rwRule [] `mem_pi)
               ","
               (Tactic.rwRule [] `prod_mk_mem_set_prod_eq)]
              "]")
             [])
            [])
           (group
            (Tactic.simpRw
             "simp_rw"
             (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `mem_set_of_eq) "," (Tactic.rwRule [] `mem_cons_iff)] "]")
             [])
            [])
           (group
            (Tactic.rwSeq
             ...
             (Tactic.rwRuleSeq
              "["
              [(Tactic.rwRule [] `forall_eq_or_imp) "," (Tactic.rwRule [] `And.congr_right_iff)]
              "]")
             [])
            [])
           (group
            (Tactic.exact
             "exact"
             (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [(Term.hole "_")] [])] "=>" `this)))
            [])]))))])
    []))
  []
  []))
     ...
     [(group (Tactic.ext "ext" [(Tactic.rcasesPat.one `f)] []) [])
          ...
          [(Term.typeSpec
            ...
            («term_↔_»
             ...
             (Init.Core.«term_∈_»
              `f
              " ∈ "
              (Term.app (Term.proj (Set.«term{_|_}» "{" `x "|" (Init.Core.«term_∈_» `x " ∈ " `l) "}") "." `pi) [`t]))))]
          ":="
          (Term.byTactic
           "by"
           (Tactic.tacticSeq
      ...
      (group
       (Tactic.rwSeq
        "rw"
        []
        (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `forall_eq_or_imp) "," (Tactic.rwRule [] `And.congr_right_iff)] "]")
        [])
       [])
      (group
       (Tactic.exact "exact" (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [(Term.hole "_")] [])] "=>" `this)))
       [])])))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.forall
   ...
   [(Term.simpleBinder [`i] [(Term.typeSpec ":" `ι)])]
   ","
   (Term.arrow (Init.Core.«term_∈_» `i " ∈ " `l) "→" (Init.Core.«term_∈_» (Term.app `f [`i]) " ∈ " (Term.app `t [`i]))))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.byTactic
   ...
   (Tactic.tacticSeq
    (Tactic.tacticSeq1Indented
     [(group
       (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] (Term.app `mk_preimage_tprod [`l `t]))] "]") [])
       [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.byTactic', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.byTactic', expected 'Lean.Parser.Term.byTactic.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq', expected 'Lean.Parser.Tactic.tacticSeq.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `mk_preimage_tprod [`l `t])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `elim_preimage_pi [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `DecidableEq [`ι]) "]")
    (Term.implicitBinder "{" [`l] [":" (Term.app `List [`ι])] "}")
    (Term.explicitBinder "(" [`hnd] [":" `l.nodup] [] ")")
    (Term.explicitBinder
     "("
     [`h]
     [":" (Term.forall "∀" [(Term.simpleBinder [`i] [])] "," (Init.Core.«term_∈_» `i " ∈ " `l))]
     []
     ")")
    (Term.explicitBinder
     "("
   ...
   (Term.typeSpec
    ":"
    («term_=_»
     (Set.Data.Set.Basic.«term_⁻¹'_» (Term.app `tprod.elim' [`h]) " ⁻¹' " (Term.app `pi [`univ `t]))
     "="
     (Term.app `Set.Tprodₓ [`l `t]))))
        ...
        (Tactic.tacticHave_
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           ...
           [(Term.typeSpec
             ":"
             («term_=_» (Set.«term{_|_}» "{" `i "|" (Init.Core.«term_∈_» `i " ∈ " `l) "}") "=" `univ))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
       ...
       (group
        (Tactic.rwSeq
         ...
         (Tactic.rwRuleSeq
          ...
          [(Tactic.rwRule ["←"] `this)
           ","
           (Tactic.rwRule ["←"] `mk_preimage_tprod)
           ","
           (Tactic.rwRule [] `preimage_preimage)]
          "]")
         [])
        [])
       (group (Tactic.convert "convert" [] `preimage_id []) [])
       (group
        (Tactic.simp
         "simp"
         []
         []
         ["[" [(Tactic.simpLemma [] [] (Term.app `tprod.mk_elim [`hnd `h])) "," (Tactic.simpLemma [] [] `id_def)] "]"]
         [])
        [])])))
   [])
  []
     ...
     [(group
       (Tactic.tacticHave_
        ...
        (Term.haveDecl
         (Term.haveIdDecl
          []
          [(Term.typeSpec ":" («term_=_» (Set.«term{_|_}» "{" `i "|" (Init.Core.«term_∈_» `i " ∈ " `l) "}") "=" `univ))]
          ":="
          (Term.byTactic
           "by"
           (Tactic.tacticSeq
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.convert "convert" [] `preimage_id [])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq
   ...
   (Tactic.rwRuleSeq
    "["
    [(Tactic.rwRule ["←"] `this) "," (Tactic.rwRule ["←"] `mk_preimage_tprod) "," (Tactic.rwRule [] `preimage_preimage)]
    "]")
   [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
...
[PrettyPrinter.parenthesize] ...precedences are 51 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 50, term))
  (Set.«term{_|_}» "{" `i "|" (Init.Core.«term_∈_» `i " ∈ " `l) "}")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Set.«term{_|_}»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Init.Core.«term_∈_» `i " ∈ " `l)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Core.«term_∈_»', expected 'antiquot'
