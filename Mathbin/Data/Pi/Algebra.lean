...
#align pi.mul_single_eq_same Pi.mul_single_eq_same

@[simp, to_additive]
theorem mul_single_eq_of_ne {i i' : I} (h : i' ≠ i) (x : f i) : mulSingle i x i' = 1 :=
  Function.update_noteq h x _
#align pi.mul_single_eq_of_ne Pi.mul_single_eq_of_ne
...
#align pi.mul_single_one Pi.mul_single_one
...
#align sum.elim_mul_single_one Sum.elim_mul_single_one
...
#align sum.elim_one_mul_single Sum.elim_one_mul_single
