...
instance
  ( priority := 100 )
  : CstarRing K
  where norm_star_mul_self x := ( NormedField.norm_mul _ _ ) . trans $ congr_argₓ ( · * ∥ x ∥ ) norm_conj
   ...
   (Term.typeSpec
    ...
    («term_=_»
     ...
     (Algebra.BigOperators.Basic.«term∏_in_,_»
      ...
      `s
      ", "
      (Term.paren "(" [(Term.app `f [`i]) [(Term.typeAscription ":" `K)]] ")")))))
  (Command.declValSimple ":=" (Term.app `RingHom.map_prod [(Term.hole "_") (Term.hole "_") (Term.hole "_")]) [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `RingHom.map_prod [(Term.hole "_") (Term.hole "_") (Term.hole "_")])
...
@[ simp , norm_cast ]
  theorem
    of_real_prod
    { α : Type _ } ( s : Finset α ) ( f : α → ℝ ) : ( ( ∏ i in s , f i : ℝ ) : K ) = ∏ i in s , ( f i : K )
   ...
   (Term.typeSpec
    ...
    («term_=_»
     ...
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      ...
      ", "
      (Term.paren "(" [(Term.app `f [`i]) [(Term.typeAscription ":" `K)]] ")")))))
  (Command.declValSimple ":=" (Term.app `RingHom.map_sum [(Term.hole "_") (Term.hole "_") (Term.hole "_")]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `RingHom.map_sum [(Term.hole "_") (Term.hole "_") (Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
  ...
  instance
    ...
    where
      re := AddMonoidHom.id ℝ
        ...
        re_add_im_ax z := by simp [ add_zeroₓ , id.def , mul_zero ]
        of_real_re_ax r := by simp only [ AddMonoidHom.id_apply , Algebra.id.map_eq_self ]
        of_real_im_ax r := by simp only [ AddMonoidHom.zero_apply ]
        mul_re_ax z w := by simp only [ sub_zero , mul_zero , AddMonoidHom.zero_apply , AddMonoidHom.id_apply ]
        mul_im_ax z w := by simp only [ add_zeroₓ , zero_mul , mul_zero , AddMonoidHom.zero_apply ]
        conj_re_ax z := by simp only [ star_ring_aut_apply , star_id_of_comm ]
        conj_im_ax z := by simp only [ neg_zero , AddMonoidHom.zero_apply ]
        conj_I_ax := by simp only [ RingEquiv.map_zero , neg_zero ]
        norm_sq_eq_def_ax
          z
          :=
          by
        ...
        div_I_ax z := by simp only [ div_zero , mul_zero , neg_zero ]
