...
def decidable_range_encode (α : Type _) [Encodable α] : DecidablePred (· ∈ Set.Range (@encode α _)) := fun x =>
...
-- ././Mathport/Syntax/Translate/Basic.lean:833:9: unsupported derive handler encodable
