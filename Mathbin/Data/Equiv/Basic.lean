...
protected theorem congr_argₓ {f : Equivₓ α β} : ∀ {x x' : α}, x = x' → f x = f x'
  | _, _, rfl => rfl

protected theorem congr_funₓ {f g : Equivₓ α β} (h : f = g) (x : α) : f x = g x :=
  h ▸ rfl
...
theorem subsingleton_congr (e : α ≃ β) : Subsingleton α ↔ Subsingleton β :=
  ⟨fun h => by
    exact e.symm.subsingleton, fun h => by
...
@[simp]
theorem coeTransₓ (f : α ≃ β) (g : β ≃ γ) : ⇑f.trans g = g ∘ f :=
  rfl
...
theorem left_inverse_symm (f : Equivₓ α β) : left_inverse f.symm f :=
  f.left_inv
...
@[simp]
theorem equiv_congr_symm {δ} (ab : α ≃ β) (cd : γ ≃ δ) : (ab.equiv_congr cd).symm = ab.symm.equiv_congr cd.symm := by
  ext
  rfl

@[simp]
theorem equiv_congr_trans {δ ε ζ} (ab : α ≃ β) (de : δ ≃ ε) (bc : β ≃ γ) (ef : ε ≃ ζ) :
    (ab.equiv_congr de).trans (bc.equiv_congr ef) = (ab.trans bc).equivCongr (de.trans ef) := by
  ext
  rfl
...
@[simp]
theorem equiv_congr_refl_right {α β} (ab e : α ≃ β) : ab.equiv_congr (Equivₓ.refl β) e = ab.symm.trans e :=
  rfl
...
theorem perm_congr_def (p : Equivₓ.Perm α') : e.perm_congr p = (e.symm.trans p).trans e :=
  rfl

@[simp]
theorem perm_congr_refl : e.perm_congr (Equivₓ.refl _) = Equivₓ.refl _ := by
  simp [perm_congr_def]
...
@[simp]
theorem perm_congr_apply (p : Equivₓ.Perm α') x : e.perm_congr p x = e (p (e.symm x)) :=
  rfl

theorem perm_congr_symm_apply (p : Equivₓ.Perm β') x : e.perm_congr.symm p x = e.symm (p (e x)) :=
  rfl

theorem perm_congr_trans (p p' : Equivₓ.Perm α') :
    (e.perm_congr p).trans (e.perm_congr p') = e.perm_congr (p.trans p') := by
  ext
  simp
...
def pprod_equiv_prod {α β : Type _} : PProd α β ≃ α × β :=
  { toFun := fun x => (x.1, x.2), invFun := fun x => ⟨x.1, x.2⟩, left_inv := fun ⟨x, y⟩ => rfl,
...
theorem arrow_congr_comp {α₁ β₁ γ₁ α₂ β₂ γ₂ : Sort _} (ea : α₁ ≃ α₂) (eb : β₁ ≃ β₂) (ec : γ₁ ≃ γ₂) (f : α₁ → β₁)
    (g : β₁ → γ₁) : arrow_congr ea ec (g ∘ f) = arrow_congr eb ec g ∘ arrow_congr ea eb f := by
  ext
  simp only [comp, arrow_congr_apply, eb.symm_apply_apply]

@[simp]
theorem arrow_congr_refl {α β : Sort _} : arrow_congr (Equivₓ.refl α) (Equivₓ.refl β) = Equivₓ.refl (α → β) :=
  rfl
...
@[simp]
theorem arrow_congr'_refl {α β : Type _} : arrow_congr' (Equivₓ.refl α) (Equivₓ.refl β) = Equivₓ.refl (α → β) :=
  rfl
...
theorem semiconj₂_conj : semiconj₂ e f (e.arrow_congr e.conj f) := fun x y => by
  simp
...
@[reducible]
def sum_congr {α β : Type _} (ea : Equivₓ.Perm α) (eb : Equivₓ.Perm β) : Equivₓ.Perm (Sum α β) :=
  Equivₓ.sumCongr ea eb

@[simp]
theorem sum_congr_apply {α β : Type _} (ea : Equivₓ.Perm α) (eb : Equivₓ.Perm β) (x : Sum α β) :
    sum_congr ea eb x = Sum.map (⇑ea) (⇑eb) x :=
...
@[simp]
theorem sum_congr_refl {α β : Sort _} : sum_congr (Equivₓ.refl α) (Equivₓ.refl β) = Equivₓ.refl (Sum α β) :=
...
def bool_equiv_punit_sum_punit : Bool ≃ Sum PUnit.{u + 1} PUnit.{v + 1} :=
  ⟨fun b => cond b (inr PUnit.unit) (inl PUnit.unit), fun s => Sum.recOn s (fun _ => ff) fun _ => tt, fun b => by
    cases b <;> rfl, fun s => by
    rcases s with (⟨⟨⟩⟩ | ⟨⟨⟩⟩) <;> rfl⟩

/--  `Prop` is noncomputably equivalent to `bool`. -/
noncomputable def Prop_equiv_bool : Prop ≃ Bool :=
  ⟨fun p => @to_bool p (Classical.propDecidable _), fun b => b, fun p => by
    simp , fun b => by
    simp ⟩
...
def option_is_some_equiv (α : Type _) : { x : Option α // x.is_some } ≃ α :=
  { toFun := fun o => Option.getₓ o.2,
    invFun := fun x =>
      ⟨some x, by
        decide⟩,
    left_inv := fun o => Subtype.eq $ Option.some_getₓ _, right_inv := fun x => Option.get_some _ _ }
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `sum_equiv_sigma_bool [])
  (Command.optDeclSig
   ...
   (Term.anonymousCtor
    ...
    [(Term.fun
      ...
      (Term.basicFun
       ...
       (Term.app
        `s.elim
        [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`x] [])] "=>" (Term.anonymousCtor "⟨" [`tt "," `x] "⟩")))
         (Term.fun
          "fun"
          (Term.basicFun [(Term.simpleBinder [`x] [])] "=>" (Term.anonymousCtor "⟨" [`ff "," `x] "⟩")))])))
     ","
     (Term.fun
      "fun"
      (Term.basicFun
       ...
       (Term.match
        ...
        "with"
        (Term.matchAlts
         [(Term.matchAlt "|" [(Term.anonymousCtor "⟨" [`tt "," `a] "⟩")] "=>" (Term.app `inl [`a]))
          (Term.matchAlt "|" [(Term.anonymousCtor "⟨" [`ff "," `b] "⟩")] "=>" (Term.app `inr [`b]))]))))
     ","
     (Term.fun
      "fun"
      (Term.basicFun
             ...
             (Tactic.rcases
              ...
              ["with"
               (Tactic.rcasesPat.tuple
                "⟨"
                [(Tactic.rcasesPatLo
                  (Tactic.rcasesPatMed [(Tactic.rcasesPat.ignore "_") "|" (Tactic.rcasesPat.ignore "_")])
                  [])
                 ","
  ...
  (Tactic.«tactic_<;>_»
   (Tactic.rcases
    ...
    ["with"
     (Tactic.rcasesPat.tuple
      "⟨"
      [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.ignore "_") "|" (Tactic.rcasesPat.ignore "_")]) [])
       ","
       (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.ignore "_")]) [])]
      "⟩")])
   "<;>"
   ...
   (Term.basicFun
    ...
    (Term.byTactic
     ...
     (Tactic.tacticSeq
      (Tactic.tacticSeq1Indented
       [(group
         (Tactic.«tactic_<;>_» (Tactic.cases "cases" [(Tactic.casesTarget [] `s)] [] []) "<;>" (Tactic.tacticRfl "rfl"))
         [])])))))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.fun.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.basicFun.antiquot'
  ...
  (Term.fun
   ...
   (Term.basicFun
    ...
    (Term.app
     `s.elim
     [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`x] [])] "=>" (Term.anonymousCtor "⟨" [`tt "," `x] "⟩")))
      (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`x] [])] "=>" (Term.anonymousCtor "⟨" [`ff "," `x] "⟩")))])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.fun.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.basicFun.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
/--
  ...
  def
    ...
    ( α β : Type u ) : Sum α β ≃ Σ b : Bool , cond b α β
    :=
      ⟨
        fun s => s.elim fun x => ⟨ tt , x ⟩ fun x => ⟨ ff , x ⟩
          ,
          fun s => match s with | ⟨ tt , a ⟩ => inl a | ⟨ ff , b ⟩ => inr b
          ,
          fun s => by cases s <;> rfl
          ,
          fun s => by rcases s with ⟨ _ | _ , _ ⟩ <;> rfl
        ⟩
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `sigma_preimage_equiv [])
  (Command.optDeclSig
   ...
   [(Term.typeSpec
     ...
     (Data.Equiv.Basic.«term_≃_»
      (Init.Data.Sigma.Basic.«termΣ_,_»
       ...
       ", "
       («term{__:_//_}» "{" `x [] "//" («term_=_» (Term.app `f [`x]) "=" `y) "}"))
      " ≃ "
      `α))])
  (Command.declValSimple
   ":="
   (Term.anonymousCtor
    ...
    [(Term.fun
      "fun"
      (Term.basicFun [(Term.simpleBinder [`x] [])] "=>" (Init.Coe.«term↑_» "↑" (Term.proj `x "." (fieldIdx "2")))))
     ","
     (Term.fun
      "fun"
      (Term.basicFun
       [(Term.simpleBinder [`x] [])]
       "=>"
       (Term.anonymousCtor "⟨" [(Term.app `f [`x]) "," `x "," `rfl] "⟩")))
     ","
     (Term.fun "fun" (Term.basicFun [(Term.anonymousCtor "⟨" [`y "," `x "," `rfl] "⟩")] "=>" `rfl))
     ","
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.fun
   "fun"
   (Term.basicFun [(Term.simpleBinder [`x] [])] "=>" (Term.anonymousCtor "⟨" [(Term.app `f [`x]) "," `x "," `rfl] "⟩")))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.fun.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.basicFun.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.basicFun.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Init.Coe.«term↑_» "↑" (Term.proj `x "." (fieldIdx "2")))
...
/--
    ...
    @[ simps ]
  def
    sigma_preimage_equiv
    { α β : Type _ } ( f : α → β ) : Σ y : β , { x // f x = y } ≃ α
...
def perm.subtype_congr : Equivₓ.Perm ε :=
...
@[simp]
theorem perm.subtype_congr.left_apply_subtype (a : { a // p a }) : ep.subtype_congr en a = ep a := by
...
@[simp]
theorem perm.subtype_congr.right_apply_subtype (a : { a // ¬p a }) : ep.subtype_congr en a = en a := by
  convert perm.subtype_congr.right_apply _ _ a.property
  simp

@[simp]
theorem perm.subtype_congr.refl :
    perm.subtype_congr (Equivₓ.refl { a // p a }) (Equivₓ.refl { a // ¬p a }) = Equivₓ.refl ε := by
  ext x
  by_cases' h : p x <;> simp [h]

@[simp]
theorem perm.subtype_congr.symm : (ep.subtype_congr en).symm = perm.subtype_congr ep.symm en.symm := by
  ext x
  by_cases' h : p x
  ·
...
theorem perm.subtype_congr.trans :
    (ep.subtype_congr en).trans (ep'.subtype_congr en') = perm.subtype_congr (ep.trans ep') (en.trans en') := by
  ext x
  by_cases' h : p x
  ·
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `Pi_curry [])
  (Command.optDeclSig
   [(Term.implicitBinder "{" [`α] [] "}")
    (Term.implicitBinder "{" [`β] [":" (Term.arrow `α "→" (Term.sort "Sort" [(Level.hole "_")]))] "}")
    (Term.explicitBinder
     "("
     [`γ]
     [":"
      (Term.forall
       ...
       [(Term.simpleBinder [`a] [])]
       ","
       (Term.arrow (Term.app `β [`a]) "→" (Term.sort "Sort" [(Level.hole "_")])))]
     []
     ")")]
   [(Term.typeSpec
     ":"
     (Data.Equiv.Basic.«term_≃_»
      ...
      " ≃ "
      (Term.forall "∀" [(Term.simpleBinder [`a `b] [])] "," (Term.app `γ [`a `b]))))])
  (Command.declValSimple
   ":="
   (Term.structInst
    "{"
    []
    [(group (Term.structInstField (Term.structInstLVal `toFun []) ":=" `Sigma.curry) [","])
     (group (Term.structInstField (Term.structInstLVal `invFun []) ":=" `Sigma.uncurry) [","])
     (group (Term.structInstField (Term.structInstLVal `left_inv []) ":=" `Sigma.uncurry_curry) [","])
     (group (Term.structInstField (Term.structInstLVal `right_inv []) ":=" `Sigma.curry_uncurry) [])]
    (Term.optEllipsis [])
    []
    "}")
   [])
...
/--
  ...
  def
    Pi_curry
    { α } { β : α → Sort _ } ( γ : ∀ a , β a → Sort _ ) : ∀ x : Σ i , β i , γ x . 1 x . 2 ≃ ∀ a b , γ a b
    :=
      {
        toFun := Sigma.curry ,
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " A `psigma`-type is equivalent to the corresponding `sigma`-type. -/")]
  [(Term.attributes "@[" [(Term.attrInstance (Term.attrKind []) (Attr.simps "simps" [] [`apply `symmApply]))] "]")]
  []
  []
  []
  [])
 (Command.def
  "def"
  (Command.declId `psigma_equiv_sigma [])
  (Command.optDeclSig
   [(Term.implicitBinder "{" [`α] [] "}")
    ...
    [(Term.fun
     ...
     (Term.fun
      ...
      (Term.basicFun
       ...
       (Term.anonymousCtor "⟨" [(Term.proj `a "." (fieldIdx "1")) "," (Term.proj `a "." (fieldIdx "2"))] "⟩")))
     ","
     (Term.fun "fun" (Term.basicFun [(Term.anonymousCtor "⟨" [`a "," `b] "⟩")] "=>" `rfl))
     ","
     (Term.fun "fun" (Term.basicFun [(Term.anonymousCtor "⟨" [`a "," `b] "⟩")] "=>" `rfl))]
    "⟩")
   [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.def', expected 'Lean.Parser.Command.structure.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.def', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
/-- A `psigma`-type is equivalent to the corresponding `sigma`-type. -/ @[ simps apply symmApply ]
  def
    psigma_equiv_sigma
    { α } ( β : α → Type _ ) : Σ' i , β i ≃ Σ i , β i
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `psigma_congr_right [])
  (Command.optDeclSig
   [(Term.implicitBinder "{" [`α] [] "}")
    (Term.implicitBinder "{" [`β₁ `β₂] [":" (Term.arrow `α "→" (Term.sort "Sort" [(Level.hole "_")]))] "}")
    (Term.explicitBinder
     "("
     [`F]
     [":"
      (Term.forall
       ...
       [(Term.simpleBinder [`a] [])]
       ","
       (Data.Equiv.Basic.«term_≃_» (Term.app `β₁ [`a]) " ≃ " (Term.app `β₂ [`a])))]
     []
     ")")]
   [(Term.typeSpec
     ":"
      ...
      (Term.basicFun
       ...
       (Term.anonymousCtor
        ...
        [(Term.proj `a "." (fieldIdx "1"))
         ","
         (Term.app
          (Term.proj (Term.app `F [(Term.proj `a "." (fieldIdx "1"))]) "." `symm)
          [(Term.proj `a "." (fieldIdx "2"))])]
        "⟩")))
     ","
     (Term.fun
      ...
      (Term.basicFun
       ...
       "=>"
       («term_$__»
        (Term.app `congr_argₓ [(Term.app `Psigma.mk [`a])])
        "$"
        (Term.app `symm_apply_apply [(Term.app `F [`a]) `b]))))
     ","
     (Term.fun
      "fun"
      (Term.basicFun
       ...
       («term_$__»
        (Term.app `congr_argₓ [(Term.app `Psigma.mk [`a])])
        "$"
        (Term.app `apply_symm_apply [(Term.app `F [`a]) `b]))))]
    "⟩")
   [])
  []
  []
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Psigma.mk [`a]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `congr_argₓ
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.proj (Term.app `F [(Term.proj `a "." (fieldIdx "1"))]) "." `symm) [(Term.proj `a "." (fieldIdx "2"))])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'Lean.Parser.Term.namedArgument'
...
/--
  ...
  def
    psigma_congr_right
    { α } { β₁ β₂ : α → Sort _ } ( F : ∀ a , β₁ a ≃ β₂ a ) : Σ' a , β₁ a ≃ Σ' a , β₂ a
    :=
      ⟨
        fun a => ⟨ a . 1 , F a . 1 a . 2 ⟩
          ,
          fun a => ⟨ a . 1 , F a . 1 . symm a . 2 ⟩
          ,
...
theorem psigma_congr_right_trans {α} {β₁ β₂ β₃ : α → Sort _} (F : ∀ a, β₁ a ≃ β₂ a) (G : ∀ a, β₂ a ≃ β₃ a) :
    (psigma_congr_right F).trans (psigma_congr_right G) = psigma_congr_right fun a => (F a).trans (G a) := by
  ext1 x
  cases x
  rfl
...
theorem psigma_congr_right_symm {α} {β₁ β₂ : α → Sort _} (F : ∀ a, β₁ a ≃ β₂ a) :
    (psigma_congr_right F).symm = psigma_congr_right fun a => (F a).symm := by
  ext1 x
  cases x
  rfl
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `psigma_congr_right_refl [])
  (Command.declSig
   [(Term.implicitBinder "{" [`α] [] "}")
    (Term.implicitBinder "{" [`β] [":" (Term.arrow `α "→" (Term.sort "Sort" [(Level.hole "_")]))] "}")]
   (Term.typeSpec
    ...
    («term_=_»
     (Term.app
      ...
      [(Term.fun
        "fun"
        (Term.basicFun [(Term.simpleBinder [`a] [])] "=>" (Term.app `Equivₓ.refl [(Term.app `β [`a])])))])
     "="
     (Term.app
      `Equivₓ.refl
      [(Init.Data.Sigma.Basic.«termΣ'_,_»
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, [anonymous]))
  («term_=_»
   (Term.app
    `psigma_congr_right
    [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`a] [])] "=>" (Term.app `Equivₓ.refl [(Term.app `β [`a])])))])
   "="
   (Term.app
    `Equivₓ.refl
    [(Init.Data.Sigma.Basic.«termΣ'_,_»
...
@[ simp ]
  theorem
    ...
    { α } { β : α → Sort _ } : psigma_congr_right fun a => Equivₓ.refl β a = Equivₓ.refl Σ' a , β a
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `sigma_congr_right [])
  (Command.optDeclSig
   [(Term.implicitBinder "{" [`α] [] "}")
    (Term.implicitBinder "{" [`β₁ `β₂] [":" (Term.arrow `α "→" (Term.type "Type" [(Level.hole "_")]))] "}")
    (Term.explicitBinder
     "("
     [`F]
     [":"
    ...
    [(Term.fun
     ...
     (Term.fun
      ...
      (Term.basicFun
       ...
       "=>"
       («term_$__»
        (Term.app `congr_argₓ [(Term.app `Sigma.mk [`a])])
        "$"
        (Term.app `symm_apply_apply [(Term.app `F [`a]) `b]))))
     ","
     (Term.fun
...
/--
  ...
  def
    sigma_congr_right
    { α } { β₁ β₂ : α → Type _ } ( F : ∀ a , β₁ a ≃ β₂ a ) : Σ a , β₁ a ≃ Σ a , β₂ a
    :=
      ⟨
        fun a => ⟨ a . 1 , F a . 1 a . 2 ⟩
          ,
...
theorem sigma_congr_right_trans {α} {β₁ β₂ β₃ : α → Type _} (F : ∀ a, β₁ a ≃ β₂ a) (G : ∀ a, β₂ a ≃ β₃ a) :
    (sigma_congr_right F).trans (sigma_congr_right G) = sigma_congr_right fun a => (F a).trans (G a) := by
  ext1 x
  cases x
  rfl
...
theorem sigma_congr_right_symm {α} {β₁ β₂ : α → Type _} (F : ∀ a, β₁ a ≃ β₂ a) :
    (sigma_congr_right F).symm = sigma_congr_right fun a => (F a).symm := by
  ext1 x
  cases x
  rfl
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `sigma_congr_right_refl [])
  (Command.declSig
   [(Term.implicitBinder "{" [`α] [] "}")
...
@[ simp ]
  theorem
    ...
    { α } { β : α → Type _ } : sigma_congr_right fun a => Equivₓ.refl β a = Equivₓ.refl Σ a , β a
    := by ext1 x cases x rfl

/- failed to parenthesize: parenthesize: uncaught backtrack exception
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " A `psigma` with `Prop` fibers is equivalent to the subtype.  -/")]
  []
  []
  []
  []
 ...
 (Command.def
  "def"
  (Command.declId `psigma_equiv_subtype [])
  (Command.optDeclSig
   [(Term.implicitBinder "{" [`α] [":" (Term.type "Type" [`v])] "}")
      ...
      (Term.structInstField
       ...
       (Term.fun
        ...
        (Term.basicFun
         [(Term.simpleBinder [`x] [])]
         "=>"
         (Term.anonymousCtor "⟨" [(Term.proj `x "." (fieldIdx "1")) "," (Term.proj `x "." (fieldIdx "2"))] "⟩"))))
      [","])
     (group
      (Term.structInstField
  ...
  (Term.fun
   ...
   (Term.basicFun
    ...
    (Term.byTactic
     ...
     (Tactic.tacticSeq
      (Tactic.tacticSeq1Indented
       [(group (Tactic.cases "cases" [(Tactic.casesTarget [] `x)] [] []) []) (group (Tactic.tacticRfl "rfl") [])])))))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.fun.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.basicFun.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " A `sigma` with `plift` fibers is equivalent to the subtype. -/")]
  []
  []
  []
  []
 ...
 (Command.def
  "def"
  (Command.declId `sigma_plift_equiv_subtype [])
  (Command.optDeclSig
   [(Term.implicitBinder "{" [`α] [":" (Term.type "Type" [`v])] "}")
    (Term.explicitBinder "(" [`P] [":" (Term.arrow `α "→" (Term.prop "Prop"))] [] ")")]
   [(Term.typeSpec
  ...
  (Command.declValSimple
   ...
   (Term.app
    (Term.proj
     (Term.app
      (Term.proj (Term.proj (Term.app `psigma_equiv_sigma [(Term.hole "_")]) "." `symm) "." `trans)
      [(Term.app
        `psigma_congr_right
        [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`a] [])] "=>" `Equivₓ.plift))])])
     "."
     `trans)
    [(Term.app `psigma_equiv_subtype [`P])])
   [])
  []
  []
  []))
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `psigma_equiv_subtype [`P]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj
   (Term.app
    (Term.proj (Term.proj (Term.app `psigma_equiv_sigma [(Term.hole "_")]) "." `symm) "." `trans)
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app
   (Term.proj (Term.proj (Term.app `psigma_equiv_sigma [(Term.hole "_")]) "." `symm) "." `trans)
   [(Term.app `psigma_congr_right [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`a] [])] "=>" `Equivₓ.plift))])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.proj (Term.app `psigma_equiv_sigma [(Term.hole "_")]) "." `symm)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `psigma_equiv_sigma [(Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `psigma_equiv_sigma [(Term.hole "_")]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(Term.app
   (Term.proj
    (Term.proj (Term.paren "(" [(Term.app `psigma_equiv_sigma [(Term.hole "_")]) []] ")") "." `symm)
    "."
    `trans)
   [(Term.paren
     "("
...
/-- A `sigma` with `plift` fibers is equivalent to the subtype. -/
  def
    sigma_plift_equiv_subtype
    { α : Type v } ( P : α → Prop ) : Σ i , Plift P i ≃ Subtype P
    := psigma_equiv_sigma _ . symm . trans psigma_congr_right fun a => Equivₓ.plift . trans psigma_equiv_subtype P
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `sigma_ulift_plift_equiv_subtype [])
  (Command.optDeclSig
   [(Term.implicitBinder "{" [`α] [":" (Term.type "Type" [`v])] "}")
    (Term.explicitBinder "(" [`P] [":" (Term.arrow `α "→" (Term.prop "Prop"))] [] ")")]
   [(Term.typeSpec
     ...
     (Data.Equiv.Basic.«term_≃_»
      (Init.Data.Sigma.Basic.«termΣ_,_»
       ...
       (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
       ", "
       (Term.app `Ulift [(Term.app `Plift [(Term.app `P [`i])])]))
      " ≃ "
      (Term.app `Subtype [`P])))])
  (Command.declValSimple
   ":="
   (Term.app
    (Term.proj
     (Term.app `sigma_congr_right [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`a] [])] "=>" `Equivₓ.ulift))])
     "."
     `trans)
    [(Term.app `sigma_plift_equiv_subtype [`P])])
   [])
  []
  []
  []))
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `sigma_plift_equiv_subtype [`P]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj
   (Term.app `sigma_congr_right [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`a] [])] "=>" `Equivₓ.ulift))])
   "."
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`a] [])] "=>" `Equivₓ.ulift))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.fun.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.basicFun.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `Plift [(Term.paren "(" [(Term.app `P [`i]) []] ")")]) []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `Ulift
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
/--
    ...
    -/
  def
    sigma_ulift_plift_equiv_subtype
    { α : Type v } ( P : α → Prop ) : Σ i , Ulift Plift P i ≃ Subtype P
    := sigma_congr_right fun a => Equivₓ.ulift . trans sigma_plift_equiv_subtype P
   ...
   [(Term.typeSpec
     ...
     (Term.app
      ...
      [(Init.Data.Sigma.Basic.«termΣ_,_»
        ...
        ", "
        (Term.app `β [`a]))]))])
  (Command.declValSimple ":=" (Term.app `Equivₓ.sigmaCongrRight [`F]) [])
  []
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Equivₓ.sigmaCongrRight [`F])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.def', expected 'Lean.Parser.Command.structure.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.def', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
/-- A family of permutations `Π a, perm (β a)` generates a permuation `perm (Σ a, β₁ a)`. -/ @[ reducible ]
  def sigma_congr_right { α } { β : α → Sort _ } ( F : ∀ a , perm β a ) : perm Σ a , β a := Equivₓ.sigmaCongrRight F
    ...
    («term_=_»
     ...
     (Term.app
      ...
      [(Init.Data.Sigma.Basic.«termΣ_,_»
        ...
        ", "
        (Term.app `β [`a]))]))))
  (Command.declValSimple ":=" `Equivₓ.sigma_congr_right_refl [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
@[ simp ]
  theorem
    sigma_congr_right_refl
    { α } { β : α → Sort _ } : sigma_congr_right fun a => Equivₓ.refl β a = Equivₓ.refl Σ a , β a
    := Equivₓ.sigma_congr_right_refl
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `sigma_congr_left [])
  (Command.optDeclSig
   [(Term.implicitBinder "{" [`α₁ `α₂] [] "}")
    (Term.implicitBinder "{" [`β] [":" (Term.arrow `α₂ "→" (Term.sort "Sort" [(Level.hole "_")]))] "}")
    (Term.explicitBinder "(" [`e] [":" (Data.Equiv.Basic.«term_≃_» `α₁ " ≃ " `α₂)] [] ")")]
   [(Term.typeSpec
     ":"
     (Data.Equiv.Basic.«term_≃_»
      (Init.Data.Sigma.Basic.«termΣ_,_»
   ...
   (Term.anonymousCtor
    ...
    [(Term.fun
      ...
      (Term.basicFun
       ...
       (Term.anonymousCtor
        "⟨"
        [(Term.app `e [(Term.proj `a "." (fieldIdx "1"))]) "," (Term.proj `a "." (fieldIdx "2"))]
        "⟩")))
     ","
     (Term.fun
      "fun"
      (Term.basicFun
       ...
       (Term.anonymousCtor
        "⟨"
        [(Term.app `e.symm [(Term.proj `a "." (fieldIdx "1"))])
         ","
         (Term.app
          (Term.explicit "@" `Eq.ndrec)
          [`β
           (Term.proj `a "." (fieldIdx "2"))
           (Term.proj (Term.app `e.right_inv [(Term.proj `a "." (fieldIdx "1"))]) "." `symm)])]
        "⟩")))
     ","
     (Term.fun
      "fun"
      (Term.basicFun
       ...
       (Term.match
        "match"
        []
        [(Term.matchDiscr [] (Term.app `e.symm [(Term.app `e [`a])]))
         ","
         (Term.matchDiscr [] (Term.app `e.left_inv [`a]))]
        []
        "with"
        (Term.matchAlts [(Term.matchAlt "|" [(Term.hole "_") "," `rfl] "=>" `rfl)]))))
     ","
     (Term.fun
      "fun"
      (Term.basicFun
       ...
       (Term.match
        "match"
        []
        [(Term.matchDiscr [] (Term.app `e [(Term.app `e.symm [`a])])) "," (Term.matchDiscr [] (Term.hole "_"))]
        []
        "with"
        (Term.matchAlts [(Term.matchAlt "|" [(Term.hole "_") "," `rfl] "=>" `rfl)]))))]
    "⟩")
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `e.symm [`a]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `e
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
  ...
  (Term.fun
   ...
   (Term.basicFun
    ...
    (Term.match
     "match"
     []
     [(Term.matchDiscr [] (Term.app `e.symm [(Term.app `e [`a])])) "," (Term.matchDiscr [] (Term.app `e.left_inv [`a]))]
     []
     "with"
     (Term.matchAlts [(Term.matchAlt "|" [(Term.hole "_") "," `rfl] "=>" `rfl)]))))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `e [`a]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `e.symm
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `e.right_inv [(Term.proj `a "." (fieldIdx "1"))])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.basicFun.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.anonymousCtor "⟨" [(Term.app `e [(Term.proj `a "." (fieldIdx "1"))]) "," (Term.proj `a "." (fieldIdx "2"))] "⟩")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.anonymousCtor.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `e [(Term.proj `a "." (fieldIdx "1"))])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.def', expected 'Lean.Parser.Command.structure.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.def', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
/-- An equivalence `f : α₁ ≃ α₂` generates an equivalence between `Σ a, β (f a)` and `Σ a, β a`. -/ @[ simps apply ]
  def
    sigma_congr_left
    { α₁ α₂ } { β : α₂ → Sort _ } ( e : α₁ ≃ α₂ ) : Σ a : α₁ , β e a ≃ Σ a : α₂ , β a
    :=
      ⟨
        fun a => ⟨ e a . 1 , a . 2 ⟩
          ,
          fun a => ⟨ e.symm a . 1 , @ Eq.ndrec β a . 2 e.right_inv a . 1 . symm ⟩
          ,
          fun ⟨ a , b ⟩ => match e.symm e a , e.left_inv a with | _ , rfl => rfl
          ,
          fun ⟨ a , b ⟩ => match e e.symm a , _ with | _ , rfl => rfl
        ⟩

/- failed to parenthesize: parenthesize: uncaught backtrack exception
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " Transporting a sigma type through an equivalence of the base -/")]
  []
  []
  []
  []
 ...
 (Command.def
  ...
  (Command.optDeclSig
   [(Term.implicitBinder "{" [`α₁ `α₂] [] "}")
    (Term.implicitBinder "{" [`β] [":" (Term.arrow `α₁ "→" (Term.sort "Sort" [(Level.hole "_")]))] "}")
    (Term.explicitBinder "(" [`f] [":" (Data.Equiv.Basic.«term_≃_» `α₁ " ≃ " `α₂)] [] ")")]
   [(Term.typeSpec
     ":"
     (Data.Equiv.Basic.«term_≃_»
      (Init.Data.Sigma.Basic.«termΣ_,_»
      ...
      (Init.Data.Sigma.Basic.«termΣ_,_»
       ...
       (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `a)] [":" `α₂]))
       ", "
       (Term.app `β [(Term.app `f.symm [`a])]))))])
  (Command.declValSimple ":=" (Term.proj (Term.app `sigma_congr_left [`f.symm]) "." `symm) [])
  []
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Term.app `sigma_congr_left [`f.symm]) "." `symm)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `sigma_congr_left [`f.symm])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `sigma_congr_left [`f.symm]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.optDeclSig', expected 'Lean.Parser.Command.optDeclSig.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'optional.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `f.symm [`a]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `β
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " `sigma` type with a constant fiber is equivalent to the product. -/")]
  [(Term.attributes "@[" [(Term.attrInstance (Term.attrKind []) (Attr.simps "simps" [] [`apply `symmApply]))] "]")]
  []
  []
  []
 ...
 (Command.def
  "def"
  (Command.declId `sigma_equiv_prod [])
  (Command.optDeclSig
   [(Term.explicitBinder "(" [`α `β] [":" (Term.type "Type" [(Level.hole "_")])] [] ")")]
   [(Term.typeSpec
     ":"
     (Data.Equiv.Basic.«term_≃_»
      (Init.Data.Sigma.Basic.«termΣ_,_»
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.def', expected 'Lean.Parser.Command.structure.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.def', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
/-- `sigma` type with a constant fiber is equivalent to the product. -/ @[ simps apply symmApply ]
  def
    sigma_equiv_prod
    ( α β : Type _ ) : Σ _ : α , β ≃ α × β
    := ⟨ fun a => ⟨ a . 1 , a . 2 ⟩ , fun a => ⟨ a . 1 , a . 2 ⟩ , fun ⟨ a , b ⟩ => rfl , fun ⟨ a , b ⟩ => rfl ⟩
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " Dependent product of types is associative up to an equivalence. -/")]
  []
  []
  []
  []
    ...
    (Term.explicitBinder
     ...
     [":"
      (Term.forall
       ...
       ","
       (Term.arrow (Term.app `β [`a]) "→" (Term.type "Type" [(Level.hole "_")])))]
     []
     ")")]
   [(Term.typeSpec
     ":"
        ...
        (Lean.unbracketedExplicitBinders
         ...
         [":"
          (Init.Data.Sigma.Basic.«termΣ_,_»
           ...
           (Term.app `β [`a]))]))
       ", "
       (Term.app `γ [(Term.proj `ab "." (fieldIdx "1")) (Term.proj `ab "." (fieldIdx "2"))]))
      " ≃ "
      (Init.Data.Sigma.Basic.«termΣ_,_»
       "Σ"
       (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `a)] [":" `α]))
       ...
       (Init.Data.Sigma.Basic.«termΣ_,_»
        "Σ"
        (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `b)] [":" (Term.app `β [`a])]))
        ", "
        (Term.app `γ [`a `b])))))])
  (Command.declValSimple
   ":="
    ...
    [(group
        ...
        (Term.basicFun
         ...
         (Term.anonymousCtor
          ...
          [(Term.proj (Term.proj `x "." (fieldIdx "1")) "." (fieldIdx "1"))
           ...
           (Term.anonymousCtor
            "⟨"
            [(Term.proj (Term.proj `x "." (fieldIdx "1")) "." (fieldIdx "2")) "," (Term.proj `x "." (fieldIdx "2"))]
            "⟩")]
          "⟩"))))
      [","])
     (group
       ...
       (Term.fun
        ...
        (Term.basicFun
         ...
         (Term.anonymousCtor
          ...
          [(Term.anonymousCtor
            "⟨"
            [(Term.proj `x "." (fieldIdx "1")) "," (Term.proj (Term.proj `x "." (fieldIdx "2")) "." (fieldIdx "1"))]
            "⟩")
           ","
     ...
     (group
      (Term.structInstField
       ...
       (Term.fun
        "fun"
        (Term.basicFun [(Term.anonymousCtor "⟨" [(Term.anonymousCtor "⟨" [`a "," `b] "⟩") "," `c] "⟩")] "=>" `rfl)))
      [","])
     (group
      (Term.structInstField
       (Term.structInstLVal `right_inv [])
       ...
       (Term.fun
        "fun"
        (Term.basicFun [(Term.anonymousCtor "⟨" [`a "," (Term.anonymousCtor "⟨" [`b "," `c] "⟩")] "⟩")] "=>" `rfl)))
      [])]
    (Term.optEllipsis [])
    []
    "}")
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.simpleBinder'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.anonymousCtor "⟨" [(Term.anonymousCtor "⟨" [`a "," `b] "⟩") "," `c] "⟩")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.anonymousCtor.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
/-- Dependent product of types is associative up to an equivalence. -/
  def
    sigma_assoc
    { α : Type _ } { β : α → Type _ } ( γ : ∀ a : α , β a → Type _ )
...
theorem prod_congr_refl_right (e : β₁ ≃ β₂) : prod_congr e (Equivₓ.refl α₁) = prod_congr_left fun _ => e := by
  ext ⟨a, b⟩ : 1
  simp
...
theorem prod_congr_refl_left (e : β₁ ≃ β₂) : prod_congr (Equivₓ.refl α₁) e = prod_congr_right fun _ => e := by
  ext ⟨a, b⟩ : 1
  simp

@[simp]
theorem prod_congr_left_trans_prod_comm :
    (prod_congr_left e).trans (prod_comm _ _) = (prod_comm _ _).trans (prod_congr_right e) := by
  ext ⟨a, b⟩ : 1
  simp

@[simp]
theorem prod_congr_right_trans_prod_comm :
    (prod_congr_right e).trans (prod_comm _ _) = (prod_comm _ _).trans (prod_congr_left e) := by
  ext ⟨a, b⟩ : 1
  simp

theorem sigma_congr_right_sigma_equiv_prod :
    (sigma_congr_right e).trans (sigma_equiv_prod α₁ β₂) = (sigma_equiv_prod α₁ β₁).trans (prod_congr_right e) := by
  ext ⟨a, b⟩ : 1
  simp
...
@[simp]
theorem fst_prod_extend_right (ab : α₁ × β₁) : (prod_extend_right a e ab).fst = ab.fst := by
 ...
 (Command.def
  ...
  (Command.optDeclSig
   [(Term.implicitBinder "{" [`ι] [":" (Term.type "Type" [(Level.hole "_")])] "}")
    (Term.explicitBinder "(" [`α] [":" (Term.arrow `ι "→" (Term.type "Type" [(Level.hole "_")]))] [] ")")
    (Term.explicitBinder "(" [`β] [":" (Term.type "Type" [(Level.hole "_")])] [] ")")]
   [(Term.typeSpec
     ":"
     (Data.Equiv.Basic.«term_≃_»
      («term_×_»
     ...
     (Term.fun
      ...
      (Term.basicFun
       ...
       (Term.paren
        ...
        [(Term.anonymousCtor
          "⟨"
          [(Term.proj `p "." (fieldIdx "1")) "," (Term.proj (Term.proj `p "." (fieldIdx "2")) "." (fieldIdx "1"))]
          "⟩")
         [(Term.tupleTail "," [(Term.proj (Term.proj `p "." (fieldIdx "2")) "." (fieldIdx "2"))])]]
        ")")))
     ","
     (Term.fun
      "fun"
...
/--
  ...
  def
    sigma_prod_distrib
    { ι : Type _ } ( α : ι → Type _ ) ( β : Type _ ) : Σ i , α i × β ≃ Σ i , α i × β
    :=
      ⟨
        fun p => ⟨ p . 1 . 1 , ( p . 1 . 2 , p . 2 ) ⟩
          ...
          ,
          fun p => by rcases p with ⟨ ⟨ _ , _ ⟩ , _ ⟩ rfl
          ,
          fun p => by rcases p with ⟨ _ , ⟨ _ , _ ⟩ ⟩ rfl
        ⟩
...
def bool_prod_equiv_sum (α : Type u) : Bool × α ≃ Sum α α :=
  calc Bool × α ≃ Sum Unit Unit × α := prod_congr bool_equiv_punit_sum_punit (Equivₓ.refl _)
...
def int_equiv_nat_sum_nat : ℤ ≃ Sum ℕ ℕ := by
  refine' ⟨_, _, _, _⟩ <;>
    intro z <;>
      first |
...
def unique_congr (e : α ≃ β) : Unique α ≃ Unique β :=
  { toFun := fun h => @Equivₓ.unique _ _ h e.symm, invFun := fun h => @Equivₓ.unique _ _ h e,
...
def subtype_equiv_prop {α : Type _} {p q : α → Prop} (h : p = q) : Subtype p ≃ Subtype q :=
  subtype_equiv (Equivₓ.refl α) fun a => h ▸ Iff.rfl
...
theorem subtype_subtype_equiv_subtype_exists_apply {α : Type u} (p : α → Prop) (q : Subtype p → Prop) a :
    (subtype_subtype_equiv_subtype_exists p q a : α) = a := by
  cases a
  cases a_val
  rfl
...
theorem subtype_subtype_equiv_subtype_inter_apply {α : Type u} (p q : α → Prop) a :
    (subtype_subtype_equiv_subtype_inter p q a : α) = a := by
  cases a
  cases a_val
  rfl
...
theorem subtype_subtype_equiv_subtype_apply {α : Type u} {p q : α → Prop} (h : ∀ x, q x → p x)
    (a : { x : Subtype p // q x.1 }) : (subtype_subtype_equiv_subtype h a : α) = a := by
  cases a
  cases a_val
  rfl
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " A subtype of a sigma-type is a sigma-type over a subtype. -/")]
  []
  []
  []
  []
 ...
 (Command.def
  "def"
  (Command.declId `subtype_sigma_equiv [])
  (Command.optDeclSig
   [(Term.implicitBinder "{" [`α] [":" (Term.type "Type" [`u])] "}")
    (Term.explicitBinder "(" [`p] [":" (Term.arrow `α "→" (Term.type "Type" [`v]))] [] ")")
    (Term.explicitBinder "(" [`q] [":" (Term.arrow `α "→" (Term.prop "Prop"))] [] ")")]
   [(Term.typeSpec
     ":"
     (Data.Equiv.Basic.«term_≃_»
      («term{__:_//_}» "{" `y [":" (Term.app `Sigma [`p])] "//" (Term.app `q [(Term.proj `y "." (fieldIdx "1"))]) "}")
      " ≃ "
      (Init.Data.Sigma.Basic.«termΣ_,_»
       "Σ"
       (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `x)] [":" (Term.app `Subtype [`q])]))
       ", "
       (Term.app `p [(Term.proj `x "." (fieldIdx "1"))]))))])
  (Command.declValSimple
   ":="
   (Term.anonymousCtor
    "⟨"
    [(Term.fun
      ...
      (Term.basicFun
       ...
       (Term.anonymousCtor
        ...
        [(Term.anonymousCtor
          "⟨"
          [(Term.proj (Term.proj `x "." (fieldIdx "1")) "." (fieldIdx "1")) "," (Term.proj `x "." (fieldIdx "2"))]
          "⟩")
         ","
         (Term.proj (Term.proj `x "." (fieldIdx "1")) "." (fieldIdx "2"))]
        "⟩")))
     ...
     (Term.fun
      "fun"
      (Term.basicFun [(Term.anonymousCtor "⟨" [(Term.anonymousCtor "⟨" [`x "," `h] "⟩") "," `y] "⟩")] "=>" `rfl))
     ","
     (Term.fun
      "fun"
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.simpleBinder'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.anonymousCtor "⟨" [(Term.anonymousCtor "⟨" [`x "," `h] "⟩") "," `y] "⟩")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.anonymousCtor.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
/-- A subtype of a sigma-type is a sigma-type over a subtype. -/
  def
    subtype_sigma_equiv
    { α : Type u } ( p : α → Type v ) ( q : α → Prop ) : { y : Sigma p // q y . 1 } ≃ Σ x : Subtype q , p x . 1
    :=
      ⟨
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `sigma_subtype_equiv_of_subset [])
  (Command.optDeclSig
   [(Term.implicitBinder "{" [`α] [":" (Term.type "Type" [`u])] "}")
    (Term.explicitBinder "(" [`p] [":" (Term.arrow `α "→" (Term.type "Type" [`v]))] [] ")")
    (Term.explicitBinder "(" [`q] [":" (Term.arrow `α "→" (Term.prop "Prop"))] [] ")")
    (Term.explicitBinder
     "("
     [`h]
     [":" (Term.forall "∀" [(Term.simpleBinder [`x] [])] "," (Term.arrow (Term.app `p [`x]) "→" (Term.app `q [`x])))]
     []
     ")")]
   [(Term.typeSpec
     ":"
  ...
  (Command.declValSimple
   ":="
   («term_$__»
    (Term.proj (Term.proj (Term.app `subtype_sigma_equiv [`p `q]) "." `symm) "." `trans)
    "$"
    («term_$__»
     `subtype_univ_equiv
     "$"
     (Term.fun
      ...
      (Term.basicFun
       [(Term.simpleBinder [`x] [])]
       "=>"
       (Term.app `h [(Term.proj `x "." (fieldIdx "1")) (Term.proj `x "." (fieldIdx "2"))])))))
   [])
  []
  []
  []))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.proj (Term.app `subtype_sigma_equiv [`p `q]) "." `symm)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `subtype_sigma_equiv [`p `q])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `subtype_sigma_equiv [`p `q]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (some 10, term)
...
/--
    ...
    if the fiber is empty outside of the subset -/
  def
    sigma_subtype_equiv_of_subset
    { α : Type u } ( p : α → Type v ) ( q : α → Prop ) ( h : ∀ x , p x → q x ) : Σ x : Subtype q , p x ≃ Σ x : α , p x
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `sigma_subtype_preimage_equiv [])
  (Command.optDeclSig
   [(Term.implicitBinder "{" [`α] [":" (Term.type "Type" [`u])] "}")
    ...
    (Term.explicitBinder
     "("
     [`h]
     [":" (Term.forall "∀" [(Term.simpleBinder [`x] [])] "," (Term.app `p [(Term.app `f [`x])]))]
     []
     ")")]
   [(Term.typeSpec
     ":"
     (Data.Equiv.Basic.«term_≃_»
      (Init.Data.Sigma.Basic.«termΣ_,_»
       "Σ"
       (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `y)] [":" (Term.app `Subtype [`p])]))
       ", "
       («term{__:_//_}» "{" `x [":" `α] "//" («term_=_» (Term.app `f [`x]) "=" `y) "}"))
      " ≃ "
      `α))])
  (Command.declValSimple
   ":="
      ...
      (Term.app
       ...
       [(Term.hole "_")
        ...
        (Term.fun
         "fun"
         (Term.basicFun
          [(Term.simpleBinder [`y] []) (Term.anonymousCtor "⟨" [`x "," `h'] "⟩")]
          "=>"
          (Term.subst `h' "▸" [(Term.app `h [`x])])))]))
     (calcStep (Data.Equiv.Basic.«term_≃_» (Term.hole "_") " ≃ " `α) ":=" (Term.app `sigma_preimage_equiv [`f]))])
   [])
  []
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `sigma_preimage_equiv [`f])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Data.Equiv.Basic.«term_≃_» (Term.hole "_") " ≃ " `α)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Data.Equiv.Basic.«term_≃_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `α
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
/--
    ...
    `Σ y : {y // p y}, {x // f x = y}` is equivalent to `α`. -/
  def
    sigma_subtype_preimage_equiv
    { α : Type u } { β : Type v } ( f : α → β ) ( p : β → Prop ) ( h : ∀ x , p f x )
      : Σ y : Subtype p , { x : α // f x = y } ≃ α
    :=
      calc
        _ ≃ Σ y : β , { x : α // f x = y } := sigma_subtype_equiv_of_subset _ p fun y ⟨ x , h' ⟩ => h' ▸ h x
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `sigma_subtype_preimage_equiv_subtype [])
  (Command.optDeclSig
   [(Term.implicitBinder "{" [`α] [":" (Term.type "Type" [`u])] "}")
    (Term.implicitBinder "{" [`β] [":" (Term.type "Type" [`v])] "}")
    (Term.explicitBinder "(" [`f] [":" (Term.arrow `α "→" `β)] [] ")")
   ...
   [(Term.typeSpec
     ...
     (Data.Equiv.Basic.«term_≃_»
      (Init.Data.Sigma.Basic.«termΣ_,_»
       "Σ"
       (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `y)] [":" (Term.app `Subtype [`q])]))
       ", "
       («term{__:_//_}» "{" `x [":" `α] "//" («term_=_» (Term.app `f [`x]) "=" `y) "}"))
      " ≃ "
      (Term.app `Subtype [`p])))])
   ...
   (calc
    ...
    [(calcStep
        ...
        («term{__:_//_}»
         ...
         («term_=_»
          (Term.app
           `Subtype.mk
           [(Term.app `f [`x])
            (Term.app (Term.proj (Term.app `h [`x]) "." (fieldIdx "1")) [(Term.proj `x "." (fieldIdx "2"))])])
          "="
          `y)
         "}")))
      ":="
      (Term.byTactic
       ...
       (Tactic.tacticSeq
        (Tactic.tacticSeq1Indented
         [(group (Tactic.apply "apply" `sigma_congr_right) [])
          ...
          (group
           (Tactic.refine'
            "refine'"
            (Term.app
             (Term.proj (Term.app `subtype_subtype_equiv_subtype_exists [(Term.hole "_") (Term.hole "_")]) "." `trans)
             [(Term.app `subtype_equiv_right [(Term.hole "_")])]))
           [])
          ...
          (group
           (Tactic.exact
            ...
            (Term.anonymousCtor
             ...
             [(Term.fun
               "fun"
               (Term.basicFun
                [(Term.anonymousCtor "⟨" [`hp "," `h'] "⟩")]
                "=>"
                (Term.app `congr_argₓ [`Subtype.val `h'])))
              ","
              (Term.fun
               "fun"
               (Term.basicFun
                ...
                (Term.anonymousCtor
                 ...
                 [(Term.app
                   ...
                   [(Term.subst `h'.symm "▸" [(Term.proj `y "." (fieldIdx "2"))])])
                  ","
           ...
           [])]))))
     (calcStep
      (Data.Equiv.Basic.«term_≃_» (Term.hole "_") " ≃ " (Term.app `Subtype [`p]))
      ":="
      (Term.app
       `sigma_preimage_equiv
       [(Term.fun
         ...
         (Term.basicFun
          ...
          (Term.paren
           ...
           [(Term.anonymousCtor
             "⟨"
             [(Term.app `f [`x]) "," (Term.app (Term.proj (Term.app `h [`x]) "." (fieldIdx "1")) [`x.property])]
             "⟩")
            [(Term.typeAscription ":" (Term.app `Subtype [`q]))]]
           ")")))]))])
   [])
  []
  []
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.proj (Term.app `h [`x]) "." (fieldIdx "1")) [`x.property])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `h [`x]) "." (fieldIdx "1"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `h [`x])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
      ...
      (group
       (Tactic.exact
        ...
        (Term.anonymousCtor
         ...
         [(Term.fun
           "fun"
           (Term.basicFun [(Term.anonymousCtor "⟨" [`hp "," `h'] "⟩")] "=>" (Term.app `congr_argₓ [`Subtype.val `h'])))
          ","
          (Term.fun
           "fun"
           (Term.basicFun
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `subtype_equiv_right [(Term.hole "_")]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `subtype_subtype_equiv_subtype_exists [(Term.hole "_") (Term.hole "_")]) "." `trans)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `subtype_subtype_equiv_subtype_exists [(Term.hole "_") (Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (some 1023, term)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `subtype_subtype_equiv_subtype_exists
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.apply "apply" `sigma_congr_right)
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app
   (Term.proj (Term.paren "(" [(Term.app `h [`x]) []] ")") "." (fieldIdx "1"))
   [(Term.proj `x "." (fieldIdx "2"))])
  []]
 ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
...
/--
    ...
    to `{x // p x}`. -/
  def
    sigma_subtype_preimage_equiv_subtype
    { α : Type u } { β : Type v } ( f : α → β ) { p : α → Prop } { q : β → Prop } ( h : ∀ x , p x ↔ q f x )
      : Σ y : Subtype q , { x : α // f x = y } ≃ Subtype p
    :=
      calc
        Σ y : Subtype q , { x : α // f x = y } ≃ Σ y : Subtype q , { x : Subtype p // Subtype.mk f x h x . 1 x . 2 = y }
            :=
            by
              apply sigma_congr_right
                ...
                exact
                  ⟨
                    fun ⟨ hp , h' ⟩ => congr_argₓ Subtype.val h' , fun h' => ⟨ h x . 2 h'.symm ▸ y . 2 , Subtype.eq h' ⟩
                    ⟩
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `sigma_option_equiv_of_some [])
  (Command.optDeclSig
   [(Term.implicitBinder "{" [`α] [":" (Term.type "Type" [`u])] "}")
    (Term.explicitBinder "(" [`p] [":" (Term.arrow (Term.app `Option [`α]) "→" (Term.type "Type" [`v]))] [] ")")
    (Term.explicitBinder "(" [`h] [":" (Term.arrow (Term.app `p [`none]) "→" `False)] [] ")")]
   [(Term.typeSpec
     ":"
     (Data.Equiv.Basic.«term_≃_»
      (Init.Data.Sigma.Basic.«termΣ_,_»
       "Σ"
       (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `x)] [":" (Term.app `Option [`α])]))
       ", "
       (Term.app `p [`x]))
      " ≃ "
      (Init.Data.Sigma.Basic.«termΣ_,_»
        ...
        (Tactic.tacticHave_
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           ...
           [(Term.typeSpec
             ":"
             (Term.forall "∀" [(Term.simpleBinder [`x] [])] "," (Term.arrow (Term.app `p [`x]) "→" `x.is_some)))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
                 ...
                 (Tactic.tacticSeq
                  (Tactic.tacticSeq1Indented
                   [(group (Tactic.intro "intro" [`n]) [])
                    ...
                    (group (Tactic.exact "exact" (Term.app `h [`n])) [])])))
                [])
               (group
                (Tactic.«tactic·._»
                 "·"
                 (Tactic.tacticSeq
                  (Tactic.tacticSeq1Indented
                   [(group (Tactic.intro "intro" [`s]) []) (group (Tactic.exact "exact" `rfl) [])])))
                [])]))))))
        [])
       (group
        (Tactic.exact
         ...
         (Term.app
          (Term.proj
           (Term.proj (Term.app `sigma_subtype_equiv_of_subset [(Term.hole "_") (Term.hole "_") `h']) "." `symm)
           "."
           `trans)
          [(Term.app `sigma_congr_left' [(Term.app `option_is_some_equiv [`α])])]))
        [])])))
   [])
  []
  []
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `option_is_some_equiv [`α])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `option_is_some_equiv [`α]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `sigma_congr_left'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `sigma_congr_left' [(Term.paren "(" [(Term.app `option_is_some_equiv [`α]) []] ")")]) []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj
   (Term.proj (Term.app `sigma_subtype_equiv_of_subset [(Term.hole "_") (Term.hole "_") `h']) "." `symm)
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `sigma_subtype_equiv_of_subset [(Term.hole "_") (Term.hole "_") `h'])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
     ...
     [(group (Tactic.intro "intro" [`x]) [])
      ...
      (group
       (Tactic.«tactic·._»
        "·"
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented [(group (Tactic.intro "intro" [`s]) []) (group (Tactic.exact "exact" `rfl) [])])))
       [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.byTactic', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.byTactic', expected 'Lean.Parser.Term.byTactic.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq', expected 'Lean.Parser.Tactic.tacticSeq.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `h [`n]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `h [`n])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.forall', expected 'Lean.Parser.Term.forall.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.arrow (Term.app `p [`x]) "→" `x.is_some)
...
/--
    ...
    if the fiber is empty at none. -/
  def
    sigma_option_equiv_of_some
    { α : Type u } ( p : Option α → Type v ) ( h : p none → False ) : Σ x : Option α , p x ≃ Σ x : α , p some x
    :=
      by
        have h' : ∀ x , p x → x.is_some := by intro x cases x · intro n exfalso exact h n · intro s exact rfl
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `pi_equiv_subtype_sigma [])
  (Command.optDeclSig
   [(Term.explicitBinder "(" [`ι] [":" (Term.type "Type" [(Level.hole "_")])] [] ")")
    (Term.explicitBinder "(" [`π] [":" (Term.arrow `ι "→" (Term.type "Type" [(Level.hole "_")]))] [] ")")]
   [(Term.typeSpec
     ":"
     (Data.Equiv.Basic.«term_≃_»
      ...
      («term{__:_//_}»
       ...
       (Term.forall
        ...
        [(Term.simpleBinder [`i] [])]
        ","
        («term_=_» (Term.proj (Term.app `f [`i]) "." (fieldIdx "1")) "=" `i))
       "}")))])
  (Command.declValSimple
   ":="
   (Term.anonymousCtor
    ...
    [(Term.fun
      ...
      (Term.basicFun
       ...
       (Term.anonymousCtor
        ...
        [(Term.fun
          "fun"
          (Term.basicFun [(Term.simpleBinder [`i] [])] "=>" (Term.anonymousCtor "⟨" [`i "," (Term.app `f [`i])] "⟩")))
         ","
         ...
         (Tactic.tacticSeq1Indented
          [(group
            (Tactic.rwSeq
             "rw"
             []
             (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] (Term.app (Term.proj `f "." (fieldIdx "2")) [`i]))] "]")
             [])
            [])
           (group
            (Tactic.exact "exact" (Term.proj (Term.app (Term.proj `f "." (fieldIdx "1")) [`i]) "." (fieldIdx "2")))
            [])])))))
     ","
     (Term.fun
      "fun"
      (Term.basicFun
       [(Term.simpleBinder [`f] [])]
       "=>"
       («term_$__» `funext "$" (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`i] [])] "=>" `rfl)))))
     ","
     (Term.fun
      "fun"
      (Term.basicFun
        ...
        («term_$__»
         ...
         (Term.fun
          ...
          (Term.basicFun
           ...
           "=>"
           («term_$__»
            (Term.app `Sigma.eq [(Term.proj (Term.app `hf [`i]) "." `symm)])
            "$"
            («term_$__»
             `eq_of_heq
             "$"
             («term_$__»
              (Term.app `rec_heq_of_heq [(Term.hole "_")])
              "$"
              («term_$__»
               (Term.app `rec_heq_of_heq [(Term.hole "_")])
               "$"
               (Term.app `HEq.refl [(Term.hole "_")])))))))))))]
    "⟩")
   [])
  []
  []
        ...
        («term_$__»
         ...
         («term_$__»
          ...
          («term_$__»
           (Term.app `rec_heq_of_heq [(Term.hole "_")])
           "$"
           («term_$__» (Term.app `rec_heq_of_heq [(Term.hole "_")]) "$" (Term.app `HEq.refl [(Term.hole "_")])))))))))))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.fun.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.basicFun.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Term.app (Term.proj `f "." (fieldIdx "1")) [`i]) "." (fieldIdx "2"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app (Term.proj `f "." (fieldIdx "1")) [`i])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app (Term.proj `f "." (fieldIdx "1")) [`i]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.proj `f "." (fieldIdx "2")) [`i])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.basicFun.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.anonymousCtor "⟨" [`i "," (Term.app `f [`i])] "⟩")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.anonymousCtor.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize] ...precedences are 51 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 50, term))
  (Term.proj (Term.app `f [`i]) "." (fieldIdx "1"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `f [`i])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
/--
    ...
    `sigma` type such that for all `i` we have `(f i).fst = i`. -/
  def
    pi_equiv_subtype_sigma
    ( ι : Type _ ) ( π : ι → Type _ ) : ∀ i , π i ≃ { f : ι → Σ i , π i // ∀ i , f i . 1 = i }
    :=
      ⟨
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " A subtype of a `prod` is equivalent to a sigma type whose fibers are subtypes. -/")]
  []
  []
  []
  []
 ...
 (Command.def
  "def"
  (Command.declId `subtype_prod_equiv_sigma_subtype [])
  (Command.optDeclSig
   [(Term.implicitBinder "{" [`α `β] [":" (Term.type "Type" [(Level.hole "_")])] "}")
    (Term.explicitBinder "(" [`p] [":" (Term.arrow `α "→" (Term.arrow `β "→" (Term.prop "Prop")))] [] ")")]
   [(Term.typeSpec
     ":"
     (Data.Equiv.Basic.«term_≃_»
      («term{__:_//_}»
      ...
      (Init.Data.Sigma.Basic.«termΣ_,_»
       ...
       (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `a)] []))
       ", "
       («term{__:_//_}» "{" `b [":" `β] "//" (Term.app `p [`a `b]) "}"))))])
  (Command.declValSimple
   ":="
   (Term.structInst
    "{"
    ...
    [(group
       ...
       (Term.fun
        ...
        (Term.basicFun
         ...
         (Term.anonymousCtor
          ...
          [(Term.anonymousCtor "⟨" [(Term.proj `x "." (fieldIdx "1")) "," (Term.proj `x "." (fieldIdx "2"))] "⟩")
           ","
           (Term.proj (Term.proj `x "." (fieldIdx "2")) "." `Prop)]
          "⟩"))))
      [","])
     (group
      (Term.structInstField
     ...
     (group
      (Term.structInstField
       (Term.structInstLVal `right_inv [])
       ":="
       (Term.fun "fun" (Term.basicFun [(Term.anonymousCtor "⟨" [`a "," `b "," `pab] "⟩")] "=>" `rfl)))
      [])]
    (Term.optEllipsis [])
    []
    "}")
...
/-- A subtype of a `prod` is equivalent to a sigma type whose fibers are subtypes. -/
  def
    ...
    { α β : Type _ } ( p : α → β → Prop ) : { x : α × β // p x . 1 x . 2 } ≃ Σ a , { b : β // p a b }
    :=
      {
...
def perm.extend_domain : perm β' :=
  (perm_congr f e).subtypeCongr (Equivₓ.refl _)

@[simp]
theorem perm.extend_domain_apply_image (a : α') : e.extend_domain f (f a) = f (e a) := by
...
@[simp]
theorem perm.extend_domain_refl : perm.extend_domain (Equivₓ.refl _) f = Equivₓ.refl _ := by
  simp [perm.extend_domain]
...
theorem perm.extend_domain_trans (e e' : perm α') :
    (e.extend_domain f).trans (e'.extend_domain f) = perm.extend_domain (e.trans e') f := by
...
theorem swap_core_self (r a : α) : swap_core a a r = r := by
  unfold swap_core
  split_ifs <;> cc

theorem swap_core_swap_core (r a b : α) : swap_core a b (swap_core a b r) = r := by
  unfold swap_core
  split_ifs <;> cc

theorem swap_core_comm (r a b : α) : swap_core a b r = swap_core b a r := by
  unfold swap_core
  split_ifs <;> cc
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `swap_apply_of_ne_of_ne [])
  (Command.declSig
   [(Term.implicitBinder "{" [`a `b `x] [":" `α] "}")]
   (Term.typeSpec
    ":"
    (Term.arrow
     («term_≠_» `x "≠" `a)
     "→"
     (Term.arrow («term_≠_» `x "≠" `b) "→" («term_=_» (Term.app `swap [`a `b `x]) "=" `x)))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
      ...
      [(group
        (Tactic.simp
         ...
         ["("
          ...
          ")"]
         []
         ["[" [(Tactic.simpLemma [] [] `swap_apply_def)] "]"]
         [])
        [])])))
   [])
  []
...
theorem
  ...
  := by simp ( config := { contextual := Bool.true._@._internal._hyg.0 } ) [ swap_apply_def ]
...
@[simp]
theorem set_value_eq (f : α ≃ β) (a : α) (b : β) : set_value f a b a = b := by
  dsimp [set_value]
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  ...
  (Command.declSig
   [(Term.implicitBinder "{" [`p] [":" (Term.arrow `α "→" (Term.prop "Prop"))] "}")
    (Term.implicitBinder "{" [`q] [":" (Term.arrow `β "→" (Term.prop "Prop"))] "}")
    (Term.explicitBinder "(" [`f] [":" (Data.Equiv.Basic.«term_≃_» `α " ≃ " `β)] [] ")")
    (Term.explicitBinder
     "("
     [`h]
     [":"
            ...
            (group
             (Tactic.exact
              ...
              (Term.anonymousCtor
               ...
               [(Term.app `f [`a])
                ","
                (Term.app (Term.proj `h "." (fieldIdx "1")) [`ha₁])
                ","
                (Term.fun
                 "fun"
                 (Term.basicFun
                  ...
                  "=>"
                  (Term.app
                   (Term.proj `f.symm_apply_eq "." (fieldIdx "1"))
                   [(Term.app
                     `ha₂
                     [(Term.app `f.symm [`b])
                      (Term.app
                       ...
                       [(Term.byTactic
                         ...
                         (Tactic.tacticSeq
                          (Tactic.tacticSeq1Indented
                           [(group (Tactic.simpa "simpa" [] [] [] [] ["using" `hb]) [])])))])])])))]
               "⟩"))
             [])])))
        [])
       (group
               ...
               [(Term.app `f.symm [`b])
                ...
                (Term.fun
                 ...
                 (Term.basicFun
                  ...
                  "=>"
                  (Term.app
                   (Term.proj (Term.app `eq_symm_apply [`f]) "." (fieldIdx "2"))
                   [(Term.app `hb₂ [(Term.hole "_") (Term.app (Term.proj `h "." (fieldIdx "1")) [`hy])])])))]
               "⟩"))
             [])])))
        [])])))
   [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.proj `h "." (fieldIdx "1")) [`hy])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app (Term.proj `h "." (fieldIdx "1")) [`hy]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `hb₂ [(Term.hole "_") (Term.paren "(" [(Term.app (Term.proj `h "." (fieldIdx "1")) [`hy]) []] ")")]) []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `eq_symm_apply [`f]) "." (fieldIdx "2"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `eq_symm_apply [`f])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `eq_symm_apply [`f]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.simpleBinder', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.simpleBinder', expected 'Lean.Parser.Term.strictImplicitBinder.antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `exists_unique_congr_left' [])
  (Command.declSig
   [(Term.implicitBinder "{" [`p] [":" (Term.arrow `α "→" (Term.prop "Prop"))] "}")
    (Term.explicitBinder "(" [`f] [":" (Data.Equiv.Basic.«term_≃_» `α " ≃ " `β)] [] ")")]
   (Term.typeSpec
    ...
    («term_↔_»
     ...
     (Init.Logic.«term∃!_,_»
      ...
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `y)] []))
      ", "
      (Term.app `p [(Term.app `f.symm [`y])])))))
  (Command.declValSimple
   ":="
   (Term.app
    `Equivₓ.exists_unique_congr
    [`f
     (Term.fun
      "fun"
      (Term.basicFun
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `f.symm [`y]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `p
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
protected
  theorem
    ...
    { p : α → Prop } ( f : α ≃ β ) : ∃! x , p x ↔ ∃! y , p f.symm y
   ...
   (Term.typeSpec
    ...
    («term_↔_»
     ...
     (Init.Logic.«term∃!_,_»
      ...
      ", "
      (Term.app `p [`y])))))
  (Command.declValSimple ":=" (Term.proj (Term.app `Equivₓ.exists_unique_congr_left' [`f.symm]) "." `symm) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Term.app `Equivₓ.exists_unique_congr_left' [`f.symm]) "." `symm)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `Equivₓ.exists_unique_congr_left' [`f.symm])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `Equivₓ.exists_unique_congr_left'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
...
@[simp]
theorem Pi_congr_apply_apply (f : ∀ a, W a) (a : α) : h₁.Pi_congr h₂ f (h₁ a) = h₂ a (f a) := by
...
theorem Pi_congr'_symm_apply_symm_apply (f : ∀ b, Z b) (b : β) :
    (h₁.Pi_congr' h₂).symm f (h₁.symm b) = (h₂ b).symm (f b) := by
