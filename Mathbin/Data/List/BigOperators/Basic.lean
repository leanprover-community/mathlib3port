...
/- warning: list.prod_repeat -> List.prod_repeat is a dubious translation:
lean 3 declaration is
  forall {M : Type.{u1}} [_inst_1 : Monoid.{u1} M] (a : M) (n : Nat), Eq.{succ u1} M (List.prod.{u1} M (MulOneClass.toHasMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1)) (MulOneClass.toHasOne.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1)) (List.repeat.{u1} M a n)) (HPow.hPow.{u1, 0, u1} M Nat M (instHPow.{u1, 0} M Nat (Monoid.Pow.{u1} M _inst_1)) a n)
but is expected to have type
  forall {M : Type.{u1}} [_inst_1 : Monoid.{u1} M] (a : M) (n : Nat), Eq.{succ u1} M (List.prod.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1)) (Monoid.toOne.{u1} M _inst_1) (List.repeat.{u1} M a n)) (HPow.hPow.{u1, 0, u1} M Nat M (instHPow.{u1, 0} M Nat (Monoid.Pow.{u1} M _inst_1)) a n)
Case conversion may be inaccurate. Consider using '#align list.prod_repeat List.prod_repeatₓ'. -/
@[simp, to_additive]
...
but is expected to have type
  forall {M : Type.{u1}} [_inst_1 : Monoid.{u1} M] [_inst_4 : Preorder.{u1} M] [_inst_5 : CovariantClass.{u1, u1} M M (Function.swap.{succ u1, succ u1, succ u1} M M (fun (ᾰ : M) (ᾰ : M) => M) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.2911 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.2913 : M) => HMul.hMul.{u1, u1, u1} M M M (instHMul.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1))) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.2911 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.2913)) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.2926 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.2928 : M) => LE.le.{u1} M (Preorder.toLE.{u1} M _inst_4) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.2926 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.2928)] [_inst_6 : CovariantClass.{u1, u1} M M (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.2945 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.2947 : M) => HMul.hMul.{u1, u1, u1} M M M (instHMul.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1))) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.2945 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.2947) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.2960 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.2962 : M) => LE.le.{u1} M (Preorder.toLE.{u1} M _inst_4) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.2960 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.2962)] {l₁ : List.{u1} M} {l₂ : List.{u1} M}, (List.Forall₂.{u1, u1} M M (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.2980 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.2982 : M) => LE.le.{u1} M (Preorder.toLE.{u1} M _inst_4) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.2980 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.2982) l₁ l₂) -> (LE.le.{u1} M (Preorder.toLE.{u1} M _inst_4) (List.prod.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1)) (Monoid.toOne.{u1} M _inst_1) l₁) (List.prod.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1)) (Monoid.toOne.{u1} M _inst_1) l₂))
...
but is expected to have type
  forall {M : Type.{u1}} [_inst_1 : Monoid.{u1} M] [_inst_4 : Preorder.{u1} M] [_inst_5 : CovariantClass.{u1, u1} M M (Function.swap.{succ u1, succ u1, succ u1} M M (fun (ᾰ : M) (ᾰ : M) => M) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3064 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3066 : M) => HMul.hMul.{u1, u1, u1} M M M (instHMul.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1))) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3064 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3066)) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3079 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3081 : M) => LE.le.{u1} M (Preorder.toLE.{u1} M _inst_4) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3079 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3081)] [_inst_6 : CovariantClass.{u1, u1} M M (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3098 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3100 : M) => HMul.hMul.{u1, u1, u1} M M M (instHMul.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1))) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3098 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3100) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3113 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3115 : M) => LE.le.{u1} M (Preorder.toLE.{u1} M _inst_4) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3113 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3115)] {l₁ : List.{u1} M} {l₂ : List.{u1} M}, (List.Sublist.{u1} M l₁ l₂) -> (forall (a : M), (Membership.mem.{u1, u1} M (List.{u1} M) (List.instMembershipList.{u1} M) a l₂) -> (LE.le.{u1} M (Preorder.toLE.{u1} M _inst_4) (OfNat.ofNat.{u1} M 1 (One.toOfNat1.{u1} M (Monoid.toOne.{u1} M _inst_1))) a)) -> (LE.le.{u1} M (Preorder.toLE.{u1} M _inst_4) (List.prod.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1)) (Monoid.toOne.{u1} M _inst_1) l₁) (List.prod.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1)) (Monoid.toOne.{u1} M _inst_1) l₂))
...
but is expected to have type
  forall {M : Type.{u1}} [_inst_1 : Monoid.{u1} M] [_inst_4 : Preorder.{u1} M] [_inst_5 : CovariantClass.{u1, u1} M M (Function.swap.{succ u1, succ u1, succ u1} M M (fun (ᾰ : M) (ᾰ : M) => M) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3252 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3254 : M) => HMul.hMul.{u1, u1, u1} M M M (instHMul.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1))) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3252 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3254)) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3267 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3269 : M) => LE.le.{u1} M (Preorder.toLE.{u1} M _inst_4) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3267 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3269)] [_inst_6 : CovariantClass.{u1, u1} M M (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3286 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3288 : M) => HMul.hMul.{u1, u1, u1} M M M (instHMul.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1))) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3286 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3288) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3301 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3303 : M) => LE.le.{u1} M (Preorder.toLE.{u1} M _inst_4) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3301 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3303)] {l₁ : List.{u1} M} {l₂ : List.{u1} M}, (List.SublistForall₂.{u1, u1} M M (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3321 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3323 : M) => LE.le.{u1} M (Preorder.toLE.{u1} M _inst_4) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3321 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3323) l₁ l₂) -> (forall (a : M), (Membership.mem.{u1, u1} M (List.{u1} M) (List.instMembershipList.{u1} M) a l₂) -> (LE.le.{u1} M (Preorder.toLE.{u1} M _inst_4) (OfNat.ofNat.{u1} M 1 (One.toOfNat1.{u1} M (Monoid.toOne.{u1} M _inst_1))) a)) -> (LE.le.{u1} M (Preorder.toLE.{u1} M _inst_4) (List.prod.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1)) (Monoid.toOne.{u1} M _inst_1) l₁) (List.prod.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1)) (Monoid.toOne.{u1} M _inst_1) l₂))
...
but is expected to have type
  forall {ι : Type.{u1}} {M : Type.{u2}} [_inst_1 : Monoid.{u2} M] [_inst_4 : Preorder.{u2} M] [_inst_5 : CovariantClass.{u2, u2} M M (Function.swap.{succ u2, succ u2, succ u2} M M (fun (ᾰ : M) (ᾰ : M) => M) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3434 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3436 : M) => HMul.hMul.{u2, u2, u2} M M M (instHMul.{u2} M (MulOneClass.toMul.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1))) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3434 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3436)) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3449 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3451 : M) => LE.le.{u2} M (Preorder.toLE.{u2} M _inst_4) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3449 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3451)] [_inst_6 : CovariantClass.{u2, u2} M M (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3468 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3470 : M) => HMul.hMul.{u2, u2, u2} M M M (instHMul.{u2} M (MulOneClass.toMul.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1))) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3468 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3470) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3483 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3485 : M) => LE.le.{u2} M (Preorder.toLE.{u2} M _inst_4) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3483 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3485)] {l : List.{u1} ι} {f : ι -> M} {g : ι -> M}, (forall (i : ι), (Membership.mem.{u1, u1} ι (List.{u1} ι) (List.instMembershipList.{u1} ι) i l) -> (LE.le.{u2} M (Preorder.toLE.{u2} M _inst_4) (f i) (g i))) -> (LE.le.{u2} M (Preorder.toLE.{u2} M _inst_4) (List.prod.{u2} M (MulOneClass.toMul.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) (Monoid.toOne.{u2} M _inst_1) (List.map.{u1, u2} ι M f l)) (List.prod.{u2} M (MulOneClass.toMul.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) (Monoid.toOne.{u2} M _inst_1) (List.map.{u1, u2} ι M g l)))
...
but is expected to have type
  forall {ι : Type.{u1}} {M : Type.{u2}} [_inst_1 : Monoid.{u2} M] [_inst_4 : Preorder.{u2} M] [_inst_5 : CovariantClass.{u2, u2} M M (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3579 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3581 : M) => HMul.hMul.{u2, u2, u2} M M M (instHMul.{u2} M (MulOneClass.toMul.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1))) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3579 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3581) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3594 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3596 : M) => LT.lt.{u2} M (Preorder.toLT.{u2} M _inst_4) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3594 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3596)] [_inst_6 : CovariantClass.{u2, u2} M M (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3613 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3615 : M) => HMul.hMul.{u2, u2, u2} M M M (instHMul.{u2} M (MulOneClass.toMul.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1))) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3613 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3615) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3628 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3630 : M) => LE.le.{u2} M (Preorder.toLE.{u2} M _inst_4) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3628 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3630)] [_inst_7 : CovariantClass.{u2, u2} M M (Function.swap.{succ u2, succ u2, succ u2} M M (fun (ᾰ : M) (ᾰ : M) => M) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3650 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3652 : M) => HMul.hMul.{u2, u2, u2} M M M (instHMul.{u2} M (MulOneClass.toMul.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1))) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3650 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3652)) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3665 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3667 : M) => LT.lt.{u2} M (Preorder.toLT.{u2} M _inst_4) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3665 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3667)] [_inst_8 : CovariantClass.{u2, u2} M M (Function.swap.{succ u2, succ u2, succ u2} M M (fun (ᾰ : M) (ᾰ : M) => M) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3687 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3689 : M) => HMul.hMul.{u2, u2, u2} M M M (instHMul.{u2} M (MulOneClass.toMul.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1))) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3687 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3689)) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3702 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3704 : M) => LE.le.{u2} M (Preorder.toLE.{u2} M _inst_4) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3702 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3704)] {l : List.{u1} ι} (f : ι -> M) (g : ι -> M), (forall (i : ι), (Membership.mem.{u1, u1} ι (List.{u1} ι) (List.instMembershipList.{u1} ι) i l) -> (LE.le.{u2} M (Preorder.toLE.{u2} M _inst_4) (f i) (g i))) -> (Exists.{succ u1} ι (fun (i : ι) => And (Membership.mem.{u1, u1} ι (List.{u1} ι) (List.instMembershipList.{u1} ι) i l) (LT.lt.{u2} M (Preorder.toLT.{u2} M _inst_4) (f i) (g i)))) -> (LT.lt.{u2} M (Preorder.toLT.{u2} M _inst_4) (List.prod.{u2} M (MulOneClass.toMul.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) (Monoid.toOne.{u2} M _inst_1) (List.map.{u1, u2} ι M f l)) (List.prod.{u2} M (MulOneClass.toMul.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) (Monoid.toOne.{u2} M _inst_1) (List.map.{u1, u2} ι M g l)))
...
but is expected to have type
  forall {ι : Type.{u1}} {M : Type.{u2}} [_inst_1 : Monoid.{u2} M] [_inst_4 : Preorder.{u2} M] [_inst_5 : CovariantClass.{u2, u2} M M (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3878 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3880 : M) => HMul.hMul.{u2, u2, u2} M M M (instHMul.{u2} M (MulOneClass.toMul.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1))) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3878 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3880) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3893 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3895 : M) => LT.lt.{u2} M (Preorder.toLT.{u2} M _inst_4) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3893 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3895)] [_inst_6 : CovariantClass.{u2, u2} M M (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3912 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3914 : M) => HMul.hMul.{u2, u2, u2} M M M (instHMul.{u2} M (MulOneClass.toMul.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1))) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3912 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3914) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3927 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3929 : M) => LE.le.{u2} M (Preorder.toLE.{u2} M _inst_4) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3927 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3929)] [_inst_7 : CovariantClass.{u2, u2} M M (Function.swap.{succ u2, succ u2, succ u2} M M (fun (ᾰ : M) (ᾰ : M) => M) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3949 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3951 : M) => HMul.hMul.{u2, u2, u2} M M M (instHMul.{u2} M (MulOneClass.toMul.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1))) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3949 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3951)) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3964 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3966 : M) => LT.lt.{u2} M (Preorder.toLT.{u2} M _inst_4) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3964 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3966)] [_inst_8 : CovariantClass.{u2, u2} M M (Function.swap.{succ u2, succ u2, succ u2} M M (fun (ᾰ : M) (ᾰ : M) => M) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3986 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3988 : M) => HMul.hMul.{u2, u2, u2} M M M (instHMul.{u2} M (MulOneClass.toMul.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1))) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3986 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.3988)) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4001 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4003 : M) => LE.le.{u2} M (Preorder.toLE.{u2} M _inst_4) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4001 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4003)] {l : List.{u1} ι}, (Ne.{succ u1} (List.{u1} ι) l (List.nil.{u1} ι)) -> (forall (f : ι -> M) (g : ι -> M), (forall (i : ι), (Membership.mem.{u1, u1} ι (List.{u1} ι) (List.instMembershipList.{u1} ι) i l) -> (LT.lt.{u2} M (Preorder.toLT.{u2} M _inst_4) (f i) (g i))) -> (LT.lt.{u2} M (Preorder.toLT.{u2} M _inst_4) (List.prod.{u2} M (MulOneClass.toMul.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) (Monoid.toOne.{u2} M _inst_1) (List.map.{u1, u2} ι M f l)) (List.prod.{u2} M (MulOneClass.toMul.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) (Monoid.toOne.{u2} M _inst_1) (List.map.{u1, u2} ι M g l))))
...
but is expected to have type
  forall {M : Type.{u1}} [_inst_1 : Monoid.{u1} M] [_inst_4 : Preorder.{u1} M] [_inst_5 : CovariantClass.{u1, u1} M M (Function.swap.{succ u1, succ u1, succ u1} M M (fun (ᾰ : M) (ᾰ : M) => M) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4139 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4141 : M) => HMul.hMul.{u1, u1, u1} M M M (instHMul.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1))) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4139 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4141)) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4154 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4156 : M) => LE.le.{u1} M (Preorder.toLE.{u1} M _inst_4) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4154 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4156)] [_inst_6 : CovariantClass.{u1, u1} M M (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4173 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4175 : M) => HMul.hMul.{u1, u1, u1} M M M (instHMul.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1))) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4173 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4175) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4188 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4190 : M) => LE.le.{u1} M (Preorder.toLE.{u1} M _inst_4) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4188 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4190)] (l : List.{u1} M) (n : M), (forall (x : M), (Membership.mem.{u1, u1} M (List.{u1} M) (List.instMembershipList.{u1} M) x l) -> (LE.le.{u1} M (Preorder.toLE.{u1} M _inst_4) x n)) -> (LE.le.{u1} M (Preorder.toLE.{u1} M _inst_4) (List.prod.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1)) (Monoid.toOne.{u1} M _inst_1) l) (HPow.hPow.{u1, 0, u1} M Nat M (instHPow.{u1, 0} M Nat (Monoid.Pow.{u1} M _inst_1)) n (List.length.{u1} M l)))
...
but is expected to have type
  forall {ι : Type.{u1}} {M : Type.{u2}} [_inst_1 : Monoid.{u2} M] [_inst_4 : LinearOrder.{u2} M] [_inst_5 : CovariantClass.{u2, u2} M M (Function.swap.{succ u2, succ u2, succ u2} M M (fun (ᾰ : M) (ᾰ : M) => M) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4344 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4346 : M) => HMul.hMul.{u2, u2, u2} M M M (instHMul.{u2} M (MulOneClass.toMul.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1))) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4344 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4346)) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4359 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4361 : M) => LE.le.{u2} M (Preorder.toLE.{u2} M (PartialOrder.toPreorder.{u2} M (SemilatticeInf.toPartialOrder.{u2} M (Lattice.toSemilatticeInf.{u2} M (DistribLattice.toLattice.{u2} M (instDistribLattice.{u2} M _inst_4)))))) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4359 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4361)] [_inst_6 : CovariantClass.{u2, u2} M M (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4378 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4380 : M) => HMul.hMul.{u2, u2, u2} M M M (instHMul.{u2} M (MulOneClass.toMul.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1))) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4378 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4380) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4393 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4395 : M) => LE.le.{u2} M (Preorder.toLE.{u2} M (PartialOrder.toPreorder.{u2} M (SemilatticeInf.toPartialOrder.{u2} M (Lattice.toSemilatticeInf.{u2} M (DistribLattice.toLattice.{u2} M (instDistribLattice.{u2} M _inst_4)))))) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4393 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4395)] {l : List.{u1} ι} (f : ι -> M) (g : ι -> M), (LT.lt.{u2} M (Preorder.toLT.{u2} M (PartialOrder.toPreorder.{u2} M (SemilatticeInf.toPartialOrder.{u2} M (Lattice.toSemilatticeInf.{u2} M (DistribLattice.toLattice.{u2} M (instDistribLattice.{u2} M _inst_4)))))) (List.prod.{u2} M (MulOneClass.toMul.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) (Monoid.toOne.{u2} M _inst_1) (List.map.{u1, u2} ι M f l)) (List.prod.{u2} M (MulOneClass.toMul.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) (Monoid.toOne.{u2} M _inst_1) (List.map.{u1, u2} ι M g l))) -> (Exists.{succ u1} ι (fun (i : ι) => And (Membership.mem.{u1, u1} ι (List.{u1} ι) (List.instMembershipList.{u1} ι) i l) (LT.lt.{u2} M (Preorder.toLT.{u2} M (PartialOrder.toPreorder.{u2} M (SemilatticeInf.toPartialOrder.{u2} M (Lattice.toSemilatticeInf.{u2} M (DistribLattice.toLattice.{u2} M (instDistribLattice.{u2} M _inst_4)))))) (f i) (g i))))
...
but is expected to have type
  forall {ι : Type.{u1}} {M : Type.{u2}} [_inst_1 : Monoid.{u2} M] [_inst_4 : LinearOrder.{u2} M] [_inst_5 : CovariantClass.{u2, u2} M M (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4511 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4513 : M) => HMul.hMul.{u2, u2, u2} M M M (instHMul.{u2} M (MulOneClass.toMul.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1))) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4511 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4513) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4526 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4528 : M) => LT.lt.{u2} M (Preorder.toLT.{u2} M (PartialOrder.toPreorder.{u2} M (SemilatticeInf.toPartialOrder.{u2} M (Lattice.toSemilatticeInf.{u2} M (DistribLattice.toLattice.{u2} M (instDistribLattice.{u2} M _inst_4)))))) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4526 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4528)] [_inst_6 : CovariantClass.{u2, u2} M M (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4545 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4547 : M) => HMul.hMul.{u2, u2, u2} M M M (instHMul.{u2} M (MulOneClass.toMul.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1))) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4545 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4547) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4560 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4562 : M) => LE.le.{u2} M (Preorder.toLE.{u2} M (PartialOrder.toPreorder.{u2} M (SemilatticeInf.toPartialOrder.{u2} M (Lattice.toSemilatticeInf.{u2} M (DistribLattice.toLattice.{u2} M (instDistribLattice.{u2} M _inst_4)))))) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4560 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4562)] [_inst_7 : CovariantClass.{u2, u2} M M (Function.swap.{succ u2, succ u2, succ u2} M M (fun (ᾰ : M) (ᾰ : M) => M) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4582 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4584 : M) => HMul.hMul.{u2, u2, u2} M M M (instHMul.{u2} M (MulOneClass.toMul.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1))) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4582 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4584)) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4597 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4599 : M) => LT.lt.{u2} M (Preorder.toLT.{u2} M (PartialOrder.toPreorder.{u2} M (SemilatticeInf.toPartialOrder.{u2} M (Lattice.toSemilatticeInf.{u2} M (DistribLattice.toLattice.{u2} M (instDistribLattice.{u2} M _inst_4)))))) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4597 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4599)] [_inst_8 : CovariantClass.{u2, u2} M M (Function.swap.{succ u2, succ u2, succ u2} M M (fun (ᾰ : M) (ᾰ : M) => M) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4619 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4621 : M) => HMul.hMul.{u2, u2, u2} M M M (instHMul.{u2} M (MulOneClass.toMul.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1))) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4619 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4621)) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4634 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4636 : M) => LE.le.{u2} M (Preorder.toLE.{u2} M (PartialOrder.toPreorder.{u2} M (SemilatticeInf.toPartialOrder.{u2} M (Lattice.toSemilatticeInf.{u2} M (DistribLattice.toLattice.{u2} M (instDistribLattice.{u2} M _inst_4)))))) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4634 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4636)] {l : List.{u1} ι}, (Ne.{succ u1} (List.{u1} ι) l (List.nil.{u1} ι)) -> (forall (f : ι -> M) (g : ι -> M), (LE.le.{u2} M (Preorder.toLE.{u2} M (PartialOrder.toPreorder.{u2} M (SemilatticeInf.toPartialOrder.{u2} M (Lattice.toSemilatticeInf.{u2} M (DistribLattice.toLattice.{u2} M (instDistribLattice.{u2} M _inst_4)))))) (List.prod.{u2} M (MulOneClass.toMul.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) (Monoid.toOne.{u2} M _inst_1) (List.map.{u1, u2} ι M f l)) (List.prod.{u2} M (MulOneClass.toMul.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) (Monoid.toOne.{u2} M _inst_1) (List.map.{u1, u2} ι M g l))) -> (Exists.{succ u1} ι (fun (x : ι) => And (Membership.mem.{u1, u1} ι (List.{u1} ι) (List.instMembershipList.{u1} ι) x l) (LE.le.{u2} M (Preorder.toLE.{u2} M (PartialOrder.toPreorder.{u2} M (SemilatticeInf.toPartialOrder.{u2} M (Lattice.toSemilatticeInf.{u2} M (DistribLattice.toLattice.{u2} M (instDistribLattice.{u2} M _inst_4)))))) (f x) (g x)))))
...
but is expected to have type
  forall {M : Type.{u1}} [_inst_1 : Monoid.{u1} M] [_inst_4 : Preorder.{u1} M] [_inst_5 : CovariantClass.{u1, u1} M M (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4762 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4764 : M) => HMul.hMul.{u1, u1, u1} M M M (instHMul.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1))) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4762 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4764) (fun (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4777 : M) (x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4779 : M) => LE.le.{u1} M (Preorder.toLE.{u1} M _inst_4) x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4777 x._@.Mathlib.Data.List.BigOperators.Basic._hyg.4779)] {l : List.{u1} M}, (forall (x : M), (Membership.mem.{u1, u1} M (List.{u1} M) (List.instMembershipList.{u1} M) x l) -> (LE.le.{u1} M (Preorder.toLE.{u1} M _inst_4) (OfNat.ofNat.{u1} M 1 (One.toOfNat1.{u1} M (Monoid.toOne.{u1} M _inst_1))) x)) -> (LE.le.{u1} M (Preorder.toLE.{u1} M _inst_4) (OfNat.ofNat.{u1} M 1 (One.toOfNat1.{u1} M (Monoid.toOne.{u1} M _inst_1))) (List.prod.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1)) (Monoid.toOne.{u1} M _inst_1) l))
...
#print List.alternating_prod_nil /-
@[simp, to_additive]
...
#print List.alternating_prod_singleton /-
@[simp, to_additive]
...
#print List.alternating_prod_cons_cons' /-
@[to_additive]
...
/- warning: list.alternating_prod_cons_cons -> List.alternating_prod_cons_cons is a dubious translation:
lean 3 declaration is
...
Case conversion may be inaccurate. Consider using '#align list.alternating_prod_cons_cons List.alternating_prod_cons_consₓ'. -/
@[to_additive]
...
/- warning: list.alternating_prod_cons' -> List.alternating_prod_cons' is a dubious translation:
lean 3 declaration is
...
Case conversion may be inaccurate. Consider using '#align list.alternating_prod_cons' List.alternating_prod_cons'ₓ'. -/
@[to_additive]
...
Case conversion may be inaccurate. Consider using '#align list.alternating_prod_cons List.alternating_prod_consₓ'. -/
@[simp, to_additive]
