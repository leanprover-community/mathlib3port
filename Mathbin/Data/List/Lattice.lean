...
theorem Disjoint.symm (d : Disjoint l₁ l₂) : Disjoint l₂ l₁ :=
  fun a i₂ i₁ => d i₁ i₂
...
theorem disjoint_of_disjoint_cons_left {l₁ l₂} : Disjoint (a :: l₁) l₂ → Disjoint l₁ l₂ :=
  disjoint_of_subset_left (List.subset_consₓ _ _)

theorem disjoint_of_disjoint_cons_right {l₁ l₂} : Disjoint l₁ (a :: l₂) → Disjoint l₁ l₂ :=
  disjoint_of_subset_right (List.subset_consₓ _ _)
...
@[simp]
theorem disjoint_singleton : Disjoint l [a] ↔ a ∉ l :=
  by 
    rw [disjoint_comm, singleton_disjoint]

@[simp]
theorem disjoint_append_left : Disjoint (l₁ ++ l₂) l ↔ Disjoint l₁ l ∧ Disjoint l₂ l :=
  by 
...
theorem disjoint_cons_left : Disjoint (a :: l₁) l₂ ↔ a ∉ l₂ ∧ Disjoint l₁ l₂ :=
  (@disjoint_append_left _ l₂ [a] l₁).trans$
    by 
...
@[simp]
theorem mem_union : a ∈ l₁ ∪ l₂ ↔ a ∈ l₁ ∨ a ∈ l₂ :=
  by 
...
@[simp]
theorem inter_reverse {xs ys : List α} : xs.inter ys.reverse = xs.inter ys :=
  by 
...
@[simp]
theorem nil_bag_inter (l : List α) : [].bagInter l = [] :=
  by 
    cases l <;> rfl

@[simp]
theorem bag_inter_nil (l : List α) : l.bag_inter [] = [] :=
  by 
    cases l <;> rfl

@[simp]
theorem cons_bag_inter_of_pos (l₁ : List α) (h : a ∈ l₂) : (a :: l₁).bagInter l₂ = a :: l₁.bag_inter (l₂.erase a) :=
  by 
    cases l₂ <;> exact if_pos h

@[simp]
theorem cons_bag_inter_of_neg (l₁ : List α) (h : a ∉ l₂) : (a :: l₁).bagInter l₂ = l₁.bag_inter l₂ :=
  by 
    cases l₂
    ·
...
| h₁ :: l₁, h₂ :: l₂ =>
  by 
    simp only [List.bagInter, List.mem_cons_iffₓ]
    byCases' p₁ : h₂ = h₁ <;> byCases' p₂ : h₁ = a
    ·
