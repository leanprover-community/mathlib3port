      ...
      (Command.declSig
       ...
       (Term.typeSpec
        ...
        («term_=_»
         (Term.typeAscription
          "("
          (List.Data.List.Perm.«term_∘r_» `perm " ∘r " `perm)
          ":"
          [(Term.arrow
            (Term.app `List [`α])
            "→"
            (Term.arrow (Term.app `List [`α]) "→" (Term.prop "Prop")))]
          ")")
         "="
         `perm)))
       ...
       (Term.byTactic
        ...
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(tacticFunext__ "funext" [`a `c])
           ";"
           (Tactic.apply "apply" `propext)
           []
           ...
           (tactic__
            ...
            [(Tactic.exact
              ...
              (Term.fun
               "fun"
               (Term.basicFun
                [(Term.anonymousCtor "⟨" [`b "," `hab "," `hba] "⟩")]
                []
                "=>"
                (Term.app `perm.trans [`hab `hba]))))])
           []
           (tactic__
            (cdotTk (patternIgnore (token.«· » "·")))
            [(Tactic.exact
              ...
              (Term.fun
               ...
               (Term.basicFun
                ...
                []
                "=>"
                (Term.anonymousCtor "⟨" [`a "," (Term.app `perm.refl [`a]) "," `h] "⟩"))))])])))
       [])
      []
      []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (List.Data.List.Perm.«term_∘r_» `perm " ∘r " `perm)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'List.Data.List.Perm.«term_∘r_»', expected 'List.Data.List.Perm.term_∘r_._@.Data.List.Perm._hyg.640'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `perm_comp_forall₂ [])
      (Command.declSig
       [(Term.implicitBinder "{" [`l `u `v] [] "}")
        (Term.explicitBinder "(" [`hlu] [":" (Term.app `Perm [`l `u])] [] ")")
        (Term.explicitBinder "(" [`huv] [":" (Term.app `Forall₂ [`r `u `v])] [] ")")]
       (Term.typeSpec
        ":"
        (Term.app (List.Data.List.Perm.«term_∘r_» (Term.app `Forall₂ [`r]) " ∘r " `perm) [`l `v])))
      (Command.declValSimple
       ":="
       (Term.byTactic
        "by"
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(Tactic.induction "induction" [`hlu] [] ["generalizing" [`v]] [])
           []
           (Tactic.case
            "case"
            [(Tactic.caseArg (Lean.binderIdent `nil) [])]
            "=>"
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(Tactic.cases "cases" [(Tactic.casesTarget [] `huv)] [] [])
               ";"
               (Tactic.exact
                "exact"
                (Term.anonymousCtor
                 "⟨"
                 [(«term[_]» "[" [] "]") "," `forall₂.nil "," `perm.nil]
                 "⟩"))])))
           []
           (Tactic.case
            "case"
            [(Tactic.caseArg
              (Lean.binderIdent `cons)
              [(Lean.binderIdent `a)
               (Lean.binderIdent `l)
               (Lean.binderIdent `u)
               (Lean.binderIdent `hlu)
               (Lean.binderIdent `ih)])]
            "=>"
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(Tactic.cases'
                ...
                ["with"
                 [(Lean.binderIdent (Term.hole "_"))
                  ...
                  (Lean.binderIdent (Term.hole "_"))
                  (Lean.binderIdent `v)
                  (Lean.binderIdent `hab)
                  (Lean.binderIdent `huv')]])
               []
               (Std.Tactic.rcases
                "rcases"
                [(Tactic.casesTarget [] (Term.app `ih [`huv']))]
                ["with"
               ...
               (Tactic.exact
                ...
                (Term.anonymousCtor
                 ...
                 [(«term_::_» `b "::" `l₂)
                  ","
                  (Term.app `forall₂.cons [`hab `h₁₂])
                  ","
                  (Term.app `h₂₃.cons [(Term.hole "_")])]
                 "⟩"))])))
           []
           (Tactic.case
            "case"
            [(Tactic.caseArg
              (Lean.binderIdent `swap)
              [(Lean.binderIdent `a₁)
               (Lean.binderIdent `a₂)
               (Lean.binderIdent `l₁)
               (Lean.binderIdent `l₂)
              ...
              [(Tactic.cases'
                ...
                ["with"
                 [(Lean.binderIdent (Term.hole "_"))
                  ...
                  (Lean.binderIdent `l₂)
                  (Lean.binderIdent `h₁)
                  (Lean.binderIdent `hr_₂₃)]])
               []
               (Tactic.cases'
                "cases'"
                [(Tactic.casesTarget [] `hr_₂₃)]
                []
                ["with"
                 [(Lean.binderIdent (Term.hole "_"))
                  (Lean.binderIdent `b₂)
               ...
               (Tactic.exact
                ...
                (Term.anonymousCtor
                 "⟨"
                 [(«term_::_» `b₂ "::" («term_::_» `b₁ "::" `l₂))
                  ","
                  (Term.app `forall₂.cons [`h₂ (Term.app `forall₂.cons [`h₁ `h₁₂])])
                  ","
            ...
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(Std.Tactic.rcases
                 ...
                 (Std.Tactic.RCases.rcasesPatLo
                  (Std.Tactic.RCases.rcasesPatMed
                   [(Std.Tactic.RCases.rcasesPat.tuple
                     "⟨"
                     [(Std.Tactic.RCases.rcasesPatLo
                       (Std.Tactic.RCases.rcasesPatMed [(Std.Tactic.RCases.rcasesPat.one `lb₂)])
                       [])
                      ","
                      (Std.Tactic.RCases.rcasesPatLo
               ...
               (Std.Tactic.rcases
                "rcases"
                [(Tactic.casesTarget [] (Term.app `ih₁ [`hab₂]))]
                ["with"
                 (Std.Tactic.RCases.rcasesPatLo
                  (Std.Tactic.RCases.rcasesPatMed
                   [(Std.Tactic.RCases.rcasesPat.tuple
               ...
               (Tactic.exact
                ...
                (Term.anonymousCtor
                 "⟨"
                 [`lb₁ "," `hab₁ "," (Term.app `perm.trans [`h₁₂ `h₂₃])]
                 "⟩"))])))])))
       [])
      []
      []))
       ...
       (Tactic.tacticSeq
        (Tactic.tacticSeq1Indented
         [(Std.Tactic.rcases
          ...
          (Tactic.exact
           "exact"
           (Term.anonymousCtor "⟨" [`lb₁ "," `hab₁ "," (Term.app `perm.trans [`h₁₂ `h₂₃])] "⟩"))])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq1Indented', expected 'Lean.Parser.Tactic.tacticSeqBracketed'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Tactic.exact
       "exact"
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023,
     term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" (Term.app `forall₂.cons [`h₁ `h₁₂]) ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      `h₂
       ...
       (Tactic.tacticSeq
        (Tactic.tacticSeq1Indented
         [(Tactic.cases "cases" [(Tactic.casesTarget [] `huv)] [] [])
          ...
          (Tactic.exact
           "exact"
           (Term.anonymousCtor "⟨" [(«term[_]» "[" [] "]") "," `forall₂.nil "," `perm.nil] "⟩"))])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq1Indented', expected 'Lean.Parser.Tactic.tacticSeqBracketed'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Tactic.exact
       "exact"
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none,
     [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      (List.Data.List.Perm.«term_∘r_» (Term.app `Forall₂ [`r]) " ∘r " `perm)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'List.Data.List.Perm.«term_∘r_»', expected 'List.Data.List.Perm.term_∘r_._@.Data.List.Perm._hyg.640'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.opaque'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.instance'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.axiom'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `forall₂_comp_perm_eq_perm_comp_forall₂ [])
      (Command.declSig
       []
       (Term.typeSpec
        ":"
        («term_=_»
         (List.Data.List.Perm.«term_∘r_» (Term.app `Forall₂ [`r]) " ∘r " `perm)
         "="
         (List.Data.List.Perm.«term_∘r_» `perm " ∘r " (Term.app `Forall₂ [`r])))))
      (Command.declValSimple
       ":="
       (Term.byTactic
        "by"
            ...
            [(Tactic.intro "intro" [`h])
             ...
             (Tactic.tacticHave_
              ...
              (Term.haveDecl
               (Term.haveIdDecl
                []
                [(Term.typeSpec ":" (Term.app `forall₂ [(Term.app `flip [`r]) `l₂ `l₁]))]
                ":="
                `h₁₂.flip)))
             []
             (Std.Tactic.rcases
              "rcases"
              [(Tactic.casesTarget [] (Term.app `perm_comp_forall₂ [`h₂₃.symm `this]))]
              ["with"
               (Std.Tactic.RCases.rcasesPatLo
                (Std.Tactic.RCases.rcasesPatMed
                 [(Std.Tactic.RCases.rcasesPat.tuple
                ...
                [])])
             []
             (Tactic.exact "exact" (Term.anonymousCtor "⟨" [`l' "," `h₂.symm "," `h₁.flip] "⟩"))])
           []
           (tactic__
            (cdotTk (patternIgnore (token.«· » "·")))
            [(Tactic.exact
              ...
              (Term.fun
               "fun"
               (Term.basicFun
                [(Term.anonymousCtor "⟨" [`l₂ "," `h₁₂ "," `h₂₃] "⟩")]
                []
                "=>"
                (Term.app `perm_comp_forall₂ [`h₁₂ `h₂₃]))))])])))
       [])
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.abbrev'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Tactic.exact "exact" (Term.anonymousCtor "⟨" [`l' "," `h₂.symm "," `h₁.flip] "⟩"))
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.anonymousCtor "⟨" [`l' "," `h₂.symm "," `h₁.flip] "⟩")
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `h₁.flip
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none,
     [anonymous]) <=? (none, [anonymous])
      ...
      (Std.Tactic.rcases
       ...
       ["with"
        (Std.Tactic.RCases.rcasesPatLo
         ...
         [])])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `perm_comp_forall₂ [`h₂₃.symm `this])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `this
...
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none,
     [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `forall₂ [(Term.app `flip [`r]) `l₂ `l₁])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `l₁
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023,
     term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" (Term.app `flip [`r]) ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      `forall₂
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none,
     [anonymous]) <=? (some 1022, term)
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `rel_perm_imp [])
      (Command.declSig
       [(Term.explicitBinder "(" [`hr] [":" (Term.app `RightUnique [`r])] [] ")")]
       (Term.typeSpec
        ":"
        (Term.app
         (Relator.Logic.Relator.«term_⇒_»
          (Term.app `Forall₂ [`r])
          " ⇒ "
          (Relator.Logic.Relator.«term_⇒_» (Term.app `Forall₂ [`r]) " ⇒ " `Implies))
         [`Perm `Perm])))
      (Command.declValSimple
       ":="
       (Term.fun
          ...
          (Term.haveDecl
           (Term.haveIdDecl
            ...
            [(Term.typeSpec
              ":"
              (Term.app
               (List.Data.List.Perm.«term_∘r_»
                (Term.app `flip [(Term.app `Forall₂ [`r])])
                " ∘r "
                (List.Data.List.Perm.«term_∘r_» `perm " ∘r " (Term.app `Forall₂ [`r])))
               [`b `d]))]
            ":="
            (Term.anonymousCtor "⟨" [`a "," `h₁ "," `c "," `h "," `h₂] "⟩")))
          []
          (Term.have
           "have"
           (Term.haveDecl
                ...
                [(Std.Tactic.tacticRwa__
                  ...
                  (Tactic.rwRuleSeq
                   ...
                   [(Tactic.rwRule
                     ...
                     `forall₂_comp_perm_eq_perm_comp_forall₂)
                    ","
                    (Tactic.rwRule [(patternIgnore (token.«← » "←"))] `Relation.comp_assoc)]
                   "]")
           ...
           (Term.let
            ...
            (Term.letDecl
             (Term.letPatDecl
              (Term.anonymousCtor
               "⟨"
               [`b' "," (Term.anonymousCtor "⟨" [`c' "," `hbc "," `hcb] "⟩") "," `hbd]
               "⟩")
              []
              []
              ":="
            ...
            (Term.have
             ...
             (Term.haveDecl
              (Term.haveIdDecl
               ...
               ":="
               (Term.app `right_unique_forall₂' [`hr `hcb `hbc])))
             []
             (Term.subst `this "▸" [`hbd])))))))
       [])
      []
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Std.Tactic.tacticRwa__
       ...
       (Tactic.rwRuleSeq
        "["
        [(Tactic.rwRule [(patternIgnore (token.«← » "←"))] `forall₂_comp_perm_eq_perm_comp_forall₂)
         ","
         (Tactic.rwRule [(patternIgnore (token.«← » "←"))] `Relation.comp_assoc)]
        "]")
       [(Tactic.location "at" (Tactic.locationHyp [`this] []))])
...
theorem
  rel_perm_imp
  ( hr : RightUnique r ) : Forall₂ r ⇒ Forall₂ r ⇒ Implies Perm Perm
  :=
    fun
      a b h₁ c d h₂ h
        =>
        have
          : flip Forall₂ r ∘r perm ∘r Forall₂ r b d := ⟨ a , h₁ , c , h , h₂ ⟩
          have
            : flip Forall₂ r ∘r Forall₂ r ∘r perm b d
              :=
              by rwa [ ← forall₂_comp_perm_eq_perm_comp_forall₂ , ← Relation.comp_assoc ] at this
            let
              ⟨ b' , ⟨ c' , hbc , hcb ⟩ , hbd ⟩ := this
              have : b' = b := right_unique_forall₂' hr hcb hbc this ▸ hbd
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `Perm.fold_op_eq [])
      (Command.declSig
       [(Term.implicitBinder "{" [`l₁ `l₂] [":" (Term.app `List [`α])] "}")
        (Term.implicitBinder "{" [`a] [":" `α] "}")
        (Term.explicitBinder "(" [`h] [":" (List.Data.List.Perm.list.perm `l₁ " ~ " `l₂)] [] ")")]
       (Term.typeSpec
        ":"
        («term_=_»
         (List.Data.List.Perm.foldl `l₁ " <*> " `a)
         "="
         (List.Data.List.Perm.foldl `l₂ " <*> " `a))))
      (Command.declValSimple
       ":="
       (Term.app
        (Term.proj `h "." `foldl_eq)
        [(Term.app `right_comm [(Term.hole "_") `IsCommutative.comm `IsAssociative.assoc])
         (Term.hole "_")])
       [])
      []
      []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (List.Data.List.Perm.foldl `l₂ " <*> " `a)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'List.Data.List.Perm.foldl', expected 'List.Data.List.Perm.foldl._@.Data.List.Perm._hyg.1814'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.opaque'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.instance'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.axiom'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.example'
