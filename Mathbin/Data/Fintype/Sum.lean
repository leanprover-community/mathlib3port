...
lean 3 declaration is
  forall {α : Type.{u1}} {β : Type.{u2}} [_inst_1 : Fintype.{u1} α] (k : β) (b : α -> β), Eq.{succ u2} (Finset.{u2} β) (Finset.image.{u1, u2} (Subtype.{succ u1} α (fun (a : α) => Ne.{succ u2} β (b a) k)) β (fun (a : β) (b : β) => Classical.propDecidable (Eq.{succ u2} β a b)) (fun (i : Subtype.{succ u1} α (fun (a : α) => Ne.{succ u2} β (b a) k)) => b ((fun (a : Type.{u1}) (b : Type.{u1}) [self : HasLiftT.{succ u1, succ u1} a b] => self.0) (Subtype.{succ u1} α (fun (a : α) => Ne.{succ u2} β (b a) k)) α (HasLiftT.mk.{succ u1, succ u1} (Subtype.{succ u1} α (fun (a : α) => Ne.{succ u2} β (b a) k)) α (CoeTCₓ.coe.{succ u1, succ u1} (Subtype.{succ u1} α (fun (a : α) => Ne.{succ u2} β (b a) k)) α (coeBase.{succ u1, succ u1} (Subtype.{succ u1} α (fun (a : α) => Ne.{succ u2} β (b a) k)) α (coeSubtype.{succ u1} α (fun (a : α) => Ne.{succ u2} β (b a) k))))) i)) (Finset.univ.{u1} (Subtype.{succ u1} α (fun (a : α) => Ne.{succ u2} β (b a) k)) (Subtype.fintype.{u1} α (fun (a : α) => Ne.{succ u2} β (b a) k) (fun (a : α) => Ne.decidable.{succ u2} β (fun (a : β) (b : β) => Classical.propDecidable (Eq.{succ u2} β a b)) (b a) k) _inst_1))) (Finset.erase.{u2} β (fun (a : β) (b : β) => Classical.propDecidable (Eq.{succ u2} β a b)) (Finset.image.{u1, u2} α β (fun (a : β) (b : β) => Classical.propDecidable (Eq.{succ u2} β a b)) b (Finset.univ.{u1} α _inst_1)) k)
but is expected to have type
  forall {α : Type.{u2}} {β : Type.{u1}} [_inst_1 : Fintype.{u2} α] (k : β) (b : α -> β), Eq.{succ u1} (Finset.{u1} β) (Finset.image.{u2, u1} (Subtype.{succ u2} α (fun (a : α) => Ne.{succ u1} β (b a) k)) β (fun (a : β) (b : β) => Classical.propDecidable (Eq.{succ u1} β a b)) (fun (i : Subtype.{succ u2} α (fun (a : α) => Ne.{succ u1} β (b a) k)) => b (Subtype.val.{succ u2} α (fun (a : α) => Ne.{succ u1} β (b a) k) i)) (Finset.univ.{u2} (Subtype.{succ u2} α (fun (a : α) => Ne.{succ u1} β (b a) k)) (Subtype.fintype.{u2} α (fun (a : α) => Ne.{succ u1} β (b a) k) (fun (a : α) => instDecidableNot (Eq.{succ u1} β (b a) k) (Classical.propDecidable (Eq.{succ u1} β (b a) k))) _inst_1))) (Finset.erase.{u1} β (fun (a : β) (b : β) => Classical.propDecidable (Eq.{succ u1} β a b)) (Finset.image.{u2, u1} α β (fun (a : β) (b : β) => Classical.propDecidable (Eq.{succ u1} β a b)) b (Finset.univ.{u2} α _inst_1)) k)
...
lean 3 declaration is
  forall {α : Type.{u1}} {β : Type.{u2}} [_inst_1 : Fintype.{u1} α] (k : β) (b : α -> β), (Membership.Mem.{u2, u2} β (Finset.{u2} β) (Finset.hasMem.{u2} β) k (Finset.image.{u1, u2} α β (fun (a : β) (b : β) => Classical.propDecidable (Eq.{succ u2} β a b)) b (Finset.univ.{u1} α _inst_1))) -> (forall (p : β -> Prop) [_inst_2 : DecidablePred.{succ u2} β p], (Not (p k)) -> (HasSSubset.SSubset.{u2} (Finset.{u2} β) (Finset.hasSsubset.{u2} β) (Finset.image.{u1, u2} (Subtype.{succ u1} α (fun (a : α) => p (b a))) β (fun (a : β) (b : β) => Classical.propDecidable (Eq.{succ u2} β a b)) (fun (i : Subtype.{succ u1} α (fun (a : α) => p (b a))) => b ((fun (a : Type.{u1}) (b : Type.{u1}) [self : HasLiftT.{succ u1, succ u1} a b] => self.0) (Subtype.{succ u1} α (fun (a : α) => p (b a))) α (HasLiftT.mk.{succ u1, succ u1} (Subtype.{succ u1} α (fun (a : α) => p (b a))) α (CoeTCₓ.coe.{succ u1, succ u1} (Subtype.{succ u1} α (fun (a : α) => p (b a))) α (coeBase.{succ u1, succ u1} (Subtype.{succ u1} α (fun (a : α) => p (b a))) α (coeSubtype.{succ u1} α (fun (a : α) => p (b a)))))) i)) (Finset.univ.{u1} (Subtype.{succ u1} α (fun (a : α) => p (b a))) (Subtype.fintype.{u1} α (fun (a : α) => p (b a)) (fun (a : α) => _inst_2 (b a)) _inst_1))) (Finset.image.{u1, u2} α β (fun (a : β) (b : β) => Classical.propDecidable (Eq.{succ u2} β a b)) b (Finset.univ.{u1} α _inst_1))))
but is expected to have type
  forall {α : Type.{u2}} {β : Type.{u1}} [_inst_1 : Fintype.{u2} α] (k : β) (b : α -> β), (Membership.mem.{u1, u1} β (Finset.{u1} β) (Finset.instMembershipFinset.{u1} β) k (Finset.image.{u2, u1} α β (fun (a : β) (b : β) => Classical.propDecidable (Eq.{succ u1} β a b)) b (Finset.univ.{u2} α _inst_1))) -> (forall (p : β -> Prop) [_inst_2 : DecidablePred.{succ u1} β p], (Not (p k)) -> (HasSSubset.SSubset.{u1} (Finset.{u1} β) (Finset.instHasSSubsetFinset.{u1} β) (Finset.image.{u2, u1} (Subtype.{succ u2} α (fun (a : α) => p (b a))) β (fun (a : β) (b : β) => Classical.propDecidable (Eq.{succ u1} β a b)) (fun (i : Subtype.{succ u2} α (fun (a : α) => p (b a))) => b (Subtype.val.{succ u2} α (fun (a : α) => p (b a)) i)) (Finset.univ.{u2} (Subtype.{succ u2} α (fun (a : α) => p (b a))) (Subtype.fintype.{u2} α (fun (a : α) => p (b a)) (fun (a : α) => _inst_2 (b a)) _inst_1))) (Finset.image.{u2, u1} α β (fun (a : β) (b : β) => Classical.propDecidable (Eq.{succ u1} β a b)) b (Finset.univ.{u2} α _inst_1))))
