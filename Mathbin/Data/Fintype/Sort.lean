...
but is expected to have type
  forall {α : Type.{u1}} [_inst_1 : DecidableEq.{succ u1} α] [_inst_2 : Fintype.{u1} α] [_inst_3 : LinearOrder.{u1} α] {m : Nat} {n : Nat} {s : Finset.{u1} α} (hm : Eq.{1} Nat (Finset.card.{u1} α s) m) (hn : Eq.{1} Nat (Finset.card.{u1} α (HasCompl.compl.{u1} (Finset.{u1} α) (BooleanAlgebra.toHasCompl.{u1} (Finset.{u1} α) (Finset.instBooleanAlgebraFinset.{u1} α _inst_2 (fun (a : α) (b : α) => _inst_1 a b))) s)) n) (i : Fin m), Eq.{succ u1} ((fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.19 : Sum.{0, 0} (Fin m) (Fin n)) => α) (Sum.inl.{0, 0} (Fin m) (Fin n) i)) (FunLike.coe.{succ u1, 1, succ u1} (Equiv.{1, succ u1} (Sum.{0, 0} (Fin m) (Fin n)) α) (Sum.{0, 0} (Fin m) (Fin n)) (fun (_x : Sum.{0, 0} (Fin m) (Fin n)) => (fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.19 : Sum.{0, 0} (Fin m) (Fin n)) => α) _x) (EmbeddingLike.toFunLike.{succ u1, 1, succ u1} (Equiv.{1, succ u1} (Sum.{0, 0} (Fin m) (Fin n)) α) (Sum.{0, 0} (Fin m) (Fin n)) α (EquivLike.toEmbeddingLike.{succ u1, 1, succ u1} (Equiv.{1, succ u1} (Sum.{0, 0} (Fin m) (Fin n)) α) (Sum.{0, 0} (Fin m) (Fin n)) α (Equiv.instEquivLikeEquiv.{1, succ u1} (Sum.{0, 0} (Fin m) (Fin n)) α))) (finSumEquivOfFinset.{u1} α (fun (a : α) (b : α) => _inst_1 a b) _inst_2 _inst_3 m n s hm hn) (Sum.inl.{0, 0} (Fin m) (Fin n) i)) (FunLike.coe.{succ u1, 1, succ u1} (Function.Embedding.{1, succ u1} (Fin m) α) (Fin m) (fun (_x : Fin m) => (fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.19 : Fin m) => α) _x) (EmbeddingLike.toFunLike.{succ u1, 1, succ u1} (Function.Embedding.{1, succ u1} (Fin m) α) (Fin m) α (Function.instEmbeddingLikeEmbedding.{1, succ u1} (Fin m) α)) (RelEmbedding.toEmbedding.{0, u1} (Fin m) α (fun (x._@.Mathlib.Order.Hom.Basic._hyg.744 : Fin m) (x._@.Mathlib.Order.Hom.Basic._hyg.746 : Fin m) => LE.le.{0} (Fin m) (instLEFin m) x._@.Mathlib.Order.Hom.Basic._hyg.744 x._@.Mathlib.Order.Hom.Basic._hyg.746) (fun (x._@.Mathlib.Order.Hom.Basic._hyg.759 : α) (x._@.Mathlib.Order.Hom.Basic._hyg.761 : α) => LE.le.{u1} α (Preorder.toLE.{u1} α (PartialOrder.toPreorder.{u1} α (SemilatticeInf.toPartialOrder.{u1} α (Lattice.toSemilatticeInf.{u1} α (DistribLattice.toLattice.{u1} α (instDistribLattice.{u1} α _inst_3)))))) x._@.Mathlib.Order.Hom.Basic._hyg.759 x._@.Mathlib.Order.Hom.Basic._hyg.761) (Finset.orderEmbOfFin.{u1} α _inst_3 s m hm)) i)
...
but is expected to have type
  forall {α : Type.{u1}} [_inst_1 : DecidableEq.{succ u1} α] [_inst_2 : Fintype.{u1} α] [_inst_3 : LinearOrder.{u1} α] {m : Nat} {n : Nat} {s : Finset.{u1} α} (hm : Eq.{1} Nat (Finset.card.{u1} α s) m) (hn : Eq.{1} Nat (Finset.card.{u1} α (HasCompl.compl.{u1} (Finset.{u1} α) (BooleanAlgebra.toHasCompl.{u1} (Finset.{u1} α) (Finset.instBooleanAlgebraFinset.{u1} α _inst_2 (fun (a : α) (b : α) => _inst_1 a b))) s)) n) (i : Fin n), Eq.{succ u1} ((fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.19 : Sum.{0, 0} (Fin m) (Fin n)) => α) (Sum.inr.{0, 0} (Fin m) (Fin n) i)) (FunLike.coe.{succ u1, 1, succ u1} (Equiv.{1, succ u1} (Sum.{0, 0} (Fin m) (Fin n)) α) (Sum.{0, 0} (Fin m) (Fin n)) (fun (_x : Sum.{0, 0} (Fin m) (Fin n)) => (fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.19 : Sum.{0, 0} (Fin m) (Fin n)) => α) _x) (EmbeddingLike.toFunLike.{succ u1, 1, succ u1} (Equiv.{1, succ u1} (Sum.{0, 0} (Fin m) (Fin n)) α) (Sum.{0, 0} (Fin m) (Fin n)) α (EquivLike.toEmbeddingLike.{succ u1, 1, succ u1} (Equiv.{1, succ u1} (Sum.{0, 0} (Fin m) (Fin n)) α) (Sum.{0, 0} (Fin m) (Fin n)) α (Equiv.instEquivLikeEquiv.{1, succ u1} (Sum.{0, 0} (Fin m) (Fin n)) α))) (finSumEquivOfFinset.{u1} α (fun (a : α) (b : α) => _inst_1 a b) _inst_2 _inst_3 m n s hm hn) (Sum.inr.{0, 0} (Fin m) (Fin n) i)) (FunLike.coe.{succ u1, 1, succ u1} (Function.Embedding.{1, succ u1} (Fin n) α) (Fin n) (fun (_x : Fin n) => (fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.19 : Fin n) => α) _x) (EmbeddingLike.toFunLike.{succ u1, 1, succ u1} (Function.Embedding.{1, succ u1} (Fin n) α) (Fin n) α (Function.instEmbeddingLikeEmbedding.{1, succ u1} (Fin n) α)) (RelEmbedding.toEmbedding.{0, u1} (Fin n) α (fun (x._@.Mathlib.Order.Hom.Basic._hyg.744 : Fin n) (x._@.Mathlib.Order.Hom.Basic._hyg.746 : Fin n) => LE.le.{0} (Fin n) (instLEFin n) x._@.Mathlib.Order.Hom.Basic._hyg.744 x._@.Mathlib.Order.Hom.Basic._hyg.746) (fun (x._@.Mathlib.Order.Hom.Basic._hyg.759 : α) (x._@.Mathlib.Order.Hom.Basic._hyg.761 : α) => LE.le.{u1} α (Preorder.toLE.{u1} α (PartialOrder.toPreorder.{u1} α (SemilatticeInf.toPartialOrder.{u1} α (Lattice.toSemilatticeInf.{u1} α (DistribLattice.toLattice.{u1} α (instDistribLattice.{u1} α _inst_3)))))) x._@.Mathlib.Order.Hom.Basic._hyg.759 x._@.Mathlib.Order.Hom.Basic._hyg.761) (Finset.orderEmbOfFin.{u1} α _inst_3 (HasCompl.compl.{u1} (Finset.{u1} α) (BooleanAlgebra.toHasCompl.{u1} (Finset.{u1} α) (Finset.instBooleanAlgebraFinset.{u1} α _inst_2 (fun (a : α) (b : α) => _inst_1 a b))) s) n hn)) i)
