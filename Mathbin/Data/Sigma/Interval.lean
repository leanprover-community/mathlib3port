...
theorem card_Icc : (Icc a b).card = if h : a.1 = b.1 then (Icc (h.ndrec a.2) b.2).card else 0 :=
...
theorem card_Ico : (Ico a b).card = if h : a.1 = b.1 then (Ico (h.ndrec a.2) b.2).card else 0 :=
  card_sigmaLift _ _ _
...
theorem card_Ioc : (Ioc a b).card = if h : a.1 = b.1 then (Ioc (h.ndrec a.2) b.2).card else 0 :=
  card_sigmaLift _ _ _
...
theorem card_Ioo : (Ioo a b).card = if h : a.1 = b.1 then (Ioo (h.ndrec a.2) b.2).card else 0 :=
  card_sigmaLift _ _ _
