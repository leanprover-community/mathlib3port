...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `sigma_preimage_mk [])
  (Command.declSig
     ...
     (Term.app
      ...
      [(Term.fun
        ...
        (Term.basicFun
         ...
         "=>"
         («term_$__»
          (Term.app `s.preimage [(Term.app `Sigma.mk [`a])])
          "$"
          (Term.app (Term.proj `sigma_mk_injective "." `InjOn) [(Term.hole "_")]))))])
     "="
     (Term.app
      `s.filter
      [(Term.fun
        ...
        (Term.basicFun
         [(Term.simpleBinder [`a] [])]
         "=>"
         (Init.Core.«term_∈_» (Term.proj `a "." (fieldIdx "1")) " ∈ " `t)))]))))
    ...
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group (Tactic.ext "ext" [(Tactic.rcasesPat.one `x)] []) [])
       (group (Tactic.simp "simp" [] [] ["[" [(Tactic.simpLemma [] [] `and_comm)] "]"] []) [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.simp "simp" [] [] ["[" [(Tactic.simpLemma [] [] `and_comm)] "]"] [])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.fun
   "fun"
   (Term.basicFun [(Term.simpleBinder [`a] [])] "=>" (Init.Core.«term_∈_» (Term.proj `a "." (fieldIdx "1")) " ∈ " `t)))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj `sigma_mk_injective "." `InjOn)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  `sigma_mk_injective
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
 ...
 [(Term.app
   ...
   [(Term.fun
     ...
     (Term.basicFun
      ...
      "=>"
      («term_$__»
       (Term.app `s.preimage [(Term.paren "(" [(Term.app `Sigma.mk [`a]) []] ")")])
       "$"
       (Term.app (Term.proj `sigma_mk_injective "." `InjOn) [(Term.hole "_")]))))])
  []]
 ")")
...
theorem
  sigma_preimage_mk
  { β : α → Type _ } [ DecidableEq α ] ( s : Finset Σ a , β a ) ( t : Finset α )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `sigma_preimage_mk_of_subset [])
  (Command.declSig
   [(Term.implicitBinder "{" [`β] [":" (Term.arrow `α "→" (Term.type "Type" [(Level.hole "_")]))] "}")
    (Term.instBinder "[" [] (Term.app `DecidableEq [`α]) "]")
    (Term.explicitBinder
    ...
    (Term.explicitBinder "(" [`ht] [":" (Init.Core.«term_⊆_» (Term.app `s.image [`Sigma.fst]) " ⊆ " `t)] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.rwSeq
         ...
         (Tactic.rwRuleSeq
          "["
          [(Tactic.rwRule [] `sigma_preimage_mk)
           ","
           (Tactic.rwRule
            []
            («term_$__» `filter_true_of_mem "$" (Term.app (Term.proj `image_subset_iff "." (fieldIdx "1")) [`ht])))]
          "]")
         [])
        [])])))
   [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.proj `image_subset_iff "." (fieldIdx "1")) [`ht])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj `image_subset_iff "." (fieldIdx "1"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  `image_subset_iff
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Init.Core.«term_⊆_» (Term.app `s.image [`Sigma.fst]) " ⊆ " `t)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Core.«term_⊆_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `t
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
theorem
  ...
  { β : α → Type _ } [ DecidableEq α ] ( s : Finset Σ a , β a ) { t : Finset α } ( ht : s.image Sigma.fst ⊆ t )
    : t.sigma fun a => s.preimage Sigma.mk a $ sigma_mk_injective . InjOn _ = s
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `sigma_image_fst_preimage_mk [])
  (Command.declSig
   [(Term.implicitBinder "{" [`β] [":" (Term.arrow `α "→" (Term.type "Type" [(Level.hole "_")]))] "}")
    (Term.instBinder "[" [] (Term.app `DecidableEq [`α]) "]")
    (Term.explicitBinder
   ...
   (Term.typeSpec
    ...
    («term_=_»
     (Term.app
      (Term.proj (Term.app `s.image [`Sigma.fst]) "." `Sigma)
      [(Term.fun
        "fun"
        (Term.basicFun
         [(Term.simpleBinder [`a] [])]
     ...
     "="
     `s)))
  (Command.declValSimple ":=" (Term.app `s.sigma_preimage_mk_of_subset [(Term.app `subset.refl [(Term.hole "_")])]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `s.sigma_preimage_mk_of_subset [(Term.app `subset.refl [(Term.hole "_")])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `s.image [`Sigma.fst]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 51 >? 1022, (some 0, term) <=? (some 50, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app
   (Term.proj (Term.paren "(" [(Term.app `s.image [`Sigma.fst]) []] ")") "." `Sigma)
   [(Term.fun
     "fun"
     (Term.basicFun
      [(Term.simpleBinder [`a] [])]
...
theorem
  ...
  { β : α → Type _ } [ DecidableEq α ] ( s : Finset Σ a , β a )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `prod_preimage' [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `CommMonoidₓ [`β]) "]")
    (Term.explicitBinder "(" [`f] [":" (Term.arrow `α "→" `γ)] [] ")")
    (Term.instBinder
     "["
     []
     («term_$__»
      ...
      (Term.fun
       "fun"
       (Term.basicFun [(Term.simpleBinder [`x] [])] "=>" (Init.Core.«term_∈_» `x " ∈ " (Term.app `Set.Range [`f])))))
     "]")
    (Term.explicitBinder "(" [`s] [":" (Term.app `Finset [`γ])] [] ")")
    (Term.explicitBinder
     "("
     [`hf]
     [":" (Term.app `Set.InjOn [`f (Set.Data.Set.Basic.«term_⁻¹'_» `f " ⁻¹' " (Init.Coe.«term↑_» "↑" `s))])]
     []
     ")")
          ...
          [(calcStep
            («term_=_»
             ...
             (Algebra.BigOperators.Basic.«term∏_in_,_»
              ...
              (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `x)] []))
              " in "
              (Term.app `image [`f (Term.app `preimage [`s `f `hf])])
              ", "
              (Term.app `g [`x])))
            ":="
            («term_$__»
                ...
                (Tactic.tacticSeq1Indented
                 [(group
                   (Tactic.simpa
                    ...
                    []
                    ["only"]
                    ["[" [(Tactic.simpLemma [] [] `mem_preimage) "," (Tactic.simpLemma [] [] `inj_on)] "]"]
                    []
                    ["using" `hf])
                   [])]))))))
           (calcStep
              ...
              (Term.app
               ...
               [(Term.fun
                 ...
                 (Term.basicFun
                  [(Term.simpleBinder [`x] [])]
                  "=>"
                  (Init.Core.«term_∈_» `x " ∈ " (Term.app `Set.Range [`f]))))])
              ", "
              (Term.app `g [`x])))
            ":="
            (Term.byTactic
             ...
             (Tactic.tacticSeq
              (Tactic.tacticSeq1Indented
               [(group
                 (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `image_preimage)] "]") [])
                 [])]))))]))
        [])])))
   [])
  []
    ...
    [(calcStep
     ...
     (calcStep
      ...
      (Term.byTactic
       ...
       (Tactic.tacticSeq
        (Tactic.tacticSeq1Indented
         [(group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `image_preimage)] "]") []) [])]))))]))
      ...
      [(group (Tactic.classical "classical") [])
       (group
        (Tactic.rwSeq
         "rw"
         []
         (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `prod_preimage') "," (Tactic.rwRule [] `prod_filter_of_ne)] "]")
         [])
        [])
       (group
        (Tactic.exact
         ...
         (Term.fun
          "fun"
          (Term.basicFun [(Term.simpleBinder [`x `hx] [])] "=>" (Term.app `Not.imp_symm [(Term.app `hg [`x `hx])]))))
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.basicFun.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Not.imp_symm [(Term.app `hg [`x `hx])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
@[ to_additive ]
  theorem
    ...
    := by classical rw [ prod_preimage' , prod_filter_of_ne ] exact fun x hx => Not.imp_symm hg x hx
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `prod_preimage_of_bij [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `CommMonoidₓ [`β]) "]")
    (Term.explicitBinder "(" [`f] [":" (Term.arrow `α "→" `γ)] [] ")")
    (Term.explicitBinder "(" [`s] [":" (Term.app `Finset [`γ])] [] ")")
    (Term.explicitBinder
     ...
     [":"
      (Term.app
       `Set.BijOn
       [`f (Set.Data.Set.Basic.«term_⁻¹'_» `f " ⁻¹' " (Init.Coe.«term↑_» "↑" `s)) (Init.Coe.«term↑_» "↑" `s)])]
     []
     ")")
    (Term.explicitBinder "(" [`g] [":" (Term.arrow `γ "→" `β)] [] ")")]
   (Term.typeSpec
    ...
    («term_=_»
     (Algebra.BigOperators.Basic.«term∏_in_,_»
      ...
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `x)] []))
      " in "
      (Term.app `s.preimage [`f `hf.inj_on])
      ", "
      (Term.app `g [(Term.app `f [`x])]))
     "="
     (Algebra.BigOperators.Basic.«term∏_in_,_»
  ...
  (Command.declValSimple
   ":="
   («term_$__»
    (Term.app `prod_preimage [(Term.hole "_") (Term.hole "_") `hf.inj_on `g])
    "$"
    (Term.fun
     "fun"
     (Term.basicFun
      [(Term.simpleBinder [`x `hxs `hxf] [])]
      "=>"
      (Term.proj («term_$__» `hxf "$" (Term.app `hf.subset_range [`hxs])) "." `elim))))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  («term_$__» `hxf "$" (Term.app `hf.subset_range [`hxs]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `hf.subset_range [`hxs])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
@[ to_additive ]
  theorem
    ...
    [ CommMonoidₓ β ] ( f : α → γ ) ( s : Finset γ ) ( hf : Set.BijOn f f ⁻¹' ↑ s ↑ s ) ( g : γ → β )
