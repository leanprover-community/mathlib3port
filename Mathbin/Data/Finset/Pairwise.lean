...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `pairwise_disjoint.bUnion_finset [])
  (Command.declSig
   [(Term.implicitBinder "{" [`s] [":" (Term.app `Set [`ι'])] "}")
    (Term.implicitBinder "{" [`g] [":" (Term.arrow `ι' "→" (Term.app `Finset [`ι]))] "}")
      ...
      (Term.app
       ...
       [(Term.fun
         ...
         (Term.basicFun
          ...
          "=>"
          (Term.app (Term.proj (Term.app `g [`i']) "." `sup) [`f])))])]
     []
     ")")
    (Term.explicitBinder
     "("
      ...
      (Term.forall
       ...
       (Mathlib.ExtendedBinder.«term∀___,_»
        ...
        (Term.forall
         ...
         (Term.app
          (Term.proj
           (Term.paren "(" [(Term.app `g [`i]) [(Term.typeAscription ":" (Term.app `Set [`ι]))]] ")")
           "."
           `PairwiseDisjoint)
          [`f]))))]
     []
                 ...
                 (Tactic.tacticSeq
                  (Tactic.tacticSeq1Indented
                   [(group
                     (tacticRwa__
                      "rwa"
                      (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `hcd)] "]")
           ...
           [(group
             (Tactic.exact
              ...
              (Term.app
               ...
               [(Term.app `Finset.le_sup [`ha]) (Term.app `Finset.le_sup [`hb])]))
             [])])))
        [])])))
   [])
  []
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Finset.le_sup [`hb]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Finset.le_sup [`ha]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `hs [`hc `hd (Term.app `ne_of_apply_ne [(Term.hole "_") `hcd])]) "." `mono)
...
/--
    ...
    `set.pairwise_disjoint.bUnion`. -/
  theorem
    pairwise_disjoint.bUnion_finset
    { s : Set ι' }
        { g : ι' → Finset ι }
        { f : ι → α }
        ( hs : s.pairwise_disjoint fun i' : ι' => g i' . sup f )
        ( hg : ∀ , ∀ i ∈ s , ∀ , ( g i : Set ι ) . PairwiseDisjoint f )
