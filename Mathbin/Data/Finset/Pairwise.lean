...
theorem PairwiseDisjoint.imageFinsetOfLe [DecidableEq ι] [SemilatticeInf α] [OrderBot α] {s : Finset ι} {f : ι → α}
...
theorem PairwiseDisjoint.bUnionFinset {s : Set ι'} {g : ι' → Finset ι} {f : ι → α}
