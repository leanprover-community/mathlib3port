...
but is expected to have type
  forall {α : Type.{u1}} {s : Finset.{u1} α}, Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α (fun (x._@.Mathlib.Data.Finset.Basic._hyg.25263 : α) => True) (fun (a : α) => instDecidableTrue) s) s
...
but is expected to have type
  forall {α : Type.{u1}} (h : Finset.{u1} α), Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α (fun (x._@.Mathlib.Data.Finset.Basic._hyg.25301 : α) => False) (fun (a : α) => instDecidableFalse) h) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.instEmptyCollectionFinset.{u1} α))
...
but is expected to have type
  forall {α : Type.{u2}} {β : Type.{u1}} (a : α) (s : Finset.{u2} α) (ha : Not (Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) a s)) (f : α -> (Finset.{u1} β)) (H : Set.PairwiseDisjoint.{u1, u2} (Finset.{u1} β) α (Finset.partialOrder.{u1} β) (Finset.instOrderBotFinsetToLEToPreorderPartialOrder.{u1} β) (Finset.toSet.{u2} α (Finset.cons.{u2} α a s ha)) f), Eq.{succ u1} (Finset.{u1} β) (Finset.disjUnionᵢ.{u2, u1} α β (Finset.cons.{u2} α a s ha) f H) (Finset.disjUnion.{u1} β (f a) (Finset.disjUnionᵢ.{u2, u1} α β s f (fun (b : α) (hb : Membership.mem.{u2, u2} α (Set.{u2} α) (Set.instMembershipSet.{u2} α) b (Finset.toSet.{u2} α s)) (c : α) (hc : Membership.mem.{u2, u2} α (Set.{u2} α) (Set.instMembershipSet.{u2} α) c (Finset.toSet.{u2} α s)) => H b (Multiset.mem_cons_of_mem.{u2} α b a (Finset.val.{u2} α s) hb) c (Multiset.mem_cons_of_mem.{u2} α c a (Finset.val.{u2} α s) hc))) (Iff.mpr (Disjoint.{u1} (Finset.{u1} β) (Finset.partialOrder.{u1} β) (Finset.instOrderBotFinsetToLEToPreorderPartialOrder.{u1} β) (f a) (Finset.disjUnionᵢ.{u2, u1} α β s f (fun (b : α) (hb : Membership.mem.{u2, u2} α (Set.{u2} α) (Set.instMembershipSet.{u2} α) b (Finset.toSet.{u2} α s)) (c : α) (hc : Membership.mem.{u2, u2} α (Set.{u2} α) (Set.instMembershipSet.{u2} α) c (Finset.toSet.{u2} α s)) => H b (Multiset.mem_cons_of_mem.{u2} α b a (Finset.val.{u2} α s) hb) c (Multiset.mem_cons_of_mem.{u2} α c a (Finset.val.{u2} α s) hc)))) (forall {{a_1 : β}}, (Membership.mem.{u1, u1} β (Finset.{u1} β) (Finset.instMembershipFinset.{u1} β) a_1 (f a)) -> (Not (Membership.mem.{u1, u1} β (Finset.{u1} β) (Finset.instMembershipFinset.{u1} β) a_1 (Finset.disjUnionᵢ.{u2, u1} α β s f (fun (b : α) (hb : Membership.mem.{u2, u2} α (Set.{u2} α) (Set.instMembershipSet.{u2} α) b (Finset.toSet.{u2} α s)) (c : α) (hc : Membership.mem.{u2, u2} α (Set.{u2} α) (Set.instMembershipSet.{u2} α) c (Finset.toSet.{u2} α s)) => H b (Multiset.mem_cons_of_mem.{u2} α b a (Finset.val.{u2} α s) hb) c (Multiset.mem_cons_of_mem.{u2} α c a (Finset.val.{u2} α s) hc)))))) (Finset.disjoint_left.{u1} β (f a) (Finset.disjUnionᵢ.{u2, u1} α β s f (fun (b : α) (hb : Membership.mem.{u2, u2} α (Set.{u2} α) (Set.instMembershipSet.{u2} α) b (Finset.toSet.{u2} α s)) (c : α) (hc : Membership.mem.{u2, u2} α (Set.{u2} α) (Set.instMembershipSet.{u2} α) c (Finset.toSet.{u2} α s)) => H b (Multiset.mem_cons_of_mem.{u2} α b a (Finset.val.{u2} α s) hb) c (Multiset.mem_cons_of_mem.{u2} α c a (Finset.val.{u2} α s) hc)))) (fun (b : β) (hb : Membership.mem.{u1, u1} β (Finset.{u1} β) (Finset.instMembershipFinset.{u1} β) b (f a)) (h : Membership.mem.{u1, u1} β (Finset.{u1} β) (Finset.instMembershipFinset.{u1} β) b (Finset.disjUnionᵢ.{u2, u1} α β s f (fun (b : α) (hb : Membership.mem.{u2, u2} α (Set.{u2} α) (Set.instMembershipSet.{u2} α) b (Finset.toSet.{u2} α s)) (c : α) (hc : Membership.mem.{u2, u2} α (Set.{u2} α) (Set.instMembershipSet.{u2} α) c (Finset.toSet.{u2} α s)) => H b (Multiset.mem_cons_of_mem.{u2} α b a (Finset.val.{u2} α s) hb) c (Multiset.mem_cons_of_mem.{u2} α c a (Finset.val.{u2} α s) hc)))) => Finset.disjUnionᵢ_cons.match_1.{u2, u1} α β s f b (fun (x._@.Mathlib.Data.Finset.Basic._hyg.32296 : Exists.{succ u2} α (fun (a : α) => And (Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) a s) (Membership.mem.{u1, u1} β (Finset.{u1} β) (Finset.instMembershipFinset.{u1} β) b (f a)))) => False) (Iff.mp (Membership.mem.{u1, u1} β (Finset.{u1} β) (Finset.instMembershipFinset.{u1} β) b (Finset.disjUnionᵢ.{u2, u1} α β s f (fun (x._@.Mathlib.Data.Finset.Basic._hyg.32261 : α) (hb : Membership.mem.{u2, u2} α (Set.{u2} α) (Set.instMembershipSet.{u2} α) x._@.Mathlib.Data.Finset.Basic._hyg.32261 (Finset.toSet.{u2} α s)) (x._@.Mathlib.Data.Finset.Basic._hyg.32264 : α) (hc : Membership.mem.{u2, u2} α (Set.{u2} α) (Set.instMembershipSet.{u2} α) x._@.Mathlib.Data.Finset.Basic._hyg.32264 (Finset.toSet.{u2} α s)) => H x._@.Mathlib.Data.Finset.Basic._hyg.32261 (Multiset.mem_cons_of_mem.{u2} α x._@.Mathlib.Data.Finset.Basic._hyg.32261 a (Finset.val.{u2} α s) hb) x._@.Mathlib.Data.Finset.Basic._hyg.32264 (Multiset.mem_cons_of_mem.{u2} α x._@.Mathlib.Data.Finset.Basic._hyg.32264 a (Finset.val.{u2} α s) hc)))) (Exists.{succ u2} α (fun (a : α) => And (Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) a s) (Membership.mem.{u1, u1} β (Finset.{u1} β) (Finset.instMembershipFinset.{u1} β) b (f a)))) (Finset.mem_disjUnionᵢ.{u2, u1} α β s f b (fun (x._@.Mathlib.Data.Finset.Basic._hyg.32261 : α) (hb : Membership.mem.{u2, u2} α (Set.{u2} α) (Set.instMembershipSet.{u2} α) x._@.Mathlib.Data.Finset.Basic._hyg.32261 (Finset.toSet.{u2} α s)) (x._@.Mathlib.Data.Finset.Basic._hyg.32264 : α) (hc : Membership.mem.{u2, u2} α (Set.{u2} α) (Set.instMembershipSet.{u2} α) x._@.Mathlib.Data.Finset.Basic._hyg.32264 (Finset.toSet.{u2} α s)) => H x._@.Mathlib.Data.Finset.Basic._hyg.32261 (Multiset.mem_cons_of_mem.{u2} α x._@.Mathlib.Data.Finset.Basic._hyg.32261 a (Finset.val.{u2} α s) hb) x._@.Mathlib.Data.Finset.Basic._hyg.32264 (Multiset.mem_cons_of_mem.{u2} α x._@.Mathlib.Data.Finset.Basic._hyg.32264 a (Finset.val.{u2} α s) hc))) h) (fun (w._@.Mathlib.Data.Finset.Basic._hyg.32309 : α) (hc : Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) w._@.Mathlib.Data.Finset.Basic._hyg.32309 s) (h : Membership.mem.{u1, u1} β (Finset.{u1} β) (Finset.instMembershipFinset.{u1} β) b (f w._@.Mathlib.Data.Finset.Basic._hyg.32309)) => Iff.mp (Disjoint.{u1} (Finset.{u1} β) (Finset.partialOrder.{u1} β) (Finset.instOrderBotFinsetToLEToPreorderPartialOrder.{u1} β) (f a) (f w._@.Mathlib.Data.Finset.Basic._hyg.32309)) (forall {{a_1 : β}}, (Membership.mem.{u1, u1} β (Finset.{u1} β) (Finset.instMembershipFinset.{u1} β) a_1 (f a)) -> (Not (Membership.mem.{u1, u1} β (Finset.{u1} β) (Finset.instMembershipFinset.{u1} β) a_1 (f w._@.Mathlib.Data.Finset.Basic._hyg.32309)))) (Finset.disjoint_left.{u1} β (f a) (f w._@.Mathlib.Data.Finset.Basic._hyg.32309)) (H a (Finset.mem_cons_self.{u2} α a s ha) w._@.Mathlib.Data.Finset.Basic._hyg.32309 (Multiset.mem_cons_of_mem.{u2} α w._@.Mathlib.Data.Finset.Basic._hyg.32309 a (Finset.val.{u2} α s) hc) (Ne.symm.{succ u2} α w._@.Mathlib.Data.Finset.Basic._hyg.32309 a (ne_of_mem_of_not_mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) s w._@.Mathlib.Data.Finset.Basic._hyg.32309 a hc ha))) b hb h))))
