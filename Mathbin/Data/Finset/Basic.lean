...
lean 3 declaration is
  forall {α : Type.{u1}} [_inst_1 : DecidableEq.{succ u1} α], Eq.{succ u1} ((Finset.{u1} α) -> (Finset.{u1} α) -> (Finset.{u1} α)) (HasSup.sup.{u1} (Finset.{u1} α) (SemilatticeSup.toHasSup.{u1} (Finset.{u1} α) (Lattice.toSemilatticeSup.{u1} (Finset.{u1} α) (Finset.lattice.{u1} α (fun (a : α) (b : α) => _inst_1 a b))))) (Union.union.{u1} (Finset.{u1} α) (Finset.hasUnion.{u1} α (fun (a : α) (b : α) => _inst_1 a b)))
but is expected to have type
  forall {α : Type.{u1}} [_inst_1 : DecidableEq.{succ u1} α], Eq.{succ u1} ((Finset.{u1} α) -> (Finset.{u1} α) -> (Finset.{u1} α)) (HasSup.sup.{u1} (Finset.{u1} α) (SemilatticeSup.toHasSup.{u1} (Finset.{u1} α) (Lattice.toSemilatticeSup.{u1} (Finset.{u1} α) (Finset.instLatticeFinset.{u1} α (fun (a : α) (b : α) => _inst_1 a b))))) (Union.union.{u1} (Finset.{u1} α) (Finset.instUnionFinset.{u1} α (fun (a : α) (b : α) => _inst_1 a b)))
...
lean 3 declaration is
  forall {α : Type.{u1}} [_inst_1 : DecidableEq.{succ u1} α], Eq.{succ u1} ((Finset.{u1} α) -> (Finset.{u1} α) -> (Finset.{u1} α)) (HasInf.inf.{u1} (Finset.{u1} α) (SemilatticeInf.toHasInf.{u1} (Finset.{u1} α) (Lattice.toSemilatticeInf.{u1} (Finset.{u1} α) (Finset.lattice.{u1} α (fun (a : α) (b : α) => _inst_1 a b))))) (Inter.inter.{u1} (Finset.{u1} α) (Finset.hasInter.{u1} α (fun (a : α) (b : α) => _inst_1 a b)))
but is expected to have type
  forall {α : Type.{u1}} [_inst_1 : DecidableEq.{succ u1} α], Eq.{succ u1} ((Finset.{u1} α) -> (Finset.{u1} α) -> (Finset.{u1} α)) (HasInf.inf.{u1} (Finset.{u1} α) (Lattice.toHasInf.{u1} (Finset.{u1} α) (Finset.instLatticeFinset.{u1} α (fun (a : α) (b : α) => _inst_1 a b)))) (Inter.inter.{u1} (Finset.{u1} α) (Finset.instInterFinset.{u1} α (fun (a : α) (b : α) => _inst_1 a b)))
...
but is expected to have type
  forall {α : Type.{u2}} {ι : Type.{u1}} [hn : Nonempty.{succ u1} ι] {f : ι -> (Set.{u2} α)}, (Directed.{u2, succ u1} (Set.{u2} α) ι (fun (x._@.Mathlib.Data.Finset.Basic._hyg.13290 : Set.{u2} α) (x._@.Mathlib.Data.Finset.Basic._hyg.13292 : Set.{u2} α) => HasSubset.Subset.{u2} (Set.{u2} α) (Set.instHasSubsetSet.{u2} α) x._@.Mathlib.Data.Finset.Basic._hyg.13290 x._@.Mathlib.Data.Finset.Basic._hyg.13292) f) -> (forall {s : Finset.{u2} α}, (HasSubset.Subset.{u2} (Set.{u2} α) (Set.instHasSubsetSet.{u2} α) (Finset.toSet.{u2} α s) (Set.unionᵢ.{u2, succ u1} α ι (fun (i : ι) => f i))) -> (Exists.{succ u1} ι (fun (i : ι) => HasSubset.Subset.{u2} (Set.{u2} α) (Set.instHasSubsetSet.{u2} α) (Finset.toSet.{u2} α s) (f i))))
...
but is expected to have type
  forall {α : Type.{u1}} [_inst_1 : DecidableEq.{succ u1} α] {s : Finset.{u1} α} {t : Finset.{u1} α}, Eq.{succ u1} (Set.{u1} α) (Finset.toSet.{u1} α (symmDiff.{u1} (Finset.{u1} α) (SemilatticeSup.toHasSup.{u1} (Finset.{u1} α) (Lattice.toSemilatticeSup.{u1} (Finset.{u1} α) (Finset.instLatticeFinset.{u1} α (fun (a : α) (b : α) => _inst_1 a b)))) (Finset.instSDiffFinset.{u1} α (fun (a : α) (b : α) => _inst_1 a b)) s t)) (symmDiff.{u1} (Set.{u1} α) (SemilatticeSup.toHasSup.{u1} (Set.{u1} α) (Lattice.toSemilatticeSup.{u1} (Set.{u1} α) (CompleteLattice.toLattice.{u1} (Set.{u1} α) (Order.Coframe.toCompleteLattice.{u1} (Set.{u1} α) (CompleteDistribLattice.toCoframe.{u1} (Set.{u1} α) (CompleteBooleanAlgebra.toCompleteDistribLattice.{u1} (Set.{u1} α) (Set.instCompleteBooleanAlgebraSet.{u1} α))))))) (Set.instSDiffSet.{u1} α) (Finset.toSet.{u1} α s) (Finset.toSet.{u1} α t))
...
/- warning: finset.filter -> Finset.filter is a dubious translation:
lean 3 declaration is
  forall {α : Type.{u1}} (p : α -> Prop) [_inst_1 : DecidablePred.{succ u1} α p], (Finset.{u1} α) -> (Finset.{u1} α)
but is expected to have type
  forall {α : Type.{u1}}, (α -> Bool) -> (Finset.{u1} α) -> (Finset.{u1} α)
Case conversion may be inaccurate. Consider using '#align finset.filter Finset.filterₓ'. -/
/-- `filter p s` is the set of elements of `s` that satisfy `p`. -/
def filter (s : Finset α) : Finset α :=
  ⟨_, s.2.filter p⟩
#align finset.filter Finset.filter

/- warning: finset.filter_val -> Finset.filter_val is a dubious translation:
lean 3 declaration is
  forall {α : Type.{u1}} (p : α -> Prop) [_inst_1 : DecidablePred.{succ u1} α p] (s : Finset.{u1} α), Eq.{succ u1} (Multiset.{u1} α) (Finset.val.{u1} α (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s)) (Multiset.filter.{u1} α p (fun (a : α) => _inst_1 a) (Finset.val.{u1} α s))
but is expected to have type
  forall {α : Type.{u1}} (p : α -> Bool) (_inst_1 : Finset.{u1} α), Eq.{succ u1} (Multiset.{u1} α) (Finset.val.{u1} α (Finset.filter.{u1} α p _inst_1)) (Multiset.filter.{u1} α p (Finset.val.{u1} α _inst_1))
Case conversion may be inaccurate. Consider using '#align finset.filter_val Finset.filter_valₓ'. -/
@[simp]
theorem filter_val (s : Finset α) : (filter p s).1 = s.1.filter p :=
  rfl
#align finset.filter_val Finset.filter_val

/- warning: finset.filter_subset -> Finset.filter_subset is a dubious translation:
lean 3 declaration is
  forall {α : Type.{u1}} (p : α -> Prop) [_inst_1 : DecidablePred.{succ u1} α p] (s : Finset.{u1} α), HasSubset.Subset.{u1} (Finset.{u1} α) (Finset.hasSubset.{u1} α) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s) s
but is expected to have type
  forall {α : Type.{u1}} (p : α -> Bool) (_inst_1 : Finset.{u1} α), HasSubset.Subset.{u1} (Finset.{u1} α) (Finset.instHasSubsetFinset.{u1} α) (Finset.filter.{u1} α p _inst_1) _inst_1
Case conversion may be inaccurate. Consider using '#align finset.filter_subset Finset.filter_subsetₓ'. -/
@[simp]
...
/- warning: finset.mem_filter -> Finset.mem_filter is a dubious translation:
lean 3 declaration is
  forall {α : Type.{u1}} {p : α -> Prop} [_inst_1 : DecidablePred.{succ u1} α p] {s : Finset.{u1} α} {a : α}, Iff (Membership.Mem.{u1, u1} α (Finset.{u1} α) (Finset.hasMem.{u1} α) a (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s)) (And (Membership.Mem.{u1, u1} α (Finset.{u1} α) (Finset.hasMem.{u1} α) a s) (p a))
but is expected to have type
  forall {α : Type.{u1}} {p : α -> Bool} {_inst_1 : Finset.{u1} α} {s : α}, Iff (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) s (Finset.filter.{u1} α p _inst_1)) (And (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) s _inst_1) (Eq.{1} Bool (p s) Bool.true))
Case conversion may be inaccurate. Consider using '#align finset.mem_filter Finset.mem_filterₓ'. -/
@[simp]
theorem mem_filter {s : Finset α} {a : α} : a ∈ s.filter p ↔ a ∈ s ∧ p a :=
  mem_filter
#align finset.mem_filter Finset.mem_filter

/- warning: finset.mem_of_mem_filter -> Finset.mem_of_mem_filter is a dubious translation:
lean 3 declaration is
  forall {α : Type.{u1}} {p : α -> Prop} [_inst_1 : DecidablePred.{succ u1} α p] {s : Finset.{u1} α} (x : α), (Membership.Mem.{u1, u1} α (Finset.{u1} α) (Finset.hasMem.{u1} α) x (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s)) -> (Membership.Mem.{u1, u1} α (Finset.{u1} α) (Finset.hasMem.{u1} α) x s)
but is expected to have type
  forall {α : Type.{u1}} {p : α -> Bool} {_inst_1 : Finset.{u1} α} (s : α), (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) s (Finset.filter.{u1} α p _inst_1)) -> (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) s _inst_1)
Case conversion may be inaccurate. Consider using '#align finset.mem_of_mem_filter Finset.mem_of_mem_filterₓ'. -/
...
but is expected to have type
  forall {α : Type.{u1}} {p : α -> Bool} {_inst_1 : Finset.{u1} α}, Iff (HasSSubset.SSubset.{u1} (Finset.{u1} α) (Finset.instHasSSubsetFinset.{u1} α) (Finset.filter.{u1} α p _inst_1) _inst_1) (Exists.{succ u1} α (fun (x : α) => And (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) x _inst_1) (Not (Eq.{1} Bool (p x) Bool.true))))
...
/- warning: finset.filter_filter -> Finset.filter_filter is a dubious translation:
lean 3 declaration is
  forall {α : Type.{u1}} (p : α -> Prop) (q : α -> Prop) [_inst_1 : DecidablePred.{succ u1} α p] [_inst_2 : DecidablePred.{succ u1} α q] (s : Finset.{u1} α), Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α q (fun (a : α) => _inst_2 a) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s)) (Finset.filter.{u1} α (fun (a : α) => And (p a) (q a)) (fun (a : α) => And.decidable (p a) (q a) (_inst_1 a) (_inst_2 a)) s)
but is expected to have type
  forall {α : Type.{u1}} (p : α -> Bool) (q : α -> Bool) (_inst_1 : Finset.{u1} α), Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α q (Finset.filter.{u1} α p _inst_1)) (Finset.filter.{u1} α (fun (a : α) => Decidable.decide (And (Eq.{1} Bool (p a) Bool.true) (Eq.{1} Bool (q a) Bool.true)) (instDecidableAnd (Eq.{1} Bool (p a) Bool.true) (Eq.{1} Bool (q a) Bool.true) (instDecidableEqBool (p a) Bool.true) (instDecidableEqBool (q a) Bool.true))) _inst_1)
Case conversion may be inaccurate. Consider using '#align finset.filter_filter Finset.filter_filterₓ'. -/
...
but is expected to have type
  forall {α : Type.{u1}} {s : Finset.{u1} α}, Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α (fun (x._@.Mathlib.Data.Finset.Basic._hyg.25565 : α) => Bool.true) s) s
...
but is expected to have type
  forall {α : Type.{u1}} (h : Finset.{u1} α), Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α (fun (x._@.Mathlib.Data.Finset.Basic._hyg.25597 : α) => Bool.false) h) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.instEmptyCollectionFinset.{u1} α))
...
/- warning: finset.filter_eq_self -> Finset.filter_eq_self is a dubious translation:
lean 3 declaration is
  forall {α : Type.{u1}} {p : α -> Prop} [_inst_1 : DecidablePred.{succ u1} α p] (s : Finset.{u1} α), Iff (Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s) s) (forall (x : α), (Membership.Mem.{u1, u1} α (Finset.{u1} α) (Finset.hasMem.{u1} α) x s) -> (p x))
but is expected to have type
  forall {α : Type.{u1}} {p : α -> Bool} (_inst_1 : Finset.{u1} α), Iff (Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α p _inst_1) _inst_1) (forall (x : α), (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) x _inst_1) -> (Eq.{1} Bool (p x) Bool.true))
Case conversion may be inaccurate. Consider using '#align finset.filter_eq_self Finset.filter_eq_selfₓ'. -/
...
/- warning: finset.filter_true_of_mem -> Finset.filter_true_of_mem is a dubious translation:
lean 3 declaration is
  forall {α : Type.{u1}} {p : α -> Prop} [_inst_1 : DecidablePred.{succ u1} α p] {s : Finset.{u1} α}, (forall (x : α), (Membership.Mem.{u1, u1} α (Finset.{u1} α) (Finset.hasMem.{u1} α) x s) -> (p x)) -> (Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s) s)
but is expected to have type
  forall {α : Type.{u1}} {p : α -> Bool} {_inst_1 : Finset.{u1} α}, (forall (x : α), (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) x _inst_1) -> (Eq.{1} Bool (p x) Bool.true)) -> (Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α p _inst_1) _inst_1)
Case conversion may be inaccurate. Consider using '#align finset.filter_true_of_mem Finset.filter_true_of_memₓ'. -/
...
/- warning: finset.filter_false_of_mem -> Finset.filter_false_of_mem is a dubious translation:
lean 3 declaration is
  forall {α : Type.{u1}} {p : α -> Prop} [_inst_1 : DecidablePred.{succ u1} α p] {s : Finset.{u1} α}, (forall (x : α), (Membership.Mem.{u1, u1} α (Finset.{u1} α) (Finset.hasMem.{u1} α) x s) -> (Not (p x))) -> (Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.hasEmptyc.{u1} α)))
but is expected to have type
  forall {α : Type.{u1}} {p : α -> Bool} {_inst_1 : Finset.{u1} α}, (forall (x : α), (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) x _inst_1) -> (Not (Eq.{1} Bool (p x) Bool.true))) -> (Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α p _inst_1) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.instEmptyCollectionFinset.{u1} α)))
Case conversion may be inaccurate. Consider using '#align finset.filter_false_of_mem Finset.filter_false_of_memₓ'. -/
...
/- warning: finset.filter_eq_empty_iff -> Finset.filter_eq_empty_iff is a dubious translation:
lean 3 declaration is
  forall {α : Type.{u1}} {p : α -> Prop} [_inst_1 : DecidablePred.{succ u1} α p] (s : Finset.{u1} α), Iff (Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.hasEmptyc.{u1} α))) (forall (x : α), (Membership.Mem.{u1, u1} α (Finset.{u1} α) (Finset.hasMem.{u1} α) x s) -> (Not (p x)))
but is expected to have type
  forall {α : Type.{u1}} {p : α -> Bool} (_inst_1 : Finset.{u1} α), Iff (Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α p _inst_1) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.instEmptyCollectionFinset.{u1} α))) (forall (x : α), (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) x _inst_1) -> (Not (Eq.{1} Bool (p x) Bool.true)))
Case conversion may be inaccurate. Consider using '#align finset.filter_eq_empty_iff Finset.filter_eq_empty_iffₓ'. -/
...
but is expected to have type
  forall {α : Type.{u1}} {p : α -> Bool} {_inst_1 : Finset.{u1} α}, Iff (Finset.Nonempty.{u1} α (Finset.filter.{u1} α p _inst_1)) (Exists.{succ u1} α (fun (a : α) => And (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) a _inst_1) (Eq.{1} Bool (p a) Bool.true)))
...
/- warning: finset.filter_congr -> Finset.filter_congr is a dubious translation:
lean 3 declaration is
  forall {α : Type.{u1}} {p : α -> Prop} {q : α -> Prop} [_inst_1 : DecidablePred.{succ u1} α p] [_inst_2 : DecidablePred.{succ u1} α q] {s : Finset.{u1} α}, (forall (x : α), (Membership.Mem.{u1, u1} α (Finset.{u1} α) (Finset.hasMem.{u1} α) x s) -> (Iff (p x) (q x))) -> (Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s) (Finset.filter.{u1} α q (fun (a : α) => _inst_2 a) s))
but is expected to have type
  forall {α : Type.{u1}} {p : α -> Bool} {q : α -> Bool} {_inst_1 : Finset.{u1} α}, (forall (x : α), (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) x _inst_1) -> (Iff (Eq.{1} Bool (p x) Bool.true) (Eq.{1} Bool (q x) Bool.true))) -> (Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α p _inst_1) (Finset.filter.{u1} α q _inst_1))
Case conversion may be inaccurate. Consider using '#align finset.filter_congr Finset.filter_congrₓ'. -/
...
/- warning: finset.filter_empty -> Finset.filter_empty is a dubious translation:
lean 3 declaration is
  forall {α : Type.{u1}} (p : α -> Prop) [_inst_1 : DecidablePred.{succ u1} α p], Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.hasEmptyc.{u1} α))) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.hasEmptyc.{u1} α))
but is expected to have type
  forall {α : Type.{u1}} (p : α -> Bool), Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α p (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.instEmptyCollectionFinset.{u1} α))) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.instEmptyCollectionFinset.{u1} α))
Case conversion may be inaccurate. Consider using '#align finset.filter_empty Finset.filter_emptyₓ'. -/
theorem filter_empty : filter p ∅ = ∅ :=
  subset_empty.1 <| filter_subset _ _
#align finset.filter_empty Finset.filter_empty

/- warning: finset.filter_subset_filter -> Finset.filter_subset_filter is a dubious translation:
lean 3 declaration is
  forall {α : Type.{u1}} (p : α -> Prop) [_inst_1 : DecidablePred.{succ u1} α p] {s : Finset.{u1} α} {t : Finset.{u1} α}, (HasSubset.Subset.{u1} (Finset.{u1} α) (Finset.hasSubset.{u1} α) s t) -> (HasSubset.Subset.{u1} (Finset.{u1} α) (Finset.hasSubset.{u1} α) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) t))
but is expected to have type
  forall {α : Type.{u1}} (p : α -> Bool) {_inst_1 : Finset.{u1} α} {s : Finset.{u1} α}, (HasSubset.Subset.{u1} (Finset.{u1} α) (Finset.instHasSubsetFinset.{u1} α) _inst_1 s) -> (HasSubset.Subset.{u1} (Finset.{u1} α) (Finset.instHasSubsetFinset.{u1} α) (Finset.filter.{u1} α p _inst_1) (Finset.filter.{u1} α p s))
Case conversion may be inaccurate. Consider using '#align finset.filter_subset_filter Finset.filter_subset_filterₓ'. -/
...
/- warning: finset.monotone_filter_left -> Finset.monotone_filter_left is a dubious translation:
lean 3 declaration is
  forall {α : Type.{u1}} (p : α -> Prop) [_inst_1 : DecidablePred.{succ u1} α p], Monotone.{u1, u1} (Finset.{u1} α) (Finset.{u1} α) (PartialOrder.toPreorder.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α)) (PartialOrder.toPreorder.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α)) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a))
but is expected to have type
  forall {α : Type.{u1}} (p : α -> Bool), Monotone.{u1, u1} (Finset.{u1} α) (Finset.{u1} α) (PartialOrder.toPreorder.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α)) (PartialOrder.toPreorder.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α)) (Finset.filter.{u1} α p)
Case conversion may be inaccurate. Consider using '#align finset.monotone_filter_left Finset.monotone_filter_leftₓ'. -/
...
but is expected to have type
  forall {α : Type.{u1}} (s : Finset.{u1} α) {{p : α -> Bool}} {{q : α -> Bool}}, (forall (a : α), (Eq.{1} Bool (p a) Bool.true) -> (Eq.{1} Bool (q a) Bool.true)) -> (LE.le.{u1} (Finset.{u1} α) (Preorder.toLE.{u1} (Finset.{u1} α) (PartialOrder.toPreorder.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α))) (Finset.filter.{u1} α p s) (Finset.filter.{u1} α q s))
...
/- warning: finset.coe_filter -> Finset.coe_filter is a dubious translation:
lean 3 declaration is
  forall {α : Type.{u1}} (p : α -> Prop) [_inst_1 : DecidablePred.{succ u1} α p] (s : Finset.{u1} α), Eq.{succ u1} (Set.{u1} α) ((fun (a : Type.{u1}) (b : Type.{u1}) [self : HasLiftT.{succ u1, succ u1} a b] => self.0) (Finset.{u1} α) (Set.{u1} α) (HasLiftT.mk.{succ u1, succ u1} (Finset.{u1} α) (Set.{u1} α) (CoeTCₓ.coe.{succ u1, succ u1} (Finset.{u1} α) (Set.{u1} α) (Finset.Set.hasCoeT.{u1} α))) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s)) (Sep.sep.{u1, u1} α (Set.{u1} α) (Set.hasSep.{u1} α) (fun (x : α) => p x) ((fun (a : Type.{u1}) (b : Type.{u1}) [self : HasLiftT.{succ u1, succ u1} a b] => self.0) (Finset.{u1} α) (Set.{u1} α) (HasLiftT.mk.{succ u1, succ u1} (Finset.{u1} α) (Set.{u1} α) (CoeTCₓ.coe.{succ u1, succ u1} (Finset.{u1} α) (Set.{u1} α) (Finset.Set.hasCoeT.{u1} α))) s))
but is expected to have type
  forall {α : Type.{u1}} (p : α -> Bool) (_inst_1 : Finset.{u1} α), Eq.{succ u1} (Set.{u1} α) (Finset.toSet.{u1} α (Finset.filter.{u1} α p _inst_1)) (setOf.{u1} α (fun (x : α) => And (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) x _inst_1) (Eq.{1} Bool (p x) Bool.true)))
Case conversion may be inaccurate. Consider using '#align finset.coe_filter Finset.coe_filterₓ'. -/
@[simp, norm_cast]
theorem coe_filter (s : Finset α) : ↑(s.filter p) = ({ x ∈ ↑s | p x } : Set α) :=
  Set.ext fun _ => mem_filter
#align finset.coe_filter Finset.coe_filter

/- warning: finset.subset_coe_filter_of_subset_forall -> Finset.subset_coe_filter_of_subset_forall is a dubious translation:
lean 3 declaration is
  forall {α : Type.{u1}} (p : α -> Prop) [_inst_1 : DecidablePred.{succ u1} α p] (s : Finset.{u1} α) {t : Set.{u1} α}, (HasSubset.Subset.{u1} (Set.{u1} α) (Set.hasSubset.{u1} α) t ((fun (a : Type.{u1}) (b : Type.{u1}) [self : HasLiftT.{succ u1, succ u1} a b] => self.0) (Finset.{u1} α) (Set.{u1} α) (HasLiftT.mk.{succ u1, succ u1} (Finset.{u1} α) (Set.{u1} α) (CoeTCₓ.coe.{succ u1, succ u1} (Finset.{u1} α) (Set.{u1} α) (Finset.Set.hasCoeT.{u1} α))) s)) -> (forall (x : α), (Membership.Mem.{u1, u1} α (Set.{u1} α) (Set.hasMem.{u1} α) x t) -> (p x)) -> (HasSubset.Subset.{u1} (Set.{u1} α) (Set.hasSubset.{u1} α) t ((fun (a : Type.{u1}) (b : Type.{u1}) [self : HasLiftT.{succ u1, succ u1} a b] => self.0) (Finset.{u1} α) (Set.{u1} α) (HasLiftT.mk.{succ u1, succ u1} (Finset.{u1} α) (Set.{u1} α) (CoeTCₓ.coe.{succ u1, succ u1} (Finset.{u1} α) (Set.{u1} α) (Finset.Set.hasCoeT.{u1} α))) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s)))
but is expected to have type
  forall {α : Type.{u1}} (p : α -> Bool) (_inst_1 : Finset.{u1} α) {s : Set.{u1} α}, (HasSubset.Subset.{u1} (Set.{u1} α) (Set.instHasSubsetSet.{u1} α) s (Finset.toSet.{u1} α _inst_1)) -> (forall (x : α), (Membership.mem.{u1, u1} α (Set.{u1} α) (Set.instMembershipSet.{u1} α) x s) -> (Eq.{1} Bool (p x) Bool.true)) -> (HasSubset.Subset.{u1} (Set.{u1} α) (Set.instHasSubsetSet.{u1} α) s (Finset.toSet.{u1} α (Finset.filter.{u1} α p _inst_1)))
Case conversion may be inaccurate. Consider using '#align finset.subset_coe_filter_of_subset_forall Finset.subset_coe_filter_of_subset_forallₓ'. -/
...
/- warning: finset.filter_singleton -> Finset.filter_singleton is a dubious translation:
lean 3 declaration is
  forall {α : Type.{u1}} (p : α -> Prop) [_inst_1 : DecidablePred.{succ u1} α p] (a : α), Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.hasSingleton.{u1} α) a)) (ite.{succ u1} (Finset.{u1} α) (p a) (_inst_1 a) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.hasSingleton.{u1} α) a) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.hasEmptyc.{u1} α)))
but is expected to have type
  forall {α : Type.{u1}} (p : α -> Bool) (_inst_1 : α), Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α p (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.instSingletonFinset.{u1} α) _inst_1)) (ite.{succ u1} (Finset.{u1} α) (Eq.{1} Bool (p _inst_1) Bool.true) (instDecidableEqBool (p _inst_1) Bool.true) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.instSingletonFinset.{u1} α) _inst_1) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.instEmptyCollectionFinset.{u1} α)))
Case conversion may be inaccurate. Consider using '#align finset.filter_singleton Finset.filter_singletonₓ'. -/
...
/- warning: finset.filter_cons_of_pos -> Finset.filter_cons_of_pos is a dubious translation:
lean 3 declaration is
  forall {α : Type.{u1}} (p : α -> Prop) [_inst_1 : DecidablePred.{succ u1} α p] (a : α) (s : Finset.{u1} α) (ha : Not (Membership.Mem.{u1, u1} α (Finset.{u1} α) (Finset.hasMem.{u1} α) a s)), (p a) -> (Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) (Finset.cons.{u1} α a s ha)) (Finset.cons.{u1} α a (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s) (Iff.mpr (Not (Membership.Mem.{u1, u1} α (Finset.{u1} α) (Finset.hasMem.{u1} α) a (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s))) (Not (And (Membership.Mem.{u1, u1} α (Finset.{u1} α) (Finset.hasMem.{u1} α) a s) (p a))) (Iff.not (Membership.Mem.{u1, u1} α (Finset.{u1} α) (Finset.hasMem.{u1} α) a (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s)) (And (Membership.Mem.{u1, u1} α (Finset.{u1} α) (Finset.hasMem.{u1} α) a s) (p a)) (Finset.mem_filter.{u1} α p (fun (a : α) => _inst_1 a) s a)) (mt (And (Membership.Mem.{u1, u1} α (Finset.{u1} α) (Finset.hasMem.{u1} α) a s) (p a)) (Membership.Mem.{u1, u1} α (Finset.{u1} α) (Finset.hasMem.{u1} α) a s) (And.left (Membership.Mem.{u1, u1} α (Finset.{u1} α) (Finset.hasMem.{u1} α) a s) (p a)) ha))))
but is expected to have type
  forall {α : Type.{u1}} (p : α -> Bool) (_inst_1 : α) (a : Finset.{u1} α) (s : Not (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) _inst_1 a)), (Eq.{1} Bool (p _inst_1) Bool.true) -> (Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α p (Finset.cons.{u1} α _inst_1 a s)) (Finset.cons.{u1} α _inst_1 (Finset.filter.{u1} α p a) (Iff.mpr (Not (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) _inst_1 (Finset.filter.{u1} α p a))) (Not (And (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) _inst_1 a) (Eq.{1} Bool (p _inst_1) Bool.true))) (Iff.not (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) _inst_1 (Finset.filter.{u1} α p a)) (And (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) _inst_1 a) (Eq.{1} Bool (p _inst_1) Bool.true)) (Finset.mem_filter.{u1} α p a _inst_1)) (mt (And (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) _inst_1 a) (Eq.{1} Bool (p _inst_1) Bool.true)) (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) _inst_1 a) (And.left (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) _inst_1 a) (Eq.{1} Bool (p _inst_1) Bool.true)) s))))
Case conversion may be inaccurate. Consider using '#align finset.filter_cons_of_pos Finset.filter_cons_of_posₓ'. -/
...
/- warning: finset.filter_cons_of_neg -> Finset.filter_cons_of_neg is a dubious translation:
lean 3 declaration is
  forall {α : Type.{u1}} (p : α -> Prop) [_inst_1 : DecidablePred.{succ u1} α p] (a : α) (s : Finset.{u1} α) (ha : Not (Membership.Mem.{u1, u1} α (Finset.{u1} α) (Finset.hasMem.{u1} α) a s)), (Not (p a)) -> (Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) (Finset.cons.{u1} α a s ha)) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s))
but is expected to have type
  forall {α : Type.{u1}} (p : α -> Bool) (_inst_1 : α) (a : Finset.{u1} α) (s : Not (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) _inst_1 a)), (Not (Eq.{1} Bool (p _inst_1) Bool.true)) -> (Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α p (Finset.cons.{u1} α _inst_1 a s)) (Finset.filter.{u1} α p a))
Case conversion may be inaccurate. Consider using '#align finset.filter_cons_of_neg Finset.filter_cons_of_negₓ'. -/
...
but is expected to have type
  forall {α : Type.{u1}} {s : Finset.{u1} α} {p : α -> Bool} {q : α -> Bool}, Iff (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.instOrderBotFinsetToLEToPreorderPartialOrder.{u1} α) (Finset.filter.{u1} α p s) (Finset.filter.{u1} α q s)) (forall (x : α), (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) x s) -> (Eq.{1} Bool (p x) Bool.true) -> (Not (Eq.{1} Bool (q x) Bool.true)))
...
but is expected to have type
  forall {α : Type.{u1}} {s : Finset.{u1} α} {t : Finset.{u1} α} {p : α -> Bool} {q : α -> Bool}, (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.instOrderBotFinsetToLEToPreorderPartialOrder.{u1} α) s t) -> (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.instOrderBotFinsetToLEToPreorderPartialOrder.{u1} α) (Finset.filter.{u1} α p s) (Finset.filter.{u1} α q t))
...
but is expected to have type
  forall {α : Type.{u1}} (s : Finset.{u1} α) (t : Finset.{u1} α) {p : α -> Bool} {q : α -> Bool}, (Disjoint.{u1} (α -> Bool) (Pi.partialOrder.{u1, 0} α (fun (a._@.Mathlib.Data.Finset.Basic._hyg.26627 : α) => Bool) (fun (i : α) => SemilatticeInf.toPartialOrder.{0} Bool (Lattice.toSemilatticeInf.{0} Bool (GeneralizedCoheytingAlgebra.toLattice.{0} Bool (CoheytingAlgebra.toGeneralizedCoheytingAlgebra.{0} Bool (BiheytingAlgebra.toCoheytingAlgebra.{0} Bool (BooleanAlgebra.toBiheytingAlgebra.{0} Bool instBooleanAlgebraBool))))))) (Pi.orderBot.{u1, 0} α (fun (a._@.Mathlib.Data.Finset.Basic._hyg.26627 : α) => Bool) (fun (i : α) => Preorder.toLE.{0} ((fun (i : α) => (fun (a._@.Mathlib.Data.Finset.Basic._hyg.26627 : α) => Bool) i) i) ((fun (i : α) => PartialOrder.toPreorder.{0} ((fun (a._@.Mathlib.Data.Finset.Basic._hyg.26627 : α) => Bool) i) ((fun (i : α) => SemilatticeInf.toPartialOrder.{0} Bool (Lattice.toSemilatticeInf.{0} Bool (GeneralizedCoheytingAlgebra.toLattice.{0} Bool (CoheytingAlgebra.toGeneralizedCoheytingAlgebra.{0} Bool (BiheytingAlgebra.toCoheytingAlgebra.{0} Bool (BooleanAlgebra.toBiheytingAlgebra.{0} Bool instBooleanAlgebraBool)))))) i)) i)) (fun (i : α) => BoundedOrder.toOrderBot.{0} Bool (Preorder.toLE.{0} Bool (PartialOrder.toPreorder.{0} Bool (SemilatticeInf.toPartialOrder.{0} Bool (Lattice.toSemilatticeInf.{0} Bool (GeneralizedCoheytingAlgebra.toLattice.{0} Bool (CoheytingAlgebra.toGeneralizedCoheytingAlgebra.{0} Bool (BiheytingAlgebra.toCoheytingAlgebra.{0} Bool (BooleanAlgebra.toBiheytingAlgebra.{0} Bool instBooleanAlgebraBool)))))))) Bool.boundedOrder)) p q) -> (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.instOrderBotFinsetToLEToPreorderPartialOrder.{u1} α) (Finset.filter.{u1} α p s) (Finset.filter.{u1} α q t))
...
but is expected to have type
  forall {α : Type.{u1}} (s : Finset.{u1} α) (t : Finset.{u1} α) (p : α -> Bool), Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.instOrderBotFinsetToLEToPreorderPartialOrder.{u1} α) (Finset.filter.{u1} α p s) (Finset.filter.{u1} α (fun (a : α) => Decidable.decide (Not (Eq.{1} Bool (p a) Bool.true)) (instDecidableNot (Eq.{1} Bool (p a) Bool.true) (instDecidableEqBool (p a) Bool.true))) t)
...
but is expected to have type
  forall {α : Type.{u1}} (p : α -> Bool) (_inst_1 : Finset.{u1} α) (s : Finset.{u1} α) (t : Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.instOrderBotFinsetToLEToPreorderPartialOrder.{u1} α) _inst_1 s), Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α p (Finset.disjUnion.{u1} α _inst_1 s t)) (Finset.disjUnion.{u1} α (Finset.filter.{u1} α p _inst_1) (Finset.filter.{u1} α p s) (Finset.disjoint_filter_filter.{u1} α _inst_1 s p p t))
...
/- warning: finset.filter_cons -> Finset.filter_cons is a dubious translation:
lean 3 declaration is
  forall {α : Type.{u1}} (p : α -> Prop) [_inst_1 : DecidablePred.{succ u1} α p] {a : α} (s : Finset.{u1} α) (ha : Not (Membership.Mem.{u1, u1} α (Finset.{u1} α) (Finset.hasMem.{u1} α) a s)), Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) (Finset.cons.{u1} α a s ha)) (Finset.disjUnion.{u1} α (ite.{succ u1} (Finset.{u1} α) (p a) (_inst_1 a) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.hasSingleton.{u1} α) a) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.hasEmptyc.{u1} α))) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s) (dite.{0} (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.orderBot.{u1} α) (ite.{succ u1} (Finset.{u1} α) (p a) (_inst_1 a) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.hasSingleton.{u1} α) a) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.hasEmptyc.{u1} α))) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s)) (p a) (_inst_1 a) (fun (h : p a) => Eq.mpr.{0} (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.orderBot.{u1} α) (ite.{succ u1} (Finset.{u1} α) (p a) (_inst_1 a) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.hasSingleton.{u1} α) a) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.hasEmptyc.{u1} α))) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s)) (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.orderBot.{u1} α) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.hasSingleton.{u1} α) a) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s)) (id_tag Tactic.IdTag.simp (Eq.{1} Prop (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.orderBot.{u1} α) (ite.{succ u1} (Finset.{u1} α) (p a) (_inst_1 a) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.hasSingleton.{u1} α) a) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.hasEmptyc.{u1} α))) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s)) (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.orderBot.{u1} α) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.hasSingleton.{u1} α) a) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s))) ((fun [_inst_2 : OrderBot.{u1} (Finset.{u1} α) (Preorder.toLE.{u1} (Finset.{u1} α) (PartialOrder.toPreorder.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α)))] (a : Finset.{u1} α) (a_1 : Finset.{u1} α) (e_2 : Eq.{succ u1} (Finset.{u1} α) a a_1) (b : Finset.{u1} α) (b_1 : Finset.{u1} α) (e_3 : Eq.{succ u1} (Finset.{u1} α) b b_1) => congr.{succ u1, 1} (Finset.{u1} α) Prop (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) _inst_2 a) (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) _inst_2 a_1) b b_1 (congr_arg.{succ u1, succ u1} (Finset.{u1} α) ((Finset.{u1} α) -> Prop) a a_1 (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) _inst_2) e_2) e_3) (Finset.orderBot.{u1} α) (ite.{succ u1} (Finset.{u1} α) (p a) (_inst_1 a) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.hasSingleton.{u1} α) a) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.hasEmptyc.{u1} α))) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.hasSingleton.{u1} α) a) (if_pos.{succ u1} (p a) (_inst_1 a) h (Finset.{u1} α) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.hasSingleton.{u1} α) a) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.hasEmptyc.{u1} α))) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s) (rfl.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s)))) (Eq.mpr.{0} (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.orderBot.{u1} α) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.hasSingleton.{u1} α) a) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s)) (Not (Membership.Mem.{u1, u1} α (Finset.{u1} α) (Finset.hasMem.{u1} α) a (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s))) (id_tag Tactic.IdTag.rw (Eq.{1} Prop (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.orderBot.{u1} α) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.hasSingleton.{u1} α) a) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s)) (Not (Membership.Mem.{u1, u1} α (Finset.{u1} α) (Finset.hasMem.{u1} α) a (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s)))) (Eq.ndrec.{0, 1} Prop (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.orderBot.{u1} α) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.hasSingleton.{u1} α) a) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s)) (fun (_a : Prop) => Eq.{1} Prop (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.orderBot.{u1} α) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.hasSingleton.{u1} α) a) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s)) _a) (rfl.{1} Prop (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.orderBot.{u1} α) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.hasSingleton.{u1} α) a) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s))) (Not (Membership.Mem.{u1, u1} α (Finset.{u1} α) (Finset.hasMem.{u1} α) a (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s))) (propext (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.orderBot.{u1} α) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.hasSingleton.{u1} α) a) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s)) (Not (Membership.Mem.{u1, u1} α (Finset.{u1} α) (Finset.hasMem.{u1} α) a (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s))) (Finset.disjoint_singleton_left.{u1} α (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s) a)))) (Iff.mpr (Not (Membership.Mem.{u1, u1} α (Finset.{u1} α) (Finset.hasMem.{u1} α) a (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s))) (Not (And (Membership.Mem.{u1, u1} α (Finset.{u1} α) (Finset.hasMem.{u1} α) a s) (p a))) (Iff.not (Membership.Mem.{u1, u1} α (Finset.{u1} α) (Finset.hasMem.{u1} α) a (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s)) (And (Membership.Mem.{u1, u1} α (Finset.{u1} α) (Finset.hasMem.{u1} α) a s) (p a)) (Finset.mem_filter.{u1} α p (fun (a : α) => _inst_1 a) s a)) (mt (And (Membership.Mem.{u1, u1} α (Finset.{u1} α) (Finset.hasMem.{u1} α) a s) (p a)) (Membership.Mem.{u1, u1} α (Finset.{u1} α) (Finset.hasMem.{u1} α) a s) (And.left (Membership.Mem.{u1, u1} α (Finset.{u1} α) (Finset.hasMem.{u1} α) a s) (p a)) ha)))) (fun (h : Not (p a)) => Eq.mpr.{0} (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.orderBot.{u1} α) (ite.{succ u1} (Finset.{u1} α) (p a) (_inst_1 a) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.hasSingleton.{u1} α) a) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.hasEmptyc.{u1} α))) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s)) (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.orderBot.{u1} α) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.hasEmptyc.{u1} α)) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s)) (id_tag Tactic.IdTag.simp (Eq.{1} Prop (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.orderBot.{u1} α) (ite.{succ u1} (Finset.{u1} α) (p a) (_inst_1 a) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.hasSingleton.{u1} α) a) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.hasEmptyc.{u1} α))) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s)) (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.orderBot.{u1} α) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.hasEmptyc.{u1} α)) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s))) ((fun [_inst_2 : OrderBot.{u1} (Finset.{u1} α) (Preorder.toLE.{u1} (Finset.{u1} α) (PartialOrder.toPreorder.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α)))] (a : Finset.{u1} α) (a_1 : Finset.{u1} α) (e_2 : Eq.{succ u1} (Finset.{u1} α) a a_1) (b : Finset.{u1} α) (b_1 : Finset.{u1} α) (e_3 : Eq.{succ u1} (Finset.{u1} α) b b_1) => congr.{succ u1, 1} (Finset.{u1} α) Prop (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) _inst_2 a) (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) _inst_2 a_1) b b_1 (congr_arg.{succ u1, succ u1} (Finset.{u1} α) ((Finset.{u1} α) -> Prop) a a_1 (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) _inst_2) e_2) e_3) (Finset.orderBot.{u1} α) (ite.{succ u1} (Finset.{u1} α) (p a) (_inst_1 a) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.hasSingleton.{u1} α) a) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.hasEmptyc.{u1} α))) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.hasEmptyc.{u1} α)) (if_neg.{succ u1} (p a) (_inst_1 a) h (Finset.{u1} α) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.hasSingleton.{u1} α) a) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.hasEmptyc.{u1} α))) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s) (rfl.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s)))) (Finset.disjoint_empty_left.{u1} α (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s)))))
but is expected to have type
  forall {α : Type.{u1}} (p : α -> Bool) {_inst_1 : α} (a : Finset.{u1} α) (s : Not (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) _inst_1 a)), Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α p (Finset.cons.{u1} α _inst_1 a s)) (Finset.disjUnion.{u1} α (ite.{succ u1} (Finset.{u1} α) (Eq.{1} Bool (p _inst_1) Bool.true) (instDecidableEqBool (p _inst_1) Bool.true) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.instSingletonFinset.{u1} α) _inst_1) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.instEmptyCollectionFinset.{u1} α))) (Finset.filter.{u1} α p a) (Or.casesOn (Eq.{1} Bool (p _inst_1) Bool.true) (Not (Eq.{1} Bool (p _inst_1) Bool.true)) (fun (x : Or (Eq.{1} Bool (p _inst_1) Bool.true) (Not (Eq.{1} Bool (p _inst_1) Bool.true))) => Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.instOrderBotFinsetToLEToPreorderPartialOrder.{u1} α) (ite.{succ u1} (Finset.{u1} α) (Eq.{1} Bool (p _inst_1) Bool.true) (instDecidableEqBool (p _inst_1) Bool.true) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.instSingletonFinset.{u1} α) _inst_1) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.instEmptyCollectionFinset.{u1} α))) (Finset.filter.{u1} α p a)) (Classical.em (Eq.{1} Bool (p _inst_1) Bool.true)) (fun (h._@.Mathlib.Data.Finset.Basic._hyg.26878 : Eq.{1} Bool (p _inst_1) Bool.true) => Eq.mpr.{0} (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.instOrderBotFinsetToLEToPreorderPartialOrder.{u1} α) (ite.{succ u1} (Finset.{u1} α) (Eq.{1} Bool (p _inst_1) Bool.true) (instDecidableEqBool (p _inst_1) Bool.true) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.instSingletonFinset.{u1} α) _inst_1) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.instEmptyCollectionFinset.{u1} α))) (Finset.filter.{u1} α p a)) (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.instOrderBotFinsetToLEToPreorderPartialOrder.{u1} α) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.instSingletonFinset.{u1} α) _inst_1) (Finset.filter.{u1} α p a)) (id.{0} (Eq.{1} Prop (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.instOrderBotFinsetToLEToPreorderPartialOrder.{u1} α) (ite.{succ u1} (Finset.{u1} α) (Eq.{1} Bool (p _inst_1) Bool.true) (instDecidableEqBool (p _inst_1) Bool.true) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.instSingletonFinset.{u1} α) _inst_1) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.instEmptyCollectionFinset.{u1} α))) (Finset.filter.{u1} α p a)) (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.instOrderBotFinsetToLEToPreorderPartialOrder.{u1} α) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.instSingletonFinset.{u1} α) _inst_1) (Finset.filter.{u1} α p a))) (congrFun.{succ u1, 1} (Finset.{u1} α) (fun (b : Finset.{u1} α) => Prop) (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.instOrderBotFinsetToLEToPreorderPartialOrder.{u1} α) (ite.{succ u1} (Finset.{u1} α) (Eq.{1} Bool (p _inst_1) Bool.true) (instDecidableEqBool (p _inst_1) Bool.true) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.instSingletonFinset.{u1} α) _inst_1) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.instEmptyCollectionFinset.{u1} α)))) (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.instOrderBotFinsetToLEToPreorderPartialOrder.{u1} α) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.instSingletonFinset.{u1} α) _inst_1)) (congrArg.{succ u1, succ u1} (Finset.{u1} α) ((Finset.{u1} α) -> Prop) (ite.{succ u1} (Finset.{u1} α) (Eq.{1} Bool (p _inst_1) Bool.true) (instDecidableEqBool (p _inst_1) Bool.true) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.instSingletonFinset.{u1} α) _inst_1) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.instEmptyCollectionFinset.{u1} α))) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.instSingletonFinset.{u1} α) _inst_1) (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.instOrderBotFinsetToLEToPreorderPartialOrder.{u1} α)) (if_pos.{succ u1} (Eq.{1} Bool (p _inst_1) Bool.true) (instDecidableEqBool (p _inst_1) Bool.true) h._@.Mathlib.Data.Finset.Basic._hyg.26878 (Finset.{u1} α) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.instSingletonFinset.{u1} α) _inst_1) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.instEmptyCollectionFinset.{u1} α)))) (Finset.filter.{u1} α p a))) (Eq.mpr.{0} (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.instOrderBotFinsetToLEToPreorderPartialOrder.{u1} α) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.instSingletonFinset.{u1} α) _inst_1) (Finset.filter.{u1} α p a)) (Not (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) _inst_1 (Finset.filter.{u1} α p a))) (id.{0} (Eq.{1} Prop (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.instOrderBotFinsetToLEToPreorderPartialOrder.{u1} α) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.instSingletonFinset.{u1} α) _inst_1) (Finset.filter.{u1} α p a)) (Not (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) _inst_1 (Finset.filter.{u1} α p a)))) (Eq.ndrec.{0, 1} Prop (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.instOrderBotFinsetToLEToPreorderPartialOrder.{u1} α) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.instSingletonFinset.{u1} α) _inst_1) (Finset.filter.{u1} α p a)) (fun (_a : Prop) => Eq.{1} Prop (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.instOrderBotFinsetToLEToPreorderPartialOrder.{u1} α) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.instSingletonFinset.{u1} α) _inst_1) (Finset.filter.{u1} α p a)) _a) (Eq.refl.{1} Prop (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.instOrderBotFinsetToLEToPreorderPartialOrder.{u1} α) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.instSingletonFinset.{u1} α) _inst_1) (Finset.filter.{u1} α p a))) (Not (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) _inst_1 (Finset.filter.{u1} α p a))) (propext (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.instOrderBotFinsetToLEToPreorderPartialOrder.{u1} α) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.instSingletonFinset.{u1} α) _inst_1) (Finset.filter.{u1} α p a)) (Not (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) _inst_1 (Finset.filter.{u1} α p a))) (Finset.disjoint_singleton_left.{u1} α (Finset.filter.{u1} α p a) _inst_1)))) (Iff.mpr (Not (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) _inst_1 (Finset.filter.{u1} α p a))) (Not (And (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) _inst_1 a) (Eq.{1} Bool (p _inst_1) Bool.true))) (Iff.not (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) _inst_1 (Finset.filter.{u1} α p a)) (And (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) _inst_1 a) (Eq.{1} Bool (p _inst_1) Bool.true)) (Finset.mem_filter.{u1} α p a _inst_1)) (mt (And (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) _inst_1 a) (Eq.{1} Bool (p _inst_1) Bool.true)) (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) _inst_1 a) (And.left (Membership.mem.{u1, u1} α (Finset.{u1} α) (Finset.instMembershipFinset.{u1} α) _inst_1 a) (Eq.{1} Bool (p _inst_1) Bool.true)) s)))) (fun (h._@.Mathlib.Data.Finset.Basic._hyg.26878 : Not (Eq.{1} Bool (p _inst_1) Bool.true)) => Eq.mpr.{0} (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.instOrderBotFinsetToLEToPreorderPartialOrder.{u1} α) (ite.{succ u1} (Finset.{u1} α) (Eq.{1} Bool (p _inst_1) Bool.true) (instDecidableEqBool (p _inst_1) Bool.true) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.instSingletonFinset.{u1} α) _inst_1) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.instEmptyCollectionFinset.{u1} α))) (Finset.filter.{u1} α p a)) (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.instOrderBotFinsetToLEToPreorderPartialOrder.{u1} α) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.instEmptyCollectionFinset.{u1} α)) (Finset.filter.{u1} α p a)) (id.{0} (Eq.{1} Prop (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.instOrderBotFinsetToLEToPreorderPartialOrder.{u1} α) (ite.{succ u1} (Finset.{u1} α) (Eq.{1} Bool (p _inst_1) Bool.true) (instDecidableEqBool (p _inst_1) Bool.true) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.instSingletonFinset.{u1} α) _inst_1) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.instEmptyCollectionFinset.{u1} α))) (Finset.filter.{u1} α p a)) (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.instOrderBotFinsetToLEToPreorderPartialOrder.{u1} α) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.instEmptyCollectionFinset.{u1} α)) (Finset.filter.{u1} α p a))) (congrFun.{succ u1, 1} (Finset.{u1} α) (fun (b : Finset.{u1} α) => Prop) (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.instOrderBotFinsetToLEToPreorderPartialOrder.{u1} α) (ite.{succ u1} (Finset.{u1} α) (Eq.{1} Bool (p _inst_1) Bool.true) (instDecidableEqBool (p _inst_1) Bool.true) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.instSingletonFinset.{u1} α) _inst_1) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.instEmptyCollectionFinset.{u1} α)))) (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.instOrderBotFinsetToLEToPreorderPartialOrder.{u1} α) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.instEmptyCollectionFinset.{u1} α))) (congrArg.{succ u1, succ u1} (Finset.{u1} α) ((Finset.{u1} α) -> Prop) (ite.{succ u1} (Finset.{u1} α) (Eq.{1} Bool (p _inst_1) Bool.true) (instDecidableEqBool (p _inst_1) Bool.true) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.instSingletonFinset.{u1} α) _inst_1) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.instEmptyCollectionFinset.{u1} α))) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.instEmptyCollectionFinset.{u1} α)) (Disjoint.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α) (Finset.instOrderBotFinsetToLEToPreorderPartialOrder.{u1} α)) (if_neg.{succ u1} (Eq.{1} Bool (p _inst_1) Bool.true) (instDecidableEqBool (p _inst_1) Bool.true) h._@.Mathlib.Data.Finset.Basic._hyg.26878 (Finset.{u1} α) (Singleton.singleton.{u1, u1} α (Finset.{u1} α) (Finset.instSingletonFinset.{u1} α) _inst_1) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.instEmptyCollectionFinset.{u1} α)))) (Finset.filter.{u1} α p a))) (Finset.disjoint_empty_left.{u1} α (Finset.filter.{u1} α p a)))))
Case conversion may be inaccurate. Consider using '#align finset.filter_cons Finset.filter_consₓ'. -/
...
/- warning: finset.filter_union -> Finset.filter_union is a dubious translation:
lean 3 declaration is
  forall {α : Type.{u1}} (p : α -> Prop) [_inst_1 : DecidablePred.{succ u1} α p] [_inst_3 : DecidableEq.{succ u1} α] (s₁ : Finset.{u1} α) (s₂ : Finset.{u1} α), Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) (Union.union.{u1} (Finset.{u1} α) (Finset.hasUnion.{u1} α (fun (a : α) (b : α) => _inst_3 a b)) s₁ s₂)) (Union.union.{u1} (Finset.{u1} α) (Finset.hasUnion.{u1} α (fun (a : α) (b : α) => _inst_3 a b)) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s₁) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s₂))
but is expected to have type
  forall {α : Type.{u1}} (p : α -> Bool) [_inst_1 : DecidableEq.{succ u1} α] (_inst_3 : Finset.{u1} α) (s₁ : Finset.{u1} α), Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α p (Union.union.{u1} (Finset.{u1} α) (Finset.instUnionFinset.{u1} α (fun (a : α) (b : α) => _inst_1 a b)) _inst_3 s₁)) (Union.union.{u1} (Finset.{u1} α) (Finset.instUnionFinset.{u1} α (fun (a : α) (b : α) => _inst_1 a b)) (Finset.filter.{u1} α p _inst_3) (Finset.filter.{u1} α p s₁))
Case conversion may be inaccurate. Consider using '#align finset.filter_union Finset.filter_unionₓ'. -/
theorem filter_union (s₁ s₂ : Finset α) : (s₁ ∪ s₂).filter p = s₁.filter p ∪ s₂.filter p :=
  ext fun _ => by simp only [mem_filter, mem_union, or_and_right]
#align finset.filter_union Finset.filter_union

/- warning: finset.filter_union_right -> Finset.filter_union_right is a dubious translation:
lean 3 declaration is
  forall {α : Type.{u1}} (p : α -> Prop) (q : α -> Prop) [_inst_1 : DecidablePred.{succ u1} α p] [_inst_2 : DecidablePred.{succ u1} α q] [_inst_3 : DecidableEq.{succ u1} α] (s : Finset.{u1} α), Eq.{succ u1} (Finset.{u1} α) (Union.union.{u1} (Finset.{u1} α) (Finset.hasUnion.{u1} α (fun (a : α) (b : α) => _inst_3 a b)) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s) (Finset.filter.{u1} α q (fun (a : α) => _inst_2 a) s)) (Finset.filter.{u1} α (fun (x : α) => Or (p x) (q x)) (fun (a : α) => Or.decidable (p a) (q a) (_inst_1 a) (_inst_2 a)) s)
but is expected to have type
  forall {α : Type.{u1}} (p : α -> Bool) (q : α -> Bool) [_inst_1 : DecidableEq.{succ u1} α] (_inst_2 : Finset.{u1} α), Eq.{succ u1} (Finset.{u1} α) (Union.union.{u1} (Finset.{u1} α) (Finset.instUnionFinset.{u1} α (fun (a : α) (b : α) => _inst_1 a b)) (Finset.filter.{u1} α p _inst_2) (Finset.filter.{u1} α q _inst_2)) (Finset.filter.{u1} α (fun (x : α) => Decidable.decide (Or (Eq.{1} Bool (p x) Bool.true) (Eq.{1} Bool (q x) Bool.true)) (instDecidableOr (Eq.{1} Bool (p x) Bool.true) (Eq.{1} Bool (q x) Bool.true) (instDecidableEqBool (p x) Bool.true) (instDecidableEqBool (q x) Bool.true))) _inst_2)
Case conversion may be inaccurate. Consider using '#align finset.filter_union_right Finset.filter_union_rightₓ'. -/
...
/- warning: finset.filter_inter_distrib -> Finset.filter_inter_distrib is a dubious translation:
lean 3 declaration is
  forall {α : Type.{u1}} (p : α -> Prop) [_inst_1 : DecidablePred.{succ u1} α p] [_inst_3 : DecidableEq.{succ u1} α] (s : Finset.{u1} α) (t : Finset.{u1} α), Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) (Inter.inter.{u1} (Finset.{u1} α) (Finset.hasInter.{u1} α (fun (a : α) (b : α) => _inst_3 a b)) s t)) (Inter.inter.{u1} (Finset.{u1} α) (Finset.hasInter.{u1} α (fun (a : α) (b : α) => _inst_3 a b)) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) t))
but is expected to have type
  forall {α : Type.{u1}} (p : α -> Bool) [_inst_1 : DecidableEq.{succ u1} α] (_inst_3 : Finset.{u1} α) (s : Finset.{u1} α), Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α p (Inter.inter.{u1} (Finset.{u1} α) (Finset.instInterFinset.{u1} α (fun (a : α) (b : α) => _inst_1 a b)) _inst_3 s)) (Inter.inter.{u1} (Finset.{u1} α) (Finset.instInterFinset.{u1} α (fun (a : α) (b : α) => _inst_1 a b)) (Finset.filter.{u1} α p _inst_3) (Finset.filter.{u1} α p s))
Case conversion may be inaccurate. Consider using '#align finset.filter_inter_distrib Finset.filter_inter_distribₓ'. -/
...
/- warning: finset.filter_inter -> Finset.filter_inter is a dubious translation:
lean 3 declaration is
  forall {α : Type.{u1}} (p : α -> Prop) [_inst_1 : DecidablePred.{succ u1} α p] [_inst_3 : DecidableEq.{succ u1} α] (s : Finset.{u1} α) (t : Finset.{u1} α), Eq.{succ u1} (Finset.{u1} α) (Inter.inter.{u1} (Finset.{u1} α) (Finset.hasInter.{u1} α (fun (a : α) (b : α) => _inst_3 a b)) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s) t) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) (Inter.inter.{u1} (Finset.{u1} α) (Finset.hasInter.{u1} α (fun (a : α) (b : α) => _inst_3 a b)) s t))
but is expected to have type
  forall {α : Type.{u1}} (p : α -> Bool) [_inst_1 : DecidableEq.{succ u1} α] (_inst_3 : Finset.{u1} α) (s : Finset.{u1} α), Eq.{succ u1} (Finset.{u1} α) (Inter.inter.{u1} (Finset.{u1} α) (Finset.instInterFinset.{u1} α (fun (a : α) (b : α) => _inst_1 a b)) (Finset.filter.{u1} α p _inst_3) s) (Finset.filter.{u1} α p (Inter.inter.{u1} (Finset.{u1} α) (Finset.instInterFinset.{u1} α (fun (a : α) (b : α) => _inst_1 a b)) _inst_3 s))
Case conversion may be inaccurate. Consider using '#align finset.filter_inter Finset.filter_interₓ'. -/
...
/- warning: finset.inter_filter -> Finset.inter_filter is a dubious translation:
lean 3 declaration is
  forall {α : Type.{u1}} (p : α -> Prop) [_inst_1 : DecidablePred.{succ u1} α p] [_inst_3 : DecidableEq.{succ u1} α] (s : Finset.{u1} α) (t : Finset.{u1} α), Eq.{succ u1} (Finset.{u1} α) (Inter.inter.{u1} (Finset.{u1} α) (Finset.hasInter.{u1} α (fun (a : α) (b : α) => _inst_3 a b)) s (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) t)) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) (Inter.inter.{u1} (Finset.{u1} α) (Finset.hasInter.{u1} α (fun (a : α) (b : α) => _inst_3 a b)) s t))
but is expected to have type
  forall {α : Type.{u1}} (p : α -> Bool) [_inst_1 : DecidableEq.{succ u1} α] (_inst_3 : Finset.{u1} α) (s : Finset.{u1} α), Eq.{succ u1} (Finset.{u1} α) (Inter.inter.{u1} (Finset.{u1} α) (Finset.instInterFinset.{u1} α (fun (a : α) (b : α) => _inst_1 a b)) _inst_3 (Finset.filter.{u1} α p s)) (Finset.filter.{u1} α p (Inter.inter.{u1} (Finset.{u1} α) (Finset.instInterFinset.{u1} α (fun (a : α) (b : α) => _inst_1 a b)) _inst_3 s))
Case conversion may be inaccurate. Consider using '#align finset.inter_filter Finset.inter_filterₓ'. -/
...
/- warning: finset.filter_insert -> Finset.filter_insert is a dubious translation:
lean 3 declaration is
  forall {α : Type.{u1}} (p : α -> Prop) [_inst_1 : DecidablePred.{succ u1} α p] [_inst_3 : DecidableEq.{succ u1} α] (a : α) (s : Finset.{u1} α), Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) (Insert.insert.{u1, u1} α (Finset.{u1} α) (Finset.hasInsert.{u1} α (fun (a : α) (b : α) => _inst_3 a b)) a s)) (ite.{succ u1} (Finset.{u1} α) (p a) (_inst_1 a) (Insert.insert.{u1, u1} α (Finset.{u1} α) (Finset.hasInsert.{u1} α (fun (a : α) (b : α) => _inst_3 a b)) a (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s)) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s))
but is expected to have type
  forall {α : Type.{u1}} (p : α -> Bool) [_inst_1 : DecidableEq.{succ u1} α] (_inst_3 : α) (a : Finset.{u1} α), Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α p (Insert.insert.{u1, u1} α (Finset.{u1} α) (Finset.instInsertFinset.{u1} α (fun (a : α) (b : α) => _inst_1 a b)) _inst_3 a)) (ite.{succ u1} (Finset.{u1} α) (Eq.{1} Bool (p _inst_3) Bool.true) (instDecidableEqBool (p _inst_3) Bool.true) (Insert.insert.{u1, u1} α (Finset.{u1} α) (Finset.instInsertFinset.{u1} α (fun (a : α) (b : α) => _inst_1 a b)) _inst_3 (Finset.filter.{u1} α p a)) (Finset.filter.{u1} α p a))
Case conversion may be inaccurate. Consider using '#align finset.filter_insert Finset.filter_insertₓ'. -/
...
/- warning: finset.filter_erase -> Finset.filter_erase is a dubious translation:
lean 3 declaration is
  forall {α : Type.{u1}} (p : α -> Prop) [_inst_1 : DecidablePred.{succ u1} α p] [_inst_3 : DecidableEq.{succ u1} α] (a : α) (s : Finset.{u1} α), Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) (Finset.erase.{u1} α (fun (a : α) (b : α) => _inst_3 a b) s a)) (Finset.erase.{u1} α (fun (a : α) (b : α) => _inst_3 a b) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s) a)
but is expected to have type
  forall {α : Type.{u1}} (p : α -> Bool) [_inst_1 : DecidableEq.{succ u1} α] (_inst_3 : α) (a : Finset.{u1} α), Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α p (Finset.erase.{u1} α (fun (a : α) (b : α) => _inst_1 a b) a _inst_3)) (Finset.erase.{u1} α (fun (a : α) (b : α) => _inst_1 a b) (Finset.filter.{u1} α p a) _inst_3)
Case conversion may be inaccurate. Consider using '#align finset.filter_erase Finset.filter_eraseₓ'. -/
...
but is expected to have type
  forall {α : Type.{u1}} (p : α -> Bool) (q : α -> Bool) [_inst_1 : DecidableEq.{succ u1} α] (_inst_2 : Finset.{u1} α), Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α (fun (a : α) => Decidable.decide (Or (Eq.{1} Bool (p a) Bool.true) (Eq.{1} Bool (q a) Bool.true)) (instDecidableOr (Eq.{1} Bool (p a) Bool.true) (Eq.{1} Bool (q a) Bool.true) (instDecidableEqBool (p a) Bool.true) (instDecidableEqBool (q a) Bool.true))) _inst_2) (Union.union.{u1} (Finset.{u1} α) (Finset.instUnionFinset.{u1} α (fun (a : α) (b : α) => _inst_1 a b)) (Finset.filter.{u1} α p _inst_2) (Finset.filter.{u1} α q _inst_2))
...
but is expected to have type
  forall {α : Type.{u1}} (p : α -> Bool) (q : α -> Bool) [_inst_1 : DecidableEq.{succ u1} α] (_inst_2 : Finset.{u1} α), Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α (fun (a : α) => Decidable.decide (And (Eq.{1} Bool (p a) Bool.true) (Eq.{1} Bool (q a) Bool.true)) (instDecidableAnd (Eq.{1} Bool (p a) Bool.true) (Eq.{1} Bool (q a) Bool.true) (instDecidableEqBool (p a) Bool.true) (instDecidableEqBool (q a) Bool.true))) _inst_2) (Inter.inter.{u1} (Finset.{u1} α) (Finset.instInterFinset.{u1} α (fun (a : α) (b : α) => _inst_1 a b)) (Finset.filter.{u1} α p _inst_2) (Finset.filter.{u1} α q _inst_2))
...
but is expected to have type
  forall {α : Type.{u1}} (p : α -> Bool) [_inst_1 : DecidableEq.{succ u1} α] (_inst_3 : Finset.{u1} α), Eq.{succ u1} (Finset.{u1} α) (Finset.filter.{u1} α (fun (a : α) => Decidable.decide (Not (Eq.{1} Bool (p a) Bool.true)) (instDecidableNot (Eq.{1} Bool (p a) Bool.true) (instDecidableEqBool (p a) Bool.true))) _inst_3) (SDiff.sdiff.{u1} (Finset.{u1} α) (Finset.instSDiffFinset.{u1} α (fun (a : α) (b : α) => _inst_1 a b)) _inst_3 (Finset.filter.{u1} α p _inst_3))
...
but is expected to have type
  forall {α : Type.{u1}} (p : α -> Bool) [_inst_1 : DecidableEq.{succ u1} α] (_inst_3 : Finset.{u1} α) (_inst_4 : Finset.{u1} α), Eq.{succ u1} (Finset.{u1} α) (Inter.inter.{u1} (Finset.{u1} α) (Finset.instInterFinset.{u1} α (fun (a : α) (b : α) => _inst_1 a b)) (Finset.filter.{u1} α p _inst_3) (Finset.filter.{u1} α (fun (a : α) => Decidable.decide (Not (Eq.{1} Bool (p a) Bool.true)) (instDecidableNot (Eq.{1} Bool (p a) Bool.true) (instDecidableEqBool (p a) Bool.true))) _inst_4)) (EmptyCollection.emptyCollection.{u1} (Finset.{u1} α) (Finset.instEmptyCollectionFinset.{u1} α))
...
/- warning: finset.filter_union_filter_of_codisjoint -> Finset.filter_union_filter_of_codisjoint is a dubious translation:
lean 3 declaration is
  forall {α : Type.{u1}} (p : α -> Prop) (q : α -> Prop) [_inst_1 : DecidablePred.{succ u1} α p] [_inst_2 : DecidablePred.{succ u1} α q] [_inst_3 : DecidableEq.{succ u1} α] (s : Finset.{u1} α), (Codisjoint.{u1} (α -> Prop) (Pi.partialOrder.{u1, 0} α (fun (ᾰ : α) => Prop) (fun (i : α) => Prop.partialOrder)) (Pi.orderTop.{u1, 0} α (fun (ᾰ : α) => Prop) (fun (i : α) => Preorder.toLE.{0} ((fun (i : α) => (fun (i : α) => (fun (ᾰ : α) => Prop) i) i) i) ((fun (i : α) => PartialOrder.toPreorder.{0} ((fun (ᾰ : α) => Prop) i) ((fun (i : α) => Prop.partialOrder) i)) i)) (fun (i : α) => BoundedOrder.toOrderTop.{0} Prop (Preorder.toLE.{0} ((fun (i : α) => (fun (i : α) => (fun (ᾰ : α) => Prop) i) i) i) ((fun (i : α) => PartialOrder.toPreorder.{0} ((fun (ᾰ : α) => Prop) i) ((fun (i : α) => Prop.partialOrder) i)) i)) Prop.boundedOrder)) p q) -> (Eq.{succ u1} (Finset.{u1} α) (Union.union.{u1} (Finset.{u1} α) (Finset.hasUnion.{u1} α (fun (a : α) (b : α) => _inst_3 a b)) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s) (Finset.filter.{u1} α q (fun (a : α) => _inst_2 a) s)) s)
but is expected to have type
  forall {α : Type.{u1}} (p : α -> Bool) (q : α -> Bool) [_inst_1 : DecidableEq.{succ u1} α] (_inst_2 : Finset.{u1} α), (Codisjoint.{u1} (α -> Bool) (Pi.partialOrder.{u1, 0} α (fun (a._@.Mathlib.Data.Finset.Basic._hyg.28382 : α) => Bool) (fun (i : α) => SemilatticeInf.toPartialOrder.{0} Bool (Lattice.toSemilatticeInf.{0} Bool (GeneralizedCoheytingAlgebra.toLattice.{0} Bool (CoheytingAlgebra.toGeneralizedCoheytingAlgebra.{0} Bool (BiheytingAlgebra.toCoheytingAlgebra.{0} Bool (BooleanAlgebra.toBiheytingAlgebra.{0} Bool instBooleanAlgebraBool))))))) (Pi.orderTop.{u1, 0} α (fun (a._@.Mathlib.Data.Finset.Basic._hyg.28382 : α) => Bool) (fun (i : α) => Preorder.toLE.{0} ((fun (i : α) => (fun (a._@.Mathlib.Data.Finset.Basic._hyg.28382 : α) => Bool) i) i) ((fun (i : α) => PartialOrder.toPreorder.{0} ((fun (a._@.Mathlib.Data.Finset.Basic._hyg.28382 : α) => Bool) i) ((fun (i : α) => SemilatticeInf.toPartialOrder.{0} Bool (Lattice.toSemilatticeInf.{0} Bool (GeneralizedCoheytingAlgebra.toLattice.{0} Bool (CoheytingAlgebra.toGeneralizedCoheytingAlgebra.{0} Bool (BiheytingAlgebra.toCoheytingAlgebra.{0} Bool (BooleanAlgebra.toBiheytingAlgebra.{0} Bool instBooleanAlgebraBool)))))) i)) i)) (fun (i : α) => BoundedOrder.toOrderTop.{0} Bool (Preorder.toLE.{0} Bool (PartialOrder.toPreorder.{0} Bool (SemilatticeInf.toPartialOrder.{0} Bool (Lattice.toSemilatticeInf.{0} Bool (GeneralizedCoheytingAlgebra.toLattice.{0} Bool (CoheytingAlgebra.toGeneralizedCoheytingAlgebra.{0} Bool (BiheytingAlgebra.toCoheytingAlgebra.{0} Bool (BooleanAlgebra.toBiheytingAlgebra.{0} Bool instBooleanAlgebraBool)))))))) Bool.boundedOrder)) p q) -> (Eq.{succ u1} (Finset.{u1} α) (Union.union.{u1} (Finset.{u1} α) (Finset.instUnionFinset.{u1} α (fun (a : α) (b : α) => _inst_1 a b)) (Finset.filter.{u1} α p _inst_2) (Finset.filter.{u1} α q _inst_2)) _inst_2)
Case conversion may be inaccurate. Consider using '#align finset.filter_union_filter_of_codisjoint Finset.filter_union_filter_of_codisjointₓ'. -/
...
/- warning: finset.filter_union_filter_neg_eq -> Finset.filter_union_filter_neg_eq is a dubious translation:
lean 3 declaration is
  forall {α : Type.{u1}} (p : α -> Prop) [_inst_1 : DecidablePred.{succ u1} α p] [_inst_3 : DecidableEq.{succ u1} α] [_inst_4 : DecidablePred.{succ u1} α (fun (a : α) => Not (p a))] (s : Finset.{u1} α), Eq.{succ u1} (Finset.{u1} α) (Union.union.{u1} (Finset.{u1} α) (Finset.hasUnion.{u1} α (fun (a : α) (b : α) => _inst_3 a b)) (Finset.filter.{u1} α p (fun (a : α) => _inst_1 a) s) (Finset.filter.{u1} α (fun (a : α) => Not (p a)) (fun (a : α) => _inst_4 a) s)) s
but is expected to have type
  forall {α : Type.{u1}} (p : α -> Bool) [_inst_1 : DecidableEq.{succ u1} α] (_inst_3 : Finset.{u1} α), Eq.{succ u1} (Finset.{u1} α) (Union.union.{u1} (Finset.{u1} α) (Finset.instUnionFinset.{u1} α (fun (a : α) (b : α) => _inst_1 a b)) (Finset.filter.{u1} α p _inst_3) (Finset.filter.{u1} α (fun (a : α) => Decidable.decide (Not (Eq.{1} Bool (p a) Bool.true)) (instDecidableNot (Eq.{1} Bool (p a) Bool.true) (instDecidableEqBool (p a) Bool.true))) _inst_3)) _inst_3
Case conversion may be inaccurate. Consider using '#align finset.filter_union_filter_neg_eq Finset.filter_union_filter_neg_eqₓ'. -/
...
but is expected to have type
  forall {α : Type.{u2}} {β : Type.{u1}} [_inst_1 : DecidableEq.{succ u1} β] (s : Finset.{u2} α) (f : α -> (Finset.{u1} β)) (p : β -> Prop) [_inst_2 : DecidablePred.{succ u1} β p], Eq.{succ u1} (Finset.{u1} β) (Finset.filter.{u1} β (fun (a : β) => Decidable.decide (p a) ((fun (a : β) => _inst_2 a) a)) (Finset.bunionᵢ.{u2, u1} α β (fun (a : β) (b : β) => _inst_1 a b) s f)) (Finset.bunionᵢ.{u2, u1} α β (fun (a : β) (b : β) => _inst_1 a b) s (fun (a : α) => Finset.filter.{u1} β (fun (a : β) => Decidable.decide (p a) ((fun (a : β) => _inst_2 a) a)) (f a)))
