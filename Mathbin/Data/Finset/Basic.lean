...
#print Finset.ssubset_iff_of_subset /-
...
#print Finset.exists_of_ssubset /-
...
@[simp]
theorem val_eq_singleton_iff {a : α} {s : Finset α} : s.val = {a} ↔ s = {a} := by rw [← val_inj];
  rfl
...
theorem eq_singleton_iff_nonempty_unique_mem {s : Finset α} {a : α} :
  ...
  constructor
  · rintro rfl; simp
  · rintro ⟨hne, h_uniq⟩; rw [eq_singleton_iff_unique_mem]; refine' ⟨_, h_uniq⟩
...
@[simp]
theorem coe_cons {a s h} : (@cons α a s h : Set α) = insert a s := by ext; simp
...
#print Finset.disjoint_of_subset_left /-
...
#print Finset.disjoint_of_subset_right /-
...
#print Finset.disjoint_empty_right /-
@[simp]
...
#print Finset.disjoint_singleton_left /-
@[simp]
...
#print Finset.disjoint_singleton_right /-
@[simp]
...
#print Finset.disjoint_singleton /-
@[simp]
...
#print Finset.disjoint_self_iff_empty /-
...
#print Finset.pairwiseDisjoint_coe /-
@[simp, norm_cast]
...
#print Finset.singleton_disjUnion /-
...
#print Finset.disjUnion_singleton /-
...
@[simp, norm_cast]
theorem coe_pair {a b : α} : (({a, b} : Finset α) : Set α) = {a, b} := by ext; simp
...
def subtypeInsertEquivOption {t : Finset α} {x : α} (h : x ∉ t) :
  ...
  · rintro (_ | y); simp only [Option.elim', dif_pos, Subtype.coe_mk]
    have : ↑y ≠ x := by rintro ⟨⟩; exact h y.2
...
#print Finset.disjoint_insert_left /-
@[simp]
...
#print Finset.disjoint_insert_right /-
@[simp]
...
#print Finset.disjUnion_eq_union /-
@[simp]
...
#print Finset.disjoint_union_left /-
@[simp]
...
#print Finset.disjoint_union_right /-
@[simp]
...
#print DirectedOn.exists_mem_subset_of_finset_subset_biUnion /-
...
#print Finset.inter_union_distrib_left /-
...
#print Finset.union_inter_distrib_right /-
...
#print Finset.union_inter_distrib_left /-
...
#print Finset.inter_union_distrib_right /-
...
#print Finset.not_disjoint_iff_nonempty_inter /-
...
#print Finset.ssubset_iff_exists_subset_erase /-
...
#print Finset.union_sdiff_cancel_left /-
...
#print Finset.union_sdiff_cancel_right /-
...
theorem sdiff_singleton_eq_erase (a : α) (s : Finset α) : s \ singleton a = erase s a := by ext;
  rw [mem_erase, mem_sdiff, mem_singleton]; tauto
...
#print Finset.disjoint_erase_comm /-
...
#print Finset.disjoint_of_erase_left /-
...
#print Finset.disjoint_of_erase_right /-
...
#print Finset.sdiff_eq_self_iff_disjoint /-
...
#print Finset.sdiff_eq_self_of_disjoint /-
...
theorem sizeOf_lt_sizeOf_of_mem [SizeOf α] {x : α} {s : Finset α} (hx : x ∈ s) :
  ...
  cases s; dsimp [SizeOf.sizeOf, SizeOf.sizeOf, Finset.sizeof]
...
#print Finset.piecewise_insert_self /-
@[simp]
...
#print Finset.piecewise_eq_of_mem /-
@[simp]
...
#print Finset.piecewise_eq_of_not_mem /-
@[simp]
...
#print Finset.piecewise_insert_of_ne /-
@[simp]
...
#print Finset.piecewise_singleton /-
...
#print Finset.piecewise_piecewise_of_subset_left /-
...
#print Finset.piecewise_idem_left /-
@[simp]
...
#print Finset.piecewise_piecewise_of_subset_right /-
...
#print Finset.piecewise_idem_right /-
@[simp]
...
#print Finset.update_piecewise_of_mem /-
...
#print Finset.update_piecewise_of_not_mem /-
...
#print Finset.disjoint_filter_filter /-
...
#print Finset.disjoint_filter_filter_neg /-
...
#print Finset.filter_disj_union /-
...
theorem filter_inter_distrib (s t : Finset α) : (s ∩ t).filterₓ p = s.filterₓ p ∩ t.filterₓ p := by
  ext; simp only [mem_filter, mem_inter]; exact and_and_right _ _ _
#align finset.filter_inter_distrib Finset.filter_inter_distrib
-/

#print Finset.filter_inter /-
theorem filter_inter (s t : Finset α) : filter p s ∩ t = filter p (s ∩ t) := by ext;
...
theorem filter_insert (a : α) (s : Finset α) :
    filter p (insert a s) = if p a then insert a (filter p s) else filter p s := by ext x; simp;
  split_ifs with h <;> by_cases h' : x = a <;> simp [h, h']
...
theorem filter_eq [DecidableEq β] (s : Finset β) (b : β) : s.filterₓ (Eq b) = ite (b ∈ s) {b} ∅ :=
  ...
  · ext
    ...
    exact ⟨fun h => h.2.symm, by rintro ⟨h⟩; exact ⟨h, rfl⟩⟩
  · ext
...
theorem filter_ne [DecidableEq β] (s : Finset β) (b : β) :
    (s.filterₓ fun a => b ≠ a) = s.eraseₓ b := by ext; simp only [mem_filter, mem_erase, Ne.def];
  tauto
...
#print Finset.filter_inter_filter_neg_eq /-
...
theorem toFinset_ssubset : s.toFinset ⊂ t.toFinset ↔ s ⊂ t := by
  simp_rw [Finset.ssubset_def, to_finset_subset]; rfl
...
@[simp]
theorem val_toFinset [DecidableEq α] (s : Finset α) : s.val.toFinset = s := by ext;
  rw [Multiset.mem_toFinset, ← mem_def]
#align finset.val_to_finset Finset.val_toFinset
-/

#print Finset.val_le_iff_val_subset /-
...
theorem toFinset_surj_on : Set.SurjOn toFinset {l : List α | l.Nodup} Set.univ := by
  rintro ⟨⟨l⟩, hl⟩ _; exact ⟨l, hl, (to_finset_eq hl).symm⟩
...
theorem perm_of_nodup_nodup_toFinset_eq (hl : Nodup l) (hl' : Nodup l')
    (h : l.toFinset = l'.toFinset) : l ~ l' := by rw [← Multiset.coe_eq_coe];
...
@[simp]
theorem toFinset_union (l l' : List α) : (l ∪ l').toFinset = l.toFinset ∪ l'.toFinset := by ext;
  simp
...
@[simp]
theorem toFinset_inter (l l' : List α) : (l ∩ l').toFinset = l.toFinset ∩ l'.toFinset := by ext;
  simp
...
theorem nodup_toList (s : Finset α) : s.toList.Nodup := by
  rw [to_list, ← Multiset.coe_nodup, Multiset.coe_toList]; exact s.nodup
...
@[simp]
theorem toList_toFinset [DecidableEq α] (s : Finset α) : s.toList.toFinset = s := by ext; simp
...
theorem toList_cons {a : α} {s : Finset α} (h : a ∉ s) : (cons a s h).toList ~ a :: s.toList :=
  (List.perm_ext_iff_of_nodup (nodup_toList _) (by simp [h, nodup_to_list s])).2 fun x => by
...
#print Finset.singleton_disjiUnion /-
@[simp]
...
#print Finset.disjiUnion_disjiUnion /-
...
#print Finset.disjiUnion_eq_biUnion /-
@[simp]
...
#print Finset.biUnion_subset_iff_forall_subset /-
@[simp]
...
#print Finset.biUnion_filter_eq_of_maps_to /-
...
#print Finset.disjoint_biUnion_right /-
...
theorem pairwise_cons' {a : α} (ha : a ∉ s) (r : β → β → Prop) (f : α → β) :
  ...
  exact fun hsr => ⟨fun h b hb => h b hb <| by rintro rfl; contradiction, fun h b hb _ => h b hb⟩
...
def sigmaEquivOptionOfInhabited (α : Type u) [Inhabited α] [DecidableEq α] :
  ...
  ⟨{ x : α // x ≠ default },
    { toFun := fun x : α => if h : x = default then none else some ⟨x, h⟩
      ...
      left_inv := fun x => by dsimp only; split_ifs <;> simp [*]
      right_inv := by
        rintro (_ | ⟨x, h⟩)
        · simp
        · dsimp only
...
#print Multiset.disjoint_toFinset /-
...
#print List.disjoint_toFinset_iff_disjoint /-
