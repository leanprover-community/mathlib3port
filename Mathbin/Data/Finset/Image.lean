...
but is expected to have type
  forall {α : Type.{u2}} {β : Type.{u1}} {s : Finset.{u2} α} {f : Equiv.{succ u2, succ u1} α β} {b : β}, Iff (Membership.mem.{u1, u1} β (Finset.{u1} β) (Finset.instMembershipFinset.{u1} β) b (Finset.map.{u2, u1} α β (Equiv.toEmbedding.{succ u2, succ u1} α β f) s)) (Membership.mem.{u2, u2} ((fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.19 : β) => α) b) (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) (FunLike.coe.{max (succ u2) (succ u1), succ u1, succ u2} (Equiv.{succ u1, succ u2} β α) β (fun (_x : β) => (fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.19 : β) => α) _x) (EmbeddingLike.toFunLike.{max (succ u2) (succ u1), succ u1, succ u2} (Equiv.{succ u1, succ u2} β α) β α (EquivLike.toEmbeddingLike.{max (succ u2) (succ u1), succ u1, succ u2} (Equiv.{succ u1, succ u2} β α) β α (Equiv.instEquivLikeEquiv.{succ u1, succ u2} β α))) (Equiv.symm.{succ u2, succ u1} α β f) b) s)
...
but is expected to have type
  forall {α : Type.{u1}} {β : Type.{u2}} {f : Function.Embedding.{succ u1, succ u2} α β} {s : Finset.{u1} α}, Eq.{succ u2} ((fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.19 : Finset.{u1} α) => Finset.{u2} β) s) (FunLike.coe.{max (succ u1) (succ u2), succ u1, succ u2} (Function.Embedding.{succ u1, succ u2} (Finset.{u1} α) (Finset.{u2} β)) (Finset.{u1} α) (fun (_x : Finset.{u1} α) => (fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.19 : Finset.{u1} α) => Finset.{u2} β) _x) (EmbeddingLike.toFunLike.{max (succ u1) (succ u2), succ u1, succ u2} (Function.Embedding.{succ u1, succ u2} (Finset.{u1} α) (Finset.{u2} β)) (Finset.{u1} α) (Finset.{u2} β) (Function.instEmbeddingLikeEmbedding.{succ u1, succ u2} (Finset.{u1} α) (Finset.{u2} β))) (RelEmbedding.toEmbedding.{u1, u2} (Finset.{u1} α) (Finset.{u2} β) (fun (x._@.Mathlib.Order.Hom.Basic._hyg.744 : Finset.{u1} α) (x._@.Mathlib.Order.Hom.Basic._hyg.746 : Finset.{u1} α) => LE.le.{u1} (Finset.{u1} α) (Preorder.toLE.{u1} (Finset.{u1} α) (PartialOrder.toPreorder.{u1} (Finset.{u1} α) (Finset.partialOrder.{u1} α))) x._@.Mathlib.Order.Hom.Basic._hyg.744 x._@.Mathlib.Order.Hom.Basic._hyg.746) (fun (x._@.Mathlib.Order.Hom.Basic._hyg.759 : Finset.{u2} β) (x._@.Mathlib.Order.Hom.Basic._hyg.761 : Finset.{u2} β) => LE.le.{u2} (Finset.{u2} β) (Preorder.toLE.{u2} (Finset.{u2} β) (PartialOrder.toPreorder.{u2} (Finset.{u2} β) (Finset.partialOrder.{u2} β))) x._@.Mathlib.Order.Hom.Basic._hyg.759 x._@.Mathlib.Order.Hom.Basic._hyg.761) (Finset.mapEmbedding.{u1, u2} α β f)) s) (Finset.map.{u1, u2} α β f s)
...
but is expected to have type
  forall {α : Type.{u2}} {β : Type.{u1}} {s : Finset.{u2} α} {f : Equiv.{succ u2, succ u1} α β} {p : α -> Prop} [_inst_1 : DecidablePred.{succ u2} α p], Eq.{succ u1} (Finset.{u1} β) (Finset.map.{u2, u1} α β (Equiv.toEmbedding.{succ u2, succ u1} α β f) (Finset.filter.{u2} α (fun (a : α) => Decidable.decide (p a) ((fun (a : α) => _inst_1 a) a)) s)) (Finset.filter.{u1} β (Function.comp.{succ u1, succ u2, 1} β α Bool (fun (b : α) => Decidable.decide (p b) ((fun (a : α) => _inst_1 a) b)) (FunLike.coe.{max (succ u2) (succ u1), succ u1, succ u2} (Equiv.{succ u1, succ u2} β α) β (fun (a : β) => (fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.19 : β) => α) a) (EmbeddingLike.toFunLike.{max (succ u2) (succ u1), succ u1, succ u2} (Equiv.{succ u1, succ u2} β α) β α (EquivLike.toEmbeddingLike.{max (succ u2) (succ u1), succ u1, succ u2} (Equiv.{succ u1, succ u2} β α) β α (Equiv.instEquivLikeEquiv.{succ u1, succ u2} β α))) (Equiv.symm.{succ u2, succ u1} α β f))) (Finset.map.{u2, u1} α β (Equiv.toEmbedding.{succ u2, succ u1} α β f) s))
...
but is expected to have type
  forall {α : Type.{u2}} {β : Type.{u1}} [_inst_1 : DecidableEq.{succ u1} β] (f : α -> β) (s : Finset.{u2} α) (t : Finset.{u1} β), (forall (x : α), (Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x s) -> (Membership.mem.{u1, u1} β (Finset.{u1} β) (Finset.instMembershipFinset.{u1} β) (f x) t)) -> (Eq.{succ u1} (Finset.{u1} β) (Finset.filter.{u1} β (fun (a : β) => Decidable.decide (Membership.mem.{u1, u1} β (Finset.{u1} β) (Finset.instMembershipFinset.{u1} β) a (Finset.image.{u2, u1} α β (fun (a : β) (b : β) => _inst_1 a b) f s)) (Finset.decidableMem.{u1} β (fun (a : β) (b : β) => _inst_1 a b) a (Finset.image.{u2, u1} α β (fun (a : β) (b : β) => _inst_1 a b) f s))) t) (Finset.image.{u2, u1} α β (fun (a : β) (b : β) => _inst_1 a b) f s))
...
but is expected to have type
  forall {α : Type.{u2}} {β : Type.{u1}} [_inst_1 : DecidableEq.{succ u1} β] (f : α -> β) (s : Finset.{u2} α) (y : β), Iff (Finset.Nonempty.{u2} α (Finset.filter.{u2} α (fun (a : α) => Decidable.decide (Eq.{succ u1} β (f a) y) (_inst_1 (f a) y)) s)) (Membership.mem.{u1, u1} β (Finset.{u1} β) (Finset.instMembershipFinset.{u1} β) y (Finset.image.{u2, u1} α β (fun (a : β) (b : β) => _inst_1 a b) f s))
...
theorem bunionᵢ_singleton {f : α → β} : (s.bUnion fun a => {f a}) = s.image f :=
...
but is expected to have type
  forall {α : Type.{u2}} {β : Type.{u1}} (e : Equiv.{succ u2, succ u1} α β) (s : Finset.{u2} α), Eq.{succ u1} ((fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.19 : Finset.{u2} α) => Finset.{u1} β) s) (FunLike.coe.{max (succ u2) (succ u1), succ u2, succ u1} (Equiv.{succ u2, succ u1} (Finset.{u2} α) (Finset.{u1} β)) (Finset.{u2} α) (fun (_x : Finset.{u2} α) => (fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.19 : Finset.{u2} α) => Finset.{u1} β) _x) (EmbeddingLike.toFunLike.{max (succ u2) (succ u1), succ u2, succ u1} (Equiv.{succ u2, succ u1} (Finset.{u2} α) (Finset.{u1} β)) (Finset.{u2} α) (Finset.{u1} β) (EquivLike.toEmbeddingLike.{max (succ u2) (succ u1), succ u2, succ u1} (Equiv.{succ u2, succ u1} (Finset.{u2} α) (Finset.{u1} β)) (Finset.{u2} α) (Finset.{u1} β) (Equiv.instEquivLikeEquiv.{succ u2, succ u1} (Finset.{u2} α) (Finset.{u1} β)))) (Equiv.finsetCongr.{u2, u1} α β e) s) (Finset.map.{u2, u1} α β (Equiv.toEmbedding.{succ u2, succ u1} α β e) s)
...
but is expected to have type
  forall {α : Type.{u2}} {β : Type.{u1}} (e : Equiv.{succ u2, succ u1} α β), Eq.{max (succ u2) (succ u1)} (Function.Embedding.{succ u2, succ u1} (Finset.{u2} α) (Finset.{u1} β)) (Equiv.toEmbedding.{succ u2, succ u1} (Finset.{u2} α) (Finset.{u1} β) (Equiv.finsetCongr.{u2, u1} α β e)) (RelEmbedding.toEmbedding.{u2, u1} (Finset.{u2} α) (Finset.{u1} β) (fun (x._@.Mathlib.Order.Hom.Basic._hyg.744 : Finset.{u2} α) (x._@.Mathlib.Order.Hom.Basic._hyg.746 : Finset.{u2} α) => LE.le.{u2} (Finset.{u2} α) (Preorder.toLE.{u2} (Finset.{u2} α) (PartialOrder.toPreorder.{u2} (Finset.{u2} α) (Finset.partialOrder.{u2} α))) x._@.Mathlib.Order.Hom.Basic._hyg.744 x._@.Mathlib.Order.Hom.Basic._hyg.746) (fun (x._@.Mathlib.Order.Hom.Basic._hyg.759 : Finset.{u1} β) (x._@.Mathlib.Order.Hom.Basic._hyg.761 : Finset.{u1} β) => LE.le.{u1} (Finset.{u1} β) (Preorder.toLE.{u1} (Finset.{u1} β) (PartialOrder.toPreorder.{u1} (Finset.{u1} β) (Finset.partialOrder.{u1} β))) x._@.Mathlib.Order.Hom.Basic._hyg.759 x._@.Mathlib.Order.Hom.Basic._hyg.761) (Finset.mapEmbedding.{u2, u1} α β (Equiv.toEmbedding.{succ u2, succ u1} α β e)))
