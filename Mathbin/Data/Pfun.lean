...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers [(Command.docComment "/--" " The domain of a partial function -/")] [] [] [] [] [])
 (Command.def
  "def"
  (Command.declId `dom [])
  (Command.optDeclSig
   [(Term.explicitBinder "(" [`f] [":" (Data.Pfun.«term_→._» `α " →. " `β)] [] ")")]
   [(Term.typeSpec ":" (Term.app `Set [`α]))])
  (Command.declValSimple ":=" (Set.«term{_|_}» "{" `a "|" (Term.proj (Term.app `f [`a]) "." `Dom) "}") [])
  []
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Set.«term{_|_}» "{" `a "|" (Term.proj (Term.app `f [`a]) "." `Dom) "}")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Set.«term{_|_}»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Term.app `f [`a]) "." `Dom)
    ...
    («term_=_»
     ...
     (Set.«term{_|_}»
      ...
      («term∃_,_»
       ...
       ","
       (Init.Core.«term_∈_» `y " ∈ " (Term.app `f [`x])))
      "}"))))
  (Command.declValSimple ":=" (Term.app `Set.ext [(Term.app `mem_dom [`f])]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Set.ext [(Term.app `mem_dom [`f])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `mem_dom [`f]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `Set.ext
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `equiv_subtype [])
  (Command.optDeclSig
   []
   [(Term.typeSpec
     ":"
     (Data.Equiv.Basic.«term_≃_»
      (Data.Pfun.«term_→._» `α " →. " `β)
      " ≃ "
      (Init.Data.Sigma.Basic.«termΣ_,_»
       "Σ"
       (Lean.explicitBinders
        (Lean.unbracketedExplicitBinders [(Lean.binderIdent `p)] [":" (Term.arrow `α "→" (Term.prop "Prop"))]))
       ", "
       (Term.arrow (Term.app `Subtype [`p]) "→" `β))))])
   ...
   (Term.anonymousCtor
    ...
    [(Term.fun
      ...
      (Term.basicFun
       ...
       (Term.anonymousCtor
        "⟨"
        [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`a] [])] "=>" (Term.proj (Term.app `f [`a]) "." `Dom)))
         ","
         (Term.app `as_subtype [`f])]
        "⟩")))
     ","
     (Term.fun
      "fun"
      (Term.basicFun
       [(Term.simpleBinder [`f `x] [])]
       "=>"
       (Term.anonymousCtor
        "⟨"
        [(Term.app (Term.proj `f "." (fieldIdx "1")) [`x])
         ","
         (Term.fun
          "fun"
          (Term.basicFun
           [(Term.simpleBinder [`h] [])]
           "=>"
           (Term.app (Term.proj `f "." (fieldIdx "2")) [(Term.anonymousCtor "⟨" [`x "," `h] "⟩")])))]
        "⟩")))
     ","
     (Term.fun
      "fun"
      (Term.basicFun
       ...
       («term_$__»
        `funext
        "$"
        (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`a] [])] "=>" (Term.app `Part.eta [(Term.hole "_")]))))))
     ","
     (Term.fun
      "fun"
      (Term.basicFun
       [(Term.anonymousCtor "⟨" [`p "," `f] "⟩")]
       "=>"
       (Term.byTactic
        "by"
        (Tactic.tacticSeq
  ...
  (Tactic.«tactic_<;>_»
   ...
   (Tactic.«tactic_<;>_»
    ...
    (Tactic.«tactic_<;>_»
     (tacticFunext__ "funext" [`a])
     "<;>"
     (Tactic.«tactic_<;>_» (Tactic.cases "cases" [(Tactic.casesTarget [] `a)] [] []) "<;>" (Tactic.tacticRfl "rfl")))))
...
/--
  ...
  def
    ...
    :=
      ⟨
        fun f => ⟨ fun a => f a . Dom , as_subtype f ⟩
          ,
          fun f x => ⟨ f . 1 x , fun h => f . 2 ⟨ x , h ⟩ ⟩
          ,
          fun f => funext $ fun a => Part.eta _
          ,
          fun ⟨ p , f ⟩ => by dsimp <;> congr <;> funext a <;> cases a <;> rfl
        ⟩
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `graph [])
  (Command.optDeclSig
   [(Term.explicitBinder "(" [`f] [":" (Data.Pfun.«term_→._» `α " →. " `β)] [] ")")]
   [(Term.typeSpec ":" (Term.app `Set [(«term_×_» `α "×" `β)]))])
  (Command.declValSimple
   ":="
   (Set.«term{_|_}»
    "{"
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
theorem image_def ( s : Set α ) : f.image s = { y | ∃ x ∈ s , y ∈ f x } := rfl
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
theorem preimage_def ( s : Set β ) : f.preimage s = { x | ∃ y ∈ s , y ∈ f x } := rfl
    ...
    («term_=_»
     ...
     (Set.«term{_|_}»
      ...
      (Term.forall
       ...
       [(Term.simpleBinder [`y] [])]
       ","
       (Term.arrow (Init.Core.«term_∈_» `y " ∈ " (Term.app `f [`x])) "→" (Init.Core.«term_∈_» `y " ∈ " `s)))
      "}"))))
  (Command.declValSimple ":=" `rfl [])
  []
  []))
