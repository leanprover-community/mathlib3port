...
@[elab_as_elim]
def fixInduction {C : α → Sort _} {f : α →. β ⊕ α} {b : β} {a : α} (h : b ∈ f.fix a)
...
theorem fix_induction_spec {C : α → Sort _} {f : α →. β ⊕ α} {b : β} {a : α} (h : b ∈ f.fix a)
...
theorem fix_induction'_stop {C : α → Sort _} {f : α →. β ⊕ α} {b : β} {a : α} (h : b ∈ f.fix a) (fa : Sum.inl b ∈ f a)
    (hbase : ∀ a_final : α, Sum.inl b ∈ f a_final → C a_final)
...
theorem fix_induction'_fwd {C : α → Sort _} {f : α →. β ⊕ α} {b : β} {a a' : α} (h : b ∈ f.fix a) (h' : b ∈ f.fix a')
