...
theorem _root_.exists_eq_subtype_mk_iff {a : Subtype p} {b : α} : (∃ h : p b, a = Subtype.mk b h) ↔ ↑a = b :=
  coe_eq_iff.symm
#align subtype._root_.exists_eq_subtype_mk_iff subtype._root_.exists_eq_subtype_mk_iff
...
#align subtype._root_.exists_subtype_mk_eq_iff subtype._root_.exists_subtype_mk_eq_iff
...
but is expected to have type
  forall {α : Sort.{u_1}} [inst._@.Mathlib.Data.Subtype._hyg.2057 : HasEquiv.{u_1 0} α] {p : α -> Prop} {s : Subtype.{u_1} α p} {t : Subtype.{u_1} α p}, Iff (HasEquiv.Equiv.{(max 1 u_1) 0} (Subtype.{u_1} α p) (Subtype.instHasEquivSubtype.{u_1 0} α inst._@.Mathlib.Data.Subtype._hyg.2057 p) s t) (HasEquiv.Equiv.{u_1 0} α inst._@.Mathlib.Data.Subtype._hyg.2057 (Subtype.val.{u_1} α p s) (Subtype.val.{u_1} α p t))
