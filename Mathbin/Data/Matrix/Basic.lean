...
@[simp]
theorem diagonal_conj_transpose [Semiringₓ α] [StarRing α] (v : n → α) : (diagonal v)ᴴ = diagonal (star v) := by
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " `dot_product v w` is the sum of the entrywise products `v i * w i` -/")]
  []
  []
  []
  []
 ...
 (Command.def
  ...
  (Command.declValSimple
   ...
   (Algebra.BigOperators.Basic.«term∑_,_»
    ...
    ", "
    (Finset.Data.Finset.Fold.«term_*_» (Term.app `v [`i]) "*" (Term.app `w [`i])))
   [])
  []
  []
  []))
...
/-- `dot_product v w` is the sum of the entrywise products `v i * w i` -/
  def dot_product [ Mul α ] [ AddCommMonoidₓ α ] ( v w : m → α ) : α := ∑ i , v i * w i
 ...
 (Command.theorem
  ...
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `Fintype [`m]) "]")
    (Term.instBinder "[" [] (Term.app `Mul [`α]) "]")
    (Term.instBinder "[" [] (Term.app `AddCommMonoidₓ [`α]) "]")
    (Term.implicitBinder "{" [`M] [":" (Term.app `Matrix [`l `m `α])] "}")
    (Term.implicitBinder "{" [`N] [":" (Term.app `Matrix [`m `n `α])] "}")
    (Term.implicitBinder "{" [`i `k] [] "}")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app (Matrix.Data.Matrix.Basic.«term_⬝_» `M " ⬝ " `N) [`i `k])
     "="
     (Algebra.BigOperators.Basic.«term∑_,_»
      "∑"
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `j)] []))
      ", "
      (Finset.Data.Finset.Fold.«term_*_» (Term.app `M [`i `j]) "*" (Term.app `N [`j `k]))))))
...
theorem
  mul_apply
  [ Fintype m ] [ Mul α ] [ AddCommMonoidₓ α ] { M : Matrix l m α } { N : Matrix m n α } { i k }
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  ...
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `AddCommMonoidₓ [`α]) "]")
    (Term.explicitBinder "(" [`i] [":" `m] [] ")")
    (Term.explicitBinder "(" [`j] [":" `n] [] ")")
    (Term.explicitBinder "(" [`s] [":" (Term.app `Finset [`β])] [] ")")
    (Term.explicitBinder "(" [`g] [":" (Term.arrow `β "→" (Term.app `Matrix [`m `n `α]))] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app
  ...
  (Command.declValSimple
   ":="
   (Term.app
    (Term.proj (Term.app `congr_funₓ [(Term.app `s.sum_apply [`i `g]) `j]) "." `trans)
    [(Term.app `s.sum_apply [`j (Term.hole "_")])])
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `s.sum_apply [`j (Term.hole "_")]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `congr_funₓ [(Term.app `s.sum_apply [`i `g]) `j]) "." `trans)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `congr_funₓ [(Term.app `s.sum_apply [`i `g]) `j])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `s.sum_apply [`i `g]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `congr_funₓ
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `congr_funₓ [(Term.paren "(" [(Term.app `s.sum_apply [`i `g]) []] ")") `j]) []]
 ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declSig', expected 'Lean.Parser.Command.declSig.antiquot'
...
theorem
  sum_apply
  [ AddCommMonoidₓ α ] ( i : m ) ( j : n ) ( s : Finset β ) ( g : β → Matrix m n α )
...
protected theorem mul_addₓ [Fintype n] (L : Matrix m n α) (M N : Matrix n o α) : (L ⬝ M+N) = (L ⬝ M)+L ⬝ N := by
  ext i j
  apply dot_product_add

protected theorem add_mulₓ [Fintype m] (L M : Matrix l m α) (N : Matrix m n α) : (L+M) ⬝ N = (L ⬝ N)+M ⬝ N := by
  ext i j
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  ...
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `Fintype [`m]) "]")
    (Term.explicitBinder "(" [`s] [":" (Term.app `Finset [`β])] [] ")")
    (Term.explicitBinder "(" [`f] [":" (Term.arrow `β "→" (Term.app `Matrix [`l `m `α]))] [] ")")
   ...
   (Term.typeSpec
    ...
    («term_=_»
     ...
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      ...
      `s
      ", "
      (Matrix.Data.Matrix.Basic.«term_⬝_» (Term.app `f [`a]) " ⬝ " `M)))))
  (Command.declValSimple
   ":="
   (Term.app
    (Term.proj
     (Term.paren
      "("
      [(Term.app `add_monoid_hom_mul_right [`M])
       [(Term.typeAscription ":" (Algebra.Group.Hom.«term_→+_» (Term.app `Matrix [`l `m `α]) " →+ " (Term.hole "_")))]]
      ")")
     "."
     `map_sum)
    [`f `s])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Algebra.Group.Hom.«term_→+_» (Term.app `Matrix [`l `m `α]) " →+ " (Term.hole "_"))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 76 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 75 >? 1022, (some 1023, term) <=? (some 75, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 75, (some 76, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `s
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
protected
  theorem
    sum_mul
    [ Fintype m ] ( s : Finset β ) ( f : β → Matrix l m α ) ( M : Matrix m n α )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  ...
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `Fintype [`m]) "]")
    (Term.explicitBinder "(" [`s] [":" (Term.app `Finset [`β])] [] ")")
    (Term.explicitBinder "(" [`f] [":" (Term.arrow `β "→" (Term.app `Matrix [`m `n `α]))] [] ")")
    (Term.explicitBinder "(" [`M] [":" (Term.app `Matrix [`l `m `α])] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Matrix.Data.Matrix.Basic.«term_⬝_»
     ...
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      ...
      `s
      ", "
      (Matrix.Data.Matrix.Basic.«term_⬝_» `M " ⬝ " (Term.app `f [`a]))))))
  (Command.declValSimple
   ":="
   (Term.app
    (Term.proj
     (Term.paren
      "("
      [(Term.app `add_monoid_hom_mul_left [`M])
       [(Term.typeAscription ":" (Algebra.Group.Hom.«term_→+_» (Term.app `Matrix [`m `n `α]) " →+ " (Term.hole "_")))]]
      ")")
     "."
     `map_sum)
    [`f `s])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeAscription', expected 'Lean.Parser.Term.typeAscription.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Algebra.Group.Hom.«term_→+_» (Term.app `Matrix [`m `n `α]) " →+ " (Term.hole "_"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Algebra.Group.Hom.«term_→+_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.hole "_")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 76 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 75, term))
  `M
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
protected
  theorem
    mul_sum
    [ Fintype m ] ( s : Finset β ) ( f : β → Matrix m n α ) ( M : Matrix l m α )
...
@[simp]
protected theorem one_mulₓ [Fintype m] [DecidableEq m] (M : Matrix m n α) : (1 : Matrix m m α) ⬝ M = M := by
  ext i j <;> rw [← diagonal_one, diagonal_mul, one_mulₓ]

@[simp]
protected theorem mul_oneₓ [Fintype n] [DecidableEq n] (M : Matrix m n α) : M ⬝ (1 : Matrix n n α) = M := by
...
@[simp]
theorem neg_mul (M : Matrix m n α) (N : Matrix n o α) : -M ⬝ N = -(M ⬝ N) := by
  ext
  apply neg_dot_product

@[simp]
theorem mul_neg (M : Matrix m n α) (N : Matrix n o α) : M ⬝ -N = -(M ⬝ N) := by
  ext
...
@[simp]
theorem zero_vec_mul [Fintype m] (A : Matrix m n α) : vec_mul 0 A = 0 := by
  ext
  simp [vec_mul]

@[simp]
theorem zero_mul_vec [Fintype n] (v : n → α) : mul_vec (0 : Matrix m n α) v = 0 := by
  ext
  simp [mul_vec]

@[simp]
theorem vec_mul_zero [Fintype m] (v : m → α) : vec_mul v (0 : Matrix m n α) = 0 := by
  ext
  simp [vec_mul]

theorem vec_mul_vec_eq (w : m → α) (v : n → α) : vec_mul_vec w v = col w ⬝ row v := by
  ext i j
  simp [vec_mul_vec, mul_apply]
  rfl

theorem smul_mul_vec_assoc [Fintype n] [Monoidₓ R] [DistribMulAction R α] [IsScalarTower R α α] (a : R)
    (A : Matrix m n α) (b : n → α) : (a • A).mulVec b = a • A.mul_vec b := by
  ext
  apply smul_dot_product

theorem mul_vec_add [Fintype n] (A : Matrix m n α) (x y : n → α) : A.mul_vec (x+y) = A.mul_vec x+A.mul_vec y := by
  ext
  apply dot_product_add

theorem add_mul_vec [Fintype n] (A B : Matrix m n α) (x : n → α) : (A+B).mulVec x = A.mul_vec x+B.mul_vec x := by
  ext
  apply add_dot_product

theorem vec_mul_add [Fintype m] (A B : Matrix m n α) (x : m → α) : vec_mul x (A+B) = vec_mul x A+vec_mul x B := by
  ext
  apply dot_product_add

theorem add_vec_mul [Fintype m] (A : Matrix m n α) (x y : m → α) : vec_mul (x+y) A = vec_mul x A+vec_mul y A := by
  ext
  apply add_dot_product

theorem vec_mul_smul [Fintype n] [CommSemiringₓ R] [Semiringₓ S] [Algebra R S] (M : Matrix n m S) (b : R) (v : n → S) :
    M.vec_mul (b • v) = b • M.vec_mul v := by
  ext i
...
theorem mul_vec_smul [Fintype n] [CommSemiringₓ R] [Semiringₓ S] [Algebra R S] (M : Matrix m n S) (b : R) (v : n → S) :
    M.mul_vec (b • v) = b • M.mul_vec v := by
  ext i
...
theorem vec_mul_vec_mul [Fintype m] (v : m → α) (M : Matrix m n α) (N : Matrix n o α) :
    vec_mul (vec_mul v M) N = vec_mul v (M ⬝ N) := by
  ext
  apply dot_product_assoc

@[simp]
theorem mul_vec_mul_vec [Fintype o] (v : o → α) (M : Matrix m n α) (N : Matrix n o α) :
    mul_vec M (mul_vec N v) = mul_vec (M ⬝ N) v := by
  ext
  symm
  apply dot_product_assoc
...
theorem neg_vec_mul [Fintype m] (v : m → α) (A : Matrix m n α) : vec_mul (-v) A = -vec_mul v A := by
  ext
  apply neg_dot_product

theorem vec_mul_neg [Fintype m] (v : m → α) (A : Matrix m n α) : vec_mul v (-A) = -vec_mul v A := by
  ext
  apply dot_product_neg

theorem neg_mul_vec [Fintype n] (v : n → α) (A : Matrix m n α) : mul_vec (-A) v = -mul_vec A v := by
  ext
  apply neg_dot_product

theorem mul_vec_neg [Fintype n] (v : n → α) (A : Matrix m n α) : mul_vec A (-v) = -mul_vec A v := by
  ext
  apply dot_product_neg
...
theorem mul_vec_transpose [Fintype m] (A : Matrix m n α) (x : m → α) : mul_vec (A)ᵀ x = vec_mul x A := by
  ext
  apply dot_product_comm

theorem vec_mul_transpose [Fintype n] (A : Matrix m n α) (x : n → α) : vec_mul x (A)ᵀ = mul_vec A x := by
  ext
  apply dot_product_comm
...
@[simp]
theorem transpose_transpose (M : Matrix m n α) : (M)ᵀᵀ = M := by
  ext <;> rfl
...
@[simp]
theorem transpose_add [Add α] (M : Matrix m n α) (N : Matrix m n α) : (M+N)ᵀ = (M)ᵀ+(N)ᵀ := by
  ext i j
  simp

@[simp]
theorem transpose_sub [Sub α] (M : Matrix m n α) (N : Matrix m n α) : (M - N)ᵀ = (M)ᵀ - (N)ᵀ := by
  ext i j
  simp

@[simp]
theorem transpose_mul [CommSemiringₓ α] [Fintype n] (M : Matrix m n α) (N : Matrix n l α) : (M ⬝ N)ᵀ = (N)ᵀ ⬝ (M)ᵀ := by
  ext i j
  apply dot_product_comm

@[simp]
theorem transpose_smul {R : Type _} [HasScalar R α] (c : R) (M : Matrix m n α) : (c • M)ᵀ = c • (M)ᵀ := by
  ext i j
  rfl

@[simp]
theorem transpose_neg [Neg α] (M : Matrix m n α) : (-M)ᵀ = -(M)ᵀ := by
  ext i j <;> rfl

theorem transpose_map {f : α → β} {M : Matrix m n α} : (M)ᵀ.map f = (M.map f)ᵀ := by
  ext
  rfl
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `transpose_sum [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `AddCommMonoidₓ [`α]) "]")
    (Term.implicitBinder "{" [`ι] [":" (Term.type "Type" [(Level.hole "_")])] "}")
    (Term.explicitBinder "(" [`s] [":" (Term.app `Finset [`ι])] [] ")")
    (Term.explicitBinder "(" [`M] [":" (Term.arrow `ι "→" (Term.app `Matrix [`m `n `α]))] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Matrix.Data.Matrix.Basic.«term_ᵀ»
      (Algebra.BigOperators.Basic.«term∑_in_,_»
       "∑"
       (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
       " in "
     ...
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      ...
      `s
      ", "
      (Matrix.Data.Matrix.Basic.«term_ᵀ» (Term.app `M [`i]) "ᵀ")))))
  (Command.declValSimple
   ":="
   (Term.app
    (Term.proj
     (Term.proj
      (Term.paren
       ...
       [`transpose_add_equiv
        [(Term.typeAscription
          ":"
          (Data.Equiv.MulAdd.«term_≃+_» (Term.app `Matrix [`m `n `α]) " ≃+ " (Term.app `Matrix [`n `m `α])))]]
       ")")
      "."
      `toAddMonoidHom)
     "."
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1500 >? 1022, (some 1023, term) <=? (some 1500, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `M [`i]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1500, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `s
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
theorem
  transpose_sum
  [ AddCommMonoidₓ α ] { ι : Type _ } ( s : Finset ι ) ( M : ι → Matrix m n α ) : ∑ i in s , M i ᵀ = ∑ i in s , M i ᵀ
...
@[simps]
def transpose_ring_equiv [CommSemiringₓ α] [Fintype m] : Matrix m m α ≃+* Matrix m m αᵐᵒᵖ :=
...
theorem transpose_list_prod [CommSemiringₓ α] [Fintype m] [DecidableEq m] (l : List (Matrix m m α)) :
  ...
  (transpose_ring_equiv : Matrix m m α ≃+* Matrix m m αᵐᵒᵖ).unop_map_list_prod l
...
@[simp]
theorem conj_transpose_conj_transpose [HasInvolutiveStar α] (M : Matrix m n α) : (M)ᴴᴴ = M := by
  ext <;> simp
...
@[simp]
theorem conj_transpose_add [AddMonoidₓ α] [StarAddMonoid α] (M N : Matrix m n α) : (M+N)ᴴ = (M)ᴴ+(N)ᴴ := by
  ext i j <;> simp

@[simp]
theorem conj_transpose_sub [AddGroupₓ α] [StarAddMonoid α] (M N : Matrix m n α) : (M - N)ᴴ = (M)ᴴ - (N)ᴴ := by
  ext i j <;> simp
...
@[simp]
theorem conj_transpose_neg [Ringₓ α] [StarRing α] (M : Matrix m n α) : (-M)ᴴ = -(M)ᴴ := by
  ext i j <;> simp
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `conj_transpose_sum [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `AddCommMonoidₓ [`α]) "]")
   ...
   (Term.typeSpec
    ":"
    («term_=_»
     (Matrix.Data.Matrix.Basic.«term_ᴴ»
      (Algebra.BigOperators.Basic.«term∑_in_,_»
       "∑"
       (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
       " in "
     ...
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      ...
      `s
      ", "
      (Matrix.Data.Matrix.Basic.«term_ᴴ» (Term.app `M [`i]) "ᴴ")))))
  (Command.declValSimple
   ":="
   (Term.app
    (Term.proj
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Matrix.Data.Matrix.Basic.«term_ᴴ» (Term.app `M [`i]) "ᴴ")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Matrix.Data.Matrix.Basic.«term_ᴴ»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1500, term))
  (Term.app `M [`i])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
...
theorem
  conj_transpose_sum
  [ AddCommMonoidₓ α ] [ StarAddMonoid α ] { ι : Type _ } ( s : Finset ι ) ( M : ι → Matrix m n α )
...
@[simps]
def conj_transpose_ring_equiv [CommSemiringₓ α] [StarRing α] [Fintype m] : Matrix m m α ≃+* Matrix m m αᵐᵒᵖ :=
...
theorem conj_transpose_list_prod [CommSemiringₓ α] [StarRing α] [Fintype m] [DecidableEq m] (l : List (Matrix m m α)) :
  ...
  (conj_transpose_ring_equiv : Matrix m m α ≃+* Matrix m m αᵐᵒᵖ).unop_map_list_prod l
...
theorem minor_mul_transpose_minor [Fintype n] [Fintype m] [Semiringₓ α] (e : n ≃ m) (M : Matrix n m α) :
    M.minor id e ⬝ (M)ᵀ.minor e id = M ⬝ (M)ᵀ := by
...
@[simp]
theorem col_smul [HasScalar R α] (x : R) (v : m → α) : col (x • v) = x • col v := by
  ext
  rfl
...
@[simp]
theorem row_smul [HasScalar R α] (x : R) (v : m → α) : row (x • v) = x • row v := by
  ext
  rfl
...
def update_column [DecidableEq m] (M : Matrix n m α) (j : m) (b : n → α) : Matrix n m α := fun i =>
...
theorem update_row_apply [DecidableEq n] {i' : n} : update_row M i b i' j = if i' = i then b j else M i' j := by
  by_cases' i' = i
  ·
...
theorem update_column_apply [DecidableEq m] {j' : m} : update_column M j c i j' = if j' = j then c i else M i j' := by
  by_cases' j' = j
  ·
...
theorem update_column_subsingleton [Subsingleton m] (A : Matrix n m R) (i : m) (b : n → R) :
    A.update_column i b = (col b).minor id (Function.const m ()) := by
  ext x y
  simp [update_column_apply, Subsingleton.elimₓ i y]

@[simp]
theorem update_row_subsingleton [Subsingleton n] (A : Matrix n m R) (i : n) (b : m → R) :
    A.update_row i b = (row b).minor (Function.const n ()) id := by
  ext x y
  simp [update_column_apply, Subsingleton.elimₓ i x]

theorem map_update_row [DecidableEq n] (f : α → β) : map (update_row M i b) f = update_row (M.map f) i (f ∘ b) := by
  ext i' j'
...
theorem map_update_column [DecidableEq m] (f : α → β) :
    map (update_column M j c) f = update_column (M.map f) j (f ∘ c) := by
  ext i' j'
  rw [update_column_apply, map_apply, map_apply, update_column_apply]
  exact apply_ite f _ _ _

theorem update_row_transpose [DecidableEq m] : update_row (M)ᵀ j c = (update_column M j c)ᵀ := by
  ext i' j
  rw [transpose_apply, update_row_apply, update_column_apply]
  rfl

theorem update_column_transpose [DecidableEq n] : update_column (M)ᵀ i b = (update_row M i b)ᵀ := by
  ext i' j
  rw [transpose_apply, update_row_apply, update_column_apply]
  rfl
...
theorem update_column_conj_transpose [DecidableEq n] [HasStar α] :
    update_column (M)ᴴ i (star b) = (update_row M i b)ᴴ := by
...
theorem map_vec_mul [Semiringₓ R] [Semiringₓ S] (f : R →+* S) (M : Matrix n m R) (v : n → R) (i : m) :
    f (M.vec_mul v i) = (M.map f).vecMul (f ∘ v) i := by
...
theorem map_mul_vec [Semiringₓ R] [Semiringₓ S] (f : R →+* S) (M : Matrix m n R) (v : n → R) (i : m) :
    f (M.mul_vec v i) = (M.map f).mulVec (f ∘ v) i := by
