...
theorem fromBlocks_multiply [Fintype l] [Fintype m] [NonUnitalNonAssocSemiring α] (A : Matrix n l α)
  ...
  rcases i with ⟨⟩ <;> rcases j with ⟨⟩ <;>
    simp only [fromBlocks, mul_apply, Fintype.sum_sum_type, Sum.elim_inl, sum.elim_inr,
...
theorem blockDiagonal_diagonal [DecidableEq m] (d : o → m → α) :
  ...
  by
  ext (⟨i, k⟩⟨j, k'⟩)
  simp only [blockDiagonal_apply, diagonal, Prod.mk.inj_iff, ← ite_and]
  congr 1
  rw [and_comm']
...
theorem blockDiagonal_add [AddZeroClass α] (M N : o → Matrix m n α) :
  ...
  by
  ext
  simp only [blockDiagonal_apply, Pi.add_apply]
  split_ifs <;> simp
...
theorem blockDiagonal_smul {R : Type _} [Monoid R] [AddMonoid α] [DistribMulAction R α] (x : R)
  ...
  by
  ext
  simp only [blockDiagonal_apply, Pi.smul_apply]
  split_ifs <;> simp
...
theorem blockDiag_diagonal [DecidableEq o] [DecidableEq m] (d : m × o → α) (k : o) :
  ...
  ext fun i j => by
    ...
    · rw [blockDiag, diagonal_apply_eq, diagonal_apply_eq]
    · rw [blockDiag, diagonal_apply_ne _ hij, diagonal_apply_ne _ (mt _ hij)]
...
theorem blockDiagonal'_add [AddZeroClass α] (M N : ∀ i, Matrix (m' i) (n' i) α) :
  ...
  by
  ext
  simp only [blockDiagonal'_apply, Pi.add_apply]
  split_ifs <;> simp
...
theorem blockDiagonal'_smul {R : Type _} [Semiring R] [AddCommMonoid α] [Module R α] (x : R)
  ...
  by
  ext
  simp only [blockDiagonal'_apply, Pi.smul_apply]
  split_ifs <;> simp
...
theorem blockDiag'_diagonal [DecidableEq o] [∀ i, DecidableEq (m' i)] (d : (Σi, m' i) → α) (k : o) :
  ...
  ext fun i j => by
    obtain rfl | hij := Decidable.eq_or_ne i j
    · rw [blockDiag', diagonal_apply_eq, diagonal_apply_eq]
    · rw [blockDiag', diagonal_apply_ne _ hij, diagonal_apply_ne _ (mt (fun h => _) hij)]
      cases h
      rfl
