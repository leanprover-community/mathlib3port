...
but is expected to have type
  forall {p : PNat -> Prop} [_inst_1 : DecidablePred.{1} PNat p] (h : Exists.{1} PNat (fun (n : PNat) => p n)), Iff (LT.lt.{0} PNat (Preorder.toLT.{0} PNat (PartialOrder.toPreorder.{0} PNat (OrderedCancelCommMonoid.toPartialOrder.{0} PNat (LinearOrderedCancelCommMonoid.toOrderedCancelCommMonoid.{0} PNat instPNatLinearOrderedCancelCommMonoid)))) (OfNat.ofNat.{0} PNat 1 (One.toOfNat1.{0} PNat instOnePNat)) (PNat.find (fun (n : PNat) => p n) (fun (a : PNat) => _inst_1 a) h)) (Not (p (OfNat.ofNat.{0} PNat 1 (One.toOfNat1.{0} PNat instOnePNat))))
...
but is expected to have type
  forall {p : PNat -> Prop} [_inst_1 : DecidablePred.{1} PNat p] (h : Exists.{1} PNat (fun (n : PNat) => p n)) (h₂ : Exists.{1} PNat (fun (n : PNat) => p (HAdd.hAdd.{0, 0, 0} PNat PNat PNat (instHAdd.{0} PNat instPNatAdd) n (OfNat.ofNat.{0} PNat 1 (One.toOfNat1.{0} PNat instOnePNat))))), (Not (p (OfNat.ofNat.{0} PNat 1 (One.toOfNat1.{0} PNat instOnePNat)))) -> (Eq.{1} PNat (PNat.find (fun (n : PNat) => p n) (fun (a : PNat) => _inst_1 a) h) (HAdd.hAdd.{0, 0, 0} PNat PNat PNat (instHAdd.{0} PNat instPNatAdd) (PNat.find (fun (n : PNat) => p (HAdd.hAdd.{0, 0, 0} PNat PNat PNat (instHAdd.{0} PNat instPNatAdd) n (OfNat.ofNat.{0} PNat 1 (One.toOfNat1.{0} PNat instOnePNat)))) (fun (a : PNat) => _inst_1 (HAdd.hAdd.{0, 0, 0} PNat PNat PNat (instHAdd.{0} PNat instPNatAdd) a (OfNat.ofNat.{0} PNat 1 (One.toOfNat1.{0} PNat instOnePNat)))) h₂) (OfNat.ofNat.{0} PNat 1 (One.toOfNat1.{0} PNat instOnePNat))))
