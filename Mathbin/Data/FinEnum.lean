...
def of_nodup_list [DecidableEq α] (xs : List α) (h : ∀ x : α, x ∈ xs) (h' : List.Nodupₓ xs) : FinEnum α :=
  { card := xs.length,
    Equiv :=
      ⟨fun x =>
        ⟨xs.index_of x, by
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.instance
  ...
  "instance"
  []
  [(Command.declId `psigma.fin_enum [])]
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `FinEnum [`α]) "]")
    (Term.instBinder
     "["
     []
     (Term.forall "∀" [(Term.simpleBinder [`a] [])] "," (Term.app `FinEnum [(Term.app `β [`a])]))
     "]")]
   (Term.typeSpec
    ":"
    (Term.app
  ...
  (Command.declValSimple
   ":="
   (Term.app `FinEnum.ofEquiv [(Term.hole "_") (Term.app `Equivₓ.psigmaEquivSigma [(Term.hole "_")])])
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Equivₓ.psigmaEquivSigma [(Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
instance
  psigma.fin_enum
  [ FinEnum α ] [ ∀ a , FinEnum β a ] : FinEnum Σ' a , β a
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.instance
  ...
  "instance"
  []
  [(Command.declId `psigma.fin_enum_prop_left [])]
  (Command.declSig
   [(Term.implicitBinder "{" [`α] [":" (Term.prop "Prop")] "}")
    (Term.implicitBinder "{" [`β] [":" (Term.arrow `α "→" (Term.type "Type" [`v]))] "}")
    (Term.instBinder
     "["
     []
     (Term.forall "∀" [(Term.simpleBinder [`a] [])] "," (Term.app `FinEnum [(Term.app `β [`a])]))
     "]")
    (Term.instBinder "[" [] (Term.app `Decidable [`α]) "]")]
   (Term.typeSpec
    ":"
    (Term.app
     `FinEnum
  ...
  (Command.declValSimple
   ...
   (termDepIfThenElse
    ...
    (Term.app
     `of_list
     [(«term_$__» (Term.proj (Term.app `to_list [(Term.app `β [`h])]) "." `map) "$" (Term.app `Psigma.mk [`h]))
      (Term.fun
       "fun"
       (Term.basicFun
    ...
    (Term.app
     ...
     [(«term[_]» "[" [] "]")
      (Term.fun
       "fun"
       (Term.basicFun [(Term.anonymousCtor "⟨" [`a "," `Ba] "⟩")] "=>" (Term.proj (Term.app `h [`a]) "." `elim)))]))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 10, term))
  (Term.proj (Term.app `to_list [(Term.app `β [`h])]) "." `map)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `to_list [(Term.app `β [`h])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `β [`h]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `to_list
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `to_list [(Term.paren "(" [(Term.app `β [`h]) []] ")")]) []]
 ")")
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(«term_$__»
   (Term.proj (Term.paren "(" [(Term.app `to_list [(Term.paren "(" [(Term.app `β [`h]) []] ")")]) []] ")") "." `map)
   "$"
   (Term.app `Psigma.mk [`h]))
  []]
 ")")
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.instance', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
instance
  psigma.fin_enum_prop_left
  { α : Prop } { β : α → Type v } [ ∀ a , FinEnum β a ] [ Decidable α ] : FinEnum Σ' a , β a
  :=
    if
      h
      :
      α
      then
      of_list to_list β h . map $ Psigma.mk h fun ⟨ a , Ba ⟩ => by simp
      else
      of_list [ ] fun ⟨ a , Ba ⟩ => h a . elim
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.instance
  ...
  "instance"
  []
  [(Command.declId `psigma.fin_enum_prop_right [])]
  (Command.declSig
   [(Term.implicitBinder "{" [`β] [":" (Term.arrow `α "→" (Term.prop "Prop"))] "}")
    (Term.instBinder "[" [] (Term.app `FinEnum [`α]) "]")
    (Term.instBinder
     "["
     []
     (Term.forall "∀" [(Term.simpleBinder [`a] [])] "," (Term.app `Decidable [(Term.app `β [`a])]))
     "]")]
   (Term.typeSpec
    ":"
    (Term.app
     ...
     (Term.anonymousCtor
      ...
      [(Term.fun
       ...
       (Term.fun
        ...
        (Term.basicFun [(Term.anonymousCtor "⟨" [`x "," `y] "⟩")] "=>" (Term.anonymousCtor "⟨" [`x "," `y] "⟩")))
       ","
       (Term.fun "fun" (Term.basicFun [(Term.anonymousCtor "⟨" [`x "," `y] "⟩")] "=>" `rfl))
       ","
       (Term.fun "fun" (Term.basicFun [(Term.anonymousCtor "⟨" [`x "," `y] "⟩")] "=>" `rfl))]
      "⟩")])
   [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.instance', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
instance
  psigma.fin_enum_prop_right
  { β : α → Prop } [ FinEnum α ] [ ∀ a , Decidable β a ] : FinEnum Σ' a , β a
  :=
    FinEnum.ofEquiv
      { a // β a }
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.instance
  ...
  "instance"
  []
  [(Command.declId `psigma.fin_enum_prop_prop [])]
  (Command.declSig
   [(Term.implicitBinder "{" [`α] [":" (Term.prop "Prop")] "}")
    (Term.implicitBinder "{" [`β] [":" (Term.arrow `α "→" (Term.prop "Prop"))] "}")
    (Term.instBinder "[" [] (Term.app `Decidable [`α]) "]")
  ...
  (Command.declValSimple
   ...
   (termDepIfThenElse
    ...
    (Term.app
     `of_list
     [(«term[_]» "[" [(Term.anonymousCtor "⟨" [`h.fst "," `h.snd] "⟩")] "]")
      (Term.byTactic
       "by"
       (Tactic.tacticSeq
     ...
     [(«term[_]» "[" [] "]")
      (Term.fun
       ...
       (Term.basicFun
        [(Term.simpleBinder [`a] [])]
        "=>"
        (Term.proj (Term.app `h [(Term.anonymousCtor "⟨" [`a.fst "," `a.snd] "⟩")]) "." `elim)))]))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `h [(Term.anonymousCtor "⟨" [`a.fst "," `a.snd] "⟩")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.anonymousCtor "⟨" [`a.fst "," `a.snd] "⟩")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.anonymousCtor.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.anonymousCtor "⟨" [`h.fst "," `h.snd] "⟩")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.anonymousCtor.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.instance', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
instance
  psigma.fin_enum_prop_prop
  { α : Prop } { β : α → Prop } [ Decidable α ] [ ∀ a , Decidable β a ] : FinEnum Σ' a , β a
  :=
    if
      h
      :
      ∃ a , β a
      then
      of_list [ ⟨ h.fst , h.snd ⟩ ] by rintro ⟨ ⟩ <;> simp
      else
      of_list [ ] fun a => h ⟨ a.fst , a.snd ⟩ . elim
