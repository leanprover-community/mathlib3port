...
#align_import data.set.intervals.order_iso from "leanprover-community/mathlib"@"c3291da49cfa65f0d43b094750541c0731edc932"
...
#print OrderIso.preimage_Iic /-
@[simp]
theorem preimage_Iic (e : α ≃o β) (b : β) : e ⁻¹' Iic b = Iic (e.symm b) := by ext x;
  simp [← e.le_iff_le]
#align order_iso.preimage_Iic OrderIso.preimage_Iic
-/

#print OrderIso.preimage_Ici /-
@[simp]
theorem preimage_Ici (e : α ≃o β) (b : β) : e ⁻¹' Ici b = Ici (e.symm b) := by ext x;
  simp [← e.le_iff_le]
#align order_iso.preimage_Ici OrderIso.preimage_Ici
-/

#print OrderIso.preimage_Iio /-
@[simp]
theorem preimage_Iio (e : α ≃o β) (b : β) : e ⁻¹' Iio b = Iio (e.symm b) := by ext x;
  simp [← e.lt_iff_lt]
#align order_iso.preimage_Iio OrderIso.preimage_Iio
-/

#print OrderIso.preimage_Ioi /-
@[simp]
theorem preimage_Ioi (e : α ≃o β) (b : β) : e ⁻¹' Ioi b = Ioi (e.symm b) := by ext x;
  simp [← e.lt_iff_lt]
#align order_iso.preimage_Ioi OrderIso.preimage_Ioi
-/

#print OrderIso.preimage_Icc /-
@[simp]
