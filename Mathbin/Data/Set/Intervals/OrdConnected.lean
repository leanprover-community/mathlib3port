...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `ord_connected_Inter [])
  (Command.declSig
   [(Term.implicitBinder "{" [`ι] [":" (Term.sort "Sort" [(Level.hole "_")])] "}")
    ...
    (Term.explicitBinder
     "("
     [`hs]
     [":" (Term.forall "∀" [(Term.simpleBinder [`i] [])] "," (Term.app `ord_connected [(Term.app `s [`i])]))]
     []
     ")")]
   (Term.typeSpec
    ":"
  ...
  (Command.declValSimple
   ":="
   («term_$__» `ord_connected_sInter "$" (Term.app (Term.proj `forall_range_iff "." (fieldIdx "2")) [`hs]))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.proj `forall_range_iff "." (fieldIdx "2")) [`hs])
...
theorem
  ord_connected_Inter
  { ι : Sort _ } { s : ι → Set α } ( hs : ∀ i , ord_connected s i ) : ord_connected ⋂ i , s i
   ...
   (Term.typeSpec
    ...
    (Term.app
     ...
     [(Set.Data.Set.Lattice.«term⋂_,_»
       ...
       ", "
       (Term.app `s [`i]))])))
  (Command.declValSimple ":=" (Term.app `ord_connected_Inter [(«term‹_›» "‹" (Term.hole "_") "›")]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `ord_connected_Inter [(«term‹_›» "‹" (Term.hole "_") "›")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
instance
  ord_connected_Inter'
  { ι : Sort _ } { s : ι → Set α } [ ∀ i , ord_connected s i ] : ord_connected ⋂ i , s i
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `ord_connected_bInter [])
  (Command.declSig
   [(Term.implicitBinder "{" [`ι] [":" (Term.sort "Sort" [(Level.hole "_")])] "}")
     ...
     [":"
      (Term.forall
       ...
       [(Term.simpleBinder [`i] [(Term.typeSpec ":" `ι)])
        (Term.simpleBinder [`hi] [(Term.typeSpec ":" (Term.app `p [`i]))])]
       ","
       (Term.app `Set [`α]))]
     "}")
    (Term.explicitBinder
     "("
     [`hs]
     [":" (Term.forall "∀" [(Term.simpleBinder [`i `hi] [])] "," (Term.app `ord_connected [(Term.app `s [`i `hi])]))]
     []
     ")")]
   (Term.typeSpec
    ":"
  ...
  (Command.declValSimple
   ...
   («term_$__»
    ...
    (Term.fun
     "fun"
     (Term.basicFun [(Term.simpleBinder [`i] [])] "=>" («term_$__» `ord_connected_Inter "$" (Term.app `hs [`i])))))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_$__» `ord_connected_Inter "$" (Term.app `hs [`i]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `hs [`i])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
theorem
  ...
  { ι : Sort _ } { p : ι → Prop } { s : ∀ i : ι hi : p i , Set α } ( hs : ∀ i hi , ord_connected s i hi )
