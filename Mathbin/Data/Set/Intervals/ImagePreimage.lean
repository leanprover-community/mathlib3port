...
theorem Ioo_add_bij : bij_on (·+d) (Ioo a b) (Ioo (a+d) (b+d)) :=
  by 
    refine'
...
theorem Ioc_add_bij : bij_on (·+d) (Ioc a b) (Ioc (a+d) (b+d)) :=
  by 
    refine'
...
theorem Ico_add_bij : bij_on (·+d) (Ico a b) (Ico (a+d) (b+d)) :=
  by 
    refine'
...
theorem Ici_add_bij : bij_on (·+d) (Ici a) (Ici (a+d)) :=
  by 
...
theorem Ioi_add_bij : bij_on (·+d) (Ioi a) (Ioi (a+d)) :=
  by 
...
@[simp]
theorem preimage_const_add_Icc : (fun x => a+x) ⁻¹' Icc b c = Icc (b - a) (c - a) :=
  by 
    simp [←Ici_inter_Iic]

@[simp]
theorem preimage_const_add_Ico : (fun x => a+x) ⁻¹' Ico b c = Ico (b - a) (c - a) :=
  by 
    simp [←Ici_inter_Iio]

@[simp]
theorem preimage_const_add_Ioc : (fun x => a+x) ⁻¹' Ioc b c = Ioc (b - a) (c - a) :=
  by 
    simp [←Ioi_inter_Iic]

@[simp]
theorem preimage_const_add_Ioo : (fun x => a+x) ⁻¹' Ioo b c = Ioo (b - a) (c - a) :=
  by 
    simp [←Ioi_inter_Iio]
...
@[simp]
theorem preimage_add_const_Icc : (fun x => x+a) ⁻¹' Icc b c = Icc (b - a) (c - a) :=
  by 
    simp [←Ici_inter_Iic]

@[simp]
theorem preimage_add_const_Ico : (fun x => x+a) ⁻¹' Ico b c = Ico (b - a) (c - a) :=
  by 
    simp [←Ici_inter_Iio]

@[simp]
theorem preimage_add_const_Ioc : (fun x => x+a) ⁻¹' Ioc b c = Ioc (b - a) (c - a) :=
  by 
    simp [←Ioi_inter_Iic]

@[simp]
theorem preimage_add_const_Ioo : (fun x => x+a) ⁻¹' Ioo b c = Ioo (b - a) (c - a) :=
  by 
    simp [←Ioi_inter_Iio]
...
@[simp]
theorem preimage_neg_Icc : -Icc a b = Icc (-b) (-a) :=
  by 
    simp [←Ici_inter_Iic, inter_comm]

@[simp]
theorem preimage_neg_Ico : -Ico a b = Ioc (-b) (-a) :=
  by 
    simp [←Ici_inter_Iio, ←Ioi_inter_Iic, inter_comm]

@[simp]
theorem preimage_neg_Ioc : -Ioc a b = Ico (-b) (-a) :=
  by 
    simp [←Ioi_inter_Iic, ←Ici_inter_Iio, inter_comm]

@[simp]
theorem preimage_neg_Ioo : -Ioo a b = Ioo (-b) (-a) :=
  by 
...
@[simp]
theorem preimage_sub_const_Ici : (fun x => x - a) ⁻¹' Ici b = Ici (b+a) :=
  by 
    simp [sub_eq_add_neg]

@[simp]
theorem preimage_sub_const_Ioi : (fun x => x - a) ⁻¹' Ioi b = Ioi (b+a) :=
  by 
    simp [sub_eq_add_neg]

@[simp]
theorem preimage_sub_const_Iic : (fun x => x - a) ⁻¹' Iic b = Iic (b+a) :=
  by 
    simp [sub_eq_add_neg]

@[simp]
theorem preimage_sub_const_Iio : (fun x => x - a) ⁻¹' Iio b = Iio (b+a) :=
  by 
    simp [sub_eq_add_neg]

@[simp]
theorem preimage_sub_const_Icc : (fun x => x - a) ⁻¹' Icc b c = Icc (b+a) (c+a) :=
  by 
    simp [sub_eq_add_neg]

@[simp]
theorem preimage_sub_const_Ico : (fun x => x - a) ⁻¹' Ico b c = Ico (b+a) (c+a) :=
  by 
    simp [sub_eq_add_neg]

@[simp]
theorem preimage_sub_const_Ioc : (fun x => x - a) ⁻¹' Ioc b c = Ioc (b+a) (c+a) :=
  by 
    simp [sub_eq_add_neg]

@[simp]
theorem preimage_sub_const_Ioo : (fun x => x - a) ⁻¹' Ioo b c = Ioo (b+a) (c+a) :=
  by 
    simp [sub_eq_add_neg]
...
@[simp]
theorem preimage_const_sub_Icc : (fun x => a - x) ⁻¹' Icc b c = Icc (a - c) (a - b) :=
  by 
    simp [←Ici_inter_Iic, inter_comm]

@[simp]
theorem preimage_const_sub_Ico : (fun x => a - x) ⁻¹' Ico b c = Ioc (a - c) (a - b) :=
  by 
    simp [←Ioi_inter_Iic, ←Ici_inter_Iio, inter_comm]

@[simp]
theorem preimage_const_sub_Ioc : (fun x => a - x) ⁻¹' Ioc b c = Ico (a - c) (a - b) :=
  by 
    simp [←Ioi_inter_Iic, ←Ici_inter_Iio, inter_comm]

@[simp]
theorem preimage_const_sub_Ioo : (fun x => a - x) ⁻¹' Ioo b c = Ioo (a - c) (a - b) :=
  by 
    simp [←Ioi_inter_Iio, inter_comm]
...
@[simp]
theorem image_const_add_Ici : (fun x => a+x) '' Ici b = Ici (a+b) :=
  by 
    simp [add_commₓ]

@[simp]
theorem image_const_add_Iic : (fun x => a+x) '' Iic b = Iic (a+b) :=
  by 
    simp [add_commₓ]

@[simp]
theorem image_const_add_Iio : (fun x => a+x) '' Iio b = Iio (a+b) :=
  by 
    simp [add_commₓ]

@[simp]
theorem image_const_add_Ioi : (fun x => a+x) '' Ioi b = Ioi (a+b) :=
  by 
    simp [add_commₓ]

@[simp]
theorem image_const_add_Icc : (fun x => a+x) '' Icc b c = Icc (a+b) (a+c) :=
  by 
    simp [add_commₓ]

@[simp]
theorem image_const_add_Ico : (fun x => a+x) '' Ico b c = Ico (a+b) (a+c) :=
  by 
    simp [add_commₓ]

@[simp]
theorem image_const_add_Ioc : (fun x => a+x) '' Ioc b c = Ioc (a+b) (a+c) :=
  by 
    simp [add_commₓ]

@[simp]
theorem image_const_add_Ioo : (fun x => a+x) '' Ioo b c = Ioo (a+b) (a+c) :=
  by 
    simp [add_commₓ]
...
theorem image_neg_Ici : Neg.neg '' Ici a = Iic (-a) :=
  by 
    simp 

theorem image_neg_Iic : Neg.neg '' Iic a = Ici (-a) :=
  by 
    simp 

theorem image_neg_Ioi : Neg.neg '' Ioi a = Iio (-a) :=
  by 
    simp 

theorem image_neg_Iio : Neg.neg '' Iio a = Ioi (-a) :=
  by 
    simp 

theorem image_neg_Icc : Neg.neg '' Icc a b = Icc (-b) (-a) :=
  by 
    simp 

theorem image_neg_Ico : Neg.neg '' Ico a b = Ioc (-b) (-a) :=
  by 
    simp 

theorem image_neg_Ioc : Neg.neg '' Ioc a b = Ico (-b) (-a) :=
  by 
    simp 

theorem image_neg_Ioo : Neg.neg '' Ioo a b = Ioo (-b) (-a) :=
  by 
    simp 
...
@[simp]
theorem image_const_sub_Ici : (fun x => a - x) '' Ici b = Iic (a - b) :=
  by 
    simp [sub_eq_add_neg, image_comp (fun x => a+x) fun x => -x]

@[simp]
theorem image_const_sub_Iic : (fun x => a - x) '' Iic b = Ici (a - b) :=
  by 
    simp [sub_eq_add_neg, image_comp (fun x => a+x) fun x => -x]

@[simp]
theorem image_const_sub_Ioi : (fun x => a - x) '' Ioi b = Iio (a - b) :=
  by 
    simp [sub_eq_add_neg, image_comp (fun x => a+x) fun x => -x]
...
@[simp]
theorem image_const_sub_Ico : (fun x => a - x) '' Ico b c = Ioc (a - c) (a - b) :=
  by 
    simp [sub_eq_add_neg, image_comp (fun x => a+x) fun x => -x]

@[simp]
theorem image_const_sub_Ioc : (fun x => a - x) '' Ioc b c = Ico (a - c) (a - b) :=
  by 
    simp [sub_eq_add_neg, image_comp (fun x => a+x) fun x => -x]

@[simp]
theorem image_const_sub_Ioo : (fun x => a - x) '' Ioo b c = Ioo (a - c) (a - b) :=
  by 
    simp [sub_eq_add_neg, image_comp (fun x => a+x) fun x => -x]
...
@[simp]
theorem image_sub_const_Ici : (fun x => x - a) '' Ici b = Ici (b - a) :=
  by 
    simp [sub_eq_neg_add]

@[simp]
theorem image_sub_const_Iic : (fun x => x - a) '' Iic b = Iic (b - a) :=
  by 
    simp [sub_eq_neg_add]

@[simp]
theorem image_sub_const_Ioi : (fun x => x - a) '' Ioi b = Ioi (b - a) :=
  by 
    simp [sub_eq_neg_add]

@[simp]
theorem image_sub_const_Iio : (fun x => x - a) '' Iio b = Iio (b - a) :=
  by 
    simp [sub_eq_neg_add]
...
@[simp]
theorem image_sub_const_Ioc : (fun x => x - a) '' Ioc b c = Ioc (b - a) (c - a) :=
  by 
    simp [sub_eq_neg_add]

@[simp]
theorem image_sub_const_Ioo : (fun x => x - a) '' Ioo b c = Ioo (b - a) (c - a) :=
  by 
    simp [sub_eq_neg_add]
...
@[simp]
theorem preimage_mul_const_Ioo (a b : k) {c : k} (h : 0 < c) : (fun x => x*c) ⁻¹' Ioo a b = Ioo (a / c) (b / c) :=
  by 
    simp [←Ioi_inter_Iio, h]

@[simp]
theorem preimage_mul_const_Ioc (a b : k) {c : k} (h : 0 < c) : (fun x => x*c) ⁻¹' Ioc a b = Ioc (a / c) (b / c) :=
  by 
    simp [←Ioi_inter_Iic, h]

@[simp]
theorem preimage_mul_const_Ico (a b : k) {c : k} (h : 0 < c) : (fun x => x*c) ⁻¹' Ico a b = Ico (a / c) (b / c) :=
  by 
    simp [←Ici_inter_Iio, h]

@[simp]
theorem preimage_mul_const_Icc (a b : k) {c : k} (h : 0 < c) : (fun x => x*c) ⁻¹' Icc a b = Icc (a / c) (b / c) :=
  by 
...
@[simp]
theorem preimage_const_mul_Ioo (a b : k) {c : k} (h : 0 < c) : (·*·) c ⁻¹' Ioo a b = Ioo (a / c) (b / c) :=
  by 
    simp [←Ioi_inter_Iio, h]

@[simp]
theorem preimage_const_mul_Ioc (a b : k) {c : k} (h : 0 < c) : (·*·) c ⁻¹' Ioc a b = Ioc (a / c) (b / c) :=
  by 
    simp [←Ioi_inter_Iic, h]

@[simp]
theorem preimage_const_mul_Ico (a b : k) {c : k} (h : 0 < c) : (·*·) c ⁻¹' Ico a b = Ico (a / c) (b / c) :=
  by 
    simp [←Ici_inter_Iio, h]

@[simp]
theorem preimage_const_mul_Icc (a b : k) {c : k} (h : 0 < c) : (·*·) c ⁻¹' Icc a b = Icc (a / c) (b / c) :=
  by 
    simp [←Ici_inter_Iic, h]

@[simp]
theorem preimage_const_mul_Iio_of_neg (a : k) {c : k} (h : c < 0) : (·*·) c ⁻¹' Iio a = Ioi (a / c) :=
  by 
    simpa only [mul_commₓ] using preimage_mul_const_Iio_of_neg a h

@[simp]
theorem preimage_const_mul_Ioi_of_neg (a : k) {c : k} (h : c < 0) : (·*·) c ⁻¹' Ioi a = Iio (a / c) :=
  by 
    simpa only [mul_commₓ] using preimage_mul_const_Ioi_of_neg a h

@[simp]
theorem preimage_const_mul_Iic_of_neg (a : k) {c : k} (h : c < 0) : (·*·) c ⁻¹' Iic a = Ici (a / c) :=
  by 
    simpa only [mul_commₓ] using preimage_mul_const_Iic_of_neg a h

@[simp]
theorem preimage_const_mul_Ici_of_neg (a : k) {c : k} (h : c < 0) : (·*·) c ⁻¹' Ici a = Iic (a / c) :=
  by 
    simpa only [mul_commₓ] using preimage_mul_const_Ici_of_neg a h

@[simp]
theorem preimage_const_mul_Ioo_of_neg (a b : k) {c : k} (h : c < 0) : (·*·) c ⁻¹' Ioo a b = Ioo (b / c) (a / c) :=
  by 
    simpa only [mul_commₓ] using preimage_mul_const_Ioo_of_neg a b h

@[simp]
theorem preimage_const_mul_Ioc_of_neg (a b : k) {c : k} (h : c < 0) : (·*·) c ⁻¹' Ioc a b = Ico (b / c) (a / c) :=
  by 
    simpa only [mul_commₓ] using preimage_mul_const_Ioc_of_neg a b h

@[simp]
theorem preimage_const_mul_Ico_of_neg (a b : k) {c : k} (h : c < 0) : (·*·) c ⁻¹' Ico a b = Ioc (b / c) (a / c) :=
  by 
    simpa only [mul_commₓ] using preimage_mul_const_Ico_of_neg a b h

@[simp]
theorem preimage_const_mul_Icc_of_neg (a b : k) {c : k} (h : c < 0) : (·*·) c ⁻¹' Icc a b = Icc (b / c) (a / c) :=
  by 
...
theorem image_mul_right_Icc {a b c : k} (hab : a ≤ b) (hc : 0 ≤ c) : (fun x => x*c) '' Icc a b = Icc (a*c) (b*c) :=
  by 
...
theorem image_mul_left_Icc' {a : k} (h : 0 < a) (b c : k) : (·*·) a '' Icc b c = Icc (a*b) (a*c) :=
  by 
    convert image_mul_right_Icc' b c h using 1 <;> simp only [mul_commₓ _ a]

theorem image_mul_left_Icc {a b c : k} (ha : 0 ≤ a) (hbc : b ≤ c) : (·*·) a '' Icc b c = Icc (a*b) (a*c) :=
  by 
...
theorem image_mul_left_Ioo {a : k} (h : 0 < a) (b c : k) : (·*·) a '' Ioo b c = Ioo (a*b) (a*c) :=
  by 
    convert image_mul_right_Ioo b c h using 1 <;> simp only [mul_commₓ _ a]

/-- The image under `inv` of `Ioo 0 a` is `Ioi a⁻¹`. -/
theorem image_inv_Ioo_0_left {a : k} (ha : 0 < a) : HasInv.inv '' Ioo 0 a = Ioi (a⁻¹) :=
  by 
    ext x 
    exact
      ⟨fun ⟨y, ⟨hy0, hya⟩, hyx⟩ => hyx ▸ (inv_lt_inv ha hy0).2 hya,
        fun h =>
...
@[simp]
theorem image_affine_Icc' {a : k} (h : 0 < a) (b c d : k) : (fun x => (a*x)+b) '' Icc c d = Icc ((a*c)+b) ((a*d)+b) :=
  by 
    suffices  : (fun x => x+b) '' ((fun x => a*x) '' Icc c d) = Icc ((a*c)+b) ((a*d)+b)
    ·
