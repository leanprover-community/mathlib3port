...
theorem interval_of_le (h : a ≤ b) :
  "././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)" = Icc a b :=
  by 
...
theorem interval_of_ge (h : b ≤ a) :
  "././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)" = Icc b a :=
  by 
...
-- ././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)
@[simp]
theorem interval_self : "././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)" = {a} :=
  Set.ext$
    by 
...
-- ././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)
@[simp]
theorem nonempty_interval : Set.Nonempty "././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)" :=
  by 
...
-- ././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)
@[simp]
theorem left_mem_interval : a ∈ "././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)" :=
  by 
    rw [interval, mem_Icc]
...
-- ././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)
@[simp]
theorem right_mem_interval : b ∈ "././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)" :=
  by 
    rw [interval_swap]
    exact left_mem_interval

-- ././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)
theorem Icc_subset_interval : Icc a b ⊆ "././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)" :=
  by 
    intro x h 
    rwa [interval_of_le]
...
-- ././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)
theorem Icc_subset_interval' : Icc b a ⊆ "././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)" :=
  by 
    rw [interval_swap]
...
theorem mem_interval_of_le (ha : a ≤ x) (hb : x ≤ b) :
  x ∈ "././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)" :=
...
-- ././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)
-- ././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)
theorem interval_subset_interval (h₁ : a₁ ∈ "././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)")
  (h₂ : b₁ ∈ "././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)") :
  "././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)" ⊆
    "././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)" :=
...
theorem interval_subset_interval_iff_mem :
  "././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)" ⊆
      "././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)" ↔
    a₁ ∈ "././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)" ∧
      b₁ ∈ "././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)" :=
...
theorem interval_subset_interval_right
  (h : x ∈ "././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)") :
  "././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)" ⊆
    "././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)" :=
...
theorem bdd_below_bdd_above_iff_subset_interval (s : Set α) :
  BddBelow s ∧ BddAbove s ↔ ∃ a b, s ⊆ "././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)" :=
  by 
...
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » Ioc a b)
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » Ioc b a)
...
theorem preimage_const_add_interval :
  (fun x => a+x) ⁻¹' "././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)" =
    "././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)" :=
  by 
...
theorem preimage_add_const_interval :
  (fun x => x+a) ⁻¹' "././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)" =
    "././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)" :=
  by 
...
theorem image_neg_interval :
  Neg.neg '' "././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)" =
    "././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)" :=
  by 
    simp 
...
theorem abs_sub_left_of_mem_interval
  (h : x ∈ "././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)") : |x - a| ≤ |b - a| :=
...
theorem abs_sub_right_of_mem_interval
  (h : x ∈ "././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)") : |b - x| ≤ |b - a| :=
...
theorem image_mul_const_interval (a b c : k) :
  ...
  if ha : a = 0 then
    ...
    calc
      ...
      _ = (fun x => x / a) ⁻¹' "././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)" :=
      by 
        simp only [div_eq_mul_inv]
      _ = "././Mathport/Syntax/Translate/Basic.lean:589:47: unsupported (impossible)" :=
