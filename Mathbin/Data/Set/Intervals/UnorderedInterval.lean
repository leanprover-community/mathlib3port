...
theorem interval_of_le (h : a ≤ b) :
    "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)" = Icc a b := by
  rw [interval, min_eq_leftₓ h, max_eq_rightₓ h]

-- ././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)
@[simp]
theorem interval_of_ge (h : b ≤ a) :
    "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)" = Icc b a := by
...
theorem interval_of_lt (h : a < b) :
    "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)" = Icc a b :=
  interval_of_le (le_of_ltₓ h)

-- ././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)
theorem interval_of_gt (h : b < a) :
    "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)" = Icc b a :=
...
-- ././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)
@[simp]
theorem interval_self : "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)" = {a} :=
  Set.ext $ by
    simp [le_antisymm_iffₓ, and_comm]

-- ././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)
@[simp]
theorem nonempty_interval : Set.Nonempty "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)" :=
  by
...
-- ././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)
@[simp]
theorem left_mem_interval : a ∈ "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)" := by
  rw [interval, mem_Icc]
  exact ⟨min_le_leftₓ _ _, le_max_leftₓ _ _⟩

-- ././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)
@[simp]
theorem right_mem_interval : b ∈ "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)" := by
  rw [interval_swap]
  exact left_mem_interval

-- ././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)
theorem Icc_subset_interval : Icc a b ⊆ "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)" :=
  by
  intro x h
  rwa [interval_of_le]
...
-- ././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)
theorem Icc_subset_interval' : Icc b a ⊆ "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)" :=
  by
  rw [interval_swap]
...
theorem mem_interval_of_le (ha : a ≤ x) (hb : x ≤ b) :
    x ∈ "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)" :=
...
-- ././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)
-- ././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)
theorem interval_subset_interval (h₁ : a₁ ∈ "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)")
    (h₂ : b₁ ∈ "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)") :
    "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)" ⊆
      "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)" :=
...
theorem interval_subset_interval_iff_mem :
    "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)" ⊆
        "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)" ↔
      a₁ ∈ "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)" ∧
        b₁ ∈ "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)" :=
...
theorem interval_subset_interval_right
    (h : x ∈ "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)") :
    "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)" ⊆
      "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)" :=
...
theorem bdd_below_bdd_above_iff_subset_interval (s : Set α) :
    BddBelow s ∧ BddAbove s ↔ ∃ a b, s ⊆ "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)" :=
  by
...
theorem preimage_const_add_interval :
    (fun x => a+x) ⁻¹' "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)" =
      "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)" :=
  by
...
theorem preimage_add_const_interval :
    (fun x => x+a) ⁻¹' "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)" =
      "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)" :=
  by
...
theorem image_neg_interval :
    Neg.neg '' "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)" =
      "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)" :=
  by
  simp
...
theorem abs_sub_left_of_mem_interval
    (h : x ∈ "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)") : |x - a| ≤ |b - a| :=
...
theorem abs_sub_right_of_mem_interval
    (h : x ∈ "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)") : |b - x| ≤ |b - a| :=
...
theorem image_mul_const_interval (a b c : k) :
  ...
  if ha : a = 0 then by
    ...
    calc
      ...
      _ = (fun x => x / a) ⁻¹' "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)" := by
      simp only [div_eq_mul_inv]
      _ = "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)" :=
