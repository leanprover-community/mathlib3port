...
but is expected to have type
  forall {α : Type.{u3}} {β : Type.{u1}} {ι : Sort.{u2}} {s : ι -> (Set.{u3} α)}, (Directed.{u3, u2} (Set.{u3} α) ι (fun (x._@.Mathlib.Data.Set.Lattice._hyg.24633 : Set.{u3} α) (x._@.Mathlib.Data.Set.Lattice._hyg.24635 : Set.{u3} α) => HasSubset.Subset.{u3} (Set.{u3} α) (Set.instHasSubsetSet_1.{u3} α) x._@.Mathlib.Data.Set.Lattice._hyg.24633 x._@.Mathlib.Data.Set.Lattice._hyg.24635) s) -> (forall {f : α -> β}, (forall (i : ι), Set.InjOn.{u3, u1} α β f (s i)) -> (Set.InjOn.{u3, u1} α β f (Set.unionᵢ.{u3, u2} α ι (fun (i : ι) => s i))))
...
but is expected to have type
  forall {α : Type.{u3}} {β : Type.{u1}} {ι : Sort.{u2}} {s : ι -> (Set.{u3} α)}, (Directed.{u3, u2} (Set.{u3} α) ι (fun (x._@.Mathlib.Data.Set.Lattice._hyg.25755 : Set.{u3} α) (x._@.Mathlib.Data.Set.Lattice._hyg.25757 : Set.{u3} α) => HasSubset.Subset.{u3} (Set.{u3} α) (Set.instHasSubsetSet_1.{u3} α) x._@.Mathlib.Data.Set.Lattice._hyg.25755 x._@.Mathlib.Data.Set.Lattice._hyg.25757) s) -> (forall {t : ι -> (Set.{u1} β)} {f : α -> β}, (forall (i : ι), Set.BijOn.{u3, u1} α β f (s i) (t i)) -> (Set.BijOn.{u3, u1} α β f (Set.unionᵢ.{u3, u2} α ι (fun (i : ι) => s i)) (Set.unionᵢ.{u1, u2} β ι (fun (i : ι) => t i))))
...
but is expected to have type
  forall {α : Type.{u2}} {β : Type.{u1}} {ι : Sort.{u3}} [_inst_1 : Nonempty.{u3} ι] {s : ι -> (Set.{u2} α)}, (Directed.{u2, u3} (Set.{u2} α) ι (fun (x._@.Mathlib.Data.Set.Lattice._hyg.25875 : Set.{u2} α) (x._@.Mathlib.Data.Set.Lattice._hyg.25877 : Set.{u2} α) => HasSubset.Subset.{u2} (Set.{u2} α) (Set.instHasSubsetSet_1.{u2} α) x._@.Mathlib.Data.Set.Lattice._hyg.25875 x._@.Mathlib.Data.Set.Lattice._hyg.25877) s) -> (forall {t : ι -> (Set.{u1} β)} {f : α -> β}, (forall (i : ι), Set.BijOn.{u2, u1} α β f (s i) (t i)) -> (Set.BijOn.{u2, u1} α β f (Set.interᵢ.{u2, u3} α ι (fun (i : ι) => s i)) (Set.interᵢ.{u1, u3} β ι (fun (i : ι) => t i))))
...
but is expected to have type
  forall {α : Type.{u1}} {β : Type.{u3}} {γ : Type.{u2}} {s : Set.{max u3 u2} (β -> γ)} {t : Set.{max u1 u3} (α -> β)} {u : Set.{u1} α}, Eq.{succ u2} (Set.{u2} γ) (Set.seq.{u3, u2} β γ s (Set.seq.{u1, u3} α β t u)) (Set.seq.{u1, u2} α γ (Set.seq.{max u3 u1, max u2 u1} (α -> β) (α -> γ) (Set.image.{max u3 u2, max (max u2 u1) u3 u1} (β -> γ) ((α -> β) -> α -> γ) (fun (x._@.Mathlib.Data.Set.Lattice._hyg.31330 : β -> γ) (x._@.Mathlib.Data.Set.Lattice._hyg.31332 : α -> β) => Function.comp.{succ u1, succ u3, succ u2} α β γ x._@.Mathlib.Data.Set.Lattice._hyg.31330 x._@.Mathlib.Data.Set.Lattice._hyg.31332) s) t) u)
...
but is expected to have type
  forall {α : Type.{u3}} {β : Type.{u2}} {γ : Type.{u1}} {f : β -> γ} {s : Set.{max u3 u2} (α -> β)} {t : Set.{u3} α}, Eq.{succ u1} (Set.{u1} γ) (Set.image.{u2, u1} β γ f (Set.seq.{u3, u2} α β s t)) (Set.seq.{u3, u1} α γ (Set.image.{max u2 u3, max u1 u3} (α -> β) (α -> γ) ((fun (x._@.Mathlib.Data.Set.Lattice._hyg.31512 : β -> γ) (x._@.Mathlib.Data.Set.Lattice._hyg.31514 : α -> β) => Function.comp.{succ u3, succ u2, succ u1} α β γ x._@.Mathlib.Data.Set.Lattice._hyg.31512 x._@.Mathlib.Data.Set.Lattice._hyg.31514) f) s) t)
