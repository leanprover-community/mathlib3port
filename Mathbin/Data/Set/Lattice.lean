...
instance : HasInfₓ Set α := ⟨ fun s => { a | ∀ t _ : t ∈ s , a ∈ t } ⟩
...
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (a «expr ∈ » {a : set β | «expr∃ , »((i), «expr = »(s i, a))})
@[simp]
...
theorem
  monotone_set_of
  [ Preorderₓ α ] { p : α → β → Prop } ( hp : ∀ b , Monotone fun a => p a b ) : Monotone fun a => { b | p a b }
  := fun a a' h b => hp b h
...
theorem Union_eq_compl_Inter_compl (s : ι → Set β) : (⋃ i, s i) = (⋂ i, s iᶜ)ᶜ :=
  by 
    simp only [compl_Inter, compl_compl]

theorem Inter_eq_compl_Union_compl (s : ι → Set β) : (⋂ i, s i) = (⋃ i, s iᶜ)ᶜ :=
  by 
...
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » @univ α)
...
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » ({a} : set α))
...
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » ({a, b} : set α))
...
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (i «expr ∈ » s)
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (i «expr ∈ » s)
theorem compl_bUnion (s : Set α) (t : α → Set β) : (⋃ (i : _)(_ : i ∈ s), t i)ᶜ = ⋂ (i : _)(_ : i ∈ s), t iᶜ :=
  by 
    simp 

-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (i «expr ∈ » s)
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (i «expr ∈ » s)
theorem compl_bInter (s : Set α) (t : α → Set β) : (⋂ (i : _)(_ : i ∈ s), t i)ᶜ = ⋃ (i : _)(_ : i ∈ s), t iᶜ :=
  by 
    simp 
...
theorem Union_eq_range_sigma (s : α → Set β) : (⋃ i, s i) = range fun a : Σ i, s i => a.2 :=
  by 
    simp [Set.ext_iff]
...
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (p «expr ∈ » S.prod T)
theorem sInter_union_sInter {S T : Set (Set α)} :
  ⋂₀S ∪ ⋂₀T = ⋂ (p : _)(_ : p ∈ S.prod T), (p : Set α × Set α).1 ∪ p.2 :=
  Inf_sup_Inf
...
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » «expr⋃ , »((i), s i))
...
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » range f)
...
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » «expr '' »(f, s))
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (y «expr ∈ » s)
