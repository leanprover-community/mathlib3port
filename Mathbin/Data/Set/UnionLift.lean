...
but is expected to have type
  forall {α : Type.{u3}} {ι : Type.{u2}} {β : Type.{u1}} {S : ι -> (Set.{u3} α)} {f : forall (i : ι), (Set.Elem.{u3} α (S i)) -> β} {hf : forall (i : ι) (j : ι) (x : α) (hxi : Membership.mem.{u3, u3} α (Set.{u3} α) (Set.instMembershipSet.{u3} α) x (S i)) (hxj : Membership.mem.{u3, u3} α (Set.{u3} α) (Set.instMembershipSet.{u3} α) x (S j)), Eq.{succ u1} β (f i (Subtype.mk.{succ u3} α (fun (x : α) => Membership.mem.{u3, u3} α (Set.{u3} α) (Set.instMembershipSet.{u3} α) x (S i)) x hxi)) (f j (Subtype.mk.{succ u3} α (fun (x : α) => Membership.mem.{u3, u3} α (Set.{u3} α) (Set.instMembershipSet.{u3} α) x (S j)) x hxj))} {T : Set.{u3} α} {hT' : HasSubset.Subset.{u3} (Set.{u3} α) (Set.instHasSubsetSet_1.{u3} α) T (Set.unionᵢ.{u3, succ u2} α ι S)} (u : Eq.{succ u3} (Set.{u3} α) T (Set.unionᵢ.{u3, succ u2} α ι S)) (ui : (Set.Elem.{u3} α T) -> (Set.Elem.{u3} α T)) (hui : forall (i : ι), (Set.Elem.{u3} α (S i)) -> (Set.Elem.{u3} α (S i))), (forall (ᾰ : ι) (x : Set.Elem.{u3} α (S ᾰ)), Eq.{succ u3} (Set.Elem.{u3} α T) (ui (Set.inclusion.{u3} α (S ᾰ) T ([mdata let_fun:1 (fun (this : HasSubset.Subset.{u3} (Set.{u3} α) (Set.instHasSubsetSet_1.{u3} α) (S ᾰ) T) => this) (Eq.rec.{0, succ u3} (Set.{u3} α) (Set.unionᵢ.{u3, succ u2} α ι S) (fun (x._@.Mathlib.Data.Set.UnionLift._hyg.758 : Set.{u3} α) (h._@.Mathlib.Data.Set.UnionLift._hyg.759 : Eq.{succ u3} (Set.{u3} α) (Set.unionᵢ.{u3, succ u2} α ι S) x._@.Mathlib.Data.Set.UnionLift._hyg.758) => HasSubset.Subset.{u3} (Set.{u3} α) (Set.instHasSubsetSet_1.{u3} α) (S ᾰ) x._@.Mathlib.Data.Set.UnionLift._hyg.758) (Set.subset_unionᵢ.{succ u2, u3} α ι S ᾰ) T (Eq.symm.{succ u3} (Set.{u3} α) T (Set.unionᵢ.{u3, succ u2} α ι S) u))]) x)) (Set.inclusion.{u3} α (S ᾰ) T ([mdata let_fun:1 (fun (this : HasSubset.Subset.{u3} (Set.{u3} α) (Set.instHasSubsetSet_1.{u3} α) (S ᾰ) T) => this) (Eq.rec.{0, succ u3} (Set.{u3} α) (Set.unionᵢ.{u3, succ u2} α ι S) (fun (x._@.Mathlib.Data.Set.UnionLift._hyg.782 : Set.{u3} α) (h._@.Mathlib.Data.Set.UnionLift._hyg.783 : Eq.{succ u3} (Set.{u3} α) (Set.unionᵢ.{u3, succ u2} α ι S) x._@.Mathlib.Data.Set.UnionLift._hyg.782) => HasSubset.Subset.{u3} (Set.{u3} α) (Set.instHasSubsetSet_1.{u3} α) (S ᾰ) x._@.Mathlib.Data.Set.UnionLift._hyg.782) (Set.subset_unionᵢ.{succ u2, u3} α ι S ᾰ) T (Eq.symm.{succ u3} (Set.{u3} α) T (Set.unionᵢ.{u3, succ u2} α ι S) u))]) (hui ᾰ x))) -> (forall (h : β -> β), (forall (i : ι) (x : Set.Elem.{u3} α (S i)), Eq.{succ u1} β (f i (hui i x)) (h (f i x))) -> (forall (x : Set.Elem.{u3} α T), Eq.{succ u1} β (Set.unionᵢLift.{u3, u2, u1} α ι β S f hf T (le_of_eq.{u3} (Set.{u3} α) (PartialOrder.toPreorder.{u3} (Set.{u3} α) (CompleteSemilatticeInf.toPartialOrder.{u3} (Set.{u3} α) (CompleteLattice.toCompleteSemilatticeInf.{u3} (Set.{u3} α) (Order.Coframe.toCompleteLattice.{u3} (Set.{u3} α) (CompleteDistribLattice.toCoframe.{u3} (Set.{u3} α) (CompleteBooleanAlgebra.toCompleteDistribLattice.{u3} (Set.{u3} α) (Set.instCompleteBooleanAlgebraSet.{u3} α))))))) T (Set.unionᵢ.{u3, succ u2} α ι S) u) (ui x)) (h (Set.unionᵢLift.{u3, u2, u1} α ι β S f hf T (le_of_eq.{u3} (Set.{u3} α) (PartialOrder.toPreorder.{u3} (Set.{u3} α) (CompleteSemilatticeInf.toPartialOrder.{u3} (Set.{u3} α) (CompleteLattice.toCompleteSemilatticeInf.{u3} (Set.{u3} α) (Order.Coframe.toCompleteLattice.{u3} (Set.{u3} α) (CompleteDistribLattice.toCoframe.{u3} (Set.{u3} α) (CompleteBooleanAlgebra.toCompleteDistribLattice.{u3} (Set.{u3} α) (Set.instCompleteBooleanAlgebraSet.{u3} α))))))) T (Set.unionᵢ.{u3, succ u2} α ι S) u) x))))
...
but is expected to have type
  forall {α : Type.{u3}} {ι : Type.{u2}} {β : Type.{u1}} {S : ι -> (Set.{u3} α)} {f : forall (i : ι), (Set.Elem.{u3} α (S i)) -> β} {hf : forall (i : ι) (j : ι) (x : α) (hxi : Membership.mem.{u3, u3} α (Set.{u3} α) (Set.instMembershipSet.{u3} α) x (S i)) (hxj : Membership.mem.{u3, u3} α (Set.{u3} α) (Set.instMembershipSet.{u3} α) x (S j)), Eq.{succ u1} β (f i (Subtype.mk.{succ u3} α (fun (x : α) => Membership.mem.{u3, u3} α (Set.{u3} α) (Set.instMembershipSet.{u3} α) x (S i)) x hxi)) (f j (Subtype.mk.{succ u3} α (fun (x : α) => Membership.mem.{u3, u3} α (Set.{u3} α) (Set.instMembershipSet.{u3} α) x (S j)) x hxj))} {T : Set.{u3} α} {hT' : HasSubset.Subset.{u3} (Set.{u3} α) (Set.instHasSubsetSet_1.{u3} α) T (Set.unionᵢ.{u3, succ u2} α ι S)} (dir : Eq.{succ u3} (Set.{u3} α) T (Set.unionᵢ.{u3, succ u2} α ι S)), (Directed.{u3, succ u2} (Set.{u3} α) ι (fun (x._@.Mathlib.Data.Set.UnionLift._hyg.1024 : Set.{u3} α) (x._@.Mathlib.Data.Set.UnionLift._hyg.1026 : Set.{u3} α) => LE.le.{u3} (Set.{u3} α) (Set.instLESet.{u3} α) x._@.Mathlib.Data.Set.UnionLift._hyg.1024 x._@.Mathlib.Data.Set.UnionLift._hyg.1026) S) -> (forall (opi : (Set.Elem.{u3} α T) -> (Set.Elem.{u3} α T) -> (Set.Elem.{u3} α T)) (hopi : forall (i : ι), (Set.Elem.{u3} α (S i)) -> (Set.Elem.{u3} α (S i)) -> (Set.Elem.{u3} α (S i))), (forall (ᾰ : ι) (ᾰ_1 : Set.Elem.{u3} α (S ᾰ)) (y : Set.Elem.{u3} α (S ᾰ)), Eq.{succ u3} (Set.Elem.{u3} α T) (Set.inclusion.{u3} α (S ᾰ) T ([mdata let_fun:1 (fun (this : HasSubset.Subset.{u3} (Set.{u3} α) (Set.instHasSubsetSet_1.{u3} α) (S ᾰ) T) => this) (Eq.rec.{0, succ u3} (Set.{u3} α) (Set.unionᵢ.{u3, succ u2} α ι S) (fun (x._@.Mathlib.Data.Set.UnionLift._hyg.1081 : Set.{u3} α) (h._@.Mathlib.Data.Set.UnionLift._hyg.1082 : Eq.{succ u3} (Set.{u3} α) (Set.unionᵢ.{u3, succ u2} α ι S) x._@.Mathlib.Data.Set.UnionLift._hyg.1081) => HasSubset.Subset.{u3} (Set.{u3} α) (Set.instHasSubsetSet_1.{u3} α) (S ᾰ) x._@.Mathlib.Data.Set.UnionLift._hyg.1081) (Set.subset_unionᵢ.{succ u2, u3} α ι S ᾰ) T (Eq.symm.{succ u3} (Set.{u3} α) T (Set.unionᵢ.{u3, succ u2} α ι S) dir))]) (hopi ᾰ ᾰ_1 y)) (opi (Set.inclusion.{u3} α (S ᾰ) T ([mdata let_fun:1 (fun (this : HasSubset.Subset.{u3} (Set.{u3} α) (Set.instHasSubsetSet_1.{u3} α) (S ᾰ) T) => this) (Eq.rec.{0, succ u3} (Set.{u3} α) (Set.unionᵢ.{u3, succ u2} α ι S) (fun (x._@.Mathlib.Data.Set.UnionLift._hyg.1113 : Set.{u3} α) (h._@.Mathlib.Data.Set.UnionLift._hyg.1114 : Eq.{succ u3} (Set.{u3} α) (Set.unionᵢ.{u3, succ u2} α ι S) x._@.Mathlib.Data.Set.UnionLift._hyg.1113) => HasSubset.Subset.{u3} (Set.{u3} α) (Set.instHasSubsetSet_1.{u3} α) (S ᾰ) x._@.Mathlib.Data.Set.UnionLift._hyg.1113) (Set.subset_unionᵢ.{succ u2, u3} α ι S ᾰ) T (Eq.symm.{succ u3} (Set.{u3} α) T (Set.unionᵢ.{u3, succ u2} α ι S) dir))]) ᾰ_1) (Set.inclusion.{u3} α (S ᾰ) T ([mdata let_fun:1 (fun (this : HasSubset.Subset.{u3} (Set.{u3} α) (Set.instHasSubsetSet_1.{u3} α) (S ᾰ) T) => this) (Eq.rec.{0, succ u3} (Set.{u3} α) (Set.unionᵢ.{u3, succ u2} α ι S) (fun (x._@.Mathlib.Data.Set.UnionLift._hyg.1139 : Set.{u3} α) (h._@.Mathlib.Data.Set.UnionLift._hyg.1140 : Eq.{succ u3} (Set.{u3} α) (Set.unionᵢ.{u3, succ u2} α ι S) x._@.Mathlib.Data.Set.UnionLift._hyg.1139) => HasSubset.Subset.{u3} (Set.{u3} α) (Set.instHasSubsetSet_1.{u3} α) (S ᾰ) x._@.Mathlib.Data.Set.UnionLift._hyg.1139) (Set.subset_unionᵢ.{succ u2, u3} α ι S ᾰ) T (Eq.symm.{succ u3} (Set.{u3} α) T (Set.unionᵢ.{u3, succ u2} α ι S) dir))]) y))) -> (forall (h : β -> β -> β), (forall (i : ι) (x : Set.Elem.{u3} α (S i)) (y : Set.Elem.{u3} α (S i)), Eq.{succ u1} β (f i (hopi i x y)) (h (f i x) (f i y))) -> (forall (y : Set.Elem.{u3} α T) (y_1 : Set.Elem.{u3} α T), Eq.{succ u1} β (Set.unionᵢLift.{u3, u2, u1} α ι β S f hf T (le_of_eq.{u3} (Set.{u3} α) (PartialOrder.toPreorder.{u3} (Set.{u3} α) (CompleteSemilatticeInf.toPartialOrder.{u3} (Set.{u3} α) (CompleteLattice.toCompleteSemilatticeInf.{u3} (Set.{u3} α) (Order.Coframe.toCompleteLattice.{u3} (Set.{u3} α) (CompleteDistribLattice.toCoframe.{u3} (Set.{u3} α) (CompleteBooleanAlgebra.toCompleteDistribLattice.{u3} (Set.{u3} α) (Set.instCompleteBooleanAlgebraSet.{u3} α))))))) T (Set.unionᵢ.{u3, succ u2} α ι S) dir) (opi y y_1)) (h (Set.unionᵢLift.{u3, u2, u1} α ι β S f hf T (le_of_eq.{u3} (Set.{u3} α) (PartialOrder.toPreorder.{u3} (Set.{u3} α) (CompleteSemilatticeInf.toPartialOrder.{u3} (Set.{u3} α) (CompleteLattice.toCompleteSemilatticeInf.{u3} (Set.{u3} α) (Order.Coframe.toCompleteLattice.{u3} (Set.{u3} α) (CompleteDistribLattice.toCoframe.{u3} (Set.{u3} α) (CompleteBooleanAlgebra.toCompleteDistribLattice.{u3} (Set.{u3} α) (Set.instCompleteBooleanAlgebraSet.{u3} α))))))) T (Set.unionᵢ.{u3, succ u2} α ι S) dir) y) (Set.unionᵢLift.{u3, u2, u1} α ι β S f hf T (le_of_eq.{u3} (Set.{u3} α) (PartialOrder.toPreorder.{u3} (Set.{u3} α) (CompleteSemilatticeInf.toPartialOrder.{u3} (Set.{u3} α) (CompleteLattice.toCompleteSemilatticeInf.{u3} (Set.{u3} α) (Order.Coframe.toCompleteLattice.{u3} (Set.{u3} α) (CompleteDistribLattice.toCoframe.{u3} (Set.{u3} α) (CompleteBooleanAlgebra.toCompleteDistribLattice.{u3} (Set.{u3} α) (Set.instCompleteBooleanAlgebraSet.{u3} α))))))) T (Set.unionᵢ.{u3, succ u2} α ι S) dir) y_1)))))
