...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `card_sections [])
  (Command.declSig
   [(Term.implicitBinder "{" [`s] [":" (Term.app `Multiset [(Term.app `Multiset [`α])])] "}")]
   (Term.typeSpec
    ":"
    («term_=_» (Term.app `card [(Term.app `sections [`s])]) "=" (Term.app `Prod [(Term.app `s.map [`card])]))))
