...
theorem succ_dvd_or_succ_dvd_of_succ_sum_dvd_mul {p : ℕ} (p_prime : Nat.Prime p) {m n : ℤ} {k l : ℕ}
  ...
  hsd.elim (fun hsd1 => Or.inl (by apply Int.dvd_nat_abs.1; apply Int.coe_nat_dvd.2 hsd1))
    fun hsd2 => Or.inr (by apply Int.dvd_nat_abs.1; apply Int.coe_nat_dvd.2 hsd2)
