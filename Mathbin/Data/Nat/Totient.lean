...
#align nat._root_.zmod.card_units_eq_totient nat._root_.zmod.card_units_eq_totient
...
theorem totient_prime {p : ℕ} (hp : p.Prime) : φ p = p - 1 := by rw [← pow_one p, totient_prime_pow hp] <;> simp
