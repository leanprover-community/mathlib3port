...
@[norm_cast]
theorem coe_of_digits (α : Type _) [Semiring α] (b : ℕ) (L : List ℕ) : ((ofDigits b L : ℕ) : α) = ofDigits (b : α) L :=
  by
  induction' L with d L ih
  · simp [of_digits]
...
theorem digits_of_digits (b : ℕ) (h : 2 ≤ b) (L : List ℕ) (w₁ : ∀ l ∈ L, l < b) (w₂ : ∀ h : L ≠ [], L.last h ≠ 0) :
