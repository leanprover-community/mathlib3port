...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " Interpret a `finsupp` as a homogenous `dfinsupp`. -/")]
  []
  []
  []
  []
 ...
 (Command.def
  "def"
  (Command.declId `Finsupp.toDfinsupp [])
  (Command.optDeclSig
   [(Term.instBinder "[" [] (Term.app `HasZero [`M]) "]")
    (Term.explicitBinder "(" [`f] [":" (Data.Finsupp.Basic.«term_→₀_» `ι " →₀ " `M)] [] ")")]
   [(Term.typeSpec
     ":"
  ...
  (Command.declValSimple
   ":="
   (Quot.Data.Quot.«term⟦_⟧»
    "⟦"
    (Term.anonymousCtor
     "⟨"
     [`f
      ","
      (Term.proj `f.support "." (fieldIdx "1"))
      ","
      (Term.fun
       "fun"
       (Term.basicFun
        ...
        (Term.app
         (Term.proj
          (Term.proj (Term.app `Classical.em [(«term_=_» (Term.app `f [`i]) "=" (numLit "0"))]) "." `symm)
          "."
          `imp_left)
         [(Term.proj `Finsupp.mem_support_iff "." `mpr)])))]
     "⟩")
    "⟧")
   [])
  []
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `Classical.em [(«term_=_» (Term.app `f [`i]) "=" (numLit "0"))])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(«term_=_» (Term.app `f [`i]) "=" (numLit "0")) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `Classical.em
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `Classical.em [(Term.paren "(" [(«term_=_» (Term.app `f [`i]) "=" (numLit "0")) []] ")")]) []]
 ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `Dfinsupp.toFinsupp [])
  (Command.optDeclSig
   [(Term.explicitBinder
     "("
     [`f]
     ...
     []
     ")")]
   [(Term.typeSpec ":" (Data.Finsupp.Basic.«term_→₀_» `ι " →₀ " `M))])
  (Command.declValSimple
   ":="
   (Term.anonymousCtor
    "⟨"
       ...
       (Term.byTactic
        ...
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(group
            (Tactic.simp "simp" [] ["only"] ["[" [(Tactic.simpLemma [] [] `Dfinsupp.mem_support_iff)] "]"] [])
            [])])))))]
    "⟩")
   [])
  []
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.byTactic
   ...
   (Tactic.tacticSeq
    (Tactic.tacticSeq1Indented
     [(group (Tactic.simp "simp" [] ["only"] ["[" [(Tactic.simpLemma [] [] `Dfinsupp.mem_support_iff)] "]"] []) [])])))
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `Dfinsupp.to_finsupp_coe [])
  (Command.declSig
   [(Term.explicitBinder
     "("
     [`f]
     ...
     []
     ")")]
   (Term.typeSpec ":" («term_=_» (Init.Coe.«term⇑_» "⇑" `f.to_finsupp) "=" `f)))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, [anonymous]))
  («term_=_» (Init.Coe.«term⇑_» "⇑" `f.to_finsupp) "=" `f)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_=_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `f
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
@[ simp ] theorem Dfinsupp.to_finsupp_coe ( f : Π₀ i : ι , M ) : ⇑ f.to_finsupp = f := rfl
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `Dfinsupp.to_finsupp_support [])
  (Command.declSig
   [(Term.explicitBinder
     "("
     [`f]
     ...
     []
     ")")]
   (Term.typeSpec ":" («term_=_» `f.to_finsupp.support "=" `f.support)))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, [anonymous]))
  («term_=_» `f.to_finsupp.support "=" `f.support)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_=_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `f.support
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
@[ simp ] theorem Dfinsupp.to_finsupp_support ( f : Π₀ i : ι , M ) : f.to_finsupp.support = f.support := by ext simp
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `Dfinsupp.to_finsupp_single [])
  (Command.declSig
      ...
      [(group (Tactic.ext "ext" [] []) [])
       (group
        (Tactic.simp
         ...
         []
         []
         ["[" [(Tactic.simpLemma [] [] `Finsupp.single_apply) "," (Tactic.simpLemma [] [] `Dfinsupp.single_apply)] "]"]
         [])
        [])])))
   [])
  []
...
@[ simp ]
  theorem
    Dfinsupp.to_finsupp_single
    ( i : ι ) ( m : M ) : ( Dfinsupp.single i m : Π₀ i : ι , M ) . toFinsupp = Finsupp.single i m
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `Dfinsupp.to_finsupp_to_dfinsupp [])
  (Command.declSig
   [(Term.explicitBinder
     "("
     [`f]
     ...
     []
     ")")]
   (Term.typeSpec ":" («term_=_» `f.to_finsupp.to_dfinsupp "=" `f)))
  (Command.declValSimple ":=" (Term.app `Dfinsupp.coe_fn_injective [`rfl]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Dfinsupp.coe_fn_injective [`rfl])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, [anonymous]))
  («term_=_» `f.to_finsupp.to_dfinsupp "=" `f)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_=_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `f
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
@[ simp ]
  theorem
    ...
    ( f : Π₀ i : ι , M ) : f.to_finsupp.to_dfinsupp = f
  ...
  (Command.declSig
   ...
   (Term.typeSpec
    ...
    («term_=_»
     (Term.paren
      "("
      [(Term.app `to_finsupp [(Init.Logic.«term_+_» `f "+" `g)])
       [(Term.typeAscription ":" (Data.Finsupp.Basic.«term_→₀_» `ι " →₀ " `M))]]
      ")")
     "="
     (Init.Logic.«term_+_» (Term.app `to_finsupp [`f]) "+" (Term.app `to_finsupp [`g])))))
  (Command.declValSimple
   ":="
   («term_$__» `Finsupp.coe_fn_injective "$" (Term.app `Dfinsupp.coe_add [(Term.hole "_") (Term.hole "_")]))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Dfinsupp.coe_add [(Term.hole "_") (Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
@[ simp ]
  theorem
    to_finsupp_add
    [ AddZeroClass M ] [ ∀ m : M , Decidable m ≠ 0 ] ( f g : Π₀ i : ι , M )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `to_finsupp_neg [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `AddGroupₓ [`M]) "]")
    (Term.instBinder
     "["
     []
     (Term.forall
   ...
   (Term.typeSpec
    ...
    («term_=_»
     (Term.paren
      "("
      [(Term.app `to_finsupp [(«term-_» "-" `f)])
       [(Term.typeAscription ":" (Data.Finsupp.Basic.«term_→₀_» `ι " →₀ " `M))]]
      ")")
     "="
     («term-_» "-" (Term.app `to_finsupp [`f])))))
  (Command.declValSimple
   ":="
   («term_$__» `Finsupp.coe_fn_injective "$" (Term.app `Dfinsupp.coe_neg [(Term.hole "_")]))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Dfinsupp.coe_neg [(Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 50, term))
  (Term.paren
   "("
   [(Term.app `to_finsupp [(«term-_» "-" `f)]) [(Term.typeAscription ":" (Data.Finsupp.Basic.«term_→₀_» `ι " →₀ " `M))]]
   ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.paren', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.paren', expected 'Lean.Parser.Term.paren.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'null', expected 'optional.antiquot_scope'
...
@[ simp ]
  theorem
    to_finsupp_neg
    [ AddGroupₓ M ] [ ∀ m : M , Decidable m ≠ 0 ] ( f : Π₀ i : ι , M ) : ( to_finsupp - f : ι →₀ M ) = - to_finsupp f
  ...
  (Command.declSig
   ...
   (Term.typeSpec
    ...
    («term_=_»
     (Term.paren
      "("
      [(Term.app `to_finsupp [(«term_-_» `f "-" `g)])
       [(Term.typeAscription ":" (Data.Finsupp.Basic.«term_→₀_» `ι " →₀ " `M))]]
      ")")
     "="
     («term_-_» (Term.app `to_finsupp [`f]) "-" (Term.app `to_finsupp [`g])))))
  (Command.declValSimple
   ":="
   («term_$__» `Finsupp.coe_fn_injective "$" (Term.app `Dfinsupp.coe_sub [(Term.hole "_") (Term.hole "_")]))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Dfinsupp.coe_sub [(Term.hole "_") (Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
@[ simp ]
  theorem
    to_finsupp_sub
    [ AddGroupₓ M ] [ ∀ m : M , Decidable m ≠ 0 ] ( f g : Π₀ i : ι , M )
      : ( to_finsupp f - g : ι →₀ M ) = to_finsupp f - to_finsupp g
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `to_finsupp_smul [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `Monoidₓ [`R]) "]")
    (Term.instBinder "[" [] (Term.app `AddMonoidₓ [`M]) "]")
   ...
   (Term.typeSpec
    ...
    («term_=_»
     (Term.paren
      "("
      [(Term.app `to_finsupp [(Algebra.Group.Defs.«term_•_» `r " • " `f)])
       [(Term.typeAscription ":" (Data.Finsupp.Basic.«term_→₀_» `ι " →₀ " `M))]]
      ")")
     "="
     (Algebra.Group.Defs.«term_•_» `r " • " (Term.app `to_finsupp [`f])))))
  (Command.declValSimple
   ":="
   («term_$__» `Finsupp.coe_fn_injective "$" (Term.app `Dfinsupp.coe_smul [(Term.hole "_") (Term.hole "_")]))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Dfinsupp.coe_smul [(Term.hole "_") (Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Algebra.Group.Defs.«term_•_» `r " • " `f) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `to_finsupp
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
@[ simp ]
  theorem
    to_finsupp_smul
    [ Monoidₓ R ] [ AddMonoidₓ M ] [ DistribMulAction R M ] [ ∀ m : M , Decidable m ≠ 0 ] ( r : R ) ( f : Π₀ i : ι , M )
      : ( to_finsupp r • f : ι →₀ M ) = r • to_finsupp f
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " `finsupp.to_dfinsupp` and `dfinsupp.to_finsupp` together form an equiv. -/")]
  [(Term.attributes
    "@["
    [(Term.attrInstance
      (Term.attrKind [])
 ...
 (Command.def
  "def"
  (Command.declId `finsuppEquivDfinsupp [])
  (Command.optDeclSig
  ...
  (Command.declValSimple
   ...
   (Term.structInst
    "{"
    []
    [(group (Term.structInstField (Term.structInstLVal `toFun []) ":=" `Finsupp.toDfinsupp) [","])
     (group (Term.structInstField (Term.structInstLVal `invFun []) ":=" `Dfinsupp.toFinsupp) [","])
     (group (Term.structInstField (Term.structInstLVal `left_inv []) ":=" `Finsupp.to_dfinsupp_to_finsupp) [","])
     (group (Term.structInstField (Term.structInstLVal `right_inv []) ":=" `Dfinsupp.to_finsupp_to_dfinsupp) [])]
    (Term.optEllipsis [])
    []
    "}")
   [])
...
/-- `finsupp.to_dfinsupp` and `dfinsupp.to_finsupp` together form an equiv. -/
  ...
  def
    ...
    [ DecidableEq ι ] [ HasZero M ] [ ∀ m : M , Decidable m ≠ 0 ] : ι →₀ M ≃ Π₀ i : ι , M
    :=
      {
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `finsuppAddEquivDfinsupp [])
  (Command.optDeclSig
   [(Term.instBinder "[" [] (Term.app `DecidableEq [`ι]) "]")
    (Term.instBinder "[" [] (Term.app `AddZeroClass [`M]) "]")
    (Term.instBinder
  ...
  (Command.declValSimple
   ...
   (Term.structInst
    ...
    [(group (Term.structInstField (Term.structInstLVal `toFun []) ":=" `Finsupp.toDfinsupp) [","])
     (group (Term.structInstField (Term.structInstLVal `invFun []) ":=" `Dfinsupp.toFinsupp) [","])
     (group (Term.structInstField (Term.structInstLVal `map_add' []) ":=" `Finsupp.to_dfinsupp_add) [])]
    (Term.optEllipsis [])
    []
    "}")
   [])
...
/--
  ...
  def
    ...
    [ DecidableEq ι ] [ AddZeroClass M ] [ ∀ m : M , Decidable m ≠ 0 ] : ι →₀ M ≃+ Π₀ i : ι , M
    :=
      {
        finsuppEquivDfinsupp with
        toFun := Finsupp.toDfinsupp , invFun := Dfinsupp.toFinsupp , map_add' := Finsupp.to_dfinsupp_add
        }
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `finsuppLequivDfinsupp [])
  (Command.optDeclSig
   [(Term.instBinder "[" [] (Term.app `DecidableEq [`ι]) "]")
  ...
  (Command.declValSimple
   ...
   (Term.structInst
    ...
    [(group (Term.structInstField (Term.structInstLVal `toFun []) ":=" `Finsupp.toDfinsupp) [","])
     (group (Term.structInstField (Term.structInstLVal `invFun []) ":=" `Dfinsupp.toFinsupp) [","])
     (group (Term.structInstField (Term.structInstLVal `map_smul' []) ":=" `Finsupp.to_dfinsupp_smul) [","])
     (group (Term.structInstField (Term.structInstLVal `map_add' []) ":=" `Finsupp.to_dfinsupp_add) [])]
    (Term.optEllipsis [])
    []
    "}")
...
/--
  ...
  def
    ...
    [ DecidableEq ι ] [ Semiringₓ R ] [ AddCommMonoidₓ M ] [ ∀ m : M , Decidable m ≠ 0 ] [ Module R M ]
      : ι →₀ M ≃ₗ[ R ] Π₀ i : ι , M
    :=
      {
        finsuppEquivDfinsupp with
...
-- ././Mathport/Syntax/Translate/Basic.lean:1382:4: ignoring doc comment on noncomputable theory
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " `finsupp.split` is an equivalence between `(Σ i, η i) →₀ N` and `Π₀ i, (η i →₀ N)`. -/")]
  []
  []
  []
  []
 ...
 (Command.def
  "def"
  (Command.declId `sigmaFinsuppEquivDfinsupp [])
  (Command.optDeclSig
   [(Term.instBinder "[" [] (Term.app `HasZero [`N]) "]")]
   [(Term.typeSpec
     ":"
     (Data.Equiv.Basic.«term_≃_»
      (Data.Finsupp.Basic.«term_→₀_»
      ...
      (Data.Dfinsupp.«termΠ₀_,_»
       ...
       (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
       ", "
       (Data.Finsupp.Basic.«term_→₀_» (Term.app `η [`i]) " →₀ " `N))))])
  (Command.declValSimple
   ":="
   (Term.structInst
    "{"
         ...
         (Quot.Data.Quot.«term⟦_⟧»
          ...
          (Term.anonymousCtor
           ...
           [(Term.app `split [`f])
            ","
            (Term.proj
             (Term.paren "(" [(Term.app `split_support [`f]) [(Term.typeAscription ":" (Term.app `Finset [`ι]))]] ")")
             "."
             `val)
            ","
            (Term.fun
                ...
                (Tactic.tacticSeq1Indented
                 [(group
                   (Tactic.rwSeq
                    ...
                    (Tactic.rwRuleSeq
                     "["
                     [(Tactic.rwRule ["←"] `Finset.mem_def) "," (Tactic.rwRule [] `mem_split_support_iff_nonzero)]
                     "]")
                    [])
                   [])
                  (group
                   (Tactic.exact "exact" (Term.proj (Term.app `Decidable.em [(Term.hole "_")]) "." `symm))
                   [])])))))]
           "⟩")
          "⟧"))))
      [","])
           ...
           (Tactic.tacticSeq1Indented
            [(group
               ...
               (Term.app
                ...
                [(Term.app
                  ...
                  [`f.support
                   (Term.fun
                    "fun"
                    (Term.basicFun [(Term.simpleBinder [`j] [])] "=>" (Term.proj (Term.app `f [`j]) "." `support)))])
                 (Term.fun
                  "fun"
                  (Term.basicFun
                   [(Term.simpleBinder [`ji] [])]
                   "=>"
                 ...
                 (Term.fun
                  ...
                  (Term.basicFun
                   ...
                   "=>"
                   (Term.app
                    `finset.mem_sigma.mpr
                    [(Term.anonymousCtor "⟨" [(Term.hole "_") "," (Term.app `mem_support_iff.mpr [`hg])] "⟩")])))]))
              [])
             (group
              (Tactic.simp
               "simp"
               []
               ["only"]
               ["[" [(Tactic.simpLemma [] [] `Ne.def) "," (Tactic.simpLemma [] [] `Dfinsupp.mem_support_to_fun)] "]"]
               [])
              [])
             ...
             (group
              ...
              [])
             (group (Tactic.simpa "simpa" [] [] [] [] ["using" `hg]) [])]))))))
      [","])
     (group
      (Term.structInstField
        ...
        (Term.basicFun
         ...
         (Term.byTactic
          ...
          (Tactic.tacticSeq
           (Tactic.tacticSeq1Indented
            [(group (Tactic.ext "ext" [] []) [])
             (group (Tactic.simp "simp" [] [] ["[" [(Tactic.simpLemma [] [] `split)] "]"] []) [])]))))))
      [","])
     (group
      (Term.structInstField
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.simp "simp" [] [] ["[" [(Tactic.simpLemma [] [] `split)] "]"] [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simp', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«]»', expected 'optional.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simpLemma', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simpLemma', expected 'Lean.Parser.Tactic.simpStar'
  ...
  (Tactic.refine'
   ...
   (Term.app
    ...
    [(Term.app
      `Finset.sigma
      [`f.support
       (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`j] [])] "=>" (Term.proj (Term.app `f [`j]) "." `support)))])
     (Term.fun
      "fun"
      (Term.basicFun
       [(Term.simpleBinder [`ji] [])]
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `mem_support_iff.mpr [`hg])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.basicFun.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Term.app `f [`j]) "." `support)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `f [`j])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
   ...
   [`f.support
    (Term.fun
     ...
     (Term.basicFun
      [(Term.simpleBinder [`j] [])]
      "=>"
      (Term.proj (Term.paren "(" [(Term.app `f [`j]) []] ")") "." `support)))])
  []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `on_finset
           ...
           (Tactic.tacticSeq1Indented
            [(group
              (Tactic.rwSeq
               ...
               [])
              [])
             (group (Tactic.exact "exact" (Term.proj (Term.app `Decidable.em [(Term.hole "_")]) "." `symm)) [])])))))]
      "⟩")
     "⟧")))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.fun.antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Term.app `Decidable.em [(Term.hole "_")]) "." `symm)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `Decidable.em [(Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Decidable.em [(Term.hole "_")]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
                ...
                f
                  ...
                  ⟦
                    ⟨
                      split f
                        ,
                        ( split_support f : Finset ι ) . val
                        ,
                        fun i => by rw [ ← Finset.mem_def , mem_split_support_iff_nonzero ] exact Decidable.em _ . symm
                      ⟩
                    ⟧
            ,
          invFun
              ...
              fun
                f
                  ...
                  by
                    refine'
                        on_finset
                          Finset.sigma f.support fun j => f j . support
                            fun ji => f ji . 1 ji . 2
                      ...
                      simpa using hg
            ,
          left_inv := fun f => by ext simp [ split ] ,
          right_inv := fun f => by ext simp [ split ]
        }
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `sigma_finsupp_equiv_dfinsupp_apply [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `HasZero [`N]) "]")
    (Term.explicitBinder
     "("
   ...
   (Term.typeSpec
    ...
    («term_=_»
     (Term.paren
      "("
      [(Term.app `sigmaFinsuppEquivDfinsupp [`f])
       [(Term.typeAscription
         ":"
         (Term.forall
          "∀"
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeAscription', expected 'Lean.Parser.Term.typeAscription.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.forall "∀" [(Term.simpleBinder [`i] [])] "," (Data.Finsupp.Basic.«term_→₀_» (Term.app `η [`i]) " →₀ " `N))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.explicitBinder', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.explicitBinder', expected 'Lean.Parser.Term.explicitBinder.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Data.Finsupp.Basic.«term_→₀_»', expected 'optional.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Data.Finsupp.Basic.«term_→₀_»
   (Init.Data.Sigma.Basic.«termΣ_,_»
    "Σ"
...
@[ simp ]
  theorem
    sigma_finsupp_equiv_dfinsupp_apply
    [ HasZero N ] ( f : Σ i , η i →₀ N ) : ( sigmaFinsuppEquivDfinsupp f : ∀ i , η i →₀ N ) = Finsupp.split f
    := rfl
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `sigma_finsupp_equiv_dfinsupp_symm_apply [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `HasZero [`N]) "]")
    (Term.explicitBinder
     "("
   ...
   (Term.typeSpec
    ...
    («term_=_»
     (Term.app
      (Term.paren
       "("
       [(Term.app (Term.proj `sigmaFinsuppEquivDfinsupp "." `symm) [`f])
        [(Term.typeAscription
          ":"
          (Data.Finsupp.Basic.«term_→₀_»
           (Init.Data.Sigma.Basic.«termΣ_,_»
      ...
      [`s])
     "="
     (Term.app `f [(Term.proj `s "." (fieldIdx "1")) (Term.proj `s "." (fieldIdx "2"))]))))
  (Command.declValSimple ":=" `rfl [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
@[ simp ]
  theorem
    sigma_finsupp_equiv_dfinsupp_symm_apply
    [ HasZero N ] ( f : Π₀ i , η i →₀ N ) ( s : Σ i , η i )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `sigma_finsupp_equiv_dfinsupp_support [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `HasZero [`N]) "]")
    (Term.explicitBinder
     "("
   ...
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.proj (Term.app `sigmaFinsuppEquivDfinsupp [`f]) "." `support)
     "="
     (Term.app `Finsupp.splitSupport [`f]))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group (Tactic.ext "ext" [] []) [])
       (group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Dfinsupp.mem_support_to_fun)] "]") []) [])
       (group
        (Tactic.exact
         "exact"
         (Term.proj (Term.app `Finsupp.mem_split_support_iff_nonzero [(Term.hole "_") (Term.hole "_")]) "." `symm))
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `Finsupp.mem_split_support_iff_nonzero [(Term.hole "_") (Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Dfinsupp.mem_support_to_fun)] "]") [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `Dfinsupp.mem_support_to_fun
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `sigmaFinsuppEquivDfinsupp [`f]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 51 >? 1024, (none, [anonymous]) <=? (some 50, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 50, (some 51, term) <=? (some 1023, [anonymous])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.explicitBinder', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.explicitBinder', expected 'Lean.Parser.Term.simpleBinder.antiquot'
...
@[ simp ]
  theorem
    ...
    [ HasZero N ] ( f : Σ i , η i →₀ N ) : sigmaFinsuppEquivDfinsupp f . support = Finsupp.splitSupport f
    := by ext rw [ Dfinsupp.mem_support_to_fun ] exact Finsupp.mem_split_support_iff_nonzero _ _ . symm
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `sigma_finsupp_equiv_dfinsupp_single [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `HasZero [`N]) "]")
    (Term.explicitBinder
     "("
   ...
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app `sigmaFinsuppEquivDfinsupp [(Term.app `Finsupp.single [`a `n])])
     "="
     (Term.app
      (Term.explicit "@" `Dfinsupp.single)
      [(Term.hole "_")
       (Term.fun
        "fun"
        (Term.basicFun [(Term.simpleBinder [`i] [])] "=>" (Data.Finsupp.Basic.«term_→₀_» (Term.app `η [`i]) " →₀ " `N)))
       (Term.hole "_")
       (Term.hole "_")
       (Term.proj `a "." (fieldIdx "1"))
       (Term.app `Finsupp.single [(Term.proj `a "." (fieldIdx "2")) `n])]))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.obtain
         ...
         [":=" [`a]])
        [])
       (group (Tactic.ext "ext" [(Tactic.rcasesPat.one `j) (Tactic.rcasesPat.one `b)] []) [])
       (group (Tactic.byCases' "by_cases'" [`h ":"] («term_=_» `i "=" `j)) [])
       (group
        (Tactic.«tactic·._»
         "·"
         (Tactic.tacticSeq
           ...
           [(group (Tactic.subst "subst" [`h]) [])
            (group
             (Tactic.simp
              ...
              []
              []
              ["[" [(Tactic.simpLemma [] [] `split_apply) "," (Tactic.simpLemma [] [] `Finsupp.single_apply)] "]"]
              [])
             [])])))
        [])
       (group
       ...
       (group
        (Tactic.rwSeq
         ...
         (Tactic.rwRuleSeq
          "["
          [(Tactic.rwRule [] `Finsupp.single_apply) "," (Tactic.rwRule [] (Term.app `if_neg [`H]))]
          "]")
         [])
        [])])))
   [])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.rwSeq
   "rw"
   []
   (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Finsupp.single_apply) "," (Tactic.rwRule [] (Term.app `if_neg [`H]))] "]")
   [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
    ...
    :=
      by
        obtain ⟨ i , a ⟩ := a
          ext j b
          by_cases' h : i = j
          · subst h simp [ split_apply , Finsupp.single_apply ]
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `sigma_finsupp_equiv_dfinsupp_add [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `AddZeroClass [`N]) "]")
    (Term.explicitBinder
     "("
     [`f `g]
     [":"
   ...
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app `sigmaFinsuppEquivDfinsupp [(Init.Logic.«term_+_» `f "+" `g)])
     "="
     (Term.paren
      "("
      [(Init.Logic.«term_+_» (Term.app `sigmaFinsuppEquivDfinsupp [`f]) "+" (Term.app `sigmaFinsuppEquivDfinsupp [`g]))
       [(Term.typeAscription
         ":"
         (Data.Dfinsupp.«termΠ₀_,_»
          "Π₀"
  ...
  (Command.declValSimple
   ...
   (Term.byTactic
    "by"
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented [(group (Tactic.ext "ext" [] []) []) (group (Tactic.tacticRfl "rfl") [])])))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `sigmaFinsuppAddEquivDfinsupp [])
  (Command.optDeclSig
   [(Term.instBinder "[" [] (Term.app `AddZeroClass [`N]) "]")]
   [(Term.typeSpec
     ":"
  ...
  (Command.declValSimple
   ...
   (Term.structInst
    ...
    [(group (Term.structInstField (Term.structInstLVal `toFun []) ":=" `sigmaFinsuppEquivDfinsupp) [","])
     (group
      (Term.structInstField (Term.structInstLVal `invFun []) ":=" (Term.proj `sigmaFinsuppEquivDfinsupp "." `symm))
      [","])
     (group (Term.structInstField (Term.structInstLVal `map_add' []) ":=" `sigma_finsupp_equiv_dfinsupp_add) [])]
    (Term.optEllipsis [])
    []
    "}")
   [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.structInstField', expected 'Lean.Parser.Term.structInstField.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj `sigmaFinsuppEquivDfinsupp "." `symm)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  `sigmaFinsuppEquivDfinsupp
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.def', expected 'Lean.Parser.Command.structure.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.def', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
/-- `finsupp.split` is an additive equivalence between `(Σ i, η i) →₀ N` and `Π₀ i, (η i →₀ N)`. -/ @[ simps ]
  def
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `sigma_finsupp_equiv_dfinsupp_smul [])
  (Command.declSig
   [(Term.implicitBinder "{" [`R] [] "}")
    (Term.instBinder "[" [] (Term.app `Monoidₓ [`R]) "]")
    (Term.instBinder "[" [] (Term.app `AddMonoidₓ [`N]) "]")
    (Term.instBinder "[" [] (Term.app `DistribMulAction [`R `N]) "]")
    (Term.explicitBinder "(" [`r] [":" `R] [] ")")
    (Term.explicitBinder
     "("
     [`f]
   ...
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app `sigmaFinsuppEquivDfinsupp [(Algebra.Group.Defs.«term_•_» `r " • " `f)])
     "="
     (Term.app
      (Term.explicit "@" `HasScalar.smul)
      [`R
       (Data.Dfinsupp.«termΠ₀_,_»
        "Π₀"
        (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
...
@[ simp ]
  theorem
    ...
    { R } [ Monoidₓ R ] [ AddMonoidₓ N ] [ DistribMulAction R N ] ( r : R ) ( f : Σ i , η i →₀ N )
      :
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `sigmaFinsuppLequivDfinsupp [])
  (Command.optDeclSig
   [(Term.instBinder "[" [] (Term.app `AddCommMonoidₓ [`N]) "]")
    (Term.instBinder "[" [] (Term.app `Module [`R `N]) "]")]
   [(Term.typeSpec
     ":"
     (Data.Equiv.Module.«term_≃ₗ[_]_»
      (Data.Finsupp.Basic.«term_→₀_»
  ...
  (Command.declValSimple
   ...
   (Term.structInst
    ...
    [(group (Term.structInstField (Term.structInstLVal `map_smul' []) ":=" `sigma_finsupp_equiv_dfinsupp_smul) [])]
    (Term.optEllipsis [])
    []
    "}")
   [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.def', expected 'Lean.Parser.Command.structure.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.def', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
/-- `finsupp.split` is a linear equivalence between `(Σ i, η i) →₀ N` and `Π₀ i, (η i →₀ N)`. -/ @[ simps ]
  def
    sigmaFinsuppLequivDfinsupp
    [ AddCommMonoidₓ N ] [ Module R N ] : Σ i , η i →₀ N ≃ₗ[ R ] Π₀ i , η i →₀ N
