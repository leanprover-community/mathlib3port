 ...
 (Command.theorem
  ...
  (Command.declSig
   [(Term.implicitBinder "{" [`M] [":" (Term.type "Type" [(Level.hole "_")])] "}")
    ...
    (Term.explicitBinder "(" [`n] [":" (Data.Finsupp.Basic.«term_→₀_» `α " →₀ " (termℕ "ℕ"))] [] ")")
    (Term.explicitBinder
     "("
     [`f]
     [":"
      (Term.arrow
       (Data.Finsupp.Basic.«term_→₀_» `α " →₀ " (termℕ "ℕ"))
       "→"
       (Term.arrow (Data.Finsupp.Basic.«term_→₀_» `α " →₀ " (termℕ "ℕ")) "→" `M))]
     []
     ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Algebra.BigOperators.Basic.«term∏_in_,_»
      ...
      ", "
      (Term.app `f [(Term.proj `p "." (fieldIdx "1")) (Term.proj `p "." (fieldIdx "2"))]))
     "="
     (Algebra.BigOperators.Basic.«term∏_in_,_»
      "∏"
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `p)] []))
      ...
      (Term.app `antidiagonal [`n])
      ", "
      (Term.app `f [(Term.proj `p "." (fieldIdx "2")) (Term.proj `p "." (fieldIdx "1"))])))))
  (Command.declValSimple
   ":="
   (Term.app
    `Finset.prod_bij
    [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`p `hp] [])] "=>" `p.swap))
     (Term.fun
      "fun"
      (Term.basicFun [(Term.simpleBinder [`p] [])] "=>" (Term.proj `swap_mem_antidiagonal "." (fieldIdx "2"))))
     (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`p `hp] [])] "=>" `rfl))
     (Term.fun
      "fun"
      (Term.basicFun
       [(Term.simpleBinder [`p₁ `p₂ (Term.hole "_") (Term.hole "_") `h] [])]
       "=>"
       (Term.app `Prod.swap_injective [`h])))
     (Term.fun
      "fun"
      (Term.basicFun
       ...
       (Term.anonymousCtor
        "⟨"
        [`p.swap "," (Term.app (Term.proj `swap_mem_antidiagonal "." (fieldIdx "2")) [`hp]) "," `p.swap_swap.symm]
        "⟩")))])
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.proj `swap_mem_antidiagonal "." (fieldIdx "2")) [`hp])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj `swap_mem_antidiagonal "." (fieldIdx "2"))
...
@[ to_additive ]
  theorem
    ...
    { M : Type _ } [ CommMonoidₓ M ] ( n : α →₀ ℕ ) ( f : α →₀ ℕ → α →₀ ℕ → M )
      : ∏ p in antidiagonal n , f p . 1 p . 2 = ∏ p in antidiagonal n , f p . 2 p . 1
    :=
      Finset.prod_bij
        fun p hp => p.swap
          fun p => swap_mem_antidiagonal . 2
          fun p hp => rfl
          fun p₁ p₂ _ _ h => Prod.swap_injective h
          fun p hp => ⟨ p.swap , swap_mem_antidiagonal . 2 hp , p.swap_swap.symm ⟩
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  ...
  (Command.declSig
   [(Term.explicitBinder "(" [`n] [":" (Data.Finsupp.Basic.«term_→₀_» `α " →₀ " (termℕ "ℕ"))] [] ")")]
   (Term.typeSpec ":" (Term.app `Set.Finite [(Set.«term{_|_}» "{" `m "|" («term_≤_» `m "≤" `n) "}")])))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.simpa "simpa" [] [] [] [] ["using" (Term.proj (Term.app `Iic_finset [`n]) "." `finite_to_set)])
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Term.app `Iic_finset [`n]) "." `finite_to_set)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Iic_finset [`n]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, [anonymous]))
  (Term.app `Set.Finite [(Set.«term{_|_}» "{" `m "|" («term_≤_» `m "≤" `n) "}")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  ...
  (Command.declValSimple
   ":="
   («term_$__»
    (Term.proj (Term.app `finite_le_nat [`n]) "." `Subset)
    "$"
    (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`m] [])] "=>" `le_of_ltₓ)))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
