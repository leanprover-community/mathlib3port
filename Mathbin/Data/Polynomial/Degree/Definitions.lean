...
@[simp]
theorem nat_degree_monomial (i : ℕ) (r : R) (hr : r ≠ 0) : nat_degree (monomial i r) = i := by
   ...
   (Term.typeSpec
    ...
    («term_=_»
     ...
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      ...
      `p.support
      ", "
      (Term.app `monomial [`i (Term.app `p.coeff [`i])])))))
  (Command.declValSimple ":=" (Term.proj (Term.app `sum_monomial_eq [`p]) "." `symm) [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Term.app `sum_monomial_eq [`p]) "." `symm)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `sum_monomial_eq [`p])
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `sum_monomial_eq [`p]) []] ")")
...
theorem as_sum_support ( p : Polynomial R ) : p = ∑ i in p.support , monomial i p.coeff i := sum_monomial_eq p . symm
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `as_sum_support_C_mul_X_pow [])
  (Command.declSig
   [(Term.explicitBinder "(" [`p] [":" (Term.app `Polynomial [`R])] [] ")")]
   (Term.typeSpec
    ":"
  ...
  (Command.declValSimple
   ":="
   («term_$__»
    (Term.app `trans [`p.as_sum_support])
    "$"
    (Term.byTactic
     "by"
     (Tactic.tacticSeq
      (Tactic.tacticSeq1Indented
       [(group
         (Tactic.simp "simp" [] ["only"] ["[" [(Tactic.simpLemma [] [] `C_mul_X_pow_eq_monomial)] "]"] [])
         [])]))))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_$__»
   ...
   (Term.byTactic
    ...
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group (Tactic.simp "simp" [] ["only"] ["[" [(Tactic.simpLemma [] [] `C_mul_X_pow_eq_monomial)] "]"] []) [])]))))
...
theorem
  ...
  ( p : Polynomial R ) : p = ∑ i in p.support , C p.coeff i * X ^ i
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `sum_over_range' [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `AddCommMonoidₓ [`S]) "]")
    (Term.explicitBinder "(" [`p] [":" (Term.app `Polynomial [`R])] [] ")")
    (Term.implicitBinder "{" [`f] [":" (Term.arrow (termℕ "ℕ") "→" (Term.arrow `R "→" `S))] "}")
    (Term.explicitBinder
     "("
     [`h]
     [":"
      (Term.forall "∀" [(Term.simpleBinder [`n] [])] "," («term_=_» (Term.app `f [`n (numLit "0")]) "=" (numLit "0")))]
     []
     ")")
    (Term.explicitBinder "(" [`n] [":" (termℕ "ℕ")] [] ")")
    (Term.explicitBinder "(" [`w] [":" («term_<_» `p.nat_degree "<" `n)] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app `p.sum [`f])
     ...
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      "∑"
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `a)] [":" (termℕ "ℕ")]))
      " in "
      (Term.app `range [`n])
      ", "
      (Term.app `f [`a (Term.app `coeff [`p `a])])))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group (Tactic.rcases "rcases" [(Tactic.casesTarget [] `p)] ["with" (Tactic.rcasesPat.tuple "⟨" [] "⟩")]) [])
       (group
        (Tactic.tacticHave_ "have" (Term.haveDecl (Term.haveIdDecl [] [] ":=" (Term.app `supp_subset_range [`w]))))
        [])
       (group
        (Tactic.simp
         "simp"
         ...
         ["only"]
         ["["
          [(Tactic.simpLemma [] [] `Polynomial.sum)
           ","
           (Tactic.simpLemma [] [] `support)
           ","
           (Tactic.simpLemma [] [] `coeff)
           ","
           (Tactic.simpLemma [] [] `nat_degree)
           ","
           (Tactic.simpLemma [] [] `degree)]
          "]"]
        ...
        (Tactic.exact
         ...
         (Term.app
          ...
          [(Term.hole "_")
           `this
           (Term.hole "_")
           (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`n `hn] [])] "=>" (Term.app `h [`n])))]))
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `coeff [`p `a]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  ...
  (Command.declValSimple
   ...
   (Term.app
    `sum_over_range'
    [`p `h (Init.Logic.«term_+_» `p.nat_degree "+" (numLit "1")) (Term.app `lt_add_one [(Term.hole "_")])])
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
/--
  ...
  theorem
    sum_over_range
    [ AddCommMonoidₓ S ] ( p : Polynomial R ) { f : ℕ → R → S } ( h : ∀ n , f n 0 = 0 )
   ...
   (Term.typeSpec
    ...
    («term_=_»
     ...
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      ...
      (Term.app `range [`n])
      ", "
      (Term.app `monomial [`i (Term.app `coeff [`p `i])])))))
  (Command.declValSimple
   ":="
   («term_$__»
    `p.sum_monomial_eq.symm.trans
    "$"
    (Term.app `p.sum_over_range' [`monomial_zero_right (Term.hole "_") `w]))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_$__» `p.sum_monomial_eq.symm.trans "$" (Term.app `p.sum_over_range' [`monomial_zero_right (Term.hole "_") `w]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `p.sum_over_range' [`monomial_zero_right (Term.hole "_") `w])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `coeff [`p `i]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
theorem
  as_sum_range'
  ( p : Polynomial R ) ( n : ℕ ) ( w : p.nat_degree < n ) : p = ∑ i in range n , monomial i coeff p i
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  ...
  (Command.declValSimple
   ":="
   («term_$__» `p.sum_monomial_eq.symm.trans "$" («term_$__» `p.sum_over_range "$" `monomial_zero_right))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_$__» `p.sum_over_range "$" `monomial_zero_right)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `monomial_zero_right
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
theorem
  as_sum_range
  ( p : Polynomial R ) : p = ∑ i in range p.nat_degree + 1 , monomial i coeff p i
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `as_sum_range_C_mul_X_pow [])
  (Command.declSig
   [(Term.explicitBinder "(" [`p] [":" (Term.app `Polynomial [`R])] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     ...
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      ...
      (Term.app `range [(Init.Logic.«term_+_» `p.nat_degree "+" (numLit "1"))])
      ", "
      (Finset.Data.Finset.Fold.«term_*_» (Term.app `C [(Term.app `coeff [`p `i])]) "*" («term_^_» `X "^" `i))))))
  (Command.declValSimple
   ":="
   («term_$__»
...
theorem
  ...
  ( p : Polynomial R ) : p = ∑ i in range p.nat_degree + 1 , C coeff p i * X ^ i
  ...
  (Command.declSig
   ...
   (Term.typeSpec
    ...
    («term_≤_»
     ...
     (Term.app
      `s.sup
      [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`b] [])] "=>" (Term.app `degree [(Term.app `f [`b])])))]))))
  (Command.declValSimple
   ":="
   («term_$__»
    (Term.app
           ...
           (Tactic.simp
            ...
            ["["
             [(Tactic.simpLemma [] [] `sum_empty)
              ","
              (Tactic.simpLemma [] [] `sup_empty)
              ","
              (Tactic.simpLemma [] [] `degree_zero)
              ","
         ...
         (Term.byTactic
          ...
          (Tactic.tacticSeq
           (Tactic.tacticSeq1Indented
            [(group
              (Tactic.«tactic_<;>_»
               (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] (Term.app `sum_insert [`has]))] "]") [])
               "<;>"
               (Tactic.exact "exact" (Term.app `degree_add_le [(Term.hole "_") (Term.hole "_")])))
              [])]))))
        (calcStep
            ...
            [(group
              (Tactic.«tactic_<;>_»
               (Tactic.rwSeq
                "rw"
                []
                (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `sup_insert) "," (Tactic.rwRule [] `sup_eq_max)] "]")
                [])
               "<;>"
               (Tactic.exact "exact" (Term.app `max_le_max [`le_rfl `ih])))
              [])]))))]))))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `degree_add_le [(Term.hole "_") (Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
theorem
  degree_sum_le
  ( s : Finset ι ) ( f : ι → Polynomial R ) : degree ∑ i in s , f i ≤ s.sup fun b => degree f b
  :=
    Finset.induction_on s by simp only [ sum_empty , sup_empty , degree_zero , le_reflₓ ]
      $
      fun
        a s has ih
          =>
...
theorem degree_mul_le (p q : Polynomial R) : degree (p*q) ≤ degree p+degree q :=
  calc degree (p*q) ≤ p.support.sup fun i => degree (Sum q fun j a => C (coeff p i*a)*X ^ i+j) := by
...
theorem degree_pow_le (p : Polynomial R) : ∀ n : ℕ, degree (p ^ n) ≤ n • degree p
  ...
  | n+1 =>
    calc degree (p ^ n+1) ≤ degree p+degree (p ^ n) := by
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `coeff_mul_degree_add_degree [])
  (Command.declSig
    ...
    («term_=_»
     (Term.app
      ...
      [(Finset.Data.Finset.Fold.«term_*_» `p "*" `q)
       (Init.Logic.«term_+_» (Term.app `nat_degree [`p]) "+" (Term.app `nat_degree [`q]))])
     "="
     (Finset.Data.Finset.Fold.«term_*_» (Term.app `leading_coeff [`p]) "*" (Term.app `leading_coeff [`q])))))
  (Command.declValSimple
   ":="
   (calc
    "calc"
    [(calcStep
      ...
      ":="
      (Term.app `coeff_mul [(Term.hole "_") (Term.hole "_") (Term.hole "_")]))
     (calcStep
      («term_=_»
       (Term.hole "_")
       "="
       (Finset.Data.Finset.Fold.«term_*_»
        (Term.app `coeff [`p (Term.app `nat_degree [`p])])
        "*"
        (Term.app `coeff [`q (Term.app `nat_degree [`q])])))
      ":="
      (Term.byTactic
       "by"
       (Tactic.tacticSeq
         ...
         [(group
           (Tactic.refine'
            ...
            (Term.app
             ...
             [(Term.paren "(" [(Term.app `nat_degree [`p]) [(Term.tupleTail "," [(Term.app `nat_degree [`q])])]] ")")
              (Term.hole "_")
              (Term.hole "_")]))
           [])
          (group
              ...
              [(group
               ...
               (group
                (Tactic.rwSeq
                 "rw"
                 []
                 (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `nat.mem_antidiagonal)] "]")
                 [(Tactic.location "at" (Tactic.locationHyp [`h₁] []))])
                [])
               (group (Tactic.byCases' "by_cases'" [`H ":"] («term_<_» (Term.app `nat_degree [`p]) "<" `i)) [])
               (group
                (Tactic.«tactic·._»
                 "·"
                 (Tactic.tacticSeq
                         ...
                         (Term.app
                          ...
                          [(Term.app
                            ...
                            [`degree_le_nat_degree
                             (Term.app (Term.proj `WithBot.coe_lt_coe "." (fieldIdx "2")) [`H])])]))
                        ","
                  ...
                  (Tactic.tacticSeq1Indented
                   [(group
                     (Tactic.rwSeq
                      "rw"
                      []
                      (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `not_lt_iff_eq_or_lt)] "]")
                      [(Tactic.location "at" (Tactic.locationHyp [`H] []))])
                     [])
                        ...
                        [(group (Tactic.subst "subst" [`H]) [])
                         (group
                          (Tactic.rwSeq
                           "rw"
                           []
                           (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `add_left_cancel_iffₓ)] "]")
                           [(Tactic.location "at" (Tactic.locationHyp [`h₁] []))])
                          [])
                         (group
                         ...
                         (group (Tactic.exact "exact" (Term.app `h₂ [`rfl])) [])])))
                     [])
                    (group
                     (Tactic.«tactic·._»
                      "·"
                       ...
                       (Tactic.tacticSeq1Indented
                        [(group
                          (Tactic.tacticSuffices_
                           ...
                           (Term.sufficesDecl
                            []
                            («term_<_» (Term.app `nat_degree [`q]) "<" `j)
                            (Term.byTactic
                             "by"
                             (Tactic.tacticSeq
                              (Tactic.tacticSeq1Indented
                                   ...
                                   [(Tactic.rwRule
                                     ...
                                     (Term.app
                                      ...
                                      [(Term.app
                                        `lt_of_le_of_ltₓ
                                        [`degree_le_nat_degree
                                         (Term.app (Term.proj `WithBot.coe_lt_coe "." (fieldIdx "2")) [`this])])]))
                                    ","
                             ...
                             [(group (byContra "by_contra" [`H']) [])
                              (group
                               (Tactic.rwSeq
                                "rw"
                                []
                                (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `not_ltₓ)] "]")
                                [(Tactic.location "at" (Tactic.locationHyp [`H'] []))])
                               [])
                              (group
                               (Tactic.exact
                                ...
                                (Term.app
                                 ...
                                 [(Term.app
                                   `Nat.lt_of_lt_of_leₓ
                                   [(Term.app `Nat.add_lt_add_rightₓ [`H `j])
                                    (Term.app `Nat.add_le_add_leftₓ [`H' (Term.hole "_")])])
                                  `h₁]))
                               [])])))
                          [])])))
                     [])])))
            ...
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(group (Tactic.intro "intro" [`H]) [])
               ...
               (group
                (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `nat.mem_antidiagonal)] "]") [])
                [])])))
           [])]))))])
   [])
  []
   ...
   [(calcStep
     («term_=_»
      ...
      (Algebra.BigOperators.Basic.«term∑_in_,_»
       ...
       (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `x)] []))
       " in "
       (Term.app `nat.antidiagonal [(Init.Logic.«term_+_» (Term.app `nat_degree [`p]) "+" (Term.app `nat_degree [`q]))])
       ", "
       (Finset.Data.Finset.Fold.«term_*_»
        (Term.app `coeff [`p (Term.proj `x "." (fieldIdx "1"))])
        "*"
                  ...
                  (Tactic.rwRuleSeq
                   ...
                   [(Tactic.rwRule
                     ...
                     (Term.app
                      ...
                      [(Term.app
                        `lt_of_le_of_ltₓ
                        [`degree_le_nat_degree (Term.app (Term.proj `WithBot.coe_lt_coe "." (fieldIdx "2")) [`H])])]))
                    ","
                    (Tactic.rwRule [] `zero_mul)]
                   "]")
                  [])
   ...
   (Tactic.tacticSeq
    (Tactic.tacticSeq1Indented
     [(group (Tactic.intro "intro" [`H]) [])
      (group (tacticExfalso "exfalso") [])
      (group (Tactic.apply "apply" `H) [])
      (group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `nat.mem_antidiagonal)] "]") []) [])])))
                ...
                (group
                 (Tactic.exact
                  ...
                  (Term.app
                   ...
                   [(Term.app
                     `Nat.lt_of_lt_of_leₓ
                     [(Term.app `Nat.add_lt_add_rightₓ [`H `j]) (Term.app `Nat.add_le_add_leftₓ [`H' (Term.hole "_")])])
                    `h₁]))
                 [])])))
            [])])))
       [])])))
               ...
               (Tactic.rwRuleSeq
                ...
                [(Tactic.rwRule
                  ...
                  (Term.app
                   ...
                   [(Term.app
                     `lt_of_le_of_ltₓ
                     [`degree_le_nat_degree (Term.app (Term.proj `WithBot.coe_lt_coe "." (fieldIdx "2")) [`this])])]))
                 ","
                 (Tactic.rwRule [] `mul_zero)]
                "]")
               [])
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `Nat.add_lt_add_rightₓ
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Nat.add_lt_add_rightₓ [`H `j]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `Nat.lt_of_lt_of_leₓ
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(Term.app
   `Nat.lt_of_lt_of_leₓ
   [(Term.paren "(" [(Term.app `Nat.add_lt_add_rightₓ [`H `j]) []] ")")
    (Term.paren "(" [(Term.app `Nat.add_le_add_leftₓ [`H' (Term.hole "_")]) []] ")")])
  []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `ne_of_ltₓ
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj `WithBot.coe_lt_coe "." (fieldIdx "2"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  `WithBot.coe_lt_coe
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(Term.app
   `lt_of_le_of_ltₓ
   [`degree_le_nat_degree
    (Term.paren "(" [(Term.app (Term.proj `WithBot.coe_lt_coe "." (fieldIdx "2")) [`this]) []] ")")])
  []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `coeff_eq_zero_of_degree_lt
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `lt_of_le_of_ltₓ [`degree_le_nat_degree (Term.app (Term.proj `WithBot.coe_lt_coe "." (fieldIdx "2")) [`H])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(Term.app
   `lt_of_le_of_ltₓ
   [`degree_le_nat_degree (Term.paren "(" [(Term.app (Term.proj `WithBot.coe_lt_coe "." (fieldIdx "2")) [`H]) []] ")")])
  []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `coeff_eq_zero_of_degree_lt
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `nat_degree [`q]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `nat_degree [`p]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
@[ simp ]
  theorem
    ...
    ( p q : Polynomial R ) : coeff p * q nat_degree p + nat_degree q = leading_coeff p * leading_coeff q
    :=
      calc
                ...
                ·
                  rintro ⟨ i , j ⟩ h₁ h₂
                    ...
                    ·
                      rw
                        [
                          coeff_eq_zero_of_degree_lt lt_of_le_of_ltₓ degree_le_nat_degree WithBot.coe_lt_coe . 2 H
                            ,
                            zero_mul
                          ]
                    ·
                      rw [ not_lt_iff_eq_or_lt ] at H
                        cases H
                        · subst H rw [ add_left_cancel_iffₓ ] at h₁ dsimp at h₁ subst h₁ exfalso exact h₂ rfl
                        ·
                          suffices
                              nat_degree q < j
                                by
                                  rw
                                    [
                                      coeff_eq_zero_of_degree_lt
                                          lt_of_le_of_ltₓ degree_le_nat_degree WithBot.coe_lt_coe . 2 this
                                        ,
                                        mul_zero
                                      ]
                            ·
                              by_contra H'
                                rw [ not_ltₓ ] at H'
                                exact
                                  ne_of_ltₓ Nat.lt_of_lt_of_leₓ Nat.add_lt_add_rightₓ H j Nat.add_le_add_leftₓ H' _ h₁
...
@[simp]
theorem coeff_pow_mul_nat_degree (p : Polynomial R) (n : ℕ) : (p ^ n).coeff (n*p.nat_degree) = p.leading_coeff ^ n := by
  induction' n with i hi
  ·
    simp
  ·
...
theorem degree_sub_lt (hd : degree p = degree q) (hp0 : p ≠ 0) (hlc : leading_coeff p = leading_coeff q) :
  ...
  calc degree (p - q) = degree (erase (nat_degree q) p+-erase (nat_degree q) q) := by
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `degree_sum_fin_lt [])
  (Command.declSig
   [(Term.implicitBinder "{" [`n] [":" (termℕ "ℕ")] "}")
    (Term.explicitBinder "(" [`f] [":" (Term.arrow (Term.app `Finₓ [`n]) "→" `R)] [] ")")]
   (Term.typeSpec
    ":"
    («term_<_»
     (Term.app
      ...
      [(Algebra.BigOperators.Basic.«term∑_,_»
        ...
        (Finset.Data.Finset.Fold.«term_*_»
         ...
         "*"
         («term_^_» `X "^" (Term.paren "(" [`i [(Term.typeAscription ":" (termℕ "ℕ"))]] ")"))))])
     "<"
     `n)))
  (Command.declValSimple
   ":="
      ...
      [(group
        (Tactic.tacticHave_
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           []
           [(Term.typeSpec ":" (Term.app `IsCommutative [(Term.app `WithBot [(termℕ "ℕ")]) `max]))]
           ":="
           (Term.anonymousCtor "⟨" [`max_commₓ] "⟩"))))
        [])
       (group
        (Tactic.tacticHave_
         "have"
         (Term.haveDecl
          (Term.haveIdDecl
           []
           [(Term.typeSpec ":" (Term.app `IsAssociative [(Term.app `WithBot [(termℕ "ℕ")]) `max]))]
           ":="
           (Term.anonymousCtor "⟨" [`max_assocₓ] "⟩"))))
        [])
       (group
        (tacticCalc_
         "calc"
          ...
          (calcStep
           ...
           (Term.app
            (Term.proj
             (Term.app
              `Finset.fold_max_lt
              [(Term.paren "(" [`n [(Term.typeAscription ":" (Term.app `WithBot [(termℕ "ℕ")]))]] ")")])
             "."
             `mpr)
            [(Term.anonymousCtor "⟨" [(Term.app `WithBot.bot_lt_coe [(Term.hole "_")]) "," (Term.hole "_")] "⟩")]))])
        [])
       (group
        (Tactic.rintro
         "rintro"
        ...
        (tacticCalc_
         ...
         [(calcStep
           («term_≤_»
            (Term.proj
             (Finset.Data.Finset.Fold.«term_*_»
              (Term.app `C [(Term.app `f [(Term.anonymousCtor "⟨" [`i "," `hi] "⟩")])])
              "*"
              («term_^_» `X "^" `i))
             "."
             `degree)
            "≤"
            (Init.Logic.«term_+_»
             (Term.proj (Term.app `C [(Term.hole "_")]) "." `degree)
             "+"
             (Term.proj («term_^_» `X "^" `i) "." `degree)))
           ":="
           (Term.app `degree_mul_le [(Term.hole "_") (Term.hole "_")]))
          (calcStep
           («term_≤_» (Term.hole "_") "≤" (Init.Logic.«term_+_» (numLit "0") "+" `i))
           ":="
           (Term.app `add_le_add [`degree_C_le (Term.app `degree_X_pow_le [`i])]))
          (calcStep («term_=_» (Term.hole "_") "=" `i) ":=" (Term.app `zero_addₓ [(Term.hole "_")]))
          (calcStep («term_<_» (Term.hole "_") "<" `n) ":=" (Term.app `with_bot.some_lt_some.mpr [`hi]))])
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'calcStep', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `with_bot.some_lt_some.mpr [`hi])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'calcStep', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, term))
  (Term.app `zero_addₓ [(Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `degree_X_pow_le [`i]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `C [(Term.hole "_")]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 51 >? 1022, (some 0, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 50, term))
  (Term.proj
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `f [(Term.anonymousCtor "⟨" [`i "," `hi] "⟩")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Finset.Data.Finset.Fold.«term_*_»
   (Term.app `C [(Term.paren "(" [(Term.app `f [(Term.anonymousCtor "⟨" [`i "," `hi] "⟩")]) []] ")")])
   "*"
   («term_^_» `X "^" `i))
  []]
 ")")
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `WithBot.bot_lt_coe [(Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Finset.Data.Finset.Fold.«term_*_»
   (Term.app `C [(Term.paren "(" [(Term.app `f [`i]) []] ")")])
   "*"
   («term_^_» `X "^" (Term.paren "(" [`i [(Term.typeAscription ":" (termℕ "ℕ"))]] ")")))
  []]
 ")")
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 68, (some 69, term) <=? (some 1023, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Order.Lattice.«term_⊔_» (Term.cdot "·") "⊔" (Term.cdot "·")) []]
 ")")
...
theorem
  degree_sum_fin_lt
  { n : ℕ } ( f : Finₓ n → R ) : degree ∑ i : Finₓ n , C f i * X ^ ( i : ℕ ) < n
  :=
    by
...
@[simp]
theorem degree_X_add_C [Semiringₓ R] (a : R) : degree (X+C a) = 1 :=
...
@[simp]
theorem next_coeff_X_sub_C (c : R) : next_coeff (X - C c) = -c := by
...
@[simp]
theorem leading_coeff_X_add_C [Nontrivial R] (a b : R) (ha : a ≠ 0) : leading_coeff ((C a*X)+C b) = a := by
