...
theorem Monic.leading_coeff {p : R[X]} (hp : p.Monic) : leadingCoeff p = 1 :=
  hp
#align polynomial.monic.leading_coeff Polynomial.Monic.leading_coeff

theorem Monic.coeff_nat_degree {p : R[X]} (hp : p.Monic) : p.coeff p.natDegree = 1 :=
  hp
#align polynomial.monic.coeff_nat_degree Polynomial.Monic.coeff_nat_degree
...
theorem nat_degree_zero : natDegree (0 : R[X]) = 0 :=
  rfl
#align polynomial.nat_degree_zero Polynomial.nat_degree_zero

@[simp]
theorem coeff_nat_degree : coeff p (natDegree p) = leadingCoeff p :=
  rfl
#align polynomial.coeff_nat_degree Polynomial.coeff_nat_degree
...
#align polynomial.nat_degree_of_subsingleton Polynomial.nat_degree_of_subsingleton
...
#align polynomial.degree_eq_nat_degree Polynomial.degree_eq_nat_degree

theorem degree_eq_iff_nat_degree_eq {p : R[X]} {n : ℕ} (hp : p ≠ 0) :
    p.degree = n ↔ p.natDegree = n := by rw [degree_eq_nat_degree hp, WithBot.coe_eq_coe]
#align polynomial.degree_eq_iff_nat_degree_eq Polynomial.degree_eq_iff_nat_degree_eq

theorem degree_eq_iff_nat_degree_eq_of_pos {p : R[X]} {n : ℕ} (hn : 0 < n) :
...
#align polynomial.degree_eq_iff_nat_degree_eq_of_pos Polynomial.degree_eq_iff_nat_degree_eq_of_pos
...
#align polynomial.nat_degree_eq_of_degree_eq_some Polynomial.nat_degree_eq_of_degree_eq_some

@[simp]
theorem degree_le_nat_degree : degree p ≤ natDegree p :=
  WithBot.giUnbot'Bot.gc.le_u_l _
#align polynomial.degree_le_nat_degree Polynomial.degree_le_nat_degree

theorem nat_degree_eq_of_degree_eq [Semiring S] {q : S[X]} (h : degree p = degree q) :
    natDegree p = natDegree q := by unfold nat_degree <;> rw [h]
#align polynomial.nat_degree_eq_of_degree_eq Polynomial.nat_degree_eq_of_degree_eq
...
theorem le_nat_degree_of_ne_zero (h : coeff p n ≠ 0) : n ≤ natDegree p :=
  ...
  · intro h
    subst h
    exact h rfl
#align polynomial.le_nat_degree_of_ne_zero Polynomial.le_nat_degree_of_ne_zero

theorem le_nat_degree_of_mem_supp (a : ℕ) : a ∈ p.support → a ≤ natDegree p :=
  le_nat_degree_of_ne_zero ∘ mem_support_iff.mp
#align polynomial.le_nat_degree_of_mem_supp Polynomial.le_nat_degree_of_mem_supp
...
theorem nat_degree_eq_of_le_of_coeff_ne_zero (pn : p.natDegree ≤ n) (p1 : p.coeff n ≠ 0) :
    p.natDegree = n :=
  pn.antisymm (le_nat_degree_of_ne_zero p1)
#align
  polynomial.nat_degree_eq_of_le_of_coeff_ne_zero Polynomial.nat_degree_eq_of_le_of_coeff_ne_zero
...
#align polynomial.supp_subset_range_nat_degree_succ Polynomial.supp_subset_range_nat_degree_succ
...
#align polynomial.degree_ne_of_nat_degree_ne Polynomial.degree_ne_of_nat_degree_ne

theorem nat_degree_le_iff_degree_le {n : ℕ} : natDegree p ≤ n ↔ degree p ≤ n :=
  WithBot.unbot'_bot_le_iff
#align polynomial.nat_degree_le_iff_degree_le Polynomial.nat_degree_le_iff_degree_le
...
theorem nat_degree_C (a : R) : natDegree (c a) = 0 :=
  ...
  · rw [nat_degree, degree_C ha]
    rfl
#align polynomial.nat_degree_C Polynomial.nat_degree_C

@[simp]
theorem nat_degree_one : natDegree (1 : R[X]) = 0 :=
  nat_degree_C 1
#align polynomial.nat_degree_one Polynomial.nat_degree_one

@[simp]
theorem nat_degree_nat_cast (n : ℕ) : natDegree (n : R[X]) = 0 := by
  simp only [← C_eq_nat_cast, nat_degree_C]
#align polynomial.nat_degree_nat_cast Polynomial.nat_degree_nat_cast
...
#align polynomial.nat_degree_C_mul_X_pow Polynomial.nat_degree_C_mul_X_pow

@[simp]
theorem nat_degree_C_mul_X (a : R) (ha : a ≠ 0) : natDegree (c a * X) = 1 := by
  simpa only [pow_one] using nat_degree_C_mul_X_pow 1 a ha
#align polynomial.nat_degree_C_mul_X Polynomial.nat_degree_C_mul_X

@[simp]
theorem nat_degree_monomial [DecidableEq R] (i : ℕ) (r : R) :
    natDegree (monomial i r) = if r = 0 then 0 else i :=
  by
  split_ifs with hr
  · simp [hr]
  · rw [← C_mul_X_pow_eq_monomial, nat_degree_C_mul_X_pow i r hr]
#align polynomial.nat_degree_monomial Polynomial.nat_degree_monomial

theorem nat_degree_monomial_le (a : R) {m : ℕ} : (monomial m a).natDegree ≤ m :=
  by
  rw [Polynomial.nat_degree_monomial]
  split_ifs
  exacts[Nat.zero_le _, rfl.le]
#align polynomial.nat_degree_monomial_le Polynomial.nat_degree_monomial_le

theorem nat_degree_monomial_eq (i : ℕ) {r : R} (r0 : r ≠ 0) : (monomial i r).natDegree = i :=
  Eq.trans (nat_degree_monomial _ _) (if_neg r0)
#align polynomial.nat_degree_monomial_eq Polynomial.nat_degree_monomial_eq
...
theorem coeff_eq_zero_of_nat_degree_lt {p : R[X]} {n : ℕ} (h : p.natDegree < n) : p.coeff n = 0 :=
  by
...
#align polynomial.coeff_eq_zero_of_nat_degree_lt Polynomial.coeff_eq_zero_of_nat_degree_lt

theorem ext_iff_nat_degree_le {p q : R[X]} {n : ℕ} (hp : p.natDegree ≤ n) (hq : q.natDegree ≤ n) :
...
#align polynomial.ext_iff_nat_degree_le Polynomial.ext_iff_nat_degree_le
...
#align polynomial.coeff_nat_degree_succ_eq_zero Polynomial.coeff_nat_degree_succ_eq_zero
...
#align polynomial.ite_le_nat_degree_coeff Polynomial.ite_le_nat_degree_coeff
...
#align
  polynomial.exists_eq_X_add_C_of_nat_degree_le_one Polynomial.exists_eq_X_add_C_of_nat_degree_le_one
...
#align polynomial.nat_degree_X_le Polynomial.nat_degree_X_le
...
theorem card_supp_le_succ_nat_degree (p : R[X]) : p.support.card ≤ p.natDegree + 1 :=
  by
  rw [← Finset.card_range (p.nat_degree + 1)]
  exact Finset.card_le_of_subset supp_subset_range_nat_degree_succ
#align polynomial.card_supp_le_succ_nat_degree Polynomial.card_supp_le_succ_nat_degree
...
#align polynomial.nat_degree_X Polynomial.nat_degree_X
...
@[simp]
theorem nat_degree_neg (p : R[X]) : natDegree (-p) = natDegree p := by simp [nat_degree]
#align polynomial.nat_degree_neg Polynomial.nat_degree_neg

@[simp]
theorem nat_degree_int_cast (n : ℤ) : natDegree (n : R[X]) = 0 := by
  rw [← C_eq_int_cast, nat_degree_C]
#align polynomial.nat_degree_int_cast Polynomial.nat_degree_int_cast

@[simp]
theorem leading_coeff_neg (p : R[X]) : (-p).leadingCoeff = -p.leadingCoeff := by
  rw [leading_coeff, leading_coeff, nat_degree_neg, coeff_neg]
#align polynomial.leading_coeff_neg Polynomial.leading_coeff_neg
...
theorem next_coeff_C_eq_zero (c : R) : nextCoeff (c c) = 0 :=
  ...
  rw [next_coeff]
  simp
#align polynomial.next_coeff_C_eq_zero Polynomial.next_coeff_C_eq_zero

theorem next_coeff_of_pos_nat_degree (p : R[X]) (hp : 0 < p.natDegree) :
    nextCoeff p = p.coeff (p.natDegree - 1) :=
  by
  rw [next_coeff, if_neg]
  contrapose! hp
  simpa
#align polynomial.next_coeff_of_pos_nat_degree Polynomial.next_coeff_of_pos_nat_degree

variable {p q : R[X]} {ι : Type _}

theorem coeff_nat_degree_eq_zero_of_degree_lt (h : degree p < degree q) :
    coeff p (natDegree q) = 0 :=
  coeff_eq_zero_of_degree_lt (lt_of_lt_of_le h degree_le_nat_degree)
#align
  polynomial.coeff_nat_degree_eq_zero_of_degree_lt Polynomial.coeff_nat_degree_eq_zero_of_degree_lt
...
#align polynomial.ne_zero_of_nat_degree_gt Polynomial.ne_zero_of_nat_degree_gt
...
theorem nat_degree_lt_nat_degree_iff (hp : p ≠ 0) :
    natDegree p < natDegree q ↔ degree p < degree q :=
  ⟨degree_lt_degree, by
    intro h
    have hq : q ≠ 0 := ne_zero_of_degree_gt h
    rw [degree_eq_nat_degree hp, degree_eq_nat_degree hq] at h
    exact_mod_cast h⟩
#align polynomial.nat_degree_lt_nat_degree_iff Polynomial.nat_degree_lt_nat_degree_iff
...
#align polynomial.nat_degree_add_le Polynomial.nat_degree_add_le

theorem nat_degree_add_le_of_degree_le {p q : R[X]} {n : ℕ} (hp : natDegree p ≤ n)
    (hq : natDegree q ≤ n) : natDegree (p + q) ≤ n :=
  (nat_degree_add_le p q).trans <| max_le hp hq
#align polynomial.nat_degree_add_le_of_degree_le Polynomial.nat_degree_add_le_of_degree_le

@[simp]
theorem leading_coeff_zero : leadingCoeff (0 : R[X]) = 0 :=
  rfl
#align polynomial.leading_coeff_zero Polynomial.leading_coeff_zero

@[simp]
theorem leading_coeff_eq_zero : leadingCoeff p = 0 ↔ p = 0 :=
  ⟨fun h =>
    by_contradiction fun hp =>
      mt mem_support_iff.1 (not_not.2 h) (mem_of_max (degree_eq_nat_degree hp)),
    fun h => h.symm ▸ leading_coeff_zero⟩
#align polynomial.leading_coeff_eq_zero Polynomial.leading_coeff_eq_zero

theorem leading_coeff_ne_zero : leadingCoeff p ≠ 0 ↔ p ≠ 0 := by rw [Ne.def, leading_coeff_eq_zero]
#align polynomial.leading_coeff_ne_zero Polynomial.leading_coeff_ne_zero

theorem leading_coeff_eq_zero_iff_deg_eq_bot : leadingCoeff p = 0 ↔ degree p = ⊥ := by
  rw [leading_coeff_eq_zero, degree_eq_bot]
#align
  polynomial.leading_coeff_eq_zero_iff_deg_eq_bot Polynomial.leading_coeff_eq_zero_iff_deg_eq_bot

theorem nat_degree_mem_support_of_nonzero (H : p ≠ 0) : p.natDegree ∈ p.support :=
  by
  rw [mem_support_iff]
  exact (not_congr leading_coeff_eq_zero).mpr H
#align polynomial.nat_degree_mem_support_of_nonzero Polynomial.nat_degree_mem_support_of_nonzero

theorem nat_degree_eq_support_max' (h : p ≠ 0) :
...
#align polynomial.nat_degree_eq_support_max' Polynomial.nat_degree_eq_support_max'

theorem nat_degree_C_mul_X_pow_le (a : R) (n : ℕ) : natDegree (c a * X ^ n) ≤ n :=
  nat_degree_le_iff_degree_le.2 <| degree_C_mul_X_pow_le _ _
#align polynomial.nat_degree_C_mul_X_pow_le Polynomial.nat_degree_C_mul_X_pow_le
...
theorem nat_degree_add_eq_left_of_nat_degree_lt (h : natDegree q < natDegree p) :
    natDegree (p + q) = natDegree p :=
  nat_degree_eq_of_degree_eq (degree_add_eq_left_of_degree_lt (degree_lt_degree h))
#align
  polynomial.nat_degree_add_eq_left_of_nat_degree_lt Polynomial.nat_degree_add_eq_left_of_nat_degree_lt

theorem nat_degree_add_eq_right_of_nat_degree_lt (h : natDegree p < natDegree q) :
    natDegree (p + q) = natDegree q :=
  nat_degree_eq_of_degree_eq (degree_add_eq_right_of_degree_lt (degree_lt_degree h))
#align
  polynomial.nat_degree_add_eq_right_of_nat_degree_lt Polynomial.nat_degree_add_eq_right_of_nat_degree_lt
...
#align
  polynomial.degree_add_eq_of_leading_coeff_add_ne_zero Polynomial.degree_add_eq_of_leading_coeff_add_ne_zero

theorem degree_erase_le (p : R[X]) (n : ℕ) : degree (p.erase n) ≤ degree p :=
  by
  rcases p with ⟨⟩
...
theorem leading_coeff_one : leadingCoeff (1 : R[X]) = 1 :=
  leading_coeff_C 1
#align polynomial.leading_coeff_one Polynomial.leading_coeff_one
...
theorem monic_of_nat_degree_le_of_coeff_eq_one (n : ℕ) (pn : p.natDegree ≤ n) (p1 : p.coeff n = 1) :
    Monic p := by
  nontriviality
  refine' (congr_arg _ <| nat_degree_eq_of_le_of_coeff_ne_zero pn _).trans p1
  exact ne_of_eq_of_ne p1 one_ne_zero
#align
  polynomial.monic_of_nat_degree_le_of_coeff_eq_one Polynomial.monic_of_nat_degree_le_of_coeff_eq_one
...
theorem leading_coeff_add_of_degree_lt (h : degree p < degree q) :
  ...
  simp only [leading_coeff, nat_degree_eq_of_degree_eq (degree_add_eq_right_of_degree_lt h), this,
    coeff_add, zero_add]
#align polynomial.leading_coeff_add_of_degree_lt Polynomial.leading_coeff_add_of_degree_lt

theorem leading_coeff_add_of_degree_eq (h : degree p = degree q)
...
#align polynomial.leading_coeff_add_of_degree_eq Polynomial.leading_coeff_add_of_degree_eq
...
theorem nat_degree_mul' (h : leadingCoeff p * leadingCoeff q ≠ 0) :
    natDegree (p * q) = natDegree p + natDegree q :=
  have hp : p ≠ 0 := mt leading_coeff_eq_zero.2 fun h₁ => h <| by rw [h₁, zero_mul]
  have hq : q ≠ 0 := mt leading_coeff_eq_zero.2 fun h₁ => h <| by rw [h₁, mul_zero]
...
theorem leading_coeff_mul' (h : leadingCoeff p * leadingCoeff q ≠ 0) :
  ...
  rfl
#align polynomial.leading_coeff_mul' Polynomial.leading_coeff_mul'
...
#align
  polynomial.monomial_nat_degree_leading_coeff_eq_self Polynomial.monomial_nat_degree_leading_coeff_eq_self
...
#align polynomial.leading_coeff_pow' Polynomial.leading_coeff_pow'
...
theorem nat_degree_pow' {n : ℕ} (h : leadingCoeff p ^ n ≠ 0) :
...
#align polynomial.leading_coeff_monic_mul Polynomial.leading_coeff_monic_mul
...
#align polynomial.leading_coeff_mul_monic Polynomial.leading_coeff_mul_monic

@[simp]
theorem leading_coeff_mul_X_pow {p : R[X]} {n : ℕ} : leadingCoeff (p * X ^ n) = leadingCoeff p :=
  leading_coeff_mul_monic (monic_X_pow n)
#align polynomial.leading_coeff_mul_X_pow Polynomial.leading_coeff_mul_X_pow

@[simp]
theorem leading_coeff_mul_X {p : R[X]} : leadingCoeff (p * X) = leadingCoeff p :=
  leading_coeff_mul_monic monic_X
#align polynomial.leading_coeff_mul_X Polynomial.leading_coeff_mul_X

theorem nat_degree_mul_le {p q : R[X]} : natDegree (p * q) ≤ natDegree p + natDegree q :=
  by
  apply nat_degree_le_of_degree_le
  apply le_trans (degree_mul_le p q)
  rw [WithBot.coe_add]
  refine' add_le_add _ _ <;> apply degree_le_nat_degree
#align polynomial.nat_degree_mul_le Polynomial.nat_degree_mul_le

theorem nat_degree_pow_le {p : R[X]} {n : ℕ} : (p ^ n).natDegree ≤ n * p.natDegree :=
  by
...
#align polynomial.nat_degree_pow_le Polynomial.nat_degree_pow_le

@[simp]
theorem coeff_pow_mul_nat_degree (p : R[X]) (n : ℕ) :
...
#align polynomial.coeff_pow_mul_nat_degree Polynomial.coeff_pow_mul_nat_degree
...
#align
  polynomial.nat_degree_eq_zero_iff_degree_le_zero Polynomial.nat_degree_eq_zero_iff_degree_le_zero
...
#align polynomial.nat_degree_smul_le Polynomial.nat_degree_smul_le
...
#align polynomial.nat_degree_pos_iff_degree_pos Polynomial.nat_degree_pos_iff_degree_pos

theorem eq_C_of_nat_degree_le_zero (h : natDegree p ≤ 0) : p = c (coeff p 0) :=
  eq_C_of_degree_le_zero <| degree_le_of_nat_degree_le h
#align polynomial.eq_C_of_nat_degree_le_zero Polynomial.eq_C_of_nat_degree_le_zero

theorem eq_C_of_nat_degree_eq_zero (h : natDegree p = 0) : p = c (coeff p 0) :=
  eq_C_of_nat_degree_le_zero h.le
#align polynomial.eq_C_of_nat_degree_eq_zero Polynomial.eq_C_of_nat_degree_eq_zero
...
#align polynomial.le_nat_degree_of_coe_le_degree Polynomial.le_nat_degree_of_coe_le_degree
...
#align polynomial.nat_degree_linear_le Polynomial.nat_degree_linear_le

@[simp]
theorem nat_degree_linear (ha : a ≠ 0) : natDegree (c a * X + c b) = 1 :=
  nat_degree_eq_of_degree_eq_some <| degree_linear ha
#align polynomial.nat_degree_linear Polynomial.nat_degree_linear
...
#align polynomial.leading_coeff_linear Polynomial.leading_coeff_linear
...
#align polynomial.nat_degree_quadratic_le Polynomial.nat_degree_quadratic_le

@[simp]
theorem nat_degree_quadratic (ha : a ≠ 0) : natDegree (c a * X ^ 2 + c b * X + c c) = 2 :=
  nat_degree_eq_of_degree_eq_some <| degree_quadratic ha
#align polynomial.nat_degree_quadratic Polynomial.nat_degree_quadratic
...
#align polynomial.leading_coeff_quadratic Polynomial.leading_coeff_quadratic
...
#align
  polynomial.degree_quadratic_lt_degree_C_mul_X_cb Polynomial.degree_quadratic_lt_degree_C_mul_X_cb
...
#align polynomial.nat_degree_cubic_le Polynomial.nat_degree_cubic_le

@[simp]
theorem nat_degree_cubic (ha : a ≠ 0) : natDegree (c a * X ^ 3 + c b * X ^ 2 + c c * X + c d) = 3 :=
  nat_degree_eq_of_degree_eq_some <| degree_cubic ha
#align polynomial.nat_degree_cubic Polynomial.nat_degree_cubic

@[simp]
theorem leading_coeff_cubic (ha : a ≠ 0) :
  ...
  rw [add_assoc, add_assoc, ← add_assoc (C b * X ^ 2), add_comm,
    ...
    leading_coeff_C_mul_X_pow]
#align polynomial.leading_coeff_cubic Polynomial.leading_coeff_cubic
...
#align polynomial.nat_degree_X_pow Polynomial.nat_degree_X_pow

--  This lemma explicitly does not require the `nontrivial R` assumption.
theorem nat_degree_X_pow_le {R : Type _} [Semiring R] (n : ℕ) : (X ^ n : R[X]).natDegree ≤ n :=
  by
  nontriviality R
  rwa [Polynomial.nat_degree_X_pow]
#align polynomial.nat_degree_X_pow_le Polynomial.nat_degree_X_pow_le
...
theorem not_is_unit_X : ¬IsUnit (x : R[X]) := fun ⟨⟨_, g, hfg, hgf⟩, rfl⟩ =>
  zero_ne_one' R <| by
    ...
    simp
#align polynomial.not_is_unit_X Polynomial.not_is_unit_X
...
#align polynomial.nat_degree_X_sub_C_le Polynomial.nat_degree_X_sub_C_le
...
theorem nat_degree_sub_eq_left_of_nat_degree_lt (h : natDegree q < natDegree p) :
    natDegree (p - q) = natDegree p :=
  nat_degree_eq_of_degree_eq (degree_sub_eq_left_of_degree_lt (degree_lt_degree h))
#align
  polynomial.nat_degree_sub_eq_left_of_nat_degree_lt Polynomial.nat_degree_sub_eq_left_of_nat_degree_lt

theorem nat_degree_sub_eq_right_of_nat_degree_lt (h : natDegree p < natDegree q) :
    natDegree (p - q) = natDegree q :=
  nat_degree_eq_of_degree_eq (degree_sub_eq_right_of_degree_lt (degree_lt_degree h))
#align
  polynomial.nat_degree_sub_eq_right_of_nat_degree_lt Polynomial.nat_degree_sub_eq_right_of_nat_degree_lt
...
#align polynomial.nat_degree_X_add_C Polynomial.nat_degree_X_add_C
...
theorem nat_degree_X_pow_add_C {n : ℕ} {r : R} : (X ^ n + c r).natDegree = n :=
  by
  by_cases hn : n = 0
...
@[simp]
theorem leading_coeff_X_pow_add_C {n : ℕ} (hn : 0 < n) {r : R} : (X ^ n + c r).leadingCoeff = 1 :=
  by
  nontriviality R
  rw [leading_coeff, nat_degree_X_pow_add_C, coeff_add, coeff_X_pow_self, coeff_C,
    if_neg (pos_iff_ne_zero.mp hn), add_zero]
#align polynomial.leading_coeff_X_pow_add_C Polynomial.leading_coeff_X_pow_add_C

@[simp]
theorem leading_coeff_X_add_C [Semiring S] (r : S) : (X + c r).leadingCoeff = 1 := by
  rw [← pow_one (X : S[X]), leading_coeff_X_pow_add_C zero_lt_one]
#align polynomial.leading_coeff_X_add_C Polynomial.leading_coeff_X_add_C

@[simp]
theorem leading_coeff_X_pow_add_one {n : ℕ} (hn : 0 < n) : (X ^ n + 1 : R[X]).leadingCoeff = 1 :=
  leading_coeff_X_pow_add_C hn
#align polynomial.leading_coeff_X_pow_add_one Polynomial.leading_coeff_X_pow_add_one
...
#align polynomial.leading_coeff_pow_X_add_C Polynomial.leading_coeff_pow_X_add_C
...
theorem leading_coeff_X_pow_sub_C {n : ℕ} (hn : 0 < n) {r : R} : (X ^ n - c r).leadingCoeff = 1 :=
  by rw [sub_eq_add_neg, ← map_neg C r, leading_coeff_X_pow_add_C hn] <;> infer_instance
#align polynomial.leading_coeff_X_pow_sub_C Polynomial.leading_coeff_X_pow_sub_C

@[simp]
theorem leading_coeff_X_pow_sub_one {n : ℕ} (hn : 0 < n) : (X ^ n - 1 : R[X]).leadingCoeff = 1 :=
  leading_coeff_X_pow_sub_C hn
#align polynomial.leading_coeff_X_pow_sub_one Polynomial.leading_coeff_X_pow_sub_one
...
#align polynomial.nat_degree_X_sub_C Polynomial.nat_degree_X_sub_C

@[simp]
theorem next_coeff_X_sub_C [Ring S] (c : S) : nextCoeff (X - c c) = -c := by
  rw [sub_eq_add_neg, ← map_neg C c, next_coeff_X_add_C]
#align polynomial.next_coeff_X_sub_C Polynomial.next_coeff_X_sub_C
...
#align polynomial.nat_degree_X_pow_sub_C Polynomial.nat_degree_X_pow_sub_C

@[simp]
theorem leading_coeff_X_sub_C [Ring S] (r : S) : (X - c r).leadingCoeff = 1 := by
  rw [sub_eq_add_neg, ← map_neg C r, leading_coeff_X_add_C]
#align polynomial.leading_coeff_X_sub_C Polynomial.leading_coeff_X_sub_C
...
theorem degree_mul : degree (p * q) = degree p + degree q :=
  if hp0 : p = 0 then by simp only [hp0, degree_zero, zero_mul, WithBot.bot_add]
    ...
    if hq0 : q = 0 then by simp only [hq0, degree_zero, mul_zero, WithBot.add_bot]
      ...
      degree_mul' <| mul_ne_zero (mt leading_coeff_eq_zero.1 hp0) (mt leading_coeff_eq_zero.1 hq0)
#align polynomial.degree_mul Polynomial.degree_mul
...
@[simp]
theorem leading_coeff_mul (p q : R[X]) : leadingCoeff (p * q) = leadingCoeff p * leadingCoeff q :=
  by
  by_cases hp : p = 0
...
theorem leading_coeff_hom_apply (p : R[X]) : leadingCoeffHom p = leadingCoeff p :=
  rfl
#align polynomial.leading_coeff_hom_apply Polynomial.leading_coeff_hom_apply
