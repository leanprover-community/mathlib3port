...
#align denoms_clearable_zero denomsClearableZero
...
#align denoms_clearable_C_mul_X_pow denomsClearableCMulXPow
...
theorem denomsClearableOfNatDegreeLe (N : ℕ) (a : R) (bu : bi * i b = 1) :
    ∀ f : R[X], f.natDegree ≤ N → DenomsClearable a b N f i :=
  induction_with_nat_degree_le _ N (denomsClearableZero N a bu) (fun N_1 r r0 => denomsClearableCMulXPow a bu r)
    fun f g fg gN df dg => df.add dg
#align denoms_clearable_of_nat_degree_le denomsClearableOfNatDegreeLe
...
theorem denomsClearableNatDegree (i : R →+* K) (f : R[X]) (a : R) (bu : bi * i b = 1) :
    DenomsClearable a b f.natDegree f i :=
  denomsClearableOfNatDegreeLe f.natDegree a bu f le_rfl
#align denoms_clearable_nat_degree denomsClearableNatDegree
