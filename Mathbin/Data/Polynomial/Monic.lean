...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `monic.as_sum [])
  (Command.declSig
   [(Term.implicitBinder "{" [`p] [":" (Term.app `Polynomial [`R])] "}")
    (Term.explicitBinder "(" [`hp] [":" `p.monic] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     `p
     ...
     (Init.Logic.«term_+_»
      ...
      (Algebra.BigOperators.Basic.«term∑_in_,_»
       ...
       " in "
       (Term.app `range [`p.nat_degree])
       ", "
       (Finset.Data.Finset.Fold.«term_*_» (Term.app `C [(Term.app `p.coeff [`i])]) "*" («term_^_» `X "^" `i)))))))
          ...
          (Tactic.Conv.convSeq1Indented
           [(group
             (Tactic.Conv.convRw__
              ...
              (Tactic.rwRuleSeq
               "["
               [(Tactic.rwRule [] `p.as_sum_range_C_mul_X_pow) "," (Tactic.rwRule [] `sum_range_succ_comm)]
               "]"))
             [])])))
        [])
       (group
        (Tactic.tacticSuffices_
         ...
         (Term.sufficesDecl
          []
          («term_=_» (Term.app `C [(Term.app `p.coeff [`p.nat_degree])]) "=" (numLit "1"))
          (Term.byTactic
           "by"
           (Tactic.tacticSeq
            (Tactic.tacticSeq1Indented
             [(group
               (Tactic.rwSeq
                "rw"
                []
                (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `this) "," (Tactic.rwRule [] `one_mulₓ)] "]")
                [])
               [])])))))
        [])
       (group (Tactic.exact "exact" (Term.app `congr_argₓ [`C `hp])) [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `congr_argₓ [`C `hp]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `congr_argₓ [`C `hp])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `this) "," (Tactic.rwRule [] `one_mulₓ)] "]") [])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 50, term))
  (Term.app `C [(Term.app `p.coeff [`p.nat_degree])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `p.coeff [`p.nat_degree]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `C
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
theorem
  monic.as_sum
  { p : Polynomial R } ( hp : p.monic ) : p = X ^ p.nat_degree + ∑ i in range p.nat_degree , C p.coeff i * X ^ i
  :=
    by
      conv_lhs => rw [ p.as_sum_range_C_mul_X_pow , sum_range_succ_comm ]
        suffices C p.coeff p.nat_degree = 1 by rw [ this , one_mulₓ ]
...
theorem monic_map [Semiringₓ S] (f : R →+* S) (hp : monic p) : monic (p.map f) :=
  if h : (0 : S) = 1 then by
    have := subsingleton_of_zero_eq_one h <;> exact Subsingleton.elimₓ _ _
  else
...
theorem monic_mul (hp : monic p) (hq : monic q) : monic (p*q) :=
  if h0 : (0 : R) = 1 then by
    have := subsingleton_of_zero_eq_one h0 <;> exact Subsingleton.elimₓ _ _
  else
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `monic_prod_of_monic [])
  (Command.declSig
     ...
     [":"
      (Term.forall
       ...
       (Mathlib.ExtendedBinder.«term∀___,_»
        ...
        («binderTerm∈_» "∈" `s)
        ","
        (Term.forall "∀" [] "," (Term.app `monic [(Term.app `f [`i])]))))]
     []
     ")")]
   (Term.typeSpec
    ":"
    (Term.app
     ...
     [(Algebra.BigOperators.Basic.«term∏_in_,_»
       ...
       ", "
       (Term.app `f [`i]))])))
  (Command.declValSimple ":=" (Term.app `monic_multiset_prod_of_monic [(Term.proj `s "." (fieldIdx "1")) `f `hs]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `monic_multiset_prod_of_monic [(Term.proj `s "." (fieldIdx "1")) `f `hs])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
theorem
  monic_prod_of_monic
  ( s : Finset ι ) ( f : ι → Polynomial R ) ( hs : ∀ , ∀ i ∈ s , ∀ , monic f i ) : monic ∏ i in s , f i
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `monic.next_coeff_prod [])
  (Command.declSig
   [(Term.explicitBinder "(" [`s] [":" (Term.app `Finset [`ι])] [] ")")
    (Term.explicitBinder "(" [`f] [":" (Term.arrow `ι "→" (Term.app `Polynomial [`R]))] [] ")")
    (Term.explicitBinder
   ...
   (Term.typeSpec
    ...
    («term_=_»
     ...
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      ...
      `s
      ", "
      (Term.app `next_coeff [(Term.app `f [`i])])))))
  (Command.declValSimple ":=" (Term.app `monic.next_coeff_multiset_prod [(Term.proj `s "." (fieldIdx "1")) `f `h]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `monic.next_coeff_multiset_prod [(Term.proj `s "." (fieldIdx "1")) `f `h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `monic.next_coeff_multiset_prod
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
