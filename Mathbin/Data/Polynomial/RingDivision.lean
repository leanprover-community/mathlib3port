    ...
    have := Classical.propDecidable (∃ x, is_root p x) <;>
      exact
        if h : ∃ x, is_root p x then
          ...
          ⟨x ::ₘ t,
            calc (card (x ::ₘ t) : WithBot ℕ) = t.card+1 := by
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `eq_zero_of_infinite_is_root [])
  (Command.declSig
   [(Term.explicitBinder "(" [`p] [":" (Term.app `Polynomial [`R])] [] ")")
    (Term.explicitBinder
     "("
     [`h]
     [":" (Term.app `Set.Infinite [(Set.«term{_|_}» "{" `x "|" (Term.app `is_root [`p `x]) "}")])]
     []
     ")")]
    ...
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group (byContra "by_contra" [`hp]) [])
       ...
       (group (Tactic.convert "convert" [] `p.roots.to_finset.finite_to_set ["using" (numLit "1")]) [])
       (group (Tactic.ext1 "ext1" [(Tactic.rcasesPat.one `r)]) [])
       (group
        (Tactic.simp
         "simp"
         []
         ["only"]
         ["["
          [(Tactic.simpLemma [] [] (Term.app `mem_roots [`hp]))
           ","
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.ext1 "ext1" [(Tactic.rcasesPat.one `r)])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.convert "convert" [] `p.roots.to_finset.finite_to_set ["using" (numLit "1")])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Set.«term{_|_}» "{" `x "|" (Term.app `is_root [`p `x]) "}")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Set.«term{_|_}»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `is_root [`p `x])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `eq_of_infinite_eval_eq [])
  (Command.declSig
   [(Term.implicitBinder "{" [`R] [":" (Term.type "Type" [(Level.hole "_")])] "}")
    ...
    (Term.explicitBinder
     ...
     [":"
      (Term.app
       `Set.Infinite
       [(Set.«term{_|_}» "{" `x "|" («term_=_» (Term.app `eval [`x `p]) "=" (Term.app `eval [`x `q])) "}")])]
     []
     ")")]
   (Term.typeSpec ":" («term_=_» `p "=" `q)))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `sub_eq_zero)] "]") []) [])
       (group (Tactic.apply "apply" `eq_zero_of_infinite_is_root) [])
       (group
        (Tactic.simpa
         "simpa"
         []
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.simpa
   ...
   ["only"]
   ["["
    [(Tactic.simpLemma [] [] `is_root) "," (Tactic.simpLemma [] [] `eval_sub) "," (Tactic.simpLemma [] [] `sub_eq_zero)]
    "]"]
   []
   [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.apply "apply" `eq_zero_of_infinite_is_root)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.apply', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `eq_zero_of_infinite_is_root
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `sub_eq_zero)] "]") [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Set.«term{_|_}»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_=_» (Term.app `eval [`x `p]) "=" (Term.app `eval [`x `q]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_=_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `eval [`x `q])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
theorem roots_C (x : R) : (C x).roots = 0 :=
  if H : x = 0 then by
    ...
    Multiset.ext.mpr $ fun r =>
      have not_root : ¬is_root (C x) r := mt (fun h : eval r (C x) = 0 => trans eval_C.symm h) H
      by
      rw [count_roots, count_zero, root_multiplicity_eq_zero not_root]
...
theorem units_coeff_zero_smul (c : Units (Polynomial R)) (p : Polynomial R) : (c : Polynomial R).coeff 0 • p = c*p := by
...
theorem coeff_coe_units_zero_ne_zero (u : Units (Polynomial R)) : coeff (u : Polynomial R) 0 ≠ 0 := by
...
theorem leading_coeff_div_by_monic_of_monic {R : Type u} [CommRingₓ R] [IsDomain R] {p q : Polynomial R}
    (hmonic : q.monic) (hdegree : q.degree ≤ p.degree) : (p /ₘ q).leadingCoeff = p.leading_coeff := by
  have hp := mod_by_monic_add_div p hmonic
  have hzero : p /ₘ q ≠ 0 := by
    intro h
    exact not_lt_of_le hdegree ((div_by_monic_eq_zero_iff hmonic).1 h)
  have deglt : (p %ₘ q).degree < (q*p /ₘ q).degree := by
    rw [degree_mul]
