        ...
        [(Command.structSimpleBinder
          ...
          (Command.optDeclSig
           ...
           [(Term.typeSpec
             ...
             (Term.forall
              "∀"
              [(Term.implicitBinder "{" [`a `a'] [] "}") (Term.implicitBinder "{" [`f `f'] [] "}")]
              []
              ","
              (Term.arrow
               (Pfunctor.M.Data.Pfunctor.Univariate.M.«term_~_»
                (Term.app `M.mk [(Term.anonymousCtor "⟨" [`a "," `f] "⟩")])
                " ~ "
                (Term.app `M.mk [(Term.anonymousCtor "⟨" [`a' "," `f'] "⟩")]))
               "→"
               («term_=_» `a "=" `a'))))])
             ...
             (Term.forall
              ...
              [(Term.implicitBinder "{" [`a] [] "}")
               (Term.implicitBinder
                "{"
                [`f `f']
                [":" (Term.arrow (Term.app (Term.proj `F "." `B) [`a]) "→" (Term.app `M [`F]))]
                "}")]
              []
              ","
              (Term.arrow
               ...
               (Term.forall
                "∀"
                [`i]
                [(Term.typeSpec ":" (Term.app (Term.proj `F "." `B) [`a]))]
                ","
                (Pfunctor.M.Data.Pfunctor.Univariate.M.«term_~_»
                 (Term.app `f [`i])
                 " ~ "
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.forall
       ...
       (Pfunctor.M.Data.Pfunctor.Univariate.M.«term_~_»
        ...
        (Term.app `f' [`i])))
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Pfunctor.M.Data.Pfunctor.Univariate.M.«term_~_» (Term.app `f [`i]) " ~ " (Term.app `f' [`i]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Pfunctor.M.Data.Pfunctor.Univariate.M.«term_~_»', expected 'Pfunctor.M.Data.Pfunctor.Univariate.M.term_~_._@.Data.Pfunctor.Univariate.M._hyg.76'-/-- failed to format: format: uncaught backtrack exception
/--
    Bisimulation is the standard proof technique for equality between
    infinite tree-like structures -/
  structure
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      ...
      (Command.declSig
       [(Term.instBinder "[" [] (Term.app `Inhabited [(Term.app `M [`F])]) "]")
        (Term.explicitBinder "(" [`bisim] [":" (Term.app `IsBisimulation [`R])] [] ")")
        (Term.explicitBinder "(" [`s₁ `s₂] [] [] ")")
        (Term.explicitBinder "(" [`ps] [":" (Term.app `Path [`F])] [] ")")]
       (Term.typeSpec
        ":"
        (Term.arrow
         (Pfunctor.M.Data.Pfunctor.Univariate.M.«term_~_» `s₁ " ~ " `s₂)
         "→"
         (Term.arrow
          («term_∨_» (Term.app `IsPath [`ps `s₁]) "∨" (Term.app `IsPath [`ps `s₂]))
          "→"
          («term_∧_»
           («term_=_» (Term.app `iselect [`ps `s₁]) "=" (Term.app `iselect [`ps `s₂]))
           "∧"
           («term∃_,_»
            "∃"
            (Lean.explicitBinders
             [(Lean.bracketedExplicitBinders "(" [(Lean.binderIdent `a)] ":" (Term.hole "_") ")")
              (Lean.bracketedExplicitBinders
               "("
               [(Lean.binderIdent `f) (Lean.binderIdent `f')]
               ":"
               (Term.arrow (Term.app (Term.proj `F "." `B) [`a]) "→" (Term.app `M [`F]))
               ")")])
            ","
         ...
         (Tactic.tacticSeq1Indented
          [(Tactic.intro "intro" [`h₀ `hh])
           ...
           (Tactic.induction'
            ...
            ["using" `Pfunctor.M.casesOn']
            ["with" [(Lean.binderIdent `a) (Lean.binderIdent `f)]]
            [])
           []
           (Tactic.induction'
            "induction'"
           ...
           (Std.Tactic.obtain
            ...
            [":" («term_=_» `a "=" `a')]
            [":=" [(Term.app `bisim.head [`h₀])]])
           []
           (Tactic.induction'
            "induction'"
            [(Tactic.casesTarget [] `ps)]
            []
            ["with" [(Lean.binderIdent `i) (Lean.binderIdent `ps)]]
            ["generalizing" [`a `f `f']])
           []
           (tactic__
            (cdotTk (patternIgnore (token.«· » "·")))
            [(Tactic.«tacticExists_,,» "exists" [`rfl "," `a "," `f "," `f' "," `rfl "," `rfl])
             []
             (Tactic.apply "apply" (Term.app `bisim.tail [`h₀]))])
           []
           (Tactic.cases'
            "cases'"
            [(Tactic.casesTarget [] `i)]
            []
            ["with" [(Lean.binderIdent `a') (Lean.binderIdent `i)]])
           []
           (Std.Tactic.obtain
            "obtain"
            [(Std.Tactic.RCases.rcasesPatMed [(Std.Tactic.RCases.rcasesPat.one `rfl)])]
             ...
             [(Term.byTactic
               ...
               (Tactic.tacticSeq
                (Tactic.tacticSeq1Indented
                 [(Tactic.«tactic_<;>_»
                   (Tactic.«tactic_<;>_»
                    (Tactic.cases "cases" [(Tactic.casesTarget [] `hh)] [] [])
                    "<;>"
                    (Tactic.cases
                     "cases"
                     [(Tactic.casesTarget [] (Term.app `is_path_cons [`hh]))]
                     []
                     []))
                   "<;>"
           ...
           (Tactic.dsimp
            ...
            []
            ["only"]
            ["[" [(Tactic.simpLemma [] [] `iselect)] "]"]
            [(Tactic.location
              "at"
              (Tactic.locationHyp [`ps_ih] [(patternIgnore (token.«⊢» "⊢"))]))])
           []
           (Tactic.tacticHave_
            "have"
            (Term.haveDecl (Term.haveIdDecl [`h₁ []] [] ":=" (Term.app `bisim.tail [`h₀ `i]))))
           []
           (Tactic.induction'
            "induction'"
            [(Tactic.casesTarget [`h ":"] (Term.app `f [`i]))]
            ["using" `Pfunctor.M.casesOn']
            ["with" [(Lean.binderIdent `a₀) (Lean.binderIdent `f₀)]]
            [])
           []
           ...
           (Tactic.simp
            ...
            ["["
             [(Tactic.simpLemma [] [] `h)
              ...
              (Tactic.simpLemma [] [] `h')
              ","
              (Tactic.simpLemma [] [] `isubtree_cons)]
             "]"]
            [(Tactic.location
              "at"
              (Tactic.locationHyp [`ps_ih] [(patternIgnore (token.«⊢» "⊢"))]))])
           ...
           (Tactic.rwSeq
            "rw"
            []
            (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `h) "," (Tactic.rwRule [] `h')] "]")
           ...
           (Tactic.apply
            "apply"
            (Term.app `ps_ih [(Term.hole "_") (Term.hole "_") (Term.hole "_") `h₁]))
           []
           (Tactic.rwSeq
            "rw"
            []
           ...
           (Tactic.apply
            "apply"
            (Term.app `or_of_or_of_imp_of_imp [`hh `is_path_cons' `is_path_cons']))])))
       [])
      []
      []))
        ...
        (Tactic.tacticSeq1Indented
         [(Tactic.intro "intro" [`h₀ `hh])
          ...
          (Tactic.dsimp
           ...
           ["only"]
           ["[" [(Tactic.simpLemma [] [] `iselect)] "]"]
           [(Tactic.location "at" (Tactic.locationHyp [`ps_ih] [(patternIgnore (token.«⊢» "⊢"))]))])
          []
          (Tactic.tacticHave_
           "have"
           (Term.haveDecl (Term.haveIdDecl [`h₁ []] [] ":=" (Term.app `bisim.tail [`h₀ `i]))))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Tactic.apply "apply" (Term.app `or_of_or_of_imp_of_imp [`hh `is_path_cons' `is_path_cons']))
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `or_of_or_of_imp_of_imp [`hh `is_path_cons' `is_path_cons'])
...
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Tactic.apply "apply" (Term.app `ps_ih [(Term.hole "_") (Term.hole "_") (Term.hole "_") `h₁]))
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `ps_ih [(Term.hole "_") (Term.hole "_") (Term.hole "_") `h₁])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
        ...
        (Tactic.tacticSeq1Indented
         [(Tactic.«tactic_<;>_»
           (Tactic.«tactic_<;>_»
            (Tactic.cases "cases" [(Tactic.casesTarget [] `hh)] [] [])
            "<;>"
            (Tactic.cases "cases" [(Tactic.casesTarget [] (Term.app `is_path_cons [`hh]))] [] []))
           "<;>"
           (Tactic.tacticRfl "rfl"))])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq1Indented', expected 'Lean.Parser.Tactic.tacticSeqBracketed'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Pfunctor.M.Data.Pfunctor.Univariate.M.«term_~_» (Term.app `f [`i]) " ~ " (Term.app `f' [`i]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Pfunctor.M.Data.Pfunctor.Univariate.M.«term_~_»', expected 'Pfunctor.M.Data.Pfunctor.Univariate.M.term_~_._@.Data.Pfunctor.Univariate.M._hyg.76'
...
theorem
  nth_of_bisim
  [ Inhabited M F ] ( bisim : IsBisimulation R ) ( s₁ s₂ ) ( ps : Path F )
    :
      s₁ ~ s₂
        →
  ...
  :=
    by
      intro h₀ hh
        ...
        · exists rfl , a , f , f' , rfl , rfl apply bisim.tail h₀
        cases' i with a' i
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      ...
      (Command.declSig
       [(Term.instBinder "[" [] (Term.app `Nonempty [(Term.app `M [`F])]) "]")
        (Term.explicitBinder "(" [`bisim] [":" (Term.app `IsBisimulation [`R])] [] ")")]
       (Term.typeSpec
        ":"
        (Term.forall
      ...
      (Command.declValSimple
       ...
       (Term.byTactic
        ...
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(Lean.Elab.Tactic.inhabit "inhabit" [] (Term.app `M [`F]))
           []
           (Mathlib.Tactic.introv "introv" [(Lean.binderIdent `Hr)])
           ";"
           (Tactic.apply "apply" `ext)
           []
           (Mathlib.Tactic.introv "introv" [])
           []
           (Classical.«tacticBy_cases_:_»
            "by_cases"
            [`h ":"]
            («term_∨_» (Term.app `is_path [`ps `s₁]) "∨" (Term.app `is_path [`ps `s₂])))
           []
           (tactic__
            (cdotTk (patternIgnore (token.«· » "·")))
            [(Tactic.tacticHave_
              ...
              (Term.haveDecl
               (Term.haveIdDecl
                ...
                []
                ":="
                (Term.app `nth_of_bisim [`R `bisim (Term.hole "_") (Term.hole "_") `ps `Hr `h]))))
             []
             (Tactic.exact "exact" `H.left)])
           []
           (tactic__
            (cdotTk (patternIgnore (token.«· » "·")))
            [(Tactic.rwSeq
              "rw"
              []
              (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `not_or)] "]")
              [(Tactic.location "at" (Tactic.locationHyp [`h] []))])
             []
             (Tactic.cases'
              "cases'"
             ...
             (Tactic.simp
              ...
              ["only"]
              ["["
               [(Tactic.simpLemma [] [] `iselect_eq_default)
                ","
                (Tactic.simpStar "*")
                ","
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none,
     [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 30 >? 1022, (some 1023,
     term) <=? (none, [anonymous])
...
theorem
  eq_of_bisim
  [ Nonempty M F ] ( bisim : IsBisimulation R ) : ∀ s₁ s₂ , s₁ ~ s₂ → s₁ = s₂
  :=
    by
      inhabit M F
        introv Hr
