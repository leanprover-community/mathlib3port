   ...
   [(Term.typeSpec
     ...
     (Term.arrow
      ...
      (Init.Data.Sigma.Basic.«termΣ_,_»
       ...
       ", "
       (Term.arrow (Term.app `β [`a]) "→" (Term.app `WType [`β])))))])
  (Command.declValEqns
   (Term.matchAltsWhereDecls
    (Term.matchAlts
     [(Term.matchAlt "|" [(Term.anonymousCtor "⟨" [`a "," `f] "⟩")] "=>" (Term.anonymousCtor "⟨" [`a "," `f] "⟩"))])
    []))
  []
  []
  []))
...
/--
    The canonical map to the corresponding sigma type, returning the label of a node as an
      element `a` of `α`, and the children of the node as a function `β a → W_type β`. -/
  def to_sigma : WType β → Σ a : α , β a → WType β | ⟨ a , f ⟩ => ⟨ a , f ⟩
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  ...
  (Command.declValEqns
   (Term.matchAltsWhereDecls
    (Term.matchAlts [(Term.matchAlt "|" [(Term.anonymousCtor "⟨" [`a "," `f] "⟩")] "=>" (Term.app `WType.mk [`a `f]))])
    []))
  []
  []
  []))
...
/--
    The canonical map from the sigma type into a `W_type`. Given a node `a : α`, and
      its children as a function `β a → W_type β`, return the corresponding tree. -/
  def of_sigma : Σ a : α , β a → WType β → WType β | ⟨ a , f ⟩ => WType.mk a f
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `to_sigma_of_sigma [])
  (Command.declSig
   []
   (Term.typeSpec
    ":"
     ...
     [(Term.simpleBinder
       ...
       [(Term.typeSpec
         ...
         (Init.Data.Sigma.Basic.«termΣ_,_»
          ...
          (Term.arrow (Term.app `β [`a]) "→" (Term.app `WType [`β]))))])]
     ","
     («term_=_» (Term.app `to_sigma [(Term.app `of_sigma [`s])]) "=" `s))))
  (Command.declValEqns
   (Term.matchAltsWhereDecls
    (Term.matchAlts [(Term.matchAlt "|" [(Term.anonymousCtor "⟨" [`a "," `f] "⟩")] "=>" `rfl)])
    []))
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 50, term))
  (Term.app `to_sigma [(Term.app `of_sigma [`s])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `of_sigma [`s]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `to_sigma
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
@[ simp ] theorem to_sigma_of_sigma : ∀ s : Σ a : α , β a → WType β , to_sigma of_sigma s = s | ⟨ a , f ⟩ => rfl
 ...
 (Command.def
  ...
  (Command.declValSimple
   ...
   (Term.structInst
    "{"
    []
    [(group (Term.structInstField (Term.structInstLVal `toFun []) ":=" `to_sigma) [","])
     (group (Term.structInstField (Term.structInstLVal `invFun []) ":=" `of_sigma) [","])
     (group (Term.structInstField (Term.structInstLVal `left_inv []) ":=" `of_sigma_to_sigma) [","])
     (group (Term.structInstField (Term.structInstLVal `right_inv []) ":=" `to_sigma_of_sigma) [])]
    (Term.optEllipsis [])
    []
    "}")
   [])
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  ...
  (Command.declId `elim [])
  (Command.optDeclSig
   [(Term.explicitBinder "(" [`γ] [":" (Term.type "Type" [(Level.hole "_")])] [] ")")
    (Term.explicitBinder
     "("
     [`fγ]
     [":"
      (Term.arrow
       (Init.Data.Sigma.Basic.«termΣ_,_»
        ...
        (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `a)] [":" `α]))
        ", "
        (Term.arrow (Term.app `β [`a]) "→" `γ))
       "→"
       `γ)]
     []
     ")")]
   [(Term.typeSpec ":" (Term.arrow (Term.app `WType [`β]) "→" `γ))])
  (Command.declValEqns
   (Term.matchAltsWhereDecls
    (Term.matchAlts
     [(Term.matchAlt
       ...
       (Term.app
        ...
        [(Term.anonymousCtor
          ...
          [`a
           ","
           (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`b] [])] "=>" (Term.app `elim [(Term.app `f [`b])])))]
          "⟩")]))])
    []))
  []
  []
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app
   ...
   [(Term.anonymousCtor
     "⟨"
     [`a "," (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`b] [])] "=>" (Term.app `elim [(Term.app `f [`b])])))]
     "⟩")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.def', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
/-- The canonical map from `W_type β` into any type `γ` given a map `(Σ a : α, β a → γ) → γ`. -/
  def elim ( γ : Type _ ) ( fγ : Σ a : α , β a → γ → γ ) : WType β → γ | ⟨ a , f ⟩ => fγ ⟨ a , fun b => elim f b ⟩
  ...
  (Command.declSig
   [(Term.explicitBinder "(" [`γ] [":" (Term.type "Type" [(Level.hole "_")])] [] ")")
    (Term.explicitBinder
     ...
     []
     ")")
    (Term.explicitBinder "(" [`fγ_injective] [":" (Term.app `Function.Injective [`fγ])] [] ")")]
   (Term.typeSpec ":" (Term.app `Function.Injective [(Term.app `elim [`γ `fγ])])))
  (Command.declValEqns
   (Term.matchAltsWhereDecls
    (Term.matchAlts
     [(Term.matchAlt
       "|"
       [(Term.anonymousCtor "⟨" [`a₁ "," `f₁] "⟩") "," (Term.anonymousCtor "⟨" [`a₂ "," `f₂] "⟩") "," `h]
       "=>"
       (Term.byTactic
        "by"
        (Tactic.tacticSeq
            ...
            (Tactic.obtain
             ...
             [(Tactic.rcasesPatMed
               [(Tactic.rcasesPat.tuple
                 ...
                 "⟩")])]
             []
             [":=" [(Term.app `Sigma.mk.inj [(Term.app `fγ_injective [`h])])]])
            [])
           (group (Tactic.congr "congr" [] ["with" [(Tactic.rcasesPat.one `x)] []]) [])
           (group
            (Tactic.exact
             "exact"
             (Term.app
              ...
              [(Term.paren
                "("
                [(Term.app `congr_funₓ [(Term.app `eq_of_heq [`h]) `x]) [(Term.typeAscription ":" (Term.hole "_"))]]
                ")")]))
            [])]))))])
    []))
  []
...
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, [anonymous]))
  (Term.app `congr_funₓ [(Term.app `eq_of_heq [`h]) `x])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `eq_of_heq [`h]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `congr_funₓ
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.congr "congr" [] ["with" [(Tactic.rcasesPat.one `x)] []])
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `fγ_injective [`h]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `Sigma.mk.inj
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, [anonymous]))
  (Term.app `Function.Injective [(Term.app `elim [`γ `fγ])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `elim [`γ `fγ]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `Function.Injective
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Function.Injective [`fγ])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
theorem
  elim_injective
  ( γ : Type _ ) ( fγ : Σ a : α , β a → γ → γ ) ( fγ_injective : Function.Injective fγ ) : Function.Injective elim γ fγ
  |
    ⟨ a₁ , f₁ ⟩ , ⟨ a₂ , f₂ ⟩ , h
    =>
    by
 ...
 (Command.def
  ...
  (Command.optDeclSig
   ...
   [(Term.typeSpec
     ":"
     (Term.arrow
      (Term.app `W_type' [`β (Init.Logic.«term_+_» `n "+" (numLit "1"))])
      "→"
      (Init.Data.Sigma.Basic.«termΣ_,_»
       "Σ"
       (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `a)] [":" `α]))
       ", "
       (Term.arrow (Term.app `β [`a]) "→" (Term.app `W_type' [`β `n])))))])
  (Command.declValEqns
   (Term.matchAltsWhereDecls
    (Term.matchAlts
     [(Term.matchAlt
       "|"
       [(Term.anonymousCtor "⟨" [`t "," `h] "⟩")]
       "=>"
       (Term.byTactic
        "by"
        (Tactic.tacticSeq
           ...
           (group
            (Tactic.have''
             ...
             [(Term.typeSpec
               ...
               (Term.forall
                "∀"
                [(Term.simpleBinder [`i] [(Term.typeSpec ":" (Term.app `β [`a]))])]
                ","
                («term_≤_» (Term.app `WType.depth [(Term.app `f [`i])]) "≤" `n)))])
            [])
           (group
            (Tactic.exact
             "exact"
             (Term.fun
              ...
              (Term.basicFun
               ...
               (Term.app
                `Nat.le_of_lt_succₓ
                [(Term.app `lt_of_lt_of_leₓ [(Term.app `WType.depth_lt_depth_mk [`a `f `i]) `h])]))))
            [])
           (group
            (Tactic.exact
             "exact"
              ...
              [`a
               ...
               (Term.fun
                ...
                (Term.basicFun
                 [(Term.simpleBinder [`i] [(Term.typeSpec ":" (Term.app `β [`a]))])]
                 "=>"
                 (Term.anonymousCtor "⟨" [(Term.app `f [`i]) "," (Term.app `h₀ [`i])] "⟩")))]
              "⟩"))
            [])]))))])
    []))
  []
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.byTactic
   ...
   (Tactic.tacticSeq
    (Tactic.tacticSeq1Indented
     [(group
       (Tactic.cases' "cases'" [(Tactic.casesTarget [] `t)] [] ["with" [(Lean.binderIdent `a) (Lean.binderIdent `f)]])
       [])
      (group
       (Tactic.have''
        "have"
  ...
  (Tactic.exact
   ...
   (Term.fun
    ...
    (Term.basicFun
     [(Term.simpleBinder [`i] [])]
     "=>"
     (Term.app `Nat.le_of_lt_succₓ [(Term.app `lt_of_lt_of_leₓ [(Term.app `WType.depth_lt_depth_mk [`a `f `i]) `h])]))))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.fun
   "fun"
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `WType.depth_lt_depth_mk [`a `f `i])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `WType.depth_lt_depth_mk [`a `f `i]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `lt_of_lt_of_leₓ
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `lt_of_lt_of_leₓ [(Term.paren "(" [(Term.app `WType.depth_lt_depth_mk [`a `f `i]) []] ")") `h]) []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `Nat.le_of_lt_succₓ
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 51 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 50, term))
  (Term.app `WType.depth [(Term.app `f [`i])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
private
  def
    f
    ( n : ℕ ) : W_type' β n + 1 → Σ a : α , β a → W_type' β n
    |
      ⟨ t , h ⟩
      =>
      by
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           ...
           [(Term.typeSpec
             ":"
             («term_≤_»
              (Term.app `WType.depth [(Term.anonymousCtor "⟨" [`a "," `f'] "⟩")])
              "≤"
            ...
            [(Term.app
              ...
              [(Term.fun
                ...
                (Term.basicFun
                 ...
                 "=>"
                 (Term.proj (Term.app `f [`b]) "." (fieldIdx "2"))))])
             (numLit "1")])))
         []
         (Term.anonymousCtor "⟨" [(Term.anonymousCtor "⟨" [`a "," `f'] "⟩") "," `this] "⟩"))))])
    []))
  []
  []
  []))
     ...
     (Term.haveIdDecl
      ...
      (Term.app
       ...
       [(Term.app
         ...
         [(Term.fun
           "fun"
           (Term.basicFun [(Term.simpleBinder [`b `h] [])] "=>" (Term.proj (Term.app `f [`b]) "." (fieldIdx "2"))))])
        (numLit "1")])))
    []
    (Term.anonymousCtor "⟨" [(Term.anonymousCtor "⟨" [`a "," `f'] "⟩") "," `this] "⟩")))
 ...
 [(Term.app
   ...
   [(Term.fun
     ...
     (Term.basicFun
      [(Term.simpleBinder [`b `h] [])]
      "=>"
      (Term.proj (Term.paren "(" [(Term.app `f [`b]) []] ")") "." (fieldIdx "2"))))])
  []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `add_le_add_right
...
private
  def
    finv
    ( n : ℕ ) : Σ a : α , β a → W_type' β n → W_type' β n + 1
    |
      ⟨ a , f ⟩
      =>
      let
        f' := fun i : β a => f i . val
        have
          : WType.depth ⟨ a , f' ⟩ ≤ n + 1 := add_le_add_right Finset.sup_le fun b h => f b . 2 1
          ⟨ ⟨ a , f' ⟩ , this ⟩
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.instance
  ...
  []
  []
  (Command.declSig [] (Term.typeSpec ":" (Term.app `Encodable [(Term.app `WType [`β])])))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
        ...
        (Tactic.tacticHave_
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           ...
           [(Term.typeSpec
             ":"
             (Term.forall "∀" [(Term.simpleBinder [`n] [])] "," (Term.app `Encodable [(Term.app `W_type' [`β `n])])))]
           ":="
           (Term.fun
            "fun"
            (Term.basicFun
             [(Term.simpleBinder [`n] [])]
             "=>"
             (Term.app `Nat.recOn [`n `encodable_zero `encodable_succ]))))))
        [])
       (group
        (Tactic.tacticLet_
         "let"
          ...
          (Term.letIdDecl
           ...
           (Term.fun
            ...
            (Term.basicFun
             ...
             (Term.anonymousCtor
              "⟨"
              [`t.depth "," (Term.anonymousCtor "⟨" [`t "," (Term.app `le_reflₓ [(Term.hole "_")])] "⟩")]
              "⟩"))))))
        [])
       (group
        (Tactic.tacticLet_
        ...
        (Tactic.have''
         ...
         [(Term.typeSpec
           ...
           (Term.forall
            ...
            [(Term.simpleBinder [`t] [])]
            ","
            («term_=_» (Term.app `finv [(Term.app `f [`t])]) "=" `t)))])
        [])
       (group (Tactic.exact "exact" (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`t] [])] "=>" `rfl))) [])
       (group (Tactic.exact "exact" (Term.app `Encodable.ofLeftInverse [`f `finv `this])) [])])))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `Encodable.ofLeftInverse [`f `finv `this]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Encodable.ofLeftInverse [`f `finv `this])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.exact "exact" (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`t] [])] "=>" `rfl)))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`t] [])] "=>" `rfl))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.fun.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.basicFun.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.have''
   ...
   [(Term.typeSpec
     ":"
     (Term.forall "∀" [(Term.simpleBinder [`t] [])] "," («term_=_» (Term.app `finv [(Term.app `f [`t])]) "=" `t)))])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.have''', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'optional.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `f [`t]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `finv
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.fun
   "fun"
   (Term.basicFun [(Term.simpleBinder [`p] [])] "=>" (Term.proj (Term.proj `p "." (fieldIdx "2")) "." (fieldIdx "1"))))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.fun.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.basicFun.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
