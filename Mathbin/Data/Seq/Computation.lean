     ...
     (Command.def
      ...
      (Command.declValSimple
       ...
       (Term.forall
        ...
        ","
        (Term.arrow
         (Computation.Data.Seq.Computation.«term_~_» `s₁ " ~ " `s₂)
         "→"
         (Term.app `BisimO [`R (Term.app `destruct [`s₁]) (Term.app `destruct [`s₂])])))
       [])
      []
      []
      []))
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023,
     term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" (Term.app `destruct [`s₂]) ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 25, term))
      (Computation.Data.Seq.Computation.«term_~_» `s₁ " ~ " `s₂)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Computation.Data.Seq.Computation.«term_~_»', expected 'Computation.Data.Seq.Computation.term_~_._@.Data.Seq.Computation._hyg.10'
...
def IsBisimulation := ∀ ⦃ s₁ s₂ ⦄ , s₁ ~ s₂ → BisimO R destruct s₁ destruct s₂
                ...
                («term∃_,_»
                 ...
                 (Lean.explicitBinders
                  (Lean.unbracketedExplicitBinders
                   [(Lean.binderIdent `s) (Lean.binderIdent `s')]
                   [":" (Term.app `Computation [`α])]))
                 ","
                 («term_∧_»
                  («term_=_» (Term.proj `s "." (fieldIdx "1")) "=" `x)
                  "∧"
                  («term_∧_»
                   («term_=_» (Term.proj `s' "." (fieldIdx "1")) "=" `y)
                   "∧"
                   (Term.app `R [`s `s']))))))]))
           []
           (Tactic.dsimp
            ...
            []
            []
            ["[" [(Tactic.simpLemma [] [] `Stream'.IsBisimulation)] "]"]
            [])
           []
           (Tactic.intro "intro" [`t₁ `t₂ `e])
           []
           (Tactic.exact
            "exact"
            (Term.match
             ...
             []
             []
             [(Term.matchDiscr [] `t₁) "," (Term.matchDiscr [] `t₂) "," (Term.matchDiscr [] `e)]
             "with"
             (Term.matchAlts
              [(Term.matchAlt
                "|"
                [[(Term.hole "_")
                  ...
                  (Term.hole "_")
                  ","
                  (Term.anonymousCtor "⟨" [`s "," `s' "," `rfl "," `rfl "," `r] "⟩")]]
                "=>"
                (Term.byTactic
                 "by"
                 (Tactic.tacticSeq
                   ...
                   [(Tactic.tacticSuffices_
                     ...
                     (Term.sufficesDecl
                      ...
                      («term_∧_»
                       ...
                       "∧"
                       (Term.app `R [(Term.app `tail [`s]) (Term.app `tail [`s'])]))
                      (Term.fromTerm
                       "from"
                       (Term.app
                        `And.imp
                    ...
                    (Tactic.tacticHave_
                     "have"
                     (Term.haveDecl (Term.haveIdDecl [] [] ":=" (Term.app `bisim [`r]))))
                    ";"
                    (Tactic.revert "revert" [`r `this])
                    []
                    (Tactic.«tactic_<;>_»
                     (Tactic.«tactic_<;>_»
                      (Tactic.«tactic_<;>_»
                       (Tactic.«tactic_<;>_»
                        (Tactic.apply
                         "apply"
                         (Term.app `rec_on [`s (Term.hole "_") (Term.hole "_")]))
                        "<;>"
                    ...
                    (tactic__
                     ...
                     [(Tactic.rwSeq
                       ...
                       (Tactic.rwRuleSeq
                        "["
                        [(Tactic.rwRule [] `destruct_ret) "," (Tactic.rwRule [] `destruct_think)]
                        "]")
                       [(Tactic.location "at" (Tactic.locationHyp [`this] []))])
                      []
                      (Tactic.exact "exact" (Term.app `False.elim [`this]))])
                    []
                    (tactic__
                     (cdotTk (patternIgnore (token.«· » "·")))
                     [(Tactic.rwSeq
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Tactic.exact "exact" (Term.anonymousCtor "⟨" [`s₁ "," `s₂ "," `rfl "," `rfl "," `r] "⟩"))
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.anonymousCtor "⟨" [`s₁ "," `s₂ "," `rfl "," `rfl "," `r] "⟩")
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `r
              ...
              [(Tactic.tacticSuffices_
               ...
               (Tactic.«tactic_<;>_»
                (Tactic.«tactic_<;>_»
                 (Tactic.«tactic_<;>_»
                  (Tactic.«tactic_<;>_»
                   (Tactic.apply "apply" (Term.app `rec_on [`s (Term.hole "_") (Term.hole "_")]))
                   "<;>"
                   (Tactic.intros "intros" []))
                  "<;>"
                  (Tactic.apply "apply" (Term.app `rec_on [`s' (Term.hole "_") (Term.hole "_")])))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (tactic__
       ...
       [(Tactic.constructor "constructor")
        []
        (Tactic.dsimp "dsimp" [] [] [] [] [(Tactic.location "at" (Tactic.locationHyp [`this] []))])
        []
        (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `this)] "]") [])
        []
        (Tactic.assumption "assumption")])
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023,
     term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" (Term.app `tail [`s']) ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      (Term.app `tail [`s])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      («term_∧_»
       («term_=_» (Term.proj `s "." (fieldIdx "1")) "=" `x)
       "∧"
       («term_∧_» («term_=_» (Term.proj `s' "." (fieldIdx "1")) "=" `y) "∧" (Term.app `R [`s `s'])))
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      («term_∧_» («term_=_» (Term.proj `s' "." (fieldIdx "1")) "=" `y) "∧" (Term.app `R [`s `s']))
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `R [`s `s'])
...
theorem
  eq_of_bisim
  ( bisim : IsBisimulation R ) { s₁ s₂ } ( r : s₁ ~ s₂ ) : s₁ = s₂
  :=
    by
      apply Subtype.eq
        apply
          Stream'.eq_of_bisim fun x y => ∃ s s' : Computation α , s . 1 = x ∧ s' . 1 = y ∧ R s s'
            ...
            |
              ...
              by
                suffices
                        ...
                        And.imp
                          id
                            fun
                              r
                                =>
                                ⟨ tail s , tail s' , by cases s <;> rfl , by cases s' <;> rfl , r ⟩
                            this
                  have := bisim r
                  ;
                  revert r this
                  ...
                  · rw [ destruct_ret , destruct_think ] at this exact False.elim this
                  · rw [ destruct_ret , destruct_think ] at this exact False.elim this
                  · simp at this simp [ * ]
        exact ⟨ s₁ , s₂ , rfl , rfl , r ⟩
...
theorem terminates_of_lift_rel {R : α → β → Prop} {s t} :
  ...
  | ⟨l, r⟩ =>
    ⟨fun ⟨⟨a, as⟩⟩ =>
      ...
      let ⟨a, as, ab⟩ := r bt
      ⟨⟨a, as⟩⟩⟩
#align computation.terminates_of_lift_rel Computation.terminates_of_lift_rel
...
#align computation.rel_of_lift_rel Computation.rel_of_lift_rel

theorem lift_rel_of_mem {R : α → β → Prop} {a b ca cb} (ma : a ∈ ca) (mb : b ∈ cb) (ab : R a b) :
    LiftRel R ca cb :=
  ⟨fun a' ma' => by rw [mem_unique ma' ma] <;> exact ⟨b, mb, ab⟩, fun b' mb' => by
    rw [mem_unique mb' mb] <;> exact ⟨a, ma, ab⟩⟩
#align computation.lift_rel_of_mem Computation.lift_rel_of_mem

theorem exists_of_lift_rel_left {R : α → β → Prop} {ca cb} (H : LiftRel R ca cb) {a} (h : a ∈ ca) :
    ∃ b, b ∈ cb ∧ R a b :=
  H.left h
#align computation.exists_of_lift_rel_left Computation.exists_of_lift_rel_left

theorem exists_of_lift_rel_right {R : α → β → Prop} {ca cb} (H : LiftRel R ca cb) {b} (h : b ∈ cb) :
    ∃ a, a ∈ ca ∧ R a b :=
  H.right h
#align computation.exists_of_lift_rel_right Computation.exists_of_lift_rel_right
...
theorem lift_rel_def {R : α → β → Prop} {ca cb} :
  ...
  ⟨fun h =>
    ...
    ⟨fun a ma =>
      ...
      let ⟨⟨a, ma⟩⟩ := l.2 ⟨⟨_, mb⟩⟩
      ⟨a, ma, r ma mb⟩⟩⟩
#align computation.lift_rel_def Computation.lift_rel_def

theorem lift_rel_bind {δ} (R : α → β → Prop) (S : γ → δ → Prop) {s1 : Computation α}
  ...
  ⟨fun c cB =>
    ...
    let ⟨c, c₂, cd⟩ := r2 d1
    ⟨_, mem_bind a2 c₂, cd⟩⟩
#align computation.lift_rel_bind Computation.lift_rel_bind
...
#align computation.lift_rel_return_left Computation.lift_rel_return_left
...
#align computation.lift_rel_return_right Computation.lift_rel_return_right

@[simp]
theorem lift_rel_return (R : α → β → Prop) (a : α) (b : β) :
...
#align computation.lift_rel_return Computation.lift_rel_return
...
#align computation.lift_rel_think_left Computation.lift_rel_think_left
...
#align computation.lift_rel_think_right Computation.lift_rel_think_right
...
#align computation.lift_rel_mem_cases Computation.lift_rel_mem_cases
...
#align computation.lift_rel_congr Computation.lift_rel_congr

theorem lift_rel_map {δ} (R : α → β → Prop) (S : γ → δ → Prop) {s1 : Computation α}
...
#align computation.lift_rel_map Computation.lift_rel_map
