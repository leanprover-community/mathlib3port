...
theorem lhopital_zero_left_on_Ioo (hff' : ∀, ∀ x ∈ Ioo a b, ∀, HasDerivAt f (f' x) x)
  ...
  have hdnf : ∀, ∀ x ∈ -Ioo a b, ∀, HasDerivAt (f ∘ Neg.neg) (f' (-x)*-1) x
  exact fun x hx => comp x (hff' (-x) hx) (has_deriv_at_neg x)
  have hdng : ∀, ∀ x ∈ -Ioo a b, ∀, HasDerivAt (g ∘ Neg.neg) (g' (-x)*-1) x
...
theorem lhopital_zero_at_top_on_Ioi (hff' : ∀, ∀ x ∈ Ioi a, ∀, HasDerivAt f (f' x) x)
  ...
  obtain ⟨a', haa', ha'⟩ : ∃ a', a < a' ∧ 0 < a' :=
    ⟨1+max a 0, ⟨lt_of_le_of_ltₓ (le_max_leftₓ a 0) (lt_one_add _), lt_of_le_of_ltₓ (le_max_rightₓ a 0) (lt_one_add _)⟩⟩
  ...
  have hdnf : ∀, ∀ x ∈ Ioo 0 (a'⁻¹), ∀, HasDerivAt (f ∘ HasInv.inv) (f' (x⁻¹)*-(x^2)⁻¹) x
  exact fun x hx => comp x (hff' (x⁻¹) $ fact2 x hx) (has_deriv_at_inv $ fact1 x hx)
  have hdng : ∀, ∀ x ∈ Ioo 0 (a'⁻¹), ∀, HasDerivAt (g ∘ HasInv.inv) (g' (x⁻¹)*-(x^2)⁻¹) x
...
theorem lhopital_zero_at_bot_on_Iio (hff' : ∀, ∀ x ∈ Iio a, ∀, HasDerivAt f (f' x) x)
  ...
  have hdnf : ∀, ∀ x ∈ -Iio a, ∀, HasDerivAt (f ∘ Neg.neg) (f' (-x)*-1) x
  exact fun x hx => comp x (hff' (-x) hx) (has_deriv_at_neg x)
  have hdng : ∀, ∀ x ∈ -Iio a, ∀, HasDerivAt (g ∘ Neg.neg) (g' (-x)*-1) x
  exact fun x hx => comp x (hgg' (-x) hx) (has_deriv_at_neg x)
...
theorem lhopital_zero_right_on_Ioo (hdf : DifferentiableOn ℝ f (Ioo a b)) (hg' : ∀, ∀ x ∈ Ioo a b, ∀, deriv g x ≠ 0)
  ...
  have hdf : ∀, ∀ x ∈ Ioo a b, ∀, DifferentiableAt ℝ f x
  exact fun x hx => (hdf x hx).DifferentiableAt (Ioo_mem_nhds hx.1 hx.2)
  have hdg : ∀, ∀ x ∈ Ioo a b, ∀, DifferentiableAt ℝ g x
...
theorem lhopital_zero_at_top_on_Ioi (hdf : DifferentiableOn ℝ f (Ioi a)) (hg' : ∀, ∀ x ∈ Ioi a, ∀, (deriv g) x ≠ 0)
  ...
  have hdf : ∀, ∀ x ∈ Ioi a, ∀, DifferentiableAt ℝ f x
  exact fun x hx => (hdf x hx).DifferentiableAt (Ioi_mem_nhds hx)
  have hdg : ∀, ∀ x ∈ Ioi a, ∀, DifferentiableAt ℝ g x
  exact fun x hx => Classical.by_contradiction fun h => hg' x hx (deriv_zero_of_not_differentiable_at h)
  exact
...
theorem lhopital_zero_at_bot_on_Iio (hdf : DifferentiableOn ℝ f (Iio a)) (hg' : ∀, ∀ x ∈ Iio a, ∀, (deriv g) x ≠ 0)
  ...
  have hdf : ∀, ∀ x ∈ Iio a, ∀, DifferentiableAt ℝ f x
  exact fun x hx => (hdf x hx).DifferentiableAt (Iio_mem_nhds hx)
  have hdg : ∀, ∀ x ∈ Iio a, ∀, DifferentiableAt ℝ g x
  exact fun x hx => Classical.by_contradiction fun h => hg' x hx (deriv_zero_of_not_differentiable_at h)
  exact
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " L'Hôpital's rule for approaching a real from the right, `has_deriv_at` version -/")]
  []
  []
  []
  []
 ...
 (Command.theorem
  "theorem"
  (Command.declId `lhopital_zero_nhds_right [])
  (Command.declSig
   [(Term.explicitBinder
     "("
     [`hff']
    ...
    (Term.explicitBinder
     ...
     [":"
      (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
       ...
       (Topology.Basic.«term𝓝[>]_» "𝓝[>] " `a)
       ", "
       (Term.app `HasDerivAt [`g (Term.app `g' [`x]) `x]))]
     []
     ")")
    (Term.explicitBinder
     "("
    ...
    (Term.explicitBinder
     ...
     [":"
      (Term.app
       `tendsto
       [`f (Topology.Basic.«term𝓝[>]_» "𝓝[>] " `a) (Term.app (Topology.Basic.term𝓝 "𝓝") [(numLit "0")])])]
     []
     ")")
    (Term.explicitBinder
     "("
     ...
     [":"
      (Term.app
       `tendsto
       [`g (Topology.Basic.«term𝓝[>]_» "𝓝[>] " `a) (Term.app (Topology.Basic.term𝓝 "𝓝") [(numLit "0")])])]
     []
     ")")
    (Term.explicitBinder
     "("
     ...
     [":"
      (Term.app
       ...
       [(Term.fun
         "fun"
         (Term.basicFun [(Term.simpleBinder [`x] [])] "=>" («term_/_» (Term.app `f' [`x]) "/" (Term.app `g' [`x]))))
        (Topology.Basic.«term𝓝[>]_» "𝓝[>] " `a)
        `l])]
     []
     ")")]
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.rwSeq
         "rw"
         []
         (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `eventually_iff_exists_mem)] "]")
         [(Tactic.location "at" (Tactic.locationWildcard "*"))])
        [])
       (group
        (Tactic.rcases
         "rcases"
         [(Tactic.casesTarget [] `hff')]
         ["with"
          (Tactic.rcasesPat.tuple
           ...
           [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `s₁)]) [])
            ...
            ","
            (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `hff')]) [])]
           "⟩")])
        [])
       (group
        (Tactic.rcases
         "rcases"
         [(Tactic.casesTarget [] `hgg')]
         ["with"
          (Tactic.rcasesPat.tuple
           "⟨"
           [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `s₂)]) [])
            ...
            (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `hs₂)]) [])
            ","
            (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `hgg')]) [])]
           "⟩")])
        [])
       (group
        (Tactic.rcases
         "rcases"
         [(Tactic.casesTarget [] `hg')]
         ["with"
          (Tactic.rcasesPat.tuple
           "⟨"
           [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `s₃)]) [])
       ...
       (group
        (Tactic.tacticLet_
         "let"
         (Term.letDecl (Term.letIdDecl `s [] ":=" (Init.Core.«term_∩_» (Init.Core.«term_∩_» `s₁ " ∩ " `s₂) " ∩ " `s₃))))
        [])
       (group
        (Tactic.tacticHave_
         "have"
         (Term.haveDecl
          (Term.haveIdDecl
           [`hs []]
           [(Term.typeSpec ":" (Init.Core.«term_∈_» `s " ∈ " (Topology.Basic.«term𝓝[>]_» "𝓝[>] " `a)))]
           ":="
           (Term.app `inter_mem [(Term.app `inter_mem [`hs₁ `hs₂]) `hs₃]))))
        [])
       (group
        (Tactic.rwSeq
         "rw"
         []
         (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `mem_nhds_within_Ioi_iff_exists_Ioo_subset)] "]")
       ...
       (group
        (Tactic.«tactic_<;>_»
         (Tactic.refine'
          "refine'"
          (Term.app `lhopital_zero_right_on_Ioo [`hau (Term.hole "_") (Term.hole "_") (Term.hole "_") `hfa `hga `hdiv]))
         "<;>"
         (Tactic.«tactic_<;>_»
          (Tactic.intro "intro" [`x `hx])
          "<;>"
          (Tactic.«tactic_<;>_»
           (Tactic.applyAssumption "apply_assumption")
           "<;>"
           (Tactic.first
            "first"
            [(group
              ...
              (Tactic.tacticSeq
               (Tactic.tacticSeq1Indented
                [(group
                  (Tactic.exact
                   "exact"
                   (Term.proj (Term.proj (Term.app `hu [`hx]) "." (fieldIdx "1")) "." (fieldIdx "1")))
                  [])])))
             (group
              "|"
              (Tactic.tacticSeq
               (Tactic.tacticSeq1Indented
                [(group
                  (Tactic.exact
                   "exact"
                   (Term.proj (Term.proj (Term.app `hu [`hx]) "." (fieldIdx "1")) "." (fieldIdx "2")))
                  [])])))
             (group
              "|"
              (Tactic.tacticSeq
               (Tactic.tacticSeq1Indented
                [(group (Tactic.exact "exact" (Term.proj (Term.app `hu [`hx]) "." (fieldIdx "2"))) [])])))]))))
        [])])))
   [])
  []
  []))
     ...
     (Tactic.first
      ...
      [(group
        ...
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(group
            (Tactic.exact "exact" (Term.proj (Term.proj (Term.app `hu [`hx]) "." (fieldIdx "1")) "." (fieldIdx "1")))
            [])])))
       (group
        "|"
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(group
            (Tactic.exact "exact" (Term.proj (Term.proj (Term.app `hu [`hx]) "." (fieldIdx "1")) "." (fieldIdx "2")))
            [])])))
       (group
        "|"
        (Tactic.tacticSeq
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.proj (Term.app `hu [`hx]) "." (fieldIdx "2")))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Term.app `hu [`hx]) "." (fieldIdx "2"))
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `hu [`hx]) []] ")")
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.proj (Term.app `hu [`hx]) "." (fieldIdx "1"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `hu [`hx])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1, tactic))
  (Tactic.applyAssumption "apply_assumption")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.applyAssumption', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `inter_mem [`hs₁ `hs₂]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `inter_mem
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Init.Core.«term_∈_» `s " ∈ " (Topology.Basic.«term𝓝[>]_» "𝓝[>] " `a))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Init.Core.«term_∩_» (Init.Core.«term_∩_» `s₁ " ∩ " `s₂) " ∩ " `s₃)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Core.«term_∩_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `s₃
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Topology.Basic.«term𝓝[>]_» "𝓝[>] " `a) []] ")")
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'optional.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `tendsto [`g (Topology.Basic.«term𝓝[>]_» "𝓝[>] " `a) (Term.app (Topology.Basic.term𝓝 "𝓝") [(numLit "0")])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'optional.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `tendsto [`f (Topology.Basic.«term𝓝[>]_» "𝓝[>] " `a) (Term.app (Topology.Basic.term𝓝 "𝓝") [(numLit "0")])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " L'Hôpital's rule for approaching a real from the left, `has_deriv_at` version -/")]
  []
  []
  []
  []
 ...
 (Command.theorem
  "theorem"
  (Command.declId `lhopital_zero_nhds_left [])
  (Command.declSig
   [(Term.explicitBinder
     "("
     [`hff']
      ...
      [(group
       ...
       (group
        (Tactic.rwSeq
         "rw"
         []
         (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `mem_nhds_within_Iio_iff_exists_Ioo_subset)] "]")
         [(Tactic.location "at" (Tactic.locationHyp [`hs] []))])
        [])
       (group
        (Tactic.rcases
         ...
         ["with"
          (Tactic.rcasesPat.tuple
           ...
           [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `l)]) [])
            ","
            (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `hal)]) [])
            ","
       ...
       (group
        (Tactic.«tactic_<;>_»
         (Tactic.refine'
          "refine'"
          (Term.app `lhopital_zero_left_on_Ioo [`hal (Term.hole "_") (Term.hole "_") (Term.hole "_") `hfa `hga `hdiv]))
         "<;>"
         (Tactic.«tactic_<;>_»
          (Tactic.intro "intro" [`x `hx])
          "<;>"
              ...
              (Tactic.tacticSeq
               (Tactic.tacticSeq1Indented
                [(group
                  (Tactic.exact
                   "exact"
                   (Term.proj (Term.proj (Term.app `hl [`hx]) "." (fieldIdx "1")) "." (fieldIdx "1")))
                  [])])))
             (group
              "|"
              (Tactic.tacticSeq
               (Tactic.tacticSeq1Indented
                [(group
                  (Tactic.exact
                   "exact"
                   (Term.proj (Term.proj (Term.app `hl [`hx]) "." (fieldIdx "1")) "." (fieldIdx "2")))
                  [])])))
             (group
              "|"
              (Tactic.tacticSeq
               (Tactic.tacticSeq1Indented
                [(group (Tactic.exact "exact" (Term.proj (Term.app `hl [`hx]) "." (fieldIdx "2"))) [])])))]))))
        [])])))
   [])
  []
  []))
     ...
     (Tactic.first
      ...
      [(group
        ...
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(group
            (Tactic.exact "exact" (Term.proj (Term.proj (Term.app `hl [`hx]) "." (fieldIdx "1")) "." (fieldIdx "1")))
            [])])))
       (group
        "|"
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(group
            (Tactic.exact "exact" (Term.proj (Term.proj (Term.app `hl [`hx]) "." (fieldIdx "1")) "." (fieldIdx "2")))
            [])])))
       (group
        "|"
        (Tactic.tacticSeq
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.proj (Term.app `hl [`hx]) "." (fieldIdx "2")))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Term.app `hl [`hx]) "." (fieldIdx "2"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `hl [`hx])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `hl [`hx]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq', expected 'Lean.Parser.Tactic.tacticSeq.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.proj (Term.app `hl [`hx]) "." (fieldIdx "1"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `hl [`hx])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `lhopital_zero_nhds' [])
  (Command.declSig
   [(Term.explicitBinder
     "("
     [`hff']
     [":"
      (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
       ...
       (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `x)] []))
       " in "
       (Topology.Basic.«term𝓝[_]_» "𝓝[" (Init.Core.«term_\_» `univ " \\ " (Set.«term{_}» "{" [`a] "}")) "] " `a)
       ", "
       (Term.app `HasDerivAt [`f (Term.app `f' [`x]) `x]))]
     []
     ")")
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           ...
           [(Term.typeSpec
             ":"
             («term_=_»
              (Init.Core.«term_\_» `univ " \\ " (Set.«term{_}» "{" [`a] "}"))
              "="
              (Init.Core.«term_∪_» (Term.app `Iio [`a]) " ∪ " (Term.app `Ioi [`a]))))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
              ...
              [(group (Tactic.ext "ext" [] []) [])
               (group
                (Tactic.rwSeq
                 ...
                 (Tactic.rwRuleSeq
                  "["
                  [(Tactic.rwRule [] `mem_diff_singleton)
                   ","
                   (Tactic.rwRule [] («term_$__» `eq_true_intro "$" (Term.app `mem_univ [`x])))
                   ","
                   (Tactic.rwRule [] `true_andₓ)
                   ","
                   (Tactic.rwRule [] `ne_iff_lt_or_gtₓ)]
                  "]")
                 [])
                [])
        ...
        (Tactic.simp
         ...
         ["["
          [(Tactic.simpLemma [] [] `this)
           ","
           (Tactic.simpLemma [] [] `nhds_within_union)
           ","
           (Tactic.simpLemma [] [] `tendsto_sup)
           ","
           (Tactic.simpLemma [] [] `eventually_sup)]
          "]"]
         [(Tactic.location "at" (Tactic.locationWildcard "*"))])
        [])
       (group
        (Tactic.exact
         ...
         (Term.anonymousCtor
          ...
          [(Term.app
            `lhopital_zero_nhds_left
            [(Term.proj `hff' "." (fieldIdx "1"))
             (Term.proj `hgg' "." (fieldIdx "1"))
             (Term.proj `hg' "." (fieldIdx "1"))
             (Term.proj `hfa "." (fieldIdx "1"))
             (Term.proj `hga "." (fieldIdx "1"))
             (Term.proj `hdiv "." (fieldIdx "1"))])
           ","
           (Term.app
            `lhopital_zero_nhds_right
            [(Term.proj `hff' "." (fieldIdx "2"))
             (Term.proj `hgg' "." (fieldIdx "2"))
             (Term.proj `hg' "." (fieldIdx "2"))
             (Term.proj `hfa "." (fieldIdx "2"))
             (Term.proj `hga "." (fieldIdx "2"))
             (Term.proj `hdiv "." (fieldIdx "2"))])]
          "⟩"))
        [])])))
   [])
  []
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_$__» `eq_true_intro "$" (Term.app `mem_univ [`x]))
...
/--
  ...
  theorem
    lhopital_zero_nhds'
    ( hff' : ∀ᶠ x in 𝓝[ univ \ { a } ] a , HasDerivAt f f' x x )
        ( hgg' : ∀ᶠ x in 𝓝[ univ \ { a } ] a , HasDerivAt g g' x x )
        ( hg' : ∀ᶠ x in 𝓝[ univ \ { a } ] a , g' x ≠ 0 )
        ( hfa : tendsto f 𝓝[ univ \ { a } ] a 𝓝 0 )
        ( hga : tendsto g 𝓝[ univ \ { a } ] a 𝓝 0 )
        ( hdiv : tendsto fun x => f' x / g' x 𝓝[ univ \ { a } ] a l )
    ...
    :=
      by
        have
            : univ \ { a } = Iio a ∪ Ioi a
              :=
              by ext rw [ mem_diff_singleton , eq_true_intro $ mem_univ x , true_andₓ , ne_iff_lt_or_gtₓ ] rfl
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " **L'Hôpital's rule** for approaching a real, `has_deriv_at` version -/")]
  []
  []
  []
  []
   ...
   [(Term.explicitBinder
    ...
    (Term.explicitBinder
     ...
     [":"
      (Term.app
       `tendsto
       [`f (Term.app (Topology.Basic.term𝓝 "𝓝") [`a]) (Term.app (Topology.Basic.term𝓝 "𝓝") [(numLit "0")])])]
     []
     ")")
    (Term.explicitBinder
     "("
     ...
     [":"
      (Term.app
       `tendsto
       [`g (Term.app (Topology.Basic.term𝓝 "𝓝") [`a]) (Term.app (Topology.Basic.term𝓝 "𝓝") [(numLit "0")])])]
     []
     ")")
    (Term.explicitBinder
     "("
      ...
      [(group
        (Tactic.«tactic_<;>_»
         (Tactic.apply
          "apply"
          (Term.app
           (Term.explicit "@" `lhopital_zero_nhds')
           [(Term.hole "_") (Term.hole "_") (Term.hole "_") `f' (Term.hole "_") `g']))
         "<;>"
         (Tactic.«tactic_<;>_»
          (Tactic.first
           "first"
           [(group
             ...
             (Tactic.tacticSeq
              (Tactic.tacticSeq1Indented
               [(group (Tactic.apply "apply" `eventually_nhds_within_of_eventually_nhds) [])])))
            (group
             "|"
             (Tactic.tacticSeq
              (Tactic.tacticSeq1Indented [(group (Tactic.apply "apply" `tendsto_nhds_within_of_tendsto_nhds) [])])))])
          "<;>"
   ...
   (Tactic.«tactic_<;>_»
    (Tactic.first
     ...
     [(group
       "|"
       (Tactic.tacticSeq
        (Tactic.tacticSeq1Indented [(group (Tactic.apply "apply" `eventually_nhds_within_of_eventually_nhds) [])])))
      (group
       "|"
       (Tactic.tacticSeq
        (Tactic.tacticSeq1Indented [(group (Tactic.apply "apply" `tendsto_nhds_within_of_tendsto_nhds) [])])))])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.apply "apply" `tendsto_nhds_within_of_tendsto_nhds)
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.apply "apply" `eventually_nhds_within_of_eventually_nhds)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.apply', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
    ...
    :=
      by
        apply @ lhopital_zero_nhds' _ _ _ f' _ g'
          <;>
          first | apply eventually_nhds_within_of_eventually_nhds | apply tendsto_nhds_within_of_tendsto_nhds
            <;>
            assumption
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " L'Hôpital's rule for approaching +∞, `has_deriv_at` version -/")]
  []
  []
  []
  []
 ...
 (Command.theorem
  "theorem"
  (Command.declId `lhopital_zero_at_top [])
  (Command.declSig
   [(Term.explicitBinder
     "("
     [`hff']
    ...
    (Term.explicitBinder
     "("
     [`hftop]
     [":" (Term.app `tendsto [`f `at_top (Term.app (Topology.Basic.term𝓝 "𝓝") [(numLit "0")])])]
     []
     ")")
    (Term.explicitBinder
     "("
     [`hgtop]
     [":" (Term.app `tendsto [`g `at_top (Term.app (Topology.Basic.term𝓝 "𝓝") [(numLit "0")])])]
     []
     ")")
    (Term.explicitBinder
     "("
       ...
       (group
        (Tactic.tacticHave_
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           [`hs []]
           [(Term.typeSpec ":" (Init.Core.«term_∈_» `s " ∈ " `at_top))]
           ":="
           (Term.app `inter_mem [(Term.app `inter_mem [`hs₁ `hs₂]) `hs₃]))))
        [])
       (group
        (Tactic.rwSeq
         "rw"
         []
         (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `mem_at_top_sets)] "]")
         [(Tactic.location "at" (Tactic.locationHyp [`hs] []))])
        [])
       (group
        (Tactic.rcases
       ...
       (group
        (Tactic.tacticHave_
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           [`hl' []]
           [(Term.typeSpec ":" (Init.Core.«term_⊆_» (Term.app `Ioi [`l]) " ⊆ " `s))]
           ":="
           (Term.fun
            "fun"
            (Term.basicFun [(Term.simpleBinder [`x `hx] [])] "=>" (Term.app `hl [`x (Term.app `le_of_ltₓ [`hx])]))))))
        [])
       (group
        (Tactic.«tactic_<;>_»
         (Tactic.refine'
           ...
           [(Term.hole "_")
            ...
            (Term.fun
             ...
             (Term.basicFun
              ...
              "=>"
              («term_$__» (Term.app `hg' [`x]) "$" (Term.proj (Term.app `hl' [`hx]) "." (fieldIdx "2")))))
            `hftop
            `hgtop
            `hdiv]))
         "<;>"
 ...
 [(Term.fun
   ...
   (Term.basicFun
    ...
    («term_$__»
     (Term.app `hg' [`x])
     "$"
     (Term.proj (Term.paren "(" [(Term.app `hl' [`hx]) []] ")") "." (fieldIdx "2")))))
  []]
 ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.basicFun.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `hl [`x (Term.app `le_of_ltₓ [`hx])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Init.Core.«term_⊆_» (Term.app `Ioi [`l]) " ⊆ " `s)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Core.«term_⊆_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `s
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
/-- L'Hôpital's rule for approaching +∞, `has_deriv_at` version -/
  theorem
    ...
    ( hff' : ∀ᶠ x in at_top , HasDerivAt f f' x x )
        ( hgg' : ∀ᶠ x in at_top , HasDerivAt g g' x x )
        ( hg' : ∀ᶠ x in at_top , g' x ≠ 0 )
        ( hftop : tendsto f at_top 𝓝 0 )
        ( hgtop : tendsto g at_top 𝓝 0 )
        ( hdiv : tendsto fun x => f' x / g' x at_top l )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `lhopital_zero_at_bot [])
  (Command.declSig
   [(Term.explicitBinder
     "("
     [`hff']
    ...
    (Term.explicitBinder
     "("
     [`hfbot]
     [":" (Term.app `tendsto [`f `at_bot (Term.app (Topology.Basic.term𝓝 "𝓝") [(numLit "0")])])]
     []
     ")")
    (Term.explicitBinder
     "("
     [`hgbot]
     [":" (Term.app `tendsto [`g `at_bot (Term.app (Topology.Basic.term𝓝 "𝓝") [(numLit "0")])])]
     []
     ")")
    (Term.explicitBinder
     "("
       ...
       (group
        (Tactic.tacticHave_
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           [`hs []]
           [(Term.typeSpec ":" (Init.Core.«term_∈_» `s " ∈ " `at_bot))]
           ":="
           (Term.app `inter_mem [(Term.app `inter_mem [`hs₁ `hs₂]) `hs₃]))))
        [])
       (group
        (Tactic.rwSeq
         "rw"
         []
         (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `mem_at_bot_sets)] "]")
         [(Tactic.location "at" (Tactic.locationHyp [`hs] []))])
        [])
       (group
        (Tactic.rcases
       ...
       (group
        (Tactic.tacticHave_
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           [`hl' []]
           [(Term.typeSpec ":" (Init.Core.«term_⊆_» (Term.app `Iio [`l]) " ⊆ " `s))]
           ":="
           (Term.fun
            "fun"
            (Term.basicFun [(Term.simpleBinder [`x `hx] [])] "=>" (Term.app `hl [`x (Term.app `le_of_ltₓ [`hx])]))))))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Init.Core.«term_⊆_» (Term.app `Iio [`l]) " ⊆ " `s)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Core.«term_⊆_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `s
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
/-- L'Hôpital's rule for approaching -∞, `has_deriv_at` version -/
  theorem
    ...
    ( hff' : ∀ᶠ x in at_bot , HasDerivAt f f' x x )
        ( hgg' : ∀ᶠ x in at_bot , HasDerivAt g g' x x )
        ( hg' : ∀ᶠ x in at_bot , g' x ≠ 0 )
        ( hfbot : tendsto f at_bot 𝓝 0 )
        ( hgbot : tendsto g at_bot 𝓝 0 )
        ( hdiv : tendsto fun x => f' x / g' x at_bot l )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " **L'Hôpital's rule** for approaching a real from the right, `deriv` version -/")]
  []
  []
  []
  []
    ...
    (Term.explicitBinder
     ...
     [":"
      (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
       ...
       (Topology.Basic.«term𝓝[>]_» "𝓝[>] " `a)
       ", "
       («term_≠_» (Term.app `deriv [`g `x]) "≠" (numLit "0")))]
     []
     ")")
    (Term.explicitBinder
     "("
      ...
      (Term.app
       ...
       [(Term.fun
         ...
         (Term.basicFun
          [(Term.simpleBinder [`x] [])]
          "=>"
          («term_/_» (Term.app (Term.app `deriv [`f]) [`x]) "/" (Term.app (Term.app `deriv [`g]) [`x]))))
        (Topology.Basic.«term𝓝[>]_» "𝓝[>] " `a)
        `l])]
     []
     ")")]
         ...
         (Term.app
          ...
          [(«term_$__»
            ...
            (Term.fun
             "fun"
             (Term.basicFun
              [(Term.simpleBinder [(Term.hole "_") `hg'] [])]
              "=>"
              (Term.app
               ...
               [(Term.fun
                 ...
                 (Term.basicFun
                  [(Term.simpleBinder [`h] [])]
                  "=>"
                  (Term.app `hg' [(Term.app `deriv_zero_of_not_differentiable_at [`h])])))]))))]))
        [])
       (group
        (Tactic.have''
         "have"
         ...
         [(Term.typeSpec
           ...
           (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
            ...
            (Topology.Basic.«term𝓝[>]_» "𝓝[>] " `a)
            ", "
            (Term.app `HasDerivAt [`f (Term.app `deriv [`f `x]) `x])))])
        [])
       (group
        (Tactic.exact
         "exact"
         (Term.app
          ...
          [(«term_$__»
            ...
            (Term.fun
             "fun"
             (Term.basicFun [(Term.simpleBinder [(Term.hole "_")] [])] "=>" `DifferentiableAt.has_deriv_at)))]))
        [])
       (group
        (Tactic.have''
         "have"
         ...
         [(Term.typeSpec
           ...
           (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
            ...
            (Topology.Basic.«term𝓝[>]_» "𝓝[>] " `a)
            ", "
            (Term.app `HasDerivAt [`g (Term.app `deriv [`g `x]) `x])))])
        [])
       (group
        (Tactic.exact
         "exact"
        ...
        [])
       (group
        (Tactic.exact "exact" (Term.app `HasDerivAt.lhopital_zero_nhds_right [`hdf' `hdg' `hg' `hfa `hga `hdiv]))
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `HasDerivAt.lhopital_zero_nhds_right [`hdf' `hdg' `hg' `hfa `hga `hdiv])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app
   ...
   [(«term_$__»
     `eventually_of_forall
     "$"
     (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [(Term.hole "_")] [])] "=>" `DifferentiableAt.has_deriv_at)))])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `deriv [`g `x]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " **L'Hôpital's rule** for approaching a real from the left, `deriv` version -/")]
  []
  []
  []
  []
     ...
     (Tactic.tacticSeq1Indented
      [(group
       ...
       (group
        ...
        [])
       (group
        (Tactic.exact "exact" (Term.app `HasDerivAt.lhopital_zero_nhds_left [`hdf' `hdg' `hg' `hfa `hga `hdiv]))
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `HasDerivAt.lhopital_zero_nhds_left [`hdf' `hdg' `hg' `hfa `hga `hdiv])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `deriv [`g]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 71 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 70, term))
  (Term.app (Term.app `deriv [`f]) [`x])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1022, (some 1023, term) <=? (some 1022, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `deriv [`f]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 70 >? 1022, (some 1023, term) <=? (some 70, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 70, (some 71, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.simpleBinder', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.simpleBinder', expected 'Lean.Parser.Term.strictImplicitBinder.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(Term.fun
   ...
   (Term.basicFun
    ...
    "=>"
    («term_/_»
     (Term.app (Term.paren "(" [(Term.app `deriv [`f]) []] ")") [`x])
     "/"
     (Term.app (Term.paren "(" [(Term.app `deriv [`g]) []] ")") [`x]))))
  []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `tendsto
...
/--
  ...
  theorem
    lhopital_zero_nhds'
    ( hdf : ∀ᶠ x in 𝓝[ univ \ { a } ] a , DifferentiableAt ℝ f x )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " **L'Hôpital's rule** for approaching a real, `deriv` version -/")]
  []
  []
  []
  []
   ...
   (Term.byTactic
    ...
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.«tactic_<;>_»
         (Tactic.apply "apply" `lhopital_zero_nhds')
         "<;>"
         (Tactic.«tactic_<;>_»
          (Tactic.first
           "first"
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " **L'Hôpital's rule** for approaching +∞, `deriv` version -/")]
  []
  []
  []
  []
     ...
     (Tactic.tacticSeq1Indented
      [(group
       ...
       (group
        ...
        [])
       (group
        (Tactic.exact "exact" (Term.app `HasDerivAt.lhopital_zero_at_top [`hdf' `hdg' `hg' `hftop `hgtop `hdiv]))
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `HasDerivAt.lhopital_zero_at_top [`hdf' `hdg' `hg' `hftop `hgtop `hdiv])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `HasDerivAt.lhopital_zero_at_top
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
...
/-- **L'Hôpital's rule** for approaching +∞, `deriv` version -/
  theorem
    lhopital_zero_at_top
    ( hdf : ∀ᶠ x : ℝ in at_top , DifferentiableAt ℝ f x )
        ( hg' : ∀ᶠ x : ℝ in at_top , deriv g x ≠ 0 )
        ( hftop : tendsto f at_top 𝓝 0 )
        ( hgtop : tendsto g at_top 𝓝 0 )
        ( hdiv : tendsto fun x => deriv f x / deriv g x at_top l )
      : tendsto fun x => f x / g x at_top l
    :=
      by
     ...
     (Tactic.tacticSeq1Indented
      [(group
       ...
       (group
        ...
        [])
       (group
        (Tactic.exact "exact" (Term.app `HasDerivAt.lhopital_zero_at_bot [`hdf' `hdg' `hg' `hfbot `hgbot `hdiv]))
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `HasDerivAt.lhopital_zero_at_bot [`hdf' `hdg' `hg' `hfbot `hgbot `hdiv])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `HasDerivAt.lhopital_zero_at_bot
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
...
/-- **L'Hôpital's rule** for approaching -∞, `deriv` version -/
  theorem
    lhopital_zero_at_bot
    ( hdf : ∀ᶠ x : ℝ in at_bot , DifferentiableAt ℝ f x )
        ( hg' : ∀ᶠ x : ℝ in at_bot , deriv g x ≠ 0 )
        ( hfbot : tendsto f at_bot 𝓝 0 )
        ( hgbot : tendsto g at_bot 𝓝 0 )
        ( hdiv : tendsto fun x => deriv f x / deriv g x at_bot l )
      : tendsto fun x => f x / g x at_bot l
    :=
      by
