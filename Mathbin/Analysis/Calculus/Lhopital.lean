...
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » Ioo a b)
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (c «expr ∈ » Ioo a x)
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » Ioo a b)
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (c «expr ∈ » Ioo a x)
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » Ioo a b)
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » Ioo a b)
...
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » «expr- »(Ioo a b))
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » «expr- »(Ioo a b))
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » Ioo a b)
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » Ioo a b)
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » Ioo a b)
...
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » Ioo 0 «expr ⁻¹»(a'))
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » Ioo 0 «expr ⁻¹»(a'))
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » Ioo 0 «expr ⁻¹»(a'))
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » Ioi a)
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » Ioi a)
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » Ioi a)
...
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » «expr- »(Iio a))
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » «expr- »(Iio a))
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » Iio a)
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » Iio a)
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » Iio a)
...
theorem lhopital_zero_nhds_right (hff' : ∀ᶠ x in 𝓝[Ioi a] a, HasDerivAt f (f' x) x)
  (hgg' : ∀ᶠ x in 𝓝[Ioi a] a, HasDerivAt g (g' x) x) (hg' : ∀ᶠ x in 𝓝[Ioi a] a, g' x ≠ 0)
  (hfa : tendsto f (𝓝[Ioi a] a) (𝓝 0)) (hga : tendsto g (𝓝[Ioi a] a) (𝓝 0))
  (hdiv : tendsto (fun x => f' x / g' x) (𝓝[Ioi a] a) l) : tendsto (fun x => f x / g x) (𝓝[Ioi a] a) l :=
  by 
...
theorem lhopital_zero_nhds_left (hff' : ∀ᶠ x in 𝓝[Iio a] a, HasDerivAt f (f' x) x)
  (hgg' : ∀ᶠ x in 𝓝[Iio a] a, HasDerivAt g (g' x) x) (hg' : ∀ᶠ x in 𝓝[Iio a] a, g' x ≠ 0)
...
theorem lhopital_zero_at_top (hff' : ∀ᶠ x in at_top, HasDerivAt f (f' x) x)
  (hgg' : ∀ᶠ x in at_top, HasDerivAt g (g' x) x) (hg' : ∀ᶠ x in at_top, g' x ≠ 0) (hftop : tendsto f at_top (𝓝 0))
  (hgtop : tendsto g at_top (𝓝 0)) (hdiv : tendsto (fun x => f' x / g' x) at_top l) :
  tendsto (fun x => f x / g x) at_top l :=
  by 
    rw [eventually_iff_exists_mem] at *
...
theorem lhopital_zero_at_bot (hff' : ∀ᶠ x in at_bot, HasDerivAt f (f' x) x)
  (hgg' : ∀ᶠ x in at_bot, HasDerivAt g (g' x) x) (hg' : ∀ᶠ x in at_bot, g' x ≠ 0) (hfbot : tendsto f at_bot (𝓝 0))
  (hgbot : tendsto g at_bot (𝓝 0)) (hdiv : tendsto (fun x => f' x / g' x) at_bot l) :
  tendsto (fun x => f x / g x) at_bot l :=
  by 
    rw [eventually_iff_exists_mem] at *
...
theorem lhopital_zero_nhds_right (hdf : ∀ᶠ x in 𝓝[Ioi a] a, DifferentiableAt ℝ f x)
  (hg' : ∀ᶠ x in 𝓝[Ioi a] a, deriv g x ≠ 0) (hfa : tendsto f (𝓝[Ioi a] a) (𝓝 0)) (hga : tendsto g (𝓝[Ioi a] a) (𝓝 0))
  (hdiv : tendsto (fun x => (deriv f) x / (deriv g) x) (𝓝[Ioi a] a) l) : tendsto (fun x => f x / g x) (𝓝[Ioi a] a) l :=
  by 
    have hdg : ∀ᶠ x in 𝓝[Ioi a] a, DifferentiableAt ℝ g x 
    exact
      hg'.mp
        (eventually_of_forall$
          fun _ hg' => Classical.by_contradiction fun h => hg' (deriv_zero_of_not_differentiable_at h))
    have hdf' : ∀ᶠ x in 𝓝[Ioi a] a, HasDerivAt f (deriv f x) x 
    exact hdf.mp (eventually_of_forall$ fun _ => DifferentiableAt.has_deriv_at)
    have hdg' : ∀ᶠ x in 𝓝[Ioi a] a, HasDerivAt g (deriv g x) x 
...
theorem lhopital_zero_nhds_left (hdf : ∀ᶠ x in 𝓝[Iio a] a, DifferentiableAt ℝ f x)
  (hg' : ∀ᶠ x in 𝓝[Iio a] a, deriv g x ≠ 0) (hfa : tendsto f (𝓝[Iio a] a) (𝓝 0)) (hga : tendsto g (𝓝[Iio a] a) (𝓝 0))
  (hdiv : tendsto (fun x => (deriv f) x / (deriv g) x) (𝓝[Iio a] a) l) : tendsto (fun x => f x / g x) (𝓝[Iio a] a) l :=
  by 
    have hdg : ∀ᶠ x in 𝓝[Iio a] a, DifferentiableAt ℝ g x 
    exact
      hg'.mp
        (eventually_of_forall$
          fun _ hg' => Classical.by_contradiction fun h => hg' (deriv_zero_of_not_differentiable_at h))
    have hdf' : ∀ᶠ x in 𝓝[Iio a] a, HasDerivAt f (deriv f x) x 
    exact hdf.mp (eventually_of_forall$ fun _ => DifferentiableAt.has_deriv_at)
    have hdg' : ∀ᶠ x in 𝓝[Iio a] a, HasDerivAt g (deriv g x) x 
    exact hdg.mp (eventually_of_forall$ fun _ => DifferentiableAt.has_deriv_at)
...
theorem lhopital_zero_at_top (hdf : ∀ᶠ x : ℝ in at_top, DifferentiableAt ℝ f x)
  (hg' : ∀ᶠ x : ℝ in at_top, deriv g x ≠ 0) (hftop : tendsto f at_top (𝓝 0)) (hgtop : tendsto g at_top (𝓝 0))
  (hdiv : tendsto (fun x => (deriv f) x / (deriv g) x) at_top l) : tendsto (fun x => f x / g x) at_top l :=
  by 
...
theorem lhopital_zero_at_bot (hdf : ∀ᶠ x : ℝ in at_bot, DifferentiableAt ℝ f x)
  (hg' : ∀ᶠ x : ℝ in at_bot, deriv g x ≠ 0) (hfbot : tendsto f at_bot (𝓝 0)) (hgbot : tendsto g at_bot (𝓝 0))
  (hdiv : tendsto (fun x => (deriv f) x / (deriv g) x) at_bot l) : tendsto (fun x => f x / g x) at_bot l :=
  by 
