...
variable {α 𝕜 : Type _} [MeasurableSpace α] [LinearOrderₓ α] [TopologicalSpace α] [OrderTopology α]
  ...
  [IsScalarTower ℝ 𝕜 E] [CompleteSpace E] [second_countable_topology E] [MeasurableSpace E] [BorelSpace E] {H : Type _}
  [NormedGroup H] [NormedSpace 𝕜 H] [second_countable_topology$ H →L[𝕜] E] {a b : α} {bound : α → ℝ} {ε : ℝ}
