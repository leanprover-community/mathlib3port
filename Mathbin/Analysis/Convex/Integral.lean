...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `convex.smul_integral_mem_of_measurable [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `is_finite_measure [`μ]) "]")
    ...
    (Term.explicitBinder "(" [`hsc] [":" (Term.app `IsClosed [`s])] [] ")")
    (Term.explicitBinder "(" [`hμ] [":" («term_≠_» `μ "≠" (numLit "0"))] [] ")")
    ...
    (Term.explicitBinder "(" [`hfm] [":" (Term.app `Measurable [`f])] [] ")")]
   (Term.typeSpec
    ":"
    (Init.Core.«term_∈_»
     (Algebra.Group.Defs.«term_•_»
      (Init.Logic.«term_⁻¹» (Term.proj (Term.app `μ [`univ]) "." `toReal) "⁻¹")
      " • "
      ...
      [(group
       ...
       (group
        (Tactic.«tactic·._»
         ...
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group (Tactic.refine' "refine'" (Term.proj (Term.app `hμ [(Term.hole "_")]) "." `elim)) [])
            (group (Tactic.simpa "simpa" [] [] [] [] ["using" `hfs]) [])])))
        [])
       (group
        (Tactic.rwSeq
         "rw"
         []
         (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `hsc.closure_eq)] "]")
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           ...
           [(Term.typeSpec
             ...
             (Term.app
              `integrable
              [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [(Term.hole "_")] [])] "=>" `y₀)) `μ]))]
           ":="
       ...
       (group
        (Tactic.set
         "set"
         `F
         [":" (Term.arrow (termℕ "ℕ") "→" (Term.app `simple_func [`α `E]))]
         ":="
         (Term.app `simple_func.approx_on [`f `hfm `s `y₀ `h₀])
         [])
        [])
       (group
        (Tactic.tacticHave_
             ...
             (Term.app
              ...
              [(Term.fun
                ...
                (Term.basicFun
                 [(Term.simpleBinder [`n] [])]
                 "=>"
                 (Term.app (Term.proj (Term.app `F [`n]) "." `integral) [`μ])))
               `at_top
               («term_$__»
                 ...
                 ["["
                  [(Tactic.simpLemma
                    ...
                    (Term.app
                     ...
                     [(Term.hole "_")
                      (Term.app `simple_func.integrable_approx_on [`hfm `hfi `h₀ `hc (Term.hole "_")])]))]
                  "]"]
                 [])
                [])
               (group
                 ...
                 (Term.app
                  ...
                  [(Term.hole "_")
                   ...
                   («term_$__»
                    ...
                    "$"
                    (Term.app `simple_func.integrable_approx_on [`hfm `hfi `h₀ `hc]))
                   (Term.app
                    `simple_func.tendsto_approx_on_L1_nnnorm
                    [`hfm `h₀ `hfs (Term.proj (Term.app `hfi.sub [`hc]) "." (fieldIdx "2"))])]))
                [])]))))))
        [])
       (group
        (Tactic.refine'
         ...
         (Term.app
          `hsc.mem_of_tendsto
          [(Term.app `tendsto_const_nhds.smul [`this])
           («term_$__»
            `eventually_of_forall
            "$"
           ...
           [(Term.typeSpec
             ...
             («term_=_»
              (Algebra.BigOperators.Basic.«term∑_in_,_»
               ...
               " in "
               (Term.proj (Term.app `F [`n]) "." `range)
               ", "
               (Term.proj
                (Term.app `μ [(Set.Data.Set.Basic.«term_⁻¹'_» (Term.app `F [`n]) " ⁻¹' " (Set.«term{_}» "{" [`y] "}"))])
                "."
                `toReal))
              "="
             ...
             (Tactic.tacticSeq1Indented
              [(group
                (Tactic.rwSeq
                 ...
                 (Tactic.rwRuleSeq
                  "["
                  [(Tactic.rwRule ["←"] (Term.proj (Term.app `F [`n]) "." `sum_range_measure_preimage_singleton))
                   ","
                   (Tactic.rwRule
                    []
                    (Term.app
                     (Term.explicit "@" `Ennreal.to_real_sum)
                     [(Term.hole "_")
                      (Term.hole "_")
                      (Term.fun
                       "fun"
                       (Term.basicFun
                        ...
                        (Term.app
                         `μ
                         [(Set.Data.Set.Basic.«term_⁻¹'_» (Term.app `F [`n]) " ⁻¹' " (Set.«term{_}» "{" [`y] "}"))])))
                      (Term.fun
                       "fun"
                       (Term.basicFun
                        [(Term.simpleBinder [(Term.hole "_") (Term.hole "_")] [])]
                        "=>"
                        (Term.app `measure_ne_top [(Term.hole "_") (Term.hole "_")])))]))]
                  "]")
                 [])
                [])]))))))
        [])
       (group
        (Tactic.rwSeq
         "rw"
         []
         (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `this) "," (Tactic.rwRule [] `simple_func.integral)] "]")
         [])
        [])
       (group
        (Tactic.refine'
         ...
         (Term.app
          ...
          [(Term.fun
            "fun"
            (Term.basicFun [(Term.simpleBinder [(Term.hole "_") (Term.hole "_")] [])] "=>" `Ennreal.to_real_nonneg))
           (Term.hole "_")
           (Term.hole "_")]))
        [])
       (group
           ...
           [(group
             (Tactic.rwSeq
              ...
              (Tactic.rwRuleSeq
               ...
               [(Tactic.rwRule [] `this)
                ","
                (Tactic.rwRule [] `Ennreal.to_real_pos_iff)
                ","
                (Tactic.rwRule [] `pos_iff_ne_zero)
                ","
                (Tactic.rwRule [] `Ne.def)
                ","
                (Tactic.rwRule [] `measure.measure_univ_eq_zero)]
               "]")
              [])
             [])
            (group
             (Tactic.exact
              "exact"
              (Term.anonymousCtor "⟨" [`hμ "," (Term.app `measure_ne_top [(Term.hole "_") (Term.hole "_")])] "⟩"))
             [])])))
        [])
       (group
        (Tactic.«tactic·._»
         ...
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group (Tactic.simp "simp" [] ["only"] ["[" [(Tactic.simpLemma [] [] `simple_func.mem_range)] "]"] []) [])
            (group
             (Tactic.rintro
              "rintro"
              ...
              [])
             [])
            (group (Tactic.exact "exact" (Term.app `simple_func.approx_on_mem [`hfm `h₀ `n `x])) [])])))
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `simple_func.approx_on_mem [`hfm `h₀ `n `x]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `simple_func.approx_on_mem [`hfm `h₀ `n `x])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.simp "simp" [] ["only"] ["[" [(Tactic.simpLemma [] [] `simple_func.mem_range)] "]"] [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Term.app `F [`n]) "." `sum_range_measure_preimage_singleton)
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(Term.app
   `μ
   [(Term.paren "(" [(Set.Data.Set.Basic.«term_⁻¹'_» (Term.app `F [`n]) " ⁻¹' " (Set.«term{_}» "{" [`y] "}")) []] ")")])
  []]
 ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
private
  theorem
    convex.smul_integral_mem_of_measurable
    [ is_finite_measure μ ]
        { s : Set E }
        ( hs : Convex ℝ s )
        ( hsc : IsClosed s )
    ...
    :=
      by
        ( rcases eq_empty_or_nonempty s with ( rfl | ⟨ y₀ , h₀ ⟩ ) )
          ...
          have
            : tendsto fun n => F n . integral μ at_top 𝓝 $ ∫ x , f x ∂ μ
              :=
              by
          ...
          have
            : ∑ y in F n . range , μ F n ⁻¹' { y } . toReal = μ univ . toReal
              :=
              by
                rw
                  [
                    ← F n . sum_range_measure_preimage_singleton
                      ,
          ...
          · simp only [ simple_func.mem_range ] rintro _ ⟨ x , rfl ⟩ exact simple_func.approx_on_mem hfm h₀ n x
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `Convex.smul_integral_mem [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `is_finite_measure [`μ]) "]")
    (Term.implicitBinder "{" [`s] [":" (Term.app `Set [`E])] "}")
    (Term.explicitBinder "(" [`hs] [":" (Term.app `Convex [(Data.Real.Basic.termℝ "ℝ") `s])] [] ")")
          ...
          (Term.haveIdDecl
           ...
           [(Term.typeSpec
             ...
             (MeasureTheory.MeasureTheory.Measure.MeasureSpaceDef.«term∀ᵐ_∂_,_»
              ...
              `μ
              ", "
              (Init.Core.«term_∈_» (Term.app `hfi.ae_measurable.mk [`f `x]) " ∈ " `s)))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(group (Tactic.filterUpwards "filter_upwards" "[" [`hfs "," `hfi.ae_measurable.ae_eq_mk] "]" []) [])
               (group (Tactic.intro "intro" [`a `ha `h]) [])
               (group (tacticRwa__ "rwa" (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `h)] "]") []) [])]))))))
        [])
       (group
        (Tactic.convert
         "convert"
         ...
         (Term.app
          `convex.smul_integral_mem_of_measurable
          [`hs `hsc `hμ `this (Term.app `hfi.congr [`hfi.ae_measurable.ae_eq_mk]) `hfi.ae_measurable.measurable_mk])
         ["using" (numLit "2")])
        [])
       (group (Tactic.apply "apply" `integral_congr_ae) [])
       (group (Tactic.exact "exact" `hfi.ae_measurable.ae_eq_mk) [])])))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" `hfi.ae_measurable.ae_eq_mk)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `hfi.ae_measurable.ae_eq_mk
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `hfi.ae_measurable.measurable_mk
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `hfi.congr [`hfi.ae_measurable.ae_eq_mk])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (tacticRwa__ "rwa" (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `h)] "]") [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.filterUpwards "filter_upwards" "[" [`hfs "," `hfi.ae_measurable.ae_eq_mk] "]" [])
...
[PrettyPrinter.parenthesize] ...precedences are 51 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 50, term))
  (Term.app `hfi.ae_measurable.mk [`f `x])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
/--
  ...
  theorem
    ...
    :=
      by
        have
            : ∀ᵐ x : α ∂ μ , hfi.ae_measurable.mk f x ∈ s
              :=
              by filter_upwards [ hfs , hfi.ae_measurable.ae_eq_mk ] intro a ha h rwa [ ← h ]
          convert
            convex.smul_integral_mem_of_measurable
              hs hsc hμ this hfi.congr hfi.ae_measurable.ae_eq_mk hfi.ae_measurable.measurable_mk
            using 2
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `Convex.integral_mem [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `is_probability_measure [`μ]) "]")
    (Term.implicitBinder "{" [`s] [":" (Term.app `Set [`E])] "}")
    (Term.explicitBinder "(" [`hs] [":" (Term.app `Convex [(Data.Real.Basic.termℝ "ℝ") `s])] [] ")")
    (Term.explicitBinder "(" [`hsc] [":" (Term.app `IsClosed [`s])] [] ")")
    (Term.implicitBinder "{" [`f] [":" (Term.arrow `α "→" `E)] "}")
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.simpa
         ...
         []
         []
         ["[" [(Tactic.simpLemma [] [] `measure_univ)] "]"]
         []
         ["using" (Term.app `hs.smul_integral_mem [`hsc (Term.app `is_probability_measure.ne_zero [`μ]) `hf `hfi])])
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `hs.smul_integral_mem [`hsc (Term.app `is_probability_measure.ne_zero [`μ]) `hf `hfi])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `is_probability_measure.ne_zero [`μ])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `is_probability_measure.ne_zero
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `is_probability_measure.ne_zero [`μ]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `ConvexOn.map_smul_integral_le [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `is_finite_measure [`μ]) "]")
    (Term.implicitBinder "{" [`s] [":" (Term.app `Set [`E])] "}")
    (Term.implicitBinder "{" [`g] [":" (Term.arrow `E "→" (Data.Real.Basic.termℝ "ℝ"))] "}")
    (Term.explicitBinder "(" [`hg] [":" (Term.app `ConvexOn [(Data.Real.Basic.termℝ "ℝ") `s `g])] [] ")")
    (Term.explicitBinder "(" [`hgc] [":" (Term.app `ContinuousOn [`g `s])] [] ")")
    (Term.explicitBinder "(" [`hsc] [":" (Term.app `IsClosed [`s])] [] ")")
    (Term.explicitBinder "(" [`hμ] [":" («term_≠_» `μ "≠" (numLit "0"))] [] ")")
    (Term.implicitBinder "{" [`f] [":" (Term.arrow `α "→" `E)] "}")
    (Term.explicitBinder
     ...
     ")")
    (Term.explicitBinder "(" [`hfi] [":" (Term.app `integrable [`f `μ])] [] ")")
    (Term.explicitBinder "(" [`hgi] [":" (Term.app `integrable [(Rel.Data.Rel.«term_∘_» `g " ∘ " `f) `μ])] [] ")")]
   (Term.typeSpec
    ":"
    («term_≤_»
     (Term.app
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.set
         ...
         (Set.«term{_|_}»
          "{"
          (Mathlib.ExtendedBinder.extBinder `p [":" («term_×_» `E "×" (Data.Real.Basic.termℝ "ℝ"))])
          "|"
          («term_∧_»
           (Init.Core.«term_∈_» (Term.proj `p "." (fieldIdx "1")) " ∈ " `s)
           "∧"
           («term_≤_» (Term.app `g [(Term.proj `p "." (fieldIdx "1"))]) "≤" (Term.proj `p "." (fieldIdx "2"))))
          "}")
         [])
        [])
       (group
        (Tactic.tacticHave_
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           [`ht_conv []]
           [(Term.typeSpec ":" (Term.app `Convex [(Data.Real.Basic.termℝ "ℝ") `t]))]
           ":="
           `hg.convex_epigraph)))
        [])
       (group
        (Tactic.tacticHave_
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           ...
           ":="
           (Term.app
            (Term.proj (Term.app `hsc.preimage [`continuous_fst]) "." `is_closed_le)
            [(Term.app `hgc.comp [`continuous_on_fst (Term.app `subset.refl [(Term.hole "_")])]) `continuous_on_snd]))))
        [])
       (group
        (Tactic.tacticHave_
         "have"
          ...
          (Term.haveIdDecl
           ...
           [(Term.typeSpec
             ...
             (MeasureTheory.MeasureTheory.Measure.MeasureSpaceDef.«term∀ᵐ_∂_,_»
              ...
              ", "
              (Init.Core.«term_∈_»
               (Term.paren "(" [(Term.app `f [`x]) [(Term.tupleTail "," [(Term.app `g [(Term.app `f [`x])])])]] ")")
               " ∈ "
               `t)))]
           ":="
           (Term.app
       ...
       (group
        (Tactic.simpa
         ...
         []
         []
         ["[" [(Tactic.simpLemma [] [] (Term.app `integral_pair [`hfi `hgi]))] "]"]
         []
         ["using"
          (Term.proj
           (Term.app `ht_conv.smul_integral_mem [`ht_closed `hμ `ht_mem (Term.app `hfi.prod_mk [`hgi])])
           "."
           (fieldIdx "2"))])
        [])])))
   [])
        ...
        (Term.haveDecl
         (Term.haveIdDecl
          ...
          (Term.app
           ...
           [(Term.fun
             "fun"
             (Term.basicFun [(Term.simpleBinder [`x `hx] [])] "=>" (Term.anonymousCtor "⟨" [`hx "," `le_rfl] "⟩")))]))))
       [])
      (group
       (Tactic.simpa
        "simpa"
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `hfi.prod_mk [`hgi]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(Term.app
   `ht_conv.smul_integral_mem
   [`ht_closed `hμ `ht_mem (Term.paren "(" [(Term.app `hfi.prod_mk [`hgi]) []] ")")])
  []]
 ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«]»', expected 'optional.antiquot_scope'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simpLemma', expected 'Lean.Parser.Tactic.simpErase'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `integral_pair [`hfi `hgi])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`x `hx] [])] "=>" (Term.anonymousCtor "⟨" [`hx "," `le_rfl] "⟩")))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.fun.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.basicFun.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
/--
  ...
  theorem
    ...
    [ is_finite_measure μ ]
      ...
      : g μ univ . toReal ⁻¹ • ∫ x , f x ∂ μ ≤ μ univ . toReal ⁻¹ • ∫ x , g f x ∂ μ
    :=
      by
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `ConvexOn.map_integral_le [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `is_probability_measure [`μ]) "]")
    (Term.implicitBinder "{" [`s] [":" (Term.app `Set [`E])] "}")
    (Term.implicitBinder "{" [`g] [":" (Term.arrow `E "→" (Data.Real.Basic.termℝ "ℝ"))] "}")
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.simpa
         ...
         ["using"
          (Term.app
           `hg.map_smul_integral_le
           [`hgc `hsc (Term.app `is_probability_measure.ne_zero [`μ]) `hfs `hfi `hgi])])
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.simpa
   ...
   []
   ["using"
    (Term.app `hg.map_smul_integral_le [`hgc `hsc (Term.app `is_probability_measure.ne_zero [`μ]) `hfs `hfi `hgi])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simpa', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'optional.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `hg.map_smul_integral_le [`hgc `hsc (Term.app `is_probability_measure.ne_zero [`μ]) `hfs `hfi `hgi])
...
/--
  ...
  theorem
    ...
    [ is_probability_measure μ ]
        ...
        ( hgi : integrable g ∘ f μ )
      : g ∫ x , f x ∂ μ ≤ ∫ x , g f x ∂ μ
    := by simpa [ measure_univ ] using hg.map_smul_integral_le hgc hsc is_probability_measure.ne_zero μ hfs hfi hgi
