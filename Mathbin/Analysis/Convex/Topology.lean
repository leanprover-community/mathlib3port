 ...
 (Command.theorem
  ...
  (Command.declSig
   [(Term.implicitBinder "{" [`s] [":" (Term.app `Set [`E])] "}")
    ...
    (Term.explicitBinder "(" [`hx] [":" (Init.Core.«term_∈_» `x " ∈ " (Term.app `Interior [`s]))] [] ")")
    (Term.explicitBinder "(" [`t] [":" (Data.Real.Basic.termℝ "ℝ")] [] ")")
    (Term.explicitBinder "(" [`ht] [":" («term_<_» (numLit "1") "<" `t)] [] ")")]
   (Term.typeSpec
    ":"
    (Init.Core.«term_⊆_» `s " ⊆ " (Term.app `Interior [(Term.app `image [(Term.app `homothety [`x `t]) `s])]))))
     ...
     (Tactic.tacticSeq1Indented
      [(group (Tactic.intro "intro" [`y `hy]) [])
           ...
           (Set.«term{_|_}»
            ...
            («term∃_,_»
             ...
             (Lean.explicitBinders
              (Lean.unbracketedExplicitBinders [(Lean.binderIdent `u)] [":" (Data.Real.Basic.termℝ "ℝ")]))
             ","
             («term_∧_»
              (Init.Core.«term_∈_»
               `u
              ...
              («term_=_»
               `z
               "="
               (Init.Logic.«term_+_» `y "+" (Algebra.Group.Defs.«term_•_» `u " • " («term_-_» `x "-" `y))))))
            "}"))))
        [])
       (group
        (Tactic.tacticHave_
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           [`hI []]
           [(Term.typeSpec ":" (Init.Core.«term_⊆_» `I " ⊆ " (Term.app `Interior [`s])))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
       ...
       (group
        (Tactic.tacticLet_
         "let"
         (Term.letDecl (Term.letIdDecl `z [] ":=" (Term.app `homothety [`x (Init.Logic.«term_⁻¹» `t "⁻¹") `y]))))
        [])
       (group
        (Tactic.tacticHave_
         "have"
         (Term.haveDecl
          (Term.haveIdDecl
           [`hz₁ []]
           [(Term.typeSpec ":" (Init.Core.«term_∈_» `z " ∈ " (Term.app `Interior [`s])))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(group
                (Tactic.tacticSuffices_
                 ...
                 (Term.sufficesDecl
                  []
                  (Init.Core.«term_∈_» `z " ∈ " `I)
                  (Term.byTactic
                   "by"
                   (Tactic.tacticSeq
                    (Tactic.tacticSeq1Indented [(group (Tactic.exact "exact" (Term.app `hI [`this])) [])])))))
                [])
               (group (Tactic.use "use" [(«term_-_» (numLit "1") "-" (Init.Logic.«term_⁻¹» `t "⁻¹"))]) [])
       ...
       (group
        (Tactic.tacticHave_
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           [`hz₂ []]
           [(Term.typeSpec ":" («term_=_» `y "=" (Term.app `homothety [`x `t `z])))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
        ...
        (Tactic.exact
         ...
         (Term.anonymousCtor
          ...
          [(Term.app `image [(Term.app `homothety [`x `t]) `U])
           ","
           (Term.app `image_subset [(Init.Coe.«term⇑_» "⇑" (Term.app `homothety [`x `t])) `hU₁])
           ","
           (Term.app `homothety_is_open_map [`x `t `ht' `U `hU₂])
           ","
           (Term.app `mem_image_of_mem [(Init.Coe.«term⇑_» "⇑" (Term.app `homothety [`x `t])) `hU₃])]
          "⟩"))
        [])])))
   [])
  []
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Init.Coe.«term⇑_» "⇑" (Term.app `homothety [`x `t]))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_=_» `y "=" (Term.app `homothety [`x `t `z]))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, tactic))
  (Tactic.use "use" [(«term_-_» (numLit "1") "-" (Init.Logic.«term_⁻¹» `t "⁻¹"))])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_-_» (numLit "1") "-" (Init.Logic.«term_⁻¹» `t "⁻¹"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_-_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Init.Logic.«term_⁻¹» `t "⁻¹")
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Init.Core.«term_∈_» `z " ∈ " (Term.app `Interior [`s]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Core.«term_∈_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Interior [`s])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `homothety [`x (Init.Logic.«term_⁻¹» `t "⁻¹") `y])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Init.Logic.«term_⁻¹» `t "⁻¹") []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Init.Core.«term_⊆_» `I " ⊆ " (Term.app `Interior [`s]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Core.«term_⊆_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Interior [`s])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
     ...
     (Set.«term{_|_}»
      ...
      («term∃_,_»
       ...
       («term_∧_»
        ...
        "∧"
        («term_=_» `z "=" (Init.Logic.«term_+_» `y "+" (Algebra.Group.Defs.«term_•_» `u " • " («term_-_» `x "-" `y))))))
      "}"))))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticLet_', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.letDecl', expected 'Lean.Parser.Term.letDecl.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.letIdDecl', expected 'Lean.Parser.Term.letIdDecl.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Set.«term{_|_}»
   ...
   («term∃_,_»
    "∃"
    (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `u)] [":" (Data.Real.Basic.termℝ "ℝ")]))
    ","
    («term_∧_»
     (Init.Core.«term_∈_»
      `u
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Algebra.Group.Defs.«term_•_» `u " • " («term_-_» `x "-" `y))
    ...
    :=
      by
        intro y hy
          ...
          have hI : I ⊆ Interior s := by rintro z ⟨ u , hu , rfl ⟩ exact hs.add_smul_sub_mem_interior hy hx hu
          ...
          have hz₂ : y = homothety x t z := by simp [ z , ht' , homothety_apply , smul_smul ]
          rw [ hz₂ ]
...
theorem convex_on_dist (z : E) (s : Set E) (hs : Convex ℝ s) : ConvexOn ℝ s fun z' => dist z' z :=
  And.intro hs $ fun x y hx hy a b ha hb hab =>
    calc dist ((a • x)+b • y) z = ∥((a • x)+b • y) - (a+b) • z∥ := by
