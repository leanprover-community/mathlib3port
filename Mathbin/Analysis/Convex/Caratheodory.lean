...
theorem mem_convex_hull_erase [DecidableEq E] {t : Finset E} (h : ¬AffineIndependent 𝕜 (coeₓ : t → E)) {x : E}
  (m : x ∈ convexHull 𝕜 («expr↑ » t : Set E)) :
  ∃ y : («expr↑ » t : Set E), x ∈ convexHull 𝕜 («expr↑ » (t.erase y) : Set E) :=
  by 
...
-- error in Analysis.Convex.Caratheodory: ././Mathport/Syntax/Translate/Basic.lean:340:40: in by_contra: ././Mathport/Syntax/Translate/Tactic/Basic.lean:41:45: missing argument
