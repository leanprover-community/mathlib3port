...
but is expected to have type
  forall {R : Type.{u3}} {E : Type.{u2}} {ι : Type.{u1}} [_inst_1 : LinearOrderedField.{u3} R] [_inst_2 : AddCommGroup.{u2} E] [_inst_5 : Module.{u3, u2} R E (StrictOrderedSemiring.toSemiring.{u3} R (LinearOrderedSemiring.toStrictOrderedSemiring.{u3} R (LinearOrderedCommSemiring.toLinearOrderedSemiring.{u3} R (LinearOrderedSemifield.toLinearOrderedCommSemiring.{u3} R (LinearOrderedField.toLinearOrderedSemifield.{u3} R _inst_1))))) (AddCommGroup.toAddCommMonoid.{u2} E _inst_2)] (i : ι) {w : ι -> R} (z : ι -> E), (Ne.{succ u3} R (w i) (OfNat.ofNat.{u3} R 0 (Zero.toOfNat0.{u3} R (CommMonoidWithZero.toZero.{u3} R (CommGroupWithZero.toCommMonoidWithZero.{u3} R (Semifield.toCommGroupWithZero.{u3} R (LinearOrderedSemifield.toSemifield.{u3} R (LinearOrderedField.toLinearOrderedSemifield.{u3} R _inst_1)))))))) -> (Eq.{succ u2} E (Finset.centerMass.{u3, u2, u1} R E ι _inst_1 _inst_2 _inst_5 (Singleton.singleton.{u1, u1} ι (Finset.{u1} ι) (Finset.instSingletonFinset.{u1} ι) i) w z) (z i))
Case conversion may be inaccurate. Consider using '#align finset.center_mass_singleton Finset.centerMass_singletonₓ'. -/
