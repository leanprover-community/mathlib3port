...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `segment_eq_image₂ [])
  (Command.declSig
   [(Term.explicitBinder "(" [`x `y] [":" `E] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Analysis.Convex.Basic.«term[_-[_]_]» "[" `x " -[" `𝕜 "] " `y "]")
     "="
     (Set.Data.Set.Basic.term_''_
      (Term.fun
       "fun"
       (Term.basicFun
        [(Term.simpleBinder [`p] [(Term.typeSpec ":" («term_×_» `𝕜 "×" `𝕜))])]
        "=>"
        (Init.Logic.«term_+_»
         (Algebra.Group.Defs.«term_•_» (Term.proj `p "." (fieldIdx "1")) " • " `x)
         "+"
         (Algebra.Group.Defs.«term_•_» (Term.proj `p "." (fieldIdx "2")) " • " `y))))
      " '' "
      (Set.«term{_|_}»
       "{"
       `p
       "|"
       («term_∧_»
        («term_≤_» (numLit "0") "≤" (Term.proj `p "." (fieldIdx "1")))
        "∧"
        («term_∧_»
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.simp
         ...
         ["only"]
         ["["
          [(Tactic.simpLemma [] [] `Segment)
           ","
           (Tactic.simpLemma [] [] `image)
           ","
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `open_segment_eq_image₂ [])
  (Command.declSig
   [(Term.explicitBinder "(" [`x `y] [":" `E] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app `OpenSegment [`𝕜 `x `y])
     "="
     (Set.Data.Set.Basic.term_''_
      (Term.fun
       "fun"
...
@[simp]
theorem mem_open_segment_translate (a : E) {x b c : E} : (a+x) ∈ OpenSegment 𝕜 (a+b) (a+c) ↔ x ∈ OpenSegment 𝕜 b c := by
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `convex_Inter [])
  (Command.declSig
   [(Term.implicitBinder "{" [`ι] [":" (Term.sort "Sort" [(Level.hole "_")])] "}")
    (Term.implicitBinder "{" [`s] [":" (Term.arrow `ι "→" (Term.app `Set [`E]))] "}")
    (Term.explicitBinder
     "("
     [`h]
     [":"
      (Term.forall
       ...
       ","
       (Term.app `Convex [`𝕜 (Term.app `s [`i])]))]
     []
     ")")]
   (Term.typeSpec
    ":"
  ...
  (Command.declValSimple
   ":="
   («term_$__»
    (Term.subst (Term.app `sInter_range [`s]) "▸" [`convex_sInter])
    "$"
...
theorem
  convex_Inter
  { ι : Sort _ } { s : ι → Set E } ( h : ∀ i : ι , Convex 𝕜 s i ) : Convex 𝕜 ⋂ i , s i
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `Directed.convex_Union [])
  (Command.declSig
   [(Term.implicitBinder "{" [`ι] [":" (Term.sort "Sort" [(Level.hole "_")])] "}")
    (Term.implicitBinder "{" [`s] [":" (Term.arrow `ι "→" (Term.app `Set [`E]))] "}")
    (Term.explicitBinder
      ...
      [(group
       ...
       (group
        (Tactic.rwSeq
         "rw"
         []
         (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `mem_Union)] "]")
         [(Tactic.location "at" (Tactic.locationHyp [`hx `hy] ["⊢"]))])
        [])
       (group
        (Tactic.obtain
         "obtain"
       ...
       (group
        (Tactic.exact
         ...
         (Term.anonymousCtor
          "⟨"
          [`k "," (Term.app `hc [(Term.app `hik [`hx]) (Term.app `hjk [`hy]) `ha `hb `hab])]
          "⟩"))
        [])])))
   [])
  []
    ...
    (Tactic.tacticSeq1Indented
     [(group
      ...
      (group
       (Tactic.exact
        "exact"
        (Term.anonymousCtor "⟨" [`k "," (Term.app `hc [(Term.app `hik [`hx]) (Term.app `hjk [`hy]) `ha `hb `hab])] "⟩"))
       [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.byTactic', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.byTactic', expected 'Lean.Parser.Term.byTactic.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq', expected 'Lean.Parser.Tactic.tacticSeq.antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `hc [(Term.app `hik [`hx]) (Term.app `hjk [`hy]) `ha `hb `hab])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `hjk [`hy]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `hik [`hx]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `hc
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
theorem
  ...
  { ι : Sort _ } { s : ι → Set E } ( hdir : Directed · ⊆ · s ) ( hc : ∀ ⦃ i : ι ⦄ , Convex 𝕜 s i ) : Convex 𝕜 ⋃ i , s i
  :=
    by
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `convex_halfspace_le [])
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.arrow `E "→" `β)] "}")
    (Term.explicitBinder "(" [`h] [":" (Term.app `IsLinearMap [`𝕜 `f])] [] ")")
    (Term.explicitBinder "(" [`r] [":" `β] [] ")")]
   (Term.typeSpec ":" (Term.app `Convex [`𝕜 (Set.«term{_|_}» "{" `w "|" («term_≤_» (Term.app `f [`w]) "≤" `r) "}")])))
  (Command.declValSimple ":=" (Term.app (Term.proj (Term.app `convex_Iic [`r]) "." `is_linear_preimage) [`h]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.proj (Term.app `convex_Iic [`r]) "." `is_linear_preimage) [`h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `convex_Iic [`r]) "." `is_linear_preimage)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `convex_Iic [`r])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `convex_Iic [`r]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declSig', expected 'Lean.Parser.Command.declSig.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, [anonymous]))
  (Term.app `Convex [`𝕜 (Set.«term{_|_}» "{" `w "|" («term_≤_» (Term.app `f [`w]) "≤" `r) "}")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Set.«term{_|_}» "{" `w "|" («term_≤_» (Term.app `f [`w]) "≤" `r) "}")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Set.«term{_|_}»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_≤_» (Term.app `f [`w]) "≤" `r)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_≤_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `r
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `convex_halfspace_ge [])
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.arrow `E "→" `β)] "}")
    (Term.explicitBinder "(" [`h] [":" (Term.app `IsLinearMap [`𝕜 `f])] [] ")")
    (Term.explicitBinder "(" [`r] [":" `β] [] ")")]
   (Term.typeSpec ":" (Term.app `Convex [`𝕜 (Set.«term{_|_}» "{" `w "|" («term_≤_» `r "≤" (Term.app `f [`w])) "}")])))
  (Command.declValSimple ":=" (Term.app (Term.proj (Term.app `convex_Ici [`r]) "." `is_linear_preimage) [`h]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.proj (Term.app `convex_Ici [`r]) "." `is_linear_preimage) [`h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `convex_Ici [`r]) "." `is_linear_preimage)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `convex_Ici [`r])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `convex_Ici [`r]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declSig', expected 'Lean.Parser.Command.declSig.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, [anonymous]))
  (Term.app `Convex [`𝕜 (Set.«term{_|_}» "{" `w "|" («term_≤_» `r "≤" (Term.app `f [`w])) "}")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Set.«term{_|_}»', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Set.«term{_|_}»', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Set.«term{_|_}»', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Set.«term{_|_}»', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Set.«term{_|_}» "{" `w "|" («term_≤_» `r "≤" (Term.app `f [`w])) "}")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Set.«term{_|_}»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_≤_» `r "≤" (Term.app `f [`w]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_≤_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `f [`w])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `convex_hyperplane [])
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.arrow `E "→" `β)] "}")
    (Term.explicitBinder "(" [`h] [":" (Term.app `IsLinearMap [`𝕜 `f])] [] ")")
    (Term.explicitBinder "(" [`r] [":" `β] [] ")")]
  ...
  (Command.declValSimple
   ...
   (Term.byTactic
    ...
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group (Tactic.simpRw "simp_rw" (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `le_antisymm_iffₓ)] "]") []) [])
       (group
        (Tactic.exact
         "exact"
         (Term.app
          (Term.proj (Term.app `convex_halfspace_le [`h `r]) "." `inter)
          [(Term.app `convex_halfspace_ge [`h `r])]))
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact
   "exact"
   (Term.app (Term.proj (Term.app `convex_halfspace_le [`h `r]) "." `inter) [(Term.app `convex_halfspace_ge [`h `r])]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.proj (Term.app `convex_halfspace_le [`h `r]) "." `inter) [(Term.app `convex_halfspace_ge [`h `r])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `convex_halfspace_ge [`h `r]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `convex_halfspace_le [`h `r]) "." `inter)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `convex_halfspace_le [`h `r])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `convex_halfspace_le [`h `r]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.simpRw "simp_rw" (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `le_antisymm_iffₓ)] "]") [])
...
theorem
  convex_hyperplane
  { f : E → β } ( h : IsLinearMap 𝕜 f ) ( r : β ) : Convex 𝕜 { w | f w = r }
  := by simp_rw [ le_antisymm_iffₓ ] exact convex_halfspace_le h r . inter convex_halfspace_ge h r
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `convex_halfspace_lt [])
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.arrow `E "→" `β)] "}")
    (Term.explicitBinder "(" [`h] [":" (Term.app `IsLinearMap [`𝕜 `f])] [] ")")
    (Term.explicitBinder "(" [`r] [":" `β] [] ")")]
   (Term.typeSpec ":" (Term.app `Convex [`𝕜 (Set.«term{_|_}» "{" `w "|" («term_<_» (Term.app `f [`w]) "<" `r) "}")])))
  (Command.declValSimple ":=" (Term.app (Term.proj (Term.app `convex_Iio [`r]) "." `is_linear_preimage) [`h]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.proj (Term.app `convex_Iio [`r]) "." `is_linear_preimage) [`h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `convex_Iio [`r]) "." `is_linear_preimage)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `convex_Iio [`r])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `convex_Iio [`r]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declSig', expected 'Lean.Parser.Command.declSig.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `convex_halfspace_gt [])
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.arrow `E "→" `β)] "}")
    (Term.explicitBinder "(" [`h] [":" (Term.app `IsLinearMap [`𝕜 `f])] [] ")")
    (Term.explicitBinder "(" [`r] [":" `β] [] ")")]
   (Term.typeSpec ":" (Term.app `Convex [`𝕜 (Set.«term{_|_}» "{" `w "|" («term_<_» `r "<" (Term.app `f [`w])) "}")])))
  (Command.declValSimple ":=" (Term.app (Term.proj (Term.app `convex_Ioi [`r]) "." `is_linear_preimage) [`h]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.proj (Term.app `convex_Ioi [`r]) "." `is_linear_preimage) [`h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `convex_Ioi [`r]) "." `is_linear_preimage)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `convex_Ioi [`r])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `convex_Ioi [`r]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declSig', expected 'Lean.Parser.Command.declSig.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `MonotoneOn.convex_le [])
  (Command.declSig
   [(Term.explicitBinder "(" [`hf] [":" (Term.app `MonotoneOn [`f `s])] [] ")")
  ...
  (Command.declValSimple
   ...
   (Term.fun
    ...
    (Term.basicFun
     ...
     (Term.anonymousCtor
      "⟨"
      [(Term.app `hs [(Term.proj `hx "." (fieldIdx "1")) (Term.proj `hy "." (fieldIdx "1")) `ha `hb `hab])
       ","
       (Term.app
        (Term.proj
         (Term.app
          `hf
          [(Term.app `hs [(Term.proj `hx "." (fieldIdx "1")) (Term.proj `hy "." (fieldIdx "1")) `ha `hb `hab])
           (Term.app `max_rec' [`s (Term.proj `hx "." (fieldIdx "1")) (Term.proj `hy "." (fieldIdx "1"))])
           (Term.app `Convex.combo_le_max [`x `y `ha `hb `hab])])
         "."
         `trans)
        [(Term.app `max_rec' [(Term.hole "_") (Term.proj `hx "." (fieldIdx "2")) (Term.proj `hy "." (fieldIdx "2"))])])]
      "⟩")))
   [])
  []
  []))
 ...
 [(Term.app
   ...
   [(Term.paren
    ...
    (Term.paren
     ...
     [(Term.app `max_rec' [`s (Term.proj `hx "." (fieldIdx "1")) (Term.proj `hy "." (fieldIdx "1"))]) []]
     ")")
    (Term.paren "(" [(Term.app `Convex.combo_le_max [`x `y `ha `hb `hab]) []] ")")])
  []]
 ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `MonotoneOn.convex_lt [])
  (Command.declSig
   [(Term.explicitBinder "(" [`hf] [":" (Term.app `MonotoneOn [`f `s])] [] ")")
    (Term.explicitBinder "(" [`hs] [":" (Term.app `Convex [`𝕜 `s])] [] ")")
    (Term.explicitBinder "(" [`r] [":" `β] [] ")")]
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `MonotoneOn.convex_ge [])
  (Command.declSig
   [(Term.explicitBinder "(" [`hf] [":" (Term.app `MonotoneOn [`f `s])] [] ")")
    (Term.explicitBinder "(" [`hs] [":" (Term.app `Convex [`𝕜 `s])] [] ")")
    (Term.explicitBinder "(" [`r] [":" `β] [] ")")]
  ...
  (Command.declValSimple
   ":="
   (Term.app
    (Term.explicit "@" `MonotoneOn.convex_le)
    [`𝕜
     (Term.app `OrderDual [`E])
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `OrderDual [`E]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `MonotoneOn.convex_gt [])
  (Command.declSig
   [(Term.explicitBinder "(" [`hf] [":" (Term.app `MonotoneOn [`f `s])] [] ")")
    (Term.explicitBinder "(" [`hs] [":" (Term.app `Convex [`𝕜 `s])] [] ")")
    (Term.explicitBinder "(" [`r] [":" `β] [] ")")]
  ...
  (Command.declValSimple
   ":="
   (Term.app
    (Term.explicit "@" `MonotoneOn.convex_lt)
    [`𝕜
     (Term.app `OrderDual [`E])
     (Term.app `OrderDual [`β])
     (Term.hole "_")
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `AntitoneOn.convex_le [])
  (Command.declSig
   [(Term.explicitBinder "(" [`hf] [":" (Term.app `AntitoneOn [`f `s])] [] ")")
    (Term.explicitBinder "(" [`hs] [":" (Term.app `Convex [`𝕜 `s])] [] ")")
    (Term.explicitBinder "(" [`r] [":" `β] [] ")")]
   (Term.typeSpec
    ":"
  ...
  (Command.declValSimple
   ":="
   (Term.app
    (Term.explicit "@" `MonotoneOn.convex_ge)
    [`𝕜
     `E
     (Term.app `OrderDual [`β])
     (Term.hole "_")
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `AntitoneOn.convex_lt [])
  (Command.declSig
   [(Term.explicitBinder "(" [`hf] [":" (Term.app `AntitoneOn [`f `s])] [] ")")
    (Term.explicitBinder "(" [`hs] [":" (Term.app `Convex [`𝕜 `s])] [] ")")
    (Term.explicitBinder "(" [`r] [":" `β] [] ")")]
  ...
  (Command.declValSimple
   ":="
   (Term.app
    (Term.explicit "@" `MonotoneOn.convex_gt)
    [`𝕜
     `E
     (Term.app `OrderDual [`β])
     (Term.hole "_")
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `AntitoneOn.convex_ge [])
  (Command.declSig
   [(Term.explicitBinder "(" [`hf] [":" (Term.app `AntitoneOn [`f `s])] [] ")")
    (Term.explicitBinder "(" [`hs] [":" (Term.app `Convex [`𝕜 `s])] [] ")")
    (Term.explicitBinder "(" [`r] [":" `β] [] ")")]
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `AntitoneOn.convex_gt [])
  (Command.declSig
   [(Term.explicitBinder "(" [`hf] [":" (Term.app `AntitoneOn [`f `s])] [] ")")
    (Term.explicitBinder "(" [`hs] [":" (Term.app `Convex [`𝕜 `s])] [] ")")
    (Term.explicitBinder "(" [`r] [":" `β] [] ")")]
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `Monotone.convex_le [])
  (Command.declSig
   [(Term.explicitBinder "(" [`hf] [":" (Term.app `Monotone [`f])] [] ")")
    (Term.explicitBinder "(" [`r] [":" `β] [] ")")]
   (Term.typeSpec ":" (Term.app `Convex [`𝕜 (Set.«term{_|_}» "{" `x "|" («term_≤_» (Term.app `f [`x]) "≤" `r) "}")])))
  (Command.declValSimple
   ":="
   (Term.app
    (Term.proj `Set.sep_univ "." `subst)
    [(Term.app (Term.proj (Term.app `hf.monotone_on [`univ]) "." `convex_le) [`convex_univ `r])])
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `hf.monotone_on [`univ]) "." `convex_le)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `hf.monotone_on [`univ])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `hf.monotone_on [`univ]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app (Term.proj (Term.paren "(" [(Term.app `hf.monotone_on [`univ]) []] ")") "." `convex_le) [`convex_univ `r])
  []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj `Set.sep_univ "." `subst)
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `Monotone.convex_lt [])
  (Command.declSig
   [(Term.explicitBinder "(" [`hf] [":" (Term.app `Monotone [`f])] [] ")")
    (Term.explicitBinder "(" [`r] [":" `β] [] ")")]
   (Term.typeSpec ":" (Term.app `Convex [`𝕜 (Set.«term{_|_}» "{" `x "|" («term_≤_» (Term.app `f [`x]) "≤" `r) "}")])))
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `Monotone.convex_ge [])
  (Command.declSig
   [(Term.explicitBinder "(" [`hf] [":" (Term.app `Monotone [`f])] [] ")")
    (Term.explicitBinder "(" [`r] [":" `β] [] ")")]
   (Term.typeSpec ":" (Term.app `Convex [`𝕜 (Set.«term{_|_}» "{" `x "|" («term_≤_» `r "≤" (Term.app `f [`x])) "}")])))
  (Command.declValSimple
   ":="
   (Term.app
    (Term.proj `Set.sep_univ "." `subst)
    [(Term.app (Term.proj (Term.app `hf.monotone_on [`univ]) "." `convex_ge) [`convex_univ `r])])
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `hf.monotone_on [`univ]) "." `convex_ge)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `hf.monotone_on [`univ])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app (Term.proj (Term.paren "(" [(Term.app `hf.monotone_on [`univ]) []] ")") "." `convex_ge) [`convex_univ `r])
  []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj `Set.sep_univ "." `subst)
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `Monotone.convex_gt [])
  (Command.declSig
   [(Term.explicitBinder "(" [`hf] [":" (Term.app `Monotone [`f])] [] ")")
    (Term.explicitBinder "(" [`r] [":" `β] [] ")")]
   (Term.typeSpec ":" (Term.app `Convex [`𝕜 (Set.«term{_|_}» "{" `x "|" («term_≤_» (Term.app `f [`x]) "≤" `r) "}")])))
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `Antitone.convex_le [])
  (Command.declSig
   [(Term.explicitBinder "(" [`hf] [":" (Term.app `Antitone [`f])] [] ")")
    (Term.explicitBinder "(" [`r] [":" `β] [] ")")]
   (Term.typeSpec ":" (Term.app `Convex [`𝕜 (Set.«term{_|_}» "{" `x "|" («term_≤_» (Term.app `f [`x]) "≤" `r) "}")])))
  (Command.declValSimple
   ":="
   (Term.app
    (Term.proj `Set.sep_univ "." `subst)
    [(Term.app (Term.proj (Term.app `hf.antitone_on [`univ]) "." `convex_le) [`convex_univ `r])])
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `hf.antitone_on [`univ]) "." `convex_le)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `hf.antitone_on [`univ])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `hf.antitone_on [`univ]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app (Term.proj (Term.paren "(" [(Term.app `hf.antitone_on [`univ]) []] ")") "." `convex_le) [`convex_univ `r])
  []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj `Set.sep_univ "." `subst)
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `Antitone.convex_lt [])
  (Command.declSig
   [(Term.explicitBinder "(" [`hf] [":" (Term.app `Antitone [`f])] [] ")")
    (Term.explicitBinder "(" [`r] [":" `β] [] ")")]
   (Term.typeSpec ":" (Term.app `Convex [`𝕜 (Set.«term{_|_}» "{" `x "|" («term_<_» (Term.app `f [`x]) "<" `r) "}")])))
  (Command.declValSimple
   ...
   (Term.app
    (Term.proj `Set.sep_univ "." `subst)
    [(Term.app (Term.proj (Term.app `hf.antitone_on [`univ]) "." `convex_lt) [`convex_univ `r])])
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `hf.antitone_on [`univ]) "." `convex_lt)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `hf.antitone_on [`univ])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app (Term.proj (Term.paren "(" [(Term.app `hf.antitone_on [`univ]) []] ")") "." `convex_lt) [`convex_univ `r])
  []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj `Set.sep_univ "." `subst)
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `Antitone.convex_ge [])
  (Command.declSig
   [(Term.explicitBinder "(" [`hf] [":" (Term.app `Antitone [`f])] [] ")")
    (Term.explicitBinder "(" [`r] [":" `β] [] ")")]
   (Term.typeSpec ":" (Term.app `Convex [`𝕜 (Set.«term{_|_}» "{" `x "|" («term_≤_» `r "≤" (Term.app `f [`x])) "}")])))
  (Command.declValSimple
   ...
   (Term.app
    (Term.proj `Set.sep_univ "." `subst)
    [(Term.app (Term.proj (Term.app `hf.antitone_on [`univ]) "." `convex_ge) [`convex_univ `r])])
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `hf.antitone_on [`univ]) "." `convex_ge)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `hf.antitone_on [`univ])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app (Term.proj (Term.paren "(" [(Term.app `hf.antitone_on [`univ]) []] ")") "." `convex_ge) [`convex_univ `r])
  []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj `Set.sep_univ "." `subst)
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `Antitone.convex_gt [])
  (Command.declSig
   [(Term.explicitBinder "(" [`hf] [":" (Term.app `Antitone [`f])] [] ")")
    (Term.explicitBinder "(" [`r] [":" `β] [] ")")]
   (Term.typeSpec ":" (Term.app `Convex [`𝕜 (Set.«term{_|_}» "{" `x "|" («term_<_» `r "<" (Term.app `f [`x])) "}")])))
  (Command.declValSimple
   ...
   (Term.app
    (Term.proj `Set.sep_univ "." `subst)
    [(Term.app (Term.proj (Term.app `hf.antitone_on [`univ]) "." `convex_gt) [`convex_univ `r])])
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `hf.antitone_on [`univ]) "." `convex_gt)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `hf.antitone_on [`univ])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app (Term.proj (Term.paren "(" [(Term.app `hf.antitone_on [`univ]) []] ")") "." `convex_gt) [`convex_univ `r])
  []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj `Set.sep_univ "." `subst)
...
theorem Convex.combo_eq_vadd {a b : 𝕜} {x y : E} (h : (a+b) = 1) : ((a • x)+b • y) = (b • (y - x))+x :=
  calc ((a • x)+b • y) = (b • y - b • x)+(a • x)+b • x := by
    abel
    _ = (b • (y - x))+x := by
...
theorem convex_open_segment (a b : E) : Convex 𝕜 (OpenSegment 𝕜 a b) := by
  ...
  refine'
    ⟨(a*ap)+b*aq, (a*bp)+b*bq, add_pos (mul_pos ha hap) (mul_pos hb haq), add_pos (mul_pos ha hbp) (mul_pos hb hbq), _,
      _⟩
  ·
    rw [add_add_add_commₓ, ← mul_addₓ, ← mul_addₓ, habp, habq, mul_oneₓ, mul_oneₓ, hab]
  ·
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `StdSimplex [])
  (Command.optDeclSig [] [(Term.typeSpec ":" (Term.app `Set [(Term.arrow `ι "→" `𝕜)]))])
  (Command.declValSimple
   ":="
   (Set.«term{_|_}»
    "{"
    ...
    "|"
    («term_∧_»
     (Term.forall "∀" [(Term.simpleBinder [`x] [])] "," («term_≤_» (numLit "0") "≤" (Term.app `f [`x])))
     "∧"
     («term_=_»
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `std_simplex_eq_inter [])
  (Command.declSig
   []
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app `StdSimplex [`𝕜 `ι])
     "="
     (Init.Core.«term_∩_»
      (Set.Data.Set.Lattice.«term⋂_,_»
       "⋂"
       (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `x)] []))
       ", "
       (Set.«term{_|_}» "{" `f "|" («term_≤_» (numLit "0") "≤" (Term.app `f [`x])) "}"))
      " ∩ "
      (Set.«term{_|_}»
       "{"
       `f
