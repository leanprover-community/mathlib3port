  ...
  (Command.declSig
   [(Term.explicitBinder
    ...
    (Term.explicitBinder
     "("
     [`huv]
     [":" (Term.app `tendsto [(«term_/_» `u "/" `v) `l (Term.app (Topology.Basic.term𝓝 "𝓝") [(numLit "1")])])]
     []
     ")")]
   (Term.typeSpec ":" (Asymptotics.Analysis.Asymptotics.AsymptoticEquivalent.«term_~[_]_» `u " ~[" `l "] " `v)))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, [anonymous]))
  (Asymptotics.Analysis.Asymptotics.AsymptoticEquivalent.«term_~[_]_» `u " ~[" `l "] " `v)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Asymptotics.Analysis.Asymptotics.AsymptoticEquivalent.«term_~[_]_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `v
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(«term_/_» `u "/" `v) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `tendsto
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
   ...
   `l
   ", "
   (Term.arrow («term_=_» (Term.app `v [`x]) "=" (numLit "0")) "→" («term_=_» (Term.app `u [`x]) "=" (numLit "0"))))
                  ...
                  (Term.app
                   ...
                   [(Term.fun
                     ...
                     (Term.basicFun
                      [(Term.simpleBinder [`x] [])]
                      "=>"
                      («term_/_» (Term.app `v [`x]) "/" (Term.app `v [`x]))))
                    `l
                    (Term.app (Topology.Basic.term𝓝 "𝓝") [(numLit "1")])]))]
                ":="
                (Term.byTactic
         ...
         (Term.haveIdDecl
          ...
          [(Term.typeSpec
            ...
            (Term.app
             ...
             [(Term.fun
               "fun"
               (Term.basicFun [(Term.simpleBinder [`x] [])] "=>" («term_/_» (Term.app `v [`x]) "/" (Term.app `v [`x]))))
              `l
              (Term.app (Topology.Basic.term𝓝 "𝓝") [(numLit "1")])]))]
          ":="
          (Term.byTactic
...
theorem is_equivalent.smul {α E 𝕜 : Type _} [NormedField 𝕜] [NormedGroup E] [NormedSpace 𝕜 E] {a b : α → 𝕜}
  ...
  calc ∥((fun x : α => φ x • u x) - v) x∥ = ∥((φ x - 1) • u x)+u x - v x∥ := by
    simp [sub_smul, sub_add]_ ≤ ∥(φ x - 1) • u x∥+∥u x - v x∥ := norm_add_le _ _ _ = (∥φ x - 1∥*∥u x∥)+∥u x - v x∥ := by
