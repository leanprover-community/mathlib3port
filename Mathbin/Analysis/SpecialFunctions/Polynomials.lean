...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `eventually_no_roots [])
  (Command.declSig
   [(Term.explicitBinder "(" [`hP] [":" («term_≠_» `P "≠" (numLit "0"))] [] ")")]
   (Term.typeSpec
    ":"
        ...
        (Tactic.obtain
         ...
         [(Tactic.rcasesPatMed
           [(Tactic.rcasesPat.tuple
             ...
             "⟩")])]
         []
         [":=" [(Term.app `exists_max_root [`P `hP])]])
        [])
       (group
        (Tactic.refine'
         "refine'"
         (Term.app
          `filter.eventually_at_top.mpr
          [(Term.anonymousCtor
            "⟨"
            [(Init.Logic.«term_+_» `x₀ "+" (numLit "1"))
             ","
             (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`x `hx `h] [])] "=>" (Term.hole "_")))]
            "⟩")]))
        [])
       (group
        (Tactic.exact
         ...
         (Term.app
          `absurd
          [(Term.app `hx₀ [`x `h])
           (Term.app `not_le.mpr [(Term.app `lt_of_lt_of_leₓ [(Term.app `lt_add_one [`x₀]) `hx])])]))
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact
   ...
   (Term.app
    `absurd
    [(Term.app `hx₀ [`x `h]) (Term.app `not_le.mpr [(Term.app `lt_of_lt_of_leₓ [(Term.app `lt_add_one [`x₀]) `hx])])]))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `lt_of_lt_of_leₓ [(Term.app `lt_add_one [`x₀]) `hx])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `lt_add_one [`x₀]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `lt_of_lt_of_leₓ
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `lt_of_lt_of_leₓ [(Term.paren "(" [(Term.app `lt_add_one [`x₀]) []] ")") `hx]) []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `not_le.mpr
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(Term.app
   `not_le.mpr
   [(Term.paren "(" [(Term.app `lt_of_lt_of_leₓ [(Term.paren "(" [(Term.app `lt_add_one [`x₀]) []] ")") `hx]) []] ")")])
  []]
 ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `hx₀ [`x `h]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `absurd
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
theorem
  eventually_no_roots
  ( hP : P ≠ 0 ) : ∀ᶠ x in Filter.atTop , ¬ P.is_root x
  :=
    by
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `is_O_of_degree_le [])
  (Command.declSig
   [(Term.explicitBinder "(" [`h] [":" («term_≤_» `P.degree "≤" `Q.degree)] [] ")")]
   (Term.typeSpec
    ":"
    (Term.app
     `is_O
     [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`x] [])] "=>" (Term.app `eval [`x `P])))
      (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`x] [])] "=>" (Term.app `eval [`x `Q])))
      `Filter.atTop])))
  (Command.declValSimple
   ":="
   (Term.byTactic
             ...
             (Tactic.tacticHave_
              ...
              (Term.haveDecl
               (Term.haveIdDecl
                ...
                ":="
                (Term.app `ne_zero_of_degree_ge_degree [`h `hp]))))
             [])
            (group
             (Tactic.tacticHave_
              "have"
              (Term.haveDecl
               (Term.haveIdDecl
                ...
                [(Term.typeSpec
                  ...
                  (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
                   "∀ᶠ"
                   (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `x)] [":" `𝕜]))
                   " in "
                   `at_top
                   ", "
                   (Term.arrow
                    («term_=_» (Term.app `eval [`x `Q]) "=" (numLit "0"))
                    "→"
                    («term_=_» (Term.app `eval [`x `P]) "=" (numLit "0")))))]
                ":="
                (Term.app
                 `Filter.mem_of_superset
                 [(Term.app `Polynomial.eventually_no_roots [`Q `hq])
                  (Term.fun
                   "fun"
                   (Term.basicFun [(Term.simpleBinder [`x `h `h'] [])] "=>" (Term.app `absurd [`h' `h])))]))))
             [])
            (group
             (Tactic.cases'
              "cases'"
              [(Tactic.casesTarget [] (Term.app `le_iff_lt_or_eq.mp [`h]))]
              []
                ...
                [(group
                  (Tactic.exact
                   ...
                   (Term.app
                    ...
                    [`hPQ (numLit "0") (Term.app `div_tendsto_zero_of_degree_lt [`P `Q `h])]))
                  [])])))
             [])
            (group
             (Tactic.«tactic·._»
               ...
               (Tactic.tacticSeq1Indented
                [(group
                  (Tactic.exact
                   ...
                   (Term.app
                    `is_O_of_div_tendsto_nhds
                    [`hPQ (Term.hole "_") (Term.app `div_tendsto_leading_coeff_div_of_degree_eq [`P `Q `h])]))
                  [])])))
             [])])))
        [])])))
   [])
        ...
        (Term.haveDecl
         (Term.haveIdDecl
          ...
          (Term.app
           `Filter.mem_of_superset
           [(Term.app `Polynomial.eventually_no_roots [`Q `hq])
            (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`x `h `h'] [])] "=>" (Term.app `absurd [`h' `h])))]))))
       [])
      (group
       (Tactic.cases'
        "cases'"
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `div_tendsto_leading_coeff_div_of_degree_eq [`P `Q `h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
   ...
   (Tactic.tacticSeq
    (Tactic.tacticSeq1Indented
     [(group
       (Tactic.exact
        "exact"
        (Term.app `is_O_of_div_tendsto_nhds [`hPQ (numLit "0") (Term.app `div_tendsto_zero_of_degree_lt [`P `Q `h])]))
       [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.«tactic·._»', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq', expected 'Lean.Parser.Tactic.tacticSeq.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq1Indented', expected 'Lean.Parser.Tactic.tacticSeqBracketed.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `div_tendsto_zero_of_degree_lt [`P `Q `h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
theorem
  is_O_of_degree_le
  ( h : P.degree ≤ Q.degree ) : is_O fun x => eval x P fun x => eval x Q Filter.atTop
  :=
    by
      by_cases' hp : P = 0
        ...
        ·
          have hq : Q ≠ 0 := ne_zero_of_degree_ge_degree h hp
            have
              hPQ
                : ∀ᶠ x : 𝕜 in at_top , eval x Q = 0 → eval x P = 0
                :=
