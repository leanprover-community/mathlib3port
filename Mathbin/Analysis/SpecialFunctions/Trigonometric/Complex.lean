...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  ...
  (Command.declValSimple
   ":="
   («term_$__»
    (Term.app (Term.proj `continuous_on_sin "." `div) [`continuous_on_cos])
    "$"
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj `continuous_on_sin "." `div)
...
-- ././Mathport/Syntax/Translate/Basic.lean:477:2: warning: expanding binder collection (w «expr ≠ » 0)
