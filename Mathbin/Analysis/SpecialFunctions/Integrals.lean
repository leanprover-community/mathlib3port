...
theorem interval_integrable_zpow {n : ℤ}
    (h : 0 ≤ n ∨ (0 : ℝ) ∉ "././Mathport/Syntax/Translate/Basic.lean:815:47: unsupported (impossible)") :
...
theorem interval_integrable_rpow {r : ℝ}
    (h : 0 ≤ r ∨ (0 : ℝ) ∉ "././Mathport/Syntax/Translate/Basic.lean:815:47: unsupported (impossible)") :
...
theorem interval_integrable_one_div
    (h : ∀ x : ℝ, x ∈ "././Mathport/Syntax/Translate/Basic.lean:815:47: unsupported (impossible)" → f x ≠ 0)
...
theorem interval_integrable_log
    (h : (0 : ℝ) ∉ "././Mathport/Syntax/Translate/Basic.lean:815:47: unsupported (impossible)") :
...
theorem integral_rpow {r : ℝ}
    (h : 0 ≤ r ∨ r ≠ -1 ∧ (0 : ℝ) ∉ "././Mathport/Syntax/Translate/Basic.lean:815:47: unsupported (impossible)") :
    (∫ x in a..b, x ^ r) = (b ^ (r + 1) - a ^ (r + 1)) / (r + 1) := by
  suffices
    ∀,
      ∀ x ∈ "././Mathport/Syntax/Translate/Basic.lean:815:47: unsupported (impossible)",
  ...
  intro x hx
  have hx' : x ≠ 0 ∨ 1 ≤ r + 1 := h.symm.imp (fun h => ne_of_mem_of_not_mem hx h.2) (le_add_iff_nonneg_left _).2
...
theorem integral_zpow {n : ℤ}
    (h : 0 ≤ n ∨ n ≠ -1 ∧ (0 : ℝ) ∉ "././Mathport/Syntax/Translate/Basic.lean:815:47: unsupported (impossible)") :
    (∫ x in a..b, x ^ n) = (b ^ (n + 1) - a ^ (n + 1)) / (n + 1) := by
  replace h :
    0 ≤ (n : ℝ) ∨ (n : ℝ) ≠ -1 ∧ (0 : ℝ) ∉ "././Mathport/Syntax/Translate/Basic.lean:815:47: unsupported (impossible)"
  · exact_mod_cast h
...
-- ././Mathport/Syntax/Translate/Basic.lean:815:47: unsupported (impossible)
@[simp]
theorem integral_inv (h : (0 : ℝ) ∉ "././Mathport/Syntax/Translate/Basic.lean:815:47: unsupported (impossible)") :
...
-- ././Mathport/Syntax/Translate/Basic.lean:815:47: unsupported (impossible)
theorem integral_one_div (h : (0 : ℝ) ∉ "././Mathport/Syntax/Translate/Basic.lean:815:47: unsupported (impossible)") :
...
-- ././Mathport/Syntax/Translate/Basic.lean:815:47: unsupported (impossible)
@[simp]
theorem integral_log (h : (0 : ℝ) ∉ "././Mathport/Syntax/Translate/Basic.lean:815:47: unsupported (impossible)") :
...
theorem integral_sin_pow_aux :
  ...
  have h : ∀ α β γ : ℝ, α * (β * α * γ) = β * (α * α * γ) := fun α β γ => by
    ring
  have hu : ∀, ∀ x ∈ _, ∀, HasDerivAt (fun y => sin y ^ (n + 1)) ((n + 1) * cos x * sin x ^ n) x := fun x hx => by
...
theorem integral_cos_pow_aux :
  ...
  have h : ∀ α β γ : ℝ, α * (β * α * γ) = β * (α * α * γ) := fun α β γ => by
    ring
  have hu : ∀, ∀ x ∈ _, ∀, HasDerivAt (fun y => cos y ^ (n + 1)) (-(n + 1) * sin x * cos x ^ n) x := fun x hx => by
    simpa only [mul_right_commₓ, neg_mul, mul_neg] using (has_deriv_at_cos x).pow
  have hv :
    ∀, ∀ x ∈ "././Mathport/Syntax/Translate/Basic.lean:815:47: unsupported (impossible)", ∀, HasDerivAt sin (cos x) x :=
