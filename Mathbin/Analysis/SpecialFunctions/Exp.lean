...
but is expected to have type
  forall {α : Type.{u1}} {l : Filter.{u1} α} {f : α -> Real} {g : α -> Real}, Iff (Asymptotics.IsBigO.{u1, 0, 0} α Real Real Real.norm Real.norm l (fun (x : α) => Real.exp (f x)) (fun (x : α) => Real.exp (g x))) (Filter.IsBoundedUnder.{0, u1} Real α (fun (x._@.Mathlib.Analysis.SpecialFunctions.Exp._hyg.3651 : Real) (x._@.Mathlib.Analysis.SpecialFunctions.Exp._hyg.3653 : Real) => LE.le.{0} Real Real.instLEReal x._@.Mathlib.Analysis.SpecialFunctions.Exp._hyg.3651 x._@.Mathlib.Analysis.SpecialFunctions.Exp._hyg.3653) l (HSub.hSub.{u1, u1, u1} (α -> Real) (α -> Real) (α -> Real) (instHSub.{u1} (α -> Real) (Pi.instSub.{u1, 0} α (fun (ᾰ : α) => Real) (fun (i : α) => Real.instSubReal))) f g))
...
but is expected to have type
  forall {α : Type.{u1}} {l : Filter.{u1} α} {f : α -> Real} {g : α -> Real}, Iff (Asymptotics.IsTheta.{u1, 0, 0} α Real Real Real.norm Real.norm l (fun (x : α) => Real.exp (f x)) (fun (x : α) => Real.exp (g x))) (Filter.IsBoundedUnder.{0, u1} Real α (fun (x._@.Mathlib.Analysis.SpecialFunctions.Exp._hyg.3750 : Real) (x._@.Mathlib.Analysis.SpecialFunctions.Exp._hyg.3752 : Real) => LE.le.{0} Real Real.instLEReal x._@.Mathlib.Analysis.SpecialFunctions.Exp._hyg.3750 x._@.Mathlib.Analysis.SpecialFunctions.Exp._hyg.3752) l (fun (x : α) => Abs.abs.{0} Real (Neg.toHasAbs.{0} Real Real.instNegReal Real.instSupReal) (HSub.hSub.{0, 0, 0} Real Real Real (instHSub.{0} Real Real.instSubReal) (f x) (g x))))
...
but is expected to have type
  forall {α : Type.{u1}} {l : Filter.{u1} α} {f : α -> Real}, Iff (Asymptotics.IsBigO.{u1, 0, 0} α Real Real Real.norm Real.norm l (fun (x : α) => OfNat.ofNat.{0} Real 1 (One.toOfNat1.{0} Real Real.instOneReal)) (fun (x : α) => Real.exp (f x))) (Filter.IsBoundedUnder.{0, u1} Real α (fun (x._@.Mathlib.Analysis.SpecialFunctions.Exp._hyg.3964 : Real) (x._@.Mathlib.Analysis.SpecialFunctions.Exp._hyg.3966 : Real) => GE.ge.{0} Real Real.instLEReal x._@.Mathlib.Analysis.SpecialFunctions.Exp._hyg.3964 x._@.Mathlib.Analysis.SpecialFunctions.Exp._hyg.3966) l f)
...
but is expected to have type
  forall {α : Type.{u1}} {l : Filter.{u1} α} {f : α -> Real}, Iff (Asymptotics.IsBigO.{u1, 0, 0} α Real Real Real.norm Real.norm l (fun (x : α) => Real.exp (f x)) (fun (x : α) => OfNat.ofNat.{0} Real 1 (One.toOfNat1.{0} Real Real.instOneReal))) (Filter.IsBoundedUnder.{0, u1} Real α (fun (x._@.Mathlib.Analysis.SpecialFunctions.Exp._hyg.4040 : Real) (x._@.Mathlib.Analysis.SpecialFunctions.Exp._hyg.4042 : Real) => LE.le.{0} Real Real.instLEReal x._@.Mathlib.Analysis.SpecialFunctions.Exp._hyg.4040 x._@.Mathlib.Analysis.SpecialFunctions.Exp._hyg.4042) l f)
...
but is expected to have type
  forall {α : Type.{u1}} {l : Filter.{u1} α} {f : α -> Real}, Iff (Asymptotics.IsTheta.{u1, 0, 0} α Real Real Real.norm Real.norm l (fun (x : α) => Real.exp (f x)) (fun (x : α) => OfNat.ofNat.{0} Real 1 (One.toOfNat1.{0} Real Real.instOneReal))) (Filter.IsBoundedUnder.{0, u1} Real α (fun (x._@.Mathlib.Analysis.SpecialFunctions.Exp._hyg.4116 : Real) (x._@.Mathlib.Analysis.SpecialFunctions.Exp._hyg.4118 : Real) => LE.le.{0} Real Real.instLEReal x._@.Mathlib.Analysis.SpecialFunctions.Exp._hyg.4116 x._@.Mathlib.Analysis.SpecialFunctions.Exp._hyg.4118) l (fun (x : α) => Abs.abs.{0} Real (Neg.toHasAbs.{0} Real Real.instNegReal Real.instSupReal) (f x)))
