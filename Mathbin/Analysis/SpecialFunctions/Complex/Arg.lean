...
theorem arg_mul_cos_add_sin_mul_I {r : ℝ} (hr : 0 < r) {θ : ℝ} (hθ : θ ∈ Ioc (-π) π) : arg (r*cos θ+sin θ*I) = θ := by
  have hπ := Real.pi_pos
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `arg_eq_nhds_of_re_neg_of_im_pos [])
  (Command.declSig
   [(Term.explicitBinder "(" [`hx_re] [":" («term_<_» `x.re "<" (numLit "0"))] [] ")")
    (Term.explicitBinder "(" [`hx_im] [":" («term_<_» (numLit "0") "<" `x.im)] [] ")")]
   (Term.typeSpec
    ":"
    (Filter.Order.Filter.Basic.«term_=ᶠ[_]_»
     ...
     (Term.fun
      ...
      (Term.basicFun
       ...
       "=>"
       (Init.Logic.«term_+_»
        (Term.app `Real.arcsin [(«term_/_» (Term.proj («term-_» "-" `x) "." `im) "/" `x.abs)])
        "+"
         ...
         [(Term.typeSpec
           ...
           (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
            ...
            (Lean.explicitBinders
             (Lean.unbracketedExplicitBinders [(Lean.binderIdent `y)] [":" (Data.Complex.Basic.termℂ "ℂ")]))
            " in "
            (Term.app (Topology.Basic.term𝓝 "𝓝") [`x])
            ", "
            («term_∧_» («term_<_» `y.re "<" (numLit "0")) "∧" («term_<_» (numLit "0") "<" `y.im))))])
        [])
       (group
        (Tactic.exact
         "exact"
          ...
          [(Term.fun
            ...
            (Term.basicFun
             ...
             (Term.app
              ...
              [(Term.proj `hy "." (fieldIdx "1")) (Term.proj (Term.proj `hy "." (fieldIdx "2")) "." `le)])))]))
        [])
       (group
        (Tactic.refine'
         "refine'"
         (Term.app
          ...
          [(Term.hole "_")
           (Term.paren
            "("
            [(Term.anonymousCtor "⟨" [`hx_re "," `hx_im] "⟩")
             [(Term.typeAscription
               ":"
               («term_∧_» («term_<_» `x.re "<" (numLit "0")) "∧" («term_<_» (numLit "0") "<" `x.im)))]]
            ")")]))
        [])
       (group
        (Tactic.exact
         ...
         (Term.app
          `IsOpen.and
          [(Term.app `is_open_lt [`continuous_re `continuous_zero])
           (Term.app `is_open_lt [`continuous_zero `continuous_im])]))
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app
   `IsOpen.and
   [(Term.app `is_open_lt [`continuous_re `continuous_zero]) (Term.app `is_open_lt [`continuous_zero `continuous_im])])
  ...
  (Term.app
   ...
   [(Term.hole "_")
    (Term.paren
     "("
     [(Term.anonymousCtor "⟨" [`hx_re "," `hx_im] "⟩")
      [(Term.typeAscription ":" («term_∧_» («term_<_» `x.re "<" (numLit "0")) "∧" («term_<_» (numLit "0") "<" `x.im)))]]
     ")")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
   "∀ᶠ"
   (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `y)] [":" (Data.Complex.Basic.termℂ "ℂ")]))
   " in "
   (Term.app (Topology.Basic.term𝓝 "𝓝") [`x])
   ", "
   («term_∧_» («term_<_» `y.re "<" (numLit "0")) "∧" («term_<_» (numLit "0") "<" `y.im)))
...
theorem
  ...
  ( hx_re : x.re < 0 ) ( hx_im : 0 < x.im ) : arg =ᶠ[ 𝓝 x ] fun x => Real.arcsin - x . im / x.abs + π
  :=
    by
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `arg_eq_nhds_of_re_neg_of_im_neg [])
  (Command.declSig
   [(Term.explicitBinder "(" [`hx_re] [":" («term_<_» `x.re "<" (numLit "0"))] [] ")")
    (Term.explicitBinder "(" [`hx_im] [":" («term_<_» `x.im "<" (numLit "0"))] [] ")")]
   (Term.typeSpec
    ":"
    (Filter.Order.Filter.Basic.«term_=ᶠ[_]_»
     `arg
        ...
        (Tactic.suffices'
         ...
         [(Term.typeSpec
           ...
           (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
            ...
            (Term.app (Topology.Basic.term𝓝 "𝓝") [`x])
            ", "
            («term_∧_» («term_<_» `y.re "<" (numLit "0")) "∧" («term_<_» `y.im "<" (numLit "0")))))])
        [])
       (group
        (Tactic.exact
         "exact"
          ...
          [(Term.hole "_")
           (Term.paren
            ...
            [(Term.anonymousCtor "⟨" [`hx_re "," `hx_im] "⟩")
             [(Term.typeAscription
               ":"
               («term_∧_» («term_<_» `x.re "<" (numLit "0")) "∧" («term_<_» `x.im "<" (numLit "0"))))]]
            ")")]))
        [])
       (group
        (Tactic.exact
         ...
         (Term.app
          `IsOpen.and
          [(Term.app `is_open_lt [`continuous_re `continuous_zero])
           (Term.app `is_open_lt [`continuous_im `continuous_zero])]))
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app
   `IsOpen.and
   [(Term.app `is_open_lt [`continuous_re `continuous_zero]) (Term.app `is_open_lt [`continuous_im `continuous_zero])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
  ...
  (Term.app
   ...
   [(Term.hole "_")
    (Term.paren
     "("
     [(Term.anonymousCtor "⟨" [`hx_re "," `hx_im] "⟩")
      [(Term.typeAscription ":" («term_∧_» («term_<_» `x.re "<" (numLit "0")) "∧" («term_<_» `x.im "<" (numLit "0"))))]]
     ")")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.paren', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.paren', expected 'Lean.Parser.Term.namedArgument.antiquot'
   ...
   (Term.app
    ...
    [(Term.fun
      ...
      (Term.basicFun
       [(Term.simpleBinder [`y `hy] [])]
       "=>"
       (Term.app `arg_of_re_neg_of_im_neg [(Term.proj `hy "." (fieldIdx "1")) (Term.proj `hy "." (fieldIdx "2"))])))]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app
   `h_forall_nhds.mono
...
theorem
  ...
  ( hx_re : x.re < 0 ) ( hx_im : x.im < 0 ) : arg =ᶠ[ 𝓝 x ] fun x => Real.arcsin - x . im / x.abs - π
  :=
    by
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `tendsto_arg_nhds_within_im_neg_of_re_neg_of_im_zero [])
  (Command.declSig
   [(Term.implicitBinder "{" [`z] [":" (Data.Complex.Basic.termℂ "ℂ")] "}")
    (Term.explicitBinder "(" [`hre] [":" («term_<_» `z.re "<" (numLit "0"))] [] ")")
    (Term.explicitBinder "(" [`him] [":" («term_=_» `z.im "=" (numLit "0"))] [] ")")]
   (Term.typeSpec
    ":"
    (Term.app
     `tendsto
     [`arg
      (Topology.Basic.«term𝓝[_]_»
       ...
       (Set.«term{_|_}»
        "{"
        (Mathlib.ExtendedBinder.extBinder `z [":" (Data.Complex.Basic.termℂ "ℂ")])
        "|"
        («term_<_» `z.im "<" (numLit "0"))
        "}")
       "] "
       `z)
      (Term.app
       (Topology.Basic.term𝓝 "𝓝")
       [(«term-_» "-" (Real.Analysis.SpecialFunctions.Trigonometric.Basic.termπ "π"))])])))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
      ...
      [(group
       ...
       (group
        (Tactic.«tactic·._»
         ...
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group (Tactic.refine' "refine'" (Term.app `H.congr' [(Term.hole "_")])) [])
            (group
             (Tactic.have''
              "have"
              []
              [(Term.typeSpec
                ...
                (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
                 ...
                 («term_<_» `x.re "<" (numLit "0"))))])
             [])
            (group (Tactic.exact "exact" (Term.app `continuous_re.tendsto [`z (Term.app `gt_mem_nhds [`hre])])) [])
            (group
             (Tactic.filterUpwards
              "filter_upwards"
              "["
              [`self_mem_nhds_within "," (Term.app `mem_nhds_within_of_mem_nhds [`this])]
              "]"
              [])
             [])
            (group (Tactic.intro "intro" [`w `him `hre]) [])
            (group
             (Tactic.rwSeq
              "rw"
              []
              (Tactic.rwRuleSeq
               ...
               [(Tactic.rwRule [] `arg)
                ","
                (Tactic.rwRule [] (Term.app `if_neg [`hre.not_le]))
                ","
                (Tactic.rwRule [] (Term.app `if_neg [`him.not_le]))]
               "]")
              [])
             [])])))
        [])
         ...
         (Term.app
          (Term.proj
           (Term.app
            ...
            [(Term.app
              (Term.proj
               (Term.app `continuous_im.continuous_at.comp_continuous_within_at [`continuous_within_at_neg])
               "."
               `div)
              [`continuous_abs.continuous_within_at (Term.hole "_")])])
           "."
           `sub)
          [`tendsto_const_nhds])
         [])
       ...
       (group
        (Tactic.«tactic·._»
         ...
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group (Tactic.simp "simp" [] [] ["[" [(Tactic.simpLemma [] [] `him)] "]"] []) [])])))
        [])
       (group
        (Tactic.«tactic·._»
         "·"
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group (Tactic.lift "lift" `z "to" (Data.Real.Basic.termℝ "ℝ") ["using" `him] []) [])
            (group (Tactic.simpa "simpa" [] [] [] [] ["using" `hre.ne]) [])])))
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.simpa "simpa" [] [] [] [] ["using" `hre.ne])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.lift "lift" `z "to" (Data.Real.Basic.termℝ "ℝ") ["using" `him] [])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.«tactic·._»
   "·"
   (Tactic.tacticSeq
    (Tactic.tacticSeq1Indented [(group (Tactic.simp "simp" [] [] ["[" [(Tactic.simpLemma [] [] `him)] "]"] []) [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.«tactic·._»', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq', expected 'Lean.Parser.Tactic.tacticSeq.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq1Indented', expected 'Lean.Parser.Tactic.tacticSeqBracketed.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq1Indented', expected 'Lean.Parser.Tactic.tacticSeqBracketed'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.simp "simp" [] [] ["[" [(Tactic.simpLemma [] [] `him)] "]"] [])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj
   (Term.app
    `real.continuous_at_arcsin.comp_continuous_within_at
    [(Term.app
      (Term.proj (Term.app `continuous_im.continuous_at.comp_continuous_within_at [`continuous_within_at_neg]) "." `div)
      [`continuous_abs.continuous_within_at (Term.hole "_")])])
   "."
   `sub)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, term))
  `continuous_abs.continuous_within_at
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (some 1023, term)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `continuous_im.continuous_at.comp_continuous_within_at
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `mem_nhds_within_of_mem_nhds [`this])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.exact "exact" (Term.app `continuous_re.tendsto [`z (Term.app `gt_mem_nhds [`hre])]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `continuous_re.tendsto [`z (Term.app `gt_mem_nhds [`hre])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `gt_mem_nhds [`hre]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
theorem
  ...
  { z : ℂ } ( hre : z.re < 0 ) ( him : z.im = 0 ) : tendsto arg 𝓝[ { z : ℂ | z.im < 0 } ] z 𝓝 - π
  :=
    by
        ...
        convert
          real.continuous_at_arcsin.comp_continuous_within_at
                continuous_im.continuous_at.comp_continuous_within_at continuous_within_at_neg . div
                  continuous_abs.continuous_within_at _
              .
              sub
            tendsto_const_nhds
        · simp [ him ]
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `continuous_within_at_arg_of_re_neg_of_im_zero [])
  (Command.declSig
   [(Term.implicitBinder "{" [`z] [":" (Data.Complex.Basic.termℂ "ℂ")] "}")
    (Term.explicitBinder "(" [`hre] [":" («term_<_» `z.re "<" (numLit "0"))] [] ")")
    (Term.explicitBinder "(" [`him] [":" («term_=_» `z.im "=" (numLit "0"))] [] ")")]
     ...
     (Tactic.tacticSeq1Indented
      [(group
                ...
                (Tactic.rwSeq
                 ...
                 (Tactic.rwRuleSeq
                  ...
                  [(Tactic.rwRule [] `arg)
                   ...
                   (Tactic.rwRule [] (Term.app `if_neg [`hre.not_le]))
                   ","
                   (Tactic.rwRule [] (Term.app `if_pos [`him]))]
                  "]")
                 [])
                [])]))))))
        [])
       (group
        (Tactic.refine'
         "refine'"
         (Term.app `ContinuousWithinAt.congr_of_eventually_eq [(Term.hole "_") `this (Term.hole "_")]))
        [])
       (group
        (Tactic.«tactic·._»
         "·"
             ...
             (Tactic.rwSeq
              ...
              (Tactic.rwRuleSeq
               ...
               [(Tactic.rwRule [] `arg)
                ...
                (Tactic.rwRule [] (Term.app `if_neg [`hre.not_le]))
                ","
                (Tactic.rwRule [] (Term.app `if_pos [`him.ge]))]
               "]")
              [])
             [])])))
        [])])))
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `ContinuousWithinAt.congr_of_eventually_eq
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
...
theorem
  ...
  { z : ℂ } ( hre : z.re < 0 ) ( him : z.im = 0 ) : ContinuousWithinAt arg { z : ℂ | 0 ≤ z.im } z
  :=
    by
      have
          : arg =ᶠ[ 𝓝[ { z : ℂ | 0 ≤ z.im } ] z ] fun x => Real.arcsin - x . im / x.abs + π
            :=
            by
              have : ∀ᶠ x : ℂ in 𝓝 z , x.re < 0
                exact continuous_re.tendsto z gt_mem_nhds hre
