...
#align is_max_filter.norm_add_same_ray IsMaxFilter.norm_add_same_ray
...
#align is_max_on.norm_add_same_ray IsMaxOn.norm_add_same_ray
...
theorem IsLocalMaxOn.norm_add_same_ray (h : IsLocalMaxOn (norm ∘ f) s c) (hy : SameRay ℝ (f c) y) :
  ...
  h.norm_add_same_ray hy
#align is_local_max_on.norm_add_same_ray IsLocalMaxOn.norm_add_same_ray
...
theorem IsLocalMax.norm_add_same_ray (h : IsLocalMax (norm ∘ f) c) (hy : SameRay ℝ (f c) y) :
  ...
  h.norm_add_same_ray hy
#align is_local_max.norm_add_same_ray IsLocalMax.norm_add_same_ray
