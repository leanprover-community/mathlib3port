...
def ofHomothety (f : E ≃ₛₗ[σ₁₂] F) (a : ℝ) (ha : 0 < a) (hf : ∀ x, ‖f x‖ = a * ‖x‖) : E ≃SL[σ₁₂] F
    where
  toLinearEquiv := f
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `op_norm_extend_le [])
      (Command.declSig
       []
       (Term.typeSpec
        ":"
        («term_≤_»
         (Analysis.Normed.Group.Basic.«term‖_‖»
          "‖"
          (ContinuousLinearMap.Analysis.NormedSpace.OperatorNorm.termψ "ψ")
          "‖")
         "≤"
         («term_*_» `N "*" (Analysis.Normed.Group.Basic.«term‖_‖» "‖" `f "‖")))))
         ...
         (Tactic.tacticSeq1Indented
          [(Tactic.tacticHave_
            ...
            (Term.haveDecl
             (Term.haveIdDecl
              [`uni []]
              [(Term.typeSpec ":" (Term.app `UniformInducing [`e]))]
              ":="
              (Term.proj
               (Term.app `uniform_embedding_of_bound [(Term.hole "_") `h_e])
               "."
               `to_uniform_inducing))))
           []
           (Tactic.tacticHave_
              ...
              [(Term.typeSpec
                ...
                (Term.forall
                 ...
                 («term_=_»
                  ...
                  (Term.app `f [`x]))))]
              ":="
              (Term.app `uniformly_extend_of_ind [`uni `h_dense `f.uniform_continuous]))))
           []
           (Classical.«tacticBy_cases_:_» "by_cases" [`N0 ":"] («term_≤_» (num "0") "≤" `N))
           []
           (tactic__
            ...
            [(Tactic.refine'
              ...
              (Term.app
               ...
               [(ContinuousLinearMap.Analysis.NormedSpace.OperatorNorm.termψ "ψ")
                ...
                (Term.app
                 `is_closed_property
                 [`h_dense
                  (Term.app `is_closed_le [(Term.hole "_") (Term.hole "_")])
                  (Term.hole "_")])]))
             []
             (tactic__
              (cdotTk (patternIgnore (token.«· » "·")))
              [(Tactic.exact
                "exact"
                (Term.app `mul_nonneg [`N0 (Term.app `norm_nonneg [(Term.hole "_")])]))])
             []
             (tactic__
              (cdotTk (patternIgnore (token.«· » "·")))
              [(Tactic.exact
             ...
             (tactic__
              (cdotTk (patternIgnore (token.«· » "·")))
              [(Tactic.exact "exact" (Term.app `continuous_const.mul [`continuous_norm]))])
             []
             (tactic__
              (cdotTk (patternIgnore (token.«· » "·")))
               ...
               (calcTactic
                ...
                [(calcStep
                  ...
                  (Term.app
                   ...
                   [(Term.app `h_e [`x]) (Term.app `norm_nonneg [(Term.hole "_")])]))
                 (calcStep
                  («term_≤_»
                   (Term.hole "_")
                   "≤"
            ...
            [(Tactic.tacticHave_
              ...
              (Term.haveDecl
               (Term.haveIdDecl
                ...
                [(Term.typeSpec
                  ":"
                  (Term.forall "∀" [`x] [(Term.typeSpec ":" `E)] "," («term_=_» `x "=" (num "0"))))]
                ":="
                (Term.byTactic
                 "by"
                 (Tactic.tacticSeq
                    ...
                    (Tactic.tacticHave_
                     ...
                     (Term.haveDecl
                      (Term.haveIdDecl
                       ...
                       ":="
                       (Term.app `le_of_lt [(Term.app `lt_of_not_ge [`N0])]))))
                    []
                    (Tactic.rwSeq
                     "rw"
                     []
                     (Tactic.rwRuleSeq
                      "["
                      [(Tactic.rwRule [(patternIgnore (token.«← » "←"))] `norm_le_zero_iff)]
                      "]")
                     [])
                    []
                    (Tactic.exact
                     ...
                     (Term.app
                      ...
                      [(Term.app `h_e [`x])
                       (Term.app
                        ...
                        [`N0 (Term.app `norm_nonneg [(Term.hole "_")])])]))]))))))
             []
             (Tactic.tacticHave_
              "have"
              (Term.haveDecl
                  ...
                  (Tactic.tacticSeq1Indented
                   [(Std.Tactic.Ext.«tacticExt___:_» "ext" [] [])
                    ...
                    (Tactic.simp
                     ...
                     ["only"]
                     ["["
                      [(Tactic.simpLemma [] [] (Term.app `he [`x]))
                       ","
              ...
              (Term.haveDecl
               (Term.haveIdDecl
                ...
                (Term.byTactic
                 ...
                 (Tactic.tacticSeq
                  (Tactic.tacticSeq1Indented
                   [(Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `hf)] "]") [])
                    []
                    (Tactic.apply "apply" `extend_zero)]))))))
             []
             (Tactic.rwSeq
              "rw"
              []
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      («term_=_» (ContinuousLinearMap.Analysis.NormedSpace.OperatorNorm.termψ "ψ") "=" (num "0"))
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (num "0")
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 50, term))
      (ContinuousLinearMap.Analysis.NormedSpace.OperatorNorm.termψ "ψ")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ContinuousLinearMap.Analysis.NormedSpace.OperatorNorm.termψ', expected 'ContinuousLinearMap.Analysis.NormedSpace.OperatorNorm.termψ._@.Analysis.NormedSpace.OperatorNorm._hyg.72'
