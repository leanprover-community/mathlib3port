...
theorem AffineBasis.interior_convexHull {ι E : Type _} [Finite ι] [NormedAddCommGroup E]
  ...
  · -- The positive-dimensional case.
    ...
    have : convexHull ℝ (range b) = ⋂ i, b.coord i ⁻¹' Ici 0 :=
      by
      rw [b.convex_hull_eq_nonneg_coord, setOf_forall]
      rfl
    ext
    simp only [this, interior_interᵢ, ←
      ...
      interior_Ici, mem_interᵢ, mem_setOf_eq, mem_Ioi, mem_preimage]
...
/- ./././Mathport/Syntax/Translate/Basic.lean:629:2: warning: expanding binder collection (y «expr ∉ » s) -/
...
/- ./././Mathport/Syntax/Translate/Basic.lean:629:2: warning: expanding binder collection (s «expr ⊆ » u) -/
...
theorem AffineBasis.centroid_mem_interior_convexHull {ι} [Fintype ι] (b : AffineBasis ι ℝ V) :
  ...
  by
  haveI := b.nonempty
  simp only [b.interior_convex_hull, mem_setOf_eq, b.coord_apply_centroid (Finset.mem_univ _),
