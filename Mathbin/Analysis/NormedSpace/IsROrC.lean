...
theorem norm_smul_inv_norm' {r : ℝ} (r_nonneg : 0 ≤ r) {x : E} (hx : x ≠ 0) : ∥(r*∥x∥⁻¹ : 𝕜) • x∥ = r :=
  by 
    have  : ∥x∥ ≠ 0 :=
      by 
        simp [hx]
    fieldSimp [norm_smul, IsROrC.norm_of_real, IsROrC.norm_eq_abs, r_nonneg]

-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (z «expr ∈ » sphere (0 : E) r)
...
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (z «expr ∈ » closed_ball (0 : E) r)
