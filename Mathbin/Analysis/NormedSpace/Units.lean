 ...
 (Command.def
  ...
  (Command.optDeclSig
   [(Term.explicitBinder "(" [`t] [":" `R] [] ")")
    (Term.explicitBinder
     "("
     [`h]
     [":" («term_<_» (Analysis.Normed.Group.Basic.«term∥_∥» "∥" `t "∥") "<" (numLit "1"))]
     []
     ")")]
  ...
  (Command.declValSimple
   ...
   (Term.structInst
    "{"
    []
    [(group (Term.structInstField (Term.structInstLVal `val []) ":=" («term_-_» (numLit "1") "-" `t)) [","])
     (group
  ...
  (Command.declSig
   ...
   (Term.typeSpec
    ...
    (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
     ...
     ", "
     («term_=_»
      (Term.app `inverse [(Init.Logic.«term_+_» (Term.paren "(" [`x [(Term.typeAscription ":" `R)]] ")") "+" `t)])
      "="
      (Finset.Data.Finset.Fold.«term_*_»
       (Term.app
        ...
        [(Init.Logic.«term_+_»
          (numLit "1")
          "+"
          (Finset.Data.Finset.Fold.«term_*_» (Init.Coe.«term↑_» "↑" (Init.Logic.«term_⁻¹» `x "⁻¹")) "*" `t))])
       "*"
       (Init.Coe.«term↑_» "↑" (Init.Logic.«term_⁻¹» `x "⁻¹")))))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
      ...
      [(group (Tactic.nontriviality "nontriviality" [`R] []) [])
             ...
             («term_<_»
              ...
              (Init.Logic.«term_⁻¹»
               (Analysis.Normed.Group.Basic.«term∥_∥»
                ...
                (Term.paren
                 "("
                 [(Init.Coe.«term↑_» "↑" (Init.Logic.«term_⁻¹» `x "⁻¹")) [(Term.typeAscription ":" `R)]]
                 ")")
                "∥")
               "⁻¹")))]
           ":="
       ...
       (group
        (Tactic.use
         ...
         [(Init.Logic.«term_⁻¹»
           (Analysis.Normed.Group.Basic.«term∥_∥»
            "∥"
            (Term.paren "(" [(Init.Coe.«term↑_» "↑" (Init.Logic.«term_⁻¹» `x "⁻¹")) [(Term.typeAscription ":" `R)]] ")")
            "∥")
           "⁻¹")
          ","
          `hinv])
           ...
           [(Term.typeSpec
             ...
             («term_<_»
              (Analysis.Normed.Group.Basic.«term∥_∥»
               "∥"
               (Finset.Data.Finset.Fold.«term_*_»
                («term-_» "-" (Init.Coe.«term↑_» "↑" (Init.Logic.«term_⁻¹» `x "⁻¹")))
                "*"
                `t)
               "∥")
              "<"
              ...
              [(group
               ...
               (group
                (Tactic.refine'
                 ...
                 (Term.app
                  `lt_of_lt_of_leₓ
                  [(Term.app `mul_lt_mul_of_pos_left [`ht (Term.proj (Init.Logic.«term_⁻¹» `x "⁻¹") "." `norm_pos)])
                   (Term.hole "_")]))
                [])
       ...
       (group
        (Tactic.simp
         ...
         []
         ["only"]
         ["[" [(Tactic.simpLemma [] ["←"] `neg_mul_eq_neg_mul) "," (Tactic.simpLemma [] [] `sub_neg_eq_add)] "]"]
           ...
           (Tactic.tacticSeq
            (Tactic.tacticSeq1Indented
             [(group
               (Tactic.refine'
                "refine'"
                (Term.app `lt_of_le_of_ltₓ [(Term.app `norm_mul_le [(Term.hole "_") (Term.hole "_")]) (Term.hole "_")]))
               [])
              (group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `norm_neg)] "]") []) [])
              (group
               (Tactic.refine'
  ...
  (Tactic.tacticHave_
   ...
   (Term.haveDecl
    (Term.haveIdDecl
     ...
     (Term.app
      `inverse_one_sub
      [(Finset.Data.Finset.Fold.«term_*_» («term-_» "-" (Init.Coe.«term↑_» "↑" (Init.Logic.«term_⁻¹» `x "⁻¹"))) "*" `t)
       `ht']))))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticHave_', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.haveDecl', expected 'Lean.Parser.Term.haveDecl.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.haveIdDecl', expected 'Lean.Parser.Term.haveIdDecl.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Finset.Data.Finset.Fold.«term_*_»
   (Term.paren "(" [(«term-_» "-" (Init.Coe.«term↑_» "↑" (Init.Logic.«term_⁻¹» `x "⁻¹"))) []] ")")
   "*"
   `t)
  []]
 ")")
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app
   `lt_of_lt_of_leₓ
   [(Term.app `mul_lt_mul_of_pos_left [`ht (Term.proj (Init.Logic.«term_⁻¹» `x "⁻¹") "." `norm_pos)]) (Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Init.Logic.«term_⁻¹» `x "⁻¹") "." `norm_pos)
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(Init.Logic.«term_+_»
   ...
   "+"
   (Finset.Data.Finset.Fold.«term_*_»
    (Term.paren "(" [(Init.Coe.«term↑_» "↑" (Init.Logic.«term_⁻¹» `x "⁻¹")) []] ")")
    "*"
    `t))
  []]
 ")")
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Logic.«term_+_»', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Init.Logic.«term_+_» (Term.paren "(" [`x [(Term.typeAscription ":" `R)]] ")") "+" `t)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Logic.«term_+_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `t
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
/-- The formula `inverse (x + t) = inverse (1 + x⁻¹ * t) * x⁻¹` holds for `t` sufficiently small. -/
  theorem
    inverse_add
    ( x : Units R ) : ∀ᶠ t in 𝓝 0 , inverse ( x : R ) + t = inverse 1 + ↑ x ⁻¹ * t * ↑ x ⁻¹
    :=
      by
        nontriviality R
  ...
  (Command.declSig
   ...
   (Term.typeSpec
    ...
    (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
     ...
     ", "
     («term_=_»
      (Term.app `inverse [(«term_-_» (Term.paren "(" [(numLit "1") [(Term.typeAscription ":" `R)]] ")") "-" `t)])
      "="
      (Init.Logic.«term_+_»
       ...
       (Finset.Data.Finset.Fold.«term_*_»
        («term_^_» `t "^" `n)
        "*"
        (Term.app `inverse [(«term_-_» (numLit "1") "-" `t)])))))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
              ...
              (Init.Logic.«term_+_»
               (Finset.Data.Finset.Fold.«term_*_»
                (Term.app
                 ...
                 [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`i] [])] "=>" («term_^_» `t "^" `i)))])
                "*"
              ...
              [(group (Tactic.simp "simp" [] ["only"] ["[" [(Tactic.simpLemma [] [] `Units.coe_one_sub)] "]"] []) [])
               (group
                (Tactic.rwSeq
                 "rw"
                 []
                 (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `geomSum) "," (Tactic.rwRule [] `geom_sum_mul_neg)] "]")
                 [])
                [])
        ...
        (Tactic.rwSeq
         ...
         (Tactic.rwRuleSeq
          ...
          [(Tactic.rwRule
            ...
            (Term.app
             `one_mulₓ
             [(Init.Coe.«term↑_» "↑" (Init.Logic.«term_⁻¹» (Term.app `Units.oneSub [`t `ht]) "⁻¹"))]))
           ","
           (Tactic.rwRule [] `h)
           ","
      ...
      (group
       (Tactic.rwSeq
        ...
        (Tactic.rwRuleSeq
         ...
         [(Tactic.rwRule
           ["←"]
           (Term.app `one_mulₓ [(Init.Coe.«term↑_» "↑" (Init.Logic.«term_⁻¹» (Term.app `Units.oneSub [`t `ht]) "⁻¹"))]))
          ","
          (Tactic.rwRule [] `h)
          ","
          (Tactic.rwRule [] `add_mulₓ)]
     ...
     [(group (Tactic.simp "simp" [] ["only"] ["[" [(Tactic.simpLemma [] [] `Units.coe_one_sub)] "]"] []) [])
      (group
       (Tactic.rwSeq
        ...
        (Tactic.rwRuleSeq
         "["
         [(Tactic.rwRule ["←"] `add_mulₓ) "," (Tactic.rwRule ["←"] `geomSum) "," (Tactic.rwRule [] `geom_sum_mul_neg)]
         "]")
        [])
       [])
      (group (Tactic.simp "simp" [] [] [] []) [])])))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq
   ...
   (Tactic.rwRuleSeq
    "["
    [(Tactic.rwRule [] `mul_assocₓ) "," (Tactic.rwRule [] (Term.proj (Term.app `Units.oneSub [`t `ht]) "." `mul_inv))]
    "]")
   [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Coe.«term↑_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Init.Logic.«term_⁻¹» (Term.app `Units.oneSub [`t `ht]) "⁻¹")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Logic.«term_⁻¹»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.app `Units.oneSub [`t `ht])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Init.Logic.«term_+_»
   (Algebra.BigOperators.Basic.«term∑_in_,_»
    ...
    («term_^_» `t "^" `i))
   "+"
   (Finset.Data.Finset.Fold.«term_*_» («term_^_» `t "^" `n) "*" (Term.app `inverse [(«term_-_» (numLit "1") "-" `t)])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Logic.«term_+_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Finset.Data.Finset.Fold.«term_*_» («term_^_» `t "^" `n) "*" (Term.app `inverse [(«term_-_» (numLit "1") "-" `t)]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Finset.Data.Finset.Fold.«term_*_»', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(«term_^_» `t "^" `n) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 0, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Algebra.BigOperators.Basic.«term∑_in_,_»
   "∑"
...
theorem
  ...
  ( n : ℕ ) : ∀ᶠ t in 𝓝 0 , inverse ( 1 : R ) - t = ∑ i in range n , t ^ i + t ^ n * inverse 1 - t
  :=
    by
      simp only [ eventually_iff , Metric.mem_nhds_iff ]
        ...
        have
          h
            ...
            :=
            by simp only [ Units.coe_one_sub ] rw [ ← geomSum , geom_sum_mul_neg ] simp
        rw [ ← one_mulₓ ↑ Units.oneSub t ht ⁻¹ , h , add_mulₓ ]
        congr
        · rw [ mul_assocₓ , Units.oneSub t ht . mul_inv ] simp
        · simp only [ Units.coe_one_sub ] rw [ ← add_mulₓ , ← geomSum , geom_sum_mul_neg ] simp
      ...
      (Init.Logic.«term_+_»
       ...
       (Finset.Data.Finset.Fold.«term_*_»
        («term_^_»
         ...
         `n)
        "*"
        (Term.app `inverse [(Init.Logic.«term_+_» `x "+" `t)])))))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
      ...
      [(group
           ...
           (Term.app
            ...
            [(Term.fun
              ...
              (Term.basicFun
               ...
               "=>"
               (Finset.Data.Finset.Fold.«term_*_» `a "*" (Init.Coe.«term↑_» "↑" (Init.Logic.«term_⁻¹» `x "⁻¹")))))
             `h1]))))
        [])
       ...
       (group
        (Tactic.rwSeq
         "rw"
         []
         (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `add_mulₓ) "," (Tactic.rwRule [] `mul_assocₓ)] "]")
         [])
        [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `add_mulₓ) "," (Tactic.rwRule [] `mul_assocₓ)] "]") [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `mul_assocₓ
...
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 0, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Init.Logic.«term_+_» `x "+" `t) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `inverse
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
    ...
    ( x : Units R ) ( n : ℕ )
      :
        ∀ᶠ
          ...
          𝓝 0
          ,
          inverse ( x : R ) + t = ∑ i in range n , - ↑ x ⁻¹ * t ^ i * ↑ x ⁻¹ + - ↑ x ⁻¹ * t ^ n * inverse x + t
    :=
      by
        refine' inverse_add x . mp _
          have
            hzero
              : tendsto fun t : R => - ↑ x ⁻¹ * t 𝓝 0 𝓝 0
              :=
              by convert mul_left_continuous - ( ↑ x ⁻¹ : R ) . Tendsto 0 . comp tendsto_id simp
       ...
       (group
        (Tactic.tacticHave_
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           [`ht' []]
           [(Term.typeSpec ":" («term_<_» (Analysis.Normed.Group.Basic.«term∥_∥» "∥" `t "∥") "<" (numLit "1")))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           ...
           [(Term.typeSpec
             ...
             («term_≤_»
              (Init.Logic.«term_⁻¹»
               («term_-_» (numLit "1") "-" (Analysis.Normed.Group.Basic.«term∥_∥» "∥" `t "∥"))
               "⁻¹")
              "≤"
              (numLit "2")))]
           ":="
        ...
        (Term.haveDecl
         (Term.haveIdDecl
          ...
          [(Term.typeSpec
            ":"
            («term_≤_»
             (Init.Logic.«term_⁻¹» («term_-_» (numLit "1") "-" (Analysis.Normed.Group.Basic.«term∥_∥» "∥" `t "∥")) "⁻¹")
             "≤"
             (numLit "2")))]
          ":="
          (Term.byTactic
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `inv_inv₀ [(Term.paren "(" [(numLit "2") [(Term.typeAscription ":" (Data.Real.Basic.termℝ "ℝ"))]] ")")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
theorem
  ...
  : is_O fun t => inverse ( 1 : R ) - t fun t => ( 1 : ℝ ) 𝓝 ( 0 : R )
  :=
    by
      simp only [ is_O , is_O_with , eventually_iff , Metric.mem_nhds_iff ]
        ...
        have ht' : ∥ t ∥ < 1 := by have : ( 2 : ℝ ) ⁻¹ < 1 := by cancel_denoms linarith
...
theorem inverse_add_norm (x : Units R) : is_O (fun t => inverse ((↑x)+t)) (fun t => (1 : ℝ)) (𝓝 (0 : R)) := by
    ...
    (Term.app
     ...
     [(Term.fun
       ...
       (Term.basicFun
        ...
        "=>"
        («term_-_»
         (Term.app `inverse [(Init.Logic.«term_+_» (Init.Coe.«term↑_» "↑" `x) "+" `t)])
         "-"
         (Finset.Data.Finset.Fold.«term_*_»
          (Algebra.BigOperators.Basic.«term∑_in_,_»
           "∑"
      ...
      (Term.fun
       ...
       (Term.basicFun
        [(Term.simpleBinder [`t] [])]
        "=>"
        («term_^_» (Analysis.Normed.Group.Basic.«term∥_∥» "∥" `t "∥") "^" `n)))
      (Term.app (Topology.Basic.term𝓝 "𝓝") [(Term.paren "(" [(numLit "0") [(Term.typeAscription ":" `R)]] ")")])])))
  (Command.declValSimple
   ":="
   (Term.byTactic
    ...
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group (Tactic.byCases' "by_cases'" [`h ":"] («term_=_» `n "=" (numLit "0"))) [])
       (group
        (Tactic.«tactic·._»
         "·"
         (Tactic.tacticSeq
       ...
       (group
        (Tactic.tacticHave_
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           [`hn []]
           [(Term.typeSpec ":" («term_<_» (numLit "0") "<" `n))]
           ":="
       ...
       (group
        (Tactic.refine'
         "refine'"
         (Term.app `le_transₓ [(Term.app `norm_mul_le [(Term.hole "_") (Term.hole "_")]) (Term.hole "_")]))
        [])
       (group
        (Tactic.tacticHave_
         "have"
                  ...
                  (calcStep
                   («term_=_»
                    ...
                    (Finset.Data.Finset.Fold.«term_*_»
                     ...
                     («term_^_» (Analysis.Normed.Group.Basic.«term∥_∥» "∥" `t "∥") "^" `n)))
                   ":="
                   (Term.app `mul_powₓ [(Term.hole "_") (Term.hole "_") `n]))])
                [])
               (group
                (Tactic.exact
                 "exact"
                 (Term.app
                  ...
                  [(Term.app `norm_nonneg [(Term.hole "_")])
                   (Term.app `norm_mul_le [(Init.Coe.«term↑_» "↑" (Init.Logic.«term_⁻¹» `x "⁻¹")) `t])
                   `n]))
                [])]))))))
        [])
       (group
       ...
       (group
        (Tactic.nlinarith
         ...
         []
         ["["
          [(Term.app `norm_nonneg [(Term.app `inverse [(Init.Logic.«term_+_» (Init.Coe.«term↑_» "↑" `x) "+" `t)])])]
          "]"])
        [])])))
   [])
  []
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Logic.«term_+_»', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Init.Logic.«term_+_» (Init.Coe.«term↑_» "↑" `x) "+" `t)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Logic.«term_+_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `t
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Init.Logic.«term_+_» (Term.paren "(" [(Init.Coe.«term↑_» "↑" `x) []] ")") "+" `t) []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `inverse
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(Term.app
   `inverse
   [(Term.paren "(" [(Init.Logic.«term_+_» (Term.paren "(" [(Init.Coe.«term↑_» "↑" `x) []] ")") "+" `t) []] ")")])
  []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `norm_nonneg
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `norm_mul_le [(Term.paren "(" [(Init.Coe.«term↑_» "↑" (Init.Logic.«term_⁻¹» `x "⁻¹")) []] ")") `t]) []]
 ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
   ...
   [(calcStep
     («term_≤_»
      (Analysis.Normed.Group.Basic.«term∥_∥»
       "∥"
       («term_^_»
        («term-_» "-" (Finset.Data.Finset.Fold.«term_*_» (Init.Coe.«term↑_» "↑" (Init.Logic.«term_⁻¹» `x "⁻¹")) "*" `t))
        "^"
        `n)
       "∥")
      "≤"
          ...
          have
            h
              :
                eventually_eq
                  𝓝 ( 0 : R )
                    fun t => inverse ↑ x + t - ∑ i in range n , - ↑ x ⁻¹ * t ^ i * ↑ x ⁻¹
...
theorem is_open_map_coe : IsOpenMap (coeₓ : Units R → R) := by
  ...
  have : u ∩ (op ∘ Ring.inverse) ⁻¹' v ∩ Set.Range (coeₓ : Units R → R) ∈ 𝓝 (↑x) := by
