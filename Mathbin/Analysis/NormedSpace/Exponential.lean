...
/- ./././Mathport/Syntax/Translate/Basic.lean:629:2: warning: expanding binder collection (n «expr ∉ » ({0} : finset[finset] exprℕ())) -/
@[simp]
...
theorem Commute.exp [t2_space 𝔸] {x y : 𝔸} (h : Commute x y) : Commute (exp 𝕂 x) (exp 𝕂 y) :=
