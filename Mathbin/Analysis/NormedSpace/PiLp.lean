...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `pseudo_emetric_aux [])
  (Command.optDeclSig [] [(Term.typeSpec ":" (Term.app `PseudoEmetricSpace [(Term.app `PiLp [`p `β])]))])
   ...
   (Term.have
    ...
    (Term.haveDecl
     (Term.haveIdDecl
      ...
      ":="
      (Term.app `lt_of_lt_of_leₓ [`zero_lt_one `fact_one_le_p.out])))
    []
    (Term.structInst
     "{"
     []
     [(group
         ...
         (Term.basicFun
          ...
          (Cardinal.SetTheory.Cofinality.«term_^_»
           (Algebra.BigOperators.Basic.«term∑_,_»
            ...
            ", "
            (Cardinal.SetTheory.Cofinality.«term_^_» (Term.app `edist [(Term.app `f [`i]) (Term.app `g [`i])]) "^" `p))
           "^"
           («term_/_» (numLit "1") "/" `p)))))
       [","])
      (group
       (Term.structInstField
        (Term.structInstLVal `edist_self [])
        ":="
        (Term.fun
         "fun"
         (Term.basicFun
            ...
            (Tactic.tacticSeq1Indented
             [(group
               (Tactic.simp
                ...
                []
                ["["
                 [(Tactic.simpLemma [] [] `edist)
                  ","
                  (Tactic.simpLemma [] [] (Term.app `Ennreal.zero_rpow_of_pos [`Pos]))
                  ","
                  (Tactic.simpLemma
                   []
                   []
                   (Term.app `Ennreal.zero_rpow_of_pos [(Term.app (Term.proj `inv_pos "." (fieldIdx "2")) [`Pos])]))]
                 "]"]
                [])
               [])]))))))
       [","])
      (group
       (Term.structInstField
        (Term.structInstLVal `edist_comm [])
        ":="
        (Term.fun
         "fun"
         (Term.basicFun
            ...
            (Tactic.tacticSeq1Indented
             [(group
               (Tactic.simp
                ...
                []
                []
                ["[" [(Tactic.simpLemma [] [] `edist) "," (Tactic.simpLemma [] [] `edist_comm)] "]"]
                [])
               [])]))))))
       [","])
      (group
       (Term.structInstField
        (Term.structInstLVal `edist_triangle [])
        ":="
        (Term.fun
         "fun"
         (Term.basicFun
             ...
             («term_≤_»
              (Cardinal.SetTheory.Cofinality.«term_^_»
               (Algebra.BigOperators.Basic.«term∑_,_»
                ...
                ", "
                (Cardinal.SetTheory.Cofinality.«term_^_»
                 (Term.app `edist [(Term.app `f [`i]) (Term.app `h [`i])])
                 "^"
                 `p))
               "^"
               («term_/_» (numLit "1") "/" `p))
              ...
              (Cardinal.SetTheory.Cofinality.«term_^_»
               (Algebra.BigOperators.Basic.«term∑_,_»
                ...
                (Cardinal.SetTheory.Cofinality.«term_^_»
                 (Init.Logic.«term_+_»
                  (Term.app `edist [(Term.app `f [`i]) (Term.app `g [`i])])
                  "+"
                  (Term.app `edist [(Term.app `g [`i]) (Term.app `h [`i])]))
                 "^"
                 `p))
               "^"
               («term_/_» (numLit "1") "/" `p)))
                ...
                [(group
                  (Tactic.apply
                   ...
                   (Term.app
                    ...
                    [(Term.hole "_")
                     («term_$__» (Term.proj `one_div_nonneg "." (fieldIdx "2")) "$" (Term.app `le_of_ltₓ [`Pos]))]))
                  [])
                 (group
                  (Tactic.refine'
                   "refine'"
                  ...
                  (Tactic.exact
                   ...
                   (Term.app
                    ...
                    [(Term.app `edist_triangle [(Term.hole "_") (Term.hole "_") (Term.hole "_")])
                     (Term.app `le_transₓ [`zero_le_one `fact_one_le_p.out])]))
                  [])]))))
            (calcStep
             («term_≤_»
              (Term.hole "_")
              ...
              (Init.Logic.«term_+_»
               ...
               (Cardinal.SetTheory.Cofinality.«term_^_»
                ...
                («term_/_» (numLit "1") "/" `p))))
             ":="
             (Term.app `Ennreal.Lp_add_le [(Term.hole "_") (Term.hole "_") (Term.hole "_") `fact_one_le_p.out]))]))))
       [])]
     (Term.optEllipsis [])
     []
     "}"))
       ...
       («term_≤_»
        (Cardinal.SetTheory.Cofinality.«term_^_»
         (Algebra.BigOperators.Basic.«term∑_,_»
          ...
          (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] [":" `ι]))
          ", "
          (Cardinal.SetTheory.Cofinality.«term_^_» (Term.app `edist [(Term.app `f [`i]) (Term.app `h [`i])]) "^" `p))
         "^"
         («term_/_» (numLit "1") "/" `p))
        "≤"
        (Cardinal.SetTheory.Cofinality.«term_^_»
        ...
        (Init.Logic.«term_+_»
         ...
         (Cardinal.SetTheory.Cofinality.«term_^_»
          (Algebra.BigOperators.Basic.«term∑_,_»
           ...
           (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] [":" `ι]))
           ", "
           (Cardinal.SetTheory.Cofinality.«term_^_» (Term.app `edist [(Term.app `g [`i]) (Term.app `h [`i])]) "^" `p))
          "^"
          («term_/_» (numLit "1") "/" `p))))
       ":="
       (Term.app `Ennreal.Lp_add_le [(Term.hole "_") (Term.hole "_") (Term.hole "_") `fact_one_le_p.out]))])))
...
/--
  ...
  def
    pseudo_emetric_aux
    : PseudoEmetricSpace PiLp p β
    :=
      have
        pos : 0 < p := lt_of_lt_of_leₓ zero_lt_one fact_one_le_p.out
        {
          edist := fun f g => ∑ i : ι , edist f i g i ^ p ^ 1 / p ,
            edist_self
                :=
                fun f => by simp [ edist , Ennreal.zero_rpow_of_pos Pos , Ennreal.zero_rpow_of_pos inv_pos . 2 Pos ]
              ,
            edist_comm := fun f g => by simp [ edist , edist_comm ] ,
            edist_triangle
              :=
              fun
                f g h
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `emetric_aux [])
  (Command.optDeclSig [] [(Term.typeSpec ":" (Term.app `EmetricSpace [(Term.app `PiLp [`p `α])]))])
  (Command.declValSimple
   ":="
   (Term.structInst
    "{"
    [[(Term.app `pseudo_emetric_aux [`p `α])] "with"]
    [(group
      (Term.structInstField
       (Term.structInstLVal `eq_of_edist_eq_zero [])
       ":="
       (Term.fun
        "fun"
        (Term.basicFun
         [(Term.simpleBinder [`f `g `hfg] [])]
         "=>"
         (Term.byTactic
          "by"
          (Tactic.tacticSeq
           (Tactic.tacticSeq1Indented
            [(group
             ...
             (group
              (Tactic.tacticLet_
               "let"
               (Term.letDecl (Term.letIdDecl `h [] [] ":=" (Term.app `pseudo_emetric_aux [`p `α]))))
              [])
             (group
              (Tactic.tacticHave_
               "have"
             ...
             (group
              (Tactic.simp
               ...
               ["["
                [(Tactic.simpLemma [] [] `h)
                 ","
                 (Tactic.simpLemma [] [] `Ennreal.rpow_eq_zero_iff)
                 ","
                 (Tactic.simpLemma [] [] `Pos)
                 ","
                 (Tactic.simpLemma [] [] (Term.app `asymm [`Pos]))
                 ","
                 (Tactic.simpLemma [] [] `Finset.sum_eq_zero_iff_of_nonneg)]
                "]"]
               [(Tactic.location "at" (Tactic.locationHyp [`hfg] []))])
              [])
             (group (Tactic.exact "exact" (Term.app `funext [`hfg])) [])]))))))
      [])]
    (Term.optEllipsis [])
    []
    "}")
     ...
     (Tactic.tacticSeq
      (Tactic.tacticSeq1Indented
       [(group
         ...
         [])
        (group
         (Tactic.tacticLet_ "let" (Term.letDecl (Term.letIdDecl `h [] [] ":=" (Term.app `pseudo_emetric_aux [`p `α]))))
         [])
        (group
         (Tactic.tacticHave_
          "have"
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `funext [`hfg]))
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `lipschitz_with_equiv [])
  (Command.declSig [] (Term.typeSpec ":" (Term.app `LipschitzWith [(numLit "1") (Term.app `PiLp.equiv [`p `β])])))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
      ...
      [(group
        ...
        (Tactic.tacticHave_
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           ...
           [(Term.typeSpec
             ":"
             («term_=_» (Finset.Data.Finset.Fold.«term_*_» `p "*" («term_/_» (numLit "1") "/" `p)) "=" (numLit "1")))]
           ":="
           (Term.app `mul_div_cancel' [(numLit "1") (Term.app `ne_of_gtₓ [`Pos])]))))
        [])
        ...
        (Tactic.simp
         ...
         ["["
          [(Tactic.simpLemma [] [] `edist)
           ...
           ","
           (Tactic.simpLemma [] [] `Finset.sup_le_iff)
           ","
       ...
       (group
        (tacticCalc_
         ...
         [(calcStep
           («term_=_»
            (Term.app `edist [(Term.app `x [`i]) (Term.app `y [`i])])
            "="
            (Cardinal.SetTheory.Cofinality.«term_^_»
             (Cardinal.SetTheory.Cofinality.«term_^_» (Term.app `edist [(Term.app `x [`i]) (Term.app `y [`i])]) "^" `p)
             "^"
             («term_/_» (numLit "1") "/" `p)))
           ":="
           (Term.byTactic
             ...
             (Tactic.tacticSeq1Indented
              [(group
                (Tactic.simp
                 ...
                 []
                 ["["
                  [(Tactic.simpLemma [] ["←"] `Ennreal.rpow_mul)
                   ","
                   (Tactic.simpLemma [] [] `cancel)
                   ","
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Finset.mem_univ [`i]) []] ")")
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.apply
   ...
   (Term.app
    `Ennreal.rpow_le_rpow
    [(Term.hole "_") («term_$__» (Term.proj `one_div_nonneg "." (fieldIdx "2")) "$" (Term.app `le_of_ltₓ [`Pos]))]))
...
theorem
  ...
  : LipschitzWith 1 PiLp.equiv p β
  :=
    by
      have pos : 0 < p := lt_of_lt_of_leₓ zero_lt_one fact_one_le_p.out
        ...
        intro i
        calc
          edist x i y i = edist x i y i ^ p ^ 1 / p := by simp [ ← Ennreal.rpow_mul , cancel , - one_div ]
            _ ≤ ∑ i : ι , edist x i y i ^ p ^ 1 / p
              :=
              by
                apply Ennreal.rpow_le_rpow _ one_div_nonneg . 2 $ le_of_ltₓ Pos
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `antilipschitz_with_equiv [])
  (Command.declSig
   []
   (Term.typeSpec
    ":"
    (Term.app
     ...
     [(Cardinal.SetTheory.Cofinality.«term_^_»
       (Term.paren
        "("
        [(Term.app `Fintype.card [`ι]) [(Term.typeAscription ":" (Data.Real.Nnreal.«termℝ≥0» " ℝ≥0 "))]]
        ")")
       "^"
       («term_/_» (numLit "1") "/" `p))
      (Term.app `PiLp.equiv [`p `β])])))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group
        ...
        (Tactic.tacticHave_
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           ...
           ":="
           (Term.app (Term.proj `one_div_nonneg "." (fieldIdx "2")) [(Term.app `le_of_ltₓ [`Pos])]))))
        [])
       (group
        (Tactic.tacticHave_
         "have"
       ...
       (group (Tactic.intro "intro" [`x `y]) [])
       (group
        (Tactic.simp "simp" [] [] ["[" [(Tactic.simpLemma [] [] `edist) "," (Tactic.simpErase "-" `one_div)] "]"] [])
        [])
       (group
        (tacticCalc_
         "calc"
         [(calcStep
           («term_≤_»
            ...
            (Cardinal.SetTheory.Cofinality.«term_^_»
             (Algebra.BigOperators.Basic.«term∑_,_»
              ...
              ", "
              (Cardinal.SetTheory.Cofinality.«term_^_»
               (Term.app `edist [(Term.app `PiLp.equiv [`p `β `x]) (Term.app `PiLp.equiv [`p `β `y])])
               "^"
               `p))
             "^"
             («term_/_» (numLit "1") "/" `p)))
           ...
           (Term.byTactic
            ...
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(group (Tactic.apply "apply" (Term.app `Ennreal.rpow_le_rpow [(Term.hole "_") `nonneg])) [])
               (group
                (Tactic.apply
                 "apply"
                 (Term.app
                ...
                [])
               (group
                (Tactic.apply "apply" (Term.app `Ennreal.rpow_le_rpow [(Term.hole "_") (Term.app `le_of_ltₓ [`Pos])]))
                [])
               (group (Tactic.exact "exact" (Term.app `Finset.le_sup [(Term.app `Finset.mem_univ [`i])])) [])]))))
          (calcStep
           («term_=_»
            (Term.hole "_")
            "="
                ...
                (Tactic.simp
                 ...
                 ["["
                  [(Tactic.simpLemma [] [] `nsmul_eq_mul)
                   ...
                   ","
                   (Tactic.simpLemma [] [] `Ennreal.rpow_one)
                   ","
                   ...
                   (Tactic.simpLemma
                    []
                    []
                    (Term.app `Ennreal.mul_rpow_of_nonneg [(Term.hole "_") (Term.hole "_") `nonneg]))
                   ","
                   (Tactic.simpLemma [] ["←"] `Ennreal.rpow_mul)
                   ","
                   (Tactic.simpLemma [] [] `cancel)]
                  ...
                  (Term.haveIdDecl
                   ...
                   [(Term.typeSpec
                     ...
                     («term_=_»
                      (Term.paren
                       "("
                       [(Term.app `Fintype.card [`ι]) [(Term.typeAscription ":" (Data.Real.Ennreal.«termℝ≥0∞» "ℝ≥0∞"))]]
                       ")")
                      "="
                      (Term.paren
                       "("
                       ...
                       ")")))]
                   ":="
                   (Term.proj (Term.app `Ennreal.coe_nat [(Term.app `Fintype.card [`ι])]) "." `symm))))
                [])
               (group
                (Tactic.rwSeq
                 "rw"
                 ...
                 (Tactic.rwRuleSeq
                  ...
                  [(Tactic.rwRule [] `this)
                   ","
                   (Tactic.rwRule [] (Term.app `Ennreal.coe_rpow_of_nonneg [(Term.hole "_") `nonneg]))]
                  "]")
                 [])
                [])]))))])
        [])])))
          ...
          (Tactic.simp
           ...
           ["["
            [(Tactic.simpLemma [] [] `nsmul_eq_mul)
             ...
             (Tactic.simpLemma [] [] `Finset.sum_const)
             ","
             (Tactic.simpLemma [] [] (Term.app `Ennreal.mul_rpow_of_nonneg [(Term.hole "_") (Term.hole "_") `nonneg]))
             ","
             (Tactic.simpLemma [] ["←"] `Ennreal.rpow_mul)
             ","
             (Tactic.simpLemma [] [] `cancel)]
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.rwSeq
   ...
   (Tactic.rwRuleSeq
    "["
    [(Tactic.rwRule [] `this) "," (Tactic.rwRule [] (Term.app `Ennreal.coe_rpow_of_nonneg [(Term.hole "_") `nonneg]))]
    "]")
   [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Ennreal.coe_rpow_of_nonneg [(Term.hole "_") `nonneg])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `Ennreal.coe_nat [(Term.app `Fintype.card [`ι])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `Ennreal.coe_nat [(Term.paren "(" [(Term.app `Fintype.card [`ι]) []] ")")]) []]
 ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'optional.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_=_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.paren "(" [(Term.app `Fintype.card [`ι]) [(Term.typeAscription ":" (Data.Real.Nnreal.«termℝ≥0» " ℝ≥0 "))]] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.paren', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.paren', expected 'Lean.Parser.Term.paren.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'null', expected 'optional.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeAscription', expected 'optional.antiquot_scope'
...
[PrettyPrinter.parenthesize] ...precedences are 51 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 50, term))
  (Term.paren "(" [(Term.app `Fintype.card [`ι]) [(Term.typeAscription ":" (Data.Real.Ennreal.«termℝ≥0∞» "ℝ≥0∞"))]] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.paren', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.paren', expected 'Lean.Parser.Term.paren.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'null', expected 'optional.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeAscription', expected 'optional.antiquot_scope'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `PiLp.equiv [`p `β `y]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `PiLp.equiv [`p `β `x]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `edist
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
      ...
      (group
       (Tactic.apply
        ...
        (Term.app
         ...
         [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`i `hi] [])] "=>" (Term.hole "_")))]))
       [])
      (group (Tactic.apply "apply" (Term.app `Ennreal.rpow_le_rpow [(Term.hole "_") (Term.app `le_of_ltₓ [`Pos])])) [])
      (group (Tactic.exact "exact" (Term.app `Finset.le_sup [(Term.app `Finset.mem_univ [`i])])) [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.byTactic', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.byTactic', expected 'Lean.Parser.Term.byTactic.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq', expected 'Lean.Parser.Tactic.tacticSeq.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `Finset.le_sup [(Term.app `Finset.mem_univ [`i])]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Finset.le_sup [(Term.app `Finset.mem_univ [`i])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.apply', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Ennreal.rpow_le_rpow [(Term.hole "_") (Term.app `le_of_ltₓ [`Pos])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `le_of_ltₓ [`Pos]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.apply "apply" (Term.app `Ennreal.rpow_le_rpow [(Term.hole "_") `nonneg]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.apply', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Ennreal.rpow_le_rpow [(Term.hole "_") `nonneg])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
      ...
      have pos : 0 < p := lt_of_lt_of_leₓ zero_lt_one fact_one_le_p.out
        ...
        calc
          ∑ i : ι , edist x i y i ^ p ^ 1 / p ≤ ∑ i : ι , edist PiLp.equiv p β x PiLp.equiv p β y ^ p ^ 1 / p
            ...
            _ = ( ( Fintype.card ι : ℝ≥0 ) ^ 1 / p : ℝ≥0 ) * edist PiLp.equiv p β x PiLp.equiv p β y
              :=
              by
                simp
                    only
                    [
                      nsmul_eq_mul
                        ...
                        Finset.sum_const
                        ,
                        Ennreal.mul_rpow_of_nonneg _ _ nonneg
                        ,
                        ← Ennreal.rpow_mul
                        ,
                        cancel
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `edist [])
  (Command.declSig
   [(Term.implicitBinder "{" [`p] [":" (Data.Real.Basic.termℝ "ℝ")] "}")
    (Term.instBinder "[" [] (Term.app `Fact [(«term_≤_» (numLit "1") "≤" `p)]) "]")
    (Term.implicitBinder "{" [`β] [":" (Term.arrow `ι "→" (Term.type "Type" [(Level.hole "_")]))] "}")
    (Term.instBinder
     "["
     []
     (Term.forall "∀" [(Term.simpleBinder [`i] [])] "," (Term.app `PseudoEmetricSpace [(Term.app `β [`i])]))
     "]")
    (Term.explicitBinder "(" [`x `y] [":" (Term.app `PiLp [`p `β])] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app `edist [`x `y])
...
protected
  theorem
    edist
    { p : ℝ } [ Fact 1 ≤ p ] { β : ι → Type _ } [ ∀ i , PseudoEmetricSpace β i ] ( x y : PiLp p β )
 ...
 (Command.instance
  ...
  (Command.declSig
   [(Term.instBinder
     "["
     []
     (Term.forall "∀" [(Term.simpleBinder [`i] [])] "," (Term.app `PseudoMetricSpace [(Term.app `β [`i])]))
     "]")]
   (Term.typeSpec ":" (Term.app `PseudoMetricSpace [(Term.app `PiLp [`p `β])])))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
            ...
            (Term.basicFun
             ...
             (Cardinal.SetTheory.Cofinality.«term_^_»
              (Algebra.BigOperators.Basic.«term∑_,_»
               ...
               ", "
               (Cardinal.SetTheory.Cofinality.«term_^_»
                (Term.app `dist [(Term.app `f [`i]) (Term.app `g [`i])])
                "^"
                `p))
              "^"
              («term_/_» (numLit "1") "/" `p))))
           (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`f `g] [])] "=>" (Term.hole "_")))
           (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`f `g] [])] "=>" (Term.hole "_")))]))
        [])
       (group
        (Tactic.«tactic·._»
          ...
          (Tactic.tacticSeq1Indented
           [(group
             (Tactic.simp
              ...
              []
              ["["
               [(Tactic.simpLemma [] [] `PiLp.edist)
                ","
                (Tactic.simpLemma [] [] `Ennreal.rpow_eq_top_iff)
                ","
                (Tactic.simpLemma [] [] (Term.app `asymm [`Pos]))
                ","
                (Tactic.simpLemma [] [] `Pos)
                ","
                (Tactic.simpLemma [] [] `Ennreal.sum_eq_top_iff)
                ","
                (Tactic.simpLemma [] [] `edist_ne_top)]
               "]"]
              [])
             [])])))
        [])
                       ...
                       (Tactic.simp
                        ...
                        ["["
                         [(Tactic.simpLemma [] [] `lt_top_iff_ne_top)
                          ...
                          (Tactic.simpLemma [] [] `edist_ne_top)
                          ","
                          (Tactic.simpLemma [] [] (Term.app `le_of_ltₓ [`Pos]))]
                         "]"]
                        [])
                       [])]))))))))
             [])
             ...
             (Tactic.simp
              ...
              ["["
               [(Tactic.simpLemma [] [] `dist)
                ...
                (Tactic.simpLemma [] [] `PiLp.edist)
                ","
                (Tactic.simpLemma [] ["←"] `Ennreal.to_real_rpow)
                ","
                (Tactic.simpLemma [] [] (Term.app `Ennreal.to_real_sum [`A]))
                ","
                (Tactic.simpLemma [] [] `dist_edist)]
               "]"]
              [])
             [])])))
        [])])))
           ...
           (Term.basicFun
            ...
            (Cardinal.SetTheory.Cofinality.«term_^_»
             (Algebra.BigOperators.Basic.«term∑_,_»
              ...
              (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] [":" `ι]))
              ", "
              (Cardinal.SetTheory.Cofinality.«term_^_» (Term.app `dist [(Term.app `f [`i]) (Term.app `g [`i])]) "^" `p))
             "^"
             («term_/_» (numLit "1") "/" `p))))
          (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`f `g] [])] "=>" (Term.hole "_")))
          (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`f `g] [])] "=>" (Term.hole "_")))]))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simpLemma', expected 'Lean.Parser.Tactic.simpErase'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Ennreal.to_real_sum [`A])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Cardinal.SetTheory.Cofinality.«term_^_»
   (Term.app `edist [(Term.paren "(" [(Term.app `f [`i]) []] ")") (Term.paren "(" [(Term.app `g [`i]) []] ")")])
   "^"
   `p)
  []]
 ")")
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 25, term))
  (Init.Core.«term_∈_» `i " ∈ " (Term.paren "(" [`Finset.univ [(Term.typeAscription ":" (Term.app `Finset [`ι]))]] ")"))
...
/--
    ...
    `L^p` distance, and having as uniformity the product uniformity. -/
  instance
    [ ∀ i , PseudoMetricSpace β i ] : PseudoMetricSpace PiLp p β
    :=
      by
        have pos : 0 < p := lt_of_lt_of_leₓ zero_lt_one fact_one_le_p.out
          refine'
            PseudoEmetricSpace.toPseudoMetricSpaceOfDist
              fun f g => ∑ i : ι , dist f i g i ^ p ^ 1 / p fun f g => _ fun f g => _
          · simp [ PiLp.edist , Ennreal.rpow_eq_top_iff , asymm Pos , Pos , Ennreal.sum_eq_top_iff , edist_ne_top ]
          ·
            have
                A
                  : ∀ i : ι , i ∈ ( Finset.univ : Finset ι ) → edist f i g i ^ p ≠ ⊤
                  :=
                  fun i hi => by simp [ lt_top_iff_ne_top , edist_ne_top , le_of_ltₓ Pos ]
 ...
 (Command.instance
  ...
  (Command.declSig
   [(Term.instBinder
     ...
     "]")]
   (Term.typeSpec ":" (Term.app `MetricSpace [(Term.app `PiLp [`p `α])])))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
                    ...
                    (Tactic.tacticSeq1Indented
                     [(group
                       (Tactic.simp
                        ...
                        []
                        []
                        ["[" [(Tactic.simpLemma [] [] `edist_ne_top) "," (Tactic.simpLemma [] [] `pos.le)] "]"]
                        [])
                       [])]))))))))
             [])
            (group
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.simp "simp" [] [] ["[" [(Tactic.simpLemma [] [] `edist_ne_top) "," (Tactic.simpLemma [] [] `pos.le)] "]"] [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simp', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«]»', expected 'optional.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simpLemma', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simpLemma', expected 'Lean.Parser.Tactic.simpStar'
...
/--
    ...
    and having as uniformity the product uniformity. -/
  instance
    [ ∀ i , MetricSpace α i ] : MetricSpace PiLp p α
    :=
      by
        have pos : 0 < p := lt_of_lt_of_leₓ zero_lt_one fact_one_le_p.out
          refine'
          ...
          ·
            have
                A
                  : ∀ i : ι , i ∈ ( Finset.univ : Finset ι ) → edist f i g i ^ p ≠ ⊤
                  :=
                  fun i hi => by simp [ edist_ne_top , pos.le ]
              simp [ dist , - one_div , PiLp.edist , ← Ennreal.to_real_rpow , Ennreal.to_real_sum A , dist_edist ]
    ...
    («term_=_»
     ...
     (Cardinal.SetTheory.Cofinality.«term_^_»
      (Algebra.BigOperators.Basic.«term∑_,_»
       ...
       (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] [":" `ι]))
       ", "
       (Cardinal.SetTheory.Cofinality.«term_^_» (Term.app `dist [(Term.app `x [`i]) (Term.app `y [`i])]) "^" `p))
      "^"
      («term_/_» (numLit "1") "/" `p)))))
  (Command.declValSimple ":=" `rfl [])
  []
...
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 0, term))
  (Term.app `dist [(Term.app `x [`i]) (Term.app `y [`i])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
protected
  theorem
    dist
    { p : ℝ } [ Fact 1 ≤ p ] { β : ι → Type _ } [ ∀ i , PseudoMetricSpace β i ] ( x y : PiLp p β )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.instance
  ...
  "instance"
  []
  [(Command.declId `SemiNormedGroup [])]
  (Command.declSig
   [(Term.instBinder
     "["
     []
     (Term.forall "∀" [(Term.simpleBinder [`i] [])] "," (Term.app `SemiNormedGroup [(Term.app `β [`i])]))
     "]")]
   (Term.typeSpec ":" (Term.app `SemiNormedGroup [(Term.app `PiLp [`p `β])])))
  (Command.declValSimple
   ":="
   (Term.structInst
    "{"
        ...
        (Term.basicFun
         ...
         (Cardinal.SetTheory.Cofinality.«term_^_»
          (Algebra.BigOperators.Basic.«term∑_,_»
           ...
           (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] [":" `ι]))
           ", "
           (Cardinal.SetTheory.Cofinality.«term_^_» (Term.app `norm [(Term.app `f [`i])]) "^" `p))
          "^"
          («term_/_» (numLit "1") "/" `p)))))
      [","])
     (group
      (Term.structInstField
       (Term.structInstLVal `dist_eq [])
       ":="
       (Term.fun
        "fun"
        (Term.basicFun
...
/--
  ...
  instance
    SemiNormedGroup
    [ ∀ i , SemiNormedGroup β i ] : SemiNormedGroup PiLp p β
    :=
      {
        Pi.addCommGroup with
        norm := fun f => ∑ i : ι , norm f i ^ p ^ 1 / p ,
          dist_eq := fun x y => by simp [ PiLp.dist , dist_eq_norm , sub_eq_add_neg ]
        }
  ...
  (Command.declSig
   [(Term.implicitBinder "{" [`p] [":" (Data.Real.Basic.termℝ "ℝ")] "}")
    ...
    (Term.instBinder
     ...
     (Term.forall "∀" [(Term.simpleBinder [`i] [])] "," (Term.app `SemiNormedGroup [(Term.app `β [`i])]))
     "]")
    (Term.explicitBinder "(" [`f] [":" (Term.app `PiLp [`p `β])] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Cardinal.SetTheory.Cofinality.«term_^_»
   (Algebra.BigOperators.Basic.«term∑_,_»
    ...
    (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] [":" `ι]))
    ", "
    (Cardinal.SetTheory.Cofinality.«term_^_» (Analysis.Normed.Group.Basic.«term∥_∥» "∥" (Term.app `f [`i]) "∥") "^" `p))
   "^"
   («term_/_» (numLit "1") "/" `p))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Cardinal.SetTheory.Cofinality.«term_^_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
theorem
  norm_eq
  { p : ℝ } [ Fact 1 ≤ p ] { β : ι → Type _ } [ ∀ i , SemiNormedGroup β i ] ( f : PiLp p β )
    : ∥ f ∥ = ∑ i : ι , ∥ f i ∥ ^ p ^ 1 / p
  := rfl
 ...
 (Command.theorem
  ...
  (Command.declSig
   [(Term.implicitBinder "{" [`p] [":" (Data.Real.Basic.termℝ "ℝ")] "}")
    ...
    (Term.explicitBinder "(" [`h] [":" («term_=_» `p "=" `n)] [] ")")
    (Term.explicitBinder "(" [`f] [":" (Term.app `PiLp [`p `β])] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     ...
     (Cardinal.SetTheory.Cofinality.«term_^_»
      (Algebra.BigOperators.Basic.«term∑_,_»
       ...
       (Cardinal.SetTheory.Cofinality.«term_^_»
        ...
        `n))
      "^"
      («term_/_» (numLit "1") "/" (Term.paren "(" [`n [(Term.typeAscription ":" (Data.Real.Basic.termℝ "ℝ"))]] ")"))))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.simp
         ...
         []
         ["["
          [(Tactic.simpLemma [] [] `norm_eq)
           ","
           (Tactic.simpLemma [] [] `h)
           ","
           (Tactic.simpLemma [] [] `Real.sqrt_eq_rpow)
           ","
           (Tactic.simpLemma [] ["←"] `Real.rpow_nat_cast)]
          "]"]
         [])
        [])])))
   [])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Cardinal.SetTheory.Cofinality.«term_^_»
   (Algebra.BigOperators.Basic.«term∑_,_»
    ...
    (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] [":" `ι]))
    ", "
    (Cardinal.SetTheory.Cofinality.«term_^_» (Analysis.Normed.Group.Basic.«term∥_∥» "∥" (Term.app `f [`i]) "∥") "^" `n))
   "^"
   («term_/_» (numLit "1") "/" (Term.paren "(" [`n [(Term.typeAscription ":" (Data.Real.Basic.termℝ "ℝ"))]] ")")))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Cardinal.SetTheory.Cofinality.«term_^_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
theorem
  norm_eq_of_nat
  { p : ℝ } [ Fact 1 ≤ p ] { β : ι → Type _ } [ ∀ i , SemiNormedGroup β i ] ( n : ℕ ) ( h : p = n ) ( f : PiLp p β )
    : ∥ f ∥ = ∑ i : ι , ∥ f i ∥ ^ n ^ 1 / ( n : ℝ )
