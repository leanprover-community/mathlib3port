 ...
 (Command.theorem
  ...
  (Command.declSig
   [(Term.implicitBinder
     ...
     "}")
    (Term.implicitBinder "{" [`δ `K `ε] [":" (Data.Real.Basic.termℝ "ℝ")] "}")
    ...
    (Term.explicitBinder
     ...
     []
     ")")
    (Term.explicitBinder "(" [`ha] [":" («term_≤_» (Term.app `f [`a]) "≤" `δ)] [] ")")
    (Term.explicitBinder
     "("
     [`bound]
     [":"
       ...
       (Mathlib.ExtendedBinder.«term∀___,_»
        ...
        (Term.forall
         ...
         («term_≤_»
          (Term.app `f' [`x])
          "≤"
          (Init.Logic.«term_+_» (Finset.Data.Finset.Fold.«term_*_» `K "*" (Term.app `f [`x])) "+" `ε)))))]
     []
     ")")]
   (Term.typeSpec
    ":"
    (Term.forall
     ...
     (Mathlib.ExtendedBinder.«term∀___,_»
      ...
      (Term.forall
       ...
       []
       ","
       («term_≤_» (Term.app `f [`x]) "≤" (Term.app `gronwallBound [`δ `K `ε («term_-_» `x "-" `a)])))))))
     ...
     (Tactic.tacticSeq1Indented
      [(group
                 ...
                 (Mathlib.ExtendedBinder.«term∀___,_»
                  ...
                  (Term.forall
                   ...
                   («term_≤_»
                    (Term.app `f [`x])
                    "≤"
                    (Term.app `gronwallBound [`δ `K `ε' («term_-_» `x "-" `a)])))))))))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(group (Tactic.intro "intro" [`x `hx `ε' `hε']) [])
                     ...
                     (Tactic.exact
                      ...
                      (Term.fun
                       ...
                       (Term.basicFun
                        [(Term.simpleBinder [`x] [])]
                        "=>"
                        (Term.app `has_deriv_at_gronwall_bound_shift [`δ `K `ε' `x `a]))))
                     [])])))
                [])
               (group
                (Tactic.«tactic·._»
                 ...
                 (Tactic.tacticSeq
                  (Tactic.tacticSeq1Indented
                   [(group (Tactic.intro "intro" [`x `hx `hfB]) [])
                    (group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `hfB)] "]") []) [])
                    (group (Tactic.apply "apply" (Term.app `lt_of_le_of_ltₓ [(Term.app `bound [`x `hx])])) [])
                    (group (Tactic.exact "exact" (Term.app `add_lt_add_left [`hε' (Term.hole "_")])) [])])))
                [])
               (group
                (Tactic.«tactic·._»
                 "·"
       ...
       (group
        (Tactic.exact
         "exact"
         (Term.proj (Term.app `gronwall_bound_continuous_ε [`δ `K («term_-_» `x "-" `a)]) "." `ContinuousWithinAt))
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `gronwall_bound_continuous_ε [`δ `K («term_-_» `x "-" `a)])
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(«term_-_» `x "-" `a) []] ")")
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `gronwall_bound_continuous_ε [`δ `K (Term.paren "(" [(«term_-_» `x "-" `a) []] ")")]) []]
 ")")
  ...
  (Tactic.change
   ...
   («term_≤_»
    ...
    (Term.app
     (Term.fun
      "fun"
      (Term.basicFun [(Term.simpleBinder [`ε'] [])] "=>" (Term.app `gronwallBound [`δ `K `ε' («term_-_» `x "-" `a)])))
     [`ε]))
   [])
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(Term.fun
   ...
   (Term.basicFun
    [(Term.simpleBinder [`ε'] [])]
    "=>"
    (Term.app `gronwallBound [`δ `K `ε' (Term.paren "(" [(«term_-_» `x "-" `a) []] ")")])))
  []]
 ")")
    ...
    (Tactic.tacticSeq1Indented
     [(group (Tactic.intro "intro" [`x `hx `ε' `hε']) [])
      ...
      (group
       ...
       [])
      (group
       (Tactic.«tactic·._» "·" (Tactic.tacticSeq (Tactic.tacticSeq1Indented [(group (Tactic.exact "exact" `hx) [])])))
       [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.byTactic', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.byTactic', expected 'Lean.Parser.Term.byTactic.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq', expected 'Lean.Parser.Tactic.tacticSeq.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `add_lt_add_left [`hε' (Term.hole "_")]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `add_lt_add_left [`hε' (Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.apply "apply" (Term.app `lt_of_le_of_ltₓ [(Term.app `bound [`x `hx])]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.apply', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `lt_of_le_of_ltₓ [(Term.app `bound [`x `hx])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `hfB)] "]") [])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact
   ...
   (Term.fun
    "fun"
    (Term.basicFun [(Term.simpleBinder [`x] [])] "=>" (Term.app `has_deriv_at_gronwall_bound_shift [`δ `K `ε' `x `a]))))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.fun
   "fun"
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Mathlib.ExtendedBinder.«term∀___,_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.forall "∀" [] "," («term_≤_» (Term.app `f [`x]) "≤" (Term.app `gronwallBound [`δ `K `ε («term_-_» `x "-" `a)])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.forall', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.forall', expected 'Lean.Parser.Term.forall.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_≤_» (Term.app `f [`x]) "≤" (Term.app `gronwallBound [`δ `K `ε («term_-_» `x "-" `a)]))
...
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Finset.Data.Finset.Fold.«term_*_» `K "*" (Term.app `f [`x]))
            ...
            H
              ...
              by
                intro x hx ε' hε'
                  ...
                  · intro x hx hfB rw [ ← hfB ] apply lt_of_le_of_ltₓ bound x hx exact add_lt_add_left hε' _
                  · exact hx
          intro x hx
...
-- ././Mathport/Syntax/Translate/Basic.lean:477:2: warning: expanding binder collection (x y «expr ∈ » s t)
