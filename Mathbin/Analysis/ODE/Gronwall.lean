...
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (ε' «expr ∈ » Ioi ε)
...
theorem le_gronwall_bound_of_liminf_deriv_right_le {f f' : ℝ → ℝ} {δ K ε : ℝ} {a b : ℝ} (hf : ContinuousOn f (Icc a b))
  (hf' : ∀ x _ : x ∈ Ico a b, ∀ r, f' x < r → ∃ᶠ z in 𝓝[Ioi x] x, ((z - x)⁻¹*f z - f x) < r) (ha : f a ≤ δ)
  (bound : ∀ x _ : x ∈ Ico a b, f' x ≤ (K*f x)+ε) : ∀ x _ : x ∈ Icc a b, f x ≤ gronwallBound δ K ε (x - a) :=
  by 
    have H : ∀ x _ : x ∈ Icc a b, ∀ ε' _ : ε' ∈ Ioi ε, f x ≤ gronwallBound δ K ε' (x - a)
    ·
      intro x hx ε' hε' 
...
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (t «expr ∈ » Ico a b)
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x y «expr ∈ » s t)
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (t «expr ∈ » Ico a b)
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (t «expr ∈ » Ico a b)
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (t «expr ∈ » Ico a b)
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (t «expr ∈ » Ico a b)
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (t «expr ∈ » Ico a b)
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (t «expr ∈ » Ico a b)
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (t «expr ∈ » Icc a b)
...
theorem dist_le_of_approx_trajectories_ODE_of_mem_set {v : ℝ → E → E} {s : ℝ → Set E} {K : ℝ}
  ...
  {εf εg δ : ℝ} (hf : ContinuousOn f (Icc a b)) (hf' : ∀ t _ : t ∈ Ico a b, HasDerivWithinAt f (f' t) (Ici t) t)
  (f_bound : ∀ t _ : t ∈ Ico a b, dist (f' t) (v t (f t)) ≤ εf) (hfs : ∀ t _ : t ∈ Ico a b, f t ∈ s t)
  (hg : ContinuousOn g (Icc a b)) (hg' : ∀ t _ : t ∈ Ico a b, HasDerivWithinAt g (g' t) (Ici t) t)
  (g_bound : ∀ t _ : t ∈ Ico a b, dist (g' t) (v t (g t)) ≤ εg) (hgs : ∀ t _ : t ∈ Ico a b, g t ∈ s t)
  (ha : dist (f a) (g a) ≤ δ) : ∀ t _ : t ∈ Icc a b, dist (f t) (g t) ≤ gronwallBound δ K (εf+εg) (t - a) :=
  by 
    simp only [dist_eq_norm] at ha⊢
    have h_deriv : ∀ t _ : t ∈ Ico a b, HasDerivWithinAt (fun t => f t - g t) (f' t - g' t) (Ici t) t 
...
theorem dist_le_of_trajectories_ODE_of_mem_set {v : ℝ → E → E} {s : ℝ → Set E} {K : ℝ}
  ...
  (hfs : ∀ t _ : t ∈ Ico a b, f t ∈ s t) (hg : ContinuousOn g (Icc a b))
  (hg' : ∀ t _ : t ∈ Ico a b, HasDerivWithinAt g (v t (g t)) (Ici t) t) (hgs : ∀ t _ : t ∈ Ico a b, g t ∈ s t)
  (ha : dist (f a) (g a) ≤ δ) : ∀ t _ : t ∈ Icc a b, dist (f t) (g t) ≤ δ*exp (K*t - a) :=
  by 
    have f_bound : ∀ t _ : t ∈ Ico a b, dist (v t (f t)) (v t (f t)) ≤ 0
    ·
      ·
        intros 
        rw [dist_self]
    have g_bound : ∀ t _ : t ∈ Ico a b, dist (v t (g t)) (v t (g t)) ≤ 0
    ·
      ·
        intros 
        rw [dist_self]
