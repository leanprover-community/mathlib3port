...
theorem HasCompactSupport.continuous_convolution_right [FirstCountableTopology G]
  ...
  · apply eventually_of_forall fun x => _
    exact (HasCompactSupport.convolutionExistsRight L hcg hf hg x).AeStronglyMeasurable
