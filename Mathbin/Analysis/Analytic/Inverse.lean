        ...
        ext n v
          ...
          ·
            simp only [ left_inv , ContinuousMultilinearMap.neg_apply , neg_inj , ContinuousMultilinearMap.sum_apply ]
              ...
              simp
                only
                [ comp_continuous_linear_map_apply_composition , ContinuousMultilinearMap.comp_along_composition_apply ]
              congr
              ext c
              congr
              ext k
  ...
  :=
    by
      have
        ...
        · apply p.congr Composition.single_length hn fun j hj1 hj2 => _ simp [ apply_composition_single ]
...
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (k «expr ∈ » Ico 1 «expr + »(n, 1))
