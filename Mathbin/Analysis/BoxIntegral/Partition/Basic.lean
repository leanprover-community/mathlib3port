...
theorem disjointCoeOfMem (h₁ : J₁ ∈ π) (h₂ : J₂ ∈ π) (h : J₁ ≠ J₂) : Disjoint (J₁ : Set (ι → ℝ)) J₂ :=
  π.PairwiseDisjoint h₁ h₂ h

theorem eq_of_mem_of_mem (h₁ : J₁ ∈ π) (h₂ : J₂ ∈ π) (hx₁ : x ∈ J₁) (hx₂ : x ∈ J₂) : J₁ = J₂ :=
  by_contra fun H => π.disjointCoeOfMem h₁ h₂ H ⟨hx₁, hx₂⟩
...
theorem disjointBoxesOfDisjointUnion (h : Disjoint π₁.UnionCat π₂.UnionCat) : Disjoint π₁.boxes π₂.boxes :=
  ...
  ofWithBot (π.boxes.Image fun J' => J ⊓ J')
    ...
    (by
      ...
      have : J₁ ≠ J₂ := by
        rintro rfl
        exact Hne rfl
      exact ((box.disjoint_coe.2 <| π.disjoint_coe_of_mem h₁ h₂ this).infLeft' _).infRight' _)
...
def filter (π : Prepartition I) (p : Box ι → Prop) : Prepartition I where
  ...
  PairwiseDisjoint J₁ h₁ J₂ h₂ := π.disjointCoeOfMem (mem_filter.1 h₁).1 (mem_filter.1 h₂).1
...
theorem sum_disj_union_boxes {M : Type _} [AddCommMonoid M] (h : Disjoint π₁.UnionCat π₂.UnionCat) (f : Box ι → M) :
  ...
  sum_union <| disjointBoxesOfDisjointUnion h
