...
protected theorem MemBaseSet.unionComplToSubordinate (hπ₁ : l.MemBaseSet I c r₁ π₁) (hle : ∀ x ∈ I.icc, r₂ x ≤ r₁ x)
    {π₂ : Prepartition I} (hU : π₂.union = I \ π₁.union) (hc : l.bDistortion → π₂.distortion ≤ c) :
