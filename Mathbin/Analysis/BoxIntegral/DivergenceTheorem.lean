...
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » Icc (I.lower i) (I.upper i))
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (y «expr ∈ » (I.face i).Icc)
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (y «expr ∈ » I.Icc)
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (z «expr ∈ » Icc (I.lower i) (I.upper i))
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (y «expr ∈ » I.Icc)
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (y «expr ∈ » I.Icc)
...
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (y₁ y₂ «expr ∈ » «expr ∩ »(closed_ball x δ, I.Icc))
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » Icc (J.lower i) (J.upper i))
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (z «expr ∈ » Icc (J.lower i) (J.upper i))
...
theorem has_integral_bot_pderiv (f : ℝⁿ⁺¹ → E) (f' : ℝⁿ⁺¹ → ℝⁿ⁺¹ →L[ℝ] E) (s : Set ℝⁿ⁺¹) (hs : countable s)
  (Hs : ∀ x _ : x ∈ s, ContinuousWithinAt f I.Icc x) (Hd : ∀ x _ : x ∈ I.Icc \ s, HasFderivWithinAt f (f' x) I.Icc x)
  (i : Finₓ (n+1)) :
  ...
  by 
    ...
    ·
      ...
      ·
        ...
        ·
          rcases((nhds_within_has_basis nhds_basis_closed_ball _).tendsto_iff nhds_basis_closed_ball).1 (Hs x hx.2) _
            ...
            ⟨δ₁, δ₁0, hδ₁⟩
          filterUpwards [Ioc_mem_nhds_within_Ioi ⟨le_rfl, δ₁0⟩]
      ...
      have Hmaps :
        ∀ z _ : z ∈ Icc (J.lower i) (J.upper i), maps_to (i.insert_nth z) (J.face i).Icc (closed_ball x δ ∩ I.Icc)
      ...
      ·
        simpRw [box_additive_map.volume_apply, norm_smul, Real.norm_eq_abs, abs_prod]
        ...
        calc (∏ j, |J.upper j - J.lower j|) ≤ ∏ j : Finₓ (n+1), 2*δ :=
          prod_le_prod (fun _ _ => abs_nonneg _) fun j hj => this j _ = ((2*δ)^n+1) :=
          by 
            simp 
      ·
