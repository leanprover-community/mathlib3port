...
instance :
    CoeFun (HilbertBasis ι 𝕜 E) fun _ => ι → E where coe b i := b.repr.symm (lp.single 2 i (1 : 𝕜))
...
protected theorem has_sum_orthogonal_projection {U : Submodule 𝕜 E} [CompleteSpace U]
