...
theorem left_adjoint_uniq_trans {F F' F'' : C ⥤ D} {G : D ⥤ C} (adj1 : F ⊣ G) (adj2 : F' ⊣ G) (adj3 : F'' ⊣ G) :
  (left_adjoint_uniq adj1 adj2).Hom ≫ (left_adjoint_uniq adj2 adj3).Hom = (left_adjoint_uniq adj1 adj3).Hom :=
  by 
    ext 
    apply Quiver.Hom.op_inj 
    apply coyoneda.map_injective 
...
@[simp]
theorem left_adjoint_uniq_refl {F : C ⥤ D} {G : D ⥤ C} (adj1 : F ⊣ G) : (left_adjoint_uniq adj1 adj1).Hom = 𝟙 _ :=
  by 
    ext 
    apply Quiver.Hom.op_inj 
    apply coyoneda.map_injective 
...
theorem right_adjoint_uniq_trans {F : C ⥤ D} {G G' G'' : D ⥤ C} (adj1 : F ⊣ G) (adj2 : F ⊣ G') (adj3 : F ⊣ G'') :
  (right_adjoint_uniq adj1 adj2).Hom ≫ (right_adjoint_uniq adj2 adj3).Hom = (right_adjoint_uniq adj1 adj3).Hom :=
  by 
    ext 
    simp 

@[simp]
theorem right_adjoint_uniq_refl {F : C ⥤ D} {G : D ⥤ C} (adj1 : F ⊣ G) : (right_adjoint_uniq adj1 adj1).Hom = 𝟙 _ :=
  by 
