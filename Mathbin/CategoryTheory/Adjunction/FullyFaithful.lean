...
#print CategoryTheory.Adjunction.unit_isIso_of_L_fully_faithful /-
...
-/
instance CategoryTheory.Adjunction.unit_isIso_of_L_fully_faithful [CategoryTheory.Functor.Full L]
...
#print CategoryTheory.Adjunction.counit_isIso_of_R_fully_faithful /-
/-- If the right adjoint is fully faithful, then the counit is an isomorphism.

See <https://stacks.math.columbia.edu/tag/07RB> (we only prove the forward direction!)
-/
instance CategoryTheory.Adjunction.counit_isIso_of_R_fully_faithful [CategoryTheory.Functor.Full R]
...
#print CategoryTheory.Adjunction.whiskerLeftLCounitIsoOfIsIsoUnit /-
/-- If the unit is an isomorphism, bundle one has an isomorphism `L ⋙ R ⋙ L ≅ L`. -/
@[simps]
noncomputable def CategoryTheory.Adjunction.whiskerLeftLCounitIsoOfIsIsoUnit [IsIso h.Unit] :
    L ⋙ R ⋙ L ≅ L :=
...
#print CategoryTheory.Adjunction.whiskerLeftRUnitIsoOfIsIsoCounit /-
/-- If the counit of an is an isomorphism, one has an isomorphism `(R ⋙ L ⋙ R) ≅ R`. -/
@[simps]
noncomputable def CategoryTheory.Adjunction.whiskerLeftRUnitIsoOfIsIsoCounit [IsIso h.counit] :
    R ⋙ L ⋙ R ≅ R :=
...
instance CategoryTheory.Adjunction.whiskerLeft_counit_iso_of_L_fully_faithful
    [CategoryTheory.Functor.Full L] [CategoryTheory.Functor.Faithful L] :
...
#print CategoryTheory.Adjunction.whiskerRight_counit_iso_of_L_fully_faithful /-
instance CategoryTheory.Adjunction.whiskerRight_counit_iso_of_L_fully_faithful
    [CategoryTheory.Functor.Full L] [CategoryTheory.Functor.Faithful L] :
...
#print CategoryTheory.Adjunction.whiskerLeft_unit_iso_of_R_fully_faithful /-
instance CategoryTheory.Adjunction.whiskerLeft_unit_iso_of_R_fully_faithful
...
#print CategoryTheory.Adjunction.whiskerRight_unit_iso_of_R_fully_faithful /-
instance CategoryTheory.Adjunction.whiskerRight_unit_iso_of_R_fully_faithful
    [CategoryTheory.Functor.Full R] [CategoryTheory.Functor.Faithful R] :
  ...
  Adjunction.mkOfHomEquiv
    { homEquiv := fun X Y =>
        calc
          ...
          _ ≃ (iC.obj X ⟶ R'.obj (iD.obj Y)) := (MonCat.adj.homEquiv _ _)
