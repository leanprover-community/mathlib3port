...
instance unit_is_iso_of_L_fully_faithful [full L] [faithful L] : is_iso (adjunction.unit h) :=
  @nat_iso.is_iso_of_is_iso_app _ _ _ _ _ _ (adjunction.unit h) $ fun X =>
...
instance counit_is_iso_of_R_fully_faithful [full R] [faithful R] : is_iso (adjunction.counit h) :=
  @nat_iso.is_iso_of_is_iso_app _ _ _ _ _ _ (adjunction.counit h) $ fun X =>
...
instance whisker_left_counit_iso_of_L_fully_faithful [full L] [faithful L] : is_iso (whisker_left L h.counit) := by
  have := h.left_triangle
  rw [← is_iso.eq_inv_comp] at this
  rw [this]
  infer_instance

instance whisker_right_counit_iso_of_L_fully_faithful [full L] [faithful L] : is_iso (whisker_right h.counit R) := by
  have := h.right_triangle
  rw [← is_iso.eq_inv_comp] at this
  rw [this]
  infer_instance

instance whisker_left_unit_iso_of_R_fully_faithful [full R] [faithful R] : is_iso (whisker_left R h.unit) := by
  have := h.right_triangle
  rw [← is_iso.eq_comp_inv] at this
  rw [this]
  infer_instance

instance whisker_right_unit_iso_of_R_fully_faithful [full R] [faithful R] : is_iso (whisker_right h.unit L) := by
  have := h.left_triangle
  rw [← is_iso.eq_comp_inv] at this
  rw [this]
  infer_instance
