...
#align category_theory.presieve.pullback_compatible_iff CategoryTheory.Presieve.pullback_compatible_iff
...
#align category_theory.presieve.family_of_elements.compatible.sieve_extend CategoryTheory.Presieve.FamilyOfElements.Compatible.sieve_extend
...
#align category_theory.presieve.compatible_iff_sieve_compatible CategoryTheory.Presieve.compatible_iff_sieve_compatible
...
#align category_theory.presieve.family_of_elements.compatible.to_sieve_compatible CategoryTheory.Presieve.FamilyOfElements.Compatible.to_sieve_compatible
...
#align category_theory.presieve.family_of_elements.compatible.functor_pullback CategoryTheory.Presieve.FamilyOfElements.Compatible.functor_pullback
...
theorem FamilyOfElements.comp_presheaf_map_id (x : FamilyOfElements P R) :
  ...
  rfl
#align category_theory.presieve.family_of_elements.comp_presheaf_map_id CategoryTheory.Presieve.FamilyOfElements.comp_presheaf_map_id
...
#align category_theory.presieve.family_of_elements.compatible.comp_presheaf_map CategoryTheory.Presieve.FamilyOfElements.Compatible.comp_presheaf_map
...
#align category_theory.presieve.family_of_elements.is_amalgamation.comp_presheaf_map CategoryTheory.Presieve.FamilyOfElements.IsAmalgamation.comp_presheaf_map
...
theorem is_amalgamation_restrict {R₁ R₂ : Presieve X} (h : R₁ ≤ R₂) (x : FamilyOfElements P R₂)
  ...
  ht f (h Y hf)
#align category_theory.presieve.is_amalgamation_restrict CategoryTheory.Presieve.is_amalgamation_restrict
...
#align category_theory.presieve.is_amalgamation_sieve_extend CategoryTheory.Presieve.is_amalgamation_sieve_extend
...
theorem is_separated_for_iff_generate : IsSeparatedFor P R ↔ IsSeparatedFor P (generate R) :=
  ...
  · intro h x t₁ t₂ ht₁ ht₂
    ...
    · exact is_amalgamation_sieve_extend x t₂ ht₂
#align category_theory.presieve.is_separated_for_iff_generate CategoryTheory.Presieve.is_separated_for_iff_generate
...
theorem is_sheaf_for_iff_yoneda_sheaf_condition {P : Cᵒᵖ ⥤ Type v₁} :
  ...
  simp
#align category_theory.presieve.is_sheaf_for_iff_yoneda_sheaf_condition CategoryTheory.Presieve.is_sheaf_for_iff_yoneda_sheaf_condition
...
#align category_theory.presieve.is_sheaf_for.functor_inclusion_comp_extend CategoryTheory.Presieve.IsSheafFor.functor_inclusion_comp_extend
...
#align category_theory.presieve.is_separated_for_and_exists_is_amalgamation_iff_sheaf_for CategoryTheory.Presieve.is_separated_for_and_exists_is_amalgamation_iff_sheaf_for
...
theorem IsSeparatedFor.is_sheaf_for (t : IsSeparatedFor P R) :
  ...
  exact And.intro t
#align category_theory.presieve.is_separated_for.is_sheaf_for CategoryTheory.Presieve.IsSeparatedFor.is_sheaf_for
...
#align category_theory.presieve.is_sheaf_for.is_separated_for CategoryTheory.Presieve.IsSheafFor.is_separated_for
...
#align category_theory.presieve.is_sheaf_for.is_amalgamation CategoryTheory.Presieve.IsSheafFor.is_amalgamation
...
#align category_theory.presieve.is_sheaf_for_iff_generate CategoryTheory.Presieve.is_sheaf_for_iff_generate
...
#align category_theory.presieve.is_sheaf_for_singleton_iso CategoryTheory.Presieve.is_sheaf_for_singleton_iso
...
#align category_theory.presieve.is_sheaf_for_top_sieve CategoryTheory.Presieve.is_sheaf_for_top_sieve
...
theorem is_sheaf_for_subsieve_aux (P : Cᵒᵖ ⥤ Type w) {S : Sieve X} {R : Presieve X}
  ...
  · intro x hx
    ...
    simp
#align category_theory.presieve.is_sheaf_for_subsieve_aux CategoryTheory.Presieve.is_sheaf_for_subsieve_aux
...
#align category_theory.presieve.is_separated_of_is_sheaf CategoryTheory.Presieve.is_separated_of_is_sheaf
