...
#align
  category_theory.presieve.family_of_elements.restrict CategoryTheory.Presieve.FamilyOfElements.restrict
...
#align
  category_theory.presieve.family_of_elements.compatible CategoryTheory.Presieve.FamilyOfElements.Compatible
...
#align
  category_theory.presieve.family_of_elements.pullback_compatible CategoryTheory.Presieve.FamilyOfElements.PullbackCompatible

theorem pullback_compatible_iff (x : FamilyOfElements P R) [HasPullbacks C] :
...
#align
  category_theory.presieve.pullback_compatible_iff CategoryTheory.Presieve.pullback_compatible_iff
...
#align
  category_theory.presieve.family_of_elements.compatible.restrict CategoryTheory.Presieve.FamilyOfElements.Compatible.restrict
...
#align
  category_theory.presieve.family_of_elements.sieve_extend CategoryTheory.Presieve.FamilyOfElements.sieveExtend
...
#align
  category_theory.presieve.family_of_elements.compatible.sieve_extend CategoryTheory.Presieve.FamilyOfElements.Compatible.sieve_extend
...
#align
  category_theory.presieve.family_of_elements.sieve_compatible CategoryTheory.Presieve.FamilyOfElements.SieveCompatible

theorem compatible_iff_sieve_compatible (x : FamilyOfElements P S) :
...
#align
  category_theory.presieve.compatible_iff_sieve_compatible CategoryTheory.Presieve.compatible_iff_sieve_compatible

theorem FamilyOfElements.Compatible.to_sieve_compatible {x : FamilyOfElements P S}
    (t : x.Compatible) : x.SieveCompatible :=
  (compatible_iff_sieve_compatible x).1 t
#align
  category_theory.presieve.family_of_elements.compatible.to_sieve_compatible CategoryTheory.Presieve.FamilyOfElements.Compatible.to_sieve_compatible
...
#align
  category_theory.presieve.compatible_equiv_generate_sieve_compatible CategoryTheory.Presieve.compatibleEquivGenerateSieveCompatible
...
#align
  category_theory.presieve.family_of_elements.comp_of_compatible CategoryTheory.Presieve.FamilyOfElements.comp_of_compatible
...
theorem FamilyOfElements.Compatible.functor_pullback (h : x.Compatible) :
    (x.functorPullback F).Compatible :=
  by
  intro Z₁ Z₂ W g₁ g₂ f₁ f₂ h₁ h₂ eq
  exact h (F.map g₁) (F.map g₂) h₁ h₂ (by simp only [← F.map_comp, Eq])
#align
  category_theory.presieve.family_of_elements.compatible.functor_pullback CategoryTheory.Presieve.FamilyOfElements.Compatible.functor_pullback
...
#align
  category_theory.presieve.family_of_elements.functor_pushforward CategoryTheory.Presieve.FamilyOfElements.functorPushforward
...
#align
  category_theory.presieve.family_of_elements.pullback CategoryTheory.Presieve.FamilyOfElements.pullback
...
theorem FamilyOfElements.Compatible.pullback (f : Y ⟶ X) {x : FamilyOfElements P S}
  ...
  simp only [assoc]
#align
  category_theory.presieve.family_of_elements.compatible.pullback CategoryTheory.Presieve.FamilyOfElements.Compatible.pullback
...
#align
  category_theory.presieve.family_of_elements.comp_presheaf_map CategoryTheory.Presieve.FamilyOfElements.compPresheafMap

@[simp]
theorem FamilyOfElements.comp_presheaf_map_id (x : FamilyOfElements P R) :
    x.compPresheafMap (𝟙 P) = x :=
  rfl
#align
  category_theory.presieve.family_of_elements.comp_presheaf_map_id CategoryTheory.Presieve.FamilyOfElements.comp_presheaf_map_id
...
theorem FamilyOfElements.comp_prersheaf_map_comp (x : FamilyOfElements P R) (f : P ⟶ Q)
  ...
  rfl
#align
  category_theory.presieve.family_of_elements.comp_prersheaf_map_comp CategoryTheory.Presieve.FamilyOfElements.comp_prersheaf_map_comp

theorem FamilyOfElements.Compatible.comp_presheaf_map (f : P ⟶ Q) {x : FamilyOfElements P R}
...
#align
  category_theory.presieve.family_of_elements.compatible.comp_presheaf_map CategoryTheory.Presieve.FamilyOfElements.Compatible.comp_presheaf_map
...
#align
  category_theory.presieve.family_of_elements.is_amalgamation CategoryTheory.Presieve.FamilyOfElements.IsAmalgamation
...
#align
  category_theory.presieve.family_of_elements.is_amalgamation.comp_presheaf_map CategoryTheory.Presieve.FamilyOfElements.IsAmalgamation.comp_presheaf_map
...
theorem is_compatible_of_exists_amalgamation (x : FamilyOfElements P R)
  ...
  simp
#align
  category_theory.presieve.is_compatible_of_exists_amalgamation CategoryTheory.Presieve.is_compatible_of_exists_amalgamation

theorem is_amalgamation_restrict {R₁ R₂ : Presieve X} (h : R₁ ≤ R₂) (x : FamilyOfElements P R₂)
    (t : P.obj (op X)) (ht : x.IsAmalgamation t) : (x.restrict h).IsAmalgamation t := fun Y f hf =>
  ht f (h Y hf)
#align
  category_theory.presieve.is_amalgamation_restrict CategoryTheory.Presieve.is_amalgamation_restrict
...
#align
  category_theory.presieve.is_amalgamation_sieve_extend CategoryTheory.Presieve.is_amalgamation_sieve_extend
...
theorem is_separated_for_iff_generate : IsSeparatedFor P R ↔ IsSeparatedFor P (generate R) :=
  by
  constructor
  · intro h x t₁ t₂ ht₁ ht₂
  ...
  · intro h x t₁ t₂ ht₁ ht₂
    ...
    · exact is_amalgamation_sieve_extend x t₂ ht₂
#align
  category_theory.presieve.is_separated_for_iff_generate CategoryTheory.Presieve.is_separated_for_iff_generate

theorem is_separated_for_top (P : Cᵒᵖ ⥤ Type w) : IsSeparatedFor P (⊤ : Presieve X) :=
  fun x t₁ t₂ h₁ h₂ => by
  have q₁ := h₁ (𝟙 X) (by simp)
  have q₂ := h₂ (𝟙 X) (by simp)
  simp only [op_id, functor_to_types.map_id_apply] at q₁ q₂
  rw [q₁, q₂]
#align category_theory.presieve.is_separated_for_top CategoryTheory.Presieve.is_separated_for_top
...
def natTransEquivCompatibleFamily {P : Cᵒᵖ ⥤ Type v₁} :
  ...
  right_inv := by
    ...
    rfl
#align
  category_theory.presieve.nat_trans_equiv_compatible_family CategoryTheory.Presieve.natTransEquivCompatibleFamily
...
theorem extension_iff_amalgamation {P : Cᵒᵖ ⥤ Type v₁} (x : S.Functor ⟶ P) (g : yoneda.obj X ⟶ P) :
  ...
  · intro h
    ...
    simp
#align
  category_theory.presieve.extension_iff_amalgamation CategoryTheory.Presieve.extension_iff_amalgamation
...
C2.1.4 of [Elephant].
-/
theorem is_sheaf_for_iff_yoneda_sheaf_condition {P : Cᵒᵖ ⥤ Type v₁} :
  ...
  simp
#align
  category_theory.presieve.is_sheaf_for_iff_yoneda_sheaf_condition CategoryTheory.Presieve.is_sheaf_for_iff_yoneda_sheaf_condition
...
#align
  category_theory.presieve.is_sheaf_for.functor_inclusion_comp_extend CategoryTheory.Presieve.IsSheafFor.functor_inclusion_comp_extend
...
#align
  category_theory.presieve.is_sheaf_for.unique_extend CategoryTheory.Presieve.IsSheafFor.unique_extend
...
#align
  category_theory.presieve.is_separated_for_and_exists_is_amalgamation_iff_sheaf_for CategoryTheory.Presieve.is_separated_for_and_exists_is_amalgamation_iff_sheaf_for
...
theorem IsSeparatedFor.is_sheaf_for (t : IsSeparatedFor P R) :
  ...
  exact And.intro t
#align
  category_theory.presieve.is_separated_for.is_sheaf_for CategoryTheory.Presieve.IsSeparatedFor.is_sheaf_for
...
#align
  category_theory.presieve.is_sheaf_for.is_separated_for CategoryTheory.Presieve.IsSheafFor.is_separated_for
...
noncomputable def IsSheafFor.amalgamate (t : IsSheafFor P R) (x : FamilyOfElements P R)
  ...
  (t x hx).exists.some
#align
  category_theory.presieve.is_sheaf_for.amalgamate CategoryTheory.Presieve.IsSheafFor.amalgamate

theorem IsSheafFor.is_amalgamation (t : IsSheafFor P R) {x : FamilyOfElements P R}
    (hx : x.Compatible) : x.IsAmalgamation (t.amalgamate x hx) :=
  (t x hx).exists.some_spec
#align
  category_theory.presieve.is_sheaf_for.is_amalgamation CategoryTheory.Presieve.IsSheafFor.is_amalgamation
...
#align
  category_theory.presieve.is_sheaf_for.valid_glue CategoryTheory.Presieve.IsSheafFor.valid_glue

/-- C2.1.3 in [Elephant] -/
theorem is_sheaf_for_iff_generate (R : Presieve X) : IsSheafFor P R ↔ IsSheafFor P (generate R) :=
  by
  rw [← is_separated_for_and_exists_is_amalgamation_iff_sheaf_for]
  rw [← is_separated_for_and_exists_is_amalgamation_iff_sheaf_for]
...
#align
  category_theory.presieve.is_sheaf_for_iff_generate CategoryTheory.Presieve.is_sheaf_for_iff_generate

/-- Every presheaf is a sheaf for the family {𝟙 X}.

[Elephant] C2.1.5(i)
-/
theorem is_sheaf_for_singleton_iso (P : Cᵒᵖ ⥤ Type w) : IsSheafFor P (Presieve.singleton (𝟙 X)) :=
  by
  intro x hx
...
#align
  category_theory.presieve.is_sheaf_for_singleton_iso CategoryTheory.Presieve.is_sheaf_for_singleton_iso

/-- Every presheaf is a sheaf for the maximal sieve.

[Elephant] C2.1.5(ii)
-/
theorem is_sheaf_for_top_sieve (P : Cᵒᵖ ⥤ Type w) : IsSheafFor P ((⊤ : Sieve X) : Presieve X) :=
  by
  rw [← generate_of_singleton_is_split_epi (𝟙 X)]
  rw [← is_sheaf_for_iff_generate]
  apply is_sheaf_for_singleton_iso
#align
  category_theory.presieve.is_sheaf_for_top_sieve CategoryTheory.Presieve.is_sheaf_for_top_sieve
...
-/
theorem is_sheaf_for_iso {P' : Cᵒᵖ ⥤ Type w} (i : P ≅ P') : IsSheafFor P R → IsSheafFor P' R :=
  by
  intro h x hx
...
#align category_theory.presieve.is_sheaf_for_iso CategoryTheory.Presieve.is_sheaf_for_iso
...
-/
theorem is_sheaf_for_subsieve_aux (P : Cᵒᵖ ⥤ Type w) {S : Sieve X} {R : Presieve X}
  ...
  · intro x hx
    ...
    simp
#align
  category_theory.presieve.is_sheaf_for_subsieve_aux CategoryTheory.Presieve.is_sheaf_for_subsieve_aux
...
-/
theorem is_sheaf_for_subsieve (P : Cᵒᵖ ⥤ Type w) {S : Sieve X} {R : Presieve X}
...
#align category_theory.presieve.is_sheaf_for_subsieve CategoryTheory.Presieve.is_sheaf_for_subsieve
...
theorem IsSheaf.is_sheaf_for {P : Cᵒᵖ ⥤ Type w} (hp : IsSheaf J P) (R : Presieve X)
...
theorem is_sheaf_of_le (P : Cᵒᵖ ⥤ Type w) {J₁ J₂ : GrothendieckTopology C} :
    J₁ ≤ J₂ → IsSheaf J₂ P → IsSheaf J₁ P := fun h t X S hS => t S (h _ hS)
#align category_theory.presieve.is_sheaf_of_le CategoryTheory.Presieve.is_sheaf_of_le

theorem is_separated_of_is_sheaf (P : Cᵒᵖ ⥤ Type w) (h : IsSheaf J P) : IsSeparated J P :=
  fun X S hS => (h S hS).IsSeparatedFor
#align
  category_theory.presieve.is_separated_of_is_sheaf CategoryTheory.Presieve.is_separated_of_is_sheaf

/-- The property of being a sheaf is preserved by isomorphism. -/
theorem is_sheaf_iso {P' : Cᵒᵖ ⥤ Type w} (i : P ≅ P') (h : IsSheaf J P) : IsSheaf J P' :=
  fun X S hS => is_sheaf_for_iso i (h S hS)
#align category_theory.presieve.is_sheaf_iso CategoryTheory.Presieve.is_sheaf_iso

theorem is_sheaf_of_yoneda {P : Cᵒᵖ ⥤ Type v₁}
    (h : ∀ {X} (S : Sieve X), S ∈ J X → YonedaSheafCondition P S) : IsSheaf J P := fun X S hS =>
  is_sheaf_for_iff_yoneda_sheaf_condition.2 (h _ hS)
#align category_theory.presieve.is_sheaf_of_yoneda CategoryTheory.Presieve.is_sheaf_of_yoneda
...
#align category_theory.presieve.is_sheaf_pretopology CategoryTheory.Presieve.is_sheaf_pretopology

/-- Any presheaf is a sheaf for the bottom (trivial) grothendieck topology. -/
theorem is_sheaf_bot : IsSheaf (⊥ : GrothendieckTopology C) P := fun X => by
  simp [is_sheaf_for_top_sieve]
#align category_theory.presieve.is_sheaf_bot CategoryTheory.Presieve.is_sheaf_bot
...
#align
  category_theory.equalizer.sieve.equalizer_sheaf_condition CategoryTheory.Equalizer.Sieve.equalizer_sheaf_condition
...
#align
  category_theory.equalizer.presieve.compatible_iff CategoryTheory.Equalizer.Presieve.compatible_iff
...
theorem sheaf_condition : R.IsSheafFor P ↔ Nonempty (IsLimit (Fork.ofι _ (w P R))) :=
  ...
  · intro q Y f hf
    ...
    simp [fork_map]
#align
  category_theory.equalizer.presieve.sheaf_condition CategoryTheory.Equalizer.Presieve.sheaf_condition
...
def sheafOfTypesBotEquiv : SheafOfTypesCat (⊥ : GrothendieckTopology C) ≌ Cᵒᵖ ⥤ Type w
  ...
  inverse :=
    { obj := fun P => ⟨P, Presieve.is_sheaf_bot⟩
