      ...
      (Command.declSig
       [(Term.implicitBinder "{" [`K] [":" (CategoryTheory.CategoryTheory.Functor.Basic.«term_⥤_» `J " ⥤ " `C)] "}")
        ...
        (Term.explicitBinder
         ...
         []
         ")")]
       (Term.typeSpec ":" (Init.Core.«term_=_» `f₁ " = " `f₂)))
        ...
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(Tactic.tacticLet_
           ...
           (Tactic.tacticHave_
            ...
            (Term.haveDecl
             (Term.haveIdDecl
              ...
              [(Term.typeSpec
                ":"
                (Init.Core.«term_=_» (Term.app `c.extend [`g₁.right]) " = " (Term.app `c.extend [`g₂.right])))]
              ":="
              (Term.byTactic
               "by"
               (Tactic.tacticSeq
           ...
           []
           (Mathlib.Tactic.tacticHave_ "have" [] [(Term.typeSpec ":" (Init.Core.«term_=_» `g₁.right " = " `g₂.right))])
           []
           (calcTactic
            "calc"
            (calcStep
             (Init.Core.«term_=_» `g₁.right " = " (Term.app `hc.lift [(Term.app `c.extend [`g₁.right])]))
             ":="
             (Term.byTactic
              "by"
              (Tactic.tacticSeq
               (Tactic.tacticSeq1Indented
                [(Tactic.apply "apply" (Term.app `hc.uniq [(Term.app `c.extend [(Term.hole "_")])]))
                 ...
                 (Tactic.tidy "tidy" [])]))))
            [(calcStep
              (Init.Core.«term_=_» (Term.hole "_") " = " (Term.app `hc.lift [(Term.app `c.extend [`g₂.right])]))
              ":="
              (Term.byTactic
               "by"
               (Tactic.tacticSeq
             ...
             (calcStep
              (Init.Core.«term_=_» (Term.hole "_") " = " `g₂.right)
              ":="
              (Term.byTactic
               "by"
               (Tactic.tacticSeq
           ...
           (calcTactic
            ...
            [(calcStep
             ...
             (calcStep
              ...
              `g₂.w.symm)
             (calcStep
              (Init.Core.«term_=_» (Term.hole "_") " = " `f₂)
              ":="
              (Term.byTactic
               "by"
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Mathlib.Tactic.tacticHave_ "have" [] [(Term.typeSpec ":" (Init.Core.«term_=_» `g₁.right " = " `g₂.right))])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Init.Core.«term_=_» `g₁.right " = " `g₂.right)
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `g₂.right
[PrettyPrinter.parenthesize] ...precedences are 51 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 50, term))
