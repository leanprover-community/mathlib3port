...
-- error in CategoryTheory.ConnectedComponents: ././Mathport/Syntax/Translate/Basic.lean:702:9: unsupported derive handler category
/-- Given an index for a connected component, produce the actual component as a full subcategory. -/
@[derive #[expr category]]
def component (j : connected_components J) : Type u₁ :=
{k : J // «expr = »(quotient.mk' k, j)}

-- error in CategoryTheory.ConnectedComponents: ././Mathport/Syntax/Translate/Basic.lean:702:9: unsupported derive handler full
