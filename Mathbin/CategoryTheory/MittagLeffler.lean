...
#align
  category_theory.functor.is_mittag_leffler_iff_eventual_range CategoryTheory.Functor.is_mittag_leffler_iff_eventual_range
...
#align
  category_theory.functor.is_mittag_leffler.subset_image_eventual_range CategoryTheory.Functor.IsMittagLeffler.subset_image_eventual_range
...
#align
  category_theory.functor.eventual_range_eq_range_precomp CategoryTheory.Functor.eventual_range_eq_range_precomp
...
#align
  category_theory.functor.is_mittag_leffler_of_surjective CategoryTheory.Functor.is_mittag_leffler_of_surjective
...
#align
  category_theory.functor.is_mittag_leffler.eq_image_eventual_range CategoryTheory.Functor.IsMittagLeffler.eq_image_eventual_range
...
#align
  category_theory.functor.is_mittag_leffler_iff_subset_range_comp CategoryTheory.Functor.is_mittag_leffler_iff_subset_range_comp
...
#align
  category_theory.functor.is_mittag_leffler.to_preimages CategoryTheory.Functor.IsMittagLeffler.to_preimages
...
#align
  category_theory.functor.is_mittag_leffler_of_exists_finite_range CategoryTheory.Functor.is_mittag_leffler_of_exists_finite_range
...
def toEventualRanges : J ⥤ Type v
  ...
  map i j f := (F.eventual_range_maps_to f).restrict _ _ _
  map_id' i := by
    simp_rw [F.map_id]
    ext
    rfl
...
def toEventualRangesSectionsEquiv : F.toEventualRanges.sections ≃ F.sections
  ...
  right_inv _ := by
    ...
    rfl
#align
  category_theory.functor.to_eventual_ranges_sections_equiv CategoryTheory.Functor.toEventualRangesSectionsEquiv
...
theorem surjective_to_eventual_ranges (h : F.IsMittagLeffler) (f : i ⟶ j) :
  ...
  exact ⟨⟨y, hy⟩, rfl⟩
#align
  category_theory.functor.surjective_to_eventual_ranges CategoryTheory.Functor.surjective_to_eventual_ranges
...
theorem to_eventual_ranges_nonempty (h : F.IsMittagLeffler) [∀ j : J, Nonempty (F.obj j)] (j : J) :
  ...
  infer_instance
#align
  category_theory.functor.to_eventual_ranges_nonempty CategoryTheory.Functor.to_eventual_ranges_nonempty
...
#align
  category_theory.functor.thin_diagram_of_surjective CategoryTheory.Functor.thin_diagram_of_surjective
