...
@[simps]
noncomputable def matrixDecomposition (o : HomOrthogonal s) {α β : Type _} [Fintype α] [Fintype β] {f : α → ι}
    {g : β → ι} :
...
@[simps]
noncomputable def matrixDecompositionAddEquiv (o : HomOrthogonal s) {α β : Type _} [Fintype α] [Fintype β] {f : α → ι}
...
@[simp]
theorem matrix_decomposition_id (o : HomOrthogonal s) {α : Type _} [Fintype α] {f : α → ι} (i : ι) :
...
theorem matrix_decomposition_comp (o : HomOrthogonal s) {α β γ : Type _} [Fintype α] [Fintype β] [Fintype γ] {f : α → ι}
...
@[simps]
noncomputable def matrixDecompositionLinearEquiv (o : HomOrthogonal s) {α β : Type _} [Fintype α] [Fintype β]
    {f : α → ι} {g : β → ι} :
...
-/
theorem equiv_of_iso (o : HomOrthogonal s) {α β : Type _} [Fintype α] [Fintype β] {f : α → ι} {g : β → ι}
