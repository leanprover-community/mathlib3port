...
@[simp]
theorem complex_d_comp_π_f_zero {Z : C} (P : ProjectiveResolutionCat Z) :
...
instance {Z : C} (P : ProjectiveResolutionCat Z) (n : ℕ) : CategoryTheory.Epi (P.π.f n) := by
...
def liftFZero {Y Z : C} (f : Y ⟶ Z) (P : ProjectiveResolutionCat Y)
    (Q : ProjectiveResolutionCat Z) : P.complex.x 0 ⟶ Q.complex.x 0 :=
  factorThru (P.π.f 0 ≫ f) (Q.π.f 0)
#align
  category_theory.ProjectiveResolution.lift_f_zero CategoryTheory.ProjectiveResolutionCat.liftFZero
...
#align
  category_theory.ProjectiveResolution.lift_f_one CategoryTheory.ProjectiveResolutionCat.liftFOne
...
def liftFSucc {Y Z : C} (P : ProjectiveResolutionCat Y) (Q : ProjectiveResolutionCat Z) (n : ℕ)
  ...
  ⟨Exact.lift (P.complex.d (n + 2) (n + 1) ≫ g') (Q.complex.d (n + 2) (n + 1))
    ...
    by simp⟩
#align
  category_theory.ProjectiveResolution.lift_f_succ CategoryTheory.ProjectiveResolutionCat.liftFSucc
...
#align
  category_theory.ProjectiveResolution.lift_commutes CategoryTheory.ProjectiveResolutionCat.lift_commutes
...
#align
  category_theory.ProjectiveResolution.lift_homotopy_zero CategoryTheory.ProjectiveResolutionCat.liftHomotopyZero

/-- Two lifts of the same morphism are homotopic. -/
def liftHomotopy {Y Z : C} (f : Y ⟶ Z) {P : ProjectiveResolutionCat Y}
    {Q : ProjectiveResolutionCat Z} (g h : P.complex ⟶ Q.complex)
...
#align
  category_theory.ProjectiveResolution.lift_homotopy CategoryTheory.ProjectiveResolutionCat.liftHomotopy

/-- The lift of the identity morphism is homotopic to the identity chain map. -/
def liftIdHomotopy (X : C) (P : ProjectiveResolutionCat X) :
    Homotopy (lift (𝟙 X) P P) (𝟙 P.complex) := by apply lift_homotopy (𝟙 X) <;> simp
#align
  category_theory.ProjectiveResolution.lift_id_homotopy CategoryTheory.ProjectiveResolutionCat.liftIdHomotopy

/-- The lift of a composition is homotopic to the composition of the lifts. -/
def liftCompHomotopy {X Y Z : C} (f : X ⟶ Y) (g : Y ⟶ Z) (P : ProjectiveResolutionCat X)
    (Q : ProjectiveResolutionCat Y) (R : ProjectiveResolutionCat Z) :
    Homotopy (lift (f ≫ g) P R) (lift f P Q ≫ lift g Q R) := by apply lift_homotopy (f ≫ g) <;> simp
#align
  category_theory.ProjectiveResolution.lift_comp_homotopy CategoryTheory.ProjectiveResolutionCat.liftCompHomotopy
