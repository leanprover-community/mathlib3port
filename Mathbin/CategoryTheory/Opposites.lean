...
instance right_op_faithful {F : Cᵒᵖ ⥤ D} [Faithful F] : Faithful F.rightOp
...
instance left_op_faithful {F : C ⥤ Dᵒᵖ} [Faithful F] : Faithful F.leftOp
...
theorem right_op_left_op_eq (F : Cᵒᵖ ⥤ D) : F.rightOp.leftOp = F :=
  by
  cases F
  rfl
