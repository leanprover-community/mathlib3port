...
#print CategoryTheory.ShortComplex.exact_iff_image_eq_kernel /-
...
#align category_theory.abelian.exact_iff_image_eq_kernel CategoryTheory.ShortComplex.exact_iff_image_eq_kernel
-/
...
#print CategoryTheory.ShortComplex.exact_iff_of_forks /-
theorem exact_iff_of_forks {cg : KernelFork g} (hg : IsLimit cg) {cf : CokernelCofork f}
  ...
  · rw [exact_iff]
    ...
    simp [h.2]
#align category_theory.abelian.exact_iff' CategoryTheory.ShortComplex.exact_iff_of_forks
-/
...
#print CategoryTheory.ShortComplex.Exact.isLimitImage /-
/-- If `(f, g)` is exact, then `abelian.image.ι f` is a kernel of `g`. -/
def CategoryTheory.ShortComplex.Exact.isLimitImage (h : Exact f g) :
  ...
  · refine' fun W u hu => kernel.lift (cokernel.π f) u _
    rw [← kernel.lift_ι g u hu, category.assoc, h.2, has_zero_morphisms.comp_zero]
  tidy
#align category_theory.abelian.is_limit_image CategoryTheory.ShortComplex.Exact.isLimitImage
-/
...
def CategoryTheory.ShortComplex.Exact.isLimitImage' (h : Exact f g) :
  ...
  IsKernel.isoKernel _ _ (CategoryTheory.ShortComplex.Exact.isLimitImage f g h)
      (imageIsoImage f).symm <|
    IsImage.lift_fac _ _
#align category_theory.abelian.is_limit_image' CategoryTheory.ShortComplex.Exact.isLimitImage'
-/

#print CategoryTheory.ShortComplex.Exact.isColimitCoimage /-
/-- If `(f, g)` is exact, then `coimages.coimage.π g` is a cokernel of `f`. -/
def CategoryTheory.ShortComplex.Exact.isColimitCoimage (h : Exact f g) :
    IsColimit
  ...
  tidy
#align category_theory.abelian.is_colimit_coimage CategoryTheory.ShortComplex.Exact.isColimitCoimage
-/

#print CategoryTheory.ShortComplex.Exact.isColimitImage /-
/-- If `(f, g)` is exact, then `factor_thru_image g` is a cokernel of `f`. -/
def CategoryTheory.ShortComplex.Exact.isColimitImage (h : Exact f g) :
    IsColimit (CokernelCofork.ofπ (Limits.factorThruImage g) (comp_factorThruImage_eq_zero h.1)) :=
  IsCokernel.cokernelIso _ _ (CategoryTheory.ShortComplex.Exact.isColimitCoimage f g h)
      (coimageIsoImage' g) <|
...
#print CategoryTheory.ShortComplex.exact_cokernel /-
theorem exact_cokernel : Exact f (cokernel.π f) := by rw [exact_iff]; tidy
#align category_theory.abelian.exact_cokernel CategoryTheory.ShortComplex.exact_cokernel
-/
    ...
    h
      (cokernel.desc f g h.w =
        (IsColimit.coconePointUniqueUpToIso (colimit.isColimit _)
              (CategoryTheory.ShortComplex.Exact.isColimitImage f g h)).Hom ≫
          Limits.image.ι g)
...
#print CategoryTheory.ShortComplex.exact_iff_exact_image_ι /-
...
#align category_theory.abelian.exact_iff_exact_image_ι CategoryTheory.ShortComplex.exact_iff_exact_image_ι
-/

#print CategoryTheory.ShortComplex.exact_iff_exact_coimage_π /-
...
#align category_theory.abelian.exact_iff_exact_coimage_π CategoryTheory.ShortComplex.exact_iff_exact_coimage_π
-/
...
#print CategoryTheory.Functor.reflects_exact_of_faithful /-
instance (priority := 100) reflects_exact_of_faithful [CategoryTheory.Functor.Faithful F] :
...
#align category_theory.functor.reflects_exact_sequences_of_preserves_zero_morphisms_of_faithful CategoryTheory.Functor.reflects_exact_of_faithful
-/
...
#print CategoryTheory.Functor.preservesHomologyOfPreservesMonosAndCokernels /-
...
#align category_theory.functor.preserves_finite_limits_of_preserves_monos_and_cokernels CategoryTheory.Functor.preservesHomologyOfPreservesMonosAndCokernels
-/

#print CategoryTheory.Functor.preservesHomologyOfPreservesEpisAndKernels /-
/-- A functor preserving zero morphisms, epis, and kernels preserves finite colimits. -/
def preservesHomologyOfPreservesEpisAndKernels [PreservesZeroMorphisms L] [PreservesEpimorphisms L]
    [∀ {X Y} (f : X ⟶ Y), PreservesLimit (parallelPair f 0) L] : PreservesFiniteColimits L :=
  by
...
#align category_theory.functor.preserves_finite_colimits_of_preserves_epis_and_kernels CategoryTheory.Functor.preservesHomologyOfPreservesEpisAndKernels
-/
