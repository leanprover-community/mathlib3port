...
theorem cone_points_iso_of_nat_iso_hom_comp {F G : J ⥤ C} {s : cone F} {t : cone G} (P : is_limit s) (Q : is_limit t)
    (w : F ≅ G) (j : J) : (cone_points_iso_of_nat_iso P Q w).Hom ≫ t.π.app j = s.π.app j ≫ w.hom.app j := by
  simp

@[reassoc]
theorem cone_points_iso_of_nat_iso_inv_comp {F G : J ⥤ C} {s : cone F} {t : cone G} (P : is_limit s) (Q : is_limit t)
    (w : F ≅ G) (j : J) : (cone_points_iso_of_nat_iso P Q w).inv ≫ s.π.app j = t.π.app j ≫ w.inv.app j := by
  simp
...
def map_cone_equiv {D : Type u₄} [category.{v₄} D] {K : J ⥤ C} {F G : C ⥤ D} (h : F ≅ G) {c : cone K}
    (t : is_limit (F.map_cone c)) : is_limit (G.map_cone c) := by
...
@[simp]
theorem cone_of_hom_of_cone (s : cone F) : cone_of_hom h (hom_of_cone h s) = s := by
...
theorem comp_cocone_points_iso_of_nat_iso_hom {F G : J ⥤ C} {s : cocone F} {t : cocone G} (P : is_colimit s)
    ...
    s.ι.app j ≫ (cocone_points_iso_of_nat_iso P Q w).Hom = w.hom.app j ≫ t.ι.app j := by
  simp

@[reassoc]
theorem comp_cocone_points_iso_of_nat_iso_inv {F G : J ⥤ C} {s : cocone F} {t : cocone G} (P : is_colimit s)
    (Q : is_colimit t) (w : F ≅ G) (j : J) :
    t.ι.app j ≫ (cocone_points_iso_of_nat_iso P Q w).inv = w.inv.app j ≫ s.ι.app j := by
  simp
...
def map_cocone_equiv {D : Type u₄} [category.{v₄} D] {K : J ⥤ C} {F G : C ⥤ D} (h : F ≅ G) {c : cocone K}
    (t : is_colimit (F.map_cocone c)) : is_colimit (G.map_cocone c) := by
...
@[simp]
theorem cocone_of_hom_of_cocone (s : cocone F) : cocone_of_hom h (hom_of_cocone h s) = s := by
