...
def Cone.toCostructuredArrow (F : J ⥤ C) : Cone F ⥤ CostructuredArrow (const J) F
  ...
  map c d f :=
    CostructuredArrow.homMk f.Hom <| by
      ...
      simp
#align
  category_theory.limits.cone.to_costructured_arrow CategoryTheory.Limits.Cone.toCostructuredArrow
  ...
  map c d f :=
    { Hom := f.left
      w' := fun j => by
        ...
        simp }
#align
  category_theory.limits.cone.from_costructured_arrow CategoryTheory.Limits.Cone.fromCostructuredArrow
...
#align
  category_theory.limits.cone.equiv_costructured_arrow CategoryTheory.Limits.Cone.equivCostructuredArrow
...
#align
  category_theory.limits.has_limit_iff_has_terminal_cone CategoryTheory.Limits.has_limit_iff_has_terminal_cone
...
#align
  category_theory.limits.has_limits_of_shape_iff_is_left_adjoint_const CategoryTheory.Limits.has_limits_of_shape_iff_is_left_adjoint_const
...
theorem IsLimit.lift_cone_morphism_eq_is_terminal_from {F : J ⥤ C} {c : Cone F} (hc : IsLimit c)
  ...
  rfl
#align
  category_theory.limits.is_limit.lift_cone_morphism_eq_is_terminal_from CategoryTheory.Limits.IsLimit.lift_cone_morphism_eq_is_terminal_from
...
#align
  category_theory.limits.is_terminal.from_eq_lift_cone_morphism CategoryTheory.Limits.IsTerminal.from_eq_lift_cone_morphism
...
#align
  category_theory.limits.is_limit.of_preserves_cone_terminal CategoryTheory.Limits.IsLimit.ofPreservesConeTerminal
...
#align
  category_theory.limits.is_limit.of_reflects_cone_terminal CategoryTheory.Limits.IsLimit.ofReflectsConeTerminal
...
def Cocone.toStructuredArrow (F : J ⥤ C) : Cocone F ⥤ StructuredArrow F (const J)
  ...
  map c d f :=
    StructuredArrow.homMk f.Hom <| by
      ...
      simp
#align
  category_theory.limits.cocone.to_structured_arrow CategoryTheory.Limits.Cocone.toStructuredArrow
  ...
  map c d f :=
    { Hom := f.right
      w' := fun j => by
        ...
        simp }
#align
  category_theory.limits.cocone.from_structured_arrow CategoryTheory.Limits.Cocone.fromStructuredArrow
...
#align
  category_theory.limits.cocone.equiv_structured_arrow CategoryTheory.Limits.Cocone.equivStructuredArrow
...
#align
  category_theory.limits.has_colimit_iff_has_initial_cocone CategoryTheory.Limits.has_colimit_iff_has_initial_cocone
...
#align
  category_theory.limits.has_colimits_of_shape_iff_is_right_adjoint_const CategoryTheory.Limits.has_colimits_of_shape_iff_is_right_adjoint_const
...
theorem IsColimit.desc_cocone_morphism_eq_is_initial_to {F : J ⥤ C} {c : Cocone F}
  ...
  rfl
#align
  category_theory.limits.is_colimit.desc_cocone_morphism_eq_is_initial_to CategoryTheory.Limits.IsColimit.desc_cocone_morphism_eq_is_initial_to
...
#align
  category_theory.limits.is_initial.to_eq_desc_cocone_morphism CategoryTheory.Limits.IsInitial.to_eq_desc_cocone_morphism
...
#align
  category_theory.limits.is_colimit.of_preserves_cocone_initial CategoryTheory.Limits.IsColimit.ofPreservesCoconeInitial
...
#align
  category_theory.limits.is_colimit.of_reflects_cocone_initial CategoryTheory.Limits.IsColimit.ofReflectsCoconeInitial
