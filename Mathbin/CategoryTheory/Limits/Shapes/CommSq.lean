...
#align
  category_theory.is_pullback.of_has_binary_product' CategoryTheory.IsPullback.of_has_binary_product'
...
theorem iso_pullback_hom_fst (h : IsPullback fst snd f g) [HasPullback f g] :
  ...
  simp
#align
  category_theory.is_pullback.iso_pullback_hom_fst CategoryTheory.IsPullback.iso_pullback_hom_fst
...
theorem iso_pullback_hom_snd (h : IsPullback fst snd f g) [HasPullback f g] :
  ...
  simp
#align
  category_theory.is_pullback.iso_pullback_hom_snd CategoryTheory.IsPullback.iso_pullback_hom_snd
...
#align
  category_theory.is_pullback.iso_pullback_inv_fst CategoryTheory.IsPullback.iso_pullback_inv_fst
...
#align
  category_theory.is_pullback.iso_pullback_inv_snd CategoryTheory.IsPullback.iso_pullback_inv_snd
...
#align
  category_theory.is_pushout.of_has_binary_coproduct' CategoryTheory.IsPushout.of_has_binary_coproduct'
...
theorem of_has_binary_biproduct (X Y : C) [HasBinaryBiproduct X Y] :
  ...
  of_is_bilimit' (BinaryBiproduct.isBilimit X Y)
#align
  category_theory.is_pullback.of_has_binary_biproduct CategoryTheory.IsPullback.of_has_binary_biproduct
...
#align
  category_theory.is_pullback.pullback_biprod_inl_biprod_inr CategoryTheory.IsPullback.pullbackBiprodInlBiprodInr
...
theorem of_has_binary_biproduct (X Y : C) [HasBinaryBiproduct X Y] :
  ...
  of_is_bilimit' (BinaryBiproduct.isBilimit X Y)
#align
  category_theory.is_pushout.of_has_binary_biproduct CategoryTheory.IsPushout.of_has_binary_biproduct
...
#align
  category_theory.is_pushout.pushout_biprod_fst_biprod_snd CategoryTheory.IsPushout.pushoutBiprodFstBiprodSnd
...
theorem of_is_pullback_is_pushout (p₁ : IsPullback f g h i) (p₂ : IsPushout f g h i) :
    BicartesianSq f g h i :=
  BicartesianSq.mk p₁.to_comm_sq ⟨p₁.IsLimit⟩ ⟨p₂.IsColimit⟩
#align
  category_theory.bicartesian_sq.of_is_pullback_is_pushout CategoryTheory.BicartesianSq.of_is_pullback_is_pushout
...
#align
  category_theory.bicartesian_sq.of_has_biproduct₁ CategoryTheory.BicartesianSq.of_has_biproduct₁
