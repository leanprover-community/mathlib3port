...
object.
-/
theorem has_weakly_initial_of_weakly_initial_set_and_has_products [HasProducts C] {ι : Type v} {B : ι → C}
...
initial object.
-/
theorem has_initial_of_weakly_initial_and_has_wide_equalizers [HasWideEqualizers C] {T : C}
