...
instance : Bitraversable Sum where
...
instance Bitraversable.flip : Bitraversable (flip t) where
...
instance : Bitraversable (bicompl t F G) where
...
instance : Bitraversable (bicompr F t) where
