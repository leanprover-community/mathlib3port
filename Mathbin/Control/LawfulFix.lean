...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " `sigma.curry` as a monotone function. -/")]
 ...
 (Command.def
  "def"
  (Command.declId `monotone_curry [])
  (Command.optDeclSig
   [(Term.instBinder
     "["
     []
     (Term.forall "∀" [(Term.simpleBinder [`x `y] [])] "," («term_$__» `Preorderₓ "$" (Term.app `γ [`x `y])))
     "]")]
   [(Term.typeSpec
     ":"
     (Order.Hom.Basic.«term_→ₘ_»
      (Term.forall
       "∀"
       [(Term.simpleBinder
         [`x]
         [(Term.typeSpec
           ...
           (Init.Data.Sigma.Basic.«termΣ_,_»
            ...
            (Term.app `β [`a])))])]
       ","
       (Term.app `γ [(Term.proj `x "." (fieldIdx "1")) (Term.proj `x "." (fieldIdx "2"))]))
      " →ₘ "
      (Term.forall
       "∀"
       [(Term.simpleBinder [`a] []) (Term.simpleBinder [`b] [(Term.typeSpec ":" (Term.app `β [`a]))])]
       ","
       (Term.app `γ [`a `b]))))])
  (Command.declValSimple
   ...
   (Term.structInst
    "{"
    []
    [(group (Term.structInstField (Term.structInstLVal `toFun []) ":=" `curry) [","])
     (group
      (Term.structInstField
       ...
       (Term.fun
        "fun"
        (Term.basicFun
         [(Term.simpleBinder [`x `y `h `a `b] [])]
         "=>"
         (Term.app `h [(Term.anonymousCtor "⟨" [`a "," `b] "⟩")]))))
      [])]
    (Term.optEllipsis [])
    []
    "}")
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, [anonymous]))
  (Order.Hom.Basic.«term_→ₘ_»
   ...
   (Term.forall
    ...
    ","
    (Term.app `γ [`a `b])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Order.Hom.Basic.«term_→ₘ_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.forall
   "∀"
   [(Term.simpleBinder [`a] []) (Term.simpleBinder [`b] [(Term.typeSpec ":" (Term.app `β [`a]))])]
...
/-- `sigma.curry` as a monotone function. -/ @[ simps ]
  def
    monotone_curry
    [ ∀ x y , Preorderₓ $ γ x y ] : ∀ x : Σ a , β a , γ x . 1 x . 2 →ₘ ∀ a b : β a , γ a b
    := { toFun := curry , monotone' := fun x y h a b => h ⟨ a , b ⟩ }

/- failed to parenthesize: parenthesize: uncaught backtrack exception
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " `sigma.uncurry` as a monotone function. -/")]
  [(Term.attributes "@[" [(Term.attrInstance (Term.attrKind []) (Attr.simps "simps" [] []))] "]")]
  []
  []
  []
 ...
 (Command.def
  "def"
  (Command.declId `monotone_uncurry [])
  (Command.optDeclSig
   [(Term.instBinder
     "["
     []
  ...
  (Command.declValSimple
   ...
   (Term.structInst
    "{"
    []
    [(group (Term.structInstField (Term.structInstLVal `toFun []) ":=" `uncurry) [","])
     (group
      (Term.structInstField
       (Term.structInstLVal `monotone' [])
       ":="
       (Term.fun
        "fun"
        (Term.basicFun
         [(Term.simpleBinder [`x `y `h `a] [])]
         "=>"
         (Term.app `h [(Term.proj `a "." (fieldIdx "1")) (Term.proj `a "." (fieldIdx "2"))]))))
      [])]
    (Term.optEllipsis [])
    []
    "}")
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.def', expected 'Lean.Parser.Command.structure.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.def', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
/-- `sigma.uncurry` as a monotone function. -/ @[ simps ]
  def
    monotone_uncurry
    [ ∀ x y , Preorderₓ $ γ x y ] : ∀ a b : β a , γ a b →ₘ ∀ x : Σ a , β a , γ x . 1 x . 2
...
instance
  pi.lawful_fix'
  [ LawfulFix $ ∀ x : Sigma β , γ x . 1 x . 2 ] : LawfulFix ( ∀ x y , γ x y )
  where fix_eq f hc := by dsimp [ fix ] conv => lhs erw [ LawfulFix.fix_eq ( uncurry_curry_continuous hc ) ] rfl
