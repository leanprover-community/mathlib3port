...
#print Random /-
/- ./././Mathport/Syntax/Translate/Command.lean:355:30: infer kinds are unsupported in Lean 4: #[`Random] [] -/
...
instance intBoundedRandom :
    ...
    let ⟨z, h₀, h₁⟩ ← @BoundedRandom.randomR ℕ _ _ g inst 0 (Int.natAbs $ y - x) dec_trivial
    pure
