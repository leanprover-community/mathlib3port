...
theorem bUnion_Ico_Ioc_map_succ [SuccOrder α] [IsSuccArchimedean α] [LinearOrderₓ β] {f : α → β} (hf : Monotoneₓ f)
...
theorem pairwise_disjoint_on_Ioc_succ [SuccOrder α] [Preorderₓ β] {f : α → β} (hf : Monotoneₓ f) :
...
theorem pairwise_disjoint_on_Ico_succ [SuccOrder α] [Preorderₓ β] {f : α → β} (hf : Monotoneₓ f) :
...
theorem pairwise_disjoint_on_Ioo_succ [SuccOrder α] [Preorderₓ β] {f : α → β} (hf : Monotoneₓ f) :
...
theorem pairwise_disjoint_on_Ioc_pred [PredOrder α] [Preorderₓ β] {f : α → β} (hf : Monotoneₓ f) :
...
theorem pairwise_disjoint_on_Ico_pred [PredOrder α] [Preorderₓ β] {f : α → β} (hf : Monotoneₓ f) :
...
theorem pairwise_disjoint_on_Ioo_pred [PredOrder α] [Preorderₓ β] {f : α → β} (hf : Monotoneₓ f) :
...
theorem pairwise_disjoint_on_Ioc_succ [SuccOrder α] [Preorderₓ β] {f : α → β} (hf : Antitoneₓ f) :
...
theorem pairwise_disjoint_on_Ico_succ [SuccOrder α] [Preorderₓ β] {f : α → β} (hf : Antitoneₓ f) :
...
theorem pairwise_disjoint_on_Ioo_succ [SuccOrder α] [Preorderₓ β] {f : α → β} (hf : Antitoneₓ f) :
...
theorem pairwise_disjoint_on_Ioc_pred [PredOrder α] [Preorderₓ β] {f : α → β} (hf : Antitoneₓ f) :
...
theorem pairwise_disjoint_on_Ico_pred [PredOrder α] [Preorderₓ β] {f : α → β} (hf : Antitoneₓ f) :
...
theorem pairwise_disjoint_on_Ioo_pred [PredOrder α] [Preorderₓ β] {f : α → β} (hf : Antitoneₓ f) :
