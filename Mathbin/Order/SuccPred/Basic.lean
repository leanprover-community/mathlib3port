...
theorem succ_eq_infi (a : α) : succ a = ⨅ (b) (h : a < b), b :=
  by
...
theorem Ioi_pred_eq_insert_of_not_is_min (ha : ¬IsMin a) : Ioi (pred a) = insert a (Ioi a) :=
  by
...
theorem pred_eq_supr (a : α) : pred a = ⨆ (b) (h : b < a), b :=
  by
