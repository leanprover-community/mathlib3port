...
-/
class BooleanAlgebra (α : Type u) extends DistribLattice α, HasCompl α, SDiff α, HasHimp α, Top α,
  Bot α where
...
#align boolean_algebra.to_complemented_lattice BooleanAlgebra.to_complemented_lattice
