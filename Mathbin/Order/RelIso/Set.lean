...
but is expected to have type
  forall {α : Type.{u3}} {β : Type.{u2}} {F : Type.{u1}} [_inst_1 : SemilatticeSup.{u3} α] [_inst_2 : LinearOrder.{u2} β] [_inst_3 : RelHomClass.{u1, u2, u3} F β α (fun (x._@.Mathlib.Order.RelIso.Set._hyg.227 : β) (x._@.Mathlib.Order.RelIso.Set._hyg.229 : β) => GT.gt.{u2} β (Preorder.toLT.{u2} β (PartialOrder.toPreorder.{u2} β (SemilatticeInf.toPartialOrder.{u2} β (Lattice.toSemilatticeInf.{u2} β (DistribLattice.toLattice.{u2} β (instDistribLattice.{u2} β _inst_2)))))) x._@.Mathlib.Order.RelIso.Set._hyg.227 x._@.Mathlib.Order.RelIso.Set._hyg.229) (fun (x._@.Mathlib.Order.RelIso.Set._hyg.249 : α) (x._@.Mathlib.Order.RelIso.Set._hyg.251 : α) => GT.gt.{u3} α (Preorder.toLT.{u3} α (PartialOrder.toPreorder.{u3} α (SemilatticeSup.toPartialOrder.{u3} α _inst_1))) x._@.Mathlib.Order.RelIso.Set._hyg.249 x._@.Mathlib.Order.RelIso.Set._hyg.251)] (a : F) (m : β) (n : β), Eq.{succ u3} ((fun (x._@.Mathlib.Order.RelIso.Basic._hyg.931 : β) => α) (HasSup.sup.{u2} β (SemilatticeSup.toHasSup.{u2} β (Lattice.toSemilatticeSup.{u2} β (DistribLattice.toLattice.{u2} β (instDistribLattice.{u2} β _inst_2)))) m n)) (FunLike.coe.{succ u1, succ u2, succ u3} F β (fun (_x : β) => (fun (x._@.Mathlib.Order.RelIso.Basic._hyg.931 : β) => α) _x) (RelHomClass.toFunLike.{u1, u2, u3} F β α (fun (x._@.Mathlib.Order.RelIso.Set._hyg.227 : β) (x._@.Mathlib.Order.RelIso.Set._hyg.229 : β) => GT.gt.{u2} β (Preorder.toLT.{u2} β (PartialOrder.toPreorder.{u2} β (SemilatticeInf.toPartialOrder.{u2} β (Lattice.toSemilatticeInf.{u2} β (DistribLattice.toLattice.{u2} β (instDistribLattice.{u2} β _inst_2)))))) x._@.Mathlib.Order.RelIso.Set._hyg.227 x._@.Mathlib.Order.RelIso.Set._hyg.229) (fun (_x : α) (x._@.Mathlib.Order.RelIso.Set._hyg.251 : α) => GT.gt.{u3} α (Preorder.toLT.{u3} α (PartialOrder.toPreorder.{u3} α (SemilatticeSup.toPartialOrder.{u3} α _inst_1))) _x x._@.Mathlib.Order.RelIso.Set._hyg.251) _inst_3) a (HasSup.sup.{u2} β (SemilatticeSup.toHasSup.{u2} β (Lattice.toSemilatticeSup.{u2} β (DistribLattice.toLattice.{u2} β (instDistribLattice.{u2} β _inst_2)))) m n)) (HasSup.sup.{u3} ((fun (x._@.Mathlib.Order.RelIso.Basic._hyg.931 : β) => α) m) (SemilatticeSup.toHasSup.{u3} ((fun (x._@.Mathlib.Order.RelIso.Basic._hyg.931 : β) => α) m) _inst_1) (FunLike.coe.{succ u1, succ u2, succ u3} F β (fun (_x : β) => (fun (x._@.Mathlib.Order.RelIso.Basic._hyg.931 : β) => α) _x) (RelHomClass.toFunLike.{u1, u2, u3} F β α (fun (x._@.Mathlib.Order.RelIso.Set._hyg.227 : β) (x._@.Mathlib.Order.RelIso.Set._hyg.229 : β) => GT.gt.{u2} β (Preorder.toLT.{u2} β (PartialOrder.toPreorder.{u2} β (SemilatticeInf.toPartialOrder.{u2} β (Lattice.toSemilatticeInf.{u2} β (DistribLattice.toLattice.{u2} β (instDistribLattice.{u2} β _inst_2)))))) x._@.Mathlib.Order.RelIso.Set._hyg.227 x._@.Mathlib.Order.RelIso.Set._hyg.229) (fun (_x : α) (x._@.Mathlib.Order.RelIso.Set._hyg.251 : α) => GT.gt.{u3} α (Preorder.toLT.{u3} α (PartialOrder.toPreorder.{u3} α (SemilatticeSup.toPartialOrder.{u3} α _inst_1))) _x x._@.Mathlib.Order.RelIso.Set._hyg.251) _inst_3) a m) (FunLike.coe.{succ u1, succ u2, succ u3} F β (fun (_x : β) => (fun (x._@.Mathlib.Order.RelIso.Basic._hyg.931 : β) => α) _x) (RelHomClass.toFunLike.{u1, u2, u3} F β α (fun (x._@.Mathlib.Order.RelIso.Set._hyg.227 : β) (x._@.Mathlib.Order.RelIso.Set._hyg.229 : β) => GT.gt.{u2} β (Preorder.toLT.{u2} β (PartialOrder.toPreorder.{u2} β (SemilatticeInf.toPartialOrder.{u2} β (Lattice.toSemilatticeInf.{u2} β (DistribLattice.toLattice.{u2} β (instDistribLattice.{u2} β _inst_2)))))) x._@.Mathlib.Order.RelIso.Set._hyg.227 x._@.Mathlib.Order.RelIso.Set._hyg.229) (fun (_x : α) (x._@.Mathlib.Order.RelIso.Set._hyg.251 : α) => GT.gt.{u3} α (Preorder.toLT.{u3} α (PartialOrder.toPreorder.{u3} α (SemilatticeSup.toPartialOrder.{u3} α _inst_1))) _x x._@.Mathlib.Order.RelIso.Set._hyg.251) _inst_3) a n))
...
but is expected to have type
  forall {α : Type.{u2}} {β : Type.{u1}} {r : α -> α -> Prop} {s : β -> β -> Prop} (e : RelIso.{u2, u1} α β r s), Eq.{succ u1} (Set.{u1} β) (Set.range.{u1, succ u2} β α (FunLike.coe.{max (succ u2) (succ u1), succ u2, succ u1} (Function.Embedding.{succ u2, succ u1} α β) α (fun (_x : α) => (fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.21 : α) => β) _x) (EmbeddingLike.toFunLike.{max (succ u2) (succ u1), succ u2, succ u1} (Function.Embedding.{succ u2, succ u1} α β) α β (Function.instEmbeddingLikeEmbedding.{succ u2, succ u1} α β)) (RelEmbedding.toEmbedding.{u2, u1} α β r s (RelIso.toRelEmbedding.{u2, u1} α β r s e)))) (Set.univ.{u1} β)
...
but is expected to have type
  forall {α : Type.{u1}} (r : α -> α -> Prop) (p : Set.{u1} α) (a : Set.Elem.{u1} α p), Eq.{succ u1} ((fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.21 : Set.Elem.{u1} α p) => α) a) (FunLike.coe.{succ u1, succ u1, succ u1} (Function.Embedding.{succ u1, succ u1} (Set.Elem.{u1} α p) α) (Set.Elem.{u1} α p) (fun (_x : Set.Elem.{u1} α p) => (fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.21 : Set.Elem.{u1} α p) => α) _x) (EmbeddingLike.toFunLike.{succ u1, succ u1, succ u1} (Function.Embedding.{succ u1, succ u1} (Set.Elem.{u1} α p) α) (Set.Elem.{u1} α p) α (Function.instEmbeddingLikeEmbedding.{succ u1, succ u1} (Set.Elem.{u1} α p) α)) (RelEmbedding.toEmbedding.{u1, u1} (Set.Elem.{u1} α p) α (Subrel.{u1} α r p) r (Subrel.relEmbedding.{u1} α r p)) a) (Subtype.val.{succ u1} α (fun (x : α) => Membership.mem.{u1, u1} α (Set.{u1} α) (Set.instMembershipSet.{u1} α) x p) a)
...
but is expected to have type
  forall {α : Type.{u1}} {β : Type.{u2}} {r : α -> α -> Prop} {s : β -> β -> Prop} (p : Set.{u2} β) (f : RelEmbedding.{u1, u2} α β r s), (forall (a : α), Membership.mem.{u2, u2} ((fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.21 : α) => β) a) (Set.{u2} β) (Set.instMembershipSet.{u2} β) (FunLike.coe.{max (succ u1) (succ u2), succ u1, succ u2} (Function.Embedding.{succ u1, succ u2} α β) α (fun (_x : α) => (fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.21 : α) => β) _x) (EmbeddingLike.toFunLike.{max (succ u1) (succ u2), succ u1, succ u2} (Function.Embedding.{succ u1, succ u2} α β) α β (Function.instEmbeddingLikeEmbedding.{succ u1, succ u2} α β)) (RelEmbedding.toEmbedding.{u1, u2} α β r s f) a) p) -> (RelEmbedding.{u1, u2} α (Set.Elem.{u2} β p) r (Subrel.{u2} β s p))
...
but is expected to have type
  forall {α : Type.{u1}} {β : Type.{u2}} {r : α -> α -> Prop} {s : β -> β -> Prop} (p : Set.{u2} β) (f : RelEmbedding.{u1, u2} α β r s) (H : forall (a : α), Membership.mem.{u2, u2} ((fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.21 : α) => β) a) (Set.{u2} β) (Set.instMembershipSet.{u2} β) (FunLike.coe.{max (succ u1) (succ u2), succ u1, succ u2} (Function.Embedding.{succ u1, succ u2} α β) α (fun (_x : α) => (fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.21 : α) => β) _x) (EmbeddingLike.toFunLike.{max (succ u1) (succ u2), succ u1, succ u2} (Function.Embedding.{succ u1, succ u2} α β) α β (Function.instEmbeddingLikeEmbedding.{succ u1, succ u2} α β)) (RelEmbedding.toEmbedding.{u1, u2} α β r s f) a) p) (a : α), Eq.{succ u2} ((fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.21 : α) => Set.Elem.{u2} β p) a) (FunLike.coe.{max (succ u1) (succ u2), succ u1, succ u2} (Function.Embedding.{succ u1, succ u2} α (Set.Elem.{u2} β p)) α (fun (_x : α) => (fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.21 : α) => Set.Elem.{u2} β p) _x) (EmbeddingLike.toFunLike.{max (succ u1) (succ u2), succ u1, succ u2} (Function.Embedding.{succ u1, succ u2} α (Set.Elem.{u2} β p)) α (Set.Elem.{u2} β p) (Function.instEmbeddingLikeEmbedding.{succ u1, succ u2} α (Set.Elem.{u2} β p))) (RelEmbedding.toEmbedding.{u1, u2} α (Set.Elem.{u2} β p) r (Subrel.{u2} β s p) (RelEmbedding.codRestrict.{u1, u2} α β r s p f H)) a) (Subtype.mk.{succ u2} β (fun (x : β) => Membership.mem.{u2, u2} β (Set.{u2} β) (Set.instMembershipSet.{u2} β) x p) (FunLike.coe.{max (succ u1) (succ u2), succ u1, succ u2} (Function.Embedding.{succ u1, succ u2} α β) α (fun (_x : α) => (fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.21 : α) => β) _x) (EmbeddingLike.toFunLike.{max (succ u1) (succ u2), succ u1, succ u2} (Function.Embedding.{succ u1, succ u2} α β) α β (Function.instEmbeddingLikeEmbedding.{succ u1, succ u2} α β)) (RelEmbedding.toEmbedding.{u1, u2} α β r s f) a) (H a))
