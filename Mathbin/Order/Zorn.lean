...
theorem exists_maximal_of_chains_bounded (h : ∀ c, IsChain r c → ∃ ub, ∀ a ∈ c, a ≺ ub)
  ...
  let ⟨ub, (hub : ∀ a ∈ max_chain r, a ≺ ub)⟩ := this
  ⟨ub, fun a ha =>
...
/- ./././Mathport/Syntax/Translate/Basic.lean:629:2: warning: expanding binder collection (c «expr ⊆ » s) -/
...
/- ./././Mathport/Syntax/Translate/Basic.lean:629:2: warning: expanding binder collection (c «expr ⊆ » Ici[set.Ici] a) -/
