...
#align is_strict_weak_order_of_is_order_connected is_strict_weak_order_of_is_order_connected
...
#align is_order_connected_of_is_strict_total_order is_order_connected_of_is_strict_total_order
...
#align is_strict_weak_order_of_is_strict_total_order is_strict_weak_order_of_is_strict_total_order
...
instance HasWellFounded.is_well_founded [h : HasWellFounded α] : IsWellFounded α HasWellFounded.R :=
  { h with }
#align has_well_founded.is_well_founded HasWellFounded.is_well_founded
...
#align nat.lt.is_well_order Nat.lt.is_well_order
