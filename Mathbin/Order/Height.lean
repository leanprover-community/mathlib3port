...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `le_chainHeight_tFAE [])
      (Command.declSig
       ...
       (Term.typeSpec
        ...
        (Term.app
         ...
         [(«term[_]»
           "["
           [(«term_≤_» (coeNotation "↑" `n) "≤" (Term.proj `s "." `chainHeight))
            ","
            (Std.ExtendedBinder.«term∃__,_»
             "∃"
             (Lean.binderIdent `l)
             («binderTerm∈_» "∈" (Term.proj `s "." `subchain))
             ","
             («term_=_» (Term.app `length [`l]) "=" `n))
            ","
            (Std.ExtendedBinder.«term∃__,_»
             "∃"
             (Lean.binderIdent `l)
         ...
         (Tactic.tacticSeq1Indented
          [(Tactic.tfaeHave "tfae_have" [] (num "1") "→" (num "2"))
           ...
           (tactic__
            ...
            [(Tactic.exact "exact" `s.exists_chain_of_le_chain_height)])
           []
              ...
              [(Std.Tactic.RCases.rintroPat.one
                (Std.Tactic.RCases.rcasesPat.tuple
                 ...
                 [(Std.Tactic.RCases.rcasesPatLo
                  ...
                  ","
                  (Std.Tactic.RCases.rcasesPatLo
                   (Std.Tactic.RCases.rcasesPatMed [(Std.Tactic.RCases.rcasesPat.one `hls)])
                   [])
                  ","
                  (Std.Tactic.RCases.rcasesPatLo
                   (Std.Tactic.RCases.rcasesPatMed [(Std.Tactic.RCases.rcasesPat.one `he)])
                   [])]
                 "⟩"))]
              [])
             []
             (Tactic.exact "exact" (Term.anonymousCtor "⟨" [`l "," `hls "," `he.ge] "⟩"))])
           []
           ...
           (tactic__
            ...
            [(Std.Tactic.rintro
             ...
             (Tactic.exact
              ...
              (Term.app
               `le_supᵢ₂_of_le
               [`l `hs (Term.app (Term.proj `WithTop.coe_le_coe "." (fieldIdx "2")) [`hn])]))])
           []
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app (Term.proj `WithTop.coe_le_coe "." (fieldIdx "2")) [`hn])
...
theorem
  ...
  :=
    by
      tfae_have 1 → 2
        ;
        · exact s.exists_chain_of_le_chain_height
        tfae_have 2 → 3
        ;
        · rintro ⟨ l , hls , he ⟩ exact ⟨ l , hls , he.ge ⟩
        tfae_have 3 → 1
        ;
        · rintro ⟨ l , hs , hn ⟩ exact le_supᵢ₂_of_le l hs WithTop.coe_le_coe . 2 hn
        tfae_finish
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `chainHeight_le_chainHeight_tFAE [])
      (Command.declSig
       [(Term.explicitBinder "(" [`s] [":" (Term.app `Set [`α])] [] ")")
        (Term.explicitBinder "(" [`t] [":" (Term.app `Set [`β])] [] ")")]
       (Term.typeSpec
        ":"
        (Term.app
         `TFAE
         [(«term[_]»
           "["
           [(«term_≤_» (Term.proj `s "." `chainHeight) "≤" (Term.proj `t "." `chainHeight))
            ","
            (Std.ExtendedBinder.«term∀__,_»
             "∀"
             (Lean.binderIdent `l)
             ...
             (Std.ExtendedBinder.«term∃__,_»
              "∃"
              (Lean.binderIdent `l')
              («binderTerm∈_» "∈" (Term.proj `t "." `subchain))
              ","
           ...
           (tactic__
            ...
            [(Tactic.«tactic_<;>_»
              (convert
               "convert"
               ["←"]
               (Term.app `chain_height_add_le_chain_height_add [`s `t (num "0") (num "0")])
               [])
              "<;>"
              (Tactic.apply "apply" `add_zero))])
           []
           (Tactic.tfaeHave "tfae_have" [] (num "2") "↔" (num "3"))
           ";"
           (tactic__
            ...
            [(Tactic.refine'
              ...
              (Term.app
               `forall₂_congr
               [(Term.fun "fun" (Term.basicFun [`l `hl] [] "=>" (Term.hole "_")))]))
             []
             (Mathlib.Tactic.tacticSimp_rw__
              ...
              (Tactic.rwRuleSeq
               ...
               [(Tactic.rwRule
                 [(patternIgnore (token.«← » "←"))]
                 (Term.app
                  (Term.proj (Term.app `le_chain_height_tfae [`t `l.length]) "." `out)
                  [(num "1") (num "2")]))
                ","
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      (Term.proj (Term.app `le_chain_height_tfae [`t `l.length]) "." `out)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      (Term.app `le_chain_height_tfae [`t `l.length])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `l.length
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Tactic.refine'
       ...
       (Term.app
        ...
        [(Term.fun "fun" (Term.basicFun [`l `hl] [] "=>" (Term.hole "_")))]))
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `forall₂_congr [(Term.fun "fun" (Term.basicFun [`l `hl] [] "=>" (Term.hole "_")))])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
theorem
  chainHeight_le_chainHeight_tFAE
  ( s : Set α ) ( t : Set β )
    :
      TFAE
        [
  ...
  :=
    by
      tfae_have 1 ↔ 3
        ;
        · convert ← chain_height_add_le_chain_height_add s t 0 0 <;> apply add_zero
        tfae_have 2 ↔ 3
        ;
        ·
