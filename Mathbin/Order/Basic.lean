...
but is expected to have type
  forall {α : Type.{u}} [inst._@.Mathlib.Order.Basic._hyg.1351 : Preorder.{u} α] {a : α} {b : α}, Iff (GE.ge.{u} α (Preorder.toLE.{u} α inst._@.Mathlib.Order.Basic._hyg.1351) a b) (LE.le.{u} α (Preorder.toLE.{u} α inst._@.Mathlib.Order.Basic._hyg.1351) b a)
...
but is expected to have type
  forall {α : Type.{u}} [inst._@.Mathlib.Order.Basic._hyg.1381 : Preorder.{u} α] {a : α} {b : α}, Iff (GT.gt.{u} α (Preorder.toLT.{u} α inst._@.Mathlib.Order.Basic._hyg.1381) a b) (LT.lt.{u} α (Preorder.toLT.{u} α inst._@.Mathlib.Order.Basic._hyg.1381) b a)
...
but is expected to have type
  forall {α : Type.{u}} [inst._@.Mathlib.Order.Basic._hyg.1899 : PartialOrder.{u} α] [inst._@.Mathlib.Order.Basic._hyg.1902 : DecidableRel.{succ u} α (fun (a._@.Mathlib.Order.Basic._hyg.1907 : α) (a._@.Mathlib.Order.Basic._hyg.1908 : α) => LE.le.{u} α (Preorder.toLE.{u} α (PartialOrder.toPreorder.{u} α inst._@.Mathlib.Order.Basic._hyg.1899)) a._@.Mathlib.Order.Basic._hyg.1907 a._@.Mathlib.Order.Basic._hyg.1908)] {a : α} {b : α}, Iff (Iff (Ne.{succ u} α a b) (LT.lt.{u} α (Preorder.toLT.{u} α (PartialOrder.toPreorder.{u} α inst._@.Mathlib.Order.Basic._hyg.1899)) a b)) (LE.le.{u} α (Preorder.toLE.{u} α (PartialOrder.toPreorder.{u} α inst._@.Mathlib.Order.Basic._hyg.1899)) a b)
...
but is expected to have type
  forall {α : Type.{u}} {β : Type.{u_1}} [inst._@.Mathlib.Order.Basic._hyg.2263 : LinearOrder.{u} α] [inst._@.Mathlib.Order.Basic._hyg.2266 : Preorder.{u_1} β] {a : α} {b : α} {c : β} {d : β}, ((LE.le.{u} α (Preorder.toLE.{u} α (PartialOrder.toPreorder.{u} α (LinearOrder.toPartialOrder.{u} α inst._@.Mathlib.Order.Basic._hyg.2263))) a b) -> (LE.le.{u_1} β (Preorder.toLE.{u_1} β inst._@.Mathlib.Order.Basic._hyg.2266) c d)) -> (LT.lt.{u_1} β (Preorder.toLT.{u_1} β inst._@.Mathlib.Order.Basic._hyg.2266) d c) -> (LT.lt.{u} α (Preorder.toLT.{u} α (PartialOrder.toPreorder.{u} α (LinearOrder.toPartialOrder.{u} α inst._@.Mathlib.Order.Basic._hyg.2263))) b a)
...
but is expected to have type
  forall {α : Type.{u}} {β : Type.{u_1}} [inst._@.Mathlib.Order.Basic._hyg.2318 : LinearOrder.{u} α] [inst._@.Mathlib.Order.Basic._hyg.2321 : LinearOrder.{u_1} β] {a : α} {b : α} {c : β} {d : β}, Iff ((LE.le.{u} α (Preorder.toLE.{u} α (PartialOrder.toPreorder.{u} α (LinearOrder.toPartialOrder.{u} α inst._@.Mathlib.Order.Basic._hyg.2318))) a b) -> (LE.le.{u_1} β (Preorder.toLE.{u_1} β (PartialOrder.toPreorder.{u_1} β (LinearOrder.toPartialOrder.{u_1} β inst._@.Mathlib.Order.Basic._hyg.2321))) c d)) ((LT.lt.{u_1} β (Preorder.toLT.{u_1} β (PartialOrder.toPreorder.{u_1} β (LinearOrder.toPartialOrder.{u_1} β inst._@.Mathlib.Order.Basic._hyg.2321))) d c) -> (LT.lt.{u} α (Preorder.toLT.{u} α (PartialOrder.toPreorder.{u} α (LinearOrder.toPartialOrder.{u} α inst._@.Mathlib.Order.Basic._hyg.2318))) b a))
...
but is expected to have type
  forall {α : Type.{u}} {β : Type.{u_1}} [inst._@.Mathlib.Order.Basic._hyg.2373 : Preorder.{u} α] [inst._@.Mathlib.Order.Basic._hyg.2376 : Preorder.{u_1} β] {a : α} {b : α} {c : β} {d : β}, (Iff (LE.le.{u} α (Preorder.toLE.{u} α inst._@.Mathlib.Order.Basic._hyg.2373) a b) (LE.le.{u_1} β (Preorder.toLE.{u_1} β inst._@.Mathlib.Order.Basic._hyg.2376) c d)) -> (Iff (LE.le.{u} α (Preorder.toLE.{u} α inst._@.Mathlib.Order.Basic._hyg.2373) b a) (LE.le.{u_1} β (Preorder.toLE.{u_1} β inst._@.Mathlib.Order.Basic._hyg.2376) d c)) -> (Iff (LT.lt.{u} α (Preorder.toLT.{u} α inst._@.Mathlib.Order.Basic._hyg.2373) b a) (LT.lt.{u_1} β (Preorder.toLT.{u_1} β inst._@.Mathlib.Order.Basic._hyg.2376) d c))
...
but is expected to have type
  forall {α : Type.{u}} {β : Type.{u_1}} [inst._@.Mathlib.Order.Basic._hyg.2447 : LinearOrder.{u} α] [inst._@.Mathlib.Order.Basic._hyg.2450 : LinearOrder.{u_1} β] {a : α} {b : α} {c : β} {d : β}, (Iff (LE.le.{u} α (Preorder.toLE.{u} α (PartialOrder.toPreorder.{u} α (LinearOrder.toPartialOrder.{u} α inst._@.Mathlib.Order.Basic._hyg.2447))) a b) (LE.le.{u_1} β (Preorder.toLE.{u_1} β (PartialOrder.toPreorder.{u_1} β (LinearOrder.toPartialOrder.{u_1} β inst._@.Mathlib.Order.Basic._hyg.2450))) c d)) -> (Iff (LT.lt.{u} α (Preorder.toLT.{u} α (PartialOrder.toPreorder.{u} α (LinearOrder.toPartialOrder.{u} α inst._@.Mathlib.Order.Basic._hyg.2447))) b a) (LT.lt.{u_1} β (Preorder.toLT.{u_1} β (PartialOrder.toPreorder.{u_1} β (LinearOrder.toPartialOrder.{u_1} β inst._@.Mathlib.Order.Basic._hyg.2450))) d c))
...
but is expected to have type
  forall {α : Type.{u}} {β : Type.{u_1}} [inst._@.Mathlib.Order.Basic._hyg.2506 : LinearOrder.{u} α] [inst._@.Mathlib.Order.Basic._hyg.2509 : LinearOrder.{u_1} β] {a : α} {b : α} {c : β} {d : β}, Iff (Iff (LE.le.{u} α (Preorder.toLE.{u} α (PartialOrder.toPreorder.{u} α (LinearOrder.toPartialOrder.{u} α inst._@.Mathlib.Order.Basic._hyg.2506))) a b) (LE.le.{u_1} β (Preorder.toLE.{u_1} β (PartialOrder.toPreorder.{u_1} β (LinearOrder.toPartialOrder.{u_1} β inst._@.Mathlib.Order.Basic._hyg.2509))) c d)) (Iff (LT.lt.{u} α (Preorder.toLT.{u} α (PartialOrder.toPreorder.{u} α (LinearOrder.toPartialOrder.{u} α inst._@.Mathlib.Order.Basic._hyg.2506))) b a) (LT.lt.{u_1} β (Preorder.toLT.{u_1} β (PartialOrder.toPreorder.{u_1} β (LinearOrder.toPartialOrder.{u_1} β inst._@.Mathlib.Order.Basic._hyg.2509))) d c))
...
but is expected to have type
  forall {ι : Type.{u}} {α : ι -> Type.{v}} [inst._@.Mathlib.Order.Basic._hyg.6397 : forall (i : ι), Complement.{v} (α i)] (x : forall (i : ι), α i), Eq.{(max (succ u) (succ v))} (forall (i : ι), α i) (Complement.complement.{(max u v)} (forall (i : ι), α i) (Pi.complement.{u v} ι (fun (i : ι) => α i) (fun (i : ι) => inst._@.Mathlib.Order.Basic._hyg.6397 i)) x) (fun (i : ι) => Complement.complement.{v} (α i) (inst._@.Mathlib.Order.Basic._hyg.6397 i) (x i))
...
but is expected to have type
  forall {ι : Type.{u}} {α : ι -> Type.{v}} [inst._@.Mathlib.Order.Basic._hyg.6450 : forall (i : ι), Complement.{v} (α i)] (x : forall (i : ι), α i) (i : ι), Eq.{succ v} (α i) (Complement.complement.{(max u v)} (forall (i : ι), α i) (Pi.complement.{u v} ι (fun (i : ι) => α i) (fun (i : ι) => inst._@.Mathlib.Order.Basic._hyg.6450 i)) x i) (Complement.complement.{v} (α i) (inst._@.Mathlib.Order.Basic._hyg.6450 i) (x i))
...
but is expected to have type
  forall {α : Type.{u_1}} {β : Type.{u_2}} [inst._@.Mathlib.Order.Basic._hyg.8560 : LinearOrder.{u_2} β] (f : α -> β), (Function.injective.{succ u_1 succ u_2} α β f) -> (LinearOrder.{u_1} α)
...
but is expected to have type
  forall {α : Type.{u_1}} {β : Type.{u_2}} [inst._@.Mathlib.Order.Basic._hyg.9134 : LE.{u_1} α] [inst._@.Mathlib.Order.Basic._hyg.9137 : LE.{u_2} β] {x : Prod.{u_1 u_2} α β} {y : Prod.{u_1 u_2} α β}, Iff (LE.le.{(max u_1 u_2)} (Prod.{u_1 u_2} α β) (Prod.has_le.{u_1 u_2} α β inst._@.Mathlib.Order.Basic._hyg.9134 inst._@.Mathlib.Order.Basic._hyg.9137) x y) (And (LE.le.{u_1} α inst._@.Mathlib.Order.Basic._hyg.9134 (Prod.fst.{u_1 u_2} α β x) (Prod.fst.{u_1 u_2} α β y)) (LE.le.{u_2} β inst._@.Mathlib.Order.Basic._hyg.9137 (Prod.snd.{u_1 u_2} α β x) (Prod.snd.{u_1 u_2} α β y)))
...
but is expected to have type
  forall {α : Type.{u_1}} {β : Type.{u_2}} [inst._@.Mathlib.Order.Basic._hyg.9185 : LE.{u_1} α] [inst._@.Mathlib.Order.Basic._hyg.9188 : LE.{u_2} β] {x₁ : α} {x₂ : α} {y₁ : β} {y₂ : β}, Iff (LE.le.{(max u_1 u_2)} (Prod.{u_1 u_2} α β) (Prod.has_le.{u_1 u_2} α β inst._@.Mathlib.Order.Basic._hyg.9185 inst._@.Mathlib.Order.Basic._hyg.9188) (Prod.mk.{u_1 u_2} α β x₁ y₁) (Prod.mk.{u_1 u_2} α β x₂ y₂)) (And (LE.le.{u_1} α inst._@.Mathlib.Order.Basic._hyg.9185 x₁ x₂) (LE.le.{u_2} β inst._@.Mathlib.Order.Basic._hyg.9188 y₁ y₂))
...
but is expected to have type
  forall {α : Type.{u}} {β : Type.{v}} [inst._@.Mathlib.Order.Basic._hyg.9546 : Preorder.{u} α] [inst._@.Mathlib.Order.Basic._hyg.9549 : Preorder.{v} β] {x : Prod.{u v} α β} {y : Prod.{u v} α β}, Iff (LT.lt.{(max u v)} (Prod.{v u} β α) (Preorder.toLT.{(max u v)} (Prod.{v u} β α) (Prod.instPreorderProd.{v u} β α inst._@.Mathlib.Order.Basic._hyg.9549 inst._@.Mathlib.Order.Basic._hyg.9546)) (Prod.swap.{u v} α β x) (Prod.swap.{u v} α β y)) (LT.lt.{(max v u)} (Prod.{u v} α β) (Preorder.toLT.{(max v u)} (Prod.{u v} α β) (Prod.instPreorderProd.{u v} α β inst._@.Mathlib.Order.Basic._hyg.9546 inst._@.Mathlib.Order.Basic._hyg.9549)) x y)
...
but is expected to have type
  forall {α : Type.{u}} {β : Type.{v}} [inst._@.Mathlib.Order.Basic._hyg.9720 : Preorder.{u} α] [inst._@.Mathlib.Order.Basic._hyg.9723 : Preorder.{v} β] {a₁ : α} {a₂ : α} {b : β}, Iff (LT.lt.{(max v u)} (Prod.{u v} α β) (Preorder.toLT.{(max v u)} (Prod.{u v} α β) (Prod.instPreorderProd.{u v} α β inst._@.Mathlib.Order.Basic._hyg.9720 inst._@.Mathlib.Order.Basic._hyg.9723)) (Prod.mk.{u v} α β a₁ b) (Prod.mk.{u v} α β a₂ b)) (LT.lt.{u} α (Preorder.toLT.{u} α inst._@.Mathlib.Order.Basic._hyg.9720) a₁ a₂)
...
but is expected to have type
  forall {α : Type.{u}} {β : Type.{v}} [inst._@.Mathlib.Order.Basic._hyg.9780 : Preorder.{u} α] [inst._@.Mathlib.Order.Basic._hyg.9783 : Preorder.{v} β] {a : α} {b₁ : β} {b₂ : β}, Iff (LT.lt.{(max v u)} (Prod.{u v} α β) (Preorder.toLT.{(max v u)} (Prod.{u v} α β) (Prod.instPreorderProd.{u v} α β inst._@.Mathlib.Order.Basic._hyg.9780 inst._@.Mathlib.Order.Basic._hyg.9783)) (Prod.mk.{u v} α β a b₁) (Prod.mk.{u v} α β a b₂)) (LT.lt.{v} β (Preorder.toLT.{v} β inst._@.Mathlib.Order.Basic._hyg.9783) b₁ b₂)
...
but is expected to have type
  forall {α : Type.{u}} {β : Type.{v}} [inst._@.Mathlib.Order.Basic._hyg.9840 : Preorder.{u} α] [inst._@.Mathlib.Order.Basic._hyg.9843 : Preorder.{v} β] {x : Prod.{u v} α β} {y : Prod.{u v} α β}, Iff (LT.lt.{(max v u)} (Prod.{u v} α β) (Preorder.toLT.{(max v u)} (Prod.{u v} α β) (Prod.instPreorderProd.{u v} α β inst._@.Mathlib.Order.Basic._hyg.9840 inst._@.Mathlib.Order.Basic._hyg.9843)) x y) (Or (And (LT.lt.{u} α (Preorder.toLT.{u} α inst._@.Mathlib.Order.Basic._hyg.9840) (Prod.fst.{u v} α β x) (Prod.fst.{u v} α β y)) (LE.le.{v} β (Preorder.toLE.{v} β inst._@.Mathlib.Order.Basic._hyg.9843) (Prod.snd.{u v} α β x) (Prod.snd.{u v} α β y))) (And (LE.le.{u} α (Preorder.toLE.{u} α inst._@.Mathlib.Order.Basic._hyg.9840) (Prod.fst.{u v} α β x) (Prod.fst.{u v} α β y)) (LT.lt.{v} β (Preorder.toLT.{v} β inst._@.Mathlib.Order.Basic._hyg.9843) (Prod.snd.{u v} α β x) (Prod.snd.{u v} α β y))))
...
but is expected to have type
  forall {α : Type.{u}} {β : Type.{v}} [inst._@.Mathlib.Order.Basic._hyg.10003 : Preorder.{u} α] [inst._@.Mathlib.Order.Basic._hyg.10006 : Preorder.{v} β] {a₁ : α} {a₂ : α} {b₁ : β} {b₂ : β}, Iff (LT.lt.{(max v u)} (Prod.{u v} α β) (Preorder.toLT.{(max v u)} (Prod.{u v} α β) (Prod.instPreorderProd.{u v} α β inst._@.Mathlib.Order.Basic._hyg.10003 inst._@.Mathlib.Order.Basic._hyg.10006)) (Prod.mk.{u v} α β a₁ b₁) (Prod.mk.{u v} α β a₂ b₂)) (Or (And (LT.lt.{u} α (Preorder.toLT.{u} α inst._@.Mathlib.Order.Basic._hyg.10003) a₁ a₂) (LE.le.{v} β (Preorder.toLE.{v} β inst._@.Mathlib.Order.Basic._hyg.10006) b₁ b₂)) (And (LE.le.{u} α (Preorder.toLE.{u} α inst._@.Mathlib.Order.Basic._hyg.10003) a₁ a₂) (LT.lt.{v} β (Preorder.toLT.{v} β inst._@.Mathlib.Order.Basic._hyg.10006) b₁ b₂)))
