...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `supr_disjointed [])
  (Command.declSig
  ...
  (Command.declValSimple
   ":="
   (Term.app `supr_eq_supr_of_partial_sups_eq_partial_sups [(Term.app `partial_sups_disjointed [`f])])
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `partial_sups_disjointed [`f])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `partial_sups_disjointed [`f]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `disjointed_eq_inf_compl [])
  (Command.declSig
   [(Term.explicitBinder "(" [`f] [":" (Term.arrow (termℕ "ℕ") "→" `α)] [] ")")
          ...
          (Tactic.tacticSeq1Indented
           [(group
             (Tactic.rwSeq
              ...
              (Tactic.rwRuleSeq
               "["
               [(Tactic.rwRule [] `disjointed_zero) "," (Tactic.rwRule [] `eq_comm) "," (Tactic.rwRule [] `inf_eq_left)]
               "]")
              [])
             [])
            (group (Tactic.simpRw "simp_rw" (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `le_infi_iff)] "]") []) [])
            (group
             (Tactic.exact
              "exact"
              (Term.fun
               ...
               (Term.basicFun
                ...
                "=>"
                (Term.proj (Term.app `i.not_lt_zero [`hi]) "." `elim))))
             [])])))
        [])
       (group
        (Tactic.simpRw
         ...
         (Tactic.rwRuleSeq
          "["
          [(Tactic.rwRule [] `disjointed_succ)
           ","
           (Tactic.rwRule [] `partial_sups_eq_bsupr)
           ","
           (Tactic.rwRule [] `sdiff_eq)
           ","
           (Tactic.rwRule [] `compl_supr)]
          "]")
         [])
        [])
     ...
     [(group
      ...
      (group
       (Tactic.exact
        ...
        (Term.fun
         "fun"
         (Term.basicFun [(Term.simpleBinder [`i `hi] [])] "=>" (Term.proj (Term.app `i.not_lt_zero [`hi]) "." `elim))))
       [])])))
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `i.not_lt_zero [`hi]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.simpRw "simp_rw" (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `le_infi_iff)] "]") [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simpRw', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `le_infi_iff
...
theorem
  ...
  ( f : ℕ → α ) ( n : ℕ ) : disjointed f n = f n ⊓ ⨅ ( i : _ ) ( _ : i < n ) , f i ᶜ
  :=
    by
      cases n
        ·
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `Union_disjointed [])
  (Command.declSig
   ...
   (Term.typeSpec
    ...
    («term_=_»
     ...
     (Set.Data.Set.Lattice.«term⋃_,_»
      ...
      ", "
      (Term.app `f [`n])))))
  (Command.declValSimple ":=" (Term.app `supr_disjointed [`f]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
theorem Union_disjointed { f : ℕ → Set α } : ⋃ n , disjointed f n = ⋃ n , f n := supr_disjointed f
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `disjointed_eq_inter_compl [])
  (Command.declSig
   [(Term.explicitBinder "(" [`f] [":" (Term.arrow (termℕ "ℕ") "→" (Term.app `Set [`α]))] [] ")")
    (Term.explicitBinder "(" [`n] [":" (termℕ "ℕ")] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     ...
     (Init.Core.«term_∩_»
      ...
      (Set.Data.Set.Lattice.«term⋂_,_»
       ...
       ", "
       (Order.BooleanAlgebra.«term_ᶜ» (Term.app `f [`i]) "ᶜ"))))))
  (Command.declValSimple ":=" (Term.app `disjointed_eq_inf_compl [`f `n]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `disjointed_eq_inf_compl [`f `n])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
theorem
  ...
  ( f : ℕ → Set α ) ( n : ℕ ) : disjointed f n = f n ∩ ⋂ ( i : _ ) ( _ : i < n ) , f i ᶜ
