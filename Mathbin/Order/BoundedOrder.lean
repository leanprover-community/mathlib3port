...
but is expected to have type
  forall {α : Type.{u1}} [_inst_1 : Preorder.{u1} α] {x : α}, Monotone.{u1, 0} α Prop _inst_1 (PartialOrder.toPreorder.{0} Prop instPartialOrderProp) ((fun (x._@.Mathlib.Order.BoundedOrder._hyg.4479 : α) (x._@.Mathlib.Order.BoundedOrder._hyg.4481 : α) => LT.lt.{u1} α (Preorder.toLT.{u1} α _inst_1) x._@.Mathlib.Order.BoundedOrder._hyg.4479 x._@.Mathlib.Order.BoundedOrder._hyg.4481) x)
...
but is expected to have type
  forall {α : Type.{u1}} {p : α -> Prop} [_inst_1 : LE.{u1} α] [_inst_2 : OrderBot.{u1} α _inst_1], (p (Bot.bot.{u1} α (OrderBot.toBot.{u1} α _inst_1 _inst_2))) -> (OrderBot.{u1} (Subtype.{succ u1} α (fun (x : α) => p x)) (Subtype.instLESubtype.{u1} α _inst_1 (fun (x : α) => p x)))
...
but is expected to have type
  forall {α : Type.{u1}} {p : α -> Prop} [_inst_1 : LE.{u1} α] [_inst_2 : OrderTop.{u1} α _inst_1], (p (Top.top.{u1} α (OrderTop.toTop.{u1} α _inst_1 _inst_2))) -> (OrderTop.{u1} (Subtype.{succ u1} α (fun (x : α) => p x)) (Subtype.instLESubtype.{u1} α _inst_1 (fun (x : α) => p x)))
...
but is expected to have type
  forall {α : Type.{u1}} {p : α -> Prop} [_inst_1 : LE.{u1} α] [_inst_2 : BoundedOrder.{u1} α _inst_1], (p (Bot.bot.{u1} α (OrderBot.toBot.{u1} α _inst_1 (BoundedOrder.toOrderBot.{u1} α _inst_1 _inst_2)))) -> (p (Top.top.{u1} α (OrderTop.toTop.{u1} α _inst_1 (BoundedOrder.toOrderTop.{u1} α _inst_1 _inst_2)))) -> (BoundedOrder.{u1} (Subtype.{succ u1} α p) (Subtype.instLESubtype.{u1} α _inst_1 p))
...
but is expected to have type
  forall {α : Type.{u1}} {p : α -> Prop} [_inst_1 : PartialOrder.{u1} α] [_inst_2 : OrderBot.{u1} α (Preorder.toLE.{u1} α (PartialOrder.toPreorder.{u1} α _inst_1))] [_inst_3 : OrderBot.{u1} (Subtype.{succ u1} α p) (Subtype.instLESubtype.{u1} α (Preorder.toLE.{u1} α (PartialOrder.toPreorder.{u1} α _inst_1)) p)] (hbot : p (Bot.bot.{u1} α (OrderBot.toBot.{u1} α (Preorder.toLE.{u1} α (PartialOrder.toPreorder.{u1} α _inst_1)) _inst_2))), Eq.{succ u1} (Subtype.{succ u1} α p) (Subtype.mk.{succ u1} α p (Bot.bot.{u1} α (OrderBot.toBot.{u1} α (Preorder.toLE.{u1} α (PartialOrder.toPreorder.{u1} α _inst_1)) _inst_2)) hbot) (Bot.bot.{u1} (Subtype.{succ u1} α p) (OrderBot.toBot.{u1} (Subtype.{succ u1} α p) (Subtype.instLESubtype.{u1} α (Preorder.toLE.{u1} α (PartialOrder.toPreorder.{u1} α _inst_1)) p) _inst_3))
...
but is expected to have type
  forall {α : Type.{u1}} {p : α -> Prop} [_inst_1 : PartialOrder.{u1} α] [_inst_2 : OrderTop.{u1} α (Preorder.toLE.{u1} α (PartialOrder.toPreorder.{u1} α _inst_1))] [_inst_3 : OrderTop.{u1} (Subtype.{succ u1} α p) (Subtype.instLESubtype.{u1} α (Preorder.toLE.{u1} α (PartialOrder.toPreorder.{u1} α _inst_1)) p)] (htop : p (Top.top.{u1} α (OrderTop.toTop.{u1} α (Preorder.toLE.{u1} α (PartialOrder.toPreorder.{u1} α _inst_1)) _inst_2))), Eq.{succ u1} (Subtype.{succ u1} α p) (Subtype.mk.{succ u1} α p (Top.top.{u1} α (OrderTop.toTop.{u1} α (Preorder.toLE.{u1} α (PartialOrder.toPreorder.{u1} α _inst_1)) _inst_2)) htop) (Top.top.{u1} (Subtype.{succ u1} α p) (OrderTop.toTop.{u1} (Subtype.{succ u1} α p) (Subtype.instLESubtype.{u1} α (Preorder.toLE.{u1} α (PartialOrder.toPreorder.{u1} α _inst_1)) p) _inst_3))
...
but is expected to have type
  forall {α : Type.{u1}} {p : α -> Prop} [_inst_1 : PartialOrder.{u1} α] [_inst_2 : OrderBot.{u1} α (Preorder.toLE.{u1} α (PartialOrder.toPreorder.{u1} α _inst_1))] [_inst_3 : OrderBot.{u1} (Subtype.{succ u1} α p) (Subtype.instLESubtype.{u1} α (Preorder.toLE.{u1} α (PartialOrder.toPreorder.{u1} α _inst_1)) p)], (p (Bot.bot.{u1} α (OrderBot.toBot.{u1} α (Preorder.toLE.{u1} α (PartialOrder.toPreorder.{u1} α _inst_1)) _inst_2))) -> (forall {x : α} (hx : p x), Iff (Eq.{succ u1} (Subtype.{succ u1} α p) (Subtype.mk.{succ u1} α p x hx) (Bot.bot.{u1} (Subtype.{succ u1} α p) (OrderBot.toBot.{u1} (Subtype.{succ u1} α p) (Subtype.instLESubtype.{u1} α (Preorder.toLE.{u1} α (PartialOrder.toPreorder.{u1} α _inst_1)) p) _inst_3))) (Eq.{succ u1} α x (Bot.bot.{u1} α (OrderBot.toBot.{u1} α (Preorder.toLE.{u1} α (PartialOrder.toPreorder.{u1} α _inst_1)) _inst_2))))
...
but is expected to have type
  forall {α : Type.{u1}} {p : α -> Prop} [_inst_1 : PartialOrder.{u1} α] [_inst_2 : OrderTop.{u1} α (Preorder.toLE.{u1} α (PartialOrder.toPreorder.{u1} α _inst_1))] [_inst_3 : OrderTop.{u1} (Subtype.{succ u1} α p) (Subtype.instLESubtype.{u1} α (Preorder.toLE.{u1} α (PartialOrder.toPreorder.{u1} α _inst_1)) p)], (p (Top.top.{u1} α (OrderTop.toTop.{u1} α (Preorder.toLE.{u1} α (PartialOrder.toPreorder.{u1} α _inst_1)) _inst_2))) -> (forall {x : α} (hx : p x), Iff (Eq.{succ u1} (Subtype.{succ u1} α p) (Subtype.mk.{succ u1} α p x hx) (Top.top.{u1} (Subtype.{succ u1} α p) (OrderTop.toTop.{u1} (Subtype.{succ u1} α p) (Subtype.instLESubtype.{u1} α (Preorder.toLE.{u1} α (PartialOrder.toPreorder.{u1} α _inst_1)) p) _inst_3))) (Eq.{succ u1} α x (Top.top.{u1} α (OrderTop.toTop.{u1} α (Preorder.toLE.{u1} α (PartialOrder.toPreorder.{u1} α _inst_1)) _inst_2))))
