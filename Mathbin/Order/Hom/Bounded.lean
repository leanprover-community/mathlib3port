...
but is expected to have type
  forall {α : Type.{u2}} {β : Type.{u1}} [_inst_1 : Top.{u2} α] [_inst_2 : Top.{u1} β] {f : TopHom.{u2, u1} α β _inst_1 _inst_2} {g : TopHom.{u2, u1} α β _inst_1 _inst_2}, (forall (a : α), Eq.{succ u1} ((fun (x._@.Mathlib.Order.Hom.Bounded._hyg.231 : α) => β) a) (FunLike.coe.{max (succ u2) (succ u1), succ u2, succ u1} (TopHom.{u2, u1} α β _inst_1 _inst_2) α (fun (_x : α) => (fun (x._@.Mathlib.Order.Hom.Bounded._hyg.231 : α) => β) _x) (TopHomClass.toFunLike.{max u2 u1, u2, u1} (TopHom.{u2, u1} α β _inst_1 _inst_2) α β _inst_1 _inst_2 (TopHom.instTopHomClassTopHom.{u2, u1} α β _inst_1 _inst_2)) f a) (FunLike.coe.{max (succ u2) (succ u1), succ u2, succ u1} (TopHom.{u2, u1} α β _inst_1 _inst_2) α (fun (_x : α) => (fun (x._@.Mathlib.Order.Hom.Bounded._hyg.231 : α) => β) _x) (TopHomClass.toFunLike.{max u2 u1, u2, u1} (TopHom.{u2, u1} α β _inst_1 _inst_2) α β _inst_1 _inst_2 (TopHom.instTopHomClassTopHom.{u2, u1} α β _inst_1 _inst_2)) g a)) -> (Eq.{max (succ u2) (succ u1)} (TopHom.{u2, u1} α β _inst_1 _inst_2) f g)
...
but is expected to have type
  forall {α : Type.{u1}} {β : Type.{u2}} [_inst_1 : Top.{u1} α] [_inst_2 : Top.{u2} β] (f : TopHom.{u1, u2} α β _inst_1 _inst_2) (f' : α -> β), (Eq.{max (succ u1) (succ u2)} (α -> β) f' (FunLike.coe.{max (succ u1) (succ u2), succ u1, succ u2} (TopHom.{u1, u2} α β _inst_1 _inst_2) α (fun (_x : α) => (fun (x._@.Mathlib.Order.Hom.Bounded._hyg.231 : α) => β) _x) (TopHomClass.toFunLike.{max u1 u2, u1, u2} (TopHom.{u1, u2} α β _inst_1 _inst_2) α β _inst_1 _inst_2 (TopHom.instTopHomClassTopHom.{u1, u2} α β _inst_1 _inst_2)) f)) -> (TopHom.{u1, u2} α β _inst_1 _inst_2)
...
but is expected to have type
  forall {α : Type.{u2}} {β : Type.{u1}} [_inst_1 : Top.{u2} α] [_inst_2 : Top.{u1} β] (f : TopHom.{u2, u1} α β _inst_1 _inst_2) (f' : α -> β) (h : Eq.{max (succ u2) (succ u1)} (α -> β) f' (FunLike.coe.{max (succ u2) (succ u1), succ u2, succ u1} (TopHom.{u2, u1} α β _inst_1 _inst_2) α (fun (_x : α) => (fun (x._@.Mathlib.Order.Hom.Bounded._hyg.231 : α) => β) _x) (TopHomClass.toFunLike.{max u2 u1, u2, u1} (TopHom.{u2, u1} α β _inst_1 _inst_2) α β _inst_1 _inst_2 (TopHom.instTopHomClassTopHom.{u2, u1} α β _inst_1 _inst_2)) f)), Eq.{max (succ u2) (succ u1)} (forall (ᾰ : α), (fun (x._@.Mathlib.Order.Hom.Bounded._hyg.231 : α) => β) ᾰ) (FunLike.coe.{max (succ u2) (succ u1), succ u2, succ u1} (TopHom.{u2, u1} α β _inst_1 _inst_2) α (fun (_x : α) => (fun (x._@.Mathlib.Order.Hom.Bounded._hyg.231 : α) => β) _x) (TopHomClass.toFunLike.{max u2 u1, u2, u1} (TopHom.{u2, u1} α β _inst_1 _inst_2) α β _inst_1 _inst_2 (TopHom.instTopHomClassTopHom.{u2, u1} α β _inst_1 _inst_2)) (TopHom.copy.{u2, u1} α β _inst_1 _inst_2 f f' h)) f'
...
but is expected to have type
  forall {α : Type.{u2}} {β : Type.{u1}} [_inst_1 : Top.{u2} α] [_inst_2 : Top.{u1} β] (f : TopHom.{u2, u1} α β _inst_1 _inst_2) (f' : α -> β) (h : Eq.{max (succ u2) (succ u1)} (α -> β) f' (FunLike.coe.{max (succ u2) (succ u1), succ u2, succ u1} (TopHom.{u2, u1} α β _inst_1 _inst_2) α (fun (_x : α) => (fun (x._@.Mathlib.Order.Hom.Bounded._hyg.231 : α) => β) _x) (TopHomClass.toFunLike.{max u2 u1, u2, u1} (TopHom.{u2, u1} α β _inst_1 _inst_2) α β _inst_1 _inst_2 (TopHom.instTopHomClassTopHom.{u2, u1} α β _inst_1 _inst_2)) f)), Eq.{max (succ u2) (succ u1)} (TopHom.{u2, u1} α β _inst_1 _inst_2) (TopHom.copy.{u2, u1} α β _inst_1 _inst_2 f f' h) f
...
but is expected to have type
  forall (α : Type.{u1}) [_inst_1 : Top.{u1} α], Eq.{succ u1} (forall (ᾰ : α), (fun (x._@.Mathlib.Order.Hom.Bounded._hyg.231 : α) => α) ᾰ) (FunLike.coe.{succ u1, succ u1, succ u1} (TopHom.{u1, u1} α α _inst_1 _inst_1) α (fun (_x : α) => (fun (x._@.Mathlib.Order.Hom.Bounded._hyg.231 : α) => α) _x) (TopHomClass.toFunLike.{u1, u1, u1} (TopHom.{u1, u1} α α _inst_1 _inst_1) α α _inst_1 _inst_1 (TopHom.instTopHomClassTopHom.{u1, u1} α α _inst_1 _inst_1)) (TopHom.id.{u1} α _inst_1)) (id.{succ u1} α)
...
but is expected to have type
  forall {α : Type.{u1}} [_inst_1 : Top.{u1} α] (a : α), Eq.{succ u1} ((fun (x._@.Mathlib.Order.Hom.Bounded._hyg.231 : α) => α) a) (FunLike.coe.{succ u1, succ u1, succ u1} (TopHom.{u1, u1} α α _inst_1 _inst_1) α (fun (_x : α) => (fun (x._@.Mathlib.Order.Hom.Bounded._hyg.231 : α) => α) _x) (TopHomClass.toFunLike.{u1, u1, u1} (TopHom.{u1, u1} α α _inst_1 _inst_1) α α _inst_1 _inst_1 (TopHom.instTopHomClassTopHom.{u1, u1} α α _inst_1 _inst_1)) (TopHom.id.{u1} α _inst_1) a) a
...
but is expected to have type
  forall {α : Type.{u1}} {β : Type.{u3}} {γ : Type.{u2}} [_inst_1 : Top.{u1} α] [_inst_2 : Top.{u3} β] [_inst_3 : Top.{u2} γ] (f : TopHom.{u3, u2} β γ _inst_2 _inst_3) (g : TopHom.{u1, u3} α β _inst_1 _inst_2), Eq.{max (succ u1) (succ u2)} (forall (a : α), (fun (x._@.Mathlib.Order.Hom.Bounded._hyg.231 : α) => γ) a) (FunLike.coe.{max (succ u1) (succ u2), succ u1, succ u2} (TopHom.{u1, u2} α γ _inst_1 _inst_3) α (fun (_x : α) => (fun (x._@.Mathlib.Order.Hom.Bounded._hyg.231 : α) => γ) _x) (TopHomClass.toFunLike.{max u1 u2, u1, u2} (TopHom.{u1, u2} α γ _inst_1 _inst_3) α γ _inst_1 _inst_3 (TopHom.instTopHomClassTopHom.{u1, u2} α γ _inst_1 _inst_3)) (TopHom.comp.{u1, u3, u2} α β γ _inst_1 _inst_2 _inst_3 f g)) (Function.comp.{succ u1, succ u3, succ u2} α β γ (FunLike.coe.{max (succ u3) (succ u2), succ u3, succ u2} (TopHom.{u3, u2} β γ _inst_2 _inst_3) β (fun (_x : β) => (fun (x._@.Mathlib.Order.Hom.Bounded._hyg.231 : β) => γ) _x) (TopHomClass.toFunLike.{max u3 u2, u3, u2} (TopHom.{u3, u2} β γ _inst_2 _inst_3) β γ _inst_2 _inst_3 (TopHom.instTopHomClassTopHom.{u3, u2} β γ _inst_2 _inst_3)) f) (FunLike.coe.{max (succ u1) (succ u3), succ u1, succ u3} (TopHom.{u1, u3} α β _inst_1 _inst_2) α (fun (_x : α) => (fun (x._@.Mathlib.Order.Hom.Bounded._hyg.231 : α) => β) _x) (TopHomClass.toFunLike.{max u1 u3, u1, u3} (TopHom.{u1, u3} α β _inst_1 _inst_2) α β _inst_1 _inst_2 (TopHom.instTopHomClassTopHom.{u1, u3} α β _inst_1 _inst_2)) g))
...
but is expected to have type
  forall {α : Type.{u1}} {β : Type.{u3}} {γ : Type.{u2}} [_inst_1 : Top.{u1} α] [_inst_2 : Top.{u3} β] [_inst_3 : Top.{u2} γ] (f : TopHom.{u3, u2} β γ _inst_2 _inst_3) (g : TopHom.{u1, u3} α β _inst_1 _inst_2) (a : α), Eq.{succ u2} ((fun (x._@.Mathlib.Order.Hom.Bounded._hyg.231 : α) => γ) a) (FunLike.coe.{max (succ u1) (succ u2), succ u1, succ u2} (TopHom.{u1, u2} α γ _inst_1 _inst_3) α (fun (_x : α) => (fun (x._@.Mathlib.Order.Hom.Bounded._hyg.231 : α) => γ) _x) (TopHomClass.toFunLike.{max u1 u2, u1, u2} (TopHom.{u1, u2} α γ _inst_1 _inst_3) α γ _inst_1 _inst_3 (TopHom.instTopHomClassTopHom.{u1, u2} α γ _inst_1 _inst_3)) (TopHom.comp.{u1, u3, u2} α β γ _inst_1 _inst_2 _inst_3 f g) a) (FunLike.coe.{max (succ u3) (succ u2), succ u3, succ u2} (TopHom.{u3, u2} β γ _inst_2 _inst_3) β (fun (_x : β) => (fun (x._@.Mathlib.Order.Hom.Bounded._hyg.231 : β) => γ) _x) (TopHomClass.toFunLike.{max u3 u2, u3, u2} (TopHom.{u3, u2} β γ _inst_2 _inst_3) β γ _inst_2 _inst_3 (TopHom.instTopHomClassTopHom.{u3, u2} β γ _inst_2 _inst_3)) f (FunLike.coe.{max (succ u1) (succ u3), succ u1, succ u3} (TopHom.{u1, u3} α β _inst_1 _inst_2) α (fun (_x : α) => (fun (x._@.Mathlib.Order.Hom.Bounded._hyg.231 : α) => β) _x) (TopHomClass.toFunLike.{max u1 u3, u1, u3} (TopHom.{u1, u3} α β _inst_1 _inst_2) α β _inst_1 _inst_2 (TopHom.instTopHomClassTopHom.{u1, u3} α β _inst_1 _inst_2)) g a))
...
but is expected to have type
  forall {α : Type.{u1}} {β : Type.{u3}} {γ : Type.{u2}} [_inst_1 : Top.{u1} α] [_inst_2 : Top.{u3} β] [_inst_3 : Top.{u2} γ] {g : TopHom.{u3, u2} β γ _inst_2 _inst_3} {f₁ : TopHom.{u1, u3} α β _inst_1 _inst_2} {f₂ : TopHom.{u1, u3} α β _inst_1 _inst_2}, (Function.Injective.{succ u3, succ u2} β γ (FunLike.coe.{max (succ u3) (succ u2), succ u3, succ u2} (TopHom.{u3, u2} β γ _inst_2 _inst_3) β (fun (_x : β) => (fun (x._@.Mathlib.Order.Hom.Bounded._hyg.231 : β) => γ) _x) (TopHomClass.toFunLike.{max u3 u2, u3, u2} (TopHom.{u3, u2} β γ _inst_2 _inst_3) β γ _inst_2 _inst_3 (TopHom.instTopHomClassTopHom.{u3, u2} β γ _inst_2 _inst_3)) g)) -> (Iff (Eq.{max (succ u1) (succ u2)} (TopHom.{u1, u2} α γ _inst_1 _inst_3) (TopHom.comp.{u1, u3, u2} α β γ _inst_1 _inst_2 _inst_3 g f₁) (TopHom.comp.{u1, u3, u2} α β γ _inst_1 _inst_2 _inst_3 g f₂)) (Eq.{max (succ u1) (succ u3)} (TopHom.{u1, u3} α β _inst_1 _inst_2) f₁ f₂))
...
lean 3 declaration is
  forall {α : Type.{u1}} {β : Type.{u2}} [_inst_1 : Top.{u1} α] [_inst_2 : SemilatticeInf.{u2} β] [_inst_3 : OrderTop.{u2} β (Preorder.toHasLe.{u2} β (PartialOrder.toPreorder.{u2} β (SemilatticeInf.toPartialOrder.{u2} β _inst_2)))] (f : TopHom.{u1, u2} α β _inst_1 (OrderTop.toHasTop.{u2} β (Preorder.toHasLe.{u2} β (PartialOrder.toPreorder.{u2} β (SemilatticeInf.toPartialOrder.{u2} β _inst_2))) _inst_3)) (g : TopHom.{u1, u2} α β _inst_1 (OrderTop.toHasTop.{u2} β (Preorder.toHasLe.{u2} β (PartialOrder.toPreorder.{u2} β (SemilatticeInf.toPartialOrder.{u2} β _inst_2))) _inst_3)), Eq.{succ (max u1 u2)} (α -> β) (coeFn.{succ (max u1 u2), succ (max u1 u2)} (TopHom.{u1, u2} α β _inst_1 (OrderTop.toHasTop.{u2} β (Preorder.toHasLe.{u2} β (PartialOrder.toPreorder.{u2} β (SemilatticeInf.toPartialOrder.{u2} β _inst_2))) _inst_3)) (fun (_x : TopHom.{u1, u2} α β _inst_1 (OrderTop.toHasTop.{u2} β (Preorder.toHasLe.{u2} β (PartialOrder.toPreorder.{u2} β (SemilatticeInf.toPartialOrder.{u2} β _inst_2))) _inst_3)) => α -> β) (TopHom.hasCoeToFun.{u1, u2} α β _inst_1 (OrderTop.toHasTop.{u2} β (Preorder.toHasLe.{u2} β (PartialOrder.toPreorder.{u2} β (SemilatticeInf.toPartialOrder.{u2} β _inst_2))) _inst_3)) (Inf.inf.{max u1 u2} (TopHom.{u1, u2} α β _inst_1 (OrderTop.toHasTop.{u2} β (Preorder.toHasLe.{u2} β (PartialOrder.toPreorder.{u2} β (SemilatticeInf.toPartialOrder.{u2} β _inst_2))) _inst_3)) (TopHom.hasInf.{u1, u2} α β _inst_1 _inst_2 _inst_3) f g)) (Inf.inf.{max u1 u2} (α -> β) (Pi.hasInf.{u1, u2} α (fun (ᾰ : α) => β) (fun (i : α) => SemilatticeInf.toHasInf.{u2} β _inst_2)) (coeFn.{max (succ u1) (succ u2), max (succ u1) (succ u2)} (TopHom.{u1, u2} α β _inst_1 (OrderTop.toHasTop.{u2} β (Preorder.toHasLe.{u2} β (PartialOrder.toPreorder.{u2} β (SemilatticeInf.toPartialOrder.{u2} β _inst_2))) _inst_3)) (fun (_x : TopHom.{u1, u2} α β _inst_1 (OrderTop.toHasTop.{u2} β (Preorder.toHasLe.{u2} β (PartialOrder.toPreorder.{u2} β (SemilatticeInf.toPartialOrder.{u2} β _inst_2))) _inst_3)) => α -> β) (TopHom.hasCoeToFun.{u1, u2} α β _inst_1 (OrderTop.toHasTop.{u2} β (Preorder.toHasLe.{u2} β (PartialOrder.toPreorder.{u2} β (SemilatticeInf.toPartialOrder.{u2} β _inst_2))) _inst_3)) f) (coeFn.{max (succ u1) (succ u2), max (succ u1) (succ u2)} (TopHom.{u1, u2} α β _inst_1 (OrderTop.toHasTop.{u2} β (Preorder.toHasLe.{u2} β (PartialOrder.toPreorder.{u2} β (SemilatticeInf.toPartialOrder.{u2} β _inst_2))) _inst_3)) (fun (_x : TopHom.{u1, u2} α β _inst_1 (OrderTop.toHasTop.{u2} β (Preorder.toHasLe.{u2} β (PartialOrder.toPreorder.{u2} β (SemilatticeInf.toPartialOrder.{u2} β _inst_2))) _inst_3)) => α -> β) (TopHom.hasCoeToFun.{u1, u2} α β _inst_1 (OrderTop.toHasTop.{u2} β (Preorder.toHasLe.{u2} β (PartialOrder.toPreorder.{u2} β (SemilatticeInf.toPartialOrder.{u2} β _inst_2))) _inst_3)) g))
but is expected to have type
...
lean 3 declaration is
  forall {α : Type.{u1}} {β : Type.{u2}} [_inst_1 : Top.{u1} α] [_inst_2 : SemilatticeInf.{u2} β] [_inst_3 : OrderTop.{u2} β (Preorder.toHasLe.{u2} β (PartialOrder.toPreorder.{u2} β (SemilatticeInf.toPartialOrder.{u2} β _inst_2)))] (f : TopHom.{u1, u2} α β _inst_1 (OrderTop.toHasTop.{u2} β (Preorder.toHasLe.{u2} β (PartialOrder.toPreorder.{u2} β (SemilatticeInf.toPartialOrder.{u2} β _inst_2))) _inst_3)) (g : TopHom.{u1, u2} α β _inst_1 (OrderTop.toHasTop.{u2} β (Preorder.toHasLe.{u2} β (PartialOrder.toPreorder.{u2} β (SemilatticeInf.toPartialOrder.{u2} β _inst_2))) _inst_3)) (a : α), Eq.{succ u2} β (coeFn.{max (succ u1) (succ u2), max (succ u1) (succ u2)} (TopHom.{u1, u2} α β _inst_1 (OrderTop.toHasTop.{u2} β (Preorder.toHasLe.{u2} β (PartialOrder.toPreorder.{u2} β (SemilatticeInf.toPartialOrder.{u2} β _inst_2))) _inst_3)) (fun (_x : TopHom.{u1, u2} α β _inst_1 (OrderTop.toHasTop.{u2} β (Preorder.toHasLe.{u2} β (PartialOrder.toPreorder.{u2} β (SemilatticeInf.toPartialOrder.{u2} β _inst_2))) _inst_3)) => α -> β) (TopHom.hasCoeToFun.{u1, u2} α β _inst_1 (OrderTop.toHasTop.{u2} β (Preorder.toHasLe.{u2} β (PartialOrder.toPreorder.{u2} β (SemilatticeInf.toPartialOrder.{u2} β _inst_2))) _inst_3)) (Inf.inf.{max u1 u2} (TopHom.{u1, u2} α β _inst_1 (OrderTop.toHasTop.{u2} β (Preorder.toHasLe.{u2} β (PartialOrder.toPreorder.{u2} β (SemilatticeInf.toPartialOrder.{u2} β _inst_2))) _inst_3)) (TopHom.hasInf.{u1, u2} α β _inst_1 _inst_2 _inst_3) f g) a) (Inf.inf.{u2} β (SemilatticeInf.toHasInf.{u2} β _inst_2) (coeFn.{max (succ u1) (succ u2), max (succ u1) (succ u2)} (TopHom.{u1, u2} α β _inst_1 (OrderTop.toHasTop.{u2} β (Preorder.toHasLe.{u2} β (PartialOrder.toPreorder.{u2} β (SemilatticeInf.toPartialOrder.{u2} β _inst_2))) _inst_3)) (fun (_x : TopHom.{u1, u2} α β _inst_1 (OrderTop.toHasTop.{u2} β (Preorder.toHasLe.{u2} β (PartialOrder.toPreorder.{u2} β (SemilatticeInf.toPartialOrder.{u2} β _inst_2))) _inst_3)) => α -> β) (TopHom.hasCoeToFun.{u1, u2} α β _inst_1 (OrderTop.toHasTop.{u2} β (Preorder.toHasLe.{u2} β (PartialOrder.toPreorder.{u2} β (SemilatticeInf.toPartialOrder.{u2} β _inst_2))) _inst_3)) f a) (coeFn.{max (succ u1) (succ u2), max (succ u1) (succ u2)} (TopHom.{u1, u2} α β _inst_1 (OrderTop.toHasTop.{u2} β (Preorder.toHasLe.{u2} β (PartialOrder.toPreorder.{u2} β (SemilatticeInf.toPartialOrder.{u2} β _inst_2))) _inst_3)) (fun (_x : TopHom.{u1, u2} α β _inst_1 (OrderTop.toHasTop.{u2} β (Preorder.toHasLe.{u2} β (PartialOrder.toPreorder.{u2} β (SemilatticeInf.toPartialOrder.{u2} β _inst_2))) _inst_3)) => α -> β) (TopHom.hasCoeToFun.{u1, u2} α β _inst_1 (OrderTop.toHasTop.{u2} β (Preorder.toHasLe.{u2} β (PartialOrder.toPreorder.{u2} β (SemilatticeInf.toPartialOrder.{u2} β _inst_2))) _inst_3)) g a))
but is expected to have type
...
but is expected to have type
  forall {α : Type.{u1}} {β : Type.{u3}} {γ : Type.{u2}} [_inst_1 : Bot.{u1} α] [_inst_2 : Bot.{u3} β] [_inst_3 : Bot.{u2} γ] (f : BotHom.{u3, u2} β γ _inst_2 _inst_3) (g : BotHom.{u1, u3} α β _inst_1 _inst_2) (a : α), Eq.{succ u2} ((fun (x._@.Mathlib.Order.Hom.Bounded._hyg.278 : α) => γ) a) (FunLike.coe.{max (succ u1) (succ u2), succ u1, succ u2} (BotHom.{u1, u2} α γ _inst_1 _inst_3) α (fun (_x : α) => (fun (x._@.Mathlib.Order.Hom.Bounded._hyg.278 : α) => γ) _x) (BotHomClass.toFunLike.{max u1 u2, u1, u2} (BotHom.{u1, u2} α γ _inst_1 _inst_3) α γ _inst_1 _inst_3 (BotHom.instBotHomClassBotHom.{u1, u2} α γ _inst_1 _inst_3)) (BotHom.comp.{u1, u3, u2} α β γ _inst_1 _inst_2 _inst_3 f g) a) (FunLike.coe.{max (succ u3) (succ u2), succ u3, succ u2} (BotHom.{u3, u2} β γ _inst_2 _inst_3) β (fun (_x : β) => (fun (x._@.Mathlib.Order.Hom.Bounded._hyg.278 : β) => γ) _x) (BotHomClass.toFunLike.{max u3 u2, u3, u2} (BotHom.{u3, u2} β γ _inst_2 _inst_3) β γ _inst_2 _inst_3 (BotHom.instBotHomClassBotHom.{u3, u2} β γ _inst_2 _inst_3)) f (FunLike.coe.{max (succ u1) (succ u3), succ u1, succ u3} (BotHom.{u1, u3} α β _inst_1 _inst_2) α (fun (_x : α) => (fun (x._@.Mathlib.Order.Hom.Bounded._hyg.278 : α) => β) _x) (BotHomClass.toFunLike.{max u1 u3, u1, u3} (BotHom.{u1, u3} α β _inst_1 _inst_2) α β _inst_1 _inst_2 (BotHom.instBotHomClassBotHom.{u1, u3} α β _inst_1 _inst_2)) g a))
...
lean 3 declaration is
  forall (α : Type.{u1}) [_inst_1 : Preorder.{u1} α] [_inst_5 : BoundedOrder.{u1} α (Preorder.toHasLe.{u1} α _inst_1)], Eq.{succ u1} (α -> α) (coeFn.{succ u1, succ u1} (BoundedOrderHom.{u1, u1} α α _inst_1 _inst_1 _inst_5 _inst_5) (fun (_x : BoundedOrderHom.{u1, u1} α α _inst_1 _inst_1 _inst_5 _inst_5) => α -> α) (BoundedOrderHom.hasCoeToFun.{u1, u1} α α _inst_1 _inst_1 _inst_5 _inst_5) (BoundedOrderHom.id.{u1} α _inst_1 _inst_5)) (id.{succ u1} α)
but is expected to have type
...
lean 3 declaration is
  forall {α : Type.{u1}} [_inst_1 : Preorder.{u1} α] [_inst_5 : BoundedOrder.{u1} α (Preorder.toHasLe.{u1} α _inst_1)] (a : α), Eq.{succ u1} α (coeFn.{succ u1, succ u1} (BoundedOrderHom.{u1, u1} α α _inst_1 _inst_1 _inst_5 _inst_5) (fun (_x : BoundedOrderHom.{u1, u1} α α _inst_1 _inst_1 _inst_5 _inst_5) => α -> α) (BoundedOrderHom.hasCoeToFun.{u1, u1} α α _inst_1 _inst_1 _inst_5 _inst_5) (BoundedOrderHom.id.{u1} α _inst_1 _inst_5) a) a
but is expected to have type
...
but is expected to have type
  forall {α : Type.{u1}} [_inst_1 : LE.{u1} α] [_inst_2 : OrderTop.{u1} α _inst_1], Eq.{succ u1} ((fun (x._@.Mathlib.Logic.Equiv.Defs._hyg.812 : TopHom.{u1, u1} α α (OrderTop.toTop.{u1} α _inst_1 _inst_2) (OrderTop.toTop.{u1} α _inst_1 _inst_2)) => BotHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.bot.{u1} α (OrderTop.toTop.{u1} α _inst_1 _inst_2)) (OrderDual.bot.{u1} α (OrderTop.toTop.{u1} α _inst_1 _inst_2))) (TopHom.id.{u1} α (OrderTop.toTop.{u1} α _inst_1 _inst_2))) (FunLike.coe.{succ u1, succ u1, succ u1} (Equiv.{succ u1, succ u1} (TopHom.{u1, u1} α α (OrderTop.toTop.{u1} α _inst_1 _inst_2) (OrderTop.toTop.{u1} α _inst_1 _inst_2)) (BotHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.bot.{u1} α (OrderTop.toTop.{u1} α _inst_1 _inst_2)) (OrderDual.bot.{u1} α (OrderTop.toTop.{u1} α _inst_1 _inst_2)))) (TopHom.{u1, u1} α α (OrderTop.toTop.{u1} α _inst_1 _inst_2) (OrderTop.toTop.{u1} α _inst_1 _inst_2)) (fun (_x : TopHom.{u1, u1} α α (OrderTop.toTop.{u1} α _inst_1 _inst_2) (OrderTop.toTop.{u1} α _inst_1 _inst_2)) => (fun (x._@.Mathlib.Logic.Equiv.Defs._hyg.812 : TopHom.{u1, u1} α α (OrderTop.toTop.{u1} α _inst_1 _inst_2) (OrderTop.toTop.{u1} α _inst_1 _inst_2)) => BotHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.bot.{u1} α (OrderTop.toTop.{u1} α _inst_1 _inst_2)) (OrderDual.bot.{u1} α (OrderTop.toTop.{u1} α _inst_1 _inst_2))) _x) (Equiv.instFunLikeEquiv.{succ u1, succ u1} (TopHom.{u1, u1} α α (OrderTop.toTop.{u1} α _inst_1 _inst_2) (OrderTop.toTop.{u1} α _inst_1 _inst_2)) (BotHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.bot.{u1} α (OrderTop.toTop.{u1} α _inst_1 _inst_2)) (OrderDual.bot.{u1} α (OrderTop.toTop.{u1} α _inst_1 _inst_2)))) (TopHom.dual.{u1, u1} α α _inst_1 _inst_2 _inst_1 _inst_2) (TopHom.id.{u1} α (OrderTop.toTop.{u1} α _inst_1 _inst_2))) (BotHom.id.{u1} (OrderDual.{u1} α) (OrderDual.bot.{u1} α (OrderTop.toTop.{u1} α _inst_1 _inst_2)))
...
but is expected to have type
  forall {α : Type.{u1}} [_inst_1 : LE.{u1} α] [_inst_2 : OrderTop.{u1} α _inst_1], Eq.{succ u1} ((fun (x._@.Mathlib.Logic.Equiv.Defs._hyg.812 : BotHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.bot.{u1} α (OrderTop.toTop.{u1} α _inst_1 _inst_2)) (OrderDual.bot.{u1} α (OrderTop.toTop.{u1} α _inst_1 _inst_2))) => TopHom.{u1, u1} α α (OrderTop.toTop.{u1} α _inst_1 _inst_2) (OrderTop.toTop.{u1} α _inst_1 _inst_2)) (BotHom.id.{u1} (OrderDual.{u1} α) (OrderDual.bot.{u1} α (OrderTop.toTop.{u1} α _inst_1 _inst_2)))) (FunLike.coe.{succ u1, succ u1, succ u1} (Equiv.{succ u1, succ u1} (BotHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.bot.{u1} α (OrderTop.toTop.{u1} α _inst_1 _inst_2)) (OrderDual.bot.{u1} α (OrderTop.toTop.{u1} α _inst_1 _inst_2))) (TopHom.{u1, u1} α α (OrderTop.toTop.{u1} α _inst_1 _inst_2) (OrderTop.toTop.{u1} α _inst_1 _inst_2))) (BotHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.bot.{u1} α (OrderTop.toTop.{u1} α _inst_1 _inst_2)) (OrderDual.bot.{u1} α (OrderTop.toTop.{u1} α _inst_1 _inst_2))) (fun (_x : BotHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.bot.{u1} α (OrderTop.toTop.{u1} α _inst_1 _inst_2)) (OrderDual.bot.{u1} α (OrderTop.toTop.{u1} α _inst_1 _inst_2))) => (fun (x._@.Mathlib.Logic.Equiv.Defs._hyg.812 : BotHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.bot.{u1} α (OrderTop.toTop.{u1} α _inst_1 _inst_2)) (OrderDual.bot.{u1} α (OrderTop.toTop.{u1} α _inst_1 _inst_2))) => TopHom.{u1, u1} α α (OrderTop.toTop.{u1} α _inst_1 _inst_2) (OrderTop.toTop.{u1} α _inst_1 _inst_2)) _x) (Equiv.instFunLikeEquiv.{succ u1, succ u1} (BotHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.bot.{u1} α (OrderTop.toTop.{u1} α _inst_1 _inst_2)) (OrderDual.bot.{u1} α (OrderTop.toTop.{u1} α _inst_1 _inst_2))) (TopHom.{u1, u1} α α (OrderTop.toTop.{u1} α _inst_1 _inst_2) (OrderTop.toTop.{u1} α _inst_1 _inst_2))) (Equiv.symm.{succ u1, succ u1} (TopHom.{u1, u1} α α (OrderTop.toTop.{u1} α _inst_1 _inst_2) (OrderTop.toTop.{u1} α _inst_1 _inst_2)) (BotHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.bot.{u1} α (OrderTop.toTop.{u1} α _inst_1 _inst_2)) (OrderDual.bot.{u1} α (OrderTop.toTop.{u1} α _inst_1 _inst_2))) (TopHom.dual.{u1, u1} α α _inst_1 _inst_2 _inst_1 _inst_2)) (BotHom.id.{u1} (OrderDual.{u1} α) (OrderDual.bot.{u1} α (OrderTop.toTop.{u1} α _inst_1 _inst_2)))) (TopHom.id.{u1} α (OrderTop.toTop.{u1} α _inst_1 _inst_2))
...
but is expected to have type
  forall {α : Type.{u1}} [_inst_1 : LE.{u1} α] [_inst_2 : OrderBot.{u1} α _inst_1], Eq.{succ u1} ((fun (x._@.Mathlib.Logic.Equiv.Defs._hyg.812 : BotHom.{u1, u1} α α (OrderBot.toBot.{u1} α _inst_1 _inst_2) (OrderBot.toBot.{u1} α _inst_1 _inst_2)) => TopHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.top.{u1} α (OrderBot.toBot.{u1} α _inst_1 _inst_2)) (OrderDual.top.{u1} α (OrderBot.toBot.{u1} α _inst_1 _inst_2))) (BotHom.id.{u1} α (OrderBot.toBot.{u1} α _inst_1 _inst_2))) (FunLike.coe.{succ u1, succ u1, succ u1} (Equiv.{succ u1, succ u1} (BotHom.{u1, u1} α α (OrderBot.toBot.{u1} α _inst_1 _inst_2) (OrderBot.toBot.{u1} α _inst_1 _inst_2)) (TopHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.top.{u1} α (OrderBot.toBot.{u1} α _inst_1 _inst_2)) (OrderDual.top.{u1} α (OrderBot.toBot.{u1} α _inst_1 _inst_2)))) (BotHom.{u1, u1} α α (OrderBot.toBot.{u1} α _inst_1 _inst_2) (OrderBot.toBot.{u1} α _inst_1 _inst_2)) (fun (_x : BotHom.{u1, u1} α α (OrderBot.toBot.{u1} α _inst_1 _inst_2) (OrderBot.toBot.{u1} α _inst_1 _inst_2)) => (fun (x._@.Mathlib.Logic.Equiv.Defs._hyg.812 : BotHom.{u1, u1} α α (OrderBot.toBot.{u1} α _inst_1 _inst_2) (OrderBot.toBot.{u1} α _inst_1 _inst_2)) => TopHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.top.{u1} α (OrderBot.toBot.{u1} α _inst_1 _inst_2)) (OrderDual.top.{u1} α (OrderBot.toBot.{u1} α _inst_1 _inst_2))) _x) (Equiv.instFunLikeEquiv.{succ u1, succ u1} (BotHom.{u1, u1} α α (OrderBot.toBot.{u1} α _inst_1 _inst_2) (OrderBot.toBot.{u1} α _inst_1 _inst_2)) (TopHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.top.{u1} α (OrderBot.toBot.{u1} α _inst_1 _inst_2)) (OrderDual.top.{u1} α (OrderBot.toBot.{u1} α _inst_1 _inst_2)))) (BotHom.dual.{u1, u1} α α _inst_1 _inst_2 _inst_1 _inst_2) (BotHom.id.{u1} α (OrderBot.toBot.{u1} α _inst_1 _inst_2))) (TopHom.id.{u1} (OrderDual.{u1} α) (OrderDual.top.{u1} α (OrderBot.toBot.{u1} α _inst_1 _inst_2)))
...
but is expected to have type
  forall {α : Type.{u1}} [_inst_1 : LE.{u1} α] [_inst_2 : OrderBot.{u1} α _inst_1], Eq.{succ u1} ((fun (x._@.Mathlib.Logic.Equiv.Defs._hyg.812 : TopHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.top.{u1} α (OrderBot.toBot.{u1} α _inst_1 _inst_2)) (OrderDual.top.{u1} α (OrderBot.toBot.{u1} α _inst_1 _inst_2))) => BotHom.{u1, u1} α α (OrderBot.toBot.{u1} α _inst_1 _inst_2) (OrderBot.toBot.{u1} α _inst_1 _inst_2)) (TopHom.id.{u1} (OrderDual.{u1} α) (OrderDual.top.{u1} α (OrderBot.toBot.{u1} α _inst_1 _inst_2)))) (FunLike.coe.{succ u1, succ u1, succ u1} (Equiv.{succ u1, succ u1} (TopHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.top.{u1} α (OrderBot.toBot.{u1} α _inst_1 _inst_2)) (OrderDual.top.{u1} α (OrderBot.toBot.{u1} α _inst_1 _inst_2))) (BotHom.{u1, u1} α α (OrderBot.toBot.{u1} α _inst_1 _inst_2) (OrderBot.toBot.{u1} α _inst_1 _inst_2))) (TopHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.top.{u1} α (OrderBot.toBot.{u1} α _inst_1 _inst_2)) (OrderDual.top.{u1} α (OrderBot.toBot.{u1} α _inst_1 _inst_2))) (fun (_x : TopHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.top.{u1} α (OrderBot.toBot.{u1} α _inst_1 _inst_2)) (OrderDual.top.{u1} α (OrderBot.toBot.{u1} α _inst_1 _inst_2))) => (fun (x._@.Mathlib.Logic.Equiv.Defs._hyg.812 : TopHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.top.{u1} α (OrderBot.toBot.{u1} α _inst_1 _inst_2)) (OrderDual.top.{u1} α (OrderBot.toBot.{u1} α _inst_1 _inst_2))) => BotHom.{u1, u1} α α (OrderBot.toBot.{u1} α _inst_1 _inst_2) (OrderBot.toBot.{u1} α _inst_1 _inst_2)) _x) (Equiv.instFunLikeEquiv.{succ u1, succ u1} (TopHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.top.{u1} α (OrderBot.toBot.{u1} α _inst_1 _inst_2)) (OrderDual.top.{u1} α (OrderBot.toBot.{u1} α _inst_1 _inst_2))) (BotHom.{u1, u1} α α (OrderBot.toBot.{u1} α _inst_1 _inst_2) (OrderBot.toBot.{u1} α _inst_1 _inst_2))) (Equiv.symm.{succ u1, succ u1} (BotHom.{u1, u1} α α (OrderBot.toBot.{u1} α _inst_1 _inst_2) (OrderBot.toBot.{u1} α _inst_1 _inst_2)) (TopHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.top.{u1} α (OrderBot.toBot.{u1} α _inst_1 _inst_2)) (OrderDual.top.{u1} α (OrderBot.toBot.{u1} α _inst_1 _inst_2))) (BotHom.dual.{u1, u1} α α _inst_1 _inst_2 _inst_1 _inst_2)) (TopHom.id.{u1} (OrderDual.{u1} α) (OrderDual.top.{u1} α (OrderBot.toBot.{u1} α _inst_1 _inst_2)))) (BotHom.id.{u1} α (OrderBot.toBot.{u1} α _inst_1 _inst_2))
...
/- warning: bounded_order_hom.dual -> BoundedOrderHom.dual is a dubious translation:
lean 3 declaration is
  forall {α : Type.{u1}} {β : Type.{u2}} [_inst_1 : Preorder.{u1} α] [_inst_2 : BoundedOrder.{u1} α (Preorder.toHasLe.{u1} α _inst_1)] [_inst_3 : Preorder.{u2} β] [_inst_4 : BoundedOrder.{u2} β (Preorder.toHasLe.{u2} β _inst_3)], Equiv.{max (succ u1) (succ u2), max (succ u1) (succ u2)} (BoundedOrderHom.{u1, u2} α β _inst_1 _inst_3 _inst_2 _inst_4) (BoundedOrderHom.{u1, u2} (OrderDual.{u1} α) (OrderDual.{u2} β) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.preorder.{u2} β _inst_3) (OrderDual.boundedOrder.{u1} α (Preorder.toHasLe.{u1} α _inst_1) _inst_2) (OrderDual.boundedOrder.{u2} β (Preorder.toHasLe.{u2} β _inst_3) _inst_4))
but is expected to have type
  forall {α : Type.{u1}} {β : Type.{u2}} [_inst_1 : Preorder.{u1} α] [_inst_2 : BoundedOrder.{u1} α (Preorder.toLE.{u1} α _inst_1)] [_inst_3 : Preorder.{u2} β] [_inst_4 : BoundedOrder.{u2} β (Preorder.toLE.{u2} β _inst_3)], Equiv.{max (succ u2) (succ u1), max (succ u2) (succ u1)} (BoundedOrderHom.{u1, u2} α β _inst_1 _inst_3 _inst_2 _inst_4) (BoundedOrderHom.{u1, u2} (OrderDual.{u1} α) (OrderDual.{u2} β) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.preorder.{u2} β _inst_3) (OrderDual.boundedOrder.{u1} α (Preorder.toLE.{u1} α _inst_1) _inst_2) (OrderDual.boundedOrder.{u2} β (Preorder.toLE.{u2} β _inst_3) _inst_4))
Case conversion may be inaccurate. Consider using '#align bounded_order_hom.dual BoundedOrderHom.dualₓ'. -/
...
/- warning: bounded_order_hom.dual_id -> BoundedOrderHom.dual_id is a dubious translation:
lean 3 declaration is
  forall {α : Type.{u1}} [_inst_1 : Preorder.{u1} α] [_inst_2 : BoundedOrder.{u1} α (Preorder.toHasLe.{u1} α _inst_1)], Eq.{succ u1} (BoundedOrderHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.boundedOrder.{u1} α (Preorder.toHasLe.{u1} α _inst_1) _inst_2) (OrderDual.boundedOrder.{u1} α (Preorder.toHasLe.{u1} α _inst_1) _inst_2)) (coeFn.{succ u1, succ u1} (Equiv.{succ u1, succ u1} (BoundedOrderHom.{u1, u1} α α _inst_1 _inst_1 _inst_2 _inst_2) (BoundedOrderHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.boundedOrder.{u1} α (Preorder.toHasLe.{u1} α _inst_1) _inst_2) (OrderDual.boundedOrder.{u1} α (Preorder.toHasLe.{u1} α _inst_1) _inst_2))) (fun (_x : Equiv.{succ u1, succ u1} (BoundedOrderHom.{u1, u1} α α _inst_1 _inst_1 _inst_2 _inst_2) (BoundedOrderHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.boundedOrder.{u1} α (Preorder.toHasLe.{u1} α _inst_1) _inst_2) (OrderDual.boundedOrder.{u1} α (Preorder.toHasLe.{u1} α _inst_1) _inst_2))) => (BoundedOrderHom.{u1, u1} α α _inst_1 _inst_1 _inst_2 _inst_2) -> (BoundedOrderHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.boundedOrder.{u1} α (Preorder.toHasLe.{u1} α _inst_1) _inst_2) (OrderDual.boundedOrder.{u1} α (Preorder.toHasLe.{u1} α _inst_1) _inst_2))) (Equiv.hasCoeToFun.{succ u1, succ u1} (BoundedOrderHom.{u1, u1} α α _inst_1 _inst_1 _inst_2 _inst_2) (BoundedOrderHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.boundedOrder.{u1} α (Preorder.toHasLe.{u1} α _inst_1) _inst_2) (OrderDual.boundedOrder.{u1} α (Preorder.toHasLe.{u1} α _inst_1) _inst_2))) (BoundedOrderHom.dual.{u1, u1} α α _inst_1 _inst_2 _inst_1 _inst_2) (BoundedOrderHom.id.{u1} α _inst_1 _inst_2)) (BoundedOrderHom.id.{u1} (OrderDual.{u1} α) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.boundedOrder.{u1} α (Preorder.toHasLe.{u1} α _inst_1) _inst_2))
but is expected to have type
  forall {α : Type.{u1}} [_inst_1 : Preorder.{u1} α] [_inst_2 : BoundedOrder.{u1} α (Preorder.toLE.{u1} α _inst_1)], Eq.{succ u1} ((fun (x._@.Mathlib.Logic.Equiv.Defs._hyg.812 : BoundedOrderHom.{u1, u1} α α _inst_1 _inst_1 _inst_2 _inst_2) => BoundedOrderHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.boundedOrder.{u1} α (Preorder.toLE.{u1} α _inst_1) _inst_2) (OrderDual.boundedOrder.{u1} α (Preorder.toLE.{u1} α _inst_1) _inst_2)) (BoundedOrderHom.id.{u1} α _inst_1 _inst_2)) (FunLike.coe.{succ u1, succ u1, succ u1} (Equiv.{succ u1, succ u1} (BoundedOrderHom.{u1, u1} α α _inst_1 _inst_1 _inst_2 _inst_2) (BoundedOrderHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.boundedOrder.{u1} α (Preorder.toLE.{u1} α _inst_1) _inst_2) (OrderDual.boundedOrder.{u1} α (Preorder.toLE.{u1} α _inst_1) _inst_2))) (BoundedOrderHom.{u1, u1} α α _inst_1 _inst_1 _inst_2 _inst_2) (fun (_x : BoundedOrderHom.{u1, u1} α α _inst_1 _inst_1 _inst_2 _inst_2) => (fun (x._@.Mathlib.Logic.Equiv.Defs._hyg.812 : BoundedOrderHom.{u1, u1} α α _inst_1 _inst_1 _inst_2 _inst_2) => BoundedOrderHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.boundedOrder.{u1} α (Preorder.toLE.{u1} α _inst_1) _inst_2) (OrderDual.boundedOrder.{u1} α (Preorder.toLE.{u1} α _inst_1) _inst_2)) _x) (Equiv.instFunLikeEquiv.{succ u1, succ u1} (BoundedOrderHom.{u1, u1} α α _inst_1 _inst_1 _inst_2 _inst_2) (BoundedOrderHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.boundedOrder.{u1} α (Preorder.toLE.{u1} α _inst_1) _inst_2) (OrderDual.boundedOrder.{u1} α (Preorder.toLE.{u1} α _inst_1) _inst_2))) (BoundedOrderHom.dual.{u1, u1} α α _inst_1 _inst_2 _inst_1 _inst_2) (BoundedOrderHom.id.{u1} α _inst_1 _inst_2)) (BoundedOrderHom.id.{u1} (OrderDual.{u1} α) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.boundedOrder.{u1} α (Preorder.toLE.{u1} α _inst_1) _inst_2))
Case conversion may be inaccurate. Consider using '#align bounded_order_hom.dual_id BoundedOrderHom.dual_idₓ'. -/
@[simp]
...
/- warning: bounded_order_hom.symm_dual_id -> BoundedOrderHom.symm_dual_id is a dubious translation:
lean 3 declaration is
  forall {α : Type.{u1}} [_inst_1 : Preorder.{u1} α] [_inst_2 : BoundedOrder.{u1} α (Preorder.toHasLe.{u1} α _inst_1)], Eq.{succ u1} (BoundedOrderHom.{u1, u1} α α _inst_1 _inst_1 _inst_2 _inst_2) (coeFn.{succ u1, succ u1} (Equiv.{succ u1, succ u1} (BoundedOrderHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.boundedOrder.{u1} α (Preorder.toHasLe.{u1} α _inst_1) _inst_2) (OrderDual.boundedOrder.{u1} α (Preorder.toHasLe.{u1} α _inst_1) _inst_2)) (BoundedOrderHom.{u1, u1} α α _inst_1 _inst_1 _inst_2 _inst_2)) (fun (_x : Equiv.{succ u1, succ u1} (BoundedOrderHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.boundedOrder.{u1} α (Preorder.toHasLe.{u1} α _inst_1) _inst_2) (OrderDual.boundedOrder.{u1} α (Preorder.toHasLe.{u1} α _inst_1) _inst_2)) (BoundedOrderHom.{u1, u1} α α _inst_1 _inst_1 _inst_2 _inst_2)) => (BoundedOrderHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.boundedOrder.{u1} α (Preorder.toHasLe.{u1} α _inst_1) _inst_2) (OrderDual.boundedOrder.{u1} α (Preorder.toHasLe.{u1} α _inst_1) _inst_2)) -> (BoundedOrderHom.{u1, u1} α α _inst_1 _inst_1 _inst_2 _inst_2)) (Equiv.hasCoeToFun.{succ u1, succ u1} (BoundedOrderHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.boundedOrder.{u1} α (Preorder.toHasLe.{u1} α _inst_1) _inst_2) (OrderDual.boundedOrder.{u1} α (Preorder.toHasLe.{u1} α _inst_1) _inst_2)) (BoundedOrderHom.{u1, u1} α α _inst_1 _inst_1 _inst_2 _inst_2)) (Equiv.symm.{succ u1, succ u1} (BoundedOrderHom.{u1, u1} α α _inst_1 _inst_1 _inst_2 _inst_2) (BoundedOrderHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.boundedOrder.{u1} α (Preorder.toHasLe.{u1} α _inst_1) _inst_2) (OrderDual.boundedOrder.{u1} α (Preorder.toHasLe.{u1} α _inst_1) _inst_2)) (BoundedOrderHom.dual.{u1, u1} α α _inst_1 _inst_2 _inst_1 _inst_2)) (BoundedOrderHom.id.{u1} (OrderDual.{u1} α) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.boundedOrder.{u1} α (Preorder.toHasLe.{u1} α _inst_1) _inst_2))) (BoundedOrderHom.id.{u1} α _inst_1 _inst_2)
but is expected to have type
  forall {α : Type.{u1}} [_inst_1 : Preorder.{u1} α] [_inst_2 : BoundedOrder.{u1} α (Preorder.toLE.{u1} α _inst_1)], Eq.{succ u1} ((fun (x._@.Mathlib.Logic.Equiv.Defs._hyg.812 : BoundedOrderHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.boundedOrder.{u1} α (Preorder.toLE.{u1} α _inst_1) _inst_2) (OrderDual.boundedOrder.{u1} α (Preorder.toLE.{u1} α _inst_1) _inst_2)) => BoundedOrderHom.{u1, u1} α α _inst_1 _inst_1 _inst_2 _inst_2) (BoundedOrderHom.id.{u1} (OrderDual.{u1} α) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.boundedOrder.{u1} α (Preorder.toLE.{u1} α _inst_1) _inst_2))) (FunLike.coe.{succ u1, succ u1, succ u1} (Equiv.{succ u1, succ u1} (BoundedOrderHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.boundedOrder.{u1} α (Preorder.toLE.{u1} α _inst_1) _inst_2) (OrderDual.boundedOrder.{u1} α (Preorder.toLE.{u1} α _inst_1) _inst_2)) (BoundedOrderHom.{u1, u1} α α _inst_1 _inst_1 _inst_2 _inst_2)) (BoundedOrderHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.boundedOrder.{u1} α (Preorder.toLE.{u1} α _inst_1) _inst_2) (OrderDual.boundedOrder.{u1} α (Preorder.toLE.{u1} α _inst_1) _inst_2)) (fun (_x : BoundedOrderHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.boundedOrder.{u1} α (Preorder.toLE.{u1} α _inst_1) _inst_2) (OrderDual.boundedOrder.{u1} α (Preorder.toLE.{u1} α _inst_1) _inst_2)) => (fun (x._@.Mathlib.Logic.Equiv.Defs._hyg.812 : BoundedOrderHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.boundedOrder.{u1} α (Preorder.toLE.{u1} α _inst_1) _inst_2) (OrderDual.boundedOrder.{u1} α (Preorder.toLE.{u1} α _inst_1) _inst_2)) => BoundedOrderHom.{u1, u1} α α _inst_1 _inst_1 _inst_2 _inst_2) _x) (Equiv.instFunLikeEquiv.{succ u1, succ u1} (BoundedOrderHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.boundedOrder.{u1} α (Preorder.toLE.{u1} α _inst_1) _inst_2) (OrderDual.boundedOrder.{u1} α (Preorder.toLE.{u1} α _inst_1) _inst_2)) (BoundedOrderHom.{u1, u1} α α _inst_1 _inst_1 _inst_2 _inst_2)) (Equiv.symm.{succ u1, succ u1} (BoundedOrderHom.{u1, u1} α α _inst_1 _inst_1 _inst_2 _inst_2) (BoundedOrderHom.{u1, u1} (OrderDual.{u1} α) (OrderDual.{u1} α) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.boundedOrder.{u1} α (Preorder.toLE.{u1} α _inst_1) _inst_2) (OrderDual.boundedOrder.{u1} α (Preorder.toLE.{u1} α _inst_1) _inst_2)) (BoundedOrderHom.dual.{u1, u1} α α _inst_1 _inst_2 _inst_1 _inst_2)) (BoundedOrderHom.id.{u1} (OrderDual.{u1} α) (OrderDual.preorder.{u1} α _inst_1) (OrderDual.boundedOrder.{u1} α (Preorder.toLE.{u1} α _inst_1) _inst_2))) (BoundedOrderHom.id.{u1} α _inst_1 _inst_2)
Case conversion may be inaccurate. Consider using '#align bounded_order_hom.symm_dual_id BoundedOrderHom.symm_dual_idₓ'. -/
@[simp]
