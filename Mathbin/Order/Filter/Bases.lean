...
but is expected to have type
  forall {α : Type.{u1}} {ι : Type.{u3}} {ι' : ι -> Type.{u2}} [_inst_1 : Nonempty.{succ u3} ι] {l : ι -> (Filter.{u1} α)} (s : forall (i : ι), (ι' i) -> (Set.{u1} α)) (p : forall (i : ι), (ι' i) -> Prop), (forall (i : ι), Filter.HasBasis.{u1, succ u2} α (ι' i) (l i) (p i) (s i)) -> (Directed.{u1, succ u3} (Filter.{u1} α) ι (fun (x._@.Mathlib.Order.Filter.Bases._hyg.5731 : Filter.{u1} α) (x._@.Mathlib.Order.Filter.Bases._hyg.5733 : Filter.{u1} α) => GE.ge.{u1} (Filter.{u1} α) (Preorder.toLE.{u1} (Filter.{u1} α) (PartialOrder.toPreorder.{u1} (Filter.{u1} α) (Filter.instPartialOrderFilter.{u1} α))) x._@.Mathlib.Order.Filter.Bases._hyg.5731 x._@.Mathlib.Order.Filter.Bases._hyg.5733) l) -> (Filter.HasBasis.{u1, max (succ u3) (succ u2)} α (Sigma.{u3, u2} ι (fun (i : ι) => ι' i)) (infᵢ.{u1, succ u3} (Filter.{u1} α) (CompleteLattice.toInfSet.{u1} (Filter.{u1} α) (Filter.instCompleteLatticeFilter.{u1} α)) ι (fun (i : ι) => l i)) (fun (ii' : Sigma.{u3, u2} ι (fun (i : ι) => ι' i)) => p (Sigma.fst.{u3, u2} ι (fun (i : ι) => ι' i) ii') (Sigma.snd.{u3, u2} ι (fun (i : ι) => ι' i) ii')) (fun (ii' : Sigma.{u3, u2} ι (fun (i : ι) => ι' i)) => s (Sigma.fst.{u3, u2} ι (fun (i : ι) => ι' i) ii') (Sigma.snd.{u3, u2} ι (fun (i : ι) => ι' i) ii')))
...
but is expected to have type
  forall {α : Type.{u1}} {ι : Type.{u3}} {ι' : Type.{u2}} [_inst_1 : Nonempty.{succ u3} ι] {l : ι -> (Filter.{u1} α)} (s : ι -> ι' -> (Set.{u1} α)) (p : ι -> ι' -> Prop), (forall (i : ι), Filter.HasBasis.{u1, succ u2} α ι' (l i) (p i) (s i)) -> (Directed.{u1, succ u3} (Filter.{u1} α) ι (fun (x._@.Mathlib.Order.Filter.Bases._hyg.5908 : Filter.{u1} α) (x._@.Mathlib.Order.Filter.Bases._hyg.5910 : Filter.{u1} α) => GE.ge.{u1} (Filter.{u1} α) (Preorder.toLE.{u1} (Filter.{u1} α) (PartialOrder.toPreorder.{u1} (Filter.{u1} α) (Filter.instPartialOrderFilter.{u1} α))) x._@.Mathlib.Order.Filter.Bases._hyg.5908 x._@.Mathlib.Order.Filter.Bases._hyg.5910) l) -> (Filter.HasBasis.{u1, max (succ u3) (succ u2)} α (Prod.{u3, u2} ι ι') (infᵢ.{u1, succ u3} (Filter.{u1} α) (CompleteLattice.toInfSet.{u1} (Filter.{u1} α) (Filter.instCompleteLatticeFilter.{u1} α)) ι (fun (i : ι) => l i)) (fun (ii' : Prod.{u3, u2} ι ι') => p (Prod.fst.{u3, u2} ι ι' ii') (Prod.snd.{u3, u2} ι ι' ii')) (fun (ii' : Prod.{u3, u2} ι ι') => s (Prod.fst.{u3, u2} ι ι' ii') (Prod.snd.{u3, u2} ι ι' ii')))
...
but is expected to have type
  forall {α : Type.{u2}} {ι : Sort.{u1}} {s : ι -> (Set.{u2} α)}, (Directed.{u2, u1} (Set.{u2} α) ι (fun (x._@.Mathlib.Order.Filter.Bases._hyg.9288 : Set.{u2} α) (x._@.Mathlib.Order.Filter.Bases._hyg.9290 : Set.{u2} α) => GE.ge.{u2} (Set.{u2} α) (Set.instLESet.{u2} α) x._@.Mathlib.Order.Filter.Bases._hyg.9288 x._@.Mathlib.Order.Filter.Bases._hyg.9290) s) -> (forall [_inst_1 : Nonempty.{u1} ι], Filter.HasBasis.{u2, u1} α ι (infᵢ.{u2, u1} (Filter.{u2} α) (CompleteLattice.toInfSet.{u2} (Filter.{u2} α) (Filter.instCompleteLatticeFilter.{u2} α)) ι (fun (i : ι) => Filter.principal.{u2} α (s i))) (fun (_x : ι) => True) s)
...
but is expected to have type
  forall {α : Type.{u2}} {β : Type.{u1}} {s : β -> (Set.{u2} α)} {S : Set.{u1} β}, (DirectedOn.{u1} β (Order.Preimage.{succ u1, succ u2} β (Set.{u2} α) s (fun (x._@.Mathlib.Order.Filter.Bases._hyg.9521 : Set.{u2} α) (x._@.Mathlib.Order.Filter.Bases._hyg.9523 : Set.{u2} α) => GE.ge.{u2} (Set.{u2} α) (Set.instLESet.{u2} α) x._@.Mathlib.Order.Filter.Bases._hyg.9521 x._@.Mathlib.Order.Filter.Bases._hyg.9523)) S) -> (Set.Nonempty.{u1} β S) -> (Filter.HasBasis.{u2, succ u1} α β (infᵢ.{u2, succ u1} (Filter.{u2} α) (CompleteLattice.toInfSet.{u2} (Filter.{u2} α) (Filter.instCompleteLatticeFilter.{u2} α)) β (fun (i : β) => infᵢ.{u2, 0} (Filter.{u2} α) (CompleteLattice.toInfSet.{u2} (Filter.{u2} α) (Filter.instCompleteLatticeFilter.{u2} α)) (Membership.mem.{u1, u1} β (Set.{u1} β) (Set.instMembershipSet.{u1} β) i S) (fun (H : Membership.mem.{u1, u1} β (Set.{u1} β) (Set.instMembershipSet.{u1} β) i S) => Filter.principal.{u2} α (s i)))) (fun (i : β) => Membership.mem.{u1, u1} β (Set.{u1} β) (Set.instMembershipSet.{u1} β) i S) s)
