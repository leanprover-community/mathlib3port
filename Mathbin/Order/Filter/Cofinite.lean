...
#align filter._root_.set.finite.eventually_cofinite_nmem filter._root_.set.finite.eventually_cofinite_nmem

theorem _root_.finset.eventually_cofinite_nmem (s : Finset α) : ∀ᶠ x in cofinite, x ∉ s :=
  s.finite_to_set.eventually_cofinite_nmem
#align filter._root_.finset.eventually_cofinite_nmem filter._root_.finset.eventually_cofinite_nmem

theorem _root_.set.infinite_iff_frequently_cofinite {s : Set α} : Set.Infinite s ↔ ∃ᶠ x in cofinite, x ∈ s :=
  frequently_cofinite_iff_infinite.symm
#align filter._root_.set.infinite_iff_frequently_cofinite filter._root_.set.infinite_iff_frequently_cofinite
