...
but is expected to have type
  forall {ι : Type.{u1}} {α : Type.{u2}} {f : Set.{max u1 u2} (Prod.{u1, u2} ι α)} {s : Filter.{u1} ι} {g : Filter.{u2} α}, Iff (Membership.Mem.{max u1 u2, max u1 u2} (Set.{max u1 u2} (Prod.{u1, u2} ι α)) (Filter.{max u1 u2} (Prod.{u1, u2} ι α)) (Filter.hasMem.{max u1 u2} (Prod.{u1, u2} ι α)) f (Filter.coprod.{u1, u2} ι α s g)) (And (Exists.{succ u1} (Set.{u1} ι) (fun (t₁ : Set.{u1} ι) => Exists.{0} (Membership.Mem.{u1, u1} (Set.{u1} ι) (Filter.{u1} ι) (Filter.hasMem.{u1} ι) t₁ s) (fun (H : Membership.Mem.{u1, u1} (Set.{u1} ι) (Filter.{u1} ι) (Filter.hasMem.{u1} ι) t₁ s) => HasSubset.Subset.{max u1 u2} (Set.{max u1 u2} (Prod.{u1, u2} ι α)) (Set.hasSubset.{max u1 u2} (Prod.{u1, u2} ι α)) (Set.preimage.{max u1 u2, u1} (Prod.{u1, u2} ι α) ι (Prod.fst.{u1, u2} ι α) t₁) f))) (Exists.{succ u2} (Set.{u2} α) (fun (t₂ : Set.{u2} α) => Exists.{0} (Membership.Mem.{u2, u2} (Set.{u2} α) (Filter.{u2} α) (Filter.hasMem.{u2} α) t₂ g) (fun (H : Membership.Mem.{u2, u2} (Set.{u2} α) (Filter.{u2} α) (Filter.hasMem.{u2} α) t₂ g) => HasSubset.Subset.{max u1 u2} (Set.{max u1 u2} (Prod.{u1, u2} ι α)) (Set.hasSubset.{max u1 u2} (Prod.{u1, u2} ι α)) (Set.preimage.{max u1 u2, u2} (Prod.{u1, u2} ι α) α (Prod.snd.{u1, u2} ι α) t₂) f))))
...
but is expected to have type
  forall {ι : Type.{u1}} {α : Type.{u2}} {f : Set.{max u1 u2} (Prod.{u1, u2} ι α)} {s : Filter.{u1} ι} {lb : Filter.{u2} α}, Iff (Membership.Mem.{max u1 u2, max u1 u2} (Set.{max u1 u2} (Prod.{u1, u2} ι α)) (Filter.{max u1 u2} (Prod.{u1, u2} ι α)) (Filter.hasMem.{max u1 u2} (Prod.{u1, u2} ι α)) (HasCompl.compl.{max u1 u2} (Set.{max u1 u2} (Prod.{u1, u2} ι α)) (BooleanAlgebra.toHasCompl.{max u1 u2} (Set.{max u1 u2} (Prod.{u1, u2} ι α)) (Set.booleanAlgebra.{max u1 u2} (Prod.{u1, u2} ι α))) f) (Filter.coprod.{u1, u2} ι α s lb)) (And (Membership.Mem.{u1, u1} (Set.{u1} ι) (Filter.{u1} ι) (Filter.hasMem.{u1} ι) (HasCompl.compl.{u1} (Set.{u1} ι) (BooleanAlgebra.toHasCompl.{u1} (Set.{u1} ι) (Set.booleanAlgebra.{u1} ι)) (Set.image.{max u1 u2, u1} (Prod.{u1, u2} ι α) ι (Prod.fst.{u1, u2} ι α) f)) s) (Membership.Mem.{u2, u2} (Set.{u2} α) (Filter.{u2} α) (Filter.hasMem.{u2} α) (HasCompl.compl.{u2} (Set.{u2} α) (BooleanAlgebra.toHasCompl.{u2} (Set.{u2} α) (Set.booleanAlgebra.{u2} α)) (Set.image.{max u1 u2, u2} (Prod.{u1, u2} ι α) α (Prod.snd.{u1, u2} ι α) f)) lb))
...
but is expected to have type
  forall {ι : Type.{u1}} {α : Type.{u2}} {f : Filter.{u1} ι} {_inst_1 : Filter.{u2} α}, Iff (Filter.NeBot.{max u1 u2} (Prod.{u1, u2} ι α) (Filter.coprod.{u1, u2} ι α f _inst_1)) (Or (And (Filter.NeBot.{u1} ι f) (Nonempty.{succ u2} α)) (And (Nonempty.{succ u1} ι) (Filter.NeBot.{u2} α _inst_1)))
...
but is expected to have type
  forall {ι : Type.{u1}} {α : Type.{u2}} (l : Filter.{u1} ι), Eq.{succ (max u1 u2)} (Filter.{max u1 u2} (Prod.{u1, u2} ι α)) (Filter.coprod.{u1, u2} ι α l (Bot.bot.{u2} (Filter.{u2} α) (CompleteLattice.toHasBot.{u2} (Filter.{u2} α) (Filter.completeLattice.{u2} α)))) (Filter.comap.{max u1 u2, u1} (Prod.{u1, u2} ι α) ι (Prod.fst.{u1, u2} ι α) l)
...
but is expected to have type
  forall {ι : Type.{u1}} {α : Type.{u2}} {f₁ : Filter.{u1} ι} {f₂ : Filter.{u1} ι} {hf : Filter.{u2} α} {g₂ : Filter.{u2} α}, (LE.le.{u1} (Filter.{u1} ι) (Preorder.toLE.{u1} (Filter.{u1} ι) (PartialOrder.toPreorder.{u1} (Filter.{u1} ι) (Filter.partialOrder.{u1} ι))) f₁ f₂) -> (LE.le.{u2} (Filter.{u2} α) (Preorder.toLE.{u2} (Filter.{u2} α) (PartialOrder.toPreorder.{u2} (Filter.{u2} α) (Filter.partialOrder.{u2} α))) hf g₂) -> (LE.le.{max u1 u2} (Filter.{max u1 u2} (Prod.{u1, u2} ι α)) (Preorder.toLE.{max u1 u2} (Filter.{max u1 u2} (Prod.{u1, u2} ι α)) (PartialOrder.toPreorder.{max u1 u2} (Filter.{max u1 u2} (Prod.{u1, u2} ι α)) (Filter.partialOrder.{max u1 u2} (Prod.{u1, u2} ι α)))) (Filter.coprod.{u1, u2} ι α f₁ hf) (Filter.coprod.{u1, u2} ι α f₂ g₂))
