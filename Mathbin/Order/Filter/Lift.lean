 ...
 (Command.def
  ...
  (Command.optDeclSig
   [(Term.explicitBinder "(" [`f] [":" (Term.app `Filter [`α])] [] ")")
    (Term.explicitBinder "(" [`g] [":" (Term.arrow (Term.app `Set [`α]) "→" (Term.app `Filter [`β]))] [] ")")]
   [])
...
/--
      ...
      This is essentially a push-forward along a function mapping each set to a filter. -/
    protected
  def lift ( f : Filter α ) ( g : Set α → Filter β ) := ⨅ ( s : _ ) ( _ : s ∈ f ) , g s
...
theorem has_basis.lift {ι} {p : ι → Prop} {s : ι → Set α} {f : Filter α} (hf : f.has_basis p s) {β : ι → Type _}
    {pg : ∀ i, β i → Prop} {sg : ∀ i, β i → Set γ} {g : Set α → Filter γ} (hg : ∀ i, (g $ s i).HasBasis (pg i) (sg i))
    (gm : Monotone g) : (f.lift g).HasBasis (fun i => p i.1 ∧ pg i.1 i.2) fun i => sg i.1 i.2 := by
    ...
    (Term.explicitBinder
     ...
     [":"
      (Term.forall
       ...
       ","
       («term_=_»
        (Order.Lattice.«term_⊓_» (Term.app `g [`s]) "⊓" (Term.app `g [`t]))
        "="
        (Term.app `g [(Init.Core.«term_∩_» `s " ∩ " `t)])))]
     []
     ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app (Term.proj (Term.app `infi [`f]) "." `lift) [`g])
     "="
     (Order.CompleteLattice.«term⨅_,_»
      "⨅"
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
      ", "
      (Term.app (Term.proj (Term.app `f [`i]) "." `lift) [`g])))))
  (Command.declValSimple
   ":="
   (Term.app
    `le_antisymmₓ
    [(«term_$__»
      ...
      (Term.fun
       ...
       (Term.basicFun
        ...
        (Term.app
         `lift_mono
         [(Term.app `infi_le [(Term.hole "_") (Term.hole "_")]) (Term.app `le_reflₓ [(Term.hole "_")])]))))
     (Term.fun
      "fun"
      (Term.basicFun
       [(Term.simpleBinder [`s] [])]
       ...
       (Term.have
        ...
        (Term.haveDecl
         (Term.haveIdDecl
          [`g_mono []]
          [(Term.typeSpec ":" (Term.app `Monotone [`g]))]
          ":="
          (Term.fun
           "fun"
           (Term.basicFun
            [(Term.simpleBinder [`s `t `h] [])]
            "=>"
            («term_$__»
             `le_of_inf_eq
             "$"
             («term_$__»
              (Term.app `Eq.trans [`hg])
              "$"
              («term_$__» (Term.app `congr_argₓ [`g]) "$" (Term.app `inter_eq_self_of_subset_left [`h]))))))))
        []
        (Term.have
         "have"
         (Term.haveDecl
               ...
               (Term.forall
                ...
                («term_≤_»
                 (Order.CompleteLattice.«term⨅_,_»
                  ...
                  ", "
                  (Term.app `Filter.lift [(Term.app `f [`i]) `g]))
                 "≤"
                 (Term.app `g [`t]))))))]
           ":="
           (Term.fun
             ...
             (Term.app
              ...
              [`ht
               (Term.let
                ...
                []
                («term_$__»
                 (Term.app `infi_le_of_le [`i])
                 "$"
                 («term_$__» (Term.app `infi_le_of_le [`univ]) "$" (Term.app `infi_le [(Term.hole "_") `univ_mem]))))
               (Term.fun
                "fun"
                (Term.basicFun
                 [(Term.simpleBinder [`i `s₁ `s₂ `hs₁ `hs₂] [])]
                 "=>"
                 (Term.subst
                  (Term.app (Term.explicit "@" `hg) [`s₁ `s₂])
                  "▸"
                  [(Term.app
                    `le_inf
                    [(«term_$__»
                      (Term.app `infi_le_of_le [`i])
                      "$"
                      («term_$__» (Term.app `infi_le_of_le [`s₁]) "$" (Term.app `infi_le [(Term.hole "_") `hs₁])))
                     `hs₂])])))])))))
         []
         (Term.byTactic
          "by"
           ...
           (Tactic.tacticSeq1Indented
            [(group
              (Tactic.simp
               ...
               ["only"]
               ["["
                [(Tactic.simpLemma [] [] (Term.app `mem_lift_sets [`g_mono]))
                 ","
             ...
             (group
              (Tactic.exact
               ...
               (Term.fun
                "fun"
                (Term.basicFun [(Term.simpleBinder [`t `ht `hs] [])] "=>" (Term.app `this [`t `ht `hs]))))
              [])])))))))])
   [])
  []
  []))
          ...
          (Tactic.tacticSeq1Indented
           [(group
            ...
            (group
             (Tactic.exact
              "exact"
              (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`t `ht `hs] [])] "=>" (Term.app `this [`t `ht `hs]))))
             [])])))))))])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
    ...
    (Tactic.tacticSeq1Indented
     [(group
       (Tactic.simp
        ...
        ["only"]
        ["["
         [(Tactic.simpLemma [] [] (Term.app `mem_lift_sets [`g_mono])) "," (Tactic.simpLemma [] [] `exists_imp_distrib)]
         "]"]
        [])
       [])
      (group
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `infi_le [(Term.hole "_") `hs₁])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.let', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.let', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.let', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.let', expected 'Lean.Parser.Term.ellipsis.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.let', expected 'Lean.Parser.Term.ellipsis'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `infi_le [(Term.hole "_") `univ_mem])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
theorem
  lift_infi
  { f : ι → Filter α } { g : Set α → Filter β } [ hι : Nonempty ι ] ( hg : ∀ { s t } , g s ⊓ g t = g s ∩ t )
    : infi f . lift g = ⨅ i , f i . lift g
  :=
    le_antisymmₓ
      le_infi $ fun i => lift_mono infi_le _ _ le_reflₓ _
        fun
          s
            =>
            have
              g_mono
                : Monotone g
                :=
                fun s t h => le_of_inf_eq $ Eq.trans hg $ congr_argₓ g $ inter_eq_self_of_subset_left h
              have
                : ∀ , ∀ t ∈ infi f , ∀ , ⨅ i : ι , Filter.lift f i g ≤ g t
                  :=
                  fun
                    t ht
                      =>
                      infi_sets_induct
                        ht
                          let ⟨ i ⟩ := hι infi_le_of_le i $ infi_le_of_le univ $ infi_le _ univ_mem
                          fun
                            i s₁ s₂ hs₁ hs₂
                              =>
                              @ hg s₁ s₂ ▸ le_inf infi_le_of_le i $ infi_le_of_le s₁ $ infi_le _ hs₁ hs₂
                by simp only [ mem_lift_sets g_mono , exists_imp_distrib ] exact fun t ht hs => this t ht hs
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `tendsto_lift' [])
  (Command.declSig
   [(Term.implicitBinder "{" [`m] [":" (Term.arrow `γ "→" `β)] "}")
    (Term.implicitBinder "{" [`l] [":" (Term.app `Filter [`γ])] "}")]
   (Term.typeSpec
    ":"
    («term_↔_»
     (Term.app `tendsto [`m `l (Term.app `f.lift' [`h])])
     "↔"
     (Term.forall
      "∀"
      []
      ...
      (Mathlib.ExtendedBinder.«term∀___,_»
       ...
       (Term.forall
        ...
        (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
         ...
         `l
         ", "
         (Init.Core.«term_∈_» (Term.app `m [`a]) " ∈ " (Term.app `h [`s])))))))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.simp
         ...
         ["only"]
         ["["
          [(Tactic.simpLemma [] [] `Filter.lift')
           ","
           (Tactic.simpLemma [] [] `tendsto_lift)
           ","
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `eventually_lift'_iff [])
  (Command.declSig
   [(Term.explicitBinder "(" [`hh] [":" (Term.app `Monotone [`h])] [] ")")
     ...
     (Mathlib.ExtendedBinder.«term∃___,_»
      ...
      (Term.forall
       ...
       (Mathlib.ExtendedBinder.«term∀___,_»
        "∀"
        `y
        («binderTerm∈_» "∈" (Term.app `h [`t]))
        ","
        (Term.forall "∀" [] "," (Term.app `p [`y]))))))))
  (Command.declValSimple ":=" (Term.app `mem_lift'_sets [`hh]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
theorem lift'_ne_bot_iff (hh : Monotone h) : ne_bot (f.lift' h) ↔ ∀, ∀ s ∈ f, ∀, (h s).Nonempty :=
  calc ne_bot (f.lift' h) ↔ ∀, ∀ s ∈ f, ∀, ne_bot (𝓟 (h s)) := lift_ne_bot_iff (monotone_principal.comp hh)
  ...
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.arrow `ι "→" (Term.app `Filter [`α]))] "}")
    ...
    (Term.explicitBinder
     "("
     [`hf]
     [":" (Term.app `Directed [(«term_≥_» (Term.cdot "·") "≥" (Term.cdot "·")) `f])]
     []
     ")")
      ...
      (Term.basicFun
       ...
       (Term.byTactic
        ...
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(group
            (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] (Term.app `mem_lift_sets [`hg]))] "]") [])
            [])
           (group
            (Tactic.simp
             "simp"
             ...
             ["["
              [(Tactic.simpLemma [] [] `exists_imp_distrib)
               ","
               (Tactic.simpLemma [] [] (Term.app `mem_infi_of_directed [`hf]))]
              "]"]
             [])
            [])
           (group
            (Tactic.exact
             ...
             (Term.fun
              "fun"
              (Term.basicFun
               [(Term.simpleBinder [`t `i `ht `hs] [])]
               "=>"
               («term_$__» (Term.app `mem_infi_of_mem [`i]) "$" (Term.app `mem_lift [`ht `hs])))))
            [])])))))])
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.simp
   ...
   ["only"]
   ["["
    [(Tactic.simpLemma [] [] `exists_imp_distrib) "," (Tactic.simpLemma [] [] (Term.app `mem_infi_of_directed [`hf]))]
    "]"]
   [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simp', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«]»', expected 'optional.antiquot_scope'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simpLemma', expected 'Lean.Parser.Tactic.simpErase'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `mem_infi_of_directed [`hf])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.basicFun.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `lift_mono [(Term.app `infi_le [(Term.hole "_") (Term.hole "_")]) (Term.app `le_reflₓ [(Term.hole "_")])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
theorem
  lift_infi'
  { f : ι → Filter α } { g : Set α → Filter β } [ Nonempty ι ] ( hf : Directed · ≥ · f ) ( hg : Monotone g )
    : infi f . lift g = ⨅ i , f i . lift g
  :=
    le_antisymmₓ
      le_infi $ fun i => lift_mono infi_le _ _ le_reflₓ _
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `lift'_infi [])
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.arrow `ι "→" (Term.app `Filter [`α]))] "}")
    (Term.implicitBinder "{" [`g] [":" (Term.arrow (Term.app `Set [`α]) "→" (Term.app `Set [`β]))] "}")
    (Term.instBinder "[" [] (Term.app `Nonempty [`ι]) "]")
    (Term.explicitBinder
     "("
     [`hg]
     [":"
      (Term.forall
       ...
       ","
       («term_=_»
        (Init.Core.«term_∩_» (Term.app `g [`s]) " ∩ " (Term.app `g [`t]))
        "="
        (Term.app `g [(Init.Core.«term_∩_» `s " ∩ " `t)])))]
     []
     ")")]
        ...
        (Tactic.tacticSeq1Indented
         [(group
           (Tactic.simp
            ...
            ["only"]
            ["["
             [(Tactic.simpLemma [] [] `principal_eq_iff_eq)
              ","
...
theorem
  lift'_infi
  { f : ι → Filter α } { g : Set α → Set β } [ Nonempty ι ] ( hg : ∀ { s t } , g s ∩ g t = g s ∩ t )
    : infi f . lift' g = ⨅ i , f i . lift' g
  := lift_infi $ fun s t => by simp only [ principal_eq_iff_eq , inf_principal , · ∘ · , hg ]
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `lift'_inf [])
  (Command.declSig
   [(Term.explicitBinder "(" [`f `g] [":" (Term.app `Filter [`α])] [] ")")
    (Term.implicitBinder "{" [`s] [":" (Term.arrow (Term.app `Set [`α]) "→" (Term.app `Set [`β]))] "}")
    (Term.explicitBinder
     "("
     [`hs]
     [":"
      (Term.forall
       "∀"
       [(Term.implicitBinder "{" [`t₁ `t₂] [] "}")]
       ","
       («term_=_»
        (Init.Core.«term_∩_» (Term.app `s [`t₁]) " ∩ " (Term.app `s [`t₂]))
        "="
        (Term.app `s [(Init.Core.«term_∩_» `t₁ " ∩ " `t₂)])))]
     []
     ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app (Term.proj (Order.Lattice.«term_⊓_» `f "⊓" `g) "." `lift') [`s])
     "="
     (Order.Lattice.«term_⊓_» (Term.app `f.lift' [`s]) "⊓" (Term.app `g.lift' [`s])))))
  (Command.declValSimple
   ":="
   (Term.have
    "have"
        ...
        («term_=_»
         (Term.app
          (Term.proj
           (Order.CompleteLattice.«term⨅_,_»
            "⨅"
            (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `b)] [":" `Bool]))
            ", "
            (Term.app `cond [`b `f `g]))
           "."
           `lift')
         ...
         (Order.CompleteLattice.«term⨅_,_»
          ...
          (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `b)] [":" `Bool]))
          ", "
          (Term.app (Term.proj (Term.app `cond [`b `f `g]) "." `lift') [`s]))))]
      ":="
      (Term.app `lift'_infi [(Term.explicit "@" `hs)])))
    []
    (Term.byTactic
     "by"
     (Tactic.tacticSeq
      (Tactic.tacticSeq1Indented
       [(group (Tactic.simpa "simpa" [] ["only"] ["[" [(Tactic.simpLemma [] [] `infi_bool_eq)] "]"] [] []) [])]))))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.simpa "simpa" [] ["only"] ["[" [(Tactic.simpLemma [] [] `infi_bool_eq)] "]"] [] [])
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `cond [`b `f `g]) "." `lift')
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `cond [`b `f `g])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `cond [`b `f `g]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.explicitBinders', expected 'Mathlib.ExtendedBinder.extBinders'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.haveIdDecl', expected 'Lean.Parser.Term.letPatDecl.antiquot'
...
theorem
  lift'_inf
  ( f g : Filter α ) { s : Set α → Set β } ( hs : ∀ { t₁ t₂ } , s t₁ ∩ s t₂ = s t₁ ∩ t₂ )
    : f ⊓ g . lift' s = f.lift' s ⊓ g.lift' s
  :=
    have
      : ⨅ b : Bool , cond b f g . lift' s = ⨅ b : Bool , cond b f g . lift' s := lift'_infi @ hs
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `lift'_infi_powerset [])
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.arrow `ι "→" (Term.app `Filter [`α]))] "}")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app (Term.proj (Term.app `infi [`f]) "." `lift') [`powerset])
     "="
     (Order.CompleteLattice.«term⨅_,_»
      "⨅"
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
      ", "
      (Term.app (Term.proj (Term.app `f [`i]) "." `lift') [`powerset])))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
          ...
          (Tactic.tacticSeq1Indented
           [(group
             (Tactic.rwSeq
              ...
              (Tactic.rwRuleSeq
               "["
               [(Tactic.rwRule [] (Term.app `infi_of_empty [`f]))
                ","
                (Tactic.rwRule [] `infi_of_empty)
                ","
                (Tactic.rwRule [] `lift'_top)
                ","
                (Tactic.rwRule [] `powerset_univ)
                ","
                (Tactic.rwRule [] `principal_univ)]
               "]")
              [])
             [])])))
        [])
              ...
              («term_$__»
               ...
               (Term.fun
                ...
                (Term.basicFun
                 ...
                 "=>"
                 (Term.proj (Term.app `powerset_inter [(Term.hole "_") (Term.hole "_")]) "." `symm)))))
             [])])))
        [])])))
   [])
  []
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `powerset_inter [(Term.hole "_") (Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
theorem
  lift'_infi_powerset
  { f : ι → Filter α } : infi f . lift' powerset = ⨅ i , f i . lift' powerset
  :=
    by
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `eventually_lift'_powerset [])
  (Command.declSig
    ...
    («term_↔_»
     ...
     (Mathlib.ExtendedBinder.«term∃___,_»
      ...
      (Term.forall
       "∀"
       [(Term.simpleBinder [`t] [])
        (Term.simpleBinder [(Term.hole "_")] [(Term.typeSpec ":" (Init.Core.«term_⊆_» `t " ⊆ " `s))])]
       ","
       (Term.app `p [`t]))))))
  (Command.declValSimple ":=" (Term.app `eventually_lift'_iff [`monotone_powerset]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `eventually_lift'_iff [`monotone_powerset])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
theorem
  ...
  { f : Filter α } { p : Set α → Prop } : ∀ᶠ s in f.lift' powerset , p s ↔ ∃ s ∈ f , ∀ t _ : t ⊆ s , p t
   ...
   [(Term.implicitBinder "{" [`f] [":" (Term.app `Filter [`α])] "}")
    ...
    (Term.explicitBinder
     ...
     [":"
      (Term.forall
       "∀"
       [(Term.strictImplicitBinder "⦃" [`s `t] [] "⦄")]
       ","
       (Term.arrow (Init.Core.«term_⊆_» `s " ⊆ " `t) "→" (Term.arrow (Term.app `p [`t]) "→" (Term.app `p [`s]))))]
     []
     ")")]
   (Term.typeSpec
    ":"
    («term_↔_»
     (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
      ...
      (Term.app `p [`s]))
     "↔"
     (Mathlib.ExtendedBinder.«term∃___,_» "∃" `s («binderTerm∈_» "∈" `f) "," (Term.app `p [`s])))))
  (Command.declValSimple
   ":="
   («term_$__»
    (Term.proj `eventually_lift'_powerset "." `trans)
    "$"
    («term_$__»
     `exists_congr
     "$"
      ...
      (Term.basicFun
       ...
       («term_$__»
        ...
        (Term.fun
         "fun"
         (Term.basicFun
          [(Term.simpleBinder [`hsf] [])]
          "=>"
          (Term.anonymousCtor
           "⟨"
           [(Term.fun
             "fun"
             (Term.basicFun [(Term.simpleBinder [`H] [])] "=>" (Term.app `H [`s (Term.app `subset.refl [`s])])))
            ","
            (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`hs `t `ht] [])] "=>" (Term.app `hp [`ht `hs])))]
           "⟩"))))))))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.anonymousCtor
   "⟨"
   [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`H] [])] "=>" (Term.app `H [`s (Term.app `subset.refl [`s])])))
    ","
    (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`hs `t `ht] [])] "=>" (Term.app `hp [`ht `hs])))]
   "⟩")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.basicFun.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `H [`s (Term.app `subset.refl [`s])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `subset.refl [`s]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
theorem
  eventually_lift'_powerset'
  { f : Filter α } { p : Set α → Prop } ( hp : ∀ ⦃ s t ⦄ , s ⊆ t → p t → p s )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `tendsto_lift'_powerset_mono [])
  (Command.declSig
   [(Term.implicitBinder "{" [`la] [":" (Term.app `Filter [`α])] "}")
    (Term.implicitBinder "{" [`lb] [":" (Term.app `Filter [`β])] "}")
    (Term.implicitBinder "{" [`s `t] [":" (Term.arrow `α "→" (Term.app `Set [`β]))] "}")
    (Term.explicitBinder "(" [`ht] [":" (Term.app `tendsto [`t `la (Term.app `lb.lift' [`powerset])])] [] ")")
    (Term.explicitBinder
     "("
     [`hst]
     [":"
      (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
       ...
       `la
       ", "
       (Init.Core.«term_⊆_» (Term.app `s [`x]) " ⊆ " (Term.app `t [`x])))]
     []
     ")")]
   (Term.typeSpec ":" (Term.app `tendsto [`s `la (Term.app `lb.lift' [`powerset])])))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
        ...
        (Tactic.exact
         ...
         (Term.fun
          ...
          (Term.basicFun
           ...
           "=>"
           (Term.app
            (Term.proj (Term.app `ht [`u `hu]) "." `mp)
            [(«term_$__»
              `hst.mono
              "$"
              (Term.fun
               "fun"
               (Term.basicFun [(Term.simpleBinder [`a `hst `ht] [])] "=>" (Term.app `subset.trans [`hst `ht]))))]))))
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app
   ...
   [(«term_$__»
     `hst.mono
     "$"
     (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`a `hst `ht] [])] "=>" (Term.app `subset.trans [`hst `ht]))))])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `ht [`u `hu]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.simpleBinder', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.simpleBinder', expected 'Lean.Parser.Term.strictImplicitBinder.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, [anonymous]))
  (Term.app `tendsto [`s `la (Term.app `lb.lift' [`powerset])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `lb.lift' [`powerset]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
theorem
  tendsto_lift'_powerset_mono
  { la : Filter α }
      { lb : Filter β }
      { s t : α → Set β }
      ( ht : tendsto t la lb.lift' powerset )
      ( hst : ∀ᶠ x in la , s x ⊆ t x )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `eventually_lift'_powerset_forall [])
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.app `Filter [`α])] "}")
  ...
  (Command.declValSimple
   ...
   (Term.app
    ...
    [(«term_$__»
      ...
      (Term.fun
       "fun"
       (Term.basicFun [(Term.simpleBinder [`s `t `hst `ht `x `hx] [])] "=>" (Term.app `ht [`x (Term.app `hst [`hx])]))))
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `hst [`hx]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(«term_$__»
   ...
   (Term.fun
    "fun"
    (Term.basicFun
     [(Term.simpleBinder [`s `t `hst `ht `x `hx] [])]
     "=>"
     (Term.app `ht [`x (Term.paren "(" [(Term.app `hst [`hx]) []] ")")]))))
  []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `Iff.trans
...
@[ simp ]
  theorem
    eventually_lift'_powerset_forall
    { f : Filter α } { p : α → Prop } : ∀ᶠ s in f.lift' powerset , ∀ , ∀ x ∈ s , ∀ , p x ↔ ∀ᶠ x in f , p x
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `eventually_lift'_powerset_eventually [])
  (Command.declSig
       ...
       (Term.fun
        ...
        (Term.basicFun
         ...
         («term_$__»
          ...
          (Term.fun
           "fun"
           (Term.basicFun [(Term.simpleBinder [`x `hx `hs] [])] "=>" (Term.app `hx [(Term.app `hst [`hs])]))))))))
     (calcStep
      («term_↔_»
       (Term.hole "_")
       "↔"
      ...
      (Term.byTactic
       ...
       (Tactic.tacticSeq
        (Tactic.tacticSeq1Indented
         [(group
           (Tactic.simp "simp" [] ["only"] ["[" [(Tactic.simpLemma [] [] `eventually_iff_exists_mem)] "]"] [])
           [])]))))
     (calcStep
      («term_↔_»
       (Term.hole "_")
      ...
      (Term.byTactic
       ...
       (Tactic.tacticSeq
        (Tactic.tacticSeq1Indented
         [(group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `eventually_inf)] "]") []) [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `eventually_inf)] "]") [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `eventually_inf
...
@[ simp ]
  theorem
    eventually_lift'_powerset_eventually
    { f g : Filter α } { p : α → Prop } : ∀ᶠ s in f.lift' powerset , ∀ᶠ x in g , x ∈ s → p x ↔ ∀ᶠ x in f ⊓ g , p x
    :=
      calc
        _ ↔ ∃ s ∈ f , ∀ᶠ x in g , x ∈ s → p x
            :=
            eventually_lift'_powerset' $ fun s t hst ht => ht.mono $ fun x hx hs => hx hst hs
          _ ↔ ∃ s ∈ f , ∃ t ∈ g , ∀ x , x ∈ t → x ∈ s → p x := by simp only [ eventually_iff_exists_mem ]
          _ ↔ ∀ᶠ x in f ⊓ g , p x := by rw [ eventually_inf ] finish
