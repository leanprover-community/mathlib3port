...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `eventually_le_limsup [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `CountableInterFilter [`f]) "]")
    (Term.explicitBinder "(" [`u] [":" (Term.arrow `α "→" (Data.Real.Ennreal.«termℝ≥0∞» "ℝ≥0∞"))] [] ")")]
   (Term.typeSpec
    ":"
    (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
     ...
     `f
     ", "
     («term_≤_» (Term.app `u [`y]) "≤" (Term.app `f.limsup [`u])))))
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.byCases'
         "by_cases'"
         [`hx_top ":"]
         («term_=_» (Term.app `f.limsup [`u]) "=" (Order.BoundedOrder.«term⊤» "⊤")))
        [])
       (group
        (Tactic.«tactic·._»
         "·"
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group (Tactic.simpRw "simp_rw" (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `hx_top)] "]") []) [])
            (group
             (Tactic.exact
              "exact"
              (Term.app
               `eventually_of_forall
               [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`a] [])] "=>" `le_top))]))
             [])])))
        [])
       (group
        (Tactic.tacticHave_
          ...
          (Term.haveIdDecl
           ...
           (Term.byTactic
            ...
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(group
                (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `eventually_countable_forall)] "]") [])
                [])
               (group
                (Tactic.refine'
                 "refine'"
                 (Term.fun
                  ...
                  (Term.basicFun
                   [(Term.simpleBinder [`n] [])]
                   "=>"
                   (Term.app `eventually_lt_of_limsup_lt [(Term.hole "_")]))))
                [])
               (group
                (Tactic.nthRw
                 "nth_rw"
                 (numLit "0")
                 (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] (Term.app `add_zeroₓ [(Term.app `f.limsup [`u])]))] "]")
                 [])
                [])
               (group
                (Tactic.exact
                 "exact"
                 (Term.app
                  (Term.proj (Term.app `add_lt_add_iff_left [`hx_top]) "." `mpr)
                  [(Term.byTactic
                    "by"
          ...
          [(Term.fun
            ...
            (Term.basicFun
             ...
             (Term.app
              ...
              [(Term.fun
                "fun"
                (Term.basicFun [(Term.simpleBinder [`r `hr_pos `hx_top] [])] "=>" (Term.hole "_")))])))]))
        [])
       (group
        (Tactic.tacticHave_
         "have"
             ...
             (Tactic.tacticSeq1Indented
              [(group
                (Tactic.rwSeq
                 "rw"
                 []
                 (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Ne.def) "," (Tactic.rwRule [] `coe_eq_zero)] "]")
                 [])
                [])
               (group (Tactic.exact "exact" (Term.proj (Term.app `ne_of_ltₓ [`hr_pos]) "." `symm)) [])]))))))
        [])
       (group
        (Tactic.cases'
         "cases'"
         [(Tactic.casesTarget [] (Term.app `exists_inv_nat_lt [`hr_ne_zero]))]
         []
       ...
       (group
        (Tactic.rwSeq
         "rw"
         []
         (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `inv_eq_one_div)] "]")
       ...
       (group
        (Tactic.exact
         "exact"
         (Term.app
          (Term.proj (Term.proj (Term.app `hy [`i]) "." `le) "." `trans)
          [(Term.app `add_le_add_left [`hi.le (Term.app `f.limsup [`u])])]))
        [])])))
   [])
  []
  []))
        ...
        (Term.app
         ...
         [(Term.fun
           ...
           (Term.basicFun
            ...
            (Term.app
             `le_of_forall_pos_le_add
             [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`r `hr_pos `hx_top] [])] "=>" (Term.hole "_")))])))]))
       [])
      (group
       (Tactic.tacticHave_
        "have"
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `f.limsup [`u]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `add_le_add_left [`hi.le (Term.paren "(" [(Term.app `f.limsup [`u]) []] ")")]) []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.proj (Term.app `hy [`i]) "." `le) "." `trans)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.proj (Term.app `hy [`i]) "." `le)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `hy [`i])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `hy [`i]) []] ")")
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `exists_inv_nat_lt [`hr_ne_zero])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.proj (Term.app `ne_of_ltₓ [`hr_pos]) "." `symm))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Term.app `ne_of_ltₓ [`hr_pos]) "." `symm)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `ne_of_ltₓ [`hr_pos])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `ne_of_ltₓ [`hr_pos]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Ne.def) "," (Tactic.rwRule [] `coe_eq_zero)] "]") [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `coe_eq_zero
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.byTactic
   ...
   (Tactic.tacticSeq
    (Tactic.tacticSeq1Indented
     [(group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `eventually_countable_forall)] "]") []) [])
      (group
       (Tactic.refine'
        "refine'"
        (Term.fun
         "fun"
         (Term.basicFun [(Term.simpleBinder [`n] [])] "=>" (Term.app `eventually_lt_of_limsup_lt [(Term.hole "_")]))))
       [])
      (group
       (Tactic.nthRw
        "nth_rw"
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `add_lt_add_iff_left [`hx_top])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `add_lt_add_iff_left [`hx_top]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `add_zeroₓ [(Term.app `f.limsup [`u])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
theorem
  ...
  [ CountableInterFilter f ] ( u : α → ℝ≥0∞ ) : ∀ᶠ y in f , u y ≤ f.limsup u
  :=
    by
      by_cases' hx_top : f.limsup u = ⊤
        · simp_rw [ hx_top ] exact eventually_of_forall fun a => le_top
        have
          h_forall_le
            : ∀ᶠ y in f , ∀ n : ℕ , u y < f.limsup u + ( 1 : ℝ≥0∞ ) / n
            :=
            by
        ...
        have hr_ne_zero : ( r : ℝ≥0∞ ) ≠ 0 := by rw [ Ne.def , coe_eq_zero ] exact ne_of_ltₓ hr_pos . symm
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `limsup_const_mul [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `CountableInterFilter [`f]) "]")
    (Term.implicitBinder "{" [`u] [":" (Term.arrow `α "→" (Data.Real.Ennreal.«termℝ≥0∞» "ℝ≥0∞"))] "}")
     ...
     (Term.app
      ...
      [(Term.fun
        ...
        (Term.basicFun
         ...
         "=>"
         (Finset.Data.Finset.Fold.«term_*_» `a "*" (Term.app `u [`x]))))])
     "="
     (Finset.Data.Finset.Fold.«term_*_» `a "*" (Term.app `f.limsup [`u])))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group (Tactic.byCases' "by_cases'" [`ha_top ":"] («term_≠_» `a "≠" (Order.BoundedOrder.«term⊤» "⊤"))) [])
       (group
        (Tactic.«tactic·._»
         "·"
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group (Tactic.exact "exact" (Term.app `limsup_const_mul_of_ne_top [`ha_top])) [])])))
        [])
       (group (Tactic.pushNeg "push_neg" [(Tactic.location "at" (Tactic.locationHyp [`ha_top] []))]) [])
       (group
        (Tactic.byCases' "by_cases'" [`hu ":"] (Filter.Order.Filter.Basic.«term_=ᶠ[_]_» `u " =ᶠ[" `f "] " (numLit "0")))
        [])
       (group
        (Tactic.«tactic·._»
         "·"
           ...
           [(group
            ...
            (group
             (Tactic.simp
              ...
              ["only"]
              ["["
               [(Tactic.simpLemma [] [] (Term.app `limsup_congr [`hu]))
                ","
                (Tactic.simpLemma [] [] (Term.app `limsup_congr [`hau]))
                ","
                (Tactic.simpLemma [] [] `Pi.zero_apply)
                ","
                (Tactic.simpLemma [] ["←"] `bot_eq_zero)
                ","
                (Tactic.simpLemma [] [] `limsup_const_bot)]
               "]"]
              [])
             [])
         ...
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group
             (Tactic.simpRw
              "simp_rw"
              (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `ha_top) "," (Tactic.rwRule [] `top_mul)] "]")
              [])
             [])
            (group
             (Tactic.tacticHave_
                  ...
                  (Tactic.tacticSeq1Indented
                   [(group
                     (Tactic.rwSeq
                      ...
                      (Tactic.rwRuleSeq
                       "["
                       [(Tactic.rwRule [] `eventually_eq) "," (Tactic.rwRule [] `not_eventually)]
                       "]")
            ...
            (group
             ...
             [])
            (group
             (Tactic.exact "exact" (Term.app `eq_top_iff.mpr [(Term.app `le_limsup_of_frequently_le [`hu_mul])]))
             [])
            (group
             (Tactic.have''
              "have"
              [`hfu []]
              [(Term.typeSpec ":" («term_≠_» (Term.app `f.limsup [`u]) "≠" (numLit "0")))])
             [])
            (group (Tactic.exact "exact" (Term.app `mt [(Term.proj `limsup_eq_zero_iff "." (fieldIdx "1")) `hu])) [])
            (group
             (Tactic.simp
              "simp"
              []
              ["only"]
              ["["
               [(Tactic.simpLemma [] [] `h_top_le)
                ","
                (Tactic.simpLemma [] [] `hfu)
                ","
            ...
            (Tactic.tacticSeq1Indented
             [(group
               (Tactic.rwSeq
                "rw"
                []
                (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `eventually_eq) "," (Tactic.rwRule [] `not_eventually)] "]")
                [(Tactic.location "at" (Tactic.locationHyp [`hu] []))])
               [])
              (group
               (Tactic.refine'
       ...
       (Tactic.have''
        ...
        [(Term.typeSpec
          ...
          («term_=_»
           ...
           (Order.BoundedOrder.«term⊤» "⊤")))])
       [])
      (group (Tactic.exact "exact" (Term.app `eq_top_iff.mpr [(Term.app `le_limsup_of_frequently_le [`hu_mul])])) [])
      (group
       (Tactic.have'' "have" [`hfu []] [(Term.typeSpec ":" («term_≠_» (Term.app `f.limsup [`u]) "≠" (numLit "0")))])
       [])
      (group (Tactic.exact "exact" (Term.app `mt [(Term.proj `limsup_eq_zero_iff "." (fieldIdx "1")) `hu])) [])
      (group
       (Tactic.simp
        ...
        ["only"]
        ["["
         [(Tactic.simpLemma [] [] `h_top_le) "," (Tactic.simpLemma [] [] `hfu) "," (Tactic.simpLemma [] [] `if_false)]
         "]"]
        [])
       [])])))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.exact "exact" (Term.app `mt [(Term.proj `limsup_eq_zero_iff "." (fieldIdx "1")) `hu]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `mt [(Term.proj `limsup_eq_zero_iff "." (fieldIdx "1")) `hu])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.proj `limsup_eq_zero_iff "." (fieldIdx "1"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  `limsup_eq_zero_iff
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_≠_» (Term.app `f.limsup [`u]) "≠" (numLit "0"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_≠_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (numLit "0")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'numLit', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `eq_top_iff.mpr [(Term.app `le_limsup_of_frequently_le [`hu_mul])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `le_limsup_of_frequently_le [`hu_mul])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `le_limsup_of_frequently_le [`hu_mul]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `eq_top_iff.mpr
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(«term_=_» (Term.app `u [`x]) "=" (numLit "0")) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `ite
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
 ...
 [(Term.app
   ...
   [(Term.fun
     ...
     (Term.basicFun
      ...
      (Term.app
       `ite
       [(Term.paren "(" [(«term_=_» (Term.app `u [`x]) "=" (numLit "0")) []] ")")
        (Term.paren "(" [(numLit "0") [(Term.typeAscription ":" (Data.Real.Ennreal.«termℝ≥0∞» "ℝ≥0∞"))]] ")")
        (Order.BoundedOrder.«term⊤» "⊤")])))])
  []]
 ")")
    ...
    (Tactic.tacticSeq1Indented
     [(group
      ...
      (group
       (Tactic.refine'
        "refine'"
        (Term.app `hu.mono [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`x `hx] [])] "=>" (Term.hole "_")))]))
       [])
      (group
       (Tactic.rwSeq
        "rw"
...
theorem
  limsup_const_mul
  [ CountableInterFilter f ] { u : α → ℝ≥0∞ } { a : ℝ≥0∞ } : f.limsup fun x : α => a * u x = a * f.limsup u
  :=
    by
      by_cases' ha_top : a ≠ ⊤
        ...
        ·
          have
              hau
                : fun x => a * u x =ᶠ[ f ] 0
                :=
                by refine' hu.mono fun x hx => _ rw [ Pi.zero_apply ] at hx simp [ hx ]
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `limsup_liminf_le_liminf_limsup [])
  (Command.declSig
   [(Term.implicitBinder "{" [`β] [] "}")
    (Term.instBinder "[" [] (Term.app `Encodable [`β]) "]")
    (Term.implicitBinder "{" [`f] [":" (Term.app `Filter [`α])] "}")
    (Term.instBinder "[" [] (Term.app `CountableInterFilter [`f]) "]")
    (Term.implicitBinder "{" [`g] [":" (Term.app `Filter [`β])] "}")
    (Term.explicitBinder
     "("
     [`u]
     [":" (Term.arrow `α "→" (Term.arrow `β "→" (Data.Real.Ennreal.«termℝ≥0∞» "ℝ≥0∞")))]
     []
     ")")]
   (Term.typeSpec
    ":"
      ...
      [(Term.fun
        ...
        (Term.basicFun
         ...
         (Term.app
          ...
          [(Term.fun
            "fun"
            (Term.basicFun [(Term.simpleBinder [`b] [(Term.typeSpec ":" `β)])] "=>" (Term.app `u [`a `b])))])))])
     "≤"
     (Term.app
      `g.liminf
      [(Term.fun
        ...
        (Term.basicFun
         ...
         (Term.app
          `f.limsup
          [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`a] [])] "=>" (Term.app `u [`a `b])))])))]))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
                  ...
                  (Tactic.tacticSeq1Indented
                   [(group
                     (Tactic.rwSeq
                      "rw"
                      []
                      (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `eventually_countable_forall)] "]")
                      [])
                     [])
                    (group
                     (Tactic.exact
            ...
            [(Term.fun
              ...
              (Term.basicFun
               ...
               (Term.app
                ...
                [(Term.app `Filter.eventually_of_forall [`hx]) (Term.hole "_")])))])]))
        [])
       (group
        (Mathlib.RunTac.tacticRun_tac_
         "run_tac"
         (Term.doSeqIndent [(Term.doSeqItem (Term.doExpr `filter.is_bounded_default) [])]))
        [])])))
   [])
  []
  []))
         ...
         [(Term.app
           ...
           [(Term.fun
             ...
             (Term.basicFun
              [(Term.simpleBinder [`x `hx] [])]
              "=>"
              (Term.app `Filter.liminf_le_liminf [(Term.app `Filter.eventually_of_forall [`hx]) (Term.hole "_")])))])]))
       [])
      (group
       (Mathlib.RunTac.tacticRun_tac_
        "run_tac"
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, term))
  (Term.app `Filter.eventually_of_forall [`hx])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Filter.eventually_of_forall [`hx]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `Filter.liminf_le_liminf
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
 ...
 [(Term.app
   ...
   [(Term.fun
     ...
     (Term.basicFun
      ...
      (Term.app
       `Filter.liminf_le_liminf
       [(Term.paren "(" [(Term.app `Filter.eventually_of_forall [`hx]) []] ")") (Term.hole "_")])))])
  []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `Inf_le
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.forall
   ...
   («term_≤_»
    (Term.app `u [`a `b])
    "≤"
    (Term.app `f.limsup [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`a'] [])] "=>" (Term.app `u [`a' `b])))])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.forall', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.forall', expected 'Lean.Parser.Term.forall.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_≤_»
...
theorem
  ...
  { β } [ Encodable β ] { f : Filter α } [ CountableInterFilter f ] { g : Filter β } ( u : α → β → ℝ≥0∞ )
    : f.limsup fun a : α => g.liminf fun b : β => u a b ≤ g.liminf fun b => f.limsup fun a => u a b
  :=
    by
      have
          h1
            : ∀ᶠ a in f , ∀ b , u a b ≤ f.limsup fun a' => u a' b
            :=
            by · rw [ eventually_countable_forall ] exact fun b => Ennreal.eventually_le_limsup fun a => u a b
        refine' Inf_le h1.mono fun x hx => Filter.liminf_le_liminf Filter.eventually_of_forall hx _
        run_tac filter.is_bounded_default
