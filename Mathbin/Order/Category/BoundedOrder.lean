...
instance hasForgetToBipointed : HasForget₂ BoundedOrderCat Bipointed
    where
  forget₂ :=
    { obj := fun X => ⟨X, ⊥, ⊤⟩
...
theorem boundedOrderCat_dual_comp_forget_to_bipointed :
    BoundedOrderCat.dual ⋙ forget₂ BoundedOrderCat Bipointed =
      forget₂ BoundedOrderCat Bipointed ⋙ Bipointed.swap :=
  rfl
#align BoundedOrder_dual_comp_forget_to_Bipointed boundedOrderCat_dual_comp_forget_to_bipointed
