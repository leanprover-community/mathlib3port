...
instance
  ...
  [ LinearOrderₓ ι ] [ ∀ a , PartialOrderₓ ( β a ) ] : IsStrictOrder ( Pilex ι β ) ( · < · )
  where
    irrefl a ⟨ k , hk₁ , hk₂ ⟩ := lt_irreflₓ ( a k ) hk₂
      trans
        :=
        by
          rintro a b c ⟨ N₁ , lt_N₁ , a_lt_b ⟩ ⟨ N₂ , lt_N₂ , b_lt_c ⟩
            ...
            exacts
              [
              ⟨ N₁ , fun j hj => ( lt_N₁ _ hj ) . trans ( lt_N₂ _ $ hj.trans H ) , lt_N₂ _ H ▸ a_lt_b ⟩
                ,
