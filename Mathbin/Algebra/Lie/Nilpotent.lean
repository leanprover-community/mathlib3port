...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `infi_max_gen_zero_eigenspace_eq_top_of_nilpotent [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `IsNilpotent [`R `L `M]) "]")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Order.CompleteLattice.«term⨅_,_»
      ...
      ", "
      (Term.app (Term.proj (Term.app `to_endomorphism [`R `L `M `x]) "." `maximalGeneralizedEigenspace) [(numLit "0")]))
     "="
      ...
      [(group (Tactic.ext "ext" [(Tactic.rcasesPat.one `m)] []) [])
       (group
        (Tactic.simp
         ...
         ["only"]
         ["["
          [(Tactic.simpLemma [] [] `Module.End.mem_maximal_generalized_eigenspace)
           ","
           (Tactic.simpLemma [] [] `Submodule.mem_top)
           ","
           (Tactic.simpLemma [] [] `sub_zero)
           ","
           (Tactic.simpLemma [] [] `iff_trueₓ)
           ","
        ...
        (Tactic.obtain
         ...
         [(Tactic.rcasesPatMed
           [(Tactic.rcasesPat.tuple
             ...
             "⟩")])]
         []
         [":=" [(Term.app `nilpotent_endo_of_nilpotent_module [`R `L `M])]])
        [])
       (group (Tactic.use "use" [`k]) [])
       (group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `hk)] "]") []) [])
       (group (Tactic.exact "exact" (Term.app `LinearMap.zero_apply [`m])) [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `LinearMap.zero_apply [`m]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `LinearMap.zero_apply [`m])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simpLemma', expected 'Lean.Parser.Tactic.simpErase'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `Module.End.mem_maximal_generalized_eigenspace
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
...
/--
  ...
  theorem
    ...
    [ IsNilpotent R L M ] : ⨅ x : L , to_endomorphism R L M x . maximalGeneralizedEigenspace 0 = ⊤
    :=
      by
        ext m
          simp
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " See also `lie_algebra.zero_root_space_eq_top_of_nilpotent`. -/")]
  []
  []
  []
  []
 ...
 (Command.theorem
  "theorem"
  (Command.declId `LieAlgebra.infi_max_gen_zero_eigenspace_eq_top_of_nilpotent [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `IsNilpotent [`R `L]) "]")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Order.CompleteLattice.«term⨅_,_»
      ...
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `x)] [":" `L]))
      ", "
      (Term.app (Term.proj (Term.app `ad [`R `L `x]) "." `maximalGeneralizedEigenspace) [(numLit "0")]))
     "="
     (Order.BoundedOrder.«term⊤» "⊤"))))
  (Command.declValSimple ":=" (Term.app `LieModule.infi_max_gen_zero_eigenspace_eq_top_of_nilpotent [`R `L `L]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `LieModule.infi_max_gen_zero_eigenspace_eq_top_of_nilpotent [`R `L `L])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `LieModule.infi_max_gen_zero_eigenspace_eq_top_of_nilpotent
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `ad [`R `L `x]) "." `maximalGeneralizedEigenspace)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `ad [`R `L `x])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `ad [`R `L `x]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.explicitBinders', expected 'Mathlib.ExtendedBinder.extBinders'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.constant.antiquot'
...
/-- See also `lie_algebra.zero_root_space_eq_top_of_nilpotent`. -/
  theorem
    LieAlgebra.infi_max_gen_zero_eigenspace_eq_top_of_nilpotent
    [ IsNilpotent R L ] : ⨅ x : L , ad R L x . maximalGeneralizedEigenspace 0 = ⊤
