...
[PrettyPrinter.parenthesize.input] (Command.declaration
     (Command.declModifiers
      [(Command.docComment "/--" "The terms correpsonding to the `⁅H, H⁆`-relations. -/")]
      []
      []
      []
      []
      ...
      (Command.optDeclSig
       ...
       [(Term.typeSpec
         ...
         (Term.arrow
          («term_×_» `B "×" `B)
          "→"
          (Term.app `FreeLieAlgebra [`R (Term.app `Generators [`B])])))])
        ...
        [(Term.fun
          ...
          (Term.basicFun
           ...
           (Data.Bracket.«term⁅_,_⁆»
            "⁅"
            (Term.app (CartanMatrix.Relations.Algebra.Lie.CartanMatrix.termH "H") [`i])
            ", "
            (Term.app (CartanMatrix.Relations.Algebra.Lie.CartanMatrix.termH "H") [`j])
            "⁆")))])
       [])
      []
      []
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      (CartanMatrix.Relations.Algebra.Lie.CartanMatrix.termH "H")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'CartanMatrix.Relations.Algebra.Lie.CartanMatrix.termH', expected 'CartanMatrix.Relations.Algebra.Lie.CartanMatrix.termH._@.Algebra.Lie.CartanMatrix._hyg.8'
...
/-- The terms correpsonding to the `⁅H, H⁆`-relations. -/
  def hH : B × B → FreeLieAlgebra R Generators B := uncurry fun i j => ⁅ H i , H j ⁆
#align cartan_matrix.relations.HH CartanMatrix.Relations.hH

/- failed to parenthesize: parenthesize: uncaught backtrack exception
[PrettyPrinter.parenthesize.input] (Command.declaration
     (Command.declModifiers
      [(Command.docComment "/--" "The terms correpsonding to the `⁅E, F⁆`-relations. -/")]
      []
      []
      []
      []
          ...
          (Term.basicFun
           ...
           (termIfThenElse
            ...
            («term_-_»
             (Data.Bracket.«term⁅_,_⁆»
              "⁅"
              (Term.app (CartanMatrix.Relations.Algebra.Lie.CartanMatrix.termE "E") [`i])
              ", "
              (Term.app (CartanMatrix.Relations.Algebra.Lie.CartanMatrix.termF "F") [`i])
              "⁆")
             "-"
             (Term.app (CartanMatrix.Relations.Algebra.Lie.CartanMatrix.termH "H") [`i]))
            "else"
            (Data.Bracket.«term⁅_,_⁆»
             ...
             (Term.app (CartanMatrix.Relations.Algebra.Lie.CartanMatrix.termE "E") [`i])
             ", "
             (Term.app (CartanMatrix.Relations.Algebra.Lie.CartanMatrix.termF "F") [`j])
             "⁆"))))])
       [])
      []
      []
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none,
     [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      (CartanMatrix.Relations.Algebra.Lie.CartanMatrix.termF "F")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'CartanMatrix.Relations.Algebra.Lie.CartanMatrix.termF', expected 'CartanMatrix.Relations.Algebra.Lie.CartanMatrix.termF._@.Algebra.Lie.CartanMatrix._hyg.94'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.matchAlts'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValEqns'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.whereStructInst'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.def', expected 'Lean.Parser.Command.theorem'
...
/-- The terms correpsonding to the `⁅E, F⁆`-relations. -/
  def
    eF
    : B × B → FreeLieAlgebra R Generators B
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     (Command.declModifiers
      [(Command.docComment "/--" "The terms correpsonding to the `⁅H, E⁆`-relations. -/")]
      []
      []
      []
      []
          ...
          (Term.basicFun
           ...
           («term_-_»
            (Data.Bracket.«term⁅_,_⁆»
             ...
             (Term.app (CartanMatrix.Relations.Algebra.Lie.CartanMatrix.termH "H") [`i])
             ", "
             (Term.app (CartanMatrix.Relations.Algebra.Lie.CartanMatrix.termE "E") [`j])
             "⁆")
            "-"
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none,
     [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      (CartanMatrix.Relations.Algebra.Lie.CartanMatrix.termE "E")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'CartanMatrix.Relations.Algebra.Lie.CartanMatrix.termE', expected 'CartanMatrix.Relations.Algebra.Lie.CartanMatrix.termE._@.Algebra.Lie.CartanMatrix._hyg.53'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.matchAlts'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValEqns'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.whereStructInst'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.def', expected 'Lean.Parser.Command.theorem'
...
/-- The terms correpsonding to the `⁅H, E⁆`-relations. -/
  def hE : B × B → FreeLieAlgebra R Generators B := uncurry fun i j => ⁅ H i , E j ⁆ - A i j • E j
#align cartan_matrix.relations.HE CartanMatrix.Relations.hE

/- failed to parenthesize: parenthesize: uncaught backtrack exception
[PrettyPrinter.parenthesize.input] (Command.declaration
     (Command.declModifiers
      [(Command.docComment "/--" "The terms correpsonding to the `⁅H, F⁆`-relations. -/")]
      []
      []
      []
      []
...
/-- The terms correpsonding to the `⁅H, F⁆`-relations. -/
  def hF : B × B → FreeLieAlgebra R Generators B := uncurry fun i j => ⁅ H i , F j ⁆ + A i j • F j
        ...
        [(Term.fun
          ...
          (Term.basicFun
           ...
           («term_<|_»
            («term_^_»
             (Term.app
              (CartanMatrix.Relations.Algebra.Lie.CartanMatrix.termad "ad")
              [(Term.app (CartanMatrix.Relations.Algebra.Lie.CartanMatrix.termE "E") [`i])])
             "^"
             (Term.proj («term-_» "-" (Term.app `A [`i `j])) "." `toNat))
            "<|"
            (Data.Bracket.«term⁅_,_⁆»
             "⁅"
             (Term.app (CartanMatrix.Relations.Algebra.Lie.CartanMatrix.termE "E") [`i])
