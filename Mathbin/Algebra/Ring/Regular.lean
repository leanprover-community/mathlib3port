...
Note this is not an instance as it forms a typeclass loop. -/
@[reducible]
def NoZeroDivisors.toCancelCommMonoidWithZero [CommRing α] [NoZeroDivisors α] : CancelCommMonoidWithZero α :=
...
instance (priority := 100) IsDomain.toCancelMonoidWithZero [Ring α] [IsDomain α] : CancelMonoidWithZero α :=
