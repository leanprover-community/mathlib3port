...
class AddFreimanHomClass (F : Type _) (A : outParam $ Set α) (β : outParam $ Type _) [AddCommMonoid α] [AddCommMonoid β]
...
class FreimanHomClass (F : Type _) (A : outParam $ Set α) (β : outParam $ Type _) [CommMonoid α] [CommMonoid β] (n : ℕ)
