...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `sum_nat_coe_enat [])
  (Command.declSig
   ...
   (Term.typeSpec
    ...
    («term_=_»
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      ...
      `s
      ", "
      (Term.paren "(" [(Term.app `f [`x]) [(Term.typeAscription ":" `Enat)]] ")"))
     "="
     (Term.paren
      "("
      [(Algebra.BigOperators.Basic.«term∑_in_,_»
  ...
  (Command.declValSimple
   ":="
   (Term.proj (Term.app (Term.proj `Enat.coeHom "." `map_sum) [(Term.hole "_") (Term.hole "_")]) "." `symm)
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app (Term.proj `Enat.coeHom "." `map_sum) [(Term.hole "_") (Term.hole "_")])
...
theorem
  sum_nat_coe_enat
  ( s : Finset α ) ( f : α → ℕ ) : ∑ x in s , ( f x : Enat ) = ( ∑ x in s , f x : ℕ )
