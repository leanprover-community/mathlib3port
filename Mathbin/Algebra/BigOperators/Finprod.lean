...
/- ./././Mathport/Syntax/Translate/Basic.lean:611:2: warning: expanding binder collection (i «expr ≠ » a) -/
@[to_additive]
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
     ...
     (Term.app
      `finprod_eq_prod_of_mul_support_to_finset_subset
      [(Term.hole "_") `hf (Term.paren "(" (Term.app `Finset.subset_insert [(Term.hole "_") (Term.hole "_")]) ")")])
     ")")
