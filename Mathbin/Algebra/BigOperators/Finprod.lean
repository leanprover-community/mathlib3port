...
-- ./././Mathport/Syntax/Translate/Basic.lean:712:2: warning: expanding binder collection (i «expr ≠ » a)
@[to_additive]
...
-- ./././Mathport/Syntax/Translate/Basic.lean:855:6: warning: expanding binder group (a b c)
@[to_additive]
