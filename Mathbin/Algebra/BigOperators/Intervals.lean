...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `sum_Ico_add [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `OrderedCancelAddCommMonoid [`α]) "]")
    (Term.instBinder "[" [] (Term.app `HasExistsAddOfLe [`α]) "]")
    (Term.instBinder "[" [] (Term.app `LocallyFiniteOrder [`α]) "]")
    (Term.instBinder "[" [] (Term.app `AddCommMonoidₓ [`β]) "]")
    (Term.explicitBinder "(" [`f] [":" (Term.arrow `α "→" `β)] [] ")")
    (Term.explicitBinder "(" [`a `b `c] [":" `α] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      ...
      (Term.app `Ico [`a `b])
      ", "
      (Term.app `f [(Init.Logic.«term_+_» `c "+" `x)]))
     "="
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      "∑"
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `x)] []))
      " in "
      (Term.app `Ico [(Init.Logic.«term_+_» `a "+" `c) (Init.Logic.«term_+_» `b "+" `c)])
      ", "
      (Term.app `f [`x])))))
      ...
      [(group (Tactic.classical "classical") [])
       (group
        (Tactic.rwSeq
         ...
         (Tactic.rwRuleSeq
          "["
          [(Tactic.rwRule ["←"] `image_add_right_Ico)
           ","
           (Tactic.rwRule
            []
            (Term.app
             ...
             [(Term.fun
               "fun"
               (Term.basicFun [(Term.simpleBinder [`x `hx `y `hy `h] [])] "=>" (Term.app `add_right_cancelₓ [`h])))]))]
          "]")
         [])
        [])
       (group (Tactic.simpRw "simp_rw" (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `add_commₓ)] "]") []) [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.simpRw "simp_rw" (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `add_commₓ)] "]") [])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`x `hx `y `hy `h] [])] "=>" (Term.app `add_right_cancelₓ [`h])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.fun.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.basicFun.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `add_right_cancelₓ [`h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Init.Logic.«term_+_» `b "+" `c) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Logic.«term_+_»', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Logic.«term_+_»', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Logic.«term_+_»', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Logic.«term_+_»', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Init.Logic.«term_+_» `a "+" `c) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `Ico
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
theorem
  ...
  := by classical rw [ ← image_add_right_Ico , sum_image fun x hx y hy h => add_right_cancelₓ h ] simp_rw [ add_commₓ ]
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Additive [`β]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `sum_Ico_succ_top [])
  (Command.declSig
   [(Term.implicitBinder "{" [`δ] [":" (Term.type "Type" [(Level.hole "_")])] "}")
    (Term.instBinder "[" [] (Term.app `AddCommMonoidₓ [`δ]) "]")
    (Term.implicitBinder "{" [`a `b] [":" (termℕ "ℕ")] "}")
    (Term.explicitBinder "(" [`hab] [":" («term_≤_» `a "≤" `b)] [] ")")
    (Term.explicitBinder "(" [`f] [":" (Term.arrow (termℕ "ℕ") "→" `δ)] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      ...
      " in "
      (Term.app `Ico [`a (Init.Logic.«term_+_» `b "+" (numLit "1"))])
      ", "
      (Term.app `f [`k]))
     "="
     (Init.Logic.«term_+_»
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.rwSeq
         ...
         (Tactic.rwRuleSeq
          "["
          [(Tactic.rwRule [] (Term.app `Nat.Ico_succ_right_eq_insert_Ico [`hab]))
           ","
           (Tactic.rwRule [] (Term.app `sum_insert [`right_not_mem_Ico]))
           ","
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `sum_insert [`right_not_mem_Ico])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Nat.Ico_succ_right_eq_insert_Ico [`hab])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
theorem
  sum_Ico_succ_top
  { δ : Type _ } [ AddCommMonoidₓ δ ] { a b : ℕ } ( hab : a ≤ b ) ( f : ℕ → δ )
    : ∑ k in Ico a b + 1 , f k = ∑ k in Ico a b , f k + f b
  := by rw [ Nat.Ico_succ_right_eq_insert_Ico hab , sum_insert right_not_mem_Ico , add_commₓ ]
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `prod_Ico_succ_top [])
  (Command.declSig
   [(Term.implicitBinder "{" [`a `b] [":" (termℕ "ℕ")] "}")
    (Term.explicitBinder "(" [`hab] [":" («term_≤_» `a "≤" `b)] [] ")")
  ...
  (Command.declValSimple
   ":="
   (Term.app
    (Term.explicit "@" `sum_Ico_succ_top)
    [(Term.app `Additive [`β]) (Term.hole "_") (Term.hole "_") (Term.hole "_") `hab (Term.hole "_")])
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
@[ to_additive ]
  theorem
    prod_Ico_succ_top
    { a b : ℕ } ( hab : a ≤ b ) ( f : ℕ → β ) : ∏ k in Ico a b + 1 , f k = ∏ k in Ico a b , f k * f b
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `sum_eq_sum_Ico_succ_bot [])
  (Command.declSig
   [(Term.implicitBinder "{" [`δ] [":" (Term.type "Type" [(Level.hole "_")])] "}")
    (Term.instBinder "[" [] (Term.app `AddCommMonoidₓ [`δ]) "]")
    (Term.implicitBinder "{" [`a `b] [":" (termℕ "ℕ")] "}")
    ...
    («term_=_»
     ...
     (Init.Logic.«term_+_»
      ...
      (Algebra.BigOperators.Basic.«term∑_in_,_»
       ...
       (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `k)] []))
       " in "
       (Term.app `Ico [(Init.Logic.«term_+_» `a "+" (numLit "1")) `b])
       ", "
       (Term.app `f [`k]))))))
  (Command.declValSimple
   ":="
   (Term.have
    ...
    (Term.haveDecl
     (Term.haveIdDecl
      ...
      [(Term.typeSpec
        ":"
        (Init.Core.«term_∉_» `a " ∉ " (Term.app `Ico [(Init.Logic.«term_+_» `a "+" (numLit "1")) `b])))]
      ":="
      (Term.byTactic
       "by"
         ...
         (Tactic.rwSeq
          ...
          (Tactic.rwRuleSeq
           ...
           [(Tactic.rwRule ["←"] (Term.app `sum_insert [`ha]))
            ","
            (Tactic.rwRule [] (Term.app `Nat.Ico_insert_succ_left [`hab]))]
           "]")
          [])
         [])]))))
   [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Nat.Ico_insert_succ_left [`hab])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 0, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Init.Logic.«term_+_» `a "+" (numLit "1")) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `Ico
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
theorem
  ...
  := have ha : a ∉ Ico a + 1 b := by simp by rw [ ← sum_insert ha , Nat.Ico_insert_succ_left hab ]
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `prod_eq_prod_Ico_succ_bot [])
  (Command.declSig
   [(Term.implicitBinder "{" [`a `b] [":" (termℕ "ℕ")] "}")
    (Term.explicitBinder "(" [`hab] [":" («term_<_» `a "<" `b)] [] ")")
    (Term.explicitBinder "(" [`f] [":" (Term.arrow (termℕ "ℕ") "→" `β)] [] ")")]
  ...
  (Command.declValSimple
   ":="
   (Term.app
    (Term.explicit "@" `sum_eq_sum_Ico_succ_bot)
    [(Term.app `Additive [`β]) (Term.hole "_") (Term.hole "_") (Term.hole "_") `hab (Term.hole "_")])
   [])
  []
  []))
...
@[ to_additive ]
  theorem
    ...
    { a b : ℕ } ( hab : a < b ) ( f : ℕ → β ) : ∏ k in Ico a b , f k = f a * ∏ k in Ico a + 1 b , f k
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `prod_Ico_consecutive [])
  (Command.declSig
   [(Term.explicitBinder "(" [`f] [":" (Term.arrow (termℕ "ℕ") "→" `β)] [] ")")
    (Term.implicitBinder "{" [`m `n `k] [":" (termℕ "ℕ")] "}")
    (Term.explicitBinder "(" [`hmn] [":" («term_≤_» `m "≤" `n)] [] ")")
    (Term.explicitBinder "(" [`hnk] [":" («term_≤_» `n "≤" `k)] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Finset.Data.Finset.Fold.«term_*_»
  ...
  (Command.declValSimple
   ":="
   («term_$__»
    (Term.subst (Term.app `Ico_union_Ico_eq_Ico [`hmn `hnk]) "▸" [`Eq.symm])
    "$"
    («term_$__» `prod_union "$" (Term.app `Ico_disjoint_Ico_consecutive [`m `n `k])))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Ico_disjoint_Ico_consecutive [`m `n `k])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 75, term))
  (Term.app `Ico_union_Ico_eq_Ico [`hmn `hnk])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `prod_range_mul_prod_Ico [])
  (Command.declSig
   [(Term.explicitBinder "(" [`f] [":" (Term.arrow (termℕ "ℕ") "→" `β)] [] ")")
  ...
  (Command.declValSimple
   ...
   (Term.subst
    ...
    "▸"
    [(Term.subst `Nat.Ico_zero_eq_range "▸" [(Term.app `prod_Ico_consecutive [`f `m.zero_le `h])])])
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `prod_Ico_consecutive [`f `m.zero_le `h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
@[ to_additive ]
  theorem
    ...
    ( f : ℕ → β ) { m n : ℕ } ( h : m ≤ n ) : ∏ k in range m , f k * ∏ k in Ico m n , f k = ∏ k in range n , f k
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `prod_Ico_eq_mul_inv [])
  (Command.declSig
   [(Term.implicitBinder "{" [`δ] [":" (Term.type "Type" [(Level.hole "_")])] "}")
    (Term.instBinder "[" [] (Term.app `CommGroupₓ [`δ]) "]")
    (Term.explicitBinder "(" [`f] [":" (Term.arrow (termℕ "ℕ") "→" `δ)] [] ")")
    (Term.implicitBinder "{" [`m `n] [":" (termℕ "ℕ")] "}")
    (Term.explicitBinder "(" [`h] [":" («term_≤_» `m "≤" `n)] [] ")")]
   (Term.typeSpec
  ...
  (Command.declValSimple
   ":="
   («term_$__»
    (Term.proj `eq_mul_inv_iff_mul_eq "." (fieldIdx "2"))
    "$"
    (Term.byTactic
     "by"
     (Tactic.tacticSeq
      (Tactic.tacticSeq1Indented
       [(group
         (Tactic.«tactic_<;>_»
          ...
          "<;>"
          (Tactic.exact "exact" (Term.app `prod_range_mul_prod_Ico [`f `h])))
         [])]))))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `prod_range_mul_prod_Ico [`f `h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
@[ to_additive ]
  theorem
    prod_Ico_eq_mul_inv
    { δ : Type _ } [ CommGroupₓ δ ] ( f : ℕ → δ ) { m n : ℕ } ( h : m ≤ n )
      : ∏ k in Ico m n , f k = ∏ k in range n , f k * ∏ k in range m , f k ⁻¹
    := eq_mul_inv_iff_mul_eq . 2 $ by rw [ mul_commₓ ] <;> exact prod_range_mul_prod_Ico f h
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `sum_Ico_eq_sub [])
  (Command.declSig
   [(Term.implicitBinder "{" [`δ] [":" (Term.type "Type" [(Level.hole "_")])] "}")
    (Term.instBinder "[" [] (Term.app `AddCommGroupₓ [`δ]) "]")
    (Term.explicitBinder "(" [`f] [":" (Term.arrow (termℕ "ℕ") "→" `δ)] [] ")")
    (Term.implicitBinder "{" [`m `n] [":" (termℕ "ℕ")] "}")
    (Term.explicitBinder "(" [`h] [":" («term_≤_» `m "≤" `n)] [] ")")]
   (Term.typeSpec
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.simpa
         ...
         []
         ["using" (Term.app `sum_Ico_eq_add_neg [`f `h])])
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `sum_Ico_eq_add_neg [`f `h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
theorem
  sum_Ico_eq_sub
  { δ : Type _ } [ AddCommGroupₓ δ ] ( f : ℕ → δ ) { m n : ℕ } ( h : m ≤ n )
    : ∑ k in Ico m n , f k = ∑ k in range n , f k - ∑ k in range m , f k
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " The two ways of summing over `(i,j)` in the range `a<=i<=j<b` are equal. -/")]
  []
  []
  []
  []
 ...
 (Command.theorem
  "theorem"
  (Command.declId `sum_Ico_Ico_comm [])
  (Command.declSig
   [(Term.implicitBinder "{" [`M] [":" (Term.type "Type" [(Level.hole "_")])] "}")
    (Term.instBinder "[" [] (Term.app `AddCommMonoidₓ [`M]) "]")
    (Term.explicitBinder "(" [`a `b] [":" (termℕ "ℕ")] [] ")")
    (Term.explicitBinder "(" [`f] [":" (Term.arrow (termℕ "ℕ") "→" (Term.arrow (termℕ "ℕ") "→" `M))] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Algebra.BigOperators.Basic.«term∑_in_,_»
     ...
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      ...
      (Algebra.BigOperators.Basic.«term∑_in_,_»
       ...
       (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
       " in "
       (Term.app `Finset.ico [`a (Init.Logic.«term_+_» `j "+" (numLit "1"))])
       ", "
       (Term.app `f [`i `j]))))))
  (Command.declValSimple
   ":="
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.rwSeq
         "rw"
         []
         (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Finset.sum_sigma') "," (Tactic.rwRule [] `Finset.sum_sigma')] "]")
         [])
        [])
       (group
        (Tactic.«tactic_<;>_»
          ...
          (Term.app
           ...
           [(Term.fun
             ...
             (Term.basicFun
              ...
              (Term.paren
               "("
               [(Term.anonymousCtor "⟨" [(Term.proj `x "." (fieldIdx "2")) "," (Term.proj `x "." (fieldIdx "1"))] "⟩")
                [(Term.typeAscription
                  ":"
                  (Init.Data.Sigma.Basic.«termΣ_,_»
                   "Σ"
          ...
          (Tactic.simp
           ...
           ["["
            [(Tactic.simpLemma [] [] `Finset.mem_Ico)
             ","
             (Tactic.simpLemma [] [] `Sigma.forall)
             ","
             (Tactic.simpLemma [] [] `Finset.mem_sigma)]
            "]"]
           [])
          "<;>"
          (Tactic.«tactic_<;>_»
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.«tactic_<;>_»
   (Tactic.rintro
    "rintro"
    [(Tactic.rintroPat.one (Tactic.rcasesPat.tuple "⟨" [] "⟩")) (Tactic.rintroPat.one (Tactic.rcasesPat.ignore "_"))]
    [])
   "<;>"
   (Tactic.tacticRfl "rfl"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.«tactic_<;>_»', expected 'antiquot'
...
/-- The two ways of summing over `(i,j)` in the range `a<=i<=j<b` are equal. -/
  theorem
    sum_Ico_Ico_comm
    { M : Type _ } [ AddCommMonoidₓ M ] ( a b : ℕ ) ( f : ℕ → ℕ → M )
      :
    ...
    :=
      by
        rw [ Finset.sum_sigma' , Finset.sum_sigma' ]
          refine'
              Finset.sum_bij'
                fun x : Σ i : ℕ , ℕ _ => ( ⟨ x . 2 , x . 1 ⟩ : Σ i : ℕ , ℕ )
                  _
                  fun _ _ => rfl
                  fun x : Σ i : ℕ , ℕ _ => ( ⟨ x . 2 , x . 1 ⟩ : Σ i : ℕ , ℕ )
                  _
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `prod_Ico_eq_prod_range [])
  (Command.declSig
   [(Term.explicitBinder "(" [`f] [":" (Term.arrow (termℕ "ℕ") "→" `β)] [] ")")
   ...
   (Term.typeSpec
    ...
    («term_=_»
     ...
     (Algebra.BigOperators.Basic.«term∏_in_,_»
      ...
      ", "
      (Term.app `f [(Init.Logic.«term_+_» `m "+" `k)])))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group (Tactic.byCases' "by_cases'" [`h ":"] («term_≤_» `m "≤" `n)) [])
       (group
        (Tactic.«tactic·._»
         "·"
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group
             (Tactic.rwSeq
              ...
              (Tactic.rwRuleSeq
               "["
               [(Tactic.rwRule ["←"] `Nat.Ico_zero_eq_range)
                ","
                (Tactic.rwRule [] `prod_Ico_add)
                ","
           ...
           [(group
            ...
            (group
             (Tactic.rwSeq
              ...
              (Tactic.rwRuleSeq
               "["
               [(Tactic.rwRule [] (Term.app `Ico_eq_empty_of_le [`h]))
                ","
                (Tactic.rwRule [] (Term.app `tsub_eq_zero_iff_le.mpr [`h]))
                ","
                (Tactic.rwRule [] `range_zero)
                ","
    ...
    (Tactic.tacticSeq1Indented
     [(group
       (Tactic.replace
        "replace"
        (Term.haveDecl
         (Term.haveIdDecl [`h []] [(Term.typeSpec ":" («term_≤_» `n "≤" `m))] ":=" (Term.app `le_of_not_geₓ [`h]))))
       [])
      (group
       (Tactic.rwSeq
        "rw"
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `tsub_eq_zero_iff_le.mpr [`h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.byCases' "by_cases'" [`h ":"] («term_≤_» `m "≤" `n))
...
@[ to_additive ]
  theorem
    ...
    ( f : ℕ → β ) ( m n : ℕ ) : ∏ k in Ico m n , f k = ∏ k in range n - m , f m + k
    :=
      by
        by_cases' h : m ≤ n
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `prod_Ico_reflect [])
  (Command.declSig
   [(Term.explicitBinder "(" [`f] [":" (Term.arrow (termℕ "ℕ") "→" `β)] [] ")")
    (Term.explicitBinder "(" [`k] [":" (termℕ "ℕ")] [] ")")
    (Term.implicitBinder "{" [`m `n] [":" (termℕ "ℕ")] "}")
    (Term.explicitBinder "(" [`h] [":" («term_≤_» `m "≤" (Init.Logic.«term_+_» `n "+" (numLit "1")))] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Algebra.BigOperators.Basic.«term∏_in_,_»
     ...
     (Algebra.BigOperators.Basic.«term∏_in_,_»
      ...
      (Term.app
       `Ico
       [(«term_-_» (Init.Logic.«term_+_» `n "+" (numLit "1")) "-" `m)
              ...
              [(group (Tactic.intro "intro" [`i `hi]) [])
               (group
                (Tactic.exact
                 "exact"
                 (Term.app
                  (Term.proj (Term.app `add_le_add_iff_right [(numLit "1")]) "." (fieldIdx "1"))
                  [(Term.app `le_transₓ [(Term.app (Term.proj `Nat.lt_iff_add_one_le "." (fieldIdx "1")) [`hi]) `h])]))
                [])]))))))
        [])
       (group
        (Tactic.cases'
         "cases'"
         [(Tactic.casesTarget [] (Term.app `lt_or_leₓ [`k `m]))]
         []
         ["with" [(Lean.binderIdent `hkm) (Lean.binderIdent `hkm)]])
        [])
       (group
        (Tactic.«tactic·._»
         "·"
           ...
           [(group
             (Tactic.rwSeq
              ...
              (Tactic.rwRuleSeq
               ...
               [(Tactic.rwRule
                 ["←"]
                 (Term.app `Nat.Ico_image_const_sub_eq_Ico [(Term.app `this [(Term.hole "_") `hkm])]))]
               "]")
              [])
             [])
            (group (Tactic.refine' "refine'" (Term.proj (Term.app `prod_image [(Term.hole "_")]) "." `symm)) [])
            (group (Tactic.simp "simp" [] ["only"] ["[" [(Tactic.simpLemma [] [] `mem_Ico)] "]"] []) [])
            (group
             (Tactic.rintro
              "rintro"
              [(Tactic.rintroPat.one (Tactic.rcasesPat.one `i))
               (Tactic.rintroPat.one
                (Tactic.rcasesPat.tuple
                 "⟨"
                 [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `ki)]) [])
                  ","
                  (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `im)]) [])]
                 "⟩"))
               (Tactic.rintroPat.one (Tactic.rcasesPat.one `j))
               (Tactic.rintroPat.one
                (Tactic.rcasesPat.tuple
                 "⟨"
                 [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `kj)]) [])
                  ","
                  (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `jm)]) [])]
                 "⟩"))
            ...
            (group
             (Tactic.rwSeq
              ...
              (Tactic.rwRuleSeq
               "["
               [(Tactic.rwRule ["←"] (Term.app `tsub_tsub_cancel_of_le [(Term.app `this [(Term.hole "_") `im])]))
                ","
                (Tactic.rwRule [] `Hij)
                ","
                (Tactic.rwRule [] (Term.app `tsub_tsub_cancel_of_le [(Term.app `this [(Term.hole "_") `jm])]))]
               "]")
              [])
             [])])))
        [])
          ...
          (Tactic.tacticSeq1Indented
           [(group
             (Tactic.simp
              ...
              []
              ["["
               [(Tactic.simpLemma [] [] `Ico_eq_empty_of_le)
                ","
                (Tactic.simpLemma [] [] `tsub_le_tsub_left)
                ","
                (Tactic.simpLemma [] [] `hkm)]
               "]"]
              [])
             [])])))
        [])])))
    ...
    (Tactic.tacticSeq1Indented
     [(group
       (Tactic.rwSeq
        ...
        (Tactic.rwRuleSeq
         "["
         [(Tactic.rwRule ["←"] (Term.app `Nat.Ico_image_const_sub_eq_Ico [(Term.app `this [(Term.hole "_") `hkm])]))]
         "]")
        [])
       [])
      (group (Tactic.refine' "refine'" (Term.proj (Term.app `prod_image [(Term.hole "_")]) "." `symm)) [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `tsub_tsub_cancel_of_le [(Term.app `this [(Term.hole "_") `jm])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `this [(Term.hole "_") `jm]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `tsub_tsub_cancel_of_le [(Term.app `this [(Term.hole "_") `im])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `this [(Term.hole "_") `im]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `tsub_tsub_cancel_of_le
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.simp "simp" [] ["only"] ["[" [(Tactic.simpLemma [] [] `mem_Ico)] "]"] [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simp', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«]»', expected 'optional.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simpLemma', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simpLemma', expected 'Lean.Parser.Tactic.simpStar'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.refine' "refine'" (Term.proj (Term.app `prod_image [(Term.hole "_")]) "." `symm))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.refine'', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Term.app `prod_image [(Term.hole "_")]) "." `symm)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `prod_image [(Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `prod_image [(Term.hole "_")]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `this [(Term.hole "_") `hkm]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app (Term.proj `Nat.lt_iff_add_one_le "." (fieldIdx "1")) [`hi])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(Term.app
   `le_transₓ
   [(Term.paren "(" [(Term.app (Term.proj `Nat.lt_iff_add_one_le "." (fieldIdx "1")) [`hi]) []] ")") `h])
  []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `add_le_add_iff_right [(numLit "1")]) "." (fieldIdx "1"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `add_le_add_iff_right [(numLit "1")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `add_le_add_iff_right [(numLit "1")]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(«term_-_» (Term.paren "(" [(Init.Logic.«term_+_» `n "+" (numLit "1")) []] ")") "-" `m) []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `Ico
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
  ...
  :=
    by
      have
          : ∀ , ∀ i < m , ∀ , i ≤ n
            :=
            by intro i hi exact add_le_add_iff_right 1 . 1 le_transₓ Nat.lt_iff_add_one_le . 1 hi h
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `sum_Ico_reflect [])
  (Command.declSig
   [(Term.implicitBinder "{" [`δ] [":" (Term.type "Type" [(Level.hole "_")])] "}")
    (Term.instBinder "[" [] (Term.app `AddCommMonoidₓ [`δ]) "]")
    (Term.explicitBinder "(" [`f] [":" (Term.arrow (termℕ "ℕ") "→" `δ)] [] ")")
  ...
  (Command.declValSimple
   ":="
   (Term.app (Term.explicit "@" `prod_Ico_reflect) [(Term.app `Multiplicative [`δ]) (Term.hole "_") `f `k `m `n `h])
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (some 1023, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Multiplicative [`δ]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.explicit "@" `prod_Ico_reflect)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.explicit', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.explicit', expected 'Lean.Parser.Term.explicit.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `prod_Ico_reflect
...
theorem
  sum_Ico_reflect
  { δ : Type _ } [ AddCommMonoidₓ δ ] ( f : ℕ → δ ) ( k : ℕ ) { m n : ℕ } ( h : m ≤ n + 1 )
    : ∑ j in Ico k m , f n - j = ∑ j in Ico n + 1 - m n + 1 - k , f j
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `prod_range_reflect [])
  (Command.declSig
   [(Term.explicitBinder "(" [`f] [":" (Term.arrow (termℕ "ℕ") "→" `β)] [] ")")
   ...
   (Term.typeSpec
    ...
    («term_=_»
     (Algebra.BigOperators.Basic.«term∏_in_,_»
      ...
      (Term.app `range [`n])
      ", "
      (Term.app `f [(«term_-_» («term_-_» `n "-" (numLit "1")) "-" `j)]))
     "="
     (Algebra.BigOperators.Basic.«term∏_in_,_»
      "∏"
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `j)] []))
          ...
          (Tactic.tacticSeq1Indented
           [(group
             (Tactic.simp
              ...
              ["only"]
              ["["
               [(Tactic.simpLemma [] ["←"] `Nat.Ico_zero_eq_range)
                ","
            ...
            (group
             (Tactic.rwSeq
              ...
              (Tactic.rwRuleSeq
               "["
               [(Tactic.rwRule [] (Term.app `prod_Ico_reflect [(Term.hole "_") (Term.hole "_") `le_rfl]))]
               "]")
              [])
             [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `prod_Ico_reflect [(Term.hole "_") (Term.hole "_") `le_rfl])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
theorem
  prod_range_reflect
  ( f : ℕ → β ) ( n : ℕ ) : ∏ j in range n , f n - 1 - j = ∏ j in range n , f j
  :=
    by
      cases n
        · simp
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `sum_range_reflect [])
  (Command.declSig
   [(Term.implicitBinder "{" [`δ] [":" (Term.type "Type" [(Level.hole "_")])] "}")
    (Term.instBinder "[" [] (Term.app `AddCommMonoidₓ [`δ]) "]")
    (Term.explicitBinder "(" [`f] [":" (Term.arrow (termℕ "ℕ") "→" `δ)] [] ")")
  ...
  (Command.declValSimple
   ":="
   (Term.app (Term.explicit "@" `prod_range_reflect) [(Term.app `Multiplicative [`δ]) (Term.hole "_") `f `n])
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Multiplicative [`δ]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.explicit "@" `prod_range_reflect)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.explicit', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.explicit', expected 'Lean.Parser.Term.explicit.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `prod_range_reflect
...
theorem
  sum_range_reflect
  { δ : Type _ } [ AddCommMonoidₓ δ ] ( f : ℕ → δ ) ( n : ℕ ) : ∑ j in range n , f n - 1 - j = ∑ j in range n , f j
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `prod_Ico_id_eq_factorial [])
  (Command.declSig
   []
   (Term.typeSpec
    ":"
          ...
          [(group
            (Tactic.rwSeq
             ...
             (Tactic.rwRuleSeq
              ...
              [(Tactic.rwRule
                []
                («term_$__» `prod_Ico_succ_top "$" («term_$__» `Nat.succ_le_succₓ "$" (Term.app `zero_le [`n]))))
               ","
               (Tactic.rwRule [] `Nat.factorial_succ)
               ","
               (Tactic.rwRule [] (Term.app `prod_Ico_id_eq_factorial [`n]))
               ","
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.rwSeq
   ...
   (Tactic.rwRuleSeq
    "["
    [(Tactic.rwRule [] («term_$__» `prod_Ico_succ_top "$" («term_$__» `Nat.succ_le_succₓ "$" (Term.app `zero_le [`n]))))
     ","
     (Tactic.rwRule [] `Nat.factorial_succ)
     ","
     (Tactic.rwRule [] (Term.app `prod_Ico_id_eq_factorial [`n]))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `prod_Ico_id_eq_factorial [`n])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_$__» `Nat.succ_le_succₓ "$" (Term.app `zero_le [`n]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `zero_le [`n])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 51 >? 10000, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 50, term))
  (Algebra.BigOperators.Basic.«term∏_in_,_»
   "∏"
   (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `x)] []))
    ...
    | 0 => rfl
      |
        ...
        by
          rw
            [
              prod_Ico_succ_top $ Nat.succ_le_succₓ $ zero_le n
                ,
                Nat.factorial_succ
                ,
                prod_Ico_id_eq_factorial n
                ,
                Nat.succ_eq_add_one
                ,
                mul_commₓ
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `prod_range_add_one_eq_factorial [])
  (Command.declSig
   []
   (Term.typeSpec
    ":"
         ...
         (Tactic.tacticSeq1Indented
          [(group
            (Tactic.simp
             ...
             []
             ["["
              [(Tactic.simpLemma [] [] `Finset.range_succ)
               ","
               (Tactic.simpLemma [] [] (Term.app `prod_range_add_one_eq_factorial [`n]))]
              "]"]
             [])
            [])]))))])
    []))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simpLemma', expected 'Lean.Parser.Tactic.simpErase'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `prod_range_add_one_eq_factorial [`n])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
@[ simp ]
  theorem
    prod_range_add_one_eq_factorial
    : ∀ n : ℕ , ∏ x in range n , x + 1 = n !
    | 0 => rfl | n + 1 => by simp [ Finset.range_succ , prod_range_add_one_eq_factorial n ]

section GaussSum

/- failed to parenthesize: parenthesize: uncaught backtrack exception
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers [(Command.docComment "/--" " Gauss' summation formula -/")] [] [] [] [] [])
 (Command.theorem
  "theorem"
  (Command.declId `sum_range_id_mul_two [])
  (Command.declSig
   [(Term.explicitBinder "(" [`n] [":" (termℕ "ℕ")] [] ")")]
   (Term.typeSpec
    ":"
           ...
           (Tactic.rwSeq
            ...
            (Tactic.rwRuleSeq
             ...
             [(Tactic.rwRule
               ...
               (Term.app
                `sum_range_reflect
                [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`i] [])] "=>" `i)) `n]))
              ","
              (Tactic.rwRule [] `mul_two)]
             "]")
            [])
           [])]))))
     (calcStep
      («term_=_»
       ...
       (Algebra.BigOperators.Basic.«term∑_in_,_»
        ...
        (Term.app `range [`n])
        ", "
        (Init.Logic.«term_+_» `i "+" («term_-_» («term_-_» `n "-" (numLit "1")) "-" `i))))
      ":="
      (Term.proj `sum_add_distrib "." `symm))
     (calcStep
      («term_=_»
       (Term.hole "_")
       "="
       ...
       (Term.fun
        ...
        (Term.basicFun
         ...
         («term_$__»
          ...
          "$"
          («term_$__» `Nat.le_pred_of_lt "$" (Term.app (Term.proj `mem_range "." (fieldIdx "1")) [`hi])))))))
     (calcStep
      («term_=_» (Term.hole "_") "=" (Finset.Data.Finset.Fold.«term_*_» `n "*" («term_-_» `n "-" (numLit "1"))))
      ":="
      (Term.byTactic
       "by"
       (Tactic.tacticSeq
        (Tactic.tacticSeq1Indented
         [(group
           (Tactic.rwSeq
            ...
            (Tactic.rwRuleSeq
             "["
             [(Tactic.rwRule [] `sum_const) "," (Tactic.rwRule [] `card_range) "," (Tactic.rwRule [] `Nat.nsmul_eq_mul)]
             "]")
            [])
           [])]))))])
   [])
        ...
        [(group
          (Tactic.rwSeq
           ...
           (Tactic.rwRuleSeq
            ...
            [(Tactic.rwRule
              []
              (Term.app `sum_range_reflect [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`i] [])] "=>" `i)) `n]))
             ","
             (Tactic.rwRule [] `mul_two)]
            "]")
           [])
   ...
   (Term.typeSpec
    ...
    («term_=_»
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      ...
      `i)
     "="
     («term_/_» (Finset.Data.Finset.Fold.«term_*_» `n "*" («term_-_» `n "-" (numLit "1"))) "/" (numLit "2")))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
      ...
      [(group
        (Tactic.«tactic_<;>_»
         (Tactic.rwSeq
          ...
          (Tactic.rwRuleSeq
           "["
           [(Tactic.rwRule ["←"] (Term.app `sum_range_id_mul_two [`n])) "," (Tactic.rwRule [] `Nat.mul_div_cancelₓ)]
           "]")
          [])
         "<;>"
         (Tactic.exact
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `sum_range_id_mul_two [`n])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
/-- Gauss' summation formula -/
  theorem
    sum_range_id
    ( n : ℕ ) : ∑ i in range n , i = n * n - 1 / 2
    := by rw [ ← sum_range_id_mul_two n , Nat.mul_div_cancelₓ ] <;> exact by decide
