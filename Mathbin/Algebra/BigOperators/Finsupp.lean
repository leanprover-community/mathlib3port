...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `Finset.sum_apply' [])
  (Command.declSig
   []
   (Term.typeSpec
    ":"
  ...
  (Command.declValSimple
   ...
   (Term.app
    (Term.proj
     (Term.paren
      "("
      [(Term.app `Finsupp.applyAddHom [`i])
       [(Term.typeAscription
         ":"
         (Algebra.Group.Hom.«term_→+_» (Data.Finsupp.Basic.«term_→₀_» `ι " →₀ " `A) " →+ " `A))]]
      ")")
     "."
     `map_sum)
    [`f `s])
  ...
  (Term.app
   (Term.proj
    (Term.paren
     "("
     [(Term.app `Finsupp.applyAddHom [`i])
      [(Term.typeAscription ":" (Algebra.Group.Hom.«term_→+_» (Data.Finsupp.Basic.«term_→₀_» `ι " →₀ " `A) " →+ " `A))]]
     ")")
    "."
    `map_sum)
   [`f `s])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 25, term))
  (Data.Finsupp.Basic.«term_→₀_» `ι " →₀ " `A)
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Data.Finsupp.Basic.«term_→₀_» `ι " →₀ " `A) []] ")")
...
theorem Finset.sum_apply' : ∑ k in s , f k i = ∑ k in s , f k i := ( Finsupp.applyAddHom i : ι →₀ A →+ A ) . map_sum f s
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `Finsupp.sum_sum_index' [])
  (Command.declSig
   []
   (Term.typeSpec
    ":"
    («term_=_»
     ...
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      ...
      `s
      ", "
      (Term.app (Term.proj (Term.app `f [`x]) "." `Sum) [`t])))))
  (Command.declValSimple
   ":="
   («term_$__»
           ...
           (Tactic.simpRw
            ...
            (Tactic.rwRuleSeq
             ...
             [(Tactic.rwRule [] (Term.app `Finset.sum_insert [`has]))
              ","
              (Tactic.rwRule [] (Term.app `Finsupp.sum_add_index [`h0 `h1]))
              ","
              (Tactic.rwRule [] `ih)]
             "]")
            [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Finsupp.sum_add_index [`h0 `h1])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
theorem
  ...
  : ∑ x in s , f x . Sum t = ∑ x in s , f x . Sum t
  :=
    Finset.induction_on s rfl
      $
      fun a s has ih => by simp_rw [ Finset.sum_insert has , Finsupp.sum_add_index h0 h1 , ih ]
