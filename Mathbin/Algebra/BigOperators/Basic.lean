...
but is expected to have type
  forall {β : Type.{u1}} {α : Type.{u2}} [_inst_1 : CommMonoid.{u1} β] (s : Finset.{u2} α) (p : α -> Prop) [_inst_2 : DecidablePred.{succ u2} α p] [_inst_3 : DecidablePred.{succ u2} α (fun (x : α) => Not (p x))] (f : α -> β), Eq.{succ u1} β (HMul.hMul.{u1, u1, u1} β β β (instHMul.{u1} β (MulOneClass.toMul.{u1} β (Monoid.toMulOneClass.{u1} β (CommMonoid.toMonoid.{u1} β _inst_1)))) (Finset.prod.{u1, u2} β α _inst_1 (Finset.filter.{u2} α (fun (a : α) => Decidable.decide (p a) ((fun (a : α) => _inst_2 a) a)) s) (fun (x : α) => f x)) (Finset.prod.{u1, u2} β α _inst_1 (Finset.filter.{u2} α (fun (a : α) => Decidable.decide (Not (p a)) (_inst_3 a)) s) (fun (x : α) => f x))) (Finset.prod.{u1, u2} β α _inst_1 s (fun (x : α) => f x))
...
but is expected to have type
  forall {β : Type.{u1}} {α : Type.{u2}} {s : Finset.{u2} α} {f : α -> β} [_inst_1 : CommMonoid.{u1} β] {p : α -> Prop} [_inst_2 : DecidablePred.{succ u2} α p], (forall (x : α), (Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x s) -> (Ne.{succ u1} β (f x) (OfNat.ofNat.{u1} β 1 (One.toOfNat1.{u1} β (Monoid.toOne.{u1} β (CommMonoid.toMonoid.{u1} β _inst_1))))) -> (p x)) -> (Eq.{succ u1} β (Finset.prod.{u1, u2} β α _inst_1 (Finset.filter.{u2} α (fun (a : α) => Decidable.decide (p a) ((fun (a : α) => _inst_2 a) a)) s) (fun (x : α) => f x)) (Finset.prod.{u1, u2} β α _inst_1 s (fun (x : α) => f x)))
...
but is expected to have type
  forall {β : Type.{u1}} {α : Type.{u2}} {γ : Type.{u3}} [_inst_1 : CommMonoid.{u1} β] {s : Finset.{u2} α} {p : α -> Prop} {hp : DecidablePred.{succ u2} α p} [_inst_2 : DecidablePred.{succ u2} α (fun (x : α) => Not (p x))] (f : forall (x : α), (p x) -> γ) (g : forall (x : α), (Not (p x)) -> γ) (h : γ -> β), Eq.{succ u1} β (Finset.prod.{u1, u2} β α _inst_1 s (fun (x : α) => h (dite.{succ u3} γ (p x) (hp x) (fun (hx : p x) => f x hx) (fun (hx : Not (p x)) => g x hx)))) (HMul.hMul.{u1, u1, u1} β β β (instHMul.{u1} β (MulOneClass.toMul.{u1} β (Monoid.toMulOneClass.{u1} β (CommMonoid.toMonoid.{u1} β _inst_1)))) (Finset.prod.{u1, u2} β (Subtype.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (a : α) => Decidable.decide (p a) ((fun (a : α) => hp a) a)) s))) _inst_1 (Finset.attach.{u2} α (Finset.filter.{u2} α (fun (a : α) => Decidable.decide (p a) ((fun (a : α) => hp a) a)) s)) (fun (x : Subtype.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (a : α) => Decidable.decide (p a) ((fun (a : α) => hp a) a)) s))) => h (f (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (a : α) => Decidable.decide (p a) ((fun (a : α) => hp a) a)) s)) x) (id.{0} (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (a : α) => Decidable.decide (p a) ((fun (a : α) => hp a) a)) s)) x)) (Eq.mp.{0} (Eq.{1} Bool (Decidable.decide (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (b : α) => Decidable.decide (p b) (hp b)) s)) x)) ((fun (a : α) => hp a) (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (b : α) => Decidable.decide (p b) ((fun (a : α) => hp a) b)) s)) x))) Bool.true) (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (b : α) => Decidable.decide (p b) (hp b)) s)) x)) (decide_eq_true_eq (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (b : α) => Decidable.decide (p b) (hp b)) s)) x)) ((fun (a : α) => hp a) (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (b : α) => Decidable.decide (p b) ((fun (a : α) => hp a) b)) s)) x))) (And.right (Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (b : α) => Decidable.decide (p b) ((fun (a : α) => hp a) b)) s)) x) s) (Eq.{1} Bool (Decidable.decide (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (b : α) => Decidable.decide (p b) ((fun (a : α) => hp a) b)) s)) x)) ((fun (a : α) => hp a) (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (b : α) => Decidable.decide (p b) ((fun (a : α) => hp a) b)) s)) x))) Bool.true) (Iff.mp (Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (b : α) => Decidable.decide (p b) ((fun (a : α) => hp a) b)) s)) x) (Finset.filter.{u2} α (fun (b : α) => Decidable.decide (p b) ((fun (a : α) => hp a) b)) s)) (And (Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (b : α) => Decidable.decide (p b) ((fun (a : α) => hp a) b)) s)) x) s) (Eq.{1} Bool (Decidable.decide (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (b : α) => Decidable.decide (p b) ((fun (a : α) => hp a) b)) s)) x)) ((fun (a : α) => hp a) (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (b : α) => Decidable.decide (p b) ((fun (a : α) => hp a) b)) s)) x))) Bool.true)) (Finset.mem_filter.{u2} α (fun (b : α) => Decidable.decide (p b) ((fun (a : α) => hp a) b)) s (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (b : α) => Decidable.decide (p b) ((fun (a : α) => hp a) b)) s)) x)) (Subtype.property.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (b : α) => Decidable.decide (p b) ((fun (a : α) => hp a) b)) s)) x)))))))) (Finset.prod.{u1, u2} β (Subtype.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (a : α) => Decidable.decide (Not (p a)) (_inst_2 a)) s))) _inst_1 (Finset.attach.{u2} α (Finset.filter.{u2} α (fun (a : α) => Decidable.decide (Not (p a)) (_inst_2 a)) s)) (fun (x : Subtype.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (a : α) => Decidable.decide (Not (p a)) (_inst_2 a)) s))) => h (g (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (a : α) => Decidable.decide (Not (p a)) (_inst_2 a)) s)) x) (Eq.mp.{0} (Eq.{1} Bool (Decidable.decide (Not (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (_inst_2 x)) s)) x))) (_inst_2 (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (_inst_2 x)) s)) x))) Bool.true) (Not (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (_inst_2 x)) s)) x))) (decide_eq_true_eq (Not (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (_inst_2 x)) s)) x))) (_inst_2 (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (a : α) => Decidable.decide (Not (p a)) (_inst_2 a)) s)) x))) (And.right (Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (_inst_2 x)) s)) x) s) (Eq.{1} Bool (Decidable.decide (Not (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (_inst_2 x)) s)) x))) (_inst_2 (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (_inst_2 x)) s)) x))) Bool.true) (Iff.mp (Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (_inst_2 x)) s)) x) (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (_inst_2 x)) s)) (And (Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (_inst_2 x)) s)) x) s) (Eq.{1} Bool (Decidable.decide (Not (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (_inst_2 x)) s)) x))) (_inst_2 (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (_inst_2 x)) s)) x))) Bool.true)) (Finset.mem_filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (_inst_2 x)) s (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (_inst_2 x)) s)) x)) (Subtype.property.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (_inst_2 x)) s)) x))))))))
...
but is expected to have type
  forall {β : Type.{u1}} {α : Type.{u2}} [_inst_1 : CommMonoid.{u1} β] {s : Finset.{u2} α} {p : α -> Prop} {hp : DecidablePred.{succ u2} α p} (f : forall (x : α), (p x) -> β) (g : forall (x : α), (Not (p x)) -> β), Eq.{succ u1} β (Finset.prod.{u1, u2} β α _inst_1 s (fun (x : α) => dite.{succ u1} β (p x) (hp x) (fun (hx : p x) => f x hx) (fun (hx : Not (p x)) => g x hx))) (HMul.hMul.{u1, u1, u1} β β β (instHMul.{u1} β (MulOneClass.toMul.{u1} β (Monoid.toMulOneClass.{u1} β (CommMonoid.toMonoid.{u1} β _inst_1)))) (Finset.prod.{u1, u2} β (Subtype.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (a : α) => Decidable.decide (p a) ((fun (a : α) => hp a) a)) s))) _inst_1 (Finset.attach.{u2} α (Finset.filter.{u2} α (fun (a : α) => Decidable.decide (p a) ((fun (a : α) => hp a) a)) s)) (fun (x : Subtype.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (a : α) => Decidable.decide (p a) ((fun (a : α) => hp a) a)) s))) => f (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (a : α) => Decidable.decide (p a) ((fun (a : α) => hp a) a)) s)) x) (id.{0} (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (a : α) => Decidable.decide (p a) ((fun (a : α) => hp a) a)) s)) x)) (Eq.mp.{0} (Eq.{1} Bool (Decidable.decide (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (b : α) => Decidable.decide (p b) (hp b)) s)) x)) ((fun (a : α) => hp a) (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (b : α) => Decidable.decide (p b) ((fun (a : α) => hp a) b)) s)) x))) Bool.true) (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (b : α) => Decidable.decide (p b) (hp b)) s)) x)) (decide_eq_true_eq (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (b : α) => Decidable.decide (p b) (hp b)) s)) x)) ((fun (a : α) => hp a) (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (b : α) => Decidable.decide (p b) ((fun (a : α) => hp a) b)) s)) x))) (And.right (Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (b : α) => Decidable.decide (p b) ((fun (a : α) => hp a) b)) s)) x) s) (Eq.{1} Bool (Decidable.decide (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (b : α) => Decidable.decide (p b) ((fun (a : α) => hp a) b)) s)) x)) ((fun (a : α) => hp a) (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (b : α) => Decidable.decide (p b) ((fun (a : α) => hp a) b)) s)) x))) Bool.true) (Iff.mp (Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (b : α) => Decidable.decide (p b) ((fun (a : α) => hp a) b)) s)) x) (Finset.filter.{u2} α (fun (b : α) => Decidable.decide (p b) ((fun (a : α) => hp a) b)) s)) (And (Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (b : α) => Decidable.decide (p b) ((fun (a : α) => hp a) b)) s)) x) s) (Eq.{1} Bool (Decidable.decide (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (b : α) => Decidable.decide (p b) ((fun (a : α) => hp a) b)) s)) x)) ((fun (a : α) => hp a) (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (b : α) => Decidable.decide (p b) ((fun (a : α) => hp a) b)) s)) x))) Bool.true)) (Finset.mem_filter.{u2} α (fun (b : α) => Decidable.decide (p b) ((fun (a : α) => hp a) b)) s (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (b : α) => Decidable.decide (p b) ((fun (a : α) => hp a) b)) s)) x)) (Subtype.property.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (b : α) => Decidable.decide (p b) ((fun (a : α) => hp a) b)) s)) x))))))) (Finset.prod.{u1, u2} β (Subtype.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (a : α) => Decidable.decide (Not (p a)) (instDecidableNot (p a) (hp a))) s))) _inst_1 (Finset.attach.{u2} α (Finset.filter.{u2} α (fun (a : α) => Decidable.decide (Not (p a)) (instDecidableNot (p a) (hp a))) s)) (fun (x : Subtype.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (a : α) => Decidable.decide (Not (p a)) (instDecidableNot (p a) (hp a))) s))) => g (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (a : α) => Decidable.decide (Not (p a)) (instDecidableNot (p a) (hp a))) s)) x) (Eq.mp.{0} (Eq.{1} Bool (Decidable.decide (Not (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x))) (instDecidableNot (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x)) (hp (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x)))) Bool.true) (Not (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x))) (Eq.trans.{1} Prop (Eq.{1} Bool (Decidable.decide (Not (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x))) (instDecidableNot (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x)) (hp (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x)))) Bool.true) (Eq.{1} Bool (Decidable.decide (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x)) (hp (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x))) Bool.false) (Not (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x))) (Eq.trans.{1} Prop (Eq.{1} Bool (Decidable.decide (Not (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x))) (instDecidableNot (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x)) (hp (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x)))) Bool.true) (Eq.{1} Bool (not (Decidable.decide (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x)) (hp (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x)))) Bool.true) (Eq.{1} Bool (Decidable.decide (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x)) (hp (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x))) Bool.false) (congrFun.{1, 1} Bool (fun (a._@.Init.Prelude._hyg.170 : Bool) => Prop) (Eq.{1} Bool (Decidable.decide (Not (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x))) (instDecidableNot (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x)) (hp (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x))))) (Eq.{1} Bool (not (Decidable.decide (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x)) (hp (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x))))) (congrArg.{1, 1} Bool (Bool -> Prop) (Decidable.decide (Not (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x))) (instDecidableNot (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x)) (hp (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x)))) (not (Decidable.decide (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x)) (hp (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x)))) (Eq.{1} Bool) (decide_not (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x)) (hp (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x)))) Bool.true) (Bool.not_eq_true' (Decidable.decide (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x)) (hp (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x))))) (Std.Logic._auxLemma.54 (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x)) (hp (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x)))) (And.right (Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x) s) (Eq.{1} Bool (Decidable.decide (Not (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x))) (instDecidableNot (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x)) (hp (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x)))) Bool.true) (Iff.mp (Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x) (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) (And (Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x) s) (Eq.{1} Bool (Decidable.decide (Not (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x))) (instDecidableNot (p (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x)) (hp (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x)))) Bool.true)) (Finset.mem_filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s (Subtype.val.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x)) (Subtype.property.{succ u2} α (fun (x : α) => Membership.mem.{u2, u2} α (Finset.{u2} α) (Finset.instMembershipFinset.{u2} α) x (Finset.filter.{u2} α (fun (x : α) => Decidable.decide (Not (p x)) (instDecidableNot (p x) (hp x))) s)) x)))))))
...
but is expected to have type
  forall {β : Type.{u1}} {α : Type.{u2}} {s : Finset.{u2} α} {p : α -> Prop} [_inst_1 : NonAssocSemiring.{u1} β] {hp : DecidablePred.{succ u2} α p}, Eq.{succ u1} β (Finset.sum.{u1, u2} β α (NonUnitalNonAssocSemiring.toAddCommMonoid.{u1} β (NonAssocSemiring.toNonUnitalNonAssocSemiring.{u1} β _inst_1)) s (fun (x : α) => ite.{succ u1} β (p x) (hp x) (OfNat.ofNat.{u1} β 1 (One.toOfNat1.{u1} β (NonAssocSemiring.toOne.{u1} β _inst_1))) (OfNat.ofNat.{u1} β 0 (Zero.toOfNat0.{u1} β (MulZeroOneClass.toZero.{u1} β (NonAssocSemiring.toMulZeroOneClass.{u1} β _inst_1)))))) (Nat.cast.{u1} β (NonAssocSemiring.toNatCast.{u1} β _inst_1) (Finset.card.{u2} α (Finset.filter.{u2} α (fun (a : α) => Decidable.decide (p a) ((fun (a : α) => hp a) a)) s)))
