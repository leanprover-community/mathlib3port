...
@[to_additive]
theorem prod_eq_multiset_prod [CommMonoid β] (s : Finset α) (f : α → β) : (∏ x in s, f x) = (s.1.map f).Prod :=
  rfl
#align finset.prod_eq_multiset_prod Finset.prod_eq_multiset_prod

@[to_additive]
theorem prod_eq_fold [CommMonoid β] (s : Finset α) (f : α → β) : (∏ x in s, f x) = s.fold (· * ·) 1 f :=
  rfl
...
@[to_additive]
theorem map_prod [CommMonoid β] [CommMonoid γ] {G : Type _} [MonoidHomClass G β γ] (g : G) (f : α → β) (s : Finset α) :
...
protected theorem MonoidHom.map_prod [CommMonoid β] [CommMonoid γ] (g : β →* γ) (f : α → β) (s : Finset α) :
...
/-- Deprecated: use `_root_.map_prod` instead. -/
@[to_additive "Deprecated: use `_root_.map_sum` instead."]
protected theorem MulEquiv.map_prod [CommMonoid β] [CommMonoid γ] (g : β ≃* γ) (f : α → β) (s : Finset α) :
    g (∏ x in s, f x) = ∏ x in s, g (f x) :=
  map_prod g f s
...
protected theorem RingHom.map_list_sum [NonAssocSemiring β] [NonAssocSemiring γ] (f : β →+* γ) (l : List β) :
    f l.Sum = (l.map f).Sum :=
  map_list_sum f l
...
-/
protected theorem RingHom.unop_map_list_prod [Semiring β] [Semiring γ] (f : β →+* γᵐᵒᵖ) (l : List β) :
...
protected theorem RingHom.map_multiset_prod [CommSemiring β] [CommSemiring γ] (f : β →+* γ) (s : Multiset β) :
...
protected theorem RingHom.map_multiset_sum [NonAssocSemiring β] [NonAssocSemiring γ] (f : β →+* γ) (s : Multiset β) :
    f s.Sum = (s.map f).Sum :=
  map_multiset_sum f s
#align ring_hom.map_multiset_sum RingHom.map_multiset_sum

/-- Deprecated: use `_root_.map_prod` instead. -/
protected theorem RingHom.map_prod [CommSemiring β] [CommSemiring γ] (g : β →+* γ) (f : α → β) (s : Finset α) :
    g (∏ x in s, f x) = ∏ x in s, g (f x) :=
  map_prod g f s
#align ring_hom.map_prod RingHom.map_prod

/-- Deprecated: use `_root_.map_sum` instead. -/
protected theorem RingHom.map_sum [NonAssocSemiring β] [NonAssocSemiring γ] (g : β →+* γ) (f : α → β) (s : Finset α) :
    g (∑ x in s, f x) = ∑ x in s, g (f x) :=
  map_sum g f s
...
@[simp, to_additive]
theorem MonoidHom.finset_prod_apply [MulOneClass β] [CommMonoid γ] (f : α → β →* γ) (s : Finset α) (b : β) :
...
theorem prod_disj_Union (s : Finset ι) (t : ι → Finset α) (h) :
    (∏ x in s.disjUnion t h, f x) = ∏ i in s, ∏ x in t i, f x := by
  refine' Eq.trans _ (fold_disj_Union h)
...
@[to_additive]
theorem _root_.equiv.perm.prod_comp (σ : Equiv.Perm α) (s : Finset α) (f : α → β) (hs : { a | σ a ≠ a } ⊆ s) :
    (∏ x in s, f (σ x)) = ∏ x in s, f x := by
  convert (Prod_map _ σ.to_embedding _).symm
  exact (map_perm hs).symm
#align finset._root_.equiv.perm.prod_comp finset._root_.equiv.perm.prod_comp

@[to_additive]
theorem _root_.equiv.perm.prod_comp' (σ : Equiv.Perm α) (s : Finset α) (f : α → α → β) (hs : { a | σ a ≠ a } ⊆ s) :
      ...
      (Command.declSig
       [(Term.implicitBinder "{" [`σ] [":" (Term.arrow `α "→" (Term.type "Type" [(Level.hole "_")]))] "}")
        ...
        (Term.explicitBinder
         "("
         [`t]
         [":" (Term.forall "∀" [`a] [] "," (Term.app `Finset [(Term.app `σ [`a])]))]
         []
         ")")
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Tactic.exact "exact" (Term.app `h [(Term.app `congr_arg [`Sigma.fst `hz'.symm])]))
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `h [(Term.app `congr_arg [`Sigma.fst `hz'.symm])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `congr_arg [`Sigma.fst `hz'.symm])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `hz'.symm
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `congr_arg [`Sigma.fst `hz'.symm]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      `h
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
      ...
      (Std.Tactic.rintro
       ...
       [(Std.Tactic.RCases.rintroPat.one (Std.Tactic.RCases.rcasesPat.ignore "_"))
        (Std.Tactic.RCases.rintroPat.one
         (Std.Tactic.RCases.rcasesPat.tuple
          "⟨"
          [(Std.Tactic.RCases.rcasesPatLo (Std.Tactic.RCases.rcasesPatMed [(Std.Tactic.RCases.rcasesPat.one `y)]) [])
           ","
           (Std.Tactic.RCases.rcasesPatLo (Std.Tactic.RCases.rcasesPatMed [(Std.Tactic.RCases.rcasesPat.one `hy)]) [])
           ","
           (Std.Tactic.RCases.rcasesPatLo (Std.Tactic.RCases.rcasesPatMed [(Std.Tactic.RCases.rcasesPat.one `rfl)]) [])]
          "⟩"))
        (Std.Tactic.RCases.rintroPat.one
         (Std.Tactic.RCases.rcasesPat.tuple
          "⟨"
          [(Std.Tactic.RCases.rcasesPatLo (Std.Tactic.RCases.rcasesPatMed [(Std.Tactic.RCases.rcasesPat.one `z)]) [])
           ","
           (Std.Tactic.RCases.rcasesPatLo (Std.Tactic.RCases.rcasesPatMed [(Std.Tactic.RCases.rcasesPat.one `hz)]) [])
           ","
           (Std.Tactic.RCases.rcasesPatLo (Std.Tactic.RCases.rcasesPatMed [(Std.Tactic.RCases.rcasesPat.one `hz')]) [])]
          "⟩"))]
       [])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Mathlib.Tactic.tacticSimp_rw__
       ...
       [])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `Function.Embedding.sigma_mk_apply
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `mem_map
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `Function.Embedding.sigmaMk [`a])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `a
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Function.Embedding.sigmaMk [`a]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      (Term.proj (Term.app `t [`a]) "." `map)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      (Term.app `t [`a])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
...
/--
  ...
  theorem
    prod_sigma
    { σ : α → Type _ } ( s : Finset α ) ( t : ∀ a , Finset σ a ) ( f : Sigma σ → β )
    ...
    :=
      by
        skip
          <;>
          calc
            ∏ x in s.sigma t , f x = ∏ x in s.bUnion fun a => t a . map Function.Embedding.sigmaMk a , f x
              :=
              by rw [ sigma_eq_bUnion ]
...
theorem prod_comm' {s : Finset γ} {t : γ → Finset α} {t' : Finset α} {s' : α → Finset γ}
  ...
  classical have :
      ∀ z : γ × α, (z ∈ s.bUnion fun x => (t x).map <| Function.Embedding.sectr x _) ↔ z.1 ∈ s ∧ z.2 ∈ t z.1 :=
...
theorem prod_filter_of_ne {p : α → Prop} [DecidablePred p] (hp : ∀ x ∈ s, f x ≠ 1 → p x) :
  ...
  (prod_subset (filter_subset _ _)) fun x => by classical rw [not_imp_comm, mem_filter]
...
theorem prod_ite_mem [DecidableEq α] (s t : Finset α) (f : α → β) :
    (∏ i in s, if i ∈ t then f i else 1) = ∏ i in s ∩ t, f i := by rw [← Finset.prod_filter, Finset.filter_mem_eq_inter]
...
@[simp]
theorem sum_pi_single' {ι M : Type _} [DecidableEq ι] [AddCommMonoid M] (i : ι) (x : M) (s : Finset ι) :
    (∑ j in s, Pi.single i x j) = if i ∈ s then x else 0 :=
  sum_dite_eq' _ _ _
#align finset.sum_pi_single' Finset.sum_pi_single'

@[simp]
theorem sum_pi_single {ι : Type _} {M : ι → Type _} [DecidableEq ι] [∀ i, AddCommMonoid (M i)] (i : ι) (f : ∀ i, M i)
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `prod_bij_ne_one [])
      (Command.declSig
       [(Term.implicitBinder "{" [`s] [":" (Term.app `Finset [`α])] "}")
        (Term.implicitBinder "{" [`t] [":" (Term.app `Finset [`γ])] "}")
                 ...
                 [(Term.fun
                   ...
                   (Term.basicFun
                    ...
                    (Term.app
                     `i
                     [`a
                      (Term.proj (Term.app `mem_filter.mp [`ha]) "." (fieldIdx "1"))
                      (Term.proj (Term.app `mem_filter.mp [`ha]) "." (fieldIdx "2"))])))
                  (Term.fun
                   "fun"
                   (Term.basicFun
                    [`a `ha]
...
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `mem_filter.mpr [(Term.anonymousCtor "⟨" [`ha₁ "," `ha₂] "⟩")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
     ...
     [(Term.fun
       ...
       (Term.basicFun
        ...
        (Term.app
         `i
         [`a
          (Term.proj (Term.paren "(" [(Term.app `mem_filter.mp [`ha]) []] ")") "." (fieldIdx "1"))
          (Term.proj (Term.paren "(" [(Term.app `mem_filter.mp [`ha]) []] ")") "." (fieldIdx "2"))])))
      []]
     ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      `prod_bij
                        ...
                        b hb
                          ...
                          mem_filter.mp hb . elim
                            fun
                              h₁ h₂
                                =>
                                let ⟨ a , ha₁ , ha₂ , Eq ⟩ := i_surj b h₁ h₂ ⟨ a , mem_filter.mpr ⟨ ha₁ , ha₂ ⟩ , Eq ⟩
...
theorem exists_ne_one_of_prod_ne_one (h : (∏ x in s, f x) ≠ 1) : ∃ a ∈ s, f a ≠ 1 := by
  classical rw [← prod_filter_ne_one] at h
...
@[to_additive]
theorem prod_list_count [DecidableEq α] [CommMonoid α] (s : List α) : s.Prod = ∏ m in s.toFinset, m ^ s.count m := by
  simpa using prod_list_map_count s id
#align finset.prod_list_count Finset.prod_list_count

@[to_additive]
theorem prod_list_count_of_subset [DecidableEq α] [CommMonoid α] (m : List α) (s : Finset α) (hs : m.toFinset ⊆ s) :
...
theorem prod_range_div {M : Type _} [CommGroup M] (f : ℕ → M) (n : ℕ) : (∏ i in range n, f (i + 1) / f i) = f n / f 0 :=
...
#align finset._root_.fintype.prod_eq_mul_prod_compl finset._root_.fintype.prod_eq_mul_prod_compl

@[to_additive]
theorem _root_.fintype.prod_eq_prod_compl_mul [DecidableEq α] [Fintype α] (a : α) (f : α → β) :
    (∏ i, f i) = (∏ i in {a}ᶜ, f i) * f a :=
  prod_eq_prod_diff_singleton_mul (mem_univ a) f
#align finset._root_.fintype.prod_eq_prod_compl_mul finset._root_.fintype.prod_eq_prod_compl_mul

theorem dvd_prod_of_mem (f : α → β) {a : α} {s : Finset α} (ha : a ∈ s) : f a ∣ ∏ i in s, f i := by
  classical rw [Finset.prod_eq_mul_prod_diff_singleton ha]
...
theorem prod_add_prod_eq [CommSemiring β] {s : Finset α} {i : α} {f g h : α → β} (hi : i ∈ s) (h1 : g i + h i = f i)
  ...
  classical simp_rw [prod_eq_mul_prod_diff_singleton hi, ← h1, right_distrib]
...
@[simp]
theorem op_sum [AddCommMonoid β] {s : Finset α} (f : α → β) : op (∑ x in s, f x) = ∑ x in s, op (f x) :=
  (opAddEquiv : β ≃+ βᵐᵒᵖ).map_sum _ _
#align finset.op_sum Finset.op_sum

@[simp]
theorem unop_sum [AddCommMonoid β] {s : Finset α} (f : α → βᵐᵒᵖ) : unop (∑ x in s, f x) = ∑ x in s, unop (f x) :=
...
@[simp]
theorem card_disj_Union (s : Finset α) (t : α → Finset β) (h) : (s.disjUnion t h).card = s.Sum fun i => (t i).card :=
...
theorem mem_sum {f : α → Multiset β} (s : Finset α) (b : β) : (b ∈ ∑ x in s, f x) ↔ ∃ a ∈ s, b ∈ f a := by
  classical refine' s.induction_on (by simp) _
...
theorem prod_unique_nonempty {α β : Type _} [CommMonoid β] [Unique α] (s : Finset α) (f : α → β) (h : s.Nonempty) :
    (∏ x in s, f x) = f default := by rw [h.eq_singleton_default, Finset.prod_singleton]
...
theorem prod_equiv {α β M : Type _} [Fintype α] [Fintype β] [CommMonoid M] (e : α ≃ β) (f : α → M) (g : β → M)
...
@[to_additive]
theorem prod_unique {α β : Type _} [CommMonoid β] [Unique α] (f : α → β) : (∏ x : α, f x) = f default := by
...
theorem prod_subtype_mul_prod_subtype {α β : Type _} [Fintype α] [CommMonoid β] (p : α → Prop) (f : α → β)
  ...
  classical let s := { x | p x }.toFinset
...
/- ./././Mathport/Syntax/Translate/Basic.lean:610:2: warning: expanding binder collection (x «expr ∈ » i) -/
/- ./././Mathport/Syntax/Translate/Basic.lean:610:2: warning: expanding binder collection (x y «expr ∈ » i) -/
...
theorem to_finset_prod_dvd_prod [CommMonoid α] (S : Multiset α) : S.toFinset.Prod id ∣ S.Prod := by
...
theorem prod_sum {α : Type _} {ι : Type _} [CommMonoid α] (f : ι → Multiset α) (s : Finset ι) :
  ...
  classical induction' s using Finset.induction_on with a t hat ih
...
@[simp, norm_cast]
theorem cast_prod [CommSemiring β] (f : α → ℕ) (s : Finset α) : (↑(∏ i in s, f i) : β) = ∏ i in s, f i :=
...
@[simp, norm_cast]
theorem cast_prod {R : Type _} [CommRing R] (f : α → ℤ) (s : Finset α) : (↑(∏ i in s, f i) : R) = ∏ i in s, f i :=
