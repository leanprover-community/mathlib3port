               ...
               (Tactic.tacticSeq
                (Tactic.tacticSeq1Indented
                 [(Tactic.rwSeq
                   "rw"
                   []
                   (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `sigma_eq_bUnion)] "]")
                   [])]))))
             [(calcStep
               («term_=_»
                (Term.hole "_")
                       ...
                       [(Mathlib.Tactic.tacticSimp_rw__
                         ...
                         (Tactic.rwRuleSeq
                          ...
                          [(Tactic.rwRule [] `mem_map)
                           ","
                           (Tactic.rwRule [] `Function.Embedding.sigma_mk_apply)]
                          "]")
                         [])
                        []
                        (Std.Tactic.rintro
               ...
               («term_=_»
                ...
                (BigOperators.Algebra.BigOperators.Basic.finset.prod
                 ...
                 (BigOperators.Algebra.BigOperators.Basic.finset.prod
                  "∏"
                  (Std.ExtendedBinder.extBinders
                   (Std.ExtendedBinder.extBinder (Lean.binderIdent `s) []))
                  " in "
                  (Term.app `t [`a])
                  ", "
                  (Term.app `f [(Term.anonymousCtor "⟨" [`a "," `s] "⟩")]))))
      ...
      by
        skip
          ...
          calc
            ∏ x in s.sigma t , f x
                =
                ∏ x in s.bUnion fun a => t a . map Function.Embedding.sigmaMk a , f x
              :=
                ...
                («term_=_»
                 ...
                 (BigOperators.Algebra.BigOperators.Basic.finset.prod
                  ...
                  (Term.app
                   ...
                   [(Term.fun
                     "fun"
                     (Term.basicFun [`x] [] "=>" («term_≠_» (Term.app `g [`x]) "≠" (num "1"))))])
                  ", "
                  (Term.app `g [`x])))
                ":="
                (Term.app
              ...
              [(Term.app `hi [`a `h₁ `h₂])
               ...
               (Term.fun
                ...
                (Term.basicFun
                 ...
                 (Term.app
                  `h₂
                  [(Term.paren "(" (Term.subst `hg "▸" [(Term.app `h [`a `h₁ `h₂])]) ")")])))]
              "⟩")])))])))
     ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.ellipsis'
