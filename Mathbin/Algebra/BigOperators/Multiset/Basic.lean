...
theorem prod_erase [DecidableEq α] (h : a ∈ s) : a * (s.erase a).prod = s.prod := by
  rw [← s.coe_to_list, coe_erase, coe_prod, coe_prod, List.prod_erase (mem_toList.2 h)]
