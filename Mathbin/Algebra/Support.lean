...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " `support` of a function is the set of points `x` such that `f x ≠ 0`. -/")]
  []
  []
  []
  []
 ...
 (Command.def
  "def"
  (Command.declId `support [])
  (Command.optDeclSig
   [(Term.instBinder "[" [] (Term.app `HasZero [`A]) "]")
    (Term.explicitBinder "(" [`f] [":" (Term.arrow `α "→" `A)] [] ")")]
   [(Term.typeSpec ":" (Term.app `Set [`α]))])
  (Command.declValSimple ":=" (Set.«term{_|_}» "{" `x "|" («term_≠_» (Term.app `f [`x]) "≠" (numLit "0")) "}") [])
  []
  []
  []))
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " `mul_support` of a function is the set of points `x` such that `f x ≠ 1`. -/")]
 ...
 (Command.def
  "def"
  (Command.declId `mul_support [])
  (Command.optDeclSig
   [(Term.explicitBinder "(" [`f] [":" (Term.arrow `α "→" `M)] [] ")")]
   [(Term.typeSpec ":" (Term.app `Set [`α]))])
  (Command.declValSimple ":=" (Set.«term{_|_}» "{" `x "|" («term_≠_» (Term.app `f [`x]) "≠" (numLit "1")) "}") [])
  []
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Set.«term{_|_}» "{" `x "|" («term_≠_» (Term.app `f [`x]) "≠" (numLit "1")) "}")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Set.«term{_|_}»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.def', expected 'Lean.Parser.Command.structure.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.def', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
/-- `mul_support` of a function is the set of points `x` such that `f x ≠ 1`. -/ @[ to_additive ]
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `compl_mul_support [])
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.arrow `α "→" `M)] "}")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Order.BooleanAlgebra.«term_ᶜ» (Term.app `mul_support [`f]) "ᶜ")
     "="
     (Set.«term{_|_}» "{" `x "|" («term_=_» (Term.app `f [`x]) "=" (numLit "1")) "}"))))
  (Command.declValSimple
   ":="
   («term_$__» `ext "$" (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`x] [])] "=>" `nmem_mul_support)))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`x] [])] "=>" `nmem_mul_support))
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `mul_support_supr [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `ConditionallyCompleteLattice [`M]) "]")
    (Term.instBinder "[" [] (Term.app `Nonempty [`ι]) "]")
    (Term.explicitBinder "(" [`f] [":" (Term.arrow `ι "→" (Term.arrow `α "→" `M))] [] ")")]
   (Term.typeSpec
    ":"
    (Init.Core.«term_⊆_»
     (Term.app
     ...
     (Set.Data.Set.Lattice.«term⋃_,_»
      ...
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
      ", "
      (Term.app `mul_support [(Term.app `f [`i])])))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `mul_support_subset_iff')] "]") []) [])
       (group
        (Tactic.simp
         "simp"
         []
         ...
         ["["
          [(Tactic.simpLemma [] [] `mem_Union)
           ...
           ","
           (Tactic.simpLemma [] [] `nmem_mul_support)]
          "]"]
         [])
        [])
       ...
       (group
        (Tactic.simp
         ...
         []
         ["only"]
         ["[" [(Tactic.simpLemma [] [] `hx) "," (Tactic.simpLemma [] [] `csupr_const)] "]"]
         [])
        [])])))
   [])
  []
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.simp "simp" [] ["only"] ["[" [(Tactic.simpLemma [] [] `hx) "," (Tactic.simpLemma [] [] `csupr_const)] "]"] [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `mul_support_subset_iff')] "]") [])
...
@[ to_additive ]
  theorem
    mul_support_supr
    [ ConditionallyCompleteLattice M ] [ Nonempty ι ] ( f : ι → α → M )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `mul_support_infi [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `ConditionallyCompleteLattice [`M]) "]")
    (Term.instBinder "[" [] (Term.app `Nonempty [`ι]) "]")
    (Term.explicitBinder "(" [`f] [":" (Term.arrow `ι "→" (Term.arrow `α "→" `M))] [] ")")]
  ...
  (Command.declValSimple
   ":="
   (Term.app
    (Term.explicit "@" `mul_support_supr)
    [(Term.hole "_")
     (Term.app `OrderDual [`M])
     `ι
     (Term.anonymousCtor "⟨" [(Term.paren "(" [(numLit "1") [(Term.typeAscription ":" `M)]] ")")] "⟩")
     (Term.hole "_")
     (Term.hole "_")
     `f])
   [])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.paren "(" [(numLit "1") [(Term.typeAscription ":" `M)]] ")")
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `mul_support_prod [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `CommMonoidₓ [`M]) "]")
    (Term.explicitBinder "(" [`s] [":" (Term.app `Finset [`α])] [] ")")
    (Term.explicitBinder "(" [`f] [":" (Term.arrow `α "→" (Term.arrow `β "→" `M))] [] ")")]
   (Term.typeSpec
    ":"
    (Init.Core.«term_⊆_»
     (Term.app
     ...
     (Tactic.tacticSeq1Indented
      [(group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `mul_support_subset_iff')] "]") []) [])
       (group
        ...
        [])
       (group
        (Tactic.exact "exact" (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`x] [])] "=>" `Finset.prod_eq_one)))
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`x] [])] "=>" `Finset.prod_eq_one))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.fun.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.basicFun.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
@[ to_additive ]
  theorem
    mul_support_prod
    [ CommMonoidₓ M ] ( s : Finset α ) ( f : α → β → M )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `support_prod_subset [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `CommMonoidWithZero [`A]) "]")
    (Term.explicitBinder "(" [`s] [":" (Term.app `Finset [`α])] [] ")")
    (Term.explicitBinder "(" [`f] [":" (Term.arrow `α "→" (Term.arrow `β "→" `A))] [] ")")]
   (Term.typeSpec
    ":"
    (Init.Core.«term_⊆_»
     (Term.app
    ...
    (Term.basicFun
     ...
     («term_$__»
      ...
      (Term.fun
       "fun"
       (Term.basicFun
        [(Term.simpleBinder [`i `hi `H] [])]
        "=>"
        («term_$__» `hx "$" (Term.app `Finset.prod_eq_zero [`hi `H])))))))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Finset.prod_eq_zero [`hi `H])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
theorem
  support_prod_subset
  [ CommMonoidWithZero A ] ( s : Finset α ) ( f : α → β → A )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `support_prod [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `CommMonoidWithZero [`A]) "]")
    (Term.instBinder "[" [] (Term.app `NoZeroDivisors [`A]) "]")
...
theorem
  support_prod
  [ CommMonoidWithZero A ] [ NoZeroDivisors A ] [ Nontrivial A ] ( s : Finset α ) ( f : α → β → A )
    : support fun x => ∏ i in s , f i x = ⋂ ( i : _ ) ( _ : i ∈ s ) , support f i
  :=
    Set.ext
      $
      fun x => by simp only [ support , Ne.def , Finset.prod_eq_zero_iff , mem_set_of_eq , Set.mem_Inter , not_exists ]
