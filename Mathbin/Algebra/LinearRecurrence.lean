...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `is_solution [])
  (Command.optDeclSig [(Term.explicitBinder "(" [`u] [":" (Term.arrow (termℕ "ℕ") "→" `α)] [] ")")] [])
  (Command.declValSimple
   ...
   (Term.forall
    ...
    ","
    («term_=_»
     (Term.app `u [(Init.Logic.«term_+_» `n "+" `E.order)])
     "="
     (Algebra.BigOperators.Basic.«term∑_,_»
      ...
      (Finset.Data.Finset.Fold.«term_*_»
       (Term.app `E.coeffs [`i])
       "*"
       (Term.app `u [(Init.Logic.«term_+_» `n "+" `i)])))))
   [])
  []
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_=_»
   ...
   (Algebra.BigOperators.Basic.«term∑_,_»
    ...
    (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
    ", "
    (Finset.Data.Finset.Fold.«term_*_» (Term.app `E.coeffs [`i]) "*" (Term.app `u [(Init.Logic.«term_+_» `n "+" `i)]))))
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Init.Logic.«term_+_» `n "+" `i) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `u
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
/--
    We say that a sequence `u` is solution of `linear_recurrence order coeffs` when we have
      `u (n + order) = ∑ i : fin order, coeffs i * u (n + i)` for any `n`. -/
  def is_solution ( u : ℕ → α ) := ∀ n , u n + E.order = ∑ i , E.coeffs i * u n + i
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `mk_sol [])
  (Command.optDeclSig
   [(Term.explicitBinder "(" [`init] [":" (Term.arrow (Term.app `Finₓ [`E.order]) "→" `α)] [] ")")]
   [(Term.typeSpec ":" (Term.arrow (termℕ "ℕ") "→" `α))])
  (Command.declValEqns
    ...
    (Term.matchAlts
     [(Term.matchAlt
       ...
       (termDepIfThenElse
        ...
        («term_<_» `n "<" `E.order)
        "then"
        (Term.app `init [(Term.anonymousCtor "⟨" [`n "," `h] "⟩")])
        "else"
        (Algebra.BigOperators.Basic.«term∑_,_»
         "∑"
         (Lean.explicitBinders
          (Lean.unbracketedExplicitBinders [(Lean.binderIdent `k)] [":" (Term.app `Finₓ [`E.order])]))
         ", "
         (Term.have
          "have"
          (Term.haveDecl
           (Term.haveIdDecl
            []
            [(Term.typeSpec ":" («term_<_» (Init.Logic.«term_+_» («term_-_» `n "-" `E.order) "+" `k) "<" `n))]
            ":="
            (Term.byTactic
             "by"
             (Tactic.tacticSeq
                 ...
                 (Tactic.rwSeq
                  ...
                  (Tactic.rwRuleSeq
                   ...
                   [(Tactic.rwRule [] `add_commₓ)
                    ","
                    (Tactic.rwRule ["←"] (Term.app `add_tsub_assoc_of_le [(Term.app `not_lt.mp [`h])]))
                    ","
                    (Tactic.rwRule [] `tsub_lt_iff_left)]
                   "]")
                  [])
                 [])
                (group
                 (Tactic.«tactic·._»
                  ...
                  (Tactic.tacticSeq
                   (Tactic.tacticSeq1Indented
                    [(group (Tactic.exact "exact" (Term.app `add_lt_add_right [`k.is_lt `n])) [])])))
                 [])
                (group
                 (Tactic.«tactic·._»
                  "·"
                   ...
                   (Tactic.tacticSeq1Indented
                    [(group
                      (Tactic.convert
                       ...
                       (Term.app
                        `add_le_add
                        [(Term.app `zero_le [(Term.paren "(" [`k [(Term.typeAscription ":" (termℕ "ℕ"))]] ")")])
                         (Term.app `not_lt.mp [`h])])
                       [])
                      [])
                     (group (Tactic.simp "simp" [] ["only"] ["[" [(Tactic.simpLemma [] [] `zero_addₓ)] "]"] []) [])])))
                 [])])))))
          []
          (Finset.Data.Finset.Fold.«term_*_»
           (Term.app `E.coeffs [`k])
           "*"
           (Term.app `mk_sol [(Init.Logic.«term_+_» («term_-_» `n "-" `E.order) "+" `k)]))))))])
    []))
  []
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (termDepIfThenElse
   ...
   (Algebra.BigOperators.Basic.«term∑_,_»
    "∑"
    (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `k)] [":" (Term.app `Finₓ [`E.order])]))
    ", "
    (Term.have
     "have"
     (Term.haveDecl
        ...
        [(group
         ...
         (group
          (Tactic.«tactic·._»
           "·"
           (Tactic.tacticSeq
            (Tactic.tacticSeq1Indented [(group (Tactic.exact "exact" (Term.app `add_lt_add_right [`k.is_lt `n])) [])])))
          [])
         (group
          (Tactic.«tactic·._»
           "·"
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Logic.«term_+_»', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Init.Logic.«term_+_» («term_-_» `n "-" `E.order) "+" `k)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Logic.«term_+_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `k
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(«term_-_» `n "-" `E.order) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 0, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Init.Logic.«term_+_» (Term.paren "(" [(«term_-_» `n "-" `E.order) []] ")") "+" `k) []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `mk_sol
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.simp "simp" [] ["only"] ["[" [(Tactic.simpLemma [] [] `zero_addₓ)] "]"] [])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app
   `add_le_add
   [(Term.app `zero_le [(Term.paren "(" [`k [(Term.typeAscription ":" (termℕ "ℕ"))]] ")")]) (Term.app `not_lt.mp [`h])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `add_lt_add_right [`k.is_lt `n]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `add_lt_add_right [`k.is_lt `n])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `add_tsub_assoc_of_le [(Term.app `not_lt.mp [`h])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_<_» (Init.Logic.«term_+_» («term_-_» `n "-" `E.order) "+" `k) "<" `n)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_<_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `n
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
            ...
            : n - E.order + k < n
              ...
              by
                rw [ add_commₓ , ← add_tsub_assoc_of_le not_lt.mp h , tsub_lt_iff_left ]
                  ...
                  · convert add_le_add zero_le ( k : ℕ ) not_lt.mp h simp only [ zero_addₓ ]
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " The space of solutions of `E`, as a `submodule` over `α` of the module `ℕ → α`. -/")]
  []
  []
  []
  []
 ...
 (Command.def
  "def"
  (Command.declId `sol_space [])
  (Command.optDeclSig [] [(Term.typeSpec ":" (Term.app `Submodule [`α (Term.arrow (termℕ "ℕ") "→" `α)]))])
  (Command.declValSimple
   ":="
   (Term.structInst
    "{"
    ...
    [(group
      (Term.structInstField
       ...
       ":="
       (Set.«term{_|_}» "{" `u "|" (Term.app `E.is_solution [`u]) "}"))
      [","])
     (group
      (Term.structInstField
              ...
              (Tactic.simp
               ...
               ["["
                [(Tactic.simpLemma [] [] `mul_addₓ)
                 ...
                 ","
                 (Tactic.simpLemma [] [] (Term.app `hu [`n]))
                 ","
                 (Tactic.simpLemma [] [] (Term.app `hv [`n]))]
                "]"]
               [])
              [])]))))))
      [","])
            ...
            [(group
              (Tactic.«tactic_<;>_»
               (Tactic.simp
                ...
                []
                []
                ["[" [(Tactic.simpLemma [] [] (Term.app `hu [`n])) "," (Tactic.simpLemma [] [] `mul_sum)] "]"]
                [])
               "<;>"
               (Tactic.«tactic_<;>_»
                (Tactic.congr "congr" [] [])
                "<;>"
                (Tactic.«tactic_<;>_» (Tactic.ext "ext" [] []) "<;>" (Tactic.acRfl "ac_rfl"))))
              [])]))))))
      [])]
    (Term.optEllipsis [])
    []
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `tuple_succ [])
  (Command.optDeclSig
   []
   [(Term.typeSpec
     ":"
     (Algebra.Module.LinearMap.«term_→ₗ[_]_»
      (Term.arrow (Term.app `Finₓ [`E.order]) "→" `α)
      " →ₗ["
      `α
      "] "
      (Term.arrow (Term.app `Finₓ [`E.order]) "→" `α)))])
       ...
       (Term.fun
        ...
        (Term.basicFun
         ...
         (termDepIfThenElse
          ...
          ":"
          («term_<_»
           (Init.Logic.«term_+_» (Term.paren "(" [`i [(Term.typeAscription ":" (termℕ "ℕ"))]] ")") "+" (numLit "1"))
           "<"
           `E.order)
          "then"
          (Term.app `X [(Term.anonymousCtor "⟨" [(Init.Logic.«term_+_» `i "+" (numLit "1")) "," `h] "⟩")])
          "else"
          (Algebra.BigOperators.Basic.«term∑_,_»
           "∑"
           (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
           ", "
           (Finset.Data.Finset.Fold.«term_*_» (Term.app `E.coeffs [`i]) "*" (Term.app `X [`i])))))))
      [","])
     (group
      (Term.structInstField
             ...
             (group
              (Tactic.«tactic_<;>_»
               ...
               (Tactic.simp
                ...
                []
                []
                ["[" [(Tactic.simpLemma [] [] `h) "," (Tactic.simpLemma [] [] `mul_sum)] "]"]
                []))
              [])
             (group
              (Tactic.exact
                ...
                [`rfl
                 (Term.fun
                  ...
                  (Term.basicFun
                   ...
                   (Term.byTactic
                    "by"
                    (Tactic.tacticSeq (Tactic.tacticSeq1Indented [(group (Tactic.acRfl "ac_rfl") [])])))))]))
              [])]))))))
      [])]
    (Term.optEllipsis [])
    []
       ...
       [(group (Tactic.ext "ext" [(Tactic.rcasesPat.one `i)] []) [])
        (group
         (Tactic.«tactic_<;>_»
          (Tactic.splitIfs "split_ifs" [] [])
          "<;>"
          (Tactic.simp "simp" [] [] ["[" [(Tactic.simpLemma [] [] `h) "," (Tactic.simpLemma [] [] `mul_sum)] "]"] []))
         [])
        (group
         (Tactic.exact
          "exact"
    ...
    [`rfl
     (Term.fun
      ...
      (Term.basicFun
       [(Term.simpleBinder [`x (Term.hole "_")] [])]
       "=>"
       (Term.byTactic "by" (Tactic.tacticSeq (Tactic.tacticSeq1Indented [(group (Tactic.acRfl "ac_rfl") [])])))))]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app
   `sum_congr
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.«tactic_<;>_»
   ...
   (Tactic.simp
    ...
    []
    ["["
     [(Tactic.simpLemma [] [] `h) "," (Tactic.simpLemma [] [] `mul_addₓ) "," (Tactic.simpLemma [] [] `sum_add_distrib)]
     "]"]
    []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.«tactic_<;>_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
/--
  ...
  def
    tuple_succ
    : Finₓ E.order → α →ₗ[ α ] Finₓ E.order → α
    :=
      {
        toFun := fun X i => if h : ( i : ℕ ) + 1 < E.order then X ⟨ i + 1 , h ⟩ else ∑ i , E.coeffs i * X i ,
          map_add' := fun x y => by ext i split_ifs <;> simp [ h , mul_addₓ , sum_add_distrib ] ,
          map_smul' := fun x y => by ext i split_ifs <;> simp [ h , mul_sum ] exact sum_congr rfl fun x _ => by ac_rfl
        }
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `char_poly [])
  (Command.optDeclSig [] [(Term.typeSpec ":" (Term.app `Polynomial [`α]))])
  (Command.declValSimple
   ":="
   («term_-_»
    (Term.app `Polynomial.monomial [`E.order (numLit "1")])
    "-"
    (Algebra.BigOperators.Basic.«term∑_,_»
     "∑"
     (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] [":" (Term.app `Finₓ [`E.order])]))
     ", "
     (Term.app `Polynomial.monomial [`i (Term.app `E.coeffs [`i])])))
   [])
  []
  []
  []))
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `E.coeffs [`i]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
/--
    The characteristic polynomial of `E` is
    `X ^ E.order - ∑ i : fin E.order, (E.coeffs i) * X ^ i`. -/
  def char_poly : Polynomial α := Polynomial.monomial E.order 1 - ∑ i : Finₓ E.order , Polynomial.monomial i E.coeffs i
