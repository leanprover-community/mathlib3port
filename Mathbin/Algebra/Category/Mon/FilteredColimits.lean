 ...
 (Command.abbrev
  ...
  (Command.declValSimple
   ...
   (Term.app
    ...
    [(Term.app
      `types.quot.rel
      [(CategoryTheory.Functor.CategoryTheory.Functor.«term_⋙_» `F " ⋙ " (Term.app `forget [`Mon]))])])
   [])))
...
/-- The canonical projection into the colimit, as a quotient type. -/
  ...
  abbrev M.mk : Σ j , F.obj j → M := Quot.mk types.quot.rel F ⋙ forget Mon
  ...
  (Command.declValSimple
   ...
   (Term.app
    ...
    [(Term.app
      ...
      [(CategoryTheory.Functor.CategoryTheory.Functor.«term_⋙_» `F " ⋙ " (Term.app `forget [`Mon])) `x `y `h])])
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `colimit_mul_aux [])
  (Command.optDeclSig
   [(Term.explicitBinder
     "("
     [`x `y]
    ...
    [(Term.anonymousCtor
      ...
      [(Term.app `max' [(Term.proj `x "." (fieldIdx "1")) (Term.proj `y "." (fieldIdx "1"))])
       ...
       (Finset.Data.Finset.Fold.«term_*_»
        (Term.app
         `F.map
         [(Term.app `left_to_max [(Term.proj `x "." (fieldIdx "1")) (Term.proj `y "." (fieldIdx "1"))])
          (Term.proj `x "." (fieldIdx "2"))])
        "*"
        (Term.app
         `F.map
         [(Term.app `right_to_max [(Term.proj `x "." (fieldIdx "1")) (Term.proj `y "." (fieldIdx "1"))])
          (Term.proj `y "." (fieldIdx "2"))]))]
      "⟩")])
   [])
  []
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " Multiplication in the colimit is well-defined in the left argument. -/")]
  [(Term.attributes
    "@["
    [(Term.attrInstance
      (Term.attrKind [])
      (Attr.toAdditive
       "to_additive"
       []
       [(strLit "\"Addition in the colimit is well-defined in the left argument.\"")]))]
    "]")]
  []
  []
  []
 ...
 (Command.theorem
  "theorem"
  (Command.declId `colimit_mul_aux_eq_of_rel_left [])
  (Command.declSig
   [(Term.implicitBinder
     "{"
     [`x `x' `y]
    ...
    (Term.explicitBinder
     ...
     [":"
      (Term.app
       ...
       [(CategoryTheory.Functor.CategoryTheory.Functor.«term_⋙_» `F " ⋙ " (Term.app `forget [`Mon])) `x `x'])]
     []
     ")")]
   (Term.typeSpec ":" («term_=_» (Term.app `colimit_mul_aux [`x `y]) "=" (Term.app `colimit_mul_aux [`x' `y]))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.cases' "cases'" [(Tactic.casesTarget [] `x)] [] ["with" [(Lean.binderIdent `j₁) (Lean.binderIdent `x)]])
        [])
       (group
        (Tactic.cases' "cases'" [(Tactic.casesTarget [] `y)] [] ["with" [(Lean.binderIdent `j₂) (Lean.binderIdent `y)]])
        [])
       (group
        (Tactic.cases'
         "cases'"
         ...
         []
         ["with" [(Lean.binderIdent `j₃) (Lean.binderIdent `x')]])
        [])
       (group
        (Tactic.obtain
         "obtain"
         ...
         [":=" [`hxx']])
        [])
       (group (Tactic.simp "simp" [] [] [] [(Tactic.location "at" (Tactic.locationHyp [`hfg] []))]) [])
       (group
        (Tactic.obtain
         "obtain"
         [(Tactic.rcasesPatMed
           [(Tactic.rcasesPat.tuple
             ...
             [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `s)]) [])
              ...
              ","
              (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `β)]) [])
              ","
              (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `γ)]) [])
              ","
         ...
         [":="
          [(Term.app
            `tulip
            [(Term.app `left_to_max [`j₁ `j₂])
             (Term.app `right_to_max [`j₁ `j₂])
             (Term.app `right_to_max [`j₃ `j₂])
             (Term.app `left_to_max [`j₃ `j₂])
             `f
             `g])]])
       ...
       (group
        (Tactic.simpRw
         ...
         (Tactic.rwRuleSeq
          "["
          [(Tactic.rwRule [] `MonoidHom.map_mul)
           ","
           (Tactic.rwRule ["←"] `comp_apply)
           ","
           (Tactic.rwRule ["←"] `F.map_comp)
           ","
           (Tactic.rwRule [] `h₁)
           ","
           (Tactic.rwRule [] `h₂)
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `left_to_max [`j₃ `j₂]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `right_to_max [`j₃ `j₂]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.simp "simp" [] [] [] [(Tactic.location "at" (Tactic.locationHyp [`hfg] []))])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, [anonymous]))
  («term_=_» (Term.app `colimit_mul_aux [`x `y]) "=" (Term.app `colimit_mul_aux [`x' `y]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_=_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `colimit_mul_aux [`x' `y])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
/-- Multiplication in the colimit is well-defined in the left argument. -/
  ...
  theorem
    ...
    { x x' y : Σ j , F.obj j } ( hxx' : types.filtered_colimit.rel F ⋙ forget Mon x x' )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " Multiplication in the colimit is well-defined in the right argument. -/")]
  [(Term.attributes
    "@["
    [(Term.attrInstance
      (Term.attrKind [])
      (Attr.toAdditive
       "to_additive"
       []
       [(strLit "\"Addition in the colimit is well-defined in the right argument.\"")]))]
    "]")]
  []
  []
  []
 ...
 (Command.theorem
  "theorem"
  (Command.declId `colimit_mul_aux_eq_of_rel_right [])
  (Command.declSig
   [(Term.implicitBinder
     "{"
     [`x `y `y']
    ...
    (Term.explicitBinder
     ...
     [":"
      (Term.app
       `types.filtered_colimit.rel
       [(CategoryTheory.Functor.CategoryTheory.Functor.«term_⋙_» `F " ⋙ " (Term.app `forget [`Mon])) `y `y'])]
     []
     ")")]
   (Term.typeSpec ":" («term_=_» (Term.app `colimit_mul_aux [`x `y]) "=" (Term.app `colimit_mul_aux [`x `y']))))
  (Command.declValSimple
      ...
      [(group
       ...
       (group
        (Tactic.cases'
         ...
         []
         ["with" [(Lean.binderIdent `j₃) (Lean.binderIdent `y')]])
        [])
       (group
        (Tactic.obtain
         "obtain"
...
/-- Multiplication in the colimit is well-defined in the right argument. -/
  ...
  theorem
    ...
    { x y y' : Σ j , F.obj j } ( hyy' : types.filtered_colimit.rel F ⋙ forget Mon y y' )
      : colimit_mul_aux x y = colimit_mul_aux x y'
    :=
      by
        cases' y with j₁ y
      ...
      mul
        ...
        by
          refine' Quot.lift₂ ( colimit_mul_aux F ) _ _ x y
            · intro x y y' h apply colimit_mul_aux_eq_of_rel_right apply types.filtered_colimit.rel_of_quot_rel exact h
            · intro x x' y h apply colimit_mul_aux_eq_of_rel_left apply types.filtered_colimit.rel_of_quot_rel exact h
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `colimit_mul_mk_eq [])
  (Command.declSig
   [(Term.explicitBinder
     "("
     [`x `y]
   ...
   (Term.typeSpec
    ":"
    («term_=_»
     (Finset.Data.Finset.Fold.«term_*_» (Term.app `M.mk [`x]) "*" (Term.app `M.mk [`y]))
     "="
     (Term.app
      `M.mk
      [(Term.anonymousCtor
        ...
        (Tactic.obtain
         ...
         [(Tactic.rcasesPatMed
           [(Tactic.rcasesPat.tuple
             ...
             "⟩")])]
         []
         [":=" [(Term.app `bowtie [(Term.app `left_to_max [`j₁ `j₂]) `f (Term.app `right_to_max [`j₁ `j₂]) `g])]])
        [])
       (group (Tactic.apply "apply" `M.mk_eq) [])
       (group (Tactic.use "use" [`s "," `α "," `β]) [])
       (group (Tactic.dsimp "dsimp" [] [] [] [] []) [])
       (group
        (Tactic.simpRw
         "simp_rw"
...
/--
  ...
  theorem
    colimit_mul_mk_eq
    ( x y : Σ j , F.obj j ) ( k : J ) ( f : x . 1 ⟶ k ) ( g : y . 1 ⟶ k )
...
@[ to_additive ]
  instance
    ...
    : preserves_filtered_colimits ( forget Mon )
    where
