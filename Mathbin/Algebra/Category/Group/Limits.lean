...
@[toAdditive]
instance group_obj (F : J ⥤ Groupₓₓ) j : Groupₓ ((F ⋙ forget Groupₓₓ).obj j) :=
  by 
...
-/
@[toAdditive "The flat sections of a functor into `AddGroup` form an additive subgroup of all sections."]
...
@[toAdditive]
instance limit_group (F : J ⥤ Groupₓₓ) : Groupₓ (types.limit_cone (F ⋙ forget Groupₓₓ.{u})).x :=
  by 
...
-/
@[toAdditive "A choice of limit cone for a functor into `Group`.\n(Generally, you'll just want to use `limit F`.)"]
...
-/
@[toAdditive "The chosen cone is a limit cone.\n(Generally, you'll just want to use `limit.cone F`.)"]
def limit_cone_is_limit (F : J ⥤ Groupₓₓ) : is_limit (limit_cone F) :=
  lifted_limit_is_limit _

/-- The category of groups has all limits. -/
@[toAdditive]
instance has_limits : has_limits Groupₓₓ :=
  { HasLimitsOfShape :=
      fun J 𝒥 =>
        by 
...
of monoids.)
-/
@[toAdditive AddGroupₓₓ.forget₂AddMonPreservesLimits]
instance forget₂_Mon_preserves_limits : preserves_limits (forget₂ Groupₓₓ Mon) :=
...
-/
@[toAdditive]
instance forget_preserves_limits : preserves_limits (forget Groupₓₓ) :=
  { PreservesLimitsOfShape :=
      fun J 𝒥 =>
        by 
...
@[toAdditive]
instance comm_group_obj (F : J ⥤ CommGroupₓₓ) j : CommGroupₓ ((F ⋙ forget CommGroupₓₓ).obj j) :=
  by 
...
(Generally, you'll just want to use `limit F`.)
-/
@[toAdditive "A choice of limit cone for a functor into `CommGroup`.\n(Generally, you'll just want to use `limit F`.)"]
...
@[toAdditive]
instance has_limits : has_limits CommGroupₓₓ :=
  { HasLimitsOfShape :=
      fun J 𝒥 =>
        by 
...
of groups.)
-/
@[toAdditive AddCommGroupₓₓ.forget₂AddGroupPreservesLimits]
instance forget₂_Group_preserves_limits : preserves_limits (forget₂ CommGroupₓₓ Groupₓₓ) :=
  { PreservesLimitsOfShape :=
      fun J 𝒥 =>
        { PreservesLimit :=
            fun F =>
...
-/
@[toAdditive AddCommGroupₓₓ.forget₂AddCommMonPreservesLimitsAux "An auxiliary declaration to speed up typechecking."]
...
-/
@[toAdditive AddCommGroupₓₓ.forget₂AddCommMonPreservesLimits]
instance forget₂_CommMon_preserves_limits : preserves_limits (forget₂ CommGroupₓₓ CommMon) :=
  { PreservesLimitsOfShape :=
      fun J 𝒥 =>
        by 
          exact
...
-/
@[toAdditive AddCommGroupₓₓ.forgetPreservesLimits]
instance forget_preserves_limits : preserves_limits (forget CommGroupₓₓ) :=
  { PreservesLimitsOfShape :=
      fun J 𝒥 =>
        by 
          exact
...
theorem kernel_iso_ker_inv_comp_ι {G H : AddCommGroupₓₓ} (f : G ⟶ H) :
  (kernel_iso_ker f).inv ≫ kernel.ι f = AddSubgroup.subtype f.ker :=
  by 
    ext 
    simp [kernel_iso_ker]
