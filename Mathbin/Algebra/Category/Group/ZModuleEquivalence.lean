...
instance forget₂_AddCommGroup_full : full (forget₂ (ModuleCat ℤ) AddCommGroupₓₓ.{u}) :=
  { Preimage :=
      fun A B f =>
...
instance forget₂_AddCommGroup_ess_surj : ess_surj (forget₂ (ModuleCat ℤ) AddCommGroupₓₓ.{u}) :=
