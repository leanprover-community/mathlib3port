...
/--
  ...
  instance
    ...
    : preserves_limits ( forget₂ ( AlgebraCat R ) Ringₓₓ .{ v } )
    where
                  ...
                  F
                    ...
                    preserves_limit_of_preserves_limit_cone
                      ( limit_cone_is_limit F )
                        ( by apply Ringₓₓ.limitConeIsLimit ( F ⋙ forget₂ ( AlgebraCat R ) Ringₓₓ ) )
              }
...
/--
    ...
    -/
  instance
    forget₂_Module_preserves_limits
    : preserves_limits ( forget₂ ( AlgebraCat R ) ( ModuleCat .{ v } R ) )
    where
      PreservesLimitsOfShape
        J 𝒥
        :=
                ...
                fun
                  F
                    ...
                    preserves_limit_of_preserves_limit_cone
                      ( limit_cone_is_limit F )
                        (
                          by apply ModuleCat.HasLimits.limitConeIsLimit ( F ⋙ forget₂ ( AlgebraCat R ) ( ModuleCat R ) )
                          )
              }
...
/--
  ...
  instance
    ...
    : preserves_limits ( forget ( AlgebraCat R ) )
    where
      PreservesLimitsOfShape
        J 𝒥
        :=
