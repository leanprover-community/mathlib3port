...
lean 3 declaration is
  forall (ι : Type.{u1}) [hi : Nonempty.{succ u1} ι] (R : Type.{u2}) [_inst_1 : CommRing.{u2} R] (p : Nat) [_inst_2 : CharP.{u2} R (AddGroupWithOne.toAddMonoidWithOne.{u2} R (AddCommGroupWithOne.toAddGroupWithOne.{u2} R (Ring.toAddCommGroupWithOne.{u2} R (CommRing.toRing.{u2} R _inst_1)))) p], CharP.{max u1 u2} (ι -> R) (Pi.addMonoidWithOne.{u1, u2} ι (fun (ᾰ : ι) => R) (fun (a : ι) => AddGroupWithOne.toAddMonoidWithOne.{u2} R (AddCommGroupWithOne.toAddGroupWithOne.{u2} R (Ring.toAddCommGroupWithOne.{u2} R (CommRing.toRing.{u2} R _inst_1))))) p
