...
lean 3 declaration is
  forall {M₀ : Type.{u1}} {M₀' : Type.{u2}} [_inst_1 : Zero.{u2} M₀'] [_inst_2 : Mul.{u2} M₀'] [_inst_3 : One.{u2} M₀'] [_inst_4 : Pow.{u2, 0} M₀' Nat] [_inst_5 : MonoidWithZero.{u1} M₀] (f : M₀' -> M₀), (Function.Injective.{succ u2, succ u1} M₀' M₀ f) -> (Eq.{succ u1} M₀ (f (OfNat.ofNat.{u2} M₀' 0 (OfNat.mk.{u2} M₀' 0 (Zero.zero.{u2} M₀' _inst_1)))) (OfNat.ofNat.{u1} M₀ 0 (OfNat.mk.{u1} M₀ 0 (Zero.zero.{u1} M₀ (MulZeroClass.toHasZero.{u1} M₀ (MulZeroOneClass.toMulZeroClass.{u1} M₀ (MonoidWithZero.toMulZeroOneClass.{u1} M₀ _inst_5))))))) -> (Eq.{succ u1} M₀ (f (OfNat.ofNat.{u2} M₀' 1 (OfNat.mk.{u2} M₀' 1 (One.one.{u2} M₀' _inst_3)))) (OfNat.ofNat.{u1} M₀ 1 (OfNat.mk.{u1} M₀ 1 (One.one.{u1} M₀ (MulOneClass.toHasOne.{u1} M₀ (MulZeroOneClass.toMulOneClass.{u1} M₀ (MonoidWithZero.toMulZeroOneClass.{u1} M₀ _inst_5))))))) -> (forall (x : M₀') (y : M₀'), Eq.{succ u1} M₀ (f (HMul.hMul.{u2, u2, u2} M₀' M₀' M₀' (instHMul.{u2} M₀' _inst_2) x y)) (HMul.hMul.{u1, u1, u1} M₀ M₀ M₀ (instHMul.{u1} M₀ (MulZeroClass.toHasMul.{u1} M₀ (MulZeroOneClass.toMulZeroClass.{u1} M₀ (MonoidWithZero.toMulZeroOneClass.{u1} M₀ _inst_5)))) (f x) (f y))) -> (forall (x : M₀') (n : Nat), Eq.{succ u1} M₀ (f (HPow.hPow.{u2, 0, u2} M₀' Nat M₀' (instHPow.{u2, 0} M₀' Nat _inst_4) x n)) (HPow.hPow.{u1, 0, u1} M₀ Nat M₀ (instHPow.{u1, 0} M₀ Nat (Monoid.hasPow.{u1} M₀ (MonoidWithZero.toMonoid.{u1} M₀ _inst_5))) (f x) n)) -> (MonoidWithZero.{u2} M₀')
but is expected to have type
...
lean 3 declaration is
  forall {M₀ : Type.{u1}} {M₀' : Type.{u2}} [_inst_1 : Zero.{u2} M₀'] [_inst_2 : Mul.{u2} M₀'] [_inst_3 : One.{u2} M₀'] [_inst_4 : Pow.{u2, 0} M₀' Nat] [_inst_5 : CommMonoidWithZero.{u1} M₀] (f : M₀' -> M₀), (Function.Injective.{succ u2, succ u1} M₀' M₀ f) -> (Eq.{succ u1} M₀ (f (OfNat.ofNat.{u2} M₀' 0 (OfNat.mk.{u2} M₀' 0 (Zero.zero.{u2} M₀' _inst_1)))) (OfNat.ofNat.{u1} M₀ 0 (OfNat.mk.{u1} M₀ 0 (Zero.zero.{u1} M₀ (MulZeroClass.toHasZero.{u1} M₀ (MulZeroOneClass.toMulZeroClass.{u1} M₀ (MonoidWithZero.toMulZeroOneClass.{u1} M₀ (CommMonoidWithZero.toMonoidWithZero.{u1} M₀ _inst_5)))))))) -> (Eq.{succ u1} M₀ (f (OfNat.ofNat.{u2} M₀' 1 (OfNat.mk.{u2} M₀' 1 (One.one.{u2} M₀' _inst_3)))) (OfNat.ofNat.{u1} M₀ 1 (OfNat.mk.{u1} M₀ 1 (One.one.{u1} M₀ (MulOneClass.toHasOne.{u1} M₀ (MulZeroOneClass.toMulOneClass.{u1} M₀ (MonoidWithZero.toMulZeroOneClass.{u1} M₀ (CommMonoidWithZero.toMonoidWithZero.{u1} M₀ _inst_5)))))))) -> (forall (x : M₀') (y : M₀'), Eq.{succ u1} M₀ (f (HMul.hMul.{u2, u2, u2} M₀' M₀' M₀' (instHMul.{u2} M₀' _inst_2) x y)) (HMul.hMul.{u1, u1, u1} M₀ M₀ M₀ (instHMul.{u1} M₀ (MulZeroClass.toHasMul.{u1} M₀ (MulZeroOneClass.toMulZeroClass.{u1} M₀ (MonoidWithZero.toMulZeroOneClass.{u1} M₀ (CommMonoidWithZero.toMonoidWithZero.{u1} M₀ _inst_5))))) (f x) (f y))) -> (forall (x : M₀') (n : Nat), Eq.{succ u1} M₀ (f (HPow.hPow.{u2, 0, u2} M₀' Nat M₀' (instHPow.{u2, 0} M₀' Nat _inst_4) x n)) (HPow.hPow.{u1, 0, u1} M₀ Nat M₀ (instHPow.{u1, 0} M₀ Nat (Monoid.hasPow.{u1} M₀ (MonoidWithZero.toMonoid.{u1} M₀ (CommMonoidWithZero.toMonoidWithZero.{u1} M₀ _inst_5)))) (f x) n)) -> (CommMonoidWithZero.{u2} M₀')
but is expected to have type
