...
but is expected to have type
  forall {R : Type.{u1}} (M : Type.{u2}) [_inst_1 : Add.{u1} R] [_inst_2 : AddZeroClass.{u2} M] (r₁ : R) (r₂ : R), Eq.{max (succ u1) (succ u2)} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.inl.{u1, u2} R M (AddZeroClass.toZero.{u2} M _inst_2) (HAdd.hAdd.{u1, u1, u1} R R R (instHAdd.{u1} R _inst_1) r₁ r₂)) (HAdd.hAdd.{max u1 u2, max u1 u2, max u1 u2} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.{u1, u2} R M) (instHAdd.{max u1 u2} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.add.{u1, u2} R M _inst_1 (AddZeroClass.toAdd.{u2} M _inst_2))) (TrivSqZeroExt.inl.{u1, u2} R M (AddZeroClass.toZero.{u2} M _inst_2) r₁) (TrivSqZeroExt.inl.{u1, u2} R M (AddZeroClass.toZero.{u2} M _inst_2) r₂))
Case conversion may be inaccurate. Consider using '#align triv_sq_zero_ext.inl_add TrivSqZeroExt.inl_addₓ'. -/
@[simp]
...
lean 3 declaration is
  forall (R : Type.{u1}) {M : Type.{u2}} [_inst_1 : SubNegZeroMonoid.{u1} R] [_inst_2 : Neg.{u2} M] (m : M), Eq.{max (succ u1) (succ u2)} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.inr.{u1, u2} R M (AddZeroClass.toHasZero.{u1} R (AddMonoid.toAddZeroClass.{u1} R (SubNegMonoid.toAddMonoid.{u1} R (SubNegZeroMonoid.toSubNegMonoid.{u1} R _inst_1)))) (Neg.neg.{u2} M _inst_2 m)) (Neg.neg.{max u1 u2} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.hasNeg.{u1, u2} R M (SubNegMonoid.toHasNeg.{u1} R (SubNegZeroMonoid.toSubNegMonoid.{u1} R _inst_1)) _inst_2) (TrivSqZeroExt.inr.{u1, u2} R M (AddZeroClass.toHasZero.{u1} R (AddMonoid.toAddZeroClass.{u1} R (SubNegMonoid.toAddMonoid.{u1} R (SubNegZeroMonoid.toSubNegMonoid.{u1} R _inst_1)))) m))
but is expected to have type
  forall (R : Type.{u1}) {M : Type.{u2}} [_inst_1 : SubNegZeroMonoid.{u1} R] [_inst_2 : Neg.{u2} M] (m : M), Eq.{max (succ u1) (succ u2)} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.inr.{u1, u2} R M (NegZeroClass.toZero.{u1} R (SubNegZeroMonoid.toNegZeroClass.{u1} R _inst_1)) (Neg.neg.{u2} M _inst_2 m)) (Neg.neg.{max u2 u1} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.neg.{u1, u2} R M (NegZeroClass.toNeg.{u1} R (SubNegZeroMonoid.toNegZeroClass.{u1} R _inst_1)) _inst_2) (TrivSqZeroExt.inr.{u1, u2} R M (NegZeroClass.toZero.{u1} R (SubNegZeroMonoid.toNegZeroClass.{u1} R _inst_1)) m))
Case conversion may be inaccurate. Consider using '#align triv_sq_zero_ext.inr_neg TrivSqZeroExt.inr_negₓ'. -/
@[simp]
...
lean 3 declaration is
  forall (R : Type.{u1}) {M : Type.{u2}} [_inst_1 : SubNegZeroMonoid.{u1} R] [_inst_2 : Sub.{u2} M] (m₁ : M) (m₂ : M), Eq.{max (succ u1) (succ u2)} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.inr.{u1, u2} R M (AddZeroClass.toHasZero.{u1} R (AddMonoid.toAddZeroClass.{u1} R (SubNegMonoid.toAddMonoid.{u1} R (SubNegZeroMonoid.toSubNegMonoid.{u1} R _inst_1)))) (HSub.hSub.{u2, u2, u2} M M M (instHSub.{u2} M _inst_2) m₁ m₂)) (HSub.hSub.{max u1 u2, max u1 u2, max u1 u2} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.{u1, u2} R M) (instHSub.{max u1 u2} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.hasSub.{u1, u2} R M (SubNegMonoid.toHasSub.{u1} R (SubNegZeroMonoid.toSubNegMonoid.{u1} R _inst_1)) _inst_2)) (TrivSqZeroExt.inr.{u1, u2} R M (AddZeroClass.toHasZero.{u1} R (AddMonoid.toAddZeroClass.{u1} R (SubNegMonoid.toAddMonoid.{u1} R (SubNegZeroMonoid.toSubNegMonoid.{u1} R _inst_1)))) m₁) (TrivSqZeroExt.inr.{u1, u2} R M (AddZeroClass.toHasZero.{u1} R (AddMonoid.toAddZeroClass.{u1} R (SubNegMonoid.toAddMonoid.{u1} R (SubNegZeroMonoid.toSubNegMonoid.{u1} R _inst_1)))) m₂))
but is expected to have type
  forall (R : Type.{u1}) {M : Type.{u2}} [_inst_1 : SubNegZeroMonoid.{u1} R] [_inst_2 : Sub.{u2} M] (m₁ : M) (m₂ : M), Eq.{max (succ u1) (succ u2)} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.inr.{u1, u2} R M (NegZeroClass.toZero.{u1} R (SubNegZeroMonoid.toNegZeroClass.{u1} R _inst_1)) (HSub.hSub.{u2, u2, u2} M M M (instHSub.{u2} M _inst_2) m₁ m₂)) (HSub.hSub.{max u2 u1, max u2 u1, max u1 u2} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.{u1, u2} R M) (instHSub.{max u2 u1} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.sub.{u1, u2} R M (SubNegMonoid.toSub.{u1} R (SubNegZeroMonoid.toSubNegMonoid.{u1} R _inst_1)) _inst_2)) (TrivSqZeroExt.inr.{u1, u2} R M (NegZeroClass.toZero.{u1} R (SubNegZeroMonoid.toNegZeroClass.{u1} R _inst_1)) m₁) (TrivSqZeroExt.inr.{u1, u2} R M (NegZeroClass.toZero.{u1} R (SubNegZeroMonoid.toNegZeroClass.{u1} R _inst_1)) m₂))
Case conversion may be inaccurate. Consider using '#align triv_sq_zero_ext.inr_sub TrivSqZeroExt.inr_subₓ'. -/
@[simp]
...
lean 3 declaration is
  forall {S : Type.{u3}} (R : Type.{u1}) {M : Type.{u2}} [_inst_1 : Zero.{u1} R] [_inst_2 : Zero.{u3} S] [_inst_3 : SMulWithZero.{u3, u1} S R _inst_2 _inst_1] [_inst_4 : SMul.{u3, u2} S M] (r : S) (m : M), Eq.{max (succ u1) (succ u2)} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.inr.{u1, u2} R M _inst_1 (SMul.smul.{u3, u2} S M _inst_4 r m)) (SMul.smul.{u3, max u1 u2} S (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.hasSmul.{u1, u2, u3} S R M (SMulZeroClass.toHasSmul.{u3, u1} S R _inst_1 (SMulWithZero.toSmulZeroClass.{u3, u1} S R _inst_2 _inst_1 _inst_3)) _inst_4) r (TrivSqZeroExt.inr.{u1, u2} R M _inst_1 m))
but is expected to have type
  forall {S : Type.{u1}} (R : Type.{u2}) {M : Type.{u3}} [_inst_1 : Zero.{u2} R] [_inst_2 : Zero.{u1} S] [_inst_3 : SMulWithZero.{u1, u2} S R _inst_2 _inst_1] [_inst_4 : SMul.{u1, u3} S M] (r : S) (m : M), Eq.{max (succ u2) (succ u3)} (TrivSqZeroExt.{u2, u3} R M) (TrivSqZeroExt.inr.{u2, u3} R M _inst_1 (HSMul.hSMul.{u1, u3, u3} S M M (instHSMul.{u1, u3} S M _inst_4) r m)) (HSMul.hSMul.{u1, max u3 u2, max u2 u3} S (TrivSqZeroExt.{u2, u3} R M) (TrivSqZeroExt.{u2, u3} R M) (instHSMul.{u1, max u3 u2} S (TrivSqZeroExt.{u2, u3} R M) (TrivSqZeroExt.smul.{u2, u3, u1} S R M (SMulZeroClass.toSMul.{u1, u2} S R _inst_1 (SMulWithZero.toSMulZeroClass.{u1, u2} S R _inst_2 _inst_1 _inst_3)) _inst_4)) r (TrivSqZeroExt.inr.{u2, u3} R M _inst_1 m))
Case conversion may be inaccurate. Consider using '#align triv_sq_zero_ext.inr_smul TrivSqZeroExt.inr_smulₓ'. -/
@[simp]
...
lean 3 declaration is
  forall (R : Type.{u1}) {M : Type.{u2}} {ι : Type.{u3}} [_inst_1 : AddCommMonoid.{u1} R] [_inst_2 : AddCommMonoid.{u2} M] (s : Finset.{u3} ι) (f : ι -> M), Eq.{max (succ u1) (succ u2)} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.inr.{u1, u2} R M (AddZeroClass.toHasZero.{u1} R (AddMonoid.toAddZeroClass.{u1} R (AddCommMonoid.toAddMonoid.{u1} R _inst_1))) (Finset.sum.{u2, u3} M ι _inst_2 s (fun (i : ι) => f i))) (Finset.sum.{max u1 u2, u3} (TrivSqZeroExt.{u1, u2} R M) ι (TrivSqZeroExt.addCommMonoid.{u1, u2} R M _inst_1 _inst_2) s (fun (i : ι) => TrivSqZeroExt.inr.{u1, u2} R M (AddZeroClass.toHasZero.{u1} R (AddMonoid.toAddZeroClass.{u1} R (AddCommMonoid.toAddMonoid.{u1} R _inst_1))) (f i)))
but is expected to have type
  forall (R : Type.{u2}) {M : Type.{u3}} {ι : Type.{u1}} [_inst_1 : AddCommMonoid.{u2} R] [_inst_2 : AddCommMonoid.{u3} M] (s : Finset.{u1} ι) (f : ι -> M), Eq.{max (succ u2) (succ u3)} (TrivSqZeroExt.{u2, u3} R M) (TrivSqZeroExt.inr.{u2, u3} R M (AddMonoid.toZero.{u2} R (AddCommMonoid.toAddMonoid.{u2} R _inst_1)) (Finset.sum.{u3, u1} M ι _inst_2 s (fun (i : ι) => f i))) (Finset.sum.{max u3 u2, u1} (TrivSqZeroExt.{u2, u3} R M) ι (TrivSqZeroExt.addCommMonoid.{u2, u3} R M _inst_1 _inst_2) s (fun (i : ι) => TrivSqZeroExt.inr.{u2, u3} R M (AddMonoid.toZero.{u2} R (AddCommMonoid.toAddMonoid.{u2} R _inst_1)) (f i)))
Case conversion may be inaccurate. Consider using '#align triv_sq_zero_ext.inr_sum TrivSqZeroExt.inr_sumₓ'. -/
...
lean 3 declaration is
  forall {R : Type.{u1}} {M : Type.{u2}} [_inst_1 : AddZeroClass.{u1} R] [_inst_2 : AddZeroClass.{u2} M] (x : TrivSqZeroExt.{u1, u2} R M), Eq.{succ (max u1 u2)} (TrivSqZeroExt.{u1, u2} R M) (HAdd.hAdd.{max u1 u2, max u1 u2, max u1 u2} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.{u1, u2} R M) (instHAdd.{max u1 u2} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.hasAdd.{u1, u2} R M (AddZeroClass.toHasAdd.{u1} R _inst_1) (AddZeroClass.toHasAdd.{u2} M _inst_2))) (TrivSqZeroExt.inl.{u1, u2} R M (AddZeroClass.toHasZero.{u2} M _inst_2) (TrivSqZeroExt.fst.{u1, u2} R M x)) (TrivSqZeroExt.inr.{u1, u2} R M (AddZeroClass.toHasZero.{u1} R _inst_1) (TrivSqZeroExt.snd.{u1, u2} R M x))) x
but is expected to have type
  forall {R : Type.{u1}} {M : Type.{u2}} [_inst_1 : AddZeroClass.{u1} R] [_inst_2 : AddZeroClass.{u2} M] (x : TrivSqZeroExt.{u1, u2} R M), Eq.{max (succ u1) (succ u2)} (TrivSqZeroExt.{u1, u2} R M) (HAdd.hAdd.{max u1 u2, max u2 u1, max u1 u2} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.{u1, u2} R M) (instHAdd.{max u1 u2} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.add.{u1, u2} R M (AddZeroClass.toAdd.{u1} R _inst_1) (AddZeroClass.toAdd.{u2} M _inst_2))) (TrivSqZeroExt.inl.{u1, u2} R M (AddZeroClass.toZero.{u2} M _inst_2) (TrivSqZeroExt.fst.{u1, u2} R M x)) (TrivSqZeroExt.inr.{u1, u2} R M (AddZeroClass.toZero.{u1} R _inst_1) (TrivSqZeroExt.snd.{u1, u2} R M x))) x
Case conversion may be inaccurate. Consider using '#align triv_sq_zero_ext.inl_fst_add_inr_snd_eq TrivSqZeroExt.inl_fst_add_inr_snd_eqₓ'. -/
...
lean 3 declaration is
  forall {R : Type.{u1}} {M : Type.{u2}} [_inst_1 : AddZeroClass.{u1} R] [_inst_2 : AddZeroClass.{u2} M] {P : (TrivSqZeroExt.{u1, u2} R M) -> Prop}, (forall (r : R) (m : M), P (HAdd.hAdd.{max u1 u2, max u1 u2, max u1 u2} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.{u1, u2} R M) (instHAdd.{max u1 u2} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.hasAdd.{u1, u2} R M (AddZeroClass.toHasAdd.{u1} R _inst_1) (AddZeroClass.toHasAdd.{u2} M _inst_2))) (TrivSqZeroExt.inl.{u1, u2} R M (AddZeroClass.toHasZero.{u2} M _inst_2) r) (TrivSqZeroExt.inr.{u1, u2} R M (AddZeroClass.toHasZero.{u1} R _inst_1) m))) -> (forall (x : TrivSqZeroExt.{u1, u2} R M), P x)
but is expected to have type
  forall {R : Type.{u2}} {M : Type.{u1}} [_inst_1 : AddZeroClass.{u2} R] [_inst_2 : AddZeroClass.{u1} M] {P : (TrivSqZeroExt.{u2, u1} R M) -> Prop}, (forall (r : R) (m : M), P (HAdd.hAdd.{max u1 u2, max u1 u2, max u2 u1} (TrivSqZeroExt.{u2, u1} R M) (TrivSqZeroExt.{u2, u1} R M) (TrivSqZeroExt.{u2, u1} R M) (instHAdd.{max u1 u2} (TrivSqZeroExt.{u2, u1} R M) (TrivSqZeroExt.add.{u2, u1} R M (AddZeroClass.toAdd.{u2} R _inst_1) (AddZeroClass.toAdd.{u1} M _inst_2))) (TrivSqZeroExt.inl.{u2, u1} R M (AddZeroClass.toZero.{u1} M _inst_2) r) (TrivSqZeroExt.inr.{u2, u1} R M (AddZeroClass.toZero.{u2} R _inst_1) m))) -> (forall (x : TrivSqZeroExt.{u2, u1} R M), P x)
Case conversion may be inaccurate. Consider using '#align triv_sq_zero_ext.ind TrivSqZeroExt.indₓ'. -/
...
/- warning: triv_sq_zero_ext.inl_mul -> TrivSqZeroExt.inl_mul is a dubious translation:
lean 3 declaration is
...
but is expected to have type
  forall {R : Type.{u1}} {M : Type.{u2}} [_inst_1 : AddMonoidWithOne.{u1} R] [_inst_2 : AddMonoid.{u2} M] (n : Nat), Eq.{succ u2} M (TrivSqZeroExt.snd.{u1, u2} R M (Nat.cast.{max u1 u2} (TrivSqZeroExt.{u1, u2} R M) (AddMonoidWithOne.toNatCast.{max u1 u2} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.addMonoidWithOne.{u1, u2} R M _inst_1 _inst_2)) n)) (OfNat.ofNat.{u2} M 0 (Zero.toOfNat0.{u2} M (AddMonoid.toZero.{u2} M _inst_2)))
Case conversion may be inaccurate. Consider using '#align triv_sq_zero_ext.snd_nat_cast TrivSqZeroExt.snd_nat_castₓ'. -/
@[simp]
...
lean 3 declaration is
  forall {R : Type.{u1}} {M : Type.{u2}} [_inst_1 : AddMonoidWithOne.{u1} R] [_inst_2 : AddMonoid.{u2} M] (n : Nat), Eq.{max (succ u1) (succ u2)} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.inl.{u1, u2} R M (AddZeroClass.toHasZero.{u2} M (AddMonoid.toAddZeroClass.{u2} M _inst_2)) ((fun (a : Type) (b : Type.{u1}) [self : HasLiftT.{1, succ u1} a b] => self.0) Nat R (HasLiftT.mk.{1, succ u1} Nat R (CoeTCₓ.coe.{1, succ u1} Nat R (Nat.castCoe.{u1} R (AddMonoidWithOne.toNatCast.{u1} R _inst_1)))) n)) ((fun (a : Type) (b : Sort.{max (succ u1) (succ u2)}) [self : HasLiftT.{1, max (succ u1) (succ u2)} a b] => self.0) Nat (TrivSqZeroExt.{u1, u2} R M) (HasLiftT.mk.{1, max (succ u1) (succ u2)} Nat (TrivSqZeroExt.{u1, u2} R M) (CoeTCₓ.coe.{1, max (succ u1) (succ u2)} Nat (TrivSqZeroExt.{u1, u2} R M) (Nat.castCoe.{max u1 u2} (TrivSqZeroExt.{u1, u2} R M) (AddMonoidWithOne.toNatCast.{max u1 u2} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.addMonoidWithOne.{u1, u2} R M _inst_1 _inst_2))))) n)
but is expected to have type
  forall {R : Type.{u1}} {M : Type.{u2}} [_inst_1 : AddMonoidWithOne.{u1} R] [_inst_2 : AddMonoid.{u2} M] (n : Nat), Eq.{max (succ u1) (succ u2)} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.inl.{u1, u2} R M (AddMonoid.toZero.{u2} M _inst_2) (Nat.cast.{u1} R (AddMonoidWithOne.toNatCast.{u1} R _inst_1) n)) (Nat.cast.{max u1 u2} (TrivSqZeroExt.{u1, u2} R M) (AddMonoidWithOne.toNatCast.{max u1 u2} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.addMonoidWithOne.{u1, u2} R M _inst_1 _inst_2)) n)
Case conversion may be inaccurate. Consider using '#align triv_sq_zero_ext.inl_nat_cast TrivSqZeroExt.inl_nat_castₓ'. -/
@[simp]
...
lean 3 declaration is
  forall {R : Type.{u1}} {M : Type.{u2}} [_inst_1 : AddGroupWithOne.{u1} R] [_inst_2 : AddGroup.{u2} M] (z : Int), Eq.{succ u1} R (TrivSqZeroExt.fst.{u1, u2} R M ((fun (a : Type) (b : Sort.{max (succ u1) (succ u2)}) [self : HasLiftT.{1, max (succ u1) (succ u2)} a b] => self.0) Int (TrivSqZeroExt.{u1, u2} R M) (HasLiftT.mk.{1, max (succ u1) (succ u2)} Int (TrivSqZeroExt.{u1, u2} R M) (CoeTCₓ.coe.{1, max (succ u1) (succ u2)} Int (TrivSqZeroExt.{u1, u2} R M) (Int.castCoe.{max u1 u2} (TrivSqZeroExt.{u1, u2} R M) (AddGroupWithOne.toHasIntCast.{max u1 u2} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.addGroupWithOne.{u1, u2} R M _inst_1 _inst_2))))) z)) ((fun (a : Type) (b : Type.{u1}) [self : HasLiftT.{1, succ u1} a b] => self.0) Int R (HasLiftT.mk.{1, succ u1} Int R (CoeTCₓ.coe.{1, succ u1} Int R (Int.castCoe.{u1} R (AddGroupWithOne.toHasIntCast.{u1} R _inst_1)))) z)
but is expected to have type
  forall {R : Type.{u1}} {M : Type.{u2}} [_inst_1 : AddGroupWithOne.{u1} R] [_inst_2 : AddGroup.{u2} M] (z : Int), Eq.{succ u1} R (TrivSqZeroExt.fst.{u1, u2} R M (Int.cast.{max u1 u2} (TrivSqZeroExt.{u1, u2} R M) (AddGroupWithOne.toIntCast.{max u1 u2} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.addGroupWithOne.{u1, u2} R M _inst_1 _inst_2)) z)) (Int.cast.{u1} R (AddGroupWithOne.toIntCast.{u1} R _inst_1) z)
Case conversion may be inaccurate. Consider using '#align triv_sq_zero_ext.fst_int_cast TrivSqZeroExt.fst_int_castₓ'. -/
@[simp]
...
lean 3 declaration is
  forall {R : Type.{u1}} {M : Type.{u2}} [_inst_1 : AddGroupWithOne.{u1} R] [_inst_2 : AddGroup.{u2} M] (z : Int), Eq.{succ u2} M (TrivSqZeroExt.snd.{u1, u2} R M ((fun (a : Type) (b : Sort.{max (succ u1) (succ u2)}) [self : HasLiftT.{1, max (succ u1) (succ u2)} a b] => self.0) Int (TrivSqZeroExt.{u1, u2} R M) (HasLiftT.mk.{1, max (succ u1) (succ u2)} Int (TrivSqZeroExt.{u1, u2} R M) (CoeTCₓ.coe.{1, max (succ u1) (succ u2)} Int (TrivSqZeroExt.{u1, u2} R M) (Int.castCoe.{max u1 u2} (TrivSqZeroExt.{u1, u2} R M) (AddGroupWithOne.toHasIntCast.{max u1 u2} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.addGroupWithOne.{u1, u2} R M _inst_1 _inst_2))))) z)) (OfNat.ofNat.{u2} M 0 (OfNat.mk.{u2} M 0 (Zero.zero.{u2} M (AddZeroClass.toHasZero.{u2} M (AddMonoid.toAddZeroClass.{u2} M (SubNegMonoid.toAddMonoid.{u2} M (AddGroup.toSubNegMonoid.{u2} M _inst_2)))))))
but is expected to have type
  forall {R : Type.{u1}} {M : Type.{u2}} [_inst_1 : AddGroupWithOne.{u1} R] [_inst_2 : AddGroup.{u2} M] (z : Int), Eq.{succ u2} M (TrivSqZeroExt.snd.{u1, u2} R M (Int.cast.{max u1 u2} (TrivSqZeroExt.{u1, u2} R M) (AddGroupWithOne.toIntCast.{max u1 u2} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.addGroupWithOne.{u1, u2} R M _inst_1 _inst_2)) z)) (OfNat.ofNat.{u2} M 0 (Zero.toOfNat0.{u2} M (NegZeroClass.toZero.{u2} M (SubNegZeroMonoid.toNegZeroClass.{u2} M (SubtractionMonoid.toSubNegZeroMonoid.{u2} M (AddGroup.toSubtractionMonoid.{u2} M _inst_2))))))
Case conversion may be inaccurate. Consider using '#align triv_sq_zero_ext.snd_int_cast TrivSqZeroExt.snd_int_castₓ'. -/
@[simp]
...
/- warning: triv_sq_zero_ext.inl_int_cast -> TrivSqZeroExt.inl_int_cast is a dubious translation:
lean 3 declaration is
  forall {R : Type.{u1}} {M : Type.{u2}} [_inst_1 : AddGroupWithOne.{u1} R] [_inst_2 : AddGroup.{u2} M] (z : Int), Eq.{max (succ u1) (succ u2)} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.inl.{u1, u2} R M (AddZeroClass.toHasZero.{u2} M (AddMonoid.toAddZeroClass.{u2} M (SubNegMonoid.toAddMonoid.{u2} M (AddGroup.toSubNegMonoid.{u2} M _inst_2)))) ((fun (a : Type) (b : Type.{u1}) [self : HasLiftT.{1, succ u1} a b] => self.0) Int R (HasLiftT.mk.{1, succ u1} Int R (CoeTCₓ.coe.{1, succ u1} Int R (Int.castCoe.{u1} R (AddGroupWithOne.toHasIntCast.{u1} R _inst_1)))) z)) ((fun (a : Type) (b : Sort.{max (succ u1) (succ u2)}) [self : HasLiftT.{1, max (succ u1) (succ u2)} a b] => self.0) Int (TrivSqZeroExt.{u1, u2} R M) (HasLiftT.mk.{1, max (succ u1) (succ u2)} Int (TrivSqZeroExt.{u1, u2} R M) (CoeTCₓ.coe.{1, max (succ u1) (succ u2)} Int (TrivSqZeroExt.{u1, u2} R M) (Int.castCoe.{max u1 u2} (TrivSqZeroExt.{u1, u2} R M) (AddGroupWithOne.toHasIntCast.{max u1 u2} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.addGroupWithOne.{u1, u2} R M _inst_1 _inst_2))))) z)
but is expected to have type
  forall {R : Type.{u1}} {M : Type.{u2}} [_inst_1 : AddGroupWithOne.{u1} R] [_inst_2 : AddGroup.{u2} M] (z : Int), Eq.{max (succ u1) (succ u2)} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.inl.{u1, u2} R M (NegZeroClass.toZero.{u2} M (SubNegZeroMonoid.toNegZeroClass.{u2} M (SubtractionMonoid.toSubNegZeroMonoid.{u2} M (AddGroup.toSubtractionMonoid.{u2} M _inst_2)))) (Int.cast.{u1} R (AddGroupWithOne.toIntCast.{u1} R _inst_1) z)) (Int.cast.{max u1 u2} (TrivSqZeroExt.{u1, u2} R M) (AddGroupWithOne.toIntCast.{max u1 u2} (TrivSqZeroExt.{u1, u2} R M) (TrivSqZeroExt.addGroupWithOne.{u1, u2} R M _inst_1 _inst_2)) z)
Case conversion may be inaccurate. Consider using '#align triv_sq_zero_ext.inl_int_cast TrivSqZeroExt.inl_int_castₓ'. -/
@[simp]
