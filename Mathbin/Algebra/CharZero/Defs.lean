...
but is expected to have type
  forall {R : Type.{u_1}} [inst._@.Mathlib.Algebra.CharZero.Defs._hyg.261 : AddMonoidWithOne.{u_1} R] [inst._@.Mathlib.Algebra.CharZero.Defs._hyg.264 : CharZero.{u_1} R inst._@.Mathlib.Algebra.CharZero.Defs._hyg.261] {n : Nat}, Iff (Eq.{succ u_1} R (Nat.cast.{u_1} R (AddMonoidWithOne.toNatCast.{u_1} R inst._@.Mathlib.Algebra.CharZero.Defs._hyg.261) n) (OfNat.ofNat.{u_1} R 0 (Zero.toOfNat0.{u_1} R (AddMonoid.toZero.{u_1} R (AddMonoidWithOne.toAddMonoid.{u_1} R inst._@.Mathlib.Algebra.CharZero.Defs._hyg.261))))) (Eq.{1} Nat n (OfNat.ofNat.{0} Nat 0 (instOfNatNat 0)))
...
but is expected to have type
  forall {R : Type.{u_1}} [inst._@.Mathlib.Algebra.CharZero.Defs._hyg.321 : AddMonoidWithOne.{u_1} R] [inst._@.Mathlib.Algebra.CharZero.Defs._hyg.324 : CharZero.{u_1} R inst._@.Mathlib.Algebra.CharZero.Defs._hyg.321] {n : Nat}, Iff (Ne.{succ u_1} R (Nat.cast.{u_1} R (AddMonoidWithOne.toNatCast.{u_1} R inst._@.Mathlib.Algebra.CharZero.Defs._hyg.321) n) (OfNat.ofNat.{u_1} R 0 (Zero.toOfNat0.{u_1} R (AddMonoid.toZero.{u_1} R (AddMonoidWithOne.toAddMonoid.{u_1} R inst._@.Mathlib.Algebra.CharZero.Defs._hyg.321))))) (Ne.{1} Nat n (OfNat.ofNat.{0} Nat 0 (instOfNatNat 0)))
...
but is expected to have type
  forall {R : Type.{u_1}} [inst._@.Mathlib.Algebra.CharZero.Defs._hyg.353 : AddMonoidWithOne.{u_1} R] [inst._@.Mathlib.Algebra.CharZero.Defs._hyg.356 : CharZero.{u_1} R inst._@.Mathlib.Algebra.CharZero.Defs._hyg.353] (n : Nat), Ne.{succ u_1} R (HAdd.hAdd.{u_1, u_1, u_1} R R R (instHAdd.{u_1} R (AddZeroClass.toAdd.{u_1} R (AddMonoid.toAddZeroClass.{u_1} R (AddMonoidWithOne.toAddMonoid.{u_1} R inst._@.Mathlib.Algebra.CharZero.Defs._hyg.353)))) (Nat.cast.{u_1} R (AddMonoidWithOne.toNatCast.{u_1} R inst._@.Mathlib.Algebra.CharZero.Defs._hyg.353) n) (OfNat.ofNat.{u_1} R 1 (One.toOfNat1.{u_1} R (AddMonoidWithOne.toOne.{u_1} R inst._@.Mathlib.Algebra.CharZero.Defs._hyg.353)))) (OfNat.ofNat.{u_1} R 0 (Zero.toOfNat0.{u_1} R (AddMonoid.toZero.{u_1} R (AddMonoidWithOne.toAddMonoid.{u_1} R inst._@.Mathlib.Algebra.CharZero.Defs._hyg.353))))
...
but is expected to have type
  forall {M : Type.{u_1}} {n : Nat} [inst._@.Mathlib.Algebra.CharZero.Defs._hyg.512 : NeZero.{0} Nat (Zero.ofOfNat0.{0} Nat (instOfNatNat 0)) n] [inst._@.Mathlib.Algebra.CharZero.Defs._hyg.515 : AddMonoidWithOne.{u_1} M] [inst._@.Mathlib.Algebra.CharZero.Defs._hyg.518 : CharZero.{u_1} M inst._@.Mathlib.Algebra.CharZero.Defs._hyg.515], NeZero.{u_1} M (AddMonoid.toZero.{u_1} M (AddMonoidWithOne.toAddMonoid.{u_1} M inst._@.Mathlib.Algebra.CharZero.Defs._hyg.515)) (Nat.cast.{u_1} M (AddMonoidWithOne.toNatCast.{u_1} M inst._@.Mathlib.Algebra.CharZero.Defs._hyg.515) n)
