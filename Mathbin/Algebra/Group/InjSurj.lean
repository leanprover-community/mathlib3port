...
lean 3 declaration is
  forall {M₂ : Type.{u1}} {M₁ : Type.{u2}} [_inst_4 : Zero.{u2} M₁] [_inst_5 : One.{u2} M₁] [_inst_6 : Add.{u2} M₁] [_inst_7 : HasSmul.{0, u2} Nat M₁] [_inst_8 : NatCast.{u2} M₁] [_inst_9 : AddMonoidWithOne.{u1} M₂] (f : M₁ -> M₂), (Function.Injective.{succ u2, succ u1} M₁ M₂ f) -> (Eq.{succ u1} M₂ (f (OfNat.ofNat.{u2} M₁ 0 (OfNat.mk.{u2} M₁ 0 (Zero.zero.{u2} M₁ _inst_4)))) (OfNat.ofNat.{u1} M₂ 0 (OfNat.mk.{u1} M₂ 0 (Zero.zero.{u1} M₂ (AddZeroClass.toHasZero.{u1} M₂ (AddMonoid.toAddZeroClass.{u1} M₂ (AddMonoidWithOne.toAddMonoid.{u1} M₂ _inst_9))))))) -> (Eq.{succ u1} M₂ (f (OfNat.ofNat.{u2} M₁ 1 (OfNat.mk.{u2} M₁ 1 (One.one.{u2} M₁ _inst_5)))) (OfNat.ofNat.{u1} M₂ 1 (OfNat.mk.{u1} M₂ 1 (One.one.{u1} M₂ (AddMonoidWithOne.toOne.{u1} M₂ _inst_9))))) -> (forall (x : M₁) (y : M₁), Eq.{succ u1} M₂ (f (HAdd.hAdd.{u2, u2, u2} M₁ M₁ M₁ (instHAdd.{u2} M₁ _inst_6) x y)) (HAdd.hAdd.{u1, u1, u1} M₂ M₂ M₂ (instHAdd.{u1} M₂ (AddZeroClass.toHasAdd.{u1} M₂ (AddMonoid.toAddZeroClass.{u1} M₂ (AddMonoidWithOne.toAddMonoid.{u1} M₂ _inst_9)))) (f x) (f y))) -> (forall (x : M₁) (n : Nat), Eq.{succ u1} M₂ (f (HasSmul.smul.{0, u2} Nat M₁ _inst_7 n x)) (HasSmul.smul.{0, u1} Nat M₂ (AddMonoid.hasSmulNat.{u1} M₂ (AddMonoidWithOne.toAddMonoid.{u1} M₂ _inst_9)) n (f x))) -> (forall (n : Nat), Eq.{succ u1} M₂ (f ((fun (a : Type) (b : Type.{u2}) [self : HasLiftT.{1, succ u2} a b] => self.0) Nat M₁ (HasLiftT.mk.{1, succ u2} Nat M₁ (CoeTCₓ.coe.{1, succ u2} Nat M₁ (Nat.castCoe.{u2} M₁ _inst_8))) n)) ((fun (a : Type) (b : Type.{u1}) [self : HasLiftT.{1, succ u1} a b] => self.0) Nat M₂ (HasLiftT.mk.{1, succ u1} Nat M₂ (CoeTCₓ.coe.{1, succ u1} Nat M₂ (Nat.castCoe.{u1} M₂ (AddMonoidWithOne.toNatCast.{u1} M₂ _inst_9)))) n)) -> (AddMonoidWithOne.{u2} M₁)
but is expected to have type
...
lean 3 declaration is
  forall {M₂ : Type.{u1}} {M₁ : Type.{u2}} [_inst_4 : Inv.{u2} M₁] [_inst_5 : HasInvolutiveInv.{u1} M₂] (f : M₁ -> M₂), (Function.Injective.{succ u2, succ u1} M₁ M₂ f) -> (forall (x : M₁), Eq.{succ u1} M₂ (f (Inv.inv.{u2} M₁ _inst_4 x)) (Inv.inv.{u1} M₂ (HasInvolutiveInv.toHasInv.{u1} M₂ _inst_5) (f x))) -> (HasInvolutiveInv.{u2} M₁)
but is expected to have type
  forall {M₂ : Type.{u1}} {M₁ : Type.{u2}} [_inst_4 : Inv.{u2} M₁] [_inst_5 : HasInvolutiveInv.{u1} M₂] (f : M₁ -> M₂), (Function.Injective.{succ u2, succ u1} M₁ M₂ f) -> (forall (x : M₁), Eq.{succ u1} M₂ (f (Inv.inv.{u2} M₁ _inst_4 x)) (Inv.inv.{u1} M₂ (HasInvolutiveInv.toInv.{u1} M₂ _inst_5) (f x))) -> (HasInvolutiveInv.{u2} M₁)
...
lean 3 declaration is
  forall {M₂ : Type.{u1}} {M₁ : Type.{u2}} [_inst_7 : Zero.{u2} M₁] [_inst_8 : One.{u2} M₁] [_inst_9 : Add.{u2} M₁] [_inst_10 : HasSmul.{0, u2} Nat M₁] [_inst_11 : Neg.{u2} M₁] [_inst_12 : Sub.{u2} M₁] [_inst_13 : HasSmul.{0, u2} Int M₁] [_inst_14 : NatCast.{u2} M₁] [_inst_15 : IntCast.{u2} M₁] [_inst_16 : AddGroupWithOne.{u1} M₂] (f : M₁ -> M₂), (Function.Injective.{succ u2, succ u1} M₁ M₂ f) -> (Eq.{succ u1} M₂ (f (OfNat.ofNat.{u2} M₁ 0 (OfNat.mk.{u2} M₁ 0 (Zero.zero.{u2} M₁ _inst_7)))) (OfNat.ofNat.{u1} M₂ 0 (OfNat.mk.{u1} M₂ 0 (Zero.zero.{u1} M₂ (AddZeroClass.toHasZero.{u1} M₂ (AddMonoid.toAddZeroClass.{u1} M₂ (AddMonoidWithOne.toAddMonoid.{u1} M₂ (AddGroupWithOne.toAddMonoidWithOne.{u1} M₂ _inst_16)))))))) -> (Eq.{succ u1} M₂ (f (OfNat.ofNat.{u2} M₁ 1 (OfNat.mk.{u2} M₁ 1 (One.one.{u2} M₁ _inst_8)))) (OfNat.ofNat.{u1} M₂ 1 (OfNat.mk.{u1} M₂ 1 (One.one.{u1} M₂ (AddMonoidWithOne.toOne.{u1} M₂ (AddGroupWithOne.toAddMonoidWithOne.{u1} M₂ _inst_16)))))) -> (forall (x : M₁) (y : M₁), Eq.{succ u1} M₂ (f (HAdd.hAdd.{u2, u2, u2} M₁ M₁ M₁ (instHAdd.{u2} M₁ _inst_9) x y)) (HAdd.hAdd.{u1, u1, u1} M₂ M₂ M₂ (instHAdd.{u1} M₂ (AddZeroClass.toHasAdd.{u1} M₂ (AddMonoid.toAddZeroClass.{u1} M₂ (AddMonoidWithOne.toAddMonoid.{u1} M₂ (AddGroupWithOne.toAddMonoidWithOne.{u1} M₂ _inst_16))))) (f x) (f y))) -> (forall (x : M₁), Eq.{succ u1} M₂ (f (Neg.neg.{u2} M₁ _inst_11 x)) (Neg.neg.{u1} M₂ (SubNegMonoid.toHasNeg.{u1} M₂ (AddGroup.toSubNegMonoid.{u1} M₂ (AddGroupWithOne.toAddGroup.{u1} M₂ _inst_16))) (f x))) -> (forall (x : M₁) (y : M₁), Eq.{succ u1} M₂ (f (HSub.hSub.{u2, u2, u2} M₁ M₁ M₁ (instHSub.{u2} M₁ _inst_12) x y)) (HSub.hSub.{u1, u1, u1} M₂ M₂ M₂ (instHSub.{u1} M₂ (SubNegMonoid.toHasSub.{u1} M₂ (AddGroup.toSubNegMonoid.{u1} M₂ (AddGroupWithOne.toAddGroup.{u1} M₂ _inst_16)))) (f x) (f y))) -> (forall (x : M₁) (n : Nat), Eq.{succ u1} M₂ (f (HasSmul.smul.{0, u2} Nat M₁ _inst_10 n x)) (HasSmul.smul.{0, u1} Nat M₂ (AddMonoid.hasSmulNat.{u1} M₂ (AddMonoidWithOne.toAddMonoid.{u1} M₂ (AddGroupWithOne.toAddMonoidWithOne.{u1} M₂ _inst_16))) n (f x))) -> (forall (x : M₁) (n : Int), Eq.{succ u1} M₂ (f (HasSmul.smul.{0, u2} Int M₁ _inst_13 n x)) (HasSmul.smul.{0, u1} Int M₂ (SubNegMonoid.hasSmulInt.{u1} M₂ (AddGroup.toSubNegMonoid.{u1} M₂ (AddGroupWithOne.toAddGroup.{u1} M₂ _inst_16))) n (f x))) -> (forall (n : Nat), Eq.{succ u1} M₂ (f ((fun (a : Type) (b : Type.{u2}) [self : HasLiftT.{1, succ u2} a b] => self.0) Nat M₁ (HasLiftT.mk.{1, succ u2} Nat M₁ (CoeTCₓ.coe.{1, succ u2} Nat M₁ (Nat.castCoe.{u2} M₁ _inst_14))) n)) ((fun (a : Type) (b : Type.{u1}) [self : HasLiftT.{1, succ u1} a b] => self.0) Nat M₂ (HasLiftT.mk.{1, succ u1} Nat M₂ (CoeTCₓ.coe.{1, succ u1} Nat M₂ (Nat.castCoe.{u1} M₂ (AddMonoidWithOne.toNatCast.{u1} M₂ (AddGroupWithOne.toAddMonoidWithOne.{u1} M₂ _inst_16))))) n)) -> (forall (n : Int), Eq.{succ u1} M₂ (f ((fun (a : Type) (b : Type.{u2}) [self : HasLiftT.{1, succ u2} a b] => self.0) Int M₁ (HasLiftT.mk.{1, succ u2} Int M₁ (CoeTCₓ.coe.{1, succ u2} Int M₁ (Int.castCoe.{u2} M₁ _inst_15))) n)) ((fun (a : Type) (b : Type.{u1}) [self : HasLiftT.{1, succ u1} a b] => self.0) Int M₂ (HasLiftT.mk.{1, succ u1} Int M₂ (CoeTCₓ.coe.{1, succ u1} Int M₂ (Int.castCoe.{u1} M₂ (AddGroupWithOne.toHasIntCast.{u1} M₂ _inst_16)))) n)) -> (AddGroupWithOne.{u2} M₁)
but is expected to have type
...
lean 3 declaration is
  forall {M₁ : Type.{u1}} {M₂ : Type.{u2}} [_inst_1 : Mul.{u2} M₂] [_inst_2 : One.{u2} M₂] [_inst_3 : Pow.{u2, 0} M₂ Nat] [_inst_4 : Monoid.{u1} M₁] (f : M₁ -> M₂), (Function.Surjective.{succ u1, succ u2} M₁ M₂ f) -> (Eq.{succ u2} M₂ (f (OfNat.ofNat.{u1} M₁ 1 (OfNat.mk.{u1} M₁ 1 (One.one.{u1} M₁ (MulOneClass.toHasOne.{u1} M₁ (Monoid.toMulOneClass.{u1} M₁ _inst_4)))))) (OfNat.ofNat.{u2} M₂ 1 (OfNat.mk.{u2} M₂ 1 (One.one.{u2} M₂ _inst_2)))) -> (forall (x : M₁) (y : M₁), Eq.{succ u2} M₂ (f (HMul.hMul.{u1, u1, u1} M₁ M₁ M₁ (instHMul.{u1} M₁ (MulOneClass.toHasMul.{u1} M₁ (Monoid.toMulOneClass.{u1} M₁ _inst_4))) x y)) (HMul.hMul.{u2, u2, u2} M₂ M₂ M₂ (instHMul.{u2} M₂ _inst_1) (f x) (f y))) -> (forall (x : M₁) (n : Nat), Eq.{succ u2} M₂ (f (HPow.hPow.{u1, 0, u1} M₁ Nat M₁ (instHPow.{u1, 0} M₁ Nat (Monoid.hasPow.{u1} M₁ _inst_4)) x n)) (HPow.hPow.{u2, 0, u2} M₂ Nat M₂ (instHPow.{u2, 0} M₂ Nat _inst_3) (f x) n)) -> (Monoid.{u2} M₂)
but is expected to have type
...
lean 3 declaration is
  forall {M₁ : Type.{u1}} {M₂ : Type.{u2}} [_inst_1 : Mul.{u2} M₂] [_inst_2 : One.{u2} M₂] [_inst_3 : Pow.{u2, 0} M₂ Nat] [_inst_4 : CommMonoid.{u1} M₁] (f : M₁ -> M₂), (Function.Surjective.{succ u1, succ u2} M₁ M₂ f) -> (Eq.{succ u2} M₂ (f (OfNat.ofNat.{u1} M₁ 1 (OfNat.mk.{u1} M₁ 1 (One.one.{u1} M₁ (MulOneClass.toHasOne.{u1} M₁ (Monoid.toMulOneClass.{u1} M₁ (CommMonoid.toMonoid.{u1} M₁ _inst_4))))))) (OfNat.ofNat.{u2} M₂ 1 (OfNat.mk.{u2} M₂ 1 (One.one.{u2} M₂ _inst_2)))) -> (forall (x : M₁) (y : M₁), Eq.{succ u2} M₂ (f (HMul.hMul.{u1, u1, u1} M₁ M₁ M₁ (instHMul.{u1} M₁ (MulOneClass.toHasMul.{u1} M₁ (Monoid.toMulOneClass.{u1} M₁ (CommMonoid.toMonoid.{u1} M₁ _inst_4)))) x y)) (HMul.hMul.{u2, u2, u2} M₂ M₂ M₂ (instHMul.{u2} M₂ _inst_1) (f x) (f y))) -> (forall (x : M₁) (n : Nat), Eq.{succ u2} M₂ (f (HPow.hPow.{u1, 0, u1} M₁ Nat M₁ (instHPow.{u1, 0} M₁ Nat (Monoid.hasPow.{u1} M₁ (CommMonoid.toMonoid.{u1} M₁ _inst_4))) x n)) (HPow.hPow.{u2, 0, u2} M₂ Nat M₂ (instHPow.{u2, 0} M₂ Nat _inst_3) (f x) n)) -> (CommMonoid.{u2} M₂)
but is expected to have type
...
lean 3 declaration is
  forall {M₁ : Type.{u1}} {M₂ : Type.{u2}} [_inst_4 : Inv.{u2} M₂] [_inst_5 : HasInvolutiveInv.{u1} M₁] (f : M₁ -> M₂), (Function.Surjective.{succ u1, succ u2} M₁ M₂ f) -> (forall (x : M₁), Eq.{succ u2} M₂ (f (Inv.inv.{u1} M₁ (HasInvolutiveInv.toHasInv.{u1} M₁ _inst_5) x)) (Inv.inv.{u2} M₂ _inst_4 (f x))) -> (HasInvolutiveInv.{u2} M₂)
but is expected to have type
  forall {M₁ : Type.{u1}} {M₂ : Type.{u2}} [_inst_4 : Inv.{u2} M₂] [_inst_5 : HasInvolutiveInv.{u1} M₁] (f : M₁ -> M₂), (Function.Surjective.{succ u1, succ u2} M₁ M₂ f) -> (forall (x : M₁), Eq.{succ u2} M₂ (f (Inv.inv.{u1} M₁ (HasInvolutiveInv.toInv.{u1} M₁ _inst_5) x)) (Inv.inv.{u2} M₂ _inst_4 (f x))) -> (HasInvolutiveInv.{u2} M₂)
