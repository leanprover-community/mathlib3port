...
but is expected to have type
  forall {G : Type.{u1}} [_inst_1 : Semigroup.{u1} G], IsAssociative.{u1} G (fun (x._@.Mathlib.Algebra.Group.Defs._hyg.3272 : G) (x._@.Mathlib.Algebra.Group.Defs._hyg.3274 : G) => HMul.hMul.{u1, u1, u1} G G G (instHMul.{u1} G (Semigroup.toMul.{u1} G _inst_1)) x._@.Mathlib.Algebra.Group.Defs._hyg.3272 x._@.Mathlib.Algebra.Group.Defs._hyg.3274)
