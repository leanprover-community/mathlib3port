...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `sum_divisors_filter_squarefree [])
  (Command.declSig
   ...
   (Term.typeSpec
    ...
    («term_=_»
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      ...
      " in "
      (Term.app `n.divisors.filter [`Squarefree])
      ", "
      (Term.app `f [`i]))
     "="
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      ...
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
      " in "
      (Term.proj (Term.proj (Term.app `UniqueFactorizationMonoid.normalizedFactors [`n]) "." `toFinset) "." `Powerset)
      ", "
      (Term.app `f [`i.val.prod])))))
        ...
        (Tactic.rwSeq
         ...
         (Tactic.rwRuleSeq
          ...
          [(Tactic.rwRule [] `Finset.sum_eq_multiset_sum)
           ","
           (Tactic.rwRule [] (Term.app `divisors_filter_squarefree [`h0]))
           ","
           (Tactic.rwRule [] `Multiset.map_map)
           ","
           (Tactic.rwRule [] `Finset.sum_eq_multiset_sum)]
          "]")
         [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `divisors_filter_squarefree [`h0])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.proj (Term.app `UniqueFactorizationMonoid.normalizedFactors [`n]) "." `toFinset)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `UniqueFactorizationMonoid.normalizedFactors [`n])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
theorem
  ...
  { n : ℕ } ( h0 : n ≠ 0 ) { α : Type _ } [ AddCommMonoidₓ α ] { f : ℕ → α }
    :
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `sq_mul_squarefree_of_pos [])
  (Command.declSig
   [(Term.implicitBinder "{" [`n] [":" (termℕ "ℕ")] "}")
   ...
   (Term.typeSpec
    ...
    («term∃_,_»
     ...
     (Lean.explicitBinders
      (Lean.unbracketedExplicitBinders [(Lean.binderIdent `a) (Lean.binderIdent `b)] [":" (termℕ "ℕ")]))
     ","
     («term_∧_»
      («term_<_» (numLit "0") "<" `a)
      "∧"
      («term_∧_»
       ...
       («term_∧_»
        («term_=_»
         (Finset.Data.Finset.Fold.«term_*_» (Cardinal.SetTheory.Cardinal.«term_^_» `b "^" (numLit "2")) "*" `a)
         "="
         `n)
        "∧"
        (Term.app `Squarefree [`a])))))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
      ...
      [(group
        (Tactic.tacticLet_
         ...
         (Term.letDecl
          (Term.letIdDecl
           ...
           (Set.«term{_|_}_1»
            "{"
            («term_∈_» `s "∈" (Term.app `Finset.range [(Init.Logic.«term_+_» `n "+" (numLit "1"))]))
            "|"
            («term_∧_»
             ...
             («term∃_,_»
              ...
              ","
              («term_=_» `s "=" (Cardinal.SetTheory.Cardinal.«term_^_» `x "^" (numLit "2")))))
            "}"))))
        [])
       (group
        (Tactic.tacticHave_
                   ...
                   [(Term.typeSpec
                     ...
                     («term_∧_»
                      ...
                      («term∃_,_»
                       "∃"
                       (Lean.explicitBinders
                        (Lean.unbracketedExplicitBinders [(Lean.binderIdent `x)] [":" (termℕ "ℕ")]))
                       ","
                       («term_=_» (numLit "1") "=" (Cardinal.SetTheory.Cardinal.«term_^_» `x "^" (numLit "2"))))))]
                   ":="
                   (Term.anonymousCtor
                    "⟨"
                    [`hn
                     ...
                     (Term.anonymousCtor
                      "⟨"
                      [(numLit "1") "," (Term.proj (Term.app `one_pow [(numLit "2")]) "." `symm)]
                      "⟩")]
                    "⟩"))))
                [])
               (group (Tactic.simpa "simpa" [] [] ["[" [(Tactic.simpLemma [] [] `S)] "]"] [] []) [])]))))))
        [])
       (group
        (Tactic.tacticLet_ "let" (Term.letDecl (Term.letIdDecl `s [] ":=" (Term.app `Finset.max' [`S `hSne]))))
        [])
       (group
        (Tactic.tacticHave_
         "have"
         (Term.haveDecl
          (Term.haveIdDecl
           ...
           ":="
           (Term.app `Finset.max'_mem [`S `hSne]))))
        [])
       (group
        (Tactic.simp
         "simp"
         ...
         ["only"]
         ["["
          [(Tactic.simpLemma [] [] `Finset.sep_def)
           ","
           (Tactic.simpLemma [] [] `S)
           ","
        ...
        (Tactic.obtain
         ...
         [(Tactic.rcasesPatMed
           [(Tactic.rcasesPat.tuple
             "⟨"
             [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `hsn1)]) [])
              ","
              (Tactic.rcasesPatLo
               (Tactic.rcasesPatMed
                [(Tactic.rcasesPat.tuple
                  ...
                  [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `a)]) [])
                   ","
                   (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `hsa)]) [])]
                  "⟩")])
               [])
              ","
              (Tactic.rcasesPatLo
               (Tactic.rcasesPatMed
                [(Tactic.rcasesPat.tuple
                  ...
                  [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `b)]) [])
                   ","
                   (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `hsb)]) [])]
                  "⟩")])
               [])]
             "⟩")])]
         []
       ...
       (group
        (Tactic.rwSeq
         "rw"
         []
         (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `hsa)] "]")
       ...
       (group
        (Tactic.obtain
         ...
         [(Tactic.rcasesPatMed
           [(Tactic.rcasesPat.tuple
             "⟨"
             [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `hlts)]) [])
              ","
              (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `hlta)]) [])]
             "⟩")])]
         []
         [":=" [(Term.app `canonically_ordered_comm_semiring.mul_pos.mp [`hn])]])
        [])
       (group
        (Tactic.rwSeq
         "rw"
         []
         (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `hsb)] "]")
         [(Tactic.location "at" (Tactic.locationHyp [`hsa `hn `hlts] []))])
        [])
       (group
        (Tactic.refine'
         "refine'"
         (Term.anonymousCtor
          ...
          [`a
           ...
           `hlta
           ","
           (Term.app (Term.proj (Term.app `pow_pos_iff [`zero_lt_two]) "." `mp) [`hlts])
           ","
           `hsa.symm
           ","
           (Term.hole "_")]
         ...
         (Term.app
          ...
          [(Term.hole "_")
           (Term.app
            `Finset.le_max'
            [`S
             (Cardinal.SetTheory.Cardinal.«term_^_» (Finset.Data.Finset.Fold.«term_*_» `b "*" `x) "^" (numLit "2"))
             (Term.hole "_")])]))
        [])
       (group
        (Tactic.«tactic·._»
             ...
             (Tactic.simpRw
              ...
              (Tactic.rwRuleSeq
               ...
               [(Tactic.rwRule [] `S)
                ...
                ","
                (Tactic.rwRule [] `Finset.mem_range)]
               "]")
              [])
             [])
            (group
             (Tactic.«tactic_<;>_»
              (Tactic.refine'
               ...
               (Term.anonymousCtor
                "⟨"
                [(Term.app `lt_succ_iff.mpr [(Term.app `le_of_dvd [`hn (Term.hole "_")])])
                 ","
                 (Term.hole "_")
                 ","
                 (Term.anonymousCtor "⟨" [(Finset.Data.Finset.Fold.«term_*_» `b "*" `x) "," `rfl] "⟩")]
                "⟩"))
              "<;>"
              (Tactic.«tactic_<;>_»
               (Tactic.use "use" [`y])
          ...
          (Tactic.tacticSeq1Indented
           [(group
             (Tactic.convert
              ...
              [])
             [])
            (group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `mul_powₓ)] "]") []) [])])))
        [])])))
   [])
  []
  []))
           ...
           (Tactic.tacticSeq
            (Tactic.tacticSeq1Indented
             [(group (Tactic.use "use" [(numLit "1")]) [])
              ...
              (group (Tactic.simpa "simpa" [] [] ["[" [(Tactic.simpLemma [] [] `S)] "]"] [] []) [])]))))))
       [])
      (group (Tactic.tacticLet_ "let" (Term.letDecl (Term.letIdDecl `s [] ":=" (Term.app `Finset.max' [`S `hSne])))) [])
      (group
       (Tactic.tacticHave_
        "have"
        (Term.haveDecl
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `mul_powₓ)] "]") [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `mul_powₓ
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Finset.Data.Finset.Fold.«term_*_» `b "*" `x)
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `le_of_dvd [`hn (Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `le_of_dvd [`hn (Term.hole "_")]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `lt_succ_iff.mpr
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Finset.Data.Finset.Fold.«term_*_» `b "*" `x) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 0, (some 0, term) <=? (some 1023, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Cardinal.SetTheory.Cardinal.«term_^_»
   (Term.paren "(" [(Finset.Data.Finset.Fold.«term_*_» `b "*" `x) []] ")")
   "^"
   (numLit "2"))
  []]
 ")")
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `pow_pos_iff [`zero_lt_two]) "." `mp)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `pow_pos_iff [`zero_lt_two])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `pow_pos_iff [`zero_lt_two]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `canonically_ordered_comm_semiring.mul_pos.mp
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
           ...
           (Term.haveDecl
            (Term.haveIdDecl
             ...
             (Term.anonymousCtor
              ...
              [`hn
               ","
               (Term.anonymousCtor "⟨" [(numLit "1") "," (Term.proj (Term.app `one_pow [(numLit "2")]) "." `symm)] "⟩")]
              "⟩"))))
          [])
         (group (Tactic.simpa "simpa" [] [] ["[" [(Tactic.simpLemma [] [] `S)] "]"] [] []) [])]))))))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticHave_', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.simpa "simpa" [] [] ["[" [(Tactic.simpLemma [] [] `S)] "]"] [] [])
  ...
  (Tactic.tacticHave_
   ...
   (Term.haveDecl
    (Term.haveIdDecl
     ...
     (Term.anonymousCtor
      "⟨"
      [`hn "," (Term.anonymousCtor "⟨" [(numLit "1") "," (Term.proj (Term.app `one_pow [(numLit "2")]) "." `symm)] "⟩")]
      "⟩"))))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticHave_', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.haveDecl', expected 'Lean.Parser.Term.haveDecl.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.haveIdDecl', expected 'Lean.Parser.Term.haveIdDecl.antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Term.app `one_pow [(numLit "2")]) "." `symm)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `one_pow [(numLit "2")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'numLit', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'numLit', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'numLit', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `one_pow [(numLit "2")]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
      ...
      let S := { s ∈ Finset.range n + 1 | s ∣ n ∧ ∃ x , s = x ^ 2 }
        have
          hSne
            : S.nonempty
            :=
            by use 1 have h1 : 0 < n ∧ ∃ x : ℕ , 1 = x ^ 2 := ⟨ hn , ⟨ 1 , one_pow 2 . symm ⟩ ⟩ simpa [ S ]
