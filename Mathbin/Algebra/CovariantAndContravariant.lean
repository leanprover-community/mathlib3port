...
but is expected to have type
  forall {M : Type.{u2}} {N : Type.{u1}} {μ : M -> N -> N} [_inst_2 : Preorder.{u1} N] [_inst_3 : CovariantClass.{u2, u1} M N μ (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.1467 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.1469 : N) => LE.le.{u1} N (Preorder.toLE.{u1} N _inst_2) x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.1467 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.1469)] (m : M), Monotone.{u1, u1} N N _inst_2 _inst_2 (μ m)
...
but is expected to have type
  forall {M : Type.{u3}} {N : Type.{u2}} {μ : M -> N -> N} {α : Type.{u1}} [_inst_1 : Preorder.{u1} α] [_inst_2 : Preorder.{u2} N] {f : N -> α} [_inst_3 : CovariantClass.{u3, u2} M N μ (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.1530 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.1532 : N) => LE.le.{u2} N (Preorder.toLE.{u2} N _inst_2) x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.1530 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.1532)], (Monotone.{u2, u1} N α _inst_2 _inst_1 f) -> (forall (m : M), Monotone.{u2, u1} N α _inst_2 _inst_1 (fun (n : N) => f (μ m n)))
...
but is expected to have type
  forall {N : Type.{u2}} {α : Type.{u1}} [_inst_1 : Preorder.{u1} α] [_inst_2 : Preorder.{u2} N] {f : N -> α} {μ : N -> N -> N} [_inst_3 : CovariantClass.{u2, u2} N N (Function.swap.{succ u2, succ u2, succ u2} N N (fun (ᾰ : N) (ᾰ : N) => N) μ) (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.1611 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.1613 : N) => LE.le.{u2} N (Preorder.toLE.{u2} N _inst_2) x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.1611 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.1613)], (Monotone.{u2, u1} N α _inst_2 _inst_1 f) -> (forall (m : N), Monotone.{u2, u1} N α _inst_2 _inst_1 (fun (n : N) => f (μ n m)))
...
but is expected to have type
  forall {M : Type.{u3}} {N : Type.{u2}} {μ : M -> N -> N} {α : Type.{u1}} [_inst_1 : Preorder.{u1} α] [_inst_2 : Preorder.{u2} N] {f : N -> α} [_inst_3 : CovariantClass.{u3, u2} M N μ (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.1692 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.1694 : N) => LE.le.{u2} N (Preorder.toLE.{u2} N _inst_2) x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.1692 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.1694)], (Antitone.{u2, u1} N α _inst_2 _inst_1 f) -> (forall (m : M), Antitone.{u2, u1} N α _inst_2 _inst_1 (fun (n : N) => f (μ m n)))
...
but is expected to have type
  forall {N : Type.{u2}} {α : Type.{u1}} [_inst_1 : Preorder.{u1} α] [_inst_2 : Preorder.{u2} N] {f : N -> α} {μ : N -> N -> N} [_inst_3 : CovariantClass.{u2, u2} N N (Function.swap.{succ u2, succ u2, succ u2} N N (fun (ᾰ : N) (ᾰ : N) => N) μ) (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.1765 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.1767 : N) => LE.le.{u2} N (Preorder.toLE.{u2} N _inst_2) x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.1765 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.1767)], (Antitone.{u2, u1} N α _inst_2 _inst_1 f) -> (forall (m : N), Antitone.{u2, u1} N α _inst_2 _inst_1 (fun (n : N) => f (μ n m)))
...
but is expected to have type
  forall (N : Type.{u1}) (r : N -> N -> Prop) [_inst_1 : CommSemigroup.{u1} N], Iff (Covariant.{u1, u1} N N (flip.{succ u1, succ u1, succ u1} N N N (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2272 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2274 : N) => HMul.hMul.{u1, u1, u1} N N N (instHMul.{u1} N (Semigroup.toMul.{u1} N (CommSemigroup.toSemigroup.{u1} N _inst_1))) x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2272 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2274)) r) (Covariant.{u1, u1} N N (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2291 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2293 : N) => HMul.hMul.{u1, u1, u1} N N N (instHMul.{u1} N (Semigroup.toMul.{u1} N (CommSemigroup.toSemigroup.{u1} N _inst_1))) x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2291 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2293) r)
...
but is expected to have type
  forall (N : Type.{u1}) (r : N -> N -> Prop) [_inst_1 : CommSemigroup.{u1} N], Iff (Contravariant.{u1, u1} N N (flip.{succ u1, succ u1, succ u1} N N N (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2360 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2362 : N) => HMul.hMul.{u1, u1, u1} N N N (instHMul.{u1} N (Semigroup.toMul.{u1} N (CommSemigroup.toSemigroup.{u1} N _inst_1))) x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2360 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2362)) r) (Contravariant.{u1, u1} N N (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2379 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2381 : N) => HMul.hMul.{u1, u1, u1} N N N (instHMul.{u1} N (Semigroup.toMul.{u1} N (CommSemigroup.toSemigroup.{u1} N _inst_1))) x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2379 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2381) r)
...
but is expected to have type
  forall (N : Type.{u1}) [_inst_1 : CommSemigroup.{u1} N] [_inst_2 : LE.{u1} N] [_inst_3 : CovariantClass.{u1, u1} N N (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2670 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2672 : N) => HMul.hMul.{u1, u1, u1} N N N (instHMul.{u1} N (Semigroup.toMul.{u1} N (CommSemigroup.toSemigroup.{u1} N _inst_1))) x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2670 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2672) (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2685 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2687 : N) => LE.le.{u1} N _inst_2 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2685 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2687)], CovariantClass.{u1, u1} N N (Function.swap.{succ u1, succ u1, succ u1} N N (fun (ᾰ : N) (ᾰ : N) => N) (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2706 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2708 : N) => HMul.hMul.{u1, u1, u1} N N N (instHMul.{u1} N (Semigroup.toMul.{u1} N (CommSemigroup.toSemigroup.{u1} N _inst_1))) x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2706 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2708)) (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2721 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2723 : N) => LE.le.{u1} N _inst_2 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2721 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2723)
...
but is expected to have type
  forall (N : Type.{u1}) [_inst_1 : CommSemigroup.{u1} N] [_inst_2 : LE.{u1} N] [_inst_3 : ContravariantClass.{u1, u1} N N (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2784 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2786 : N) => HMul.hMul.{u1, u1, u1} N N N (instHMul.{u1} N (Semigroup.toMul.{u1} N (CommSemigroup.toSemigroup.{u1} N _inst_1))) x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2784 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2786) (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2799 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2801 : N) => LE.le.{u1} N _inst_2 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2799 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2801)], ContravariantClass.{u1, u1} N N (Function.swap.{succ u1, succ u1, succ u1} N N (fun (ᾰ : N) (ᾰ : N) => N) (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2820 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2822 : N) => HMul.hMul.{u1, u1, u1} N N N (instHMul.{u1} N (Semigroup.toMul.{u1} N (CommSemigroup.toSemigroup.{u1} N _inst_1))) x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2820 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2822)) (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2835 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2837 : N) => LE.le.{u1} N _inst_2 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2835 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2837)
...
but is expected to have type
  forall (N : Type.{u1}) [_inst_1 : CommSemigroup.{u1} N] [_inst_2 : LT.{u1} N] [_inst_3 : ContravariantClass.{u1, u1} N N (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2898 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2900 : N) => HMul.hMul.{u1, u1, u1} N N N (instHMul.{u1} N (Semigroup.toMul.{u1} N (CommSemigroup.toSemigroup.{u1} N _inst_1))) x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2898 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2900) (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2913 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2915 : N) => LT.lt.{u1} N _inst_2 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2913 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2915)], ContravariantClass.{u1, u1} N N (Function.swap.{succ u1, succ u1, succ u1} N N (fun (ᾰ : N) (ᾰ : N) => N) (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2934 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2936 : N) => HMul.hMul.{u1, u1, u1} N N N (instHMul.{u1} N (Semigroup.toMul.{u1} N (CommSemigroup.toSemigroup.{u1} N _inst_1))) x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2934 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2936)) (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2949 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2951 : N) => LT.lt.{u1} N _inst_2 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2949 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.2951)
...
but is expected to have type
  forall (N : Type.{u1}) [_inst_1 : CommSemigroup.{u1} N] [_inst_2 : LT.{u1} N] [_inst_3 : CovariantClass.{u1, u1} N N (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3012 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3014 : N) => HMul.hMul.{u1, u1, u1} N N N (instHMul.{u1} N (Semigroup.toMul.{u1} N (CommSemigroup.toSemigroup.{u1} N _inst_1))) x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3012 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3014) (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3027 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3029 : N) => LT.lt.{u1} N _inst_2 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3027 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3029)], CovariantClass.{u1, u1} N N (Function.swap.{succ u1, succ u1, succ u1} N N (fun (ᾰ : N) (ᾰ : N) => N) (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3048 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3050 : N) => HMul.hMul.{u1, u1, u1} N N N (instHMul.{u1} N (Semigroup.toMul.{u1} N (CommSemigroup.toSemigroup.{u1} N _inst_1))) x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3048 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3050)) (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3063 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3065 : N) => LT.lt.{u1} N _inst_2 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3063 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3065)
...
but is expected to have type
  forall (N : Type.{u1}) [_inst_1 : LeftCancelSemigroup.{u1} N] [_inst_2 : PartialOrder.{u1} N] [_inst_3 : CovariantClass.{u1, u1} N N (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3129 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3131 : N) => HMul.hMul.{u1, u1, u1} N N N (instHMul.{u1} N (Semigroup.toMul.{u1} N (LeftCancelSemigroup.toSemigroup.{u1} N _inst_1))) x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3129 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3131) (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3144 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3146 : N) => LE.le.{u1} N (Preorder.toLE.{u1} N (PartialOrder.toPreorder.{u1} N _inst_2)) x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3144 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3146)], CovariantClass.{u1, u1} N N (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3162 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3164 : N) => HMul.hMul.{u1, u1, u1} N N N (instHMul.{u1} N (Semigroup.toMul.{u1} N (LeftCancelSemigroup.toSemigroup.{u1} N _inst_1))) x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3162 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3164) (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3177 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3179 : N) => LT.lt.{u1} N (Preorder.toLT.{u1} N (PartialOrder.toPreorder.{u1} N _inst_2)) x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3177 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3179)
...
but is expected to have type
  forall (N : Type.{u1}) [_inst_1 : RightCancelSemigroup.{u1} N] [_inst_2 : PartialOrder.{u1} N] [_inst_3 : CovariantClass.{u1, u1} N N (Function.swap.{succ u1, succ u1, succ u1} N N (fun (ᾰ : N) (ᾰ : N) => N) (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3254 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3256 : N) => HMul.hMul.{u1, u1, u1} N N N (instHMul.{u1} N (Semigroup.toMul.{u1} N (RightCancelSemigroup.toSemigroup.{u1} N _inst_1))) x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3254 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3256)) (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3269 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3271 : N) => LE.le.{u1} N (Preorder.toLE.{u1} N (PartialOrder.toPreorder.{u1} N _inst_2)) x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3269 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3271)], CovariantClass.{u1, u1} N N (Function.swap.{succ u1, succ u1, succ u1} N N (fun (ᾰ : N) (ᾰ : N) => N) (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3290 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3292 : N) => HMul.hMul.{u1, u1, u1} N N N (instHMul.{u1} N (Semigroup.toMul.{u1} N (RightCancelSemigroup.toSemigroup.{u1} N _inst_1))) x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3290 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3292)) (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3305 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3307 : N) => LT.lt.{u1} N (Preorder.toLT.{u1} N (PartialOrder.toPreorder.{u1} N _inst_2)) x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3305 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3307)
...
but is expected to have type
  forall (N : Type.{u1}) [_inst_1 : LeftCancelSemigroup.{u1} N] [_inst_2 : PartialOrder.{u1} N] [_inst_3 : ContravariantClass.{u1, u1} N N (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3379 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3381 : N) => HMul.hMul.{u1, u1, u1} N N N (instHMul.{u1} N (Semigroup.toMul.{u1} N (LeftCancelSemigroup.toSemigroup.{u1} N _inst_1))) x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3379 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3381) (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3394 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3396 : N) => LT.lt.{u1} N (Preorder.toLT.{u1} N (PartialOrder.toPreorder.{u1} N _inst_2)) x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3394 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3396)], ContravariantClass.{u1, u1} N N (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3412 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3414 : N) => HMul.hMul.{u1, u1, u1} N N N (instHMul.{u1} N (Semigroup.toMul.{u1} N (LeftCancelSemigroup.toSemigroup.{u1} N _inst_1))) x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3412 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3414) (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3427 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3429 : N) => LE.le.{u1} N (Preorder.toLE.{u1} N (PartialOrder.toPreorder.{u1} N _inst_2)) x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3427 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3429)
...
but is expected to have type
  forall (N : Type.{u1}) [_inst_1 : RightCancelSemigroup.{u1} N] [_inst_2 : PartialOrder.{u1} N] [_inst_3 : ContravariantClass.{u1, u1} N N (Function.swap.{succ u1, succ u1, succ u1} N N (fun (ᾰ : N) (ᾰ : N) => N) (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3513 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3515 : N) => HMul.hMul.{u1, u1, u1} N N N (instHMul.{u1} N (Semigroup.toMul.{u1} N (RightCancelSemigroup.toSemigroup.{u1} N _inst_1))) x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3513 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3515)) (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3528 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3530 : N) => LT.lt.{u1} N (Preorder.toLT.{u1} N (PartialOrder.toPreorder.{u1} N _inst_2)) x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3528 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3530)], ContravariantClass.{u1, u1} N N (Function.swap.{succ u1, succ u1, succ u1} N N (fun (ᾰ : N) (ᾰ : N) => N) (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3549 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3551 : N) => HMul.hMul.{u1, u1, u1} N N N (instHMul.{u1} N (Semigroup.toMul.{u1} N (RightCancelSemigroup.toSemigroup.{u1} N _inst_1))) x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3549 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3551)) (fun (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3564 : N) (x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3566 : N) => LE.le.{u1} N (Preorder.toLE.{u1} N (PartialOrder.toPreorder.{u1} N _inst_2)) x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3564 x._@.Mathlib.Algebra.CovariantAndContravariant._hyg.3566)
