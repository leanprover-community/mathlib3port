...
/- warning: pos_mul_mono -> PosMulMono is a dubious translation:
...
/- warning: pos_mul_strict_mono -> PosMulStrictMono is a dubious translation:
lean 3 declaration is
  forall (α : Type.{u_1}) [_inst_1 : Mul.{u_1} α] [_inst_2 : Zero.{u_1} α] [_inst_3 : Preorder.{u_1} α], Prop
but is expected to have type
...
theorem pos_mul_strict_mono_iff_pos_mul_mono_rev : PosMulStrictMono α ↔ PosMulMonoRev α :=
  ⟨@PosMulStrictMono.to_pos_mul_mono_rev _ _ _ _, @PosMulMonoRev.toPosMulStrictMono _ _ _ _⟩
