...
theorem AddHom.le_map_tsub [Preorder β] [Add β] [Sub β] [HasOrderedSub β] (f : AddHom α β)
...
theorem le_mul_tsub {R : Type _} [Distrib R] [Preorder R] [Sub R] [HasOrderedSub R]
...
theorem OrderIso.map_tsub {M N : Type _} [Preorder M] [Add M] [Sub M] [HasOrderedSub M]
    [PartialOrder N] [Add N] [Sub N] [HasOrderedSub N] (e : M ≃o N)
...
theorem AddMonoidHom.le_map_tsub [Preorder β] [AddCommMonoid β] [Sub β] [HasOrderedSub β]
    (f : α →+ β) (hf : Monotone f) (a b : α) : f a - f b ≤ f (a - b) :=
