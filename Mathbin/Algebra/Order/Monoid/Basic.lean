...
but is expected to have type
  forall (M : Type.{u_1}) [inst._@.Mathlib.Algebra.Order.Monoid._hyg.77 : OrderedCommMonoid.{u_1} M], CovariantClass.{u_1 u_1} M M (fun (a._@.Mathlib.Algebra.Order.Monoid._hyg.85 : M) (a._@.Mathlib.Algebra.Order.Monoid._hyg.86 : M) => HMul.hMul.{u_1 u_1 u_1} M M M (instHMul.{u_1} M (MulOneClass.toMul.{u_1} M (Monoid.toMulOneClass.{u_1} M (CommMonoid.toMonoid.{u_1} M (OrderedCommMonoid.toCommMonoid.{u_1} M inst._@.Mathlib.Algebra.Order.Monoid._hyg.77))))) a._@.Mathlib.Algebra.Order.Monoid._hyg.85 a._@.Mathlib.Algebra.Order.Monoid._hyg.86) (fun (a._@.Mathlib.Algebra.Order.Monoid._hyg.98 : M) (a._@.Mathlib.Algebra.Order.Monoid._hyg.99 : M) => LE.le.{u_1} M (Preorder.toLE.{u_1} M (PartialOrder.toPreorder.{u_1} M (OrderedCommMonoid.toPartialOrder.{u_1} M inst._@.Mathlib.Algebra.Order.Monoid._hyg.77))) a._@.Mathlib.Algebra.Order.Monoid._hyg.98 a._@.Mathlib.Algebra.Order.Monoid._hyg.99)
...
but is expected to have type
  forall (M : Type.{u_1}) [inst._@.Mathlib.Algebra.Order.Monoid._hyg.133 : OrderedCommMonoid.{u_1} M], CovariantClass.{u_1 u_1} M M (Function.swap.{succ u_1 succ u_1 succ u_1} M M (fun (a._@.Mathlib.Algebra.CovariantAndContravariant._hyg.110 : M) (a._@.Mathlib.Algebra.CovariantAndContravariant._hyg.108 : M) => M) (fun (a._@.Mathlib.Algebra.Order.Monoid._hyg.144 : M) (a._@.Mathlib.Algebra.Order.Monoid._hyg.145 : M) => HMul.hMul.{u_1 u_1 u_1} M M M (instHMul.{u_1} M (MulOneClass.toMul.{u_1} M (Monoid.toMulOneClass.{u_1} M (CommMonoid.toMonoid.{u_1} M (OrderedCommMonoid.toCommMonoid.{u_1} M inst._@.Mathlib.Algebra.Order.Monoid._hyg.133))))) a._@.Mathlib.Algebra.Order.Monoid._hyg.144 a._@.Mathlib.Algebra.Order.Monoid._hyg.145)) (fun (a._@.Mathlib.Algebra.Order.Monoid._hyg.157 : M) (a._@.Mathlib.Algebra.Order.Monoid._hyg.158 : M) => LE.le.{u_1} M (Preorder.toLE.{u_1} M (PartialOrder.toPreorder.{u_1} M (OrderedCommMonoid.toPartialOrder.{u_1} M inst._@.Mathlib.Algebra.Order.Monoid._hyg.133))) a._@.Mathlib.Algebra.Order.Monoid._hyg.157 a._@.Mathlib.Algebra.Order.Monoid._hyg.158)
