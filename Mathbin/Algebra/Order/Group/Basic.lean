...
but is expected to have type
  forall {α : Type.{u_1}} [inst._@.Mathlib.Algebra.Order.Group._hyg.78 : OrderedCommGroup.{u_1} α], CovariantClass.{u_1 u_1} α α (fun (a._@.Mathlib.Algebra.Order.Group._hyg.86 : α) (a._@.Mathlib.Algebra.Order.Group._hyg.87 : α) => HMul.hMul.{u_1 u_1 u_1} α α α (instHMul.{u_1} α (MulOneClass.toMul.{u_1} α (Monoid.toMulOneClass.{u_1} α (DivInvMonoid.toMonoid.{u_1} α (Group.toDivInvMonoid.{u_1} α (CommGroup.toGroup.{u_1} α (OrderedCommGroup.toCommGroup.{u_1} α inst._@.Mathlib.Algebra.Order.Group._hyg.78))))))) a._@.Mathlib.Algebra.Order.Group._hyg.86 a._@.Mathlib.Algebra.Order.Group._hyg.87) (fun (a._@.Mathlib.Algebra.Order.Group._hyg.99 : α) (a._@.Mathlib.Algebra.Order.Group._hyg.100 : α) => LE.le.{u_1} α (Preorder.toLE.{u_1} α (PartialOrder.toPreorder.{u_1} α (OrderedCommGroup.toPartialOrder.{u_1} α inst._@.Mathlib.Algebra.Order.Group._hyg.78))) a._@.Mathlib.Algebra.Order.Group._hyg.99 a._@.Mathlib.Algebra.Order.Group._hyg.100)
...
but is expected to have type
  forall {α : Type.{u_1}} [inst._@.Mathlib.Algebra.Order.Group._hyg.227 : Group.{u_1} α] [inst._@.Mathlib.Algebra.Order.Group._hyg.230 : LT.{u_1} α] [inst._@.Mathlib.Algebra.Order.Group._hyg.233 : CovariantClass.{u_1 u_1} α α (fun (a._@.Mathlib.Algebra.Order.Group._hyg.239 : α) (a._@.Mathlib.Algebra.Order.Group._hyg.240 : α) => HMul.hMul.{u_1 u_1 u_1} α α α (instHMul.{u_1} α (MulOneClass.toMul.{u_1} α (Monoid.toMulOneClass.{u_1} α (DivInvMonoid.toMonoid.{u_1} α (Group.toDivInvMonoid.{u_1} α inst._@.Mathlib.Algebra.Order.Group._hyg.227))))) a._@.Mathlib.Algebra.Order.Group._hyg.239 a._@.Mathlib.Algebra.Order.Group._hyg.240) (fun (a._@.Mathlib.Algebra.Order.Group._hyg.252 : α) (a._@.Mathlib.Algebra.Order.Group._hyg.253 : α) => LT.lt.{u_1} α inst._@.Mathlib.Algebra.Order.Group._hyg.230 a._@.Mathlib.Algebra.Order.Group._hyg.252 a._@.Mathlib.Algebra.Order.Group._hyg.253)] {a : α}, Iff (LT.lt.{u_1} α inst._@.Mathlib.Algebra.Order.Group._hyg.230 (OfNat.ofNat.{u_1} α 1 (One.toOfNat1.{u_1} α (InvOneClass.toOne.{u_1} α (DivInvOneMonoid.toInvOneClass.{u_1} α (DivisionMonoid.toDivInvOneMonoid.{u_1} α (Group.toDivisionMonoid.{u_1} α inst._@.Mathlib.Algebra.Order.Group._hyg.227)))))) (Inv.inv.{u_1} α (InvOneClass.toInv.{u_1} α (DivInvOneMonoid.toInvOneClass.{u_1} α (DivisionMonoid.toDivInvOneMonoid.{u_1} α (Group.toDivisionMonoid.{u_1} α inst._@.Mathlib.Algebra.Order.Group._hyg.227)))) a)) (LT.lt.{u_1} α inst._@.Mathlib.Algebra.Order.Group._hyg.230 a (OfNat.ofNat.{u_1} α 1 (One.toOfNat1.{u_1} α (InvOneClass.toOne.{u_1} α (DivInvOneMonoid.toInvOneClass.{u_1} α (DivisionMonoid.toDivInvOneMonoid.{u_1} α (Group.toDivisionMonoid.{u_1} α inst._@.Mathlib.Algebra.Order.Group._hyg.227)))))))
...
theorem Left.one_lt_inv_iff : 1 < a⁻¹ ↔ a < 1 := by rw [← mul_lt_mul_iff_left a, mul_inv_self, mul_one]

/-- Uses `left` co(ntra)variant. -/
@[simp, to_additive Left.neg_neg_iff "Uses `left` co(ntra)variant."]
theorem Left.inv_lt_one_iff : a⁻¹ < 1 ↔ 1 < a := by rw [← mul_lt_mul_iff_left a, mul_inv_self, mul_one]
...
but is expected to have type
  forall {α : Type.{u_1}} [inst._@.Mathlib.Algebra.Order.Group._hyg.373 : Group.{u_1} α] [inst._@.Mathlib.Algebra.Order.Group._hyg.376 : LT.{u_1} α] [inst._@.Mathlib.Algebra.Order.Group._hyg.379 : CovariantClass.{u_1 u_1} α α (Function.swap.{succ u_1 succ u_1 succ u_1} α α (fun (a._@.Mathlib.Algebra.CovariantAndContravariant._hyg.110 : α) (a._@.Mathlib.Algebra.CovariantAndContravariant._hyg.108 : α) => α) (fun (a._@.Mathlib.Algebra.Order.Group._hyg.388 : α) (a._@.Mathlib.Algebra.Order.Group._hyg.389 : α) => HMul.hMul.{u_1 u_1 u_1} α α α (instHMul.{u_1} α (MulOneClass.toMul.{u_1} α (Monoid.toMulOneClass.{u_1} α (DivInvMonoid.toMonoid.{u_1} α (Group.toDivInvMonoid.{u_1} α inst._@.Mathlib.Algebra.Order.Group._hyg.373))))) a._@.Mathlib.Algebra.Order.Group._hyg.388 a._@.Mathlib.Algebra.Order.Group._hyg.389)) (fun (a._@.Mathlib.Algebra.Order.Group._hyg.401 : α) (a._@.Mathlib.Algebra.Order.Group._hyg.402 : α) => LT.lt.{u_1} α inst._@.Mathlib.Algebra.Order.Group._hyg.376 a._@.Mathlib.Algebra.Order.Group._hyg.401 a._@.Mathlib.Algebra.Order.Group._hyg.402)] {a : α} {b : α}, Iff (LT.lt.{u_1} α inst._@.Mathlib.Algebra.Order.Group._hyg.376 (OfNat.ofNat.{u_1} α 1 (One.toOfNat1.{u_1} α (InvOneClass.toOne.{u_1} α (DivInvOneMonoid.toInvOneClass.{u_1} α (DivisionMonoid.toDivInvOneMonoid.{u_1} α (Group.toDivisionMonoid.{u_1} α inst._@.Mathlib.Algebra.Order.Group._hyg.373)))))) (HDiv.hDiv.{u_1 u_1 u_1} α α α (instHDiv.{u_1} α (DivInvMonoid.toDiv.{u_1} α (Group.toDivInvMonoid.{u_1} α inst._@.Mathlib.Algebra.Order.Group._hyg.373))) a b)) (LT.lt.{u_1} α inst._@.Mathlib.Algebra.Order.Group._hyg.376 b a)
...
@[simp, to_additive]
theorem div_le_div_flip {α : Type _} [CommGroup α] [LinearOrder α] [CovariantClass α α (· * ·) (· ≤ ·)] {a b : α} :
    a / b ≤ b / a ↔ a ≤ b := by
...
@[protect_proj]
class LinearOrderedAddCommGroupWithTop (α : Type _) extends LinearOrderedAddCommMonoidWithTop α, SubNegMonoid α,
  Nontrivial α where
  neg_top : -(⊤ : α) = ⊤
...
def mkOfPositiveCone {α : Type _} [AddCommGroup α] (C : TotalPositiveCone α) : LinearOrderedAddCommGroup α :=
