...
#align
  ideal.torsion_of_eq_bot_iff_of_no_zero_smul_divisors Ideal.torsion_of_eq_bot_iff_of_no_zero_smul_divisors
...
theorem CompleteLattice.Independent.linear_independent' {ι R M : Type _} {v : ι → M} [Ring R]
  ...
  simpa using this
#align
  ideal.complete_lattice.independent.linear_independent' Ideal.CompleteLattice.Independent.linear_independent'
...
theorem quot_torsion_of_equiv_span_singleton_apply_mk (x : M) (a : R) :
  ...
  rfl
#align
  ideal.quot_torsion_of_equiv_span_singleton_apply_mk Ideal.quot_torsion_of_equiv_span_singleton_apply_mk
...
theorem is_torsion_by_set_iff_torsion_by_set_eq_top :
  ...
  ⟨fun h => eq_top_iff.mpr fun _ _ => (mem_torsion_by_set_iff _ _).mpr <| @h _, fun h x => by
    ...
    trivial⟩
#align
  module.is_torsion_by_set_iff_torsion_by_set_eq_top Module.is_torsion_by_set_iff_torsion_by_set_eq_top
...
#align
  module.is_torsion_by_set_iff_is_torsion_by_span Module.is_torsion_by_set_iff_is_torsion_by_span
...
#align
  submodule.supr_torsion_by_ideal_eq_torsion_by_infi Submodule.supr_torsion_by_ideal_eq_torsion_by_infi

theorem supIndepTorsionByIdeal : S.SupIndep fun i => torsionBySet R M <| p i := fun T hT i hi hiT =>
  by
...
#align submodule.sup_indep_torsion_by_ideal Submodule.supIndepTorsionByIdeal
...
theorem supIndepTorsionBy : S.SupIndep fun i => torsionBy R M <| q i := by
  convert
...
#align submodule.sup_indep_torsion_by Submodule.supIndepTorsionBy
...
theorem torsion_by_set_is_internal {p : ι → Ideal R}
  ...
  DirectSum.is_internal_submodule_of_independent_of_supr_eq_top
    (CompleteLattice.independent_iff_sup_indep.mpr <| supIndepTorsionByIdeal hp)
...
def IsTorsionBySet.hasSmul :
    HasSmul (R ⧸ I) M where smul b x :=
    (Quotient.liftOn' b (· • x)) fun b₁ b₂ h => by
      show b₁ • x = b₂ • x
...
instance IsTorsionBySet.is_scalar_tower {S : Type _} [HasSmul S R] [HasSmul S M]
    ...
    @IsScalarTower S (R ⧸ I) M _ (IsTorsionBySet.module hM).toHasSmul
      _ where smul_assoc b d x := (Quotient.inductionOn' d) fun c => (smul_assoc b c x : _)
...
#align
  submodule.is_torsion_by_ideal_of_finite_of_is_torsion Submodule.is_torsion_by_ideal_of_finite_of_is_torsion
...
#align
  submodule.no_zero_smul_divisors_iff_torsion_eq_bot Submodule.no_zero_smul_divisors_iff_torsion_eq_bot
