...
structure LinearEquiv {R : Type _} {S : Type _} [Semiring R] [Semiring S] (σ : R →+* S) {σ' : S →+* R}
  [RingHomInvPair σ σ'] [RingHomInvPair σ' σ] (M : Type _) (M₂ : Type _) [AddCommMonoid M] [AddCommMonoid M₂]
...
-/
abbrev LinearEquivClass (F : Type _) (R M M₂ : outParam (Type _)) [Semiring R] [AddCommMonoid M] [AddCommMonoid M₂]
...
theorem coe_trans : (e₁₂.trans e₂₃ : M₁ →ₛₗ[σ₁₃] M₃) = (e₂₃ : M₂ →ₛₗ[σ₂₃] M₃).comp (e₁₂ : M₁ →ₛₗ[σ₁₂] M₂) :=
  rfl
...
#align
  add_equiv._root_.linear_equiv.to_add_equiv_to_nat_linear_equiv add_equiv._root_.linear_equiv.to_add_equiv_to_nat_linear_equiv
...
theorem _root_.linear_equiv.to_add_equiv_to_int_linear_equiv (e : M ≃ₗ[ℤ] M₂) : e.toAddEquiv.toIntLinearEquiv = e :=
  FunLike.coe_injective rfl
#align
  add_equiv._root_.linear_equiv.to_add_equiv_to_int_linear_equiv add_equiv._root_.linear_equiv.to_add_equiv_to_int_linear_equiv
