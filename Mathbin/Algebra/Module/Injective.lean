...
theorem Module.injectiveModuleOfInjectiveObject
    [CategoryTheory.Injective.{max u v} (⟨Q⟩ : ModuleCat.{max u v} R)] :
...
an `R`-linear map `R ⟶ Q`-/
def Module.BaerCat : Prop :=
  ∀ (I : Ideal R) (g : I →ₗ[R] Q), ∃ g' : R →ₗ[R] Q, ∀ (x : R) (mem : x ∈ I), g' x = g ⟨x, mem⟩
#align module.Baer Module.BaerCat

namespace Module.BaerCat
...
#align module.Baer.extension_of Module.BaerCat.ExtensionOf
...
#align module.Baer.extension_of.ext Module.BaerCat.ExtensionOf.ext
...
#align module.Baer.chain_linear_pmap_of_chain_extension_of Module.BaerCat.chain_linearPmap_of_chain_extensionOf
...
#align module.Baer.extension_of.inhabited Module.BaerCat.ExtensionOf.inhabited
...
#align module.Baer.extension_of_max_is_max Module.BaerCat.extensionOfMax_is_max
...
#align module.Baer.extension_of_max_adjoin.fst Module.BaerCat.ExtensionOfMaxAdjoin.fst
...
#align module.Baer.extension_of_max_adjoin.snd Module.BaerCat.ExtensionOfMaxAdjoin.snd
...
#align module.Baer.extension_of_max_adjoin.eqn Module.BaerCat.ExtensionOfMaxAdjoin.eqn
...
#align module.Baer.extension_of_max_adjoin.ideal Module.BaerCat.ExtensionOfMaxAdjoin.ideal
...
#align module.Baer.extension_of_max_adjoin.ideal_to Module.BaerCat.ExtensionOfMaxAdjoin.idealTo
...
theorem ExtensionOfMaxAdjoin.extendIdealTo_is_extension (h : Module.BaerCat R Q) (y : N) :
...
#align module.Baer.extension_of_max_adjoin.extend_ideal_to_is_extension Module.BaerCat.ExtensionOfMaxAdjoin.extendIdealTo_is_extension

theorem ExtensionOfMaxAdjoin.extendIdealTo_wd' (h : Module.BaerCat R Q) {y : N} (r : R)
...
#align module.Baer.extension_of_max_adjoin.extend_ideal_to_wd' Module.BaerCat.ExtensionOfMaxAdjoin.extendIdealTo_wd'

theorem ExtensionOfMaxAdjoin.extendIdealTo_wd (h : Module.BaerCat R Q) {y : N} (r r' : R)
    (eq1 : r • y = r' • y) :
...
theorem ExtensionOfMaxAdjoin.extendIdealTo_eq (h : Module.BaerCat R Q) {y : N} (r : R)
...
#align module.Baer.extension_of_max_adjoin.extend_ideal_to_eq Module.BaerCat.ExtensionOfMaxAdjoin.extendIdealTo_eq

/-- We can finally define a linear map `M ⊔ ⟨y⟩ ⟶ Q` by `x + r • y ↦ f x + φ r`
-/
def ExtensionOfMaxAdjoin.extensionToFun (h : Module.BaerCat R Q) {y : N} :
...
theorem ExtensionOfMaxAdjoin.extensionToFun_wd (h : Module.BaerCat R Q) {y : N}
...
#align module.Baer.extension_of_max_adjoin.extension_to_fun_wd Module.BaerCat.ExtensionOfMaxAdjoin.extensionToFun_wd
...
theorem extensionOfMax_le (h : Module.BaerCat R Q) {y : N} :
  ...
  ⟨le_sup_left, fun x x' EQ => by
    ...
    rw [extension_of_max_adjoin.extension_to_fun_wd i f h x' x 0 (by simp [EQ]), map_zero,
      add_zero]⟩
#align module.Baer.extension_of_max_le Module.BaerCat.extensionOfMax_le

theorem extensionOfMax_to_submodule_eq_top (h : Module.BaerCat R Q) :
    (extensionOfMax i f).domain = ⊤ :=
  by
...
#align module.Baer.extension_of_max_to_submodule_eq_top Module.BaerCat.extensionOfMax_to_submodule_eq_top
...
#align module.Baer.injective Module.BaerCat.injective
