...
/- ./././Mathport/Syntax/Translate/Tactic/Builtin.lean:65:38: in transitivity #[[expr «expr • »(«expr • »(u₁, «expr • »(t₁, a₁)), «expr • »(u₂, «expr • »(t₂, a₂)))]]: ./././Mathport/Syntax/Translate/Tactic/Basic.lean:55:35: expecting parse arg -/
