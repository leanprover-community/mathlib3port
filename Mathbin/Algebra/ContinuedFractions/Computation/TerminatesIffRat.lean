...
#print GenContFract.exists_gcf_pair_rat_eq_of_nth_contsAux /-
theorem exists_gcf_pair_rat_eq_of_nth_contsAux :
    ∃ conts : Pair ℚ, (of v).contsAux n = (conts.map coe : Pair K) :=
...
#print GenContFract.exists_gcf_pair_rat_eq_nth_conts /-
theorem exists_gcf_pair_rat_eq_nth_conts :
    ∃ conts : Pair ℚ, (of v).conts n = (conts.map coe : Pair K) := by
...
#print GenContFract.exists_rat_eq_nth_num /-
theorem exists_rat_eq_nth_num : ∃ q : ℚ, (of v).nums n = (q : K) :=
  by
...
#print GenContFract.exists_rat_eq_nth_den /-
theorem exists_rat_eq_nth_den : ∃ q : ℚ, (of v).dens n = (q : K) :=
  by
...
#print GenContFract.exists_rat_eq_nth_conv /-
/-- Every finite convergent corresponds to a rational number. -/
theorem exists_rat_eq_nth_conv : ∃ q : ℚ, (of v).convs n = (q : K) :=
  by
...
#print GenContFract.exists_rat_eq_of_terminates /-
/-- Every terminating continued fraction corresponds to a rational number. -/
theorem exists_rat_eq_of_terminates (terminates : (of v).Terminates) : ∃ q : ℚ, v = ↑q :=
  by
  obtain ⟨n, v_eq_conv⟩ : ∃ n, v = (of v).convs n; exact of_correctness_of_terminates terminates
  obtain ⟨q, conv_eq_q⟩ : ∃ q : ℚ, (of v).convs n = (↑q : K)
...
#print GenContFract.IntFractPair.coe_of_rat_eq /-
...
#print GenContFract.IntFractPair.coe_stream_nth_rat_eq /-
...
#print GenContFract.IntFractPair.coe_stream'_rat_eq /-
...
#print GenContFract.coe_of_h_rat_eq /-
...
#print GenContFract.coe_of_s_get?_rat_eq /-
...
#print GenContFract.coe_of_s_rat_eq /-
...
#print GenContFract.coe_of_rat_eq /-
/-- Given `(v : K), (q : ℚ), and v = q`, we have that `gcf.of q = gcf.of v` -/
theorem coe_of_rat_eq : (⟨(of q).h, (of q).s.map (Pair.map coe)⟩ : GenContFract K) = of v :=
  by
...
#print GenContFract.of_terminates_iff_of_rat_terminates /-
...
#print GenContFract.IntFractPair.of_inv_fr_num_lt_num_of_pos /-
...
#print GenContFract.IntFractPair.stream_succ_nth_fr_num_lt_nth_fr_num_rat /-
...
#print GenContFract.IntFractPair.stream_nth_fr_num_le_fr_num_sub_n_rat /-
...
#print GenContFract.IntFractPair.exists_nth_stream_eq_none_of_rat /-
...
#print GenContFract.terminates_of_rat /-
...
#print GenContFract.terminates_iff_rat /-
