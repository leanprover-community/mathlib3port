...
/- warning: generalized_continued_fraction.comp_exact_value_correctness_of_stream_eq_some_aux_comp -> GeneralizedContinuedFraction.compExactValue_correctness_of_stream_eq_some_aux_comp is a dubious translation:
...
Case conversion may be inaccurate. Consider using '#align generalized_continued_fraction.comp_exact_value_correctness_of_stream_eq_some_aux_comp GeneralizedContinuedFraction.compExactValue_correctness_of_stream_eq_some_aux_compₓ'. -/
