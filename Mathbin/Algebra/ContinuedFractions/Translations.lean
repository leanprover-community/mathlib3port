...
theorem terminated_at_iff_s_terminated_at : g.terminated_at n ↔ g.s.terminated_at n := by
  rfl

theorem terminated_at_iff_s_none : g.terminated_at n ↔ g.s.nth n = none := by
  rfl
