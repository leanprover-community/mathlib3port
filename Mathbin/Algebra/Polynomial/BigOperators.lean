...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `nat_degree_sum_le [])
  (Command.declSig
   [(Term.explicitBinder "(" [`f] [":" (Term.arrow `ι "→" (Term.app `Polynomial [`α]))] [] ")")]
   (Term.typeSpec
    ":"
    («term_≤_»
     (Term.app
      ...
      [(Algebra.BigOperators.Basic.«term∑_in_,_»
        ...
        (Term.app `f [`i]))])
     "≤"
     (Term.app `s.fold [`max (numLit "0") («term_∘_» `nat_degree "∘" `f)]))))
   ...
   (Term.byTactic
    ...
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.simpa "simpa" [] [] [] [] ["using" (Term.app `nat_degree_multiset_sum_le [(Term.app `s.val.map [`f])])])
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `nat_degree_multiset_sum_le [(Term.app `s.val.map [`f])])
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `s.val.map [`f]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(«term_∘_» `nat_degree "∘" `f) []] ")")
...
theorem
  nat_degree_sum_le
  ( f : ι → Polynomial α ) : nat_degree ∑ i in s , f i ≤ s.fold max 0 nat_degree ∘ f
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `nat_degree_prod_le [])
  (Command.declSig
   []
   (Term.typeSpec
    ":"
    («term_≤_»
     ...
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      ...
      `s
      ", "
      (Term.proj (Term.app `f [`i]) "." `natDegree)))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
        ...
        (Tactic.simpa
         ...
         ["using"
          (Term.app
           ...
           [(Term.app (Term.proj (Term.proj `s "." (fieldIdx "1")) "." `map) [`f])])])
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.simpa
   ...
   []
   ["using"
    (Term.app `nat_degree_multiset_prod_le [(Term.app (Term.proj (Term.proj `s "." (fieldIdx "1")) "." `map) [`f])])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simpa', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'optional.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `nat_degree_multiset_prod_le [(Term.app (Term.proj (Term.proj `s "." (fieldIdx "1")) "." `map) [`f])])
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.proj `s "." (fieldIdx "1")) "." `map)
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `leading_coeff_prod' [])
  (Command.declSig
   [(Term.explicitBinder
     "("
     [`h]
     [":"
      («term_≠_»
       (Algebra.BigOperators.Basic.«term∏_in_,_»
        ...
        `s
        ", "
        (Term.proj (Term.app `f [`i]) "." `leadingCoeff))
       "≠"
       (numLit "0"))]
     []
     ")")]
...
/--
  ...
  theorem
    leading_coeff_prod'
    ( h : ∏ i in s , f i . leadingCoeff ≠ 0 ) : ∏ i in s , f i . leadingCoeff = ∏ i in s , f i . leadingCoeff
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `nat_degree_prod' [])
  (Command.declSig
   [(Term.explicitBinder
     "("
     [`h]
...
/--
  ...
  theorem
    nat_degree_prod'
    ( h : ∏ i in s , f i . leadingCoeff ≠ 0 ) : ∏ i in s , f i . natDegree = ∑ i in s , f i . natDegree
...
theorem nat_degree_multiset_prod_of_monic [Nontrivial R] (h : ∀, ∀ f ∈ t, ∀, monic f) :
  ...
  suffices (t.map fun f => leading_coeff f).Prod = 1by
    rw [this]
    simp
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `nat_degree_prod_of_monic [])
  (Command.declSig
     ...
     [":"
      (Term.forall
       ...
       (Mathlib.ExtendedBinder.«term∀___,_»
        ...
        («binderTerm∈_» "∈" `s)
        ","
        (Term.forall "∀" [] "," (Term.proj (Term.app `f [`i]) "." `Monic))))]
     []
     ")")]
   (Term.typeSpec
    ":"
...
theorem
  ...
  [ Nontrivial R ] ( h : ∀ , ∀ i ∈ s , ∀ , f i . Monic ) : ∏ i in s , f i . natDegree = ∑ i in s , f i . natDegree
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `coeff_prod_of_nat_degree_le [])
  (Command.declSig
     ...
     [":"
      (Term.forall
       ...
       (Mathlib.ExtendedBinder.«term∀___,_»
        ...
        («binderTerm∈_» "∈" `s)
        ","
        (Term.forall "∀" [] "," («term_≤_» (Term.app `nat_degree [(Term.app `f [`p])]) "≤" `n))))]
     []
     ")")]
   (Term.typeSpec
    ":"
  ...
  (Command.declValSimple
   ...
   (Term.byTactic
    ...
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.cases' "cases'" [(Tactic.casesTarget [] `s)] [] ["with" [(Lean.binderIdent `l) (Lean.binderIdent `hl)]])
        [])
       (group
        (Tactic.convert
         "convert"
         []
         (Term.app `coeff_multiset_prod_of_nat_degree_le [(Term.app `l.map [`f]) (Term.hole "_") (Term.hole "_")])
         [])
        [])
       (group
        (Tactic.«tactic·._»
...
theorem
  ...
  ( f : ι → Polynomial R ) ( n : ℕ ) ( h : ∀ , ∀ p ∈ s , ∀ , nat_degree f p ≤ n )
    : coeff ∏ i in s , f i s.card * n = ∏ i in s , coeff f i n
  := by cases' s with l hl convert coeff_multiset_prod_of_nat_degree_le l.map f _ _ · simp · simp · simpa using h
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `coeff_zero_prod [])
  (Command.declSig
   []
   (Term.typeSpec
    ":"
    («term_=_»
     ...
     (Algebra.BigOperators.Basic.«term∏_in_,_»
      ...
      `s
      ", "
      (Term.app (Term.proj (Term.app `f [`i]) "." `coeff) [(numLit "0")])))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
    ...
    (Tactic.tacticSeq1Indented
     [(group
       (Tactic.simpa
        ...
        []
        ["using"
         (Term.app `coeff_zero_multiset_prod [(Term.app (Term.proj (Term.proj `s "." (fieldIdx "1")) "." `map) [`f])])])
       [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.byTactic', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.byTactic', expected 'Lean.Parser.Term.byTactic.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq', expected 'Lean.Parser.Tactic.tacticSeq.antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `prod_X_sub_C_next_coeff [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `Nontrivial [`R]) "]")
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'optional.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `multiset_prod_X_sub_C_next_coeff [(Term.app (Term.proj (Term.proj `s "." (fieldIdx "1")) "." `map) [`f])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
theorem
  ...
  [ Nontrivial R ] { s : Finset ι } ( f : ι → R ) : next_coeff ∏ i in s , X - C f i = - ∑ i in s , f i
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `prod_X_sub_C_coeff_card_pred [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `Nontrivial [`R]) "]")
    (Term.explicitBinder "(" [`s] [":" (Term.app `Finset [`ι])] [] ")")
    (Term.explicitBinder "(" [`f] [":" (Term.arrow `ι "→" `R)] [] ")")
    (Term.explicitBinder "(" [`hs] [":" («term_<_» (numLit "0") "<" `s.card)] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app
...
theorem
  ...
  [ Nontrivial R ] ( s : Finset ι ) ( f : ι → R ) ( hs : 0 < s.card )
 ...
 (Command.theorem
     ...
     [":"
      (Term.forall
       ...
       (Mathlib.ExtendedBinder.«term∀___,_»
        ...
        («binderTerm∈_» "∈" `s)
        ","
        (Term.forall "∀" [] "," («term_≠_» (Term.app `f [`i]) "≠" (numLit "0")))))]
     []
     ")")]
   (Term.typeSpec
    ":"
  ...
  (Command.declValSimple
   ...
   (Term.byTactic
    ...
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group (Tactic.apply "apply" `nat_degree_prod') [])
       (group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `prod_ne_zero_iff)] "]") []) [])
       (group (Tactic.intro "intro" [`x `hx]) [])
       (group (Tactic.simp "simp" [] [] ["[" [(Tactic.simpLemma [] [] (Term.app `h [`x `hx]))] "]"] []) [])])))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.simp "simp" [] [] ["[" [(Tactic.simpLemma [] [] (Term.app `h [`x `hx]))] "]"] [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simp', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `prod_ne_zero_iff)] "]") [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.apply "apply" `nat_degree_prod')
...
/--
  ...
  theorem
    nat_degree_prod
    [ Nontrivial R ] ( h : ∀ , ∀ i ∈ s , ∀ , f i ≠ 0 ) : ∏ i in s , f i . natDegree = ∑ i in s , f i . natDegree
    := by apply nat_degree_prod' rw [ prod_ne_zero_iff ] intro x hx simp [ h x hx ]
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.simpa
         ...
         []
         ["using"
          (Term.app `degree_multiset_prod [(Term.app (Term.proj (Term.proj `s "." (fieldIdx "1")) "." `map) [`f])])])
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.simpa
   ...
   []
   []
   ["using" (Term.app `degree_multiset_prod [(Term.app (Term.proj (Term.proj `s "." (fieldIdx "1")) "." `map) [`f])])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simpa', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'optional.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `degree_multiset_prod [(Term.app (Term.proj (Term.proj `s "." (fieldIdx "1")) "." `map) [`f])])
...
/--
  ...
  theorem
    degree_prod
    [ Nontrivial R ] : ∏ i in s , f i . degree = ∑ i in s , f i . degree
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.simpa
   ...
   []
   ["using"
    (Term.app `leading_coeff_multiset_prod [(Term.app (Term.proj (Term.proj `s "." (fieldIdx "1")) "." `map) [`f])])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simpa', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'optional.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `leading_coeff_multiset_prod [(Term.app (Term.proj (Term.proj `s "." (fieldIdx "1")) "." `map) [`f])])
