...
theorem coe_pow_monoid_with_zero_hom : (powMonoidWithZeroHom hn : M → M) = (· ^ n) :=
  rfl
#align coe_pow_monoid_with_zero_hom coe_pow_monoid_with_zero_hom

@[simp]
theorem pow_monoid_with_zero_hom_apply (a : M) : powMonoidWithZeroHom hn a = a ^ n :=
  rfl
#align pow_monoid_with_zero_hom_apply pow_monoid_with_zero_hom_apply
