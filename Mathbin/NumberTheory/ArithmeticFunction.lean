...
@[simp]
theorem nat_coe_one [AddZeroClassₓ R] [One R] : ((1 : ArithmeticFunction ℕ) : ArithmeticFunction R) = 1 := by
  ext n
  simp [one_apply]

@[simp]
theorem int_coe_one [AddMonoidₓ R] [One R] [Neg R] : ((1 : ArithmeticFunction ℤ) : ArithmeticFunction R) = 1 := by
  ext n
  simp [one_apply]
