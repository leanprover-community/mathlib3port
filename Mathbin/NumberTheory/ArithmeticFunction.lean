...
-- ././Mathport/Syntax/Translate/Basic.lean:833:9: unsupported derive handler has_zero
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.instance
  ...
  (Command.declSig
   ...
   (Term.typeSpec
    ":"
    (Term.app `HasScalar [(Term.app `arithmetic_function [`R]) (Term.app `arithmetic_function [`M])])))
        ...
        [(Term.fun
          ...
          (Term.basicFun
           ...
           (Algebra.BigOperators.Basic.«term∑_in_,_»
            ...
            " in "
            (Term.app `divisors_antidiagonal [`n])
            ", "
            (Algebra.Group.Defs.«term_•_» (Term.app `f [`x.fst]) " • " (Term.app `g [`x.snd])))))
         ","
         (Term.byTactic
          "by"
...
/--
    The Dirichlet convolution of two arithmetic functions `f` and `g` is another arithmetic function
      such that `(f * g) n` is the sum of `f x * g y` over all `(x,y)` such that `x * y = n`. -/
  instance
    : HasScalar arithmetic_function R arithmetic_function M
    := ⟨ fun f g => ⟨ fun n => ∑ x in divisors_antidiagonal n , f x.fst • g x.snd , by simp ⟩ ⟩
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  ...
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.app `arithmetic_function [`R])] "}")
    (Term.implicitBinder "{" [`g] [":" (Term.app `arithmetic_function [`M])] "}")
    (Term.implicitBinder "{" [`n] [":" (termℕ "ℕ")] "}")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app (Algebra.Group.Defs.«term_•_» `f " • " `g) [`n])
     "="
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      "∑"
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `x)] []))
...
@[ simp ]
  theorem
    smul_apply
    { f : arithmetic_function R } { g : arithmetic_function M } { n : ℕ }
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  ...
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `Semiringₓ [`R]) "]")
    (Term.implicitBinder "{" [`f `g] [":" (Term.app `arithmetic_function [`R])] "}")
    (Term.implicitBinder "{" [`n] [":" (termℕ "ℕ")] "}")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app (Finset.Data.Finset.Fold.«term_*_» `f "*" `g) [`n])
     "="
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      "∑"
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `x)] []))
      ...
      (Term.app `divisors_antidiagonal [`n])
      ", "
      (Finset.Data.Finset.Fold.«term_*_» (Term.app `f [`x.fst]) "*" (Term.app `g [`x.snd]))))))
  (Command.declValSimple ":=" `rfl [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
@[ simp ]
  theorem
    mul_apply
    [ Semiringₓ R ] { f g : arithmetic_function R } { n : ℕ }
      : f * g n = ∑ x in divisors_antidiagonal n , f x.fst * g x.snd
    := rfl
...
instance
  { M : Type _ } [ Semiringₓ R ] [ AddCommMonoidₓ M ] [ Module R M ]
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `coe_zeta_mul_apply [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `Semiringₓ [`R]) "]")
    (Term.implicitBinder "{" [`f] [":" (Term.app `arithmetic_function [`R])] "}")
    (Term.implicitBinder "{" [`x] [":" (termℕ "ℕ")] "}")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app
      (Finset.Data.Finset.Fold.«term_*_»
       (Init.Coe.«term↑_» "↑" (Nat.ArithmeticFunction.NumberTheory.ArithmeticFunction.termζ "ζ"))
       "*"
       `f)
      [`x])
     "="
   ...
   (Term.byTactic
    ...
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `mul_apply)] "]") []) [])
       (group
        (Tactic.trans
         "trans"
         [(Algebra.BigOperators.Basic.«term∑_in_,_»
           ...
           (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
           " in "
           (Term.app `divisors_antidiagonal [`x])
           ", "
           (Term.app `f [`i.snd]))])
        [])
       (group
          ...
          (Tactic.tacticSeq1Indented
           [(group (Tactic.apply "apply" (Term.app `sum_congr [`rfl])) [])
            ...
            (group
             (Tactic.rcases
              "rcases"
              [(Tactic.casesTarget [] (Term.app (Term.proj `mem_divisors_antidiagonal "." (fieldIdx "1")) [`hi]))]
              ["with"
            ...
            (group
             (Tactic.rwSeq
              ...
              (Tactic.rwRuleSeq
               "["
               [(Tactic.rwRule [] `nat_coe_apply)
                ","
                (Tactic.rwRule [] (Term.app `zeta_apply_ne [(Term.app `left_ne_zero_of_mul [`h])]))
                ","
                (Tactic.rwRule [] `cast_one)
                ","
          ...
          (Tactic.tacticSeq1Indented
           [(group
             (Tactic.apply
              ...
              (Term.app
               `sum_bij
               [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`i `h] [])] "=>" (Term.app `Prod.snd [`i])))]))
             [])
            (group
             (Tactic.«tactic·._»
              "·"
                ...
                [(group
                 ...
                 (group
                  (Tactic.simp
                   ...
                   []
                   []
                   ["[" [(Tactic.simpLemma [] [] (Term.app `snd_mem_divisors_of_mem_antidiagonal [`h]))] "]"]
                   [])
                  [])])))
             [])
            (group
                ...
                [(group
                   ...
                   [(Tactic.rintroPat.one
                     (Tactic.rcasesPat.tuple
                      ...
                      [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `a1)]) [])
                       ","
                       (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `b1)]) [])]
                      "⟩"))
                    (Tactic.rintroPat.one
                     (Tactic.rcasesPat.tuple
                      "⟨"
                      [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `a2)]) [])
                       ","
                       (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `b2)]) [])]
                      "⟩"))
                 ...
                 (group
                  (Tactic.rwSeq
                   "rw"
                   []
                   (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `mem_divisors_antidiagonal)] "]")
                   [(Tactic.location "at" (Tactic.locationWildcard "*"))])
                  [])
                 ...
                 (group
                  (Tactic.apply
                   "apply"
                   (Term.app
                    `Nat.eq_of_mul_eq_mul_rightₓ
                    [(Term.hole "_")
                     (Term.app
                      `Eq.trans
                      [(Term.proj `h1 "." (fieldIdx "1")) (Term.proj (Term.proj `h2 "." (fieldIdx "1")) "." `symm)])]))
                  [])
                 (group
                  (Tactic.rcases
                   "rcases"
                  ...
                  [])
                 (group
                  (Tactic.apply "apply" (Term.app `Nat.pos_of_ne_zeroₓ [(Term.app `right_ne_zero_of_mul [`h])]))
                  [])])))
             [])
            (group
             (Tactic.«tactic·._»
               ...
               (Tactic.tacticSeq1Indented
                [(group (Tactic.intro "intro" [`a `ha]) [])
                 (group
                  (Tactic.rcases
                   "rcases"
                   [(Tactic.casesTarget [] (Term.app (Term.proj `mem_divisors "." (fieldIdx "1")) [`ha]))]
                   ["with"
                    (Tactic.rcasesPat.tuple
                     "⟨"
                     [(Tactic.rcasesPatLo
                       ...
                       [])
                      ","
                      (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `ne0)]) [])]
                     "⟩")])
                  [])
                 (group (Tactic.use "use" [(Term.paren "(" [`b [(Term.tupleTail "," [`a])]] ")")]) [])
                 (group
                  (Tactic.simp
                   "simp"
                   []
                   []
                   ["[" [(Tactic.simpLemma [] [] `ne0) "," (Tactic.simpLemma [] [] `mul_commₓ)] "]"]
                   [])
                  [])])))
             [])])))
        [])])))
            ...
            (Tactic.rcases
             ...
             ["with"
              (Tactic.rcasesPat.tuple
               ...
               "⟩")])
            [])
           (group (Tactic.apply "apply" (Term.app `Nat.pos_of_ne_zeroₓ [(Term.app `right_ne_zero_of_mul [`h])])) [])])))
       [])
      (group
       (Tactic.«tactic·._»
        "·"
   ...
   (Tactic.tacticSeq
    (Tactic.tacticSeq1Indented
     [(group (Tactic.intro "intro" [`a `ha]) [])
      ...
      (group (Tactic.use "use" [(Term.paren "(" [`b [(Term.tupleTail "," [`a])]] ")")]) [])
      (group
       (Tactic.simp "simp" [] [] ["[" [(Tactic.simpLemma [] [] `ne0) "," (Tactic.simpLemma [] [] `mul_commₓ)] "]"] [])
       [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.«tactic·._»', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq', expected 'Lean.Parser.Tactic.tacticSeq.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq1Indented', expected 'Lean.Parser.Tactic.tacticSeqBracketed.antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.use "use" [(Term.paren "(" [`b [(Term.tupleTail "," [`a])]] ")")])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.proj `mem_divisors "." (fieldIdx "1")) [`ha])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj `mem_divisors "." (fieldIdx "1"))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Nat.pos_of_ne_zeroₓ [(Term.app `right_ne_zero_of_mul [`h])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `right_ne_zero_of_mul [`h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `right_ne_zero_of_mul [`h]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `Nat.pos_of_ne_zeroₓ
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app
   `Nat.eq_of_mul_eq_mul_rightₓ
   [(Term.hole "_")
    (Term.app `Eq.trans [(Term.proj `h1 "." (fieldIdx "1")) (Term.proj (Term.proj `h2 "." (fieldIdx "1")) "." `symm)])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Term.proj `h2 "." (fieldIdx "1")) "." `symm)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.proj `h2 "." (fieldIdx "1"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  `h2
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simpLemma', expected 'Lean.Parser.Tactic.simpErase'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `snd_mem_divisors_of_mem_antidiagonal [`h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.apply', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `sum_bij [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`i `h] [])] "=>" (Term.app `Prod.snd [`i])))])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `zeta_apply_ne [(Term.app `left_ne_zero_of_mul [`h])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `left_ne_zero_of_mul [`h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `left_ne_zero_of_mul [`h]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `zeta_apply_ne
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.casesTarget', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.proj `mem_divisors_antidiagonal "." (fieldIdx "1")) [`hi])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj `mem_divisors_antidiagonal "." (fieldIdx "1"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  `mem_divisors_antidiagonal
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
@[ simp ]
  theorem
    coe_zeta_mul_apply
    [ Semiringₓ R ] { f : arithmetic_function R } { x : ℕ } : ↑ ζ * f x = ∑ i in divisors x , f i
    :=
      by
        rw [ mul_apply ]
          ...
          ·
            apply sum_bij fun i h => Prod.snd i
              · rintro ⟨ a , b ⟩ h simp [ snd_mem_divisors_of_mem_antidiagonal h ]
              · rintro ⟨ a , b ⟩ h rfl
              ·
              ...
              · intro a ha rcases mem_divisors . 1 ha with ⟨ ⟨ b , rfl ⟩ , ne0 ⟩ use ( b , a ) simp [ ne0 , mul_commₓ ]
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `coe_zeta_smul_apply [])
  (Command.declSig
   [(Term.implicitBinder "{" [`M] [":" (Term.type "Type" [(Level.hole "_")])] "}")
    ...
    (Term.implicitBinder "{" [`f] [":" (Term.app `arithmetic_function [`M])] "}")
    (Term.implicitBinder "{" [`x] [":" (termℕ "ℕ")] "}")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app
      (Algebra.Group.Defs.«term_•_»
       (Term.paren
        "("
        [(Init.Coe.«term↑_» "↑" (Nat.ArithmeticFunction.NumberTheory.ArithmeticFunction.termζ "ζ"))
         [(Term.typeAscription ":" (Term.app `arithmetic_function [`R]))]]
        ")")
       " • "
       `f)
      [`x])
  ...
  (Command.declValSimple
   ...
   (Term.byTactic
    ...
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `smul_apply)] "]") []) [])
       (group
        (Tactic.trans
         "trans"
         [(Algebra.BigOperators.Basic.«term∑_in_,_»
...
theorem
  coe_zeta_smul_apply
  { M : Type _ } [ CommRingₓ R ] [ AddCommGroupₓ M ] [ Module R M ] { f : arithmetic_function M } { x : ℕ }
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `coe_mul_zeta_apply [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `Semiringₓ [`R]) "]")
    (Term.implicitBinder "{" [`f] [":" (Term.app `arithmetic_function [`R])] "}")
    (Term.implicitBinder "{" [`x] [":" (termℕ "ℕ")] "}")]
   (Term.typeSpec
    ...
    («term_=_»
     (Term.app
      (Finset.Data.Finset.Fold.«term_*_» `f "*" (Nat.ArithmeticFunction.NumberTheory.ArithmeticFunction.termζ "ζ"))
      [`x])
     "="
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      "∑"
  ...
  (Command.declValSimple
   ...
   (Term.byTactic
    ...
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group (Tactic.apply "apply" `MulOpposite.op_injective) [])
       (group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `op_sum)] "]") []) [])
       (group
        (Tactic.convert
         "convert"
         []
         (Term.app
          (Term.explicit "@" `coe_zeta_mul_apply)
          [(Algebra.Opposites.«term_ᵐᵒᵖ» `R "ᵐᵒᵖ")
           (Term.hole "_")
           (Term.structInst
            "{"
            []
            [(group
              (Term.structInstField (Term.structInstLVal `toFun []) ":=" («term_∘_» `MulOpposite.op "∘" `f))
              [","])
             (group
       ...
       (group
        (Tactic.rwSeq
         ...
         (Tactic.rwRuleSeq
          "["
          [(Tactic.rwRule [] `mul_apply) "," (Tactic.rwRule [] `mul_apply) "," (Tactic.rwRule [] `op_sum)]
          "]")
         [])
        [])
       (group
          ...
          (Tactic.Conv.convSeq1Indented
           [(group
             (Tactic.Conv.convRw__
              "rw"
              []
              (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `map_swap_divisors_antidiagonal)] "]"))
             [])])))
        [])
       (group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `sum_map)] "]") []) [])
       (group (Tactic.apply "apply" (Term.app `sum_congr [`rfl])) [])
       (group (Tactic.intro "intro" [`y `hy]) [])
       (group (Tactic.byCases' "by_cases'" [`h1 ":"] («term_=_» `y.fst "=" (numLit "0"))) [])
       (group
        (Tactic.«tactic·._»
         "·"
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group
             (Tactic.simp
              ...
              []
              []
              ["[" [(Tactic.simpLemma [] [] `Function.comp_applyₓ) "," (Tactic.simpLemma [] [] `h1)] "]"]
              [])
             [])])))
        [])
       (group
             ...
             (Tactic.simp
              ...
              ["["
               [(Tactic.simpLemma [] [] `h1)
                ...
                ","
                (Tactic.simpLemma [] [] `zeta_apply)
                ","
                (Tactic.simpLemma [] [] `ZeroHom.coe_mk)
                ","
                (Tactic.simpLemma [] [] `nat_coe_apply)
                ","
                (Tactic.simpLemma [] [] `cast_one)]
               "]"]
              [])
             [])])))
        [])])))
        ...
        (Term.app
         ...
         [(Algebra.Opposites.«term_ᵐᵒᵖ» `R "ᵐᵒᵖ")
          ...
          (Term.structInst
           "{"
           []
           [(group (Term.structInstField (Term.structInstLVal `toFun []) ":=" («term_∘_» `MulOpposite.op "∘" `f)) [","])
            (group
             (Term.structInstField
              (Term.structInstLVal `map_zero' [])
              ":="
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `sum_map)] "]") [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `sum_map
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Mathlib.Tactic.Conv.convLHS
   ...
   (Tactic.Conv.convSeq
    (Tactic.Conv.convSeq1Indented
     [(group
       (Tactic.Conv.convRw__ "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `map_swap_divisors_antidiagonal)] "]"))
       [])])))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Algebra.Opposites.«term_ᵐᵒᵖ»', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Algebra.Opposites.«term_ᵐᵒᵖ»', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Algebra.Opposites.«term_ᵐᵒᵖ»', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Algebra.Opposites.«term_ᵐᵒᵖ»', expected 'Lean.Parser.Term.ellipsis.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Algebra.Opposites.«term_ᵐᵒᵖ»', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, term))
  (Algebra.Opposites.«term_ᵐᵒᵖ» `R "ᵐᵒᵖ")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Algebra.Opposites.«term_ᵐᵒᵖ»', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Algebra.Opposites.«term_ᵐᵒᵖ» `R "ᵐᵒᵖ") []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.explicit "@" `coe_zeta_mul_apply)
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `op_sum)] "]") [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `op_sum
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.apply "apply" `MulOpposite.op_injective)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.apply', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
@[ simp ]
  theorem
    coe_mul_zeta_apply
    [ Semiringₓ R ] { f : arithmetic_function R } { x : ℕ } : f * ζ x = ∑ i in divisors x , f i
    :=
      by
        apply MulOpposite.op_injective
          rw [ op_sum ]
          convert @ coe_zeta_mul_apply R ᵐᵒᵖ _ { toFun := MulOpposite.op ∘ f , map_zero' := by simp } x
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `zeta_mul_apply [])
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.app `arithmetic_function [(termℕ "ℕ")])] "}")
    (Term.implicitBinder "{" [`x] [":" (termℕ "ℕ")] "}")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app
      (Finset.Data.Finset.Fold.«term_*_» (Nat.ArithmeticFunction.NumberTheory.ArithmeticFunction.termζ "ζ") "*" `f)
      [`x])
     "="
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      "∑"
      ...
      [(group
        (Tactic.rwSeq
         ...
         (Tactic.rwRuleSeq
          ...
          [(Tactic.rwRule
            ["←"]
            (Term.app `nat_coe_nat [(Nat.ArithmeticFunction.NumberTheory.ArithmeticFunction.termζ "ζ")]))
           ","
           (Tactic.rwRule [] `coe_zeta_mul_apply)]
          "]")
         [])
        [])])))
   [])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.rwSeq
   ...
   (Tactic.rwRuleSeq
    "["
    [(Tactic.rwRule ["←"] (Term.app `nat_coe_nat [(Nat.ArithmeticFunction.NumberTheory.ArithmeticFunction.termζ "ζ")]))
     ","
     (Tactic.rwRule [] `coe_zeta_mul_apply)]
    "]")
   [])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `nat_coe_nat [(Nat.ArithmeticFunction.NumberTheory.ArithmeticFunction.termζ "ζ")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Nat.ArithmeticFunction.NumberTheory.ArithmeticFunction.termζ', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Nat.ArithmeticFunction.NumberTheory.ArithmeticFunction.termζ', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Nat.ArithmeticFunction.NumberTheory.ArithmeticFunction.termζ', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Nat.ArithmeticFunction.NumberTheory.ArithmeticFunction.termζ', expected 'Lean.Parser.Term.ellipsis.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Nat.ArithmeticFunction.NumberTheory.ArithmeticFunction.termζ', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Nat.ArithmeticFunction.NumberTheory.ArithmeticFunction.termζ "ζ")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Nat.ArithmeticFunction.NumberTheory.ArithmeticFunction.termζ', expected 'antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `nat_coe_nat
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
theorem
  zeta_mul_apply
  { f : arithmetic_function ℕ } { x : ℕ } : ζ * f x = ∑ i in divisors x , f i
        ...
        (Tactic.rwSeq
         ...
         (Tactic.rwRuleSeq
          ...
          [(Tactic.rwRule
            ...
            (Term.app `nat_coe_nat [(Nat.ArithmeticFunction.NumberTheory.ArithmeticFunction.termζ "ζ")]))
           ","
           (Tactic.rwRule [] `coe_mul_zeta_apply)]
          "]")
         [])
        [])])))
   [])
...
theorem
  mul_zeta_apply
  { f : arithmetic_function ℕ } { x : ℕ } : f * ζ x = ∑ i in divisors x , f i
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " `σ k n` is the sum of the `k`th powers of the divisors of `n` -/")]
  []
  []
  []
  []
 ...
 (Command.def
  ...
  (Command.optDeclSig
   ...
   [(Term.typeSpec ":" (Term.app `arithmetic_function [(termℕ "ℕ")]))])
  (Command.declValSimple
   ":="
   (Term.anonymousCtor
    "⟨"
    [(Term.fun
      ...
      (Term.basicFun
       ...
       (Algebra.BigOperators.Basic.«term∑_in_,_»
        ...
        (Term.app `divisors [`n])
        ", "
        (Cardinal.SetTheory.Cardinal.«term_^_» `d "^" `k))))
     ","
     (Term.byTactic "by" (Tactic.tacticSeq (Tactic.tacticSeq1Indented [(group (Tactic.simp "simp" [] [] [] []) [])])))]
    "⟩")
   [])
...
/-- `σ k n` is the sum of the `k`th powers of the divisors of `n` -/
  def Sigma ( k : ℕ ) : arithmetic_function ℕ := ⟨ fun n => ∑ d in divisors n , d ^ k , by simp ⟩
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `sigma_apply [])
  (Command.declSig
   [(Term.implicitBinder "{" [`k `n] [":" (termℕ "ℕ")] "}")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app (Nat.ArithmeticFunction.NumberTheory.ArithmeticFunction.termσ "σ") [`k `n])
     "="
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      "∑"
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `d)] []))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
@[ simp ] theorem sigma_apply { k n : ℕ } : σ k n = ∑ d in divisors n , d ^ k := rfl
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `sigma_one_apply [])
  (Command.declSig
   [(Term.implicitBinder "{" [`n] [":" (termℕ "ℕ")] "}")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app (Nat.ArithmeticFunction.NumberTheory.ArithmeticFunction.termσ "σ") [(numLit "1") `n])
     "="
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      "∑"
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `d)] []))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
theorem sigma_one_apply { n : ℕ } : σ 1 n = ∑ d in divisors n , d := by simp
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `coe_moebius_mul_coe_zeta [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `CommRingₓ [`R]) "]")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.paren
      "("
      [(Finset.Data.Finset.Fold.«term_*_»
        (Nat.ArithmeticFunction.NumberTheory.ArithmeticFunction.termμ "μ")
        "*"
        (Nat.ArithmeticFunction.NumberTheory.ArithmeticFunction.termζ "ζ"))
       [(Term.typeAscription ":" (Term.app `arithmetic_function [`R]))]]
      ")")
          ...
          (Tactic.tacticSeq1Indented
           [(group
             (Tactic.simp
              ...
              ["only"]
              ["["
               [(Tactic.simpLemma [] [] `divisors_zero)
                ","
                ...
                ","
                (Tactic.simpLemma [] [] `coe_mul_zeta_apply)
                ","
                (Tactic.simpLemma [] [] `zero_ne_one)
                ","
                (Tactic.simpLemma [] [] `one_apply_ne)]
               "]"]
              [])
             [])])))
        [])
          ...
          (Tactic.tacticSeq1Indented
           [(group
             (Tactic.simp
              ...
              ["only"]
              ["["
               [(Tactic.simpLemma [] [] `moebius_apply_of_squarefree)
                ","
                (Tactic.simpLemma [] [] `card_factors_one)
                ","
                (Tactic.simpLemma [] [] `squarefree_one)
                ","
                (Tactic.simpLemma [] [] `divisors_one)
                ","
                ...
                (Tactic.simpLemma [] [] `coe_mul_zeta_apply)
                ","
                (Tactic.simpLemma [] [] `one_one)
                ","
                (Tactic.simpLemma [] [] `int_coe_apply)
                ","
         ...
         (Tactic.rwRuleSeq
          ...
          [(Tactic.rwRule [] `coe_mul_zeta_apply)
           ...
           (Tactic.rwRule
            ...
            (Term.app
             `one_apply_ne
             [(Term.app `ne_of_gtₓ [(Term.app `succ_lt_succ [(Term.app `Nat.succ_posₓ [(Term.hole "_")])])])]))]
          "]")
         [])
        [])
       (group (Tactic.simpRw "simp_rw" (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `int_coe_apply)] "]") []) [])
       (group
        (Tactic.rwSeq
         "rw"
         []
         (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `Int.cast_sum) "," (Tactic.rwRule ["←"] `sum_filter_ne_zero)] "]")
         [])
        [])
       (group (Tactic.convert "convert" [] `Int.cast_zero []) [])
       (group
        (Tactic.simp "simp" [] ["only"] ["[" [(Tactic.simpLemma [] [] `moebius_ne_zero_iff_squarefree)] "]"] [])
        [])
       (group
          ...
          («term_=_»
           (Algebra.BigOperators.Basic.«term∑_in_,_»
            ...
            (Lean.explicitBinders
             (Lean.unbracketedExplicitBinders [(Lean.binderIdent `y)] [":" (Term.app `Finset [(termℕ "ℕ")])]))
            " in "
            (Term.proj
             (Term.proj (Term.app `UniqueFactorizationMonoid.normalizedFactors [`x.succ.succ]) "." `toFinset)
             "."
             `Powerset)
            ", "
            (Term.app
             `ite
             [(Term.app `Squarefree [`y.val.prod])
              (Cardinal.SetTheory.Cardinal.«term_^_»
               (Term.paren "(" [(«term-_» "-" (numLit "1")) [(Term.typeAscription ":" (termℤ "ℤ"))]] ")")
               "^"
               (Term.app (Nat.ArithmeticFunction.NumberTheory.ArithmeticFunction.termΩ "Ω") [`y.val.prod]))
              (numLit "0")]))
           "="
           (numLit "0"))
          (Term.byTactic
                  ...
                  [(Term.typeSpec
                    ...
                    («term_=_»
                     (Algebra.BigOperators.Basic.«term∑_in_,_»
                      ...
                      (Term.app
                       `ite
                       [(Term.app `Squarefree [`i])
                        (Cardinal.SetTheory.Cardinal.«term_^_»
                         (Term.paren "(" [(«term-_» "-" (numLit "1")) [(Term.typeAscription ":" (termℤ "ℤ"))]] ")")
                         "^"
                         (Term.app (Nat.ArithmeticFunction.NumberTheory.ArithmeticFunction.termΩ "Ω") [`i]))
                        (numLit "0")]))
                     "="
                     (Term.hole "_")))]
                  ":="
                  (Term.app `sum_divisors_filter_squarefree [(Term.app `Nat.succ_ne_zero [(Term.hole "_")])]))))
               [])
              (group
               (Tactic.exact
                "exact"
        ...
        (Tactic.apply
         ...
         (Term.app
          ...
          [(Term.app `sum_congr [`rfl (Term.hole "_")])
           (Term.app `sum_powerset_neg_one_pow_card_of_nonempty [(Term.hole "_")])]))
        [])
       (group
        (Tactic.«tactic·._»
         "·"
           ...
           [(group (Tactic.intro "intro" [`y `hy]) [])
            (group
             (Tactic.rwSeq
              ...
              (Tactic.rwRuleSeq
               "["
               [(Tactic.rwRule [] `Finset.mem_powerset)
                ","
                (Tactic.rwRule ["←"] `Finset.val_le_iff)
                ","
             ...
             (Tactic.tacticHave_
              ...
              (Term.haveDecl
               (Term.haveIdDecl
                ...
                [(Term.typeSpec
                  ":"
                  («term_=_» (Term.app `UniqueFactorizationMonoid.normalizedFactors [`y.val.prod]) "=" `y.val))]
                ":="
                (Term.byTactic
                 "by"
                 (Tactic.tacticSeq
                  (Tactic.tacticSeq1Indented
                   [(group (Tactic.apply "apply" `factors_multiset_prod_of_irreducible) [])
                      ...
                      (Term.app
                       ...
                       [(Term.hole "_")
                        (Term.app
                         ...
                         [(Term.app `le_transₓ [`hy (Term.app `Multiset.erase_dup_le [(Term.hole "_")])]) `hz])]))
                     [])]))))))
             [])
               ...
               (Tactic.tacticSeq1Indented
                [(group
                  (Tactic.rwSeq
                   ...
                   (Tactic.rwRuleSeq
                    "["
                    [(Tactic.rwRule [] `card_factors_apply)
                     ","
                     (Tactic.rwRule ["←"] `Multiset.coe_card)
                     ","
                     (Tactic.rwRule ["←"] `factors_eq)
                     ","
                     (Tactic.rwRule [] `h)
                     ","
                     (Tactic.rwRule [] `Finset.card)]
                    "]")
                   [])
                  [])])))
             [])
            (group
             (Tactic.rwSeq
              ...
              (Tactic.rwRuleSeq
               "["
               [(Tactic.rwRule [] `UniqueFactorizationMonoid.squarefree_iff_nodup_normalized_factors)
                ","
                (Tactic.rwRule [] `h)]
               "]")
              [])
            ...
            (group
             (Tactic.«tactic·._»
              "·"
              (Tactic.tacticSeq (Tactic.tacticSeq1Indented [(group (Tactic.apply "apply" `y.nodup) [])])))
             [])
            (group
             (Tactic.rwSeq
              "rw"
              []
              (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Ne.def) "," (Tactic.rwRule [] `Multiset.prod_eq_zero_iff)] "]")
              [])
             [])
            (group (Tactic.intro "intro" [`con]) [])
            (group
             (Tactic.rwSeq
              "rw"
              []
              (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `h)] "]")
              [(Tactic.location "at" (Tactic.locationHyp [`con] []))])
             [])
            (group
             (Tactic.exact
              "exact"
              (Term.app `not_irreducible_zero [(Term.app `irreducible_of_normalized_factor [(numLit "0") `Con])]))
             [])])))
        [])
       (group
        (Tactic.«tactic·._»
         ...
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Finset.Nonempty)] "]") []) [])
            (group
             (Tactic.rcases
              "rcases"
              [(Tactic.casesTarget
                ...
                (Term.app
                 ...
                 [(Term.hole "_") (Term.app `Nat.succ_ne_zero [(Term.hole "_")])]))]
              ["with"
               (Tactic.rcasesPat.tuple
                "⟨"
                   ...
                   ["with"
                    (Tactic.rcasesPat.tuple
                     ...
                     [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `j)]) [])
                      ...
                      ","
                      (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `hj2)]) [])]
                     "⟩")])
                  [])
                 (group (Tactic.use "use" [`j]) [])
                 (group
                  (Tactic.apply "apply" (Term.app (Term.proj `Multiset.mem_to_finset "." (fieldIdx "2")) [`hj]))
                  [])])))
             [])
            (group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Nat.is_unit_iff)] "]") []) [])
        ...
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(group
            ...
            [])
           (group (Tactic.use "use" [`j]) [])
           (group (Tactic.apply "apply" (Term.app (Term.proj `Multiset.mem_to_finset "." (fieldIdx "2")) [`hj])) [])])))
       [])
      (group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Nat.is_unit_iff)] "]") []) [])
      (group (Lean.Tactic.normNum "norm_num" [] []) [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.«tactic·._»', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Nat.is_unit_iff)] "]") [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `Nat.is_unit_iff
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.apply', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.proj `Multiset.mem_to_finset "." (fieldIdx "2")) [`hj])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj `Multiset.mem_to_finset "." (fieldIdx "2"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.casesTarget', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `WfDvdMonoid.exists_irreducible_factor [(Term.hole "_") (Term.app `Nat.succ_ne_zero [(Term.hole "_")])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Finset.Nonempty)] "]") [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `Finset.Nonempty
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `irreducible_of_normalized_factor [(numLit "0") `Con])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.«tactic·._» "·" (Tactic.tacticSeq (Tactic.tacticSeq1Indented [(group (Tactic.apply "apply" `y.nodup) [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.«tactic·._»', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq', expected 'Lean.Parser.Tactic.tacticSeq.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq1Indented', expected 'Lean.Parser.Tactic.tacticSeqBracketed.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq1Indented', expected 'Lean.Parser.Tactic.tacticSeqBracketed'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq
   ...
   (Tactic.rwRuleSeq
    "["
    [(Tactic.rwRule [] `UniqueFactorizationMonoid.squarefree_iff_nodup_normalized_factors) "," (Tactic.rwRule [] `h)]
    "]")
   [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `UniqueFactorizationMonoid.squarefree_iff_nodup_normalized_factors
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.tacticHave_
   ...
   (Term.haveDecl
    (Term.haveIdDecl
     [`h []]
     [(Term.typeSpec ":" («term_=_» (Term.app `UniqueFactorizationMonoid.normalizedFactors [`y.val.prod]) "=" `y.val))]
     ":="
     (Term.byTactic
      "by"
      (Tactic.tacticSeq
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `le_transₓ [`hy (Term.app `Multiset.erase_dup_le [(Term.hole "_")])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Multiset.erase_dup_le [(Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `le_transₓ [`hy (Term.paren "(" [(Term.app `Multiset.erase_dup_le [(Term.hole "_")]) []] ")")]) []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `Multiset.subset_of_le
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.apply "apply" `factors_multiset_prod_of_irreducible)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.apply', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize] ...precedences are 51 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 50, term))
  (Term.app `UniqueFactorizationMonoid.normalizedFactors [`y.val.prod])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
  ...
  (Tactic.exact
   ...
   (Term.app
    (Term.proj
     (Term.app
      `Eq.trans
      [(Term.byTactic "by" (Tactic.tacticSeq (Tactic.tacticSeq1Indented [(group (Tactic.congr "congr" [] []) [])])))
       `h])
     "."
     `trans)
    [`this]))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app
   (Term.proj
    (Term.app
     `Eq.trans
     [(Term.byTactic "by" (Tactic.tacticSeq (Tactic.tacticSeq1Indented [(group (Tactic.congr "congr" [] []) [])]))) `h])
    "."
    `trans)
   [`this])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'numLit', expected 'numLit.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Cardinal.SetTheory.Cardinal.«term_^_»', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Cardinal.SetTheory.Cardinal.«term_^_»', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Cardinal.SetTheory.Cardinal.«term_^_»', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Cardinal.SetTheory.Cardinal.«term_^_»', expected 'Lean.Parser.Term.ellipsis.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Cardinal.SetTheory.Cardinal.«term_^_»', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Cardinal.SetTheory.Cardinal.«term_^_»
   (Term.paren "(" [(«term-_» "-" (numLit "1")) [(Term.typeAscription ":" (termℤ "ℤ"))]] ")")
   "^"
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Nat.ArithmeticFunction.NumberTheory.ArithmeticFunction.termΩ "Ω")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Nat.ArithmeticFunction.NumberTheory.ArithmeticFunction.termΩ', expected 'antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 0, term))
  (Term.paren "(" [(«term-_» "-" (numLit "1")) [(Term.typeAscription ":" (termℤ "ℤ"))]] ")")
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Squarefree [`i]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `ite
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
@[ simp ]
  theorem
    ...
    [ CommRingₓ R ] : ( μ * ζ : arithmetic_function R ) = 1
    :=
      by
        ext x
          cases x
          ·
            simp
              only
              [ divisors_zero , sum_empty , Ne.def , not_false_iff , coe_mul_zeta_apply , zero_ne_one , one_apply_ne ]
          cases x
          ·
            simp
              only
          ...
          suffices
            ∑
                  y : Finset ℕ
                  in
                  UniqueFactorizationMonoid.normalizedFactors x.succ.succ . toFinset . Powerset
                  ,
              ...
              by
                have
                    h
                      : ∑ i in _ , ite Squarefree i ( - 1 : ℤ ) ^ Ω i 0 = _
                      :=
          ...
          ·
            intro y hy
              ...
              have
                h
                  : UniqueFactorizationMonoid.normalizedFactors y.val.prod = y.val
                  :=
                  by
                    apply factors_multiset_prod_of_irreducible
                      intro z hz
                      apply
                        irreducible_of_normalized_factor _ Multiset.subset_of_le le_transₓ hy Multiset.erase_dup_le _ hz
              rw [ if_pos ]
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " Möbius inversion for functions to an `add_comm_group`. -/")]
  []
  []
  []
  []
 ...
 (Command.theorem
  "theorem"
  (Command.declId `sum_eq_iff_sum_smul_moebius_eq [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `AddCommGroupₓ [`R]) "]")
    (Term.implicitBinder "{" [`f `g] [":" (Term.arrow (termℕ "ℕ") "→" `R)] "}")]
   (Term.typeSpec
    ":"
    («term_↔_»
     (Term.forall
      ...
      (Term.arrow
       ...
       («term_=_»
        (Algebra.BigOperators.Basic.«term∑_in_,_»
         "∑"
         (Lean.explicitBinders
          (Lean.unbracketedExplicitBinders [(Lean.binderIdent `x)] [":" («term_×_» (termℕ "ℕ") "×" (termℕ "ℕ"))]))
         " in "
         `n.divisors_antidiagonal
         ", "
         (Algebra.Group.Defs.«term_•_»
          (Term.app (Nat.ArithmeticFunction.NumberTheory.ArithmeticFunction.termμ "μ") [`x.fst])
          " • "
          (Term.app `g [`x.snd])))
        "="
        (Term.app `f [`n])))))))
      ...
      [(group
        (Tactic.tacticLet_
         ...
         (Term.letDecl
          (Term.letIdDecl
           `f'
           [(Term.typeSpec ":" (Term.app `arithmetic_function [`R]))]
           ":="
           (Term.anonymousCtor
            "⟨"
            [(Term.fun
              ...
              (Term.basicFun
               [(Term.simpleBinder [`x] [])]
               "=>"
               (termIfThenElse "if" («term_=_» `x "=" (numLit "0")) "then" (numLit "0") "else" (Term.app `f [`x]))))
             ","
             (Term.app `if_pos [`rfl])]
            "⟩"))))
        [])
           ...
           (Term.anonymousCtor
            ...
            [(Term.fun
              ...
              (Term.basicFun
               [(Term.simpleBinder [`x] [])]
               "=>"
               (termIfThenElse "if" («term_=_» `x "=" (numLit "0")) "then" (numLit "0") "else" (Term.app `g [`x]))))
             ","
             (Term.app `if_pos [`rfl])]
            "⟩"))))
        [])
         ...
         [(«term_=_»
           (Algebra.Group.Defs.«term_•_»
            (Term.paren
             "("
             [(Nat.ArithmeticFunction.NumberTheory.ArithmeticFunction.termζ "ζ")
              [(Term.typeAscription ":" (Term.app `arithmetic_function [(termℤ "ℤ")]))]]
             ")")
            " • "
            `f')
           "="
       ...
       (group
        (Tactic.«tactic·._»
         ...
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `ext_iff)] "]") []) [])
            ...
            (group
             (Tactic.«tactic·._»
              ...
              (Tactic.tacticSeq (Tactic.tacticSeq1Indented [(group (Tactic.simp "simp" [] [] [] []) [])])))
             [])
            (group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `coe_zeta_smul_apply)] "]") []) [])
            (group
             (Tactic.simp
              "simp"
              []
              ["only"]
              ["["
               [(Tactic.simpLemma [] [] `n.succ_ne_zero)
                ","
                (Tactic.simpLemma [] [] `forall_prop_of_true)
                ","
                (Tactic.simpLemma [] [] `succ_pos')
                ","
                (Tactic.simpLemma [] [] `if_false)
                ","
                (Tactic.simpLemma [] [] `ZeroHom.coe_mk)]
            ...
            (group
             (Tactic.rwSeq
              ...
              (Tactic.rwRuleSeq
               ...
               [(Tactic.rwRule
                 []
                 (Term.app `if_neg [(Term.app `ne_of_gtₓ [(Term.app `Nat.pos_of_mem_divisors [`hx])])]))]
               "]")
              [])
             [])])))
        [])
       (group
        (Tactic.trans
         "trans"
         [(«term_=_»
           (Algebra.Group.Defs.«term_•_» (Nat.ArithmeticFunction.NumberTheory.ArithmeticFunction.termμ "μ") " • " `g')
           "="
           `f')])
        [])
       (group
        (Tactic.«tactic·._»
         ...
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group (Tactic.«tactic_<;>_» (Tactic.constructor "constructor") "<;>" (Tactic.intro "intro" [`h])) [])
            (group
             (Tactic.«tactic·._»
              "·"
              (Tactic.tacticSeq
                  ...
                  (Tactic.rwSeq
                   ...
                   (Tactic.rwRuleSeq
                    ...
                    [(Tactic.rwRule ["←"] `h)
                     ...
                     ","
                     (Tactic.rwRule [] `moebius_mul_coe_zeta)
                     ","
                     (Tactic.rwRule [] `one_smul)]
                    "]")
                   [])
                  ...
                  (Tactic.rwSeq
                   ...
                   (Tactic.rwRuleSeq
                    ...
                    [(Tactic.rwRule ["←"] `h)
                     ...
                     (Tactic.rwRule ["←"] `mul_smul)
                     ","
                     (Tactic.rwRule [] `coe_zeta_mul_moebius)
                     ","
                     (Tactic.rwRule [] `one_smul)]
                    "]")
                   [])
              ...
              (Tactic.rwRuleSeq
               ...
               [(Tactic.rwRule
                 ...
                 (Term.app
                  ...
                  [(Term.app
                    `ne_of_gtₓ
                    [(Term.app `Nat.pos_of_mem_divisors [(Term.app `snd_mem_divisors_of_mem_antidiagonal [`hx])])])]))]
               "]")
              [])
             [])])))
        [])])))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `ne_of_gtₓ [(Term.app `Nat.pos_of_mem_divisors [(Term.app `snd_mem_divisors_of_mem_antidiagonal [`hx])])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `snd_mem_divisors_of_mem_antidiagonal [`hx])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `Nat.pos_of_mem_divisors [(Term.paren "(" [(Term.app `snd_mem_divisors_of_mem_antidiagonal [`hx]) []] ")")])
  []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `ne_of_gtₓ
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(Term.app
   ...
   [(Term.paren
     ...
     [(Term.app
       `Nat.pos_of_mem_divisors
       [(Term.paren "(" [(Term.app `snd_mem_divisors_of_mem_antidiagonal [`hx]) []] ")")])
      []]
     ")")])
  []]
 ")")
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `sum_congr [`rfl (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`x `hx] [])] "=>" (Term.hole "_")))])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `ext_iff)] "]") [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `ext_iff
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.«tactic_<;>_» (Tactic.constructor "constructor") "<;>" (Tactic.intro "intro" [`h]))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 73, term))
  (Nat.ArithmeticFunction.NumberTheory.ArithmeticFunction.termμ "μ")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Nat.ArithmeticFunction.NumberTheory.ArithmeticFunction.termμ', expected 'antiquot'
     ...
     [(group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `ext_iff)] "]") []) [])
      ...
      (group
       (Tactic.rwSeq
        ...
        (Tactic.rwRuleSeq
         "["
         [(Tactic.rwRule [] (Term.app `if_neg [(Term.app `ne_of_gtₓ [(Term.app `Nat.pos_of_mem_divisors [`hx])])]))]
         "]")
        [])
       [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.«tactic·._»', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `ne_of_gtₓ [(Term.app `Nat.pos_of_mem_divisors [`hx])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Nat.pos_of_mem_divisors [`hx])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Nat.pos_of_mem_divisors [`hx]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `ne_of_gtₓ
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `ne_of_gtₓ [(Term.paren "(" [(Term.app `Nat.pos_of_mem_divisors [`hx]) []] ")")]) []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `if_neg
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `coe_zeta_smul_apply)] "]") [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `coe_zeta_smul_apply
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeAscription', expected 'Lean.Parser.Term.typeAscription.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `arithmetic_function [(termℤ "ℤ")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `arithmetic_function [`R])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " Möbius inversion for functions to a `comm_ring`. -/")]
  []
  []
  []
  []
 ...
 (Command.theorem
  "theorem"
  (Command.declId `sum_eq_iff_sum_mul_moebius_eq [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `CommRingₓ [`R]) "]")
    (Term.implicitBinder "{" [`f `g] [":" (Term.arrow (termℕ "ℕ") "→" `R)] "}")]
   (Term.typeSpec
  ...
  (Command.declValSimple
   ...
   (Term.byTactic
    ...
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `sum_eq_iff_sum_smul_moebius_eq)] "]") [])
        [])
       (group (Tactic.apply "apply" `forall_congrₓ) [])
          ...
          [(Term.app `Iff.refl [(Term.hole "_")])
           (Term.app
            ...
            [(Term.app
              ...
              [`rfl (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`x `hx] [])] "=>" (Term.hole "_")))])])]))
        [])
       (group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `zsmul_eq_mul)] "]") []) [])])))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `zsmul_eq_mul)] "]") [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `zsmul_eq_mul
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Iff.refl [(Term.hole "_")]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `imp_congr
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " Möbius inversion for functions to a `comm_group`. -/")]
  []
  []
  []
  []
 ...
 (Command.theorem
  "theorem"
  (Command.declId `prod_eq_iff_prod_pow_moebius_eq [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `CommGroupₓ [`R]) "]")
    (Term.implicitBinder "{" [`f `g] [":" (Term.arrow (termℕ "ℕ") "→" `R)] "}")]
   (Term.typeSpec
    ":"
    («term_↔_»
  ...
  (Command.declValSimple
   ":="
   (Term.app
    (Term.explicit "@" `sum_eq_iff_sum_smul_moebius_eq)
    [(Term.app `Additive [`R]) (Term.hole "_") (Term.hole "_") (Term.hole "_")])
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Additive [`R]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.explicit "@" `sum_eq_iff_sum_smul_moebius_eq)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.explicit', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.explicit', expected 'Lean.Parser.Term.explicit.antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " Möbius inversion for functions to a `comm_group_with_zero`. -/")]
  []
  []
  []
  []
 ...
 (Command.theorem
  "theorem"
  (Command.declId `prod_eq_iff_prod_pow_moebius_eq_of_nonzero [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `CommGroupWithZero [`R]) "]")
    (Term.implicitBinder "{" [`f `g] [":" (Term.arrow (termℕ "ℕ") "→" `R)] "}")
    (Term.explicitBinder
     "("
     [`hf]
     [":"
      (Term.forall
       ...
       [(Term.simpleBinder [`n] [(Term.typeSpec ":" (termℕ "ℕ"))])]
       ","
       (Term.arrow («term_<_» (numLit "0") "<" `n) "→" («term_≠_» (Term.app `f [`n]) "≠" (numLit "0"))))]
     []
     ")")
    (Term.explicitBinder
     "("
     ...
     [":"
      (Term.forall
       ...
       [(Term.simpleBinder [`n] [(Term.typeSpec ":" (termℕ "ℕ"))])]
       ","
       (Term.arrow («term_<_» (numLit "0") "<" `n) "→" («term_≠_» (Term.app `g [`n]) "≠" (numLit "0"))))]
     []
     ")")]
   (Term.typeSpec
    ":"
          ...
          (Term.app
           ...
           [(Term.app
             ...
             [(Term.app
              ...
              (Term.app
               (Term.explicit "@" `prod_eq_iff_prod_pow_moebius_eq)
               [(Term.app `Units [`R])
                (Term.hole "_")
                (Term.fun
                 "fun"
                 (Term.basicFun
                  ...
                  (termDepIfThenElse
                   ...
                   («term_<_» (numLit "0") "<" `n)
                   "then"
                   (Term.app `Units.mk0 [(Term.app `f [`n]) (Term.app `hf [`n `h])])
                   "else"
                   (numLit "1"))))
                (Term.fun
                 "fun"
                 (Term.basicFun
                  ...
                  (termDepIfThenElse
                   ...
                   («term_<_» (numLit "0") "<" `n)
                   "then"
                   (Term.app `Units.mk0 [(Term.app `g [`n]) (Term.app `hg [`n `h])])
                   "else"
                   (numLit "1"))))])])
            (Term.app
             `forall_congrₓ
           ...
           [(group (Tactic.dsimp "dsimp" [] [] [] [] []) [])
            (group
             (Tactic.rwSeq
              ...
              (Tactic.rwRuleSeq
               "["
               [(Tactic.rwRule [] (Term.app `dif_pos [`hn]))
                ","
                (Tactic.rwRule ["←"] `Units.eq_iff)
                ","
                (Tactic.rwRule ["←"] `Units.coe_hom_apply)
                ","
                (Tactic.rwRule [] `MonoidHom.map_prod)
                ","
                (Tactic.rwRule [] `Units.coe_mk0)
                ","
                (Tactic.rwRule [] (Term.app `prod_congr [`rfl (Term.hole "_")]))]
               "]")
              [])
             [])
            ...
            (group
             (Tactic.rwSeq
              ...
              (Tactic.rwRuleSeq
               "["
               [(Tactic.rwRule [] (Term.app `dif_pos [(Term.app `Nat.pos_of_mem_divisors [`hx])]))
                ","
                (Tactic.rwRule [] `Units.coe_hom_apply)
                ","
                (Tactic.rwRule [] `Units.coe_mk0)]
             ...
             (Tactic.rwSeq
              ...
              (Tactic.rwRuleSeq
               ...
               [(Tactic.rwRule
                 ...
                 (Term.app
                  `dif_pos
                  [(Term.app `Nat.pos_of_mem_divisors [(Term.app `Nat.snd_mem_divisors_of_mem_antidiagonal [`hx])])]))
                ","
                (Tactic.rwRule [] `Units.coe_hom_apply)
                ","
                (Tactic.rwRule [] `Units.coe_zpow₀)
                ","
                (Tactic.rwRule [] `Units.coe_mk0)]
               "]")
              [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `dif_pos [(Term.app `Nat.pos_of_mem_divisors [(Term.app `Nat.snd_mem_divisors_of_mem_antidiagonal [`hx])])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Nat.snd_mem_divisors_of_mem_antidiagonal [`hx])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(Term.app
   `Nat.pos_of_mem_divisors
   [(Term.paren "(" [(Term.app `Nat.snd_mem_divisors_of_mem_antidiagonal [`hx]) []] ")")])
  []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `dif_pos
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `prod_congr [`rfl (Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `dif_pos [(Term.app `Nat.pos_of_mem_divisors [`hx])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
  ...
  (Tactic.«tactic_<;>_»
   (Tactic.refine'
    ...
    (Term.app
     ...
     [(Term.app
       `Iff.trans
       [(Term.app `forall_congrₓ [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`n] [])] "=>" (Term.hole "_")))])
        (Term.app
         (Term.explicit "@" `prod_eq_iff_prod_pow_moebius_eq)
         [(Term.app `Units [`R])
          (Term.hole "_")
   ...
   (Tactic.refine'
    "refine'"
    (Term.app `imp_congr_right [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`hn] [])] "=>" (Term.hole "_")))])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.«tactic_<;>_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.refine'
   "refine'"
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `hf [`n `h]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis.antiquot'
 ...
 [(Term.fun
   ...
   (Term.basicFun
    ...
    (termDepIfThenElse
     ...
     (Term.app
      `Units.mk0
      [(Term.paren "(" [(Term.app `f [`n]) []] ")") (Term.paren "(" [(Term.app `hf [`n `h]) []] ")")])
     "else"
     (numLit "1"))))
  []]
 ")")
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (some 1023, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Units [`R]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.explicit "@" `prod_eq_iff_prod_pow_moebius_eq)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.explicit', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.explicit', expected 'Lean.Parser.Term.explicit.antiquot'
    ...
    (Term.fun
     ...
     (Term.basicFun
      ...
      (termDepIfThenElse
       ...
       (Term.app
        `Units.mk0
        [(Term.paren "(" [(Term.app `g [`n]) []] ")") (Term.paren "(" [(Term.app `hg [`n `h]) []] ")")])
       "else"
       (numLit "1"))))])
  []]
 ")")
...
/-- Möbius inversion for functions to a `comm_group_with_zero`. -/
  theorem
    ...
    [ CommGroupWithZero R ] { f g : ℕ → R } ( hf : ∀ n : ℕ , 0 < n → f n ≠ 0 ) ( hg : ∀ n : ℕ , 0 < n → g n ≠ 0 )
      :
        ∀ n : ℕ , 0 < n → ∏ i in n.divisors , f i = g n
          ↔
          ∀ n : ℕ , 0 < n → ∏ x : ℕ × ℕ in n.divisors_antidiagonal , g x.snd ^ μ x.fst = f n
        ...
        refine'
          ...
          ·
            dsimp
              ...
              rw
                [
                  dif_pos Nat.pos_of_mem_divisors Nat.snd_mem_divisors_of_mem_antidiagonal hx
                    ,
                    Units.coe_hom_apply
                    ,
                    Units.coe_zpow₀
