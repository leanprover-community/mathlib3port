              ...
              Inter_subset_Inter
                fun
                  n
                    ...
                    Union_subset_Union
                      $
                      fun a => Union_subset_Union $ fun b => Union_subset_Union $ fun hb => diff_subset _ _
        ·
...
/-- The set of Liouville numbers in dense. -/
  theorem dense_liouville : Dense { x | Liouville x } := dense_of_mem_residual eventually_residual_liouville
