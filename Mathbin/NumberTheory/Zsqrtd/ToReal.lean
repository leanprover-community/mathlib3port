...
but is expected to have type
  forall {d : Int} (h0d : LE.le.{0} Int Int.instLEInt (OfNat.ofNat.{0} Int 0 (instOfNatInt 0)) d), (forall (n : Int), Ne.{1} Int d (HMul.hMul.{0, 0, 0} Int Int Int (instHMul.{0} Int Int.instMulInt) n n)) -> (Function.Injective.{1, 1} (Zsqrtd d) Real (FunLike.coe.{1, 1, 1} (RingHom.{0, 0} (Zsqrtd d) Real (Semiring.toNonAssocSemiring.{0} (Zsqrtd d) (Zsqrtd.instSemiringZsqrtd d)) (Semiring.toNonAssocSemiring.{0} Real Real.semiring)) (Zsqrtd d) (fun (_x : Zsqrtd d) => (fun (x._@.Mathlib.Algebra.Hom.Group._hyg.2397 : Zsqrtd d) => Real) _x) (MulHomClass.toFunLike.{0, 0, 0} (RingHom.{0, 0} (Zsqrtd d) Real (Semiring.toNonAssocSemiring.{0} (Zsqrtd d) (Zsqrtd.instSemiringZsqrtd d)) (Semiring.toNonAssocSemiring.{0} Real Real.semiring)) (Zsqrtd d) Real (NonUnitalNonAssocSemiring.toMul.{0} (Zsqrtd d) (NonAssocSemiring.toNonUnitalNonAssocSemiring.{0} (Zsqrtd d) (Semiring.toNonAssocSemiring.{0} (Zsqrtd d) (Zsqrtd.instSemiringZsqrtd d)))) (NonUnitalNonAssocSemiring.toMul.{0} Real (NonAssocSemiring.toNonUnitalNonAssocSemiring.{0} Real (Semiring.toNonAssocSemiring.{0} Real Real.semiring))) (NonUnitalRingHomClass.toMulHomClass.{0, 0, 0} (RingHom.{0, 0} (Zsqrtd d) Real (Semiring.toNonAssocSemiring.{0} (Zsqrtd d) (Zsqrtd.instSemiringZsqrtd d)) (Semiring.toNonAssocSemiring.{0} Real Real.semiring)) (Zsqrtd d) Real (NonAssocSemiring.toNonUnitalNonAssocSemiring.{0} (Zsqrtd d) (Semiring.toNonAssocSemiring.{0} (Zsqrtd d) (Zsqrtd.instSemiringZsqrtd d))) (NonAssocSemiring.toNonUnitalNonAssocSemiring.{0} Real (Semiring.toNonAssocSemiring.{0} Real Real.semiring)) (RingHomClass.toNonUnitalRingHomClass.{0, 0, 0} (RingHom.{0, 0} (Zsqrtd d) Real (Semiring.toNonAssocSemiring.{0} (Zsqrtd d) (Zsqrtd.instSemiringZsqrtd d)) (Semiring.toNonAssocSemiring.{0} Real Real.semiring)) (Zsqrtd d) Real (Semiring.toNonAssocSemiring.{0} (Zsqrtd d) (Zsqrtd.instSemiringZsqrtd d)) (Semiring.toNonAssocSemiring.{0} Real Real.semiring) (RingHom.instRingHomClassRingHom.{0, 0} (Zsqrtd d) Real (Semiring.toNonAssocSemiring.{0} (Zsqrtd d) (Zsqrtd.instSemiringZsqrtd d)) (Semiring.toNonAssocSemiring.{0} Real Real.semiring))))) (Zsqrtd.toReal d h0d)))
