...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `frequently_at_top_modeq_one [])
  (Command.declSig
   [(Term.explicitBinder "(" [`k] [":" (termℕ "ℕ")] [] ")")
    (Term.explicitBinder "(" [`hpos] [":" («term_<_» (numLit "0") "<" `k)] [] ")")]
   (Term.typeSpec
    ":"
    (Filter.Order.Filter.Basic.«term∃ᶠ_in_,_»
     ...
     («term_∧_»
      ...
      "∧"
      (Nat.Data.Nat.Modeq.«term_≡_[MOD_]» `p " ≡ " (numLit "1") " [MOD " `k "]")))))
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.refine'
         "refine'"
         (Term.app
          (Term.proj `frequently_at_top "." (fieldIdx "2"))
        ...
        (Tactic.obtain
         ...
         [(Tactic.rcasesPatMed
           [(Tactic.rcasesPat.tuple
             ...
             "⟩")])]
         []
         [":=" [(Term.app `exists_prime_ge_modeq_one [`k `n `hpos])]])
        [])
       (group
        (Tactic.exact
         "exact"
         (Term.anonymousCtor
          ...
          [`p
           ...
           (Term.anonymousCtor
            "⟨"
            [(Term.proj (Term.proj `hp "." (fieldIdx "2")) "." (fieldIdx "1"))
             ","
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_∧_» (Term.app `Nat.Prime [`p]) "∧" (Nat.Data.Nat.Modeq.«term_≡_[MOD_]» `p " ≡ " (numLit "1") " [MOD " `k "]"))
...
[PrettyPrinter.parenthesize] ...precedences are 35 >? 50, (none, [anonymous]) <=? (none, [anonymous])
...
theorem
  ...
  ( k : ℕ ) ( hpos : 0 < k ) : ∃ᶠ p in at_top , Nat.Prime p ∧ p ≡ 1 [MOD k ]
  :=
    by
