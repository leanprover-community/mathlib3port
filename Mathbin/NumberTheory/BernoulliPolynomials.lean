...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " The Bernoulli polynomials are defined in terms of the negative Bernoulli numbers. -/")]
  []
  []
  []
  []
 ...
 (Command.def
  "def"
  (Command.declId `bernoulliPoly [])
  (Command.optDeclSig
   [(Term.explicitBinder "(" [`n] [":" (termℕ "ℕ")] [] ")")]
   [(Term.typeSpec ":" (Term.app `Polynomial [(Data.Rat.Basic.termℚ "ℚ")]))])
  (Command.declValSimple
   ...
   (Algebra.BigOperators.Basic.«term∑_in_,_»
    ...
    (Term.app
     `Polynomial.monomial
     [(«term_-_» `n "-" `i)
      (Finset.Data.Finset.Fold.«term_*_» (Term.app `bernoulli [`i]) "*" (Term.app `choose [`n `i]))]))
   [])
  []
  []
  []))
...
/-- The Bernoulli polynomials are defined in terms of the negative Bernoulli numbers. -/
  def bernoulliPoly ( n : ℕ ) : Polynomial ℚ := ∑ i in range n + 1 , Polynomial.monomial n - i bernoulli i * choose n i
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `bernoulli_poly_def [])
  (Command.declSig
   [(Term.explicitBinder "(" [`n] [":" (termℕ "ℕ")] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app `bernoulliPoly [`n])
     "="
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      "∑"
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
      ...
      (Term.app
       ...
       [`i
        (Finset.Data.Finset.Fold.«term_*_»
         (Term.app `bernoulli [(«term_-_» `n "-" `i)])
         "*"
         (Term.app `choose [`n `i]))])))))
  (Command.declValSimple
   ":="
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.rwSeq
         ...
         (Tactic.rwRuleSeq
          "["
          [(Tactic.rwRule ["←"] `sum_range_reflect)
           ","
           (Tactic.rwRule [] `add_succ_sub_one)
           ","
           (Tactic.rwRule [] `add_zeroₓ)
           ","
           (Tactic.rwRule [] `bernoulliPoly)]
          "]")
         [])
        [])
       ...
       (group
        (Tactic.rintro
         "rintro"
         [(Tactic.rintroPat.one (Tactic.rcasesPat.one `x)) (Tactic.rintroPat.one (Tactic.rcasesPat.one `hx))]
         [])
        [])
       (group
        (Tactic.rwSeq
         "rw"
         []
         (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `mem_range_succ_iff)] "]")
       ...
       (group
        (Tactic.rwSeq
         ...
         (Tactic.rwRuleSeq
          "["
          [(Tactic.rwRule [] (Term.app `choose_symm [`hx]))
           ","
           (Tactic.rwRule [] (Term.app `tsub_tsub_cancel_of_le [`hx]))]
          "]")
         [])
        [])])))
   [])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.rwSeq
   ...
   (Tactic.rwRuleSeq
    "["
    [(Tactic.rwRule [] (Term.app `choose_symm [`hx])) "," (Tactic.rwRule [] (Term.app `tsub_tsub_cancel_of_le [`hx]))]
    "]")
   [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `tsub_tsub_cancel_of_le [`hx])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Algebra.BigOperators.Basic.«term∑_in_,_»
   ...
   (Term.app
    `Polynomial.monomial
    [`i
     (Finset.Data.Finset.Fold.«term_*_» (Term.app `bernoulli [(«term_-_» `n "-" `i)]) "*" (Term.app `choose [`n `i]))]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Algebra.BigOperators.Basic.«term∑_in_,_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app
   `Polynomial.monomial
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Finset.Data.Finset.Fold.«term_*_»
   (Term.app `bernoulli [(Term.paren "(" [(«term_-_» `n "-" `i) []] ")")])
   "*"
   (Term.app `choose [`n `i]))
  []]
 ")")
...
theorem
  bernoulli_poly_def
  ( n : ℕ ) : bernoulliPoly n = ∑ i in range n + 1 , Polynomial.monomial i bernoulli n - i * choose n i
  :=
    by
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `bernoulli_poly_eval_zero [])
  (Command.declSig
   [(Term.explicitBinder "(" [`n] [":" (termℕ "ℕ")] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app (Term.proj (Term.app `bernoulliPoly [`n]) "." `eval) [(numLit "0")])
     "="
      ...
      [(group
        (Tactic.rwSeq
         ...
         (Tactic.rwRuleSeq
          ...
          [(Tactic.rwRule [] `bernoulliPoly)
           ","
           (Tactic.rwRule [] `Polynomial.eval_finset_sum)
           ","
           ...
           [(Term.typeSpec
             ...
             («term_=_»
              (Algebra.BigOperators.Basic.«term∑_in_,_»
               ...
               ", "
               (Finset.Data.Finset.Fold.«term_*_»
                (Finset.Data.Finset.Fold.«term_*_» (Term.app `bernoulli [`x]) "*" (Term.app `n.choose [`x]))
                "*"
                (Cardinal.SetTheory.Cardinal.«term_^_» (numLit "0") "^" («term_-_» `n "-" `x))))
              "="
              (numLit "0")))]
           ":="
           (Term.byTactic
               ...
               (group
                (Tactic.tacticHave_
                 ...
                 (Term.haveDecl
                  (Term.haveIdDecl
                   [`h []]
                   [(Term.typeSpec ":" («term_<_» (numLit "0") "<" («term_-_» `n "-" `x)))]
                   ":="
                   (Term.app `tsub_pos_of_lt [(Term.app (Term.proj `mem_range "." (fieldIdx "1")) [`hx])]))))
                [])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.proj `mem_range "." (fieldIdx "1")) [`hx])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.apply
   "apply"
   (Term.app `sum_eq_zero [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`x `hx] [])] "=>" (Term.hole "_")))]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.apply', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `sum_eq_zero [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`x `hx] [])] "=>" (Term.hole "_")))])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
@[ simp ]
  theorem
    bernoulli_poly_eval_zero
    ( n : ℕ ) : bernoulliPoly n . eval 0 = bernoulli n
    :=
      by
        rw [ bernoulliPoly , Polynomial.eval_finset_sum , sum_range_succ ]
          have
            : ∑ x : ℕ in range n , bernoulli x * n.choose x * 0 ^ n - x = 0
              :=
              by apply sum_eq_zero fun x hx => _ have h : 0 < n - x := tsub_pos_of_lt mem_range . 1 hx simp [ h ]
          simp [ this ]
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `sum_bernoulli_poly [])
  (Command.declSig
   [(Term.explicitBinder "(" [`n] [":" (termℕ "ℕ")] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      ...
      (Algebra.Group.Defs.«term_•_»
       (Term.paren
        "("
        [(Term.app (Term.proj (Init.Logic.«term_+_» `n "+" (numLit "1")) "." `choose) [`k])
         [(Term.typeAscription ":" (Data.Rat.Basic.termℚ "ℚ"))]]
        ")")
       " • "
       (Term.app `bernoulliPoly [`k])))
     "="
     (Term.app
      `Polynomial.monomial
      [`n
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.simpRw
         ...
         (Tactic.rwRuleSeq
          "["
          [(Tactic.rwRule [] `bernoulli_poly_def)
           ","
           (Tactic.rwRule [] `Finset.smul_sum)
           ","
           (Tactic.rwRule [] `Finset.range_eq_Ico)
           ","
           (Tactic.rwRule ["←"] `Finset.sum_Ico_Ico_comm)
           ","
           (Tactic.rwRule [] `Finset.sum_Ico_eq_sum_range)]
          "]")
         [])
        [])
       (group
       ...
       (group
        (Tactic.simpRw
         ...
         (Tactic.rwRuleSeq
          "["
          [(Tactic.rwRule [] `Polynomial.smul_monomial)
           ","
           (Tactic.rwRule [] (Term.app `mul_commₓ [(Term.app `bernoulli [(Term.hole "_")]) (Term.hole "_")]))
           ","
               ...
               (Tactic.Conv.convSeq1Indented
                [(group (Tactic.Conv.applyCongr "apply_congr" []) [])
                 ...
                 (group
                    ...
                    [(Tactic.rwRule ["←"] `Nat.cast_mul)
                     ...
                     (Tactic.rwRule
                      ...
                      (Term.app
                       `choose_mul
                       [(«term_$__»
                         (Term.proj («term_$__» `le_tsub_iff_left "$" (Term.app `mem_range_le [`H])) "." (fieldIdx "1"))
                         "$"
                         (Term.app `mem_range_le [`H_1]))
                        (Term.app `le.intro [`rfl])]))
                     ","
                     (Tactic.rwRule [] `Nat.cast_mul)
                     ","
                     (Tactic.rwRule [] (Term.app `add_commₓ [`x `x_1]))
                     ","
                  ...
                  [])])))
             [])
            (group (Tactic.Conv.convRw__ "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `sum_smul)] "]")) [])])))
        [])
       (group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `sum_range_succ_comm)] "]") []) [])
       (group
        (Tactic.simp
         "simp"
         []
         ["only"]
         ["["
          [(Tactic.simpLemma [] [] `add_right_eq_selfₓ)
           ","
           (Tactic.simpLemma [] [] `cast_succ)
           ","
           ...
           ","
           (Tactic.simpLemma [] [] `cast_add)
           ","
           (Tactic.simpLemma [] [] `add_tsub_cancel_left)
           ","
           (Tactic.simpLemma [] [] `choose_succ_self_right)
           ","
             ...
             (Term.forall
              ...
              (Mathlib.ExtendedBinder.«term∀___,_»
               ...
               (Term.forall
                ...
                («term¬_»
                 "¬"
                 («term_=_» («term_-_» (Init.Logic.«term_+_» `n "+" (numLit "1")) "-" `x) "=" (numLit "1")))))))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(group
                (Tactic.rintro
                 "rintro"
                 [(Tactic.rintroPat.one (Tactic.rcasesPat.one `x)) (Tactic.rintroPat.one (Tactic.rcasesPat.one `H))]
                 [])
                [])
               (group
                (Tactic.rwSeq
                ...
                [])
               (group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `eq_comm)] "]") []) [])
               (group
                (Tactic.exact
                 "exact"
                 (Term.app
                  ...
                  [(Term.app
                    `Nat.lt_of_lt_of_leₓ
                    [`one_lt_two (Term.app `le_tsub_of_add_le_left [(Term.app `succ_le_succ [`H])])])]))
                [])]))))))
        [])
       (group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `sum_bernoulli)] "]") []) [])
       (group
        (Tactic.tacticHave_
         "have"
         (Term.haveDecl
           ...
           [(Term.typeSpec
             ...
             («term_=_»
              (Term.app
               `ite
               [(«term_=_» («term_-_» (Init.Logic.«term_+_» `n "+" (numLit "1")) "-" `x) "=" (numLit "1"))
                (Term.paren "(" [(numLit "1") [(Term.typeAscription ":" (Data.Rat.Basic.termℚ "ℚ"))]] ")")
                (numLit "0")])
              "="
              (numLit "0")))]
           ":="
             ...
             (Tactic.tacticSeq1Indented
              [(group
                (Tactic.simp
                 ...
                 []
                 ["only"]
                 ["[" [(Tactic.simpLemma [] [] `ite_eq_right_iff) "," (Tactic.simpLemma [] [] `one_ne_zero)] "]"]
                 [])
                [])
               (group (Tactic.intro "intro" [`h₁]) [])
               (group (Tactic.exact "exact" (Term.app (Term.app `f [`x `hx]) [`h₁])) [])]))))))
        [])
       (group
        (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `g) "," (Tactic.rwRule [] `zero_smul)] "]") [])
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app (Term.app `f [`x `hx]) [`h₁]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.app `f [`x `hx]) [`h₁])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `f [`x `hx]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
...
[PrettyPrinter.parenthesize] ...precedences are 51 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 50, term))
  («term_-_» (Init.Logic.«term_+_» `n "+" (numLit "1")) "-" `x)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_-_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `x
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(«term_=_» («term_-_» (Term.paren "(" [(Init.Logic.«term_+_» `n "+" (numLit "1")) []] ")") "-" `x) "=" (numLit "1"))
  []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `ite
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `sum_bernoulli)] "]") [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `sum_bernoulli
       ...
       (Term.forall
        ...
        (Mathlib.ExtendedBinder.«term∀___,_»
         ...
         (Term.forall
          ...
          []
          ","
          («term¬_» "¬" («term_=_» («term_-_» (Init.Logic.«term_+_» `n "+" (numLit "1")) "-" `x) "=" (numLit "1")))))))]
     ":="
     (Term.byTactic
      "by"
      (Tactic.tacticSeq
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact
   ...
   (Term.app
    `ne_of_ltₓ
    [(Term.app `Nat.lt_of_lt_of_leₓ [`one_lt_two (Term.app `le_tsub_of_add_le_left [(Term.app `succ_le_succ [`H])])])]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app
   `ne_of_ltₓ
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `le_tsub_of_add_le_left [(Term.app `succ_le_succ [`H])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `succ_le_succ [`H]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `le_tsub_of_add_le_left [(Term.paren "(" [(Term.app `succ_le_succ [`H]) []] ")")]) []]
 ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `eq_comm)] "]") [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `eq_comm
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `sum_range_succ_comm)] "]") [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `sum_range_succ_comm
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `le.intro [`rfl]) []] ")")
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  («term_$__» `le_tsub_iff_left "$" (Term.app `mem_range_le [`H]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `mem_range_le [`H])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(«term_$__»
   (Term.proj
    (Term.paren "(" [(«term_$__» `le_tsub_iff_left "$" (Term.app `mem_range_le [`H])) []] ")")
    "."
    (fieldIdx "1"))
   "$"
   (Term.app `mem_range_le [`H_1]))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `mul_commₓ [(Term.app `bernoulli [(Term.hole "_")]) (Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, term))
  (Term.app `bernoulli [(Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `bernoulli [(Term.hole "_")]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `mul_commₓ
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
@[ simp ]
  theorem
    sum_bernoulli_poly
    ( n : ℕ ) : ∑ k in range n + 1 , ( n + 1 . choose k : ℚ ) • bernoulliPoly k = Polynomial.monomial n ( n + 1 : ℚ )
    :=
      by
        simp_rw
            [
          ...
          have
            g
              : ite n + 1 - x = 1 ( 1 : ℚ ) 0 = 0
              :=
              by simp only [ ite_eq_right_iff , one_ne_zero ] intro h₁ exact f x hx h₁
          rw [ g , zero_smul ]
