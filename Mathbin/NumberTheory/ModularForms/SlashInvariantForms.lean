      ...
      (Term.explicitBinder
       ...
       [":"
        («term_<|_»
         ...
         (Term.app
          `Subgroup
          [(NumberTheory.ModularForms.SlashInvariantForms.«termSL(_,_)»
            "SL("
            (num "2")
            ", "
            (termℤ "ℤ")
       ...
       []
       ")")
      (Term.explicitBinder "(" [`k] [":" (Term.app `outParam [(termℤ "ℤ")])] [] ")")])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `outParam [(termℤ "ℤ")])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app
       ...
       [(NumberTheory.ModularForms.SlashInvariantForms.«termSL(_,_)»
         ...
         (termℤ "ℤ")
         ")")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'NumberTheory.ModularForms.SlashInvariantForms.«termSL(_,_)»', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'NumberTheory.ModularForms.SlashInvariantForms.«termSL(_,_)»', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (NumberTheory.ModularForms.SlashInvariantForms.«termSL(_,_)»
       "SL("
       (num "2")
       ...
       (termℤ "ℤ")
       ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'NumberTheory.ModularForms.SlashInvariantForms.«termSL(_,_)»', expected 'NumberTheory.ModularForms.SlashInvariantForms.termSL(_,_)._@.NumberTheory.ModularForms.SlashInvariantForms._hyg.909'
        ...
        («term_<|_»
         ...
         (Term.app
          ...
          [(NumberTheory.ModularForms.SlashInvariantForms.«termSL(_,_)»
            ...
            ")")]))]
       "}")
      (Term.implicitBinder "{" [`k] [":" (Term.app `outParam [(termℤ "ℤ")])] "}")])
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `slash_action_eqn' [])
      (Command.declSig
       [(Term.explicitBinder "(" [`k] [":" (termℤ "ℤ")] [] ")")
        (Term.explicitBinder
         ...
         []
         ")")
        (Term.instBinder "[" [] (Term.app `SlashInvariantFormClass [`F `Γ `k]) "]")
           ...
           («term_+_»
            («term_*_»
             (Term.typeAscription
              "("
              (Term.app
               (NumberTheory.ModularForms.SlashInvariantForms.«term↑ₘ_» "↑ₘ" `γ)
               [(num "1") (num "0")])
              ":"
        ...
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(Tactic.rwSeq
            ...
            (Tactic.rwRuleSeq
             "["
             [(Tactic.rwRule [(patternIgnore (token.«← » "←"))] `ModularForm.slash_action_eq'_iff)]
             "]")
            [])
           []
           (Tactic.simp "simp" [] [] [] [] [])])))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      (NumberTheory.ModularForms.SlashInvariantForms.«term↑ₘ_» "↑ₘ" `γ)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'NumberTheory.ModularForms.SlashInvariantForms.«term↑ₘ_»', expected 'NumberTheory.ModularForms.SlashInvariantForms.term↑ₘ_._@.NumberTheory.ModularForms.SlashInvariantForms._hyg.28'
...
theorem
  ...
  ( k : ℤ )
      ...
      ( γ : Γ )
      ( z : ℍ )
    : f γ • z = ( ↑ₘ γ 1 0 : ℂ ) * z + ( ↑ₘ γ 1 1 : ℂ ) ^ k * f z
  := by rw [ ← ModularForm.slash_action_eq'_iff ] simp
#align slash_invariant_form.slash_action_eqn' SlashInvariantForm.slash_action_eqn'
