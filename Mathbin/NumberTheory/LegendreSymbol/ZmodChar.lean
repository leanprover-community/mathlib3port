...
theorem isQuadraticχ₄ : χ₄.IsQuadratic := by
  intro a
  decide!
#align zmod.is_quadratic_χ₄ Zmod.isQuadraticχ₄
...
theorem _root_.neg_one_pow_div_two_of_one_mod_four {n : ℕ} (hn : n % 4 = 1) : (-1 : ℤ) ^ (n / 2) = 1 := by
  ...
  rfl
#align zmod._root_.neg_one_pow_div_two_of_one_mod_four zmod._root_.neg_one_pow_div_two_of_one_mod_four
...
theorem _root_.neg_one_pow_div_two_of_three_mod_four {n : ℕ} (hn : n % 4 = 3) : (-1 : ℤ) ^ (n / 2) = -1 := by
  ...
  rfl
#align zmod._root_.neg_one_pow_div_two_of_three_mod_four zmod._root_.neg_one_pow_div_two_of_three_mod_four
