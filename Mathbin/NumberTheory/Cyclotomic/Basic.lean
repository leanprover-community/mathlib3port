...
theorem trans (C : Type w) [CommRing C] [Nontrivial C] [Algebra A C] [Algebra B C] [IsScalarTower A B C]
...
theorem finiteDimensional (C : Type z) [Fintype S] [CommRing C] [Algebra K C] [IsDomain C]
