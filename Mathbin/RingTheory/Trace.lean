...
theorem
  ...
  { x : L } ( hx : ¬ IsIntegral K x )
    :
      Algebra.trace
          K K ⟮ "././Mathport/Syntax/Translate/Basic.lean:813:11: unsupported (impossible)" ⟯ AdjoinSimple.gen K x
        =
        0
  :=
    by
      rw [ trace_eq_zero_of_not_exists_basis , LinearMap.zero_apply ]
        ...
        refine'
          is_integral_of_mem_of_fg
            K ⟮ "././Mathport/Syntax/Translate/Basic.lean:813:11: unsupported (impossible)" ⟯ . toSubalgebra _ x _
    ...
    by
      have
          injKKx
            :
              Function.Injective
                algebraMap K K ⟮ "././Mathport/Syntax/Translate/Basic.lean:813:11: unsupported (impossible)" ⟯
            :=
            RingHom.injective _
        have
          injKxL
            :
              Function.Injective
                algebraMap K ⟮ "././Mathport/Syntax/Translate/Basic.lean:813:11: unsupported (impossible)" ⟯ L
            :=
            RingHom.injective _
...
theorem
  ...
  [ FiniteDimensional K L ] ( x : L )
    :
      Algebra.trace K L x
        =
        finrank K ⟮ "././Mathport/Syntax/Translate/Basic.lean:813:11: unsupported (impossible)" ⟯ L
          •
          trace K K ⟮ "././Mathport/Syntax/Translate/Basic.lean:813:11: unsupported (impossible)" ⟯ AdjoinSimple.gen K x
  :=
    by
      rw
          [
      ...
      have hx := IsSeparable.is_integral K x
        ...
        ·
          have
              :=
                is_separable_tower_bot_of_is_separable
                  K K ⟮ "././Mathport/Syntax/Translate/Basic.lean:813:11: unsupported (impossible)" ⟯ L
