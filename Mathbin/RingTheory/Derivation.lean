     ...
     (Command.theorem
      ...
      (Command.declSig
       ...
       (Term.typeSpec
        ":"
        («term_=_»
         (RingTheory.Derivation.«term_𝖣_» `z "𝖣" («term_+_» `x "+" `y))
         "="
         («term_+_»
          (RingTheory.Derivation.«term_𝖣_» `z "𝖣" `x)
          "+"
          (RingTheory.Derivation.«term_𝖣_» `z "𝖣" `y)))))
        ...
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(Tactic.rwSeq
            ...
            (Tactic.rwRuleSeq
             "["
             [(Tactic.rwRule [(patternIgnore (token.«← » "←"))] `map_add)
              ","
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (RingTheory.Derivation.«term_𝖣_» `z "𝖣" `y)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'RingTheory.Derivation.«term_𝖣_»', expected 'RingTheory.Derivation.term_𝖣_._@.RingTheory.Derivation._hyg.703'
      ...
      (Command.declSig
       ...
       (Term.typeSpec
        ...
        («term_=_»
         ...
         "="
         («term_+_»
          (RingTheory.Derivation.«term_𝖣_» («term_*_» `z "*" `x) "𝖣" `y)
          "+"
          (RingTheory.Derivation.«term_𝖣_» («term_*_» `z "*" `y) "𝖣" `x)))))
      (Command.declValSimple
       ":="
       (Term.byTactic
        "by"
     ...
     (Command.theorem
      ...
      (Command.declSig
       ...
       (Term.typeSpec
        ":"
        («term_=_»
         (RingTheory.Derivation.«term_𝖣_» `y "𝖣" (Term.app `algebraMap [`R `S `x]))
         "="
         (num "0"))))
      (Command.declValSimple
       ":="
      ...
      (Tactic.exact
       ...
       (Term.app
        ...
        [(Term.hole "_")
         ...
         (Term.app
          `Submodule.subset_span
          [(«term_<|_» `Or.inr "<|" (Term.anonymousCtor "⟨" [(Term.hole "_") "," `rfl] "⟩"))])]))
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app
       `Submodule.smul_mem
       [(Term.hole "_")
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      ...
      (Command.declSig
       ...
       (Term.typeSpec
        ":"
        («term_=_» (RingTheory.Derivation.«term_𝖣_» `x "𝖣" (num "1")) "=" (num "0"))))
      (Command.declValSimple
       ":="
       (Term.byTactic
        "by"
...
[PrettyPrinter.parenthesize] ...precedences are 51 >? 1024, (none,
     [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 50, term))
      (RingTheory.Derivation.«term_𝖣_» `x "𝖣" (num "1"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'RingTheory.Derivation.«term_𝖣_»', expected 'RingTheory.Derivation.term_𝖣_._@.RingTheory.Derivation._hyg.703'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.opaque'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.instance'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.axiom'
...
theorem
  ...
  ( x ) : x 𝖣 1 = 0
  := by rw [ ← algebraMap R S . map_one , KaehlerDifferential.ker_total_mkq_single_algebra_map ]
#align
     ...
     (Command.theorem
      ...
      (Command.declSig
       ...
       (Term.typeSpec
        ":"
        («term_=_»
         (RingTheory.Derivation.«term_𝖣_» `y "𝖣" (Algebra.Group.Defs.«term_•_» `r " • " `x))
         "="
         (Algebra.Group.Defs.«term_•_» `r " • " (RingTheory.Derivation.«term_𝖣_» `y "𝖣" `x)))))
      (Command.declValSimple
       ":="
       (Term.byTactic
        "by"
          ...
          [(Tactic.rwSeq
            ...
            (Tactic.rwRuleSeq
             ...
             [(Tactic.rwRule [] `Algebra.smul_def)
              ...
              ","
              (Tactic.rwRule [(patternIgnore (token.«← » "←"))] `LinearMap.map_smul_of_tower)
              ","
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Algebra.Group.Defs.«term_•_» `r " • " (RingTheory.Derivation.«term_𝖣_» `y "𝖣" `x))
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (RingTheory.Derivation.«term_𝖣_» `y "𝖣" `x)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'RingTheory.Derivation.«term_𝖣_»', expected 'RingTheory.Derivation.term_𝖣_._@.RingTheory.Derivation._hyg.703'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.opaque'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.instance'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.axiom'
     ...
     (Command.def
      ...
      (Command.whereStructInst
       ...
       [(Command.whereStructField
         (Term.letDecl
          (Term.letIdDecl `toFun [`x] [] ":=" (RingTheory.Derivation.«term_𝖣_» (num "1") "𝖣" `x))))
        []
        (Command.whereStructField
         (Term.letDecl
          (Term.letIdDecl
           ...
           (Tactic.rwRuleSeq
            ...
            [(Tactic.rwRule
              ...
              (Term.app
               `Finsupp.smul_single_one
               [(Term.hole "_")
                (Term.typeAscription "(" («term_*_» (num "1") "*" (Term.hole "_")) ":" [`S] ")")]))]
            "]")
           [])
          []
          (Tactic.dsimp "dsimp" [] [] [] [] [])
...
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (RingTheory.Derivation.«term_𝖣_» (num "1") "𝖣" `x)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'RingTheory.Derivation.«term_𝖣_»', expected 'RingTheory.Derivation.term_𝖣_._@.RingTheory.Derivation._hyg.703'
...
theorem
  ...
  ( x ) : KaehlerDifferential.derivationQuotKerTotal R S x = 1 𝖣 x
  := rfl
#align
      ...
      (Tactic.simp
       ...
       ["["
        [(Tactic.simpLemma [] [] `LinearMap.comp_apply)
         ...
         (Tactic.simpLemma [] [] `Algebra.of_id_apply)
         ","
         (Tactic.simpLemma [] [(patternIgnore (token.«← » "←"))] `IsScalarTower.algebra_map_apply)
         ","
         (Tactic.simpLemma [] [] `map_one)
         ","
         (Tactic.simpLemma [] [] `map_add)
