...
instance (priority := 100) IsNoetherianRing.wf_dvd_monoid [CommRing α] [IsDomain α]
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `exists_prime_factors [])
      (Command.declSig
         ...
         («term∃_,_»
          ...
          («term_∧_»
           (Std.ExtendedBinder.«term∀__,_»
            ...
            (Term.app `Prime [`b]))
           "∧"
           (RingTheory.UniqueFactorizationDomain.«term_~ᵤ_» (Term.proj `f "." `Prod) " ~ᵤ " `a))))))
        ...
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(Mathlib.Tactic.tacticSimp_rw__
            ...
            [])
           []
           (Tactic.apply "apply" (Term.app `WfDvdMonoid.exists_factors [`a]))])))
       [])
      []
      []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Tactic.apply "apply" (Term.app `WfDvdMonoid.exists_factors [`a]))
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `WfDvdMonoid.exists_factors [`a])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, [anonymous]))
      (Term.arrow
       ...
       («term∃_,_»
        "∃"
        (Lean.explicitBinders
         (Lean.unbracketedExplicitBinders [(Lean.binderIdent `f)] [":" (Term.app `Multiset [`α])]))
        ","
        («term_∧_»
         (Std.ExtendedBinder.«term∀__,_»
          "∀"
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (RingTheory.UniqueFactorizationDomain.«term_~ᵤ_» (Term.proj `f "." `Prod) " ~ᵤ " `a)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'RingTheory.UniqueFactorizationDomain.«term_~ᵤ_»', expected 'RingTheory.UniqueFactorizationDomain.term_~ᵤ_._@.RingTheory.UniqueFactorizationDomain._hyg.7'
...
#align
  unique_factorization_monoid.exists_prime_factors UniqueFactorizationMonoid.exists_prime_factors
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `prime_factors_unique [])
      (Command.declSig
       ...
       (Term.typeSpec
        ...
        (Term.forall
         "∀"
         [(Term.implicitBinder "{" [`f `g] [":" (Term.app `Multiset [`α])] "}")]
         []
         ","
         (Term.arrow
          (Std.ExtendedBinder.«term∀__,_»
          ...
          (Term.arrow
           ...
           "→"
           (Term.arrow
            (RingTheory.UniqueFactorizationDomain.«term_~ᵤ_»
             (Term.proj `f "." `Prod)
             " ~ᵤ "
             (Term.proj `g "." `Prod))
            "→"
            (Term.app `Multiset.Rel [`Associated `f `g])))))))
      (Command.declValSimple
       ":="
       (Std.Tactic.haveI
        "haveI"
        (Term.haveDecl (Term.haveIdDecl [] [] ":=" (Term.app `Classical.decEq [`α])))
        []
        (Term.fun
         "fun"
         (Term.basicFun
           ...
           [`f
            (Term.fun
             ...
             (Term.basicFun
              ...
              "=>"
              («term_<|_»
               (Term.proj `Multiset.rel_zero_left "." (fieldIdx "2"))
               "<|"
               (Term.app
                  ...
                  (Term.basicFun
                   ...
                   (Term.have
                    ...
                    (Term.haveDecl
                     (Term.haveIdDecl
                      []
                      [(Term.typeSpec ":" (Term.app `IsUnit [(Term.proj `g "." `Prod)]))]
                      ":="
                      (Term.byTactic
                       "by"
                       (Tactic.tacticSeq
                        (Tactic.tacticSeq1Indented
                         [(Std.Tactic.Simpa.simpa
                           ...
                           (Std.Tactic.Simpa.simpaArgsRest
                            ...
                            [(Tactic.simpArgs
                              "["
                              [(Tactic.simpLemma [] [] `associated_one_iff_isUnit)]
                              "]")]
                            ["using" `h.symm]))])))))
                    []
                    («term_<|_»
                     (Term.proj (Term.app `hg [`x `hx]) "." `not_unit)
                     "<|"
                     («term_<|_»
                      (Term.proj `isUnit_iff_dvd_one "." (fieldIdx "2"))
                      "<|"
                      (Term.app
                       (Term.proj (Term.app `Multiset.dvd_prod [`hx]) "." `trans)
                       [(Term.app
                         (Term.proj `isUnit_iff_dvd_one "." (fieldIdx "1"))
                         [`this])]))))))]))))
            (Term.fun
             "fun"
             (Term.basicFun
                 ...
                 [(Tactic.tacticLet_
                     ...
                     («term_<|_»
                      (Term.app
                       ...
                       [(Term.app
                        ...
                        (Term.fun
                         "fun"
                         (Term.basicFun [`q `hq] [] "=>" (Term.app `hg [(Term.hole "_") `hq])))])
                      "<|"
                      (Term.app
                       (Term.proj (Term.proj `hfg "." `dvd_iff_dvd_right) "." (fieldIdx "1"))
                       [(Term.show
                         "show"
                         («term_∣_»
                          `p
                          "∣"
                          (Term.proj
                           (Multiset.Data.Multiset.Basic.«term_::ₘ_» `p " ::ₘ " `f)
                           "."
                           `Prod))
                         (Term.byTactic'
                          "by"
                  ...
                  (Tactic.rwSeq
                   ...
                   (Tactic.rwRuleSeq
                    ...
                    [(Tactic.rwRule
                      [(patternIgnore (token.«← » "←"))]
                      (Term.app `Multiset.cons_erase [`hbg]))]
                    "]")
                   [])
                  []
                  (Tactic.exact
                        ...
                        (Term.basicFun
                         [`q
                          (Term.typeAscription
                           ...
                           (Term.app `hq [])
                           ":"
                           [(«term_∈_» `q "∈" (Term.app `g.erase [`b]))]
                           ")")]
                         []
                         "=>"
                         (Term.app `hg [`q (Term.app `Multiset.mem_of_mem_erase [`hq])])))
                       (Term.app
                              ...
                              (Tactic.rwRuleSeq
                               ...
                               [(Tactic.rwRule
                                ...
                                (Tactic.rwRule
                                 ...
                                 `Multiset.prod_cons)
                                ","
                                (Tactic.rwRule [] (Term.app `Multiset.cons_erase [`hbg]))]
                               "]")
                              [])])))
                         `hb
                         (Term.proj
                        ...
                        (Tactic.tacticSeq
                         (Tactic.tacticSeq1Indented
                          [(Std.Tactic.tacticRwa__
                            ...
                            (Tactic.rwRuleSeq
                             "["
                             [(Tactic.rwRule [(patternIgnore (token.«← » "←"))] `Multiset.prod_cons)
                              ","
                              (Tactic.rwRule [(patternIgnore (token.«← » "←"))] `Multiset.prod_cons)
                              ","
                              (Tactic.rwRule [] (Term.app `Multiset.cons_erase [`hbg]))]
                ...
                (Term.app
                 ...
                 [(Term.show
                   ...
                   («term_∣_»
                    `p
                    "∣"
                    (Term.proj (Multiset.Data.Multiset.Basic.«term_::ₘ_» `p " ::ₘ " `f) "." `Prod))
                   (Term.byTactic'
                    "by"
                    (Tactic.tacticSeq
                     (Tactic.tacticSeq1Indented [(Tactic.simp "simp" [] [] [] [] [])]))))])))))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `Multiset.mem_of_mem_erase [`hq])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `hq
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
     ...
     (Term.fun
      ...
      (Term.basicFun
       ...
       []
       "=>"
       (Term.app `hg [`q (Term.paren "(" (Term.app `Multiset.mem_of_mem_erase [`hq]) ")")])))
     ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Tactic.rwSeq
       ...
       (Tactic.rwRuleSeq
        "["
        [(Tactic.rwRule [(patternIgnore (token.«← » "←"))] (Term.app `Multiset.cons_erase [`hbg]))]
        "]")
       [])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `Multiset.cons_erase [`hbg])
           ...
           [(Term.app
             ...
             [`p
              (Term.byTactic
               ...
               (Tactic.tacticSeq
                (Tactic.tacticSeq1Indented [(Tactic.simp "simp" [] [] [] [] [])])))])
            (Term.fun "fun" (Term.basicFun [`q `hq] [] "=>" (Term.app `hg [(Term.hole "_") `hq])))])
          "<|"
          (Term.app
           (Term.proj (Term.proj `hfg "." `dvd_iff_dvd_right) "." (fieldIdx "1"))
           [(Term.show
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
     ...
     (Term.show
      ...
      («term_∣_»
       ...
       "∣"
       (Term.proj
        (Term.paren "(" (Multiset.Data.Multiset.Basic.«term_::ₘ_» `p " ::ₘ " `f) ")")
        "."
        `Prod))
      (Term.byTactic'
       "by"
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      (Term.proj (Term.proj `hfg "." `dvd_iff_dvd_right) "." (fieldIdx "1"))
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      (Term.proj `hfg "." `dvd_iff_dvd_right)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      `hfg
             ...
             (Term.have
              ...
              («term_<|_»
               ...
               («term_<|_»
                ...
                (Term.app
                 (Term.proj (Term.app `Multiset.dvd_prod [`hx]) "." `trans)
                 [(Term.app (Term.proj `isUnit_iff_dvd_one "." (fieldIdx "1")) [`this])]))))))]))))
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      («term_<|_»
       (Term.proj `Multiset.rel_zero_left "." (fieldIdx "2"))
       "<|"
               ...
               (Tactic.tacticSeq1Indented
                [(Std.Tactic.Simpa.simpa
                  ...
                  (Std.Tactic.Simpa.simpaArgsRest
                   ...
                   []
                   []
                   [(Tactic.simpArgs "[" [(Tactic.simpLemma [] [] `associated_one_iff_isUnit)] "]")]
                   ["using" `h.symm]))])))))
           []
           («term_<|_»
            (Term.proj (Term.app `hg [`x `hx]) "." `not_unit)
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none,
     [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" (Term.app `Multiset.dvd_prod [`hx]) ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none,
     [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 10 >? 1022, (some 1023,
     term) <=? (none, [anonymous])
...
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 0, tactic) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `IsUnit [(Term.proj `g "." `Prod)])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.proj `g "." `Prod)
         ...
         [(Term.fun
           ...
           (Term.basicFun
            ...
            (Term.have
             ...
             []
             («term_<|_»
              (Term.proj (Term.paren "(" (Term.app `hg [`x `hx]) ")") "." `not_unit)
              "<|"
              («term_<|_»
               (Term.proj `isUnit_iff_dvd_one "." (fieldIdx "2"))
               "<|"
               (Term.app
                (Term.proj (Term.paren "(" (Term.app `Multiset.dvd_prod [`hx]) ")") "." `trans)
                [(Term.paren
                  "("
                  (Term.app (Term.proj `isUnit_iff_dvd_one "." (fieldIdx "1")) [`this])
                  ")")]))))))]))))
                    ...
                    Multiset.eq_zero_of_forall_not_mem
                      fun
                        x hx
                          =>
                          have
                            : IsUnit g . Prod := by simpa [ associated_one_iff_isUnit ] using h.symm
                            hg x hx . not_unit
                              <|
                              isUnit_iff_dvd_one . 2
                                <|
                                Multiset.dvd_prod hx . trans isUnit_iff_dvd_one . 1 this
              fun
                p f ih g hf hg hfg
                  =>
                  by
      ...
      (Command.declSig
       [(Term.implicitBinder "{" [`f `g] [":" (Term.app `Multiset [`α])] "}")
        ...
        (Term.explicitBinder
         ...
         []
         ")")]
       (Term.typeSpec ":" (Term.app `Multiset.Rel [`Associated `f `g])))
      (Command.declValSimple
       ":="
       (Term.app
        `prime_factors_unique
        [(Term.fun
          ...
          (Term.basicFun
           ...
           []
           "=>"
           (Term.app (Term.proj `irreducible_iff_prime "." `mp) [(Term.app `hf [`x `hx])])))
         (Term.fun
          "fun"
          (Term.basicFun
           [`x `hx]
           []
           "=>"
           (Term.app (Term.proj `irreducible_iff_prime "." `mp) [(Term.app `hg [`x `hx])])))
         `h])
       [])
      []
      []))
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" (Term.app `hg [`x `hx]) ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      (Term.proj `irreducible_iff_prime "." `mp)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
...
theorem
  ...
  :=
    prime_factors_unique
      fun x hx => irreducible_iff_prime . mp hf x hx
        fun x hx => irreducible_iff_prime . mp hg x hx
        h
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `prime_factors_irreducible [])
      (Command.declSig
       [(Term.instBinder "[" [] (Term.app `CancelCommMonoidWithZero [`α]) "]")
        (Term.implicitBinder "{" [`a] [":" `α] "}")
        (Term.implicitBinder "{" [`f] [":" (Term.app `Multiset [`α])] "}")
        (Term.explicitBinder "(" [`ha] [":" (Term.app `Irreducible [`a])] [] ")")
        (Term.explicitBinder
         "("
         [`pfa]
         [":"
       ...
       (Term.typeSpec
        ...
        («term∃_,_»
         ...
         ","
         («term_∧_»
          (RingTheory.UniqueFactorizationDomain.«term_~ᵤ_» `a " ~ᵤ " `p)
          "∧"
          («term_=_» `f "=" («term{_}» "{" [`p] "}"))))))
      (Command.declValSimple
       ":="
         ...
         (Tactic.tacticSeq1Indented
          [(Std.Tactic.tacticHaveI_
               ...
               (Term.basicFun
                ...
                (Term.proj
                 (Term.app
                  `ha.not_unit
                  [(Term.app
                    (Term.proj `associated_one_iff_isUnit "." (fieldIdx "1"))
                    [(Term.app `Associated.symm [`h])])])
                 "."
                 `elim)))
              (Term.hole "_")
              (Term.proj `pfa "." (fieldIdx "2"))
              (Term.proj `pfa "." (fieldIdx "1"))]))
           []
           (Std.Tactic.rintro
            "rintro"
              ...
              (Std.Tactic.RCases.rcasesPat.tuple
               ...
               [(Std.Tactic.RCases.rcasesPatLo
                ...
                (Std.Tactic.RCases.rcasesPatLo
                 ...
                 [])]
               "⟩"))
             (Std.Tactic.RCases.rintroPat.one (Std.Tactic.RCases.rcasesPat.one `hs))]
            [])
           []
           (Mathlib.Tactic.«tacticUse_,,» "use" [`p])
           []
           (Tactic.tacticHave_
            "have"
            (Term.haveDecl
             (Term.haveIdDecl
              [`hs0 []]
              [(Term.typeSpec ":" («term_=_» `s "=" (num "0")))]
              ":="
              (Term.byTactic
               "by"
               (Tactic.tacticSeq
                (Tactic.tacticSeq1Indented
                 [(Std.Tactic.byContra "by_contra" [(Lean.binderIdent `hs0)])
                  []
                  (Std.Tactic.obtain
                   "obtain"
                   [(Std.Tactic.RCases.rcasesPatMed
                     [(Std.Tactic.RCases.rcasesPat.tuple
                       ...
                       "⟩")])]
                   []
                   [":=" [(Term.app `Multiset.exists_mem_of_ne_zero [`hs0])]])
                  []
                  (Tactic.apply
                   "apply"
                   (Term.proj
                     ...
                     (Term.app
                      ...
                      [(Term.typeAscription
                        ...
                        [(«term_=_»
                          ...
                          («term_*_»
                           («term_*_»
                            («term_*_» `p "*" (coeNotation "↑" `u))
                            "*"
                            (Term.proj (Term.app `s.erase [`q]) "." `Prod))
                           "*"
                           (Term.hole "_")))]
                        ")")])
                     "."
                  ...
                  (tactic__
                   ...
                   [(Tactic.rwSeq
                     ...
                     (Tactic.rwRuleSeq
                      ...
                      [(Tactic.rwRule
                        []
                        (Term.app `mul_right_comm [(Term.hole "_") (Term.hole "_") `q]))
                       ","
                       (Tactic.rwRule [] `mul_assoc)
                       ","
                       (Tactic.rwRule [(patternIgnore (token.«← » "←"))] `Multiset.prod_cons)
                       ","
                       (Tactic.rwRule [] (Term.app `Multiset.cons_erase [`hq]))
                       ","
                       (Tactic.rwRule [(patternIgnore (token.«← » "←"))] `hu)
                       ","
                       (Tactic.rwRule [] `mul_comm)
                       ","
                       (Tactic.rwRule [] (Term.app `mul_comm [`p (Term.hole "_")]))
                       ","
                       (Tactic.rwRule [] `mul_assoc)]
                      "]")
                     [])
                  ...
                  (Tactic.apply
                   ...
                   (Term.app
                    ...
                    [`isUnit_of_mul_isUnit_left
                     (Term.app `mt [`isUnit_of_mul_isUnit_left (Term.hole "_")])]))
                  []
                  (Tactic.apply
                   "apply"
                   (Term.proj
                    (Term.proj
                     (Term.app
                      `hs
                      [`p (Term.app `Multiset.mem_cons_self [(Term.hole "_") (Term.hole "_")])])
                     "."
                     (fieldIdx "2"))
                    "."
                    (fieldIdx "1")))]))))))
           ...
           (Tactic.simp
            ...
            ["["
             [(Tactic.simpLemma [] [] `mul_one)
              ","
              (Tactic.simpLemma [] [] `Multiset.prod_cons)
              ","
              (Tactic.simpLemma [] [] `Multiset.prod_zero)
              ","
              (Tactic.simpLemma [] [] `hs0)]
             "]"]
           ...
           (Tactic.exact
            ...
            (Term.anonymousCtor
             "⟨"
             [(Term.app `Associated.symm [(Term.anonymousCtor "⟨" [`u "," `hu] "⟩")]) "," `rfl]
             "⟩"))])))
       [])
      []
      []))
...
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none,
     [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `Associated.symm [(Term.anonymousCtor "⟨" [`u "," `hu] "⟩")])
            ...
            [(Std.Tactic.byContra "by_contra" [(Lean.binderIdent `hs0)])
             ...
             (tactic__
              ...
              [(Tactic.rwSeq
                ...
                (Tactic.rwRuleSeq
                 "["
                 [(Tactic.rwRule [] (Term.app `mul_right_comm [(Term.hole "_") (Term.hole "_") `q]))
                  ","
                  (Tactic.rwRule [] `mul_assoc)
                  ","
                  (Tactic.rwRule [(patternIgnore (token.«← » "←"))] `Multiset.prod_cons)
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Tactic.apply
       ...
       (Term.proj
        (Term.proj
         (Term.app `hs [`p (Term.app `Multiset.mem_cons_self [(Term.hole "_") (Term.hole "_")])])
         "."
         (fieldIdx "2"))
        "."
        (fieldIdx "1")))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `Multiset.mem_cons_self [(Term.hole "_") (Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.hole "_")
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
     ...
     (Term.app
      `hs
      [`p
       (Term.paren "(" (Term.app `Multiset.mem_cons_self [(Term.hole "_") (Term.hole "_")]) ")")])
     ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none,
     [anonymous]) <=? (none, [anonymous])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Tactic.apply
       ...
       (Term.app
        `mt
        [`isUnit_of_mul_isUnit_left (Term.app `mt [`isUnit_of_mul_isUnit_left (Term.hole "_")])]))
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app
       `mt
       [`isUnit_of_mul_isUnit_left (Term.app `mt [`isUnit_of_mul_isUnit_left (Term.hole "_")])])
...
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none,
     [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `mul_comm [`p (Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.hole "_")
...
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none,
     [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `Multiset.cons_erase [`hq])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `hq
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none,
     [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" (Term.app `s.erase [`q]) ")")
[PrettyPrinter.parenthesize] ...precedences are 71 >? 1024, (none,
     [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 70, term))
      («term_*_» `p "*" (coeNotation "↑" `u))
        ...
        [(«term_=_»
          ...
          («term_*_»
           («term_*_»
            («term_*_» `p "*" (coeNotation "↑" `u))
            "*"
            (Term.proj (Term.paren "(" (Term.app `s.erase [`q]) ")") "." `Prod))
           "*"
           (Term.hole "_")))]
        ")")])
     ")")
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023,
     term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" (Term.app `Associated.symm [`h]) ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      (Term.proj `associated_one_iff_isUnit "." (fieldIdx "1"))
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      `associated_one_iff_isUnit
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
     ...
     (Term.app
      (Term.proj `associated_one_iff_isUnit "." (fieldIdx "1"))
      [(Term.paren "(" (Term.app `Associated.symm [`h]) ")")])
     ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      `ha.not_unit
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none,
      ...
      by
        haveI := Classical.decEq α
          refine'
            Multiset.induction_on
              f
                fun h => ha.not_unit associated_one_iff_isUnit . 1 Associated.symm h . elim
                _
                pfa . 2
                pfa . 1
            ...
            hs0
              ...
              by
                by_contra hs0
                  ...
                  refine'
                    ha.is_unit_or_is_unit ( _ : _ = p * ↑ u * s.erase q . Prod * _ ) . resolve_left
                      _
                  ·
                    rw
                        [
                          mul_right_comm _ _ q
                            ,
                            mul_assoc
                            ,
                            ← Multiset.prod_cons
...
#align
  unique_factorization_monoid.of_exists_prime_factors UniqueFactorizationMonoid.of_exists_prime_factors
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `UniqueFactorizationMonoid.iff_exists_prime_factors [])
      (Command.declSig
       [(Term.instBinder "[" [] (Term.app `CancelCommMonoidWithZero [`α]) "]")]
       (Term.typeSpec
        ":"
        («term_↔_»
         (Term.app `UniqueFactorizationMonoid [`α])
         "↔"
         (Term.forall
          "∀"
          [`a]
       ...
       (Term.anonymousCtor
        ...
        [(Term.fun
          ...
          (Term.basicFun
           ...
           "=>"
           (Term.app
            (Term.explicit "@" `UniqueFactorizationMonoid.exists_prime_factors)
...
theorem
  ...
  :=
    ⟨
      ...
      ⟩
#align
  unique_factorization_monoid.iff_exists_prime_factors UniqueFactorizationMonoid.iff_exists_prime_factors
...
#align mul_equiv.unique_factorization_monoid_iff MulEquiv.unique_factorization_monoid_iff
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `irreducible_iff_prime_of_exists_unique_irreducible_factors [])
      (Command.declSig
       [(Term.instBinder "[" [] (Term.app `CancelCommMonoidWithZero [`α]) "]")
        (Term.explicitBinder
         "("
        ...
        (Term.explicitBinder
         ...
         [":"
          (Term.forall
           "∀"
           [`f `g]
           [(Term.typeSpec ":" (Term.app `Multiset [`α]))]
           ","
           (Term.arrow
            (Std.ExtendedBinder.«term∀__,_»
             "∀"
         ...
         []
         ")")
        (Term.explicitBinder "(" [`p] [":" `α] [] ")")]
       (Term.typeSpec ":" («term_↔_» (Term.app `Irreducible [`p]) "↔" (Term.app `Prime [`p]))))
      (Command.declValSimple
       ":="
       (Term.anonymousCtor
        "⟨"
        [(Std.Tactic.letI
          ...
          (Term.fun
           ...
           (Term.basicFun
            ...
            (Term.anonymousCtor
             "⟨"
             [(Term.proj `hpi "." `NeZero)
              ","
              (Term.proj `hpi "." (fieldIdx "1"))
              ","
              (Term.fun
               "fun"
               (Term.basicFun
                [`a `b (Term.anonymousCtor "⟨" [`x "," `hx] "⟩")]
                []
                "=>"
                (termDepIfThenElse
                 "if"
                 (Lean.binderIdent `hab0)
                 ":"
                 («term_=_» («term_*_» `a "*" `b) "=" (num "0"))
                 "then"
                 (Term.app
                  (Term.proj (Term.app `eq_zero_or_eq_zero_of_mul_eq_zero [`hab0]) "." `elim)
                  [(Term.fun
                    "fun"
                    (Term.basicFun
                     [`ha0]
                     ...
                     (Tactic.tacticHave_
                      ...
                      (Term.haveDecl
                       (Term.haveIdDecl
                        ...
                        ":="
                        (Term.app `left_ne_zero_of_mul [`hab0]))))
                     []
                     (Tactic.tacticHave_
                      "have"
                      (Term.haveDecl
                       (Term.haveIdDecl
                        ...
                        ":="
                        (Term.app `right_ne_zero_of_mul [`hab0]))))
                     []
                     (Tactic.cases'
                      "cases'"
                      [(Tactic.casesTarget [] (Term.app `eif [`x `hx0]))]
                      []
                      ["with" [(Lean.binderIdent `fx) (Lean.binderIdent `hfx)]])
                     []
                     (Tactic.cases'
                      "cases'"
                      [(Tactic.casesTarget [] (Term.app `eif [`a `ha0]))]
                      []
                      ["with" [(Lean.binderIdent `fa) (Lean.binderIdent `hfa)]])
                     []
                     (Tactic.cases'
                      "cases'"
                      [(Tactic.casesTarget [] (Term.app `eif [`b `hb0]))]
                      []
                      ["with" [(Lean.binderIdent `fb) (Lean.binderIdent `hfb)]])
                     []
                     (Tactic.tacticHave_
                      "have"
                      (Term.haveDecl
                       (Term.haveIdDecl
                        ...
                        [(Term.typeSpec
                          ...
                          (Term.app
                           `Multiset.Rel
                           [`Associated
                            (Multiset.Data.Multiset.Basic.«term_::ₘ_» `p " ::ₘ " `fx)
                            («term_+_» `fa "+" `fb)]))]
                        ":="
                        (Term.byTactic
                         "by"
                               ...
                               (Term.fun
                                ...
                                (Term.basicFun
                                 ...
                                 (Term.app
                                  (Term.proj
                                   (Term.app
                                    (Term.proj `Multiset.mem_cons "." (fieldIdx "1"))
                                    [`hi])
                                   "."
                                   `elim)
                                  [(Term.fun
                                    ...
                                    (Term.basicFun
                                     ...
                                     []
                                     "=>"
                                     (Term.subst (Term.proj `hip "." `symm) "▸" [`hpi])))
                                   (Term.app
                                    (Term.proj `hfx "." (fieldIdx "1"))
                                    [(Term.hole "_")])]))))])
                            []
                            (tactic__
                             (cdotTk (patternIgnore (token.«· » "·")))
                             [(Tactic.exact
                               ...
                               (Term.fun
                                ...
                                (Term.basicFun
                                 ...
                                 (Term.app
                                  (Term.proj
                                   (Term.app (Term.proj `Multiset.mem_add "." (fieldIdx "1")) [`hi])
                                   "."
                                   `elim)
                                  [(Term.app (Term.proj `hfa "." (fieldIdx "1")) [(Term.hole "_")])
                                   (Term.app
                                    (Term.proj `hfb "." (fieldIdx "1"))
                                    [(Term.hole "_")])]))))])
                            []
                            (calcTactic
                             "calc"
                                 ...
                                 [(Tactic.«tactic_<;>_»
                                   (Tactic.rwSeq
                                    ...
                                    (Tactic.rwRuleSeq
                                     ...
                                     [(Tactic.rwRule [] `hx)
                                      ","
                                      (Tactic.rwRule [] `Multiset.prod_cons)]
                                     "]")
                                    [])
                                   "<;>"
                                   (Tactic.exact
                                    "exact"
                                    (Term.app
                                     (Term.proj (Term.proj `hfx "." (fieldIdx "2")) "." `mul_left)
                                     [(Term.hole "_")])))]))))
                             [(calcStep
                               (RingTheory.UniqueFactorizationDomain.«term_~ᵤ_»
                                (Term.hole "_")
                                " ~ᵤ "
                                («term_*_» (Term.proj `fa "." `Prod) "*" (Term.proj `fb "." `Prod)))
                               ":="
                               (Term.app
                                (Term.proj
                                 (Term.proj (Term.proj `hfa "." (fieldIdx "2")) "." `symm)
                                 "."
                                 `mul_mul)
                                [(Term.proj (Term.proj `hfb "." (fieldIdx "2")) "." `symm)]))
                              (calcStep
                                ...
                                (Tactic.tacticSeq
                                 (Tactic.tacticSeq1Indented
                                  [(Tactic.rwSeq
                                    ...
                                    (Tactic.rwRuleSeq
                                     "["
                                     [(Tactic.rwRule [] `Multiset.prod_add)]
                                     "]")
                                    [])]))))])]))))))
                     []
                     (Tactic.exact
                      ...
                      (Term.let
                       ...
                       (Term.letDecl
                        (Term.letPatDecl
                         (Term.anonymousCtor "⟨" [`q "," `hqf "," `hq] "⟩")
                         []
                         []
                         ":="
                         (Term.app
                          `Multiset.exists_mem_of_rel_of_mem
                          [`h (Term.app `Multiset.mem_cons_self [`p (Term.hole "_")])])))
                       []
                       (Term.app
                        (Term.proj
                         (Term.app (Term.proj `Multiset.mem_add "." (fieldIdx "1")) [`hqf])
                         "."
                         `elim)
                        [(Term.fun
                          "fun"
                          (Term.basicFun
                           ...
                           («term_<|_»
                            ...
                            "<|"
                            («term_<|_»
                             (Term.proj (Term.proj `hq "." `dvd_iff_dvd_left) "." (fieldIdx "2"))
                             "<|"
                             (Term.app
                              (Term.proj
                               (Term.proj
                               ...
                               "."
                               (fieldIdx "1"))
                              [(Term.app `Multiset.dvd_prod [`hqa])])))))
                         (Term.fun
                          "fun"
                          (Term.basicFun
                           [`hqb]
                           ...
                           («term_<|_»
                            ...
                            («term_<|_»
                             ...
                             (Term.app
                              (Term.proj
                               (Term.proj
                                (Term.proj `hfb "." (fieldIdx "2"))
                                "."
                                `dvd_iff_dvd_right)
                               "."
                               (fieldIdx "1"))
                              [(Term.app `Multiset.dvd_prod [`hqb])])))))])))]))))))]
             "⟩"))))
         ","
         `Prime.irreducible]
        "⟩")
                            ...
                            [(Tactic.exact
                              ...
                              (Term.fun
                               ...
                               (Term.basicFun
                                ...
                                (Term.app
                                 (Term.proj
                                  (Term.app (Term.proj `Multiset.mem_cons "." (fieldIdx "1")) [`hi])
                                  "."
                                  `elim)
                                 [(Term.fun
                                   "fun"
                         ...
                         (Term.basicFun
                          ...
                          («term_<|_»
                           ...
                           («term_<|_»
                            ...
                            (Term.app
                             (Term.proj
                              (Term.proj (Term.proj `hfa "." (fieldIdx "2")) "." `dvd_iff_dvd_right)
                              "."
                              (fieldIdx "1"))
                             [(Term.app `Multiset.dvd_prod [`hqa])])))))
                        (Term.fun
                         ...
                         (Term.basicFun
                          ...
                          («term_<|_»
                           ...
                           («term_<|_»
                            ...
                            (Term.app
                             (Term.proj
                              (Term.proj (Term.proj `hfb "." (fieldIdx "2")) "." `dvd_iff_dvd_right)
                              "."
                              (fieldIdx "1"))
                             [(Term.app `Multiset.dvd_prod [`hqb])])))))])))]))))))]
            "⟩"))))
                             ...
                             (Tactic.tacticSeq
                              (Tactic.tacticSeq1Indented
                               [(Tactic.rwSeq
                                 "rw"
                                 []
                                 (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Multiset.prod_add)] "]")
                                 [])]))))])]))))))
                  []
                  (Tactic.exact
                   "exact"
                    ...
                    (Term.fun
                     ...
                     (Term.basicFun
                      ...
                      (Term.byTactic
                       "by"
                       (Tactic.tacticSeq
                        (Tactic.tacticSeq1Indented [(Tactic.simpAll "simp_all" [] [] [] [])]))))))))
                 []
                 (Tactic.tacticHave_
                  "have"
                  (Term.haveDecl
                            ...
                            (Tactic.tacticSeq1Indented
                             [(Tactic.«tactic_<;>_»
                               (Tactic.rwSeq
                                ...
                                (Tactic.rwRuleSeq
                                 "["
                                 [(Tactic.rwRule [] `hx) "," (Tactic.rwRule [] `Multiset.prod_cons)]
                                 "]")
                                [])
                               "<;>"
                               (Tactic.exact
            ...
            [(Term.fun
              ...
              (Term.basicFun
               ...
               (Term.byTactic
                ...
                (Tactic.tacticSeq
                 (Tactic.tacticSeq1Indented
                  [(Tactic.simp "simp" [] [] [] ["[" [(Tactic.simpLemma [] [] `ha0)] "]"] [])])))))
             (Term.fun
              "fun"
              (Term.basicFun
               [`hb0]
                           ...
                           (Term.app
                            ...
                            [(Term.fun
                              ...
                              (Term.basicFun
                               ...
                               "=>"
                               (Term.subst (Term.proj `hip "." `symm) "▸" [`hpi])))
                             (Term.app (Term.proj `hfx "." (fieldIdx "1")) [(Term.hole "_")])]))))])
                      []
                      (tactic__
                       (cdotTk (patternIgnore (token.«· » "·")))
                       [(Tactic.exact
                          ...
                          (Term.basicFun
                           ...
                           (Term.app
                            (Term.proj
                             ...
                             `elim)
                            [(Term.app (Term.proj `hfa "." (fieldIdx "1")) [(Term.hole "_")])
                             (Term.app (Term.proj `hfb "." (fieldIdx "1")) [(Term.hole "_")])]))))])
                      []
                      (calcTactic
                       "calc"
                       (calcStep
           ...
           (Term.fun
            ...
            (Term.basicFun
             ...
             (Term.byTactic
              ...
              (Tactic.tacticSeq
               (Tactic.tacticSeq1Indented
                [(Tactic.simp "simp" [] [] [] ["[" [(Tactic.simpLemma [] [] `hb0)] "]"] [])])))))])
         "else"
         (Term.byTactic
          "by"
          (Tactic.tacticSeq
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Tactic.exact
       ...
       (Term.let
        ...
        []
        (Term.app
         (Term.proj (Term.app (Term.proj `Multiset.mem_add "." (fieldIdx "1")) [`hqf]) "." `elim)
         [(Term.fun
           "fun"
           (Term.basicFun
            [`hqa]
        ...
        («term_<|_»
         ...
         (Term.app
          (Term.proj
           ...
           "."
           (fieldIdx "1"))
          [(Term.paren "(" (Term.app `Multiset.dvd_prod [`hqa]) ")")])))))
     ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      (Term.proj (Term.app (Term.proj `Multiset.mem_add "." (fieldIdx "1")) [`hqf]) "." `elim)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none,
     [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      (Term.proj `Multiset.mem_add "." (fieldIdx "1"))
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      `Multiset.mem_add
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none,
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `Multiset.mem_cons_self [`p (Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.hole "_")
            ...
            [(Tactic.apply "apply" `uif)
             ...
             (calcTactic
              ...
              [(calcStep
                ...
                ":="
                (Term.app
                 (Term.proj (Term.proj (Term.proj `hfa "." (fieldIdx "2")) "." `symm) "." `mul_mul)
                 [(Term.proj (Term.proj `hfb "." (fieldIdx "2")) "." `symm)]))
               (calcStep
                («term_=_» (Term.hole "_") "=" (Term.hole "_"))
                ":="
        ...
        (Tactic.tacticSeq1Indented
         [(Tactic.apply "apply" `uif)
             ...
             (Term.fun
              ...
              (Term.basicFun
               ...
               (Term.app
                ...
                [(Term.fun
                  "fun"
                  (Term.basicFun [`hip] [] "=>" (Term.subst (Term.proj `hip "." `symm) "▸" [`hpi])))
                 (Term.app (Term.proj `hfx "." (fieldIdx "1")) [(Term.hole "_")])]))))])
          []
          (tactic__
           (cdotTk (patternIgnore (token.«· » "·")))
          ...
          (calcTactic
           ...
           (calcStep
            (RingTheory.UniqueFactorizationDomain.«term_~ᵤ_»
             (Term.app `Multiset.prod [(Multiset.Data.Multiset.Basic.«term_::ₘ_» `p " ::ₘ " `fx)])
             " ~ᵤ "
             («term_*_» `a "*" `b))
            ":="
            (Term.byTactic
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq1Indented', expected 'Lean.Parser.Tactic.tacticSeqBracketed'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Multiset.prod_add)] "]") [])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `Multiset.prod_add
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none,
     [anonymous]) <=? (none, [anonymous])
                    ...
                    a b ⟨ x , hx ⟩
                      ...
                      if
                        ...
                        eq_zero_or_eq_zero_of_mul_eq_zero hab0 . elim
                          fun ha0 => by simp [ ha0 ] fun hb0 => by simp [ hb0 ]
                        else
                        by
                          have hx0 : x ≠ 0 := fun hx0 => by simp_all
                                    ...
                                    ·
                                      exact
                                        fun
                                          i hi
                                            =>
                                            Multiset.mem_cons . 1 hi . elim
                                              fun hip => hip . symm ▸ hpi hfx . 1 _
                                    ·
                                      exact
                                        fun
                                          i hi => Multiset.mem_add . 1 hi . elim hfa . 1 _ hfb . 1 _
                                    calc
                            ...
                            exact
                              let
                                ⟨ q , hqf , hq ⟩
                                  :=
                                  Multiset.exists_mem_of_rel_of_mem h Multiset.mem_cons_self p _
                                Multiset.mem_add . 1 hqf . elim
                                  fun
                                      hqa
                                        ...
                                        Or.inl
                                          <|
                                          hq . dvd_iff_dvd_left . 2
                                            <|
                                            hfa . 2 . dvd_iff_dvd_right . 1 Multiset.dvd_prod hqa
                                    fun
                                      hqb
                                        =>
                                        Or.inr
                                          ...
                                          hq . dvd_iff_dvd_left . 2
                                            <|
                                            hfb . 2 . dvd_iff_dvd_right . 1 Multiset.dvd_prod hqb
                ⟩
        ,
        Prime.irreducible
      ⟩
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `UniqueFactorizationMonoid.of_exists_unique_irreducible_factors [])
      (Command.declSig
       [(Term.instBinder "[" [] (Term.app `CancelCommMonoidWithZero [`α]) "]")
        (Term.explicitBinder
         "("
        ...
        (Term.explicitBinder
         ...
         []
         ")")]
       (Term.typeSpec ":" (Term.app `UniqueFactorizationMonoid [`α])))
      (Command.declValSimple
       ":="
       (Term.app
        `UniqueFactorizationMonoid.of_exists_prime_factors
           ...
           [(convert "convert" [] `eif [])
            ...
            (Mathlib.Tactic.tacticSimp_rw__
             ...
             (Tactic.rwRuleSeq
              ...
              [(Tactic.rwRule
                []
                (Term.app `irreducible_iff_prime_of_exists_unique_irreducible_factors [`eif `uif]))]
              "]")
             [])])))])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.byTactic', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.byTactic', expected 'Lean.Parser.Term.ellipsis'
...
theorem
  ...
  :=
    UniqueFactorizationMonoid.of_exists_prime_factors
      by convert eif simp_rw [ irreducible_iff_prime_of_exists_unique_irreducible_factors eif uif ]
#align
...
#align
  unique_factorization_monoid.ne_zero_of_mem_factors UniqueFactorizationMonoid.ne_zero_of_mem_factors
...
#align
  unique_factorization_monoid.irreducible_of_factor UniqueFactorizationMonoid.irreducible_of_factor
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `exists_mem_factors_of_dvd [])
      (Command.declSig
       [(Term.implicitBinder "{" [`a `p] [":" `α] "}")
        (Term.explicitBinder "(" [`ha0] [":" («term_≠_» `a "≠" (num "0"))] [] ")")
       ...
       (Term.typeSpec
        ...
        (Term.arrow
         ...
         (Std.ExtendedBinder.«term∃__,_»
          "∃"
          (Lean.binderIdent `q)
          («binderTerm∈_» "∈" (Term.app `factors [`a]))
          ","
          (RingTheory.UniqueFactorizationDomain.«term_~ᵤ_» `p " ~ᵤ " `q)))))
      (Command.declValSimple
       ":="
       (Term.fun
        "fun"
            ...
            (Term.haveIdDecl
             ...
             [(Term.typeSpec
               ...
               (Term.app
                `Multiset.Rel
                [`Associated
                 (Multiset.Data.Multiset.Basic.«term_::ₘ_» `p " ::ₘ " (Term.app `factors [`b]))
                 (Term.app `factors [`a])]))]
             ":="
             (Term.app
              `factors_unique
              [(Term.fun
                ...
                (Term.basicFun
                 ...
                 (Term.app
                  (Term.proj
                   (Term.app (Term.proj `Multiset.mem_cons "." (fieldIdx "1")) [`hx])
                   "."
                   `elim)
                  [(Term.fun
                    "fun"
                    (Term.basicFun [`h] [] "=>" (Term.subst (Term.proj `h "." `symm) "▸" [`hp])))
                   (Term.app `irreducible_of_factor [(Term.hole "_")])])))
               ...
               («term_<|_»
                ...
                (calc
                 ...
                 (calcStep
                  (RingTheory.UniqueFactorizationDomain.«term_~ᵤ_»
                   (Term.app `Multiset.prod [(Term.app `factors [`a])])
                   " ~ᵤ "
                   `a)
                  ":="
                  (Term.app `factors_prod [`ha0]))
                 [(calcStep («term_=_» (Term.hole "_") "=" («term_*_» `p "*" `b)) ":=" `hb)
                  (calcStep
                   (RingTheory.UniqueFactorizationDomain.«term_~ᵤ_»
                    (Term.hole "_")
                    " ~ᵤ "
                     ...
                     (Tactic.tacticSeq1Indented
                      [(Tactic.«tactic_<;>_»
                        ...
                        (Tactic.exact
                         ...
                         (Term.app
                          (Term.proj
                           (Term.proj (Term.app `factors_prod [`hb0]) "." `symm)
                           "."
                           `mul_left)
                          [(Term.hole "_")])))]))))]))])))
           []
      ...
      (Term.app
       ...
       [(Term.fun
         ...
         (Term.basicFun
          ...
          "=>"
          (Term.app
           (Term.proj (Term.app (Term.proj `Multiset.mem_cons "." (fieldIdx "1")) [`hx]) "." `elim)
           [(Term.fun
             "fun"
             (Term.basicFun [`h] [] "=>" (Term.subst (Term.proj `h "." `symm) "▸" [`hp])))
            (Term.app `irreducible_of_factor [(Term.hole "_")])])))
              ...
              (Tactic.tacticSeq1Indented
               [(Tactic.«tactic_<;>_»
                 ...
                 (Tactic.exact
                  "exact"
                  (Term.app
                   (Term.proj (Term.proj (Term.app `factors_prod [`hb0]) "." `symm) "." `mul_left)
                   [(Term.hole "_")])))]))))]))])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Tactic.«tactic_<;>_»
       (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Multiset.prod_cons)] "]") [])
       "<;>"
       (Tactic.exact
        "exact"
        (Term.app
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none,
     [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" (Term.app `factors_prod [`hb0]) ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none,
     [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
...
theorem
  ...
  { a p : α } ( ha0 : a ≠ 0 ) ( hp : Irreducible p ) : p ∣ a → ∃ q ∈ factors a , p ~ᵤ q
  :=
    fun
      ⟨ b , hb ⟩
        =>
        have
          hb0 : b ≠ 0 := fun hb0 => by simp_all
          have
            : Multiset.Rel Associated p ::ₘ factors b factors a
              :=
              factors_unique
                fun
                    x hx
                      =>
                      Multiset.mem_cons . 1 hx . elim fun h => h . symm ▸ hp irreducible_of_factor _
                  irreducible_of_factor
                  Associated.symm
                    <|
                    calc
...
#align
  unique_factorization_monoid.exists_mem_factors_of_dvd UniqueFactorizationMonoid.exists_mem_factors_of_dvd
...
#align
  unique_factorization_monoid.factors_eq_normalized_factors UniqueFactorizationMonoid.factors_eq_normalized_factors

theorem normalized_factors_prod {a : α} (ane0 : a ≠ 0) : Associated (normalizedFactors a).Prod a :=
  by
...
#align
  unique_factorization_monoid.normalized_factors_prod UniqueFactorizationMonoid.normalized_factors_prod
...
#align
  unique_factorization_monoid.prime_of_normalized_factor UniqueFactorizationMonoid.prime_of_normalized_factor
...
#align
  unique_factorization_monoid.normalize_normalized_factor UniqueFactorizationMonoid.normalize_normalized_factor

theorem normalized_factors_irreducible {a : α} (ha : Irreducible a) :
...
theorem normalized_factors_eq_of_dvd (a : α) :
  ...
  convert
    ...
    assumption
#align
  unique_factorization_monoid.normalized_factors_eq_of_dvd UniqueFactorizationMonoid.normalized_factors_eq_of_dvd
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `exists_mem_normalized_factors_of_dvd [])
      (Command.declSig
       [(Term.implicitBinder "{" [`a `p] [":" `α] "}")
        (Term.explicitBinder "(" [`ha0] [":" («term_≠_» `a "≠" (num "0"))] [] ")")
        (Term.explicitBinder "(" [`hp] [":" (Term.app `Irreducible [`p])] [] ")")]
       (Term.typeSpec
        ...
        (Term.arrow
         ...
         (Std.ExtendedBinder.«term∃__,_»
          "∃"
          (Lean.binderIdent `q)
          («binderTerm∈_» "∈" (Term.app `normalizedFactors [`a]))
          ","
          (RingTheory.UniqueFactorizationDomain.«term_~ᵤ_» `p " ~ᵤ " `q)))))
      (Command.declValSimple
       ":="
               ...
               (Term.app
                ...
                [`Associated
                 (Multiset.Data.Multiset.Basic.«term_::ₘ_»
                  `p
                  " ::ₘ "
                  (Term.app `normalizedFactors [`b]))
                 (Term.app `normalizedFactors [`a])]))]
             ":="
             (Term.app
              `factors_unique
              [(Term.fun
                ...
                (Term.basicFun
                 ...
                 (Term.app
                  ...
                  [(Term.fun
                    "fun"
                    (Term.basicFun [`h] [] "=>" (Term.subst (Term.proj `h "." `symm) "▸" [`hp])))
                   (Term.app `irreducible_of_normalized_factor [(Term.hole "_")])])))
               ...
               («term_<|_»
                ...
                (calc
                 ...
                 (calcStep
                  (RingTheory.UniqueFactorizationDomain.«term_~ᵤ_»
                   (Term.app `Multiset.prod [(Term.app `normalizedFactors [`a])])
                   " ~ᵤ "
                   `a)
                  ":="
                  (Term.app `normalized_factors_prod [`ha0]))
                 [(calcStep («term_=_» (Term.hole "_") "=" («term_*_» `p "*" `b)) ":=" `hb)
                  (calcStep
                   (RingTheory.UniqueFactorizationDomain.«term_~ᵤ_»
                    (Term.hole "_")
                     ...
                     (Tactic.tacticSeq1Indented
                      [(Tactic.«tactic_<;>_»
                        ...
                        (Tactic.exact
                         ...
                         (Term.app
                          (Term.proj
                           (Term.proj (Term.app `normalized_factors_prod [`hb0]) "." `symm)
                           "."
                           `mul_left)
                          [(Term.hole "_")])))]))))]))])))
           []
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Tactic.«tactic_<;>_»
       ...
       (Tactic.exact
        "exact"
        (Term.app
         (Term.proj (Term.proj (Term.app `normalized_factors_prod [`hb0]) "." `symm) "." `mul_left)
         [(Term.hole "_")])))
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Tactic.exact
       "exact"
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      (Term.proj (Term.app `normalized_factors_prod [`hb0]) "." `symm)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      (Term.app `normalized_factors_prod [`hb0])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `hb0
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (RingTheory.UniqueFactorizationDomain.«term_~ᵤ_»
       ...
       (Term.app
        `Multiset.prod
        [(Multiset.Data.Multiset.Basic.«term_::ₘ_» `p " ::ₘ " (Term.app `normalizedFactors [`b]))]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'RingTheory.UniqueFactorizationDomain.«term_~ᵤ_»', expected 'RingTheory.UniqueFactorizationDomain.term_~ᵤ_._@.RingTheory.UniqueFactorizationDomain._hyg.7'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.haveIdDecl', expected 'Lean.Parser.Term.letPatDecl'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.haveIdDecl', expected 'Lean.Parser.Term.haveEqnsDecl'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.matchAlts'
    ...
    fun
      ⟨ b , hb ⟩
        ...
        have
          hb0 : b ≠ 0 := fun hb0 => by simp_all
          have
            : Multiset.Rel Associated p ::ₘ normalizedFactors b normalizedFactors a
              :=
              factors_unique
                fun
                    x hx
                      =>
                      Multiset.mem_cons . 1 hx . elim
                        fun h => h . symm ▸ hp irreducible_of_normalized_factor _
                  irreducible_of_normalized_factor
                  Associated.symm
                    <|
                    calc
                        ...
                        _ ~ᵤ Multiset.prod p ::ₘ normalizedFactors b
                          ...
                          by
                            rw [ Multiset.prod_cons ]
                              <;>
                              exact normalized_factors_prod hb0 . symm . mul_left _
            Multiset.exists_mem_of_rel_of_mem this by simp
#align
  unique_factorization_monoid.exists_mem_normalized_factors_of_dvd UniqueFactorizationMonoid.exists_mem_normalized_factors_of_dvd

theorem exists_mem_normalized_factors {x : α} (hx : x ≠ 0) (h : ¬IsUnit x) :
  ...
  exact ⟨p, hp⟩
#align
  unique_factorization_monoid.exists_mem_normalized_factors UniqueFactorizationMonoid.exists_mem_normalized_factors

@[simp]
theorem normalized_factors_zero : normalizedFactors (0 : α) = 0 := by
  simp [normalized_factors, factors]
#align
  unique_factorization_monoid.normalized_factors_zero UniqueFactorizationMonoid.normalized_factors_zero

@[simp]
theorem normalized_factors_one : normalizedFactors (1 : α) = 0 :=
  by
  ...
  infer_instance
#align
  unique_factorization_monoid.normalized_factors_one UniqueFactorizationMonoid.normalized_factors_one
...
#align
  unique_factorization_monoid.normalized_factors_mul UniqueFactorizationMonoid.normalized_factors_mul

@[simp]
theorem normalized_factors_pow {x : α} (n : ℕ) :
...
#align
  unique_factorization_monoid.normalized_factors_prod_eq UniqueFactorizationMonoid.normalized_factors_prod_eq
...
#align
  unique_factorization_monoid.dvd_iff_normalized_factors_le_normalized_factors UniqueFactorizationMonoid.dvd_iff_normalized_factors_le_normalized_factors
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `associated_iff_normalized_factors_eq_normalized_factors [])
      (Command.declSig
       ...
       (Term.typeSpec
        ":"
        («term_↔_»
         (RingTheory.UniqueFactorizationDomain.«term_~ᵤ_» `x " ~ᵤ " `y)
         "↔"
         («term_=_» (Term.app `normalizedFactors [`x]) "=" (Term.app `normalizedFactors [`y])))))
      (Command.declValSimple
       ":="
       (Term.byTactic
        "by"
             ...
             [(Term.fun "fun" (Term.basicFun [`h] [] "=>" (Term.hole "_")))
              ...
              (Term.fun
               ...
               (Term.basicFun
                ...
                (Term.app
                 (Term.proj
                  (Term.proj (Term.app `normalized_factors_prod [`hx]) "." `symm)
                  "."
                  `trans)
                 [(Term.app
                   `trans
                     ...
                     (Tactic.tacticSeq
                      (Tactic.tacticSeq1Indented
                       [(Tactic.rwSeq
                         ...
                         [])])))
                    (Term.app `normalized_factors_prod [`hy])])])))]
             "⟩"))
           []
           (Tactic.«tactic_<;>_»
             ...
             (Tactic.tacticSeq1Indented
              [(Tactic.simp
                ...
                ["["
                 [(Tactic.simpStar "*")
                  ","
                  (Tactic.simpLemma [] [] `h.dvd)
                  ","
                  (Tactic.simpLemma [] [] `h.symm.dvd)]
                 "]"]
                [])])))])))
       [])
      []
        ...
        [(Term.fun "fun" (Term.basicFun [`h] [] "=>" (Term.hole "_")))
         ...
         (Term.fun
          ...
          (Term.basicFun
           ...
           "=>"
           (Term.app
            (Term.proj (Term.proj (Term.app `normalized_factors_prod [`hx]) "." `symm) "." `trans)
            [(Term.app
              `trans
              [(Term.byTactic
                "by"
        ...
        (Term.byTactic
         ...
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `h)] "]") [])])))
        ")")
       (Term.paren "(" (Term.app `normalized_factors_prod [`hy]) ")")])
     ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      (Term.proj (Term.proj (Term.app `normalized_factors_prod [`hx]) "." `symm) "." `trans)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      (Term.proj (Term.app `normalized_factors_prod [`hx]) "." `symm)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      (Term.app `normalized_factors_prod [`hx])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `hx
          ...
          ⟨
            fun h => _
              ...
              fun
                h
                  =>
                  normalized_factors_prod hx . symm . trans
                    trans by rw [ h ] normalized_factors_prod hy
            ⟩
...
theorem dvd_of_mem_normalized_factors {a p : α} (H : p ∈ normalizedFactors a) : p ∣ a :=
  by
  by_cases hcases : a = 0
  · rw [hcases]
    exact dvd_zero p
...
#align
  unique_factorization_monoid.dvd_of_mem_normalized_factors UniqueFactorizationMonoid.dvd_of_mem_normalized_factors
...
theorem normalized_factors_prod_of_prime [Nontrivial α] [Unique αˣ] {m : Multiset α}
...
#align
  unique_factorization_monoid.normalized_factors_prod_of_prime UniqueFactorizationMonoid.normalized_factors_prod_of_prime
...
#align
  unique_factorization_monoid.mem_normalized_factors_eq_of_associated UniqueFactorizationMonoid.mem_normalized_factors_eq_of_associated

@[simp]
theorem normalized_factors_pos (x : α) (hx : x ≠ 0) : 0 < normalizedFactors x ↔ ¬IsUnit x :=
  by
  constructor
  · intro h hx
    obtain ⟨p, hp⟩ := Multiset.exists_mem_of_ne_zero h.ne'
  ...
  · intro h
    ...
    exact
      bot_lt_iff_ne_bot.mpr
        (mt multiset.eq_zero_iff_forall_not_mem.mp (not_forall.mpr ⟨p, not_not.mpr hp⟩))
#align
  unique_factorization_monoid.normalized_factors_pos UniqueFactorizationMonoid.normalized_factors_pos

theorem dvd_not_unit_iff_normalized_factors_lt_normalized_factors {x y : α} (hx : x ≠ 0)
    (hy : y ≠ 0) : DvdNotUnit x y ↔ normalizedFactors x < normalizedFactors y :=
  by
  constructor
  · rintro ⟨_, c, hc, rfl⟩
...
#align
  unique_factorization_monoid.dvd_not_unit_iff_normalized_factors_lt_normalized_factors UniqueFactorizationMonoid.dvd_not_unit_iff_normalized_factors_lt_normalized_factors
...
#align
  unique_factorization_monoid.normalization_monoid UniqueFactorizationMonoid.normalizationMonoid
...
#align
  unique_factorization_monoid.no_factors_of_no_prime_factors UniqueFactorizationMonoid.no_factors_of_no_prime_factors
...
#align
  unique_factorization_monoid.dvd_of_dvd_mul_left_of_no_prime_factors UniqueFactorizationMonoid.dvd_of_dvd_mul_left_of_no_prime_factors
...
#align
  unique_factorization_monoid.exists_reduced_factors UniqueFactorizationMonoid.exists_reduced_factors
...
-/
theorem count_normalized_factors_eq {p x : R} (hp : Irreducible p) (hnorm : normalize p = p) {n : ℕ}
...
#align
  unique_factorization_monoid.count_normalized_factors_eq UniqueFactorizationMonoid.count_normalized_factors_eq
...
See also `multiplicity_eq_count_normalized_factors` if `n` is given by `multiplicity p x`.
-/
theorem count_normalized_factors_eq' {p x : R} (hp : p = 0 ∨ Irreducible p)
...
#align
  unique_factorization_monoid.induction_on_prime_power UniqueFactorizationMonoid.induction_on_prime_power
...
#align
  unique_factorization_monoid.multiplicative_prime_power UniqueFactorizationMonoid.multiplicative_prime_power
      ...
      exact
        normalize_eq_normalize hdvd
          ((prime_of_normalized_factor _ hp).Irreducible.dvd_symm
            (prime_of_normalized_factor _ hq).Irreducible hdvd)
#align
  unique_factorization_monoid.multiplicative_of_coprime UniqueFactorizationMonoid.multiplicative_of_coprime
...
theorem factor_set_mem_eq_mem (p : Associates α) (s : FactorSet α) : FactorSetMem p s = (p ∈ s) :=
  rfl
#align associates.factor_set_mem_eq_mem Associates.factor_set_mem_eq_mem
...
#align associates.mem_factor_set_top Associates.mem_factor_set_top
...
#align associates.mem_factor_set_some Associates.mem_factor_set_some

theorem reducible_not_mem_factor_set {p : Associates α} (hp : ¬Irreducible p) (s : FactorSet α) :
    ¬p ∈ s := fun h : if hp : Irreducible p then BfactorSetMem ⟨p, hp⟩ s else False => by
  rwa [dif_neg hp] at h
#align associates.reducible_not_mem_factor_set Associates.reducible_not_mem_factor_set
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `factors'_cong [])
      (Command.declSig
       [(Term.implicitBinder "{" [`a `b] [":" `α] "}")
        (Term.explicitBinder
         "("
         [`h]
         [":" (RingTheory.UniqueFactorizationDomain.«term_~ᵤ_» `a " ~ᵤ " `b)]
         []
         ")")]
       (Term.typeSpec ":" («term_=_» (Term.app `factors' [`a]) "=" (Term.app `factors' [`b]))))
      (Command.declValSimple
       ":="
       (Term.byTactic
        "by"
          ...
          [(Std.Tactic.obtain
           ...
           (tactic__
            ...
            [(Tactic.rwSeq
              "rw"
              []
              (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `associated_zero_iff_eq_zero)] "]")
            ...
            (Term.haveDecl
             (Term.haveIdDecl
              ...
              (Term.byTactic
               ...
               (Tactic.tacticSeq
                (Tactic.tacticSeq1Indented
                 [(Mathlib.Tactic.Contrapose.contrapose! "contrapose!" [`hb ["with" `ha]])
                  []
                  (Tactic.rwSeq
                   "rw"
                   []
                   (Tactic.rwRuleSeq
                    "["
                    [(Tactic.rwRule [(patternIgnore (token.«← » "←"))] `associated_zero_iff_eq_zero)
                     ","
                     (Tactic.rwRule [(patternIgnore (token.«← » "←"))] `ha)]
                    "]")
                   [])
                  []
           ...
           (Tactic.rwSeq
            ...
            (Tactic.rwRuleSeq
             ...
             [(Tactic.rwRule
               [(patternIgnore (token.«← » "←"))]
               (Term.app `Multiset.map_eq_map [`Subtype.coe_injective]))
              ","
              (Tactic.rwRule [] `map_subtype_coe_factors')
              ","
              (Tactic.rwRule [] `map_subtype_coe_factors')
              ","
              (Tactic.rwRule [(patternIgnore (token.«← » "←"))] `rel_associated_iff_map_eq_map)]
             "]")
            [])
           []
           (Tactic.exact
            ...
            (Term.app
             ...
             [`irreducible_of_factor
              `irreducible_of_factor
              («term_<|_»
               (Term.proj (Term.app `factors_prod [`ha]) "." `trans)
               "<|"
               («term_<|_»
                `h.trans
                "<|"
                (Term.proj (Term.app `factors_prod [`hb]) "." `symm)))]))])))
       [])
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.abbrev'
       ...
       (Term.app
        ...
        [`irreducible_of_factor
         ...
         («term_<|_»
          (Term.proj (Term.app `factors_prod [`ha]) "." `trans)
          "<|"
          («term_<|_» `h.trans "<|" (Term.proj (Term.app `factors_prod [`hb]) "." `symm)))]))
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app
       `factors_unique
       [`irreducible_of_factor
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none,
     [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" (Term.app `factors_prod [`hb]) ")")
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none,
     [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" (Term.app `factors_prod [`ha]) ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (some 10, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 10, (some 10, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
     "("
     («term_<|_»
      (Term.proj (Term.paren "(" (Term.app `factors_prod [`ha]) ")") "." `trans)
      "<|"
      («term_<|_»
       `h.trans
       "<|"
       (Term.proj (Term.paren "(" (Term.app `factors_prod [`hb]) ")") "." `symm)))
     ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
...
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 0, tactic) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, [anonymous]))
      («term_=_» (Term.app `factors' [`a]) "=" (Term.app `factors' [`b]))
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `factors' [`b])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
...
theorem
  factors'_cong
  { a b : α } ( h : a ~ᵤ b ) : factors' a = factors' b
  :=
    by
      obtain rfl | hb := eq_or_ne b 0
        ...
        have
          ha
            : a ≠ 0
            :=
            by contrapose! hb with ha rw [ ← associated_zero_iff_eq_zero , ← ha ] exact h.symm
        rw
          [
            ← Multiset.map_eq_map Subtype.coe_injective
              ,
              map_subtype_coe_factors'
              ,
              map_subtype_coe_factors'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.def
      "def"
      (Command.declId `factors [])
      (Command.optDeclSig
       [(Term.explicitBinder "(" [`a] [":" (Term.app `Associates [`α])] [] ")")]
       [(Term.typeSpec ":" (Term.app `FactorSet [`α]))])
      (Command.declValSimple
       ":="
       (Term.byTactic
        "by"
            ...
            (termDepIfThenElse
             ...
             (Term.app
              ...
              [`a
               (Term.fun
                "fun"
                (Term.basicFun [`x `h] [] "=>" («term_<|_» `some "<|" (Term.app `factors' [`x]))))
               (Term.hole "_")
               `h])))
           []
           (Tactic.intro "intro" [`a `b `hab])
           []
           (Tactic.apply "apply" `Function.hfunext)
           []
           (tactic__
            (cdotTk (patternIgnore (token.«· » "·")))
            [(Tactic.tacticHave_
              ...
              (Term.haveDecl
               (Term.haveIdDecl
                ...
                [(Term.typeSpec
                  ":"
                  («term_↔_»
                   (RingTheory.UniqueFactorizationDomain.«term_~ᵤ_» `a " ~ᵤ " (num "0"))
                   "↔"
                   (RingTheory.UniqueFactorizationDomain.«term_~ᵤ_» `b " ~ᵤ " (num "0"))))]
                ":="
                (Term.app
                 `Iff.intro
                 [(Term.fun "fun" (Term.basicFun [`ha0] [] "=>" (Term.app `hab.symm.trans [`ha0])))
                  (Term.fun "fun" (Term.basicFun [`hb0] [] "=>" (Term.app `hab.trans [`hb0])))]))))
             []
             (Tactic.simp
              "simp"
              []
              []
              ["only"]
              ["[" [(Tactic.simpLemma [] [] `associated_zero_iff_eq_zero)] "]"]
             ...
             (Tactic.simp
              ...
              ["only"]
              ["["
               [(Tactic.simpLemma [] [] `quotient_mk_eq_mk)
                ","
                (Tactic.simpLemma [] [] `this)
                ","
                (Tactic.simpLemma [] [] `mk_eq_zero)]
               "]"]
              [])])
           []
           (Tactic.exact
            ...
            (Term.fun
             ...
             (Term.basicFun
              ...
              («term_<|_»
               ...
               "<|"
               («term_<|_»
                (Term.app `congr_arg [`some])
                "<|"
                (Term.app `factors'_cong [`hab]))))))])))
       [])
      []
      []
      []))
       ...
       (Term.fun
        ...
        (Term.basicFun
         ...
         («term_<|_»
          `heq_of_eq
          "<|"
          («term_<|_» (Term.app `congr_arg [`some]) "<|" (Term.app `factors'_cong [`hab]))))))
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.fun
       "fun"
       (Term.basicFun
        ...
        refine' if h : a = 0 then ⊤ else Quotient.hrecOn a fun x h => some <| factors' x _ h
          ...
          ·
            have
                : a ~ᵤ 0 ↔ b ~ᵤ 0
                  :=
                  Iff.intro fun ha0 => hab.symm.trans ha0 fun hb0 => hab.trans hb0
