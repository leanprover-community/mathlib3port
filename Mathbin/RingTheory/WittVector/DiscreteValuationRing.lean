...
-- ./././Mathport/Syntax/Translate/Basic.lean:648:40: in linear_combination #[[expr «expr * »(«expr- »(H_coeff), H)], ["with"], { normalize := ff }]: ./././Mathport/Syntax/Translate/Basic.lean:319:22: unsupported: too many args
