...
-- ./././Mathport/Syntax/Translate/Tactic/Builtin.lean:63:38: in linear_combination #[[expr «expr * »(«expr- »(H_coeff), H)], ["with"], { normalize := ff[bool.ff] }]: ./././Mathport/Syntax/Translate/Basic.lean:350:22: unsupported: too many args
