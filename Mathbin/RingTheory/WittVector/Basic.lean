...
private theorem ghost_fun_zero : ghost_fun (0 : 𝕎 R) = 0 := by
  ghost_fun_tac 0, «expr![ , ]» "././Mathport/Syntax/Translate/Basic.lean:681:61: unsupported notation `«expr![ , ]»"

-- ././Mathport/Syntax/Translate/Basic.lean:680:4: warning: unsupported notation `«expr![ , ]»
-- ././Mathport/Syntax/Translate/Basic.lean:681:61: unsupported notation `«expr![ , ]»
private theorem ghost_fun_one : ghost_fun (1 : 𝕎 R) = 1 := by
  ghost_fun_tac 1, «expr![ , ]» "././Mathport/Syntax/Translate/Basic.lean:681:61: unsupported notation `«expr![ , ]»"
...
private theorem ghost_fun_neg : ghost_fun (-x) = -ghost_fun x := by
  ghost_fun_tac -X 0, «expr![ , ]» "././Mathport/Syntax/Translate/Basic.lean:681:61: unsupported notation `«expr![ , ]»"
