...
#align ideal.prime_compl_le_non_zero_divisors Ideal.prime_compl_le_non_zero_divisors
...
#align is_localization.at_prime.local_ring IsLocalization.AtPrime.local_ring
...
#align localization.at_prime.local_ring Localization.AtPrime.local_ring
...
-/
instance is_domain_of_local_at_prime {P : Ideal A} (hp : P.IsPrime) :
    IsDomain (Localization.AtPrime P) :=
  is_domain_localization P.prime_compl_le_non_zero_divisors
#align is_localization.is_domain_of_local_at_prime IsLocalization.is_domain_of_local_at_prime
...
theorem to_map_mem_maximal_iff (x : R) (h : LocalRing S := local_ring S I) :
  ...
  not_iff_not.mp <| by
    simpa only [LocalRing.mem_maximal_ideal, mem_nonunits_iff, not_not] using
...
#align is_localization.at_prime.is_unit_mk'_iff IsLocalization.AtPrime.is_unit_mk'_iff
...
#align localization.at_prime.comap_maximal_ideal Localization.AtPrime.comap_maximal_ideal
...
theorem local_ring_hom_to_map (J : Ideal P) [hJ : J.IsPrime] (f : R →+* P) (hIJ : I = J.comap f)
    (x : R) : localRingHom I J f hIJ (algebraMap _ _ x) = algebraMap _ _ (f x) :=
  map_eq _ _
#align localization.local_ring_hom_to_map Localization.local_ring_hom_to_map

theorem local_ring_hom_mk' (J : Ideal P) [hJ : J.IsPrime] (f : R →+* P) (hIJ : I = J.comap f)
    (x : R) (y : I.primeCompl) :
  ...
  map_mk' _ _ _
#align localization.local_ring_hom_mk' Localization.local_ring_hom_mk'
...
#align localization.is_local_ring_hom_local_ring_hom Localization.is_local_ring_hom_local_ring_hom
...
theorem local_ring_hom_unique (J : Ideal P) [hJ : J.IsPrime] (f : R →+* P) (hIJ : I = J.comap f)
  ...
  map_unique _ _ hj
#align localization.local_ring_hom_unique Localization.local_ring_hom_unique

@[simp]
theorem local_ring_hom_id :
    localRingHom I I (RingHom.id R) (Ideal.comap_id I).symm = RingHom.id _ :=
  local_ring_hom_unique _ _ _ _ fun x => rfl
#align localization.local_ring_hom_id Localization.local_ring_hom_id

@[simp]
theorem local_ring_hom_comp {S : Type _} [CommSemiring S] (J : Ideal S) [hJ : J.IsPrime]
    (K : Ideal P) [hK : K.IsPrime] (f : R →+* S) (hIJ : I = J.comap f) (g : S →+* P)
    (hJK : J = K.comap g) :
...
#align localization.local_ring_hom_comp Localization.local_ring_hom_comp
