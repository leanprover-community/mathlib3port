...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `norm_eq_zero_iff_of_basis [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `IsDomain [`S]) "]")
    (Term.explicitBinder "(" [`b] [":" (Term.app `Basis [`ι `R `S])] [] ")")
    (Term.implicitBinder "{" [`x] [":" `S] "}")]
   (Term.typeSpec
    ":"
    («term_↔_» («term_=_» (Term.app `Algebra.norm [`R `x]) "=" (numLit "0")) "↔" («term_=_» `x "=" (numLit "0")))))
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.tacticHave_
         "have"
         (Term.haveDecl
          (Term.haveIdDecl [`hι []] [(Term.typeSpec ":" (Term.app `Nonempty [`ι]))] ":=" `b.index_nonempty)))
        [])
       (group
       ...
       (group
        (Tactic.rwSeq
         "rw"
         []
         (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] (Term.app `Algebra.norm_eq_matrix_det [`b]))] "]")
         [])
        [])
          ...
          (Tactic.tacticSeq1Indented
           [(group
             (Tactic.rwSeq
              "rw"
              []
              (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `Matrix.exists_mul_vec_eq_zero_iff)] "]")
              [])
             [])
            (group
             (Tactic.rintro
              ...
              [(Tactic.rintroPat.one
                (Tactic.rcasesPat.tuple
                 ...
                 [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `v)]) [])
                  ","
                  (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `v_ne)]) [])
                  ","
            ...
            (group
             (Tactic.rwSeq
              ...
              (Tactic.rwRuleSeq
               "["
               [(Tactic.rwRule ["←"] (Term.app `b.equiv_fun.apply_symm_apply [`v]))
                ","
                (Tactic.rwRule [] `b.equiv_fun_symm_apply)
                ","
                (Tactic.rwRule [] `b.equiv_fun_apply)
                ","
                (Tactic.rwRule [] `Algebra.left_mul_matrix_mul_vec_repr)]
               "]")
               ...
               [(Term.show
                 ...
                 («term_≠_»
                  (Algebra.BigOperators.Basic.«term∑_,_»
                   ...
                   ", "
                   (Algebra.Group.Defs.«term_•_» (Term.app `v [`i]) " • " (Term.app `b [`i])))
                  "≠"
                  (numLit "0"))
               ...
               (Tactic.tacticSeq1Indented
                [(group
                  (Tactic.simpa
                   ...
                   ["only"]
                   ["["
                    [(Tactic.simpLemma [] [] `LinearEquiv.map_zero) "," (Tactic.simpLemma [] [] `Pi.zero_apply)]
                    "]"]
                   []
                   ["using" (Term.app `congr_funₓ [`hv `i])])
                  [])])))
             [])
            (group
             (Tactic.«tactic·._»
              ...
              (Tactic.tacticSeq
               (Tactic.tacticSeq1Indented
                [(group (Tactic.contrapose! "contrapose!" [`v_ne ["with" `sum_eq]]) [])
                 (group (Tactic.apply "apply" `b.equiv_fun.symm.injective) [])
                 (group
                  (Tactic.rwSeq
                   "rw"
                   []
                   (Tactic.rwRuleSeq
                    ...
                    [(Tactic.rwRule [] `b.equiv_fun_symm_apply)
                     ","
                     (Tactic.rwRule [] `sum_eq)
                     ","
                     (Tactic.rwRule [] `LinearEquiv.map_zero)]
                    "]")
                   [])
                  [])])))
             [])])))
           ...
           [(group (Tactic.rintro "rintro" [(Tactic.rintroPat.one (Tactic.rcasesPat.one `rfl))] []) [])
            (group
             (Tactic.rwSeq
              ...
              (Tactic.rwRuleSeq
               "["
               [(Tactic.rwRule [] `AlgHom.map_zero) "," (Tactic.rwRule [] (Term.app `Matrix.det_zero [`hι]))]
               "]")
              [])
             [])])))
        [])])))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.«tactic·._»
   ...
   (Tactic.tacticSeq
    (Tactic.tacticSeq1Indented
     [(group
       (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `Matrix.exists_mul_vec_eq_zero_iff)] "]") [])
       [])
      (group
       (Tactic.rintro
        "rintro"
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.apply "apply" `b.equiv_fun.symm.injective)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.apply', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `b.equiv_fun.symm.injective
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.contrapose! "contrapose!" [`v_ne ["with" `sum_eq]])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app
   (Term.proj
    (Term.app
     `mul_eq_zero.mp
     [(«term_$__» `b.ext_elem "$" (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`i] [])] "=>" (Term.hole "_"))))])
    "."
    `resolve_right)
   [(Term.show
     "show"
      ...
      have hι : Nonempty ι := b.index_nonempty
        ...
        ·
          rw [ ← Matrix.exists_mul_vec_eq_zero_iff ]
            ...
            rw
              [
                ← b.equiv_fun.apply_symm_apply v
                  ,
                  b.equiv_fun_symm_apply
                  ,
                  b.equiv_fun_apply
        ...
        · rintro rfl rw [ AlgHom.map_zero , Matrix.det_zero hι ]
...
theorem norm_eq_norm_adjoin [FiniteDimensional K L] [IsSeparable K L] (x : L) :
    norm K x =
      (norm K
          (adjoin_simple.gen K
            x)^finrank
          («expr ⟮ , ⟯» K "././Mathport/Syntax/Translate/Basic.lean:681:61: unsupported notation `«expr ⟮ , ⟯»") L) :=
  by
  let this' :=
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `prod_embeddings_eq_finrank_pow [])
  (Command.declSig
   ...
   (Term.typeSpec
    ...
    («term_=_»
     ...
     (Cardinal.SetTheory.Cofinality.«term_^_»
      (Term.app
       (Term.proj (Term.app (Term.explicit "@" `Finset.univ) [(Term.app `PowerBasis.AlgHom.fintype [`pb])]) "." `Prod)
       [(Term.fun
         "fun"
         (Term.basicFun
        ...
        (Tactic.rwSeq
         ...
         (Tactic.rwRuleSeq
          ...
          [(Tactic.rwRule
           ...
           ","
           (Tactic.rwRule [] `Finset.prod_sigma)
           ","
           (Tactic.rwRule ["←"] `Finset.prod_pow)]
          "]")
         [])
        [])
       (group
           ...
           [(group
            ...
            (group
             (Tactic.simp
              ...
              []
              ["only"]
              ["[" [(Tactic.simpLemma [] [] `Finset.prod_const) "," (Tactic.simpLemma [] [] `Finset.card_univ)] "]"]
              [])
             [])
 ...
 [(Term.app
   (Term.proj
    (Term.paren
     ...
     [(Term.app
       (Term.explicit "@" `Finset.univ)
       [(Term.paren "(" [(Term.app `PowerBasis.AlgHom.fintype [`pb]) []] ")")])
      []]
     ")")
    "."
    `Prod)
...
theorem
  ...
  [ IsAlgClosed E ] [ IsSeparable K F ] [ FiniteDimensional K F ] ( pb : PowerBasis K L )
    :
  ...
  :=
    by
      have : FiniteDimensional L F := FiniteDimensional.right K L F
        ...
        rw
          [
            Fintype.prod_equiv algHomEquivSigma fun σ : F →ₐ[ K ] E => _ fun σ => σ . 1 pb.gen
              ,
              ← Finset.univ_sigma_univ
              ,
              Finset.prod_sigma
   ...
   (Tactic.tacticSeq
    (Tactic.tacticSeq1Indented
     [(group
       (Tactic.exact
        "exact"
        (Term.proj (Term.app `prod_embeddings_eq_finrank_pow [`L `E (Term.app `adjoin.power_basis [`hx])]) "." `symm))
       [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.«tactic·._»', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq', expected 'Lean.Parser.Tactic.tacticSeq.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq1Indented', expected 'Lean.Parser.Tactic.tacticSeqBracketed.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `prod_embeddings_eq_finrank_pow [`L `E (Term.paren "(" [(Term.app `adjoin.power_basis [`hx]) []] ")")]) []]
 ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022
