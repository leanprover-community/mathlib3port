...
#align polynomial.op_ring_equiv_op_C Polynomial.op_ring_equiv_op_C
...
#align polynomial.op_ring_equiv_symm_monomial Polynomial.op_ring_equiv_symm_monomial

@[simp]
theorem op_ring_equiv_symm_C (a : Rᵐᵒᵖ) : (opRingEquiv R).symm (c a) = op (c (unop a)) :=
  op_ring_equiv_symm_monomial 0 a
#align polynomial.op_ring_equiv_symm_C Polynomial.op_ring_equiv_symm_C

@[simp]
theorem op_ring_equiv_symm_X : (opRingEquiv R).symm (x : Rᵐᵒᵖ[X]) = op x :=
  op_ring_equiv_symm_monomial 1 1
#align polynomial.op_ring_equiv_symm_X Polynomial.op_ring_equiv_symm_X
