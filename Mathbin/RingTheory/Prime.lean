     ...
     [":"
      (Term.forall
       ...
       (Mathlib.ExtendedBinder.«term∀___,_»
        ...
        («binderTerm∈_» "∈" `s)
        ","
        (Term.forall "∀" [] "," (Term.app `Prime [(Term.app `p [`i])]))))]
     []
     ")")
    (Term.explicitBinder
     "("
   ...
   (Term.typeSpec
    ...
    («term∃_,_»
     ...
     (Lean.explicitBinders
      [(Lean.bracketedExplicitBinders "(" [(Lean.binderIdent `t) (Lean.binderIdent `u)] ":" (Term.app `Finset [`α]) ")")
       (Lean.bracketedExplicitBinders "(" [(Lean.binderIdent `b) (Lean.binderIdent `c)] ":" `R ")")])
     ","
     («term_∧_»
      («term_=_» (Init.Core.«term_∪_» `t " ∪ " `u) "=" `s)
      "∧"
      («term_∧_»
       (Term.app `Disjoint [`t `u])
       "∧"
       («term_∧_»
        («term_=_» `a "=" (Finset.Data.Finset.Fold.«term_*_» `b "*" `c))
        "∧"
        («term_∧_»
         («term_=_»
          `x
          ...
          (Tactic.tacticSeq1Indented
           [(group
             (Tactic.rwSeq
              ...
              (Tactic.rwRuleSeq
               "["
               [(Tactic.rwRule [] (Term.app `prod_insert [`his])) "," (Tactic.rwRule ["←"] `mul_assocₓ)]
               "]")
            ...
            (group
             (Tactic.tacticHave_
              ...
              (Term.haveDecl
               (Term.haveIdDecl
                [`hpi []]
                [(Term.typeSpec ":" (Term.app `Prime [(Term.app `p [`i])]))]
                ":="
                (Term.byTactic
                 "by"
                 (Tactic.tacticSeq
                  (Tactic.tacticSeq1Indented
                   [(group
                     (Tactic.exact
                      "exact"
                      (Term.app `hp [`i (Term.app `mem_insert_self [(Term.hole "_") (Term.hole "_")])]))
                     [])]))))))
             [])
            (group
             (Tactic.rcases
                ...
                (Term.app
                 ...
                 [(Term.fun
                   ...
                   (Term.basicFun
                    ...
                    "=>"
                    (Term.app `hp [`i (Term.app `mem_insert_of_mem [`hi])])))
                  `hx]))]
              ["with"
               (Tactic.rcasesPat.tuple
                ...
                [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `t)]) [])
                 ...
                 ","
                 (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `htus)]) [])
                 ","
                ...
                "⟩")])
             [])
            (group (Tactic.have'' "have" [`hit []] [(Term.typeSpec ":" (Init.Core.«term_∉_» `i " ∉ " `t))]) [])
            (group
             (Tactic.exact
              "exact"
              (Term.fun
               "fun"
               (Term.basicFun
                [(Term.simpleBinder [`hit] [])]
                "=>"
                (Term.app `his [(Term.subst `htus "▸" [(Term.app `mem_union_left [(Term.hole "_") `hit])])]))))
             [])
            (group (Tactic.have'' "have" [`hiu []] [(Term.typeSpec ":" (Init.Core.«term_∉_» `i " ∉ " `u))]) [])
            (group
             (Tactic.exact
              "exact"
              (Term.fun
               "fun"
               (Term.basicFun
                [(Term.simpleBinder [`hiu] [])]
                "=>"
                (Term.app `his [(Term.subst `htus "▸" [(Term.app `mem_union_right [(Term.hole "_") `hiu])])]))))
             [])
            (group
             (Tactic.obtain
              "obtain"
              ...
              [":"
               («term_∨_»
                (Init.Core.«term_∣_» (Term.app `p [`i]) " ∣ " `b)
                "∨"
                (Init.Core.«term_∣_» (Term.app `p [`i]) " ∣ " `c))]
              [])
             [])
            (group
             (Tactic.exact
                    ...
                    (Tactic.tacticSeq1Indented
                     [(group
                       (Tactic.rwSeq
                        "rw"
                        []
                        (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `hbc) "," (Tactic.rwRule [] `mul_commₓ)] "]")
                        [])
                       [])])))]
                 "⟩")]))
             [])
                  ...
                  (Tactic.rwSeq
                   ...
                   (Tactic.rwRuleSeq
                    ...
                    [(Tactic.rwRule [] `mul_assocₓ)
                     ","
                     (Tactic.rwRule [] (Term.app `mul_commₓ [`a]))
                     ","
                     (Tactic.rwRule [] (Term.app `mul_right_inj' [`hpi.ne_zero]))]
                    "]")
                   [(Tactic.location "at" (Tactic.locationHyp [`hbc] []))])
                  [])
                 (group
                  (Tactic.exact
                   "exact"
                       ...
                       (Tactic.tacticSeq1Indented
                        [(group
                          (Tactic.rwSeq
                           "rw"
                           []
                           (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `insert_union) "," (Tactic.rwRule [] `htus)] "]")
                           [])
                          [])])))
                     ","
                     (Term.app
                      (Term.proj `disjoint_insert_left "." (fieldIdx "2"))
                      [(Term.anonymousCtor "⟨" [`hiu "," `htu] "⟩")])
                     ","
                     (Term.byTactic
                      "by"
                      (Tactic.tacticSeq
                       (Tactic.tacticSeq1Indented
                        [(group
                          (Tactic.simp
                           ...
                           []
                           ["["
                            [(Tactic.simpLemma [] [] `hbc)
                             ","
                             (Tactic.simpLemma [] [] (Term.app `prod_insert [`hit]))
                             ","
                ...
                [(group
                  (Tactic.rwSeq
                   ...
                   (Tactic.rwRuleSeq
                    ...
                    [(Tactic.rwRule ["←"] `mul_assocₓ)
                     ","
                     (Tactic.rwRule [] (Term.app `mul_right_commₓ [`b]))
                     ","
                     (Tactic.rwRule [] (Term.app `mul_left_inj' [`hpi.ne_zero]))]
                    "]")
                   [(Tactic.location "at" (Tactic.locationHyp [`hbc] []))])
                  [])
                 (group
                       ...
                       (Tactic.tacticSeq1Indented
                        [(group
                          (Tactic.rwSeq
                           "rw"
                           []
                           (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `union_insert) "," (Tactic.rwRule [] `htus)] "]")
                           [])
                          [])])))
                     ","
                     (Term.app
                      (Term.proj `disjoint_insert_right "." (fieldIdx "2"))
                      [(Term.anonymousCtor "⟨" [`hit "," `htu] "⟩")])
                     ","
                     (Term.byTactic
                      "by"
                      (Tactic.tacticSeq
                        ...
                        [(group
                          (Tactic.simp
                           ...
                           ["["
                            [(Tactic.simpLemma [] ["←"] `hbc)
                             ","
                             (Tactic.simpLemma [] [] (Term.app `prod_insert [`hiu]))
                             ","
                             (Tactic.simpLemma [] [] `mul_assocₓ)
                             ","
                             (Tactic.simpLemma [] [] `mul_commₓ)
         ...
         (Term.haveIdDecl
          ...
          (Term.byTactic
           ...
           (Tactic.tacticSeq
            (Tactic.tacticSeq1Indented
             [(group
               (Tactic.exact "exact" (Term.app `hp [`i (Term.app `mem_insert_self [(Term.hole "_") (Term.hole "_")])]))
               [])]))))))
       [])
      (group
       (Tactic.rcases
      ...
      (Tactic.tacticSeq
       (Tactic.tacticSeq1Indented
        [(group
          ...
          [])])))
     ","
     (Term.app (Term.proj `disjoint_insert_right "." (fieldIdx "2")) [(Term.anonymousCtor "⟨" [`hit "," `htu] "⟩")])
     ","
     (Term.byTactic
      "by"
      (Tactic.tacticSeq
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `union_insert) "," (Tactic.rwRule [] `htus)] "]") [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `mul_left_inj' [`hpi.ne_zero])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
           ...
           (Tactic.tacticSeq
            (Tactic.tacticSeq1Indented
             [(group
               ...
               [])])))
          ","
          (Term.app (Term.proj `disjoint_insert_left "." (fieldIdx "2")) [(Term.anonymousCtor "⟨" [`hiu "," `htu] "⟩")])
          ","
          (Term.byTactic
           "by"
           (Tactic.tacticSeq
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `insert_union) "," (Tactic.rwRule [] `htus)] "]") [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `htus
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `mul_right_inj' [`hpi.ne_zero])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `hbc) "," (Tactic.rwRule [] `mul_commₓ)] "]") [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `mul_commₓ
   ...
   [(Tactic.rcasesPatMed
     [(Tactic.rcasesPat.tuple
      ...
      (Tactic.rcasesPat.tuple
       ...
       "⟩")])]
   [":"
    («term_∨_» (Init.Core.«term_∣_» (Term.app `p [`i]) " ∣ " `b) "∨" (Init.Core.«term_∣_» (Term.app `p [`i]) " ∣ " `c))]
   [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.have'' "have" [`hiu []] [(Term.typeSpec ":" (Init.Core.«term_∉_» `i " ∉ " `u))])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.subst', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.subst `htus "▸" [(Term.app `mem_union_left [(Term.hole "_") `hit])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.subst', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `mem_union_left [(Term.hole "_") `hit])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.have'' "have" [`hit []] [(Term.typeSpec ":" (Init.Core.«term_∉_» `i " ∉ " `t))])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.have''', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'optional.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  ...
  (Tactic.rcases
   ...
   [(Tactic.casesTarget
     ...
     (Term.app
      ...
      [(Term.fun
        "fun"
        (Term.basicFun [(Term.simpleBinder [`i `hi] [])] "=>" (Term.app `hp [`i (Term.app `mem_insert_of_mem [`hi])])))
       `hx]))]
   ["with"
    (Tactic.rcasesPat.tuple
     "⟨"
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `mem_insert_of_mem [`hi]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(Term.fun
   ...
   (Term.basicFun
    [(Term.simpleBinder [`i `hi] [])]
    "=>"
    (Term.app `hp [`i (Term.paren "(" [(Term.app `mem_insert_of_mem [`hi]) []] ")")])))
  []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `ih
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq
   "rw"
   []
   (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] (Term.app `prod_insert [`his])) "," (Tactic.rwRule ["←"] `mul_assocₓ)] "]")
   [(Tactic.location "at" (Tactic.locationHyp [`hx] []))])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.location', expected 'optional.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.locationHyp', expected 'Lean.Parser.Tactic.locationWildcard'
        ...
        induction' s using Finset.induction with i s his ih generalizing x y a
          ...
          ·
            rw [ prod_insert his , ← mul_assocₓ ] at hx
              have hpi : Prime p i := by exact hp i mem_insert_self _ _
              ...
              exact hpi.dvd_or_dvd ⟨ a , by rw [ ← hbc , mul_commₓ ] ⟩
              ·
                  ...
                  exact
                    ⟨
                      insert i t
                        ...
                        c
                        ,
                        by rw [ insert_union , htus ]
                        ,
                        disjoint_insert_left . 2 ⟨ hiu , htu ⟩
                        ,
                        by simp [ hbc , prod_insert hit , mul_assocₓ , mul_commₓ , mul_left_commₓ ]
                      ⟩
              ·
                  ...
                  exact
                    ⟨
                      t
                        ...
                        d
                        ,
                        by rw [ union_insert , htus ]
                        ,
                        disjoint_insert_right . 2 ⟨ hit , htu ⟩
                        ,
                        by simp [ ← hbc , prod_insert hiu , mul_assocₓ , mul_commₓ , mul_left_commₓ ]
                      ⟩
