...
/- ./././Mathport/Syntax/Translate/Basic.lean:572:2: warning: expanding binder collection (I «expr ≠ » «expr⊥»()) -/
                     ...
                     (Tactic.rwRuleSeq
                      ...
                      [(Tactic.rwRule
                        ...
                        (Term.app
                         ...
                         [(Term.paren
                           "("
                           [(Order.BoundedOrder.«term⊥» "⊥") [(Term.typeAscription ":" (Term.app `Ideal [`R]))]]
                           ")")
                          `bot_ne_top]))]
                      "]")
                     [])
                 ...
                 (Tactic.refine'
                  ...
                  (Term.fun
                   ...
                   (Term.basicFun
                    ...
                    "=>"
                    (Term.app
                     (Term.app `Quotient.induction_on' [`w])
           ...
           («tactic___;_»
            ...
            [(group
              (Std.Tactic.rintro
               ...
               [])
              [])
             (group (Tactic.induction "induction" [`x] ["using" `Quotient.induction_on'] [] []) [])
                  ...
                  (Tactic.tacticSeq
                   (Tactic.tacticSeq1Indented
                    [(Tactic.refine' "refine'" (Term.app `sup_le [`le_sup_left (Term.hole "_")]))
                     ...
                     []
                     (Tactic.induction "induction" [`c] ["using" `Quotient.induction_on'] [] [])
                     []
                     (Tactic.rwSeq
                      "rw"
                      []
      ...
      have ne_bot := Ring.ne_bot_of_is_maximal_of_not_is_field maximal_ideal.is_maximal R h
        ...
        ·
          rintro ⟨ x , hx ⟩
            ...
            ·
              refine' fun w => Quotient.induction_on' w fun y => _
                obtain ⟨ y , hy ⟩ := y
