...
/-- A valuation is coerced to the underlying function `R → Γ₀`. -/
  instance : CoeFun ( Valuation R Γ₀ ) fun _ => R → Γ₀ where coe v := v.to_monoid_with_zero_hom.to_fun
     ...
     [":"
      (Term.forall
       ...
       (Mathlib.ExtendedBinder.«term∀___,_»
        ...
        («binderTerm∈_» "∈" `s)
        ","
        (Term.forall "∀" [] "," («term_≤_» (Term.app `v [(Term.app `f [`i])]) "≤" `g))))]
     []
     ")")]
   (Term.typeSpec
    ":"
      ...
      [(group
          ...
          [`s
           (Term.fun
            ...
            (Term.basicFun
             ...
             "=>"
             (Term.app `trans_rel_right [(«term_≤_» (Term.cdot "·") "≤" (Term.cdot "·")) `v.map_zero `zero_le'])))
           (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`a `s `has `ih `hf] [])] "=>" (Term.hole "_")))
           `hf]))
        [])
       (group
        (Tactic.rwSeq
       ...
       (group
        (Tactic.exact
         ...
         (Term.app
          `v.map_add_le
          [(Term.proj `hf "." (fieldIdx "1")) (Term.app `ih [(Term.proj `hf "." (fieldIdx "2"))])]))
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact
   "exact"
   (Term.app `v.map_add_le [(Term.proj `hf "." (fieldIdx "1")) (Term.app `ih [(Term.proj `hf "." (fieldIdx "2"))])]))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `ih [(Term.proj `hf "." (fieldIdx "2"))])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(Term.fun
   ...
   (Term.basicFun
    ...
    (Term.app
     `trans_rel_right
     [(Term.paren "(" [(«term_≤_» (Term.cdot "·") "≤" (Term.cdot "·")) []] ")") `v.map_zero `zero_le'])))
  []]
 ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
...
theorem
  map_sum_le
  { ι : Type _ } { s : Finset ι } { f : ι → R } { g : Γ₀ } ( hf : ∀ , ∀ i ∈ s , ∀ , v f i ≤ g ) : v ∑ i in s , f i ≤ g
  :=
    by
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `map_sum_lt [])
  (Command.declSig
   [(Term.implicitBinder "{" [`ι] [":" (Term.type "Type" [(Level.hole "_")])] "}")
    (Term.implicitBinder "{" [`s] [":" (Term.app `Finset [`ι])] "}")
    (Term.implicitBinder "{" [`f] [":" (Term.arrow `ι "→" `R)] "}")
    (Term.implicitBinder "{" [`g] [":" `Γ₀] "}")
    (Term.explicitBinder "(" [`hg] [":" («term_≠_» `g "≠" (numLit "0"))] [] ")")
    (Term.explicitBinder
     "("
     [`hf]
     [":"
           ...
           (Term.fun
            ...
            (Term.basicFun
             ...
             (Term.app
              ...
              [(«term_<_» (Term.cdot "·") "<" (Term.cdot "·"))
               `v.map_zero
               (Term.app (Term.proj `zero_lt_iff "." (fieldIdx "2")) [`hg])])))
           (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`a `s `has `ih `hf] [])] "=>" (Term.hole "_")))
           `hf]))
        [])
       (group
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact
   "exact"
   (Term.app `v.map_add_lt [(Term.proj `hf "." (fieldIdx "1")) (Term.app `ih [(Term.proj `hf "." (fieldIdx "2"))])]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `v.map_add_lt [(Term.proj `hf "." (fieldIdx "1")) (Term.app `ih [(Term.proj `hf "." (fieldIdx "2"))])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
   ...
   (Term.basicFun
    ...
    (Term.app
     ...
     [(Term.paren "(" [(«term_<_» (Term.cdot "·") "<" (Term.cdot "·")) []] ")")
      `v.map_zero
      (Term.paren "(" [(Term.app (Term.proj `zero_lt_iff "." (fieldIdx "2")) [`hg]) []] ")")])))
  []]
 ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
...
theorem
  map_sum_lt
  { ι : Type _ } { s : Finset ι } { f : ι → R } { g : Γ₀ } ( hg : g ≠ 0 ) ( hf : ∀ , ∀ i ∈ s , ∀ , v f i < g )
    : v ∑ i in s , f i < g
  :=
    by
      refine'
  ...
  (Command.declSig
   ...
   (Term.typeSpec
    ...
    («term_<_»
     ...
     "<"
     `g)))
  (Command.declValSimple ":=" (Term.app `v.map_sum_lt [(Term.app `ne_of_gtₓ [`hg]) `hf]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `v.map_sum_lt [(Term.app `ne_of_gtₓ [`hg]) `hf])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `ne_of_gtₓ [`hg]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `v.map_sum_lt
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
theorem
  map_sum_lt'
  { ι : Type _ } { s : Finset ι } { f : ι → R } { g : Γ₀ } ( hg : 0 < g ) ( hf : ∀ , ∀ i ∈ s , ∀ , v f i < g )
    : v ∑ i in s , f i < g
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " The subgroup of elements whose valuation is less than a certain unit.-/")]
  []
  []
  []
  []
 ...
 (Command.def
  "def"
  (Command.declId `lt_add_subgroup [])
  (Command.optDeclSig
   [(Term.explicitBinder "(" [`v] [":" (Term.app `Valuation [`R `Γ₀])] [] ")")
    (Term.explicitBinder "(" [`γ] [":" (Term.app `Units [`Γ₀])] [] ")")]
   [(Term.typeSpec ":" (Term.app `AddSubgroup [`R]))])
  (Command.declValSimple
   ":="
   (Term.structInst
    "{"
    ...
    [(group
      (Term.structInstField
       ...
       ":="
       (Set.«term{_|_}» "{" `x "|" («term_<_» (Term.app `v [`x]) "<" `γ) "}"))
      [","])
     (group
      (Term.structInstField
       ...
       (Term.byTactic
        ...
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(group
            (Tactic.tacticHave_ "have" (Term.haveDecl (Term.haveIdDecl [`h []] [] ":=" (Term.app `Units.ne_zero [`γ]))))
            [])
     ...
     (group
      (Term.structInstField
       ...
       (Term.fun
        "fun"
        (Term.basicFun
         [(Term.simpleBinder [`x `y `x_in `y_in] [])]
         "=>"
         (Term.app `lt_of_le_of_ltₓ [(Term.app `v.map_add [`x `y]) (Term.app `max_ltₓ [`x_in `y_in])]))))
      [","])
     (group
      (Term.structInstField
          ...
          (Tactic.tacticSeq
           (Tactic.tacticSeq1Indented
            [(group
              (tacticRwa__
               "rwa"
               (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Set.mem_set_of_eq) "," (Tactic.rwRule [] `map_neg)] "]")
               [])
              [])]))))))
      [])]
    (Term.optEllipsis [])
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `max_ltₓ [`x_in `y_in]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `v.map_add [`x `y]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `lt_of_le_of_ltₓ
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " The support of a valuation `v : R → Γ₀` is the ideal of `R` where `v` vanishes. -/")]
  []
  []
  []
  []
   ...
   (Term.structInst
    ...
    [(group
      (Term.structInstField
       (Term.structInstLVal `Carrier [])
       ":="
       (Set.«term{_|_}» "{" `x "|" («term_=_» (Term.app `v [`x]) "=" (numLit "0")) "}"))
      [","])
     (group (Term.structInstField (Term.structInstLVal `zero_mem' []) ":=" (Term.app `map_zero [`v])) [","])
     (group
      (Term.structInstField
       (Term.structInstLVal `add_mem' [])
       ":="
       (Term.fun
        ...
        (Term.basicFun
         ...
         "=>"
         («term_$__»
          (Term.proj `le_zero_iff "." `mp)
          "$"
          (calc
           "calc"
           [(calcStep
             («term_≤_»
              (Term.app `v [(Init.Logic.«term_+_» `x "+" `y)])
              "≤"
              (Term.app `max [(Term.app `v [`x]) (Term.app `v [`y])]))
             ":="
             (Term.app `v.map_add [`x `y]))
            (calcStep
             ...
             (Term.app
              `max_leₓ
              [(Term.app (Term.proj `le_zero_iff "." `mpr) [`hx])
               (Term.app (Term.proj `le_zero_iff "." `mpr) [`hy])]))])))))
      [","])
     (group
      (Term.structInstField
       ...
       (Term.fun
        "fun"
        (Term.basicFun
         [(Term.simpleBinder [`c `x `hx] [])]
         "=>"
         (calc
          "calc"
          [(calcStep
            («term_=_»
             (Term.app `v [(Finset.Data.Finset.Fold.«term_*_» `c "*" `x)])
             "="
             (Finset.Data.Finset.Fold.«term_*_» (Term.app `v [`c]) "*" (Term.app `v [`x])))
            ":="
            (Term.app `map_mul [`v `c `x]))
           (calcStep
            («term_=_» (Term.hole "_") "=" (Finset.Data.Finset.Fold.«term_*_» (Term.app `v [`c]) "*" (numLit "0")))
            ":="
            (Term.app `congr_argₓ [(Term.hole "_") `hx]))
           (calcStep («term_=_» (Term.hole "_") "=" (numLit "0")) ":=" (Term.app `mul_zero [(Term.hole "_")]))]))))
      [])]
    (Term.optEllipsis [])
    []
    "}")
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_=_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Finset.Data.Finset.Fold.«term_*_» (Term.app `v [`c]) "*" (numLit "0"))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Finset.Data.Finset.Fold.«term_*_» `c "*" `x)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Finset.Data.Finset.Fold.«term_*_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `x
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Finset.Data.Finset.Fold.«term_*_» `c "*" `x) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `v
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
     ...
     (calc
      ...
      [(calcStep
       ...
       (calcStep
        ...
        (Term.app
         `max_leₓ
         [(Term.app (Term.proj `le_zero_iff "." `mpr) [`hx]) (Term.app (Term.proj `le_zero_iff "." `mpr) [`hy])]))]))))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.fun.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.basicFun.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app (Term.proj `le_zero_iff "." `mpr) [`hy]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app (Term.proj `le_zero_iff "." `mpr) [`hx]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `max_leₓ
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `v [`y]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
-- failed to format: format: uncaught backtrack exception
/-- A valuation is coerced to the underlying function `R → Γ₀`. -/
  instance : CoeFun ( AddValuation R Γ₀ ) fun _ => R → Γ₀ where coe v := v.to_monoid_with_zero_hom.to_fun
     ...
     [":"
      (Term.forall
       ...
       (Mathlib.ExtendedBinder.«term∀___,_»
        ...
        («binderTerm∈_» "∈" `s)
        ","
        (Term.forall "∀" [] "," («term_≤_» `g "≤" (Term.app `v [(Term.app `f [`i])])))))]
     []
     ")")]
   (Term.typeSpec
    ":"
    («term_≤_»
     ...
     (Term.app
      ...
      [(Algebra.BigOperators.Basic.«term∑_in_,_»
        ...
        ", "
        (Term.app `f [`i]))]))))
  (Command.declValSimple ":=" (Term.app `v.map_sum_le [`hf]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
theorem
  map_le_sum
  { ι : Type _ } { s : Finset ι } { f : ι → R } { g : Γ₀ } ( hf : ∀ , ∀ i ∈ s , ∀ , g ≤ v f i ) : g ≤ v ∑ i in s , f i
  := v.map_sum_le hf
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `map_lt_sum [])
  (Command.declSig
   [(Term.implicitBinder "{" [`ι] [":" (Term.type "Type" [(Level.hole "_")])] "}")
    (Term.implicitBinder "{" [`s] [":" (Term.app `Finset [`ι])] "}")
    (Term.implicitBinder "{" [`f] [":" (Term.arrow `ι "→" `R)] "}")
    (Term.implicitBinder "{" [`g] [":" `Γ₀] "}")
    (Term.explicitBinder "(" [`hg] [":" («term_≠_» `g "≠" (Order.BoundedOrder.«term⊤» "⊤"))] [] ")")
    (Term.explicitBinder
     "("
     [`hf]
     [":"
    ...
    («term_<_»
     ...
     (Term.app
      ...
      [(Algebra.BigOperators.Basic.«term∑_in_,_»
        ...
        ", "
        (Term.app `f [`i]))]))))
  (Command.declValSimple ":=" (Term.app `v.map_sum_lt [`hg `hf]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
theorem
  map_lt_sum
  { ι : Type _ } { s : Finset ι } { f : ι → R } { g : Γ₀ } ( hg : g ≠ ⊤ ) ( hf : ∀ , ∀ i ∈ s , ∀ , g < v f i )
    : g < v ∑ i in s , f i
  := v.map_sum_lt hg hf
