...
but is expected to have type
  forall {α : Sort.{u_1}} {p : α -> Sort.{u_2}} [inst._@.Mathlib.Logic.Basic._hyg.8575 : forall (x : α), Subsingleton.{u_2} (p x)] {q : forall (x : α), (p x) -> Prop} {b : Prop}, (ExistsUnique.{u_1} α (fun (x : α) => ExistsUnique.{u_2} (p x) (fun (h : p x) => q x h))) -> (forall (x : α) (h : p x), (q x h) -> (forall (y : α) (hy : p y), (q y hy) -> (Eq.{u_1} α y x)) -> b) -> b
...
but is expected to have type
  forall {α : Sort.{u_2}} {β : Sort.{u_3}} {γ : Sort.{u_1}} (f : α -> β -> γ) (P : Prop) [inst._@.Mathlib.Logic.Basic._hyg.13318 : Decidable P] (a : P -> α) (b : (Not P) -> α) (c : P -> β) (d : (Not P) -> β), Eq.{u_1} γ (f (dite.{u_2} α P inst._@.Mathlib.Logic.Basic._hyg.13318 a b) (dite.{u_3} β P inst._@.Mathlib.Logic.Basic._hyg.13318 c d)) (dite.{u_1} γ P inst._@.Mathlib.Logic.Basic._hyg.13318 (fun (h : P) => f (a h) (c h)) (fun (h : Not P) => f (b h) (d h)))
...
but is expected to have type
  forall {α : Sort.{u_2}} {β : Sort.{u_3}} {γ : Sort.{u_1}} (f : α -> β -> γ) (P : Prop) [inst._@.Mathlib.Logic.Basic._hyg.13470 : Decidable P] (a : α) (b : α) (c : β) (d : β), Eq.{u_1} γ (f (ite.{u_2} α P inst._@.Mathlib.Logic.Basic._hyg.13470 a b) (ite.{u_3} β P inst._@.Mathlib.Logic.Basic._hyg.13470 c d)) (ite.{u_1} γ P inst._@.Mathlib.Logic.Basic._hyg.13470 (f a c) (f b d))
