...
#align_import logic.equiv.nat from "leanprover-community/mathlib"@"c3291da49cfa65f0d43b094750541c0731edc932"
...
@[simp]
theorem natSumNatEquivNat_apply : ⇑natSumNatEquivNat = Sum.elim bit0 bit1 := by ext (x | x) <;> rfl
