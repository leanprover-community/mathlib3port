...
but is expected to have type
  forall (f : Type.{u} -> Type.{v}) [inst._@.Mathlib.Data.Equiv.Functor._hyg.76 : Functor.{u, v} f] [inst._@.Mathlib.Data.Equiv.Functor._hyg.79 : LawfulFunctor.{u, v} f inst._@.Mathlib.Data.Equiv.Functor._hyg.76] {α : Type.{u}} {β : Type.{u}} (h : Equiv.{succ u, succ u} α β) (x : f α), Eq.{succ v} ((fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.21 : f α) => f β) x) (FunLike.coe.{succ v, succ v, succ v} (Equiv.{succ v, succ v} (f α) (f β)) (f α) (fun (a : f α) => (fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.21 : f α) => f β) a) (EmbeddingLike.toFunLike.{succ v, succ v, succ v} (Equiv.{succ v, succ v} (f α) (f β)) (f α) (f β) (EquivLike.toEmbeddingLike.{succ v, succ v, succ v} (Equiv.{succ v, succ v} (f α) (f β)) (f α) (f β) (Equiv.instEquivLikeEquiv.{succ v, succ v} (f α) (f β)))) (Functor.map_equiv.{u, v} f inst._@.Mathlib.Data.Equiv.Functor._hyg.76 inst._@.Mathlib.Data.Equiv.Functor._hyg.79 α β h) x) (Functor.map.{u, v} f inst._@.Mathlib.Data.Equiv.Functor._hyg.76 α β (FunLike.coe.{succ u, succ u, succ u} (Equiv.{succ u, succ u} α β) α (fun (a : α) => (fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.21 : α) => β) a) (EmbeddingLike.toFunLike.{succ u, succ u, succ u} (Equiv.{succ u, succ u} α β) α β (EquivLike.toEmbeddingLike.{succ u, succ u, succ u} (Equiv.{succ u, succ u} α β) α β (Equiv.instEquivLikeEquiv.{succ u, succ u} α β))) h) x)
...
but is expected to have type
  forall (f : Type.{u} -> Type.{v}) [inst._@.Mathlib.Data.Equiv.Functor._hyg.125 : Functor.{u, v} f] [inst._@.Mathlib.Data.Equiv.Functor._hyg.128 : LawfulFunctor.{u, v} f inst._@.Mathlib.Data.Equiv.Functor._hyg.125] {α : Type.{u}} {β : Type.{u}} (h : Equiv.{succ u, succ u} α β) (y : f β), Eq.{succ v} ((fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.21 : f β) => f α) y) (FunLike.coe.{succ v, succ v, succ v} (Equiv.{succ v, succ v} (f β) (f α)) (f β) (fun (a : f β) => (fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.21 : f β) => f α) a) (EmbeddingLike.toFunLike.{succ v, succ v, succ v} (Equiv.{succ v, succ v} (f β) (f α)) (f β) (f α) (EquivLike.toEmbeddingLike.{succ v, succ v, succ v} (Equiv.{succ v, succ v} (f β) (f α)) (f β) (f α) (Equiv.instEquivLikeEquiv.{succ v, succ v} (f β) (f α)))) (Equiv.symm.{succ v, succ v} (f α) (f β) (Functor.map_equiv.{u, v} f inst._@.Mathlib.Data.Equiv.Functor._hyg.125 inst._@.Mathlib.Data.Equiv.Functor._hyg.128 α β h)) y) (Functor.map.{u, v} f inst._@.Mathlib.Data.Equiv.Functor._hyg.125 β α (FunLike.coe.{succ u, succ u, succ u} (Equiv.{succ u, succ u} β α) β (fun (a : β) => (fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.21 : β) => α) a) (EmbeddingLike.toFunLike.{succ u, succ u, succ u} (Equiv.{succ u, succ u} β α) β α (EquivLike.toEmbeddingLike.{succ u, succ u, succ u} (Equiv.{succ u, succ u} β α) β α (Equiv.instEquivLikeEquiv.{succ u, succ u} β α))) (Equiv.symm.{succ u, succ u} α β h)) y)
