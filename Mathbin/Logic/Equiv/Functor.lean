...
but is expected to have type
  forall (α : Type.{u1} -> Type.{u2}) [β : Functor.{u1, u2} α] [f : LawfulFunctor.{u1, u2} α β] {_inst_1 : Type.{u1}} {_inst_2 : Type.{u1}} (h : Equiv.{succ u1, succ u1} _inst_1 _inst_2) (x : α _inst_1), Eq.{succ u2} ((fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.19 : α _inst_1) => α _inst_2) x) (FunLike.coe.{succ u2, succ u2, succ u2} (Equiv.{succ u2, succ u2} (α _inst_1) (α _inst_2)) (α _inst_1) (fun (_x : α _inst_1) => (fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.19 : α _inst_1) => α _inst_2) _x) (EmbeddingLike.toFunLike.{succ u2, succ u2, succ u2} (Equiv.{succ u2, succ u2} (α _inst_1) (α _inst_2)) (α _inst_1) (α _inst_2) (EquivLike.toEmbeddingLike.{succ u2, succ u2, succ u2} (Equiv.{succ u2, succ u2} (α _inst_1) (α _inst_2)) (α _inst_1) (α _inst_2) (Equiv.instEquivLikeEquiv.{succ u2, succ u2} (α _inst_1) (α _inst_2)))) (Functor.map_equiv.{u1, u2} α β f _inst_1 _inst_2 h) x) (Functor.map.{u1, u2} α β _inst_1 _inst_2 (FunLike.coe.{succ u1, succ u1, succ u1} (Equiv.{succ u1, succ u1} _inst_1 _inst_2) _inst_1 (fun (_x : _inst_1) => (fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.19 : _inst_1) => _inst_2) _x) (EmbeddingLike.toFunLike.{succ u1, succ u1, succ u1} (Equiv.{succ u1, succ u1} _inst_1 _inst_2) _inst_1 _inst_2 (EquivLike.toEmbeddingLike.{succ u1, succ u1, succ u1} (Equiv.{succ u1, succ u1} _inst_1 _inst_2) _inst_1 _inst_2 (Equiv.instEquivLikeEquiv.{succ u1, succ u1} _inst_1 _inst_2))) h) x)
...
but is expected to have type
  forall (α : Type.{u1} -> Type.{u2}) [β : Functor.{u1, u2} α] [f : LawfulFunctor.{u1, u2} α β] {_inst_1 : Type.{u1}} {_inst_2 : Type.{u1}} (h : Equiv.{succ u1, succ u1} _inst_1 _inst_2) (y : α _inst_2), Eq.{succ u2} ((fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.19 : α _inst_2) => α _inst_1) y) (FunLike.coe.{succ u2, succ u2, succ u2} (Equiv.{succ u2, succ u2} (α _inst_2) (α _inst_1)) (α _inst_2) (fun (_x : α _inst_2) => (fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.19 : α _inst_2) => α _inst_1) _x) (EmbeddingLike.toFunLike.{succ u2, succ u2, succ u2} (Equiv.{succ u2, succ u2} (α _inst_2) (α _inst_1)) (α _inst_2) (α _inst_1) (EquivLike.toEmbeddingLike.{succ u2, succ u2, succ u2} (Equiv.{succ u2, succ u2} (α _inst_2) (α _inst_1)) (α _inst_2) (α _inst_1) (Equiv.instEquivLikeEquiv.{succ u2, succ u2} (α _inst_2) (α _inst_1)))) (Equiv.symm.{succ u2, succ u2} (α _inst_1) (α _inst_2) (Functor.map_equiv.{u1, u2} α β f _inst_1 _inst_2 h)) y) (Functor.map.{u1, u2} α β _inst_2 _inst_1 (FunLike.coe.{succ u1, succ u1, succ u1} (Equiv.{succ u1, succ u1} _inst_2 _inst_1) _inst_2 (fun (_x : _inst_2) => (fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.19 : _inst_2) => _inst_1) _x) (EmbeddingLike.toFunLike.{succ u1, succ u1, succ u1} (Equiv.{succ u1, succ u1} _inst_2 _inst_1) _inst_2 _inst_1 (EquivLike.toEmbeddingLike.{succ u1, succ u1, succ u1} (Equiv.{succ u1, succ u1} _inst_2 _inst_1) _inst_2 _inst_1 (Equiv.instEquivLikeEquiv.{succ u1, succ u1} _inst_2 _inst_1))) (Equiv.symm.{succ u1, succ u1} _inst_1 _inst_2 h)) y)
