...
but is expected to have type
  forall (f : Type.{u} -> Type.{v}) [inst._@.Mathlib.Data.Equiv.Functor._hyg.140 : Functor.{u v} f] [inst._@.Mathlib.Data.Equiv.Functor._hyg.143 : LawfulFunctor.{u v} f inst._@.Mathlib.Data.Equiv.Functor._hyg.140] {α : Type.{u}} {β : Type.{u}} (h : Equiv.{succ u succ u} α β) (x : f α), Eq.{succ v} (f β) (Equiv.toFun.{succ v succ v} (f α) (f β) (Functor.map_equiv.{u v} f inst._@.Mathlib.Data.Equiv.Functor._hyg.140 inst._@.Mathlib.Data.Equiv.Functor._hyg.143 α β h) x) (Functor.map.{u v} f inst._@.Mathlib.Data.Equiv.Functor._hyg.140 α β (Equiv.toFun.{succ u succ u} α β h) x)
...
but is expected to have type
  forall (f : Type.{u} -> Type.{v}) [inst._@.Mathlib.Data.Equiv.Functor._hyg.189 : Functor.{u v} f] [inst._@.Mathlib.Data.Equiv.Functor._hyg.192 : LawfulFunctor.{u v} f inst._@.Mathlib.Data.Equiv.Functor._hyg.189] {α : Type.{u}} {β : Type.{u}} (h : Equiv.{succ u succ u} α β) (y : f β), Eq.{succ v} (f α) (Equiv.toFun.{succ v succ v} (f β) (f α) (Equiv.symm.{succ v succ v} (f α) (f β) (Functor.map_equiv.{u v} f inst._@.Mathlib.Data.Equiv.Functor._hyg.189 inst._@.Mathlib.Data.Equiv.Functor._hyg.192 α β h)) y) (Functor.map.{u v} f inst._@.Mathlib.Data.Equiv.Functor._hyg.189 β α (Equiv.toFun.{succ u succ u} β α (Equiv.symm.{succ u succ u} α β h)) y)
