...
theorem
  ...
  [ FiniteDimensional F E ]
      ...
      (
        ...
        :
          minpoly F α . Splits
            algebraMap F F ⟮ "././Mathport/Syntax/Translate/Basic.lean:813:11: unsupported (impossible)" ⟯
        )
    :
      Fintype.card
  ...
  :=
    by
      let
        ...
        exact
          Fintype.card_congr
            algEquivEquivAlgHom F F ⟮ "././Mathport/Syntax/Translate/Basic.lean:813:11: unsupported (impossible)" ⟯
  ...
  :=
    by
      cases' Field.exists_primitive_element F E with α hα
        let
          iso
            : F ⟮ "././Mathport/Syntax/Translate/Basic.lean:813:11: unsupported (impossible)" ⟯ ≃ₐ[ F ] E
            :=
            {
              toFun := fun e => e . val ,
        ...
        replace
          ...
          :
            Polynomial.Splits
              algebraMap F F ⟮ "././Mathport/Syntax/Translate/Basic.lean:813:11: unsupported (impossible)" ⟯ minpoly F α
        ·
          have
              p
                :
    ...
    :
      Fintype.card
        ...
        Fintype.card K →ₐ[ F ] E
          *
          finrank K K ⟮ "././Mathport/Syntax/Translate/Basic.lean:813:11: unsupported (impossible)" ⟯
  :=
    by
      have
