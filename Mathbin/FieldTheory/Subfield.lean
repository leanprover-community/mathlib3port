...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " Product of elements of a subfield indexed by a `finset` is in the subfield. -/")]
  []
  []
  []
  []
 ...
 (Command.theorem
  ...
  (Command.declSig
   [(Term.implicitBinder "{" [`ι] [":" (Term.type "Type" [(Level.hole "_")])] "}")
    ...
    (Term.implicitBinder "{" [`f] [":" (Term.arrow `ι "→" `K)] "}")
    (Term.explicitBinder
     "("
     [`h]
     [":"
...
/-- Product of elements of a subfield indexed by a `finset` is in the subfield. -/
  theorem
    prod_mem
    { ι : Type _ } { t : Finset ι } { f : ι → K } ( h : ∀ , ∀ c ∈ t , ∀ , f c ∈ s ) : ∏ i in t , f i ∈ s
    := s.to_submonoid.prod_mem h

/- failed to parenthesize: parenthesize: uncaught backtrack exception
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " Sum of elements in a `subfield` indexed by a `finset` is in the `subfield`. -/")]
  []
  []
  []
  []
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  ...
  (Command.declSig
   [(Term.explicitBinder "(" [`S] [":" (Term.app `Set [(Term.app `Subfield [`K])])] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.paren
      "("
      [(Term.paren "(" [(Term.app `Inf [`S]) [(Term.typeAscription ":" (Term.app `Subfield [`K]))]] ")")
       [(Term.typeAscription ":" (Term.app `Set [`K]))]]
      ")")
     "="
   ...
   (Term.show
    ...
    («term_=_»
     (Term.paren
      ...
      [(Term.paren
        "("
        [(Term.app `Inf [(Set.Data.Set.Basic.term_''_ `Subfield.toSubring " '' " `S)])
         [(Term.typeAscription ":" (Term.app `Subring [`K]))]]
        ")")
       [(Term.typeAscription ":" (Term.app `Set [`K]))]]
      ")")
     "="
         ...
         (Tactic.exact
          ...
          (Term.anonymousCtor
           ...
           [(Term.fun
             "fun"
             (Term.basicFun
              [(Term.simpleBinder [`h `s `s'] []) (Term.anonymousCtor "⟨" [`s_mem "," `s'_eq] "⟩")]
              "=>"
              (Term.app
               `h
               [`s.to_subring
                (Term.hole "_")
                (Term.anonymousCtor "⟨" [(Term.anonymousCtor "⟨" [`s "," `s_mem "," `rfl] "⟩") "," `s'_eq] "⟩")])))
            ","
            (Term.fun
             "fun"
             (Term.basicFun
              [(Term.simpleBinder [`h `s `s'] [])
               (Term.anonymousCtor
                "⟨"
                [(Term.anonymousCtor "⟨" [`s'' "," `s''_mem "," `s_eq] "⟩")
                 ","
                 (Term.paren
                  "("
                  [`s'_eq [(Term.typeAscription ":" («term_=_» (Init.Coe.«term↑_» "↑" `s) "=" `s'))]]
                  ")")]
                "⟩")]
              "=>"
              (Term.app
                    ...
                    (Tactic.tacticSeq1Indented
                     [(group
                       (Tactic.simp
                        ...
                        []
                        []
                        ["[" [(Tactic.simpLemma [] ["←"] `s_eq) "," (Tactic.simpLemma [] ["←"] `s'_eq)] "]"]
                        [])
                       [])])))]
                 "⟩")])))]
           "⟩"))
      ...
      (Term.basicFun
       [(Term.simpleBinder [`h `s `s'] [])
        (Term.anonymousCtor
         ...
         [(Term.anonymousCtor "⟨" [`s'' "," `s''_mem "," `s_eq] "⟩")
          ","
          (Term.paren "(" [`s'_eq [(Term.typeAscription ":" («term_=_» (Init.Coe.«term↑_» "↑" `s) "=" `s'))]] ")")]
         "⟩")]
       "=>"
       (Term.app
        `h
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.simp "simp" [] [] ["[" [(Tactic.simpLemma [] ["←"] `s_eq) "," (Tactic.simpLemma [] ["←"] `s'_eq)] "]"] [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.anonymousCtor "⟨" [`s "," `s_mem "," `rfl] "⟩")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.anonymousCtor.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.simpleBinder'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.anonymousCtor "⟨" [`s_mem "," `s'_eq] "⟩")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.anonymousCtor.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq
   ...
   (Tactic.rwRuleSeq
    "["
    [(Tactic.rwRule [] `Subring.coe_Inf) "," (Tactic.rwRule [] `Set.mem_Inter) "," (Tactic.rwRule [] `Set.mem_Inter)]
    "]")
   [])
...
@[ simp , norm_cast ]
  theorem
    coe_Inf
    ( S : Set Subfield K ) : ( ( Inf S : Subfield K ) : Set K ) = ⋂ ( s : _ ) ( _ : s ∈ S ) , ↑ s
    :=
      show
        ( ( Inf Subfield.toSubring '' S : Subring K ) : Set K ) = ⋂ ( s : _ ) ( _ : s ∈ S ) , ↑ s
        by
          ext x
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `Inf_to_subring [])
  (Command.declSig
   [(Term.explicitBinder "(" [`s] [":" (Term.app `Set [(Term.app `Subfield [`K])])] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.proj (Term.app `Inf [`s]) "." `toSubring)
     "="
      ...
      [(group (Tactic.ext "ext" [(Tactic.rcasesPat.one `x)] []) [])
       (group
        (Tactic.rwSeq
         "rw"
         []
         (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `mem_to_subring) "," (Tactic.rwRule [] `mem_Inf)] "]")
         [])
        [])
       (group (Tactic.tacticErw__ "erw" (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Subring.mem_Inf)] "]") []) [])
       (group
        (Tactic.exact
         "exact"
         (Term.anonymousCtor
          ...
          [(Term.fun
            "fun"
            (Term.basicFun
             [(Term.simpleBinder [`h `p] []) (Term.anonymousCtor "⟨" [`p' "," `hp] "⟩")]
             "=>"
             (Term.subst
              `hp
              "▸"
              [(Term.app
                ...
                [(Term.fun
                  "fun"
                  (Term.basicFun
                   [(Term.simpleBinder [`p] []) (Term.anonymousCtor "⟨" [`hp' "," `hp] "⟩")]
                   "=>"
                   (Term.subst `hp "▸" [(Term.app `h [(Term.hole "_") `hp'])])))])])))
           ","
           (Term.fun
            "fun"
            (Term.basicFun
             [(Term.simpleBinder [`h `p `hp] [])]
             "=>"
             (Term.app
              `h
              [`p.to_subring
                     ...
                     (Term.anonymousCtor
                      ...
                      [(Term.fun
                        ...
                        (Term.basicFun
                         ...
                         (Term.app
                          `subring.mem_Inf.mp
                          [`hx (Term.hole "_") (Term.anonymousCtor "⟨" [`hp "," `rfl] "⟩")])))
                       ","
                       (Term.fun
                        "fun"
                        (Term.basicFun
                         ...
                         (Term.app
                          ...
                          [(Term.fun
                            "fun"
                            (Term.basicFun
                             [(Term.simpleBinder [`p'] []) (Term.anonymousCtor "⟨" [`hp "," `p'_eq] "⟩")]
                             "=>"
                             (Term.subst `p'_eq "▸" [`hx])))])))]
                      "⟩")))])]
                "⟩")])))]
               ...
               (Term.anonymousCtor
                ...
                [(Term.fun
                  ...
                  (Term.basicFun
                   [(Term.simpleBinder [`hx] [])]
                   "=>"
                   (Term.app `subring.mem_Inf.mp [`hx (Term.hole "_") (Term.anonymousCtor "⟨" [`hp "," `rfl] "⟩")])))
                 ","
                 (Term.fun
                  "fun"
                  (Term.basicFun
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.tacticErw__ "erw" (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Subring.mem_Inf)] "]") [])
...
@[ simp ]
  theorem
    Inf_to_subring
    ( s : Set Subfield K ) : Inf s . toSubring = ⨅ ( t : _ ) ( _ : t ∈ s ) , Subfield.toSubring t
    :=
      by
        ext x
...
-- ././Mathport/Syntax/Translate/Basic.lean:802:4: unsupported set replacement {(«expr / »(x, y)) | (x «expr ∈ » subring.closure s) (y «expr ∈ » subring.closure s)}
 ...
 (Command.theorem
  ...
  (Command.declSig
   [(Term.implicitBinder "{" [`ι] [] "}")
    (Term.explicitBinder "(" [`s] [":" (Term.arrow `ι "→" (Term.app `Set [`K]))] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app
  ...
  (Command.declValSimple ":=" (Term.proj (Term.proj (Term.app `Subfield.gi [`K]) "." `gc) "." `l_supr) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Term.proj (Term.app `Subfield.gi [`K]) "." `gc) "." `l_supr)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.proj (Term.app `Subfield.gi [`K]) "." `gc)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `Subfield.gi [`K])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Subfield.gi [`K]) []] ")")
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
theorem closure_Union { ι } ( s : ι → Set K ) : closure ⋃ i , s i = ⨆ i , closure s i := Subfield.gi K . gc . l_supr
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  ...
  (Command.declSig
   [(Term.explicitBinder "(" [`s] [":" (Term.app `Set [(Term.app `Set [`K])])] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     ...
     (Order.CompleteLattice.«term⨆_,_»
      ...
      ", "
      (Term.app `closure [`t])))))
  (Command.declValSimple ":=" (Term.proj (Term.proj (Term.app `Subfield.gi [`K]) "." `gc) "." `l_Sup) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Term.proj (Term.app `Subfield.gi [`K]) "." `gc) "." `l_Sup)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.proj (Term.app `Subfield.gi [`K]) "." `gc)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
...
theorem
  closure_sUnion
  ( s : Set Set K ) : closure ⋃₀ s = ⨆ ( t : _ ) ( _ : t ∈ s ) , closure t
  := Subfield.gi K . gc . l_Sup
 ...
 (Command.theorem
  ...
  (Command.declSig
   [(Term.implicitBinder "{" [`ι] [":" (Term.sort "Sort" [(Level.hole "_")])] "}")
    (Term.explicitBinder "(" [`f] [":" (Algebra.Ring.Basic.«term_→+*_» `K " →+* " `L)] [] ")")
    (Term.explicitBinder "(" [`s] [":" (Term.arrow `ι "→" (Term.app `Subfield [`K]))] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
...
theorem
  map_supr
  { ι : Sort _ } ( f : K →+* L ) ( s : ι → Subfield K ) : supr s . map f = ⨆ i , s i . map f
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  ...
  (Command.declSig
   [(Term.implicitBinder "{" [`ι] [":" (Term.sort "Sort" [(Level.hole "_")])] "}")
    (Term.explicitBinder "(" [`f] [":" (Algebra.Ring.Basic.«term_→+*_» `K " →+* " `L)] [] ")")
    (Term.explicitBinder "(" [`s] [":" (Term.arrow `ι "→" (Term.app `Subfield [`L]))] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
...
theorem
  comap_infi
  { ι : Sort _ } ( f : K →+* L ) ( s : ι → Subfield L ) : infi s . comap f = ⨅ i , s i . comap f
 ...
 (Command.theorem
  ...
  (Command.declSig
   [(Term.implicitBinder "{" [`ι] [] "}")
    ...
    (Term.implicitBinder "{" [`S] [":" (Term.arrow `ι "→" (Term.app `Subfield [`K]))] "}")
    (Term.explicitBinder
     "("
     [`hS]
           ...
           (Init.Core.«term_∈_»
            ...
            (Term.app
             ...
             [(Set.Data.Set.Lattice.«term⋃_,_»
               ...
               (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
               ", "
               (Term.paren "(" [(Term.app `S [`i]) [(Term.typeAscription ":" (Term.app `Set [`K]))]] ")"))]))
           "→"
           («term∃_,_»
            "∃"
            (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
            ...
            (Tactic.tacticSeq1Indented
             [(group
               (Tactic.simpa
                ...
                []
                ["only"]
                ["[" [(Tactic.simpLemma [] [] `closure_Union) "," (Tactic.simpLemma [] [] `closure_eq)] "]"]
                []
                [])
               [])])))))
        [])
         ...
         (Term.fun
          ...
          (Term.basicFun
           ...
           (Term.app
            `closure_induction
            [`hx
             (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`x] [])] "=>" `set.mem_Union.mp))
             (Term.hole "_")
             (Term.hole "_")
             (Term.hole "_")
             (Term.hole "_")
            ...
            (group
             (Tactic.exact
              ...
              (Term.anonymousCtor
               ...
               [`k
                ","
                (Term.app (Term.proj (Term.app `S [`k]) "." `add_mem) [(Term.app `hki [`hi]) (Term.app `hkj [`hj])])]
               "⟩"))
             [])])))
        [])
       (group
          ...
          (Tactic.tacticSeq1Indented
           [(group
            ...
            (group
             (Tactic.exact
              "exact"
              (Term.anonymousCtor "⟨" [`i "," (Term.app (Term.proj (Term.app `S [`i]) "." `neg_mem) [`hi])] "⟩"))
             [])])))
        [])
       (group
        (Tactic.«tactic·._»
          ...
          (Tactic.tacticSeq1Indented
           [(group
            ...
            (group
             (Tactic.exact
              "exact"
              (Term.anonymousCtor "⟨" [`i "," (Term.app (Term.proj (Term.app `S [`i]) "." `inv_mem) [`hi])] "⟩"))
             [])])))
        [])
       (group
        (Tactic.«tactic·._»
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.proj (Term.app `S [`i]) "." `inv_mem) [`hi])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `S [`i]) "." `inv_mem)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `S [`i])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.proj (Term.app `S [`i]) "." `neg_mem) [`hi])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `S [`i]) "." `neg_mem)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `S [`i])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
     ...
     [(group
      ...
      (group
       (Tactic.exact
        ...
        (Term.anonymousCtor
         "⟨"
         [`k "," (Term.app (Term.proj (Term.app `S [`k]) "." `add_mem) [(Term.app `hki [`hi]) (Term.app `hkj [`hj])])]
         "⟩"))
       [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.«tactic·._»', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq', expected 'Lean.Parser.Tactic.tacticSeq.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `hki [`hi]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `S [`k]) "." `add_mem)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `S [`k])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
    ...
    :=
      by
        refine' ⟨ _ , fun ⟨ i , hi ⟩ => SetLike.le_def . 1 $ le_supr S i hi ⟩
          ...
          · rintro x ⟨ i , hi ⟩ exact ⟨ i , S i . neg_mem hi ⟩
          · rintro x ⟨ i , hi ⟩ exact ⟨ i , S i . inv_mem hi ⟩
          ·
            rintro x y ⟨ i , hi ⟩ ⟨ j , hj ⟩
              obtain ⟨ k , hki , hkj ⟩ := hS i j
     ...
     (Term.paren
      ...
      [(Term.paren
        ...
        [(Order.CompleteLattice.«term⨆_,_»
          ...
          ", "
          (Term.app `S [`i]))
         [(Term.typeAscription ":" (Term.app `Subfield [`K]))]]
        ")")
       [(Term.typeAscription ":" (Term.app `Set [`K]))]]
      ")")
     "="
...
theorem
  ...
  { ι } [ hι : Nonempty ι ] { S : ι → Subfield K } ( hS : Directed · ≤ · S )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  ...
  (Command.declSig
   [(Term.implicitBinder "{" [`S] [":" (Term.app `Set [(Term.app `Subfield [`K])])] "}")
   ...
   (Term.typeSpec
    ...
    («term_=_»
     (Term.paren
      "("
      [(Init.Coe.«term↑_» "↑" (Term.app `Sup [`S])) [(Term.typeAscription ":" (Term.app `Set [`K]))]]
      ")")
     "="
     (Set.Data.Set.Lattice.«term⋃_,_»
      "⋃"
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, [anonymous]))
  («term_=_»
   (Term.paren "(" [(Init.Coe.«term↑_» "↑" (Term.app `Sup [`S])) [(Term.typeAscription ":" (Term.app `Set [`K]))]] ")")
   "="
   (Set.Data.Set.Lattice.«term⋃_,_»
    "⋃"
    (Lean.explicitBinders
...
theorem
  ...
  { S : Set Subfield K } ( Sne : S.nonempty ) ( hS : DirectedOn · ≤ · S )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `eq_locus_field [])
  (Command.optDeclSig
   [(Term.explicitBinder "(" [`f `g] [":" (Algebra.Ring.Basic.«term_→+*_» `K " →+* " `L)] [] ")")]
   [(Term.typeSpec ":" (Term.app `Subfield [`K]))])
  (Command.declValSimple
   ":="
   (Term.structInst
    "{"
    [[(Term.app
       (Term.proj
        (Term.paren "(" [`f [(Term.typeAscription ":" (Algebra.Ring.Basic.«term_→+*_» `K " →+* " `L))]] ")")
        "."
        `eqLocus)
       [`g])]
     "with"]
    [(group
      (Term.structInstField
       ...
       (Term.fun
        ...
        (Term.basicFun
         [(Term.simpleBinder [`x] [])
          (Term.simpleBinder [`hx] [(Term.typeSpec ":" («term_=_» (Term.app `f [`x]) "=" (Term.app `g [`x])))])]
         "=>"
         (Term.show
          "show"
          («term_=_» (Term.app `f [(Init.Logic.«term_⁻¹» `x "⁻¹")]) "=" (Term.app `g [(Init.Logic.«term_⁻¹» `x "⁻¹")]))
          (Term.byTactic
           "by"
           (Tactic.tacticSeq
            (Tactic.tacticSeq1Indented
             [(group
               (Tactic.rwSeq
                ...
                (Tactic.rwRuleSeq
                 "["
                 [(Tactic.rwRule [] `f.map_inv) "," (Tactic.rwRule [] `g.map_inv) "," (Tactic.rwRule [] `hx)]
                 "]")
                [])
               [])])))))))
      [","])
