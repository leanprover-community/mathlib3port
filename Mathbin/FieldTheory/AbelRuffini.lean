...
theorem splits_X_pow_sub_one_of_X_pow_sub_C {F : Type _} [Field F] {E : Type _} [Field E] (i : F →+* E) (n : ℕ) {a : F}
  ...
  by 
    ...
    ·
      rw [map_sub, map_sub, map_pow, map_X, map_C, map_one, sub_comp, pow_comp, X_comp, C_comp, mul_powₓ, ←C_pow, hb,
        mul_sub, ←mul_assocₓ, C_mul_C, one_mulₓ]
...
-- error in FieldTheory.AbelRuffini: ././Mathport/Syntax/Translate/Basic.lean:340:40: in let: ././Mathport/Syntax/Translate/Basic.lean:557:61: unsupported notation `«expr ⟮ , ⟯»
/-- An auxiliary induction lemma, which is generalized by `solvable_by_rad.is_solvable`. -/
theorem induction2
...
-- error in FieldTheory.AbelRuffini: ././Mathport/Syntax/Translate/Basic.lean:557:61: unsupported notation `«expr ⟮ , ⟯»
/-- An auxiliary induction lemma, which is generalized by `solvable_by_rad.is_solvable`. -/
