...
@[simp]
theorem inf_to_subalgebra (S T : IntermediateField F E) : (S⊓T).toSubalgebra = S.to_subalgebra⊓T.to_subalgebra :=
  rfl

@[simp]
theorem inf_to_subfield (S T : IntermediateField F E) : (S⊓T).toSubfield = S.to_subfield⊓T.to_subfield :=
  rfl
...
@[simp]
theorem top_equiv_symm_apply_coe (a : E) : ↑(top_equiv.symm a : (⊤ : IntermediateField F E)) = a :=
  rfl
...
theorem mem_adjoin_simple_self :
    α ∈ «expr ⟮ , ⟯» F "././Mathport/Syntax/Translate/Basic.lean:706:61: unsupported notation `«expr ⟮ , ⟯»" :=
...
theorem adjoin_simple.algebra_map_gen :
    algebraMap («expr ⟮ , ⟯» F "././Mathport/Syntax/Translate/Basic.lean:706:61: unsupported notation `«expr ⟮ , ⟯»") E
...
theorem adjoin_simple.is_integral_gen : IsIntegral F (adjoin_simple.gen F α) ↔ IsIntegral F α := by
  ...
  rw
    [is_integral_algebra_map_iff
      (algebraMap («expr ⟮ , ⟯» F "././Mathport/Syntax/Translate/Basic.lean:706:61: unsupported notation `«expr ⟮ , ⟯»")
          E).Injective]
  infer_instance
...
theorem finrank_adjoin_simple_eq_one_iff :
    finrank F («expr ⟮ , ⟯» F "././Mathport/Syntax/Translate/Basic.lean:706:61: unsupported notation `«expr ⟮ , ⟯»") =
        1 ↔
      α ∈ (⊥ : IntermediateField F E) :=
  by
...
theorem aeval_gen_minpoly (α : E) : aeval (adjoin_simple.gen F α) (minpoly F α) = 0 := by
  ...
  exact
    IsScalarTower.algebra_map_aeval F
      («expr ⟮ , ⟯» F "././Mathport/Syntax/Translate/Basic.lean:706:61: unsupported notation `«expr ⟮ , ⟯»") E _ _
...
noncomputable def adjoin_root_equiv_adjoin (h : IsIntegral F α) :
  ...
  AlgEquiv.ofBijective (AdjoinRoot.liftHom (minpoly F α) (adjoin_simple.gen F α) (aeval_gen_minpoly F α))
    (by
      ...
      · suffices
          («expr ⟮ , ⟯» F
                "././Mathport/Syntax/Translate/Basic.lean:706:61: unsupported notation `«expr ⟮ , ⟯»").toSubfield ≤
            RingHom.fieldRange
              ((«expr ⟮ , ⟯» F
                        "././Mathport/Syntax/Translate/Basic.lean:706:61: unsupported notation `«expr ⟮ , ⟯»").toSubfield.Subtype.comp
                f)
          by
...
noncomputable def adjoin.power_basis {x : L} (hx : IsIntegral K x) :
    PowerBasis K
      («expr ⟮ , ⟯» K "././Mathport/Syntax/Translate/Basic.lean:706:61: unsupported notation `«expr ⟮ , ⟯»") where
...
noncomputable def alg_hom_adjoin_integral_equiv (h : IsIntegral F α) :
    («expr ⟮ , ⟯» F "././Mathport/Syntax/Translate/Basic.lean:706:61: unsupported notation `«expr ⟮ , ⟯»" →ₐ[F] K) ≃
...
noncomputable def lifts.upper_bound_alg_hom {c : Set (lifts F E K)} (hc : Zorn.Chain (· ≤ ·) c) :
    lifts.upper_bound_intermediate_field hc →ₐ[F] K where
...
theorem lifts.le_lifts_of_splits (x : lifts F E K) {s : E} (h1 : IsIntegral F s)
  ...
  ⟨fun z hz =>
    algebra_map_mem
      («expr ⟮ , ⟯» x.1 "././Mathport/Syntax/Translate/Basic.lean:706:61: unsupported notation `«expr ⟮ , ⟯»") ⟨z, hz⟩,
    fun t u htu =>
    Eq.symm
      (by
        rw [←
...
theorem le_sup_to_subalgebra {K L : Type _} [Field K] [Field L] [Algebra K L] (E1 E2 : IntermediateField K L) :
    E1.to_subalgebra⊔E2.to_subalgebra ≤ (E1⊔E2).toSubalgebra :=
...
theorem sup_to_subalgebra {K L : Type _} [Field K] [Field L] [Algebra K L] (E1 E2 : IntermediateField K L)
    ...
    (E1⊔E2).toSubalgebra = E1.to_subalgebra⊔E2.to_subalgebra := by
  ...
  have h1 : Algebra.IsAlgebraic K E1 := Algebra.is_algebraic_of_finite
  have h2 : Algebra.IsAlgebraic K E2 := Algebra.is_algebraic_of_finite
...
noncomputable def equiv_adjoin_simple (pb : PowerBasis K L) :
    «expr ⟮ , ⟯» K "././Mathport/Syntax/Translate/Basic.lean:706:61: unsupported notation `«expr ⟮ , ⟯»" ≃ₐ[K] L :=
