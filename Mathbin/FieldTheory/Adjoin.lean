...
theorem adjoin_simple_adjoin_simple (β : E) :
    ↑(«expr ⟮ ,⟯» («expr ⟮ ,⟯» F "././Mathport/Syntax/Translate/Basic.lean:827:71: unsupported notation `«expr ⟮ ,⟯»")
          "././Mathport/Syntax/Translate/Basic.lean:827:71: unsupported notation `«expr ⟮ ,⟯»") =
      «expr ⟮ ,⟯» F "././Mathport/Syntax/Translate/Basic.lean:827:71: unsupported notation `«expr ⟮ ,⟯»" :=
...
theorem adjoin_simple_to_subalgebra_of_integral (hα : IsIntegral F α) :
    («expr ⟮ ,⟯» F "././Mathport/Syntax/Translate/Basic.lean:827:71: unsupported notation `«expr ⟮ ,⟯»").toSubalgebra =
      Algebra.adjoin F {α} :=
  by
...
theorem dim_adjoin_simple_eq_one_iff :
    Module.rank F («expr ⟮ ,⟯» F "././Mathport/Syntax/Translate/Basic.lean:827:71: unsupported notation `«expr ⟮ ,⟯»") =
        1 ↔
      α ∈ (⊥ : IntermediateField F E) :=
  by
...
theorem finrank_adjoin_simple_eq_one_iff :
    finrank F («expr ⟮ ,⟯» F "././Mathport/Syntax/Translate/Basic.lean:827:71: unsupported notation `«expr ⟮ ,⟯»") = 1 ↔
      α ∈ (⊥ : IntermediateField F E) :=
  by
    ...
    (ih :
      ∀ K : IntermediateField F E,
        ∀ x ∈ S,
          ∀,
            P K →
              P ↑(«expr ⟮ ,⟯» K "././Mathport/Syntax/Translate/Basic.lean:827:71: unsupported notation `«expr ⟮ ,⟯»")) :
    P (adjoin F ↑S) := by
