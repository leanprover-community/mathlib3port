...
/-- **Primitive element theorem** assuming E is finite. -/
  theorem
    ...
    [ Fintype E ] : ∃ α : E , F ⟮ "././Mathport/Syntax/Translate/Basic.lean:813:11: unsupported (impossible)" ⟯ = ⊤
    :=
      by
        obtain ⟨ α , hα ⟩ := IsCyclic.exists_generator Units E
          ...
          rintro x -
          by_cases' hx : x = 0
          · rw [ hx ] exact F ⟮ "././Mathport/Syntax/Translate/Basic.lean:813:11: unsupported (impossible)" ⟯ . zero_mem
          ·
...
/-- Primitive element theorem for finite dimensional extension of a finite field. -/
  theorem
    ...
    [ Fintype F ] [ FiniteDimensional F E ]
      : ∃ α : E , F ⟮ "././Mathport/Syntax/Translate/Basic.lean:813:11: unsupported (impossible)" ⟯ = ⊤
  ...
  :=
    by
      have hα := IsSeparable.is_integral F α
        ...
        let γ := α + c • β
        suffices β_in_Fγ : β ∈ F ⟮ "././Mathport/Syntax/Translate/Basic.lean:813:11: unsupported (impossible)" ⟯
        ·
          use γ
            apply le_antisymmₓ
            ·
                  ...
                  α_in_Fγ
                    ...
                    by
                      rw [ ← add_sub_cancel α c • β ]
                        exact
                          F ⟮ "././Mathport/Syntax/Translate/Basic.lean:813:11: unsupported (impossible)" ⟯ . sub_mem
            ...
            ·
              rw [ adjoin_le_iff ]
                ...
                have
                  β_in_Fαβ
                    : β ∈ F ⟮ "././Mathport/Syntax/Translate/Basic.lean:813:11: unsupported (impossible)" ⟯
                    :=
                    subset_adjoin F { α , β } Set.mem_insert_of_mem α rfl
                exact
                  F ⟮ "././Mathport/Syntax/Translate/Basic.lean:813:11: unsupported (impossible)" ⟯ . add_mem
                    α_in_Fαβ
                      F ⟮ "././Mathport/Syntax/Translate/Basic.lean:813:11: unsupported (impossible)" ⟯ . smul_mem
                        β_in_Fαβ
        let
          p
            :=
            EuclideanDomain.gcd
              f.map algebraMap F F ⟮ "././Mathport/Syntax/Translate/Basic.lean:813:11: unsupported (impossible)" ⟯
                    .
                    comp
                  C adjoin_simple.gen F γ - C ↑ c * X
                g.map algebraMap F F ⟮ "././Mathport/Syntax/Translate/Basic.lean:813:11: unsupported (impossible)" ⟯
        ...
        suffices
          p_linear
          :
            p.map algebraMap F ⟮ "././Mathport/Syntax/Translate/Basic.lean:813:11: unsupported (impossible)" ⟯ E
              =
        ...
        ·
          dsimp only [ p ]
            convert
              gcd_map algebraMap F ⟮ "././Mathport/Syntax/Translate/Basic.lean:813:11: unsupported (impossible)" ⟯ E
                .
                symm
          ...
          ·
            let
                P
                  ...
                  :=
                  fun
                    K => ∃ α : E , F ⟮ "././Mathport/Syntax/Translate/Basic.lean:813:11: unsupported (impossible)" ⟯ = K
