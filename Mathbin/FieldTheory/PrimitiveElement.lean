...
theorem exists_primitive_element_of_fintype_top [Fintype E] :
    ∃ α : E, «expr ⟮ , ⟯» F "././Mathport/Syntax/Translate/Basic.lean:827:71: unsupported notation `«expr ⟮ , ⟯»" = ⊤ :=
  by
  ...
  · rw [hx]
    exact
      («expr ⟮ , ⟯» F "././Mathport/Syntax/Translate/Basic.lean:827:71: unsupported notation `«expr ⟮ , ⟯»").zero_mem
  ...
  · obtain ⟨n, hn⟩ := set.mem_range.mp (hα (Units.mk0 x hx))
    rw
      [show x = α ^ n by
        ...
        rw [hn, Units.coe_mk0]]
    exact
      pow_mem («expr ⟮ , ⟯» F "././Mathport/Syntax/Translate/Basic.lean:827:71: unsupported notation `«expr ⟮ , ⟯»")
...
theorem primitive_element_inf_aux [IsSeparable F E] :
  ...
  let γ := α + c • β
  suffices β_in_Fγ :
    β ∈ «expr ⟮ , ⟯» F "././Mathport/Syntax/Translate/Basic.lean:827:71: unsupported notation `«expr ⟮ , ⟯»"
  · use γ
    apply le_antisymmₓ
    · rw [adjoin_le_iff]
      have α_in_Fγ :
        α ∈ «expr ⟮ , ⟯» F "././Mathport/Syntax/Translate/Basic.lean:827:71: unsupported notation `«expr ⟮ , ⟯»" := by
        rw [← add_sub_cancel α (c • β)]
        exact
          («expr ⟮ , ⟯» F "././Mathport/Syntax/Translate/Basic.lean:827:71: unsupported notation `«expr ⟮ , ⟯»").sub_mem
            (mem_adjoin_simple_self F γ)
            ((«expr ⟮ , ⟯» F
                    "././Mathport/Syntax/Translate/Basic.lean:827:71: unsupported notation `«expr ⟮ , ⟯»").toSubalgebra.smul_mem
              β_in_Fγ c)
      exact fun x hx => by
    ...
    · rw [adjoin_le_iff]
      ...
      exact
        («expr ⟮ , ⟯» F "././Mathport/Syntax/Translate/Basic.lean:827:71: unsupported notation `«expr ⟮ , ⟯»").add_mem
          α_in_Fαβ
          ((«expr ⟮ , ⟯» F
                "././Mathport/Syntax/Translate/Basic.lean:827:71: unsupported notation `«expr ⟮ , ⟯»").smul_mem
            β_in_Fαβ)
  ...
  let p :=
    EuclideanDomain.gcd
      ((f.map
            (algebraMap F
              («expr ⟮ , ⟯» F
                "././Mathport/Syntax/Translate/Basic.lean:827:71: unsupported notation `«expr ⟮ , ⟯»"))).comp
  ...
  suffices p_linear :
    p.map
        (algebraMap
          («expr ⟮ , ⟯» F "././Mathport/Syntax/Translate/Basic.lean:827:71: unsupported notation `«expr ⟮ , ⟯»") E) =
...
theorem exists_primitive_element :
  ...
  · let P : IntermediateField F E → Prop := fun K =>
      ∃ α : E, «expr ⟮ , ⟯» F "././Mathport/Syntax/Translate/Basic.lean:827:71: unsupported notation `«expr ⟮ , ⟯»" = K
...
noncomputable def powerBasisOfFiniteOfSeparable : PowerBasis F E :=
  ...
  have e : «expr ⟮ , ⟯» F "././Mathport/Syntax/Translate/Basic.lean:827:71: unsupported notation `«expr ⟮ , ⟯»" = ⊤ :=
