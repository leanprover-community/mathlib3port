  ...
  instance
    ...
    where
      R α β := Nonempty ( α ≃ β )
        iseqv
          :=
          ⟨ fun α => ⟨ Equivₓ.refl α ⟩ , fun α β ⟨ e ⟩ => ⟨ e.symm ⟩ , fun α β γ ⟨ e₁ ⟩ ⟨ e₂ ⟩ => ⟨ e₁.trans e₂ ⟩ ⟩
...
instance
  ...
  where
    zero := 0
      ...
      add_zero a := by rw [ Cardinal.add_comm a 0 , Cardinal.zero_add a ]
      add_assoc a b c := induction_on₃ a b c $ fun α β γ => mk_congr ( Equivₓ.sumAssoc α β γ )
      add_comm := Cardinal.add_comm
      zero_mul := Cardinal.zero_mul
      mul_zero a := by rw [ Cardinal.mul_comm a 0 , Cardinal.zero_mul a ]
      one_mul := Cardinal.one_mul
      mul_one a := by rw [ Cardinal.mul_comm a 1 , Cardinal.one_mul a ]
      mul_assoc a b c := induction_on₃ a b c $ fun α β γ => mk_congr ( Equivₓ.prodAssoc α β γ )
      ...
      right_distrib
        ...
        by
          rw
            [
              Cardinal.mul_comm ( a + b ) c
                ,
                Cardinal.left_distrib c a b
                ,
                Cardinal.mul_comm c a
                ,
                Cardinal.mul_comm c b
              ]
      npow n c := c ^ n
      npow_zero' := @ power_zero
      npow_succ' n c := by rw [ Nat.cast_succ , power_add , power_one , Cardinal.mul_comm ]
...
noncomputable instance : DistribLattice Cardinal.{u} := by
  infer_instance
...
theorem succ_le {a b : Cardinal} : succ a ≤ b ↔ a < b :=
  ⟨lt_of_lt_of_leₓ (lt_succ_self _), fun h => by
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  ...
  (Command.declId `Sum [])
  (Command.optDeclSig
   [(Term.implicitBinder "{" [`ι] [] "}") (Term.explicitBinder "(" [`f] [":" (Term.arrow `ι "→" `Cardinal)] [] ")")]
   [(Term.typeSpec ":" `Cardinal)])
     ...
     (Term.app
      ...
      [(Term.fun
        ...
        (Term.basicFun
         [(Term.simpleBinder [`i] [])]
         "=>"
         (Term.app (Cardinal.SetTheory.Cardinal.«term#» "#") [(Term.app `f [`i])])))]))))
  (Command.declValSimple
   ":="
   («term_$__»
    `mk_congr
    ...
    («term_$__»
     ...
     "$"
     (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`i] [])] "=>" (Term.proj `out_mk_equiv "." `symm)))))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
@[ simp ]
  theorem
    mk_sigma
    { ι } ( f : ι → Type _ ) : # Σ i , f i = Sum fun i => # f i
 ...
 (Command.theorem
  ...
  (Command.declSig
   ...
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app `Sum [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`i] [(Term.typeSpec ":" `ι)])] "=>" `a))])
     "="
     (Finset.Data.Finset.Fold.«term_*_»
      (Term.app (Term.explicitUniv `lift ".{" [`v] "}") [(Term.app (Cardinal.SetTheory.Cardinal.«term#» "#") [`ι])])
      "*"
        ...
        [(calcStep
          (Data.Equiv.Basic.«term_≃_»
           (Init.Data.Sigma.Basic.«termΣ_,_»
            ...
            ", "
            (Term.app `Quotientₓ.out [(Term.app (Cardinal.SetTheory.Cardinal.«term#» "#") [`α])]))
           " ≃ "
           («term_×_» `ι "×" (Term.app `Quotientₓ.out [(Term.app (Cardinal.SetTheory.Cardinal.«term#» "#") [`α])])))
          ":="
         ...
         (calcStep
          (Data.Equiv.Basic.«term_≃_»
           (Term.hole "_")
           " ≃ "
           («term_×_» (Term.app `Ulift [`ι]) "×" (Term.app `Ulift [`α])))
          ":="
          (Term.app
           (Term.proj (Term.proj `Equivₓ.ulift "." `symm) "." `prodCongr)
           [(Term.app (Term.proj `out_mk_equiv "." `trans) [(Term.proj `Equivₓ.ulift "." `symm)])]))])))))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
    ...
    («term_$__»
     ...
     (calc
      ...
      [(calcStep
        ...
        (Term.app `Equivₓ.sigmaEquivProd [(Term.hole "_") (Term.hole "_")]))
       (calcStep
        (Data.Equiv.Basic.«term_≃_» (Term.hole "_") " ≃ " («term_×_» (Term.app `Ulift [`ι]) "×" (Term.app `Ulift [`α])))
        ":="
        (Term.app
         (Term.proj (Term.proj `Equivₓ.ulift "." `symm) "." `prodCongr)
         [(Term.app (Term.proj `out_mk_equiv "." `trans) [(Term.proj `Equivₓ.ulift "." `symm)])]))]))))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Cardinal.SetTheory.Cardinal.«term#» "#") [`α])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
@[ simp ]
  theorem
    sum_const
    ( ι : Type u ) ( a : Cardinal .{ v } ) : Sum fun i : ι => a = lift .{ v } # ι * lift .{ u } a
    :=
      induction_on a
        $
        fun
...
theorem lift_max {a : Cardinal.{u}} {b : Cardinal.{v}} :
  ...
  calc lift.{max v w} a = lift.{max u w} b ↔ lift.{w} (lift.{v} a) = lift.{w} (lift.{u} b) := by
    simp
...
theorem lt_omega_iff_fintype {α : Type u} : # α < ω ↔ Nonempty (Fintype α) :=
  lt_omega.trans
    ⟨fun ⟨n, e⟩ => by
      ...
      exact ⟨Fintype.ofEquiv _ f.symm⟩, fun ⟨_⟩ => by
...
@[simp]
theorem cast_to_nat_of_lt_omega {c : Cardinal} (h : c < ω) : ↑c.to_nat = c := by
  rw [to_nat_apply_of_lt_omega h, ← Classical.some_spec (lt_omega.1 h)]

@[simp]
theorem cast_to_nat_of_omega_le {c : Cardinal} (h : ω ≤ c) : ↑c.to_nat = (0 : Cardinal) := by
...
@[simp]
theorem zero_to_nat : to_nat 0 = 0 := by
  rw [← to_nat_cast 0, Nat.cast_zero]

@[simp]
theorem one_to_nat : to_nat 1 = 1 := by
...
@[simp]
theorem to_nat_lift (c : Cardinal.{v}) : (lift.{u, v} c).toNat = c.to_nat := by
...
@[simp]
theorem to_nat_mul (x y : Cardinal) : (x*y).toNat = x.to_nat*y.to_nat := by
  by_cases' hx1 : x = 0
  ·
...
theorem to_nat_add_of_lt_omega {a : Cardinal.{u}} {b : Cardinal.{v}} (ha : a < ω) (hb : b < ω) :
    (lift.{v, u} a+lift.{u, v} b).toNat = a.to_nat+b.to_nat := by
...
theorem to_enat_surjective : surjective to_enat := by
  intro x
 ...
 (Command.theorem
  ...
  (Command.declSig
   ...
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app (Cardinal.SetTheory.Cardinal.«term#» "#") [(Term.app `List [`α])])
     "="
     (Term.app
      `Sum
      [(Term.fun
        ...
        (Term.basicFun
         ...
         "=>"
         (Cardinal.SetTheory.Cardinal.«term_^ℕ_»
          (Term.app (Cardinal.SetTheory.Cardinal.«term#» "#") [`α])
          " ^ℕ "
          `n)))]))))
  (Command.declValSimple
      ...
      («term_=_»
       ...
       (Term.app
        ...
        [(Init.Data.Sigma.Basic.«termΣ_,_»
          ...
          (Term.app `Vector [`α `n]))]))
      ":="
      (Term.app `mk_congr [(Term.proj (Term.app `Equivₓ.sigmaPreimageEquiv [`List.length]) "." `symm)]))
     (calcStep
      («term_=_»
       (Term.hole "_")
       "="
   ...
   (Term.app
    ...
    [(Term.fun
      ...
      (Term.basicFun
       [(Term.simpleBinder [`n] [(Term.typeSpec ":" (termℕ "ℕ"))])]
       "=>"
       (Cardinal.SetTheory.Cardinal.«term_^ℕ_» (Term.app (Cardinal.SetTheory.Cardinal.«term#» "#") [`α]) " ^ℕ " `n)))]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_=_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app
   `Sum
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Cardinal.SetTheory.Cardinal.«term_^ℕ_» (Term.app (Cardinal.SetTheory.Cardinal.«term#» "#") [`α]) " ^ℕ " `n)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Cardinal.SetTheory.Cardinal.«term_^ℕ_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `n
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Term.app `Equivₓ.sigmaPreimageEquiv [`List.length]) "." `symm)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `Equivₓ.sigmaPreimageEquiv [`List.length])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `mk_Union_le_sum_mk [])
  (Command.declSig
   [(Term.implicitBinder "{" [`α `ι] [":" (Term.type "Type" [`u])] "}")
      ...
      («term_≤_»
       ...
       (Term.app
        ...
        [(Init.Data.Sigma.Basic.«termΣ_,_»
          ...
          (Term.app `f [`i]))]))
      ":="
      (Term.app `mk_le_of_surjective [(Term.app `Set.sigma_to_Union_surjective [`f])]))
     (calcStep
      («term_=_»
       (Term.hole "_")
       "="
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Set.sigma_to_Union_surjective [`f])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Set.sigma_to_Union_surjective [`f]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `mk_le_of_surjective
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `mk_Union_eq_sum_mk [])
  (Command.declSig
   [(Term.implicitBinder "{" [`α `ι] [":" (Term.type "Type" [`u])] "}")
    (Term.implicitBinder "{" [`f] [":" (Term.arrow `ι "→" (Term.app `Set [`α]))] "}")
    (Term.explicitBinder
     ...
     [":"
      (Term.forall
       ...
       ","
       (Term.arrow («term_≠_» `i "≠" `j) "→" (Term.app `Disjoint [(Term.app `f [`i]) (Term.app `f [`j])])))]
     []
     ")")]
   (Term.typeSpec
    ":"
      ...
      («term_=_»
       ...
       (Term.app
        ...
        [(Init.Data.Sigma.Basic.«termΣ_,_»
          ...
          (Term.app `f [`i]))]))
      ":="
      (Term.app `mk_congr [(Term.app `Set.unionEqSigmaOfDisjoint [`h])]))
     (calcStep
      («term_=_»
       (Term.hole "_")
       "="
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Set.unionEqSigmaOfDisjoint [`h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Set.unionEqSigmaOfDisjoint [`h]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `mk_congr
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
theorem
  mk_Union_eq_sum_mk
  { α ι : Type u } { f : ι → Set α } ( h : ∀ i j , i ≠ j → Disjoint f i f j ) : # ⋃ i , f i = Sum fun i => # f i
  := calc # ⋃ i , f i = # Σ i , f i := mk_congr Set.unionEqSigmaOfDisjoint h _ = Sum fun i => # f i := mk_sigma _
  ...
  (Command.declSig
   ...
   (Term.typeSpec
    ...
    («term_≤_»
     ...
     "≤"
     (Finset.Data.Finset.Fold.«term_*_»
      (Term.app (Cardinal.SetTheory.Cardinal.«term#» "#") [`ι])
      "*"
      (Term.app
       (Term.explicitUniv `Cardinal.sup ".{" [`u "," `u] "}")
       [(Term.fun
         "fun"
         (Term.basicFun
          [(Term.simpleBinder [`i] [])]
          "=>"
          (Term.app (Cardinal.SetTheory.Cardinal.«term#» "#") [(Term.app `f [`i])])))])))))
  (Command.declValSimple ":=" (Term.app `le_transₓ [`mk_Union_le_sum_mk (Term.app `sum_le_sup [(Term.hole "_")])]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `le_transₓ [`mk_Union_le_sum_mk (Term.app `sum_le_sup [(Term.hole "_")])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `sum_le_sup [(Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `sum_le_sup [(Term.hole "_")]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
theorem
  mk_Union_le
  { α ι : Type u } ( f : ι → Set α ) : # ⋃ i , f i ≤ # ι * Cardinal.sup .{ u , u } fun i => # f i
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `mk_bUnion_le [])
  (Command.declSig
   [(Term.implicitBinder "{" [`ι `α] [":" (Term.type "Type" [`u])] "}")
    (Term.explicitBinder "(" [`A] [":" (Term.arrow `ι "→" (Term.app `Set [`α]))] [] ")")
   ...
   (Term.typeSpec
    ...
    («term_≤_»
     ...
     "≤"
     (Finset.Data.Finset.Fold.«term_*_»
      (Term.app (Cardinal.SetTheory.Cardinal.«term#» "#") [`s])
      "*"
      (Term.app
       (Term.explicitUniv `Cardinal.sup ".{" [`u "," `u] "}")
       [(Term.fun
    ...
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `bUnion_eq_Union)] "]") []) [])
       (group (Tactic.apply "apply" `mk_Union_le) [])])))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.apply "apply" `mk_Union_le)
    ...
    (Term.app
     ...
     [(Term.fun
       ...
       (Term.basicFun
        [(Term.simpleBinder [`x] [(Term.typeSpec ":" `s)])]
        "=>"
        (Term.app (Cardinal.SetTheory.Cardinal.«term#» "#") [(Term.app `A [(Term.proj `x "." (fieldIdx "1"))])])))])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_≤_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Finset.Data.Finset.Fold.«term_*_»
   (Term.app (Cardinal.SetTheory.Cardinal.«term#» "#") [`s])
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `A [(Term.proj `x "." (fieldIdx "1"))]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Cardinal.SetTheory.Cardinal.«term#» "#")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Cardinal.SetTheory.Cardinal.«term#»', expected 'antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
   ...
   (Term.typeSpec
    ...
    («term_=_»
     ...
     (Term.app
      ...
      [(Set.«term{_|_}»
        "{"
        (Mathlib.ExtendedBinder.extBinder `x [":" `s])
        "|"
        (Term.app `t [(Term.proj `x "." (fieldIdx "1"))])
        "}")]))))
  (Command.declValSimple ":=" (Term.app `mk_congr [(Term.app `Equivₓ.Set.sep [`s `t])]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `mk_congr [(Term.app `Equivₓ.Set.sep [`s `t])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Equivₓ.Set.sep [`s `t]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `mk_congr
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `mk_subset_ge_of_subset_image_lift [])
  (Command.declSig
   [(Term.implicitBinder "{" [`α] [":" (Term.type "Type" [`u])] "}")
    ...
    (Term.explicitBinder
     "("
     [`h]
     [":" (Init.Core.«term_⊆_» `t " ⊆ " (Set.Data.Set.Basic.term_''_ `f " '' " `s))]
     []
     ")")]
   (Term.typeSpec
    ":"
    («term_≤_»
     (Term.app (Term.explicitUniv `lift ".{" [`u] "}") [(Term.app (Cardinal.SetTheory.Cardinal.«term#» "#") [`t])])
     "≤"
     (Term.app
      ...
      [(Term.app
        ...
        [(Term.paren
          "("
          [(Set.«term{_|_}_1» "{" («term_∈_» `x "∈" `s) "|" (Init.Core.«term_∈_» (Term.app `f [`x]) " ∈ " `t) "}")
           [(Term.typeAscription ":" (Term.app `Set [`α]))]]
          ")")])]))))
  (Command.declValSimple
   ":="
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.rwSeq
         "rw"
         []
         (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `image_eq_range)] "]")
       ...
       (group
        (Tactic.convert
         "convert"
         []
         (Term.app `mk_preimage_of_subset_range_lift [(Term.hole "_") (Term.hole "_") `h])
         ["using" (numLit "1")])
        [])
       (group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `mk_sep)] "]") []) [])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `mk_sep)] "]") [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `mk_sep
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `mk_subset_ge_of_subset_image [])
  (Command.declSig
   [(Term.explicitBinder "(" [`f] [":" (Term.arrow `α "→" `β)] [] ")")
    (Term.implicitBinder "{" [`s] [":" (Term.app `Set [`α])] "}")
    (Term.implicitBinder "{" [`t] [":" (Term.app `Set [`β])] "}")
   ...
   (Term.typeSpec
    ":"
    («term_≤_»
     (Term.app (Cardinal.SetTheory.Cardinal.«term#» "#") [`t])
     "≤"
     (Term.app
      (Cardinal.SetTheory.Cardinal.«term#» "#")
      [(Term.paren
      ...
      [(group
       ...
       (group
        (Tactic.convert
         "convert"
         []
         (Term.app `mk_preimage_of_subset_range [(Term.hole "_") (Term.hole "_") `h])
         ["using" (numLit "1")])
        [])
       (group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `mk_sep)] "]") []) [])
       (group (Tactic.tacticRfl "rfl") [])])))
