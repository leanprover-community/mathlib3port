...
@[simp]
theorem aleph_idx_le {a b} : aleph_idx a ≤ aleph_idx b ↔ a ≤ b := by
...
def aleph_idx.rel_iso : @RelIso Cardinal.{u} Ordinal.{u} (· < ·) (· < ·) :=
  @RelIso.ofSurjective Cardinal.{u} Ordinal.{u} (· < ·) (· < ·) aleph_idx.initial_seg.{u} $
    (InitialSeg.eq_or_principal aleph_idx.initial_seg.{u}).resolve_right $ fun ⟨o, e⟩ => by
...
theorem aleph'_le_of_limit {o : Ordinal.{u}} (l : o.is_limit) {c} : aleph' o ≤ c ↔ ∀, ∀ o' < o, ∀, aleph' o' ≤ c :=
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " If `α` is an infinite type, then `α × α` and `α` have the same cardinality. -/")]
  []
  []
  []
  []
 ...
 (Command.theorem
  "theorem"
  (Command.declId `mul_eq_self [])
  (Command.declSig
   [(Term.implicitBinder "{" [`c] [":" `Cardinal] "}")
    (Term.explicitBinder "(" [`h] [":" («term_≤_» (Ordinal.SetTheory.Ordinal.termω "ω") "≤" `c)] [] ")")]
   (Term.typeSpec ":" («term_=_» (Finset.Data.Finset.Fold.«term_*_» `c "*" `c) "=" `c)))
    ...
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group
             ...
             (Tactic.tacticSeq1Indented
              [(group
                (Tactic.simpa
                 ...
                 []
                 ["using" (Term.app `mul_le_mul_left' [(Term.app `one_lt_omega.le.trans [`h]) `c])])
                [])])))]))
        [])
       (group
        (Tactic.refine'
          ...
          [(Term.app `cardinal.wf.apply [`c])
           (Term.fun
            ...
            (Term.basicFun
             ...
             "=>"
             («term_$__»
              (Term.app `Quotientₓ.induction_on [`c])
              "$"
              (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`α `IH `ol] [])] "=>" (Term.hole "_"))))))
           `h]))
        [])
       (group
        (Tactic.rcases
         ...
         ["with"
          (Tactic.rcasesPat.tuple
           ...
           [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `r)]) [])
            ","
            (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `wo)]) [])
            ","
       ...
       (group
        (Tactic.tacticLet_ "let" (Term.letDecl (Term.letIdDecl `this' [] [] ":=" (Term.app `linearOrderOfSTO' [`r]))))
        [])
       (group
        (Tactic.tacticHave_
         "have"
         (Term.haveDecl
          (Term.haveIdDecl
           []
           [(Term.typeSpec ":" (Term.app `IsWellOrder [`α («term_<_» (Term.cdot "·") "<" (Term.cdot "·"))]))]
           ":="
           `wo)))
        [])
       (group
        (Tactic.tacticLet_
         ...
         (Term.letDecl
          (Term.letIdDecl
           `g
           [(Term.typeSpec ":" (Term.arrow («term_×_» `α "×" `α) "→" `α))]
           ":="
           (Term.fun
            "fun"
            (Term.basicFun
             [(Term.simpleBinder [`p] [])]
             "=>"
             (Term.app `max [(Term.proj `p "." (fieldIdx "1")) (Term.proj `p "." (fieldIdx "2"))]))))))
        [])
       (group
        (Tactic.tacticLet_
         "let"
           ...
           (Term.anonymousCtor
            ...
            [(Term.fun
              ...
              (Term.basicFun
               ...
               (Term.paren
                "("
                [(Term.app `typein [(«term_<_» (Term.cdot "·") "<" (Term.cdot "·")) (Term.app `g [`p])])
                 [(Term.tupleTail "," [`p])]]
                ")")))
             ","
             (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`p `q] [])] "=>" (Term.app `congr_argₓ [`Prod.snd])))]
            "⟩"))))
        [])
       (group
        (Tactic.tacticLet_
           ...
           (Order.Basic.«term_⁻¹'o_»
            ...
            (Term.app
             ...
             [(«term_<_» (Term.cdot "·") "<" (Term.cdot "·"))
              (Term.app
               `Prod.Lex
               [(«term_<_» (Term.cdot "·") "<" (Term.cdot "·")) («term_<_» (Term.cdot "·") "<" (Term.cdot "·"))])])))))
        [])
       (group
        (Tactic.tacticHave_
         "have"
         (Term.haveDecl
          (Term.haveIdDecl
           []
           [(Term.typeSpec ":" (Term.app `IsWellOrder [(Term.hole "_") `s]))]
           ":="
           (Term.proj (Term.app `RelEmbedding.preimage [(Term.hole "_") (Term.hole "_")]) "." `IsWellOrder))))
        [])
       (group
        (Tactic.tacticSuffices_
         ...
         (Term.sufficesDecl
          []
          («term_≤_» (Term.app `type [`s]) "≤" (Term.app `type [`r]))
          (Term.byTactic
           "by"
           (Tactic.tacticSeq
            (Tactic.tacticSeq1Indented [(group (Tactic.exact "exact" (Term.app `card_le_card [`this])) [])])))))
        [])
       (group
        (Tactic.refine'
         "refine'"
         (Term.app
          `le_of_forall_lt
          [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`o `h] [])] "=>" (Term.hole "_")))]))
        [])
       (group
        (Tactic.rcases
         "rcases"
         [(Tactic.casesTarget [] (Term.app `typein_surj [`s `h]))]
         ["with"
          (Tactic.rcasesPat.tuple
           "⟨"
        ...
        [])
       (group
        (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `e) "," (Tactic.rwRule [] `lt_ord)] "]") [])
        [])
       (group
        (Tactic.refine'
         "refine'"
           ...
           [(group
              ...
              (Term.haveDecl
               (Term.haveIdDecl
                ...
                [(Term.typeSpec
                  ":"
                  (Init.Core.«term_⊆_»
                   (Set.«term{_|_}» "{" `q "|" (Term.app `s [`q `p]) "}")
                   " ⊆ "
                   (Term.app
                    (Term.proj
                     (Term.app
                      `insert
                      [(Term.app `g [`p]) (Set.«term{_|_}» "{" `x "|" («term_<_» `x "<" (Term.app `g [`p])) "}")])
                     "."
                     `Prod)
                    [(Term.app
                      `insert
                   ...
                   [(group (Tactic.intro "intro" [`q `h]) [])
                     ...
                     (Tactic.simp
                      ...
                      ["["
                       [(Tactic.simpLemma [] [] `s)
                        ...
                        ","
                        (Tactic.simpLemma [] [] `Order.Preimage)
                        ","
                        (Tactic.simpLemma [] [] `typein_lt_typein)
                        ","
                        (Tactic.simpLemma [] [] `Prod.lex_def)
                        ","
                        (Tactic.simpLemma [] [] `typein_inj)]
                       "]"]
                    ...
                    (group
                     (Tactic.exact
                      "exact"
                      (Term.app
                       (Term.proj `max_le_iff "." (fieldIdx "1"))
                       [(«term_$__»
                         (Term.proj `le_iff_lt_or_eqₓ "." (fieldIdx "2"))
                         "$"
                         (Term.app `h.imp_right [`And.left]))]))
                     [])]))))))
             [])
            (group
             (Tactic.suffices'
              ...
              [(Term.typeSpec
                ...
                (Data.Equiv.Basic.«term_≃_»
                 (Term.paren
                  ...
                  [(Term.app
                    `insert
                    [(Term.app `g [`p]) (Set.«term{_|_}» "{" `x "|" (Term.app `r [`x (Term.app `g [`p])]) "}")])
                   [(Term.typeAscription ":" (Term.app `Set [`α]))]]
                  ")")
                 " ≃ "
                 (Term.app `Sum [(Set.«term{_|_}» "{" `x "|" (Term.app `r [`x (Term.app `g [`p])]) "}") `PUnit])))])
             [])
            (group
             (Tactic.«tactic·._»
              "·"
                ...
                [(group
                  (Tactic.exact
                   ...
                   (Term.anonymousCtor
                    "⟨"
                    [(Term.app
                      (Term.proj (Term.app `Set.embeddingOfSubset [(Term.hole "_") (Term.hole "_") `this]) "." `trans)
                      [(Term.proj
                        (Term.app
                         (Term.proj (Term.app `Equivₓ.Set.prod [(Term.hole "_") (Term.hole "_")]) "." `trans)
                         [(Term.app `H.prod_congr [`H])])
                        "."
                        `toEmbedding)])]
                    "⟩"))
                  [])])))
            ...
            (group
             (Tactic.refine'
              "refine'"
              (Term.app
               (Term.proj (Term.app `Equivₓ.Set.insert [(Term.hole "_")]) "." `trans)
               [(Term.app (Term.proj (Term.app `Equivₓ.refl [(Term.hole "_")]) "." `sumCongr) [`punit_equiv_punit])]))
             [])
            (group (Tactic.apply "apply" (Term.app (Term.explicit "@" `irrefl) [(Term.hole "_") `r])) [])])))
        [])
       (group
        (Tactic.cases'
         "cases'"
           ...
           (Term.app
            ...
            [(Term.app
              ...
              [(Term.proj
                ...
                "."
                `succ)])
             (Ordinal.SetTheory.Ordinal.termω "ω")]))]
         []
         ["with" [(Lean.binderIdent `qo) (Lean.binderIdent `qo)]])
        [])
       (group
        (Tactic.«tactic·._»
         "·"
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group (Tactic.exact "exact" (Term.app `lt_of_lt_of_leₓ [(Term.app `mul_lt_omega [`qo `qo]) `ol])) [])])))
        [])
       (group
        (Tactic.«tactic·._»
         "·"
            ...
            (group
             (Tactic.«tactic·._»
              ...
              (Tactic.tacticSeq
               (Tactic.tacticSeq1Indented
                [(group
                  (Tactic.exact "exact" (Term.app `lt_of_le_of_ltₓ [(Term.app `IH [(Term.hole "_") `this `qo]) `this]))
                  [])])))
             [])
            (group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `lt_ord)] "]") []) [])
            (group (Tactic.apply "apply" (Term.proj (Term.app `ord_is_limit [`ol]) "." (fieldIdx "2"))) [])
            (group
             (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `mk_def) "," (Tactic.rwRule [] `e)] "]") [])
             [])
            (group (Tactic.apply "apply" `typein_lt_type) [])])))
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.apply "apply" (Term.proj (Term.app `ord_is_limit [`ol]) "." (fieldIdx "2")))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.apply', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Term.app `ord_is_limit [`ol]) "." (fieldIdx "2"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `ord_is_limit [`ol])
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `ord_is_limit [`ol]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `lt_ord)] "]") [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `lt_ord
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `lt_of_le_of_ltₓ [(Term.app `IH [(Term.hole "_") `this `qo]) `this])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `IH [(Term.hole "_") `this `qo])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `IH [(Term.hole "_") `this `qo]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `lt_of_le_of_ltₓ
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `lt_of_lt_of_leₓ [(Term.app `mul_lt_omega [`qo `qo]) `ol]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `lt_of_lt_of_leₓ [(Term.app `mul_lt_omega [`qo `qo]) `ol])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `mul_lt_omega [`qo `qo]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `lt_of_lt_of_leₓ
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
  ...
  (Tactic.cases'
   ...
   [(Tactic.casesTarget
     ...
     (Term.app
      ...
      [(Term.app
        `card
        [(Term.proj (Term.app `typein [(«term_<_» (Term.cdot "·") "<" (Term.cdot "·")) (Term.app `g [`p])]) "." `succ)])
       (Ordinal.SetTheory.Ordinal.termω "ω")]))]
   []
   ["with" [(Lean.binderIdent `qo) (Lean.binderIdent `qo)]])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app
   ...
   [(Term.app
    ...
    (Ordinal.SetTheory.Ordinal.termω "ω")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Ordinal.SetTheory.Ordinal.termω', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Ordinal.SetTheory.Ordinal.termω', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Ordinal.SetTheory.Ordinal.termω', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Ordinal.SetTheory.Ordinal.termω', expected 'Lean.Parser.Term.ellipsis.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Ordinal.SetTheory.Ordinal.termω', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Ordinal.SetTheory.Ordinal.termω "ω")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Ordinal.SetTheory.Ordinal.termω', expected 'antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `g [`p]) []] ")")
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.apply "apply" (Term.app (Term.explicit "@" `irrefl) [(Term.hole "_") `r]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.apply', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.explicit "@" `irrefl) [(Term.hole "_") `r])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `Equivₓ.refl [(Term.hole "_")]) "." `sumCongr)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app
   (Term.proj (Term.paren "(" [(Term.app `Equivₓ.refl [(Term.hole "_")]) []] ")") "." `sumCongr)
   [`punit_equiv_punit])
  []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `Equivₓ.Set.insert [(Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Equivₓ.Set.insert [(Term.hole "_")]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `H.prod_congr [`H]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `Equivₓ.Set.prod [(Term.hole "_") (Term.hole "_")]) "." `trans)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `Equivₓ.Set.prod [(Term.hole "_") (Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app
   (Term.proj (Term.paren "(" [(Term.app `Equivₓ.Set.prod [(Term.hole "_") (Term.hole "_")]) []] ")") "." `trans)
   [(Term.paren "(" [(Term.app `H.prod_congr [`H]) []] ")")])
  []]
 ")")
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `Set.embeddingOfSubset [(Term.hole "_") (Term.hole "_") `this])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
  ...
  (Tactic.suffices'
   ...
   [(Term.typeSpec
     ...
     (Data.Equiv.Basic.«term_≃_»
      (Term.paren
       "("
       [(Term.app `insert [(Term.app `g [`p]) (Set.«term{_|_}» "{" `x "|" (Term.app `r [`x (Term.app `g [`p])]) "}")])
        [(Term.typeAscription ":" (Term.app `Set [`α]))]]
       ")")
      " ≃ "
      (Term.app `Sum [(Set.«term{_|_}» "{" `x "|" (Term.app `r [`x (Term.app `g [`p])]) "}") `PUnit])))])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Set.«term{_|_}» "{" `x "|" (Term.app `r [`x (Term.app `g [`p])]) "}")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Set.«term{_|_}»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `r [`x (Term.app `g [`p])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
    ...
    :=
      by
        refine' le_antisymmₓ _ by simpa only [ mul_oneₓ ] using mul_le_mul_left' one_lt_omega.le.trans h c
          ...
          ·
            have
                : { q | s q p } ⊆ insert g p { x | x < g p } . Prod insert g p { x | x < g p }
                  :=
                  by
                    intro q h
                      simp
...
theorem mk_compl_finset_of_infinite {α : Type _} [Infinite α] (s : Finset α) : # ((↑s)ᶜ : Set α) = # α := by
...
theorem not_injective_of_ordinal {α : Type u} (f : Ordinal.{u} → α) : ¬Function.Injective f := by
  let g : Ordinal.{u} → Ulift.{u + 1} α := fun o => Ulift.up (f o)
  suffices ¬Function.Injective g by
    intro hf
...
theorem not_injective_of_ordinal_of_small {α : Type v} [Small.{u} α] (f : Ordinal.{u} → α) : ¬Function.Injective f := by
  intro hf
