...
variable(K :
    Type u)(V : Type v)[DivisionRing K][AddCommGroupₓ V][Module K V]{V₂ : Type v'}[AddCommGroupₓ V₂][Module K V₂]
...
variable{K : Type u}{V : Type v}[Field K][AddCommGroupₓ V][Module K V]{V₂ : Type v'}[AddCommGroupₓ V₂][Module K V₂]
