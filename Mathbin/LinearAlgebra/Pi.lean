   ...
   [(Term.explicitBinder
     ...
     [":"
      (Term.forall
       ...
       [(Term.simpleBinder [`i] [])]
       ","
       (Algebra.Module.LinearMap.«term_→ₗ[_]_» `M₂ " →ₗ[" `R "] " (Term.app `φ [`i])))]
     []
     ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app `ker [(Term.app `pi [`f])])
     "="
     (Order.CompleteLattice.«term⨅_,_»
      "⨅"
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] [":" `ι]))
      ", "
      (Term.app `ker [(Term.app `f [`i])])))))
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.«tactic_<;>_»
         ...
         "<;>"
         (Tactic.«tactic_<;>_»
          (Tactic.simp "simp" [] [] ["[" [(Tactic.simpLemma [] [] `funext_iff)] "]"] [])
          "<;>"
            ...
            (Tactic.exact
             ...
             (Term.app
              ...
              [(«term_$__»
                `funext
                "$"
                (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`i] [])] "=>" (Term.app `h [`i]))))]))
            [])])))))))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact
   ...
   (Term.app
    (Term.proj (Term.app `mem_bot [(Term.hole "_")]) "." (fieldIdx "2"))
    [(«term_$__» `funext "$" (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`i] [])] "=>" (Term.app `h [`i]))))]))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.simp
   ...
   ["only"]
   ["["
    [(Tactic.simpLemma [] [] `mem_infi) "," (Tactic.simpLemma [] [] `mem_ker) "," (Tactic.simpLemma [] [] `proj_apply)]
    "]"]
   [(Tactic.location "at" (Tactic.locationHyp [`h] []))])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simp', expected 'antiquot'
...
theorem
  infi_ker_proj
  : ( ⨅ i , ker proj i : Submodule R ∀ i , φ i ) = ⊥
  :=
    bot_unique
      $
      SetLike.le_def . 2
        $
        fun a h => by simp only [ mem_infi , mem_ker , proj_apply ] at h exact mem_bot _ . 2 funext $ fun i => h i
 ...
 (Command.def
  ...
  (Command.optDeclSig
   [(Term.simpleBinder [`S] [])
    ...
    (Term.instBinder "[" [] (Term.app `Semiringₓ [`S]) "]")
    (Term.instBinder "[" [] (Term.app `Module [`S `M]) "]")
    (Term.instBinder "[" [] (Term.app `SmulCommClass [`R `S `M]) "]")]
   [(Term.typeSpec
     ":"
     (Data.Equiv.Module.«term_≃ₗ[_]_»
      (Term.forall
       ...
       [(Term.simpleBinder [`i] [])]
       ","
       (Algebra.Module.LinearMap.«term_→ₗ[_]_» (Term.app `φ [`i]) " →ₗ[" `R "] " `M))
      " ≃ₗ["
      `S
      "] "
       ...
       (Term.fun
        ...
        (Term.basicFun
         ...
         (Algebra.BigOperators.Basic.«term∑_,_»
          ...
          (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] [":" `ι]))
          ", "
          (Term.app (Term.proj (Term.app `f [`i]) "." `comp) [(Term.app `proj [`i])])))))
      [","])
     (group
      (Term.structInstField
       ...
       (Term.fun
        "fun"
        (Term.basicFun [(Term.simpleBinder [`f `i] [])] "=>" (Term.app `f.comp [(Term.app `single [`i])]))))
      [","])
     (group
      (Term.structInstField
       ...
       (Term.fun
        ...
        (Term.basicFun
         ...
         (Term.byTactic
          ...
          (Tactic.tacticSeq
           (Tactic.tacticSeq1Indented
            [(group (Tactic.ext "ext" [(Tactic.rcasesPat.one `i) (Tactic.rcasesPat.one `x)] []) [])
             (group (Tactic.simp "simp" [] [] ["[" [(Tactic.simpLemma [] [] `apply_single)] "]"] []) [])]))))))
      [","])
     (group
      (Term.structInstField
                ...
                («term_=_»
                 (Term.app
                  ...
                  [(Algebra.BigOperators.Basic.«term∑_,_»
                    ...
                    ", "
                    (Term.app `Pi.single [`j (Term.app `x [`j])]))])
                 "="
                 (Term.app `f [`x]))
                (Term.byTactic
                 "by"
                 (Tactic.tacticSeq
                  (Tactic.tacticSeq1Indented
                   [(group
                     (Tactic.simpa "simpa" [] [] ["[" [(Tactic.simpLemma [] [] `apply_single)] "]"] [] [])
                     [])])))))
              [])
             (group
              (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Finset.univ_sum_single)] "]") [])
              [])]))))))
      [])]
    (Term.optEllipsis [])
    []
         ...
         (Tactic.tacticSuffices_
          ...
          (Term.sufficesDecl
           ...
           (Term.byTactic
            ...
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(group (Tactic.simpa "simpa" [] [] ["[" [(Tactic.simpLemma [] [] `apply_single)] "]"] [] []) [])])))))
         [])
        (group
         (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Finset.univ_sum_single)] "]") [])
         [])])))))
         ...
         (Term.byTactic
          ...
          (Tactic.tacticSeq
           (Tactic.tacticSeq1Indented
            [(group (Tactic.simpa "simpa" [] [] ["[" [(Tactic.simpLemma [] [] `apply_single)] "]"] [] []) [])])))))
       [])
      (group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Finset.univ_sum_single)] "]") []) [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.byTactic', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.byTactic', expected 'Lean.Parser.Term.byTactic.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq', expected 'Lean.Parser.Tactic.tacticSeq.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq1Indented', expected 'Lean.Parser.Tactic.tacticSeqBracketed.antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `x [`j]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
/--
  ...
  def
    ...
    S
        ...
        [ Module S M ]
        [ SmulCommClass R S M ]
      : ∀ i , φ i →ₗ[ R ] M ≃ₗ[ S ] ∀ i , φ i →ₗ[ R ] M
    :=
      {
        toFun := fun f => ∑ i : ι , f i . comp proj i ,
          invFun := fun f i => f.comp single i ,
          map_add' := fun f g => by simp only [ Pi.add_apply , add_comp , Finset.sum_add_distrib ] ,
          map_smul' := fun c f => by simp only [ Pi.smul_apply , smul_comp , Finset.smul_sum , RingHom.id_apply ] ,
          left_inv := fun f => by ext i x simp [ apply_single ] ,
          right_inv
            :=
            fun
              f => by ext suffices f ∑ j , Pi.single j x j = f x by simpa [ apply_single ] rw [ Finset.univ_sum_single ]
        }
          ...
          [(«term_$__»
            ...
            (Term.fun
             ...
             (Term.basicFun
              ...
              "=>"
              (Term.app
               (Term.proj (Term.app `proj [(Term.paren "(" [`i [(Term.typeAscription ":" `ι)]] ")")]) "." `comp)
               [(Term.app `Submodule.subtype [(Term.hole "_")])]))))
           (Term.app
            `cod_restrict
            [(Term.hole "_")
             («term_$__»
              ...
              (Term.fun
               ...
               (Term.basicFun
                ...
                (termDepIfThenElse
                 ...
                 (Term.app
                  `proj
                  [(Term.paren "(" [(Term.anonymousCtor "⟨" [`i "," `h] "⟩") [(Term.typeAscription ":" `I)]] ")")])
                 "else"
                 (numLit "0")))))
             (Term.hole "_")])
           (Term.hole "_")
             ...
             (Tactic.simp
              ...
              ["["
               [(Tactic.simpLemma [] [] `mem_infi)
                ...
                (Tactic.simpLemma [] [] `proj_apply)
                ","
                (Tactic.simpLemma [] [] `pi_apply)]
               "]"]
              [])
             [])
            (group (Tactic.intro "intro" [`j `hjJ]) [])
            (group
             (Tactic.tacticHave_
              "have"
              (Term.haveDecl
               (Term.haveIdDecl
                []
                [(Term.typeSpec ":" (Init.Core.«term_∉_» `j " ∉ " `I))]
                ":="
                (Term.fun
                 "fun"
                 (Term.basicFun
                  [(Term.simpleBinder [`hjI] [])]
                  "=>"
                  (Term.app `hd [(Term.anonymousCtor "⟨" [`hjI "," `hjJ] "⟩")]))))))
             [])
            (group
             (Tactic.rwSeq
              "rw"
              ...
              (Tactic.rwRuleSeq
               "["
               [(Tactic.rwRule [] (Term.app `dif_neg [`this])) "," (Tactic.rwRule [] `zero_apply)]
               "]")
              [])
             [])])))
        [])
          ...
          (Tactic.tacticSeq1Indented
           [(group
             (Tactic.simp
              ...
              ["only"]
              ["["
               [(Tactic.simpLemma [] [] `pi_comp)
                ","
                (Tactic.simpLemma [] [] `comp_assoc)
                ","
                (Tactic.simpLemma [] [] `subtype_comp_cod_restrict)
                ","
                (Tactic.simpLemma [] [] `proj_pi)
                ","
                (Tactic.simpLemma [] [] `Subtype.coe_prop)]
               "]"]
              [])
             [])
            (group
             ...
             (Tactic.simp
              ...
              ["["
               [(Tactic.simpLemma [] [] `dif_pos)
                ...
                ","
                (Tactic.simpLemma [] [] `Function.eval_apply)
                ","
                (Tactic.simpLemma [] [] `LinearMap.cod_restrict_apply)
                ","
                (Tactic.simpLemma [] [] `LinearMap.coe_comp)
                ","
                (Tactic.simpLemma [] [] `LinearMap.coe_proj)
                ","
                (Tactic.simpLemma [] [] `LinearMap.pi_apply)
                ","
           ...
           [(group
             (Tactic.ext1
              ...
              [(Tactic.rcasesPat.tuple
                ...
                "⟩")])
             [])
            (group (Tactic.apply "apply" `Subtype.ext) [])
                ...
                [(Term.typeSpec
                  ...
                  (Term.forall
                   ...
                   (Mathlib.ExtendedBinder.«term∀___,_»
                    ...
                    («binderTerm∈_» "∈" `J)
                    ","
                    (Term.forall "∀" [] "," («term_=_» (Term.app `b [`i]) "=" (numLit "0"))))))]
                ":="
                (Term.byTactic
                 "by"
                 (Tactic.tacticSeq
                   ...
                   [(group
                     (Tactic.simpa
                      ...
                      ["["
                       ...
                       "]"]
                      []
                      ["using" (Term.app (Term.proj (Term.app `mem_infi [(Term.hole "_")]) "." (fieldIdx "1")) [`hb])])
                     [])]))))))
             [])
            (group
             (Tactic.simp
              ...
              ["["
               [(Tactic.simpLemma [] [] `comp_apply)
                ...
                (Tactic.simpLemma [] [] `proj_apply)
                ","
                (Tactic.simpLemma [] [] `subtype_apply)
                ","
                (Tactic.simpLemma [] [] `cod_restrict_apply)]
               "]"]
              [])
             [])
                  ...
                  (Tactic.exact
                   ...
                   (Term.proj
                    («term_$__»
                     ...
                     "$"
                     (Term.app (Term.proj (Term.app `hu [`trivialₓ]) "." `resolve_left) [`h]))
                    "."
                    `symm))
                  [])])))
             [])])))
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(«term_$__»
   (Term.app `hb [(Term.hole "_")])
   "$"
   (Term.app (Term.proj (Term.paren "(" [(Term.app `hu [`trivialₓ]) []] ")") "." `resolve_left) [`h]))
  []]
 ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.proj (Term.app `mem_infi [(Term.hole "_")]) "." (fieldIdx "1")) [`hb])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.apply "apply" `Subtype.ext)
     ...
     [(group (Tactic.intro "intro" [`b]) [])
      ...
      (group
       (Tactic.rwSeq
        "rw"
        []
        (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] (Term.app `dif_neg [`this])) "," (Tactic.rwRule [] `zero_apply)] "]")
        [])
       [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.«tactic·._»', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq', expected 'Lean.Parser.Tactic.tacticSeq.antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.fun
   "fun"
   (Term.basicFun [(Term.simpleBinder [`hjI] [])] "=>" (Term.app `hd [(Term.anonymousCtor "⟨" [`hjI "," `hjJ] "⟩")])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.fun.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.basicFun.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
   ...
   (Term.fun
    ...
    (Term.basicFun
     ...
     (termDepIfThenElse
      ...
      (Init.Core.«term_∈_» `i " ∈ " `I)
      "then"
      (Term.app `proj [(Term.paren "(" [(Term.anonymousCtor "⟨" [`i "," `h] "⟩") [(Term.typeAscription ":" `I)]] ")")])
      "else"
      (numLit "0")))))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Submodule.subtype [(Term.hole "_")]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `proj [(Term.paren "(" [`i [(Term.typeAscription ":" `ι)]] ")")]) "." `comp)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `proj [(Term.paren "(" [`i [(Term.typeAscription ":" `ι)]] ")")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.paren', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.paren', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.paren', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.paren', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.paren "(" [`i [(Term.typeAscription ":" `ι)]] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.paren', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.paren', expected 'Lean.Parser.Term.paren.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'null', expected 'optional.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeAscription', expected 'optional.antiquot_scope'
 ...
 [(«term_$__»
   ...
   (Term.fun
    ...
    (Term.basicFun
     ...
     (Term.app
      (Term.proj
       (Term.paren "(" [(Term.app `proj [(Term.paren "(" [`i [(Term.typeAscription ":" `ι)]] ")")]) []] ")")
       "."
       `comp)
      [(Term.paren "(" [(Term.app `Submodule.subtype [(Term.hole "_")]) []] ")")]))))
  []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `LinearEquiv.ofLinear
  ...
  def
    ...
    :=
      by
        refine'
            LinearEquiv.ofLinear
              pi $ fun i => proj ( i : ι ) . comp Submodule.subtype _
                cod_restrict _ pi $ fun i => if h : i ∈ I then proj ( ⟨ i , h ⟩ : I ) else 0 _
                _
                _
          ·
            intro b
            ...
            ext1 ⟨ b , hb ⟩
              ...
              have
                hb
                  : ∀ , ∀ i ∈ J , ∀ , b i = 0
                  :=
                  by simpa only [ mem_infi , mem_ker , proj_apply ] using mem_infi _ . 1 hb
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `binfi_comap_proj [])
  (Command.declSig
   []
   (Term.typeSpec
    ":"
    («term_=_»
     (Order.CompleteLattice.«term⨅_,_»
      ...
      ", "
      (Term.app `comap [(Term.app `proj [`i]) (Term.app `p [`i])]))
     "="
     (Term.app `pi [`I `p]))))
  (Command.declValSimple
   ":="
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
theorem binfi_comap_proj : ⨅ ( i : _ ) ( _ : i ∈ I ) , comap proj i p i = pi I p := by ext x simp
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `infi_comap_proj [])
  (Command.declSig
   []
   (Term.typeSpec
    ":"
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
theorem infi_comap_proj : ⨅ i , comap proj i p i = pi Set.Univ p := by ext x simp
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `supr_map_single [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `DecidableEq [`ι]) "]") (Term.instBinder "[" [] (Term.app `Fintype [`ι]) "]")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Order.CompleteLattice.«term⨆_,_»
      ...
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
      ", "
      (Term.app `map [(Term.app `LinearMap.single [`i]) (Term.app `p [`i])]))
     "="
     (Term.app `pi [`Set.Univ `p]))))
  (Command.declValSimple
   ":="
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.refine'
         ...
         (Term.app
          (Term.proj
           («term_$__» `supr_le "$" (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`i] [])] "=>" (Term.hole "_"))))
           "."
           `antisymm)
          [(Term.hole "_")]))
        [])
           ...
           [(group
               ...
               (Tactic.rintroPat.one
                (Tactic.rcasesPat.tuple
                 ...
                 [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `x)]) [])
                  ","
                  (Tactic.rcasesPatLo
                   (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `hx)])
            ...
            (group
             (Tactic.«tactic_<;>_»
              (Tactic.rcases
               "rcases"
               [(Tactic.casesTarget [] (Term.app `em [(«term_=_» `j "=" `i)]))]
               ["with"
           ...
           [(group (Tactic.intro "intro" [`x `hx]) [])
            (group
             (Tactic.rwSeq
              "rw"
              []
              (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] (Term.app `Finset.univ_sum_single [`x]))] "]")
              [])
             [])
            (group
             (Tactic.exact
              ...
              (Term.app
               ...
               [(Term.fun
                 ...
                 (Term.basicFun
                  [(Term.simpleBinder [`i] [])]
                  "=>"
                  (Term.app `mem_map_of_mem [(Term.app `hx [`i `trivialₓ])])))]))
             [])])))
        [])])))
   [])
  []
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact
   ...
   (Term.app
    ...
    [(Term.fun
      "fun"
      (Term.basicFun [(Term.simpleBinder [`i] [])] "=>" (Term.app `mem_map_of_mem [(Term.app `hx [`i `trivialₓ])])))]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app
   `sum_mem_supr
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `hx [`i `trivialₓ]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `mem_map_of_mem
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] (Term.app `Finset.univ_sum_single [`x]))] "]") [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Finset.univ_sum_single [`x])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
       ...
       (Tactic.«tactic_<;>_»
        (Tactic.rcases
         ...
         ["with"
          (Tactic.rcasesPat.paren
           "("
           (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `rfl) "|" (Tactic.rcasesPat.one `hj)]) [])
           ")")])
        "<;>"
        (Tactic.simp "simp" [] [] [] []))
       [])])))
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `LinearMap.single [`i]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `map
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
theorem
  supr_map_single
  [ DecidableEq ι ] [ Fintype ι ] : ⨆ i , map LinearMap.single i p i = pi Set.Univ p
  :=
    by
      refine' supr_le $ fun i => _ . antisymm _
        · rintro _ ⟨ x , hx : x ∈ p i , rfl ⟩ j - rcases em j = i with ( rfl | hj ) <;> simp
        · intro x hx rw [ ← Finset.univ_sum_single x ] exact sum_mem_supr fun i => mem_map_of_mem hx i trivialₓ
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `pi_ring_symm_apply [])
  (Command.declSig
   [(Term.explicitBinder "(" [`f] [":" (Term.arrow `ι "→" `M)] [] ")")
    (Term.explicitBinder "(" [`g] [":" (Term.arrow `ι "→" `R)] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app (Term.proj (Term.app `pi_ring [`R `M `ι `S]) "." `symm) [`f `g])
     "="
     (Algebra.BigOperators.Basic.«term∑_,_»
      "∑"
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
      ", "
      (Algebra.Group.Defs.«term_•_» (Term.app `g [`i]) " • " (Term.app `f [`i]))))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.simp
         ...
         []
         []
         ["[" [(Tactic.simpLemma [] [] `pi_ring) "," (Tactic.simpLemma [] [] `LinearMap.lsum)] "]"]
         [])
        [])])))
   [])
  []
...
@[ simp ]
  theorem
    pi_ring_symm_apply
    ( f : ι → M ) ( g : ι → R ) : pi_ring R M ι S . symm f g = ∑ i , g i • f i
