...
theorem graded_algebra.ι_sq_zero (m : M) : GradedAlgebra.ι R M m * GradedAlgebra.ι R M m = 0 := by
...
instance GradedAlgebra :
  ...
  GradedAlgebra.ofAlgHom _ (lift _ <| ⟨GradedAlgebra.ι R M, GradedAlgebra.ι_sq_zero R M⟩)
    ...
    apply Submodule.pow_induction_on' _ (fun r => _) (fun x y i hx hy ihx ihy => _) (fun m hm i x hx ih => _) hx
