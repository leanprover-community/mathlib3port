...
theorem mv_polynomial_X_map_matrix_eval [Fintype m] [DecidableEq m] [CommSemiring R]
    (A : Matrix m m R) :
...
theorem mv_polynomial_X_map_matrix_aeval [Fintype m] [DecidableEq m] [CommSemiring R]
    [CommSemiring S] [Algebra R S] (A : Matrix m m S) :
...
#align matrix.det_mv_polynomial_X_ne_zero Matrix.det_mv_polynomial_X_ne_zero
