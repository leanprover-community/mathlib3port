...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers [(Command.docComment "/--" "\nThe trace of a square matrix.\n-/")] [] [] [] [] [])
 (Command.def
  "def"
  (Command.declId `trace [])
  (Command.optDeclSig
   [(Term.instBinder "[" [] (Term.app `Fintype [`n]) "]")]
   [(Term.typeSpec ":" (Algebra.Module.LinearMap.«term_→ₗ[_]_» (Term.app `Matrix [`n `n `M]) " →ₗ[" `R "] " `M))])
       ...
       (Term.byTactic
        ...
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(group (Tactic.intros "intros" []) []) (group (Tactic.apply "apply" `Finset.sum_add_distrib) [])]))))
      [","])
     (group
      (Term.structInstField
        ...
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(group (Tactic.intros "intros" []) [])
           (group (Tactic.simp "simp" [] [] ["[" [(Tactic.simpLemma [] [] `Finset.smul_sum)] "]"] []) [])]))))
      [])]
    (Term.optEllipsis [])
    []
    "}")
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.simp "simp" [] [] ["[" [(Tactic.simpLemma [] [] `Finset.smul_sum)] "]"] [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.apply "apply" `Finset.sum_add_distrib)
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `trace_diag [])
  (Command.declSig
   [(Term.explicitBinder "(" [`A] [":" (Term.app `Matrix [`n `n `M])] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app `trace [`n `R `M `A])
     "="
     (Algebra.BigOperators.Basic.«term∑_,_»
      "∑"
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
...
@[ simp ] theorem trace_diag ( A : Matrix n n M ) : trace n R M A = ∑ i , diag n R M A i := rfl
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
theorem trace_apply ( A : Matrix n n M ) : trace n R M A = ∑ i , A i i := rfl
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `trace_one [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `DecidableEq [`n]) "]")]
   (Term.typeSpec ":" («term_=_» (Term.app `trace [`n `R `R (numLit "1")]) "=" (Term.app `Fintype.card [`n]))))
  (Command.declValSimple
   ":="
   (Term.have
    "have"
    (Term.haveDecl
     (Term.haveIdDecl
      ...
      [(Term.typeSpec
        ":"
        («term_=_»
         (Term.app `trace [`n `R `R (numLit "1")])
         "="
         (Algebra.BigOperators.Basic.«term∑_,_»
          "∑"
          (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
          ", "
          (Term.app `diag [`n `R `R (numLit "1") `i]))))]
      ":="
      `rfl))
    []
    (Term.byTactic
         ...
         (Tactic.«tactic_<;>_»
          (Tactic.simpRw
           ...
           (Tactic.rwRuleSeq
            ...
            [(Tactic.rwRule [] `h)
             ","
             (Tactic.rwRule [] `diag_one)
             ","
             (Tactic.rwRule [] `Finset.sum_const)
             ","
             (Tactic.rwRule [] `nsmul_one)]
            "]")
           [])
          "<;>"
...
@[ simp ]
  theorem
    trace_one
    [ DecidableEq n ] : trace n R R 1 = Fintype.card n
    :=
      have
        h : trace n R R 1 = ∑ i , diag n R R 1 i := rfl
        by simp_rw [ h , diag_one , Finset.sum_const , nsmul_one ] <;> rfl
