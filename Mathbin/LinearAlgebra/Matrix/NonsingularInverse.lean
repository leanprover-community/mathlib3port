...
theorem det_from_blocks₁₁ (A : Matrix m m α) (B : Matrix m n α) (C : Matrix n m α)
  ...
  rw [this, det_mul, det_mul, det_fromBlocks_zero₂₁, det_fromBlocks_zero₂₁, det_fromBlocks_zero₁₂,
    det_one, det_one, one_mul, one_mul, mul_one]
...
theorem det_from_blocks₂₂ (A : Matrix m m α) (B : Matrix m n α) (C : Matrix n m α)
  ...
  by
  have : fromBlocks A B C D = (fromBlocks D C B A).submatrix (sum_comm _ _) (sum_comm _ _) :=
    by
    ext (i j)
    cases i <;> cases j <;> rfl
