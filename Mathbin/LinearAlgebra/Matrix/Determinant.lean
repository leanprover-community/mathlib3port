...
but is expected to have type
  forall {n : Type.{u1}} [_inst_1 : DecidableEq.{succ u1} n] [_inst_2 : Fintype.{u1} n] {R : Type.{u2}} [_inst_5 : CommRing.{u2} R], Eq.{succ u2} R (Matrix.det.{u2, u1} n (fun (a : n) (b : n) => _inst_1 a b) _inst_2 R _inst_5 (OfNat.ofNat.{max u2 u1} (Matrix.{u1, u1, u2} n n R) 1 (One.toOfNat1.{max u2 u1} (Matrix.{u1, u1, u2} n n R) (Matrix.one.{u2, u1} n R (fun (a : n) (b : n) => _inst_1 a b) (CommMonoidWithZero.toZero.{u2} R (CommSemiring.toCommMonoidWithZero.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5))) (Semiring.toOne.{u2} R (CommSemiring.toSemiring.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5))))))) (OfNat.ofNat.{u2} R 1 (One.toOfNat1.{u2} R (Semiring.toOne.{u2} R (CommSemiring.toSemiring.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5)))))
...
but is expected to have type
  forall {n : Type.{u1}} [_inst_1 : DecidableEq.{succ u1} n] [_inst_2 : Fintype.{u1} n] {R : Type.{u2}} [_inst_5 : CommRing.{u2} R] [_inst_6 : IsEmpty.{succ u1} n] {A : Matrix.{u1, u1, u2} n n R}, Eq.{succ u2} R (Matrix.det.{u2, u1} n (fun (a : n) (b : n) => _inst_1 a b) _inst_2 R _inst_5 A) (OfNat.ofNat.{u2} R 1 (One.toOfNat1.{u2} R (Semiring.toOne.{u2} R (CommSemiring.toSemiring.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5)))))
...
but is expected to have type
  forall {n : Type.{u1}} [_inst_1 : DecidableEq.{succ u1} n] [_inst_2 : Fintype.{u1} n] {R : Type.{u2}} [_inst_5 : CommRing.{u2} R] {A : Matrix.{u1, u1, u2} n n R}, (Eq.{1} Nat (Fintype.card.{u1} n _inst_2) (OfNat.ofNat.{0} Nat 0 (instOfNatNat 0))) -> (Eq.{succ u2} R (Matrix.det.{u2, u1} n (fun (a : n) (b : n) => _inst_1 a b) _inst_2 R _inst_5 A) (OfNat.ofNat.{u2} R 1 (One.toOfNat1.{u2} R (Semiring.toOne.{u2} R (CommSemiring.toSemiring.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5))))))
...
but is expected to have type
  forall {n : Type.{u1}} [_inst_1 : DecidableEq.{succ u1} n] [_inst_2 : Fintype.{u1} n] {R : Type.{u2}} [_inst_5 : CommRing.{u2} R], Eq.{max (succ u2) (succ u1)} (forall (a : Matrix.{u1, u1, u2} n n R), (fun (x._@.Mathlib.Algebra.Hom.Group._hyg.2397 : Matrix.{u1, u1, u2} n n R) => R) a) (FunLike.coe.{max (succ u1) (succ u2), max (succ u1) (succ u2), succ u2} (MonoidHom.{max u2 u1, u2} (Matrix.{u1, u1, u2} n n R) R (MulZeroOneClass.toMulOneClass.{max u2 u1} (Matrix.{u1, u1, u2} n n R) (NonAssocSemiring.toMulZeroOneClass.{max u2 u1} (Matrix.{u1, u1, u2} n n R) (Matrix.nonAssocSemiring.{u2, u1} n R (Semiring.toNonAssocSemiring.{u2} R (CommSemiring.toSemiring.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5))) _inst_2 (fun (a : n) (b : n) => _inst_1 a b)))) (MulZeroOneClass.toMulOneClass.{u2} R (NonAssocSemiring.toMulZeroOneClass.{u2} R (Semiring.toNonAssocSemiring.{u2} R (CommSemiring.toSemiring.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5)))))) (Matrix.{u1, u1, u2} n n R) (fun (_x : Matrix.{u1, u1, u2} n n R) => (fun (x._@.Mathlib.Algebra.Hom.Group._hyg.2397 : Matrix.{u1, u1, u2} n n R) => R) _x) (MulHomClass.toFunLike.{max u1 u2, max u1 u2, u2} (MonoidHom.{max u2 u1, u2} (Matrix.{u1, u1, u2} n n R) R (MulZeroOneClass.toMulOneClass.{max u2 u1} (Matrix.{u1, u1, u2} n n R) (NonAssocSemiring.toMulZeroOneClass.{max u2 u1} (Matrix.{u1, u1, u2} n n R) (Matrix.nonAssocSemiring.{u2, u1} n R (Semiring.toNonAssocSemiring.{u2} R (CommSemiring.toSemiring.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5))) _inst_2 (fun (a : n) (b : n) => _inst_1 a b)))) (MulZeroOneClass.toMulOneClass.{u2} R (NonAssocSemiring.toMulZeroOneClass.{u2} R (Semiring.toNonAssocSemiring.{u2} R (CommSemiring.toSemiring.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5)))))) (Matrix.{u1, u1, u2} n n R) R (MulOneClass.toMul.{max u1 u2} (Matrix.{u1, u1, u2} n n R) (MulZeroOneClass.toMulOneClass.{max u2 u1} (Matrix.{u1, u1, u2} n n R) (NonAssocSemiring.toMulZeroOneClass.{max u2 u1} (Matrix.{u1, u1, u2} n n R) (Matrix.nonAssocSemiring.{u2, u1} n R (Semiring.toNonAssocSemiring.{u2} R (CommSemiring.toSemiring.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5))) _inst_2 (fun (a : n) (b : n) => _inst_1 a b))))) (MulOneClass.toMul.{u2} R (MulZeroOneClass.toMulOneClass.{u2} R (NonAssocSemiring.toMulZeroOneClass.{u2} R (Semiring.toNonAssocSemiring.{u2} R (CommSemiring.toSemiring.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5)))))) (MonoidHomClass.toMulHomClass.{max u1 u2, max u1 u2, u2} (MonoidHom.{max u2 u1, u2} (Matrix.{u1, u1, u2} n n R) R (MulZeroOneClass.toMulOneClass.{max u2 u1} (Matrix.{u1, u1, u2} n n R) (NonAssocSemiring.toMulZeroOneClass.{max u2 u1} (Matrix.{u1, u1, u2} n n R) (Matrix.nonAssocSemiring.{u2, u1} n R (Semiring.toNonAssocSemiring.{u2} R (CommSemiring.toSemiring.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5))) _inst_2 (fun (a : n) (b : n) => _inst_1 a b)))) (MulZeroOneClass.toMulOneClass.{u2} R (NonAssocSemiring.toMulZeroOneClass.{u2} R (Semiring.toNonAssocSemiring.{u2} R (CommSemiring.toSemiring.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5)))))) (Matrix.{u1, u1, u2} n n R) R (MulZeroOneClass.toMulOneClass.{max u2 u1} (Matrix.{u1, u1, u2} n n R) (NonAssocSemiring.toMulZeroOneClass.{max u2 u1} (Matrix.{u1, u1, u2} n n R) (Matrix.nonAssocSemiring.{u2, u1} n R (Semiring.toNonAssocSemiring.{u2} R (CommSemiring.toSemiring.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5))) _inst_2 (fun (a : n) (b : n) => _inst_1 a b)))) (MulZeroOneClass.toMulOneClass.{u2} R (NonAssocSemiring.toMulZeroOneClass.{u2} R (Semiring.toNonAssocSemiring.{u2} R (CommSemiring.toSemiring.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5))))) (MonoidHom.monoidHomClass.{max u1 u2, u2} (Matrix.{u1, u1, u2} n n R) R (MulZeroOneClass.toMulOneClass.{max u2 u1} (Matrix.{u1, u1, u2} n n R) (NonAssocSemiring.toMulZeroOneClass.{max u2 u1} (Matrix.{u1, u1, u2} n n R) (Matrix.nonAssocSemiring.{u2, u1} n R (Semiring.toNonAssocSemiring.{u2} R (CommSemiring.toSemiring.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5))) _inst_2 (fun (a : n) (b : n) => _inst_1 a b)))) (MulZeroOneClass.toMulOneClass.{u2} R (NonAssocSemiring.toMulZeroOneClass.{u2} R (Semiring.toNonAssocSemiring.{u2} R (CommSemiring.toSemiring.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5)))))))) (Matrix.detMonoidHom.{u2, u1} n (fun (a : n) (b : n) => _inst_1 a b) _inst_2 R _inst_5)) (Matrix.det.{u2, u1} n (fun (a : n) (b : n) => _inst_1 a b) _inst_2 R _inst_5)
...
but is expected to have type
  forall {m : Type.{u1}} [_inst_3 : DecidableEq.{succ u1} m] [_inst_4 : Fintype.{u1} m] {R : Type.{u2}} [_inst_5 : CommRing.{u2} R] (M : Units.{max u2 u1} (Matrix.{u1, u1, u2} m m R) (MonoidWithZero.toMonoid.{max u2 u1} (Matrix.{u1, u1, u2} m m R) (Semiring.toMonoidWithZero.{max u2 u1} (Matrix.{u1, u1, u2} m m R) (Matrix.semiring.{u2, u1} m R (CommSemiring.toSemiring.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5)) _inst_4 (fun (a : m) (b : m) => _inst_3 a b))))) (N : Matrix.{u1, u1, u2} m m R), Eq.{succ u2} R (Matrix.det.{u2, u1} m (fun (a : m) (b : m) => _inst_3 a b) _inst_4 R _inst_5 (Matrix.mul.{u2, u1, u1, u1} m m m R _inst_4 (NonUnitalNonAssocRing.toMul.{u2} R (NonAssocRing.toNonUnitalNonAssocRing.{u2} R (Ring.toNonAssocRing.{u2} R (CommRing.toRing.{u2} R _inst_5)))) (NonUnitalNonAssocSemiring.toAddCommMonoid.{u2} R (NonUnitalNonAssocRing.toNonUnitalNonAssocSemiring.{u2} R (NonAssocRing.toNonUnitalNonAssocRing.{u2} R (Ring.toNonAssocRing.{u2} R (CommRing.toRing.{u2} R _inst_5))))) (Matrix.mul.{u2, u1, u1, u1} m m m R _inst_4 (NonUnitalNonAssocRing.toMul.{u2} R (NonAssocRing.toNonUnitalNonAssocRing.{u2} R (Ring.toNonAssocRing.{u2} R (CommRing.toRing.{u2} R _inst_5)))) (NonUnitalNonAssocSemiring.toAddCommMonoid.{u2} R (NonUnitalNonAssocRing.toNonUnitalNonAssocSemiring.{u2} R (NonAssocRing.toNonUnitalNonAssocRing.{u2} R (Ring.toNonAssocRing.{u2} R (CommRing.toRing.{u2} R _inst_5))))) (Units.val.{max u2 u1} (Matrix.{u1, u1, u2} m m R) (MonoidWithZero.toMonoid.{max u2 u1} (Matrix.{u1, u1, u2} m m R) (Semiring.toMonoidWithZero.{max u2 u1} (Matrix.{u1, u1, u2} m m R) (Matrix.semiring.{u2, u1} m R (CommSemiring.toSemiring.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5)) _inst_4 (fun (a : m) (b : m) => _inst_3 a b)))) M) N) (Units.val.{max u2 u1} (Matrix.{u1, u1, u2} m m R) (MonoidWithZero.toMonoid.{max u2 u1} (Matrix.{u1, u1, u2} m m R) (Semiring.toMonoidWithZero.{max u2 u1} (Matrix.{u1, u1, u2} m m R) (Matrix.semiring.{u2, u1} m R (CommSemiring.toSemiring.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5)) _inst_4 (fun (a : m) (b : m) => _inst_3 a b)))) (Inv.inv.{max u2 u1} (Units.{max u2 u1} (Matrix.{u1, u1, u2} m m R) (MonoidWithZero.toMonoid.{max u2 u1} (Matrix.{u1, u1, u2} m m R) (Semiring.toMonoidWithZero.{max u2 u1} (Matrix.{u1, u1, u2} m m R) (Matrix.semiring.{u2, u1} m R (CommSemiring.toSemiring.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5)) _inst_4 (fun (a : m) (b : m) => _inst_3 a b))))) (Units.instInv.{max u2 u1} (Matrix.{u1, u1, u2} m m R) (MonoidWithZero.toMonoid.{max u2 u1} (Matrix.{u1, u1, u2} m m R) (Semiring.toMonoidWithZero.{max u2 u1} (Matrix.{u1, u1, u2} m m R) (Matrix.semiring.{u2, u1} m R (CommSemiring.toSemiring.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5)) _inst_4 (fun (a : m) (b : m) => _inst_3 a b))))) M)))) (Matrix.det.{u2, u1} m (fun (a : m) (b : m) => _inst_3 a b) _inst_4 R _inst_5 N)
...
but is expected to have type
  forall {n : Type.{u1}} [_inst_1 : DecidableEq.{succ u1} n] [_inst_2 : Fintype.{u1} n] {R : Type.{u2}} [_inst_5 : CommRing.{u2} R] (σ : Equiv.Perm.{succ u1} n) (M : Matrix.{u1, u1, u2} n n R), Eq.{succ u2} R (Matrix.det.{u2, u1} n (fun (a : n) (b : n) => _inst_1 a b) _inst_2 R _inst_5 (fun (i : n) => M (FunLike.coe.{succ u1, succ u1, succ u1} (Equiv.Perm.{succ u1} n) n (fun (_x : n) => (fun (x._@.Mathlib.Logic.Equiv.Defs._hyg.812 : n) => n) _x) (Equiv.instFunLikeEquiv.{succ u1, succ u1} n n) σ i))) (HMul.hMul.{u2, u2, u2} R R R (instHMul.{u2} R (NonUnitalNonAssocRing.toMul.{u2} R (NonAssocRing.toNonUnitalNonAssocRing.{u2} R (Ring.toNonAssocRing.{u2} R (CommRing.toRing.{u2} R _inst_5))))) (Int.cast.{u2} R (Ring.toIntCast.{u2} R (CommRing.toRing.{u2} R _inst_5)) (Units.val.{0} Int Int.instMonoidInt (FunLike.coe.{succ u1, succ u1, 1} (MonoidHom.{u1, 0} (Equiv.Perm.{succ u1} n) (Units.{0} Int Int.instMonoidInt) (Monoid.toMulOneClass.{u1} (Equiv.Perm.{succ u1} n) (DivInvMonoid.toMonoid.{u1} (Equiv.Perm.{succ u1} n) (Group.toDivInvMonoid.{u1} (Equiv.Perm.{succ u1} n) (Equiv.Perm.permGroup.{u1} n)))) (Units.instMulOneClassUnits.{0} Int Int.instMonoidInt)) (Equiv.Perm.{succ u1} n) (fun (a : Equiv.Perm.{succ u1} n) => (fun (x._@.Mathlib.Algebra.Hom.Group._hyg.2397 : Equiv.Perm.{succ u1} n) => Units.{0} Int Int.instMonoidInt) a) (MulHomClass.toFunLike.{u1, u1, 0} (MonoidHom.{u1, 0} (Equiv.Perm.{succ u1} n) (Units.{0} Int Int.instMonoidInt) (Monoid.toMulOneClass.{u1} (Equiv.Perm.{succ u1} n) (DivInvMonoid.toMonoid.{u1} (Equiv.Perm.{succ u1} n) (Group.toDivInvMonoid.{u1} (Equiv.Perm.{succ u1} n) (Equiv.Perm.permGroup.{u1} n)))) (Units.instMulOneClassUnits.{0} Int Int.instMonoidInt)) (Equiv.Perm.{succ u1} n) (Units.{0} Int Int.instMonoidInt) (MulOneClass.toMul.{u1} (Equiv.Perm.{succ u1} n) (Monoid.toMulOneClass.{u1} (Equiv.Perm.{succ u1} n) (DivInvMonoid.toMonoid.{u1} (Equiv.Perm.{succ u1} n) (Group.toDivInvMonoid.{u1} (Equiv.Perm.{succ u1} n) (Equiv.Perm.permGroup.{u1} n))))) (MulOneClass.toMul.{0} (Units.{0} Int Int.instMonoidInt) (Units.instMulOneClassUnits.{0} Int Int.instMonoidInt)) (MonoidHomClass.toMulHomClass.{u1, u1, 0} (MonoidHom.{u1, 0} (Equiv.Perm.{succ u1} n) (Units.{0} Int Int.instMonoidInt) (Monoid.toMulOneClass.{u1} (Equiv.Perm.{succ u1} n) (DivInvMonoid.toMonoid.{u1} (Equiv.Perm.{succ u1} n) (Group.toDivInvMonoid.{u1} (Equiv.Perm.{succ u1} n) (Equiv.Perm.permGroup.{u1} n)))) (Units.instMulOneClassUnits.{0} Int Int.instMonoidInt)) (Equiv.Perm.{succ u1} n) (Units.{0} Int Int.instMonoidInt) (Monoid.toMulOneClass.{u1} (Equiv.Perm.{succ u1} n) (DivInvMonoid.toMonoid.{u1} (Equiv.Perm.{succ u1} n) (Group.toDivInvMonoid.{u1} (Equiv.Perm.{succ u1} n) (Equiv.Perm.permGroup.{u1} n)))) (Units.instMulOneClassUnits.{0} Int Int.instMonoidInt) (MonoidHom.monoidHomClass.{u1, 0} (Equiv.Perm.{succ u1} n) (Units.{0} Int Int.instMonoidInt) (Monoid.toMulOneClass.{u1} (Equiv.Perm.{succ u1} n) (DivInvMonoid.toMonoid.{u1} (Equiv.Perm.{succ u1} n) (Group.toDivInvMonoid.{u1} (Equiv.Perm.{succ u1} n) (Equiv.Perm.permGroup.{u1} n)))) (Units.instMulOneClassUnits.{0} Int Int.instMonoidInt)))) (Equiv.Perm.sign.{u1} n (fun (a : n) (b : n) => _inst_1 a b) _inst_2) σ))) (Matrix.det.{u2, u1} n (fun (a : n) (b : n) => _inst_1 a b) _inst_2 R _inst_5 M))
...
but is expected to have type
  forall {n : Type.{u1}} [_inst_1 : DecidableEq.{succ u1} n] [_inst_2 : Fintype.{u1} n] {R : Type.{u2}} [_inst_5 : CommRing.{u2} R] (σ : Equiv.Perm.{succ u1} n), Eq.{succ u2} R (Matrix.det.{u2, u1} n (fun (a : n) (b : n) => _inst_1 a b) _inst_2 R _inst_5 (PEquiv.toMatrix.{u2, u1, u1} n n R (fun (a : n) (b : n) => _inst_1 a b) (CommMonoidWithZero.toZero.{u2} R (CommSemiring.toCommMonoidWithZero.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5))) (Semiring.toOne.{u2} R (CommSemiring.toSemiring.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5))) (Equiv.toPEquiv.{u1, u1} n n σ))) (Int.cast.{u2} R (Ring.toIntCast.{u2} R (CommRing.toRing.{u2} R _inst_5)) (Units.val.{0} Int Int.instMonoidInt (FunLike.coe.{succ u1, succ u1, 1} (MonoidHom.{u1, 0} (Equiv.Perm.{succ u1} n) (Units.{0} Int Int.instMonoidInt) (Monoid.toMulOneClass.{u1} (Equiv.Perm.{succ u1} n) (DivInvMonoid.toMonoid.{u1} (Equiv.Perm.{succ u1} n) (Group.toDivInvMonoid.{u1} (Equiv.Perm.{succ u1} n) (Equiv.Perm.permGroup.{u1} n)))) (Units.instMulOneClassUnits.{0} Int Int.instMonoidInt)) (Equiv.Perm.{succ u1} n) (fun (a : Equiv.Perm.{succ u1} n) => (fun (x._@.Mathlib.Algebra.Hom.Group._hyg.2397 : Equiv.Perm.{succ u1} n) => Units.{0} Int Int.instMonoidInt) a) (MulHomClass.toFunLike.{u1, u1, 0} (MonoidHom.{u1, 0} (Equiv.Perm.{succ u1} n) (Units.{0} Int Int.instMonoidInt) (Monoid.toMulOneClass.{u1} (Equiv.Perm.{succ u1} n) (DivInvMonoid.toMonoid.{u1} (Equiv.Perm.{succ u1} n) (Group.toDivInvMonoid.{u1} (Equiv.Perm.{succ u1} n) (Equiv.Perm.permGroup.{u1} n)))) (Units.instMulOneClassUnits.{0} Int Int.instMonoidInt)) (Equiv.Perm.{succ u1} n) (Units.{0} Int Int.instMonoidInt) (MulOneClass.toMul.{u1} (Equiv.Perm.{succ u1} n) (Monoid.toMulOneClass.{u1} (Equiv.Perm.{succ u1} n) (DivInvMonoid.toMonoid.{u1} (Equiv.Perm.{succ u1} n) (Group.toDivInvMonoid.{u1} (Equiv.Perm.{succ u1} n) (Equiv.Perm.permGroup.{u1} n))))) (MulOneClass.toMul.{0} (Units.{0} Int Int.instMonoidInt) (Units.instMulOneClassUnits.{0} Int Int.instMonoidInt)) (MonoidHomClass.toMulHomClass.{u1, u1, 0} (MonoidHom.{u1, 0} (Equiv.Perm.{succ u1} n) (Units.{0} Int Int.instMonoidInt) (Monoid.toMulOneClass.{u1} (Equiv.Perm.{succ u1} n) (DivInvMonoid.toMonoid.{u1} (Equiv.Perm.{succ u1} n) (Group.toDivInvMonoid.{u1} (Equiv.Perm.{succ u1} n) (Equiv.Perm.permGroup.{u1} n)))) (Units.instMulOneClassUnits.{0} Int Int.instMonoidInt)) (Equiv.Perm.{succ u1} n) (Units.{0} Int Int.instMonoidInt) (Monoid.toMulOneClass.{u1} (Equiv.Perm.{succ u1} n) (DivInvMonoid.toMonoid.{u1} (Equiv.Perm.{succ u1} n) (Group.toDivInvMonoid.{u1} (Equiv.Perm.{succ u1} n) (Equiv.Perm.permGroup.{u1} n)))) (Units.instMulOneClassUnits.{0} Int Int.instMonoidInt) (MonoidHom.monoidHomClass.{u1, 0} (Equiv.Perm.{succ u1} n) (Units.{0} Int Int.instMonoidInt) (Monoid.toMulOneClass.{u1} (Equiv.Perm.{succ u1} n) (DivInvMonoid.toMonoid.{u1} (Equiv.Perm.{succ u1} n) (Group.toDivInvMonoid.{u1} (Equiv.Perm.{succ u1} n) (Equiv.Perm.permGroup.{u1} n)))) (Units.instMulOneClassUnits.{0} Int Int.instMonoidInt)))) (Equiv.Perm.sign.{u1} n (fun (a : n) (b : n) => _inst_1 a b) _inst_2) σ)))
...
but is expected to have type
  forall {n : Type.{u1}} [_inst_1 : DecidableEq.{succ u1} n] [_inst_2 : Fintype.{u1} n] {R : Type.{u2}} [_inst_5 : CommRing.{u2} R] (A : Matrix.{u1, u1, u2} n n R) (c : R), Eq.{succ u2} R (Matrix.det.{u2, u1} n (fun (a : n) (b : n) => _inst_1 a b) _inst_2 R _inst_5 (HSMul.hSMul.{u2, max u2 u1, max u2 u1} R (Matrix.{u1, u1, u2} n n R) (Matrix.{u1, u1, u2} n n R) (instHSMul.{u2, max u2 u1} R (Matrix.{u1, u1, u2} n n R) (Matrix.smul.{u2, u1, u1, u2} n n R R (Algebra.toSMul.{u2, u2} R R (CommRing.toCommSemiring.{u2} R _inst_5) (CommSemiring.toSemiring.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5)) (Algebra.id.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5))))) c A)) (HMul.hMul.{u2, u2, u2} R R R (instHMul.{u2} R (NonUnitalNonAssocRing.toMul.{u2} R (NonAssocRing.toNonUnitalNonAssocRing.{u2} R (Ring.toNonAssocRing.{u2} R (CommRing.toRing.{u2} R _inst_5))))) (HPow.hPow.{u2, 0, u2} R Nat R (instHPow.{u2, 0} R Nat (Monoid.Pow.{u2} R (MonoidWithZero.toMonoid.{u2} R (Semiring.toMonoidWithZero.{u2} R (CommSemiring.toSemiring.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5)))))) c (Fintype.card.{u1} n _inst_2)) (Matrix.det.{u2, u1} n (fun (a : n) (b : n) => _inst_1 a b) _inst_2 R _inst_5 A))
...
but is expected to have type
  forall {n : Type.{u1}} [_inst_1 : DecidableEq.{succ u1} n] [_inst_2 : Fintype.{u1} n] {R : Type.{u2}} [_inst_5 : CommRing.{u2} R] (A : Matrix.{u1, u1, u2} n n R), Eq.{succ u2} R (Matrix.det.{u2, u1} n (fun (a : n) (b : n) => _inst_1 a b) _inst_2 R _inst_5 (Neg.neg.{max u2 u1} (Matrix.{u1, u1, u2} n n R) (Matrix.neg.{u2, u1, u1} n n R (Ring.toNeg.{u2} R (CommRing.toRing.{u2} R _inst_5))) A)) (HMul.hMul.{u2, u2, u2} R R R (instHMul.{u2} R (NonUnitalNonAssocRing.toMul.{u2} R (NonAssocRing.toNonUnitalNonAssocRing.{u2} R (Ring.toNonAssocRing.{u2} R (CommRing.toRing.{u2} R _inst_5))))) (HPow.hPow.{u2, 0, u2} R Nat R (instHPow.{u2, 0} R Nat (Monoid.Pow.{u2} R (MonoidWithZero.toMonoid.{u2} R (Semiring.toMonoidWithZero.{u2} R (CommSemiring.toSemiring.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5)))))) (Neg.neg.{u2} R (Ring.toNeg.{u2} R (CommRing.toRing.{u2} R _inst_5)) (OfNat.ofNat.{u2} R 1 (One.toOfNat1.{u2} R (Semiring.toOne.{u2} R (CommSemiring.toSemiring.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5)))))) (Fintype.card.{u1} n _inst_2)) (Matrix.det.{u2, u1} n (fun (a : n) (b : n) => _inst_1 a b) _inst_2 R _inst_5 A))
...
but is expected to have type
  forall {m : Type.{u1}} [_inst_3 : DecidableEq.{succ u1} m] [_inst_4 : Fintype.{u1} m] {R : Type.{u2}} [_inst_5 : CommRing.{u2} R] (M : Matrix.{u1, u1, u2} m m R) (n : Nat), Eq.{succ u2} R (Matrix.det.{u2, u1} m (fun (a : m) (b : m) => _inst_3 a b) _inst_4 R _inst_5 (HPow.hPow.{max u2 u1, 0, max u2 u1} (Matrix.{u1, u1, u2} m m R) Nat (Matrix.{u1, u1, u2} m m R) (instHPow.{max u2 u1, 0} (Matrix.{u1, u1, u2} m m R) Nat (Monoid.Pow.{max u2 u1} (Matrix.{u1, u1, u2} m m R) (MonoidWithZero.toMonoid.{max u2 u1} (Matrix.{u1, u1, u2} m m R) (Semiring.toMonoidWithZero.{max u2 u1} (Matrix.{u1, u1, u2} m m R) (Matrix.semiring.{u2, u1} m R (CommSemiring.toSemiring.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5)) _inst_4 (fun (a : m) (b : m) => _inst_3 a b)))))) M n)) (HPow.hPow.{u2, 0, u2} R Nat R (instHPow.{u2, 0} R Nat (Monoid.Pow.{u2} R (MonoidWithZero.toMonoid.{u2} R (Semiring.toMonoidWithZero.{u2} R (CommSemiring.toSemiring.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5)))))) (Matrix.det.{u2, u1} m (fun (a : m) (b : m) => _inst_3 a b) _inst_4 R _inst_5 M) n)
...
but is expected to have type
  forall {m : Type.{u1}} [_inst_3 : DecidableEq.{succ u1} m] [_inst_4 : Fintype.{u1} m] {R : Type.{u2}} [_inst_5 : CommRing.{u2} R] [_inst_6 : StarRing.{u2} R (NonUnitalCommSemiring.toNonUnitalSemiring.{u2} R (NonUnitalCommRing.toNonUnitalCommSemiring.{u2} R (CommRing.toNonUnitalCommRing.{u2} R _inst_5)))] (M : Matrix.{u1, u1, u2} m m R), Eq.{succ u2} R (Matrix.det.{u2, u1} m (fun (a : m) (b : m) => _inst_3 a b) _inst_4 R _inst_5 (Matrix.conjTranspose.{u2, u1, u1} m m R (InvolutiveStar.toStar.{u2} R (StarAddMonoid.toInvolutiveStar.{u2} R (AddMonoidWithOne.toAddMonoid.{u2} R (AddGroupWithOne.toAddMonoidWithOne.{u2} R (Ring.toAddGroupWithOne.{u2} R (CommRing.toRing.{u2} R _inst_5)))) (StarRing.toStarAddMonoid.{u2} R (NonUnitalCommSemiring.toNonUnitalSemiring.{u2} R (NonUnitalCommRing.toNonUnitalCommSemiring.{u2} R (CommRing.toNonUnitalCommRing.{u2} R _inst_5))) _inst_6))) M)) (Star.star.{u2} R (InvolutiveStar.toStar.{u2} R (StarAddMonoid.toInvolutiveStar.{u2} R (AddMonoidWithOne.toAddMonoid.{u2} R (AddGroupWithOne.toAddMonoidWithOne.{u2} R (Ring.toAddGroupWithOne.{u2} R (CommRing.toRing.{u2} R _inst_5)))) (StarRing.toStarAddMonoid.{u2} R (NonUnitalCommSemiring.toNonUnitalSemiring.{u2} R (NonUnitalCommRing.toNonUnitalCommSemiring.{u2} R (CommRing.toNonUnitalCommRing.{u2} R _inst_5))) _inst_6))) (Matrix.det.{u2, u1} m (fun (a : m) (b : m) => _inst_3 a b) _inst_4 R _inst_5 M))
...
but is expected to have type
  forall {n : Type.{u1}} [_inst_1 : DecidableEq.{succ u1} n] [_inst_2 : Fintype.{u1} n] {R : Type.{u2}} [_inst_5 : CommRing.{u2} R] (M : Matrix.{u1, u1, u2} n n R) (j : n) (s : R) (u : n -> R), Eq.{succ u2} R (Matrix.det.{u2, u1} n (fun (a : n) (b : n) => _inst_1 a b) _inst_2 R _inst_5 (Matrix.updateRow.{u2, u1, u1} n n R (fun (a : n) (b : n) => _inst_1 a b) (HSMul.hSMul.{u2, max u2 u1, max u2 u1} R (Matrix.{u1, u1, u2} n n R) (Matrix.{u1, u1, u2} n n R) (instHSMul.{u2, max u2 u1} R (Matrix.{u1, u1, u2} n n R) (Matrix.smul.{u2, u1, u1, u2} n n R R (Algebra.toSMul.{u2, u2} R R (CommRing.toCommSemiring.{u2} R _inst_5) (CommSemiring.toSemiring.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5)) (Algebra.id.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5))))) s M) j u)) (HMul.hMul.{u2, u2, u2} R R R (instHMul.{u2} R (NonUnitalNonAssocRing.toMul.{u2} R (NonAssocRing.toNonUnitalNonAssocRing.{u2} R (Ring.toNonAssocRing.{u2} R (CommRing.toRing.{u2} R _inst_5))))) (HPow.hPow.{u2, 0, u2} R Nat R (instHPow.{u2, 0} R Nat (Monoid.Pow.{u2} R (MonoidWithZero.toMonoid.{u2} R (Semiring.toMonoidWithZero.{u2} R (CommSemiring.toSemiring.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5)))))) s (HSub.hSub.{0, 0, 0} Nat Nat Nat (instHSub.{0} Nat instSubNat) (Fintype.card.{u1} n _inst_2) (OfNat.ofNat.{0} Nat 1 (instOfNatNat 1)))) (Matrix.det.{u2, u1} n (fun (a : n) (b : n) => _inst_1 a b) _inst_2 R _inst_5 (Matrix.updateRow.{u2, u1, u1} n n R (fun (a : n) (b : n) => _inst_1 a b) M j u)))
...
but is expected to have type
  forall {n : Type.{u1}} [_inst_1 : DecidableEq.{succ u1} n] [_inst_2 : Fintype.{u1} n] {R : Type.{u2}} [_inst_5 : CommRing.{u2} R] (M : Matrix.{u1, u1, u2} n n R) (j : n) (s : R) (u : n -> R), Eq.{succ u2} R (Matrix.det.{u2, u1} n (fun (a : n) (b : n) => _inst_1 a b) _inst_2 R _inst_5 (Matrix.updateColumn.{u2, u1, u1} n n R (fun (a : n) (b : n) => _inst_1 a b) (HSMul.hSMul.{u2, max u2 u1, max u2 u1} R (Matrix.{u1, u1, u2} n n R) (Matrix.{u1, u1, u2} n n R) (instHSMul.{u2, max u2 u1} R (Matrix.{u1, u1, u2} n n R) (Matrix.smul.{u2, u1, u1, u2} n n R R (Algebra.toSMul.{u2, u2} R R (CommRing.toCommSemiring.{u2} R _inst_5) (CommSemiring.toSemiring.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5)) (Algebra.id.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5))))) s M) j u)) (HMul.hMul.{u2, u2, u2} R R R (instHMul.{u2} R (NonUnitalNonAssocRing.toMul.{u2} R (NonAssocRing.toNonUnitalNonAssocRing.{u2} R (Ring.toNonAssocRing.{u2} R (CommRing.toRing.{u2} R _inst_5))))) (HPow.hPow.{u2, 0, u2} R Nat R (instHPow.{u2, 0} R Nat (Monoid.Pow.{u2} R (MonoidWithZero.toMonoid.{u2} R (Semiring.toMonoidWithZero.{u2} R (CommSemiring.toSemiring.{u2} R (CommRing.toCommSemiring.{u2} R _inst_5)))))) s (HSub.hSub.{0, 0, 0} Nat Nat Nat (instHSub.{0} Nat instSubNat) (Fintype.card.{u1} n _inst_2) (OfNat.ofNat.{0} Nat 1 (instOfNatNat 1)))) (Matrix.det.{u2, u1} n (fun (a : n) (b : n) => _inst_1 a b) _inst_2 R _inst_5 (Matrix.updateColumn.{u2, u1, u1} n n R (fun (a : n) (b : n) => _inst_1 a b) M j u)))
