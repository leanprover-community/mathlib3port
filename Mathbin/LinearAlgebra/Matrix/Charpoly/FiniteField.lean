...
#align_import linear_algebra.matrix.charpoly.finite_field from "leanprover-community/mathlib"@"af471b9e3ce868f296626d33189b4ce730fa4c00"
...
theorem FiniteField.Matrix.charpoly_pow_card {K : Type _} [Field K] [Fintype K] (M : Matrix n n K) :
  ...
  · cases' CharP.exists K with p hp; letI := hp
    ...
    rw [AlgEquiv.map_pow, Matrix.matPolyEquiv_charmatrix, hk, sub_pow_char_pow_of_commute, ← C_pow]
