...
#align
  linear_map._root_.matrix.separating_left_to_linear_map₂'_iff_separating_left_to_linear_map₂ linear_map._root_.matrix.separating_left_to_linear_map₂'_iff_separating_left_to_linear_map₂
...
theorem separatingLeftToLinearMap₂'OfDetNeZero' (M : Matrix ι ι R₁) (h : M.det ≠ 0) : M.toLinearMap₂'.SeparatingLeft :=
...
theorem separatingLeftOfDetNeZero {B : M₁ →ₗ[R₁] M₁ →ₗ[R₁] R₁} (b : Basis ι R₁ M₁) (h : (toMatrix₂ b b B).det ≠ 0) :
    B.SeparatingLeft :=
