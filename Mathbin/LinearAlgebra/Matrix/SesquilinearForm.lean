...
/- ././././Mathport/Syntax/Translate/Expr.lean:107:6: warning: expanding binder group (i' j') -/
#print Matrix.toLinearMap₂'Aux_stdBasis /-
...
#print LinearMap.toMatrix₂Aux_apply /-
@[simp]
...
#print LinearMap.toLinearMap₂'Aux_toMatrix₂Aux /-
...
#print Matrix.toMatrix₂Aux_toLinearMap₂'Aux /-
...
#print Matrix.toLinearMapₛₗ₂'_aux_eq /-
...
/- ././././Mathport/Syntax/Translate/Expr.lean:107:6: warning: expanding binder group (i j) -/
#print Matrix.toLinearMapₛₗ₂'_apply /-
...
/- ././././Mathport/Syntax/Translate/Expr.lean:107:6: warning: expanding binder group (i j) -/
#print Matrix.toLinearMap₂'_apply /-
...
#print Matrix.toLinearMapₛₗ₂'_stdBasis /-
@[simp]
...
#print Matrix.toLinearMap₂'_stdBasis /-
@[simp]
...
#print LinearMap.toMatrixₛₗ₂'_symm /-
@[simp]
...
#print Matrix.toLinearMapₛₗ₂'_symm /-
@[simp]
...
#print Matrix.toLinearMapₛₗ₂'_toMatrix' /-
@[simp]
...
#print Matrix.toLinearMap₂'_toMatrix' /-
@[simp]
...
#print LinearMap.toMatrix'_toLinearMapₛₗ₂' /-
@[simp]
...
#print LinearMap.toMatrix'_toLinearMap₂' /-
@[simp]
...
#print LinearMap.toMatrixₛₗ₂'_apply /-
@[simp]
...
#print LinearMap.toMatrix₂'_compl₁₂ /-
@[simp]
...
#print LinearMap.mul_toMatrix₂'_mul /-
...
#print Matrix.toLinearMap₂'_comp /-
...
#print LinearMap.toMatrix₂Aux_eq /-
...
#print Matrix.toLinearMap₂_symm /-
@[simp]
...
#print Matrix.toLinearMap₂_basisFun /-
...
#print LinearMap.toMatrix₂_basisFun /-
...
#print LinearMap.toMatrix₂_mul_basis_toMatrix /-
@[simp]
...
#print Matrix.toLinearMap₂_compl₁₂ /-
...
#print isAdjointPair_toLinearMap₂' /-
@[simp]
...
#print Matrix.separatingLeft_toLinearMap₂'_iff_separatingLeft_toLinearMap₂ /-
...
#print LinearMap.nondegenerate_toMatrix₂'_iff /-
...
#print LinearMap.SeparatingLeft.toMatrix₂' /-
...
#print LinearMap.nondegenerate_toMatrix_iff /-
@[simp]
...
#print LinearMap.separatingLeft_toLinearMap₂'_of_det_ne_zero' /-
...
#print LinearMap.separatingLeft_iff_det_ne_zero /-
...
#print LinearMap.separatingLeft_of_det_ne_zero /-
