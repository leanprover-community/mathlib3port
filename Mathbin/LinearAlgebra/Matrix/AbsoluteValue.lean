...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `det_le [])
  (Command.declSig
   [(Term.implicitBinder "{" [`A] [":" (Term.app `Matrix [`n `n `R])] "}")
    (Term.implicitBinder "{" [`abv] [":" (Term.app `AbsoluteValue [`R `S])] "}")
    (Term.implicitBinder "{" [`x] [":" `S] "}")
    (Term.explicitBinder
     "("
     [`hx]
     [":"
      (Term.forall "∀" [(Term.simpleBinder [`i `j] [])] "," («term_≤_» (Term.app `abv [(Term.app `A [`i `j])]) "≤" `x))]
     []
     ")")]
   (Term.typeSpec
    ":"
    («term_≤_»
     ...
     (Algebra.Group.Defs.«term_•_»
      (Term.app `Nat.factorial [(Term.app `Fintype.card [`n])])
      " • "
      (Cardinal.SetTheory.Cardinal.«term_^_» `x "^" (Term.app `Fintype.card [`n]))))))
      ...
      («term_=_»
       ...
       (Term.app
        ...
        [(Algebra.BigOperators.Basic.«term∑_,_»
          "∑"
          (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `σ)] [":" (Term.app `perm [`n])]))
          ", "
          (Term.hole "_"))]))
      ":="
      (Term.app `congr_argₓ [`abv (Term.app `det_apply [(Term.hole "_")])]))
     (calcStep
      («term_≤_»
       (Term.hole "_")
       "≤"
       (Algebra.BigOperators.Basic.«term∑_,_»
        ...
        (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `σ)] [":" (Term.app `perm [`n])]))
        ", "
        (Term.app `abv [(Term.hole "_")])))
      ":="
      (Term.app `abv.sum_le [(Term.hole "_") (Term.hole "_")]))
     (calcStep
      («term_=_»
       (Term.hole "_")
       "="
       (Algebra.BigOperators.Basic.«term∑_,_»
        ...
        (Algebra.BigOperators.Basic.«term∏_,_»
         ...
         ", "
         (Term.app `abv [(Term.app `A [(Term.app `σ [`i]) `i])]))))
      ":="
      (Term.app
       `sum_congr
       [`rfl
            ...
            (Tactic.tacticSeq1Indented
             [(group
               (Tactic.rwSeq
                ...
                (Tactic.rwRuleSeq
                 "["
                 [(Tactic.rwRule [] `abv.map_units_int_smul) "," (Tactic.rwRule [] `abv.map_prod)]
                 "]")
                [])
               [])])))))]))
     (calcStep
          ...
          (Term.app
           ...
           [(Term.fun
             ...
             (Term.basicFun
              [(Term.simpleBinder [(Term.hole "_") (Term.hole "_")] [])]
              "=>"
              (Term.app `abv.nonneg [(Term.hole "_")])))
            (Term.fun
             "fun"
             (Term.basicFun
              [(Term.simpleBinder [(Term.hole "_") (Term.hole "_")] [])]
              "=>"
              (Term.app `hx [(Term.hole "_") (Term.hole "_")])))])))]))
     (calcStep
      («term_=_»
       (Term.hole "_")
       "="
            ...
            (Tactic.tacticSeq1Indented
             [(group
               (Tactic.rwSeq
                "rw"
                []
                (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `prod_const) "," (Tactic.rwRule [] `Finset.card_univ)] "]")
                [])
               [])])))))]))
     (calcStep
      («term_=_»
           ...
           (Tactic.rwSeq
            ...
            (Tactic.rwRuleSeq
             ...
             [(Tactic.rwRule [] `sum_const)
              ...
              ","
              (Tactic.rwRule [] `Fintype.card_perm)]
             "]")
            [])
           [])]))))])
   [])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.rwSeq
   ...
   (Tactic.rwRuleSeq
    "["
    [(Tactic.rwRule [] `sum_const) "," (Tactic.rwRule [] `Finset.card_univ) "," (Tactic.rwRule [] `Fintype.card_perm)]
    "]")
   [])
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Fintype.card [`n]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `Nat.factorial
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
theorem
  det_le
  { A : Matrix n n R } { abv : AbsoluteValue R S } { x : S } ( hx : ∀ i j , abv A i j ≤ x )
   ...
   [(Term.implicitBinder "{" [`ι] [":" (Term.type "Type" [(Level.hole "_")])] "}")
    ...
    (Term.explicitBinder
     ...
     [":"
      (Term.forall
       "∀"
       [(Term.simpleBinder [`k `i `j] [])]
       ","
       («term_≤_» (Term.app `abv [(Term.app `A [`k `i `j])]) "≤" `x))]
     []
     ")")]
   (Term.typeSpec
    ":"
    («term_≤_»
     ...
     (Algebra.Group.Defs.«term_•_»
      ...
      (Cardinal.SetTheory.Cardinal.«term_^_»
       (Algebra.Group.Defs.«term_•_» (Term.app `Finset.card [`s]) " • " `x)
       "^"
       (Term.app `Fintype.card [`n]))))))
  (Command.declValSimple
   ":="
      ...
      (calc
       ...
       [(calcStep
         ...
         (Term.byTactic
          ...
          (Tactic.tacticSeq
           (Tactic.tacticSeq1Indented
            [(group (Tactic.simp "simp" [] ["only"] ["[" [(Tactic.simpLemma [] [] `sum_apply)] "]"] []) [])]))))
        (calcStep
         («term_≤_»
          (Term.hole "_")
          "≤"
        ...
        (calcStep
         ...
         (Term.app
          ...
          [(Term.fun
            "fun"
            (Term.basicFun [(Term.simpleBinder [`k (Term.hole "_")] [])] "=>" (Term.app `hx [`k `i `j])))]))
        (calcStep
         («term_=_» (Term.hole "_") "=" (Algebra.Group.Defs.«term_•_» `s.card " • " `x))
         ":="
         (Term.app `sum_const [(Term.hole "_")]))]))))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
  ...
  (calc
   ...
   [(calcStep
    ...
    (calcStep
     ...
     (Term.app
      `sum_le_sum
      [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`k (Term.hole "_")] [])] "=>" (Term.app `hx [`k `i `j])))]))
    (calcStep
     («term_=_» (Term.hole "_") "=" (Algebra.Group.Defs.«term_•_» `s.card " • " `x))
     ":="
     (Term.app `sum_const [(Term.hole "_")]))])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_=_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Algebra.Group.Defs.«term_•_» `s.card " • " `x)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Algebra.Group.Defs.«term_•_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `x
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `det_sum_smul_le [])
  (Command.declSig
   [(Term.implicitBinder "{" [`ι] [":" (Term.type "Type" [(Level.hole "_")])] "}")
    (Term.explicitBinder "(" [`s] [":" (Term.app `Finset [`ι])] [] ")")
    (Term.implicitBinder "{" [`c] [":" (Term.arrow `ι "→" `R)] "}")
    (Term.implicitBinder "{" [`A] [":" (Term.arrow `ι "→" (Term.app `Matrix [`n `n `R]))] "}")
    (Term.implicitBinder "{" [`abv] [":" (Term.app `AbsoluteValue [`R `S])] "}")
    (Term.implicitBinder "{" [`x] [":" `S] "}")
    (Term.explicitBinder
    ...
    (Term.explicitBinder
     "("
     [`hy]
     [":" (Term.forall "∀" [(Term.simpleBinder [`k] [])] "," («term_≤_» (Term.app `abv [(Term.app `c [`k])]) "≤" `y))]
     []
     ")")]
   (Term.typeSpec
    ":"
     ...
     (Term.app
      ...
      [(Term.app
        ...
        [(Algebra.BigOperators.Basic.«term∑_in_,_»
          ...
          `s
          ", "
          (Algebra.Group.Defs.«term_•_» (Term.app `c [`k]) " • " (Term.app `A [`k])))])])
     "≤"
     (Algebra.Group.Defs.«term_•_»
      (Term.app `Nat.factorial [(Term.app `Fintype.card [`n])])
      " • "
      (Cardinal.SetTheory.Cardinal.«term_^_»
       (Finset.Data.Finset.Fold.«term_*_» (Algebra.Group.Defs.«term_•_» (Term.app `Finset.card [`s]) " • " `y) "*" `x)
       "^"
       (Term.app `Fintype.card [`n]))))))
  (Command.declValSimple
   ":="
            ...
            (Term.fun
             ...
             (Term.basicFun
              ...
              (calc
               ...
               [(calcStep
                 («term_=_»
                  (Term.app `abv [(Finset.Data.Finset.Fold.«term_*_» (Term.app `c [`k]) "*" (Term.app `A [`k `i `j]))])
                  "="
                  (Finset.Data.Finset.Fold.«term_*_»
                   (Term.app `abv [(Term.app `c [`k])])
                   "*"
                   (Term.app `abv [(Term.app `A [`k `i `j])])))
                 ":="
                 (Term.app `abv.map_mul [(Term.hole "_") (Term.hole "_")]))
                (calcStep
                 («term_≤_» (Term.hole "_") "≤" (Finset.Data.Finset.Fold.«term_*_» `y "*" `x))
                 ":="
                 (Term.app
                  `mul_le_mul
                  [(Term.app `hy [`k])
                   ...
                   (Term.app `abv.nonneg [(Term.hole "_")])
                   (Term.app
                    (Term.proj (Term.app `abv.nonneg [(Term.hole "_")]) "." `trans)
                    [(Term.app `hy [`k])])]))])))])])
        [])])))
   [])
  []
          ...
          (calcStep
           ...
           (Term.app
            ...
            [(Term.app `hy [`k])
             (Term.app `hx [`k `i `j])
             (Term.app `abv.nonneg [(Term.hole "_")])
             (Term.app (Term.proj (Term.app `abv.nonneg [(Term.hole "_")]) "." `trans) [(Term.app `hy [`k])])]))])))])])
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `hy [`k]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `abv.nonneg [(Term.hole "_")]) "." `trans)
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `abv.nonneg [(Term.hole "_")]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app
   (Term.proj (Term.paren "(" [(Term.app `abv.nonneg [(Term.hole "_")]) []] ")") "." `trans)
   [(Term.paren "(" [(Term.app `hy [`k]) []] ")")])
  []]
 ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `hx [`k `i `j]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `A [`k `i `j]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `abv
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Finset.Data.Finset.Fold.«term_*_» (Term.app `c [`k]) "*" (Term.app `A [`k `i `j]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Finset.Data.Finset.Fold.«term_*_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `A [`k `i `j])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Algebra.Group.Defs.«term_•_» (Term.app `Finset.card [`s]) " • " `y)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Algebra.Group.Defs.«term_•_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `y
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Finset.Data.Finset.Fold.«term_*_»
   (Term.paren "(" [(Algebra.Group.Defs.«term_•_» (Term.app `Finset.card [`s]) " • " `y) []] ")")
   "*"
   `x)
  []]
 ")")
