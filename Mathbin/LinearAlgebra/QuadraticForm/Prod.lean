...
#print QuadraticForm.IsometryEquiv.prod /-
...
@[simps toLinearEquiv]
def IsometryEquiv.prod {Q₁ : QuadraticForm R M₁} {Q₂ : QuadraticForm R M₂}
    {Q₁' : QuadraticForm R N₁} {Q₂' : QuadraticForm R N₂} (e₁ : Q₁.IsometryEquiv Q₁')
    (e₂ : Q₂.IsometryEquiv Q₂') : (Q₁.Prod Q₂).IsometryEquiv (Q₁'.Prod Q₂')
    where
...
#print QuadraticForm.Equivalent.prod /-
...
#print QuadraticForm.anisotropic_of_prod /-
...
#print QuadraticForm.nonneg_prod_iff /-
...
#print QuadraticForm.posDef_prod_iff /-
...
#print QuadraticForm.PosDef.prod /-
...
#print QuadraticForm.IsometryEquiv.pi /-
/-- An isometry between quadratic forms generated by `quadratic_form.prod` can be constructed
from a pair of isometries between the left and right parts. -/
@[simps toLinearEquiv]
def IsometryEquiv.pi [Fintype ι] {Q : ∀ i, QuadraticForm R (Mᵢ i)}
    {Q' : ∀ i, QuadraticForm R (Nᵢ i)} (e : ∀ i, (Q i).IsometryEquiv (Q' i)) :
    (pi Q).IsometryEquiv (pi Q')
    where
  map_app' x := by
...
#print QuadraticForm.Equivalent.pi /-
...
#print QuadraticForm.anisotropic_of_pi /-
...
#print QuadraticForm.nonneg_pi_iff /-
...
#print QuadraticForm.posDef_pi_iff /-
