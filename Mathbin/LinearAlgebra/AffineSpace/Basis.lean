...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `sum_coord_apply_eq_one [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `Fintype [`ι]) "]") (Term.explicitBinder "(" [`q] [":" `P] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
        ...
        (Tactic.tacticHave_
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           ...
           [(Term.typeSpec
             ":"
             (Init.Core.«term_∈_» `q " ∈ " (Term.app `affineSpan [`k (Term.app `range [`b.points])])))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `b.tot)] "]") []) [])
               (group (Tactic.exact "exact" (Term.app `AffineSubspace.mem_top [`k `V `q])) [])]))))))
        [])
       (group
        (Tactic.obtain
         "obtain"
         [(Tactic.rcasesPatMed
           [(Tactic.rcasesPat.tuple
             ...
             "⟩")])]
         []
         [":=" [(Term.app `eq_affine_combination_of_mem_affine_span_of_fintype [`hq])]])
        [])
       (group (Tactic.convert "convert" [] `hw []) [])
       (group (Tactic.ext "ext" [(Tactic.rcasesPat.one `i)] []) [])
       (group
        (Tactic.exact "exact" (Term.app `b.coord_apply_combination_of_mem [(Term.app `Finset.mem_univ [`i]) `hw]))
        [])])))
   [])
  []
  []))
     ...
     [(group
       (Tactic.tacticHave_
        ...
        (Term.haveDecl
         (Term.haveIdDecl
          [`hq []]
          [(Term.typeSpec ":" (Init.Core.«term_∈_» `q " ∈ " (Term.app `affineSpan [`k (Term.app `range [`b.points])])))]
          ":="
          (Term.byTactic
           "by"
           (Tactic.tacticSeq
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `b.coord_apply_combination_of_mem [(Term.app `Finset.mem_univ [`i]) `hw])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `AffineSubspace.mem_top [`k `V `q]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `AffineSubspace.mem_top [`k `V `q])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `b.tot)] "]") [])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `affineSpan [`k (Term.app `range [`b.points])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `range [`b.points]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
@[ simp ]
  theorem
    ...
    :=
      by
        have hq : q ∈ affineSpan k range b.points := by rw [ b.tot ] exact AffineSubspace.mem_top k V q
...
@[simp]
theorem to_matrix_self [DecidableEq ι] : b.to_matrix b.points = (1 : Matrix ι ι k) := by
  ext i j
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `to_matrix_row_sum_one [])
  (Command.declSig
   [(Term.implicitBinder "{" [`ι'] [":" (Term.type "Type" [(Level.hole "_")])] "}")
    (Term.explicitBinder "(" [`q] [":" (Term.arrow `ι' "→" `P)] [] ")")
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
theorem to_matrix_row_sum_one { ι' : Type _ } ( q : ι' → P ) ( i : ι' ) : ∑ j , b.to_matrix q i j = 1 := by simp
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `affine_independent_of_to_matrix_right_inv [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `DecidableEq [`ι']) "]")
    (Term.explicitBinder "(" [`p] [":" (Term.arrow `ι' "→" `P)] [] ")")
    (Term.implicitBinder "{" [`A] [":" (Term.app `Matrix [`ι `ι' `k])] "}")
    (Term.explicitBinder
     "("
     [`hA]
     [":" («term_=_» (Matrix.Data.Matrix.Basic.«term_⬝_» (Term.app `b.to_matrix [`p]) " ⬝ " `A) "=" (numLit "1"))]
     []
     ")")]
   (Term.typeSpec ":" (Term.app `AffineIndependent [`k `p])))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.rwSeq
         "rw"
         []
         (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `affine_independent_iff_eq_of_fintype_affine_combination_eq)] "]")
         [])
        [])
       (group (Tactic.intro "intro" [`w₁ `w₂ `hw₁ `hw₂ `hweq]) [])
       (group
        (Tactic.tacticHave_
         "have"
         (Term.haveDecl
          (Term.haveIdDecl
           ...
           [(Term.typeSpec
             ":"
             («term_=_»
              (Term.app (Term.proj (Term.app `b.to_matrix [`p]) "." `vecMul) [`w₁])
              "="
              (Term.app (Term.proj (Term.app `b.to_matrix [`p]) "." `vecMul) [`w₂])))]
           ":="
           (Term.byTactic
                ...
                (Tactic.change
                 ...
                 («term_=_»
                  (Algebra.BigOperators.Basic.«term∑_,_»
                   ...
                   (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
                   ", "
                   (Algebra.Group.Defs.«term_•_» (Term.app `w₁ [`i]) " • " (Term.app `b.coord [`j (Term.app `p [`i])])))
                  "="
                  (Algebra.BigOperators.Basic.«term∑_,_»
                   "∑"
                   (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
                   ...
                   (Algebra.Group.Defs.«term_•_»
                    (Term.app `w₂ [`i])
                    " • "
                    (Term.app `b.coord [`j (Term.app `p [`i])]))))
                 [])
                [])
               (group
                (Tactic.rwSeq
                 ...
                 (Tactic.rwRuleSeq
                  ...
                  [(Tactic.rwRule
                    ["←"]
                    (Term.app
                     `finset.univ.affine_combination_eq_linear_combination
                     [(Term.hole "_") (Term.hole "_") `hw₁]))
                   ","
                   (Tactic.rwRule
                    ["←"]
                    (Term.app
                     ...
                     [(Term.hole "_") (Term.hole "_") `hw₂]))
                   ","
                   (Tactic.rwRule ["←"] (Term.app `finset.univ.map_affine_combination [`p `w₁ `hw₁]))
                   ","
                   (Tactic.rwRule ["←"] (Term.app `finset.univ.map_affine_combination [`p `w₂ `hw₂]))
                   ","
                   (Tactic.rwRule [] `hweq)]
        ...
        (Tactic.replace
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           ...
           (Term.app
            `congr_argₓ
            [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`w] [])] "=>" (Term.app `A.vec_mul [`w]))) `hweq']))))
        [])
       (group
        (Tactic.simpa
         "simpa"
         ...
         ["only"]
         ["["
          [(Tactic.simpLemma [] [] `Matrix.vec_mul_vec_mul)
           ","
           (Tactic.simpLemma [] ["←"] `Matrix.mul_eq_mul)
           ","
           (Tactic.simpLemma [] [] `hA)
           ","
           (Tactic.simpLemma [] [] `Matrix.vec_mul_one)]
          "]"]
         []
         ["using" `hweq'])
        [])])))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`w] [])] "=>" (Term.app `A.vec_mul [`w])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.fun.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.basicFun.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `A.vec_mul [`w])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
         ...
         (group
          (Tactic.rwSeq
           ...
           (Tactic.rwRuleSeq
            ...
            [(Tactic.rwRule
              ["←"]
              (Term.app `finset.univ.affine_combination_eq_linear_combination [(Term.hole "_") (Term.hole "_") `hw₁]))
             ","
             (Tactic.rwRule
              ["←"]
              (Term.app `finset.univ.affine_combination_eq_linear_combination [(Term.hole "_") (Term.hole "_") `hw₂]))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `finset.univ.map_affine_combination [`p `w₂ `hw₂])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `finset.univ.map_affine_combination
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
...
/--
  ...
  theorem
    ...
    [ DecidableEq ι' ] ( p : ι' → P ) { A : Matrix ι ι' k } ( hA : b.to_matrix p ⬝ A = 1 ) : AffineIndependent k p
    :=
      by
        rw [ affine_independent_iff_eq_of_fintype_affine_combination_eq ]
          ...
          have
            hweq'
              : b.to_matrix p . vecMul w₁ = b.to_matrix p . vecMul w₂
              :=
              by
                ext j
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `affine_span_eq_top_of_to_matrix_left_inv [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `DecidableEq [`ι]) "]")
    ...
    (Term.explicitBinder
     "("
     [`hA]
     [":" («term_=_» (Matrix.Data.Matrix.Basic.«term_⬝_» `A " ⬝ " (Term.app `b.to_matrix [`p])) "=" (numLit "1"))]
     []
     ")")]
   (Term.typeSpec
    ":"
    («term_=_» (Term.app `affineSpan [`k (Term.app `range [`p])]) "=" (Order.BoundedOrder.«term⊤» "⊤"))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.tacticSuffices_
         ...
         (Term.sufficesDecl
          ...
          (Term.forall
           ...
           [(Term.simpleBinder [`i] [])]
           ","
           (Init.Core.«term_∈_» (Term.app `b.points [`i]) " ∈ " (Term.app `affineSpan [`k (Term.app `range [`p])])))
          (Term.byTactic
           "by"
           (Tactic.tacticSeq
            (Tactic.tacticSeq1Indented
             [(group
              ...
              (group
               (Tactic.rintro
                ...
                [])
               [])
              (group (Tactic.exact "exact" (Term.app `this [`i])) [])])))))
        [])
                  ...
                  (calcStep
                   ...
                   (Term.byTactic
                    ...
                    (Tactic.tacticSeq
                     (Tactic.tacticSeq1Indented
                      [(group
                        (Tactic.simpRw "simp_rw" (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Finset.mul_sum)] "]") [])
                        [])]))))
                  (calcStep
                   («term_=_»
                    (Term.hole "_")
                  ...
                  (calcStep
                   («term_=_»
                    ...
                    (Algebra.BigOperators.Basic.«term∑_,_»
                     ...
                     (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `l)] []))
                     ", "
                     (Term.app (Matrix.Data.Matrix.Basic.«term_⬝_» `A " ⬝ " (Term.app `b.to_matrix [`p])) [`i `l])))
                   ":="
                   `rfl)
                  (calcStep
                      ...
                      [(group
                        (Tactic.simp
                         ...
                         ["["
                          [(Tactic.simpLemma [] [] `hA)
                           ","
                           (Tactic.simpLemma [] [] `Matrix.one_apply)
                           ","
          ...
          (Term.haveIdDecl
           ...
           [(Term.typeSpec
             ...
             («term_=_»
              (Term.app `b.points [`i])
              "="
              (Term.app `finset.univ.affine_combination [`p (Term.app `A [`i])])))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(group (Tactic.apply "apply" `b.ext_elem) [])
               ...
               (group
                (Tactic.rwSeq
                 ...
                 (Tactic.rwRuleSeq
                  "["
                  [(Tactic.rwRule [] `b.coord_apply)
                   ","
                   (Tactic.rwRule
                    []
                    (Term.app `finset.univ.map_affine_combination [(Term.hole "_") (Term.hole "_") `hAi]))
                   ","
                   (Tactic.rwRule
                    []
                    (Term.app
                     `finset.univ.affine_combination_eq_linear_combination
                     [(Term.hole "_") (Term.hole "_") `hAi]))]
                  "]")
                 [])
                [])
               (group
                (Tactic.change
                 ...
                 («term_=_»
                  (Term.hole "_")
                  "="
                  (Term.app (Matrix.Data.Matrix.Basic.«term_⬝_» `A " ⬝ " (Term.app `b.to_matrix [`p])) [`i `j]))
                 [])
                [])
               (group
                (Tactic.simpRw
                 ...
                 (Tactic.rwRuleSeq
                  ...
                  [(Tactic.rwRule [] `hA)
                   ","
                   (Tactic.rwRule [] `Matrix.one_apply)
                   ","
                   (Tactic.rwRule [] (Term.app (Term.explicit "@" `eq_comm) [(Term.hole "_") `i `j]))]
                  "]")
                 [])
                [])
       ...
       (group (Tactic.exact "exact" (Term.app `affine_combination_mem_affine_span [`hAi `p])) [])])))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
           ...
           (Tactic.tacticSeq1Indented
            [(group
              (Tactic.rwSeq
               ...
               (Tactic.rwRuleSeq
                "["
                [(Tactic.rwRule [] `eq_top_iff) "," (Tactic.rwRule ["←"] `b.tot) "," (Tactic.rwRule [] `affine_span_le)]
                "]")
               [])
              [])
             (group
                  ...
                  («term_=_»
                   ...
                   (Algebra.BigOperators.Basic.«term∑_,_»
                    ...
                    (Algebra.BigOperators.Basic.«term∑_,_»
                     ...
                     (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `l)] []))
                     ", "
                     (Finset.Data.Finset.Fold.«term_*_» (Term.app `A [`i `j]) "*" (Term.app `b.to_matrix [`p `j `l])))))
                  ":="
                  (Term.byTactic
                   "by"
                   (Tactic.tacticSeq
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `affine_combination_mem_affine_span [`hAi `p]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `affine_combination_mem_affine_span [`hAi `p])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
  ...
  (Tactic.tacticHave_
   ...
   (Term.haveDecl
    (Term.haveIdDecl
     ...
     [(Term.typeSpec
       ":"
       («term_=_» (Term.app `b.points [`i]) "=" (Term.app `finset.univ.affine_combination [`p (Term.app `A [`i])])))]
     ":="
     (Term.byTactic
      "by"
      (Tactic.tacticSeq
         ...
         (group
          (Tactic.rwSeq
           ...
           (Tactic.rwRuleSeq
            ...
            [(Tactic.rwRule [] `b.coord_apply)
             ","
             (Tactic.rwRule [] (Term.app `finset.univ.map_affine_combination [(Term.hole "_") (Term.hole "_") `hAi]))
             ","
             (Tactic.rwRule
              []
              (Term.app `finset.univ.affine_combination_eq_linear_combination [(Term.hole "_") (Term.hole "_") `hAi]))]
            "]")
           [])
          [])
         (group
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.explicit "@" `eq_comm) [(Term.hole "_") `i `j])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `finset.univ.affine_combination
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 51 >? 1022, (some 1023, term) <=? (none, [anonymous])
        ...
        [(calcStep
         ...
         (calcStep
          ...
          (Term.byTactic
           ...
           (Tactic.tacticSeq
            (Tactic.tacticSeq1Indented
             [(group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Finset.sum_comm)] "]") []) [])]))))
         (calcStep
          («term_=_»
           (Term.hole "_")
           "="
   ...
   [(calcStep
    ...
    (calcStep
     ...
     (Term.byTactic
      ...
      (Tactic.tacticSeq
       (Tactic.tacticSeq1Indented
        [(group (Tactic.simpRw "simp_rw" (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Finset.mul_sum)] "]") []) [])]))))
    (calcStep
     («term_=_»
      (Term.hole "_")
      "="
...
/--
  ...
  theorem
    ...
    [ DecidableEq ι ] [ Nontrivial k ] ( p : ι' → P ) { A : Matrix ι ι' k } ( hA : A ⬝ b.to_matrix p = 1 )
      : affineSpan k range p = ⊤
    :=
      by
        suffices
            ∀ i , b.points i ∈ affineSpan k range p
              by rw [ eq_top_iff , ← b.tot , affine_span_le ] rintro q ⟨ i , rfl ⟩ exact this i
          intro i
          have
            hAi
              : ∑ j , A i j = 1
          ...
          have
            hbi
              : b.points i = finset.univ.affine_combination p A i
              :=
              by
                apply b.ext_elem
                  intro j
                  rw
                    [
                      b.coord_apply
                        ,
                        finset.univ.map_affine_combination _ _ hAi
                        ,
...
@[simp]
theorem to_matrix_vec_mul_coords (x : P) : (b.to_matrix b₂.points).vecMul (b₂.coords x) = b.coords x := by
  ext j
...
theorem to_matrix_mul_to_matrix : b.to_matrix b₂.points ⬝ b₂.to_matrix b.points = 1 := by
  ext l m
...
theorem is_unit_to_matrix_iff [Nontrivial k] (p : ι → P) :
    IsUnit (b.to_matrix p) ↔ AffineIndependent k p ∧ affineSpan k (range p) = ⊤ := by
  constructor
  ·
...
theorem det_smul_coords_eq_cramer_coords (x : P) :
    (b.to_matrix b₂.points).det • b₂.coords x = (b.to_matrix b₂.points)ᵀ.cramer (b.coords x) := by
  have hu := b.is_unit_to_matrix b₂
  rw [Matrix.is_unit_iff_is_unit_det] at hu
