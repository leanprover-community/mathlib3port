...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " The finrank of the direct sum is the sum of the finranks. -/")]
 ...
 (Command.theorem
  "theorem"
  (Command.declId `finrank_direct_sum [])
  (Command.declSig
   [(Term.implicitBinder "{" [`ι] [":" (Term.type "Type" [`v])] "}")
    ...
    (Term.instBinder
     ...
     (Term.forall
      ...
      [(Term.simpleBinder [`i] [(Term.typeSpec ":" `ι)])]
      ","
      (Term.app `Module.Finite [`R (Term.app `M [`i])]))
     "]")]
   (Term.typeSpec
    ":"
    («term_=_»
     ...
     (Algebra.BigOperators.Basic.«term∑_,_»
      ...
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
      ", "
      (Term.app `finrank [`R (Term.app `M [`i])])))))
    ...
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.tacticLet_
         "let"
         (Term.letDecl (Term.letIdDecl `this' [] [] ":=" (Term.app `nontrivial_of_invariant_basis_number [`R]))))
        [])
       (group
        (Tactic.simp
         "simp"
           ...
           (Tactic.simpLemma
            ...
            (Term.fun
             ...
             (Term.basicFun
              [(Term.simpleBinder [`i] [])]
              "=>"
              (Term.app `rank_eq_card_choose_basis_index [`R (Term.app `M [`i])]))))
           ","
           (Tactic.simpLemma [] [] `rank_direct_sum)
           ","
           (Tactic.simpLemma [] ["←"] `mk_sigma)
           ","
           (Tactic.simpLemma [] [] `mk_to_nat_eq_card)
           ","
           (Tactic.simpLemma [] [] `card_sigma)]
          "]"]
         [])
        [])])))
   [])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `nontrivial_of_invariant_basis_number [`R])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
/-- The finrank of the direct sum is the sum of the finranks. -/ @[ simp ]
  theorem
    finrank_direct_sum
    { ι : Type v }
        [ Fintype ι ]
        ...
        let this' := nontrivial_of_invariant_basis_number R
          simp
            ...
            [
              finrank
                ,
                fun i => rank_eq_card_choose_basis_index R M i
                ,
                rank_direct_sum
                ,
                ← mk_sigma
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " The finrank of a finite product is the sum of the finranks. -/")]
  []
  []
  []
  []
 ...
 (Command.theorem
  "theorem"
  (Command.declId `finrank_pi_fintype [])
  (Command.declSig
   [(Term.implicitBinder "{" [`ι] [":" (Term.type "Type" [`v])] "}")
    (Term.instBinder "[" [] (Term.app `Fintype [`ι]) "]")
    (Term.implicitBinder "{" [`M] [":" (Term.arrow `ι "→" (Term.type "Type" [`w]))] "}")
    (Term.instBinder
     "["
     []
     (Term.forall
   ...
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app `finrank [`R (Term.forall "∀" [(Term.simpleBinder [`i] [])] "," (Term.app `M [`i]))])
     "="
     (Algebra.BigOperators.Basic.«term∑_,_»
      "∑"
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
           ...
           (Tactic.simpLemma
            ...
            (Term.fun
             ...
             (Term.basicFun
              ...
              (Term.app `rank_eq_card_choose_basis_index [`R (Term.app `M [`i])]))))
           ","
           (Tactic.simpLemma [] [] `rank_pi_fintype)
           ","
           (Tactic.simpLemma [] ["←"] `mk_sigma)
           ","
           (Tactic.simpLemma [] [] `mk_to_nat_eq_card)
