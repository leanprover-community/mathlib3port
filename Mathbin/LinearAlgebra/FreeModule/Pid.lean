...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `Submodule.basis_of_pid_aux [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `Fintype [`ι]) "]")
    (Term.implicitBinder "{" [`O] [":" (Term.type "Type" [(Level.hole "_")])] "}")
    (Term.instBinder "[" [] (Term.app `AddCommGroupₓ [`O]) "]")
    (Term.instBinder "[" [] (Term.app `Module [`R `O]) "]")
    (Term.explicitBinder "(" [`M `N] [":" (Term.app `Submodule [`R `O])] [] ")")
    (Term.explicitBinder "(" [`b'M] [":" (Term.app `Basis [`ι `R `M])] [] ")")
    (Term.explicitBinder "(" [`N_bot] [":" («term_≠_» `N "≠" (Order.BoundedOrder.«term⊥» "⊥"))] [] ")")
    (Term.explicitBinder "(" [`N_le_M] [":" («term_≤_» `N "≤" `M)] [] ")")]
   (Term.typeSpec
    ":"
    (Mathlib.ExtendedBinder.«term∃___,_»
     ...
     («term∃_,_»
      ...
      (Lean.explicitBinders
       [(Lean.bracketedExplicitBinders "(" [(Lean.binderIdent `a)] ":" `R ")")
        (Lean.bracketedExplicitBinders
         "("
         [(Lean.binderIdent `hay)]
         ":"
         (Init.Core.«term_∈_» (Algebra.Group.Defs.«term_•_» `a " • " `y) " ∈ " `N)
         ")")])
      ","
      (Mathlib.ExtendedBinder.«term∃___,_»
       "∃"
       `M'
       (Mathlib.ExtendedBinder.«binderTerm≤_» "≤" `M)
       ","
       (Mathlib.ExtendedBinder.«term∃___,_»
        "∃"
        `N'
        ...
        («term∃_,_»
         "∃"
         (Lean.explicitBinders
          [(Lean.bracketedExplicitBinders "(" [(Lean.binderIdent `N'_le_M')] ":" («term_≤_» `N' "≤" `M') ")")
           (Lean.bracketedExplicitBinders
            "("
            [(Lean.binderIdent `y_ortho_M')]
            ":"
            (Term.forall
             "∀"
             [(Term.simpleBinder [`c] [(Term.typeSpec ":" `R)]) (Term.simpleBinder [`z] [(Term.typeSpec ":" `O)])]
             ","
             (Term.arrow
              (Init.Core.«term_∈_» `z " ∈ " `M')
              "→"
              (Term.arrow
               («term_=_» (Init.Logic.«term_+_» (Algebra.Group.Defs.«term_•_» `c " • " `y) "+" `z) "=" (numLit "0"))
               "→"
               («term_=_» `c "=" (numLit "0")))))
            ")")
           (Lean.bracketedExplicitBinders
            "("
            [(Lean.binderIdent `ay_ortho_N')]
            ":"
            (Term.forall
             "∀"
             [(Term.simpleBinder [`c] [(Term.typeSpec ":" `R)]) (Term.simpleBinder [`z] [(Term.typeSpec ":" `O)])]
             ","
             (Term.arrow
              (Init.Core.«term_∈_» `z " ∈ " `N')
              "→"
              (Term.arrow
               («term_=_»
                (Init.Logic.«term_+_»
                 (Algebra.Group.Defs.«term_•_» `c " • " (Algebra.Group.Defs.«term_•_» `a " • " `y))
                 "+"
                 `z)
                "="
                (numLit "0"))
         ...
         (Term.forall
          "∀"
          [(Term.simpleBinder [`n'] [])
           (Term.simpleBinder [`bN'] [(Term.typeSpec ":" (Term.app `Basis [(Term.app `Finₓ [`n']) `R `N']))])]
          ","
          («term∃_,_»
           "∃"
           (Lean.explicitBinders
            (Lean.unbracketedExplicitBinders
             [(Lean.binderIdent `bN)]
             [":" (Term.app `Basis [(Term.app `Finₓ [(Init.Logic.«term_+_» `n' "+" (numLit "1"))]) `R `N])]))
           ","
           (Term.forall
            "∀"
            [(Term.simpleBinder [`m'] [])
             (Term.simpleBinder [`hn'm'] [(Term.typeSpec ":" («term_≤_» `n' "≤" `m'))])
             (Term.simpleBinder [`bM'] [(Term.typeSpec ":" (Term.app `Basis [(Term.app `Finₓ [`m']) `R `M']))])]
            ","
            («term∃_,_»
             "∃"
             (Lean.explicitBinders
              [(Lean.bracketedExplicitBinders
                "("
                [(Lean.binderIdent `hnm)]
                ":"
                («term_≤_» (Init.Logic.«term_+_» `n' "+" (numLit "1")) "≤" (Init.Logic.«term_+_» `m' "+" (numLit "1")))
                ")")
               (Lean.bracketedExplicitBinders
                "("
                [(Lean.binderIdent `bM)]
                ":"
                (Term.app `Basis [(Term.app `Finₓ [(Init.Logic.«term_+_» `m' "+" (numLit "1"))]) `R `M])
                ")")])
             ","
             (Term.forall
              "∀"
              [(Term.simpleBinder [`as] [(Term.typeSpec ":" (Term.arrow (Term.app `Finₓ [`n']) "→" `R))])
               (Term.simpleBinder
                [`h]
                [(Term.typeSpec
                  ":"
                  (Term.forall
                   ...
                   ","
                   («term_=_»
                    (Term.paren "(" [(Term.app `bN' [`i]) [(Term.typeAscription ":" `O)]] ")")
                    "="
                    (Algebra.Group.Defs.«term_•_»
                     ...
                     (Term.paren
                      "("
                      [(Term.app `bM' [(Term.app `Finₓ.castLe [`hn'm' `i])]) [(Term.typeAscription ":" `O)]]
                      ")")))))])]
              ","
              («term∃_,_»
               "∃"
               (Lean.explicitBinders
                (Lean.unbracketedExplicitBinders
                 [(Lean.binderIdent `as')]
                 [":" (Term.arrow (Term.app `Finₓ [(Init.Logic.«term_+_» `n' "+" (numLit "1"))]) "→" `R)]))
               ","
               (Term.forall
                "∀"
                [(Term.simpleBinder
                  [`i]
                  [(Term.typeSpec ":" (Term.app `Finₓ [(Init.Logic.«term_+_» `n' "+" (numLit "1"))]))])]
                ","
                («term_=_»
                 (Term.paren "(" [(Term.app `bN [`i]) [(Term.typeAscription ":" `O)]] ")")
                 "="
                 (Algebra.Group.Defs.«term_•_»
                  ...
                  (Term.paren
                   "("
                   [(Term.app `bM [(Term.app `Finₓ.castLe [`hnm `i])]) [(Term.typeAscription ":" `O)]]
                   ")")))))))))))))))))
      ...
      [(group
           ...
           [(Term.typeSpec
             ...
             («term∃_,_»
              ...
              (Lean.explicitBinders
               (Lean.unbracketedExplicitBinders
                [(Lean.binderIdent `ϕ)]
                [":" (Algebra.Module.LinearMap.«term_→ₗ[_]_» `M " →ₗ[" `R "] " `R)]))
              ","
              (Term.forall
               "∀"
               [(Term.simpleBinder
                 [`ψ]
                 [(Term.typeSpec ":" (Algebra.Module.LinearMap.«term_→ₗ[_]_» `M " →ₗ[" `R "] " `R))])]
               ","
               (Term.arrow
                («term_≤_» (Term.app `ϕ.submodule_image [`N]) "≤" (Term.app `ψ.submodule_image [`N]))
                "→"
                («term_=_» (Term.app `ψ.submodule_image [`N]) "=" (Term.app `ϕ.submodule_image [`N]))))))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
                 ...
                 [(Tactic.rcasesPatMed
                   [(Tactic.rcasesPat.tuple
                     ...
                     [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `P)]) [])
                      ","
                      (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `P_eq)]) [])
                      ","
                      (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `P_max)]) [])]
                     "⟩")])]
                 []
                 [":="
                  [(Term.app
                    `set_has_maximal_iff_noetherian.mpr
                    [(Term.paren "(" [`inferInstance [(Term.typeAscription ":" (Term.app `IsNoetherian [`R `R]))]] ")")
                     (Term.hole "_")
                     (Term.show
                      "show"
                      (Term.proj
                      ...
                      (Term.fromTerm
                       ...
                       (Term.anonymousCtor
                        ...
                        [(Term.hole "_")
                         ","
                         (Term.app `set.mem_range.mpr [(Term.anonymousCtor "⟨" [(numLit "0") "," `rfl] "⟩")])]
                        "⟩")))])]])
                [])
               (group
                (Tactic.obtain
                 ...
                 [(Tactic.rcasesPatMed
                   [(Tactic.rcasesPat.tuple
                     "⟨"
                     [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `ϕ)]) [])
                      ","
                      (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `rfl)]) [])]
                     "⟩")])]
                 []
                 [":=" [(Term.app `set.mem_range.mp [`P_eq])]])
                [])
               (group
                (Tactic.exact
                 "exact"
                 (Term.anonymousCtor
                  ...
                  [`ϕ
                   ...
                   (Term.fun
                    "fun"
                    (Term.basicFun
                     [(Term.simpleBinder [`ψ `hψ] [])]
                     "=>"
                     (Term.app `P_max [(Term.hole "_") (Term.anonymousCtor "⟨" [(Term.hole "_") "," `rfl] "⟩") `hψ])))]
                  "⟩"))
                [])]))))))
        [])
       (group (Tactic.tacticLet_ "let" (Term.letDecl (Term.letIdDecl `ϕ [] ":=" `this.some))) [])
       (group (Tactic.tacticHave_ "have" (Term.haveDecl (Term.haveIdDecl [`ϕ_max []] [] ":=" `this.some_spec))) [])
       (group
        (Tactic.tacticLet_
         "let"
         (Term.letDecl (Term.letIdDecl `a [] ":=" (Term.app `generator [(Term.app `ϕ.submodule_image [`N])]))))
        [])
       (group
        (Tactic.tacticHave_
         "have"
         (Term.haveDecl
          (Term.haveIdDecl
           [`a_mem []]
           [(Term.typeSpec ":" (Init.Core.«term_∈_» `a " ∈ " (Term.app `ϕ.submodule_image [`N])))]
           ":="
           (Term.app `generator_mem [(Term.hole "_")]))))
        [])
       (group (Tactic.byCases' "by_cases'" [`a_zero ":"] («term_=_» `a "=" (numLit "0"))) [])
       (group
        (Tactic.«tactic·._»
         "·"
         (Tactic.tacticSeq
             ...
             (Tactic.tacticHave_
              ...
              (Term.haveDecl
               (Term.haveIdDecl
                ...
                []
                ":="
                (Term.app `eq_bot_of_generator_maximal_submodule_image_eq_zero [`b'M `N_le_M `ϕ_max `a_zero]))))
             [])
         ...
         [(Tactic.rcasesPatMed
           [(Tactic.rcasesPat.tuple
             ...
             [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `y)]) [])
              ","
              (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `yN)]) [])
              ","
              (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `ϕy_eq)]) [])]
             "⟩")])]
         []
         [":=" [(Term.app (Term.proj (Term.app `LinearMap.mem_submodule_image_of_le [`N_le_M]) "." `mp) [`a_mem])]])
        [])
       (group
        (Tactic.tacticHave_
         "have"
         (Term.haveDecl
          (Term.haveIdDecl
           ...
           [(Term.typeSpec
             ":"
             («term_≠_»
              (Term.app `ϕ [(Term.anonymousCtor "⟨" [`y "," (Term.app `N_le_M [`yN])] "⟩")])
              "≠"
              (numLit "0")))]
           ":="
           (Term.fun
            ...
            (Term.basicFun
             [(Term.simpleBinder [`h] [])]
             "=>"
             (Term.app `a_zero [(Term.app `ϕy_eq.symm.trans [`h])]))))))
        [])
       (group
        (Tactic.tacticHave_
         "have"
           ...
           [(Term.typeSpec
             ...
             (Term.forall
              ...
              (Init.Core.«term_∣_»
               `a
               " ∣ "
               (Term.app `b'M.coord [`i (Term.anonymousCtor "⟨" [`y "," (Term.app `N_le_M [`yN])] "⟩")]))))]
           ":="
           (Term.fun
            "fun"
            (Term.basicFun
             ...
             (Term.app
              ...
              [`N_le_M `ϕ_max `y `yN `ϕy_eq (Term.app `b'M.coord [`i])]))))))
        [])
       (group (Tactic.choose "choose" [`c `hc] ["using" `hdvd]) [])
       (group
        (Tactic.tacticLet_
         "let"
         (Term.letDecl
          (Term.letIdDecl
           ...
           (Algebra.BigOperators.Basic.«term∑_,_»
            ...
            ", "
            (Algebra.Group.Defs.«term_•_» (Term.app `c [`i]) " • " (Term.app `b'M [`i]))))))
        [])
       (group
        (Tactic.tacticHave_
         "have"
         (Term.haveDecl
          (Term.haveIdDecl
           [`y'M []]
           [(Term.typeSpec ":" (Init.Core.«term_∈_» `y' " ∈ " `M))]
           ":="
           (Term.app
            `M.sum_mem
            [(Term.fun
              ...
              (Term.basicFun
               ...
               "=>"
               (Term.app `M.smul_mem [(Term.app `c [`i]) (Term.proj (Term.app `b'M [`i]) "." (fieldIdx "2"))])))]))))
        [])
       (group
        (Tactic.tacticHave_
         "have"
         (Term.haveDecl
          (Term.haveIdDecl
           ...
           [(Term.typeSpec
             ":"
             («term_=_»
              (Term.paren "(" [(Term.anonymousCtor "⟨" [`y' "," `y'M] "⟩") [(Term.typeAscription ":" `M)]] ")")
              "="
              (Algebra.BigOperators.Basic.«term∑_,_»
               "∑"
               (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
           ...
           (Term.app
            ...
            [(Term.show
              "show"
              («term_=_» `y' "=" (Term.app `M.subtype [(Term.hole "_")]))
              (Term.byTactic
               "by"
               (Tactic.tacticSeq
                (Tactic.tacticSeq1Indented
                 [(group
                   (Tactic.simp
                    ...
                    ["only"]
                    ["["
                     [(Tactic.simpLemma [] [] `LinearMap.map_sum) "," (Tactic.simpLemma [] [] `LinearMap.map_smul)]
                     "]"]
                    [])
                   [])
       ...
       (group
        (Tactic.tacticHave_
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           [`a_smul_y' []]
           [(Term.typeSpec ":" («term_=_» (Algebra.Group.Defs.«term_•_» `a " • " `y') "=" `y))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
              ...
              [(group
                  ...
                  [`coeₓ
                   (Term.show
                    ...
                    («term_=_»
                     (Term.paren
                      "("
                      [(Algebra.Group.Defs.«term_•_» `a " • " (Term.anonymousCtor "⟨" [`y' "," `y'M] "⟩"))
                       [(Term.typeAscription ":" `M)]]
                      ")")
                     "="
                     (Term.anonymousCtor "⟨" [`y "," (Term.app `N_le_M [`yN])] "⟩"))
               ...
               (group
                (Tactic.rwSeq
                 ...
                 (Tactic.rwRuleSeq
                  ...
                  [(Tactic.rwRule
                    ["←"]
                    (Term.app `b'M.sum_repr [(Term.anonymousCtor "⟨" [`y "," (Term.app `N_le_M [`yN])] "⟩")]))
                   ","
                   (Tactic.rwRule [] `mk_y')
                   ","
               ...
               (group
                (Tactic.rwSeq
                 "rw"
                 []
                 (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `mul_smul) "," (Tactic.rwRule ["←"] `hc)] "]")
                 [])
                [])
               (group (Tactic.tacticRfl "rfl") [])]))))))
        [])
       (group
        (Tactic.refine'
         ...
         (Term.anonymousCtor
          "⟨"
          [`y' "," `y'M "," `a "," (Term.subst `a_smul_y'.symm "▸" [`yN]) "," (Term.hole "_")]
          "⟩"))
        [])
       (group
        (Tactic.tacticHave_
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           ...
           [(Term.typeSpec
             ":"
             («term_=_» (Term.app `ϕ [(Term.anonymousCtor "⟨" [`y' "," `y'M] "⟩")]) "=" (numLit "1")))]
           ":="
           (Term.app
            `mul_left_cancel₀
            [`a_zero
             (calc
              ...
              [(calcStep
                («term_=_»
                 (Algebra.Group.Defs.«term_•_» `a " • " (Term.app `ϕ [(Term.anonymousCtor "⟨" [`y' "," `y'M] "⟩")]))
                 "="
                 (Term.app
                  `ϕ
                  [(Term.anonymousCtor "⟨" [(Algebra.Group.Defs.«term_•_» `a " • " `y') "," (Term.hole "_")] "⟩")]))
                ":="
                (Term.proj (Term.app `ϕ.map_smul [`a (Term.anonymousCtor "⟨" [`y' "," `y'M] "⟩")]) "." `symm))
               (calcStep
                («term_=_»
                 (Term.hole "_")
                 "="
                ...
                (Term.byTactic
                 ...
                 (Tactic.tacticSeq
                  (Tactic.tacticSeq1Indented
                   [(group (Tactic.simp "simp" [] ["only"] ["[" [(Tactic.simpLemma [] [] `a_smul_y')] "]"] []) [])]))))
               (calcStep («term_=_» (Term.hole "_") "=" `a) ":=" `ϕy_eq)
               (calcStep
                («term_=_» (Term.hole "_") "=" (Finset.Data.Finset.Fold.«term_*_» `a "*" (numLit "1")))
                ":="
                (Term.proj (Term.app `mul_oneₓ [`a]) "." `symm))])]))))
        [])
       (group
        (Tactic.tacticHave_
         "have"
         (Term.haveDecl
          (Term.haveIdDecl
           ...
           [(Term.typeSpec
             ":"
             («term_≠_» (Term.app `ϕ [(Term.anonymousCtor "⟨" [`y' "," `y'M] "⟩")]) "≠" (numLit "0")))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
       ...
       (group
        (Tactic.tacticLet_
         ...
         (Term.letDecl
          (Term.letIdDecl
           `M'
           [(Term.typeSpec ":" (Term.app `Submodule [`R `O]))]
           ":="
           (Term.app `ϕ.ker.map [`M.subtype]))))
        [])
       (group
        (Tactic.tacticLet_
         "let"
         (Term.letDecl
          (Term.letIdDecl
           ...
           ":="
           (Term.app
            (Term.proj (Term.proj (Term.app `ϕ.comp [(Term.app `of_le [`N_le_M])]) "." `ker) "." `map)
            [`N.subtype]))))
        [])
       (group
        (Tactic.tacticHave_
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           [`M'_le_M []]
           [(Term.typeSpec ":" («term_≤_» `M' "≤" `M))]
           ":="
           (Term.app `M.map_subtype_le [`ϕ.ker]))))
        [])
       (group
        (Tactic.tacticHave_
         "have"
              ...
              [(group (Tactic.intro "intro" [`x `hx]) [])
               (group
                (Tactic.simp
                 ...
                 []
                 ["only"]
                 ["[" [(Tactic.simpLemma [] [] `mem_map) "," (Tactic.simpLemma [] [] `LinearMap.mem_ker)] "]"]
                       ...
                       (Tactic.rcasesPatMed
                        [(Tactic.rcasesPat.tuple
                          ...
                          [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `x)]) [])
                           ","
                           (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `xN)]) [])]
                          "⟩")])
                       [])
                      ","
               ...
               (group
                (Tactic.exact
                 ...
                 (Term.anonymousCtor
                  "⟨"
                  [(Term.anonymousCtor "⟨" [`x "," (Term.app `N_le_M [`xN])] "⟩") "," `hx "," `rfl]
                  "⟩"))
                [])]))))))
        [])
       (group
        (Tactic.tacticHave_
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           ...
           ":="
           (Term.app `N.map_subtype_le [(Term.proj (Term.app `ϕ.comp [(Term.app `of_le [`N_le_M])]) "." `ker)]))))
        [])
       (group
        (Tactic.refine'
         "refine'"
         (Term.anonymousCtor "⟨" [`M' "," `M'_le_M "," `N' "," `N'_le_N "," `N'_le_M' "," (Term.hole "_")] "⟩"))
        [])
       (group
        (Tactic.tacticHave_
         "have"
         (Term.haveDecl
          (Term.haveIdDecl
           ...
           (Term.byTactic
            ...
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(group (Tactic.intro "intro" [`c `x `xM' `hc]) [])
               (group
                (Tactic.obtain
                 "obtain"
                 [(Tactic.rcasesPatMed
                   [(Tactic.rcasesPat.tuple
                     ...
                     [(Tactic.rcasesPatLo
                       (Tactic.rcasesPatMed
                        [(Tactic.rcasesPat.tuple
                          ...
                          [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `x)]) [])
                           ","
                           (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `xM)]) [])]
                          "⟩")])
                       [])
                      ","
                      (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `hx')]) [])
                     ...
                     "⟩")])]
                 []
                 [":=" [(Term.app `submodule.mem_map.mp [`xM'])]])
                [])
               (group
                (Tactic.rwSeq
                 "rw"
                   ...
                   [(Term.typeSpec
                     ...
                     («term_=_»
                      (Term.paren
                       "("
                       [(Init.Logic.«term_+_»
                         (Algebra.Group.Defs.«term_•_» `c " • " (Term.anonymousCtor "⟨" [`y' "," `y'M] "⟩"))
                         "+"
                         (Term.anonymousCtor "⟨" [`x "," `xM] "⟩"))
                        [(Term.typeAscription ":" `M)]]
                       ")")
                      "="
                      (numLit "0")))]
                   ":="
                   (Term.app `Subtype.coe_injective [`hc]))))
                [])
               (group
                (Tactic.simpa
                 "simpa"
                 ...
                 ["only"]
                 ["["
                  [(Tactic.simpLemma [] [] `LinearMap.map_add)
                   ","
                  ...
                  "]"]
                 []
                 ["using" (Term.app `congr_argₓ [`ϕ `hc'])])
                [])]))))))
        [])
       (group
        (Tactic.tacticHave_
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           ...
           (Term.byTactic
            ...
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(group (Tactic.intro "intro" [`c `z `zN' `hc]) [])
               (group
                (Tactic.refine'
                 "refine'"
                 (Term.app
                  (Term.proj
                   (Term.app
                    ...
                    [(Term.app
                      `y'_ortho_M'
                      [(Finset.Data.Finset.Fold.«term_*_» `a "*" `c) `z (Term.app `N'_le_M' [`zN']) (Term.hole "_")])])
                   "."
                   `resolve_left)
                  [`a_zero]))
                [])
               (group
                (Tactic.rwSeq
                 ...
                 (Tactic.rwRuleSeq
                  "["
                  [(Tactic.rwRule [] `mul_commₓ) "," (Tactic.rwRule [] `mul_smul) "," (Tactic.rwRule [] `hc)]
                  "]")
                 [])
                [])]))))))
        [])
         ...
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group
             (Tactic.refine'
              "refine'"
              (Term.app `Basis.mkFinConsOfLe [`y `yN `bN' `N'_le_N (Term.hole "_") (Term.hole "_")]))
             [])
            (group
             (Tactic.«tactic·._»
              "·"
              (Tactic.tacticSeq
               (Tactic.tacticSeq1Indented
                [(group (Tactic.intro "intro" [`c `z `zN' `hc]) [])
                 (group (Tactic.refine' "refine'" (Term.app `ay'_ortho_N' [`c `z `zN' (Term.hole "_")])) [])
                 (group
                  (tacticRwa__
                   "rwa"
                   (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `a_smul_y')] "]")
            ...
            (group
                  ...
                  (Tactic.obtain
                   ...
                   [":"
                    (Init.Core.«term_∣_»
                     (Term.hole "_")
                     " ∣ "
                     (Term.app `ϕ [(Term.anonymousCtor "⟨" [`z "," (Term.app `N_le_M [`zN])] "⟩")]))]
                   [":=" [(Term.app `generator_submodule_image_dvd_of_mem [`N_le_M `ϕ `zN])]])
                  [])
                 (group
                  (Tactic.refine'
                   "refine'"
                    ...
                    [(«term-_» "-" `b)
                     ...
                     (Term.app
                      ...
                      [(Term.anonymousCtor
                        ...
                        [(Term.anonymousCtor
                          "⟨"
                          [(Term.hole "_") "," (Term.app `N.sub_mem [`zN (Term.app `N.smul_mem [`b `yN])])]
                          "⟩")
                         ","
                         (Term.hole "_")
                         ","
                     ...
                     [(group
                         ...
                         [(Term.show
                           ...
                           («term_=_»
                            (Term.app
                             `ϕ
                             [(«term_-_»
                               (Term.anonymousCtor "⟨" [`z "," (Term.app `N_le_M [`zN])] "⟩")
                               "-"
                               (Algebra.Group.Defs.«term_•_»
                                `b
                                " • "
                      ...
                      (group
                       (Tactic.rwSeq
                        ...
                        (Tactic.rwRuleSeq
                         "["
                         [(Tactic.rwRule [] `LinearMap.map_sub)
                          ","
                    ...
                    (Tactic.tacticSeq1Indented
                     [(group
                       (Tactic.simp
                        ...
                        []
                        ["only"]
                        ["[" [(Tactic.simpLemma [] [] `sub_eq_add_neg) "," (Tactic.simpLemma [] [] `neg_smul)] "]"]
                        [])
                       [])
                      (group (Tactic.tacticRfl "rfl") [])])))
                  [])])))
             [])])))
        [])
       (group (Tactic.intro "intro" [`m' `hn'm' `bM']) [])
       (group
        (Tactic.refine'
         "refine'"
         (Term.anonymousCtor "⟨" [(Term.app `Nat.succ_le_succₓ [`hn'm']) "," (Term.hole "_") "," (Term.hole "_")] "⟩"))
        [])
       (group
        (Tactic.«tactic·._»
         "·"
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group
             (Tactic.refine'
              "refine'"
              (Term.app `Basis.mkFinConsOfLe [`y' `y'M `bM' `M'_le_M `y'_ortho_M' (Term.hole "_")]))
             [])
            (group (Tactic.intro "intro" [`z `zM]) [])
            (group
             (Tactic.refine'
              "refine'"
              (Term.anonymousCtor
               "⟨"
               [(«term-_» "-" (Term.app `ϕ [(Term.anonymousCtor "⟨" [`z "," `zM] "⟩")]))
                ","
                (Term.anonymousCtor
                 "⟨"
                 [(«term_-_»
                   (Term.anonymousCtor "⟨" [`z "," `zM] "⟩")
                   "-"
                   (Algebra.Group.Defs.«term_•_»
                    (Term.app `ϕ [(Term.anonymousCtor "⟨" [`z "," `zM] "⟩")])
                    " • "
                    (Term.anonymousCtor "⟨" [`y' "," `y'M] "⟩")))
                  ","
                  (Term.app `linear_map.mem_ker.mpr [(Term.hole "_")])
                  ","
                  (Term.hole "_")]
                 "⟩")]
               "⟩"))
            ...
            (group
             ...
             [])])))
        [])
       (group (Tactic.intro "intro" [`as `h]) [])
       (group
        (Tactic.refine' "refine'" (Term.anonymousCtor "⟨" [(Term.app `Finₓ.cons [`a `as]) "," (Term.hole "_")] "⟩"))
        [])
       ...
       (group
        (Tactic.rwSeq
         ...
         (Tactic.rwRuleSeq
          "["
          [(Tactic.rwRule [] `Basis.coe_mk_fin_cons_of_le) "," (Tactic.rwRule [] `Basis.coe_mk_fin_cons_of_le)]
          "]")
         [])
        [])
       (group
          ...
          (Tactic.tacticSeq1Indented
           [(group
             (Tactic.simp
              ...
              []
              ["only"]
              ["[" [(Tactic.simpLemma [] [] `Finₓ.cons_zero) "," (Tactic.simpLemma [] [] `Finₓ.cast_le_zero)] "]"]
              [])
             [])
            (group (Tactic.exact "exact" `a_smul_y'.symm) [])])))
        [])
       (group
        (Tactic.«tactic·._»
         "·"
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Finₓ.cast_le_succ)] "]") []) [])
            (group
             (Tactic.simp
              "simp"
              []
       ...
       (Tactic.tacticHave_
        ...
        (Term.haveDecl
         (Term.haveIdDecl
          ...
          (Term.fun
           "fun"
           (Term.basicFun [(Term.simpleBinder [`h] [])] "=>" (Term.app `a_zero [(Term.app `ϕy_eq.symm.trans [`h])]))))))
       [])
      (group
       (Tactic.tacticHave_
        "have"
      ...
      (group
       (Tactic.tacticHave_
        ...
        (Term.haveDecl
         (Term.haveIdDecl
          [`ϕy'_eq []]
          [(Term.typeSpec ":" («term_=_» (Term.app `ϕ [(Term.anonymousCtor "⟨" [`y' "," `y'M] "⟩")]) "=" (numLit "1")))]
          ":="
          (Term.app
           `mul_left_cancel₀
           [`a_zero
      ...
      (group
       (Tactic.tacticHave_
        ...
        (Term.haveDecl
         (Term.haveIdDecl
          [`ϕy'_ne_zero []]
          [(Term.typeSpec ":" («term_≠_» (Term.app `ϕ [(Term.anonymousCtor "⟨" [`y' "," `y'M] "⟩")]) "≠" (numLit "0")))]
          ":="
          (Term.byTactic
           "by"
           (Tactic.tacticSeq
            (Tactic.tacticSeq1Indented
             [(group
               (Tactic.simpa "simpa" [] ["only"] ["[" [(Tactic.simpLemma [] [] `ϕy'_eq)] "]"] [] ["using" `one_ne_zero])
               [])]))))))
       [])
      (group
       (Tactic.tacticLet_
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Finₓ.cast_le_succ)] "]") [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" `a_smul_y'.symm)
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.refine'', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.anonymousCtor "⟨" [(Term.app `Finₓ.cons [`a `as]) "," (Term.hole "_")] "⟩")
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.«tactic·._»
   ...
   (Tactic.tacticSeq
    (Tactic.tacticSeq1Indented
     [(group
       (Tactic.refine' "refine'" (Term.app `Basis.mkFinConsOfLe [`y' `y'M `bM' `M'_le_M `y'_ortho_M' (Term.hole "_")]))
       [])
      (group (Tactic.intro "intro" [`z `zM]) [])
      (group
       (Tactic.refine'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Nat.succ_le_succₓ [`hn'm'])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.«tactic·._»
   ...
   (Tactic.tacticSeq
    (Tactic.tacticSeq1Indented
     [(group
       (Tactic.refine' "refine'" (Term.app `Basis.mkFinConsOfLe [`y `yN `bN' `N'_le_N (Term.hole "_") (Term.hole "_")]))
       [])
      (group
       (Tactic.«tactic·._»
        "·"
           ...
           («term_=_»
            (Term.app
             ...
             [(«term_-_»
               (Term.anonymousCtor "⟨" [`z "," (Term.app `N_le_M [`zN])] "⟩")
               "-"
               (Algebra.Group.Defs.«term_•_» `b " • " (Term.anonymousCtor "⟨" [`y "," (Term.app `N_le_M [`yN])] "⟩")))])
            "="
            (numLit "0"))
           (Term.fromTerm "from" (Term.hole "_")))]))
       [])
   ...
   (Term.anonymousCtor
    ...
    [(«term-_» "-" `b)
     ...
     (Term.app
      ...
      [(Term.anonymousCtor
        "⟨"
        [(Term.anonymousCtor "⟨" [(Term.hole "_") "," (Term.app `N.sub_mem [`zN (Term.app `N.smul_mem [`b `yN])])] "⟩")
         ","
         (Term.hole "_")
         ","
         (Term.hole "_")]
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `N.sub_mem [`zN (Term.app `N.smul_mem [`b `yN])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `N.smul_mem [`b `yN]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.refine' "refine'" (Term.app `ay'_ortho_N' [`c `z `zN' (Term.hole "_")]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.refine'', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `ay'_ortho_N' [`c `z `zN' (Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `y'_ortho_M' [(Finset.Data.Finset.Fold.«term_*_» `a "*" `c) `z (Term.app `N'_le_M' [`zN']) (Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `N'_le_M' [`zN']) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Finset.Data.Finset.Fold.«term_*_» `a "*" `c) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `y'_ortho_M'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(Term.app
   `y'_ortho_M'
   [(Term.paren "(" [(Finset.Data.Finset.Fold.«term_*_» `a "*" `c) []] ")")
    `z
    (Term.paren "(" [(Term.app `N'_le_M' [`zN']) []] ")")
    (Term.hole "_")])
  []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  ...
  (Term.forall
   ...
   (Mathlib.ExtendedBinder.«term∀___,_»
    ...
    (Term.forall
     ...
     (Term.arrow
      («term_=_»
       (Init.Logic.«term_+_» (Algebra.Group.Defs.«term_•_» `c " • " (Algebra.Group.Defs.«term_•_» `a " • " `y')) "+" `z)
       "="
       (numLit "0"))
      "→"
      («term_=_» `c "=" (numLit "0"))))))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Algebra.Group.Defs.«term_•_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Algebra.Group.Defs.«term_•_» `a " • " `y')
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Algebra.Group.Defs.«term_•_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `y'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Init.Logic.«term_+_»
   (Term.paren "(" [(Algebra.Group.Defs.«term_•_» `c " • " (Algebra.Group.Defs.«term_•_» `a " • " `y')) []] ")")
   "+"
   `z)
  []]
 ")")
...
[PrettyPrinter.parenthesize] ...precedences are 51 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 50, term))
  (Init.Logic.«term_+_» (Algebra.Group.Defs.«term_•_» `c " • " `y') "+" `z)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Logic.«term_+_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `z
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Algebra.Group.Defs.«term_•_» `c " • " `y')
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Algebra.Group.Defs.«term_•_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `y'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 74 >? 1024, (none, [anonymous]) <=? (some 73, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 73, (some 73, term) <=? (some 1022, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Algebra.Group.Defs.«term_•_» `c " • " `y') []] ")")
[PrettyPrinter.parenthesize] ...precedences are 51 >? 1022, (some 0, term) <=? (some 50, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Init.Logic.«term_+_» (Term.paren "(" [(Algebra.Group.Defs.«term_•_» `c " • " `y') []] ")") "+" `z) []]
 ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 50, (some 51, term) <=? (some 25, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 25, (some 25, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 0, term) <=? (none, [anonymous])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Term.app `ϕ.comp [(Term.app `of_le [`N_le_M])]) "." `ker)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `ϕ.comp [(Term.app `of_le [`N_le_M])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `of_le [`N_le_M]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `ϕ.comp
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `ϕ.comp [(Term.paren "(" [(Term.app `of_le [`N_le_M]) []] ")")]) []]
 ")")
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `N.map_subtype_le
    ...
    (Tactic.tacticSeq1Indented
     [(group (Tactic.intro "intro" [`x `hx]) [])
      ...
      (group
       (Tactic.exact
        "exact"
        (Term.anonymousCtor "⟨" [(Term.anonymousCtor "⟨" [`x "," (Term.app `N_le_M [`xN])] "⟩") "," `hx "," `rfl] "⟩"))
       [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.byTactic', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.byTactic', expected 'Lean.Parser.Term.byTactic.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq', expected 'Lean.Parser.Tactic.tacticSeq.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.anonymousCtor "⟨" [`x "," (Term.app `N_le_M [`xN])] "⟩")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.anonymousCtor.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.proj (Term.proj (Term.app `ϕ.comp [(Term.app `of_le [`N_le_M])]) "." `ker) "." `map) [`N.subtype])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.tacticLet_
   "let"
   (Term.letDecl
    (Term.letIdDecl `M' [(Term.typeSpec ":" (Term.app `Submodule [`R `O]))] ":=" (Term.app `ϕ.ker.map [`M.subtype]))))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticLet_', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.letDecl', expected 'Lean.Parser.Term.letDecl.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.letIdDecl', expected 'Lean.Parser.Term.letIdDecl.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize] ...precedences are 51 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 50, term))
  (Term.app `ϕ [(Term.anonymousCtor "⟨" [`y' "," `y'M] "⟩")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.namedArgument'
      ...
      [`a_zero
       (calc
        ...
        [(calcStep
          ...
          (Term.proj (Term.app `ϕ.map_smul [`a (Term.anonymousCtor "⟨" [`y' "," `y'M] "⟩")]) "." `symm))
         (calcStep
          («term_=_» (Term.hole "_") "=" (Term.app `ϕ [(Term.anonymousCtor "⟨" [`y "," (Term.app `N_le_M [`yN])] "⟩")]))
          ":="
          (Term.byTactic
           "by"
           (Tactic.tacticSeq
    ...
    (calc
     ...
     [(calcStep
       («term_=_»
        (Algebra.Group.Defs.«term_•_» `a " • " (Term.app `ϕ [(Term.anonymousCtor "⟨" [`y' "," `y'M] "⟩")]))
        "="
        (Term.app `ϕ [(Term.anonymousCtor "⟨" [(Algebra.Group.Defs.«term_•_» `a " • " `y') "," (Term.hole "_")] "⟩")]))
       ":="
       (Term.proj (Term.app `ϕ.map_smul [`a (Term.anonymousCtor "⟨" [`y' "," `y'M] "⟩")]) "." `symm))
      (calcStep
       («term_=_» (Term.hole "_") "=" (Term.app `ϕ [(Term.anonymousCtor "⟨" [`y "," (Term.app `N_le_M [`yN])] "⟩")]))
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `mul_oneₓ [`a]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_=_» (Term.hole "_") "=" (Finset.Data.Finset.Fold.«term_*_» `a "*" (numLit "1")))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_=_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Finset.Data.Finset.Fold.«term_*_» `a "*" (numLit "1"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Finset.Data.Finset.Fold.«term_*_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (numLit "1")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'numLit', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.simp "simp" [] ["only"] ["[" [(Tactic.simpLemma [] [] `a_smul_y')] "]"] [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simp', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«]»', expected 'optional.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simpLemma', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simpLemma', expected 'Lean.Parser.Tactic.simpStar'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `ϕ.map_smul [`a (Term.anonymousCtor "⟨" [`y' "," `y'M] "⟩")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(calc
   ...
   [(calcStep
     ...
     ":="
     (Term.proj
      (Term.paren "(" [(Term.app `ϕ.map_smul [`a (Term.anonymousCtor "⟨" [`y' "," `y'M] "⟩")]) []] ")")
      "."
      `symm))
    (calcStep
     («term_=_» (Term.hole "_") "=" (Term.app `ϕ [(Term.anonymousCtor "⟨" [`y "," (Term.app `N_le_M [`yN])] "⟩")]))
    ...
    (calcStep
     («term_=_» (Term.hole "_") "=" (Finset.Data.Finset.Fold.«term_*_» `a "*" (numLit "1")))
     ":="
     (Term.proj (Term.paren "(" [(Term.app `mul_oneₓ [`a]) []] ")") "." `symm))])
  []]
 ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.refine'
   "refine'"
   (Term.anonymousCtor "⟨" [`y' "," `y'M "," `a "," (Term.subst `a_smul_y'.symm "▸" [`yN]) "," (Term.hole "_")] "⟩"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.refine'', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.anonymousCtor "⟨" [`y' "," `y'M "," `a "," (Term.subst `a_smul_y'.symm "▸" [`yN]) "," (Term.hole "_")] "⟩")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `mul_smul) "," (Tactic.rwRule ["←"] `hc)] "]") [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `hc
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq
   ...
   (Tactic.rwRuleSeq
    "["
    [(Tactic.rwRule ["←"] (Term.app `b'M.sum_repr [(Term.anonymousCtor "⟨" [`y "," (Term.app `N_le_M [`yN])] "⟩")]))
     ","
     (Tactic.rwRule [] `mk_y')
     ","
     (Tactic.rwRule [] `Finset.smul_sum)]
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, [anonymous]))
  («term_=_»
   (Term.paren
    "("
    [(Algebra.Group.Defs.«term_•_» `a " • " (Term.anonymousCtor "⟨" [`y' "," `y'M] "⟩")) [(Term.typeAscription ":" `M)]]
    ")")
   "="
   (Term.anonymousCtor "⟨" [`y "," (Term.app `N_le_M [`yN])] "⟩"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_=_»', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_=_» (Algebra.Group.Defs.«term_•_» `a " • " `y') "=" `y)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_=_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `y
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_=_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `M.subtype [(Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
    ...
    :=
      by
        have
            :
              ...
              by
                obtain
                    ...
                    :=
                      set_has_maximal_iff_noetherian.mpr
                        ( inferInstance : IsNoetherian R R )
                          _
                          show
                            Set.Range fun ψ : M →ₗ[ R ] R => ψ.submodule_image N . Nonempty
          ...
          by_cases' a_zero : a = 0
          · have := eq_bot_of_generator_maximal_submodule_image_eq_zero b'M N_le_M ϕ_max a_zero contradiction
          ...
          ·
            refine' Basis.mkFinConsOfLe y yN bN' N'_le_N _ _
              · intro c z zN' hc refine' ay'_ortho_N' c z zN' _ rwa [ ← a_smul_y' ] at hc
              ·
                intro z zN
          ...
          · simp only [ Finₓ.cons_zero , Finₓ.cast_le_zero ] exact a_smul_y'.symm
          · rw [ Finₓ.cast_le_succ ] simp only [ Finₓ.cons_succ , coe_of_le , h i ]
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `Submodule.basisOfPid [])
  (Command.optDeclSig
   ...
   [(Term.typeSpec
     ...
     (Init.Data.Sigma.Basic.«termΣ_,_»
      ...
      ", "
      (Term.app `Basis [(Term.app `Finₓ [`n]) `R `N])))])
  (Command.declValSimple
   ":="
   (Term.anonymousCtor
    "⟨"
    [(Term.hole "_") "," (Term.proj (Term.proj (Term.app `N.nonempty_basis_of_pid [`b]) "." `some_spec) "." `some)]
    "⟩")
   [])
  []
  []
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Term.proj (Term.app `N.nonempty_basis_of_pid [`b]) "." `some_spec) "." `some)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.proj (Term.app `N.nonempty_basis_of_pid [`b]) "." `some_spec)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `N.nonempty_basis_of_pid [`b])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `N.nonempty_basis_of_pid
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `N.nonempty_basis_of_pid [`b]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
/--
  ...
  def
    ...
    { ι : Type _ } [ Fintype ι ] ( b : Basis ι R M ) ( N : Submodule R M ) : Σ n : ℕ , Basis Finₓ n R N
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `Submodule.basisOfPidOfLe [])
  (Command.optDeclSig
   [(Term.implicitBinder "{" [`ι] [":" (Term.type "Type" [(Level.hole "_")])] "}")
    (Term.instBinder "[" [] (Term.app `Fintype [`ι]) "]")
    (Term.implicitBinder "{" [`N `O] [":" (Term.app `Submodule [`R `M])] "}")
    (Term.explicitBinder "(" [`hNO] [":" («term_≤_» `N "≤" `O)] [] ")")
    (Term.explicitBinder "(" [`b] [":" (Term.app `Basis [`ι `R `O])] [] ")")]
   [(Term.typeSpec
     ":"
     (Init.Data.Sigma.Basic.«termΣ_,_»
      "Σ"
  ...
  (Command.declValSimple
   ...
   (Term.let
    ...
    (Term.letDecl
     (Term.letPatDecl
      (Term.anonymousCtor "⟨" [`n "," `bN'] "⟩")
      []
      []
      ":="
      (Term.app `Submodule.basisOfPid [`b (Term.app `N.comap [`O.subtype])])))
    []
    (Term.anonymousCtor "⟨" [`n "," (Term.app `bN'.map [(Term.app `Submodule.comapSubtypeEquivOfLe [`hNO])])] "⟩"))
   [])
  []
  []
  []))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `bN'.map [(Term.app `Submodule.comapSubtypeEquivOfLe [`hNO])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Submodule.comapSubtypeEquivOfLe [`hNO])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Submodule.comapSubtypeEquivOfLe [`hNO]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `bN'.map
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `N.comap [`O.subtype]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
/--
    ...
    noncomputable
  def
    Submodule.basisOfPidOfLe
    { ι : Type _ } [ Fintype ι ] { N O : Submodule R M } ( hNO : N ≤ O ) ( b : Basis ι R O )
      : Σ n : ℕ , Basis Finₓ n R N
    := let ⟨ n , bN' ⟩ := Submodule.basisOfPid b N.comap O.subtype ⟨ n , bN'.map Submodule.comapSubtypeEquivOfLe hNO ⟩
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `Submodule.basisOfPidOfLeSpan [])
  (Command.optDeclSig
   [(Term.implicitBinder "{" [`ι] [":" (Term.type "Type" [(Level.hole "_")])] "}")
    (Term.instBinder "[" [] (Term.app `Fintype [`ι]) "]")
    (Term.implicitBinder "{" [`b] [":" (Term.arrow `ι "→" `M)] "}")
    (Term.explicitBinder "(" [`hb] [":" (Term.app `LinearIndependent [`R `b])] [] ")")
    (Term.implicitBinder "{" [`N] [":" (Term.app `Submodule [`R `M])] "}")
    (Term.explicitBinder
     "("
     [`le]
     [":" («term_≤_» `N "≤" (Term.app `Submodule.span [`R (Term.app `Set.Range [`b])]))]
     []
     ")")]
   [(Term.typeSpec
     ":"
     (Init.Data.Sigma.Basic.«termΣ_,_»
      ...
      ", "
      (Term.app `Basis [(Term.app `Finₓ [`n]) `R `N])))])
  (Command.declValSimple ":=" (Term.app `Submodule.basisOfPidOfLe [`le (Term.app `Basis.span [`hb])]) [])
  []
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Submodule.basisOfPidOfLe [`le (Term.app `Basis.span [`hb])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Basis.span [`hb]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
/--
    ...
    noncomputable
  def
    Submodule.basisOfPidOfLeSpan
    { ι : Type _ }
        [ Fintype ι ]
        { b : ι → M }
        ( hb : LinearIndependent R b )
        { N : Submodule R M }
        ( le : N ≤ Submodule.span R Set.Range b )
      : Σ n : ℕ , Basis Finₓ n R N
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " A finite type torsion free module over a PID is free. -/")]
  []
  []
  [(Command.noncomputable "noncomputable")]
  []
 ...
 (Command.def
  "def"
  (Command.declId `Module.freeOfFiniteTypeTorsionFree [])
  (Command.optDeclSig
   [(Term.instBinder "[" [] (Term.app `Fintype [`ι]) "]")
    (Term.implicitBinder "{" [`s] [":" (Term.arrow `ι "→" `M)] "}")
    (Term.explicitBinder
     "("
     [`hs]
     [":" («term_=_» (Term.app `span [`R (Term.app `range [`s])]) "=" (Order.BoundedOrder.«term⊤» "⊤"))]
     []
     ")")
    (Term.instBinder "[" [] (Term.app `NoZeroSmulDivisors [`R `M]) "]")]
   [(Term.typeSpec
     ":"
     (Init.Data.Sigma.Basic.«termΣ_,_»
      "Σ"
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `n)] [":" (termℕ "ℕ")]))
      ", "
      (Term.app `Basis [(Term.app `Finₓ [`n]) `R `M])))])
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
     ...
     (Tactic.tacticSeq1Indented
      [(group (Tactic.classical "classical") [])
       (group
        (Tactic.tacticHave_
         "have"
         (Term.haveDecl (Term.haveIdDecl [] [] ":=" (Term.app `exists_maximal_independent [`R `s]))))
        [])
       (group
        (Tactic.tacticLet_
         "let"
         (Term.letDecl (Term.letIdDecl `I [(Term.typeSpec ":" (Term.app `Set [`ι]))] ":=" `this.some)))
        [])
       (group
        (Tactic.obtain
         "obtain"
         [(Tactic.rcasesPatMed
           [(Tactic.rcasesPat.tuple
             "⟨"
             [(Tactic.rcasesPatLo
               (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `indepI)])
               [":"
                (Term.app
                 `LinearIndependent
                 [`R
              ...
              ","
              (Tactic.rcasesPatLo
               (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `hI)])
               [":"
                (Term.forall
                 "∀"
                 [(Term.simpleBinder [`i] [])
                  (Term.simpleBinder [(Term.hole "_")] [(Term.typeSpec ":" (Init.Core.«term_∉_» `i " ∉ " `I))])]
                 ","
                 («term∃_,_»
                  "∃"
                  ...
                  («term_∧_»
                   ...
                   "∧"
                   (Init.Core.«term_∈_»
                    (Algebra.Group.Defs.«term_•_» `a " • " (Term.app `s [`i]))
                    " ∈ "
                    (Term.app `span [`R (Set.Data.Set.Basic.term_''_ `s " '' " `I)])))))])]
             "⟩")])]
         []
         [":=" [`this.some_spec]])
        [])
          ...
          (Term.letIdDecl
           ...
           (Term.fun
            ...
            (Term.basicFun
             ...
             (Term.anonymousCtor
              "⟨"
              [(Term.app `s [(Term.proj `i "." (fieldIdx "1"))])
               ","
               (Term.app `subset_span [(Term.app `mem_range_self [`i])])]
              "⟩"))))))
        [])
       (group (Tactic.let'' "let" [`sI_basis []] [(Term.typeSpec ":" (Term.app `Basis [`I `R `N]))]) [])
       (group (Tactic.exact "exact" (Term.app `Basis.span [`indepI])) [])
       (group
        (Tactic.tacticHave_
         "have"
         (Term.haveDecl
             ...
             (Term.forall
              ...
              («term∃_,_»
               ...
               («term_∧_»
                («term_≠_» `a "≠" (numLit "0"))
                "∧"
                (Init.Core.«term_∈_» (Algebra.Group.Defs.«term_•_» `a " • " (Term.app `s [`i])) " ∈ " `N)))))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(group (Tactic.intro "intro" [`i]) [])
               (group (Tactic.byCases' "by_cases'" [`hi ":"] (Init.Core.«term_∈_» `i " ∈ " `I)) [])
               (group
                (Tactic.«tactic·._»
                 "·"
                 (Tactic.tacticSeq
                  (Tactic.tacticSeq1Indented
                   [(group (Tactic.use "use" [(numLit "1") "," `zero_ne_one.symm]) [])
                    (group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `one_smul)] "]") []) [])
                    (group
                     (Tactic.exact
                      "exact"
                      (Term.app
                       ...
                       [(Term.app
                         ...
                         [(Term.paren
                           "("
                           [(Term.anonymousCtor "⟨" [`i "," `hi] "⟩") [(Term.typeAscription ":" `I)]]
                           ")")])]))
                     [])])))
                [])
               (group
                  ...
                  (Tactic.tacticSeq1Indented
                   [(group
                     (Tactic.simpa
                      ...
                      []
                      []
                      ["[" [(Tactic.simpLemma [] [] (Term.app `image_eq_range [`s `I]))] "]"]
                      []
                      ["using" (Term.app `hI [`i `hi])])
                     [])])))
                [])]))))))
        [])
       (group (Tactic.choose "choose" [`a `ha `ha'] ["using" `exists_a]) [])
       (group
        (Tactic.tacticLet_
         "let"
         (Term.letDecl
       ...
       (group
        (Tactic.tacticHave_
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           [`hA []]
           [(Term.typeSpec ":" («term_≠_» `A "≠" (numLit "0")))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(group
                (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Finset.prod_ne_zero_iff)] "]") [])
                [])
               (group (Tactic.simpa "simpa" [] [] [] [] ["using" `ha]) [])]))))))
        [])
       (group
        (Tactic.tacticLet_
         "let"
         (Term.letDecl
          (Term.letIdDecl
           `φ
           [(Term.typeSpec ":" (Algebra.Module.LinearMap.«term_→ₗ[_]_» `M " →ₗ[" `R "] " `M))]
           ":="
           (Term.app `LinearMap.lsmul [`R `M `A]))))
        [])
       (group
        (Tactic.have'' "have" [] [(Term.typeSpec ":" («term_=_» `φ.ker "=" (Order.BoundedOrder.«term⊥» "⊥")))])
        [])
       (group (Tactic.exact "exact" (Term.app `LinearMap.ker_lsmul [`hA])) [])
       (group
        (Tactic.tacticLet_
         "let"
         (Term.letDecl
          (Term.letIdDecl
           `ψ
           [(Term.typeSpec ":" (Data.Equiv.Module.«term_≃ₗ[_]_» `M " ≃ₗ[" `R "] " `φ.range))]
           ":="
           (Term.app `LinearEquiv.ofInjective [`φ (Term.app `linear_map.ker_eq_bot.mp [`this])]))))
        [])
       (group
        (Tactic.tacticHave_
         "have"
         (Term.haveDecl
          (Term.haveIdDecl
           []
           [(Term.typeSpec ":" («term_≤_» `φ.range "≤" `N))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
                ...
                (Tactic.tacticSuffices_
                 ...
                 (Term.sufficesDecl
                  ...
                  (Term.forall
                   ...
                   [(Term.simpleBinder [`i] [])]
                   ","
                   (Init.Core.«term_∈_» (Term.app `φ [(Term.app `s [`i])]) " ∈ " `N))
                  (Term.byTactic
                   "by"
                   (Tactic.tacticSeq
                    (Tactic.tacticSeq1Indented
                     [(group
                       (Tactic.rwSeq
                        ...
                        (Tactic.rwRuleSeq
                         "["
                         [(Tactic.rwRule [] `LinearMap.range_eq_map)
                          ","
                          (Tactic.rwRule ["←"] `hs)
                          ","
                          (Tactic.rwRule [] `φ.map_span_le)]
                         "]")
                        [])
                       [])
                      (group
                   ...
                   («term_=_»
                    ...
                    (Algebra.Group.Defs.«term_•_»
                     (Algebra.BigOperators.Basic.«term∏_in_,_»
                      ...
                      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `j)] []))
                      " in "
                      (Order.BooleanAlgebra.«term_ᶜ» (Set.«term{_}» "{" [`i] "}") "ᶜ")
                      ", "
                      (Term.app `a [`j]))
                     " • "
                     (Algebra.Group.Defs.«term_•_» (Term.app `a [`i]) " • " (Term.app `s [`i]))))
                   ":="
                   (Term.byTactic
                    "by"
                    (Tactic.tacticSeq
                     (Tactic.tacticSeq1Indented
                      [(group
                        (Tactic.rwSeq
                         ...
                         (Tactic.rwRuleSeq
                          "["
                          [(Tactic.rwRule [] (Term.app `Fintype.prod_eq_prod_compl_mul [`i]))
                           ","
                        ...
                        [])]))))
                  (calcStep
                   (Init.Core.«term_∈_» (Term.hole "_") " ∈ " `N)
                   ":="
                   (Term.app `N.smul_mem [(Term.hole "_") (Term.app `ha' [`i])]))])
                [])]))))))
        [])
       (group
        (Tactic.obtain
         ...
         [(Tactic.rcasesPatMed
           [(Tactic.rcasesPat.tuple
             ...
             [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `n)]) [])
              ","
              (Tactic.rcasesPatLo
               (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `b)])
               [":" (Term.app `Basis [(Term.app `Finₓ [`n]) `R `φ.range])])]
             "⟩")])]
         []
         [":=" [(Term.app `Submodule.basisOfPidOfLe [`this `sI_basis])]])
        [])
       (group (Tactic.exact "exact" (Term.anonymousCtor "⟨" [`n "," (Term.app `b.map [`ψ.symm])] "⟩")) [])])))
   [])
  []
  []
  []))
       ...
       (Tactic.tacticLet_
        ...
        (Term.letDecl
         (Term.letIdDecl
          ...
          (Term.app `LinearMap.lsmul [`R `M `A]))))
       [])
      (group (Tactic.have'' "have" [] [(Term.typeSpec ":" («term_=_» `φ.ker "=" (Order.BoundedOrder.«term⊥» "⊥")))]) [])
      (group (Tactic.exact "exact" (Term.app `LinearMap.ker_lsmul [`hA])) [])
      (group
       (Tactic.tacticLet_
        "let"
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.anonymousCtor "⟨" [`n "," (Term.app `b.map [`ψ.symm])] "⟩"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.anonymousCtor "⟨" [`n "," (Term.app `b.map [`ψ.symm])] "⟩")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.anonymousCtor.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `b.map [`ψ.symm])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
            ...
            (Tactic.tacticSeq1Indented
             [(group
               (Tactic.rwSeq
                ...
                (Tactic.rwRuleSeq
                 "["
                 [(Tactic.rwRule [] (Term.app `Fintype.prod_eq_prod_compl_mul [`i])) "," (Tactic.rwRule [] `mul_smul)]
                 "]")
                [])
               [])]))))
         (calcStep
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Fintype.prod_eq_prod_compl_mul [`i])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.def', expected 'Lean.Parser.Command.structure.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.def', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
/-- A finite type torsion free module over a PID is free. -/ noncomputable
  def
    Module.freeOfFiniteTypeTorsionFree
    [ Fintype ι ] { s : ι → M } ( hs : span R range s = ⊤ ) [ NoZeroSmulDivisors R M ] : Σ n : ℕ , Basis Finₓ n R M
    :=
      by
        classical
          ...
          obtain
            ⟨
              indepI : LinearIndependent R ( s ∘ coeₓ : I → M )
                ,
                hI : ∀ i _ : i ∉ I , ∃ a : R , a ≠ 0 ∧ a • s i ∈ span R s '' I
              ⟩
            := this.some_spec
          ...
          have
            exists_a
              ...
              by
                intro i
                  by_cases' hi : i ∈ I
                  · use 1 , zero_ne_one.symm rw [ one_smul ] exact subset_span mem_range_self ( ⟨ i , hi ⟩ : I )
                  · simpa [ image_eq_range s I ] using hI i hi
          choose a ha ha' using exists_a
          let A := ∏ i , a i
          have hA : A ≠ 0 := by rw [ Finset.prod_ne_zero_iff ] simpa using ha
          ...
          have
            : φ.range ≤ N
              ...
              by
                suffices
                    ∀ i , φ s i ∈ N
                      by rw [ LinearMap.range_eq_map , ← hs , φ.map_span_le ] rintro _ ⟨ i , rfl ⟩ apply this
                  intro i
                  calc
                    ∏ j , a j • s i = ∏ j in { i } ᶜ , a j • a i • s i
                        :=
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  ...
  (Command.declId `Module.freeOfFiniteTypeTorsionFree' [])
  (Command.optDeclSig
   [(Term.instBinder "[" [] (Term.app `Module.Finite [`R `M]) "]")
    (Term.instBinder "[" [] (Term.app `NoZeroSmulDivisors [`R `M]) "]")]
   [(Term.typeSpec
     ":"
     (Init.Data.Sigma.Basic.«termΣ_,_»
  ...
  (Command.declValSimple
   ...
   (Term.app
    `Module.freeOfFiniteTypeTorsionFree
    [(Term.proj (Term.proj `Module.Finite.exists_fin "." `some_spec) "." `some_spec)])
   [])
  []
  []
  []))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.proj `Module.Finite.exists_fin "." `some_spec)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
...
/-- A finite type torsion free module over a PID is free. -/ noncomputable
  def
    Module.freeOfFiniteTypeTorsionFree'
    [ Module.Finite R M ] [ NoZeroSmulDivisors R M ] : Σ n : ℕ , Basis Finₓ n R M
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `Submodule.smithNormalFormOfLe [])
  (Command.optDeclSig
   [(Term.instBinder "[" [] (Term.app `Fintype [`ι]) "]")
    (Term.explicitBinder "(" [`b] [":" (Term.app `Basis [`ι `R `M])] [] ")")
    (Term.explicitBinder "(" [`N `O] [":" (Term.app `Submodule [`R `M])] [] ")")
    (Term.explicitBinder "(" [`N_le_O] [":" («term_≤_» `N "≤" `O)] [] ")")]
   [(Term.typeSpec
     ":"
     (Init.Data.Sigma.Basic.«termΣ_,_»
      "Σ"
      (Lean.explicitBinders
       (Lean.unbracketedExplicitBinders [(Lean.binderIdent `o) (Lean.binderIdent `n)] [":" (termℕ "ℕ")]))
      ", "
      (Term.app `Basis.SmithNormalForm [(Term.app `N.comap [`O.subtype]) (Term.app `Finₓ [`o]) `n])))])
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.choose
         "choose"
         [`n `o `hno `bO `bN `a `snf]
         ["using" (Term.app `N.exists_smith_normal_form_of_le [`b `O `N_le_O])])
        [])
       (group
        (Tactic.refine'
         "refine'"
         (Term.anonymousCtor
          ...
          [`o
           ...
           `bO
           ","
           (Term.app `bN.map [(Term.proj (Term.app `comap_subtype_equiv_of_le [`N_le_O]) "." `symm)])
           ","
           (Term.proj (Term.app `Finₓ.castLe [`hno]) "." `toEmbedding)
           ","
           `a
           ","
           (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`i] [])] "=>" (Term.hole "_")))]
       ...
       (group
        (Tactic.simp
         ...
         ["only"]
         ["["
          [(Tactic.simpLemma [] [] `snf)
           ","
           (Tactic.simpLemma [] [] `Basis.map_apply)
           ","
           (Tactic.simpLemma [] [] `Submodule.comap_subtype_equiv_of_le_symm_apply_coe_coe)
           ","
           (Tactic.simpLemma [] [] `Submodule.coe_smul_of_tower)
           ","
           (Tactic.simpLemma [] [] `RelEmbedding.coe_fn_to_embedding)]
          "]"]
         [])
        [])])))
   [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simpLemma', expected 'Lean.Parser.Tactic.simpErase'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `Submodule.comap_subtype_equiv_of_le_symm_apply_coe_coe
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simpLemma', expected 'sepBy.antiquot_scope'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Finₓ.castLe [`hno]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `bN.map [(Term.proj (Term.app `comap_subtype_equiv_of_le [`N_le_O]) "." `symm)])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Term.app `comap_subtype_equiv_of_le [`N_le_O]) "." `symm)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `comap_subtype_equiv_of_le [`N_le_O])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `comap_subtype_equiv_of_le [`N_le_O]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `bN.map
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'optional.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `N.exists_smith_normal_form_of_le [`b `O `N_le_O])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `N.exists_smith_normal_form_of_le
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Finₓ [`o]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
/--
  ...
  def
    ...
    [ Fintype ι ] ( b : Basis ι R M ) ( N O : Submodule R M ) ( N_le_O : N ≤ O )
          ...
          refine'
            ⟨
              o
                ...
                bO
                ,
                bN.map comap_subtype_equiv_of_le N_le_O . symm
                ,
                Finₓ.castLe hno . toEmbedding
                ,
                a
                ,
                fun i => _
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `Submodule.smithNormalForm [])
  (Command.optDeclSig
   [(Term.instBinder "[" [] (Term.app `Fintype [`ι]) "]")
    (Term.explicitBinder "(" [`b] [":" (Term.app `Basis [`ι `R `M])] [] ")")
    (Term.explicitBinder "(" [`N] [":" (Term.app `Submodule [`R `M])] [] ")")]
   [(Term.typeSpec
     ...
     (Init.Data.Sigma.Basic.«termΣ_,_»
      ...
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `n)] [":" (termℕ "ℕ")]))
      ", "
      (Term.app `Basis.SmithNormalForm [`N `ι `n])))])
  (Command.declValSimple
   ":="
   (Term.let
    "let"
    (Term.letDecl
     (Term.letPatDecl
      (Term.anonymousCtor "⟨" [`m "," `n "," `bM "," `bN "," `f "," `a "," `snf] "⟩")
      []
      []
      ":="
      (Term.app `N.smith_normal_form_of_le [`b (Order.BoundedOrder.«term⊤» "⊤") `le_top])))
    []
    (Term.let
     "let"
     (Term.letDecl
      (Term.letIdDecl `bM' [] [] ":=" (Term.app `bM.map [(Term.app `LinearEquiv.ofTop [(Term.hole "_") `rfl])])))
     []
     (Term.let
      "let"
      (Term.letDecl (Term.letIdDecl `e [] [] ":=" (Term.app `bM'.index_equiv [`b])))
      []
      (Term.anonymousCtor
       "⟨"
       [`n
        ","
        (Term.app `bM'.reindex [`e])
        ","
        (Term.app `bN.map [(Term.app `comap_subtype_equiv_of_le [`le_top])])
        ","
        (Term.app `f.trans [`e.to_embedding])
        ","
        `a
        ","
        (Term.fun
               ...
               (Tactic.simp
                ...
                ["["
                 [(Tactic.simpLemma [] [] `snf)
                  ...
                  (Tactic.simpLemma [] [] `Basis.map_apply)
                  ","
                  (Tactic.simpLemma [] [] `LinearEquiv.of_top_apply)
                  ","
                  (Tactic.simpLemma [] [] `Submodule.coe_smul_of_tower)
                  ","
                  (Tactic.simpLemma [] [] `Submodule.comap_subtype_equiv_of_le_apply_coe)
                  ","
                  (Tactic.simpLemma [] [] `coe_coe)
                  ","
                  (Tactic.simpLemma [] [] `Basis.reindex_apply)
                  ","
                  (Tactic.simpLemma [] [] `Equivₓ.to_embedding_apply)
                  ","
                  (Tactic.simpLemma [] [] `Function.Embedding.trans_apply)
                  ","
                  (Tactic.simpLemma [] [] `Equivₓ.symm_apply_apply)]
                 "]"]
                [])
               [])])))))]
       "⟩"))))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `comap_subtype_equiv_of_le [`le_top])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `comap_subtype_equiv_of_le [`le_top]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `bN.map
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.letIdDecl', expected 'Lean.Parser.Term.letIdDecl.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, term))
  (Term.app `bM.map [(Term.app `LinearEquiv.ofTop [(Term.hole "_") `rfl])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `LinearEquiv.ofTop [(Term.hole "_") `rfl])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
/--
  ...
  def
    ...
    [ Fintype ι ] ( b : Basis ι R M ) ( N : Submodule R M ) : Σ n : ℕ , Basis.SmithNormalForm N ι n
    :=
      let
        ⟨ m , n , bM , bN , f , a , snf ⟩ := N.smith_normal_form_of_le b ⊤ le_top
        let
          bM' := bM.map LinearEquiv.ofTop _ rfl
          let
            e := bM'.index_equiv b
            ⟨
              n
                ...
                bM'.reindex e
                ,
                bN.map comap_subtype_equiv_of_le le_top
                ,
                f.trans e.to_embedding
                ,
                a
                ,
                fun
