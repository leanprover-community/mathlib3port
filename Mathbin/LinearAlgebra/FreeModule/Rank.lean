...
/- warning: rank_tensor_product' -> rank_tensor_product' is a dubious translation:
lean 3 declaration is
...
Case conversion may be inaccurate. Consider using '#align rank_tensor_product' rank_tensor_product'ₓ'. -/
