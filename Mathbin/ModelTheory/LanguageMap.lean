     ...
     (Command.theorem
      ...
      (Command.declSig
       [(Term.explicitBinder
         "("
         [`F]
         [":" (FirstOrder.Language.ModelTheory.LanguageMap.«term_→ᴸ_» `L " →ᴸ " `L')]
         []
         ")")]
       (Term.typeSpec
        ":"
        («term_=_»
         (FirstOrder.Language.LhomCat.ModelTheory.LanguageMap.Lhom.comp
          (Term.app `LhomCat.id [`L'])
          " ∘ "
          `F)
         "="
         `F)))
       ...
       (Term.byTactic
        ...
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(Tactic.cases "cases" [(Tactic.casesTarget [] `F)] [] []) [] (Tactic.tacticRfl "rfl")])))
       [])
      []
      []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 50, term))
      (FirstOrder.Language.LhomCat.ModelTheory.LanguageMap.Lhom.comp
       ...
       " ∘ "
       `F)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'FirstOrder.Language.LhomCat.ModelTheory.LanguageMap.Lhom.comp', expected 'FirstOrder.Language.LhomCat.ModelTheory.LanguageMap.Lhom.comp._@.ModelTheory.LanguageMap._hyg.636'
...
@[ simp ] theorem id_comp ( F : L →ᴸ L' ) : LhomCat.id L' ∘ F = F := by cases F rfl
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.classInductive'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
@[ simp ] theorem comp_id ( F : L →ᴸ L' ) : F ∘ LhomCat.id L = F := by cases F rfl
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      ...
      (Command.declSig
       [(Term.implicitBinder "{" [`L3] [":" `Language] "}")
        (Term.explicitBinder
         "("
         [`F]
         [":" (FirstOrder.Language.ModelTheory.LanguageMap.«term_→ᴸ_» `L'' " →ᴸ " `L3)]
         []
         ")")
        (Term.explicitBinder
         "("
       ...
       (Term.typeSpec
        ...
        («term_=_»
         (FirstOrder.Language.LhomCat.ModelTheory.LanguageMap.Lhom.comp
          (FirstOrder.Language.LhomCat.ModelTheory.LanguageMap.Lhom.comp `F " ∘ " `G)
          " ∘ "
          `H)
         "="
         (FirstOrder.Language.LhomCat.ModelTheory.LanguageMap.Lhom.comp
          `F
          " ∘ "
          (FirstOrder.Language.LhomCat.ModelTheory.LanguageMap.Lhom.comp `G " ∘ " `H)))))
...
theorem
  comp_assoc
  { L3 : Language } ( F : L'' →ᴸ L3 ) ( G : L' →ᴸ L'' ) ( H : L →ᴸ L' ) : F ∘ G ∘ H = F ∘ G ∘ H
  := rfl
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `sum_elim_comp_inl [])
      (Command.declSig
       [(Term.explicitBinder
         "("
         [`ψ]
       ...
       (Term.typeSpec
        ...
        («term_=_»
         (FirstOrder.Language.LhomCat.ModelTheory.LanguageMap.Lhom.comp
          (Term.app (Term.proj `ϕ "." `sum_elim) [`ψ])
          " ∘ "
          `Lhom.sum_inl)
         "="
         `ϕ)))
      (Command.declValSimple
       ...
       (Term.app
        `LhomCat.funext
        [(Term.app `funext [(Term.fun "fun" (Term.basicFun [(Term.hole "_")] [] "=>" `rfl))])
         (Term.app `funext [(Term.fun "fun" (Term.basicFun [(Term.hole "_")] [] "=>" `rfl))])])
       [])
      []
      []))
...
theorem
  sum_elim_comp_inl
  ( ψ : L'' →ᴸ L' ) : ϕ . sum_elim ψ ∘ Lhom.sum_inl = ϕ
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `sum_elim_comp_inr [])
      (Command.declSig
       [(Term.explicitBinder
         "("
         [`ψ]
...
theorem
  sum_elim_comp_inr
  ( ψ : L'' →ᴸ L' ) : ϕ . sum_elim ψ ∘ Lhom.sum_inr = ψ
  := LhomCat.funext funext fun _ => rfl funext fun _ => rfl
      ...
      (Command.declSig
       ...
       (Term.typeSpec
        ...
        («term_=_»
         ...
         (Term.app
          (Term.proj
           (FirstOrder.Language.LhomCat.ModelTheory.LanguageMap.Lhom.comp `θ " ∘ " `ϕ)
           "."
           `sum_elim)
          [(FirstOrder.Language.LhomCat.ModelTheory.LanguageMap.Lhom.comp `θ " ∘ " `ψ)]))))
      (Command.declValSimple
       ":="
       (Term.app
        `LhomCat.funext
        [(Term.app
          ...
          [(Term.fun
            ...
            (Term.basicFun
             ...
             []
             "=>"
             (Term.app `Sum.comp_elim [(Term.hole "_") (Term.hole "_") (Term.hole "_")])))])
         (Term.app
          `funext
          [(Term.fun
            "fun"
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app
       (Term.proj
        ...
        `sum_elim)
       [(FirstOrder.Language.LhomCat.ModelTheory.LanguageMap.Lhom.comp `θ " ∘ " `ψ)])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'FirstOrder.Language.LhomCat.ModelTheory.LanguageMap.Lhom.comp', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'FirstOrder.Language.LhomCat.ModelTheory.LanguageMap.Lhom.comp', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (FirstOrder.Language.LhomCat.ModelTheory.LanguageMap.Lhom.comp `θ " ∘ " `ψ)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'FirstOrder.Language.LhomCat.ModelTheory.LanguageMap.Lhom.comp', expected 'FirstOrder.Language.LhomCat.ModelTheory.LanguageMap.Lhom.comp._@.ModelTheory.LanguageMap._hyg.636'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.opaque'
...
theorem
  comp_sum_elim
  { L3 : Language } ( θ : L' →ᴸ L3 ) : θ ∘ ϕ . sum_elim ψ = θ ∘ ϕ . sum_elim θ ∘ ψ
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `sum_map_comp_inl [])
      (Command.declSig
       []
       (Term.typeSpec
        ":"
        («term_=_»
         (FirstOrder.Language.LhomCat.ModelTheory.LanguageMap.Lhom.comp
          (Term.app (Term.proj `ϕ "." `sum_map) [`ψ])
          " ∘ "
          `Lhom.sum_inl)
         "="
         (FirstOrder.Language.LhomCat.ModelTheory.LanguageMap.Lhom.comp `Lhom.sum_inl " ∘ " `ϕ))))
      (Command.declValSimple
       ":="
       (Term.app
        `LhomCat.funext
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `sum_map_comp_inr [])
      (Command.declSig
       []
       (Term.typeSpec
        ":"
        («term_=_»
         (FirstOrder.Language.LhomCat.ModelTheory.LanguageMap.Lhom.comp
          ...
          `Lhom.sum_inr)
         "="
         (FirstOrder.Language.LhomCat.ModelTheory.LanguageMap.Lhom.comp `Lhom.sum_inr " ∘ " `ψ))))
      (Command.declValSimple
       ":="
       (Term.app
        `LhomCat.funext
