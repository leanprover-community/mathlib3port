...
#align first_order.language._root_.function.empty_hom first_order.language._root_.function.empty_hom
...
#align first_order.language._root_.embedding.empty first_order.language._root_.embedding.empty

/-- Makes a `language.empty.equiv` out of any function. -/
@[simps]
def _root_.equiv.empty (f : M ≃ N) : M ≃[language.empty] N where toEquiv := f
#align first_order.language._root_.equiv.empty first_order.language._root_.equiv.empty
