    ...
    · have hi' : n = (i : ℕ) + q :=
      ...
      · rw [← id_comp (X.σ i), ← (p_add_q_f q n.succ : _ = 𝟙 (X.obj _)), add_comp, add_comp]
        ...
        erw [← assoc, v.comp_P_eq_self, HomologicalComplex.add_f_apply, Preadditive.comp_add,
          comp_id, v.comp_Hσ_eq hi', assoc, SimplicialObject.δ_comp_σ_succ'_assoc, Fin.eta,
          ...
          have eq :=
            hq j.rev.succ
              (by
                ...
                linarith)
          rw [HomologicalComplex.comp_f, assoc, assoc, assoc, hi'', SimplicialObject.σ_comp_σ_assoc,
            reassoc_of eq, zero_comp, comp_zero, comp_zero, comp_zero]
