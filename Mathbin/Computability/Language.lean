...
-- ././Mathport/Syntax/Translate/Basic.lean:833:9: unsupported derive handler has_mem (list α)
-- ././Mathport/Syntax/Translate/Basic.lean:833:9: unsupported derive handler has_singleton (list α)
-- ././Mathport/Syntax/Translate/Basic.lean:833:9: unsupported derive handler has_insert (list α)
-- ././Mathport/Syntax/Translate/Basic.lean:833:9: unsupported derive handler complete_boolean_algebra
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  ...
  (Command.declId `star [])
  (Command.optDeclSig
   [(Term.explicitBinder "(" [`l] [":" (Term.app `Language [`α])] [] ")")]
   [(Term.typeSpec ":" (Term.app `Language [`α]))])
   ...
   (Set.«term{_|_}»
    ...
    («term∃_,_»
     ...
     (Lean.explicitBinders
      (Lean.unbracketedExplicitBinders [(Lean.binderIdent `S)] [":" (Term.app `List [(Term.app `List [`α])])]))
     ","
     («term_∧_»
      («term_=_» `x "=" `S.join)
      "∧"
      (Term.forall
       ...
       (Mathlib.ExtendedBinder.«term∀___,_»
        ...
        («binderTerm∈_» "∈" `S)
        ","
        (Term.forall "∀" [] "," (Init.Core.«term_∈_» `y " ∈ " `l))))))
    "}")
   [])
  []
  []
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `List [`α]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `List
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
/--
    The star of a language `L` is the set of all strings which can be written by concatenating
      strings from `L`. -/
  def star ( l : Language α ) : Language α := { x | ∃ S : List List α , x = S.join ∧ ∀ , ∀ y ∈ S , ∀ , y ∈ l }
...
theorem star_def ( l : Language α ) : l.star = { x | ∃ S : List List α , x = S.join ∧ ∀ , ∀ y ∈ S , ∀ , y ∈ l } := rfl
...
instance
  ...
  where
    add := · + ·
      ...
      mul := · * ·
      mul_assoc l m n := by simp only [ mul_def , Set.image2_image2_left , Set.image2_image2_right , List.append_assoc ]
      ...
      left_distrib l m n := by simp only [ mul_def , add_def , Set.image2_union_right ]
      right_distrib l m n := by simp only [ mul_def , add_def , Set.image2_union_left ]
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `star_def_nonempty [])
  (Command.declSig
   [(Term.explicitBinder "(" [`l] [":" (Term.app `Language [`α])] [] ")")]
   (Term.typeSpec
    ":"
        ...
        (Term.forall
         ...
         (Mathlib.ExtendedBinder.«term∀___,_»
          ...
          (Term.forall
           ...
           []
           ","
           («term_∧_» (Init.Core.«term_∈_» `y " ∈ " `l) "∧" («term_≠_» `y "≠" («term[_]» "[" [] "]"))))))))
      "}"))))
  (Command.declValSimple
   ":="
   (Term.byTactic
           ...
           [(group
             ...
             (Tactic.refine'
              ...
              (Term.anonymousCtor
               ...
               [(Term.app
                 ...
                 [(Term.fun
                   "fun"
                   (Term.basicFun [(Term.simpleBinder [`l] [])] "=>" («term¬_» "¬" (Term.app `List.empty [`l]))))])
                ","
                (Term.byTactic
                 "by"
            ...
            (group
             (Tactic.rwSeq
              ...
              (Tactic.rwRuleSeq
               "["
               [(Tactic.rwRule [] `List.mem_filterₓ) "," (Tactic.rwRule [] `List.empty_iff_eq_nil)]
               "]")
            ...
            (group
             (Tactic.exact
              ...
              (Term.anonymousCtor
               "⟨"
               [(Term.app `h [`y (Term.proj `hy "." (fieldIdx "1"))]) "," (Term.proj `hy "." (fieldIdx "2"))]
               "⟩"))
             [])])))
        [])
       (group
               ...
               [`S
                ...
                (Term.fun
                 ...
                 (Term.basicFun
                  ...
                  "=>"
                  (Term.proj (Term.app `h [`y `hy]) "." (fieldIdx "1"))))]
               "⟩"))
             [])])))
        [])])))
   [])
  ...
  (Tactic.exact
   ...
   (Term.anonymousCtor
    ...
    [`S
     ...
     (Term.fun
      "fun"
      (Term.basicFun [(Term.simpleBinder [`y `hy] [])] "=>" (Term.proj (Term.app `h [`y `hy]) "." (fieldIdx "1"))))]
    "⟩"))
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `h [`y `hy]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
     ...
     [(group
      ...
      (group
       (Tactic.rwSeq
        "rw"
        []
        (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `List.mem_filterₓ) "," (Tactic.rwRule [] `List.empty_iff_eq_nil)] "]")
        [(Tactic.location "at" (Tactic.locationHyp [`hy] []))])
       [])
      (group
       (Tactic.exact
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `h [`y (Term.proj `hy "." (fieldIdx "1"))])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.refine'
   ...
   (Term.anonymousCtor
    ...
    [(Term.app
      `S.filter
      [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`l] [])] "=>" («term¬_» "¬" (Term.app `List.empty [`l]))))])
     ","
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Mathlib.ExtendedBinder.«term∀___,_»
   ...
   («binderTerm∈_» "∈" `S)
   ","
   (Term.forall "∀" [] "," («term_∧_» (Init.Core.«term_∈_» `y " ∈ " `l) "∧" («term_≠_» `y "≠" («term[_]» "[" [] "]")))))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Mathlib.ExtendedBinder.«term∀___,_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.forall "∀" [] "," («term_∧_» (Init.Core.«term_∈_» `y " ∈ " `l) "∧" («term_≠_» `y "≠" («term[_]» "[" [] "]"))))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.forall', expected 'antiquot'
...
theorem
  star_def_nonempty
  ( l : Language α ) : l.star = { x | ∃ S : List List α , x = S.join ∧ ∀ , ∀ y ∈ S , ∀ , y ∈ l ∧ y ≠ [ ] }
  :=
    by
      ext x
        constructor
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `mem_supr [])
  (Command.declSig
   [(Term.implicitBinder "{" [`ι] [":" (Term.sort "Sort" [`v])] "}")
    (Term.implicitBinder "{" [`l] [":" (Term.arrow `ι "→" (Term.app `Language [`α]))] "}")
    (Term.implicitBinder "{" [`x] [":" (Term.app `List [`α])] "}")]
   (Term.typeSpec
    ":"
    («term_↔_»
     (Init.Core.«term_∈_»
     ...
     («term∃_,_»
      ...
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
      ","
      (Init.Core.«term_∈_» `x " ∈ " (Term.app `l [`i]))))))
  (Command.declValSimple ":=" `Set.mem_Union [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
theorem mem_supr { ι : Sort v } { l : ι → Language α } { x : List α } : x ∈ ⨆ i , l i ↔ ∃ i , x ∈ l i := Set.mem_Union
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `supr_mul [])
  (Command.declSig
   [(Term.implicitBinder "{" [`ι] [":" (Term.sort "Sort" [`v])] "}")
    (Term.explicitBinder "(" [`l] [":" (Term.arrow `ι "→" (Term.app `Language [`α]))] [] ")")
    (Term.explicitBinder "(" [`m] [":" (Term.app `Language [`α])] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (List.Data.List.Basic.«term_*_»
      (Order.CompleteLattice.«term⨆_,_»
       "⨆"
       (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
       ", "
     ...
     (Order.CompleteLattice.«term⨆_,_»
      ...
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
      ", "
      (List.Data.List.Basic.«term_*_» (Term.app `l [`i]) "*" `m)))))
  (Command.declValSimple ":=" (Term.app `Set.image2_Union_left [(Term.hole "_") (Term.hole "_") (Term.hole "_")]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Set.image2_Union_left [(Term.hole "_") (Term.hole "_") (Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (List.Data.List.Basic.«term_*_» (Term.app `l [`i]) "*" `m)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'List.Data.List.Basic.«term_*_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `m
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
theorem
  supr_mul
  { ι : Sort v } ( l : ι → Language α ) ( m : Language α ) : ⨆ i , l i * m = ⨆ i , l i * m
   ...
   (Term.typeSpec
    ...
    («term_=_»
     ...
     (Order.CompleteLattice.«term⨆_,_»
      ...
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
      ", "
      (List.Data.List.Basic.«term_*_» `m "*" (Term.app `l [`i]))))))
  (Command.declValSimple ":=" (Term.app `Set.image2_Union_right [(Term.hole "_") (Term.hole "_") (Term.hole "_")]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Set.image2_Union_right [(Term.hole "_") (Term.hole "_") (Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
theorem
  mul_supr
  { ι : Sort v } ( l : ι → Language α ) ( m : Language α ) : m * ⨆ i , l i = ⨆ i , m * l i
   ...
   (Term.typeSpec
    ...
    («term_=_»
     ...
     (Order.CompleteLattice.«term⨆_,_»
      ...
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
      ", "
      (Init.Logic.«term_+_» (Term.app `l [`i]) "+" `m)))))
  (Command.declValSimple ":=" `supr_sup [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
theorem
  supr_add
  { ι : Sort v } [ Nonempty ι ] ( l : ι → Language α ) ( m : Language α ) : ⨆ i , l i + m = ⨆ i , l i + m
  := supr_sup
   ...
   (Term.typeSpec
    ...
    («term_=_»
     ...
     (Order.CompleteLattice.«term⨆_,_»
      ...
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
      ", "
      (Init.Logic.«term_+_» `m "+" (Term.app `l [`i]))))))
  (Command.declValSimple ":=" `sup_supr [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
theorem
  add_supr
  { ι : Sort v } [ Nonempty ι ] ( l : ι → Language α ) ( m : Language α ) : m + ⨆ i , l i = ⨆ i , m + l i
  := sup_supr
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `star_eq_supr_pow [])
  (Command.declSig
   [(Term.explicitBinder "(" [`l] [":" (Term.app `Language [`α])] [] ")")]
   (Term.typeSpec
    ":"
         ...
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group
             ...
             [])
            (group
             (Tactic.exact "exact" (Term.anonymousCtor "⟨" [(Term.hole "_") "," `S "," `rfl "," `rfl "," `hS] "⟩"))
             [])])))
        [])
       (group
        (Tactic.«tactic·._»
          ...
          (Tactic.tacticSeq1Indented
           [(group
             (Tactic.rintro
              ...
              [])
             [])
            (group (Tactic.exact "exact" (Term.anonymousCtor "⟨" [`S "," `rfl "," `hS] "⟩")) [])])))
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.anonymousCtor "⟨" [`S "," `rfl "," `hS] "⟩"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.anonymousCtor "⟨" [`S "," `rfl "," `hS] "⟩")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.anonymousCtor.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.anonymousCtor "⟨" [(Term.hole "_") "," `S "," `rfl "," `rfl "," `hS] "⟩")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.anonymousCtor.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, tactic))
  (Tactic.simp
   ...
   ["only"]
   ["["
    [(Tactic.simpLemma [] [] `mem_star) "," (Tactic.simpLemma [] [] `mem_supr) "," (Tactic.simpLemma [] [] `mem_pow)]
    "]"]
   [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simp', expected 'antiquot'
