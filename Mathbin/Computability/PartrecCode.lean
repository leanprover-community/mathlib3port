...
-- ./././Mathport/Syntax/Translate/Tactic/Builtin.lean:64:14: unsupported tactic `rsuffices #[["⟨", ident k, ",", ident h, "⟩", ":", expr «expr∃ , »((k), «expr ∈ »(x, evaln «expr + »(k, 1) c n))]]
