...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `IsOpen.Union_preimage_smul [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `is_minimal [`M `α]) "]")
    (Term.implicitBinder "{" [`U] [":" (Term.app `Set [`α])] "}")
    (Term.explicitBinder "(" [`hUo] [":" (Term.app `IsOpen [`U])] [] ")")
    (Term.explicitBinder "(" [`hne] [":" `U.nonempty] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Set.Data.Set.Lattice.«term⋃_,_»
      "⋃"
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `c)] [":" `M]))
      ", "
      (Set.Data.Set.Basic.«term_⁻¹'_»
       (Term.app (Algebra.Group.Defs.«term_•_» (Term.cdot "·") " • " (Term.cdot "·")) [`c])
       " ⁻¹' "
       `U))
     "="
     `univ)))
  (Command.declValSimple
   ...
   («term_$__»
    ...
    "$"
    (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`x] [])] "=>" (Term.app `hUo.exists_smul_mem [`M `x `hne]))))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `hUo.exists_smul_mem [`M `x `hne])
...
@[ to_additive ]
  theorem
    IsOpen.Union_preimage_smul
    [ is_minimal M α ] { U : Set α } ( hUo : IsOpen U ) ( hne : U.nonempty ) : ⋃ c : M , · • · c ⁻¹' U = univ
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `IsOpen.Union_smul [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `is_minimal [`G `α]) "]")
    (Term.implicitBinder "{" [`U] [":" (Term.app `Set [`α])] "}")
    (Term.explicitBinder "(" [`hUo] [":" (Term.app `IsOpen [`U])] [] ")")
    (Term.explicitBinder "(" [`hne] [":" `U.nonempty] [] ")")]
   (Term.typeSpec
    ...
    («term_=_»
     (Set.Data.Set.Lattice.«term⋃_,_»
      ...
      ", "
      (Algebra.Group.Defs.«term_•_» `g " • " `U))
     "="
     `univ)))
  (Command.declValSimple
   ":="
      ...
      (Term.let
       ...
       (Term.letDecl
        (Term.letPatDecl
         ...
         []
         ":="
         (Term.app `hUo.exists_smul_mem [`G `x `hne])))
       []
       (Term.anonymousCtor
        "⟨"
        [(Init.Logic.«term_⁻¹» `g "⁻¹")
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.let
   "let"
   (Term.letDecl
    (Term.letPatDecl (Term.anonymousCtor "⟨" [`g "," `hg] "⟩") [] [] ":=" (Term.app `hUo.exists_smul_mem [`G `x `hne])))
   []
   (Term.anonymousCtor
    "⟨"
    [(Init.Logic.«term_⁻¹» `g "⁻¹")
...
@[ to_additive ]
  theorem
    IsOpen.Union_smul
    [ is_minimal G α ] { U : Set α } ( hUo : IsOpen U ) ( hne : U.nonempty ) : ⋃ g : G , g • U = univ
    :=
      Union_eq_univ_iff . 2
        $
        fun x => let ⟨ g , hg ⟩ := hUo.exists_smul_mem G x hne ⟨ g ⁻¹ , _ , hg , inv_smul_smul _ _ ⟩

-- ././Mathport/Syntax/Translate/Basic.lean:477:2: warning: expanding binder collection (g «expr ∈ » I)
/- failed to parenthesize: parenthesize: uncaught backtrack exception
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  []
 ...
 (Command.theorem
  "theorem"
  (Command.declId `IsCompact.exists_finite_cover_smul [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `TopologicalSpace [`G]) "]")
    (Term.instBinder "[" [] (Term.app `is_minimal [`G `α]) "]")
    (Term.instBinder "[" [] (Term.app `HasContinuousSmul [`G `α]) "]")
   ...
   (Term.typeSpec
    ...
    («term∃_,_»
     "∃"
     (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `I)] [":" (Term.app `Finset [`G])]))
     ","
     (Init.Core.«term_⊆_»
      `K
      " ⊆ "
      (Set.Data.Set.Lattice.«term⋃_,_»
       ...
       (Lean.explicitBinders
        [(Lean.bracketedExplicitBinders "(" [(Lean.binderIdent `g)] ":" (Term.hole "_") ")")
         (Lean.bracketedExplicitBinders "(" [(Lean.binderIdent "_")] ":" (Init.Core.«term_∈_» `g " ∈ " `I) ")")])
       ", "
       (Algebra.Group.Defs.«term_•_» `g " • " `U))))))
  (Command.declValSimple
   ":="
    ...
    (Term.app
     ...
     [(Term.fun
       ...
       (Term.basicFun
        ...
        "=>"
        (Algebra.Group.Defs.«term_•_» `g " • " `U)))
      (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`g] [])] "=>" (Term.app `hUo.smul [(Term.hole "_")])))])
    "$"
    (calc
     "calc"
     [(calcStep (Init.Core.«term_⊆_» `K " ⊆ " `univ) ":=" (Term.app `subset_univ [`K]))
      (calcStep
       («term_=_»
        (Term.hole "_")
        "="
        (Set.Data.Set.Lattice.«term⋃_,_»
         ...
         (Algebra.Group.Defs.«term_•_» `g " • " `U)))
       ":="
       (Term.proj (Term.app `hUo.Union_smul [`G `hne]) "." `symm))]))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `hUo.Union_smul [`G `hne]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_=_»
   (Term.hole "_")
...
@[ to_additive ]
  theorem
    ...
    [ TopologicalSpace G ]
        [ is_minimal G α ]
        [ HasContinuousSmul G α ]
        { K U : Set α }
        ( hK : IsCompact K )
        ( hUo : IsOpen U )
        ( hne : U.nonempty )
      : ∃ I : Finset G , K ⊆ ⋃ ( g : _ ) ( _ : g ∈ I ) , g • U
    :=
      hK.elim_finite_subcover fun g : G => g • U fun g => hUo.smul _
        $
        calc K ⊆ univ := subset_univ K _ = ⋃ g : G , g • U := hUo.Union_smul G hne . symm
