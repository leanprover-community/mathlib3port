...
-- ././Mathport/Syntax/Translate/Basic.lean:477:2: warning: expanding binder collection (u «expr ∈ » f)
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `OmegaLimit [])
  (Command.optDeclSig
   [(Term.instBinder "[" [] (Term.app `TopologicalSpace [`β]) "]")
    (Term.explicitBinder "(" [`f] [":" (Term.app `Filter [`τ])] [] ")")
    (Term.explicitBinder "(" [`ϕ] [":" (Term.arrow `τ "→" (Term.arrow `α "→" `β))] [] ")")
   ...
   (Set.Data.Set.Lattice.«term⋂_,_»
    ...
    (Lean.explicitBinders
     [(Lean.bracketedExplicitBinders "(" [(Lean.binderIdent `u)] ":" (Term.hole "_") ")")
      (Lean.bracketedExplicitBinders "(" [(Lean.binderIdent "_")] ":" (Init.Core.«term_∈_» `u " ∈ " `f) ")")])
    ", "
    (Term.app `Closure [(Term.app `image2 [`ϕ `u `s])]))
   [])
  []
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `image2 [`ϕ `u `s]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `Closure
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
/--
  ...
  def
    OmegaLimit
    [ TopologicalSpace β ] ( f : Filter τ ) ( ϕ : τ → α → β ) ( s : Set α ) : Set β
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `omega_limit_def [])
  (Command.declSig
   []
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app (Dynamics.OmegaLimit.termω "ω") [`f `ϕ `s])
     "="
     (Set.Data.Set.Lattice.«term⋂_,_»
      "⋂"
      (Lean.explicitBinders
...
theorem omega_limit_def : ω f ϕ s = ⋂ ( u : _ ) ( _ : u ∈ f ) , Closure image2 ϕ u s := rfl
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `maps_to_omega_limit' [])
  (Command.declSig
   [(Term.implicitBinder "{" [`α' `β'] [":" (Term.type "Type" [(Level.hole "_")])] "}")
    (Term.instBinder "[" [] (Term.app `TopologicalSpace [`β']) "]")
    (Term.implicitBinder "{" [`f] [":" (Term.app `Filter [`τ])] "}")
    (Term.implicitBinder "{" [`ϕ] [":" (Term.arrow `τ "→" (Term.arrow `α "→" `β))] "}")
    (Term.implicitBinder "{" [`ϕ'] [":" (Term.arrow `τ "→" (Term.arrow `α' "→" `β'))] "}")
    (Term.implicitBinder "{" [`ga] [":" (Term.arrow `α "→" `α')] "}")
    (Term.implicitBinder "{" [`s'] [":" (Term.app `Set [`α'])] "}")
    (Term.explicitBinder "(" [`hs] [":" (Term.app `maps_to [`ga `s `s'])] [] ")")
    (Term.implicitBinder "{" [`gb] [":" (Term.arrow `β "→" `β')] "}")
    (Term.explicitBinder
     "("
     [`hg]
     [":"
      (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
       ...
       (Term.app
        `eq_on
        [(Rel.Data.Rel.«term_∘_» `gb " ∘ " (Term.app `ϕ [`t]))
         (Rel.Data.Rel.«term_∘_» (Term.app `ϕ' [`t]) " ∘ " `ga)
         `s]))]
     []
     ")")
    (Term.explicitBinder "(" [`hgc] [":" (Term.app `Continuous [`gb])] [] ")")]
   (Term.typeSpec
    ":"
    (Term.app
     `maps_to
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.simp
         ...
         ["only"]
         ["["
          [(Tactic.simpLemma [] [] `omega_limit_def)
           ","
           (Tactic.simpLemma [] [] `mem_Inter)
           ","
           (Tactic.simpLemma [] [] `maps_to)]
          "]"]
         [])
        [])
       (group (Tactic.intro "intro" [`y `hy `u `hu]) [])
       (group
        (Tactic.refine'
         "refine'"
         (Term.app
          `map_mem_closure
          [`hgc
           (Term.app `hy [(Term.hole "_") (Term.app `inter_mem [`hu `hg])])
           («term_$__»
            (Term.proj `forall_image2_iff "." (fieldIdx "2"))
            "$"
            (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`t `ht `x `hx] [])] "=>" (Term.hole "_"))))]))
        [])
       (group
        (tacticCalc_
         "calc"
         [(calcStep
           («term_=_» (Term.app `gb [(Term.app `ϕ [`t `x])]) "=" (Term.app `ϕ' [`t (Term.app `ga [`x])]))
           ":="
           (Term.app (Term.proj `ht "." (fieldIdx "2")) [`hx]))
          (calcStep
           (Init.Core.«term_∈_» (Term.hole "_") " ∈ " (Term.app `image2 [`ϕ' `u `s']))
           ":="
           (Term.app `mem_image2_of_mem [(Term.proj `ht "." (fieldIdx "1")) (Term.app `hs [`hx])]))])
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `hs [`hx]) []] ")")
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `ga [`x]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `ϕ [`t `x]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `gb
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `inter_mem [`hu `hg]) []] ")")
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `hy [(Term.hole "_") (Term.paren "(" [(Term.app `inter_mem [`hu `hg]) []] ")")]) []]
 ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, [anonymous]))
  (Term.app
   `maps_to
   [`gb (Term.app (Dynamics.OmegaLimit.termω "ω") [`f `ϕ `s]) (Term.app (Dynamics.OmegaLimit.termω "ω") [`f `ϕ' `s'])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Dynamics.OmegaLimit.termω "ω")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Dynamics.OmegaLimit.termω', expected 'antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
   ...
   (Term.app
    `eq_on
    [(Rel.Data.Rel.«term_∘_» `gb " ∘ " (Term.app `ϕ [`t])) (Rel.Data.Rel.«term_∘_» (Term.app `ϕ' [`t]) " ∘ " `ga) `s]))
...
theorem
  ...
  { α' β' : Type _ }
      ...
      ( hs : maps_to ga s s' )
      { gb : β → β' }
      ( hg : ∀ᶠ t in f , eq_on gb ∘ ϕ t ϕ' t ∘ ga s )
      ( hgc : Continuous gb )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `mem_omega_limit_iff_frequently [])
  (Command.declSig
   [(Term.explicitBinder "(" [`y] [":" `β] [] ")")]
   (Term.typeSpec
    ":"
    («term_↔_»
     (Init.Core.«term_∈_» `y " ∈ " (Term.app (Dynamics.OmegaLimit.termω "ω") [`f `ϕ `s]))
     "↔"
     (Term.forall
      "∀"
      []
      ...
      (Mathlib.ExtendedBinder.«term∀___,_»
       "∀"
       `n
       («binderTerm∈_» "∈" (Term.app (Topology.Basic.term𝓝 "𝓝") [`y]))
       ","
       (Term.forall
        "∀"
        []
        ...
        (Filter.Order.Filter.Basic.«term∃ᶠ_in_,_»
         ...
         ", "
         (Term.proj
          (Init.Core.«term_∩_» `s " ∩ " (Set.Data.Set.Basic.«term_⁻¹'_» (Term.app `ϕ [`t]) " ⁻¹' " `n))
          "."
          `Nonempty))))))))
  (Command.declValSimple
   ":="
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.simpRw
         ...
         (Tactic.rwRuleSeq
          "["
          [(Tactic.rwRule [] `frequently_iff)
           ","
           (Tactic.rwRule [] `omega_limit_def)
           ","
           (Tactic.rwRule [] `mem_Inter)
           ","
           (Tactic.rwRule [] `mem_closure_iff_nhds)]
          "]")
         [])
        [])
       ...
       (group
        (Tactic.«tactic·._»
         ...
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group (Tactic.intro "intro" [`h (Term.hole "_") `hn (Term.hole "_") `hu]) [])
            (group
             (Tactic.rcases
              "rcases"
              [(Tactic.casesTarget [] (Term.app `h [(Term.hole "_") `hu (Term.hole "_") `hn]))]
              ["with"
               (Tactic.rcasesPat.tuple
                ...
                [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.ignore "_")]) [])
                 ...
                 ","
                 (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `hϕtx)]) [])]
                "⟩")])
             [])
            (group
             (Tactic.exact
                 ...
                 (Tactic.tacticSeq
                  (Tactic.tacticSeq1Indented
                   [(group
                     (tacticRwa__
                      "rwa"
                      (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `mem_preimage) "," (Tactic.rwRule [] `hϕtx)] "]")
                      [])
                     [])])))]
               "⟩"))
             [])])))
       ...
       (group
        (Tactic.«tactic·._»
         ...
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group (Tactic.intro "intro" [`h (Term.hole "_") `hu (Term.hole "_") `hn]) [])
            (group
             (Tactic.rcases
              "rcases"
              [(Tactic.casesTarget [] (Term.app `h [(Term.hole "_") `hn `hu]))]
              ["with"
               (Tactic.rcasesPat.tuple
                "⟨"
                [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.ignore "_")]) [])
            ...
            (group
             (Tactic.exact
              ...
              (Term.anonymousCtor
               "⟨"
               [(Term.hole "_") "," `hϕtx "," (Term.hole "_") "," (Term.hole "_") "," `ht "," `hx "," `rfl]
               "⟩"))
             [])])))
        [])])))
   [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.intro "intro" [`h (Term.hole "_") `hu (Term.hole "_") `hn])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.intro', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `hn
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.byTactic
   ...
   (Tactic.tacticSeq
    (Tactic.tacticSeq1Indented
     [(group
       (tacticRwa__ "rwa" (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `mem_preimage) "," (Tactic.rwRule [] `hϕtx)] "]") [])
       [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.byTactic', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.byTactic', expected 'Lean.Parser.Term.byTactic.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq', expected 'Lean.Parser.Tactic.tacticSeq.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.casesTarget', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `h [(Term.hole "_") `hu (Term.hole "_") `hn])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.intro "intro" [`h (Term.hole "_") `hn (Term.hole "_") `hu])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.intro', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `hu
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Core.«term_∩_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Set.Data.Set.Basic.«term_⁻¹'_» (Term.app `ϕ [`t]) " ⁻¹' " `n)
...
/--
  ...
  theorem
    ...
    ( y : β ) : y ∈ ω f ϕ s ↔ ∀ , ∀ n ∈ 𝓝 y , ∀ , ∃ᶠ t in f , s ∩ ϕ t ⁻¹' n . Nonempty
    :=
      by
      ...
      (Mathlib.ExtendedBinder.«term∀___,_»
       ...
       (Term.forall
        ...
        (Filter.Order.Filter.Basic.«term∃ᶠ_in_,_»
         ...
         ", "
         (Term.proj
          (Init.Core.«term_∩_» (Set.Data.Set.Basic.term_''_ (Term.app `ϕ [`t]) " '' " `s) " ∩ " `n)
          "."
          `Nonempty))))))))
  (Command.declValSimple
   ":="
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.simpRw
         ...
         (Tactic.rwRuleSeq
          "["
          [(Tactic.rwRule [] `mem_omega_limit_iff_frequently) "," (Tactic.rwRule [] `image_inter_nonempty_iff)]
          "]")
         [])
        [])])))
   [])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Filter.Order.Filter.Basic.«term∃ᶠ_in_,_»
   ...
   `f
   ", "
   (Term.proj (Init.Core.«term_∩_» (Set.Data.Set.Basic.term_''_ (Term.app `ϕ [`t]) " '' " `s) " ∩ " `n) "." `Nonempty))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Filter.Order.Filter.Basic.«term∃ᶠ_in_,_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Init.Core.«term_∩_» (Set.Data.Set.Basic.term_''_ (Term.app `ϕ [`t]) " '' " `s) " ∩ " `n) "." `Nonempty)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 70, term))
  (Set.Data.Set.Basic.term_''_ (Term.app `ϕ [`t]) " '' " `s)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Set.Data.Set.Basic.term_''_', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `s
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
/--
  ...
  theorem
    mem_omega_limit_iff_frequently₂
    ( y : β ) : y ∈ ω f ϕ s ↔ ∀ , ∀ n ∈ 𝓝 y , ∀ , ∃ᶠ t in f , ϕ t '' s ∩ n . Nonempty
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `omega_limit_Inter [])
  (Command.declSig
   [(Term.explicitBinder "(" [`p] [":" (Term.arrow `ι "→" (Term.app `Set [`α]))] [] ")")]
   (Term.typeSpec
    ":"
    (Init.Core.«term_⊆_»
     (Term.app
     ...
     (Set.Data.Set.Lattice.«term⋂_,_»
      ...
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
      ", "
      (Term.app (Dynamics.OmegaLimit.termω "ω") [`f `ϕ (Term.app `p [`i])])))))
  (Command.declValSimple
   ":="
   («term_$__»
    `subset_Inter
    ...
    (Term.fun
     ...
     (Term.basicFun
      ...
      (Term.app
       ...
       [(Term.hole "_") (Term.hole "_") (Term.app `Inter_subset [(Term.hole "_") (Term.hole "_")])]))))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
theorem
  omega_limit_Inter
  ( p : ι → Set α ) : ω f ϕ ⋂ i , p i ⊆ ⋂ i , ω f ϕ p i
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `omega_limit_Union [])
  (Command.declSig
   [(Term.explicitBinder "(" [`p] [":" (Term.arrow `ι "→" (Term.app `Set [`α]))] [] ")")]
   (Term.typeSpec
    ":"
  ...
  (Command.declValSimple
   ...
   (Term.byTactic
    ...
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Union_subset_iff)] "]") []) [])
       (group
        (Tactic.exact
         "exact"
         (Term.fun
          ...
          (Term.basicFun
           ...
           (Term.app
            `omega_limit_mono_right
            [(Term.hole "_") (Term.hole "_") (Term.app `subset_Union [(Term.hole "_") (Term.hole "_")])]))))
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Union_subset_iff)] "]") [])
...
theorem
  omega_limit_Union
  ( p : ι → Set α ) : ⋃ i , ω f ϕ p i ⊆ ω f ϕ ⋃ i , p i
  := by rw [ Union_subset_iff ] exact fun i => omega_limit_mono_right _ _ subset_Union _ _
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `omega_limit_eq_Inter [])
  (Command.declSig
   []
   (Term.typeSpec
    ":"
    («term_=_»
     ...
     (Set.Data.Set.Lattice.«term⋂_,_»
      "⋂"
      (Lean.explicitBinders
       (Lean.unbracketedExplicitBinders [(Lean.binderIdent `u)] [":" (Init.Coe.«term↥_» "↥" `f.sets)]))
      ", "
      (Term.app `Closure [(Term.app `image2 [`ϕ `u `s])])))))
  (Command.declValSimple ":=" (Term.app `bInter_eq_Inter [(Term.hole "_") (Term.hole "_")]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `bInter_eq_Inter [(Term.hole "_") (Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
theorem omega_limit_eq_Inter : ω f ϕ s = ⋂ u : ↥ f.sets , Closure image2 ϕ u s := bInter_eq_Inter _ _
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `omega_limit_eq_bInter_inter [])
  (Command.declSig
   [(Term.implicitBinder "{" [`v] [":" (Term.app `Set [`τ])] "}")
    (Term.explicitBinder "(" [`hv] [":" (Init.Core.«term_∈_» `v " ∈ " `f)] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app (Dynamics.OmegaLimit.termω "ω") [`f `ϕ `s])
     ...
     (Set.Data.Set.Lattice.«term⋂_,_»
      ...
      (Lean.explicitBinders
       [(Lean.bracketedExplicitBinders "(" [(Lean.binderIdent `u)] ":" (Term.hole "_") ")")
        (Lean.bracketedExplicitBinders "(" [(Lean.binderIdent "_")] ":" (Init.Core.«term_∈_» `u " ∈ " `f) ")")])
      ", "
      (Term.app `Closure [(Term.app `image2 [`ϕ (Init.Core.«term_∩_» `u " ∩ " `v) `s])])))))
  (Command.declValSimple
   ":="
   (Term.app
    `subset.antisymm
           ...
           (Term.app
            ...
            [(Term.fun
              ...
              (Term.basicFun
               ...
               "=>"
               (Term.anonymousCtor "⟨" [(Term.app `inter_mem [`hu `hv]) "," `subset.rfl] "⟩")))])]
          "⟩")))])
     (Term.app
      `Inter_subset_Inter
      [(Term.fun
          ...
          [(Term.fun
            ...
            (Term.basicFun
             ...
             (Term.app
              ...
              [(Term.app
                `image2_subset
                [(Term.app `inter_subset_left [(Term.hole "_") (Term.hole "_")]) `subset.rfl])])))])))])])
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
  ...
  (Term.app
   ...
   [(Term.fun
     ...
     (Term.basicFun
      ...
      (Term.app
       `closure_mono
       [(Term.app `image2_subset [(Term.app `inter_subset_left [(Term.hole "_") (Term.hole "_")]) `subset.rfl])])))])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(Term.app
   `image2_subset
   [(Term.paren "(" [(Term.app `inter_subset_left [(Term.hole "_") (Term.hole "_")]) []] ")") `subset.rfl])
  []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `closure_mono
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `image2 [`ϕ (Init.Core.«term_∩_» `u " ∩ " `v) `s])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `image2 [`ϕ (Term.paren "(" [(Init.Core.«term_∩_» `u " ∩ " `v) []] ")") `s]) []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `Closure
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
theorem
  ...
  { v : Set τ } ( hv : v ∈ f ) : ω f ϕ s = ⋂ ( u : _ ) ( _ : u ∈ f ) , Closure image2 ϕ u ∩ v s
  :=
    subset.antisymm
      Inter_subset_Inter2 fun u => ⟨ u ∩ v , Inter_subset_Inter2 fun hu => ⟨ inter_mem hu hv , subset.rfl ⟩ ⟩
        Inter_subset_Inter
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `omega_limit_eq_Inter_inter [])
  (Command.declSig
   [(Term.implicitBinder "{" [`v] [":" (Term.app `Set [`τ])] "}")
    (Term.explicitBinder "(" [`hv] [":" (Init.Core.«term_∈_» `v " ∈ " `f)] [] ")")]
   (Term.typeSpec
      ...
      [(group
        (Tactic.rwSeq
         ...
         (Tactic.rwRuleSeq
          ...
          [(Tactic.rwRule
            []
            (Term.app `omega_limit_eq_bInter_inter [(Term.hole "_") (Term.hole "_") (Term.hole "_") `hv]))]
          "]")
         [])
        [])
       (group (Tactic.apply "apply" `bInter_eq_Inter) [])])))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.apply "apply" `bInter_eq_Inter)
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq
   ...
   (Tactic.rwRuleSeq
    "["
    [(Tactic.rwRule [] (Term.app `omega_limit_eq_bInter_inter [(Term.hole "_") (Term.hole "_") (Term.hole "_") `hv]))]
    "]")
   [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
...
theorem
  ...
  { v : Set τ } ( hv : v ∈ f ) : ω f ϕ s = ⋂ u : ↥ f.sets , Closure image2 ϕ u ∩ v s
...
-- ././Mathport/Syntax/Translate/Basic.lean:477:2: warning: expanding binder collection (u «expr ∈ » f)
-- ././Mathport/Syntax/Translate/Basic.lean:477:2: warning: expanding binder collection (u «expr ∈ » f)
-- ././Mathport/Syntax/Translate/Basic.lean:477:2: warning: expanding binder collection (u «expr ∈ » g)
-- ././Mathport/Syntax/Translate/Basic.lean:477:2: warning: expanding binder collection (u «expr ∈ » g)
/- failed to parenthesize: parenthesize: uncaught backtrack exception
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
 ...
 (Command.theorem
  "theorem"
  (Command.declId `eventually_closure_subset_of_is_compact_absorbing_of_is_open_of_omega_limit_subset' [])
  (Command.declSig
   [(Term.implicitBinder "{" [`c] [":" (Term.app `Set [`β])] "}")
    (Term.explicitBinder "(" [`hc₁] [":" (Term.app `IsCompact [`c])] [] ")")
    (Term.explicitBinder
     "("
     [`hc₂]
     [":"
      (Mathlib.ExtendedBinder.«term∃___,_»
       ...
       («binderTerm∈_» "∈" `f)
       ","
       (Init.Core.«term_⊆_» (Term.app `Closure [(Term.app `image2 [`ϕ `v `s])]) " ⊆ " `c))]
     []
     ")")
    (Term.implicitBinder "{" [`n] [":" (Term.app `Set [`β])] "}")
    (Term.explicitBinder "(" [`hn₁] [":" (Term.app `IsOpen [`n])] [] ")")
    (Term.explicitBinder
     "("
     [`hn₂]
     [":" (Init.Core.«term_⊆_» (Term.app (Dynamics.OmegaLimit.termω "ω") [`f `ϕ `s]) " ⊆ " `n)]
     []
     ")")]
   (Term.typeSpec
    ":"
    (Mathlib.ExtendedBinder.«term∃___,_»
     ...
     («binderTerm∈_» "∈" `f)
     ","
     (Init.Core.«term_⊆_» (Term.app `Closure [(Term.app `image2 [`ϕ `u `s])]) " ⊆ " `n))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
     ...
     (Tactic.tacticSeq1Indented
      [(group
       ...
       (group
        (Tactic.tacticLet_
         "let"
         (Term.letDecl (Term.letIdDecl `k [] ":=" (Term.app `Closure [(Term.app `image2 [`ϕ `v `s])]))))
        [])
       (group
        (Tactic.tacticHave_
         "have"
         (Term.haveDecl
          (Term.haveIdDecl
           [`hk []]
           [(Term.typeSpec ":" (Term.app `IsCompact [(Init.Core.«term_\_» `k " \\ " `n)]))]
           ":="
           (Term.app `IsCompact.diff [(Term.app `compact_of_is_closed_subset [`hc₁ `is_closed_closure `hv₂]) `hn₁]))))
        [])
       (group
        (Tactic.tacticLet_
         "let"
         ...
         [(Term.typeSpec
           ...
           (Term.forall
            ...
            (Mathlib.ExtendedBinder.«term∀___,_»
             ...
             («binderTerm∈_» "∈" `f)
             ","
             (Term.forall "∀" [] "," (Term.app `IsOpen [(Term.app `j [`u])])))))])
        [])
       (group
        (Tactic.exact
         "exact"
         (Term.fun
          ...
          (Term.basicFun
           ...
           "=>"
           (Term.app `is_open_compl_iff.mpr [`is_closed_closure]))))
        [])
       (group
        (Tactic.tacticHave_
         "have"
                 ...
                 [(Term.typeSpec
                   ...
                   («term_=_»
                    ...
                    (Set.Data.Set.Lattice.«term⋃_,_»
                     ...
                     (Term.app `j [`u]))))])
                [])
               (group (Tactic.exact "exact" (Term.app `bUnion_eq_Union [(Term.hole "_") (Term.hole "_")])) [])
               (group
                (Tactic.rwSeq
                 "rw"
                 []
                 (Tactic.rwRuleSeq
                  "["
                  [(Tactic.rwRule [] `this) "," (Tactic.rwRule [] `diff_subset_comm) "," (Tactic.rwRule [] `diff_Union)]
                  "]")
                 [])
                [])
               (group
                (Tactic.rwSeq
                 ...
                 (Tactic.rwRuleSeq
                  ...
                  [(Tactic.rwRule
                    []
                    (Term.app `omega_limit_eq_Inter_inter [(Term.hole "_") (Term.hole "_") (Term.hole "_") `hv₁]))]
                  "]")
                 [(Tactic.location "at" (Tactic.locationHyp [`hn₂] []))])
                [])
               (group (Tactic.simpRw "simp_rw" (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `diff_compl)] "]") []) [])
               (group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `inter_Inter)] "]") []) [])
               (group
                (Tactic.exact
                 "exact"
                 (Term.app `subset.trans [(Term.app `inter_subset_right [(Term.hole "_") (Term.hole "_")]) `hn₂]))
                [])]))))))
        [])
       (group
        (Tactic.rcases
         "rcases"
         [(Tactic.casesTarget [] (Term.app `hk.elim_finite_subcover_image [`hj₁ `hj₂]))]
         ["with"
          (Tactic.rcasesPat.tuple
           "⟨"
           [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `g)]) [])
            ","
            (Tactic.rcasesPatLo
             (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `hg₁)])
             [":"
              (Term.forall
               "∀"
               []
               ...
               (Mathlib.ExtendedBinder.«term∀___,_»
                ...
                («binderTerm∈_» "∈" `g)
                ","
                (Term.forall "∀" [] "," (Init.Core.«term_∈_» `u " ∈ " `f))))])
            ","
          ...
          (Term.letIdDecl
           ...
           (Init.Core.«term_∩_»
            (Set.Data.Set.Lattice.«term⋂_,_»
             ...
             (Lean.explicitBinders
              [(Lean.bracketedExplicitBinders "(" [(Lean.binderIdent `u)] ":" (Term.hole "_") ")")
               (Lean.bracketedExplicitBinders "(" [(Lean.binderIdent "_")] ":" (Init.Core.«term_∈_» `u " ∈ " `g) ")")])
             ", "
             `u)
            " ∩ "
            `v))))
       ...
       (group
        (Tactic.tacticHave_
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           [`hw₂ []]
           [(Term.typeSpec ":" (Init.Core.«term_∈_» `w " ∈ " `f))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(group (Tactic.simpa "simpa" [] [] ["[" [(Tactic.simpStar "*")] "]"] [] []) [])]))))))
        [])
       (group
        (Tactic.have''
         "have"
         ...
         [(Term.typeSpec
           ...
           (Init.Core.«term_⊆_»
            (Init.Core.«term_\_» `k " \\ " `n)
            " ⊆ "
            (Order.BooleanAlgebra.«term_ᶜ» (Term.app `Closure [(Term.app `image2 [`ϕ `w `s])]) "ᶜ")))])
        [])
       (group
        (Tactic.exact
         "exact"
              ...
              (Tactic.tacticSeq1Indented
               [(group
                 (Tactic.simp
                  ...
                  ["only"]
                  ["["
                   [(Tactic.simpLemma [] [] `Union_subset_iff) "," (Tactic.simpLemma [] [] `compl_subset_compl)]
                   "]"]
                  [])
                 [])
                (group (Tactic.intro "intro" [`u `hu]) [])
                (group (Tactic.mono "mono" ["*"] [] [] ["using" [(Tactic.simpLemma [] [] `w)]]) [])
                (group
                 (Tactic.exact
                  "exact"
                  (Term.app `Inter_subset_of_subset [`u (Term.app `Inter_subset_of_subset [`hu `subset.rfl])]))
                 [])]))))]))
        [])
       (group
        (Tactic.tacticHave_
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           ...
           [(Term.typeSpec
             ":"
             (Init.Core.«term_⊆_»
              (Order.BooleanAlgebra.«term_ᶜ» `k "ᶜ")
              " ⊆ "
              (Order.BooleanAlgebra.«term_ᶜ» (Term.app `Closure [(Term.app `image2 [`ϕ `w `s])]) "ᶜ")))]
           ":="
           (Term.byTactic
            ...
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `compl_subset_compl)] "]") []) [])
               (group
                (tacticCalc_
                 "calc"
                 [(calcStep
                   (Init.Core.«term_⊆_» (Term.app `Closure [(Term.app `image2 [`ϕ `w `s])]) " ⊆ " (Term.hole "_"))
                   ":="
                   (Term.app
                    `closure_mono
                    [(Term.app
                      `image2_subset
                      [(Term.app `inter_subset_right [(Term.hole "_") (Term.hole "_")]) `subset.rfl])]))])
                [])]))))))
        [])
       (group
        (Tactic.tacticHave_
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           ...
           [(Term.typeSpec
             ":"
             (Init.Core.«term_⊆_»
              (Order.BooleanAlgebra.«term_ᶜ» `n "ᶜ")
              " ⊆ "
              (Init.Core.«term_∪_» (Init.Core.«term_\_» `k " \\ " `n) " ∪ " (Order.BooleanAlgebra.«term_ᶜ» `k "ᶜ"))))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
                ...
                (Tactic.rwSeq
                 ...
                 (Tactic.rwRuleSeq
                  ...
                  [(Tactic.rwRule [] `union_comm)
                   ","
                   (Tactic.rwRule ["←"] `inter_subset)
                   ","
                   (Tactic.rwRule [] `diff_eq)
                   ","
       ...
       (group
        (Tactic.have''
         "have"
         [`hw []]
         [(Term.typeSpec ":" (Init.Core.«term_⊆_» (Term.app `Closure [(Term.app `image2 [`ϕ `w `s])]) " ⊆ " `n))])
        [])
       (group
        (Tactic.exact
         "exact"
         (Term.app `compl_subset_compl.mp [(Term.app `subset.trans [`hnc (Term.app `union_subset [`hw₃ `hw₄])])]))
        [])
       (group (Tactic.exact "exact" (Term.anonymousCtor "⟨" [(Term.hole "_") "," `hw₂ "," `hw] "⟩")) [])])))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.anonymousCtor "⟨" [(Term.hole "_") "," `hw₂ "," `hw] "⟩"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.anonymousCtor "⟨" [(Term.hole "_") "," `hw₂ "," `hw] "⟩")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.anonymousCtor.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `subset.trans [`hnc (Term.app `union_subset [`hw₃ `hw₄])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `union_subset [`hw₃ `hw₄]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `subset.trans [`hnc (Term.paren "(" [(Term.app `union_subset [`hw₃ `hw₄]) []] ")")]) []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Init.Core.«term_⊆_» (Term.app `Closure [(Term.app `image2 [`ϕ `w `s])]) " ⊆ " `n)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Core.«term_⊆_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `n
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 50, term))
  (Term.app `Closure [(Term.app `image2 [`ϕ `w `s])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `image2 [`ϕ `w `s]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `Closure
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 66 >? 999, (none, [anonymous]) <=? (none, [anonymous])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (tacticCalc_
   ...
   [(calcStep
     ...
     (Term.app
      `closure_mono
      [(Term.app `image2_subset [(Term.app `inter_subset_right [(Term.hole "_") (Term.hole "_")]) `subset.rfl])]))])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'tacticCalc_', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'calcStep', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(Term.app
   `image2_subset
   [(Term.paren "(" [(Term.app `inter_subset_right [(Term.hole "_") (Term.hole "_")]) []] ")") `subset.rfl])
  []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `closure_mono
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `compl_subset_compl)] "]") [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `compl_subset_compl
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `Inter_subset_of_subset [`u (Term.app `Inter_subset_of_subset [`hu `subset.rfl])]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Inter_subset_of_subset [`u (Term.app `Inter_subset_of_subset [`hu `subset.rfl])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Inter_subset_of_subset [`hu `subset.rfl])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.mono "mono" ["*"] [] [] ["using" [(Tactic.simpLemma [] [] `w)]])
    ...
    :=
      by
        rcases hc₂ with ⟨ v , hv₁ , hv₂ ⟩
          ...
          have
            hw₄
              : k ᶜ ⊆ Closure image2 ϕ w s ᶜ
              :=
              by
                rw [ compl_subset_compl ]
                  calc Closure image2 ϕ w s ⊆ _ := closure_mono image2_subset inter_subset_right _ _ subset.rfl
          have hnc : n ᶜ ⊆ k \ n ∪ k ᶜ := by rw [ union_comm , ← inter_subset , diff_eq , inter_comm ]
    ...
    (Term.explicitBinder
     ...
     [":"
      (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
       ...
       `f
       ", "
       (Term.app `maps_to [(Term.app `ϕ [`t]) `s `c]))]
     []
     ")")
    (Term.implicitBinder "{" [`n] [":" (Term.app `Set [`β])] "}")
    (Term.explicitBinder "(" [`hn₁] [":" (Term.app `IsOpen [`n])] [] ")")
     ...
     (Term.anonymousCtor
      ...
      [(Term.hole "_")
       ...
       (Term.app
        `closure_minimal
        [(Term.app
          (Term.proj `image2_subset_iff "." (fieldIdx "2"))
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `ϕ [`t]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `maps_to
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
/--
  ...
  theorem
    ...
    :=
      eventually_closure_subset_of_is_compact_absorbing_of_is_open_of_omega_limit_subset'
        f ϕ _ hc₁ ⟨ _ , hc₂ , closure_minimal image2_subset_iff . 2 fun t => id hc₁.is_closed ⟩ hn₁ hn₂
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `eventually_maps_to_of_is_compact_absorbing_of_is_open_of_omega_limit_subset [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `T2Space [`β]) "]")
    (Term.implicitBinder "{" [`c] [":" (Term.app `Set [`β])] "}")
    (Term.explicitBinder "(" [`hc₁] [":" (Term.app `IsCompact [`c])] [] ")")
   ...
   (Term.typeSpec
    ...
    (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
     ...
     `f
     ", "
     (Term.app `maps_to [(Term.app `ϕ [`t]) `s `n]))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
      ...
      [(group
         ...
         ["with"
          (Tactic.rcasesPat.tuple
           ...
           [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `u)]) [])
            ","
            (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `hu_mem)]) [])
            ","
       ...
       (group
        (Tactic.refine'
         ...
         (Term.app
          `mem_of_superset
          [`hu_mem (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`t `ht `x `hx] [])] "=>" (Term.hole "_")))]))
        [])
       (group
        (Tactic.exact "exact" (Term.app `hu [(«term_$__» `subset_closure "$" (Term.app `mem_image2_of_mem [`ht `hx]))]))
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `hu [(«term_$__» `subset_closure "$" (Term.app `mem_image2_of_mem [`ht `hx]))])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_$__» `subset_closure "$" (Term.app `mem_image2_of_mem [`ht `hx]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `mem_image2_of_mem [`ht `hx])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
theorem
  ...
  :=
    by
      rcases
          eventually_closure_subset_of_is_compact_absorbing_of_is_open_of_omega_limit_subset f ϕ s hc₁ hc₂ hn₁ hn₂
          with ⟨ u , hu_mem , hu ⟩
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `eventually_maps_to_of_is_open_of_omega_limit_subset [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `CompactSpace [`β]) "]")
    (Term.implicitBinder "{" [`v] [":" (Term.app `Set [`β])] "}")
    (Term.explicitBinder "(" [`hv₁] [":" (Term.app `IsOpen [`v])] [] ")")
    (Term.explicitBinder
     "("
     [`hv₂]
     [":" (Init.Core.«term_⊆_» (Term.app (Dynamics.OmegaLimit.termω "ω") [`f `ϕ `s]) " ⊆ " `v)]
     []
     ")")]
   (Term.typeSpec
    ":"
    (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
     ...
     `f
     ", "
     (Term.app `maps_to [(Term.app `ϕ [`t]) `s `v]))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.rcases
         ...
         [(Tactic.casesTarget
           []
           (Term.app `eventually_closure_subset_of_is_open_of_omega_limit_subset [`f `ϕ `s `hv₁ `hv₂]))]
         ["with"
          (Tactic.rcasesPat.tuple
           "⟨"
           [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `u)]) [])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rcases
   "rcases"
   [(Tactic.casesTarget [] (Term.app `eventually_closure_subset_of_is_open_of_omega_limit_subset [`f `ϕ `s `hv₁ `hv₂]))]
   ["with"
    (Tactic.rcasesPat.tuple
     "⟨"
     [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `u)]) [])
...
theorem
  ...
  [ CompactSpace β ] { v : Set β } ( hv₁ : IsOpen v ) ( hv₂ : ω f ϕ s ⊆ v ) : ∀ᶠ t in f , maps_to ϕ t s v
  :=
    by
...
theorem omega_limit_image_eq (hf : ∀ t, tendsto (·+t) f f) (t : τ) : ω f ϕ (ϕ t '' s) = ω f ϕ s :=
  subset.antisymm (omega_limit_image_subset _ _ _ _ (hf t)) $
    calc ω f ϕ s = ω f ϕ (ϕ (-t) '' (ϕ t '' s)) := by
