...
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (p1 «expr ∈ » ps)
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (p1 «expr ∈ » ps)
...
theorem exists_dist_eq_iff_exists_dist_orthogonal_projection_eq {s : AffineSubspace ℝ P} [Nonempty s]
  ...
  (∃ r, ∀ p1 _ : p1 ∈ ps, dist p1 p = r) ↔ ∃ r, ∀ p1 _ : p1 ∈ ps, dist p1 (↑orthogonalProjection s p) = r :=
  by 
...
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (p1 «expr ∈ » ps)
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (p1 «expr ∈ » ps)
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (p1 «expr ∈ » insert p ps)
  ...
  by 
    ...
    ·
      ...
      ·
        ...
        ·
          change _ = insert _ (Set.Range fun i2 => p i2)
        ...
        change (Set.Range fun i2 => p i2) = _ 
...
theorem orthogonal_projection_eq_circumcenter_of_dist_eq {n : ℕ} (s : simplex ℝ P n) {p : P} {r : ℝ}
  (hr : ∀ i, dist (s.points i) p = r) : ↑orthogonalProjection (affineSpan ℝ (Set.Range s.points)) p = s.circumcenter :=
...
inductive points_with_circumcenter_index (n : ℕ)
  ...
  | circumcenter_index : points_with_circumcenter_index deriving [anonymous]
...
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (center «expr ∈ » s)
