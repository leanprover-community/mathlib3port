...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " `monge_point_weights_with_circumcenter` sums to 1. -/")]
 ...
 (Command.theorem
  "theorem"
  (Command.declId `sum_monge_point_weights_with_circumcenter [])
  (Command.declSig
   ...
   (Term.typeSpec
    ...
    («term_=_»
     (Algebra.BigOperators.Basic.«term∑_,_»
      ...
      ", "
      (Term.app `monge_point_weights_with_circumcenter [`n `i]))
     "="
     (numLit "1"))))
        ...
        (Tactic.simpRw
         ...
         (Tactic.rwRuleSeq
          ...
          [(Tactic.rwRule [] `sum_points_with_circumcenter)
           ","
           (Tactic.rwRule [] `monge_point_weights_with_circumcenter)
           ","
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           ...
           (Term.byTactic
            ...
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(group (Tactic.exactModCast "exact_mod_cast" (Term.app `Nat.succ_ne_zero [(Term.hole "_")])) [])]))))))
        [])
       (group (Tactic.fieldSimp "field_simp" [] [] ["[" [(Tactic.simpLemma [] [] `hn1)] "]"] [] []) [])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, tactic))
  (Tactic.fieldSimp "field_simp" [] [] ["[" [(Tactic.simpLemma [] [] `hn1)] "]"] [] [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exactModCast "exact_mod_cast" (Term.app `Nat.succ_ne_zero [(Term.hole "_")]))
...
/-- `monge_point_weights_with_circumcenter` sums to 1. -/ @[ simp ]
  theorem
    sum_monge_point_weights_with_circumcenter
    ( n : ℕ ) : ∑ i , monge_point_weights_with_circumcenter n i = 1
    :=
      by
        simp_rw
            [
              sum_points_with_circumcenter , monge_point_weights_with_circumcenter , sum_const , card_fin , nsmul_eq_mul
              ]
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " `monge_point_vsub_face_centroid_weights_with_circumcenter` sums to 0. -/")]
  [(Term.attributes "@[" [(Term.attrInstance (Term.attrKind []) (Attr.simp "simp" [] []))] "]")]
  []
  []
  []
 ...
 (Command.theorem
  "theorem"
  (Command.declId `sum_monge_point_vsub_face_centroid_weights_with_circumcenter [])
  (Command.declSig
   [(Term.implicitBinder "{" [`n] [":" (termℕ "ℕ")] "}")
    (Term.implicitBinder "{" [`i₁ `i₂] [":" (Term.app `Finₓ [(Init.Logic.«term_+_» `n "+" (numLit "3"))])] "}")
   ...
   (Term.typeSpec
    ...
    («term_=_»
     (Algebra.BigOperators.Basic.«term∑_,_»
      ...
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
      ", "
      (Term.app `monge_point_vsub_face_centroid_weights_with_circumcenter [`i₁ `i₂ `i]))
     "="
     (numLit "0"))))
  (Command.declValSimple
   ":="
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.rwSeq
         ...
         (Tactic.rwRuleSeq
          "["
          [(Tactic.rwRule [] (Term.app `monge_point_vsub_face_centroid_weights_with_circumcenter_eq_sub [`h]))]
          "]")
         [])
        [])
       (group
        (Tactic.simpRw
         ...
         (Tactic.rwRuleSeq
          ...
          [(Tactic.rwRule [] `Pi.sub_apply)
           ...
           ","
           (Tactic.rwRule [] `sum_monge_point_weights_with_circumcenter)]
          "]")
         [])
        [])
       (group
        (Tactic.rwSeq
         ...
         (Tactic.rwRuleSeq
          "["
          [(Tactic.rwRule [] `sum_centroid_weights_with_circumcenter) "," (Tactic.rwRule [] `sub_self)]
          "]")
         [])
        [])
       (group
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.simp
   ...
   []
   ["["
    [(Tactic.simpLemma [] ["←"] `card_pos) "," (Tactic.simpLemma [] [] `card_compl) "," (Tactic.simpLemma [] [] `h)]
    "]"]
   [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `monge_point_vsub_face_centroid_weights_with_circumcenter_eq_sub [`h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
/-- `monge_point_vsub_face_centroid_weights_with_circumcenter` sums to 0. -/ @[ simp ]
  theorem
    sum_monge_point_vsub_face_centroid_weights_with_circumcenter
    { n : ℕ } { i₁ i₂ : Finₓ n + 3 } ( h : i₁ ≠ i₂ )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `inner_monge_point_vsub_face_centroid_vsub [])
  (Command.declSig
   [(Term.implicitBinder "{" [`n] [":" (termℕ "ℕ")] "}")
    (Term.explicitBinder
     "("
     [`s]
     [":" (Term.app `simplex [(Data.Real.Basic.termℝ "ℝ") `P (Init.Logic.«term_+_» `n "+" (numLit "2"))])]
     []
     ")")
    (Term.implicitBinder "{" [`i₁ `i₂] [":" (Term.app `Finₓ [(Init.Logic.«term_+_» `n "+" (numLit "3"))])] "}")]
   (Term.typeSpec
    ":"
    («term_=_»
     (EuclideanGeometry.Geometry.Euclidean.Basic.«term⟪_,_⟫»
      "⟪"
      (Algebra.AddTorsor.«term_-ᵥ_»
       ...
       (Term.app
        (Term.proj
         (Term.paren
          "("
          [(Order.BooleanAlgebra.«term_ᶜ» (Set.«term{_}» "{" [`i₁ "," `i₂] "}") "ᶜ")
           [(Term.typeAscription
             ":"
             (Term.app `Finset [(Term.app `Finₓ [(Init.Logic.«term_+_» `n "+" (numLit "3"))])]))]]
          ")")
         "."
         `centroid)
        [(Data.Real.Basic.termℝ "ℝ") `s.points]))
      ", "
      (Algebra.AddTorsor.«term_-ᵥ_» (Term.app `s.points [`i₁]) " -ᵥ " (Term.app `s.points [`i₂]))
      "⟫")
     "="
     (numLit "0"))))
  (Command.declValSimple
   ...
   (Term.byTactic
    ...
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group (Tactic.byCases' "by_cases'" [`h ":"] («term_=_» `i₁ "=" `i₂)) [])
       (group
        (Tactic.«tactic·._»
         "·"
         (Tactic.tacticSeq
       ...
       (group
        (Tactic.simpRw
         ...
         (Tactic.rwRuleSeq
          ...
          [(Tactic.rwRule
            []
            (Term.app `monge_point_vsub_face_centroid_eq_weighted_vsub_of_points_with_circumcenter [`s `h]))
           ","
           (Tactic.rwRule [] `point_eq_affine_combination_of_points_with_circumcenter)
           ","
           (Tactic.rwRule [] `affine_combination_vsub)]
          "]")
         [])
        [])
       (group
           ...
           [(Term.typeSpec
             ...
             («term_=_»
              (Algebra.BigOperators.Basic.«term∑_,_»
               ...
               (Term.app
                («term_-_»
                 (Term.app `point_weights_with_circumcenter [`i₁])
                 "-"
                 (Term.app `point_weights_with_circumcenter [`i₂]))
                [`i]))
              "="
         ...
         (Tactic.rwRuleSeq
          ...
          [(Tactic.rwRule
            ...
            (Term.app
             `inner_weighted_vsub
             [(Term.hole "_")
              (Term.app `sum_monge_point_vsub_face_centroid_weights_with_circumcenter [`h])
              (Term.hole "_")
              `hs]))
           ","
           (Tactic.rwRule [] `sum_points_with_circumcenter)
           ","
           (Tactic.rwRule [] `points_with_circumcenter_eq_circumcenter)]
          "]")
         [])
        [])
       (group
        (Tactic.simp
         ...
         ["only"]
         ["["
          [(Tactic.simpLemma [] [] `monge_point_vsub_face_centroid_weights_with_circumcenter)
           ","
           (Tactic.simpLemma [] [] `points_with_circumcenter_point)]
          "]"]
         [])
        [])
       (group
        (Tactic.tacticLet_
         ...
         (Term.letDecl
          (Term.letIdDecl
           `fs
           [(Term.typeSpec ":" (Term.app `Finset [(Term.app `Finₓ [(Init.Logic.«term_+_» `n "+" (numLit "3"))])]))]
           ":="
           (Set.«term{_}» "{" [`i₁ "," `i₂] "}"))))
        [])
       (group
          ...
          (Term.haveIdDecl
           ...
           [(Term.typeSpec
             ...
             (Term.forall
              ...
              [(Term.simpleBinder
                [`i]
                [(Term.typeSpec ":" (Term.app `Finₓ [(Init.Logic.«term_+_» `n "+" (numLit "3"))]))])]
              ","
              (Term.arrow
               (Init.Core.«term_∉_» `i " ∉ " `fs)
               "→"
               («term_∧_» («term_≠_» `i "≠" `i₁) "∧" («term_≠_» `i "≠" `i₂)))))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
                  ...
                  (Tactic.tacticSeq
                   (Tactic.tacticSeq1Indented
                    [(group (Tactic.intro "intro" [`hj]) [])
                     (group
                      (Tactic.simpa "simpa" [] [] ["[" [(Tactic.simpLemma [] ["←"] `hj)] "]"] [] ["using" `hi])
                      [])]))))
                [])]))))))
        [])
       (group
        (Tactic.rwSeq
         "rw"
         []
         (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] (Term.app `sum_subset [`fs.subset_univ (Term.hole "_")]))] "]")
         [])
        [])
       (group
        (Tactic.«tactic·._»
             ...
             (Tactic.simpRw
              ...
              (Tactic.rwRuleSeq
               ...
               [(Tactic.rwRule [] `sum_points_with_circumcenter)
                ...
                (Tactic.rwRule [] `points_with_circumcenter_eq_circumcenter)
                ","
                (Tactic.rwRule [] `points_with_circumcenter_point)
                ","
                (Tactic.rwRule [] `Pi.sub_apply)
                ","
                (Tactic.rwRule [] `point_weights_with_circumcenter)]
               "]")
              [])
             [])
            (group
             (Tactic.rwSeq
              ...
              (Tactic.rwRuleSeq
               "["
               [(Tactic.rwRule ["←"] (Term.app `sum_subset [`fs.subset_univ (Term.hole "_")]))]
               "]")
              [])
             [])
            (group
                ...
                [(group
                  (Tactic.simpRw
                   ...
                   (Tactic.rwRuleSeq
                    ...
                    [(Tactic.rwRule
                      []
                      (Term.app `sum_insert [(Term.app (Term.proj `not_mem_singleton "." (fieldIdx "2")) [`h])]))
                     ","
                      ...
                      (group
                       (Tactic.simp
                        ...
                        ["["
                         [(Tactic.simpLemma [] [] `h)
                          ","
                          (Tactic.simpLemma [] [] (Term.app `Ne.symm [`h]))
                          ","
                          (Tactic.simpLemma [] [] (Term.app `dist_comm [(Term.app `s.points [`i₁])]))]
                         "]"]
                        [])
                       [])])))
                  [])
                 (group
                  (Tactic.allGoals
                   ...
                   (Tactic.tacticSeq
                    (Tactic.tacticSeq1Indented
                     [(group (Tactic.intro "intro" [`i `hu `hi]) [])
                      (group
                       (Tactic.simp "simp" [] [] ["[" [(Tactic.simpLemma [] [] (Term.app `hfs [`i `hi]))] "]"] [])
                       [])])))
                  [])])))
             [])
            (group
                ...
                [(group (Tactic.intro "intro" [`i `hu `hi]) [])
                 (group
                  (Tactic.simp
                   ...
                   []
                   ["["
                    [(Tactic.simpLemma [] [] (Term.app `hfs [`i `hi]))
                     ","
                     (Tactic.simpLemma [] [] `point_weights_with_circumcenter)]
                    "]"]
                   [])
                  [])])))
             [])])))
       ...
       (group
        (Tactic.«tactic·._»
         ...
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group (Tactic.intro "intro" [`i `hu `hi]) [])
            (group (Tactic.simp "simp" [] [] ["[" [(Tactic.simpLemma [] [] (Term.app `hfs [`i `hi]))] "]"] []) [])])))
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.simp
   ...
   []
   ["["
    [(Tactic.simpLemma [] [] (Term.app `hfs [`i `hi])) "," (Tactic.simpLemma [] [] `point_weights_with_circumcenter)]
    "]"]
   [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simp', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«]»', expected 'optional.antiquot_scope'
    ...
    (Tactic.tacticSeq1Indented
     [(group
       (Tactic.simpRw
        ...
        (Tactic.rwRuleSeq
         "["
         [(Tactic.rwRule [] (Term.app `sum_insert [(Term.app (Term.proj `not_mem_singleton "." (fieldIdx "2")) [`h])]))
          ","
          (Tactic.rwRule [] `sum_singleton)]
         "]")
        [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simpLemma', expected 'Lean.Parser.Tactic.simpErase'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `dist_comm [(Term.app `s.points [`i₁])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `s.points [`i₁]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `dist_comm
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.proj `not_mem_singleton "." (fieldIdx "2")) [`h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj `not_mem_singleton "." (fieldIdx "2"))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `sum_subset [`fs.subset_univ (Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
   ...
   (Term.haveDecl
    (Term.haveIdDecl
     ...
     [(Term.typeSpec
       ...
       (Term.forall
        "∀"
        [(Term.simpleBinder [`i] [(Term.typeSpec ":" (Term.app `Finₓ [(Init.Logic.«term_+_» `n "+" (numLit "3"))]))])]
        ","
        (Term.arrow
         (Init.Core.«term_∉_» `i " ∉ " `fs)
         "→"
          ...
          (Tactic.«tactic_<;>_»
           ...
           (Tactic.«tactic·._»
            ...
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(group (Tactic.intro "intro" [`hj]) [])
               (group (Tactic.simpa "simpa" [] [] ["[" [(Tactic.simpLemma [] ["←"] `hj)] "]"] [] ["using" `hi]) [])]))))
          [])]))))))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticHave_', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.haveDecl', expected 'Lean.Parser.Term.haveDecl.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.haveIdDecl', expected 'Lean.Parser.Term.haveIdDecl.antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.forall
   ...
   [(Term.simpleBinder [`i] [(Term.typeSpec ":" (Term.app `Finₓ [(Init.Logic.«term_+_» `n "+" (numLit "3"))]))])]
   ","
   (Term.arrow (Init.Core.«term_∉_» `i " ∉ " `fs) "→" («term_∧_» («term_≠_» `i "≠" `i₁) "∧" («term_≠_» `i "≠" `i₂))))
...
[PrettyPrinter.parenthesize] ...precedences are 25 >? 35, (some 35, term) <=? (none, [anonymous])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Finₓ [(Init.Logic.«term_+_» `n "+" (numLit "3"))])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `Finₓ [(Term.paren "(" [(Init.Logic.«term_+_» `n "+" (numLit "3")) []] ")")]) []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `Finset
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app
   `inner_weighted_vsub
   [(Term.hole "_") (Term.app `sum_monge_point_vsub_face_centroid_weights_with_circumcenter [`h]) (Term.hole "_") `hs])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_=_»
   (Algebra.BigOperators.Basic.«term∑_,_»
    ...
    ", "
    (Term.app
     («term_-_» (Term.app `point_weights_with_circumcenter [`i₁]) "-" (Term.app `point_weights_with_circumcenter [`i₂]))
     [`i]))
   "="
   (numLit "0"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_=_»', expected 'antiquot'
...
/--
  ...
  theorem
    ...
    { n : ℕ } ( s : simplex ℝ P n + 2 ) { i₁ i₂ : Finₓ n + 3 }
      :
        ⟪ s.monge_point -ᵥ ( { i₁ , i₂ } ᶜ : Finset Finₓ n + 3 ) . centroid ℝ s.points , s.points i₁ -ᵥ s.points i₂ ⟫
          =
          0
    :=
      by
        by_cases' h : i₁ = i₂
          ...
          simp_rw
            [
              monge_point_vsub_face_centroid_eq_weighted_vsub_of_points_with_circumcenter s h
                ,
          ...
          rw
            [
              inner_weighted_vsub _ sum_monge_point_vsub_face_centroid_weights_with_circumcenter h _ hs
                ,
                sum_points_with_circumcenter
                ,
                points_with_circumcenter_eq_circumcenter
          ...
          have
            hfs
              : ∀ i : Finₓ n + 3 , i ∉ fs → i ≠ i₁ ∧ i ≠ i₂
              :=
              by intro i hi constructor <;> · intro hj simpa [ ← hj ] using hi
          ...
          ·
            simp_rw
              ...
              · intro i hu hi simp [ hfs i hi , point_weights_with_circumcenter ]
          · intro i hu hi simp [ hfs i hi ]
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " The Monge point is the only point in all the Monge planes from any\none vertex. -/")]
  []
  []
  []
  []
 ...
 (Command.theorem
  "theorem"
  (Command.declId `eq_monge_point_of_forall_mem_monge_plane [])
  (Command.declSig
   [(Term.implicitBinder "{" [`n] [":" (termℕ "ℕ")] "}")
    (Term.implicitBinder
     "{"
     ...
     [":" (Term.app `simplex [(Data.Real.Basic.termℝ "ℝ") `P (Init.Logic.«term_+_» `n "+" (numLit "2"))])]
     "}")
    (Term.implicitBinder "{" [`i₁] [":" (Term.app `Finₓ [(Init.Logic.«term_+_» `n "+" (numLit "3"))])] "}")
    ...
    (Term.explicitBinder
     ...
     [":"
      (Term.forall
       ...
       [(Term.simpleBinder [`i₂] [])]
       ","
       (Term.arrow («term_≠_» `i₁ "≠" `i₂) "→" (Init.Core.«term_∈_» `p " ∈ " (Term.app `s.monge_plane [`i₁ `i₂]))))]
     []
     ")")]
   (Term.typeSpec ":" («term_=_» `p "=" `s.monge_point)))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.rwSeq
         "rw"
         []
         (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] (Term.app (Term.explicit "@" `vsub_eq_zero_iff_eq) [`V]))] "]")
         [])
        [])
       (group
        (Tactic.tacticHave_
           ...
           [(Term.typeSpec
             ...
             (Term.forall
              ...
              (Term.arrow
               ...
               "→"
               (Init.Core.«term_∈_»
                (Algebra.AddTorsor.«term_-ᵥ_» `p " -ᵥ " `s.monge_point)
                " ∈ "
                (Order.Lattice.«term_⊓_»
                 (Analysis.InnerProductSpace.Basic.«term_ᗮ»
                  (Submodule.LinearAlgebra.Basic.«term_∙_»
                   (Data.Real.Basic.termℝ "ℝ")
                   "∙"
                   (Algebra.AddTorsor.«term_-ᵥ_» (Term.app `s.points [`i₁]) " -ᵥ " (Term.app `s.points [`i₂])))
                  "ᗮ")
                 "⊓"
                 (Term.app `vectorSpan [(Data.Real.Basic.termℝ "ℝ") (Term.app `Set.Range [`s.points])]))))))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(group (Tactic.intro "intro" [`i₂ `hne]) [])
               (group
                (Tactic.rwSeq
                 "rw"
                 []
                 (Tactic.rwRuleSeq
                  "["
                  [(Tactic.rwRule ["←"] `s.direction_monge_plane)
                   ","
                   (Tactic.rwRule [] (Term.app `vsub_right_mem_direction_iff_mem [`s.monge_point_mem_monge_plane]))]
                  "]")
                 [])
                [])
               (group (Tactic.exact "exact" (Term.app `h [`i₂ `hne])) [])]))))))
        [])
       (group
        (Tactic.tacticHave_
         "have"
         (Term.haveDecl
          (Term.haveIdDecl
           ...
           (Term.byTactic
            ...
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Submodule.mem_infi)] "]") []) [])
               (group
                (Tactic.exact
                 "exact"
                 (Term.fun
                  ...
                  (Term.basicFun
                   ...
                   "=>"
                   (Term.proj
                    (Term.app (Term.proj `Submodule.mem_inf "." (fieldIdx "1")) [(Term.app `h' [`i `i.property])])
                    "."
                    (fieldIdx "1")))))
                [])]))))))
        [])
       (group
        (Tactic.rwSeq
         ...
         (Tactic.rwRuleSeq
          "["
          [(Tactic.rwRule [] `Submodule.infi_orthogonal) "," (Tactic.rwRule ["←"] `Submodule.span_Union)]
          "]")
           ...
           [(Term.typeSpec
             ...
             («term_=_»
              ...
              (Set.Data.Set.Basic.term_''_
               (Term.app
                (Algebra.AddTorsor.«term_-ᵥ_» (Term.cdot "·") " -ᵥ " (Term.cdot "·"))
                [(Term.app `s.points [`i₁])])
               " '' "
               (Set.Data.Set.Basic.term_''_
                `s.points
                " '' "
                (Init.Core.«term_\_» `Set.Univ " \\ " (Set.«term{_}» "{" [`i₁] "}"))))))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Set.image_image)] "]") []) [])
                ...
                (Tactic.simpRw
                 ...
                 (Tactic.rwRuleSeq
                  ...
                  [(Tactic.rwRule [] `Set.mem_Union)
                   ...
                   ","
                   (Tactic.rwRule [] `Set.mem_diff_singleton)]
                  "]")
                 [])
                [])
                   ...
                   [(group
                    ...
                    (group
                     (Tactic.use
                      ...
                      [`i
                       ","
                       (Term.anonymousCtor "⟨" [(Term.app `Set.mem_univ [(Term.hole "_")]) "," `i.property.symm] "⟩")])
                     [])])))
                [])
               (group
                (Tactic.«tactic·._»
                  ...
                  (Tactic.tacticSeq1Indented
                   [(group
                     (Tactic.rintro
                         ...
                         [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `i)]) [])
                          ...
                          (Tactic.rcasesPatLo
                           (Tactic.rcasesPatMed
                            [(Tactic.rcasesPat.tuple
                              "⟨"
                              [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `hiu)]) [])
                               ","
                      ...
                      [])
                     [])
                    (group (Tactic.use "use" [(Term.anonymousCtor "⟨" [`i "," `hi.symm] "⟩") "," `rfl]) [])])))
                [])]))))))
        [])
       (group
        (Tactic.rwSeq
         ...
         (Tactic.rwRuleSeq
          ...
          [(Tactic.rwRule [] `hu)
           ...
           (Tactic.rwRule
            ["←"]
            (Term.app
             `vector_span_image_eq_span_vsub_set_left_ne
             [(Data.Real.Basic.termℝ "ℝ") (Term.hole "_") (Term.app `Set.mem_univ [(Term.hole "_")])]))
           ","
              ...
              [(group
               ...
               (group
                (Tactic.obtain
                 ...
                 [":="
                  [(Term.app
                    (Term.proj `card_pos "." (fieldIdx "1"))
                    [(Term.show
                      "show"
                      («term_<_» (numLit "0") "<" (Term.app `card [`s₁]))
                      (Term.byTactic
                       "by"
                       (Tactic.tacticSeq
                        (Tactic.tacticSeq1Indented
                         [(group
                           (Tactic.simp "simp" [] [] ["[" [(Tactic.simpLemma [] [] `card_erase_of_mem)] "]"] [])
                           [])]))))])]])
                [])
               (group
                (Tactic.tacticHave_
                 ...
                 (Term.haveDecl
                  (Term.haveIdDecl
                   [`h₁₂ []]
                   [(Term.typeSpec ":" («term_≠_» `i₁ "≠" `i₂))]
                   ":="
                   (Term.proj (Term.app `ne_of_mem_erase [`h₂]) "." `symm))))
                [])
               (group
                (Tactic.exact
                 "exact"
                 (Term.proj
                  (Term.app (Term.proj `Submodule.mem_inf "." (fieldIdx "1")) [(Term.app `h' [`i₂ `h₁₂])])
                  "."
                  (fieldIdx "2")))
                [])]))))))
        [])
       (group
        (Tactic.exact
         "exact"
         (Term.app
          (Term.proj `Submodule.disjoint_def "." (fieldIdx "1"))
          [(Term.proj
            (Term.app `vectorSpan [(Data.Real.Basic.termℝ "ℝ") (Term.app `Set.Range [`s.points])])
            "."
            `orthogonal_disjoint)
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Set.Range [`s.points]) []] ")")
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `vectorSpan [(Data.Real.Basic.termℝ "ℝ") (Term.paren "(" [(Term.app `Set.Range [`s.points]) []] ")")]) []]
 ")")
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (some 1023, term)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj `Submodule.disjoint_def "." (fieldIdx "1"))
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `h' [`i₂ `h₁₂]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj `Submodule.mem_inf "." (fieldIdx "1"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  `Submodule.mem_inf
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app (Term.proj `Submodule.mem_inf "." (fieldIdx "1")) [(Term.paren "(" [(Term.app `h' [`i₂ `h₁₂]) []] ")")]) []]
 ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `ne_of_mem_erase [`h₂]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'optional.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
    ...
    [(Term.app
      ...
      [(Term.show
        ...
        (Term.byTactic
         ...
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group (Tactic.simp "simp" [] [] ["[" [(Tactic.simpLemma [] [] `card_erase_of_mem)] "]"] []) [])]))))])]])
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Set.mem_univ [(Term.hole "_")]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.ellipsis.antiquot'
    ...
    (Term.haveIdDecl
     ...
     [(Term.typeSpec
       ...
       («term_=_»
        ...
        "="
        (Set.Data.Set.Basic.term_''_
         (Term.app (Algebra.AddTorsor.«term_-ᵥ_» (Term.cdot "·") " -ᵥ " (Term.cdot "·")) [(Term.app `s.points [`i₁])])
         " '' "
         (Set.Data.Set.Basic.term_''_
          `s.points
          " '' "
            ...
            (Tactic.tacticSeq1Indented
             [(group
              ...
              (group
               (Tactic.use
                "use"
                [`i "," (Term.anonymousCtor "⟨" [(Term.app `Set.mem_univ [(Term.hole "_")]) "," `i.property.symm] "⟩")])
               [])])))
          [])
         (group
          (Tactic.«tactic·._»
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.use "use" [(Term.anonymousCtor "⟨" [`i "," `hi.symm] "⟩") "," `rfl])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Set.image_image)] "]") [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `Set.image_image
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Set.Data.Set.Basic.term_''_
   (Term.app (Algebra.AddTorsor.«term_-ᵥ_» (Term.cdot "·") " -ᵥ " (Term.cdot "·")) [(Term.app `s.points [`i₁])])
   " '' "
   (Set.Data.Set.Basic.term_''_ `s.points " '' " (Init.Core.«term_\_» `Set.Univ " \\ " (Set.«term{_}» "{" [`i₁] "}"))))
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(Set.Data.Set.Basic.term_''_
   `s.points
   " '' "
   (Term.paren "(" [(Init.Core.«term_\_» `Set.Univ " \\ " (Set.«term{_}» "{" [`i₁] "}")) []] ")"))
  []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 80, term))
  (Term.app (Algebra.AddTorsor.«term_-ᵥ_» (Term.cdot "·") " -ᵥ " (Term.cdot "·")) [(Term.app `s.points [`i₁])])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.paren
   "("
   [(Set.«term{_}» "{" [(Algebra.AddTorsor.«term_-ᵥ_» (Term.app `s.points [`i₁]) " -ᵥ " (Term.app `s.points [`i]))] "}")
    [(Term.typeAscription ":" (Term.app `Set [`V]))]]
   ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.paren', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.paren', expected 'Lean.Parser.Term.paren.antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, [anonymous]))
  (Set.«term{_}» "{" [(Algebra.AddTorsor.«term_-ᵥ_» (Term.app `s.points [`i₁]) " -ᵥ " (Term.app `s.points [`i]))] "}")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Set.«term{_}»', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Algebra.AddTorsor.«term_-ᵥ_»', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Algebra.AddTorsor.«term_-ᵥ_» (Term.app `s.points [`i₁]) " -ᵥ " (Term.app `s.points [`i]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Algebra.AddTorsor.«term_-ᵥ_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
/--
  ...
  theorem
    ...
    { n : ℕ } { s : simplex ℝ P n + 2 } { i₁ : Finₓ n + 3 } { p : P } ( h : ∀ i₂ , i₁ ≠ i₂ → p ∈ s.monge_plane i₁ i₂ )
      : p = s.monge_point
    :=
      by
        rw [ ← @ vsub_eq_zero_iff_eq V ]
          have
            h'
              : ∀ i₂ , i₁ ≠ i₂ → p -ᵥ s.monge_point ∈ ℝ ∙ s.points i₁ -ᵥ s.points i₂ ᗮ ⊓ vectorSpan ℝ Set.Range s.points
              :=
              by
                intro i₂ hne
          ...
          have
            hi
              : p -ᵥ s.monge_point ∈ ⨅ i₂ : { i // i₁ ≠ i } , ℝ ∙ s.points i₁ -ᵥ s.points i₂ ᗮ
              :=
              by rw [ Submodule.mem_infi ] exact fun i => Submodule.mem_inf . 1 h' i i.property . 1
            ...
            hu
              ...
              by
                rw [ Set.image_image ]
                  ...
                  constructor
                  · rintro ⟨ i , rfl ⟩ use i , ⟨ Set.mem_univ _ , i.property.symm ⟩
                  · rintro ⟨ i , ⟨ hiu , hi ⟩ , rfl ⟩ use ⟨ i , hi.symm ⟩ , rfl
          rw [ hu , ← vector_span_image_eq_span_vsub_set_left_ne ℝ _ Set.mem_univ _ , Set.image_univ ] at hi
          have
            hv
              : p -ᵥ s.monge_point ∈ vectorSpan ℝ Set.Range s.points
              :=
              by
