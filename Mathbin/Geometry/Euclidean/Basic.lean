...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `cos_angle_mul_norm_mul_norm [])
  (Command.declSig
   [(Term.explicitBinder "(" [`x `y] [":" `V] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Finset.Data.Finset.Fold.«term_*_»
      (Term.app `Real.cos [(Term.app `angle [`x `y])])
      "*"
      (Finset.Data.Finset.Fold.«term_*_»
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.rwSeq
         "rw"
         []
         (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `cos_angle) "," (Tactic.rwRule [] `div_mul_cancel_of_imp)] "]")
         [])
        [])
       (group
        (Tactic.simp
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " Two vectors have inner product 0 if and only if the angle between\nthem is π/2. -/")]
  []
  []
  []
  []
 ...
 (Command.theorem
  "theorem"
  (Command.declId `inner_eq_zero_iff_angle_eq_pi_div_two [])
  (Command.declSig
   [(Term.explicitBinder "(" [`x `y] [":" `V] [] ")")]
   (Term.typeSpec
    ":"
    («term_↔_»
     («term_=_» (Analysis.InnerProductSpace.Projection.«term⟪_,_⟫» "⟪" `x ", " `y "⟫") "=" (numLit "0"))
     "↔"
     («term_=_»
      (Term.app `angle [`x `y])
      "="
       ...
       [(group
         (Tactic.simp
          ...
          ["("
           ...
           ")"]
          []
          ["[" [(Tactic.simpLemma [] [] `angle) "," (Tactic.simpLemma [] [] `or_imp_distrib)] "]"]
          [])
         [])]))))
   [])
  []
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `inner_weighted_vsub [])
  (Command.declSig
   ...
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app `inner [(Term.app `s₁.weighted_vsub [`p₁ `w₁]) (Term.app `s₂.weighted_vsub [`p₂ `w₂])])
     "="
     («term_/_»
      («term-_»
       "-"
       (Algebra.BigOperators.Basic.«term∑_in_,_»
        ...
        (Algebra.BigOperators.Basic.«term∑_in_,_»
         ...
         (Finset.Data.Finset.Fold.«term_*_»
          ...
          "*"
          (Finset.Data.Finset.Fold.«term_*_»
           (Term.app `dist [(Term.app `p₁ [`i₁]) (Term.app `p₂ [`i₂])])
           "*"
           (Term.app `dist [(Term.app `p₁ [`i₁]) (Term.app `p₂ [`i₂])]))))))
      "/"
      (numLit "2")))))
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.rwSeq
         ...
         (Tactic.rwRuleSeq
          "["
          [(Tactic.rwRule [] `Finset.weighted_vsub_apply)
           ","
           (Tactic.rwRule [] `Finset.weighted_vsub_apply)
           ","
           (Tactic.rwRule
            []
            (Term.app `inner_sum_smul_sum_smul_of_sum_eq_zero [(Term.hole "_") `h₁ (Term.hole "_") `h₂]))]
          "]")
         [])
        [])
       (group
        (Tactic.simpRw "simp_rw" (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `vsub_sub_vsub_cancel_right)] "]") [])
        [])
       (group
        (Tactic.«tactic_<;>_»
         (Tactic.rcongr "rcongr" [(Tactic.rcasesPat.one `i₁) (Tactic.rcasesPat.one `i₂)])
         "<;>"
         (Tactic.rwSeq
          "rw"
          []
          (Tactic.rwRuleSeq
           "["
           [(Tactic.rwRule [] (Term.app `dist_eq_norm_vsub [`V (Term.app `p₁ [`i₁]) (Term.app `p₂ [`i₂])]))]
           "]")
          []))
        [])])))
   [])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `dist_eq_norm_vsub [`V (Term.app `p₁ [`i₁]) (Term.app `p₂ [`i₂])])
  ...
  (Tactic.rwSeq
   ...
   (Tactic.rwRuleSeq
    ...
    [(Tactic.rwRule [] `Finset.weighted_vsub_apply)
     ...
     (Tactic.rwRule [] `Finset.weighted_vsub_apply)
     ","
     (Tactic.rwRule [] (Term.app `inner_sum_smul_sum_smul_of_sum_eq_zero [(Term.hole "_") `h₁ (Term.hole "_") `h₂]))]
    "]")
   [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
  ...
  theorem
    ...
    :=
      by
        rw
            [
              Finset.weighted_vsub_apply , Finset.weighted_vsub_apply , inner_sum_smul_sum_smul_of_sum_eq_zero _ h₁ _ h₂
              ]
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `dist_affine_combination [])
  (Command.declSig
   [(Term.implicitBinder "{" [`ι] [":" (Term.type "Type" [(Level.hole "_")])] "}")
    (Term.implicitBinder "{" [`s] [":" (Term.app `Finset [`ι])] "}")
    (Term.implicitBinder "{" [`w₁ `w₂] [":" (Term.arrow `ι "→" (Data.Real.Basic.termℝ "ℝ"))] "}")
    (Term.explicitBinder "(" [`p] [":" (Term.arrow `ι "→" `P)] [] ")")
    (Term.explicitBinder
     "("
     [`h₁]
   ...
   (Term.typeSpec
    ...
    («term_=_»
     (Finset.Data.Finset.Fold.«term_*_»
      (Term.app `dist [(Term.app `s.affine_combination [`p `w₁]) (Term.app `s.affine_combination [`p `w₂])])
      "*"
      (Term.app `dist [(Term.app `s.affine_combination [`p `w₁]) (Term.app `s.affine_combination [`p `w₂])]))
     "="
     («term_/_»
        ...
        (Tactic.rwSeq
         ...
         (Tactic.rwRuleSeq
          ...
          [(Tactic.rwRule
            ...
            (Term.app
             `dist_eq_norm_vsub
             [`V (Term.app `s.affine_combination [`p `w₁]) (Term.app `s.affine_combination [`p `w₂])]))
           ","
            ...
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(group
                ...
                [])]))))))
        [])
       (group (Tactic.exact "exact" (Term.app `inner_weighted_vsub [`p `h `p `h])) [])])))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `inner_weighted_vsub [`p `h `p `h]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `inner_weighted_vsub [`p `h `p `h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(«term_-_» `w₁ "-" `w₂) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `s
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
  ...
  theorem
    ...
    :=
      by
        rw
            [
              dist_eq_norm_vsub V s.affine_combination p w₁ s.affine_combination p w₂
                ,
                ← inner_self_eq_norm_mul_norm
                ,
                Finset.affine_combination_vsub
              ]
          have h : ∑ i in s , w₁ - w₂ i = 0 := by simp_rw [ Pi.sub_apply , Finset.sum_sub_distrib , h₁ , h₂ , sub_self ]
