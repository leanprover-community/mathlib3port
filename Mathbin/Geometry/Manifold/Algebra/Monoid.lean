...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `smooth_finset_prod' [])
  (Command.declSig
   [(Term.implicitBinder "{" [`ι] [] "}")
    (Term.implicitBinder "{" [`s] [":" (Term.app `Finset [`ι])] "}")
    (Term.implicitBinder "{" [`f] [":" (Term.arrow `ι "→" (Term.arrow `M "→" `G))] "}")
    (Term.explicitBinder
     "("
     [`h]
     [":"
      (Term.forall
       ...
       (Mathlib.ExtendedBinder.«term∀___,_»
        ...
        («binderTerm∈_» "∈" `s)
        ","
        (Term.forall "∀" [] "," (Term.app `Smooth [`I' `I (Term.app `f [`i])]))))]
     []
     ")")]
   (Term.typeSpec
    ":"
  ...
  (Command.declValSimple
   ...
   (Term.app
    ...
    [(Term.hole "_")
     (Term.hole "_")
     (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`f `g `hf `hg] [])] "=>" (Term.app `hf.mul [`hg])))
     (Term.app
      (Term.explicit "@" `smooth_const)
      [(Term.hole "_")
       (Term.hole "_")
       (Term.hole "_")
       (Term.hole "_")
...
@[ to_additive ]
  theorem
    smooth_finset_prod'
    { ι } { s : Finset ι } { f : ι → M → G } ( h : ∀ , ∀ i ∈ s , ∀ , Smooth I' I f i ) : Smooth I' I ∏ i in s , f i
   ...
   (Term.byTactic
    ...
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group (Tactic.simp "simp" [] ["only"] ["[" [(Tactic.simpLemma [] ["←"] `Finset.prod_apply)] "]"] []) [])
       (group (Tactic.exact "exact" (Term.app `smooth_finset_prod' [`h])) [])])))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `smooth_finset_prod' [`h]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `smooth_finset_prod' [`h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.simp "simp" [] ["only"] ["[" [(Tactic.simpLemma [] ["←"] `Finset.prod_apply)] "]"] [])
...
@[ to_additive ]
  theorem
    smooth_finset_prod
    { ι } { s : Finset ι } { f : ι → M → G } ( h : ∀ , ∀ i ∈ s , ∀ , Smooth I' I f i )
  ...
  (Command.declSig
   [(Term.implicitBinder "{" [`ι] [] "}")
    ...
    (Term.explicitBinder
     "("
     [`h]
     [":" (Term.forall "∀" [(Term.simpleBinder [`i] [])] "," (Term.app `Smooth [`I' `I (Term.app `f [`i])]))]
     []
     ")")
    (Term.explicitBinder
     "("
     ...
     (Tactic.tacticSeq1Indented
      [(group (Tactic.intro "intro" [`x]) [])
       (group
        (Tactic.rcases
         "rcases"
         [(Tactic.casesTarget [] (Term.app `hfin [`x]))]
         ["with"
       ...
       (group
        (Tactic.exact
         ...
         (Term.app
          `smooth_finset_prod
          [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`i `hi] [])] "=>" (Term.app `h [`i]))) `x]))
        [])
       (group
        (Tactic.refine'
         "refine'"
         (Term.app
          `this.congr_of_eventually_eq
          [(«term_$__»
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`i `hi] [])] "=>" (Term.app `h [`i])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.fun.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.basicFun.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
@[ to_additive ]
  theorem
    smooth_finprod
    { ι } { f : ι → M → G } ( h : ∀ i , Smooth I' I f i ) ( hfin : LocallyFinite fun i => mul_support f i )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `smooth_finprod_cond [])
  (Command.declSig
   [(Term.implicitBinder "{" [`ι] [] "}")
    (Term.implicitBinder "{" [`f] [":" (Term.arrow `ι "→" (Term.arrow `M "→" `G))] "}")
    ...
    (Term.explicitBinder
     ...
     [":"
      (Term.forall
       ...
       [(Term.simpleBinder [`i] [])]
       ","
       (Term.arrow (Term.app `p [`i]) "→" (Term.app `Smooth [`I' `I (Term.app `f [`i])])))]
     []
     ")")
    (Term.explicitBinder
     "("
...
@[ to_additive ]
  theorem
    ...
    { ι }
        { f : ι → M → G }
        { p : ι → Prop }
        ( hc : ∀ i , p i → Smooth I' I f i )
        ( hf : LocallyFinite fun i => mul_support f i )
      : Smooth I' I fun x => ∏ᶠ ( i : _ ) ( hi : p i ) , f i x
    :=
      by
