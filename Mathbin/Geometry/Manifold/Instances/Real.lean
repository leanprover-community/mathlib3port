...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `range_half_space [])
  (Command.declSig
   [(Term.explicitBinder "(" [`n] [":" (termℕ "ℕ")] [] ")")
    (Term.instBinder "[" [] (Term.app `HasZero [(Term.app `Finₓ [`n])]) "]")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app
      ...
      [(Term.fun
        "fun"
        (Term.basicFun
         [(Term.simpleBinder [`x] [(Term.typeSpec ":" (Term.app `EuclideanHalfSpace [`n]))])]
         "=>"
         `x.val))])
     "="
     (Set.«term{_|_}» "{" `y "|" («term_≤_» (numLit "0") "≤" (Term.app `y [(numLit "0")])) "}"))))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_≤_» (numLit "0") "≤" (Term.app `y [(numLit "0")]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_≤_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `y [(numLit "0")])
    ...
    («term_=_»
     (Term.app
      ...
      [(Term.fun
        "fun"
        (Term.basicFun
         [(Term.simpleBinder [`x] [(Term.typeSpec ":" (Term.app `EuclideanQuadrant [`n]))])]
         "=>"
         `x.val))])
     "="
     (Set.«term{_|_}»
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, [anonymous]))
  («term_=_»
   (Term.app
    ...
    [(Term.fun
      "fun"
      (Term.basicFun [(Term.simpleBinder [`x] [(Term.typeSpec ":" (Term.app `EuclideanQuadrant [`n]))])] "=>" `x.val))])
   "="
   (Set.«term{_|_}»
    "{"
    `y
...
-- ././Mathport/Syntax/Translate/Basic.lean:477:2: warning: expanding binder collection (i «expr ∈ » ({0} : set (fin n)))
/- failed to parenthesize: parenthesize: uncaught backtrack exception
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment
 ...
 (Command.def
  "def"
  (Command.declId `modelWithCornersEuclideanHalfSpace [])
  (Command.optDeclSig
   [(Term.explicitBinder "(" [`n] [":" (termℕ "ℕ")] [] ")")
    (Term.instBinder "[" [] (Term.app `HasZero [(Term.app `Finₓ [`n])]) "]")]
   [(Term.typeSpec
     ...
     (Term.app
      ...
      [(Data.Real.Basic.termℝ "ℝ")
       ...
       (Term.app `EuclideanHalfSpace [`n])]))])
  (Command.declValSimple
   ":="
   (Term.structInst
    "{"
    []
    [(group (Term.structInstField (Term.structInstLVal `toFun []) ":=" `Subtype.val) [","])
     (group
      (Term.structInstField
       ...
       (Term.fun
        ...
        (Term.basicFun
         ...
         (Term.anonymousCtor
          "⟨"
          [(Term.app `update [`x (numLit "0") (Term.app `max [(Term.app `x [(numLit "0")]) (numLit "0")])])
           ","
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
          ...
          "⟩"))))
      [","])
     (group (Term.structInstField (Term.structInstLVal `Source []) ":=" `univ) [","])
     (group
      (Term.structInstField
       (Term.structInstLVal `Target [])
       ":="
       (Set.«term{_|_}» "{" `x "|" («term_≤_» (numLit "0") "≤" (Term.app `x [(numLit "0")])) "}"))
      [","])
     (group
      (Term.structInstField
       (Term.structInstLVal `map_source' [])
       ":="
       (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`x `hx] [])] "=>" `x.property)))
      [","])
     (group
      (Term.structInstField
       (Term.structInstLVal `map_target' [])
       ":="
       (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`x `hx] [])] "=>" (Term.app `mem_univ [(Term.hole "_")]))))
      [","])
     (group
      (Term.structInstField
       ...
       (Term.fun
        "fun"
        (Term.basicFun
         [(Term.anonymousCtor "⟨" [`xval "," `xprop] "⟩") (Term.simpleBinder [`hx] [])]
         "=>"
         (Term.byTactic
          "by"
          (Tactic.tacticSeq
           (Tactic.tacticSeq1Indented
            [(group
              (Tactic.rwSeq
               "rw"
               []
               (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Subtype.mk_eq_mk) "," (Tactic.rwRule [] `update_eq_iff)] "]")
               [])
              [])
             (group
              (Tactic.exact
               ...
               (Term.anonymousCtor
                "⟨"
                [(Term.app `max_eq_leftₓ [`xprop])
                 ","
                 (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`i (Term.hole "_")] [])] "=>" `rfl))]
                "⟩"))
              [])]))))))
      [","])
     (group
      ...
      (Term.structInstField
       ...
       (Term.have
        ...
        (Term.haveDecl
         (Term.haveIdDecl
          [`this []]
          [(Term.typeSpec ":" (Term.app `UniqueDiffOn [(Data.Real.Basic.termℝ "ℝ") (Term.hole "_")]))]
          ":="
          (Term.app
           `UniqueDiffOn.pi
           [(Term.app `Finₓ [`n])
            (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [(Term.hole "_")] [])] "=>" (Data.Real.Basic.termℝ "ℝ")))
            (Term.hole "_")
            (Term.hole "_")
            (Term.fun
             "fun"
                ...
                [(Term.typeSpec
                  ...
                  (Init.Core.«term_∈_»
                   ...
                   (Term.paren
                    "("
                    [(Set.«term{_}» "{" [(numLit "0")] "}")
                     [(Term.typeAscription ":" (Term.app `Set [(Term.app `Finₓ [`n])]))]]
                    ")")))])]
              "=>"
              (Term.app `unique_diff_on_Ici [(numLit "0")])))])))
        []
        (Term.byTactic
         "by"
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group
             (Tactic.simpa "simpa" [] ["only"] ["[" [(Tactic.simpLemma [] [] `singleton_pi)] "]"] [] ["using" `this])
             [])])))))
      [","])
     (group (Term.structInstField (Term.structInstLVal `continuous_to_fun []) ":=" `continuous_subtype_val) [","])
     (group
      (Term.structInstField
       (Term.structInstLVal `continuous_inv_fun [])
       ":="
       («term_$__»
        (Term.app `continuous_subtype_mk [(Term.hole "_")])
        "$"
        («term_$__»
         (Term.app (Term.proj `continuous_id "." `update) [(numLit "0")])
         "$"
         (Term.app (Term.proj (Term.app `continuous_apply [(numLit "0")]) "." `max) [`continuous_const]))))
      [])]
    (Term.optEllipsis [])
    []
    "}")
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `continuous_apply [(numLit "0")]) "." `max)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `continuous_apply [(numLit "0")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'numLit', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'numLit', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'numLit', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `continuous_apply [(numLit "0")]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj `continuous_id "." `update)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  `continuous_id
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
       ...
       (Term.simpleBinder
        ...
        [(Term.typeSpec
          ...
          (Init.Core.«term_∈_»
           ...
           (Term.paren
            "("
            [(Set.«term{_}» "{" [(numLit "0")] "}") [(Term.typeAscription ":" (Term.app `Set [(Term.app `Finₓ [`n])]))]]
            ")")))])]
      "=>"
      (Term.app `unique_diff_on_Ici [(numLit "0")])))])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `UniqueDiffOn [(Data.Real.Basic.termℝ "ℝ") (Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Set.«term{_|_}»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_≤_» (numLit "0") "≤" (Term.app `x [(numLit "0")]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_≤_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `x [(numLit "0")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `modelWithCornersEuclideanQuadrant [])
  (Command.optDeclSig
   [(Term.explicitBinder "(" [`n] [":" (termℕ "ℕ")] [] ")")]
   [(Term.typeSpec
     ":"
       ...
       (Term.fun
        ...
        (Term.basicFun
         ...
         (Term.anonymousCtor
          ...
          [(Term.fun
            "fun"
            (Term.basicFun [(Term.simpleBinder [`i] [])] "=>" (Term.app `max [(Term.app `x [`i]) (numLit "0")])))
           ","
           (Term.fun
            "fun"
            (Term.basicFun
     ...
     (group
      (Term.structInstField
       ...
       (Set.«term{_|_}»
        ...
        `x
        "|"
        (Term.forall "∀" [(Term.simpleBinder [`i] [])] "," («term_≤_» (numLit "0") "≤" (Term.app `x [`i])))
        "}"))
      [","])
     (group
      (Term.structInstField
           ...
           (Tactic.tacticSeq1Indented
            [(group
              (Tactic.simpa
               ...
               []
               ["only"]
               ["[" [(Tactic.simpLemma [] [] `Subtype.range_val)] "]"]
               []
               ["using" `x.property])
              [])]))))))
      [","])
              ...
              (Tactic.simp
               ...
               ["["
                [(Tactic.simpLemma [] [] `Subtype.coe_mk)
                 ","
                 (Tactic.simpLemma [] [] (Term.app `xprop [`i]))
                 ","
                 (Tactic.simpLemma [] [] `max_eq_leftₓ)]
                "]"]
               [])
              [])]))))))
      [","])
       ...
       (Term.fun
        ...
        (Term.basicFun
         ...
         (Term.byTactic
          ...
          (Tactic.tacticSeq
           (Tactic.tacticSeq1Indented
            [(group (Tactic.ext1 "ext1" [(Tactic.rcasesPat.one `i)]) [])
             (group
              (Tactic.simp
               "simp"
               []
               ["only"]
               ["[" [(Tactic.simpLemma [] [] (Term.app `hx [`i])) "," (Tactic.simpLemma [] [] `max_eq_leftₓ)] "]"]
               [])
              [])]))))))
      [","])
     (group (Term.structInstField (Term.structInstLVal `source_eq []) ":=" `rfl) [","])
         ...
         (Term.haveIdDecl
          ...
          (Term.app
           ...
           [(Term.app `Finₓ [`n])
            ...
            (Term.fun
             "fun"
             (Term.basicFun [(Term.simpleBinder [`i] [])] "=>" (Term.app `unique_diff_on_Ici [(numLit "0")])))])))
        []
        (Term.byTactic
         "by"
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group
             (Tactic.simpa "simpa" [] ["only"] ["[" [(Tactic.simpLemma [] [] `pi_univ_Ici)] "]"] [] ["using" `this])
             [])])))))
      [","])
     (group (Term.structInstField (Term.structInstLVal `continuous_to_fun []) ":=" `continuous_subtype_val) [","])
     (group
        ...
        («term_$__»
         ...
         (Term.fun
          ...
          (Term.basicFun
           ...
           "=>"
           (Term.app
            (Term.proj (Term.app (Term.proj `continuous_id "." `max) [`continuous_const]) "." `comp)
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app (Term.proj `continuous_id "." `max) [`continuous_const])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, term))
  (Term.app
   ...
   [(Term.app `Finₓ [`n])
    (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [(Term.hole "_")] [])] "=>" (Data.Real.Basic.termℝ "ℝ")))
    (Term.hole "_")
    (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`i] [])] "=>" (Term.app `unique_diff_on_Ici [(numLit "0")])))])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.ext1 "ext1" [(Tactic.rcasesPat.one `i)])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.simpa "simpa" [] ["only"] ["[" [(Tactic.simpLemma [] [] `Subtype.range_val)] "]"] [] ["using" `x.property])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simpa', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'optional.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `x.property
...
/--
  ...
  instance
    iccManifold
    ( x y : ℝ ) [ Fact ( x < y ) ] : ChartedSpace ( EuclideanHalfSpace 1 ) ( Icc x y )
    where
        ...
        mem_chart_source
          ...
          by
            by_cases' h' : z.val < y
              ...
              · simp only [ h' , if_false ] apply lt_of_lt_of_leₓ ( Fact.out ( x < y ) ) simpa only [ not_ltₓ ] using h'
        chart_mem_atlas z := by by_cases' h' : z.val < y <;> simp [ h' ]
