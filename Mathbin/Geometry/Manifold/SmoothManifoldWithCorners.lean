...
theorem unique_diff_preimage_source {β : Type _} [TopologicalSpace β] {e : PartialHomeomorph H β} :
...
theorem PartialHomeomorph.singleton_smoothManifoldWithCorners {𝕜 : Type _}
