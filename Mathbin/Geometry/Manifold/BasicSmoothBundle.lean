...
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » i.1.target)
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » ((i.1.symm.trans j.1).trans (j.1.symm.trans k.1)).source)
...
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » «expr ∩ »(«expr ⁻¹' »(I.symm, (i.1.symm.trans j.1).source), range I))
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (y «expr ∈ » «expr ∩ »(«expr ⁻¹' »(I.symm, ((i.1.symm.trans j.1).trans (j.1.symm.trans u.1)).source), range I))
...
theorem tangent_bundle_model_space_chart_at (p : TangentBundle I H) :
  (chart_at (ModelProd H E) p).toLocalEquiv = (Equivₓ.sigmaEquivProd H E).toLocalEquiv :=
  by 
...
theorem tangent_bundle_model_space_coe_chart_at (p : TangentBundle I H) :
  ⇑chart_at (ModelProd H E) p = Equivₓ.sigmaEquivProd H E :=
  by 
    unfoldCoes 
    simp' only with mfld_simps
...
theorem tangent_bundle_model_space_coe_chart_at_symm (p : TangentBundle I H) :
  ((chart_at (ModelProd H E) p).symm : ModelProd H E → TangentBundle I H) = (Equivₓ.sigmaEquivProd H E).symm :=
  by 
    unfoldCoes 
    simp' only with mfld_simps
