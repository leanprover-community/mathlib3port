...
instance smoothFunctionsAlgebra : Algebra 𝕜 C^∞⟮I, M; 𝕜⟯ :=
  by 
    infer_instance

instance smooth_functions_tower : IsScalarTower 𝕜 C^∞⟮I, M; 𝕜⟯ C^∞⟮I, M; 𝕜⟯ :=
  by 
    infer_instance
      ...
      fun v =>
        { toLinearMap :=
          ...
          leibniz' :=
            fun g g' =>
              by 
                simp only [Derivation.leibniz, SmoothMap.mul_comp, PointedSmoothMap.smul_def,
