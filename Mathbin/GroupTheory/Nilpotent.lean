...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `upperCentralSeriesAux [])
  (Command.optDeclSig
   []
   [(Term.typeSpec
     ":"
     (Term.arrow
      ...
      (Init.Data.Sigma.Basic.«termΣ'_,_»
       "Σ'"
       (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `H)] [":" (Term.app `Subgroup [`G])]))
       ", "
       (Term.app `normal [`H]))))])
  (Command.declValEqns
   (Term.matchAltsWhereDecls
    (Term.matchAlts
     [(Term.matchAlt
       ...
       [(numLit "0")]
       "=>"
       (Term.anonymousCtor "⟨" [(Order.BoundedOrder.«term⊥» "⊥") "," `inferInstance] "⟩"))
      (Term.matchAlt
       "|"
       ...
       (Term.let
        "let"
        (Term.letDecl (Term.letIdDecl `un [] [] ":=" (Term.app `upperCentralSeriesAux [`n])))
        []
        (Term.let
         "let"
         (Term.letDecl (Term.letIdDecl `un_normal [] [] ":=" (Term.proj `un "." (fieldIdx "2"))))
         []
         (Term.byTactic
          "by"
          (Tactic.tacticSeq
           (Tactic.tacticSeq1Indented
            [(group
              (Tactic.exact
               ...
               (Term.anonymousCtor
                "⟨"
                [(Term.app `upperCentralSeriesStep [(Term.proj `un "." (fieldIdx "1"))]) "," `inferInstance]
                "⟩"))
              [])]))))))])
    []))
  []
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `upperCentralSeriesStep [(Term.proj `un "." (fieldIdx "1"))])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.letIdDecl', expected 'Lean.Parser.Term.letIdDecl.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, term))
  (Term.app `upperCentralSeriesAux [`n])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
/--
  ...
  def
    upperCentralSeriesAux
    : ℕ → Σ' H : Subgroup G , normal H
    | 0 => ⟨ ⊥ , inferInstance ⟩
      |
        n + 1
        =>
        let
          un := upperCentralSeriesAux n
          let un_normal := un . 2 by exact ⟨ upperCentralSeriesStep un . 1 , inferInstance ⟩
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `mem_lower_central_series_succ_iff [])
  (Command.declSig
   [(Term.explicitBinder "(" [`n] [":" (termℕ "ℕ")] [] ")") (Term.explicitBinder "(" [`q] [":" `G] [] ")")]
   (Term.typeSpec
    ":"
    («term_↔_»
     (Init.Core.«term_∈_» `q " ∈ " (Term.app `lowerCentralSeries [`G (Init.Logic.«term_+_» `n "+" (numLit "1"))]))
     "↔"
     (Init.Core.«term_∈_»
      `q
      " ∈ "
      (Term.app
       ...
       [(Set.«term{_|_}»
         ...
         (Mathlib.ExtendedBinder.«term∃___,_»
          "∃"
          `p
          («binderTerm∈_» "∈" (Term.app `lowerCentralSeries [`G `n]))
          ","
          (Mathlib.ExtendedBinder.«term∃___,_»
           "∃"
           `q
           («binderTerm∈_»
            ...
            (Term.paren
             "("
             [(Order.BoundedOrder.«term⊤» "⊤") [(Term.typeAscription ":" (Term.app `Subgroup [`G]))]]
             ")"))
           ","
           («term_=_»
     ...
     [(Set.«term{_|_}»
       ...
       (Mathlib.ExtendedBinder.«term∃___,_»
        ...
        (Mathlib.ExtendedBinder.«term∃___,_»
         ...
         («binderTerm∈_»
          "∈"
          (Term.paren "(" [(Order.BoundedOrder.«term⊤» "⊤") [(Term.typeAscription ":" (Term.app `Subgroup [`G]))]] ")"))
         ","
         («term_=_»
          (Finset.Data.Finset.Fold.«term_*_»
           (Finset.Data.Finset.Fold.«term_*_»
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«binderTerm∈_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `lowerCentralSeries [`G `n])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `lower_central_series_succ [])
  (Command.declSig
   [(Term.explicitBinder "(" [`n] [":" (termℕ "ℕ")] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app `lowerCentralSeries [`G (Init.Logic.«term_+_» `n "+" (numLit "1"))])
     "="
     (Term.app
      `closure
      [(Set.«term{_|_}»
