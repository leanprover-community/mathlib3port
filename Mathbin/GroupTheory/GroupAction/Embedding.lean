...
lean 3 declaration is
  forall {G : Type.{u1}} {α : Type.{u2}} {β : Type.{u3}} [_inst_1 : Group.{u1} G] [_inst_2 : MulAction.{u1, u3} G β (DivInvMonoid.toMonoid.{u1} G (Group.toDivInvMonoid.{u1} G _inst_1))] (g : G) (f : Function.Embedding.{succ u2, succ u3} α β) (a : α), Eq.{succ u3} β (coeFn.{max 1 (succ u2) (succ u3), max (succ u2) (succ u3)} (Function.Embedding.{succ u2, succ u3} α β) (fun (_x : Function.Embedding.{succ u2, succ u3} α β) => α -> β) (Function.Embedding.hasCoeToFun.{succ u2, succ u3} α β) (HasSmul.smul.{u1, max u2 u3} G (Function.Embedding.{succ u2, succ u3} α β) (Function.Embedding.hasSmul.{u1, u2, u3} G α β _inst_1 _inst_2) g f) a) (HasSmul.smul.{u1, u3} G β (MulAction.toHasSmul.{u1, u3} G β (DivInvMonoid.toMonoid.{u1} G (Group.toDivInvMonoid.{u1} G _inst_1)) _inst_2) g (coeFn.{max 1 (succ u2) (succ u3), max (succ u2) (succ u3)} (Function.Embedding.{succ u2, succ u3} α β) (fun (_x : Function.Embedding.{succ u2, succ u3} α β) => α -> β) (Function.Embedding.hasCoeToFun.{succ u2, succ u3} α β) f a))
but is expected to have type
  forall {G : Type.{u3}} {α : Type.{u1}} {β : Type.{u2}} [_inst_1 : Group.{u3} G] [_inst_2 : MulAction.{u3, u2} G β (DivInvMonoid.toMonoid.{u3} G (Group.toDivInvMonoid.{u3} G _inst_1))] (g : G) (f : Function.Embedding.{succ u1, succ u2} α β) (a : α), Eq.{succ u2} ((fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.21 : α) => β) a) (FunLike.coe.{max (succ u1) (succ u2), succ u1, succ u2} (Function.Embedding.{succ u1, succ u2} α β) α (fun (_x : α) => (fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.21 : α) => β) _x) (EmbeddingLike.toFunLike.{max (succ u1) (succ u2), succ u1, succ u2} (Function.Embedding.{succ u1, succ u2} α β) α β (Function.instEmbeddingLikeEmbedding.{succ u1, succ u2} α β)) (HSMul.hSMul.{u3, max u1 u2, max u1 u2} G (Function.Embedding.{succ u1, succ u2} α β) (Function.Embedding.{succ u1, succ u2} α β) (instHSMul.{u3, max u1 u2} G (Function.Embedding.{succ u1, succ u2} α β) (Function.Embedding.smul.{u3, u1, u2} G α β _inst_1 _inst_2)) g f) a) (HSMul.hSMul.{u3, u2, u2} G ((fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.21 : α) => β) a) ((fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.21 : α) => β) a) (instHSMul.{u3, u2} G ((fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.21 : α) => β) a) (MulAction.toSMul.{u3, u2} G ((fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.21 : α) => β) a) (DivInvMonoid.toMonoid.{u3} G (Group.toDivInvMonoid.{u3} G _inst_1)) _inst_2)) g (FunLike.coe.{max (succ u1) (succ u2), succ u1, succ u2} (Function.Embedding.{succ u1, succ u2} α β) α (fun (_x : α) => (fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.21 : α) => β) _x) (EmbeddingLike.toFunLike.{max (succ u1) (succ u2), succ u1, succ u2} (Function.Embedding.{succ u1, succ u2} α β) α β (Function.instEmbeddingLikeEmbedding.{succ u1, succ u2} α β)) f a))
...
lean 3 declaration is
  forall {G : Type.{u1}} {α : Type.{u2}} {β : Type.{u3}} [_inst_1 : Group.{u1} G] [_inst_2 : MulAction.{u1, u3} G β (DivInvMonoid.toMonoid.{u1} G (Group.toDivInvMonoid.{u1} G _inst_1))] (g : G) (f : Function.Embedding.{succ u2, succ u3} α β), Eq.{succ (max u2 u3)} (α -> β) (coeFn.{succ (max u2 u3), succ (max u2 u3)} (Function.Embedding.{succ u2, succ u3} α β) (fun (_x : Function.Embedding.{succ u2, succ u3} α β) => α -> β) (Function.Embedding.hasCoeToFun.{succ u2, succ u3} α β) (HasSmul.smul.{u1, max u2 u3} G (Function.Embedding.{succ u2, succ u3} α β) (Function.Embedding.hasSmul.{u1, u2, u3} G α β _inst_1 _inst_2) g f)) (HasSmul.smul.{u1, max u2 u3} G (α -> β) (Function.hasSMul.{u2, u1, u3} α G β (MulAction.toHasSmul.{u1, u3} G β (DivInvMonoid.toMonoid.{u1} G (Group.toDivInvMonoid.{u1} G _inst_1)) _inst_2)) g (coeFn.{max 1 (succ u2) (succ u3), max (succ u2) (succ u3)} (Function.Embedding.{succ u2, succ u3} α β) (fun (_x : Function.Embedding.{succ u2, succ u3} α β) => α -> β) (Function.Embedding.hasCoeToFun.{succ u2, succ u3} α β) f))
but is expected to have type
  forall {G : Type.{u3}} {α : Type.{u1}} {β : Type.{u2}} [_inst_1 : Group.{u3} G] [_inst_2 : MulAction.{u3, u2} G β (DivInvMonoid.toMonoid.{u3} G (Group.toDivInvMonoid.{u3} G _inst_1))] (g : G) (f : Function.Embedding.{succ u1, succ u2} α β), Eq.{max (succ u1) (succ u2)} (forall (ᾰ : α), (fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.21 : α) => β) ᾰ) (FunLike.coe.{max (succ u1) (succ u2), succ u1, succ u2} (Function.Embedding.{succ u1, succ u2} α β) α (fun (_x : α) => (fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.21 : α) => β) _x) (EmbeddingLike.toFunLike.{max (succ u1) (succ u2), succ u1, succ u2} (Function.Embedding.{succ u1, succ u2} α β) α β (Function.instEmbeddingLikeEmbedding.{succ u1, succ u2} α β)) (HSMul.hSMul.{u3, max u1 u2, max u1 u2} G (Function.Embedding.{succ u1, succ u2} α β) (Function.Embedding.{succ u1, succ u2} α β) (instHSMul.{u3, max u1 u2} G (Function.Embedding.{succ u1, succ u2} α β) (Function.Embedding.smul.{u3, u1, u2} G α β _inst_1 _inst_2)) g f)) (HSMul.hSMul.{u3, max u1 u2, max u1 u2} G (forall (a : α), (fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.21 : α) => β) a) (forall (ᾰ : α), (fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.21 : α) => β) ᾰ) (instHSMul.{u3, max u1 u2} G (forall (a : α), (fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.21 : α) => β) a) (Pi.instSMul.{u1, u2, u3} α G (fun (a : α) => (fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.21 : α) => β) a) (fun (i : α) => MulAction.toSMul.{u3, u2} G ((fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.21 : α) => β) i) (DivInvMonoid.toMonoid.{u3} G (Group.toDivInvMonoid.{u3} G _inst_1)) _inst_2))) g (FunLike.coe.{max (succ u1) (succ u2), succ u1, succ u2} (Function.Embedding.{succ u1, succ u2} α β) α (fun (_x : α) => (fun (x._@.Mathlib.Data.FunLike.Embedding._hyg.21 : α) => β) _x) (EmbeddingLike.toFunLike.{max (succ u1) (succ u2), succ u1, succ u2} (Function.Embedding.{succ u1, succ u2} α β) α β (Function.instEmbeddingLikeEmbedding.{succ u1, succ u2} α β)) f))
