...
lean 3 declaration is
  forall {M : Type.{u1}} {α : Type.{u2}} [_inst_1 : Monoid.{u1} M] [_inst_2 : HasSmul.{u1, u2} M α] {m : M} (hm : IsUnit.{u1} M _inst_1 m) (a : α), Eq.{succ u2} α (HasSmul.smul.{u1, u2} (Units.{u1} M _inst_1) α (Units.hasSmul.{u1, u2} M α _inst_1 _inst_2) (IsUnit.unit.{u1} M _inst_1 m hm) a) (HasSmul.smul.{u1, u2} M α _inst_2 m a)
but is expected to have type
...
@[simp]
theorem smul_isUnit [Monoid M] [HasSmul M α] {m : M} (hm : IsUnit m) (a : α) :
    hm.Unit • a = m • a :=
  rfl
...
lean 3 declaration is
  forall {α : Type.{u1}} [_inst_1 : Monoid.{u1} α] {a : α} (h : IsUnit.{u1} α _inst_1 a), Eq.{succ u1} α (HasSmul.smul.{u1, u1} (Units.{u1} α _inst_1) α (Units.hasSmul.{u1, u1} α α _inst_1 (Mul.toSMul.{u1} α (MulOneClass.toHasMul.{u1} α (Monoid.toMulOneClass.{u1} α _inst_1)))) (Inv.inv.{u1} (Units.{u1} α _inst_1) (Units.hasInv.{u1} α _inst_1) (IsUnit.unit.{u1} α _inst_1 a h)) a) (OfNat.ofNat.{u1} α 1 (OfNat.mk.{u1} α 1 (One.one.{u1} α (MulOneClass.toHasOne.{u1} α (Monoid.toMulOneClass.{u1} α _inst_1)))))
but is expected to have type
...
/- warning: units.smul_comm_class_left -> Units.smulCommClass_left is a dubious translation:
lean 3 declaration is
  forall {M : Type.{u1}} {N : Type.{u2}} {α : Type.{u3}} [_inst_1 : Monoid.{u1} M] [_inst_2 : HasSmul.{u1, u3} M α] [_inst_3 : HasSmul.{u2, u3} N α] [_inst_4 : SMulCommClass.{u1, u2, u3} M N α _inst_2 _inst_3], SMulCommClass.{u1, u2, u3} (Units.{u1} M _inst_1) N α (Units.hasSmul.{u1, u3} M α _inst_1 _inst_2) _inst_3
but is expected to have type
  forall {M : Type.{u1}} {N : Type.{u2}} {α : Type.{u3}} [_inst_1 : Monoid.{u1} M] [_inst_2 : SMul.{u1, u3} M α] [_inst_3 : SMul.{u2, u3} N α] [_inst_4 : SMulCommClass.{u1, u2, u3} M N α _inst_2 _inst_3], SMulCommClass.{u1, u2, u3} (Units.{u1} M _inst_1) N α (Units.instSMulUnits.{u1, u3} M α _inst_1 _inst_2) _inst_3
Case conversion may be inaccurate. Consider using '#align units.smul_comm_class_left Units.smulCommClass_leftₓ'. -/
instance smulCommClass_left [Monoid M] [HasSmul M α] [HasSmul N α] [SMulCommClass M N α] :
    SMulCommClass Mˣ N α where smul_comm m n := (smul_comm (m : M) n : _)
#align units.smul_comm_class_left Units.smulCommClass_left

/- warning: units.smul_comm_class_right -> Units.smulCommClass_right is a dubious translation:
lean 3 declaration is
  forall {M : Type.{u1}} {N : Type.{u2}} {α : Type.{u3}} [_inst_1 : Monoid.{u2} N] [_inst_2 : HasSmul.{u1, u3} M α] [_inst_3 : HasSmul.{u2, u3} N α] [_inst_4 : SMulCommClass.{u1, u2, u3} M N α _inst_2 _inst_3], SMulCommClass.{u1, u2, u3} M (Units.{u2} N _inst_1) α _inst_2 (Units.hasSmul.{u2, u3} N α _inst_1 _inst_3)
but is expected to have type
  forall {M : Type.{u1}} {N : Type.{u2}} {α : Type.{u3}} [_inst_1 : Monoid.{u2} N] [_inst_2 : SMul.{u1, u3} M α] [_inst_3 : SMul.{u2, u3} N α] [_inst_4 : SMulCommClass.{u1, u2, u3} M N α _inst_2 _inst_3], SMulCommClass.{u1, u2, u3} M (Units.{u2} N _inst_1) α _inst_2 (Units.instSMulUnits.{u2, u3} N α _inst_1 _inst_3)
Case conversion may be inaccurate. Consider using '#align units.smul_comm_class_right Units.smulCommClass_rightₓ'. -/
instance smulCommClass_right [Monoid N] [HasSmul M α] [HasSmul N α] [SMulCommClass M N α] :
...
lean 3 declaration is
  forall {G : Type.{u1}} {M : Type.{u2}} [_inst_1 : Group.{u1} G] [_inst_2 : Monoid.{u2} M] [_inst_3 : MulAction.{u1, u2} G M (DivInvMonoid.toMonoid.{u1} G (Group.toDivInvMonoid.{u1} G _inst_1))] [_inst_4 : SMulCommClass.{u1, u2, u2} G M M (MulAction.toHasSmul.{u1, u2} G M (DivInvMonoid.toMonoid.{u1} G (Group.toDivInvMonoid.{u1} G _inst_1)) _inst_3) (Mul.toSMul.{u2} M (MulOneClass.toHasMul.{u2} M (Monoid.toMulOneClass.{u2} M _inst_2)))] [_inst_5 : IsScalarTower.{u1, u2, u2} G M M (MulAction.toHasSmul.{u1, u2} G M (DivInvMonoid.toMonoid.{u1} G (Group.toDivInvMonoid.{u1} G _inst_1)) _inst_3) (Mul.toSMul.{u2} M (MulOneClass.toHasMul.{u2} M (Monoid.toMulOneClass.{u2} M _inst_2))) (MulAction.toHasSmul.{u1, u2} G M (DivInvMonoid.toMonoid.{u1} G (Group.toDivInvMonoid.{u1} G _inst_1)) _inst_3)] {m : M} (g : G), (IsUnit.{u2} M _inst_2 m) -> (IsUnit.{u2} M _inst_2 (HasSmul.smul.{u1, u2} G M (MulAction.toHasSmul.{u1, u2} G M (DivInvMonoid.toMonoid.{u1} G (Group.toDivInvMonoid.{u1} G _inst_1)) _inst_3) g m))
but is expected to have type
