...
but is expected to have type
  forall (M : Type.{u2}) (α : Type.{u1}) [_inst_1 : Monoid.{u2} M] [_inst_2 : MulAction.{u2, u1} M α _inst_1] {P : Submonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)} {Q : Submonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)}, Eq.{succ u1} (Set.{u1} α) (MulAction.fixedPoints.{u2, u1} (Subtype.{succ u2} M (fun (x : M) => Membership.mem.{u2, u2} M (Submonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) (SetLike.instMembership.{u2, u2} (Submonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) M (Submonoid.instSetLikeSubmonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1))) x (HasSup.sup.{u2} (Submonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) (SemilatticeSup.toHasSup.{u2} (Submonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) (Lattice.toSemilatticeSup.{u2} (Submonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) (CompleteLattice.toLattice.{u2} (Submonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) (Submonoid.instCompleteLatticeSubmonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1))))) P Q))) α (Submonoid.toMonoid.{u2} M _inst_1 (HasSup.sup.{u2} (Submonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) (SemilatticeSup.toHasSup.{u2} (Submonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) (Lattice.toSemilatticeSup.{u2} (Submonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) (CompleteLattice.toLattice.{u2} (Submonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) (Submonoid.instCompleteLatticeSubmonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1))))) P Q)) (Submonoid.instMulActionSubtypeMemSubmonoidToMulOneClassInstMembershipInstSetLikeSubmonoidToMonoid.{u2, u1} M α _inst_1 _inst_2 (HasSup.sup.{u2} (Submonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) (SemilatticeSup.toHasSup.{u2} (Submonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) (Lattice.toSemilatticeSup.{u2} (Submonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) (CompleteLattice.toLattice.{u2} (Submonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) (Submonoid.instCompleteLatticeSubmonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1))))) P Q))) (Inter.inter.{u1} (Set.{u1} α) (Set.instInterSet.{u1} α) (MulAction.fixedPoints.{u2, u1} (Subtype.{succ u2} M (fun (x : M) => Membership.mem.{u2, u2} M (Submonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) (SetLike.instMembership.{u2, u2} (Submonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) M (Submonoid.instSetLikeSubmonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1))) x P)) α (Submonoid.toMonoid.{u2} M _inst_1 P) (Submonoid.instMulActionSubtypeMemSubmonoidToMulOneClassInstMembershipInstSetLikeSubmonoidToMonoid.{u2, u1} M α _inst_1 _inst_2 P)) (MulAction.fixedPoints.{u2, u1} (Subtype.{succ u2} M (fun (x : M) => Membership.mem.{u2, u2} M (Submonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) (SetLike.instMembership.{u2, u2} (Submonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) M (Submonoid.instSetLikeSubmonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1))) x Q)) α (Submonoid.toMonoid.{u2} M _inst_1 Q) (Submonoid.instMulActionSubtypeMemSubmonoidToMulOneClassInstMembershipInstSetLikeSubmonoidToMonoid.{u2, u1} M α _inst_1 _inst_2 Q)))
...
but is expected to have type
  forall (M : Type.{u2}) (α : Type.{u1}) [_inst_1 : Monoid.{u2} M] [_inst_2 : MulAction.{u2, u1} M α _inst_1] {ι : Sort.{u3}} {P : ι -> (Submonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1))}, Eq.{succ u1} (Set.{u1} α) (MulAction.fixedPoints.{u2, u1} (Subtype.{succ u2} M (fun (x : M) => Membership.mem.{u2, u2} M (Submonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) (SetLike.instMembership.{u2, u2} (Submonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) M (Submonoid.instSetLikeSubmonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1))) x (supᵢ.{u2, u3} (Submonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) (CompleteLattice.toSupSet.{u2} (Submonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) (Submonoid.instCompleteLatticeSubmonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1))) ι P))) α (Submonoid.toMonoid.{u2} M _inst_1 (supᵢ.{u2, u3} (Submonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) (CompleteLattice.toSupSet.{u2} (Submonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) (Submonoid.instCompleteLatticeSubmonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1))) ι P)) (Submonoid.instMulActionSubtypeMemSubmonoidToMulOneClassInstMembershipInstSetLikeSubmonoidToMonoid.{u2, u1} M α _inst_1 _inst_2 (supᵢ.{u2, u3} (Submonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) (CompleteLattice.toSupSet.{u2} (Submonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) (Submonoid.instCompleteLatticeSubmonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1))) ι P))) (Set.interᵢ.{u1, u3} α ι (fun (i : ι) => MulAction.fixedPoints.{u2, u1} (Subtype.{succ u2} M (fun (x : M) => Membership.mem.{u2, u2} M (Submonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) (SetLike.instMembership.{u2, u2} (Submonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1)) M (Submonoid.instSetLikeSubmonoid.{u2} M (Monoid.toMulOneClass.{u2} M _inst_1))) x (P i))) α (Submonoid.toMonoid.{u2} M _inst_1 (P i)) (Submonoid.instMulActionSubtypeMemSubmonoidToMulOneClassInstMembershipInstSetLikeSubmonoidToMonoid.{u2, u1} M α _inst_1 _inst_2 (P i))))
