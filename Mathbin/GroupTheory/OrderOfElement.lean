...
theorem pow_eq_mod_order_of {n : ℕ} : x ^ n = x ^ (n % orderOf x) :=
  calc x ^ n = x ^ (n % orderOf x)+orderOf x*n / orderOf x := by
    rw [Nat.mod_add_divₓ]
    _ = x ^ (n % orderOf x) := by
...
theorem order_of_pow' (h : n ≠ 0) : orderOf (x ^ n) = orderOf x / gcd (orderOf x) n := by
...
example : orderOf (-1 : Units ℤ) = 2 := by
  have : Fact (prime 2) := ⟨prime_two⟩
  exact
...
theorem zpow_eq_mod_order_of : x ^ i = x ^ (i % orderOf x) :=
  calc x ^ i = x ^ (i % orderOf x)+orderOf x*i / orderOf x := by
    rw [Int.mod_add_div]
    _ = x ^ (i % orderOf x) := by
    simp [zpow_add, zpow_mul, pow_order_of_eq_one]
    

-- ././Mathport/Syntax/Translate/Basic.lean:169:9: warning: unsupported option pp.all
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  ...
  [(Term.attributes
    ...
    [(Term.attrInstance
      (Term.attrKind [])
      (Attr.toAdditive "to_additive" [`sum_card_add_order_of_eq_card_nsmul_eq_zero] []))]
    "]")]
  []
  []
  []
 ...
 (Command.theorem
  "theorem"
  (Command.declId `sum_card_order_of_eq_card_pow_eq_one [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `DecidableEq [`G]) "]")
   ...
   (Term.typeSpec
    ...
    («term_=_»
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      ...
      " in "
      (Term.app
       (Term.proj (Term.app `Finset.range [`n.succ]) "." `filter)
          ...
          (Tactic.tacticSeq
           (Tactic.tacticSeq1Indented
            [(group (Tactic.intros "intros" []) [])
             (group (Tactic.apply "apply" (Term.proj `Finset.disjoint_filter "." (fieldIdx "2"))) [])
             (group (Tactic.cc "cc") [])])))])
       "."
       `symm))
     (calcStep
              ...
              (group
               (Tactic.tacticSuffices_
                ...
                (Term.sufficesDecl
                 ...
                 («term_↔_»
                  («term_∧_»
                   («term_≤_» (Term.app `orderOf [`x]) "≤" `n)
                   "∧"
                   (Init.Core.«term_∣_» (Term.app `orderOf [`x]) " ∣ " `n))
                  "↔"
                  («term_=_» («term_^_» `x "^" `n) "=" (numLit "1")))
                 (Term.byTactic
                  "by"
                  (Tactic.tacticSeq
                   (Tactic.tacticSeq1Indented
                    [(group
                      (Tactic.simpa "simpa" [] [] ["[" [(Tactic.simpLemma [] [] `Nat.lt_succ_iffₓ)] "]"] [] [])
                      [])])))))
               [])
              (group
               (Tactic.exact
                 ...
                 [(Term.fun
                        ...
                        [(group
                          (Tactic.rwSeq
                           ...
                           (Tactic.rwRuleSeq
                            ...
                            [(Tactic.rwRule [] `hm)
                             ","
                             (Tactic.rwRule [] `pow_mulₓ)
                             ","
                             (Tactic.rwRule [] `pow_order_of_eq_one)
                             ","
                  ...
                  (Term.fun
                   ...
                   (Term.basicFun
                    ...
                    (Term.anonymousCtor
                     "⟨"
                     [(Term.app `order_of_le_of_pow_eq_one [`hn `h]) "," (Term.app `order_of_dvd_of_pow_eq_one [`h])]
                     "⟩")))]
                 "⟩"))
               [])])))])]))])
   [])
       ...
       (Tactic.tacticSuffices_
        ...
        (Term.sufficesDecl
         ...
         (Term.byTactic
          ...
          (Tactic.tacticSeq
           (Tactic.tacticSeq1Indented
            [(group (Tactic.simpa "simpa" [] [] ["[" [(Tactic.simpLemma [] [] `Nat.lt_succ_iffₓ)] "]"] [] []) [])])))))
       [])
      (group
       (Tactic.exact
        "exact"
         ...
         [(Term.fun
           ...
           (Term.basicFun
            ...
            (Term.let
             "let"
             (Term.letDecl
              (Term.letPatDecl (Term.anonymousCtor "⟨" [`m "," `hm] "⟩") [] [] ":=" (Term.proj `h "." (fieldIdx "2"))))
             []
             (Term.byTactic
              "by"
              (Tactic.tacticSeq
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `order_of_dvd_of_pow_eq_one [`h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `order_of_le_of_pow_eq_one [`hn `h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.tacticSuffices_
   ...
   (Term.sufficesDecl
    []
    («term_↔_»
     («term_∧_» («term_≤_» (Term.app `orderOf [`x]) "≤" `n) "∧" (Init.Core.«term_∣_» (Term.app `orderOf [`x]) " ∣ " `n))
     "↔"
     («term_=_» («term_^_» `x "^" `n) "=" (numLit "1")))
    (Term.byTactic
     "by"
...
[PrettyPrinter.parenthesize] ...precedences are 21 >? 35, (some 35, term) <=? (some 20, term)
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, tactic))
  (Tactic.apply "apply" (Term.proj `Finset.disjoint_filter "." (fieldIdx "2")))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.fun
   "fun"
   (Term.basicFun [(Term.simpleBinder [`x] [(Term.typeSpec ":" `G)])] "=>" («term_=_» (Term.app `orderOf [`x]) "=" `m)))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.fun.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.basicFun.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.proj (Term.app `Finset.range [`n.succ]) "." `filter) [(Init.Core.«term_∣_» (Term.cdot "·") " ∣ " `n)])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Finset.range [`n.succ]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
    ...
    :=
      calc
        ∑ m in Finset.range n.succ . filter · ∣ n , Finset.univ . filter fun x : G => orderOf x = m . card = _
            :=
            Finset.card_bUnion by intros apply Finset.disjoint_filter . 2 cc . symm
          _ = _
            :=
            congr_argₓ
              Finset.card
                Finset.ext
                  by
                    intro x
                      suffices orderOf x ≤ n ∧ orderOf x ∣ n ↔ x ^ n = 1 by simpa [ Nat.lt_succ_iffₓ ]
                      exact
                        ⟨
                          fun h => let ⟨ m , hm ⟩ := h . 2 by rw [ hm , pow_mulₓ , pow_order_of_eq_one , one_pow ]
                            ,
...
@[to_additive nsmulCoprime "If `gcd(|G|,n)=1` then the smul by `n` is a bijection", simps]
