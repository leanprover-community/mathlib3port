...
but is expected to have type
  forall {M : Type.{u3}} {N : Type.{u2}} [_inst_1 : Mul.{u3} M] [_inst_2 : Mul.{u2} N] {cM : Con.{u3} M _inst_1} {cN : Con.{u2} N _inst_2} {φ : (Con.Quotient.{u3} M _inst_1 cM) -> (Con.Quotient.{u2} N _inst_2 cN) -> Sort.{u1}} (a : M) (b : N) (f : forall (x : M) (y : N), φ (Con.toQuotient.{u3} M _inst_1 cM x) (Con.toQuotient.{u2} N _inst_2 cN y)) (h : forall (x : M) (y : N) (x' : M) (y' : N), (FunLike.coe.{succ u3, succ u3, succ u3} (Con.{u3} M _inst_1) M (fun (_x : M) => (fun (x._@.Mathlib.GroupTheory.Congruence._hyg.480 : M) => M -> Prop) _x) (Con.instFunLikeConForAllProp.{u3} M _inst_1) cM x x') -> (FunLike.coe.{succ u2, succ u2, succ u2} (Con.{u2} N _inst_2) N (fun (_x : N) => (fun (x._@.Mathlib.GroupTheory.Congruence._hyg.480 : N) => N -> Prop) _x) (Con.instFunLikeConForAllProp.{u2} N _inst_2) cN y y') -> (HEq.{u1} (φ (Con.toQuotient.{u3} M _inst_1 cM x) (Con.toQuotient.{u2} N _inst_2 cN y)) (f x y) (φ (Con.toQuotient.{u3} M _inst_1 cM x') (Con.toQuotient.{u2} N _inst_2 cN y')) (f x' y'))), Eq.{u1} (φ (Con.toQuotient.{u3} M _inst_1 cM a) (Con.toQuotient.{u2} N _inst_2 cN b)) (Con.hrecOn₂.{u3, u2, u1} M N _inst_1 _inst_2 cM cN φ (Con.toQuotient.{u3} M _inst_1 cM a) (Con.toQuotient.{u2} N _inst_2 cN b) f h) (f a b)
...
but is expected to have type
  forall {M : Type.{u1}} [_inst_1 : Mul.{u1} M] (S : Set.{u1} (Con.{u1} M _inst_1)), Eq.{succ u1} (forall (ᾰ : M), (fun (x._@.Mathlib.GroupTheory.Congruence._hyg.480 : M) => M -> Prop) ᾰ) (FunLike.coe.{succ u1, succ u1, succ u1} (Con.{u1} M _inst_1) M (fun (_x : M) => (fun (x._@.Mathlib.GroupTheory.Congruence._hyg.480 : M) => M -> Prop) _x) (Con.instFunLikeConForAllProp.{u1} M _inst_1) (InfSet.infₛ.{u1} (Con.{u1} M _inst_1) (Con.instInfSetCon.{u1} M _inst_1) S)) (InfSet.infₛ.{u1} (M -> M -> Prop) (Pi.infSet.{u1, u1} M (fun (ᾰ : M) => M -> Prop) (fun (i : M) => Pi.infSet.{u1, 0} M (fun (ᾰ : M) => Prop) (fun (i : M) => CompleteBooleanAlgebra.toInfSet.{0} Prop Prop.completeBooleanAlgebra))) (Set.image.{u1, u1} (Con.{u1} M _inst_1) (M -> M -> Prop) (FunLike.coe.{succ u1, succ u1, succ u1} (Con.{u1} M _inst_1) M (fun (ᾰ : M) => (fun (x._@.Mathlib.GroupTheory.Congruence._hyg.480 : M) => M -> Prop) ᾰ) (Con.instFunLikeConForAllProp.{u1} M _inst_1)) S))
...
but is expected to have type
  forall {M : Type.{u1}} [_inst_1 : Mul.{u1} M] {c : Con.{u1} M _inst_1} {d : Con.{u1} M _inst_1} {x : M} {y : M}, Iff (FunLike.coe.{succ u1, succ u1, succ u1} (Con.{u1} M _inst_1) M (fun (_x : M) => (fun (x._@.Mathlib.GroupTheory.Congruence._hyg.480 : M) => M -> Prop) _x) (Con.instFunLikeConForAllProp.{u1} M _inst_1) (HasInf.inf.{u1} (Con.{u1} M _inst_1) (Lattice.toHasInf.{u1} (Con.{u1} M _inst_1) (CompleteLattice.toLattice.{u1} (Con.{u1} M _inst_1) (Con.instCompleteLatticeCon.{u1} M _inst_1))) c d) x y) (And (FunLike.coe.{succ u1, succ u1, succ u1} (Con.{u1} M _inst_1) M (fun (_x : M) => (fun (x._@.Mathlib.GroupTheory.Congruence._hyg.480 : M) => M -> Prop) _x) (Con.instFunLikeConForAllProp.{u1} M _inst_1) c x y) (FunLike.coe.{succ u1, succ u1, succ u1} (Con.{u1} M _inst_1) M (fun (_x : M) => (fun (x._@.Mathlib.GroupTheory.Congruence._hyg.480 : M) => M -> Prop) _x) (Con.instFunLikeConForAllProp.{u1} M _inst_1) d x y))
...
but is expected to have type
  forall {M : Type.{u1}} [_inst_1 : Mul.{u1} M] (r : M -> M -> Prop), Eq.{succ u1} (Con.{u1} M _inst_1) (conGen.{u1} M _inst_1 r) (InfSet.infₛ.{u1} (Con.{u1} M _inst_1) (Con.instInfSetCon.{u1} M _inst_1) (setOf.{u1} (Con.{u1} M _inst_1) (fun (s : Con.{u1} M _inst_1) => forall (x : M) (y : M), (r x y) -> (FunLike.coe.{succ u1, succ u1, succ u1} (Con.{u1} M _inst_1) M (fun (_x : M) => (fun (x._@.Mathlib.GroupTheory.Congruence._hyg.480 : M) => M -> Prop) _x) (Con.instFunLikeConForAllProp.{u1} M _inst_1) s x y))))
...
but is expected to have type
  forall {M : Type.{u1}} [_inst_1 : Mul.{u1} M] (c : Con.{u1} M _inst_1) (d : Con.{u1} M _inst_1), Eq.{succ u1} (Con.{u1} M _inst_1) (HasSup.sup.{u1} (Con.{u1} M _inst_1) (SemilatticeSup.toHasSup.{u1} (Con.{u1} M _inst_1) (Lattice.toSemilatticeSup.{u1} (Con.{u1} M _inst_1) (CompleteLattice.toLattice.{u1} (Con.{u1} M _inst_1) (Con.instCompleteLatticeCon.{u1} M _inst_1)))) c d) (conGen.{u1} M _inst_1 (fun (x : M) (y : M) => Or (FunLike.coe.{succ u1, succ u1, succ u1} (Con.{u1} M _inst_1) M (fun (_x : M) => (fun (x._@.Mathlib.GroupTheory.Congruence._hyg.480 : M) => M -> Prop) _x) (Con.instFunLikeConForAllProp.{u1} M _inst_1) c x y) (FunLike.coe.{succ u1, succ u1, succ u1} (Con.{u1} M _inst_1) M (fun (_x : M) => (fun (x._@.Mathlib.GroupTheory.Congruence._hyg.480 : M) => M -> Prop) _x) (Con.instFunLikeConForAllProp.{u1} M _inst_1) d x y)))
...
but is expected to have type
  forall {M : Type.{u1}} [_inst_1 : Mul.{u1} M] (S : Set.{u1} (Con.{u1} M _inst_1)), Eq.{succ u1} (Con.{u1} M _inst_1) (SupSet.supₛ.{u1} (Con.{u1} M _inst_1) (CompleteLattice.toSupSet.{u1} (Con.{u1} M _inst_1) (Con.instCompleteLatticeCon.{u1} M _inst_1)) S) (conGen.{u1} M _inst_1 (fun (x : M) (y : M) => Exists.{succ u1} (Con.{u1} M _inst_1) (fun (c : Con.{u1} M _inst_1) => And (Membership.mem.{u1, u1} (Con.{u1} M _inst_1) (Set.{u1} (Con.{u1} M _inst_1)) (Set.instMembershipSet.{u1} (Con.{u1} M _inst_1)) c S) (FunLike.coe.{succ u1, succ u1, succ u1} (Con.{u1} M _inst_1) M (fun (_x : M) => (fun (x._@.Mathlib.GroupTheory.Congruence._hyg.480 : M) => M -> Prop) _x) (Con.instFunLikeConForAllProp.{u1} M _inst_1) c x y))))
...
but is expected to have type
  forall {M : Type.{u1}} [_inst_1 : Mul.{u1} M] {S : Set.{u1} (Con.{u1} M _inst_1)}, Eq.{succ u1} (Con.{u1} M _inst_1) (SupSet.supₛ.{u1} (Con.{u1} M _inst_1) (CompleteLattice.toSupSet.{u1} (Con.{u1} M _inst_1) (Con.instCompleteLatticeCon.{u1} M _inst_1)) S) (conGen.{u1} M _inst_1 (SupSet.supₛ.{u1} (M -> M -> Prop) (Pi.supSet.{u1, u1} M (fun (ᾰ : M) => M -> Prop) (fun (i : M) => Pi.supSet.{u1, 0} M (fun (ᾰ : M) => Prop) (fun (i : M) => CompleteBooleanAlgebra.toSupSet.{0} Prop Prop.completeBooleanAlgebra))) (Set.image.{u1, u1} (Con.{u1} M _inst_1) (M -> M -> Prop) (FunLike.coe.{succ u1, succ u1, succ u1} (Con.{u1} M _inst_1) M (fun (ᾰ : M) => (fun (x._@.Mathlib.GroupTheory.Congruence._hyg.480 : M) => M -> Prop) ᾰ) (Con.instFunLikeConForAllProp.{u1} M _inst_1)) S)))
...
but is expected to have type
  forall {M : Type.{u2}} {P : Type.{u1}} [_inst_1 : MulOneClass.{u2} M] [_inst_3 : MulOneClass.{u1} P] (f : MonoidHom.{u2, u1} M P _inst_1 _inst_3) {x : M} {y : M}, Iff (FunLike.coe.{succ u2, succ u2, succ u2} (Con.{u2} M (MulOneClass.toMul.{u2} M _inst_1)) M (fun (_x : M) => (fun (x._@.Mathlib.GroupTheory.Congruence._hyg.480 : M) => M -> Prop) _x) (Con.instFunLikeConForAllProp.{u2} M (MulOneClass.toMul.{u2} M _inst_1)) (Con.ker.{u2, u1} M P _inst_1 _inst_3 f) x y) (Eq.{succ u1} ((fun (x._@.Mathlib.Algebra.Hom.Group._hyg.2528 : M) => P) x) (FunLike.coe.{max (succ u2) (succ u1), succ u2, succ u1} (MonoidHom.{u2, u1} M P _inst_1 _inst_3) M (fun (_x : M) => (fun (x._@.Mathlib.Algebra.Hom.Group._hyg.2528 : M) => P) _x) (MulHomClass.toFunLike.{max u2 u1, u2, u1} (MonoidHom.{u2, u1} M P _inst_1 _inst_3) M P (MulOneClass.toMul.{u2} M _inst_1) (MulOneClass.toMul.{u1} P _inst_3) (MonoidHomClass.toMulHomClass.{max u2 u1, u2, u1} (MonoidHom.{u2, u1} M P _inst_1 _inst_3) M P _inst_1 _inst_3 (MonoidHom.monoidHomClass.{u2, u1} M P _inst_1 _inst_3))) f x) (FunLike.coe.{max (succ u2) (succ u1), succ u2, succ u1} (MonoidHom.{u2, u1} M P _inst_1 _inst_3) M (fun (_x : M) => (fun (x._@.Mathlib.Algebra.Hom.Group._hyg.2528 : M) => P) _x) (MulHomClass.toFunLike.{max u2 u1, u2, u1} (MonoidHom.{u2, u1} M P _inst_1 _inst_3) M P (MulOneClass.toMul.{u2} M _inst_1) (MulOneClass.toMul.{u1} P _inst_3) (MonoidHomClass.toMulHomClass.{max u2 u1, u2, u1} (MonoidHom.{u2, u1} M P _inst_1 _inst_3) M P _inst_1 _inst_3 (MonoidHom.monoidHomClass.{u2, u1} M P _inst_1 _inst_3))) f y))
...
but is expected to have type
  forall {M : Type.{u2}} {P : Type.{u1}} [_inst_1 : MulOneClass.{u2} M] [_inst_3 : MulOneClass.{u1} P] {f : MonoidHom.{u2, u1} M P _inst_1 _inst_3} (x : M), Eq.{succ u2} ((fun (x._@.Mathlib.GroupTheory.Congruence._hyg.480 : M) => M -> Prop) x) (FunLike.coe.{succ u2, succ u2, succ u2} (Con.{u2} M (MulOneClass.toMul.{u2} M _inst_1)) M (fun (_x : M) => (fun (x._@.Mathlib.GroupTheory.Congruence._hyg.480 : M) => M -> Prop) _x) (Con.instFunLikeConForAllProp.{u2} M (MulOneClass.toMul.{u2} M _inst_1)) (Con.ker.{u2, u1} M P _inst_1 _inst_3 f) x) (Set.preimage.{u2, u1} M P (FunLike.coe.{max (succ u2) (succ u1), succ u2, succ u1} (MonoidHom.{u2, u1} M P _inst_1 _inst_3) M (fun (_x : M) => (fun (x._@.Mathlib.Algebra.Hom.Group._hyg.2528 : M) => P) _x) (MulHomClass.toFunLike.{max u2 u1, u2, u1} (MonoidHom.{u2, u1} M P _inst_1 _inst_3) M P (MulOneClass.toMul.{u2} M _inst_1) (MulOneClass.toMul.{u1} P _inst_3) (MonoidHomClass.toMulHomClass.{max u2 u1, u2, u1} (MonoidHom.{u2, u1} M P _inst_1 _inst_3) M P _inst_1 _inst_3 (MonoidHom.monoidHomClass.{u2, u1} M P _inst_1 _inst_3))) f) (Singleton.singleton.{u1, u1} ((fun (x._@.Mathlib.Algebra.Hom.Group._hyg.2528 : M) => P) x) (Set.{u1} P) (Set.instSingletonSet.{u1} P) (FunLike.coe.{max (succ u2) (succ u1), succ u2, succ u1} (MonoidHom.{u2, u1} M P _inst_1 _inst_3) M (fun (_x : M) => (fun (x._@.Mathlib.Algebra.Hom.Group._hyg.2528 : M) => P) _x) (MulHomClass.toFunLike.{max u2 u1, u2, u1} (MonoidHom.{u2, u1} M P _inst_1 _inst_3) M P (MulOneClass.toMul.{u2} M _inst_1) (MulOneClass.toMul.{u1} P _inst_3) (MonoidHomClass.toMulHomClass.{max u2 u1, u2, u1} (MonoidHom.{u2, u1} M P _inst_1 _inst_3) M P _inst_1 _inst_3 (MonoidHom.monoidHomClass.{u2, u1} M P _inst_1 _inst_3))) f x)))
...
but is expected to have type
  forall {M : Type.{u1}} {P : Type.{u2}} [_inst_1 : MulOneClass.{u1} M] [_inst_3 : MulOneClass.{u2} P] (f : MonoidHom.{u1, u2} M P _inst_1 _inst_3) (g : P -> M), (Function.RightInverse.{succ u1, succ u2} M P g (FunLike.coe.{max (succ u1) (succ u2), succ u1, succ u2} (MonoidHom.{u1, u2} M P _inst_1 _inst_3) M (fun (_x : M) => (fun (x._@.Mathlib.Algebra.Hom.Group._hyg.2528 : M) => P) _x) (MulHomClass.toFunLike.{max u1 u2, u1, u2} (MonoidHom.{u1, u2} M P _inst_1 _inst_3) M P (MulOneClass.toMul.{u1} M _inst_1) (MulOneClass.toMul.{u2} P _inst_3) (MonoidHomClass.toMulHomClass.{max u1 u2, u1, u2} (MonoidHom.{u1, u2} M P _inst_1 _inst_3) M P _inst_1 _inst_3 (MonoidHom.monoidHomClass.{u1, u2} M P _inst_1 _inst_3))) f)) -> (MulEquiv.{u1, u2} (Con.Quotient.{u1} M (MulOneClass.toMul.{u1} M _inst_1) (Con.ker.{u1, u2} M P _inst_1 _inst_3 f)) P (Con.hasMul.{u1} M (MulOneClass.toMul.{u1} M _inst_1) (Con.ker.{u1, u2} M P _inst_1 _inst_3 f)) (MulOneClass.toMul.{u2} P _inst_3))
...
but is expected to have type
  forall {M : Type.{u1}} {P : Type.{u2}} [_inst_1 : MulOneClass.{u1} M] [_inst_3 : MulOneClass.{u2} P] (f : MonoidHom.{u1, u2} M P _inst_1 _inst_3), (Function.Surjective.{succ u1, succ u2} M P (FunLike.coe.{max (succ u1) (succ u2), succ u1, succ u2} (MonoidHom.{u1, u2} M P _inst_1 _inst_3) M (fun (_x : M) => (fun (x._@.Mathlib.Algebra.Hom.Group._hyg.2528 : M) => P) _x) (MulHomClass.toFunLike.{max u1 u2, u1, u2} (MonoidHom.{u1, u2} M P _inst_1 _inst_3) M P (MulOneClass.toMul.{u1} M _inst_1) (MulOneClass.toMul.{u2} P _inst_3) (MonoidHomClass.toMulHomClass.{max u1 u2, u1, u2} (MonoidHom.{u1, u2} M P _inst_1 _inst_3) M P _inst_1 _inst_3 (MonoidHom.monoidHomClass.{u1, u2} M P _inst_1 _inst_3))) f)) -> (MulEquiv.{u1, u2} (Con.Quotient.{u1} M (MulOneClass.toMul.{u1} M _inst_1) (Con.ker.{u1, u2} M P _inst_1 _inst_3 f)) P (Con.hasMul.{u1} M (MulOneClass.toMul.{u1} M _inst_1) (Con.ker.{u1, u2} M P _inst_1 _inst_3 f)) (MulOneClass.toMul.{u2} P _inst_3))
...
but is expected to have type
  forall {M : Type.{u1}} [_inst_1 : Monoid.{u1} M] {c : Con.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1))} {p : (Units.{u1} (Con.Quotient.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1)) c) (Con.monoid.{u1} M _inst_1 c)) -> Prop} (u : Units.{u1} (Con.Quotient.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1)) c) (Con.monoid.{u1} M _inst_1 c)), (forall (x : M) (y : M) (hxy : FunLike.coe.{succ u1, succ u1, succ u1} (Con.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1))) M (fun (_x : M) => (fun (x._@.Mathlib.GroupTheory.Congruence._hyg.480 : M) => M -> Prop) _x) (Con.instFunLikeConForAllProp.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1))) c (HMul.hMul.{u1, u1, u1} M M M (instHMul.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1))) x y) (OfNat.ofNat.{u1} M 1 (One.toOfNat1.{u1} M (Monoid.toOne.{u1} M _inst_1)))) (hyx : FunLike.coe.{succ u1, succ u1, succ u1} (Con.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1))) M (fun (_x : M) => (fun (x._@.Mathlib.GroupTheory.Congruence._hyg.480 : M) => M -> Prop) _x) (Con.instFunLikeConForAllProp.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1))) c (HMul.hMul.{u1, u1, u1} M M M (instHMul.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1))) y x) (OfNat.ofNat.{u1} M 1 (One.toOfNat1.{u1} M (Monoid.toOne.{u1} M _inst_1)))), p (Units.mk.{u1} (Con.Quotient.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1)) c) (Con.monoid.{u1} M _inst_1 c) (Con.toQuotient.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1)) c x) (Con.toQuotient.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1)) c y) (Iff.mpr (Eq.{succ u1} (Con.Quotient.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1)) c) (Con.toQuotient.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1)) c ((fun (x._@.Mathlib.GroupTheory.Congruence._hyg.1890 : M) (x._@.Mathlib.GroupTheory.Congruence._hyg.1892 : M) => HMul.hMul.{u1, u1, u1} M M M (instHMul.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1))) x._@.Mathlib.GroupTheory.Congruence._hyg.1890 x._@.Mathlib.GroupTheory.Congruence._hyg.1892) x y)) (Con.toQuotient.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1)) c (OfNat.ofNat.{u1} M 1 (One.toOfNat1.{u1} M (MulOneClass.toOne.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1)))))) (FunLike.coe.{succ u1, succ u1, succ u1} (Con.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1))) M (fun (_x : M) => (fun (x._@.Mathlib.GroupTheory.Congruence._hyg.480 : M) => M -> Prop) _x) (Con.instFunLikeConForAllProp.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1))) c ((fun (x._@.Mathlib.GroupTheory.Congruence._hyg.1890 : M) (x._@.Mathlib.GroupTheory.Congruence._hyg.1892 : M) => HMul.hMul.{u1, u1, u1} M M M (instHMul.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1))) x._@.Mathlib.GroupTheory.Congruence._hyg.1890 x._@.Mathlib.GroupTheory.Congruence._hyg.1892) x y) (OfNat.ofNat.{u1} M 1 (One.toOfNat1.{u1} M (MulOneClass.toOne.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1))))) (Con.eq.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1)) c ((fun (x._@.Mathlib.GroupTheory.Congruence._hyg.1890 : M) (x._@.Mathlib.GroupTheory.Congruence._hyg.1892 : M) => HMul.hMul.{u1, u1, u1} M M M (instHMul.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1))) x._@.Mathlib.GroupTheory.Congruence._hyg.1890 x._@.Mathlib.GroupTheory.Congruence._hyg.1892) x y) (OfNat.ofNat.{u1} M 1 (One.toOfNat1.{u1} M (MulOneClass.toOne.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1))))) hxy) (Iff.mpr (Eq.{succ u1} (Con.Quotient.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1)) c) (Con.toQuotient.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1)) c ((fun (x._@.Mathlib.GroupTheory.Congruence._hyg.1890 : M) (x._@.Mathlib.GroupTheory.Congruence._hyg.1892 : M) => HMul.hMul.{u1, u1, u1} M M M (instHMul.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1))) x._@.Mathlib.GroupTheory.Congruence._hyg.1890 x._@.Mathlib.GroupTheory.Congruence._hyg.1892) y x)) (Con.toQuotient.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1)) c (OfNat.ofNat.{u1} M 1 (One.toOfNat1.{u1} M (MulOneClass.toOne.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1)))))) (FunLike.coe.{succ u1, succ u1, succ u1} (Con.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1))) M (fun (_x : M) => (fun (x._@.Mathlib.GroupTheory.Congruence._hyg.480 : M) => M -> Prop) _x) (Con.instFunLikeConForAllProp.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1))) c ((fun (x._@.Mathlib.GroupTheory.Congruence._hyg.1890 : M) (x._@.Mathlib.GroupTheory.Congruence._hyg.1892 : M) => HMul.hMul.{u1, u1, u1} M M M (instHMul.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1))) x._@.Mathlib.GroupTheory.Congruence._hyg.1890 x._@.Mathlib.GroupTheory.Congruence._hyg.1892) y x) (OfNat.ofNat.{u1} M 1 (One.toOfNat1.{u1} M (MulOneClass.toOne.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1))))) (Con.eq.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1)) c ((fun (x._@.Mathlib.GroupTheory.Congruence._hyg.1890 : M) (x._@.Mathlib.GroupTheory.Congruence._hyg.1892 : M) => HMul.hMul.{u1, u1, u1} M M M (instHMul.{u1} M (MulOneClass.toMul.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1))) x._@.Mathlib.GroupTheory.Congruence._hyg.1890 x._@.Mathlib.GroupTheory.Congruence._hyg.1892) y x) (OfNat.ofNat.{u1} M 1 (One.toOfNat1.{u1} M (MulOneClass.toOne.{u1} M (Monoid.toMulOneClass.{u1} M _inst_1))))) hyx))) -> (p u)
