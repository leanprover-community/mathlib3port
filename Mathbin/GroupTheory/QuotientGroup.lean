      ...
      (Command.declSig
       ...
       (Term.typeSpec
        ...
        («term_=_»
         (Term.typeAscription
          "("
          (Term.typeAscription "(" (num "1") ":" [`G] ")")
          ":"
          [(QuotientGroup.GroupTheory.QuotientGroup.termQ "Q")]
          ")")
         "="
         (num "1"))))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (QuotientGroup.GroupTheory.QuotientGroup.termQ "Q")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'QuotientGroup.GroupTheory.QuotientGroup.termQ', expected 'QuotientGroup.GroupTheory.QuotientGroup.termQ._@.GroupTheory.QuotientGroup._hyg.7'
...
@[ simp , to_additive ] theorem coe_one : ( ( 1 : G ) : Q ) = 1 := rfl
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      ...
      (Command.declSig
       [(Term.explicitBinder "(" [`a `b] [":" `G] [] ")")]
       (Term.typeSpec
        ":"
        («term_=_»
         (Term.typeAscription
          "("
          (Term.typeAscription "(" («term_*_» `a "*" `b) ":" [`G] ")")
          ":"
          [(QuotientGroup.GroupTheory.QuotientGroup.termQ "Q")]
          ")")
         "="
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.classInductive'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
@[ simp , to_additive ] theorem coe_mul ( a b : G ) : ( ( a * b : G ) : Q ) = a * b := rfl
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.classInductive'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
@[ simp , to_additive ] theorem coe_inv ( a : G ) : ( ( a ⁻¹ : G ) : Q ) = a ⁻¹ := rfl
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.classInductive'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
@[ simp , to_additive ] theorem coe_div ( a b : G ) : ( ( a / b : G ) : Q ) = a / b := rfl
      ...
      (Command.declSig
       ...
       (Term.typeSpec
        ...
        («term_=_»
         (Term.typeAscription
          "("
          (Term.typeAscription "(" («term_^_» `a "^" `n) ":" [`G] ")")
          ":"
          [(QuotientGroup.GroupTheory.QuotientGroup.termQ "Q")]
          ")")
         "="
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.classInductive'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
@[ simp , to_additive ] theorem coe_pow ( a : G ) ( n : ℕ ) : ( ( a ^ n : G ) : Q ) = a ^ n := rfl
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.classInductive'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
@[ simp , to_additive ] theorem coe_zpow ( a : G ) ( n : ℤ ) : ( ( a ^ n : G ) : Q ) = a ^ n := rfl
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.def
      ...
      (Command.declId `lift [])
      (Command.optDeclSig
       [(Term.explicitBinder "(" [`φ] [":" (Algebra.Hom.Group.«term_→*_» `G " →* " `H)] [] ")")
        (Term.explicitBinder
         "("
         [`HN]
         [":"
      ...
      (Command.declValSimple
       ":="
       (Term.app
        (Term.app (Term.proj (Term.app `QuotientGroup.con [`N]) "." `lift) [`φ])
        [(Term.fun
          "fun"
          (Term.basicFun
           [`x `y `h]
            ...
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(Tactic.simp
                ...
                ["only"]
                ["["
                 [(Tactic.simpLemma [] [] `QuotientGroup.con)
                  ","
                  (Tactic.simpLemma [] [] `left_rel_apply)
                  ","
                  (Tactic.simpLemma [] [] `Con.rel_mk)]
                 "]"]
               ...
               (calcTactic
                ...
                (calcStep
                 («term_=_»
                  ...
                  (Term.app
                   `φ
                   [(«term_*_» `y "*" («term_⁻¹» («term_*_» («term_⁻¹» `x "⁻¹") "*" `y) "⁻¹"))]))
                 ":="
                 (Term.byTactic
                  "by"
                  (Tactic.tacticSeq
                    ...
                    [(Tactic.rwSeq
                      ...
                      (Tactic.rwRuleSeq
                       ...
                       [(Tactic.rwRule [] `mul_inv_rev)
                        ","
                        (Tactic.rwRule [] `inv_inv)
                        ","
                        (Tactic.rwRule [] `mul_inv_cancel_left)]
                       "]")
                      [])]))))
                [(calcStep
                  («term_=_» (Term.hole "_") "=" (Term.app `φ [`y]))
                  ":="
                  (Term.byTactic
                   "by"
                   (Tactic.tacticSeq
                    (Tactic.tacticSeq1Indented
                     [(Tactic.rwSeq
                       ...
                       (Tactic.rwRuleSeq
                        "["
                        [(Tactic.rwRule [] `φ.map_mul)
                         ","
                         (Tactic.rwRule
                          []
                          (Term.app `HN [(Term.hole "_") (Term.app `N.inv_mem [`h])]))
                         ","
                 ...
                 (Tactic.tacticSeq1Indented
                  [(Tactic.rwSeq
                    ...
                    (Tactic.rwRuleSeq
                     ...
                     [(Tactic.rwRule [] `φ.map_mul)
                      ","
                      (Tactic.rwRule [] (Term.app `HN [(Term.hole "_") (Term.app `N.inv_mem [`h])]))
                      ","
                      (Tactic.rwRule [] `mul_one)]
                     "]")
                    [])]))))])])))))
      ...
      (calcTactic
       ...
       (calcStep
        («term_=_»
         (Term.app `φ [`x])
         "="
         (Term.app `φ [(«term_*_» `y "*" («term_⁻¹» («term_*_» («term_⁻¹» `x "⁻¹") "*" `y) "⁻¹"))]))
        ":="
        (Term.byTactic
         "by"
         (Tactic.tacticSeq
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023,
     term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" (Term.app `N.inv_mem [`h]) ")")
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none,
     [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] ...precedences are 70 >? 1024, (none, [anonymous]) <=? (some 70, term)
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 70, (some 71, term) <=? (some 1024, term)
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
     "("
     («term_*_» `y "*" («term_⁻¹» (Term.paren "(" («term_*_» («term_⁻¹» `x "⁻¹") "*" `y) ")") "⁻¹"))
     ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      `φ
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none,
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none,
     [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      (Term.proj (Term.app `QuotientGroup.con [`N]) "." `lift)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      (Term.app `QuotientGroup.con [`N])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `N
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" (Term.app `QuotientGroup.con [`N]) ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none,
     [anonymous]) <=? (some 1022, term)
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
     "("
     (Term.app (Term.proj (Term.paren "(" (Term.app `QuotientGroup.con [`N]) ")") "." `lift) [`φ])
     ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 0, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, [anonymous]))
      (Algebra.Hom.Group.«term_→*_» (QuotientGroup.GroupTheory.QuotientGroup.termQ "Q") " →* " `H)
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `H
...
/--
  ...
  def
    lift
    ( φ : G →* H ) ( HN : ∀ x ∈ N , φ x = 1 ) : Q →* H
    :=
      QuotientGroup.con N . lift φ
        fun
          x y h
            =>
            by
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      ...
      (Command.declSig
       [(Term.implicitBinder "{" [`φ] [":" (Algebra.Hom.Group.«term_→*_» `G " →* " `H)] "}")
        (Term.explicitBinder
         "("
         [`HN]
         [":"
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 50, term))
      (Term.app
       ...
       [`N
        `φ
        `HN
        (Term.typeAscription "(" `g ":" [(QuotientGroup.GroupTheory.QuotientGroup.termQ "Q")] ")")])
...
@[ simp , to_additive ]
  theorem
    lift_mk
    { φ : G →* H } ( HN : ∀ x ∈ N , φ x = 1 ) ( g : G ) : lift N φ HN ( g : Q ) = φ g
    := rfl
...
@[ simp , to_additive ]
  theorem
    lift_mk'
    { φ : G →* H } ( HN : ∀ x ∈ N , φ x = 1 ) ( g : G ) : lift N φ HN ( mk g : Q ) = φ g
    := rfl
#align quotient_group.lift_mk' QuotientGroup.lift_mk'
        ...
        («term_=_»
         (Term.app
          ...
          [`N
           ...
           (Term.typeAscription
            "("
            (Term.app `Quot.mk [(Term.hole "_") `g])
            ":"
            [(QuotientGroup.GroupTheory.QuotientGroup.termQ "Q")]
            ")")])
         "="
...
@[ simp , to_additive ]
  theorem
    lift_quot_mk
    { φ : G →* H } ( HN : ∀ x ∈ N , φ x = 1 ) ( g : G ) : lift N φ HN ( Quot.mk _ g : Q ) = φ g
    := rfl
