...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `num_derangements_tendsto_inv_e [])
  (Command.declSig
   []
   (Term.typeSpec
    ":"
    (Term.app
     ...
     [(Term.fun
       ...
       (Term.basicFun
        ...
        "=>"
        («term_/_»
         (Term.paren "(" [(Term.app `numDerangements [`n]) [(Term.typeAscription ":" (Data.Real.Basic.termℝ "ℝ"))]] ")")
         "/"
         `n.factorial)))
      `at_top
      (Term.app (Topology.Basic.term𝓝 "𝓝") [(Term.app `Real.exp [(«term-_» "-" (numLit "1"))])])])))
      ...
      [(group
        (Tactic.tacticLet_
         ...
         (Term.letDecl
          (Term.letIdDecl
           `s
           [(Term.typeSpec ":" (Term.arrow (termℕ "ℕ") "→" (Data.Real.Basic.termℝ "ℝ")))]
           ":="
           (Term.fun
            "fun"
            (Term.basicFun
          ...
          (Term.forall
           ...
           («term_=_»
            («term_/_»
             (Term.paren
              "("
              [(Term.app `numDerangements [`n]) [(Term.typeAscription ":" (Data.Real.Basic.termℝ "ℝ"))]]
              ")")
             "/"
             `n.factorial)
            "="
             ...
             [(group (Tactic.simpRw "simp_rw" (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `this)] "]") []) [])
              (group
               (Tactic.rwSeq
                "rw"
                []
                (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] (Term.app `tendsto_add_at_top_iff_nat [(numLit "1")]))] "]")
                [])
               [])
              (group (Tactic.apply "apply" `HasSum.tendsto_sum_nat) [])
              (group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Real.exp_eq_exp_ℝ_ℝ)] "]") []) [])
              (group
               (Tactic.exact
                "exact"
                (Term.app
                 `exp_series_field_has_sum_exp
                 [(Term.paren
                   "("
                   [(«term-_» "-" (numLit "1")) [(Term.typeAscription ":" (Data.Real.Basic.termℝ "ℝ"))]]
                   ")")]))
       ...
       (group
        (Tactic.rwSeq
         ...
         (Tactic.rwRuleSeq
          "["
          [(Tactic.rwRule ["←"] `Int.cast_coe_nat) "," (Tactic.rwRule [] `num_derangements_sum)]
          "]")
         [])
        [])
       (group (Tactic.pushCast "push_cast" [] []) [])
       (group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Finset.sum_div)] "]") []) [])
       (group
        (Tactic.refine' "refine'" (Term.app `Finset.sum_congr [(Term.app `refl [(Term.hole "_")]) (Term.hole "_")]))
        [])
       ...
       (group
        (Tactic.tacticHave_
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           [`h_le []]
           [(Term.typeSpec ":" («term_≤_» `k "≤" `n))]
           ":="
           (Term.app `finset.mem_range_succ_iff.mp [`hk]))))
        [])
       (group
        (Tactic.rwSeq
         "rw"
         ...
         (Tactic.rwRuleSeq
          "["
          [(Tactic.rwRule [] `Nat.asc_factorial_eq_div)
           ","
           (Tactic.rwRule [] (Term.app `add_tsub_cancel_of_le [`h_le]))]
          "]")
         [])
        [])
       (group
        (Tactic.pushCast
         "push_cast"
         ["[" [(Tactic.simpLemma [] [] (Term.app `Nat.factorial_dvd_factorial [`h_le]))] "]"]
         [])
        [])
       (group
        (Tactic.fieldSimp "field_simp" [] [] ["[" [(Tactic.simpLemma [] [] `Nat.factorial_ne_zero)] "]"] [] [])
        [])
     ...
     [(group
      ...
      (group
       (Tactic.rwSeq
        ...
        (Tactic.rwRuleSeq
         "["
         [(Tactic.rwRule [] `Nat.asc_factorial_eq_div) "," (Tactic.rwRule [] (Term.app `add_tsub_cancel_of_le [`h_le]))]
         "]")
        [])
       [])
      (group
       (Tactic.pushCast
        ...
        [])
       [])
      (group (Tactic.fieldSimp "field_simp" [] [] ["[" [(Tactic.simpLemma [] [] `Nat.factorial_ne_zero)] "]"] [] []) [])
      (group (Tactic.Ring.tacticRing "ring") [])])))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.pushCast "push_cast" ["[" [(Tactic.simpLemma [] [] (Term.app `Nat.factorial_dvd_factorial [`h_le]))] "]"] [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simpLemma', expected 'Lean.Parser.Tactic.simpErase'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Nat.factorial_dvd_factorial [`h_le])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `add_tsub_cancel_of_le [`h_le])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Finset.sum_congr [(Term.app `refl [(Term.hole "_")]) (Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `refl [(Term.hole "_")]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `Finset.sum_congr
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Finset.sum_div)] "]") [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `Finset.sum_div
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq
   "rw"
   []
   (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `Int.cast_coe_nat) "," (Tactic.rwRule [] `num_derangements_sum)] "]")
   [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Real.exp_eq_exp_ℝ_ℝ)] "]") [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `Real.exp_eq_exp_ℝ_ℝ
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.apply "apply" `HasSum.tendsto_sum_nat)
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `tendsto_add_at_top_iff_nat [(numLit "1")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
  ...
  :=
    by
      let s : ℕ → ℝ := fun n => ∑ k in Finset.range n , ( - 1 : ℝ ) ^ k / k.factorial
        suffices
          ∀ n : ℕ , ( numDerangements n : ℝ ) / n.factorial = s n + 1
            by
              simp_rw [ this ]
