...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `Ultrafilter.eventually_mul [])
  (Command.declSig
   [(Term.implicitBinder "{" [`M] [] "}")
    (Term.instBinder "[" [] (Term.app `Mul [`M]) "]")
    (Term.explicitBinder "(" [`U `V] [":" (Term.app `Ultrafilter [`M])] [] ")")
    (Term.explicitBinder "(" [`p] [":" (Term.arrow `M "→" (Term.prop "Prop"))] [] ")")]
   (Term.typeSpec
    ":"
    («term_↔_»
     (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
      ...
      " in "
      (Init.Coe.«term↑_» "↑" (Finset.Data.Finset.Fold.«term_*_» `U "*" `V))
      ", "
      (Term.app `p [`m]))
     "↔"
     (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
      ...
      (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
       ...
       `V
       ", "
       (Term.app `p [(Finset.Data.Finset.Fold.«term_*_» `m "*" `m')]))))))
...
@[ to_additive ]
  theorem
    ...
    { M } [ Mul M ] ( U V : Ultrafilter M ) ( p : M → Prop ) : ∀ᶠ m in ↑ U * V , p m ↔ ∀ᶠ m in U , ∀ᶠ m' in V , p m * m'
    := Iff.rfl
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `Ultrafilter.continuous_mul_left [])
  (Command.declSig
   [(Term.implicitBinder "{" [`M] [] "}")
    (Term.instBinder "[" [] (Term.app `Semigroupₓ [`M]) "]")
    (Term.explicitBinder "(" [`V] [":" (Term.app `Ultrafilter [`M])] [] ")")]
   (Term.typeSpec ":" (Term.app `Continuous [(Finset.Data.Finset.Fold.«term_*_» (Term.cdot "·") "*" `V)])))
  (Command.declValSimple
   ":="
   («term_$__»
    (Term.app `TopologicalSpace.IsTopologicalBasis.continuous [`ultrafilter_basis_is_basis (Term.hole "_")])
    "$"
    («term_$__»
     (Term.proj `Set.forall_range_iff "." `mpr)
     "$"
     (Term.fun
      "fun"
      (Term.basicFun
       ...
       (Term.app
        ...
        [(Set.«term{_|_}»
          ...
          (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
           ...
           `V
           ", "
           (Init.Core.«term_∈_» (Finset.Data.Finset.Fold.«term_*_» `m "*" `m') " ∈ " `s))
          "}")])))))
   [])
  []
  []))
...
@[ to_additive ]
  theorem
    ...
    { M } [ Semigroupₓ M ] ( V : Ultrafilter M ) : Continuous · * V
    :=
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  ...
  [(Term.attributes
    "@["
    [(Term.attrInstance (Term.attrKind []) (Attr.toAdditive "to_additive" [`exists_idempotent_ultrafilter_le_FS] []))]
    "]")]
  []
  []
  []
 ...
 (Command.theorem
  "theorem"
  (Command.declId `exists_idempotent_ultrafilter_le_FP [])
  (Command.declSig
   [(Term.implicitBinder "{" [`M] [] "}")
    (Term.instBinder "[" [] (Term.app `Semigroupₓ [`M]) "]")
    (Term.explicitBinder "(" [`a] [":" (Term.app `Streamₓ [`M])] [] ")")]
   (Term.typeSpec
    ":"
    («term∃_,_»
     "∃"
     (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `U)] [":" (Term.app `Ultrafilter [`M])]))
     ","
     («term_∧_»
      («term_=_» (Finset.Data.Finset.Fold.«term_*_» `U "*" `U) "=" `U)
      "∧"
      (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
       "∀ᶠ"
       (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `m)] []))
       ...
       `U
       ", "
       (Init.Core.«term_∈_» `m " ∈ " (Term.app `FP [`a])))))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
      ...
      [(group
        (Tactic.tacticLet_
         ...
         (Term.letDecl
          (Term.letIdDecl
           `S
           [(Term.typeSpec ":" (Term.app `Set [(Term.app `Ultrafilter [`M])]))]
           ":="
           (Set.Data.Set.Lattice.«term⋂_,_»
            ...
            (Set.«term{_|_}»
             ...
             (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
              ...
              `U
              ", "
              (Init.Core.«term_∈_» `m " ∈ " (Term.app `FP [(Term.app `a.drop [`n])])))
             "}")))))
        [])
       (group
        (Tactic.obtain
         ...
         [(Tactic.rcasesPatMed
           [(Tactic.rcasesPat.tuple
             ...
             [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `U)]) [])
              ...
              ","
              (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `U_idem)]) [])]
             "⟩")])]
         []
         [":="
          [(Term.app
            `exists_idempotent_in_compact_subsemigroup
            [(Term.hole "_") `S (Term.hole "_") (Term.hole "_") (Term.hole "_")])]])
        [])
       (group
        (Tactic.«tactic·._»
         "·"
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group (Tactic.refine' "refine'" (Term.anonymousCtor "⟨" [`U "," `U_idem "," (Term.hole "_")] "⟩")) [])
            (group (Tactic.convert "convert" [] (Term.app `set.mem_Inter.mp [`hU (numLit "0")]) []) [])])))
        [])
       (group
        (Tactic.«tactic·._»
         "·"
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented [(group (Tactic.exact "exact" `Ultrafilter.continuous_mul_left) [])])))
        [])
       (group
        (Tactic.«tactic·._»
         "·"
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group (Tactic.apply "apply" `IsCompact.nonempty_Inter_of_sequence_nonempty_compact_closed) [])
            (group
             (Tactic.«tactic·._»
              "·"
              (Tactic.tacticSeq
               (Tactic.tacticSeq1Indented
                [(group (Tactic.intro "intro" [`n `U `hU]) [])
                 (group (Tactic.apply "apply" (Term.app `eventually.mono [`hU])) [])
                 (group
                  (Tactic.rwSeq
                   "rw"
                   []
                   (Tactic.rwRuleSeq
                    ...
                    [(Tactic.rwRule [] `add_commₓ)
                     ","
                     (Tactic.rwRule ["←"] `Streamₓ.drop_drop)
                     ","
                     (Tactic.rwRule ["←"] `Streamₓ.tail_eq_drop)]
                    "]")
                   [])
                  [])
                 (group (Tactic.exact "exact" (Term.app `FP.tail [(Term.hole "_")])) [])])))
             [])
            (group
             (Tactic.«tactic·._»
              "·"
                ...
                [(group (Tactic.intro "intro" [`n]) [])
                 (group
                  (Tactic.exact
                   ...
                   (Term.anonymousCtor
                    "⟨"
                    [(Term.app `pure [(Term.hole "_")])
                     ","
                     («term_$__» `mem_pure.mpr "$" (Term.app `FP.head [(Term.hole "_")]))]
                    "⟩"))
                  [])])))
             [])
            (group
              ...
              (Tactic.tacticSeq
               (Tactic.tacticSeq1Indented
                [(group
                  (Tactic.exact
                   "exact"
                   (Term.proj (Term.app `ultrafilter_is_closed_basic [(Term.hole "_")]) "." `IsCompact))
                  [])])))
             [])
            (group
             (Tactic.«tactic·._»
              ...
              (Tactic.tacticSeq
               (Tactic.tacticSeq1Indented
                [(group (Tactic.intro "intro" [`n]) [])
                 (group (Tactic.apply "apply" `ultrafilter_is_closed_basic) [])])))
             [])])))
        [])
       (group
        (Tactic.«tactic·._»
               ...
               [(«term_$__»
                 ...
                 (Term.fun
                  ...
                  (Term.basicFun
                   [(Term.simpleBinder [`i] [])]
                   "=>"
                   (Term.app `ultrafilter_is_closed_basic [(Term.hole "_")]))))]))
             [])])))
        [])
       (group
        (Tactic.«tactic·._»
         ...
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group (Tactic.intro "intro" [`U `V `hU `hV]) [])
            (group
             (Tactic.rwSeq
              "rw"
              []
              (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Set.mem_Inter)] "]")
            ...
            (group
             (Tactic.rwSeq
              ...
              (Tactic.rwRuleSeq
               "["
               [(Tactic.rwRule [] `Set.mem_set_of_eq) "," (Tactic.rwRule [] `Ultrafilter.eventually_mul)]
               "]")
              [])
             [])
            (group (Tactic.apply "apply" (Term.app `eventually.mono [(Term.app `hU [`n])])) [])
            ...
            (group
             ...
             [])
            (group
             (Tactic.apply "apply" (Term.app `eventually.mono [(Term.app `hV [(Init.Logic.«term_+_» `n' "+" `n)])]))
             [])
            (group (Tactic.intro "intro" [`m' `hm']) [])
            ...
            (group
             (Tactic.simpa
              ...
              []
              ["only"]
              ["[" [(Tactic.simpLemma [] [] `Streamₓ.drop_drop)] "]"]
              []
              ["using" `hm'])
             [])])))
        [])])))
        ...
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(group (Tactic.intro "intro" [`U `V `hU `hV]) [])
           ...
           (group (Tactic.apply "apply" `hn) [])
           (group
            (Tactic.simpa "simpa" [] ["only"] ["[" [(Tactic.simpLemma [] [] `Streamₓ.drop_drop)] "]"] [] ["using" `hm'])
            [])])))
       [])])))
     ...
     [(group (Tactic.intro "intro" [`U `V `hU `hV]) [])
      ...
      (group
       (Tactic.obtain
        ...
        [":=" [(Term.app `FP.mul [`hm])]])
       [])
      (group (Tactic.apply "apply" (Term.app `eventually.mono [(Term.app `hV [(Init.Logic.«term_+_» `n' "+" `n)])])) [])
      (group (Tactic.intro "intro" [`m' `hm']) [])
      (group (Tactic.apply "apply" `hn) [])
      (group
       (Tactic.simpa "simpa" [] ["only"] ["[" [(Tactic.simpLemma [] [] `Streamₓ.drop_drop)] "]"] [] ["using" `hm'])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.apply', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `eventually.mono [(Term.app `hV [(Init.Logic.«term_+_» `n' "+" `n)])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `hV [(Init.Logic.«term_+_» `n' "+" `n)])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 0, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Init.Logic.«term_+_» `n' "+" `n) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `hV
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `hV [(Term.paren "(" [(Init.Logic.«term_+_» `n' "+" `n) []] ")")]) []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `eventually.mono
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.apply "apply" (Term.app `eventually.mono [(Term.app `hU [`n])]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.apply', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `eventually.mono [(Term.app `hU [`n])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `hU [`n]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `eventually.mono
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq
   "rw"
   []
   (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Set.mem_set_of_eq) "," (Tactic.rwRule [] `Ultrafilter.eventually_mul)] "]")
   [])
  ...
  (Tactic.exact
   ...
   (Term.app
    ...
    [(«term_$__»
      ...
      (Term.fun
       "fun"
       (Term.basicFun [(Term.simpleBinder [`i] [])] "=>" (Term.app `ultrafilter_is_closed_basic [(Term.hole "_")]))))]))
      ...
      (group
       (Tactic.«tactic·._»
        ...
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(group
            (Tactic.exact "exact" (Term.proj (Term.app `ultrafilter_is_closed_basic [(Term.hole "_")]) "." `IsCompact))
            [])])))
       [])
      (group
       (Tactic.«tactic·._»
        ...
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(group (Tactic.intro "intro" [`n]) []) (group (Tactic.apply "apply" `ultrafilter_is_closed_basic) [])])))
       [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.«tactic·._»', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq', expected 'Lean.Parser.Tactic.tacticSeq.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq1Indented', expected 'Lean.Parser.Tactic.tacticSeqBracketed.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.apply "apply" `ultrafilter_is_closed_basic)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.apply', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `ultrafilter_is_closed_basic
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
     ...
     [(group (Tactic.intro "intro" [`n]) [])
      (group
       (Tactic.exact
        ...
        (Term.anonymousCtor
         "⟨"
         [(Term.app `pure [(Term.hole "_")]) "," («term_$__» `mem_pure.mpr "$" (Term.app `FP.head [(Term.hole "_")]))]
         "⟩"))
       [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.«tactic·._»', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq', expected 'Lean.Parser.Tactic.tacticSeq.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `FP.tail [(Term.hole "_")]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `FP.tail [(Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.apply "apply" (Term.app `eventually.mono [`hU]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.apply', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `eventually.mono [`hU])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.apply "apply" `IsCompact.nonempty_Inter_of_sequence_nonempty_compact_closed)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.apply', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.«tactic·._»
   "·"
   (Tactic.tacticSeq (Tactic.tacticSeq1Indented [(group (Tactic.exact "exact" `Ultrafilter.continuous_mul_left) [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.«tactic·._»', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq', expected 'Lean.Parser.Tactic.tacticSeq.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq1Indented', expected 'Lean.Parser.Tactic.tacticSeqBracketed.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq1Indented', expected 'Lean.Parser.Tactic.tacticSeqBracketed'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" `Ultrafilter.continuous_mul_left)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `Ultrafilter.continuous_mul_left
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.convert "convert" [] (Term.app `set.mem_Inter.mp [`hU (numLit "0")]) [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.convert', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `set.mem_Inter.mp [`hU (numLit "0")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.refine' "refine'" (Term.anonymousCtor "⟨" [`U "," `U_idem "," (Term.hole "_")] "⟩"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.refine'', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.anonymousCtor "⟨" [`U "," `U_idem "," (Term.hole "_")] "⟩")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.anonymousCtor.antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `a.drop [`n]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `FP
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  ...
  [(Term.attributes
    "@["
    [(Term.attrInstance (Term.attrKind []) (Attr.toAdditive "to_additive" [`exists_FS_of_large] []))]
    "]")]
  []
  []
  []
 ...
 (Command.theorem
  "theorem"
  (Command.declId `exists_FP_of_large [])
  (Command.declSig
   [(Term.implicitBinder "{" [`M] [] "}")
    (Term.instBinder "[" [] (Term.app `Semigroupₓ [`M]) "]")
    (Term.explicitBinder "(" [`U] [":" (Term.app `Ultrafilter [`M])] [] ")")
    (Term.explicitBinder "(" [`U_idem] [":" («term_=_» (Finset.Data.Finset.Fold.«term_*_» `U "*" `U) "=" `U)] [] ")")
    (Term.explicitBinder "(" [`s₀] [":" (Term.app `Set [`M])] [] ")")
    (Term.explicitBinder "(" [`sU] [":" (Init.Core.«term_∈_» `s₀ " ∈ " `U)] [] ")")]
   (Term.typeSpec
    ":"
    («term∃_,_»
     "∃"
     ...
     ","
     (Init.Core.«term_⊆_» (Term.app `FP [`a]) " ⊆ " `s₀))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
           ...
           [(Term.typeSpec
             ...
             (Term.forall
              ...
              [(Term.implicitBinder "{" [`s] [":" (Term.app `Set [`M])] "}")
               (Term.simpleBinder [`hs] [(Term.typeSpec ":" (Init.Core.«term_∈_» `s " ∈ " `U))])]
              ","
              (Term.proj
               (Init.Core.«term_∩_»
                `s
                  ...
                  (Tactic.tacticSeq1Indented
                   [(group
                     (Tactic.rwSeq
                      "rw"
                      []
                      (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `U_idem)] "]")
                      [(Tactic.location "at" (Tactic.locationHyp [`hs] []))])
                     [])
                    (group (Tactic.exact "exact" `hs) [])]))))]))))))
        [])
       (group
        (Tactic.tacticLet_
         "let"
         (Term.letDecl
          (Term.letIdDecl
           ...
           [(Term.typeSpec
             ":"
             (Term.arrow («term{__:_//_}» "{" `s [] "//" (Init.Core.«term_∈_» `s " ∈ " `U) "}") "→" `M))]
           ":="
           (Term.fun
            "fun"
            (Term.basicFun
             [(Term.simpleBinder [`p] [])]
             "=>"
             (Term.proj (Term.app `exists_elem [`p.property]) "." `some))))))
        [])
       (group
        (Tactic.tacticLet_
         "let"
         (Term.letDecl
          (Term.letIdDecl
           ...
           [(Term.typeSpec
             ":"
             (Term.arrow
              («term{__:_//_}» "{" `s [] "//" (Init.Core.«term_∈_» `s " ∈ " `U) "}")
              "→"
              («term{__:_//_}» "{" `s [] "//" (Init.Core.«term_∈_» `s " ∈ " `U) "}")))]
           ":="
           (Term.fun
             ...
             (Term.anonymousCtor
              ...
              [(Init.Core.«term_∩_»
                ...
                (Set.«term{_|_}»
                 ...
                 `m
                 "|"
                 (Init.Core.«term_∈_» (Finset.Data.Finset.Fold.«term_*_» (Term.app `elem [`p]) "*" `m) " ∈ " `p.val)
                 "}"))
               ","
               («term_$__»
                (Term.app `inter_mem [(Term.proj `p "." (fieldIdx "2"))])
                "$"
                (Term.show
                 "show"
                 (Term.hole "_")
                 (Term.fromTerm
                  ...
                  (Term.app
                   ...
                   [(Term.hole "_")
                    (Term.hole "_")
                    (Term.proj (Term.app `exists_elem [(Term.proj `p "." (fieldIdx "2"))]) "." `some_mem)]))))]
              "⟩"))))))
        [])
       (group (Tactic.use "use" [(Term.app `Streamₓ.corec [`elem `succ (Term.app `Subtype.mk [`s₀ `sU])])]) [])
       (group
        (Tactic.tacticSuffices_
         ...
         (Term.sufficesDecl
          ...
          (Term.forall
           "∀"
           [(Term.simpleBinder [`a] [(Term.typeSpec ":" (Term.app `Streamₓ [`M]))])]
           ","
           (Mathlib.ExtendedBinder.«term∀___,_»
            "∀"
            `m
            («binderTerm∈_» "∈" (Term.app `FP [`a]))
            ","
            (Term.forall
             "∀"
             []
             ...
             (Term.forall
              ...
              ","
              (Term.arrow
               («term_=_» `a "=" (Term.app `Streamₓ.corec [`elem `succ `p]))
               "→"
               (Init.Core.«term_∈_» `m " ∈ " `p.val))))))
          (Term.byTactic
           "by"
           (Tactic.tacticSeq
            (Tactic.tacticSeq1Indented
             [(group (Tactic.intro "intro" [`m `hm]) [])
              (group
               (Tactic.exact
                "exact"
                (Term.app `this [(Term.hole "_") `m `hm (Term.anonymousCtor "⟨" [`s₀ "," `sU] "⟩") `rfl]))
               [])])))))
        [])
       (group (Tactic.clear "clear" [`sU `s₀]) [])
       (group (Tactic.intro "intro" [`a `m `h]) [])
       (group
        (Tactic.induction'
         "induction'"
         ...
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group
             (Tactic.rintro
              "rintro"
              [(Tactic.rintroPat.one (Tactic.rcasesPat.one `p)) (Tactic.rintroPat.one (Tactic.rcasesPat.one `rfl))]
              [])
             [])
            (group
             (Tactic.rwSeq
              ...
              (Tactic.rwRuleSeq
               "["
               [(Tactic.rwRule [] `Streamₓ.corec_eq) "," (Tactic.rwRule [] `Streamₓ.head_cons)]
               "]")
              [])
             [])
            (group
             (Tactic.exact
              ...
              (Term.app
               ...
               [(Term.hole "_") (Term.hole "_") (Term.app `Set.Nonempty.some_mem [(Term.hole "_")])]))
             [])])))
        [])
       (group
        (Tactic.«tactic·._»
           ...
           [(group
            ...
            (group
             (Tactic.refine'
              ...
              (Term.app
               `Set.inter_subset_left
               [(Term.hole "_") (Term.hole "_") (Term.app `ih [(Term.app `succ [`p]) (Term.hole "_")])]))
             [])
            (group
             (Tactic.rwSeq
              "rw"
              ...
              (Tactic.rwRuleSeq
               "["
               [(Tactic.rwRule [] `Streamₓ.corec_eq) "," (Tactic.rwRule [] `Streamₓ.tail_cons)]
               "]")
              [])
             [])])))
        [])
           ...
           [(group
            ...
            (group
             (Tactic.«tactic·._»
              "·"
              (Tactic.tacticSeq
               (Tactic.tacticSeq1Indented [(group (Tactic.simpa "simpa" [] ["only"] [] [] ["using" `this]) [])])))
             [])
            (group
             (Tactic.rwSeq
              "rw"
          ...
          [(group
           ...
           (group
            (Tactic.rwSeq
             "rw"
             []
             (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Streamₓ.corec_eq) "," (Tactic.rwRule [] `Streamₓ.head_cons)] "]")
             [])
            [])
           (group
            (Tactic.exact
          ...
          [(group
           ...
           (group
            (Tactic.rwSeq
             "rw"
             []
             (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Streamₓ.corec_eq) "," (Tactic.rwRule [] `Streamₓ.tail_cons)] "]")
             [])
            [])])))
       [])
      (group
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.«tactic·._»
   "·"
   (Tactic.tacticSeq (Tactic.tacticSeq1Indented [(group (Tactic.simpa "simpa" [] ["only"] [] [] ["using" `this]) [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.«tactic·._»', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq', expected 'Lean.Parser.Tactic.tacticSeq.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq1Indented', expected 'Lean.Parser.Tactic.tacticSeqBracketed.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq1Indented', expected 'Lean.Parser.Tactic.tacticSeqBracketed'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.simpa "simpa" [] ["only"] [] [] ["using" `this])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simpa', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'optional.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `this
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `ih [(Term.app `succ [`p]) (Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `succ [`p]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `ih
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `ih [(Term.paren "(" [(Term.app `succ [`p]) []] ")") (Term.hole "_")]) []]
 ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Set.Nonempty.some_mem [(Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `this [(Term.hole "_") `m `hm (Term.anonymousCtor "⟨" [`s₀ "," `sU] "⟩") `rfl]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `this [(Term.hole "_") `m `hm (Term.anonymousCtor "⟨" [`s₀ "," `sU] "⟩") `rfl])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.forall
   ...
   [(Term.simpleBinder [`p] [])]
   ","
   (Term.arrow («term_=_» `a "=" (Term.app `Streamₓ.corec [`elem `succ `p])) "→" (Init.Core.«term_∈_» `m " ∈ " `p.val)))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.forall', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.forall', expected 'Lean.Parser.Term.forall.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.arrow («term_=_» `a "=" (Term.app `Streamₓ.corec [`elem `succ `p])) "→" (Init.Core.«term_∈_» `m " ∈ " `p.val))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_=_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Streamₓ.corec [`elem `succ `p])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.use "use" [(Term.app `Streamₓ.corec [`elem `succ (Term.app `Subtype.mk [`s₀ `sU])])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.use', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Streamₓ.corec [`elem `succ (Term.app `Subtype.mk [`s₀ `sU])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Subtype.mk [`s₀ `sU]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `exists_elem [(Term.proj `p "." (fieldIdx "2"))])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 51 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 50, term))
  (Finset.Data.Finset.Fold.«term_*_» (Term.app `elem [`p]) "*" `m)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Finset.Data.Finset.Fold.«term_*_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `m
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
    ...
    :=
      by
        have
          ...
          suffices
            ∀ a : Streamₓ M , ∀ m ∈ FP a , ∀ , ∀ p , a = Streamₓ.corec elem succ p → m ∈ p.val
              by intro m hm exact this _ m hm ⟨ s₀ , sU ⟩ rfl
          clear sU s₀
          intro a m h
