...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `adj_matrix_dot_product [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `NonAssocSemiring [`α]) "]")
    (Term.explicitBinder "(" [`v] [":" `V] [] ")")
    (Term.explicitBinder "(" [`vec] [":" (Term.arrow `V "→" `α)] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app `dot_product [(Term.app `G.adj_matrix [`α `v]) `vec])
     "="
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      "∑"
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `u)] []))
      " in "
      (Term.app `G.neighbor_finset [`v])
      ", "
      (Term.app `vec [`u])))))
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.simp
         ...
         []
         ["["
          [(Tactic.simpLemma [] [] `neighbor_finset_eq_filter)
           ","
           (Tactic.simpLemma [] [] `dot_product)
           ","
           (Tactic.simpLemma [] [] `sum_filter)]
          "]"]
         [])
        [])])))
   [])
...
@[ simp ]
  theorem
    ...
    [ NonAssocSemiring α ] ( v : V ) ( vec : V → α )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `dot_product_adj_matrix [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `NonAssocSemiring [`α]) "]")
    (Term.explicitBinder "(" [`v] [":" `V] [] ")")
    (Term.explicitBinder "(" [`vec] [":" (Term.arrow `V "→" `α)] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app `dot_product [`vec (Term.app `G.adj_matrix [`α `v])])
     "="
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      "∑"
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `u)] []))
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `adj_matrix_mul_vec_apply [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `NonAssocSemiring [`α]) "]")
    (Term.explicitBinder "(" [`v] [":" `V] [] ")")
    (Term.explicitBinder "(" [`vec] [":" (Term.arrow `V "→" `α)] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app (Term.app (Term.proj (Term.app `G.adj_matrix [`α]) "." `mulVec) [`vec]) [`v])
     "="
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      "∑"
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `u)] []))
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.rwSeq
         "rw"
         []
         (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `mul_vec) "," (Tactic.rwRule [] `adj_matrix_dot_product)] "]")
         [])
        [])])))
   [])
  []
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `adj_matrix_vec_mul_apply [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `NonAssocSemiring [`α]) "]")
    (Term.explicitBinder "(" [`v] [":" `V] [] ")")
    (Term.explicitBinder "(" [`vec] [":" (Term.arrow `V "→" `α)] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app (Term.app (Term.proj (Term.app `G.adj_matrix [`α]) "." `vecMul) [`vec]) [`v])
     "="
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      "∑"
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `u)] []))
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.rwSeq
         "rw"
         []
         (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `dot_product_adj_matrix) "," (Tactic.rwRule [] `vec_mul)] "]")
         [])
        [])
       (group (Tactic.refine' "refine'" (Term.app `congr [`rfl (Term.hole "_")])) [])
       ...
       (group
        (Tactic.rwSeq
         ...
         (Tactic.rwRuleSeq
          "["
          [(Tactic.rwRule ["←"] (Term.app `transpose_apply [(Term.app `adj_matrix [`α `G]) `x `v]))
           ","
           (Tactic.rwRule [] `transpose_adj_matrix)]
          "]")
         [])
        [])])))
   [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `transpose_apply [(Term.app `adj_matrix [`α `G]) `x `v])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `adj_matrix [`α `G]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `transpose_apply
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.refine' "refine'" (Term.app `congr [`rfl (Term.hole "_")]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.refine'', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `congr [`rfl (Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `adj_matrix_mul_apply [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `NonAssocSemiring [`α]) "]")
    (Term.explicitBinder "(" [`M] [":" (Term.app `Matrix [`V `V `α])] [] ")")
    (Term.explicitBinder "(" [`v `w] [":" `V] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app (Matrix.Data.Matrix.Basic.«term_⬝_» (Term.app `G.adj_matrix [`α]) " ⬝ " `M) [`v `w])
     "="
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      "∑"
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `u)] []))
...
@[ simp ]
  theorem
    ...
    [ NonAssocSemiring α ] ( M : Matrix V V α ) ( v w : V )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `mul_adj_matrix_apply [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `NonAssocSemiring [`α]) "]")
    (Term.explicitBinder "(" [`M] [":" (Term.app `Matrix [`V `V `α])] [] ")")
    (Term.explicitBinder "(" [`v `w] [":" `V] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app (Matrix.Data.Matrix.Basic.«term_⬝_» `M " ⬝ " (Term.app `G.adj_matrix [`α])) [`v `w])
     "="
     (Algebra.BigOperators.Basic.«term∑_in_,_»
      "∑"
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `u)] []))
      " in "
      (Term.app `G.neighbor_finset [`w])
      ", "
      (Term.app `M [`v `u])))))
  (Command.declValSimple
   ":="
