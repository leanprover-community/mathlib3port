...
theorem exists_isometric_embedding (α : Type u) [MetricSpace α] [separable_space α] : ∃ f : α → ℓ_infty_ℝ, Isometry f :=
  by
...
def kuratowskiEmbedding (α : Type u) [MetricSpace α] [separable_space α] : α → ℓ_infty_ℝ :=
