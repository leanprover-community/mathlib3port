...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " Define a predistance on `X ⊕ Y`, for which `Φ p` and `Ψ p` are at distance `ε` -/")]
  []
  []
  []
  []
 ...
 (Command.def
  "def"
  (Command.declId `glue_dist [])
  (Command.optDeclSig
   [(Term.explicitBinder "(" [`Φ] [":" (Term.arrow `Z "→" `X)] [] ")")
    (Term.explicitBinder "(" [`Ψ] [":" (Term.arrow `Z "→" `Y)] [] ")")
    (Term.explicitBinder "(" [`ε] [":" (Data.Real.Basic.termℝ "ℝ")] [] ")")]
   [(Term.typeSpec
     ":"
     (Term.arrow (Term.app `Sum [`X `Y]) "→" (Term.arrow (Term.app `Sum [`X `Y]) "→" (Data.Real.Basic.termℝ "ℝ"))))])
  (Command.declValEqns
   (Term.matchAltsWhereDecls
    (Term.matchAlts
     [(Term.matchAlt "|" [(Term.app `inl [`x]) "," (Term.app `inl [`y])] "=>" (Term.app `dist [`x `y]))
      (Term.matchAlt "|" [(Term.app `inr [`x]) "," (Term.app `inr [`y])] "=>" (Term.app `dist [`x `y]))
      (Term.matchAlt
       "|"
       ...
       (Init.Logic.«term_+_»
        (Order.CompleteLattice.«term⨅_,_»
         ...
         ", "
         (Init.Logic.«term_+_» (Term.app `dist [`x (Term.app `Φ [`p])]) "+" (Term.app `dist [`y (Term.app `Ψ [`p])])))
        "+"
        `ε))
      (Term.matchAlt
       "|"
       [(Term.app `inr [`x]) "," (Term.app `inl [`y])]
       "=>"
       (Init.Logic.«term_+_»
        (Order.CompleteLattice.«term⨅_,_»
         "⨅"
         (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `p)] []))
         ", "
         (Init.Logic.«term_+_» (Term.app `dist [`y (Term.app `Φ [`p])]) "+" (Term.app `dist [`x (Term.app `Ψ [`p])])))
        "+"
        `ε))])
    []))
  []
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Ψ [`p]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
/-- Define a predistance on `X ⊕ Y`, for which `Φ p` and `Ψ p` are at distance `ε` -/
  def
    glue_dist
    ( Φ : Z → X ) ( Ψ : Z → Y ) ( ε : ℝ ) : Sum X Y → Sum X Y → ℝ
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `glue_dist_glued_points [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `Nonempty [`Z]) "]")
    (Term.explicitBinder "(" [`Φ] [":" (Term.arrow `Z "→" `X)] [] ")")
    (Term.explicitBinder "(" [`Ψ] [":" (Term.arrow `Z "→" `Y)] [] ")")
    (Term.explicitBinder "(" [`ε] [":" (Data.Real.Basic.termℝ "ℝ")] [] ")")
    (Term.explicitBinder "(" [`p] [":" `Z] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app `glue_dist [`Φ `Ψ `ε (Term.app `inl [(Term.app `Φ [`p])]) (Term.app `inr [(Term.app `Ψ [`p])])])
     "="
     `ε)))
      ...
      [(group
          ...
          (Term.haveIdDecl
           ...
           [(Term.typeSpec
             ...
             («term_=_»
              (Order.CompleteLattice.«term⨅_,_»
               "⨅"
               (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `q)] []))
               ", "
               (Init.Logic.«term_+_»
                (Term.app `dist [(Term.app `Φ [`p]) (Term.app `Φ [`q])])
                "+"
                (Term.app `dist [(Term.app `Ψ [`p]) (Term.app `Ψ [`q])])))
              "="
              (numLit "0")))]
           ":="
           (Term.byTactic
                        ...
                        [(group
                          (Tactic.«tactic_<;>_»
                           (Tactic.rwSeq
                            ...
                            [])
                           "<;>"
                           (Tactic.exact "exact" (Term.app `add_le_add [`dist_nonneg `dist_nonneg])))
                          [])]))))))))
                [])
               (group
                (Tactic.refine' "refine'" (Term.app `le_antisymmₓ [(Term.hole "_") (Term.app `le_cinfi [`A])]))
                [])
               (group
                (Tactic.tacticHave_
                 "have"
                  ...
                  (Term.haveIdDecl
                   ...
                   [(Term.typeSpec
                     ...
                     («term_=_»
                      ...
                      "="
                      (Init.Logic.«term_+_»
                       (Term.app `dist [(Term.app `Φ [`p]) (Term.app `Φ [`p])])
                       "+"
                       (Term.app `dist [(Term.app `Ψ [`p]) (Term.app `Ψ [`p])]))))]
                   ":="
                   (Term.byTactic
                    "by"
               ...
               (group
                (Tactic.exact
                 ...
                 (Term.app
                  ...
                  [(Term.anonymousCtor
                    "⟨"
                    [(numLit "0") "," (Term.app (Term.proj `forall_range_iff "." (fieldIdx "2")) [`A])]
                    "⟩")
                   `p]))
                [])]))))))
        [])
       (group
        (Tactic.rwSeq
         ...
         (Tactic.rwRuleSeq
          "["
          [(Tactic.rwRule [] `glue_dist) "," (Tactic.rwRule [] `this) "," (Tactic.rwRule [] `zero_addₓ)]
          "]")
         [])
        [])])))
   [])
                     ...
                     (Tactic.tacticSeq
                      (Tactic.tacticSeq1Indented
                       [(group
                         ...
                         [])]))))))))
               [])
              (group (Tactic.refine' "refine'" (Term.app `le_antisymmₓ [(Term.hole "_") (Term.app `le_cinfi [`A])])) [])
              (group
               (Tactic.tacticHave_
                "have"
                (Term.haveDecl
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact
   ...
   (Term.app
    `cinfi_le
    [(Term.anonymousCtor "⟨" [(numLit "0") "," (Term.app (Term.proj `forall_range_iff "." (fieldIdx "2")) [`A])] "⟩")
     `p]))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.proj `forall_range_iff "." (fieldIdx "2")) [`A])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `le_antisymmₓ [(Term.hole "_") (Term.app `le_cinfi [`A])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `le_cinfi [`A]) []] ")")
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `add_le_add [`dist_nonneg `dist_nonneg])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `add_zeroₓ [(Term.paren "(" [(numLit "0") [(Term.typeAscription ":" (Data.Real.Basic.termℝ "ℝ"))]] ")")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Ψ [`q]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
theorem
  ...
  [ Nonempty Z ] ( Φ : Z → X ) ( Ψ : Z → Y ) ( ε : ℝ ) ( p : Z ) : glue_dist Φ Ψ ε inl Φ p inr Ψ p = ε
  :=
    by
      have
          : ⨅ q , dist Φ p Φ q + dist Ψ p Ψ q = 0
            ...
            by
              have
                  A
                    : ∀ q , 0 ≤ dist Φ p Φ q + dist Ψ p Ψ q
                    :=
                    fun q => by rw [ ← add_zeroₓ ( 0 : ℝ ) ] <;> exact add_le_add dist_nonneg dist_nonneg
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `glue_dist_triangle [])
  (Command.declSig
   [(Term.explicitBinder "(" [`Φ] [":" (Term.arrow `Z "→" `X)] [] ")")
    (Term.explicitBinder "(" [`Ψ] [":" (Term.arrow `Z "→" `Y)] [] ")")
    (Term.explicitBinder "(" [`ε] [":" (Data.Real.Basic.termℝ "ℝ")] [] ")")
   ...
   (Term.typeSpec
    ...
    (Term.forall
     ...
     ","
     («term_≤_»
      (Term.app `glue_dist [`Φ `Ψ `ε `x `z])
      "≤"
      (Init.Logic.«term_+_» (Term.app `glue_dist [`Φ `Ψ `ε `x `y]) "+" (Term.app `glue_dist [`Φ `Ψ `ε `y `z]))))))
  (Command.declValEqns
   (Term.matchAltsWhereDecls
    (Term.matchAlts
     [(Term.matchAlt
       "|"
       [(Term.app `inl [`x]) "," (Term.app `inl [`y]) "," (Term.app `inl [`z])]
       "=>"
       (Term.app `dist_triangle [(Term.hole "_") (Term.hole "_") (Term.hole "_")]))
      (Term.matchAlt
       "|"
       [(Term.app `inr [`x]) "," (Term.app `inr [`y]) "," (Term.app `inr [`z])]
       "=>"
       (Term.app `dist_triangle [(Term.hole "_") (Term.hole "_") (Term.hole "_")]))
      (Term.matchAlt
       "|"
       [(Term.app `inr [`x]) "," (Term.app `inl [`y]) "," (Term.app `inl [`z])]
       "=>"
       (Term.byTactic
        "by"
        (Tactic.tacticSeq
                  ...
                  (Term.app
                   ...
                   [(Term.app
                     ...
                     [(Term.fun
                       "fun"
                       (Term.basicFun
                        [(Term.simpleBinder [`p] [(Term.typeSpec ":" `Z)])]
                        "=>"
                        (Init.Logic.«term_+_»
                         (Term.app `dist [`a (Term.app `Φ [`p])])
                         "+"
                         (Term.app `dist [`b (Term.app `Ψ [`p])]))))])])))]
               ":="
               (Term.fun
                "fun"
                (Term.basicFun
                   ...
                   (Term.app
                    ...
                    [(Term.fun
                      ...
                      (Term.basicFun
                       [(Term.simpleBinder [`p] [])]
                       "=>"
                       (Term.app `add_nonneg [`dist_nonneg `dist_nonneg])))])]
                  "⟩"))))))
            [])
           (group (Tactic.unfold "unfold" [] [`glue_dist] []) [])
           (group
            (Tactic.tacticHave_
             "have"
             (Term.haveDecl
                  ...
                  [(group
                           ...
                           [(Rel.Data.Rel.«term_∘_»
                             (Term.fun
                              ...
                              (Term.basicFun
                               [(Term.simpleBinder [`t] [])]
                               "=>"
                               (Init.Logic.«term_+_» `t "+" (Term.app `dist [`y `z]))))
                             " ∘ "
                             (Term.fun
                              "fun"
                              (Term.basicFun
                            ...
                            (Tactic.refine'
                             ...
                             (Term.app
                              ...
                              [(Term.app `continuous_at_id.add [`continuous_at_const])
                               (Term.hole "_")
                               (Term.app `B [(Term.hole "_") (Term.hole "_")])]))
                            [])
                           (group (Tactic.intro "intro" [`x `y `hx]) [])
                   ...
                   (group
                    (Tactic.rwSeq
                     "rw"
                     []
                     (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `this) "," (Tactic.rwRule [] `comp)] "]")
                     [])
                    [])
                   (group
                    (Tactic.refine'
                    ...
                    (tacticCalc_
                     ...
                     [(calcStep
                       («term_≤_»
                        ...
                        "≤"
                        (Init.Logic.«term_+_»
                         (Init.Logic.«term_+_» (Term.app `dist [`y `z]) "+" (Term.app `dist [`y (Term.app `Φ [`p])]))
                         "+"
                         (Term.app `dist [`x (Term.app `Ψ [`p])])))
                       ":="
                       (Term.app
                        `add_le_add
                        [(Term.app `dist_triangle_left [(Term.hole "_") (Term.hole "_") (Term.hole "_")])
      ...
      (Term.matchAlt
       "|"
       [(Term.app `inr [`x]) "," (Term.app `inr [`y]) "," (Term.app `inl [`z])]
       "=>"
       (Term.byTactic
        "by"
        (Tactic.tacticSeq
                           ...
                           [(Rel.Data.Rel.«term_∘_»
                             (Term.fun
                              ...
                              (Term.basicFun
                               [(Term.simpleBinder [`t] [])]
                               "=>"
                               (Init.Logic.«term_+_» (Term.app `dist [`x `y]) "+" `t)))
                             " ∘ "
                             (Term.fun
                              "fun"
                              (Term.basicFun
                         ...
                         (Tactic.tacticSeq1Indented
                          [(group
                            (Tactic.refine'
                             ...
                             (Term.app
                              `map_cinfi_of_continuous_at_of_monotone
                              [(Term.app `continuous_at_const.add [`continuous_at_id])
                               (Term.hole "_")
                               (Term.app `B [(Term.hole "_") (Term.hole "_")])]))
                            [])
                           (group (Tactic.intro "intro" [`x `y `hx]) [])
                     ...
                     [(calcStep
                       («term_≤_»
                        ...
                        (Init.Logic.«term_+_»
                         (Term.app `dist [`z (Term.app `Φ [`p])])
                         "+"
                         (Init.Logic.«term_+_» (Term.app `dist [`x `y]) "+" (Term.app `dist [`y (Term.app `Ψ [`p])]))))
                       ":="
                       (Term.app
                        `add_le_add
                        [(Term.app `le_reflₓ [(Term.hole "_")])
      ...
      (Term.matchAlt
       "|"
       [(Term.app `inl [`x]) "," (Term.app `inl [`y]) "," (Term.app `inr [`z])]
       "=>"
       (Term.byTactic
        "by"
        (Tactic.tacticSeq
               ...
               [(Term.typeSpec
                 ...
                 («term_≤_»
                  (Order.CompleteLattice.«term⨅_,_»
                   ...
                   ", "
                   (Init.Logic.«term_+_»
                    (Term.app `dist [`x (Term.app `Φ [`p])])
                    "+"
                    (Term.app `dist [`z (Term.app `Ψ [`p])])))
                  "≤"
                  (Init.Logic.«term_+_»
                   (Term.app `dist [`x `y])
                   "+"
                    ...
                    (tacticCalc_
                     ...
                     [(calcStep
                       («term_≤_»
                        ...
                        "≤"
                        (Init.Logic.«term_+_»
                         (Init.Logic.«term_+_» (Term.app `dist [`x `y]) "+" (Term.app `dist [`y (Term.app `Φ [`p])]))
                         "+"
                         (Term.app `dist [`z (Term.app `Ψ [`p])])))
                       ":="
                       (Term.app
      ...
      (Term.matchAlt
       "|"
       [(Term.app `inl [`x]) "," (Term.app `inr [`y]) "," (Term.app `inr [`z])]
       "=>"
       (Term.byTactic
        "by"
        (Tactic.tacticSeq
                     ...
                     [(calcStep
                       («term_≤_»
                        ...
                        (Init.Logic.«term_+_»
                         (Term.app `dist [`x (Term.app `Φ [`p])])
                         "+"
                         (Init.Logic.«term_+_» (Term.app `dist [`y `z]) "+" (Term.app `dist [`y (Term.app `Ψ [`p])]))))
                       ":="
                       (Term.app
                        `add_le_add
                        [(Term.app `le_reflₓ [(Term.hole "_")])
      ...
      (Term.matchAlt
       "|"
       [(Term.app `inl [`x]) "," (Term.app `inr [`y]) "," (Term.app `inl [`z])]
       "=>"
       («term_$__»
               ...
               (Tactic.obtain
                ...
                [":"
                 («term∃_,_»
                  ...
                  («term_<_»
                   (Init.Logic.«term_+_»
                    (Term.app `dist [`z (Term.app `Φ [`q])])
                    "+"
                    (Term.app `dist [`y (Term.app `Ψ [`q])]))
                   "<"
                   (Init.Logic.«term_+_»
                    (Order.CompleteLattice.«term⨅_,_»
                     "⨅"
                       ...
                       (Tactic.tacticHave_
                        ...
                        (Term.haveDecl
                         (Term.haveIdDecl
                          ...
                          []
                          ":="
                          (Term.app `le_transₓ [(Term.app `le_abs_self [(Term.hole "_")]) (Term.app `H [`p `q])]))))
                       [])
                      (group
                       (Tactic.«tactic·._»
                        "·"
                  ...
                  («term_≤_»
                   ...
                   (Init.Logic.«term_+_»
                    (Init.Logic.«term_+_»
                     ...
                     (Term.app `dist [(Term.app `Φ [`p]) (Term.app `Φ [`q])]))
                    "+"
                    (Term.app `dist [(Term.app `Φ [`q]) `z])))
                  ":="
                  (Term.app `dist_triangle4 [(Term.hole "_") (Term.hole "_") (Term.hole "_") (Term.hole "_")]))
                 (calcStep
                  («term_≤_»
                   (Term.hole "_")
                   "≤"
                     ...
                     [(group
                       (Tactic.«tactic_<;>_»
                        (Tactic.rwSeq
                         "rw"
                         []
                         (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] (Term.app `dist_comm [`z]))] "]")
                         [])
                        "<;>"
      ...
      (Term.matchAlt
       "|"
       [(Term.app `inr [`x]) "," (Term.app `inl [`y]) "," (Term.app `inr [`z])]
       "=>"
       («term_$__»
        `le_of_forall_pos_le_add
        "$"
               ...
               (Tactic.obtain
                ...
                [":"
                 («term∃_,_»
                  ...
                  («term_<_»
                   (Init.Logic.«term_+_»
                    (Term.app `dist [`y (Term.app `Φ [`q])])
                    "+"
                    (Term.app `dist [`z (Term.app `Ψ [`q])]))
                   "<"
                   (Init.Logic.«term_+_»
                    (Order.CompleteLattice.«term⨅_,_»
                     "⨅"
                       ...
                       (Tactic.tacticHave_
                        ...
                        (Term.haveDecl
                         (Term.haveIdDecl
                          ...
                          []
                          ":="
                          (Term.app `le_transₓ [(Term.app `neg_le_abs_self [(Term.hole "_")]) (Term.app `H [`p `q])]))))
                       [])
                      (group
                       (Tactic.«tactic·._»
                        "·"
                 ...
                 (calcStep
                  ...
                  (Term.app
                   ...
                   [(Term.app
                     ...
                     [(Term.app
                       `add_le_add
                       [`le_rfl (Term.app `dist_triangle_left [(Term.hole "_") (Term.hole "_") (Term.hole "_")])])
                      `le_rfl])
                    `le_rfl]))
                 (calcStep
                  («term_≤_»
             ...
             (Term.byTactic
              ...
              (Tactic.tacticSeq
               (Tactic.tacticSeq1Indented
                [(group
                  (Tactic.«tactic_<;>_»
                   (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] (Term.app `dist_comm [`z]))] "]") [])
                   "<;>"
                   (Tactic.linarith "linarith" [] [] []))
                  [])]))))
            (calcStep
       ...
       (Tactic.obtain
        ...
        [":"
         («term∃_,_»
          ...
          ","
          («term_<_»
           (Init.Logic.«term_+_» (Term.app `dist [`y (Term.app `Φ [`q])]) "+" (Term.app `dist [`z (Term.app `Ψ [`q])]))
           "<"
           (Init.Logic.«term_+_»
            (Order.CompleteLattice.«term⨅_,_»
             "⨅"
      ...
      (Init.Logic.«term_+_»
       (Init.Logic.«term_+_»
        (Init.Logic.«term_+_»
         (Term.app `dist [`x (Term.app `Ψ [`p])])
         "+"
         (Init.Logic.«term_+_» (Term.app `dist [`y (Term.app `Φ [`p])]) "+" (Term.app `dist [`y (Term.app `Φ [`q])])))
        "+"
        (Term.app `dist [`z (Term.app `Ψ [`q])]))
       "+"
       (Finset.Data.Finset.Fold.«term_*_» (numLit "2") "*" `ε)))
       ...
       (Init.Logic.«term_+_»
        ...
        (Init.Logic.«term_+_»
         (Order.CompleteLattice.«term⨅_,_»
          ...
          (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `p)] []))
          ", "
          (Init.Logic.«term_+_» (Term.app `dist [`y (Term.app `Φ [`p])]) "+" (Term.app `dist [`z (Term.app `Ψ [`p])])))
         "+"
         `ε))
       "+"
       `δ))
...
private
  theorem
    glue_dist_triangle
    ( Φ : Z → X ) ( Ψ : Z → Y ) ( ε : ℝ ) ( H : ∀ p q , | dist Φ p Φ q - dist Ψ p Ψ q | ≤ 2 * ε )
    ...
    | inl x , inl y , inl z => dist_triangle _ _ _
      ...
      |
        ...
        by
          have
              B
                : ∀ a b , BddBelow range fun p : Z => dist a Φ p + dist b Ψ p
                :=
                fun a b => ⟨ 0 , forall_range_iff . 2 fun p => add_nonneg dist_nonneg dist_nonneg ⟩
            unfold glue_dist
            have
              : ⨅ p , dist z Φ p + dist x Ψ p ≤ ⨅ p , dist y Φ p + dist x Ψ p + dist y z
                :=
                by
                  have
                      :
                        ...
                        by
                          refine'
                              map_cinfi_of_continuous_at_of_monotone continuous_at_id.add continuous_at_const _ B _ _
                            intro x y hx
                            simpa
                    rw [ this , comp ]
                    ...
                    calc
                      dist z Φ p + dist x Ψ p ≤ dist y z + dist y Φ p + dist x Ψ p
                          :=
                          add_le_add dist_triangle_left _ _ _ le_reflₓ _
      ...
      |
        ...
        by
          have
            ...
            unfold glue_dist
            have
              : ⨅ p , dist z Φ p + dist x Ψ p ≤ dist x y + ⨅ p , dist z Φ p + dist y Ψ p
                :=
                by
                  have
                      :
                        ...
                        by
                          refine'
                              map_cinfi_of_continuous_at_of_monotone continuous_at_const.add continuous_at_id _ B _ _
                            intro x y hx
                            simpa
                    rw [ this , comp ]
                    refine' cinfi_le_cinfi B _ _ fun p => _
                    calc
                      dist z Φ p + dist x Ψ p ≤ dist z Φ p + dist x y + dist y Ψ p
                          :=
                          add_le_add le_reflₓ _ dist_triangle _ _ _
      ...
      |
        ...
        by
          have
            ...
            unfold glue_dist
            have
              : ⨅ p , dist x Φ p + dist z Ψ p ≤ dist x y + ⨅ p , dist y Φ p + dist z Ψ p
                :=
                by
                  have
                      :
                    ...
                    calc
                      dist x Φ p + dist z Ψ p ≤ dist x y + dist y Φ p + dist z Ψ p
                          :=
                          add_le_add dist_triangle _ _ _ le_reflₓ _
      ...
      |
        ...
        by
          have
            ...
            unfold glue_dist
            have
              : ⨅ p , dist x Φ p + dist z Ψ p ≤ ⨅ p , dist x Φ p + dist y Ψ p + dist y z
                :=
                by
                  have
                      :
                    ...
                    calc
                      dist x Φ p + dist z Ψ p ≤ dist x Φ p + dist y z + dist y Ψ p
                          :=
                          add_le_add le_reflₓ _ dist_triangle_left _ _ _
            ...
            δ δpos
              ...
              by
                obtain ⟨ p , hp ⟩ : ∃ p , dist x Φ p + dist y Ψ p < ⨅ p , dist x Φ p + dist y Ψ p + δ / 2
                  ...
                  exact exists_lt_of_cinfi_lt by linarith
                  have : dist Φ p Φ q ≤ dist Ψ p Ψ q + 2 * ε := by have := le_transₓ le_abs_self _ H p q · linarith
                  calc
                    dist x z ≤ dist x Φ p + dist Φ p Φ q + dist Φ q z := dist_triangle4 _ _ _ _
                      ...
                      _ ≤ dist x Φ p + dist y Ψ p + dist y Ψ q + dist z Φ q + 2 * ε
                        :=
                        add_le_add add_le_add add_le_add le_reflₓ _ dist_triangle_left _ _ _ le_rfl le_rfl
            ...
            δ δpos
              ...
              by
                obtain ⟨ p , hp ⟩ : ∃ p , dist y Φ p + dist x Ψ p < ⨅ p , dist y Φ p + dist x Ψ p + δ / 2
                  ...
                  exact exists_lt_of_cinfi_lt by linarith
                  have : dist Ψ p Ψ q ≤ dist Φ p Φ q + 2 * ε := by have := le_transₓ neg_le_abs_self _ H p q · linarith
                  calc
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `glue_eq_of_dist_eq_zero [])
  (Command.declSig
   [(Term.explicitBinder "(" [`Φ] [":" (Term.arrow `Z "→" `X)] [] ")")
    (Term.explicitBinder "(" [`Ψ] [":" (Term.arrow `Z "→" `Y)] [] ")")
    (Term.explicitBinder "(" [`ε] [":" (Data.Real.Basic.termℝ "ℝ")] [] ")")
   ...
   (Term.typeSpec
    ...
    (Term.forall
     "∀"
     [(Term.simpleBinder [`p `q] [(Term.typeSpec ":" (Term.app `Sum [`X `Y]))])]
     ","
     (Term.arrow («term_=_» (Term.app `glue_dist [`Φ `Ψ `ε `p `q]) "=" (numLit "0")) "→" («term_=_» `p "=" `q)))))
  (Command.declValEqns
   (Term.matchAltsWhereDecls
    (Term.matchAlts
     [(Term.matchAlt
       "|"
       [(Term.app `inl [`x]) "," (Term.app `inl [`y]) "," `h]
       "=>"
       (Term.byTactic
        "by"
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(group
            (Tactic.rwSeq
             "rw"
             []
             (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] (Term.app `eq_of_dist_eq_zero [`h]))] "]")
             [])
            [])]))))
      (Term.matchAlt
       "|"
       [(Term.app `inl [`x]) "," (Term.app `inr [`y]) "," `h]
       "=>"
       (Term.byTactic
        "by"
        (Tactic.tacticSeq
                        ...
                        (Tactic.simpa
                         ...
                         ["using"
                          (Term.app
                           `add_le_add
                           [(Term.app
                             (Term.explicit "@" `dist_nonneg)
                             [(Term.hole "_") (Term.hole "_") `x (Term.hole "_")])
                            (Term.app
                             (Term.explicit "@" `dist_nonneg)
                             [(Term.hole "_") (Term.hole "_") `y (Term.hole "_")])])])
                        [])])))))]))))
            [])
           (group
            (Tactic.tacticHave_
             ...
             (Term.haveDecl
              (Term.haveIdDecl
               ...
               [(Term.typeSpec
                 ":"
                 («term_≤_»
                  (Init.Logic.«term_+_» (numLit "0") "+" `ε)
                  "≤"
                  (Term.app `glue_dist [`Φ `Ψ `ε (Term.app `inl [`x]) (Term.app `inr [`y])])))]
               ":="
               (Term.app `add_le_add [`this (Term.app `le_reflₓ [`ε])]))))
            [])
           (group (tacticExfalso "exfalso") [])
           (group (Tactic.linarith "linarith" [] [] []) [])]))))
      (Term.matchAlt
       "|"
       [(Term.app `inr [`x]) "," (Term.app `inl [`y]) "," `h]
       "=>"
       (Term.byTactic
        "by"
        (Tactic.tacticSeq
              ...
              (Term.haveIdDecl
               ...
               [(Term.typeSpec
                 ...
                 («term_≤_»
                  (Init.Logic.«term_+_» (numLit "0") "+" `ε)
                  "≤"
                  (Term.app `glue_dist [`Φ `Ψ `ε (Term.app `inr [`x]) (Term.app `inl [`y])])))]
               ":="
               (Term.app `add_le_add [`this (Term.app `le_reflₓ [`ε])]))))
            [])
           (group (tacticExfalso "exfalso") [])
      ...
      (Term.matchAlt
       "|"
       [(Term.app `inr [`x]) "," (Term.app `inr [`y]) "," `h]
       "=>"
       (Term.byTactic
        "by"
        (Tactic.tacticSeq
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.byTactic
   ...
   (Tactic.tacticSeq
    (Tactic.tacticSeq1Indented
     [(group
       (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] (Term.app `eq_of_dist_eq_zero [`h]))] "]") [])
       [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.byTactic', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.byTactic', expected 'Lean.Parser.Term.byTactic.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq', expected 'Lean.Parser.Tactic.tacticSeq.antiquot'
                 ...
                 [(group
                   (Tactic.simpa
                    ...
                    ["using"
                     (Term.app
                      `add_le_add
                      [(Term.app (Term.explicit "@" `dist_nonneg) [(Term.hole "_") (Term.hole "_") `x (Term.hole "_")])
                       (Term.app
                        (Term.explicit "@" `dist_nonneg)
                        [(Term.hole "_") (Term.hole "_") `y (Term.hole "_")])])])
                   [])])))))]))))
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `le_reflₓ [`ε]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `inl [`y]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `inr [`x]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Init.Logic.«term_+_» (numLit "0") "+" `ε) []] ")")
              ...
              (Tactic.simpa
               ...
               ["using"
                (Term.app
                 `add_le_add
                 [(Term.app (Term.explicit "@" `dist_nonneg) [(Term.hole "_") (Term.hole "_") `x (Term.hole "_")])
                  (Term.app (Term.explicit "@" `dist_nonneg) [(Term.hole "_") (Term.hole "_") `y (Term.hole "_")])])])
              [])])))))]))))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticHave_', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.haveDecl', expected 'Lean.Parser.Term.haveDecl.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.haveIdDecl', expected 'Lean.Parser.Term.haveIdDecl.antiquot'
...
private
  theorem
    ...
    ( Φ : Z → X ) ( Ψ : Z → Y ) ( ε : ℝ ) ( ε0 : 0 < ε ) : ∀ p q : Sum X Y , glue_dist Φ Ψ ε p q = 0 → p = q
...
/- failed to parenthesize: parenthesize: uncaught backtrack exception
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers [(Command.docComment "/--" " Predistance on the disjoint union `Σ n, X n`. -/")] [] [] [] [] [])
 (Command.def
  "def"
  (Command.declId `inductive_limit_dist [])
  (Command.optDeclSig
   [(Term.explicitBinder
     "("
     [`f]
     [":"
      (Term.forall
       ...
       [(Term.simpleBinder [`n] [])]
       ","
       (Term.arrow (Term.app `X [`n]) "→" (Term.app `X [(Init.Logic.«term_+_» `n "+" (numLit "1"))])))]
     []
     ")")
    (Term.explicitBinder
     "("
  ...
  (Command.declValSimple
   ...
   (Term.app
    ...
    [(Term.paren
      ...
      [(Term.app
        `le_rec_on
        [(Term.app `le_max_leftₓ [(Term.proj `x "." (fieldIdx "1")) (Term.proj `y "." (fieldIdx "1"))])
         `f
         (Term.proj `x "." (fieldIdx "2"))])
       [(Term.typeAscription
         ":"
         (Term.app `X [(Term.app `max [(Term.proj `x "." (fieldIdx "1")) (Term.proj `y "." (fieldIdx "1"))])]))]]
      ")")
     (Term.paren
      "("
      [(Term.app
        `le_rec_on
        [(Term.app `le_max_rightₓ [(Term.proj `x "." (fieldIdx "1")) (Term.proj `y "." (fieldIdx "1"))])
         `f
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `max [(Term.proj `x "." (fieldIdx "1")) (Term.proj `y "." (fieldIdx "1"))])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
/-- Predistance on the disjoint union `Σ n, X n`. -/
  def
    inductive_limit_dist
    ( f : ∀ n , X n → X n + 1 ) ( x y : Σ n , X n ) : ℝ
    :=
      dist
        ( le_rec_on le_max_leftₓ x . 1 y . 1 f x . 2 : X max x . 1 y . 1 )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `inductive_limit_dist_eq_dist [])
  (Command.declSig
   [(Term.explicitBinder
     "("
     [`I]
     [":" (Term.forall "∀" [(Term.simpleBinder [`n] [])] "," (Term.app `Isometry [(Term.app `f [`n])]))]
     []
     ")")
    (Term.explicitBinder
     "("
   ...
   (Term.typeSpec
    ...
    (Term.forall
     "∀"
     [(Term.simpleBinder [`hx] [(Term.typeSpec ":" («term_≤_» (Term.proj `x "." (fieldIdx "1")) "≤" `m))])]
     ","
     (Term.forall
      "∀"
      [(Term.simpleBinder [`hy] [(Term.typeSpec ":" («term_≤_» (Term.proj `y "." (fieldIdx "1")) "≤" `m))])]
      ","
      («term_=_»
       (Term.app `inductive_limit_dist [`f `x `y])
       "="
       (Term.app
        `dist
        [(Term.paren
          "("
          [(Term.app `le_rec_on [`hx `f (Term.proj `x "." (fieldIdx "2"))])
           [(Term.typeAscription ":" (Term.app `X [`m]))]]
          ")")
         (Term.paren
          "("
          [(Term.app `le_rec_on [`hy `f (Term.proj `y "." (fieldIdx "2"))])
           [(Term.typeAscription ":" (Term.app `X [`m]))]]
          ")")]))))))
  (Command.declValSimple
   ":="
      ...
      [(group
       ...
       (group
        (Tactic.«tactic·._»
         ...
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group (Tactic.intro "intro" [`hx `hy]) [])
            (group
             (Tactic.tacticHave_
              "have"
              (Term.haveDecl
                  ...
                  (Tactic.tacticSeq1Indented
                   [(group
                     (Tactic.rwSeq
                      ...
                      (Tactic.rwRuleSeq
                       "["
                       [(Tactic.rwRule [] (Term.app (Term.proj `nonpos_iff_eq_zero "." (fieldIdx "1")) [`hx]))
                        ","
                        (Tactic.rwRule [] (Term.app (Term.proj `nonpos_iff_eq_zero "." (fieldIdx "1")) [`hy]))]
                       "]")
                      [])
                     [])
                    (group (Tactic.simp "simp" [] [] [] []) [])]))))))
             [])
            (group (Tactic.unfold "unfold" [] [`inductive_limit_dist] []) [])
            (group
             (Tactic.«tactic_<;>_»
              (Tactic.congr "congr" [] [])
              "<;>"
              (Tactic.simp "simp" [] ["only"] ["[" [(Tactic.simpLemma [] [] `A)] "]"] []))
             [])])))
        [])
       (group
        (Tactic.«tactic·._»
                       ...
                       (Tactic.tacticSeq1Indented
                        [(group
                          (Tactic.simpa
                           ...
                           ["[" [(Tactic.simpLemma [] [] `h)] "]"]
                           []
                           ["using" (Term.app `of_le_succ [`this])])
                          [])]))))))
                  [])
                 (group
                  (Tactic.tacticHave_
                   ...
                   (Term.haveDecl
                    (Term.haveIdDecl
                     [`xm []]
                     [(Term.typeSpec ":" («term_≤_» (Term.proj `x "." (fieldIdx "1")) "≤" `m))]
                     ":="
                     (Term.app `le_transₓ [(Term.app `le_max_leftₓ [(Term.hole "_") (Term.hole "_")]) `this]))))
                  [])
                 (group
                  (Tactic.tacticHave_
                   "have"
                   (Term.haveDecl
                    (Term.haveIdDecl
                     [`ym []]
                     [(Term.typeSpec ":" («term_≤_» (Term.proj `y "." (fieldIdx "1")) "≤" `m))]
                     ":="
                     (Term.app `le_transₓ [(Term.app `le_max_rightₓ [(Term.hole "_") (Term.hole "_")]) `this]))))
                  [])
                 (group
                  (Tactic.rwSeq
                   "rw"
                   ...
                   (Tactic.rwRuleSeq
                    "["
                    [(Tactic.rwRule [] (Term.app `le_rec_on_succ [`xm]))
                     ","
                     (Tactic.rwRule [] (Term.app `le_rec_on_succ [`ym]))
                     ","
                     (Tactic.rwRule [] (Term.proj (Term.app `I [`m]) "." `dist_eq))]
                    "]")
                   [])
                  [])
                 (group (Tactic.exact "exact" (Term.app `hm [`xm `ym])) [])])))
             [])])))
        [])])))
   [])
  []
     ...
     [(group (Tactic.intro "intro" [`hx `hy]) [])
      (group
       (Tactic.byCases'
        "by_cases'"
        [`h ":"]
        («term_=_» (Term.app `max [(Term.proj `x "." (fieldIdx "1")) (Term.proj `y "." (fieldIdx "1"))]) "=" `m.succ))
       [])
      (group
       (Tactic.«tactic·._»
        "·"
         ...
         (Term.haveIdDecl
          ...
          (Term.byTactic
           ...
           (Tactic.tacticSeq
            (Tactic.tacticSeq1Indented
             [(group
               (Tactic.simp "simp" [] [] ["[" [(Tactic.simpLemma [] [] `hx) "," (Tactic.simpLemma [] [] `hy)] "]"] [])
               [])]))))))
       [])
      (group
       (Tactic.tacticHave_
        ...
        (Term.haveDecl
         (Term.haveIdDecl
          ...
          [(Term.typeSpec
            ":"
            («term_≤_» (Term.app `max [(Term.proj `x "." (fieldIdx "1")) (Term.proj `y "." (fieldIdx "1"))]) "≤" `m))]
          ":="
          (Term.byTactic
           "by"
           (Tactic.tacticSeq
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `hm [`xm `ym]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `hm [`xm `ym])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Term.app `I [`m]) "." `dist_eq)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `I [`m])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `I [`m]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `le_rec_on_succ [`ym])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_≤_» (Term.proj `y "." (fieldIdx "1")) "≤" `m)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_≤_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `m
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_≤_» (Term.proj `x "." (fieldIdx "1")) "≤" `m)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_≤_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `m
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.byTactic
   ...
   (Tactic.tacticSeq
    (Tactic.tacticSeq1Indented
     [(group
       (Tactic.simpa "simpa" [] [] ["[" [(Tactic.simpLemma [] [] `h)] "]"] [] ["using" (Term.app `of_le_succ [`this])])
       [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.byTactic', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.byTactic', expected 'Lean.Parser.Term.byTactic.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq', expected 'Lean.Parser.Tactic.tacticSeq.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.unfold "unfold" [] [`inductive_limit_dist] [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.proj `nonpos_iff_eq_zero "." (fieldIdx "1")) [`hy])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj `nonpos_iff_eq_zero "." (fieldIdx "1"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  `nonpos_iff_eq_zero
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.proj `nonpos_iff_eq_zero "." (fieldIdx "1")) [`hx])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_=_» (Term.app `max [(Term.proj `x "." (fieldIdx "1")) (Term.proj `y "." (fieldIdx "1"))]) "=" (numLit "0"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_=_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (numLit "0")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'numLit', expected 'antiquot'
  ...
  (Term.forall
   ...
   («term_=_»
    ...
    (Term.app
     ...
     [(Term.paren
       "("
       [(Term.app `le_rec_on [`hx `f (Term.proj `x "." (fieldIdx "2"))]) [(Term.typeAscription ":" (Term.app `X [`m]))]]
       ")")
      (Term.paren
       "("
       [(Term.app `le_rec_on [`hy `f (Term.proj `y "." (fieldIdx "2"))]) [(Term.typeAscription ":" (Term.app `X [`m]))]]
       ")")])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.forall', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.forall', expected 'Lean.Parser.Term.forall.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
/--
  ...
  theorem
    ...
    ( I : ∀ n , Isometry f n ) ( x y : Σ n , X n ) ( m : ℕ )
      :
        ∀
          hx : x . 1 ≤ m
          ,
        ...
        induction' m with m hm
          ...
          ·
            intro hx hy
              ...
              · unfold inductive_limit_dist congr <;> simp only [ h ]
              ·
...
/- failed to parenthesize: parenthesize: uncaught backtrack exception
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers [(Command.docComment "/--" " Premetric space structure on `Σ n, X n`.-/")] [] [] [] [] [])
 (Command.def
  "def"
  (Command.declId `inductive_premetric [])
  (Command.optDeclSig
   [(Term.explicitBinder
     "("
     [`I]
  ...
  (Command.declValSimple
   ...
   (Term.structInst
    "{"
    []
    [(group (Term.structInstField (Term.structInstLVal `dist []) ":=" (Term.app `inductive_limit_dist [`f])) [","])
     (group
      (Term.structInstField
       (Term.structInstLVal `dist_self [])
       ":="
       (Term.fun
        "fun"
        (Term.basicFun
           ...
           (Tactic.tacticSeq1Indented
            [(group
              (Tactic.simp
               ...
               []
               []
               ["[" [(Tactic.simpLemma [] [] `dist) "," (Tactic.simpLemma [] [] `inductive_limit_dist)] "]"]
               [])
              [])]))))))
      [","])
     (group
      (Term.structInstField
       (Term.structInstLVal `dist_comm [])
       ":="
       (Term.fun
        "fun"
        (Term.basicFun
            ...
            [(group
             ...
             (group
              (Tactic.rwSeq
               ...
               (Tactic.rwRuleSeq
                "["
                [(Tactic.rwRule [] (Term.app `inductive_limit_dist_eq_dist [`I `x `y `m `hx `hy]))
                 ","
                 (Tactic.rwRule [] (Term.app `inductive_limit_dist_eq_dist [`I `y `x `m `hy `hx]))
                 ","
     ...
     (group
      (Term.structInstField
       (Term.structInstLVal `dist_triangle [])
       ":="
       (Term.fun
        "fun"
        (Term.basicFun
             ...
             (group
              (Tactic.tacticHave_
               ...
               (Term.haveDecl
                (Term.haveIdDecl
                 [`hz []]
                 [(Term.typeSpec ":" («term_≤_» (Term.proj `z "." (fieldIdx "1")) "≤" `m))]
                 ":="
                 (Term.app `le_max_rightₓ [(Term.hole "_") (Term.hole "_")]))))
              [])
             (group
              (tacticCalc_
               ...
               [(calcStep
                 («term_=_»
                  (Term.app `inductive_limit_dist [`f `x `z])
                  "="
                  (Term.app
                   `dist
                   [(Term.paren
                    ...
                    (Term.paren
                     "("
                     [(Term.app `le_rec_on [`hz `f (Term.proj `z "." (fieldIdx "2"))])
                      [(Term.typeAscription ":" (Term.app `X [`m]))]]
                     ")")]))
                 ":="
                 (Term.app `inductive_limit_dist_eq_dist [`I `x `z `m `hx `hz]))
                (calcStep
                 («term_≤_»
                  (Term.hole "_")
                  "≤"
                ...
                (calcStep
                 («term_=_»
                  ...
                  (Init.Logic.«term_+_»
                   (Term.app `inductive_limit_dist [`f `x `y])
                   "+"
                   (Term.app `inductive_limit_dist [`f `y `z])))
                 ":="
                 (Term.byTactic
                  "by"
                  (Tactic.tacticSeq
                    ...
                    [(group
                      (Tactic.rwSeq
                       ...
                       (Tactic.rwRuleSeq
                        ...
                        [(Tactic.rwRule [] (Term.app `inductive_limit_dist_eq_dist [`I `x `y `m `hx `hy]))
                         ","
                         (Tactic.rwRule [] (Term.app `inductive_limit_dist_eq_dist [`I `y `z `m `hy `hz]))]
                        "]")
                       [])
                      [])]))))])
              [])]))))))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `inductive_limit_dist_eq_dist [`I `y `z `m `hy `hz])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `inductive_limit_dist_eq_dist [`I `x `y `m `hx `hy])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_=_»
   (Term.hole "_")
   "="
   (Init.Logic.«term_+_» (Term.app `inductive_limit_dist [`f `x `y]) "+" (Term.app `inductive_limit_dist [`f `y `z])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_=_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Init.Logic.«term_+_» (Term.app `inductive_limit_dist [`f `x `y]) "+" (Term.app `inductive_limit_dist [`f `y `z]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Logic.«term_+_»', expected 'antiquot'
   ...
   (Init.Logic.«term_+_»
    ...
    (Term.app
     ...
     [(Term.paren
      ...
      (Term.paren
       "("
       [(Term.app `le_rec_on [`hz `f (Term.proj `z "." (fieldIdx "2"))]) [(Term.typeAscription ":" (Term.app `X [`m]))]]
       ")")])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_≤_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Init.Logic.«term_+_»
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_≤_» (Term.proj `z "." (fieldIdx "1")) "≤" `m)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_≤_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `m
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `inductive_limit_dist_eq_dist [`I `y `x `m `hy `hx])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.tacticLet_
   "let"
   (Term.letDecl
    (Term.letIdDecl `m [] ":=" (Term.app `max [(Term.proj `x "." (fieldIdx "1")) (Term.proj `y "." (fieldIdx "1"))]))))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticLet_', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.letDecl', expected 'Lean.Parser.Term.letDecl.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.letIdDecl', expected 'Lean.Parser.Term.letIdDecl.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.structInstField', expected 'Lean.Parser.Term.structInstField.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `inductive_limit_dist [`f])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
/-- Premetric space structure on `Σ n, X n`.-/
  def
    inductive_premetric
    ( I : ∀ n , Isometry f n ) : PseudoMetricSpace Σ n , X n
    :=
      {
                ...
                x y
                  ...
                  by
                    let m := max x . 1 y . 1
                      ...
                      rw
                        [
                          inductive_limit_dist_eq_dist I x y m hx hy
                            ,
                            inductive_limit_dist_eq_dist I y x m hy hx
                            ,
                            dist_comm
                          ]
            ,
                    ...
                    calc
                      inductive_limit_dist f x z = dist ( le_rec_on hx f x . 2 : X m ) ( le_rec_on hz f z . 2 : X m )
                        ...
                        _
                          ...
                          :=
                          dist_triangle _ _ _
                        _ = inductive_limit_dist f x y + inductive_limit_dist f y z
                          :=
                          by
                            rw
                              [
                                inductive_limit_dist_eq_dist I x y m hx hy , inductive_limit_dist_eq_dist I y z m hy hz
                                ]
        }
...
/- failed to parenthesize: parenthesize: uncaught backtrack exception
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers [(Command.docComment "/--" " Mapping each `X n` to the inductive limit. -/")] [] [] [] [] [])
 (Command.def
  "def"
  (Command.declId `to_inductive_limit [])
  (Command.optDeclSig
   [(Term.explicitBinder
     "("
     [`I]
    ...
    (Term.explicitBinder "(" [`x] [":" (Term.app `X [`n])] [] ")")]
   [(Term.typeSpec ":" (Term.app `Metric.InductiveLimit [`I]))])
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
            ...
            [(Term.typeSpec
              ...
              (Term.app
               ...
               [(Init.Data.Sigma.Basic.«termΣ_,_»
                 ...
                 (Term.app `X [`n]))]))]
            ":="
            (Term.app `inductive_premetric [`I]))))
         "<;>"
         (Tactic.exact "exact" (Quot.Data.Quot.«term⟦_⟧» "⟦" (Term.app `Sigma.mk [`n `x]) "⟧")))
        [])])))
   [])
  []
  []
...
/-- Mapping each `X n` to the inductive limit. -/
  def
    to_inductive_limit
    ( I : ∀ n , Isometry f n ) ( n : ℕ ) ( x : X n ) : Metric.InductiveLimit I
    := by let this' : PseudoMetricSpace Σ n , X n := inductive_premetric I <;> exact ⟦ Sigma.mk n x ⟧
