...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `exists_subset_Union_ball_radius_lt [])
  (Command.declSig
   [(Term.implicitBinder "{" [`r] [":" (Term.arrow `ι "→" (Data.Real.Basic.termℝ "ℝ"))] "}")
        ...
        (Term.forall
         ...
         (Term.app
          ...
          [(Set.«term{_|_}»
            ...
            `i
            "|"
            (Init.Core.«term_∈_» `x " ∈ " (Term.app `ball [(Term.app `c [`i]) (Term.app `r [`i])]))
            "}")]))))]
     []
     ")")
    (Term.explicitBinder
     ...
     [":"
      (Init.Core.«term_⊆_»
       ...
       (Set.Data.Set.Lattice.«term⋃_,_»
        ...
        ", "
        (Term.app `ball [(Term.app `c [`i]) (Term.app `r [`i])])))]
     []
     ")")]
   (Term.typeSpec
    ":"
    («term∃_,_»
     ...
     (Lean.explicitBinders
      (Lean.unbracketedExplicitBinders [(Lean.binderIdent `r')] [":" (Term.arrow `ι "→" (Data.Real.Basic.termℝ "ℝ"))]))
     ","
     («term_∧_»
      (Init.Core.«term_⊆_»
       `s
       ...
       (Set.Data.Set.Lattice.«term⋃_,_»
        ...
        (Term.app `ball [(Term.app `c [`i]) (Term.app `r' [`i])])))
      "∧"
      (Term.forall "∀" [(Term.simpleBinder [`i] [])] "," («term_<_» (Term.app `r' [`i]) "<" (Term.app `r [`i])))))))
            ...
            [`hs
             (Term.fun
              ...
              (Term.basicFun
               ...
               "=>"
               (Term.app
                (Term.explicit "@" `is_open_ball)
                [(Term.hole "_") (Term.hole "_") (Term.app `c [`i]) (Term.app `r [`i])])))
             `uf
             `us]))]
         ["with"
          (Tactic.rcasesPat.tuple
           ...
           [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `v)]) [])
            ...
            ","
            (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `hcv)]) [])]
           "⟩")])
        [])
       (group
        (Tactic.tacticHave_
          ...
          (Term.haveIdDecl
           ...
           (Term.fun
            ...
            (Term.basicFun
             [(Term.simpleBinder [`i] [])]
             "=>"
             (Term.app `exists_lt_subset_ball [(Term.app `hvc [`i]) (Term.app `hcv [`i])]))))))
        [])
       (group (Tactic.choose "choose" [`r' `hlt `hsub] []) [])
       (group
        (Tactic.exact
         "exact"
         (Term.anonymousCtor
          "⟨"
          [`r' "," («term_$__» (Term.app `subset.trans [`hsv]) "$" («term_$__» `Union_subset_Union "$" `hsub)) "," `hlt]
          "⟩"))
        [])])))
   [])
  []
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_$__» (Term.app `subset.trans [`hsv]) "$" («term_$__» `Union_subset_Union "$" `hsub))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_$__» `Union_subset_Union "$" `hsub)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `hsub
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.choose "choose" [`r' `hlt `hsub] [])
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `hcv [`i]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `hvc [`i]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.basicFun.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.explicit "@" `is_open_ball) [(Term.hole "_") (Term.hole "_") (Term.app `c [`i]) (Term.app `r [`i])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_<_» (Term.app `r' [`i]) "<" (Term.app `r [`i]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_<_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `r [`i])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
/--
  ...
  theorem
    ...
    { r : ι → ℝ }
        ( hs : IsClosed s )
        ( uf : ∀ , ∀ x ∈ s , ∀ , finite { i | x ∈ ball c i r i } )
        ( us : s ⊆ ⋃ i , ball c i r i )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `exists_Union_ball_eq_radius_lt [])
  (Command.declSig
   [(Term.implicitBinder "{" [`r] [":" (Term.arrow `ι "→" (Data.Real.Basic.termℝ "ℝ"))] "}")
    (Term.explicitBinder
     "("
    ...
    (Term.letDecl
     (Term.letPatDecl
      ...
      (Term.app
       `exists_subset_Union_ball_radius_lt
       [`is_closed_univ
        (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`x (Term.hole "_")] [])] "=>" (Term.app `uf [`x])))
        `uU.ge])))
    []
    (Term.anonymousCtor "⟨" [`r' "," (Term.app (Term.proj `univ_subset_iff "." (fieldIdx "1")) [`hU]) "," `hv] "⟩"))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `exists_subset_Union_ball_radius_pos_lt [])
  (Command.declSig
   [(Term.implicitBinder "{" [`r] [":" (Term.arrow `ι "→" (Data.Real.Basic.termℝ "ℝ"))] "}")
    (Term.explicitBinder
     "("
     [`hr]
     [":" (Term.forall "∀" [(Term.simpleBinder [`i] [])] "," («term_<_» (numLit "0") "<" (Term.app `r [`i])))]
     []
     ")")
    (Term.explicitBinder "(" [`hs] [":" (Term.app `IsClosed [`s])] [] ")")
    (Term.explicitBinder
    ...
    («term∃_,_»
     ...
     («term_∧_»
      ...
      (Term.forall
       ...
       [(Term.simpleBinder [`i] [])]
       ","
       (Init.Core.«term_∈_» (Term.app `r' [`i]) " ∈ " (Term.app `Ioo [(numLit "0") (Term.app `r [`i])])))))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
          ...
          (Term.haveIdDecl
           ...
           (Term.fun
            ...
            (Term.basicFun
             [(Term.simpleBinder [`i] [])]
             "=>"
             (Term.app `exists_pos_lt_subset_ball [(Term.app `hr [`i]) (Term.app `hvc [`i]) (Term.app `hcv [`i])]))))))
        [])
       (group (Tactic.choose "choose" [`r' `hlt `hsub] []) [])
       (group
        (Tactic.exact
         ...
         (Term.anonymousCtor
          "⟨"
          [`r' "," («term_$__» (Term.app `subset.trans [`hsv]) "$" (Term.app `Union_subset_Union [`hsub])) "," `hlt]
          "⟩"))
        [])])))
   [])
  []
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_$__» (Term.app `subset.trans [`hsv]) "$" (Term.app `Union_subset_Union [`hsub]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Union_subset_Union [`hsub])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Core.«term_∈_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Ioo [(numLit "0") (Term.app `r [`i])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `exists_Union_ball_eq_radius_pos_lt [])
  (Command.declSig
   [(Term.implicitBinder "{" [`r] [":" (Term.arrow `ι "→" (Data.Real.Basic.termℝ "ℝ"))] "}")
    (Term.explicitBinder
     "("
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `exists_locally_finite_subset_Union_ball_radius_lt [])
  (Command.declSig
   [(Term.explicitBinder "(" [`hs] [":" (Term.app `IsClosed [`s])] [] ")")
    (Term.implicitBinder "{" [`R] [":" (Term.arrow `α "→" (Data.Real.Basic.termℝ "ℝ"))] "}")
    (Term.explicitBinder
     "("
     [`hR]
     [":"
    ...
    («term∃_,_»
     ...
     (Lean.explicitBinders
      [(Lean.bracketedExplicitBinders "(" [(Lean.binderIdent `ι)] ":" (Term.type "Type" [`u]) ")")
       (Lean.bracketedExplicitBinders "(" [(Lean.binderIdent `c)] ":" (Term.arrow `ι "→" `α) ")")
       (Lean.bracketedExplicitBinders
        "("
        [(Lean.binderIdent `r) (Lean.binderIdent `r')]
        ":"
     ...
     («term_∧_»
      (Term.forall
       ...
       ","
       («term_∧_»
        (Init.Core.«term_∈_» (Term.app `c [`i]) " ∈ " `s)
        "∧"
        («term_∧_»
         («term_<_» (numLit "0") "<" (Term.app `r [`i]))
         "∧"
         («term_∧_»
          («term_<_» (Term.app `r [`i]) "<" (Term.app `r' [`i]))
          "∧"
          («term_<_» (Term.app `r' [`i]) "<" (Term.app `R [(Term.app `c [`i])]))))))
      "∧"
      («term_∧_»
       (Term.app
        `LocallyFinite
              ...
              (Term.app
               ...
               [(Term.fun
                 ...
                 (Term.basicFun
                  ...
                  "=>"
                  («term_∧_» («term_<_» (numLit "0") "<" `r) "∧" («term_<_» `r "<" (Term.app `R [`x])))))
                (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`r] [])] "=>" (Term.app `ball [`x `r])))])))))])
        [])
       (group
        (Tactic.exact
         "exact"
         (Term.fun
          ...
          (Term.basicFun
           ...
           "=>"
           (Term.app `nhds_basis_uniformity [(Term.app `uniformity_basis_dist_lt [(Term.app `hR [`x `hx])])]))))
        [])
       (group
        (Tactic.rcases
         "rcases"
         [(Tactic.casesTarget [] (Term.app `refinement_of_locally_compact_sigma_compact_of_nhds_basis_set [`hs `this]))]
         ["with"
          (Tactic.rcasesPat.tuple
           "⟨"
           [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `ι)]) [])
            ...
            ","
            (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `hfin)]) [])]
           "⟩")])
        [])
       (group
        (Tactic.rcases
           ...
           (Term.app
            ...
            [(Term.fun
              ...
              (Term.basicFun
               [(Term.simpleBinder [`i] [])]
               "=>"
               (Term.proj (Term.proj (Term.app `hr' [`i]) "." (fieldIdx "2")) "." (fieldIdx "1"))))
             `hs
             (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`x `hx] [])] "=>" (Term.app `hfin.point_finite [`x])))
             `hsub']))]
         ["with"
          (Tactic.rcasesPat.tuple
           "⟨"
          ...
          [`ι
           ...
           (Term.fun
            ...
            (Term.basicFun
             ...
             (Term.anonymousCtor
              "⟨"
              [(Term.proj (Term.app `hr' [`i]) "." (fieldIdx "1"))
               ","
               (Term.proj (Term.app `hlt [`i]) "." (fieldIdx "1"))
               ","
               (Term.proj (Term.app `hlt [`i]) "." (fieldIdx "2"))
               ","
               (Term.proj (Term.proj (Term.app `hr' [`i]) "." (fieldIdx "2")) "." (fieldIdx "2"))]
              "⟩")))
           ","
           `hfin
           ","
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.proj (Term.app `hr' [`i]) "." (fieldIdx "2"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `hr' [`i])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `hlt [`i]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Term.app `hlt [`i]) "." (fieldIdx "1"))
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(Term.fun
   ...
   (Term.basicFun
    [(Term.simpleBinder [`i] [])]
    "=>"
    (Term.proj (Term.proj (Term.paren "(" [(Term.app `hr' [`i]) []] ")") "." (fieldIdx "2")) "." (fieldIdx "1"))))
  []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `exists_subset_Union_ball_radius_pos_lt
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.casesTarget', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `refinement_of_locally_compact_sigma_compact_of_nhds_basis_set [`hs `this])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `uniformity_basis_dist_lt [(Term.app `hR [`x `hx])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `uniformity_basis_dist_lt [(Term.paren "(" [(Term.app `hR [`x `hx]) []] ")")]) []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
   ...
   («term_∧_»
    ...
    («term_∧_»
     (Term.app
      ...
      [(Term.fun
        "fun"
        (Term.basicFun [(Term.simpleBinder [`i] [])] "=>" (Term.app `ball [(Term.app `c [`i]) (Term.app `r' [`i])])))])
     "∧"
     (Init.Core.«term_⊆_»
      `s
      " ⊆ "
...
/--
  ...
  theorem
    ...
    ( hs : IsClosed s ) { R : α → ℝ } ( hR : ∀ , ∀ x ∈ s , ∀ , 0 < R x )
      :
        ∃
    ...
    :=
      by
        have : ∀ , ∀ x ∈ s , ∀ , 𝓝 x . HasBasis fun r : ℝ => 0 < r ∧ r < R x fun r => ball x r
          exact fun x hx => nhds_basis_uniformity uniformity_basis_dist_lt hR x hx
          rcases
            refinement_of_locally_compact_sigma_compact_of_nhds_basis_set hs this
            with ⟨ ι , c , r' , hr' , hsub' , hfin ⟩
          rcases
            exists_subset_Union_ball_radius_pos_lt fun i => hr' i . 2 . 1 hs fun x hx => hfin.point_finite x hsub'
            with ⟨ r , hsub , hlt ⟩
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `exists_locally_finite_Union_eq_ball_radius_lt [])
  (Command.declSig
   [(Term.implicitBinder "{" [`R] [":" (Term.arrow `α "→" (Data.Real.Basic.termℝ "ℝ"))] "}")
    (Term.explicitBinder
     "("
     [`hR]
     [":" (Term.forall "∀" [(Term.simpleBinder [`x] [])] "," («term_<_» (numLit "0") "<" (Term.app `R [`x])))]
     []
     ")")]
   (Term.typeSpec
    ":"
  ...
  (Command.declValSimple
   ...
   (Term.let
    ...
    (Term.letDecl
     (Term.letPatDecl
      (Term.anonymousCtor "⟨" [`ι "," `c "," `r "," `r' "," `hlt "," `hfin "," `hsub] "⟩")
      []
      []
      ":="
      (Term.app
       `exists_locally_finite_subset_Union_ball_radius_lt
       [`is_closed_univ
        (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`x (Term.hole "_")] [])] "=>" (Term.app `hR [`x])))])))
    []
    (Term.anonymousCtor
     "⟨"
     [`ι
      ...
      (Term.fun
       "fun"
       (Term.basicFun [(Term.simpleBinder [`i] [])] "=>" (Term.proj (Term.app `hlt [`i]) "." (fieldIdx "2"))))
      ","
      `hfin
      ","
      (Term.app (Term.proj `univ_subset_iff "." (fieldIdx "1")) [`hsub])]
     "⟩"))
   [])
  []
  []))
    ...
    { R : α → ℝ } ( hR : ∀ x , 0 < R x )
      :
        ∃
          ( ι : Type u ) ( c : ι → α ) ( r r' : ι → ℝ )
          ,
          ∀ i , 0 < r i ∧ r i < r' i ∧ r' i < R c i ∧ LocallyFinite fun i => ball c i r' i ∧ ⋃ i , ball c i r i = univ
    :=
      let
        ⟨ ι , c , r , r' , hlt , hfin , hsub ⟩
          :=
