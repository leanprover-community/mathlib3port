...
/-- The minimal edistance of a point to a set -/
  def inf_edist ( x : α ) ( s : Set α ) : ℝ≥0∞ := ⨅ ( y : _ ) ( _ : y ∈ s ) , edist x y
  ...
  (Command.declSig
   ...
   (Term.typeSpec
    ...
    («term_≤_»
     ...
     "≤"
     (Init.Logic.«term_+_» (Term.app `inf_edist [`y `s]) "+" (Term.app `edist [`x `y])))))
  (Command.declValSimple
   ":="
   (calc
    "calc"
       ...
       (Order.CompleteLattice.«term⨅_,_»
        ...
        (Lean.explicitBinders
         [(Lean.bracketedExplicitBinders "(" [(Lean.binderIdent `z)] ":" (Term.hole "_") ")")
          (Lean.bracketedExplicitBinders "(" [(Lean.binderIdent "_")] ":" (Init.Core.«term_∈_» `z " ∈ " `s) ")")])
        ", "
        (Init.Logic.«term_+_» (Term.app `edist [`y `z]) "+" (Term.app `edist [`x `y]))))
      ":="
      («term_$__»
       `binfi_le_binfi
       "$"
...
/--
  ...
  theorem
    ...
    : inf_edist x s ≤ inf_edist y s + edist x y
    :=
      calc
        ⨅ ( z : _ ) ( _ : z ∈ s ) , edist x z ≤ ⨅ ( z : _ ) ( _ : z ∈ s ) , edist y z + edist x y
            :=
            binfi_le_binfi $ fun z hz => edist_triangle _ _ _ . trans_eq add_commₓ _ _
          _ = ⨅ ( z : _ ) ( _ : z ∈ s ) , edist y z + edist x y := by simp only [ Ennreal.infi_add ]
  ...
  (Command.declSig
   ...
   (Term.typeSpec
    ...
    («term∃_,_»
     "∃"
     (Lean.explicitBinders
      (Lean.unbracketedExplicitBinders [(Lean.binderIdent `F)] [":" (Term.arrow (termℕ "ℕ") "→" (Term.app `Set [`α]))]))
     ","
     («term_∧_»
      (Term.forall "∀" [(Term.simpleBinder [`n] [])] "," (Term.app `IsClosed [(Term.app `F [`n])]))
      "∧"
      («term_∧_»
       (Term.forall "∀" [(Term.simpleBinder [`n] [])] "," (Init.Core.«term_⊆_» (Term.app `F [`n]) " ⊆ " `U))
       "∧"
       («term_∧_»
        («term_=_»
        ...
        (Tactic.obtain
         ...
         [":"
          («term∃_,_»
           "∃"
           (Lean.explicitBinders
            (Lean.unbracketedExplicitBinders [(Lean.binderIdent `a)] [":" (Data.Real.Ennreal.«termℝ≥0∞» "ℝ≥0∞")]))
           ","
           («term_∧_» («term_<_» (numLit "0") "<" `a) "∧" («term_<_» `a "<" (numLit "1"))))]
             ...
             (Set.Data.Set.Basic.«term_⁻¹'_»
              (Term.fun
               ...
               (Term.basicFun
                [(Term.simpleBinder [`x] [])]
                "=>"
                (Term.app `inf_edist [`x (Order.BooleanAlgebra.«term_ᶜ» `U "ᶜ")])))
              " ⁻¹' "
              (Term.app `Ici [(«term_^_» `a "^" `n)])))))))
        [])
       (group
        (Tactic.tacticHave_
         "have"
                ...
                (Tactic.tacticHave_
                 ...
                 (Term.haveDecl
                  (Term.haveIdDecl
                   ...
                   [(Term.typeSpec
                     ":"
                     («term_<_» (numLit "0") "<" (Term.app `inf_edist [`x (Order.BooleanAlgebra.«term_ᶜ» `U "ᶜ")])))]
                   ":="
                   (Term.app `lt_of_lt_of_leₓ [(Term.app `Ennreal.pow_pos [`a_pos (Term.hole "_")]) `hx]))))
                [])
               (group
                (Tactic.rwSeq
                 "rw"
                ...
                [])
               (group (Tactic.exact "exact" (Term.app `lt_irreflₓ [(Term.hole "_") `this])) [])]))))))
        [])
       (group
        (Tactic.refine'
         "refine'"
          ...
          (Tactic.tacticSeq1Indented
           [(group (Tactic.intro "intro" [`m `n `hmn `x `hx]) [])
            ...
            (group
             (Tactic.apply
              "apply"
              (Term.app `le_transₓ [(Term.app `Ennreal.pow_le_pow_of_le_one [`a_lt_one.le `hmn]) `hx]))
             [])])))
        [])
       (group
        (Tactic.tacticShow_
           ...
           [(group
             ...
             (Tactic.tacticHave_
              ...
              (Term.haveDecl
               (Term.haveIdDecl
                ...
                [(Term.typeSpec
                  ":"
                  («term¬_» "¬" (Init.Core.«term_∈_» `x " ∈ " (Order.BooleanAlgebra.«term_ᶜ» `U "ᶜ"))))]
                ":="
                (Term.byTactic
                 "by"
                 (Tactic.tacticSeq
              ...
              (Term.haveDecl
               (Term.haveIdDecl
                ...
                [(Term.typeSpec
                  ...
                  (Term.app
                   `Filter.Tendsto
                   [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`n] [])] "=>" («term_^_» `a "^" `n)))
                    `at_top
            ...
            (group
             (Tactic.simp
              ...
              [])
             [])
            (group (Tactic.exact "exact" (Term.anonymousCtor "⟨" [`n "," `hn.le] "⟩")) [])])))
        [])])))
   [])
  []
  []))
      ...
      (group
       (Tactic.tacticHave_
        ...
        (Term.haveDecl
         (Term.haveIdDecl
          []
          [(Term.typeSpec ":" («term¬_» "¬" (Init.Core.«term_∈_» `x " ∈ " (Order.BooleanAlgebra.«term_ᶜ» `U "ᶜ"))))]
          ":="
          (Term.byTactic
           "by"
           (Tactic.tacticSeq
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.anonymousCtor "⟨" [`n "," `hn.le] "⟩"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.anonymousCtor "⟨" [`n "," `hn.le] "⟩")
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Init.Core.«term_∈_» `x " ∈ " (Order.BooleanAlgebra.«term_ᶜ» `U "ᶜ"))
  ...
  :=
    by
      obtain ⟨ a , a_pos , a_lt_one ⟩ : ∃ a : ℝ≥0∞ , 0 < a ∧ a < 1 := exists_between Ennreal.zero_lt_one
        let F := fun n : ℕ => fun x => inf_edist x U ᶜ ⁻¹' Ici a ^ n
        have
          F_subset
            : ∀ n , F n ⊆ U
            :=
            by
              intro n x hx
                ...
                have : 0 < inf_edist x U ᶜ := lt_of_lt_of_leₓ Ennreal.pow_pos a_pos _ hx
                rw [ h ] at this
        ...
        ·
          refine' subset.antisymm by simp only [ Union_subset_iff , F_subset , forall_const ] fun x hx => _
            have : ¬ x ∈ U ᶜ := by simpa using hx
            rw [ mem_iff_inf_edist_zero_of_closed IsOpen.is_closed_compl hU ] at this
            have B : 0 < inf_edist x U ᶜ := by simpa [ pos_iff_ne_zero ] using this
...
/--
  ...
  irreducible_def
  Hausdorff_edist
  { α : Type u } [ PseudoEmetricSpace α ] ( s t : Set α ) : ℝ≥0∞
...
theorem
  Hausdorff_edist_def
  { α : Type u } [ PseudoEmetricSpace α ] ( s t : Set α )
...
theorem Hausdorff_edist_zero_iff_closure_eq_closure : Hausdorff_edist s t = 0 ↔ Closure s = Closure t :=
  calc Hausdorff_edist s t = 0 ↔ s ⊆ Closure t ∧ t ⊆ Closure s := by
    ...
    ⟨fun h => subset.antisymm (closure_minimal h.1 is_closed_closure) (closure_minimal h.2 is_closed_closure), fun h =>
...
theorem Hausdorff_edist_closure₁ : Hausdorff_edist (Closure s) t = Hausdorff_edist s t := by
  ...
  ·
    calc _ ≤ Hausdorff_edist (Closure s) s+Hausdorff_edist s t := Hausdorff_edist_triangle _ = Hausdorff_edist s t := by
...
theorem disjoint_closed_ball_of_lt_inf_dist {r : ℝ} (h : r < inf_dist x s) : Disjoint (closed_ball x r) s := by
  rw [disjoint_left]
  intro y hy h'y
  apply lt_irreflₓ (inf_dist x s)
  calc inf_dist x s ≤ dist x y := inf_dist_le_dist_of_mem h'y _ ≤ r := by
...
-- ././Mathport/Syntax/Translate/Basic.lean:477:2: warning: expanding binder collection (x «expr ∈ » E)
/- failed to parenthesize: parenthesize: uncaught backtrack exception
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment
 ...
 (Command.theorem
  ...
  (Command.declSig
   [(Term.implicitBinder "{" [`δ] [":" (Data.Real.Basic.termℝ "ℝ")] "}")
    (Term.implicitBinder "{" [`E] [":" (Term.app `Set [`X])] "}")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app `thickening [`δ `E])
     "="
     (Set.Data.Set.Lattice.«term⋃_,_»
      "⋃"
      (Lean.explicitBinders
       [(Lean.bracketedExplicitBinders "(" [(Lean.binderIdent `x)] ":" (Term.hole "_") ")")
        (Lean.bracketedExplicitBinders "(" [(Lean.binderIdent "_")] ":" (Init.Core.«term_∈_» `x " ∈ " `E) ")")])
      ", "
      (Term.app `ball [`x `δ])))))
  (Command.declValSimple
   ":="
...
/--
  ...
  theorem
    ...
    { δ : ℝ } { E : Set X } : thickening δ E = ⋃ ( x : _ ) ( _ : x ∈ E ) , ball x δ
...
-- ././Mathport/Syntax/Translate/Basic.lean:477:2: warning: expanding binder collection (ε «expr ∈ » s)
/- failed to parenthesize: parenthesize: uncaught backtrack exception
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers [] [] [] [] [] [])
 (Command.theorem
  ...
  (Command.declSig
   [(Term.implicitBinder "{" [`δ] [":" (Data.Real.Basic.termℝ "ℝ")] "}")
    ...
    (Term.explicitBinder "(" [`hsδ] [":" (Init.Core.«term_⊆_» `s " ⊆ " (Term.app `Ioi [`δ]))] [] ")")
    (Term.explicitBinder
     "("
     [`hs]
     [":"
      (Term.forall
       ...
       (Term.arrow
        («term_<_» `δ "<" `ε)
        "→"
        (Term.proj (Init.Core.«term_∩_» `s " ∩ " (Term.app `Ioc [`δ `ε])) "." `Nonempty)))]
     []
     ")")
    (Term.explicitBinder "(" [`E] [":" (Term.app `Set [`α])] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app `cthickening [`δ `E])
     "="
     (Set.Data.Set.Lattice.«term⋂_,_»
      "⋂"
      (Lean.explicitBinders
       [(Lean.bracketedExplicitBinders "(" [(Lean.binderIdent `ε)] ":" (Term.hole "_") ")")
        (Lean.bracketedExplicitBinders "(" [(Lean.binderIdent "_")] ":" (Init.Core.«term_∈_» `ε " ∈ " `s) ")")])
      ", "
      (Term.app `cthickening [`ε `E])))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
             ...
             (Tactic.exact
              ...
              (Term.app
               ...
               [(Term.fun
                 "fun"
                 (Term.basicFun
                  [(Term.simpleBinder [(Term.hole "_") `hε] [])]
                  "=>"
                  (Term.app `cthickening_mono [(Term.app `le_of_ltₓ [(Term.app `hsδ [`hε])]) `E])))]))
             [])])))
        [])
       (group
        (Tactic.«tactic·._»
         ...
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group (Tactic.unfold "unfold" [] [`thickening `cthickening] []) [])
            ...
            (group (Tactic.intro "intro" [`η `η_pos (Term.hole "_")]) [])
            (group
             (Tactic.rcases
              "rcases"
              [(Tactic.casesTarget
                ...
                (Term.app
                 `hs
                 [(Init.Logic.«term_+_» `δ "+" `η)
                  (Term.app `lt_add_of_pos_right [(Term.hole "_") (Term.app `nnreal.coe_pos.mpr [`η_pos])])]))]
              ["with"
               (Tactic.rcasesPat.tuple
                "⟨"
                [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `ε)]) [])
                 ...
                 (Tactic.rcasesPatLo
                  (Tactic.rcasesPatMed
                   [(Tactic.rcasesPat.tuple
                     "⟨"
                     [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `hsε)]) [])
                      ","
            ...
            (group
             (Tactic.apply
              ...
              (Term.proj
               (Term.app
                (Term.proj (Term.app `hx [`ε `hsε]) "." `trans)
                [(Term.app `Ennreal.of_real_le_of_real [(Term.proj `hε "." (fieldIdx "2"))])])
               "."
               `trans))
             [])
            (group
             (Tactic.rwSeq
              "rw"
              []
              (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] (Term.app `Ennreal.coe_nnreal_eq [`η]))] "]")
              [])
             [])
    ...
    (Tactic.tacticSeq1Indented
     [(group (Tactic.unfold "unfold" [] [`thickening `cthickening] []) [])
      ...
      (group
       ...
       [])
      (group
       (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] (Term.app `Ennreal.coe_nnreal_eq [`η]))] "]") [])
       [])
      (group (Tactic.exact "exact" `Ennreal.of_real_add_le) [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.«tactic·._»', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq', expected 'Lean.Parser.Tactic.tacticSeq.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Ennreal.coe_nnreal_eq [`η])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `hx [`ε `hsε]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app
   (Term.proj (Term.paren "(" [(Term.app `hx [`ε `hsε]) []] ")") "." `trans)
   [(Term.paren "(" [(Term.app `Ennreal.of_real_le_of_real [(Term.proj `hε "." (fieldIdx "2"))]) []] ")")])
  []]
 ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `nnreal.coe_pos.mpr [`η_pos])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `nnreal.coe_pos.mpr [`η_pos]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `lt_add_of_pos_right [(Term.hole "_") (Term.paren "(" [(Term.app `nnreal.coe_pos.mpr [`η_pos]) []] ")")])
  []]
 ")")
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Init.Logic.«term_+_» `δ "+" `η) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `hs
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.intro "intro" [`η `η_pos (Term.hole "_")])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `le_of_ltₓ [(Term.app `hsδ [`hε])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `hsδ [`hε]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `le_of_ltₓ
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `le_of_ltₓ [(Term.paren "(" [(Term.app `hsδ [`hε]) []] ")")]) []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `cthickening_mono
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
theorem
  ...
  { δ : ℝ } ( s : Set ℝ ) ( hsδ : s ⊆ Ioi δ ) ( hs : ∀ ε , δ < ε → s ∩ Ioc δ ε . Nonempty ) ( E : Set α )
    : cthickening δ E = ⋂ ( ε : _ ) ( _ : ε ∈ s ) , cthickening ε E
  :=
    by
      apply le_antisymmₓ
     ...
     (Set.Data.Set.Lattice.«term⋂_,_»
      ...
      (Lean.explicitBinders
       [(Lean.bracketedExplicitBinders "(" [(Lean.binderIdent `ε)] ":" (Data.Real.Basic.termℝ "ℝ") ")")
        (Lean.bracketedExplicitBinders "(" [(Lean.binderIdent `h)] ":" («term_<_» `δ "<" `ε) ")")])
      ", "
      (Term.app `cthickening [`ε `E])))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    ...
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.apply "apply" (Term.app `cthickening_eq_Inter_cthickening' [(Term.app `Ioi [`δ]) `rfl.subset]))
        [])
       (group
        (Tactic.simpRw
         "simp_rw"
       ...
       (group
        (Tactic.exact
         ...
         (Term.fun
          "fun"
          (Term.basicFun [(Term.simpleBinder [(Term.hole "_") `hε] [])] "=>" (Term.app `nonempty_Ioc.mpr [`hε]))))
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.byTactic
   ...
   (Tactic.tacticSeq
    (Tactic.tacticSeq1Indented
     [(group (Tactic.apply "apply" (Term.app `cthickening_eq_Inter_cthickening' [(Term.app `Ioi [`δ]) `rfl.subset])) [])
      (group
       (Tactic.simpRw
        "simp_rw"
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.apply', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `cthickening_eq_Inter_cthickening' [(Term.app `Ioi [`δ]) `rfl.subset])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Ioi [`δ]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `cthickening_eq_Inter_cthickening'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
theorem
  cthickening_eq_Inter_cthickening
  { δ : ℝ } ( E : Set α ) : cthickening δ E = ⋂ ( ε : ℝ ) ( h : δ < ε ) , cthickening ε E
  :=
    by
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  ...
  (Command.declSig
   [(Term.implicitBinder "{" [`δ] [":" (Data.Real.Basic.termℝ "ℝ")] "}")
    (Term.explicitBinder "(" [`δ_nn] [":" («term_≤_» (numLit "0") "≤" `δ)] [] ")")
    (Term.explicitBinder "(" [`s] [":" (Term.app `Set [(Data.Real.Basic.termℝ "ℝ")])] [] ")")
    (Term.explicitBinder "(" [`hsδ] [":" (Init.Core.«term_⊆_» `s " ⊆ " (Term.app `Ioi [`δ]))] [] ")")
    (Term.explicitBinder
     "("
          ...
          (Tactic.tacticSeq1Indented
           [(group (Tactic.apply "apply" `subset_bInter) [])
            ...
            (group
             (Tactic.rcases
              "rcases"
              [(Tactic.casesTarget [] (Term.app `hs [`ε (Term.app `mem_Ioi.mp [(Term.app `hsδ [`hε])])]))]
              ["with"
               (Tactic.rcasesPat.tuple
                "⟨"
                [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `ε')]) [])
              ...
              (Term.haveDecl
               (Term.haveIdDecl
                ...
                (Term.app
                 ...
                 [(Term.app `lt_of_le_of_ltₓ [`δ_nn (Term.proj `hε' "." (fieldIdx "1"))])
                  (Term.proj `hε' "." (fieldIdx "1"))
                  `E]))))
             [])
            (group
             (Tactic.exact
              "exact"
              (Term.app `ss.trans [(Term.app `thickening_mono [(Term.proj `hε' "." (fieldIdx "2")) `E])]))
             [])])))
        [])
       (group
        (Tactic.«tactic·._»
          ...
          (Tactic.tacticSeq1Indented
           [(group
             (Tactic.rwSeq
              ...
              (Tactic.rwRuleSeq
               "["
               [(Tactic.rwRule [] (Term.app `cthickening_eq_Inter_cthickening' [`s `hsδ `hs `E]))]
               "]")
              [])
             [])
             ...
             (Tactic.exact
              ...
              (Term.fun
               ...
               (Term.basicFun
                ...
                "=>"
                (Term.app `thickening_subset_cthickening [`ε `E]))))
             [])])))
        [])])))
   [])
  []
          ...
          [(group
           ...
           (group
            (Tactic.exact
             ...
             (Term.fun
              "fun"
              (Term.basicFun [(Term.simpleBinder [`ε `hε] [])] "=>" (Term.app `thickening_subset_cthickening [`ε `E]))))
            [])])))
       [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.byTactic', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.byTactic', expected 'Lean.Parser.Term.byTactic.antiquot'
    ...
    (Tactic.tacticSeq1Indented
     [(group
       (Tactic.rwSeq
        "rw"
        []
        (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] (Term.app `cthickening_eq_Inter_cthickening' [`s `hsδ `hs `E]))] "]")
        [])
       [])
      (group (Tactic.apply "apply" `bInter_mono) [])
      (group
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `cthickening_eq_Inter_cthickening' [`s `hsδ `hs `E])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `ss.trans [(Term.app `thickening_mono [(Term.proj `hε' "." (fieldIdx "2")) `E])]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `ss.trans [(Term.app `thickening_mono [(Term.proj `hε' "." (fieldIdx "2")) `E])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `thickening_mono [(Term.proj `hε' "." (fieldIdx "2")) `E])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app
   `cthickening_subset_thickening'
   [(Term.app `lt_of_le_of_ltₓ [`δ_nn (Term.proj `hε' "." (fieldIdx "1"))]) (Term.proj `hε' "." (fieldIdx "1")) `E])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.casesTarget', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `hs [`ε (Term.app `mem_Ioi.mp [(Term.app `hsδ [`hε])])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `mem_Ioi.mp [(Term.app `hsδ [`hε])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `mem_Ioi.mp [(Term.paren "(" [(Term.app `hsδ [`hε]) []] ")")]) []]
 ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
theorem
  ...
  { δ : ℝ }
      ...
      ( s : Set ℝ )
      ( hsδ : s ⊆ Ioi δ )
      ( hs : ∀ ε , δ < ε → s ∩ Ioc δ ε . Nonempty )
      ( E : Set α )
    : cthickening δ E = ⋂ ( ε : _ ) ( _ : ε ∈ s ) , thickening ε E
  :=
    by
      apply le_antisymmₓ
        ·
  ...
  (Command.declValSimple
   ...
   (Term.byTactic
    ...
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.apply "apply" (Term.app `cthickening_eq_Inter_thickening' [`δ_nn (Term.app `Ioi [`δ]) `rfl.subset]))
        [])
       (group
        (Tactic.simpRw
         "simp_rw"
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.apply', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `cthickening_eq_Inter_thickening' [`δ_nn (Term.app `Ioi [`δ]) `rfl.subset])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
theorem
  cthickening_eq_Inter_thickening
  { δ : ℝ } ( δ_nn : 0 ≤ δ ) ( E : Set α ) : cthickening δ E = ⋂ ( ε : ℝ ) ( h : δ < ε ) , thickening ε E
  :=
    by
...
-- ././Mathport/Syntax/Translate/Basic.lean:477:2: warning: expanding binder collection (δ «expr ∈ » s)
/- failed to parenthesize: parenthesize: uncaught backtrack exception
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment
     ...
     [":"
      (Term.forall
       ...
       (Term.arrow
        («term_<_» (numLit "0") "<" `ε)
        "→"
        (Term.proj (Init.Core.«term_∩_» `s " ∩ " (Term.app `Ioc [(numLit "0") `ε])) "." `Nonempty)))]
     []
     ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     ...
     (Set.Data.Set.Lattice.«term⋂_,_»
      "⋂"
      (Lean.explicitBinders
       [(Lean.bracketedExplicitBinders "(" [(Lean.binderIdent `δ)] ":" (Term.hole "_") ")")
        (Lean.bracketedExplicitBinders "(" [(Lean.binderIdent "_")] ":" (Init.Core.«term_∈_» `δ " ∈ " `s) ")")])
      ", "
      (Term.app `cthickening [`δ `E])))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    ...
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group (Tactic.byCases' "by_cases'" [`hs₀ ":"] (Init.Core.«term_⊆_» `s " ⊆ " (Term.app `Ioi [(numLit "0")]))) [])
       (group
        (Tactic.«tactic·._»
         "·"
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `cthickening_zero)] "]") []) [])
            (group
             (Tactic.apply "apply" (Term.app `cthickening_eq_Inter_cthickening' [(Term.hole "_") `hs₀ `hs]))
             [])])))
        [])
       (group
        (Tactic.rcases
         "rcases"
         [(Tactic.casesTarget [] (Term.app `not_subset.mp [`hs₀]))]
         ["with"
          (Tactic.rcasesPat.tuple
           "⟨"
           [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `δ)]) [])
            ...
            (Tactic.rcasesPatLo
             (Tactic.rcasesPatMed
              [(Tactic.rcasesPat.tuple
                "⟨"
                [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `hδs)]) [])
                 ","
                 (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `δ_nonpos)]) [])]
                "⟩")])
             [])]
           "⟩")])
        [])
       (group (Tactic.simp "simp" [] [] [] [(Tactic.location "at" (Tactic.locationHyp [`δ_nonpos] []))]) [])
       (group (Tactic.apply "apply" `le_antisymmₓ) [])
       (group
        (Tactic.«tactic·._»
         "·"
             ...
             (Tactic.exact
              ...
              (Term.app
               ...
               [(Term.fun
                 "fun"
                 (Term.basicFun
                  [(Term.simpleBinder [`ε (Term.hole "_")] [])]
                  "=>"
                  (Term.app `closure_subset_cthickening [`ε `E])))]))
             [])])))
        [])
       (group
        (Tactic.«tactic·._»
          ...
          (Tactic.tacticSeq1Indented
           [(group
             (Tactic.rwSeq
              "rw"
              []
              (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] (Term.app `cthickening_of_nonpos [`δ_nonpos `E]))] "]")
              [])
             [])
            (group (Tactic.exact "exact" (Term.app `bInter_subset_of_mem [`hδs])) [])])))
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `bInter_subset_of_mem [`hδs]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `bInter_subset_of_mem [`hδs])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `cthickening_of_nonpos [`δ_nonpos `E])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.fun
   "fun"
   (Term.basicFun [(Term.simpleBinder [`ε (Term.hole "_")] [])] "=>" (Term.app `closure_subset_cthickening [`ε `E])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.fun.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.basicFun.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.simp "simp" [] [] [] [(Tactic.location "at" (Tactic.locationHyp [`δ_nonpos] []))])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simp', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.location', expected 'optional.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.locationHyp', expected 'Lean.Parser.Tactic.locationWildcard'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.«tactic·._»
   ...
   (Tactic.tacticSeq
    (Tactic.tacticSeq1Indented
     [(group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `cthickening_zero)] "]") []) [])
      (group (Tactic.apply "apply" (Term.app `cthickening_eq_Inter_cthickening' [(Term.hole "_") `hs₀ `hs])) [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.«tactic·._»', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq', expected 'Lean.Parser.Tactic.tacticSeq.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq1Indented', expected 'Lean.Parser.Tactic.tacticSeqBracketed.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq1Indented', expected 'Lean.Parser.Tactic.tacticSeqBracketed'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.apply', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `cthickening_eq_Inter_cthickening' [(Term.hole "_") `hs₀ `hs])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `cthickening_zero)] "]") [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `cthickening_zero
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.byCases' "by_cases'" [`hs₀ ":"] (Init.Core.«term_⊆_» `s " ⊆ " (Term.app `Ioi [(numLit "0")])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.byCases'', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Init.Core.«term_⊆_» `s " ⊆ " (Term.app `Ioi [(numLit "0")]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Core.«term_⊆_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
/--
  ...
  theorem
    ...
    ( E : Set α ) ( s : Set ℝ ) ( hs : ∀ ε , 0 < ε → s ∩ Ioc 0 ε . Nonempty )
      : Closure E = ⋂ ( δ : _ ) ( _ : δ ∈ s ) , cthickening δ E
    :=
      by
        by_cases' hs₀ : s ⊆ Ioi 0
          ...
          · rw [ ← cthickening_of_nonpos δ_nonpos E ] exact bInter_subset_of_mem hδs
   ...
   (Term.typeSpec
    ...
    («term_=_»
     ...
     (Set.Data.Set.Lattice.«term⋂_,_»
      "⋂"
      (Lean.explicitBinders
       [(Lean.bracketedExplicitBinders "(" [(Lean.binderIdent `δ)] ":" (Data.Real.Basic.termℝ "ℝ") ")")
        (Lean.bracketedExplicitBinders "(" [(Lean.binderIdent `h)] ":" («term_<_» (numLit "0") "<" `δ) ")")])
      ", "
      (Term.app `cthickening [`δ `E])))))
  (Command.declValSimple
   ":="
...
/-- The closure of a set equals the intersection of its closed thickenings of positive radii. -/
  theorem
    closure_eq_Inter_cthickening
    ( E : Set α ) : Closure E = ⋂ ( δ : ℝ ) ( h : 0 < δ ) , cthickening δ E
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  ...
  (Command.declSig
   [(Term.explicitBinder "(" [`E] [":" (Term.app `Set [`α])] [] ")")
    (Term.explicitBinder "(" [`s] [":" (Term.app `Set [(Data.Real.Basic.termℝ "ℝ")])] [] ")")
    (Term.explicitBinder "(" [`hs₀] [":" (Init.Core.«term_⊆_» `s " ⊆ " (Term.app `Ioi [(numLit "0")]))] [] ")")
    (Term.explicitBinder
     "("
     [`hs]
     [":"
   ...
   (Term.byTactic
    ...
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `cthickening_zero)] "]") []) [])
       (group
        (Tactic.apply "apply" (Term.app `cthickening_eq_Inter_thickening' [`rfl.ge (Term.hole "_") `hs₀ `hs]))
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.apply', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `cthickening_eq_Inter_thickening' [`rfl.ge (Term.hole "_") `hs₀ `hs])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
/--
  ...
  theorem
    ...
    ( E : Set α ) ( s : Set ℝ ) ( hs₀ : s ⊆ Ioi 0 ) ( hs : ∀ ε , 0 < ε → s ∩ Ioc 0 ε . Nonempty )
      : Closure E = ⋂ ( δ : _ ) ( _ : δ ∈ s ) , thickening δ E
...
/-- The closure of a set equals the intersection of its (open) thickenings of positive radii. -/
  theorem
    closure_eq_Inter_thickening
    ( E : Set α ) : Closure E = ⋂ ( δ : ℝ ) ( h : 0 < δ ) , thickening δ E
