...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `continuous_iff_coinduced_le [])
      (Command.declSig
       [(Term.implicitBinder
         "{"
         [`t₁]
         [":" (Term.app (Topology.Order.termtspace "tspace") [`α])]
         "}")
        (Term.implicitBinder
         "{"
         [`t₂]
         [":" (Term.app (Topology.Order.termtspace "tspace") [`β])]
         "}")]
       (Term.typeSpec
        ":"
        («term_↔_»
         (Term.app (Topology.Order.termcont "cont") [`t₁ `t₂ `f])
         "↔"
         («term_≤_» (Term.app `coinduced [`f `t₁]) "≤" `t₂))))
      (Command.declValSimple ":=" (Term.app (Term.proj `continuous_def "." `trans) [`Iff.rfl]) [])
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.abbrev'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.def'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app (Term.proj `continuous_def "." `trans) [`Iff.rfl])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      (Term.proj `continuous_def "." `trans)
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none,
     [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      (Topology.Order.termcont "cont")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Topology.Order.termcont', expected 'Topology.Order.termcont._@.Topology.Order._hyg.14'
...
theorem
  ...
  { t₁ : tspace α } { t₂ : tspace β } : cont t₁ t₂ f ↔ coinduced f t₁ ≤ t₂
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `continuous_iff_le_induced [])
      (Command.declSig
       [(Term.implicitBinder
         "{"
         [`t₁]
       ...
       (Term.typeSpec
        ...
        («term_↔_»
         (Term.app (Topology.Order.termcont "cont") [`t₁ `t₂ `f])
         "↔"
         («term_≤_» `t₁ "≤" (Term.app `induced [`f `t₂])))))
      (Command.declValSimple
       ":="
       (Term.app
        `Iff.trans
        [`continuous_iff_coinduced_le
         (Term.app `gc_coinduced_induced [`f (Term.hole "_") (Term.hole "_")])])
       [])
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.abbrev'
...
theorem
  ...
  { t₁ : tspace α } { t₂ : tspace β } : cont t₁ t₂ f ↔ t₁ ≤ induced f t₂
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `continuous_generated_from [])
      (Command.declSig
       [(Term.implicitBinder
         "{"
         [`t]
         [":" (Term.app (Topology.Order.termtspace "tspace") [`α])]
         "}")
        (Term.implicitBinder "{" [`b] [":" (Term.app `Set [(Term.app `Set [`β])])] "}")
        (Term.explicitBinder
         "("
         [`h]
         [":"
          (Std.ExtendedBinder.«term∀__,_»
           ...
           («binderTerm∈_» "∈" `b)
           ","
           (Term.app `IsOpen [(Set.Data.Set.Image.«term_⁻¹'_» `f " ⁻¹' " `s)]))]
         []
         ")")]
       (Term.typeSpec
        ":"
        (Term.app (Topology.Order.termcont "cont") [`t (Term.app `generateFrom [`b]) `f])))
      (Command.declValSimple
       ":="
       («term_<|_»
        (Term.proj `continuous_iff_coinduced_le "." (fieldIdx "2"))
        "<|"
        (Term.app `le_generate_from [`h]))
       [])
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.abbrev'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023,
     term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" (Term.app `generateFrom [`b]) ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      `t
...
theorem
  ...
  { t : tspace α } { b : Set Set β } ( h : ∀ s ∈ b , IsOpen f ⁻¹' s ) : cont t generateFrom b f
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `continuous_induced_dom [])
      (Command.declSig
       [(Term.implicitBinder
         "{"
         [`t]
       ...
       (Term.typeSpec
        ":"
        (Term.app (Topology.Order.termcont "cont") [(Term.app `induced [`f `t]) `t `f])))
      (Command.declValSimple
       ":="
       (Term.byTactic
        "by"
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `continuous_def)] "]") [])
           []
           (Tactic.intro "intro" [`s `h])
           []
           (Tactic.exact "exact" (Term.anonymousCtor "⟨" [(Term.hole "_") "," `h "," `rfl] "⟩"))])))
       [])
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.abbrev'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023,
     term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" (Term.app `induced [`f `t]) ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      (Topology.Order.termcont "cont")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Topology.Order.termcont', expected 'Topology.Order.termcont._@.Topology.Order._hyg.14'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.opaque'
...
@[ continuity ]
  theorem
    ...
    { t : tspace β } : cont induced f t t f
    := by rw [ continuous_def ] intro s h exact ⟨ _ , h , rfl ⟩
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `continuous_induced_rng [])
      (Command.declSig
       [(Term.implicitBinder "{" [`g] [":" (Term.arrow `γ "→" `α)] "}")
        ...
        (Term.implicitBinder
         "{"
         [`t₁]
         [":" (Term.app (Topology.Order.termtspace "tspace") [`γ])]
         "}")]
       (Term.typeSpec
        ":"
        («term_↔_»
         (Term.app (Topology.Order.termcont "cont") [`t₁ (Term.app `induced [`f `t₂]) `g])
         "↔"
         (Term.app (Topology.Order.termcont "cont") [`t₁ `t₂ («term_∘_» `f "∘" `g)]))))
      (Command.declValSimple
       ":="
       (Term.byTactic
        "by"
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(Tactic.simp
            ...
            ["only"]
            ["["
             [(Tactic.simpLemma [] [] `continuous_iff_le_induced)
              ","
              (Tactic.simpLemma [] [] `induced_compose)]
             "]"]
            [])])))
       [])
      []
...
theorem
  ...
  { g : γ → α } { t₂ : tspace β } { t₁ : tspace γ } : cont t₁ induced f t₂ g ↔ cont t₁ t₂ f ∘ g
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `continuous_coinduced_rng [])
      (Command.declSig
       [(Term.implicitBinder
         "{"
         [`t]
       ...
       (Term.typeSpec
        ":"
        (Term.app (Topology.Order.termcont "cont") [`t (Term.app `coinduced [`f `t]) `f])))
      (Command.declValSimple
       ":="
       (Term.byTactic
        "by"
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023,
     term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" (Term.app `coinduced [`f `t]) ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      `t
...
theorem
  ...
  { t : tspace α } : cont t coinduced f t f
  := by rw [ continuous_def ] intro s h exact h
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `continuous_coinduced_dom [])
      (Command.declSig
       ...
       (Term.typeSpec
        ":"
        («term_↔_»
         (Term.app (Topology.Order.termcont "cont") [(Term.app `coinduced [`f `t₁]) `t₂ `g])
         "↔"
         (Term.app (Topology.Order.termcont "cont") [`t₁ `t₂ («term_∘_» `g "∘" `f)]))))
      (Command.declValSimple
       ":="
       (Term.byTactic
        "by"
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(Tactic.simp
            ...
            ["only"]
            ["["
             [(Tactic.simpLemma [] [] `continuous_iff_coinduced_le)
              ","
              (Tactic.simpLemma [] [] `coinduced_compose)]
             "]"]
            [])])))
       [])
      []
...
[PrettyPrinter.parenthesize] ...precedences are 91 >? 1024, (none, [anonymous]) <=? (some 90, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 90, (some 90, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" («term_∘_» `g "∘" `f) ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      `t₂
...
theorem
  ...
  { g : β → γ } { t₁ : tspace α } { t₂ : tspace γ } : cont coinduced f t₁ t₂ g ↔ cont t₁ t₂ g ∘ f
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `continuous_le_dom [])
      (Command.declSig
       [(Term.implicitBinder
         "{"
         [`t₁ `t₂]
        ...
        (Term.implicitBinder
         ...
         [":" (Term.app (Topology.Order.termtspace "tspace") [`β])]
         "}")
        (Term.explicitBinder "(" [`h₁] [":" («term_≤_» `t₂ "≤" `t₁)] [] ")")
        (Term.explicitBinder
         "("
         [`h₂]
         [":" (Term.app (Topology.Order.termcont "cont") [`t₁ `t₃ `f])]
         []
         ")")]
       (Term.typeSpec ":" (Term.app (Topology.Order.termcont "cont") [`t₂ `t₃ `f])))
      (Command.declValSimple
       ":="
       (Term.byTactic
        "by"
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(Tactic.rwSeq
            "rw"
            []
            (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `continuous_def)] "]")
            [(Tactic.location "at" (Tactic.locationHyp [`h₂] [(patternIgnore (token.«⊢» "⊢"))]))])
           []
           (Tactic.intro "intro" [`s `h])
           []
           (Tactic.exact "exact" (Term.app `h₁ [(Term.hole "_") (Term.app `h₂ [`s `h])]))])))
       [])
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.abbrev'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Tactic.exact "exact" (Term.app `h₁ [(Term.hole "_") (Term.app `h₂ [`s `h])]))
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `h₁ [(Term.hole "_") (Term.app `h₂ [`s `h])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `h₂ [`s `h])
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023,
     term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" (Term.app `h₂ [`s `h]) ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      (Term.hole "_")
...
theorem
  continuous_le_dom
  { t₁ t₂ : tspace α } { t₃ : tspace β } ( h₁ : t₂ ≤ t₁ ) ( h₂ : cont t₁ t₃ f ) : cont t₂ t₃ f
  := by rw [ continuous_def ] at h₂ ⊢ intro s h exact h₁ _ h₂ s h
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `continuous_le_rng [])
      (Command.declSig
       [(Term.implicitBinder
         "{"
         [`t₁]
        ...
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(Tactic.rwSeq
           ...
           (Tactic.intro "intro" [`s `h])
           []
           (Tactic.exact "exact" (Term.app `h₂ [`s (Term.app `h₁ [`s `h])]))])))
       [])
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.abbrev'
...
theorem
  continuous_le_rng
  { t₁ : tspace α } { t₂ t₃ : tspace β } ( h₁ : t₂ ≤ t₃ ) ( h₂ : cont t₁ t₂ f ) : cont t₁ t₃ f
  := by rw [ continuous_def ] at h₂ ⊢ intro s h exact h₂ s h₁ s h
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `continuous_sup_dom [])
      (Command.declSig
       [(Term.implicitBinder
         "{"
         [`t₁ `t₂]
       ...
       (Term.typeSpec
        ":"
        («term_↔_»
         (Term.app (Topology.Order.termcont "cont") [(Order.Basic.«term_⊔_» `t₁ " ⊔ " `t₂) `t₃ `f])
         "↔"
         («term_∧_»
          (Term.app (Topology.Order.termcont "cont") [`t₁ `t₃ `f])
          "∧"
...
theorem
  continuous_sup_dom
  { t₁ t₂ : tspace α } { t₃ : tspace β } : cont t₁ ⊔ t₂ t₃ f ↔ cont t₁ t₃ f ∧ cont t₂ t₃ f
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `continuous_sup_rng_left [])
      (Command.declSig
       [(Term.implicitBinder
         "{"
         [`t₁]
       ...
       (Term.typeSpec
        ...
        (Term.arrow
         ...
         (Term.app
          (Topology.Order.termcont "cont")
          [`t₁ (Order.Basic.«term_⊔_» `t₂ " ⊔ " `t₃) `f]))))
      (Command.declValSimple ":=" (Term.app `continuous_le_rng [`le_sup_left]) [])
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.abbrev'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.def'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `continuous_le_rng [`le_sup_left])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `le_sup_left
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, [anonymous]))
      (Term.arrow
       (Term.app (Topology.Order.termcont "cont") [`t₁ `t₂ `f])
       "→"
       (Term.app (Topology.Order.termcont "cont") [`t₁ (Order.Basic.«term_⊔_» `t₂ " ⊔ " `t₃) `f]))
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app (Topology.Order.termcont "cont") [`t₁ (Order.Basic.«term_⊔_» `t₂ " ⊔ " `t₃) `f])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 68, (some 69, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
     "("
     (Order.Basic.«term_⊔_» `t₂ " ⊔ " `t₃)
     ")")
...
theorem
  ...
  { t₁ : tspace α } { t₃ t₂ : tspace β } : cont t₁ t₂ f → cont t₁ t₂ ⊔ t₃ f
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `continuous_sup_rng_right [])
      (Command.declSig
       [(Term.implicitBinder
         "{"
         [`t₁]
       ...
       (Term.typeSpec
        ...
        (Term.arrow
         ...
         (Term.app
          (Topology.Order.termcont "cont")
          [`t₁ (Order.Basic.«term_⊔_» `t₂ " ⊔ " `t₃) `f]))))
      (Command.declValSimple ":=" (Term.app `continuous_le_rng [`le_sup_right]) [])
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.abbrev'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.def'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `continuous_le_rng [`le_sup_right])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `le_sup_right
     ...
     (Command.theorem
      ...
      (Command.declSig
       [(Term.implicitBinder
         "{"
         [`T]
         [":" (Term.app `Set [(Term.app (Topology.Order.termtspace "tspace") [`α])])]
         "}")
        (Term.implicitBinder
         "{"
         [`t₂]
       ...
       (Term.typeSpec
        ":"
        («term_↔_»
         (Term.app (Topology.Order.termcont "cont") [(Term.app `supₛ [`T]) `t₂ `f])
         "↔"
         (Std.ExtendedBinder.«term∀__,_»
          "∀"
          (Lean.binderIdent `t)
...
theorem
  continuous_Sup_dom
  { T : Set tspace α } { t₂ : tspace β } : cont supₛ T t₂ f ↔ ∀ t ∈ T , cont t t₂ f
  := by simp only [ continuous_iff_le_induced , supₛ_le_iff ]
#align continuous_Sup_dom continuous_Sup_dom
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `continuous_Sup_rng [])
      (Command.declSig
       [(Term.implicitBinder
         "{"
         [`t₁]
        ...
        (Term.implicitBinder
         "{"
         [`t₂]
         [":" (Term.app `Set [(Term.app (Topology.Order.termtspace "tspace") [`β])])]
         "}")
        (Term.implicitBinder
         "{"
         [`t]
       ...
       (Term.typeSpec
        ":"
        (Term.app (Topology.Order.termcont "cont") [`t₁ (Term.app `supₛ [`t₂]) `f])))
      (Command.declValSimple
       ":="
       («term_<|_»
        (Term.proj `continuous_iff_coinduced_le "." (fieldIdx "2"))
        "<|"
        («term_<|_»
         (Term.app `le_supₛ_of_le [`h₁])
         "<|"
         (Term.app (Term.proj `continuous_iff_coinduced_le "." (fieldIdx "1")) [`hf])))
       [])
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.abbrev'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none,
     [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      (Term.proj `continuous_iff_coinduced_le "." (fieldIdx "1"))
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      `continuous_iff_coinduced_le
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none,
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023,
     term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" (Term.app `supₛ [`t₂]) ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      `t₁
...
theorem
  continuous_Sup_rng
  { t₁ : tspace α } { t₂ : Set tspace β } { t : tspace β } ( h₁ : t ∈ t₂ ) ( hf : cont t₁ t f )
    : cont t₁ supₛ t₂ f
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `continuous_supr_dom [])
      (Command.declSig
       [(Term.implicitBinder
         "{"
         [`t₁]
         [":" (Term.arrow `ι "→" (Term.app (Topology.Order.termtspace "tspace") [`α]))]
         "}")
        (Term.implicitBinder
         "{"
         [`t₂]
       ...
       (Term.typeSpec
        ":"
        («term_↔_»
         (Term.app (Topology.Order.termcont "cont") [(Term.app `supᵢ [`t₁]) `t₂ `f])
         "↔"
         (Term.forall
          "∀"
          [`i]
          []
          ","
          (Term.app (Topology.Order.termcont "cont") [(Term.app `t₁ [`i]) `t₂ `f])))))
      (Command.declValSimple
       ":="
       (Term.byTactic
        "by"
...
theorem
  continuous_supr_dom
  { t₁ : ι → tspace α } { t₂ : tspace β } : cont supᵢ t₁ t₂ f ↔ ∀ i , cont t₁ i t₂ f
  := by simp only [ continuous_iff_le_induced , supᵢ_le_iff ]
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `continuous_supr_rng [])
      (Command.declSig
       [(Term.implicitBinder
         "{"
         [`t₁]
        ...
        (Term.implicitBinder
         "{"
         [`t₂]
         [":" (Term.arrow `ι "→" (Term.app (Topology.Order.termtspace "tspace") [`β]))]
         "}")
        (Term.implicitBinder "{" [`i] [":" `ι] "}")
        (Term.explicitBinder
         "("
         [`h]
         [":" (Term.app (Topology.Order.termcont "cont") [`t₁ (Term.app `t₂ [`i]) `f])]
         []
         ")")]
       (Term.typeSpec
        ":"
        (Term.app (Topology.Order.termcont "cont") [`t₁ (Term.app `supᵢ [`t₂]) `f])))
      (Command.declValSimple
       ":="
       (Term.app `continuous_Sup_rng [(Term.anonymousCtor "⟨" [`i "," `rfl] "⟩") `h])
       [])
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.abbrev'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023,
     term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" (Term.app `supᵢ [`t₂]) ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      `t₁
...
theorem
  continuous_supr_rng
  { t₁ : tspace α } { t₂ : ι → tspace β } { i : ι } ( h : cont t₁ t₂ i f ) : cont t₁ supᵢ t₂ f
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `continuous_inf_rng [])
      (Command.declSig
       [(Term.implicitBinder
         "{"
         [`t₁]
...
theorem
  continuous_inf_rng
  { t₁ : tspace α } { t₂ t₃ : tspace β } : cont t₁ t₂ ⊓ t₃ f ↔ cont t₁ t₂ f ∧ cont t₁ t₃ f
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `continuous_inf_dom_left [])
      (Command.declSig
       [(Term.implicitBinder
         "{"
         [`t₁ `t₂]
       ...
       (Term.typeSpec
        ...
        (Term.arrow
         ...
         (Term.app
          (Topology.Order.termcont "cont")
          [(Order.Basic.«term_⊓_» `t₁ " ⊓ " `t₂) `t₃ `f]))))
      (Command.declValSimple ":=" (Term.app `continuous_le_dom [`inf_le_left]) [])
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.abbrev'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.def'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `continuous_le_dom [`inf_le_left])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `inf_le_left
...
theorem
  ...
  { t₁ t₂ : tspace α } { t₃ : tspace β } : cont t₁ t₃ f → cont t₁ ⊓ t₂ t₃ f
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `continuous_inf_dom_right [])
      (Command.declSig
       [(Term.implicitBinder
         "{"
         [`t₁ `t₂]
       ...
       (Term.typeSpec
        ...
        (Term.arrow
         ...
         (Term.app
          (Topology.Order.termcont "cont")
          [(Order.Basic.«term_⊓_» `t₁ " ⊓ " `t₂) `t₃ `f]))))
      (Command.declValSimple ":=" (Term.app `continuous_le_dom [`inf_le_right]) [])
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.abbrev'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.def'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `continuous_le_dom [`inf_le_right])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `inf_le_right
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `continuous_Inf_dom [])
      (Command.declSig
       [(Term.implicitBinder
         "{"
         [`t₁]
       ...
       (Term.typeSpec
        ...
        (Term.arrow
         (Term.app (Topology.Order.termcont "cont") [`t `t₂ `f])
         "→"
         (Term.app (Topology.Order.termcont "cont") [(Term.app `infₛ [`t₁]) `t₂ `f]))))
      (Command.declValSimple ":=" («term_<|_» `continuous_le_dom "<|" (Term.app `infₛ_le [`h₁])) [])
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.abbrev'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.def'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      («term_<|_» `continuous_le_dom "<|" (Term.app `infₛ_le [`h₁]))
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `infₛ_le [`h₁])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023,
     term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" (Term.app `infₛ [`t₁]) ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      (Topology.Order.termcont "cont")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Topology.Order.termcont', expected 'Topology.Order.termcont._@.Topology.Order._hyg.14'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.opaque'
...
theorem
  continuous_Inf_dom
  { t₁ : Set tspace α } { t₂ : tspace β } { t : tspace α } ( h₁ : t ∈ t₁ )
     ...
     (Command.theorem
      ...
      (Command.declSig
       ...
       (Term.typeSpec
        ":"
        («term_↔_»
         (Term.app (Topology.Order.termcont "cont") [`t₁ (Term.app `infₛ [`T]) `f])
         "↔"
         (Std.ExtendedBinder.«term∀__,_»
          "∀"
          (Lean.binderIdent `t)
...
theorem
  continuous_Inf_rng
  { t₁ : tspace α } { T : Set tspace β } : cont t₁ infₛ T f ↔ ∀ t ∈ T , cont t₁ t f
  := by simp only [ continuous_iff_coinduced_le , le_infₛ_iff ]
#align continuous_Inf_rng continuous_Inf_rng
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `continuous_infi_dom [])
      (Command.declSig
       [(Term.implicitBinder
         "{"
         [`t₁]
       ...
       (Term.typeSpec
        ...
        (Term.arrow
         (Term.app (Topology.Order.termcont "cont") [(Term.app `t₁ [`i]) `t₂ `f])
         "→"
         (Term.app (Topology.Order.termcont "cont") [(Term.app `infᵢ [`t₁]) `t₂ `f]))))
      (Command.declValSimple
       ":="
       («term_<|_» `continuous_le_dom "<|" (Term.app `infᵢ_le [(Term.hole "_") (Term.hole "_")]))
       [])
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.abbrev'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023,
     term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" (Term.app `infᵢ [`t₁]) ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      (Topology.Order.termcont "cont")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Topology.Order.termcont', expected 'Topology.Order.termcont._@.Topology.Order._hyg.14'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.opaque'
...
theorem
  continuous_infi_dom
  { t₁ : ι → tspace α } { t₂ : tspace β } { i : ι } : cont t₁ i t₂ f → cont infᵢ t₁ t₂ f
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `continuous_infi_rng [])
      (Command.declSig
       [(Term.implicitBinder
         "{"
         [`t₁]
       ...
       (Term.typeSpec
        ":"
        («term_↔_»
         (Term.app (Topology.Order.termcont "cont") [`t₁ (Term.app `infᵢ [`t₂]) `f])
         "↔"
         (Term.forall
          "∀"
          [`i]
...
theorem
  continuous_infi_rng
  { t₁ : tspace α } { t₂ : ι → tspace β } : cont t₁ infᵢ t₂ f ↔ ∀ i , cont t₁ t₂ i f
  := by simp only [ continuous_iff_coinduced_le , le_infᵢ_iff ]
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      ...
      (Command.declSig
       ...
       (Term.typeSpec
        ":"
        (Term.app (Topology.Order.termcont "cont") [(Order.BoundedOrder.«term⊥» "⊥") `t `f])))
      (Command.declValSimple
       ":="
       («term_<|_» (Term.proj `continuous_iff_le_induced "." (fieldIdx "2")) "<|" `bot_le)
       [])
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.abbrev'
...
[PrettyPrinter.parenthesize] ...precedences are 10 >? 1024, (none,
     [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 10, term))
      (Term.proj `continuous_iff_le_induced "." (fieldIdx "2"))
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      `continuous_iff_le_induced
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (some 10, term)
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
@[ continuity ]
  theorem continuous_bot { t : tspace β } : cont ⊥ t f := continuous_iff_le_induced . 2 <| bot_le
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      ...
      (Command.declSig
       ...
       (Term.typeSpec
        ":"
        (Term.app (Topology.Order.termcont "cont") [`t (Order.BoundedOrder.«term⊤» "⊤") `f])))
      (Command.declValSimple
       ":="
       («term_<|_» (Term.proj `continuous_iff_coinduced_le "." (fieldIdx "2")) "<|" `le_top)
       [])
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.abbrev'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
@[ continuity ]
  theorem continuous_top { t : tspace α } : cont t ⊤ f := continuous_iff_coinduced_le . 2 <| le_top
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `continuous_id_iff_le [])
      (Command.declSig
       [(Term.implicitBinder
         "{"
         [`t `t']
       ...
       (Term.typeSpec
        ":"
        («term_↔_»
         (Term.app (Topology.Order.termcont "cont") [`t `t' `id])
         "↔"
         («term_≤_» `t "≤" `t'))))
      (Command.declValSimple
       ":="
       (Term.app (Term.explicit "@" `continuous_def) [(Term.hole "_") (Term.hole "_") `t `t' `id])
       [])
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.abbrev'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `continuous_id_of_le [])
      (Command.declSig
       [(Term.implicitBinder
         "{"
         [`t `t']
         ...
         "}")
        (Term.explicitBinder "(" [`h] [":" («term_≤_» `t "≤" `t')] [] ")")]
       (Term.typeSpec ":" (Term.app (Topology.Order.termcont "cont") [`t `t' `id])))
      (Command.declValSimple
       ":="
       (Term.app (Term.proj `continuous_id_iff_le "." (fieldIdx "2")) [`h])
       [])
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.abbrev'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none,
     [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      (Term.proj `continuous_id_iff_le "." (fieldIdx "2"))
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      `continuous_id_iff_le
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none,
...
theorem
  continuous_id_of_le
  { t t' : tspace α } ( h : t ≤ t' ) : cont t t' id
