...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `is_sheaf_unique_gluing [])
  (Command.optDeclSig [] [(Term.typeSpec ":" (Term.prop "Prop"))])
  (Command.declValSimple
   ":="
   (Term.forall
    "∀"
    [(Term.strictImplicitBinder "⦃" [`ι] [":" (Term.type "Type" [`v])] "⦄")
     (Term.simpleBinder [`U] [(Term.typeSpec ":" (Term.arrow `ι "→" (Term.app `opens [`X])))])
     (Term.simpleBinder
      [`sf]
      [(Term.typeSpec
        ":"
        (Term.forall
         ...
         ","
         (Term.app `F.obj [(Term.app `op [(Term.app `U [`i])])])))])]
    ","
    (Term.arrow
     (Term.app `is_compatible [`F `U `sf])
     "→"
     (Init.Logic.«term∃!_,_»
      "∃!"
      (Lean.explicitBinders
       (Lean.unbracketedExplicitBinders
        [(Lean.binderIdent `s)]
        [":" (Term.app `F.obj [(Term.app `op [(Term.app `supr [`U])])])]))
      ", "
      (Term.app `is_gluing [`F `U `sf `s]))))
   [])
  []
  []
  []))
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `exists_unique_gluing [])
  (Command.declSig
   [(Term.explicitBinder
     "("
     [`sf]
     [":"
      (Term.forall
       ...
       [(Term.simpleBinder [`i] [(Term.typeSpec ":" `ι)])]
       ","
       (Term.app (Term.proj (Term.proj `F "." (fieldIdx "1")) "." `obj) [(Term.app `op [(Term.app `U [`i])])]))]
     []
     ")")
    (Term.explicitBinder "(" [`h] [":" (Term.app `is_compatible [(Term.proj `F "." (fieldIdx "1")) `U `sf])] [] ")")]
   (Term.typeSpec
    ":"
    (Init.Logic.«term∃!_,_»
     "∃!"
     (Lean.explicitBinders
      (Lean.unbracketedExplicitBinders
       [(Lean.binderIdent `s)]
       [":"
        (Term.app (Term.proj (Term.proj `F "." (fieldIdx "1")) "." `obj) [(Term.app `op [(Term.app `supr [`U])])])]))
     ", "
     (Term.app `is_gluing [(Term.proj `F "." (fieldIdx "1")) `U `sf `s]))))
  (Command.declValSimple
   ":="
   (Term.app
    (Term.proj (Term.app `is_sheaf_iff_is_sheaf_unique_gluing [(Term.proj `F "." (fieldIdx "1"))]) "." `mp)
    [`F.property `U `sf `h])
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `is_sheaf_iff_is_sheaf_unique_gluing [(Term.proj `F "." (fieldIdx "1"))])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  ...
  (Command.declId `exists_unique_gluing' [])
  (Command.declSig
   [(Term.explicitBinder "(" [`V] [":" (Term.app `opens [`X])] [] ")")
    (Term.explicitBinder
     "("
     [`iUV]
     [":"
      (Term.forall
       ...
       [(Term.simpleBinder [`i] [(Term.typeSpec ":" `ι)])]
       ","
       (Combinatorics.Quiver.«term_⟶_» (Term.app `U [`i]) " ⟶ " `V))]
     []
     ")")
    (Term.explicitBinder "(" [`hcover] [":" («term_≤_» `V "≤" (Term.app `supr [`U]))] [] ")")
    (Term.explicitBinder
     "("
     [`sf]
     [":"
   ...
   (Term.typeSpec
    ...
    (Init.Logic.«term∃!_,_»
     ...
     (Lean.explicitBinders
      (Lean.unbracketedExplicitBinders
       [(Lean.binderIdent `s)]
       [":" (Term.app (Term.proj (Term.proj `F "." (fieldIdx "1")) "." `obj) [(Term.app `op [`V])])]))
     ", "
     (Term.forall
      "∀"
      [(Term.simpleBinder [`i] [(Term.typeSpec ":" `ι)])]
      ","
      («term_=_»
       (Term.app (Term.proj (Term.proj `F "." (fieldIdx "1")) "." `map) [(Term.proj (Term.app `iUV [`i]) "." `op) `s])
       "="
       (Term.app `sf [`i]))))))
  (Command.declValSimple
   ":="
      ...
      [(group
        (Tactic.tacticHave_
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           [`V_eq_supr_U []]
           [(Term.typeSpec ":" («term_=_» `V "=" (Term.app `supr [`U])))]
           ":="
           (Term.app
            `le_antisymmₓ
            [`hcover
             (Term.app
              ...
              [(Term.fun
                "fun"
                (Term.basicFun [(Term.simpleBinder [`i] [])] "=>" (Term.proj (Term.app `iUV [`i]) "." `le)))])]))))
        [])
       (group
        (Tactic.obtain
         "obtain"
         [(Tactic.rcasesPatMed
           [(Tactic.rcasesPat.tuple
             "⟨"
             [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `gl)]) [])
              ","
              (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `gl_spec)]) [])
              ","
              (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `gl_uniq)]) [])]
             "⟩")])]
         []
         [":=" [(Term.app `F.exists_unique_gluing [`U `sf `h])]])
        [])
       (group
        (Tactic.refine'
         "refine'"
         (Term.anonymousCtor
          "⟨"
          [(Term.app
            (Term.proj (Term.proj `F "." (fieldIdx "1")) "." `map)
            [(Term.proj (Term.app `eq_to_hom [`V_eq_supr_U]) "." `op) `gl])
           ","
           (Term.hole "_")
           ","
           (Term.hole "_")]
             ...
             (Tactic.rwSeq
              ...
              (Tactic.rwRuleSeq
               ...
               [(Tactic.rwRule ["←"] `comp_apply)
                ","
                (Tactic.rwRule ["←"] (Term.proj (Term.proj `F "." (fieldIdx "1")) "." `map_comp))]
               "]")
              [])
             [])
            (group (Tactic.exact "exact" (Term.app `gl_spec [`i])) [])])))
        [])
       (group
        (Tactic.«tactic·._»
         "·"
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group (Tactic.intro "intro" [`gl' `gl'_spec]) [])
            (group
             (Tactic.«tactic_<;>_»
              (Tactic.convert
               "convert"
               ...
               (Term.app
                ...
                [(Term.hole "_")
                 (Term.app
                  ...
                  [(Term.app
                    (Term.proj (Term.proj `F "." (fieldIdx "1")) "." `map)
                    [(Term.proj (Term.app `eq_to_hom [`V_eq_supr_U.symm]) "." `op) `gl'])
                  ...
                  (Tactic.rwSeq
                   ...
                   (Tactic.rwRuleSeq
                    ...
                    [(Tactic.rwRule [] `eq_to_hom_op)
                     ...
                     ","
                     (Tactic.rwRule [] `eq_to_hom_refl)
                     ","
                     (Tactic.rwRule [] (Term.proj (Term.proj `F "." (fieldIdx "1")) "." `map_id))
                     ","
                     (Tactic.rwRule [] `id_apply)]
                    "]")
                   [])
                  [])])))
             [])
            (group
             (Tactic.«tactic·._»
              "·"
              (Tactic.tacticSeq
               (Tactic.tacticSeq1Indented [(group (Tactic.convert "convert" [] (Term.app `gl'_spec [`i]) []) [])])))
             [])])))
        [])])))
   [])
  []
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.convert "convert" [] (Term.app `gl'_spec [`i]) [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Term.proj `F "." (fieldIdx "1")) "." `map_id)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.proj `F "." (fieldIdx "1"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Term.proj `F "." (fieldIdx "1")) "." `map_comp)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.proj `F "." (fieldIdx "1"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.proj (Term.app `eq_to_hom [`V_eq_supr_U.symm]) "." `op)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `eq_to_hom [`V_eq_supr_U.symm])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `eq_to_hom [`V_eq_supr_U.symm]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.proj `F "." (fieldIdx "1")) "." `map)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(Term.app
   (Term.proj (Term.proj `F "." (fieldIdx "1")) "." `map)
   [(Term.proj (Term.paren "(" [(Term.app `eq_to_hom [`V_eq_supr_U.symm]) []] ")") "." `op) `gl'])
  []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `gl_uniq
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.intro "intro" [`gl' `gl'_spec])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `gl_spec [`i]))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.proj (Term.app `eq_to_hom [`V_eq_supr_U]) "." `op)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `eq_to_hom [`V_eq_supr_U])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `eq_to_hom [`V_eq_supr_U]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.proj `F "." (fieldIdx "1")) "." `map)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app
   ...
   [`hcover
    (Term.app
     `supr_le
     [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`i] [])] "=>" (Term.proj (Term.app `iUV [`i]) "." `le)))])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `iUV [`i]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.simpleBinder', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.simpleBinder', expected 'Lean.Parser.Term.strictImplicitBinder.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.simpleBinder', expected 'Lean.Parser.Term.strictImplicitBinder'
 ...
 [(Term.app
   ...
   [(Term.fun
     ...
     (Term.basicFun
      [(Term.simpleBinder [`i] [])]
      "=>"
      (Term.proj (Term.paren "(" [(Term.app `iUV [`i]) []] ")") "." `le)))])
  []]
 ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
    ...
    :=
      by
        have V_eq_supr_U : V = supr U := le_antisymmₓ hcover supr_le fun i => iUV i . le
          ...
          · intro i rw [ ← comp_apply , ← F . 1 . map_comp ] exact gl_spec i
          ·
            intro gl' gl'_spec
