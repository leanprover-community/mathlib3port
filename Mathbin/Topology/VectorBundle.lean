...
def continuous_linear_equiv_at (e : Trivialization R F E) (b : B) (hb : b ∈ e.BaseSet) : E b ≃L[R] F where
  toFun := fun y => (e ⟨b, y⟩).2
  invFun := fun z => by
...
instance to_topological_space : TopologicalSpace (TotalSpace Z.Fiber) :=
