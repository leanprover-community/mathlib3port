...
but is expected to have type
  forall {α : Type.{u1}} {β : Type.{u3}} {γ : Type.{u2}} [_inst_1 : TopologicalSpace.{u1} α] [_inst_2 : TopologicalSpace.{u3} β] [_inst_3 : TopologicalSpace.{u2} γ] (f : α -> (ContinuousMap.{u3, u2} β γ _inst_2 _inst_3)), (Continuous.{max u3 u1, u2} (Prod.{u1, u3} α β) γ (instTopologicalSpaceProd.{u1, u3} α β _inst_1 _inst_2) _inst_3 (Function.uncurry.{u1, u3, u2} α β γ (fun (x : α) (y : β) => FunLike.coe.{max (succ u3) (succ u2), succ u3, succ u2} (ContinuousMap.{u3, u2} β γ _inst_2 _inst_3) β (fun (_x : β) => (fun (x._@.Mathlib.Topology.ContinuousFunction.Basic._hyg.669 : β) => γ) _x) (ContinuousMapClass.toFunLike.{max u3 u2, u3, u2} (ContinuousMap.{u3, u2} β γ _inst_2 _inst_3) β γ _inst_2 _inst_3 (ContinuousMap.instContinuousMapClassContinuousMap.{u3, u2} β γ _inst_2 _inst_3)) (f x) y))) -> (Continuous.{u1, max u3 u2} α (ContinuousMap.{u3, u2} β γ _inst_2 _inst_3) _inst_1 (ContinuousMap.compactOpen.{u3, u2} β γ _inst_2 _inst_3) f)
...
but is expected to have type
  forall {α : Type.{u2}} {β : Type.{u3}} {γ : Type.{u1}} [_inst_1 : TopologicalSpace.{u2} α] [_inst_2 : TopologicalSpace.{u3} β] [_inst_3 : TopologicalSpace.{u1} γ] (f : ContinuousMap.{max u3 u2, u1} (Prod.{u2, u3} α β) γ (instTopologicalSpaceProd.{u2, u3} α β _inst_1 _inst_2) _inst_3) (a : α) (b : β), Eq.{succ u1} ((fun (x._@.Mathlib.Topology.ContinuousFunction.Basic._hyg.669 : β) => γ) b) (FunLike.coe.{max (succ u3) (succ u1), succ u3, succ u1} ((fun (x._@.Mathlib.Topology.ContinuousFunction.Basic._hyg.669 : α) => ContinuousMap.{u3, u1} β γ _inst_2 _inst_3) a) β (fun (_x : β) => (fun (x._@.Mathlib.Topology.ContinuousFunction.Basic._hyg.669 : β) => γ) _x) (ContinuousMapClass.toFunLike.{max u3 u1, u3, u1} ((fun (x._@.Mathlib.Topology.ContinuousFunction.Basic._hyg.669 : α) => ContinuousMap.{u3, u1} β γ _inst_2 _inst_3) a) β γ _inst_2 _inst_3 (ContinuousMap.instContinuousMapClassContinuousMap.{u3, u1} β γ _inst_2 _inst_3)) (FunLike.coe.{max (max (succ u2) (succ u3)) (succ u1), succ u2, max (succ u3) (succ u1)} (ContinuousMap.{u2, max u1 u3} α (ContinuousMap.{u3, u1} β γ _inst_2 _inst_3) _inst_1 (ContinuousMap.compactOpen.{u3, u1} β γ _inst_2 _inst_3)) α (fun (_x : α) => (fun (x._@.Mathlib.Topology.ContinuousFunction.Basic._hyg.669 : α) => ContinuousMap.{u3, u1} β γ _inst_2 _inst_3) _x) (ContinuousMapClass.toFunLike.{max (max u2 u3) u1, u2, max u3 u1} (ContinuousMap.{u2, max u1 u3} α (ContinuousMap.{u3, u1} β γ _inst_2 _inst_3) _inst_1 (ContinuousMap.compactOpen.{u3, u1} β γ _inst_2 _inst_3)) α (ContinuousMap.{u3, u1} β γ _inst_2 _inst_3) _inst_1 (ContinuousMap.compactOpen.{u3, u1} β γ _inst_2 _inst_3) (ContinuousMap.instContinuousMapClassContinuousMap.{u2, max u3 u1} α (ContinuousMap.{u3, u1} β γ _inst_2 _inst_3) _inst_1 (ContinuousMap.compactOpen.{u3, u1} β γ _inst_2 _inst_3))) (ContinuousMap.curry.{u2, u3, u1} α β γ _inst_1 _inst_2 _inst_3 f) a) b) (FunLike.coe.{max (max (succ u2) (succ u3)) (succ u1), max (succ u2) (succ u3), succ u1} (ContinuousMap.{max u3 u2, u1} (Prod.{u2, u3} α β) γ (instTopologicalSpaceProd.{u2, u3} α β _inst_1 _inst_2) _inst_3) (Prod.{u2, u3} α β) (fun (_x : Prod.{u2, u3} α β) => (fun (x._@.Mathlib.Topology.ContinuousFunction.Basic._hyg.669 : Prod.{u2, u3} α β) => γ) _x) (ContinuousMapClass.toFunLike.{max (max u2 u3) u1, max u2 u3, u1} (ContinuousMap.{max u3 u2, u1} (Prod.{u2, u3} α β) γ (instTopologicalSpaceProd.{u2, u3} α β _inst_1 _inst_2) _inst_3) (Prod.{u2, u3} α β) γ (instTopologicalSpaceProd.{u2, u3} α β _inst_1 _inst_2) _inst_3 (ContinuousMap.instContinuousMapClassContinuousMap.{max u2 u3, u1} (Prod.{u2, u3} α β) γ (instTopologicalSpaceProd.{u2, u3} α β _inst_1 _inst_2) _inst_3)) f (Prod.mk.{u2, u3} α β a b))
...
but is expected to have type
  forall {α : Type.{u2}} {β : Type.{u3}} {γ : Type.{u1}} [_inst_1 : TopologicalSpace.{u2} α] [_inst_2 : TopologicalSpace.{u3} β] [_inst_3 : TopologicalSpace.{u1} γ] [_inst_4 : LocallyCompactSpace.{u3} β _inst_2] (f : ContinuousMap.{u2, max u1 u3} α (ContinuousMap.{u3, u1} β γ _inst_2 _inst_3) _inst_1 (ContinuousMap.compactOpen.{u3, u1} β γ _inst_2 _inst_3)), Continuous.{max u3 u2, u1} (Prod.{u2, u3} α β) γ (instTopologicalSpaceProd.{u2, u3} α β _inst_1 _inst_2) _inst_3 (Function.uncurry.{u2, u3, u1} α β γ (fun (x : α) (y : β) => FunLike.coe.{max (succ u3) (succ u1), succ u3, succ u1} ((fun (x._@.Mathlib.Topology.ContinuousFunction.Basic._hyg.669 : α) => ContinuousMap.{u3, u1} β γ _inst_2 _inst_3) x) β (fun (_x : β) => (fun (x._@.Mathlib.Topology.ContinuousFunction.Basic._hyg.669 : β) => γ) _x) (ContinuousMapClass.toFunLike.{max u3 u1, u3, u1} ((fun (x._@.Mathlib.Topology.ContinuousFunction.Basic._hyg.669 : α) => ContinuousMap.{u3, u1} β γ _inst_2 _inst_3) x) β γ _inst_2 _inst_3 (ContinuousMap.instContinuousMapClassContinuousMap.{u3, u1} β γ _inst_2 _inst_3)) (FunLike.coe.{max (max (succ u2) (succ u3)) (succ u1), succ u2, max (succ u3) (succ u1)} (ContinuousMap.{u2, max u1 u3} α (ContinuousMap.{u3, u1} β γ _inst_2 _inst_3) _inst_1 (ContinuousMap.compactOpen.{u3, u1} β γ _inst_2 _inst_3)) α (fun (_x : α) => (fun (x._@.Mathlib.Topology.ContinuousFunction.Basic._hyg.669 : α) => ContinuousMap.{u3, u1} β γ _inst_2 _inst_3) _x) (ContinuousMapClass.toFunLike.{max (max u2 u3) u1, u2, max u3 u1} (ContinuousMap.{u2, max u1 u3} α (ContinuousMap.{u3, u1} β γ _inst_2 _inst_3) _inst_1 (ContinuousMap.compactOpen.{u3, u1} β γ _inst_2 _inst_3)) α (ContinuousMap.{u3, u1} β γ _inst_2 _inst_3) _inst_1 (ContinuousMap.compactOpen.{u3, u1} β γ _inst_2 _inst_3) (ContinuousMap.instContinuousMapClassContinuousMap.{u2, max u3 u1} α (ContinuousMap.{u3, u1} β γ _inst_2 _inst_3) _inst_1 (ContinuousMap.compactOpen.{u3, u1} β γ _inst_2 _inst_3))) f x) y))
