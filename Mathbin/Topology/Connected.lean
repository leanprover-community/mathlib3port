...
/- ./././Mathport/Syntax/Translate/Basic.lean:572:2: warning: expanding binder collection (i j «expr ∈ » t) -/
/- ./././Mathport/Syntax/Translate/Basic.lean:572:2: warning: expanding binder collection (p «expr ⊆ » t) -/
/- ./././Mathport/Syntax/Translate/Basic.lean:572:2: warning: expanding binder collection (i j «expr ∈ » t) -/
...
theorem connectedComponentDisjoint {x y : α} (h : ConnectedComponent x ≠ ConnectedComponent y) :
...
theorem preimage_connected_component_connected [TopologicalSpace β] {f : α → β}
  ...
  have T_disjoint : Disjoint T₁ T₂ := by
    refine' Disjoint.ofPreimage hf _
...
/- ./././Mathport/Syntax/Translate/Basic.lean:572:2: warning: expanding binder collection (V «expr ⊆ » U) -/
...
/- ./././Mathport/Syntax/Translate/Command.lean:353:30: infer kinds are unsupported in Lean 4: #[`is_totally_separated_univ] [] -/
