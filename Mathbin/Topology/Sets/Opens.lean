...
but is expected to have type
  forall {α : Type.{u1}} {β : Type.{u2}} [_inst_1 : TopologicalSpace.{u1} α] [_inst_2 : TopologicalSpace.{u2} β] (f : ContinuousMap.{u1, u2} α β _inst_1 _inst_2) (x : α), LatticeHom.{u2, u1} (TopologicalSpace.OpenNhdsOf.{u2} ((fun (x._@.Mathlib.Topology.ContinuousFunction.Basic._hyg.669 : α) => β) x) _inst_2 (FunLike.coe.{max (succ u1) (succ u2), succ u1, succ u2} (ContinuousMap.{u1, u2} α β _inst_1 _inst_2) α (fun (_x : α) => (fun (x._@.Mathlib.Topology.ContinuousFunction.Basic._hyg.669 : α) => β) _x) (ContinuousMapClass.toFunLike.{max u1 u2, u1, u2} (ContinuousMap.{u1, u2} α β _inst_1 _inst_2) α β _inst_1 _inst_2 (ContinuousMap.instContinuousMapClassContinuousMap.{u1, u2} α β _inst_1 _inst_2)) f x)) (TopologicalSpace.OpenNhdsOf.{u1} α _inst_1 x) (DistribLattice.toLattice.{u2} (TopologicalSpace.OpenNhdsOf.{u2} ((fun (x._@.Mathlib.Topology.ContinuousFunction.Basic._hyg.669 : α) => β) x) _inst_2 (FunLike.coe.{max (succ u1) (succ u2), succ u1, succ u2} (ContinuousMap.{u1, u2} α β _inst_1 _inst_2) α (fun (_x : α) => (fun (x._@.Mathlib.Topology.ContinuousFunction.Basic._hyg.669 : α) => β) _x) (ContinuousMapClass.toFunLike.{max u1 u2, u1, u2} (ContinuousMap.{u1, u2} α β _inst_1 _inst_2) α β _inst_1 _inst_2 (ContinuousMap.instContinuousMapClassContinuousMap.{u1, u2} α β _inst_1 _inst_2)) f x)) (TopologicalSpace.OpenNhdsOf.instDistribLatticeOpenNhdsOf.{u2} ((fun (x._@.Mathlib.Topology.ContinuousFunction.Basic._hyg.669 : α) => β) x) _inst_2 (FunLike.coe.{max (succ u1) (succ u2), succ u1, succ u2} (ContinuousMap.{u1, u2} α β _inst_1 _inst_2) α (fun (_x : α) => (fun (x._@.Mathlib.Topology.ContinuousFunction.Basic._hyg.669 : α) => β) _x) (ContinuousMapClass.toFunLike.{max u1 u2, u1, u2} (ContinuousMap.{u1, u2} α β _inst_1 _inst_2) α β _inst_1 _inst_2 (ContinuousMap.instContinuousMapClassContinuousMap.{u1, u2} α β _inst_1 _inst_2)) f x))) (DistribLattice.toLattice.{u1} (TopologicalSpace.OpenNhdsOf.{u1} α _inst_1 x) (TopologicalSpace.OpenNhdsOf.instDistribLatticeOpenNhdsOf.{u1} α _inst_1 x))
