...
-- ././Mathport/Syntax/Translate/Basic.lean:833:9: unsupported derive handler creates_limits
...
instance
  { X : Compactum } : TopologicalSpace X
  where
    IsOpen U := ∀ F : Ultrafilter X , X.str F ∈ U → U ∈ F
      ...
      is_open_sUnion S h1 F ⟨ T , hT , h2 ⟩ := mem_of_superset ( h1 T hT _ h2 ) ( Set.subset_sUnion_of_mem hT )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " A local definition used only in the proofs. -/")]
  []
 ...
 (Command.def
  "def"
  (Command.declId `basic [])
  (Command.optDeclSig
   [(Term.implicitBinder "{" [`X] [":" `Compactum] "}")
    (Term.explicitBinder "(" [`A] [":" (Term.app `Set [`X])] [] ")")]
   [(Term.typeSpec ":" (Term.app `Set [(Term.app `Ultrafilter [`X])]))])
  (Command.declValSimple ":=" (Set.«term{_|_}» "{" `F "|" (Init.Core.«term_∈_» `A " ∈ " `F) "}") [])
  []
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Set.«term{_|_}» "{" `F "|" (Init.Core.«term_∈_» `A " ∈ " `F) "}")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Set.«term{_|_}»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Init.Core.«term_∈_» `A " ∈ " `F)
...
-- ././Mathport/Syntax/Translate/Basic.lean:477:2: warning: expanding binder collection (B C «expr ∈ » C0)
/- failed to parenthesize: parenthesize: uncaught backtrack exception
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers [] [] [(Command.private "private")] [] [] [])
 (Command.theorem
  "theorem"
  (Command.declId `cl_cl [])
  (Command.declSig
   [(Term.implicitBinder "{" [`X] [":" `Compactum] "}")
    (Term.explicitBinder "(" [`A] [":" (Term.app `Set [`X])] [] ")")]
   (Term.typeSpec ":" (Init.Core.«term_⊆_» (Term.app `cl [(Term.app `cl [`A])]) " ⊆ " (Term.app `cl [`A]))))
      ...
      [(group
       ...
       (group
        (Tactic.tacticLet_
         "let"
         (Term.letDecl
          (Term.letIdDecl `fsu [] ":=" (Term.app `Finset [(Term.app `Set [(Term.app `Ultrafilter [`X])])]))))
        [])
       (group
        (Tactic.tacticLet_
         "let"
         (Term.letDecl (Term.letIdDecl `ssu [] ":=" (Term.app `Set [(Term.app `Set [(Term.app `Ultrafilter [`X])])]))))
        [])
       (group
        (Tactic.tacticLet_
         "let"
         (Term.letDecl (Term.letIdDecl `ι [(Term.typeSpec ":" (Term.arrow `fsu "→" `ssu))] ":=" `coeₓ)))
        [])
       (group
        (Tactic.tacticLet_
         "let"
          ...
          (Term.letIdDecl
           ...
           (Set.«term{_|_}»
            ...
            (Mathlib.ExtendedBinder.«term∃___,_»
             ...
             («binderTerm∈_» "∈" `F)
             ","
             («term_=_» (Set.Data.Set.Basic.«term_⁻¹'_» `X.str " ⁻¹' " `B) "=" `Z))
            "}"))))
        [])
       (group
        (Tactic.tacticLet_
         ...
         (Term.letDecl
          (Term.letIdDecl
           ...
           (Set.«term{_|_}»
            "{"
            (Mathlib.ExtendedBinder.extBinder `G [":" (Term.app `Ultrafilter [`X])])
            "|"
            (Init.Core.«term_∈_» `A " ∈ " `G)
            "}"))))
        [])
       (group (Tactic.tacticLet_ "let" (Term.letDecl (Term.letIdDecl `C1 [] ":=" (Term.app `insert [`AA `C0])))) [])
       (group
        (Tactic.tacticLet_ "let" (Term.letDecl (Term.letIdDecl `C2 [] ":=" (Term.app `finite_inter_closure [`C1]))))
        [])
       (group
        (Tactic.tacticHave_
         "have"
         (Term.haveDecl
          (Term.haveIdDecl
           ...
           [(Term.typeSpec
             ...
             (Term.forall
              "∀"
              [(Term.simpleBinder [`B `C] [])
               (Term.simpleBinder [(Term.hole "_")] [(Term.typeSpec ":" (Init.Core.«term_∈_» `B " ∈ " `C0))])
               (Term.simpleBinder [(Term.hole "_")] [(Term.typeSpec ":" (Init.Core.«term_∈_» `C " ∈ " `C0))])]
              ","
              (Init.Core.«term_∈_» (Init.Core.«term_∩_» `B " ∩ " `C) " ∈ " `C0)))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(group
                (Tactic.rintro
                 ...
                 [])
                [])
               (group (Tactic.use "use" [(Init.Core.«term_∩_» `Q " ∩ " `R)]) [])
               (group
                (Tactic.simp
                 "simp"
                 []
                 ...
                 ["["
                  [(Tactic.simpLemma [] [] `and_trueₓ)
                   ...
                   ","
                   (Tactic.simpLemma [] [] `Set.preimage_inter)
                   ","
                   (Tactic.simpLemma [] [] `Subtype.val_eq_coe)]
                  "]"]
                 [])
                [])
               (group (Tactic.exact "exact" (Term.app `inter_sets [(Term.hole "_") `hQ `hR])) [])]))))))
        [])
       (group
        (Tactic.tacticHave_
         "have"
           ...
           [(Term.typeSpec
             ...
             (Term.forall
              ...
              (Mathlib.ExtendedBinder.«term∀___,_»
               ...
               («binderTerm∈_» "∈" `C0)
               ","
               (Term.forall "∀" [] "," (Term.app `Set.Nonempty [`B])))))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
                ...
                (Tactic.obtain
                 ...
                 [(Tactic.rcasesPatMed
                   [(Tactic.rcasesPat.tuple
                     ...
                     "⟩")])]
                 []
                 [":=" [(Term.app `Filter.nonempty_of_mem [`hQ])]])
                [])
               (group (Tactic.use "use" [(Term.app `X.incl [`q])]) [])
           ...
           [(Term.typeSpec
             ...
             (Term.forall
              ...
              (Mathlib.ExtendedBinder.«term∀___,_»
               ...
               («binderTerm∈_» "∈" `C0)
               ","
               (Term.forall "∀" [] "," (Term.proj (Init.Core.«term_∩_» `AA " ∩ " `B) "." `Nonempty)))))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
               ...
               (group
                (Tactic.tacticHave_
                 ...
                 (Term.haveDecl
                  (Term.haveIdDecl
                   []
                   [(Term.typeSpec ":" (Term.proj (Init.Core.«term_∩_» `Q " ∩ " (Term.app `cl [`A])) "." `Nonempty))]
                   ":="
                   (Term.app `Filter.nonempty_of_mem [(Term.app `inter_mem [`hQ `hF])]))))
                [])
               (group
                (Tactic.rcases
                 "rcases"
                 ...
                 ["with"
                  (Tactic.rcasesPat.tuple
                   ...
                   [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `q)]) [])
                    ...
                    ","
                    (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `hq3)]) [])]
                   "⟩")])
                [])
               (group (Tactic.refine' "refine'" (Term.anonymousCtor "⟨" [`P "," `hq2 "," (Term.hole "_")] "⟩")) [])
               (group
                (Tactic.rwSeq
                 "rw"
                 []
                 (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `hq3)] "]")
                 [(Tactic.location "at" (Tactic.locationHyp [`hq1] []))])
                [])
               (group (Tactic.simpa "simpa" [] [] [] [] []) [])]))))))
        [])
       (group
        (Tactic.tacticSuffices_
         ...
         (Term.sufficesDecl
          ...
          (Term.forall
           "∀"
           [(Term.simpleBinder [`T] [(Term.typeSpec ":" `fsu)])]
           ","
           (Term.arrow
            (Init.Core.«term_⊆_» (Term.app `ι [`T]) " ⊆ " `C1)
            "→"
            (Term.proj (Set.Data.Set.Lattice.«term⋂₀_» "⋂₀" (Term.app `ι [`T])) "." `Nonempty)))
          (Term.byTactic
           "by"
           (Tactic.tacticSeq
            (Tactic.tacticSeq1Indented
               ...
               (Tactic.obtain
                ...
                [(Tactic.rcasesPatMed
                  [(Tactic.rcasesPat.tuple
                    ...
                    "⟩")])]
                []
                [":=" [(Term.app `exists_ultrafilter_of_finite_inter_nonempty [(Term.hole "_") `this])]])
               [])
              (group (Tactic.use "use" [(Term.app `X.join [`G])]) [])
              (group
               (Tactic.tacticHave_
                "have"
                (Term.haveDecl
                 (Term.haveIdDecl
                  []
                  [(Term.typeSpec ":" («term_=_» (Term.app `G.map [`X.str]) "=" `F))]
                  ":="
                  (Term.app
                   (Term.proj `Ultrafilter.coe_le_coe "." (fieldIdx "1"))
                   [(Term.fun
                     "fun"
                     (Term.basicFun
                      [(Term.simpleBinder [`S `hS] [])]
                      "=>"
                      (Term.app `h1 [(Term.app `Or.inr [(Term.anonymousCtor "⟨" [`S "," `hS "," `rfl] "⟩")])])))]))))
               [])
              (group
               (Tactic.rwSeq
                "rw"
                []
                (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `join_distrib) "," (Tactic.rwRule [] `this)] "]")
                [])
               [])
              (group
               (Tactic.exact "exact" (Term.anonymousCtor "⟨" [(Term.app `h1 [(Term.app `Or.inl [`rfl])]) "," `rfl] "⟩"))
               [])])))))
        [])
       (group
        (Tactic.tacticHave_
         "have"
         (Term.haveDecl (Term.haveIdDecl [`claim4 []] [] ":=" (Term.app `finite_inter_closure_has_finite_inter [`C1]))))
        [])
       (group
        (Tactic.tacticHave_
         "have"
         (Term.haveDecl
          (Term.haveIdDecl
           [`claim5 []]
           [(Term.typeSpec ":" (Term.app `HasFiniteInter [`C0]))]
           ":="
           (Term.anonymousCtor
            "⟨"
            [(Term.anonymousCtor "⟨" [(Term.hole "_") "," `univ_mem "," `Set.preimage_univ] "⟩") "," `claim1]
            "⟩"))))
        [])
       (group
        (Tactic.tacticHave_
             ...
             (Term.forall
              ...
              (Mathlib.ExtendedBinder.«term∀___,_»
               ...
               (Term.forall
                ...
                ","
                (Term.proj
                 (Term.paren "(" [`P [(Term.typeAscription ":" (Term.app `Set [(Term.app `Ultrafilter [`X])]))]] ")")
                 "."
                 `Nonempty)))))]
           ":="
           (Term.byTactic
                    ...
                    (Term.forall
                     ...
                     («term_∨_»
                      ...
                      (Mathlib.ExtendedBinder.«term∃___,_»
                       ...
                       («binderTerm∈_» "∈" `C0)
                       ","
                       («term_=_» `P "=" (Init.Core.«term_∩_» `AA " ∩ " `Q)))))))
                  (Term.byTactic
                   "by"
                   (Tactic.tacticSeq
                    (Tactic.tacticSeq1Indented
                     [(group (Tactic.intro "intro" [`P `hP]) [])
                      (group (Tactic.cases "cases" [(Tactic.casesTarget [] (Term.app `this [`P `hP]))] [] []) [])
                      (group
                       (Tactic.«tactic·._»
                        "·"
                        (Tactic.tacticSeq
                         (Tactic.tacticSeq1Indented
                          [(group (Tactic.exact "exact" (Term.app `claim2 [(Term.hole "_") `h])) [])])))
                       [])
                      (group
                       (Tactic.«tactic·._»
                        "·"
                            ...
                            (Tactic.rcases
                             ...
                             ["with"
                              (Tactic.rcasesPat.tuple
                               ...
                               "⟩")])
                            [])
                           (group (Tactic.exact "exact" (Term.app `claim3 [(Term.hole "_") `hQ])) [])])))
                       [])])))))
                [])
               (group (Tactic.intro "intro" [`P `hP]) [])
               (group
                (Tactic.exact "exact" (Term.app `claim5.finite_inter_closure_insert [(Term.hole "_") `hP]))
                [])]))))))
        [])
       ...
       (group
        (Tactic.tacticSuffices_
         ...
         (Term.sufficesDecl
          []
          (Init.Core.«term_∈_» (Set.Data.Set.Lattice.«term⋂₀_» "⋂₀" (Term.app `ι [`T])) " ∈ " `C2)
          (Term.byTactic
           "by"
           (Tactic.tacticSeq
            (Tactic.tacticSeq1Indented
             [(group (Tactic.exact "exact" (Term.app `claim6 [(Term.hole "_") `this])) [])])))))
        [])
       (group (Tactic.apply "apply" `claim4.finite_inter_mem) [])
       (group (Tactic.intro "intro" [`t `ht]) [])
       (group
        (Tactic.exact "exact" (Term.app `finite_inter_closure.basic [(Term.app (Term.explicit "@" `hT) [`t `ht])]))
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `finite_inter_closure.basic [(Term.app (Term.explicit "@" `hT) [`t `ht])])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.explicit "@" `hT) [`t `ht])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app (Term.explicit "@" `hT) [`t `ht]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.apply "apply" `claim4.finite_inter_mem)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.apply', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `claim4.finite_inter_mem
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
  ...
  (Tactic.tacticSuffices_
   ...
   (Term.sufficesDecl
    ...
    (Term.byTactic
     "by"
     (Tactic.tacticSeq
      (Tactic.tacticSeq1Indented [(group (Tactic.exact "exact" (Term.app `claim6 [(Term.hole "_") `this])) [])])))))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `claim6 [(Term.hole "_") `this]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `claim6 [(Term.hole "_") `this])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 51 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 50, term))
  (Set.Data.Set.Lattice.«term⋂₀_» "⋂₀" (Term.app `ι [`T]))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 110 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] ...precedences are 50 >? 110, (some 110, term) <=? (some 50, term)
      ...
      (Tactic.tacticSeq
       (Tactic.tacticSeq1Indented
        [(group
          ...
          [])
         (group (Tactic.intro "intro" [`P `hP]) [])
         (group (Tactic.exact "exact" (Term.app `claim5.finite_inter_closure_insert [(Term.hole "_") `hP])) [])]))))))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `claim5.finite_inter_closure_insert [(Term.hole "_") `hP])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `claim5.finite_inter_closure_insert
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
       ...
       [(group (Tactic.intro "intro" [`P `hP]) [])
        ...
        (group
         (Tactic.«tactic·._»
          "·"
          (Tactic.tacticSeq
           (Tactic.tacticSeq1Indented [(group (Tactic.exact "exact" (Term.app `claim2 [(Term.hole "_") `h])) [])])))
         [])
        (group
         (Tactic.«tactic·._»
          "·"
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `claim3 [(Term.hole "_") `hQ]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `claim3 [(Term.hole "_") `hQ])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `claim2 [(Term.hole "_") `h]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `claim2 [(Term.hole "_") `h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.cases "cases" [(Tactic.casesTarget [] (Term.app `this [`P `hP]))] [] [])
...
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 30 >? 1022, (some 0, term) <=? (none, [anonymous])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Set [(Term.app `Ultrafilter [`X])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Ultrafilter [`X]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `Set
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.anonymousCtor "⟨" [(Term.hole "_") "," `univ_mem "," `Set.preimage_univ] "⟩")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.anonymousCtor.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.haveIdDecl', expected 'Lean.Parser.Term.haveIdDecl.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `finite_inter_closure_has_finite_inter [`C1])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.anonymousCtor "⟨" [(Term.app `h1 [(Term.app `Or.inl [`rfl])]) "," `rfl] "⟩")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.anonymousCtor.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `h1 [(Term.app `Or.inl [`rfl])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `join_distrib) "," (Tactic.rwRule [] `this)] "]") [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Or.inr [(Term.anonymousCtor "⟨" [`S "," `hS "," `rfl] "⟩")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_=_» (Term.app `G.map [`X.str]) "=" `F)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_=_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `F
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.use "use" [(Term.app `X.join [`G])])
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 110 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] ...precedences are 0 >? 110, (some 110, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Set.Data.Set.Lattice.«term⋂₀_» "⋂₀" (Term.app `ι [`T])) []]
 ")")
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.refine' "refine'" (Term.anonymousCtor "⟨" [`P "," `hq2 "," (Term.hole "_")] "⟩"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.refine'', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.anonymousCtor "⟨" [`P "," `hq2 "," (Term.hole "_")] "⟩")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.anonymousCtor.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `inter_mem [`hQ `hF]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Init.Core.«term_∩_» `Q " ∩ " (Term.app `cl [`A])) "." `Nonempty)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Init.Core.«term_∩_» `Q " ∩ " (Term.app `cl [`A]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Core.«term_∩_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `cl [`A])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Init.Core.«term_∩_» `Q " ∩ " (Term.app `cl [`A])) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.forall', expected 'Lean.Parser.Term.forall.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Init.Core.«term_∩_» `AA " ∩ " `B) "." `Nonempty)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Init.Core.«term_∩_» `AA " ∩ " `B)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Core.«term_∩_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `B
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 70 >? 1024, (none, [anonymous]) <=? (some 70, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 70, (some 71, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Init.Core.«term_∩_» `AA " ∩ " `B) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 0, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«binderTerm∈_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.use "use" [(Term.app `X.incl [`q])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.use', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `X.incl [`q])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.obtain
   "obtain"
   [(Tactic.rcasesPatMed
     [(Tactic.rcasesPat.tuple "⟨" [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `q)]) [])] "⟩")])]
   []
   [":=" [(Term.app `Filter.nonempty_of_mem [`hQ])]])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.obtain', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'null', expected 'optional.antiquot_scope'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `inter_sets [(Term.hole "_") `hQ `hR]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `inter_sets [(Term.hole "_") `hQ `hR])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.use "use" [(Init.Core.«term_∩_» `Q " ∩ " `R)])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.use', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `finite_inter_closure [`C1])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.tacticLet_ "let" (Term.letDecl (Term.letIdDecl `C1 [] ":=" (Term.app `insert [`AA `C0]))))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticLet_', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.letDecl', expected 'Lean.Parser.Term.letDecl.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.letIdDecl', expected 'Lean.Parser.Term.letIdDecl.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `insert [`AA `C0])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 51 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 50, term))
  (Set.Data.Set.Basic.«term_⁻¹'_» `X.str " ⁻¹' " `B)
        ...
        rintro _ ⟨ F , hF , rfl ⟩
          ...
          have
            claim2
              : ∀ , ∀ B ∈ C0 , ∀ , Set.Nonempty B
              :=
              by rintro B ⟨ Q , hQ , rfl ⟩ obtain ⟨ q ⟩ := Filter.nonempty_of_mem hQ use X.incl q simpa
          have
            claim3
              : ∀ , ∀ B ∈ C0 , ∀ , AA ∩ B . Nonempty
              :=
          ...
          have
            claim6
              : ∀ , ∀ P ∈ C2 , ∀ , ( P : Set Ultrafilter X ) . Nonempty
              :=
              by
                suffices
                    ∀ , ∀ P ∈ C2 , ∀ , P ∈ C0 ∨ ∃ Q ∈ C0 , P = AA ∩ Q
                      by
...
-- ././Mathport/Syntax/Translate/Basic.lean:477:2: warning: expanding binder collection (S1 S2 «expr ∈ » T0)
/- failed to parenthesize: parenthesize: uncaught backtrack exception
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers [] [] [] [] [] [])
 (Command.theorem
  "theorem"
  (Command.declId `str_eq_of_le_nhds [])
  (Command.declSig
   [(Term.implicitBinder "{" [`X] [":" `Compactum] "}")
    (Term.explicitBinder "(" [`F] [":" (Term.app `Ultrafilter [`X])] [] ")")
    (Term.explicitBinder "(" [`x] [":" `X] [] ")")]
   (Term.typeSpec
    ":"
    (Term.arrow
     («term_≤_» (Init.Coe.«term↑_» "↑" `F) "≤" (Term.app (Topology.Basic.term𝓝 "𝓝") [`x]))
     "→"
     («term_=_» (Term.app `X.str [`F]) "=" `x))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
      ...
      [(group
       ...
       (group
        (Tactic.tacticLet_
         "let"
         (Term.letDecl
          (Term.letIdDecl `AA [] ":=" (Set.Data.Set.Basic.«term_⁻¹'_» `X.str " ⁻¹' " (Set.«term{_}» "{" [`x] "}")))))
        [])
       (group (Tactic.tacticLet_ "let" (Term.letDecl (Term.letIdDecl `T1 [] ":=" (Term.app `insert [`AA `T0])))) [])
       (group
        (Tactic.tacticLet_ "let" (Term.letDecl (Term.letIdDecl `T2 [] ":=" (Term.app `finite_inter_closure [`T1]))))
        [])
       (group (Tactic.intro "intro" [`cond]) [])
       (group
        (Tactic.tacticHave_
         "have"
         (Term.haveDecl
          (Term.haveIdDecl
           ...
           [(Term.typeSpec
             ...
             (Term.forall
              "∀"
              [(Term.simpleBinder [`A] [(Term.typeSpec ":" (Term.app `Set [`X]))])]
              ","
              (Term.arrow
               (Term.app `IsClosed [`A])
               "→"
               (Term.arrow (Init.Core.«term_∈_» `A " ∈ " `F) "→" (Init.Core.«term_∈_» `x " ∈ " `A)))))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(group (Tactic.intro "intro" [`A `hA `h]) [])
               (group (byContra "by_contra" [`H]) [])
               (group
                (Tactic.rwSeq
                 "rw"
                 []
                 (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `le_nhds_iff)] "]")
                 [(Tactic.location "at" (Tactic.locationHyp [`cond] []))])
                [])
               (group
                (Tactic.specialize
                 "specialize"
                 (Term.app `cond [(Order.BooleanAlgebra.«term_ᶜ» `A "ᶜ") `H `hA.is_open_compl]))
                [])
               (group
                (Tactic.rwSeq
                 "rw"
                 ...
                 (Tactic.rwRuleSeq
                  "["
                  [(Tactic.rwRule [] `Ultrafilter.mem_coe) "," (Tactic.rwRule [] `Ultrafilter.compl_mem_iff_not_mem)]
                  "]")
                 [(Tactic.location "at" (Tactic.locationHyp [`cond] []))])
                [])
          ...
          (Term.haveIdDecl
           ...
           [(Term.typeSpec
             ...
             (Term.forall
              ...
              [(Term.simpleBinder [`A] [(Term.typeSpec ":" (Term.app `Set [`X]))])]
              ","
              (Term.arrow (Init.Core.«term_∈_» `A " ∈ " `F) "→" (Init.Core.«term_∈_» `x " ∈ " (Term.app `cl [`A])))))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
               ...
               (group
                (Tactic.exact
                 ...
                 (Term.app
                  `claim1
                  [(Term.app `cl [`A])
                   (Term.app `is_closed_cl [`A])
                   (Term.app `mem_of_superset [`hA (Term.app `subset_cl [`A])])]))
                [])]))))))
        [])
       (group
        (Tactic.tacticHave_
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           ...
           [(Term.typeSpec
             ...
             (Term.forall
              "∀"
              [(Term.simpleBinder [`S1 `S2] [])
               (Term.simpleBinder [(Term.hole "_")] [(Term.typeSpec ":" (Init.Core.«term_∈_» `S1 " ∈ " `T0))])
               (Term.simpleBinder [(Term.hole "_")] [(Term.typeSpec ":" (Init.Core.«term_∈_» `S2 " ∈ " `T0))])]
              ","
              (Init.Core.«term_∈_» (Init.Core.«term_∩_» `S1 " ∩ " `S2) " ∈ " `T0)))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(group
                (Tactic.rintro
                 "rintro"
                 [(Tactic.rintroPat.one (Tactic.rcasesPat.one `S1))
                  (Tactic.rintroPat.one (Tactic.rcasesPat.one `S2))
                  (Tactic.rintroPat.one
                   (Tactic.rcasesPat.tuple
                    "⟨"
                    [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `S1)]) [])
                     ","
                  ...
                  (Tactic.rintroPat.one
                   (Tactic.rcasesPat.tuple
                    "⟨"
                    [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `S2)]) [])
                     ","
                     (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `hS2)]) [])
                     ","
                     (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `rfl)]) [])]
                    "⟩"))]
                 [])
                ...
                (Tactic.exact
                 ...
                 (Term.anonymousCtor
                  ...
                  [(Init.Core.«term_∩_» `S1 " ∩ " `S2)
                   ","
                   (Term.app `inter_mem [`hS1 `hS2])
                   ","
                   (Term.byTactic
                    "by"
                    (Tactic.tacticSeq
                     (Tactic.tacticSeq1Indented
                      [(group (Tactic.simp "simp" [] [] ["[" [(Tactic.simpLemma [] [] `basic_inter)] "]"] []) [])])))]
                  "⟩"))
                [])]))))))
        [])
       (group
           ...
           [(Term.typeSpec
             ...
             (Term.forall
              ...
              (Mathlib.ExtendedBinder.«term∀___,_»
               ...
               («binderTerm∈_» "∈" `T0)
               ","
               (Term.forall "∀" [] "," (Term.proj (Init.Core.«term_∩_» `AA " ∩ " `S) "." `Nonempty)))))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(group
               ...
               (group
                (Tactic.rcases
                 "rcases"
                 [(Tactic.casesTarget [] (Term.app `claim2 [(Term.hole "_") `hS]))]
                 ["with"
                  (Tactic.rcasesPat.tuple
                   "⟨"
                   [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `G)]) [])
                    ...
                    ","
                    (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `hG2)]) [])]
                   "⟩")])
                [])
               (group (Tactic.exact "exact" (Term.anonymousCtor "⟨" [`G "," `hG2 "," `hG] "⟩")) [])]))))))
        [])
       (group
        (Tactic.tacticHave_
         "have"
           ...
           [(Term.typeSpec
             ...
             (Term.forall
              ...
              (Mathlib.ExtendedBinder.«term∀___,_»
               ...
               («binderTerm∈_» "∈" `T0)
               ","
               (Term.forall "∀" [] "," (Term.app `Set.Nonempty [`S])))))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(group
                (Tactic.rintro
                 ...
                 [])
                [])
               (group (Tactic.exact "exact" (Term.anonymousCtor "⟨" [`F "," `hS] "⟩")) [])]))))))
        [])
       (group
        (Tactic.tacticHave_
         "have"
                    ...
                    (Term.forall
                     ...
                     («term_∨_»
                      ...
                      (Mathlib.ExtendedBinder.«term∃___,_»
                       ...
                       («binderTerm∈_» "∈" `T0)
                       ","
                       («term_=_» `S "=" (Init.Core.«term_∩_» `AA " ∩ " `Q)))))))
                  (Term.byTactic
                   "by"
                   (Tactic.tacticSeq
                    (Tactic.tacticSeq1Indented
                     [(group (Tactic.intro "intro" [`S `hS]) [])
                      (group
                       (Tactic.cases'
                        "cases'"
                        [(Tactic.casesTarget [] (Term.app `this [(Term.hole "_") `hS]))]
                        []
                      ...
                      (group
                       (Tactic.«tactic·._»
                        "·"
                        (Tactic.tacticSeq
                         (Tactic.tacticSeq1Indented [(group (Tactic.exact "exact" (Term.app `claim5 [`S `h])) [])])))
                       [])
                      (group
                       (Tactic.«tactic·._»
                        "·"
                            ...
                            (Tactic.rcases
                             ...
                             ["with"
                              (Tactic.rcasesPat.tuple
                               ...
                               "⟩")])
                            [])
                           (group (Tactic.exact "exact" (Term.app `claim4 [`Q `hQ])) [])])))
                       [])])))))
                [])
               (group (Tactic.intro "intro" [`S `hS]) [])
               (group (Tactic.apply "apply" `finite_inter_closure_insert) [])
               (group
                (Tactic.«tactic·._»
                 "·"
                 (Tactic.tacticSeq
                   ...
                   [(group (Tactic.constructor "constructor") [])
                    (group
                     (Tactic.«tactic·._»
                      ...
                      (Tactic.tacticSeq
                       (Tactic.tacticSeq1Indented
                        [(group (Tactic.use "use" [`Set.Univ]) [])
                         (group
                          (Tactic.refine'
                           "refine'"
                           (Term.anonymousCtor
                            "⟨"
                            [(Term.app `Filter.univ_sets [(Term.hole "_")]) "," (Term.hole "_")]
                            "⟩"))
                          [])
                           ...
                           (Tactic.tacticSeq
                            (Tactic.tacticSeq1Indented
                             [(group (Tactic.intro "intro" []) [])
                              (group (Tactic.apply "apply" `Filter.univ_sets) [])])))
                          [])])))
                     [])
                    (group
                     (Tactic.«tactic·._»
                      "·"
                      (Tactic.tacticSeq (Tactic.tacticSeq1Indented [(group (Tactic.exact "exact" `claim3) [])])))
                     [])])))
                [])
               (group
                (Tactic.«tactic·._»
                 "·"
                 (Tactic.tacticSeq (Tactic.tacticSeq1Indented [(group (Tactic.exact "exact" `hS) [])])))
                [])]))))))
        [])
       (group
        (Tactic.tacticSuffices_
         ...
         (Term.sufficesDecl
          ...
          (Term.forall
           "∀"
           [(Term.simpleBinder [`F] [(Term.typeSpec ":" `fsu)])]
           ","
           (Term.arrow
            (Init.Core.«term_⊆_» (Init.Coe.«term↑_» "↑" `F) " ⊆ " `T1)
            "→"
            (Term.proj (Set.Data.Set.Lattice.«term⋂₀_» "⋂₀" (Term.app `ι [`F])) "." `Nonempty)))
          (Term.byTactic
           "by"
           (Tactic.tacticSeq
            (Tactic.tacticSeq1Indented
             [(group
               (Tactic.obtain
                ...
                [(Tactic.rcasesPatMed
                  [(Tactic.rcasesPat.tuple
                    ...
                    "⟩")])]
                []
                [":=" [(Term.app `Ultrafilter.exists_ultrafilter_of_finite_inter_nonempty [(Term.hole "_") `this])]])
               [])
              (group
               (Tactic.tacticHave_
                "have"
                (Term.haveDecl
                 (Term.haveIdDecl
                  [`c1 []]
                  [(Term.typeSpec ":" («term_=_» (Term.app `X.join [`G]) "=" `F))]
                  ":="
                  (Term.app
                   (Term.proj `Ultrafilter.coe_le_coe "." (fieldIdx "1"))
                   [(Term.fun
                     ...
                     (Term.basicFun
                      ...
                      "=>"
                      (Term.app `h1 [(Term.app `Or.inr [(Term.anonymousCtor "⟨" [`P "," `hP "," `rfl] "⟩")])])))]))))
               [])
              (group
               (Tactic.tacticHave_
                "have"
                (Term.haveDecl
                 (Term.haveIdDecl
                  [`c2 []]
                  [(Term.typeSpec ":" («term_=_» (Term.app `G.map [`X.str]) "=" (Term.app `X.incl [`x])))]
                  ":="
                  (Term.byTactic
                   "by"
                   (Tactic.tacticSeq
                    (Tactic.tacticSeq1Indented
                     [(group
                       ...
                       [])
                      (group
                       (Tactic.apply "apply" (Term.app `mem_of_superset [(Term.app `h1 [(Term.app `Or.inl [`rfl])])]))
                       [])
                      (group
                       (Tactic.rintro
                        "rintro"
              ...
              (group
               (Tactic.simp
                ...
                []
                []
                ["[" [(Tactic.simpLemma [] ["←"] `c1) "," (Tactic.simpLemma [] [] `c2)] "]"]
                [])
               [])])))))
        [])
       (group (Tactic.intro "intro" [`T `hT]) [])
        ...
        (Tactic.refine'
         ...
         (Term.app
          ...
          [(Term.hole "_")
           (Term.app
            `finite_inter_mem
            [(Term.app `finite_inter_closure_has_finite_inter [(Term.hole "_")]) (Term.hole "_") (Term.hole "_")])]))
        [])
       (group (Tactic.intro "intro" [`t `ht]) [])
       (group
        (Tactic.exact "exact" (Term.app `finite_inter_closure.basic [(Term.app (Term.explicit "@" `hT) [`t `ht])]))
           ...
           (Tactic.tacticSeq1Indented
            [(group
             ...
             (group
              ...
              [])
             (group
              (Tactic.simp "simp" [] [] ["[" [(Tactic.simpLemma [] ["←"] `c1) "," (Tactic.simpLemma [] [] `c2)] "]"] [])
              [])])))))
       [])
      (group (Tactic.intro "intro" [`T `hT]) [])
      (group
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, term))
  (Term.app `finite_inter_closure_has_finite_inter [(Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(Term.app
   `finite_inter_mem
   [(Term.paren "(" [(Term.app `finite_inter_closure_has_finite_inter [(Term.hole "_")]) []] ")")
    (Term.hole "_")
    (Term.hole "_")])
  []]
 ")")
        ...
        [(group
          (Tactic.refine'
           ...
           (Term.app
            ...
            [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`P `hP] [])] "=>" (Term.hole "_")))]))
          [])
         (group (Tactic.apply "apply" (Term.app `mem_of_superset [(Term.app `h1 [(Term.app `Or.inl [`rfl])])])) [])
         (group
          (Tactic.rintro
           "rintro"
           [(Tactic.rintroPat.one (Tactic.rcasesPat.one `x))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rintro
   ...
   [(Tactic.rintroPat.one (Tactic.rcasesPat.one `x))
    (Tactic.rintroPat.one
     (Tactic.rcasesPat.tuple "⟨" [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `rfl)]) [])] "⟩"))]
   [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rintro', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rintroPat.one', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rintroPat.one', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.apply', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `mem_of_superset [(Term.app `h1 [(Term.app `Or.inl [`rfl])])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `h1 [(Term.paren "(" [(Term.app `Or.inl [`rfl]) []] ")")]) []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `mem_of_superset
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_=_» (Term.app `G.map [`X.str]) "=" (Term.app `X.incl [`x]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_=_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `X.incl [`x])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Or.inr [(Term.anonymousCtor "⟨" [`P "," `hP "," `rfl] "⟩")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Set.Data.Set.Lattice.«term⋂₀_» "⋂₀" (Term.app `ι [`F]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Set.Data.Set.Lattice.«term⋂₀_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `ι [`F])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
                 ...
                 (Tactic.tacticSeq1Indented
                  [(group (Tactic.use "use" [`Set.Univ]) [])
                   (group
                    (Tactic.refine'
                     "refine'"
                     (Term.anonymousCtor "⟨" [(Term.app `Filter.univ_sets [(Term.hole "_")]) "," (Term.hole "_")] "⟩"))
                    [])
                   (group (Tactic.ext "ext" [] []) [])
                   (group
                    (Tactic.refine'
                   ...
                   (group
                    (Tactic.«tactic·._»
                     ...
                     (Tactic.tacticSeq
                      (Tactic.tacticSeq1Indented
                       [(group (Tactic.intro "intro" []) []) (group (Tactic.apply "apply" `Filter.univ_sets) [])])))
                    [])])))
               [])
              (group
               (Tactic.«tactic·._»
    ...
    (Tactic.tacticSeq1Indented
     [(group
      ...
      (group
       ...
       [])
      (group
       (Tactic.«tactic·._» "·" (Tactic.tacticSeq (Tactic.tacticSeq1Indented [(group (Tactic.exact "exact" `hS) [])])))
       [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.byTactic', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.byTactic', expected 'Lean.Parser.Term.byTactic.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq', expected 'Lean.Parser.Tactic.tacticSeq.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.«tactic·._» "·" (Tactic.tacticSeq (Tactic.tacticSeq1Indented [(group (Tactic.exact "exact" `claim3) [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.«tactic·._»', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq', expected 'Lean.Parser.Tactic.tacticSeq.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq1Indented', expected 'Lean.Parser.Tactic.tacticSeqBracketed.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq1Indented', expected 'Lean.Parser.Tactic.tacticSeqBracketed'
      ...
      (group
       (Tactic.refine'
        ...
        (Term.anonymousCtor
         ...
         [(Term.hole "_")
          ","
          (Term.byTactic "by" (Tactic.tacticSeq (Tactic.tacticSeq1Indented [(group (Tactic.tauto "tauto" []) [])])))]
         "⟩"))
       [])
      (group
       (Tactic.«tactic·._»
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.apply "apply" `Filter.univ_sets)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.apply', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `Filter.univ_sets
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Filter.univ_sets [(Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.apply "apply" `finite_inter_closure_insert)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.apply', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      ...
      (Tactic.tacticSeq1Indented
       [(group (Tactic.intro "intro" [`S `hS]) [])
        ...
        (group
         (Tactic.«tactic·._»
          "·"
          (Tactic.tacticSeq (Tactic.tacticSeq1Indented [(group (Tactic.exact "exact" (Term.app `claim5 [`S `h])) [])])))
         [])
        (group
         (Tactic.«tactic·._»
          "·"
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `claim4 [`Q `hQ]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `claim4 [`Q `hQ])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `claim5 [`S `h]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `claim5 [`S `h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.anonymousCtor "⟨" [`F "," `hS] "⟩"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.anonymousCtor "⟨" [`F "," `hS] "⟩")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.anonymousCtor.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.anonymousCtor "⟨" [`G "," `hG2 "," `hG] "⟩"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.anonymousCtor "⟨" [`G "," `hG2 "," `hG] "⟩")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.anonymousCtor.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.casesTarget', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `claim2 [(Term.hole "_") `hS])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.forall', expected 'Lean.Parser.Term.forall.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Init.Core.«term_∩_» `AA " ∩ " `S) "." `Nonempty)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Init.Core.«term_∩_» `AA " ∩ " `S)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Core.«term_∩_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `S
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 70 >? 1024, (none, [anonymous]) <=? (some 70, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 70, (some 71, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Init.Core.«term_∩_» `AA " ∩ " `S) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 0, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«binderTerm∈_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.simp "simp" [] [] ["[" [(Tactic.simpLemma [] [] `basic_inter)] "]"] [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simp', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«]»', expected 'optional.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simpLemma', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simpLemma', expected 'Lean.Parser.Tactic.simpStar'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact
   ...
   (Term.app
    `claim1
    [(Term.app `cl [`A]) (Term.app `is_closed_cl [`A]) (Term.app `mem_of_superset [`hA (Term.app `subset_cl [`A])])]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app
   `claim1
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `subset_cl [`A]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `mem_of_superset [`hA (Term.paren "(" [(Term.app `subset_cl [`A]) []] ")")]) []]
 ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `is_closed_cl [`A]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `cl [`A]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `claim1
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.arrow', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Init.Core.«term_∈_» `x " ∈ " (Term.app `cl [`A]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Core.«term_∈_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `cl [`A])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
    ...
    (Tactic.tacticSeq1Indented
     [(group (Tactic.intro "intro" [`A `hA `h]) [])
      ...
      (group
       ...
       [])
      (group
       (Tactic.specialize "specialize" (Term.app `cond [(Order.BooleanAlgebra.«term_ᶜ» `A "ᶜ") `H `hA.is_open_compl]))
       [])
      (group
       (Tactic.rwSeq
        "rw"
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Order.BooleanAlgebra.«term_ᶜ» `A "ᶜ") []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `cond
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.letIdDecl', expected 'Lean.Parser.Term.letIdDecl.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `finite_inter_closure [`T1])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.tacticLet_ "let" (Term.letDecl (Term.letIdDecl `T1 [] ":=" (Term.app `insert [`AA `T0]))))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticLet_', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.letDecl', expected 'Lean.Parser.Term.letDecl.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.letIdDecl', expected 'Lean.Parser.Term.letIdDecl.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `insert [`AA `T0])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.letIdDecl', expected 'Lean.Parser.Term.letIdDecl.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Set.Data.Set.Basic.«term_⁻¹'_» `X.str " ⁻¹' " (Set.«term{_}» "{" [`x] "}"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Set.Data.Set.Basic.«term_⁻¹'_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Set.«term{_}» "{" [`x] "}")
   ...
   (Term.letDecl
    (Term.letIdDecl
     ...
     (Set.«term{_|_}»
      ...
      `S
      "|"
      (Mathlib.ExtendedBinder.«term∃___,_» "∃" `A («binderTerm∈_» "∈" `F) "," («term_=_» `S "=" (Term.app `basic [`A])))
      "}"))))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticLet_', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.letDecl', expected 'Lean.Parser.Term.letDecl.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.letIdDecl', expected 'Lean.Parser.Term.letIdDecl.antiquot'
      ...
      let fsu := Finset Set Ultrafilter X
        ...
        have
          claim2
            : ∀ A : Set X , A ∈ F → x ∈ cl A
            :=
            by intro A hA exact claim1 cl A is_closed_cl A mem_of_superset hA subset_cl A
        have
          claim3
            : ∀ S1 S2 _ : S1 ∈ T0 _ : S2 ∈ T0 , S1 ∩ S2 ∈ T0
            :=
            by
        ...
        have
          claim4
            : ∀ , ∀ S ∈ T0 , ∀ , AA ∩ S . Nonempty
            :=
            by rintro S ⟨ S , hS , rfl ⟩ rcases claim2 _ hS with ⟨ G , hG , hG2 ⟩ exact ⟨ G , hG2 , hG ⟩
        have claim5 : ∀ , ∀ S ∈ T0 , ∀ , Set.Nonempty S := by rintro S ⟨ S , hS , rfl ⟩ exact ⟨ F , hS ⟩
        have
          claim6
            : ∀ , ∀ S ∈ T2 , ∀ , Set.Nonempty S
            :=
            by
              suffices
                  ∀ , ∀ S ∈ T2 , ∀ , S ∈ T0 ∨ ∃ Q ∈ T0 , S = AA ∩ Q
                    by
                      intro S hS
                        cases' this _ hS with h h
                        · exact claim5 S h
                        · rcases h with ⟨ Q , hQ , rfl ⟩ exact claim4 Q hQ
                intro S hS
