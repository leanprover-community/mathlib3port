...
lean 3 declaration is
  forall (m : Type.{u1}) (n : Type.{u2}) (𝕜 : Type.{u3}) [_inst_1 : UniformSpace.{u3} 𝕜], Eq.{succ (max u1 u2 u3)} (Filter.{max u1 u2 u3} (Prod.{max u1 u2 u3, max u1 u2 u3} (Matrix.{u1, u2, u3} m n 𝕜) (Matrix.{u1, u2, u3} m n 𝕜))) (uniformity.{max u1 u2 u3} (Matrix.{u1, u2, u3} m n 𝕜) (Matrix.uniformSpace.{u1, u2, u3} m n 𝕜 _inst_1)) (iInf.{max u1 u2 u3, succ u1} (Filter.{max u1 u2 u3} (Prod.{max u1 u2 u3, max u1 u2 u3} (Matrix.{u1, u2, u3} m n 𝕜) (Matrix.{u1, u2, u3} m n 𝕜))) (ConditionallyCompleteLattice.toHasInf.{max u1 u2 u3} (Filter.{max u1 u2 u3} (Prod.{max u1 u2 u3, max u1 u2 u3} (Matrix.{u1, u2, u3} m n 𝕜) (Matrix.{u1, u2, u3} m n 𝕜))) (CompleteLattice.toConditionallyCompleteLattice.{max u1 u2 u3} (Filter.{max u1 u2 u3} (Prod.{max u1 u2 u3, max u1 u2 u3} (Matrix.{u1, u2, u3} m n 𝕜) (Matrix.{u1, u2, u3} m n 𝕜))) (Filter.completeLattice.{max u1 u2 u3} (Prod.{max u1 u2 u3, max u1 u2 u3} (Matrix.{u1, u2, u3} m n 𝕜) (Matrix.{u1, u2, u3} m n 𝕜))))) m (fun (i : m) => iInf.{max u1 u2 u3, succ u2} (Filter.{max u1 u2 u3} (Prod.{max u1 u2 u3, max u1 u2 u3} (Matrix.{u1, u2, u3} m n 𝕜) (Matrix.{u1, u2, u3} m n 𝕜))) (ConditionallyCompleteLattice.toHasInf.{max u1 u2 u3} (Filter.{max u1 u2 u3} (Prod.{max u1 u2 u3, max u1 u2 u3} (Matrix.{u1, u2, u3} m n 𝕜) (Matrix.{u1, u2, u3} m n 𝕜))) (CompleteLattice.toConditionallyCompleteLattice.{max u1 u2 u3} (Filter.{max u1 u2 u3} (Prod.{max u1 u2 u3, max u1 u2 u3} (Matrix.{u1, u2, u3} m n 𝕜) (Matrix.{u1, u2, u3} m n 𝕜))) (Filter.completeLattice.{max u1 u2 u3} (Prod.{max u1 u2 u3, max u1 u2 u3} (Matrix.{u1, u2, u3} m n 𝕜) (Matrix.{u1, u2, u3} m n 𝕜))))) n (fun (j : n) => Filter.comap.{max u1 u2 u3, u3} (Prod.{max u1 u2 u3, max u1 u2 u3} (Matrix.{u1, u2, u3} m n 𝕜) (Matrix.{u1, u2, u3} m n 𝕜)) (Prod.{u3, u3} 𝕜 𝕜) (fun (a : Prod.{max u1 u2 u3, max u1 u2 u3} (Matrix.{u1, u2, u3} m n 𝕜) (Matrix.{u1, u2, u3} m n 𝕜)) => Prod.mk.{u3, u3} 𝕜 𝕜 (Prod.fst.{max u1 u2 u3, max u1 u2 u3} (Matrix.{u1, u2, u3} m n 𝕜) (Matrix.{u1, u2, u3} m n 𝕜) a i j) (Prod.snd.{max u1 u2 u3, max u1 u2 u3} (Matrix.{u1, u2, u3} m n 𝕜) (Matrix.{u1, u2, u3} m n 𝕜) a i j)) (uniformity.{u3} 𝕜 _inst_1))))
but is expected to have type
  forall (m : Type.{u3}) (n : Type.{u2}) (𝕜 : Type.{u1}) [_inst_1 : UniformSpace.{u1} 𝕜], Eq.{max (max (succ u3) (succ u2)) (succ u1)} (Filter.{max (max u1 u2) u3} (Prod.{max (max u1 u2) u3, max (max u1 u2) u3} (Matrix.{u3, u2, u1} m n 𝕜) (Matrix.{u3, u2, u1} m n 𝕜))) (uniformity.{max (max u1 u2) u3} (Matrix.{u3, u2, u1} m n 𝕜) (Matrix.instUniformSpaceMatrix.{u3, u2, u1} m n 𝕜 _inst_1)) (iInf.{max (max u3 u2) u1, succ u3} (Filter.{max (max u3 u2) u1} (Prod.{max (max u1 u2) u3, max (max u1 u2) u3} (Matrix.{u3, u2, u1} m n 𝕜) (Matrix.{u3, u2, u1} m n 𝕜))) (ConditionallyCompleteLattice.toInfSet.{max (max u3 u2) u1} (Filter.{max (max u3 u2) u1} (Prod.{max (max u1 u2) u3, max (max u1 u2) u3} (Matrix.{u3, u2, u1} m n 𝕜) (Matrix.{u3, u2, u1} m n 𝕜))) (CompleteLattice.toConditionallyCompleteLattice.{max (max u3 u2) u1} (Filter.{max (max u3 u2) u1} (Prod.{max (max u1 u2) u3, max (max u1 u2) u3} (Matrix.{u3, u2, u1} m n 𝕜) (Matrix.{u3, u2, u1} m n 𝕜))) (Filter.instCompleteLatticeFilter.{max (max u3 u2) u1} (Prod.{max (max u1 u2) u3, max (max u1 u2) u3} (Matrix.{u3, u2, u1} m n 𝕜) (Matrix.{u3, u2, u1} m n 𝕜))))) m (fun (i : m) => iInf.{max (max u3 u2) u1, succ u2} (Filter.{max (max u3 u2) u1} (Prod.{max (max u1 u2) u3, max (max u1 u2) u3} (Matrix.{u3, u2, u1} m n 𝕜) (Matrix.{u3, u2, u1} m n 𝕜))) (ConditionallyCompleteLattice.toInfSet.{max (max u3 u2) u1} (Filter.{max (max u3 u2) u1} (Prod.{max (max u1 u2) u3, max (max u1 u2) u3} (Matrix.{u3, u2, u1} m n 𝕜) (Matrix.{u3, u2, u1} m n 𝕜))) (CompleteLattice.toConditionallyCompleteLattice.{max (max u3 u2) u1} (Filter.{max (max u3 u2) u1} (Prod.{max (max u1 u2) u3, max (max u1 u2) u3} (Matrix.{u3, u2, u1} m n 𝕜) (Matrix.{u3, u2, u1} m n 𝕜))) (Filter.instCompleteLatticeFilter.{max (max u3 u2) u1} (Prod.{max (max u1 u2) u3, max (max u1 u2) u3} (Matrix.{u3, u2, u1} m n 𝕜) (Matrix.{u3, u2, u1} m n 𝕜))))) n (fun (j : n) => Filter.comap.{max (max u3 u2) u1, u1} (Prod.{max (max u1 u2) u3, max (max u1 u2) u3} (Matrix.{u3, u2, u1} m n 𝕜) (Matrix.{u3, u2, u1} m n 𝕜)) (Prod.{u1, u1} 𝕜 𝕜) (fun (a : Prod.{max (max u1 u2) u3, max (max u1 u2) u3} (Matrix.{u3, u2, u1} m n 𝕜) (Matrix.{u3, u2, u1} m n 𝕜)) => Prod.mk.{u1, u1} 𝕜 𝕜 (Prod.fst.{max (max u3 u2) u1, max (max u3 u2) u1} (Matrix.{u3, u2, u1} m n 𝕜) (Matrix.{u3, u2, u1} m n 𝕜) a i j) (Prod.snd.{max (max u3 u2) u1, max (max u3 u2) u1} (Matrix.{u3, u2, u1} m n 𝕜) (Matrix.{u3, u2, u1} m n 𝕜) a i j)) (uniformity.{u1} 𝕜 _inst_1))))
