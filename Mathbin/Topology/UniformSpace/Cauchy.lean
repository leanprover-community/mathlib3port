...
/- ./././Mathport/Syntax/Translate/Basic.lean:610:2: warning: expanding binder collection (m n «expr ≥ » N) -/
-- see Note [nolint_ge]
@[nolint ge_or_gt]
...
def SetSeq (n : ℕ) : Set α :=
  ⋂ m ∈ Set.IicCat n, (setSeqAux hf U_mem m).val
