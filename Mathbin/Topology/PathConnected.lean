...
theorem of_line_mem {f : ℝ → X} (hf : ContinuousOn f I) (h₀ : f 0 = x) (h₁ : f 1 = y) :
    ∀ t, of_line hf h₀ h₁ t ∈ f '' I := fun ⟨t, t_in⟩ => ⟨t, t_in, rfl⟩
...
theorem range_reparam (γ : Path x y) {f : I → I} (hfcont : Continuous f) (hf₀ : f 0 = 0) (hf₁ : f 1 = 1) :
  ...
  have : range f = univ := by
    ...
    intro t
    have h₁ : Continuous (Icc_extend (@zero_le_one ℝ _) f) := by
      continuity
...
theorem joined_in_iff_joined (x_in : x ∈ F) (y_in : y ∈ F) : JoinedIn F x y ↔ Joined (⟨x, x_in⟩ : F) (⟨y, y_in⟩ : F) :=
  ⟨fun h => h.joined_subtype, fun h =>
    ⟨h.some_path.map continuous_subtype_coe, by
      simp ⟩⟩
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " The path component of `x` is the set of points that can be joined to `x`. -/")]
  []
  []
  []
  []
 ...
 (Command.def
  "def"
  (Command.declId `PathComponent [])
  (Command.optDeclSig [(Term.explicitBinder "(" [`x] [":" `X] [] ")")] [])
  (Command.declValSimple ":=" (Set.«term{_|_}» "{" `y "|" (Term.app `Joined [`x `y]) "}") [])
  []
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Set.«term{_|_}» "{" `y "|" (Term.app `Joined [`x `y]) "}")
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `PathComponentIn [])
  (Command.optDeclSig
   [(Term.explicitBinder "(" [`x] [":" `X] [] ")") (Term.explicitBinder "(" [`F] [":" (Term.app `Set [`X])] [] ")")]
   [])
  (Command.declValSimple ":=" (Set.«term{_|_}» "{" `y "|" (Term.app `JoinedIn [`F `x `y]) "}") [])
  []
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Set.«term{_|_}» "{" `y "|" (Term.app `JoinedIn [`F `x `y]) "}")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Set.«term{_|_}»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `JoinedIn [`F `x `y])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
