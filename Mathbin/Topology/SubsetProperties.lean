...
#print IsCompact.inter_iInter_nonempty /-
...
#print Set.Finite.isCompact_biUnion /-
...
#print Finset.isCompact_biUnion /-
...
#print isCompact_open_iff_eq_finite_iUnion_of_isTopologicalBasis /-
...
#print Filter.hasBasis_cocompact /-
...
#print Filter.cocompact_le_cofinite /-
...
#print exists_clusterPt_of_compactSpace /-
theorem exists_clusterPt_of_compactSpace [CompactSpace α] (f : Filter α) [NeBot f] :
    ∃ x, ClusterPt x f := by simpa using isCompact_univ (show f ≤ 𝓟 univ by simp)
...
/- ./././Mathport/Syntax/Translate/Command.lean:400:30: infer kinds are unsupported in Lean 4: #[`noncompact_univ] [] -/
...
theorem isClosedMap_snd_of_compactSpace {X : Type _} [TopologicalSpace X] [CompactSpace X]
  ...
  exact exists_clusterPt_of_compactSpace _
...
/- ./././Mathport/Syntax/Translate/Basic.lean:642:2: warning: expanding binder collection (s «expr ∈ » irreducible_components[irreducible_components] α) -/
...
/- ./././Mathport/Syntax/Translate/Command.lean:400:30: infer kinds are unsupported in Lean 4: #[`isPreirreducible_univ] [] -/
...
/- ./././Mathport/Syntax/Translate/Command.lean:400:30: infer kinds are unsupported in Lean 4: #[`to_nonempty] [] -/
...
#print isIrreducible_iff_sInter /-
...
#print isIrreducible_iff_sUnion_closed /-
