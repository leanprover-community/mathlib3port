...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  ...
  (Command.declSig
   [(Term.explicitBinder "(" [`e] [":" (Term.app `LocalHomeomorph [`α `β])] [] ")")
    (Term.implicitBinder "{" [`x] [] "}")
    (Term.explicitBinder "(" [`hx] [":" (Init.Core.«term_∈_» `x " ∈ " `e.source)] [] ")")]
   (Term.typeSpec
    ":"
    (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
     ...
     ", "
     («term_=_» (Term.app `e.symm [(Term.app `e [`y])]) "=" `y))))
...
theorem
  ...
  ( e : LocalHomeomorph α β ) { x } ( hx : x ∈ e.source ) : ∀ᶠ y in 𝓝 x , e.symm e y = y
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  ...
  (Command.declSig
   [(Term.explicitBinder "(" [`e] [":" (Term.app `LocalHomeomorph [`α `β])] [] ")")
    (Term.implicitBinder "{" [`x] [] "}")
    (Term.explicitBinder "(" [`hx] [":" (Init.Core.«term_∈_» `x " ∈ " `e.target)] [] ")")]
   (Term.typeSpec
    ":"
    (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
     "∀ᶠ"
     (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `y)] []))
     " in "
     (Term.app (Topology.Basic.term𝓝 "𝓝") [(Term.app `e.symm [`x])])
     ", "
     («term_=_» (Term.app `e.symm [(Term.app `e [`y])]) "=" `y))))
...
theorem
  eventually_left_inverse'
  ( e : LocalHomeomorph α β ) { x } ( hx : x ∈ e.target ) : ∀ᶠ y in 𝓝 e.symm x , e.symm e y = y
  ...
  (Command.declSig
   ...
   (Term.typeSpec
    ...
    (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
     ...
     (Term.app (Topology.Basic.term𝓝 "𝓝") [`x])
     ", "
     («term_=_» (Term.app `e [(Term.app `e.symm [`y])]) "=" `y))))
  (Command.declValSimple
   ":="
...
theorem
  ...
  ( e : LocalHomeomorph α β ) { x } ( hx : x ∈ e.target ) : ∀ᶠ y in 𝓝 x , e e.symm y = y
  ...
  (Command.declSig
   ...
   (Term.typeSpec
    ...
    (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
     ...
     (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `y)] []))
     " in "
     (Term.app (Topology.Basic.term𝓝 "𝓝") [(Term.app `e [`x])])
     ", "
     («term_=_» (Term.app `e [(Term.app `e.symm [`y])]) "=" `y))))
...
theorem
  eventually_right_inverse'
  ( e : LocalHomeomorph α β ) { x } ( hx : x ∈ e.source ) : ∀ᶠ y in 𝓝 e x , e e.symm y = y
  ...
  (Command.declSig
   ...
   (Term.typeSpec
    ...
    (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
     ...
     ", "
     («term_≠_» (Term.app `e [`x']) "≠" (Term.app `e [`x])))))
  (Command.declValSimple
   ":="
   («term_$__»
               ...
               (Tactic.rwSeq
                ...
                (Tactic.rwRuleSeq
                 ...
                 [(Tactic.rwRule [] `mem_singleton_iff)
                  ","
                  (Tactic.rwRule ["←"] (Term.app `e.left_inv [`hx]))
                  ","
                  (Tactic.rwRule ["←"] `h)
                  ","
                  (Tactic.rwRule [] `hx')]
...
theorem
  ...
  ( e : LocalHomeomorph α β ) { x } ( hx : x ∈ e.source ) : ∀ᶠ x' in 𝓝[≠] x , e x' ≠ e x
  :=
    eventually_nhds_within_iff . 2
      $
      e.eventually_left_inverse hx . mono
        $
        fun x' hx' => mt $ fun h => by rw [ mem_singleton_iff , ← e.left_inv hx , ← h , hx' ]
  ...
  { toLocalEquiv := LocalEquiv.pi fun i => (ei i).toLocalEquiv,
    ...
    continuous_to_fun :=
      continuous_on_pi.2 $ fun i =>
        (ei i).ContinuousOn.comp (continuous_apply _).ContinuousOn fun f hf => hf i trivialₓ,
    continuous_inv_fun :=
      continuous_on_pi.2 $ fun i =>
