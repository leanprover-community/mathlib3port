...
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (t₂ «expr ∈ » s)
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (x «expr ∈ » «expr ∩ »(t₁, t₂))
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (t₃ «expr ∈ » s)
...
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (o «expr ∈ » b)
...
-- ././Mathport/Syntax/Translate/Basic.lean:452:2: warning: expanding binder collection (V «expr ∈ » T i)
theorem is_topological_basis_pi {ι : Type _} {X : ι → Type _} [∀ i, TopologicalSpace (X i)] {T : ∀ i, Set (Set (X i))}
  ...
  by 
    ...
    ·
      ...
      have  : ∀ i, ∃ (V : _)(_ : V ∈ T i), a i ∈ V ∧ V ⊆ t i := fun i => (cond i).mem_nhds_iff.1 (hta i)
