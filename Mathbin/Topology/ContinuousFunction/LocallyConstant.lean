...
@[simps]
def toContinuousMapLinearMap (R : Type _) [Semiring R] [AddCommMonoid Y] [Module R Y] [HasContinuousAdd Y]
...
@[simps]
def toContinuousMapAlgHom (R : Type _) [CommSemiring R] [Semiring Y] [Algebra R Y] [TopologicalSemiring Y] :
