...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `LowerSemicontinuousWithinAt [])
  (Command.optDeclSig
  ...
  (Command.declValSimple
   ...
   (Term.forall
    ...
    (Mathlib.ExtendedBinder.«term∀___,_»
     "∀"
     `y
     (Mathlib.ExtendedBinder.«binderTerm<_» "<" (Term.app `f [`x]))
     ","
     (Term.forall
      "∀"
      []
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `LowerSemicontinuousAt [])
  (Command.optDeclSig
   [(Term.explicitBinder "(" [`f] [":" (Term.arrow `α "→" `β)] [] ")") (Term.explicitBinder "(" [`x] [":" `α] [] ")")]
   [])
  (Command.declValSimple
   ":="
   (Term.forall
...
/--
    ...
    enough to `x`, then `f x'` is at least `f x - ε`. We formulate this in a general preordered space,
    using an arbitrary `y < f x` instead of `f x - ε`. -/
  def LowerSemicontinuousAt ( f : α → β ) ( x : α ) := ∀ , ∀ y < f x , ∀ , ∀ᶠ x' in 𝓝 x , y < f x'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `UpperSemicontinuousWithinAt [])
  (Command.optDeclSig
   [(Term.explicitBinder "(" [`f] [":" (Term.arrow `α "→" `β)] [] ")")
    (Term.explicitBinder "(" [`s] [":" (Term.app `Set [`α])] [] ")")
    (Term.explicitBinder "(" [`x] [":" `α] [] ")")]
...
/--
    ...
    `x'` close enough to `x` in  `s`, then `f x'` is at most `f x + ε`. We formulate this in a general
    preordered space, using an arbitrary `y > f x` instead of `f x + ε`. -/
  def UpperSemicontinuousWithinAt ( f : α → β ) ( s : Set α ) ( x : α ) := ∀ y , f x < y → ∀ᶠ x' in 𝓝[ s ] x , f x' < y
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `UpperSemicontinuousAt [])
  (Command.optDeclSig
   [(Term.explicitBinder "(" [`f] [":" (Term.arrow `α "→" `β)] [] ")") (Term.explicitBinder "(" [`x] [":" `α] [] ")")]
   [])
  (Command.declValSimple
...
/--
    ...
    enough to `x`, then `f x'` is at most `f x + ε`. We formulate this in a general preordered space,
    using an arbitrary `y > f x` instead of `f x + ε`. -/
  def UpperSemicontinuousAt ( f : α → β ) ( x : α ) := ∀ y , f x < y → ∀ᶠ x' in 𝓝 x , f x' < y
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `IsOpen.lower_semicontinuous_indicator [])
  (Command.declSig
   [(Term.explicitBinder "(" [`hs] [":" (Term.app `IsOpen [`s])] [] ")")
    (Term.explicitBinder "(" [`hy] [":" («term_≤_» (numLit "0") "≤" `y)] [] ")")]
   (Term.typeSpec
    ":"
    (Term.app
     `LowerSemicontinuous
     [(Term.app `indicator [`s (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`x] [])] "=>" `y))])])))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group (Tactic.intro "intro" [`x `z `hz]) [])
       (group
        (Tactic.«tactic_<;>_»
         (Tactic.byCases' "by_cases'" [`h ":"] (Init.Core.«term_∈_» `x " ∈ " `s))
         "<;>"
         (Tactic.simp
          "simp"
          []
       ...
       (group
        (Tactic.«tactic·._»
         ...
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group (Tactic.filterUpwards "filter_upwards" "[" [(Term.app `hs.mem_nhds [`h])] "]" []) [])
            (group
             (Tactic.simp
              "simp"
              ["("
             ...
             (Tactic.«tactic_<;>_»
              ...
              (Tactic.simp
               ...
               ["["
                [(Tactic.simpLemma [] [] `h')
                 ","
                 (Tactic.simpLemma [] [] (Term.app `hz.trans_le [`hy]))
                 ","
                 (Tactic.simpLemma [] [] `hz)]
                "]"]
               []))
  ...
  :=
    by
      intro x z hz
        ...
        · filter_upwards [ hs.mem_nhds h ] simp ( config := { contextual := Bool.true._@._internal._hyg.0 } ) [ hz ]
        · apply Filter.eventually_of_forall fun x' => _ by_cases' h' : x' ∈ s <;> simp [ h' , hz.trans_le hy , hz ]
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `IsClosed.lower_semicontinuous_indicator [])
  (Command.declSig
   [(Term.explicitBinder "(" [`hs] [":" (Term.app `IsClosed [`s])] [] ")")
    (Term.explicitBinder "(" [`hy] [":" («term_≤_» `y "≤" (numLit "0"))] [] ")")]
   (Term.typeSpec
    ":"
    (Term.app
     `LowerSemicontinuous
      ...
      [(group (Tactic.intro "intro" [`x `z `hz]) [])
       ...
       (group
        (Tactic.«tactic·._»
         ...
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group (Tactic.filterUpwards "filter_upwards" "[" [(Term.app `hs.is_open_compl.mem_nhds [`h])] "]" []) [])
            (group
             (Tactic.simp
              "simp"
              ["("
...
theorem
  ...
  :=
    by
      intro x z hz
        by_cases' h : x ∈ s <;> simp [ h ] at hz
        · apply Filter.eventually_of_forall fun x' => _ by_cases' h' : x' ∈ s <;> simp [ h' , hz , hz.trans_le hy ]
        ·
...
theorem LowerSemicontinuousWithinAt.add' {f g : α → γ} (hf : LowerSemicontinuousWithinAt f s x)
  ...
  ·
    ...
    ·
      ...
      calc y < min (f z) (f x)+min (g z) (g x) := h this _ ≤ f z+g z := add_le_add (min_le_leftₓ _ _) (min_le_leftₓ _ _)
    ·
...
theorem LowerSemicontinuous.add' {f g : α → γ} (hf : LowerSemicontinuous f) (hg : LowerSemicontinuous g)
    (hcont : ∀ x, ContinuousAt (fun p : γ × γ => p.1+p.2) (f x, g x)) : LowerSemicontinuous fun z => f z+g z := fun x =>
  (hf x).add' (hg x) (hcont x)
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `lower_semicontinuous_within_at_sum [])
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.arrow `ι "→" (Term.arrow `α "→" `γ))] "}")
    (Term.implicitBinder "{" [`a] [":" (Term.app `Finset [`ι])] "}")
    (Term.explicitBinder
     "("
     [`ha]
     [":"
      (Term.forall
       ...
       (Mathlib.ExtendedBinder.«term∀___,_»
        ...
        («binderTerm∈_» "∈" `a)
        ","
        (Term.forall "∀" [] "," (Term.app `LowerSemicontinuousWithinAt [(Term.app `f [`i]) `s `x]))))]
     []
     ")")]
   (Term.typeSpec
    ":"
      ...
      [(group (Tactic.classical "classical") [])
       (group
        (Tactic.induction'
         ...
         ["with" [(Lean.binderIdent `i) (Lean.binderIdent `a) (Lean.binderIdent `ia) (Lean.binderIdent `IH)]]
         ["generalizing" [`ha]])
        [])
       (group
        (Tactic.«tactic·._»
         "·"
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented [(group (Tactic.exact "exact" `lower_semicontinuous_within_at_const) [])])))
        [])
       (group
        (Tactic.«tactic·._»
         "·"
            ...
            (group
             (Tactic.exact
              ...
              (Term.app
               ...
               [(Term.app `ha [(Term.hole "_") (Term.app `Finset.mem_insert_self [`i `a])])
                (Term.app
                 `IH
                 [(Term.fun
                   "fun"
                   (Term.basicFun
                    [(Term.simpleBinder [`j `ja] [])]
                    "=>"
                    (Term.app `ha [`j (Term.app `Finset.mem_insert_of_mem [`ja])])))])]))
             [])])))
        [])])))
   [])
  []
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Finset.mem_insert_of_mem [`ja])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Finset.mem_insert_of_mem [`ja]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
 ...
 [(Term.app
   ...
   [(Term.fun
     ...
     (Term.basicFun
      [(Term.simpleBinder [`j `ja] [])]
      "=>"
      (Term.app `ha [`j (Term.paren "(" [(Term.app `Finset.mem_insert_of_mem [`ja]) []] ")")])))])
  []]
 ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Finset.mem_insert_self [`i `a])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Finset.mem_insert_self [`i `a]) []] ")")
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `ha [(Term.hole "_") (Term.paren "(" [(Term.app `Finset.mem_insert_self [`i `a]) []] ")")]) []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `LowerSemicontinuousWithinAt.add
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" `lower_semicontinuous_within_at_const)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `lower_semicontinuous_within_at_const
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
      ...
      classical
        ...
        ·
          simp only [ ia , Finset.sum_insert , not_false_iff ]
            exact
              LowerSemicontinuousWithinAt.add
                ha _ Finset.mem_insert_self i a IH fun j ja => ha j Finset.mem_insert_of_mem ja
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `lower_semicontinuous_at_sum [])
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.arrow `ι "→" (Term.arrow `α "→" `γ))] "}")
    (Term.implicitBinder "{" [`a] [":" (Term.app `Finset [`ι])] "}")
    (Term.explicitBinder
     ...
     [":"
      (Term.forall
       ...
       (Mathlib.ExtendedBinder.«term∀___,_»
        ...
        («binderTerm∈_» "∈" `a)
        ","
        (Term.forall "∀" [] "," (Term.app `LowerSemicontinuousAt [(Term.app `f [`i]) `x]))))]
     []
     ")")]
   (Term.typeSpec
    ":"
    ...
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.simpRw
         "simp_rw"
         (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `lower_semicontinuous_within_at_univ_iff)] "]")
         [(Tactic.location "at" (Tactic.locationWildcard "*"))])
        [])
       (group (Tactic.exact "exact" (Term.app `lower_semicontinuous_within_at_sum [`ha])) [])])))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `lower_semicontinuous_within_at_sum [`ha]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `lower_semicontinuous_within_at_sum [`ha])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
theorem
  ...
  := by simp_rw [ ← lower_semicontinuous_within_at_univ_iff ] at * exact lower_semicontinuous_within_at_sum ha
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `lower_semicontinuous_on_sum [])
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.arrow `ι "→" (Term.arrow `α "→" `γ))] "}")
    (Term.implicitBinder "{" [`a] [":" (Term.app `Finset [`ι])] "}")
    (Term.explicitBinder
     ...
     [":"
      (Term.forall
       ...
       (Mathlib.ExtendedBinder.«term∀___,_»
        ...
        («binderTerm∈_» "∈" `a)
        ","
        (Term.forall "∀" [] "," (Term.app `LowerSemicontinuousOn [(Term.app `f [`i]) `s]))))]
     []
     ")")]
   (Term.typeSpec
    ":"
  ...
  (Command.declValSimple
   ...
   (Term.fun
    ...
    (Term.basicFun
     ...
     (Term.app
      `lower_semicontinuous_within_at_sum
      [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`i `hi] [])] "=>" (Term.app `ha [`i `hi `x `hx])))])))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `lower_semicontinuous_sum [])
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.arrow `ι "→" (Term.arrow `α "→" `γ))] "}")
    (Term.implicitBinder "{" [`a] [":" (Term.app `Finset [`ι])] "}")
    (Term.explicitBinder
     ...
     [":"
      (Term.forall
       ...
       (Mathlib.ExtendedBinder.«term∀___,_»
        ...
        («binderTerm∈_» "∈" `a)
        ","
        (Term.forall "∀" [] "," (Term.app `LowerSemicontinuous [(Term.app `f [`i])]))))]
     []
     ")")]
   (Term.typeSpec
    ":"
  ...
  (Command.declValSimple
   ...
   (Term.fun
    ...
    (Term.basicFun
     ...
     (Term.app
      `lower_semicontinuous_at_sum
      [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`i `hi] [])] "=>" (Term.app `ha [`i `hi `x])))])))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
theorem
  ...
  { f : ι → α → γ } { a : Finset ι } ( ha : ∀ , ∀ i ∈ a , ∀ , LowerSemicontinuous f i )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `lower_semicontinuous_within_at_supr [])
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.arrow `ι "→" (Term.arrow `α "→" `δ))] "}")
    (Term.explicitBinder
     "("
     [`h]
     [":"
      (Term.forall
       ...
       [(Term.simpleBinder [`i] [])]
       ","
       (Term.app `LowerSemicontinuousWithinAt [(Term.app `f [`i]) `s `x]))]
     []
     ")")]
   (Term.typeSpec
    ":"
     ...
     (Tactic.tacticSeq1Indented
      [(group (Tactic.intro "intro" [`y `hy]) [])
       (group
        (Tactic.rcases
         "rcases"
         [(Tactic.casesTarget [] (Term.app (Term.proj `lt_supr_iff "." (fieldIdx "1")) [`hy]))]
         ["with"
          (Tactic.rcasesPat.tuple
           ...
           "⟩")])
        [])
       (group (Tactic.filterUpwards "filter_upwards" "[" [(Term.app `h [`i `y `hi])] "]" []) [])
       (group (Tactic.intro "intro" [`x' `hx']) [])
       (group
        (Tactic.exact
         "exact"
         (Term.app (Term.proj `lt_supr_iff "." (fieldIdx "2")) [(Term.anonymousCtor "⟨" [`i "," `hx'] "⟩")]))
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj `lt_supr_iff "." (fieldIdx "2"))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.filterUpwards "filter_upwards" "[" [(Term.app `h [`i `y `hi])] "]" [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.casesTarget', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.proj `lt_supr_iff "." (fieldIdx "1")) [`hy])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `lower_semicontinuous_within_at_bsupr [])
  (Command.declSig
   [(Term.implicitBinder "{" [`p] [":" (Term.arrow `ι "→" (Term.prop "Prop"))] "}")
    (Term.implicitBinder
     ...
     [":"
      (Term.forall
       "∀"
       [(Term.simpleBinder [`i] []) (Term.simpleBinder [`h] [(Term.typeSpec ":" (Term.app `p [`i]))])]
       ","
       (Term.arrow `α "→" `δ))]
     "}")
    (Term.explicitBinder
     ...
     [":"
      (Term.forall
       ...
       ","
       (Term.app `LowerSemicontinuousWithinAt [(Term.app `f [`i `hi]) `s `x]))]
     []
     ")")]
   (Term.typeSpec
    ":"
...
theorem
  ...
  { p : ι → Prop } { f : ∀ i h : p i , α → δ } ( h : ∀ i hi , LowerSemicontinuousWithinAt f i hi s x )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `lower_semicontinuous_at_supr [])
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.arrow `ι "→" (Term.arrow `α "→" `δ))] "}")
    (Term.explicitBinder
     "("
     [`h]
     [":" (Term.forall "∀" [(Term.simpleBinder [`i] [])] "," (Term.app `LowerSemicontinuousAt [(Term.app `f [`i]) `x]))]
     []
     ")")]
   (Term.typeSpec
    ":"
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.simpRw
         ...
         [(Tactic.location "at" (Tactic.locationWildcard "*"))])
        [])
       (group (Tactic.exact "exact" (Term.app `lower_semicontinuous_within_at_supr [`h])) [])])))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `lower_semicontinuous_within_at_supr [`h]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `lower_semicontinuous_within_at_supr [`h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
theorem
  ...
  := by simp_rw [ ← lower_semicontinuous_within_at_univ_iff ] at * exact lower_semicontinuous_within_at_supr h
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `lower_semicontinuous_at_bsupr [])
  (Command.declSig
   [(Term.implicitBinder "{" [`p] [":" (Term.arrow `ι "→" (Term.prop "Prop"))] "}")
    (Term.implicitBinder
     "{"
    ...
    (Term.explicitBinder
     ...
     [":"
      (Term.forall
       ...
       [(Term.simpleBinder [`i `hi] [])]
       ","
       (Term.app `LowerSemicontinuousAt [(Term.app `f [`i `hi]) `x]))]
     []
     ")")]
   (Term.typeSpec
    ":"
...
theorem
  ...
  { p : ι → Prop } { f : ∀ i h : p i , α → δ } ( h : ∀ i hi , LowerSemicontinuousAt f i hi x )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `lower_semicontinuous_on_supr [])
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.arrow `ι "→" (Term.arrow `α "→" `δ))] "}")
    (Term.explicitBinder
     "("
     [`h]
     [":" (Term.forall "∀" [(Term.simpleBinder [`i] [])] "," (Term.app `LowerSemicontinuousOn [(Term.app `f [`i]) `s]))]
     []
     ")")]
   (Term.typeSpec
    ":"
  ...
  (Command.declValSimple
   ...
   (Term.fun
    ...
    (Term.basicFun
     ...
     (Term.app
      `lower_semicontinuous_within_at_supr
      [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`i] [])] "=>" (Term.app `h [`i `x `hx])))])))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `lower_semicontinuous_on_bsupr [])
  (Command.declSig
   [(Term.implicitBinder "{" [`p] [":" (Term.arrow `ι "→" (Term.prop "Prop"))] "}")
    (Term.implicitBinder
     "{"
    ...
    (Term.explicitBinder
     ...
     [":"
      (Term.forall
       ...
       [(Term.simpleBinder [`i `hi] [])]
       ","
       (Term.app `LowerSemicontinuousOn [(Term.app `f [`i `hi]) `s]))]
     []
     ")")]
   (Term.typeSpec
    ":"
...
theorem
  ...
  { p : ι → Prop } { f : ∀ i h : p i , α → δ } ( h : ∀ i hi , LowerSemicontinuousOn f i hi s )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `lower_semicontinuous_supr [])
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.arrow `ι "→" (Term.arrow `α "→" `δ))] "}")
    (Term.explicitBinder
     "("
     [`h]
     [":" (Term.forall "∀" [(Term.simpleBinder [`i] [])] "," (Term.app `LowerSemicontinuous [(Term.app `f [`i])]))]
     []
     ")")]
   (Term.typeSpec
    ":"
  ...
  (Command.declValSimple
   ...
   (Term.fun
    ...
    (Term.basicFun
     ...
     (Term.app
      `lower_semicontinuous_at_supr
      [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`i] [])] "=>" (Term.app `h [`i `x])))])))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `lower_semicontinuous_bsupr [])
  (Command.declSig
   [(Term.implicitBinder "{" [`p] [":" (Term.arrow `ι "→" (Term.prop "Prop"))] "}")
    (Term.implicitBinder
     "{"
    ...
    (Term.explicitBinder
     ...
     [`h]
     [":"
      (Term.forall "∀" [(Term.simpleBinder [`i `hi] [])] "," (Term.app `LowerSemicontinuous [(Term.app `f [`i `hi])]))]
     []
     ")")]
   (Term.typeSpec
    ":"
...
theorem
  ...
  { p : ι → Prop } { f : ∀ i h : p i , α → δ } ( h : ∀ i hi , LowerSemicontinuous f i hi )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `lower_semicontinuous_within_at_tsum [])
  (Command.declSig
   [(Term.implicitBinder
     "{"
     [`f]
  ...
  (Command.declValSimple
   ...
   (Term.byTactic
    ...
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group (Tactic.simpRw "simp_rw" (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Ennreal.tsum_eq_supr_sum)] "]") []) [])
       (group
        (Tactic.apply
         "apply"
         (Term.app
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.simpRw "simp_rw" (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Ennreal.tsum_eq_supr_sum)] "]") [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simpRw', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `lower_semicontinuous_at_tsum [])
  (Command.declSig
   [(Term.implicitBinder
     "{"
     [`f]
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.simpRw
         ...
         [(Tactic.location "at" (Tactic.locationWildcard "*"))])
        [])
       (group (Tactic.exact "exact" (Term.app `lower_semicontinuous_within_at_tsum [`h])) [])])))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `lower_semicontinuous_within_at_tsum [`h]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `lower_semicontinuous_within_at_tsum [`h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
theorem
  ...
  := by simp_rw [ ← lower_semicontinuous_within_at_univ_iff ] at * exact lower_semicontinuous_within_at_tsum h
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `lower_semicontinuous_on_tsum [])
  (Command.declSig
   [(Term.implicitBinder
     "{"
     [`f]
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `lower_semicontinuous_tsum [])
  (Command.declSig
   [(Term.implicitBinder
     "{"
     [`f]
...
theorem UpperSemicontinuous.add' {f g : α → γ} (hf : UpperSemicontinuous f) (hg : UpperSemicontinuous g)
    (hcont : ∀ x, ContinuousAt (fun p : γ × γ => p.1+p.2) (f x, g x)) : UpperSemicontinuous fun z => f z+g z := fun x =>
  (hf x).add' (hg x) (hcont x)
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `upper_semicontinuous_within_at_sum [])
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.arrow `ι "→" (Term.arrow `α "→" `γ))] "}")
    (Term.implicitBinder "{" [`a] [":" (Term.app `Finset [`ι])] "}")
    (Term.explicitBinder
     ...
     [":"
      (Term.forall
       ...
       (Mathlib.ExtendedBinder.«term∀___,_»
        ...
        («binderTerm∈_» "∈" `a)
        ","
        (Term.forall "∀" [] "," (Term.app `UpperSemicontinuousWithinAt [(Term.app `f [`i]) `s `x]))))]
     []
     ")")]
   (Term.typeSpec
    ":"
  ...
  (Command.declValSimple
   ":="
   (Term.app
    (Term.explicit "@" `lower_semicontinuous_within_at_sum)
    [`α
     (Term.hole "_")
     `x
     `s
     `ι
     (Term.app `OrderDual [`γ])
     (Term.hole "_")
     (Term.hole "_")
     (Term.hole "_")
     (Term.hole "_")
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `OrderDual [`γ]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `upper_semicontinuous_at_sum [])
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.arrow `ι "→" (Term.arrow `α "→" `γ))] "}")
    (Term.implicitBinder "{" [`a] [":" (Term.app `Finset [`ι])] "}")
    (Term.explicitBinder
     ...
     [":"
      (Term.forall
       ...
       (Mathlib.ExtendedBinder.«term∀___,_»
        ...
        («binderTerm∈_» "∈" `a)
        ","
        (Term.forall "∀" [] "," (Term.app `UpperSemicontinuousAt [(Term.app `f [`i]) `x]))))]
     []
     ")")]
   (Term.typeSpec
    ":"
    ...
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.simpRw
         "simp_rw"
         (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `upper_semicontinuous_within_at_univ_iff)] "]")
         [(Tactic.location "at" (Tactic.locationWildcard "*"))])
        [])
       (group (Tactic.exact "exact" (Term.app `upper_semicontinuous_within_at_sum [`ha])) [])])))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `upper_semicontinuous_within_at_sum [`ha]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `upper_semicontinuous_within_at_sum [`ha])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
theorem
  ...
  := by simp_rw [ ← upper_semicontinuous_within_at_univ_iff ] at * exact upper_semicontinuous_within_at_sum ha
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `upper_semicontinuous_on_sum [])
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.arrow `ι "→" (Term.arrow `α "→" `γ))] "}")
    (Term.implicitBinder "{" [`a] [":" (Term.app `Finset [`ι])] "}")
    (Term.explicitBinder
     ...
     [":"
      (Term.forall
       ...
       (Mathlib.ExtendedBinder.«term∀___,_»
        ...
        («binderTerm∈_» "∈" `a)
        ","
        (Term.forall "∀" [] "," (Term.app `UpperSemicontinuousOn [(Term.app `f [`i]) `s]))))]
     []
     ")")]
   (Term.typeSpec
    ":"
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `upper_semicontinuous_sum [])
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.arrow `ι "→" (Term.arrow `α "→" `γ))] "}")
    (Term.implicitBinder "{" [`a] [":" (Term.app `Finset [`ι])] "}")
    (Term.explicitBinder
     ...
     [":"
      (Term.forall
       ...
       (Mathlib.ExtendedBinder.«term∀___,_»
        ...
        («binderTerm∈_» "∈" `a)
        ","
        (Term.forall "∀" [] "," (Term.app `UpperSemicontinuous [(Term.app `f [`i])]))))]
     []
     ")")]
   (Term.typeSpec
    ":"
...
theorem
  ...
  { f : ι → α → γ } { a : Finset ι } ( ha : ∀ , ∀ i ∈ a , ∀ , UpperSemicontinuous f i )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `upper_semicontinuous_within_at_infi [])
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.arrow `ι "→" (Term.arrow `α "→" `δ))] "}")
    (Term.explicitBinder
     "("
     ...
     [":"
      (Term.forall
       ...
       [(Term.simpleBinder [`i] [])]
       ","
       (Term.app `UpperSemicontinuousWithinAt [(Term.app `f [`i]) `s `x]))]
     []
     ")")]
   (Term.typeSpec
    ":"
  ...
  (Command.declValSimple
   ":="
   (Term.app
    (Term.explicit "@" `lower_semicontinuous_within_at_supr)
    [`α (Term.hole "_") `x `s `ι (Term.app `OrderDual [`δ]) (Term.hole "_") `f `h])
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (some 1023, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `OrderDual [`δ]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `upper_semicontinuous_within_at_binfi [])
  (Command.declSig
   [(Term.implicitBinder "{" [`p] [":" (Term.arrow `ι "→" (Term.prop "Prop"))] "}")
    (Term.implicitBinder
     "{"
    ...
    (Term.explicitBinder
     ...
     [":"
      (Term.forall
       ...
       [(Term.simpleBinder [`i `hi] [])]
       ","
       (Term.app `UpperSemicontinuousWithinAt [(Term.app `f [`i `hi]) `s `x]))]
     []
     ")")]
   (Term.typeSpec
    ":"
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
theorem
  upper_semicontinuous_within_at_binfi
  { p : ι → Prop } { f : ∀ i h : p i , α → δ } ( h : ∀ i hi , UpperSemicontinuousWithinAt f i hi s x )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `upper_semicontinuous_at_infi [])
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.arrow `ι "→" (Term.arrow `α "→" `δ))] "}")
    (Term.explicitBinder
     "("
     [`h]
     [":" (Term.forall "∀" [(Term.simpleBinder [`i] [])] "," (Term.app `UpperSemicontinuousAt [(Term.app `f [`i]) `x]))]
     []
     ")")]
   (Term.typeSpec
    ":"
  ...
  (Command.declValSimple
   ":="
   (Term.app
    (Term.explicit "@" `lower_semicontinuous_at_supr)
    [`α (Term.hole "_") `x `ι (Term.app `OrderDual [`δ]) (Term.hole "_") `f `h])
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `upper_semicontinuous_at_binfi [])
  (Command.declSig
   [(Term.implicitBinder "{" [`p] [":" (Term.arrow `ι "→" (Term.prop "Prop"))] "}")
    (Term.implicitBinder
     "{"
    ...
    (Term.explicitBinder
     ...
     [":"
      (Term.forall
       ...
       [(Term.simpleBinder [`i `hi] [])]
       ","
       (Term.app `UpperSemicontinuousAt [(Term.app `f [`i `hi]) `x]))]
     []
     ")")]
   (Term.typeSpec
    ":"
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
theorem
  upper_semicontinuous_at_binfi
  { p : ι → Prop } { f : ∀ i h : p i , α → δ } ( h : ∀ i hi , UpperSemicontinuousAt f i hi x )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `upper_semicontinuous_on_infi [])
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.arrow `ι "→" (Term.arrow `α "→" `δ))] "}")
    (Term.explicitBinder
     "("
     [`h]
     [":" (Term.forall "∀" [(Term.simpleBinder [`i] [])] "," (Term.app `UpperSemicontinuousOn [(Term.app `f [`i]) `s]))]
     []
     ")")]
   (Term.typeSpec
    ":"
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `upper_semicontinuous_on_binfi [])
  (Command.declSig
   [(Term.implicitBinder "{" [`p] [":" (Term.arrow `ι "→" (Term.prop "Prop"))] "}")
    (Term.implicitBinder
     "{"
    ...
    (Term.explicitBinder
     ...
     [":"
      (Term.forall
       ...
       [(Term.simpleBinder [`i `hi] [])]
       ","
       (Term.app `UpperSemicontinuousOn [(Term.app `f [`i `hi]) `s]))]
     []
     ")")]
   (Term.typeSpec
    ":"
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
theorem
  upper_semicontinuous_on_binfi
  { p : ι → Prop } { f : ∀ i h : p i , α → δ } ( h : ∀ i hi , UpperSemicontinuousOn f i hi s )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `upper_semicontinuous_infi [])
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.arrow `ι "→" (Term.arrow `α "→" `δ))] "}")
    (Term.explicitBinder
     "("
     [`h]
     [":" (Term.forall "∀" [(Term.simpleBinder [`i] [])] "," (Term.app `UpperSemicontinuous [(Term.app `f [`i])]))]
     []
     ")")]
   (Term.typeSpec
    ":"
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `upper_semicontinuous_binfi [])
  (Command.declSig
   [(Term.implicitBinder "{" [`p] [":" (Term.arrow `ι "→" (Term.prop "Prop"))] "}")
    (Term.implicitBinder
     "{"
    ...
    (Term.explicitBinder
     ...
     [`h]
     [":"
      (Term.forall "∀" [(Term.simpleBinder [`i `hi] [])] "," (Term.app `UpperSemicontinuous [(Term.app `f [`i `hi])]))]
     []
     ")")]
   (Term.typeSpec
    ":"
...
theorem
  ...
  { p : ι → Prop } { f : ∀ i h : p i , α → δ } ( h : ∀ i hi , UpperSemicontinuous f i hi )
