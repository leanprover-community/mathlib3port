...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  ...
  (Command.optDeclSig
   [(Term.explicitBinder "(" [`M] [":" (Term.app `Set [`α])] [] ")")]
   ...
   (Set.«term{_|_}»
    ...
    («term∃_,_»
     ...
     (Lean.explicitBinders
      (Lean.unbracketedExplicitBinders [(Lean.binderIdent `x)] [":" (Term.arrow (termℕ "ℕ") "→" `α)]))
     ","
     («term_∧_»
      (Term.forall
       "∀"
       ...
       ","
       (Init.Core.«term_∈_» (Term.app `x [`n]) " ∈ " `M))
      "∧"
      (Topology.Sequences.«term_⟶_» `x " ⟶ " `p)))
    "}")
   [])
  []
  []
    ...
    (Term.explicitBinder
     ...
     [":"
      (Filter.Order.Filter.Basic.«term∃ᶠ_in_,_»
       ...
       `at_top
       ", "
       (Init.Core.«term_∈_» (Term.app `u [`n]) " ∈ " `s))]
     []
     ")")]
   (Term.typeSpec
    ":"
    (Mathlib.ExtendedBinder.«term∃___,_»
     ...
     («term∃_,_»
      ...
      («term_∧_»
       ...
       (Term.app
        `tendsto
        [(Rel.Data.Rel.«term_∘_» `u " ∘ " `φ) `at_top (Term.app (Topology.Basic.term𝓝 "𝓝") [`x])]))))))
  (Command.declValSimple
   ":="
   (Term.let
    "let"
    ...
    (Term.let
     ...
     (Term.letDecl
      (Term.letPatDecl
       (Term.anonymousCtor "⟨" [`x "," `x_in "," `φ "," `hφ "," `h] "⟩")
       []
       []
       ":="
       (Term.app `hs [`huψ])))
     ...
     (Term.anonymousCtor
      "⟨"
      [`x "," `x_in "," (Rel.Data.Rel.«term_∘_» `ψ " ∘ " `φ) "," (Term.app `hψ.comp [`hφ]) "," `h]
      "⟩")))
   [])
  []
  []))
  ...
  (Mathlib.ExtendedBinder.«term∃___,_»
   ...
   («term∃_,_»
    ...
    («term_∧_»
     (Term.app `StrictMono [`φ])
     "∧"
     (Term.app `tendsto [(Rel.Data.Rel.«term_∘_» `u " ∘ " `φ) `at_top (Term.app (Topology.Basic.term𝓝 "𝓝") [`x])]))))
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Rel.Data.Rel.«term_∘_» `u " ∘ " `φ) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `tendsto
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
theorem
  ...
  { s : Set α } ( hs : IsSeqCompact s ) { u : ℕ → α } ( hu : ∃ᶠ n in at_top , u n ∈ s )
    : ∃ x ∈ s , ∃ φ : ℕ → ℕ , StrictMono φ ∧ tendsto u ∘ φ at_top 𝓝 x
  :=
    let
      ⟨ ψ , hψ , huψ ⟩ := extraction_of_frequently_at_top hu
      let ⟨ x , x_in , φ , hφ , h ⟩ := hs huψ ⟨ x , x_in , ψ ∘ φ , hψ.comp hφ , h ⟩
...
theorem
  ...
  { s : Set α } { u : ℕ → α } ( hs : IsCompact s ) ( hu : ∃ᶠ n in at_top , u n ∈ s )
    : ∃ x ∈ s , ∃ φ : ℕ → ℕ , StrictMono φ ∧ tendsto u ∘ φ at_top 𝓝 x
  ...
  (Command.declSig
   [(Term.implicitBinder "{" [`ι] [":" (Term.type "Type" [(Level.hole "_")])] "}")
    (Term.instBinder
     ...
     "]")
    (Term.implicitBinder "{" [`c] [":" (Term.arrow `ι "→" (Term.app `Set [`β]))] "}")
    (Term.explicitBinder "(" [`hs] [":" (Term.app `IsSeqCompact [`s])] [] ")")
    (Term.explicitBinder
     "("
     [`hc₁]
       ...
       (Mathlib.ExtendedBinder.«term∀___,_»
        ...
        (Term.forall
         ...
         («term∃_,_»
          ...
          (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
          ","
          (Init.Core.«term_⊆_» (Term.app `ball [`x `V]) " ⊆ " (Term.app `c [`i]))))))))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
          ...
          («term∃_,_»
           ...
           (Lean.explicitBinders
            (Lean.unbracketedExplicitBinders
             [(Lean.binderIdent `V)]
             [":" (Term.arrow (termℕ "ℕ") "→" (Term.app `Set [(«term_×_» `β "×" `β)]))]))
           ","
           («term_∧_»
            (Term.app (Term.proj (Term.app (Topology.UniformSpace.Basic.term𝓤 "𝓤") [`β]) "." `HasAntitoneBasis) [`V])
            "∧"
            (Term.forall
             "∀"
             [(Term.simpleBinder [`n] [])]
             ","
             («term_=_» (Set.Data.Set.Basic.«term_⁻¹'_» `swap " ⁻¹' " (Term.app `V [`n])) "=" (Term.app `V [`n])))))]
         [])
        [])
       (group (Tactic.exact "exact" (Term.app `UniformSpace.has_seq_basis [`β])) [])
       (group
            ...
            (Mathlib.ExtendedBinder.«term∀___,_»
             ...
             (Term.forall
              ...
              («term∃_,_»
               ...
               (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
               ","
               (Init.Core.«term_⊆_» (Term.app `ball [`x (Term.app `V [`n])]) " ⊆ " (Term.app `c [`i])))))))
          (Term.byTactic
           "by"
           (Tactic.tacticSeq
            (Tactic.tacticSeq1Indented
              ...
              (group
               (Tactic.exact
                ...
                (Term.anonymousCtor
                 ...
                 [(Term.app `V [`n])
                  ","
                  (Term.app `hV.to_has_basis.mem_of_mem [`trivialₓ])
                  ","
                  (Term.app `Vsymm [`n])
                  ","
                  `hn]
        ...
        (Tactic.obtain
         ...
         [":"
          («term∃_,_»
           "∃"
           (Lean.explicitBinders
            (Lean.unbracketedExplicitBinders [(Lean.binderIdent `x)] [":" (Term.arrow (termℕ "ℕ") "→" `β)]))
           ","
           («term_∧_»
            (Term.forall "∀" [(Term.simpleBinder [`n] [])] "," (Init.Core.«term_∈_» (Term.app `x [`n]) " ∈ " `s))
            "∧"
            (Term.forall
             "∀"
         ...
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group (Tactic.pushNeg "push_neg" [(Tactic.location "at" (Tactic.locationHyp [`H] []))]) [])
            ...
            (group
             (Tactic.exact "exact" (Term.anonymousCtor "⟨" [`x "," (Term.app `forall_and_distrib.mp [`hx])] "⟩"))
             [])])))
        [])
        ...
        (Tactic.obtain
         ...
         [(Tactic.rcasesPatMed
           [(Tactic.rcasesPat.tuple
             ...
             [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `x₀)]) [])
              ","
              (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `x₀_in)]) [])
              ","
              (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `φ)]) [])
              ","
              (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `φ_mono)]) [])
              ","
          ...
          (Mathlib.ExtendedBinder.«term∃___,_»
           ...
           («term∃_,_»
            ...
            («term_∧_»
             (Term.app `StrictMono [`φ])
             "∧"
             (Topology.Sequences.«term_⟶_» (Rel.Data.Rel.«term_∘_» `x " ∘ " `φ) " ⟶ " `x₀))))]
         [])
        [])
        ...
        (Tactic.obtain
         ...
         [":"
          («term∃_,_»
           ...
           (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i₀)] []))
           ","
           (Init.Core.«term_∈_» `x₀ " ∈ " (Term.app `c [`i₀])))]
         [])
        [])
       (group
        (Tactic.«tactic·._»
         ...
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group
             (Tactic.rcases
              "rcases"
              [(Tactic.casesTarget [] (Term.app `hc₂ [`x₀_in]))]
              ["with"
               (Tactic.rcasesPat.tuple
                "⟨"
                [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.ignore "_")]) [])
                 ...
                 (Tactic.rcasesPatLo
                  ...
                  [])
                 ","
                 (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `x₀_in_c)]) [])]
                "⟩")])
             [])
            (group (Tactic.exact "exact" (Term.anonymousCtor "⟨" [`i₀ "," `x₀_in_c] "⟩")) [])])))
        [])
       (group (Tactic.clear "clear" [`hc₂]) [])
       (group
        (Tactic.obtain
         "obtain"
         [(Tactic.rcasesPatMed
           ...
           [(group
             (Tactic.rcases
              ...
              [(Tactic.casesTarget
                ...
                (Term.app
                 ...
                 [(Term.app `is_open_iff_mem_nhds.mp [(Term.app `hc₁ [`i₀]) (Term.hole "_") `x₀_in])]))]
              ["with"
               (Tactic.rcasesPat.tuple
                "⟨"
                [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `n₀)]) [])
            ...
            (group
             (tacticRwa__
              ...
              (Tactic.rwRuleSeq
               "["
               [(Tactic.rwRule ["←"] (Term.app `ball_eq_of_symmetry [(Term.app `Vsymm [`n₀])]))]
               "]")
        ...
        (Tactic.obtain
         ...
         [":"
          (Mathlib.ExtendedBinder.«term∃___,_»
           ...
           («binderTerm∈_» "∈" (Term.app (Topology.UniformSpace.Basic.term𝓤 "𝓤") [`β]))
           ","
           (Init.Core.«term_⊆_» (Topology.UniformSpace.Basic.«term_○_» `W " ○ " `W) " ⊆ " (Term.app `V [`n₀])))]
         [])
        [])
       (group
        (Tactic.exact "exact" (Term.app `comp_mem_uniformity_sets [(Term.app `hV.to_has_basis.mem_of_mem [`trivialₓ])]))
        [])
       (group
        (Tactic.obtain
         "obtain"
         [(Tactic.rcasesPatMed
           [(Tactic.rcasesPat.tuple
             ...
             [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `N)]) [])
              ","
              (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `x_φ_N_in)]) [])
              ","
         ...
         [":"
          («term∃_,_»
           ...
           ","
           («term_∧_»
            (Init.Core.«term_∈_» (Term.app `x [(Term.app `φ [`N])]) " ∈ " (Term.app `ball [`x₀ `W]))
            "∧"
            (Init.Core.«term_⊆_» (Term.app `V [(Term.app `φ [`N])]) " ⊆ " `W)))]
         [])
        [])
       (group
        (Tactic.«tactic·._»
          ...
          (Tactic.tacticSeq1Indented
           [(group
            ...
            (group
             (Tactic.exact
              "exact"
              (Term.app `tendsto_at_top'.mp [`hlim (Term.hole "_") (Term.app `mem_nhds_left [`x₀ `W_in])]))
             [])
            (group
             (Tactic.obtain
              "obtain"
                ...
                [(group
                 ...
                 (group
                  (Tactic.exact
                   ...
                   (Term.app
                    `subset.trans
                    [(«term_$__» `hV.antitone "$" (Term.app `φ_mono.id_le [(Term.hole "_")])) `hN]))
                  [])])))
             [])
            (group
             (Tactic.have''
              "have"
              []
              [(Term.typeSpec ":" («term_≤_» (Term.app `φ [`N₂]) "≤" (Term.app `φ [(Term.app `max [`N₁ `N₂])])))])
             [])
            (group
             (Tactic.exact
              "exact"
              (Term.app `φ_mono.le_iff_le.mpr [(Term.app `le_max_rightₓ [(Term.hole "_") (Term.hole "_")])]))
             [])
            (group
             (Tactic.exact
              "exact"
              (Term.anonymousCtor
               ...
               [(Term.app `max [`N₁ `N₂])
                ","
                (Term.app `h₁ [(Term.hole "_") (Term.app `le_max_leftₓ [(Term.hole "_") (Term.hole "_")])])
                ","
                (Term.app `trans [(Term.app `hV.antitone [`this]) `h₂])]
               "⟩"))
             [])])))
        [])
       (group
        (Tactic.suffices'
         ...
         [(Term.typeSpec
           ":"
           (Init.Core.«term_⊆_»
            (Term.app `ball [(Term.app `x [(Term.app `φ [`N])]) (Term.app `V [(Term.app `φ [`N])])])
            " ⊆ "
            (Term.app `c [`i₀])))])
        [])
       (group (Tactic.exact "exact" (Term.app `hx [(Term.app `φ [`N]) `i₀ `this])) [])
       (group
        (tacticCalc_
         "calc"
         [(calcStep
           (Init.Core.«term_⊆_»
            (Term.app `ball [(«term_$__» `x "$" (Term.app `φ [`N])) («term_$__» `V "$" (Term.app `φ [`N]))])
            " ⊆ "
            (Term.app `ball [(«term_$__» `x "$" (Term.app `φ [`N])) `W]))
           ":="
           (Term.app `preimage_mono [`hVNW]))
          (calcStep
           (Init.Core.«term_⊆_» (Term.hole "_") " ⊆ " (Term.app `ball [`x₀ (Term.app `V [`n₀])]))
           ":="
           (Term.app `ball_subset_of_comp_subset [`x_φ_N_in `hWW]))
          (calcStep (Init.Core.«term_⊆_» (Term.hole "_") " ⊆ " (Term.app `c [`i₀])) ":=" `hn₀)])
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Init.Core.«term_⊆_» (Term.hole "_") " ⊆ " (Term.app `c [`i₀]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Core.«term_⊆_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `c [`i₀])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(«term_$__» `x "$" (Term.app `φ [`N])) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `ball
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(«term_$__» `V "$" (Term.app `φ [`N])) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.exact "exact" (Term.app `hx [(Term.app `φ [`N]) `i₀ `this]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `hx [(Term.app `φ [`N]) `i₀ `this])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `V [(Term.paren "(" [(Term.app `φ [`N]) []] ")")]) []]
 ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `x [(Term.paren "(" [(Term.app `φ [`N]) []] ")")]) []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `ball
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
         ...
         (Tactic.tacticSeq1Indented
          [(group
           ...
           (group
            (Tactic.exact
             "exact"
             (Term.app `subset.trans [(«term_$__» `hV.antitone "$" (Term.app `φ_mono.id_le [(Term.hole "_")])) `hN]))
            [])])))
       [])
      (group
       (Tactic.have''
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.exact "exact" (Term.app `φ_mono.le_iff_le.mpr [(Term.app `le_max_rightₓ [(Term.hole "_") (Term.hole "_")])]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `φ_mono.le_iff_le.mpr [(Term.app `le_max_rightₓ [(Term.hole "_") (Term.hole "_")])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_≤_» (Term.app `φ [`N₂]) "≤" (Term.app `φ [(Term.app `max [`N₁ `N₂])]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_≤_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `φ [(Term.app `max [`N₁ `N₂])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `max [`N₁ `N₂]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `φ
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  («term_$__» `hV.antitone "$" (Term.app `φ_mono.id_le [(Term.hole "_")]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `φ_mono.id_le [(Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.exact "exact" (Term.app `tendsto_at_top'.mp [`hlim (Term.hole "_") (Term.app `mem_nhds_left [`x₀ `W_in])]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `tendsto_at_top'.mp [`hlim (Term.hole "_") (Term.app `mem_nhds_left [`x₀ `W_in])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `mem_nhds_left [`x₀ `W_in]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.forall
   ...
   (Mathlib.ExtendedBinder.«term∀___,_»
    ...
    (Mathlib.ExtendedBinder.«binderTerm≥_» "≥" `N₁)
    ","
    (Term.forall "∀" [] "," (Init.Core.«term_∈_» (Term.app `x [(Term.app `φ [`n])]) " ∈ " (Term.app `ball [`x₀ `W])))))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.forall', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.forall', expected 'Lean.Parser.Term.forall.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Mathlib.ExtendedBinder.«term∀___,_»
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `comp_mem_uniformity_sets [(Term.app `hV.to_has_basis.mem_of_mem [`trivialₓ])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `hV.to_has_basis.mem_of_mem [`trivialₓ]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
    ...
    (Tactic.tacticSeq1Indented
     [(group
      ...
      (group
       (tacticRwa__
        "rwa"
        (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] (Term.app `ball_eq_of_symmetry [(Term.app `Vsymm [`n₀])]))] "]")
        [(Tactic.location "at" (Tactic.locationHyp [`h] []))])
       [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.«tactic·._»', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq', expected 'Lean.Parser.Tactic.tacticSeq.antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `ball_eq_of_symmetry [(Term.app `Vsymm [`n₀])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Vsymm [`n₀]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `ball_eq_of_symmetry
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `is_open_iff_mem_nhds.mp [(Term.paren "(" [(Term.app `hc₁ [`i₀]) []] ")") (Term.hole "_") `x₀_in]) []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.proj (Term.app `nhds_basis_uniformity [`hV.to_has_basis]) "." `mem_iff) "." `mp)
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.anonymousCtor "⟨" [`i₀ "," `x₀_in_c] "⟩"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.anonymousCtor "⟨" [`i₀ "," `x₀_in_c] "⟩")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.anonymousCtor.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Rel.Data.Rel.«term_∘_» `x " ∘ " `φ) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 35 >? 1022, (some 0, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 35, term))
  (Term.app `StrictMono [`φ])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.anonymousCtor "⟨" [`x "," (Term.app `forall_and_distrib.mp [`hx])] "⟩")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.anonymousCtor.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
    ...
    («term∃_,_»
     ...
     («term_∧_»
      ...
      (Term.forall
       ...
       («term¬_»
        "¬"
        (Init.Core.«term_⊆_» (Term.app `ball [(Term.app `x [`n]) (Term.app `V [`n])]) " ⊆ " (Term.app `c [`i]))))))]
   [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.obtain', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term∃_,_»', expected 'optional.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.forall', expected 'Lean.Parser.Term.forall.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term¬_» "¬" (Init.Core.«term_⊆_» (Term.app `ball [(Term.app `x [`n]) (Term.app `V [`n])]) " ⊆ " (Term.app `c [`i])))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.forall', expected 'Lean.Parser.Term.forall.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Init.Core.«term_∈_» (Term.app `x [`n]) " ∈ " `s)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Core.«term_∈_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `s
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact
   ...
   (Term.anonymousCtor
    "⟨"
    [(Term.app `V [`n]) "," (Term.app `hV.to_has_basis.mem_of_mem [`trivialₓ]) "," (Term.app `Vsymm [`n]) "," `hn]
    "⟩"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.anonymousCtor
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.exact "exact" (Term.app `UniformSpace.has_seq_basis [`β]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `UniformSpace.has_seq_basis [`β])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 51 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 50, term))
  (Set.Data.Set.Basic.«term_⁻¹'_» `swap " ⁻¹' " (Term.app `V [`n]))
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app (Topology.UniformSpace.Basic.term𝓤 "𝓤") [`β]) "." `HasAntitoneBasis)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app (Topology.UniformSpace.Basic.term𝓤 "𝓤") [`β])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(«term_×_» `β "×" `β) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `Set
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
theorem
  ...
  { ι : Type _ }
      [ is_countably_generated 𝓤 β ]
      { c : ι → Set β }
      ( hs : IsSeqCompact s )
      ( hc₁ : ∀ i , IsOpen c i )
      ( hc₂ : s ⊆ ⋃ i , c i )
    : ∃ V ∈ 𝓤 β , SymmetricRel V ∧ ∀ , ∀ x ∈ s , ∀ , ∃ i , ball x V ⊆ c i
  :=
    by
      classical
        ...
        suffices
          ∃ n , ∀ , ∀ x ∈ s , ∀ , ∃ i , ball x V n ⊆ c i
            by cases' this with n hn exact ⟨ V n , hV.to_has_basis.mem_of_mem trivialₓ , Vsymm n , hn ⟩
        by_contra H
        obtain ⟨ x , x_in , hx ⟩ : ∃ x : ℕ → β , ∀ n , x n ∈ s ∧ ∀ n i , ¬ ball x n V n ⊆ c i
        · push_neg at H choose x hx using H exact ⟨ x , forall_and_distrib.mp hx ⟩
        clear H
        obtain ⟨ x₀ , x₀_in , φ , φ_mono , hlim ⟩ : ∃ x₀ ∈ s , ∃ φ : ℕ → ℕ , StrictMono φ ∧ x ∘ φ ⟶ x₀
        exact hs x_in
        clear hs
        obtain ⟨ i₀ , x₀_in ⟩ : ∃ i₀ , x₀ ∈ c i₀
        · rcases hc₂ x₀_in with ⟨ _ , ⟨ i₀ , rfl ⟩ , x₀_in_c ⟩ exact ⟨ i₀ , x₀_in_c ⟩
        clear hc₂
        obtain ⟨ n₀ , hn₀ ⟩ : ∃ n₀ , ball x₀ V n₀ ⊆ c i₀
        ·
          rcases
              nhds_basis_uniformity hV.to_has_basis . mem_iff . mp is_open_iff_mem_nhds.mp hc₁ i₀ _ x₀_in
              with ⟨ n₀ , _ , h ⟩
            use n₀
    ...
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group (Tactic.classical "classical") [])
                  ...
                  (Mathlib.ExtendedBinder.«term∃___,_»
                   ...
                   (Term.forall
                    ...
                    (Term.arrow
                     ...
                     "→"
                     (Init.Core.«term_∉_» (Term.paren "(" [`x [(Term.tupleTail "," [`a])]] ")") " ∉ " `V))))]
                 [])
                [])
               (group
                (Tactic.«tactic·._»
       ...
       (group (Tactic.intro "intro" [`x `x_in `φ]) [])
       (group (Tactic.intro "intro" [`hφ `huφ]) [])
       (group
        (Tactic.obtain
         "obtain"
         [(Tactic.rcasesPatMed
            ...
            (Term.arrow
             ...
             (Term.arrow
              ...
              (Init.Core.«term_∈_»
               (Term.paren
                "("
                [(Term.app `u [(Term.app `φ [`p])]) [(Term.tupleTail "," [(Term.app `u [(Term.app `φ [`q])])])]]
                ")")
               " ∈ "
               `V)))))]
         [])
        [])
       (group (Tactic.exact "exact" (Term.app `huφ.cauchy_seq.mem_entourage [`V_in])) [])
       (group
        (Tactic.specialize
         "specialize"
         (Term.app
          `hN
          [`N (Init.Logic.«term_+_» `N "+" (numLit "1")) (Term.app `le_reflₓ [`N]) (Term.app `Nat.le_succₓ [`N])]))
        [])
       (group
        (Tactic.specialize
         "specialize"
         (Term.app
          `hu
          [(«term_$__» `φ "$" (Init.Logic.«term_+_» `N "+" (numLit "1")))
           (Term.app `φ [`N])
           («term_$__» `hφ "$" (Term.app `lt_add_one [`N]))]))
        [])
...
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (some 10, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 10, (some 10, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(«term_$__» `hφ "$" (Term.app `lt_add_one [`N])) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.specialize', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `hN [`N (Init.Logic.«term_+_» `N "+" (numLit "1")) (Term.app `le_reflₓ [`N]) (Term.app `Nat.le_succₓ [`N])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Nat.le_succₓ [`N]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.exact "exact" (Term.app `huφ.cauchy_seq.mem_entourage [`V_in]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `huφ.cauchy_seq.mem_entourage [`V_in])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Init.Core.«term_∈_»
   (Term.paren "(" [(Term.app `u [(Term.app `φ [`p])]) [(Term.tupleTail "," [(Term.app `u [(Term.app `φ [`q])])])]] ")")
   " ∈ "
   `V)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Core.«term_∈_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `φ [`q]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `u
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `φ [`p]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `u
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
  ...
  :=
    by
      classical
        ...
        have
          : ∀ t : Set β , finite t → ∃ a , a ∈ s ∧ a ∉ ⋃ ( y : _ ) ( _ : y ∈ t ) , ball y V
            :=
            by
              intro t ht
 ...
 (Command.theorem
  ...
  (Command.declSig
   [(Term.instBinder
     "["
     []
     («term_$__» `is_countably_generated "$" (Term.app (Topology.UniformSpace.Basic.term𝓤 "𝓤") [`β]))
     "]")
    (Term.explicitBinder "(" [`hs] [":" (Term.app `IsSeqCompact [`s])] [] ")")]
     ...
     (Tactic.tacticSeq1Indented
      [(group (Tactic.classical "classical") [])
       (group
        ...
        [])
       (group (Tactic.intro "intro" [`ι `U `Uop `s_sub]) [])
       (group
        (Tactic.rcases
         "rcases"
           ...
           [(Term.typeSpec
             ...
             (Term.forall
              ...
              («term∃_,_»
               ...
               ","
               (Init.Core.«term_⊆_» (Term.app `ball [`x.val `V]) " ⊆ " (Term.app `U [`i])))))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Set.Data.Set.Lattice.«term⋃_,_»', expected 'optional.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Set.Data.Set.Lattice.«term⋃_,_»
   "⋃"
   (Lean.explicitBinders
...
protected
  theorem
    ...
    [ is_countably_generated $ 𝓤 β ] ( hs : IsSeqCompact s ) : IsCompact s
    :=
      by
        classical
          ...
          have : ∀ x : t , ∃ i : ι , ball x.val V ⊆ U i := by rintro ⟨ x , x_in ⟩ exact H x t_sub x_in
          choose i hi using this
          have : Fintype t := tfin.fintype
          use Finset.image i Finset.univ
          trans ⋃ ( y : _ ) ( _ : y ∈ t ) , ball y V
          · intro x x_in specialize ht x_in rw [ mem_bUnion_iff ] at * simp_rw [ ball_eq_of_symmetry Vsymm ] exact ht
          ·
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  ...
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `ProperSpace [`β]) "]")
   ...
   (Term.typeSpec
    ...
    (Mathlib.ExtendedBinder.«term∃___,_»
     "∃"
     `b
     («binderTerm∈_» "∈" (Term.app `Closure [`s]))
     ","
     («term∃_,_»
      "∃"
      (Lean.explicitBinders
      ...
      («term_∧_»
       ...
       (Term.app
        `tendsto
        [(Rel.Data.Rel.«term_∘_» `u " ∘ " `φ) `at_top (Term.app (Topology.Basic.term𝓝 "𝓝") [`b])]))))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           ...
           (Term.app
            ...
            [(Term.anonymousCtor "⟨" [`is_closed_closure "," (Term.app `bounded_closure_of_bounded [`hs])] "⟩")]))))
        [])
       (group
          ...
          (Term.haveIdDecl
           ...
           [(Term.typeSpec
             ...
             (Filter.Order.Filter.Basic.«term∃ᶠ_in_,_»
              ...
              `at_top
              ", "
              (Init.Core.«term_∈_» (Term.app `u [`n]) " ∈ " (Term.app `Closure [`s]))))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
...
/--
  ...
  theorem
    ...
    [ ProperSpace β ] ( hs : Bounded s ) { u : ℕ → β } ( hu : ∃ᶠ n in at_top , u n ∈ s )
    ...
    :=
      by
        have
          ...
          have hu' : ∃ᶠ n in at_top , u n ∈ Closure s := by apply frequently.mono hu intro n apply subset_closure
      ...
      (Mathlib.ExtendedBinder.«term∀___,_»
       ...
       (Term.forall
        ...
        («term∃_,_»
         ...
         (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
         ","
         (Init.Core.«term_⊆_» (Term.app `ball [`x `δ]) " ⊆ " (Term.app `c [`i])))))))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.rcases
         "rcases"
         [(Tactic.casesTarget [] (Term.app `lebesgue_number_lemma_seq [`hs `hc₁ `hc₂]))]
         ["with"
          (Tactic.rcasesPat.tuple
           "⟨"
           [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `V)]) [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.casesTarget', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `lebesgue_number_lemma_seq [`hs `hc₁ `hc₂])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
theorem
  ...
  { ι : Type _ } { c : ι → Set β } ( hs : IsSeqCompact s ) ( hc₁ : ∀ i , IsOpen c i ) ( hc₂ : s ⊆ ⋃ i , c i )
