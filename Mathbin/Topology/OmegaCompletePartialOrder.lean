...
theorem IsOpen.inter (s t : Set α) : IsOpen α s → IsOpen α t → IsOpen α (s ∩ t) := by
  ...
  ·
    intro x y h
    apply and_implies <;> solve_by_elim [h₀ h, h₂ h]
     ...
     (Term.arrow
      (Term.forall
       ...
       (Mathlib.ExtendedBinder.«term∀___,_»
        ...
        («binderTerm∈_» "∈" `s)
        ","
        (Term.forall "∀" [] "," (Term.app `IsOpen [`α `t]))))
      "→"
      (Term.app `IsOpen [`α (Set.Init.Data.Set.«term⋃₀_» "⋃₀" `s)])))))
   ...
   (Term.byTactic
    ...
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group (introv "introv" [(Lean.binderIdent `h₀)]) [])
       (group
            ...
            (Set.«term{_|_}»
             ...
             (Term.app
              ...
              [(Set.Data.Set.Basic.term_''_
                (Term.app `flip [(Init.Core.«term_∈_» (Term.cdot "·") " ∈ " (Term.cdot "·"))])
                " '' "
                `s)
               `x])
             "}")])
             ...
             [(group (Tactic.convert "convert" [] `this []) [])
              ...
              (group
               (Tactic.simp
                ...
                ["only"]
                ["["
                 [(Tactic.simpLemma [] [] `Set.SUnion)
                  ","
                  (Tactic.simpLemma [] [] `Sup)
                  ","
                  ...
                  ","
                  (Tactic.simpLemma [] [] `ConditionallyCompleteLattice.supₓ)
                  ","
                  (Tactic.simpLemma [] [] `exists_exists_and_eq_and)
                  ","
                  (Tactic.simpLemma [] [] `CompleteLattice.supₓ)
                  ","
       ...
       (group
        (Tactic.dsimp
         ...
         []
         []
         ["[" [(Tactic.simpLemma [] [] `IsOpen)] "]"]
         []
         [(Tactic.location "at" (Tactic.locationWildcard "*"))])
        [])
       (group (Tactic.apply "apply" (Term.app `CompleteLattice.Sup_continuous' [(Term.hole "_")])) [])
       (group (introv "introv" [(Lean.binderIdent `ht)]) [])
       (group
        (Tactic.specialize
         "specialize"
         (Term.app `h₀ [(Set.«term{_|_}» "{" `x "|" (Term.app `f [`x]) "}") (Term.hole "_")]))
        [])
       (group
        (Tactic.«tactic·._»
         "·"
          ...
          (Tactic.tacticSeq1Indented
           [(group
             (Tactic.simp
              ...
              []
              ["only"]
              ["[" [(Tactic.simpLemma [] [] `flip) "," (Tactic.simpLemma [] [] `Set.mem_image)] "]"]
              [(Tactic.location "at" (Tactic.locationWildcard "*"))])
             [])
            (group
             (Tactic.rcases
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.specialize "specialize" (Term.app `h₀ [(Set.«term{_|_}» "{" `x "|" (Term.app `f [`x]) "}") (Term.hole "_")]))
...
theorem
  is_open_sUnion
  : ∀ s , ∀ , ∀ t ∈ s , ∀ , IsOpen α t → IsOpen α ⋃₀ s
  :=
    by
      introv h₀
        suffices
          IsOpen α { x | Sup flip · ∈ · '' s x }
            by
              convert this
                ext
                simp
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `NotBelow [])
  (Command.optDeclSig [] [])
  (Command.declValSimple ":=" (Set.«term{_|_}» "{" `x "|" («term¬_» "¬" («term_≤_» `x "≤" `y)) "}") [])
  []
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Set.«term{_|_}» "{" `x "|" («term¬_» "¬" («term_≤_» `x "≤" `y)) "}")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Set.«term{_|_}»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term¬_» "¬" («term_≤_» `x "≤" `y))
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `Scott_continuous_of_continuous [])
  (Command.declSig
   [(Term.implicitBinder "{" [`α `β] [] "}")
    (Term.instBinder "[" [] (Term.app `OmegaCompletePartialOrder [`α]) "]")
    (Term.instBinder "[" [] (Term.app `OmegaCompletePartialOrder [`β]) "]")
    (Term.explicitBinder "(" [`f] [":" (Term.arrow (Term.app `Scott [`α]) "→" (Term.app `Scott [`β]))] [] ")")
    (Term.explicitBinder "(" [`hf] [":" (Term.app `Continuous [`f])] [] ")")]
   (Term.typeSpec ":" (Term.app `OmegaCompletePartialOrder.Continuous' [`f])))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
      ...
      [(group
        (Tactic.simp
         ...
         ["["
          [(Tactic.simpLemma [] [] `continuous_def)
           ","
           (Tactic.simpLemma [] [] (Set.Data.Set.Basic.«term_⁻¹'_» (Term.cdot "·") " ⁻¹' " (Term.cdot "·")))]
          "]"]
       ...
       (group
        (Tactic.tacticHave_
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           [`h []]
           [(Term.typeSpec ":" (Term.app `Monotone [`f]))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
               ...
               (group
                (Tactic.cases'
                 ...
                 [(Tactic.casesTarget
                   ...
                   (Term.app
                    `hf
                    [(Set.«term{_|_}» "{" `x "|" («term¬_» "¬" («term_≤_» `x "≤" (Term.app `f [`y]))) "}")
                     (Term.app `not_below_is_open [(Term.hole "_")])]))]
                 []
                 ["with" [(Lean.binderIdent `hf) (Lean.binderIdent `hf')]])
                [])
               (group (Tactic.clear "clear" [`hf']) [])
               (group (Tactic.specialize "specialize" (Term.app `hf [`h])) [])
               (group
                (Tactic.simp
                 "simp"
                 []
                 ["only"]
                 ["["
                  [(Tactic.simpLemma [] [] `Set.Preimage)
                   ","
                   (Tactic.simpLemma [] [] `SetOf)
                   ","
                   (Tactic.simpLemma [] [] (Init.Core.«term_∈_» (Term.cdot "·") " ∈ " (Term.cdot "·")))
                   ","
                   (Tactic.simpLemma [] [] `Set.Mem)
                   ","
                   (Tactic.simpLemma [] [] `le_Prop_eq)]
                  "]"]
                 [(Tactic.location "at" (Tactic.locationHyp [`hf] []))])
                [])
               (group (byContra "by_contra" [`H]) [])
               (group (Tactic.apply "apply" (Term.app `hf [`H (Term.app `le_reflₓ [(Term.app `f [`y])])])) [])]))))))
        [])
       (group (Tactic.existsi "exists" [`h]) [])
       (group (Tactic.intro "intro" [`c]) [])
       (group (Tactic.apply "apply" `eq_of_forall_ge_iff) [])
       (group (Tactic.intro "intro" [`z]) [])
       (group (Tactic.specialize "specialize" `[anonymous]) [])
       (group (Tactic.cases "cases" [(Tactic.casesTarget [] `hf)] [] []) [])
       (group (Tactic.specialize "specialize" (Term.app `hf_h [`c])) [])
       (group
        (Tactic.simp
         "simp"
         []
         ["only"]
         ["["
          [(Tactic.simpLemma [] [] `NotBelow)
           ","
           (Tactic.simpLemma [] [] `OrderHom.coe_fun_mk)
           ","
           (Tactic.simpLemma [] [] `eq_iff_iff)
           ","
           (Tactic.simpLemma [] [] `Set.mem_set_of_eq)]
          "]"]
         [(Tactic.location "at" (Tactic.locationHyp [`hf_h] []))])
        [])
       ...
       (group
        (Tactic.simp
         ...
         ["only"]
         ["["
          [(Tactic.simpLemma [] [] `ωSup_le_iff)
           ","
           (Tactic.simpLemma [] [] `hf_h)
           ","
           (Tactic.simpLemma [] [] `ωSup)
           ","
           (Tactic.simpLemma [] [] `supr)
           ","
           (Tactic.simpLemma [] [] `Sup)
           ...
           (Tactic.simpLemma [] [] `CompleteLattice.supₓ)
           ","
           (Tactic.simpLemma [] [] `CompleteSemilatticeSup.sup)
           ","
           (Tactic.simpLemma [] [] `exists_prop)
           ","
           (Tactic.simpLemma [] [] `Set.mem_range)
           ...
           (Tactic.simpLemma [] [] `OrderHom.coe_fun_mk)
           ","
           (Tactic.simpLemma [] [] `chain.map_coe)
           ","
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `not_iff_not)] "]") [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.specialize "specialize" (Term.app `hf_h [`c]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.specialize', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `hf_h [`c])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.cases "cases" [(Tactic.casesTarget [] `hf)] [] [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.specialize "specialize" `[anonymous])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.specialize', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `[anonymous]
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.apply "apply" `eq_of_forall_ge_iff)
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.apply "apply" (Term.app `hf [`H (Term.app `le_reflₓ [(Term.app `f [`y])])]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.apply', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `hf [`H (Term.app `le_reflₓ [(Term.app `f [`y])])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `le_reflₓ [(Term.app `f [`y])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `le_reflₓ [(Term.paren "(" [(Term.app `f [`y]) []] ")")]) []]
 ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.specialize "specialize" (Term.app `hf [`h]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.specialize', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `hf [`h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `not_below_is_open [(Term.hole "_")]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Set.«term{_|_}»', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Set.«term{_|_}»', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Set.«term{_|_}»', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Set.«term{_|_}»', expected 'Lean.Parser.Term.ellipsis.antiquot'
