...
-- ././Mathport/Syntax/Translate/Basic.lean:477:2: warning: expanding binder collection (a «expr ≠ » 0)
     ...
     (Order.CompleteLattice.«term⨅_,_»
      ...
      (Lean.explicitBinders
       [(Lean.bracketedExplicitBinders "(" [(Lean.binderIdent `a)] ":" (Term.hole "_") ")")
        (Lean.bracketedExplicitBinders "(" [(Lean.binderIdent "_")] ":" («term_≠_» `a "≠" (numLit "0")) ")")])
      ", "
  ...
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.arrow `α "→" (Data.Real.Basic.termℝ "ℝ"))] "}")
    (Term.explicitBinder
     "("
     [`hf_nonneg]
     [":" (Term.forall "∀" [(Term.simpleBinder [`n] [])] "," («term_≤_» (numLit "0") "≤" (Term.app `f [`n])))]
     []
     ")")
  ...
  (Command.declValSimple
   ...
   (termDepIfThenElse
    ...
    («term_$__»
     `Eq.symm
     "$"
     (Term.proj («term_$__» (Term.proj `has_sum_coe "." (fieldIdx "2")) "$" `hf.has_sum) "." `tsum_eq))
    "else"
    (Term.byTactic
     "by"
     (Tactic.tacticSeq
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  («term_$__» (Term.proj `has_sum_coe "." (fieldIdx "2")) "$" `hf.has_sum)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_$__»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `hf.has_sum
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
     ...
     (Tactic.tacticSeq1Indented
      [(group
       ...
       (group
        (Tactic.simpRw
         "simp_rw"
         (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `Nnreal.coe_tsum) "," (Tactic.rwRule [] `Subtype.coe_eta)] "]")
         [])
        [])])))
   [])
  []
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  ...
  (Command.declSig
   [(Term.explicitBinder "(" [`a] [":" (Data.Real.Nnreal.«termℝ≥0» " ℝ≥0 ")] [] ")")
   ...
   (Term.typeSpec
    ...
    («term_=_»
     (Topology.Algebra.InfiniteSum.«term∑'_,_»
      ...
      ", "
      (Finset.Data.Finset.Fold.«term_*_» `a "*" (Term.app `f [`x])))
     "="
   ...
   (Term.typeSpec
    ...
    («term_=_»
     (Topology.Algebra.InfiniteSum.«term∑'_,_»
      ...
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `x)] []))
      ", "
      (Finset.Data.Finset.Fold.«term_*_» (Term.app `f [`x]) "*" `a))
     "="
     (Finset.Data.Finset.Fold.«term_*_»
      (Topology.Algebra.InfiniteSum.«term∑'_,_»
       "∑'"
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  ...
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.arrow (termℕ "ℕ") "→" (Data.Real.Nnreal.«termℝ≥0» " ℝ≥0 "))] "}")
    (Term.explicitBinder "(" [`k] [":" (termℕ "ℕ")] [] ")")
    (Term.implicitBinder "{" [`a] [":" (Data.Real.Nnreal.«termℝ≥0» " ℝ≥0 ")] "}")]
   (Term.typeSpec
    ":"
    («term_↔_»
     (Term.app
      ...
      [(Term.fun
        "fun"
        (Term.basicFun [(Term.simpleBinder [`n] [])] "=>" (Term.app `f [(Init.Logic.«term_+_» `n "+" `k)])))
       `a])
     "↔"
     (Term.app
      `HasSum
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.simp
         ...
         []
         ["["
          [(Tactic.simpLemma [] ["←"] `has_sum_coe)
           ","
           (Tactic.simpLemma [] [] `coe_sum)
           ","
           (Tactic.simpLemma [] [] `Nnreal.coe_add)
           ","
           (Tactic.simpLemma [] ["←"] (Term.app `has_sum_nat_add_iff [`k]))]
          "]"]
         [])
        [])])))
   [])
...
theorem
  has_sum_nat_add_iff
  { f : ℕ → ℝ≥0 } ( k : ℕ ) { a : ℝ≥0 } : HasSum fun n => f n + k a ↔ HasSum f a + ∑ i in range k , f i
    ...
    («term_=_»
     ...
     (Init.Logic.«term_+_»
      ...
      (Topology.Algebra.InfiniteSum.«term∑'_,_»
       ...
       (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
       ", "
       (Term.app `f [(Init.Logic.«term_+_» `i "+" `k)]))))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Init.Logic.«term_+_» `i "+" `k) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `f
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
theorem
  sum_add_tsum_nat_add
  { f : ℕ → ℝ≥0 } ( k : ℕ ) ( hf : Summable f ) : ∑' i , f i = ∑ i in range k , f i + ∑' i , f i + k
  :=
    by
      rw
        [
 ...
 (Command.theorem
  ...
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `CompleteLattice [`α]) "]")
    (Term.implicitBinder "{" [`f] [":" (Term.arrow (Data.Real.Basic.termℝ "ℝ") "→" `α)] "}")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Order.CompleteLattice.«term⨅_,_»
      "⨅"
      (Lean.explicitBinders
       [(Lean.bracketedExplicitBinders "(" [(Lean.binderIdent `n)] ":" (Data.Real.Basic.termℝ "ℝ") ")")
        (Lean.bracketedExplicitBinders "(" [(Lean.binderIdent `h)] ":" («term_<_» (numLit "0") "<" `n) ")")])
      ", "
      (Term.app `f [`n]))
     "="
     (Order.CompleteLattice.«term⨅_,_»
      "⨅"
      (Lean.explicitBinders
       [(Lean.bracketedExplicitBinders "(" [(Lean.binderIdent `n)] ":" (Data.Real.Nnreal.«termℝ≥0» " ℝ≥0 ") ")")
        (Lean.bracketedExplicitBinders "(" [(Lean.binderIdent `h)] ":" («term_<_» (numLit "0") "<" `n) ")")])
      ", "
      (Term.app `f [`n])))))
  (Command.declValSimple
      ...
      (Term.fun
       ...
       (Term.basicFun
        ...
        (Term.anonymousCtor
         ...
         [`r
          ","
          («term_$__» `infi_le_infi "$" (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`hr] [])] "=>" `le_rfl)))]
         "⟩"))))
     («term_$__»
      `le_infi
      "$"
        ...
        («term_$__»
         ...
         (Term.fun
          ...
          (Term.basicFun
           ...
           "=>"
           («term_$__»
            (Term.app `infi_le_of_le [(Term.anonymousCtor "⟨" [`r "," `hr.le] "⟩")])
            "$"
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.anonymousCtor
   "⟨"
   [`r "," («term_$__» `infi_le_infi "$" (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`hr] [])] "=>" `le_rfl)))]
   "⟩")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.anonymousCtor.antiquot'
...
theorem
  ...
  [ CompleteLattice α ] { f : ℝ → α } : ⨅ ( n : ℝ ) ( h : 0 < n ) , f n = ⨅ ( n : ℝ≥0 ) ( h : 0 < n ) , f n
  :=
    le_antisymmₓ
      infi_le_infi2 $ fun r => ⟨ r , infi_le_infi $ fun hr => le_rfl ⟩
   ...
   (Term.typeSpec
    ...
    (Term.app
     ...
     [(Term.fun
       "fun"
       (Term.basicFun
        [(Term.simpleBinder [`s] [(Term.typeSpec ":" (Term.app `Finset [`α]))])]
        "=>"
        (Topology.Algebra.InfiniteSum.«term∑'_,_»
         "∑'"
         (Lean.explicitBinders
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.simpRw
         ...
         (Tactic.rwRuleSeq
          "["
          [(Tactic.rwRule ["←"] `tendsto_coe) "," (Tactic.rwRule [] `coe_tsum) "," (Tactic.rwRule [] `Nnreal.coe_zero)]
          "]")
         [])
        [])
       (group
...
/--
  ...
  theorem
    tendsto_tsum_compl_at_top_zero
    { α : Type _ } ( f : α → ℝ≥0 ) : tendsto fun s : Finset α => ∑' b : { x // x ∉ s } , f b at_top 𝓝 0
    :=
      by
