...
/-- The cartesian product of two nonarchimedean groups is nonarchimedean. -/ @[ to_additive ]
  instance
    : NonarchimedeanGroup ( G × K )
    where is_nonarchimedean U hU := let ⟨ V , W , h ⟩ := prod_subset hU ⟨ V.prod W , ‹ _ › ⟩
