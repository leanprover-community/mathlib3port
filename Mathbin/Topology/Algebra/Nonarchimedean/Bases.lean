...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " Every subgroups basis on a ring leads to a ring filter basis. -/")]
  []
  []
  []
  []
 ...
 (Command.def
  "def"
  (Command.declId `to_ring_filter_basis [])
  (Command.optDeclSig
   [(Term.instBinder "[" [] (Term.app `Nonempty [`ι]) "]")
    (Term.implicitBinder "{" [`B] [":" (Term.arrow `ι "→" (Term.app `AddSubgroup [`A]))] "}")
    (Term.explicitBinder "(" [`hB] [":" (Term.app `RingSubgroupsBasis [`B])] [] ")")]
   [(Term.typeSpec ":" (Term.app `RingFilterBasis [`A]))])
       ...
       (Term.byTactic
        ...
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(group (Tactic.inhabit "inhabit" [] `ι) [])
           (group
            (Tactic.exact
             "exact"
             (Term.anonymousCtor
              "⟨"
              [(Term.app `B [(Term.app `default [`ι])]) "," (Term.app `default [`ι]) "," `rfl]
              "⟩"))
            [])]))))
      [","])
     (group
         ...
         (Tactic.tacticSeq1Indented
          [(group
           ...
           (group
            (Tactic.cases'
             "cases'"
             [(Tactic.casesTarget [] (Term.app `hB.inter [`i `j]))]
             []
             ["with" [(Lean.binderIdent `k) (Lean.binderIdent `hk)]])
            [])
           (group (Tactic.use "use" [(Term.app `B [`k]) "," `k "," `rfl "," `hk]) [])]))))
      [","])
     (group
      (Term.structInstField
       (Term.structInstLVal `zero' [])
       ":="
       (Term.byTactic
        "by"
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(group
            (Tactic.rintro
             ...
             [])
            [])
           (group (Tactic.exact "exact" (Term.proj (Term.app `B [`i]) "." `zero_mem)) [])]))))
      [","])
     (group
      (Term.structInstField
       (Term.structInstLVal `add' [])
       ":="
       (Term.byTactic
        "by"
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(group
            (Tactic.rintro
             ...
             [])
            [])
           (group (Tactic.use "use" [(Term.app `B [`i]) "," `i "," `rfl]) [])
           (group
            (Tactic.rintro
             "rintro"
              ...
              (Tactic.rintroPat.one
               (Tactic.rcasesPat.tuple
                ...
                [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `y)]) [])
                 ...
                 ","
                 (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `y_in)]) [])
                 ","
                 (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `z_in)]) [])
                 ","
                 (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `rfl)]) [])]
                "⟩"))]
             [])
            [])
           (group (Tactic.exact "exact" (Term.app (Term.proj (Term.app `B [`i]) "." `add_mem) [`y_in `z_in])) [])]))))
      [","])
     (group
      (Term.structInstField
        ...
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(group
           ...
           (group (Tactic.exact "exact" (Term.app (Term.proj (Term.app `B [`i]) "." `neg_mem) [`x_in])) [])]))))
      [","])
     (group
      (Term.structInstField
       (Term.structInstLVal `conj' [])
       ":="
       (Term.byTactic
        "by"
        (Tactic.tacticSeq
         ...
         (Tactic.tacticSeq1Indented
          [(group
           ...
           (group
            (Tactic.cases'
             "cases'"
             [(Tactic.casesTarget [] (Term.app `hB.mul [`i]))]
             []
             ["with" [(Lean.binderIdent `k) (Lean.binderIdent `hk)]])
            [])
           (group (Tactic.use "use" [(Term.app `B [`k]) "," `k "," `rfl "," `hk]) [])]))))
         ...
         (Tactic.tacticSeq1Indented
          [(group
           ...
           (group
            (Tactic.cases'
             "cases'"
             [(Tactic.casesTarget [] (Term.app `hB.left_mul [`x₀ `i]))]
             []
             ["with" [(Lean.binderIdent `k) (Lean.binderIdent `hk)]])
            [])
           (group (Tactic.use "use" [(Term.app `B [`k]) "," `k "," `rfl "," `hk]) [])]))))
         ...
         (Tactic.tacticSeq1Indented
          [(group
           ...
           (group
            (Tactic.cases'
             "cases'"
             [(Tactic.casesTarget [] (Term.app `hB.right_mul [`x₀ `i]))]
             []
             ["with" [(Lean.binderIdent `k) (Lean.binderIdent `hk)]])
            [])
           (group (Tactic.use "use" [(Term.app `B [`k]) "," `k "," `rfl "," `hk]) [])]))))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.use "use" [(Term.app `B [`k]) "," `k "," `rfl "," `hk])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.use "use" [(Term.app `B [`i]) "," `i "," `rfl])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.use', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `rfl
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app (Term.proj (Term.app `B [`i]) "." `neg_mem) [`x_in]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.proj (Term.app `B [`i]) "." `neg_mem) [`x_in])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `B [`i]) "." `neg_mem)
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app (Term.proj (Term.app `B [`i]) "." `add_mem) [`y_in `z_in]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.proj (Term.app `B [`i]) "." `add_mem) [`y_in `z_in])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `B [`i]) "." `add_mem)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `B [`i])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.proj (Term.app `B [`i]) "." `zero_mem))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Term.app `B [`i]) "." `zero_mem)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `B [`i])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
    ...
    (Tactic.tacticSeq1Indented
     [(group (Tactic.inhabit "inhabit" [] `ι) [])
      (group
       (Tactic.exact
        "exact"
        (Term.anonymousCtor "⟨" [(Term.app `B [(Term.app `default [`ι])]) "," (Term.app `default [`ι]) "," `rfl] "⟩"))
       [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.byTactic', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.byTactic', expected 'Lean.Parser.Term.byTactic.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq', expected 'Lean.Parser.Tactic.tacticSeq.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.inhabit "inhabit" [] `ι)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.inhabit', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `ι
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
 ...
 (Command.theorem
  ...
  (Command.declSig
   ...
   (Term.typeSpec
    ...
    (Term.app
     `has_basis
     [(Term.app (Term.explicit "@" `nhds) [`A `hB.topology `a])
      ...
      (Term.fun
       ...
       (Term.basicFun
        [(Term.simpleBinder [`i] [])]
        "=>"
        (Set.«term{_|_}» "{" `b "|" (Init.Core.«term_∈_» («term_-_» `b "-" `a) " ∈ " (Term.app `B [`i])) "}")))])))
  (Command.declValSimple
   ":="
   (Term.anonymousCtor
    "⟨"
        ...
        [(group (Tactic.intro "intro" [`s]) [])
          ...
          (Tactic.rwSeq
           ...
           (Tactic.rwRuleSeq
            ...
            [(Tactic.rwRule
              []
              (Term.proj
               (Term.app `hB.to_ring_filter_basis.to_add_group_filter_basis.nhds_has_basis [`a])
               "."
               `mem_iff))]
            "]")
           [])
         ...
         (group
          (Tactic.simp
           ...
           []
           ["only"]
           ["[" [(Tactic.simpLemma [] [] `exists_prop) "," (Tactic.simpLemma [] [] `exists_true_left)] "]"]
           [])
          [])
           ...
           (Tactic.tacticSeq
            (Tactic.tacticSeq1Indented
             [(group
              ...
              (group (Tactic.convert "convert" [] `hi []) [])
              (group (Tactic.ext "ext" [(Tactic.rcasesPat.one `b)] []) [])
              (group (Tactic.constructor "constructor") [])
              (group
               (Tactic.«tactic·._»
                "·"
                (Tactic.tacticSeq
                 (Tactic.tacticSeq1Indented
                  [(group (Tactic.intro "intro" [`h]) [])
                   (group (Tactic.use "use" [(«term_-_» `b "-" `a) "," `h]) [])
           ...
           (Tactic.tacticSeq
            (Tactic.tacticSeq1Indented
             [(group
               ...
               [])
              (group (Tactic.use "use" [(Term.app `B [`i]) "," `i "," `rfl]) [])
              (group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `image_subset_iff)] "]") []) [])
              (group
               (Tactic.rintro
                "rintro"
                [(Tactic.rintroPat.one (Tactic.rcasesPat.one `b)) (Tactic.rintroPat.one (Tactic.rcasesPat.one `b_in))]
                [])
               [])
              (group (Tactic.apply "apply" `hi) [])
              (group (Tactic.simpa "simpa" [] [] [] [] ["using" `b_in]) [])])))
          [])])))]
    "⟩")
   [])
  []
      ...
      (group
       (Tactic.rwSeq
        ...
        (Tactic.rwRuleSeq
         ...
         [(Tactic.rwRule
           []
           (Term.proj (Term.app `hB.to_ring_filter_basis.to_add_group_filter_basis.nhds_has_basis [`a]) "." `mem_iff))]
         "]")
        [])
       [])
      (group
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `image_subset_iff)] "]") [])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, tactic))
  (Tactic.ext "ext" [(Tactic.rcasesPat.one `b)] [])
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `hB.to_ring_filter_basis.to_add_group_filter_basis.nhds_has_basis
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Set.«term{_|_}»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Init.Core.«term_∈_» («term_-_» `b "-" `a) " ∈ " (Term.app `B [`i]))
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.structure
  ...
  (Command.declId `SubmodulesBasis [])
  [(Term.instBinder "[" [] (Term.app `TopologicalSpace [`R]) "]")
   (Term.explicitBinder "(" [`B] [":" (Term.arrow `ι "→" (Term.app `Submodule [`R `M]))] [] ")")]
  []
       ...
       [(Term.typeSpec
         ...
         (Term.forall
          ...
          («term∃_,_»
           ...
           ","
           («term_≤_» (Term.app `B [`k]) "≤" (Order.Lattice.«term_⊓_» (Term.app `B [`i]) "⊓" (Term.app `B [`j]))))))])
      [])
     (Command.structSimpleBinder
      (Command.declModifiers [] [] [] [] [] [])
      `smul
      ...
      (Command.optDeclSig
       ...
       [(Term.typeSpec
         ...
         (Term.forall
          "∀"
          [(Term.simpleBinder [`m] [(Term.typeSpec ":" `M)]) (Term.simpleBinder [`i] [(Term.typeSpec ":" `ι)])]
          ","
          (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
           ...
           ", "
           (Init.Core.«term_∈_» (Algebra.Group.Defs.«term_•_» `a " • " `m) " ∈ " (Term.app `B [`i])))))])
      [])])]
  (Command.optDeriving [])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 51 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 50, term))
  (Algebra.Group.Defs.«term_•_» `a " • " `m)
...
/--
  ...
  structure
    SubmodulesBasis
    [ TopologicalSpace R ] ( B : ι → Submodule R M )
    : Prop
    where inter : ∀ i j , ∃ k , B k ≤ B i ⊓ B j smul : ∀ m : M i : ι , ∀ᶠ a in 𝓝 ( 0 : R ) , a • m ∈ B i
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " The image of a submodules basis is a module filter basis. -/")]
  []
  []
  []
  []
 ...
 (Command.def
  "def"
  (Command.declId `to_module_filter_basis [])
  (Command.optDeclSig [] [(Term.typeSpec ":" (Term.app `ModuleFilterBasis [`R `M]))])
  (Command.declValSimple
   ":="
   (Term.structInst
    "{"
         ...
         (Tactic.tacticSeq1Indented
          [(group
            (Tactic.rintro
             ...
             [])
            [])
           (group (Tactic.use "use" [`univ "," `univ_mem "," (Term.app `B [`i]) "," `i "," `rfl]) [])
           (group
            (Tactic.rintro
             "rintro"
             [(Tactic.rintroPat.one (Tactic.rcasesPat.ignore "_"))
            ...
            [])
           (group
            (Tactic.exact "exact" (Term.app (Term.proj (Term.app `B [`i]) "." `smul_mem) [(Term.hole "_") `hm]))
            [])]))))
      [","])
     (group
      (Term.structInstField
        ...
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(group
           ...
           (group
            (Tactic.exact "exact" (Term.app (Term.proj (Term.app `B [`i]) "." `smul_mem) [(Term.hole "_")]))
            [])]))))
      [","])
     (group
      (Term.structInstField
         ...
         (Tactic.tacticSeq1Indented
          [(group
            (Tactic.rintro
             ...
             [])
            [])
           (group (Tactic.exact "exact" (Term.app `hB.smul [`m₀ `i])) [])]))))
      [])]
    (Term.optEllipsis [])
    []
    "}")
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `hB.smul [`m₀ `i]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `hB.smul [`m₀ `i])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
   ...
   (Tactic.tacticSeq
    (Tactic.tacticSeq1Indented
     [(group
      ...
      (group (Tactic.use "use" [(Term.app `B [`i]) "," `i "," `rfl]) [])
      (group (Tactic.intro "intro" [`m]) [])
      (group (Tactic.exact "exact" (Term.app (Term.proj (Term.app `B [`i]) "." `smul_mem) [(Term.hole "_")])) [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.byTactic', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.byTactic', expected 'Lean.Parser.Term.byTactic.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq', expected 'Lean.Parser.Tactic.tacticSeq.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq1Indented', expected 'Lean.Parser.Tactic.tacticSeqBracketed.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.proj (Term.app `B [`i]) "." `smul_mem) [(Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `B [`i]) "." `smul_mem)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `B [`i])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.proj (Term.app `B [`i]) "." `smul_mem) [(Term.hole "_") `hm])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.use "use" [`univ "," `univ_mem "," (Term.app `B [`i]) "," `i "," `rfl])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.use', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `rfl
...
[PrettyPrinter.parenthesize.input] (Command.variable
 "variable"
 [(Term.instBinder "[" [] (Term.app `TopologicalSpace [`R]) "]")
  (Term.implicitBinder "{" [`B] [":" (Term.arrow `ι "→" (Term.app `Submodule [`R `A]))] "}")
  (Term.explicitBinder "(" [`hB] [":" (Term.app `SubmodulesRingBasis [`B])] [] ")")
  (Term.explicitBinder
   "("
   [`hsmul]
   [":"
    (Term.forall
     "∀"
     [(Term.simpleBinder [`m] [(Term.typeSpec ":" `A)]) (Term.simpleBinder [`i] [(Term.typeSpec ":" `ι)])]
     ","
     (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
      "∀ᶠ"
