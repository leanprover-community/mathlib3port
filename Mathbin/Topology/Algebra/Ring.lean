...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `coinduced_continuous [])
      (Command.declSig
       [(Term.implicitBinder "{" [`α `β] [":" (Term.type "Type" [(Level.hole "_")])] "}")
        (Term.instBinder "[" [`t ":"] (Term.app `TopologicalSpace [`α]) "]")
        (Term.instBinder "[" [] (Term.app `Ring [`β]) "]")
        (Term.explicitBinder "(" [`f] [":" (Term.arrow `α "→" `β)] [] ")")]
       (Term.typeSpec
        ":"
        (Term.app
         (RingTopology.Topology.Algebra.Ring.termcont "cont")
         [`t (Term.proj (Term.app `coinduced [`f]) "." `toTopologicalSpace) `f])))
        ...
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(Tactic.rwSeq
            "rw"
            []
            (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `continuous_iff_coinduced_le)] "]")
            [])
           []
           (Tactic.refine' "refine'" (Term.app `le_infₛ [(Term.hole "_")]))
           []
           (Std.Tactic.rintro
            "rintro"
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      (Term.proj (Term.app `coinduced [`f]) "." `toTopologicalSpace)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      (Term.app `coinduced [`f])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `f
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" (Term.app `coinduced [`f]) ")")
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none,
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      (RingTopology.Topology.Algebra.Ring.termcont "cont")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'RingTopology.Topology.Algebra.Ring.termcont', expected 'RingTopology.Topology.Algebra.Ring.termcont._@.Topology.Algebra.Ring._hyg.32'
...
theorem
  ...
  { α β : Type _ } [ t : TopologicalSpace α ] [ Ring β ] ( f : α → β )
    : cont t coinduced f . toTopologicalSpace f
  := by rw [ continuous_iff_coinduced_le ] refine' le_infₛ _ rintro _ ⟨ t' , ht' , rfl ⟩ exact ht'
