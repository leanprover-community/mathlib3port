...
#print HasContinuousConstSmul.op /-
...
#print MulOpposite.hasContinuousConstSmul /-
@[to_additive]
...
#print OrderDual.has_continuous_const_smul' /-
@[to_additive]
...
lean 3 declaration is
  forall {α : Type.{u1}} {β : Type.{u2}} [_inst_5 : SMul.{u1, u2} α β] [_inst_6 : TopologicalSpace.{u2} β] [_inst_7 : HasContinuousConstSmul.{u1, u2} α β _inst_6 _inst_5] (a : α) {s : Set.{u2} β}, (IsCompact.{u2} β _inst_6 s) -> (IsCompact.{u2} β _inst_6 (SMul.smul.{u1, u2} α (Set.{u2} β) (Set.smulSet.{u1, u2} α β _inst_5) a s))
but is expected to have type
  forall {α : Type.{u2}} {β : Type.{u1}} [_inst_5 : SMul.{u2, u1} α β] [_inst_6 : TopologicalSpace.{u1} β] [_inst_7 : HasContinuousConstSmul.{u2, u1} α β _inst_6 _inst_5] (a : α) {s : Set.{u1} β}, (IsCompact.{u1} β _inst_6 s) -> (IsCompact.{u1} β _inst_6 (HSMul.hSMul.{u2, u1, u1} α (Set.{u1} β) (Set.{u1} β) (instHSMul.{u2, u1} α (Set.{u1} β) (Set.smulSet.{u2, u1} α β _inst_5)) a s))
...
#print Units.hasContinuousConstSmul /-
@[to_additive]
...
lean 3 declaration is
  forall {α : Type.{u1}} {G₀ : Type.{u2}} [_inst_1 : TopologicalSpace.{u1} α] [_inst_2 : GroupWithZero.{u2} G₀] [_inst_3 : MulAction.{u2, u1} G₀ α (MonoidWithZero.toMonoid.{u2} G₀ (GroupWithZero.toMonoidWithZero.{u2} G₀ _inst_2))] [_inst_4 : HasContinuousConstSmul.{u2, u1} G₀ α _inst_1 (MulAction.toHasSmul.{u2, u1} G₀ α (MonoidWithZero.toMonoid.{u2} G₀ (GroupWithZero.toMonoidWithZero.{u2} G₀ _inst_2)) _inst_3)] (c : G₀), (Ne.{succ u2} G₀ c (OfNat.ofNat.{u2} G₀ 0 (OfNat.mk.{u2} G₀ 0 (Zero.zero.{u2} G₀ (MulZeroClass.toHasZero.{u2} G₀ (MulZeroOneClass.toMulZeroClass.{u2} G₀ (MonoidWithZero.toMulZeroOneClass.{u2} G₀ (GroupWithZero.toMonoidWithZero.{u2} G₀ _inst_2)))))))) -> (Homeomorph.{u1, u1} α α _inst_1 _inst_1)
but is expected to have type
...
lean 3 declaration is
  forall {α : Type.{u1}} {G₀ : Type.{u2}} [_inst_1 : TopologicalSpace.{u1} α] [_inst_2 : GroupWithZero.{u2} G₀] [_inst_3 : MulAction.{u2, u1} G₀ α (MonoidWithZero.toMonoid.{u2} G₀ (GroupWithZero.toMonoidWithZero.{u2} G₀ _inst_2))] [_inst_4 : HasContinuousConstSmul.{u2, u1} G₀ α _inst_1 (MulAction.toHasSmul.{u2, u1} G₀ α (MonoidWithZero.toMonoid.{u2} G₀ (GroupWithZero.toMonoidWithZero.{u2} G₀ _inst_2)) _inst_3)] {c : G₀} {s : Set.{u1} α}, (IsClosed.{u1} α _inst_1 s) -> (Ne.{succ u2} G₀ c (OfNat.ofNat.{u2} G₀ 0 (OfNat.mk.{u2} G₀ 0 (Zero.zero.{u2} G₀ (MulZeroClass.toHasZero.{u2} G₀ (MulZeroOneClass.toMulZeroClass.{u2} G₀ (MonoidWithZero.toMulZeroOneClass.{u2} G₀ (GroupWithZero.toMonoidWithZero.{u2} G₀ _inst_2)))))))) -> (IsClosed.{u1} α _inst_1 (SMul.smul.{u2, u1} G₀ (Set.{u1} α) (Set.smulSet.{u2, u1} G₀ α (MulAction.toHasSmul.{u2, u1} G₀ α (MonoidWithZero.toMonoid.{u2} G₀ (GroupWithZero.toMonoidWithZero.{u2} G₀ _inst_2)) _inst_3)) c s))
but is expected to have type
...
lean 3 declaration is
  forall {α : Type.{u1}} {G₀ : Type.{u2}} [_inst_1 : TopologicalSpace.{u1} α] [_inst_2 : GroupWithZero.{u2} G₀] [_inst_3 : MulAction.{u2, u1} G₀ α (MonoidWithZero.toMonoid.{u2} G₀ (GroupWithZero.toMonoidWithZero.{u2} G₀ _inst_2))] [_inst_4 : HasContinuousConstSmul.{u2, u1} G₀ α _inst_1 (MulAction.toHasSmul.{u2, u1} G₀ α (MonoidWithZero.toMonoid.{u2} G₀ (GroupWithZero.toMonoidWithZero.{u2} G₀ _inst_2)) _inst_3)] {β : Type.{u3}} [_inst_6 : One.{u3} β] {f : α -> β}, (HasCompactMulSupport.{u1, u3} α β _inst_1 _inst_6 f) -> (forall {c : G₀}, (Ne.{succ u2} G₀ c (OfNat.ofNat.{u2} G₀ 0 (OfNat.mk.{u2} G₀ 0 (Zero.zero.{u2} G₀ (MulZeroClass.toHasZero.{u2} G₀ (MulZeroOneClass.toMulZeroClass.{u2} G₀ (MonoidWithZero.toMulZeroOneClass.{u2} G₀ (GroupWithZero.toMonoidWithZero.{u2} G₀ _inst_2)))))))) -> (HasCompactMulSupport.{u1, u3} α β _inst_1 _inst_6 (fun (x : α) => f (SMul.smul.{u2, u1} G₀ α (MulAction.toHasSmul.{u2, u1} G₀ α (MonoidWithZero.toMonoid.{u2} G₀ (GroupWithZero.toMonoidWithZero.{u2} G₀ _inst_2)) _inst_3) c x))))
but is expected to have type
...
lean 3 declaration is
  forall {α : Type.{u1}} {G₀ : Type.{u2}} [_inst_1 : TopologicalSpace.{u1} α] [_inst_2 : GroupWithZero.{u2} G₀] [_inst_3 : MulAction.{u2, u1} G₀ α (MonoidWithZero.toMonoid.{u2} G₀ (GroupWithZero.toMonoidWithZero.{u2} G₀ _inst_2))] [_inst_4 : HasContinuousConstSmul.{u2, u1} G₀ α _inst_1 (MulAction.toHasSmul.{u2, u1} G₀ α (MonoidWithZero.toMonoid.{u2} G₀ (GroupWithZero.toMonoidWithZero.{u2} G₀ _inst_2)) _inst_3)] {β : Type.{u3}} [_inst_6 : Zero.{u3} β] {f : α -> β}, (HasCompactSupport.{u1, u3} α β _inst_1 _inst_6 f) -> (forall {c : G₀}, (Ne.{succ u2} G₀ c (OfNat.ofNat.{u2} G₀ 0 (OfNat.mk.{u2} G₀ 0 (Zero.zero.{u2} G₀ (MulZeroClass.toHasZero.{u2} G₀ (MulZeroOneClass.toMulZeroClass.{u2} G₀ (MonoidWithZero.toMulZeroOneClass.{u2} G₀ (GroupWithZero.toMonoidWithZero.{u2} G₀ _inst_2)))))))) -> (HasCompactSupport.{u1, u3} α β _inst_1 _inst_6 (fun (x : α) => f (SMul.smul.{u2, u1} G₀ α (MulAction.toHasSmul.{u2, u1} G₀ α (MonoidWithZero.toMonoid.{u2} G₀ (GroupWithZero.toMonoidWithZero.{u2} G₀ _inst_2)) _inst_3) c x))))
but is expected to have type
...
lean 3 declaration is
  forall {M : Type.{u1}} {α : Type.{u2}} {β : Type.{u3}} [_inst_1 : Monoid.{u1} M] [_inst_2 : TopologicalSpace.{u2} α] [_inst_3 : MulAction.{u1, u2} M α _inst_1] [_inst_4 : HasContinuousConstSmul.{u1, u2} M α _inst_2 (MulAction.toHasSmul.{u1, u2} M α _inst_1 _inst_3)] [_inst_5 : TopologicalSpace.{u3} β] {f : β -> α} {b : β} {c : M} {s : Set.{u3} β}, (IsUnit.{u1} M _inst_1 c) -> (Iff (ContinuousWithinAt.{u3, u2} β α _inst_5 _inst_2 (fun (x : β) => SMul.smul.{u1, u2} M α (MulAction.toHasSmul.{u1, u2} M α _inst_1 _inst_3) c (f x)) s b) (ContinuousWithinAt.{u3, u2} β α _inst_5 _inst_2 f s b))
but is expected to have type
  forall {M : Type.{u3}} {α : Type.{u1}} {β : Type.{u2}} [_inst_1 : Monoid.{u3} M] [_inst_2 : TopologicalSpace.{u1} α] [_inst_3 : MulAction.{u3, u1} M α _inst_1] [_inst_4 : HasContinuousConstSmul.{u3, u1} M α _inst_2 (MulAction.toSMul.{u3, u1} M α _inst_1 _inst_3)] [_inst_5 : TopologicalSpace.{u2} β] {f : β -> α} {b : β} {c : M} {s : Set.{u2} β}, (IsUnit.{u3} M _inst_1 c) -> (Iff (ContinuousWithinAt.{u2, u1} β α _inst_5 _inst_2 (fun (x : β) => HSMul.hSMul.{u3, u1, u1} M α α (instHSMul.{u3, u1} M α (MulAction.toSMul.{u3, u1} M α _inst_1 _inst_3)) c (f x)) s b) (ContinuousWithinAt.{u2, u1} β α _inst_5 _inst_2 f s b))
...
lean 3 declaration is
  forall {M : Type.{u1}} {α : Type.{u2}} {β : Type.{u3}} [_inst_1 : Monoid.{u1} M] [_inst_2 : TopologicalSpace.{u2} α] [_inst_3 : MulAction.{u1, u2} M α _inst_1] [_inst_4 : HasContinuousConstSmul.{u1, u2} M α _inst_2 (MulAction.toHasSmul.{u1, u2} M α _inst_1 _inst_3)] [_inst_5 : TopologicalSpace.{u3} β] {f : β -> α} {c : M} {s : Set.{u3} β}, (IsUnit.{u1} M _inst_1 c) -> (Iff (ContinuousOn.{u3, u2} β α _inst_5 _inst_2 (fun (x : β) => SMul.smul.{u1, u2} M α (MulAction.toHasSmul.{u1, u2} M α _inst_1 _inst_3) c (f x)) s) (ContinuousOn.{u3, u2} β α _inst_5 _inst_2 f s))
but is expected to have type
...
lean 3 declaration is
  forall {M : Type.{u1}} {α : Type.{u2}} {β : Type.{u3}} [_inst_1 : Monoid.{u1} M] [_inst_2 : TopologicalSpace.{u2} α] [_inst_3 : MulAction.{u1, u2} M α _inst_1] [_inst_4 : HasContinuousConstSmul.{u1, u2} M α _inst_2 (MulAction.toHasSmul.{u1, u2} M α _inst_1 _inst_3)] [_inst_5 : TopologicalSpace.{u3} β] {f : β -> α} {b : β} {c : M}, (IsUnit.{u1} M _inst_1 c) -> (Iff (ContinuousAt.{u3, u2} β α _inst_5 _inst_2 (fun (x : β) => SMul.smul.{u1, u2} M α (MulAction.toHasSmul.{u1, u2} M α _inst_1 _inst_3) c (f x)) b) (ContinuousAt.{u3, u2} β α _inst_5 _inst_2 f b))
but is expected to have type
...
lean 3 declaration is
  forall {M : Type.{u1}} {α : Type.{u2}} {β : Type.{u3}} [_inst_1 : Monoid.{u1} M] [_inst_2 : TopologicalSpace.{u2} α] [_inst_3 : MulAction.{u1, u2} M α _inst_1] [_inst_4 : HasContinuousConstSmul.{u1, u2} M α _inst_2 (MulAction.toHasSmul.{u1, u2} M α _inst_1 _inst_3)] [_inst_5 : TopologicalSpace.{u3} β] {f : β -> α} {c : M}, (IsUnit.{u1} M _inst_1 c) -> (Iff (Continuous.{u3, u2} β α _inst_5 _inst_2 (fun (x : β) => SMul.smul.{u1, u2} M α (MulAction.toHasSmul.{u1, u2} M α _inst_1 _inst_3) c (f x))) (Continuous.{u3, u2} β α _inst_5 _inst_2 f))
but is expected to have type
...
lean 3 declaration is
  forall {M : Type.{u1}} {α : Type.{u2}} [_inst_1 : Monoid.{u1} M] [_inst_2 : TopologicalSpace.{u2} α] [_inst_3 : MulAction.{u1, u2} M α _inst_1] [_inst_4 : HasContinuousConstSmul.{u1, u2} M α _inst_2 (MulAction.toHasSmul.{u1, u2} M α _inst_1 _inst_3)] {c : M}, (IsUnit.{u1} M _inst_1 c) -> (IsOpenMap.{u2, u2} α α _inst_2 _inst_2 (fun (x : α) => SMul.smul.{u1, u2} M α (MulAction.toHasSmul.{u1, u2} M α _inst_1 _inst_3) c x))
but is expected to have type
  forall {M : Type.{u2}} {α : Type.{u1}} [_inst_1 : Monoid.{u2} M] [_inst_2 : TopologicalSpace.{u1} α] [_inst_3 : MulAction.{u2, u1} M α _inst_1] [_inst_4 : HasContinuousConstSmul.{u2, u1} M α _inst_2 (MulAction.toSMul.{u2, u1} M α _inst_1 _inst_3)] {c : M}, (IsUnit.{u2} M _inst_1 c) -> (IsOpenMap.{u1, u1} α α _inst_2 _inst_2 (fun (x : α) => HSMul.hSMul.{u2, u1, u1} M α α (instHSMul.{u2, u1} M α (MulAction.toSMul.{u2, u1} M α _inst_1 _inst_3)) c x))
...
lean 3 declaration is
  forall {M : Type.{u1}} {α : Type.{u2}} [_inst_1 : Monoid.{u1} M] [_inst_2 : TopologicalSpace.{u2} α] [_inst_3 : MulAction.{u1, u2} M α _inst_1] [_inst_4 : HasContinuousConstSmul.{u1, u2} M α _inst_2 (MulAction.toHasSmul.{u1, u2} M α _inst_1 _inst_3)] {c : M}, (IsUnit.{u1} M _inst_1 c) -> (IsClosedMap.{u2, u2} α α _inst_2 _inst_2 (fun (x : α) => SMul.smul.{u1, u2} M α (MulAction.toHasSmul.{u1, u2} M α _inst_1 _inst_3) c x))
but is expected to have type
...
#print HasContinuousConstSmul.secondCountableTopology /-
