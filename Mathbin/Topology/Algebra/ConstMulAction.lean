...
-/
class HasContinuousConstSmul (Γ : Type _) (T : Type _) [TopologicalSpace T] [HasScalar Γ T] : Prop where
...
variable [TopologicalSpace α] [HasScalar M α] [HasContinuousConstSmul M α]
