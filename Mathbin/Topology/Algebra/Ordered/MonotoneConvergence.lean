...
theorem tendsto_at_top_is_lub (h_mono : Monotone f) (ha : IsLub (Set.Range f) a) : tendsto f at_top (𝓝 a) := by
...
theorem tendsto_at_top_csupr (h_mono : Monotone f) (hbdd : BddAbove $ range f) : tendsto f at_top (𝓝 (⨆ i, f i)) := by
...
theorem tendsto_iff_tendsto_subseq_of_monotone {ι₁ ι₂ α : Type _} [SemilatticeSup ι₁] [Preorderₓ ι₂] [Nonempty ι₁]
    [TopologicalSpace α] [ConditionallyCompleteLinearOrder α] [OrderTopology α] [NoTopOrder α] {f : ι₂ → α}
    {φ : ι₁ → ι₂} {l : α} (hf : Monotone f) (hg : tendsto φ at_top at_top) :
    tendsto f at_top (𝓝 l) ↔ tendsto (f ∘ φ) at_top (𝓝 l) := by
  constructor <;> intro h
  · exact h.comp hg
...
theorem Monotone.ge_of_tendsto [TopologicalSpace α] [Preorderₓ α] [OrderClosedTopology α] [SemilatticeSup β] {f : β → α}
    {a : α} (hf : Monotone f) (ha : tendsto f at_top (𝓝 a)) (b : β) : f b ≤ a :=
...
theorem Monotone.le_of_tendsto [TopologicalSpace α] [Preorderₓ α] [OrderClosedTopology α] [SemilatticeInf β] {f : β → α}
    {a : α} (hf : Monotone f) (ha : tendsto f at_bot (𝓝 a)) (b : β) : a ≤ f b :=
...
theorem is_lub_of_tendsto_at_top [TopologicalSpace α] [Preorderₓ α] [OrderClosedTopology α] [Nonempty β]
    [SemilatticeSup β] {f : β → α} {a : α} (hf : Monotone f) (ha : tendsto f at_top (𝓝 a)) : IsLub (Set.Range f) a := by
  constructor
  · rintro _ ⟨b, rfl⟩
...
theorem is_glb_of_tendsto_at_bot [TopologicalSpace α] [Preorderₓ α] [OrderClosedTopology α] [Nonempty β]
  ...
  @is_lub_of_tendsto_at_top (OrderDual α) (OrderDual β) _ _ _ _ _ _ _ hf.dual ha

theorem is_lub_of_tendsto_at_bot [TopologicalSpace α] [Preorderₓ α] [OrderClosedTopology α] [Nonempty β]
    [SemilatticeInf β] {f : β → α} {a : α} (hf : Antitone f) (ha : tendsto f at_bot (𝓝 a)) : IsLub (Set.Range f) a :=
  @is_lub_of_tendsto_at_top α (OrderDual β) _ _ _ _ _ _ _ hf.dual_left ha

theorem is_glb_of_tendsto_at_top [TopologicalSpace α] [Preorderₓ α] [OrderClosedTopology α] [Nonempty β]
    [SemilatticeSup β] {f : β → α} {a : α} (hf : Antitone f) (ha : tendsto f at_top (𝓝 a)) : IsGlb (Set.Range f) a :=
  @is_glb_of_tendsto_at_bot α (OrderDual β) _ _ _ _ _ _ _ hf.dual_left ha
