...
theorem Filter.Eventually.exists_gt [NoTopOrder α] {a : α} {p : α → Prop} (h : ∀ᶠ x in 𝓝 a, p x) : ∃ b > a, p b := by
...
theorem Filter.Eventually.exists_lt [NoBotOrder α] {a : α} {p : α → Prop} (h : ∀ᶠ x in 𝓝 a, p x) : ∃ b < a, p b :=
