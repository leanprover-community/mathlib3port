...
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment "/--" " A closed interval in a conditionally complete linear order is compact. -/")]
  []
  []
  []
  []
 ...
 (Command.instance
  ...
  [(Command.declId `ConditionallyCompleteLinearOrder.to_compact_Icc_space [])]
  (Command.declSig
   [(Term.explicitBinder "(" [`α] [":" (Term.type "Type" [(Level.hole "_")])] [] ")")
    (Term.instBinder "[" [] (Term.app `ConditionallyCompleteLinearOrder [`α]) "]")
    (Term.instBinder "[" [] (Term.app `TopologicalSpace [`α]) "]")
    (Term.instBinder "[" [] (Term.app `OrderTopology [`α]) "]")]
   (Term.typeSpec ":" (Term.app `CompactIccSpace [`α])))
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.refine'
         ...
         (Term.anonymousCtor
          "⟨"
          [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`a `b] [])] "=>" (Term.hole "_")))]
          "⟩"))
        [])
       (group
        (Tactic.cases'
       ...
       (group
        (Tactic.«tactic·._»
         ...
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group (Tactic.simp "simp" [] [] ["[" [(Tactic.simpLemma [] [] `hab)] "]"] []) [])])))
        [])
       (group
        (Tactic.refine'
         "refine'"
         (Term.app
          (Term.proj `is_compact_iff_ultrafilter_le_nhds "." (fieldIdx "2"))
          [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`f `hf] [])] "=>" (Term.hole "_")))]))
        [])
       (group (Tactic.contrapose! "contrapose!" [`hf []]) [])
         ...
         [(Term.typeSpec
           ...
           (Term.forall
            ...
            (Mathlib.ExtendedBinder.«term∀___,_»
             "∀"
             `x
             («binderTerm∈_» "∈" (Term.app `Icc [`a `b]))
             ","
             (Term.forall "∀" [] "," (Init.Core.«term_∉_» (Set.«term{_}» "{" [`x] "}") " ∉ " `f)))))])
        [])
       (group
        (Tactic.exact
         "exact"
          ...
          (Term.basicFun
           ...
           (Term.app
            ...
            [`x
             `hx
             (Term.app
              (Term.proj (Term.app (Term.proj `le_pure_iff "." (fieldIdx "2")) [`hxf]) "." `trans)
              [(Term.app `pure_le_nhds [`x])])]))))
        [])
       (group
        (Tactic.set
         "set"
         ...
         (Set.«term{_|_}_1»
          "{"
          («term_∈_» `x "∈" (Term.app `Icc [`a `b]))
          "|"
          (Init.Core.«term_∉_» (Term.app `Icc [`a `x]) " ∉ " `f)
          "}")
         [])
        [])
       (group
        (Tactic.have''
         "have"
         [`hsb []]
         [(Term.typeSpec ":" (Init.Core.«term_∈_» `b " ∈ " (Term.app `UpperBounds [`s])))])
        [])
       (group
        (Tactic.exact
         "exact"
        ...
        [])
       (group (Tactic.have'' "have" [`sbd []] [(Term.typeSpec ":" (Term.app `BddAbove [`s]))]) [])
       (group (Tactic.exact "exact" (Term.anonymousCtor "⟨" [`b "," `hsb] "⟩")) [])
       (group
        (Tactic.tacticHave_
         "have"
         (Term.haveDecl
          (Term.haveIdDecl
           [`ha []]
           [(Term.typeSpec ":" (Init.Core.«term_∈_» `a " ∈ " `s))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(group
                (Tactic.simp
                 ...
                 []
                 []
                 ["[" [(Tactic.simpLemma [] [] `hpt) "," (Tactic.simpLemma [] [] `hab)] "]"]
                 [])
                [])]))))))
        [])
       (group
        (Tactic.rcases
         "rcases"
         [(Tactic.casesTarget [] `hab.eq_or_lt)]
         ["with"
          (Tactic.rcasesPat.paren
           "("
           (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `rfl) "|" (Tactic.rcasesPat.one `hlt)]) [])
           ")")])
        [])
       (group
        (Tactic.«tactic·._»
         "·"
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented [(group (Tactic.exact "exact" (Term.proj `ha "." (fieldIdx "2"))) [])])))
        [])
       (group (Tactic.set "set" `c [] ":=" (Term.app `Sup [`s]) []) [])
       (group (Tactic.have'' "have" [`hsc []] [(Term.typeSpec ":" (Term.app `IsLub [`s `c]))]) [])
       (group (Tactic.exact "exact" (Term.app `is_lub_cSup [(Term.anonymousCtor "⟨" [`a "," `ha] "⟩") `sbd])) [])
       (group
        (Tactic.have'' "have" [`hc []] [(Term.typeSpec ":" (Init.Core.«term_∈_» `c " ∈ " (Term.app `Icc [`a `b])))])
        [])
       (group
        (Tactic.exact
         "exact"
         (Term.anonymousCtor
          ...
          "⟩"))
        [])
       (group (Tactic.specialize "specialize" (Term.app `hf [`c `hc])) [])
       (group
        (Tactic.tacticHave_
         "have"
         (Term.haveDecl
              ...
              [(group
               ...
               (group
                (Tactic.«tactic·._»
                 ...
                 (Tactic.tacticSeq
                  (Tactic.tacticSeq1Indented
                   [(group (tacticRwa__ "rwa" (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `HEq)] "]") []) [])])))
                [])
               (group
                (Tactic.refine'
                 "refine'"
               ...
               (group
                (Tactic.rcases
                 ...
                 [(Tactic.casesTarget
                   []
                   (Term.app
                    (Term.proj (Term.app `mem_nhds_within_Iic_iff_exists_Ioc_subset' [`hlt]) "." (fieldIdx "1"))
                    [(Term.app `mem_nhds_within_of_mem_nhds [`hU])]))]
                 ["with"
                  (Tactic.rcasesPat.tuple
                   "⟨"
                   [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `x)]) [])
                    ","
                    (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `hxc)]) [])
                    ","
                ...
                (Tactic.rcases
                 ...
                 [(Tactic.casesTarget
                   ...
                   (Term.proj
                    (Term.app
                     (Term.proj
                      (Term.app `hsc.frequently_mem [(Term.anonymousCtor "⟨" [`a "," `ha] "⟩")])
                      "."
                      `and_eventually)
                     [(Term.app `Ioc_mem_nhds_within_Iic [(Term.anonymousCtor "⟨" [`hxc "," `le_rfl] "⟩")])])
                    "."
                    `exists))]
                 ["with"
                  (Tactic.rcasesPat.tuple
                   ...
                   [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `y)]) [])
                    ...
                    (Tactic.rcasesPatLo
                     (Tactic.rcasesPatMed
                      [(Tactic.rcasesPat.tuple
                        "⟨"
                        [(Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `hyab)]) [])
                         ","
                         (Tactic.rcasesPatLo (Tactic.rcasesPatMed [(Tactic.rcasesPat.one `hyf)]) [])]
                        "⟩")])
                     [])
                    ","
               ...
               (group
                (Tactic.refine'
                 ...
                 (Term.app
                  `mem_of_superset
                  [(Term.app
                    (Term.proj `f.diff_mem_iff "." (fieldIdx "2"))
                    [(Term.anonymousCtor "⟨" [`hcf "," `hyf] "⟩")])
                   (Term.app `subset.trans [(Term.hole "_") `hxU])]))
                [])
               (group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `diff_subset_iff)] "]") []) [])
               (group
                (Tactic.exact
                 "exact"
                 (Term.app
                  ...
                  [`Icc_subset_Icc_union_Ioc
                   («term_$__»
                    (Term.app `union_subset_union [`subset.rfl])
                    "$"
                    (Term.app `Ioc_subset_Ioc_left [(Term.proj (Term.proj `hy "." (fieldIdx "1")) "." `le)]))]))
                [])]))))))
        [])
       (group
        (Tactic.cases'
         ...
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `HEq)] "]") []) [])
            (group (Tactic.exact "exact" (Term.proj `hcs "." (fieldIdx "2"))) [])])))
        [])
       (group (Tactic.contrapose! "contrapose!" [`hf []]) [])
       (group (Tactic.intro "intro" [`U `hU]) [])
       (group
        (Tactic.rcases
         "rcases"
         [(Tactic.casesTarget
         ...
         ["with"
          (Tactic.rcasesPat.tuple
           ...
           "⟩")])
        [])
       (group (Tactic.refine' "refine'" (Term.app `mem_of_superset [(Term.hole "_") `hyU])) [])
       (group (Tactic.clear! "clear!" [`U]) [])
       (group
        (Tactic.have'' "have" [`hy []] [(Term.typeSpec ":" (Init.Core.«term_∈_» `y " ∈ " (Term.app `Icc [`a `b])))])
        [])
       (group
        (Tactic.exact
         "exact"
         (Term.anonymousCtor
          ...
          [(Term.app
            ...
            [(Term.proj (Term.proj `hxy "." (fieldIdx "1")) "." `le)])
           ","
           (Term.proj `hxy "." (fieldIdx "2"))]
          "⟩"))
        [])
       (group (Tactic.byCases' "by_cases'" [`hay ":"] (Init.Core.«term_∈_» (Term.app `Icc [`a `y]) " ∈ " `f)) [])
       (group
        (Tactic.«tactic·._»
         "·"
         (Tactic.tacticSeq
           ...
           [(group
              ...
              (Term.app
               ...
               [(Term.app
                 ...
                 [(Term.anonymousCtor
                   ...
                   [(Term.app
                     (Term.proj `f.diff_mem_iff "." (fieldIdx "2"))
                     [(Term.anonymousCtor "⟨" [`hay "," (Term.proj `hcs "." (fieldIdx "2"))] "⟩")])
                    ","
                    (Term.app `hpt [`y `hy])]
                   "⟩")])
                (Term.hole "_")]))
            ...
            (group
             (Tactic.rwSeq
              ...
              (Tactic.rwRuleSeq
               "["
               [(Tactic.rwRule [] `diff_subset_iff)
                ","
                (Tactic.rwRule [] `union_comm)
                ","
                (Tactic.rwRule [] (Term.app `Ico_union_right [(Term.proj (Term.proj `hxy "." (fieldIdx "1")) "." `le)]))
                ","
                (Tactic.rwRule [] `diff_subset_iff)]
               "]")
              [])
             [])
            (group (Tactic.exact "exact" `Icc_subset_Icc_union_Icc) [])])))
        [])
       (group
        (Tactic.«tactic·._»
         "·"
           ...
           [(group
             (Tactic.exact
              ...
              (Term.proj
               (Term.app
                (Term.proj
                 (Term.app (Term.proj `hsc "." (fieldIdx "1")) [(Term.anonymousCtor "⟨" [`hy "," `hay] "⟩")])
                 "."
                 `not_lt)
                [(Term.proj `hxy "." (fieldIdx "1"))])
               "."
               `elim))
             [])])))
        [])])))
         ...
         (Term.haveIdDecl
          ...
          (Term.byTactic
           ...
           (Tactic.tacticSeq
            (Tactic.tacticSeq1Indented
             [(group
               (Tactic.simp "simp" [] [] ["[" [(Tactic.simpLemma [] [] `hpt) "," (Tactic.simpLemma [] [] `hab)] "]"] [])
               [])]))))))
       [])
      (group
       (Tactic.rcases
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj
   (Term.app
    (Term.proj (Term.app (Term.proj `hsc "." (fieldIdx "1")) [(Term.anonymousCtor "⟨" [`hy "," `hay] "⟩")]) "." `not_lt)
    [(Term.proj `hxy "." (fieldIdx "1"))])
   "."
   `elim)
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" `Icc_subset_Icc_union_Icc)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Ico_union_right [(Term.proj (Term.proj `hxy "." (fieldIdx "1")) "." `le)])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Init.Core.«term_∈_» `y " ∈ " (Term.app `Icc [`a `b]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Core.«term_∈_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Icc [`a `b])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.refine' "refine'" (Term.app `mem_of_superset [(Term.hole "_") `hyU]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.refine'', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `mem_of_superset [(Term.hole "_") `hyU])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `mem_nhds_within_of_mem_nhds [`hU]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `mem_nhds_within_Ici_iff_exists_mem_Ioc_Ico_subset [`hlt]) "." (fieldIdx "1"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.contrapose! "contrapose!" [`hf []])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.proj `hcs "." (fieldIdx "2")))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj `hcs "." (fieldIdx "2"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
        ...
        [(group
         ...
         (group
          (Tactic.refine'
           ...
           (Term.app
            `mem_of_superset
            [(Term.app (Term.proj `f.diff_mem_iff "." (fieldIdx "2")) [(Term.anonymousCtor "⟨" [`hcf "," `hyf] "⟩")])
             (Term.app `subset.trans [(Term.hole "_") `hxU])]))
          [])
         (group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `diff_subset_iff)] "]") []) [])
         (group
         ...
         [`hc
          ...
          (Term.fun
           ...
           (Term.basicFun
            [(Term.simpleBinder [`hcf] [])]
            "=>"
            (Term.app `hf [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`U `hU] [])] "=>" (Term.hole "_")))])))]
         "⟩"))
       [])
      (group
       (Tactic.rcases
      ...
      (group
       (Tactic.rcases
        ...
        [(Tactic.casesTarget
          ...
          (Term.proj
           (Term.app
            (Term.proj (Term.app `hsc.frequently_mem [(Term.anonymousCtor "⟨" [`a "," `ha] "⟩")]) "." `and_eventually)
            [(Term.app `Ioc_mem_nhds_within_Iic [(Term.anonymousCtor "⟨" [`hxc "," `le_rfl] "⟩")])])
           "."
           `exists))]
        ["with"
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Term.proj `hy "." (fieldIdx "1")) "." `le)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `diff_subset_iff)] "]") [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `diff_subset_iff
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `subset.trans [(Term.hole "_") `hxU]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(Term.app
   (Term.proj
    (Term.paren "(" [(Term.app `hsc.frequently_mem [(Term.anonymousCtor "⟨" [`a "," `ha] "⟩")]) []] ")")
    "."
    `and_eventually)
   [(Term.paren "(" [(Term.app `Ioc_mem_nhds_within_Iic [(Term.anonymousCtor "⟨" [`hxc "," `le_rfl] "⟩")]) []] ")")])
  []]
 ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `mem_nhds_within_Iic_iff_exists_Ioc_subset' [`hlt])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (tacticRwa__ "rwa" (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `HEq)] "]") [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.specialize "specialize" (Term.app `hf [`c `hc]))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Init.Core.«term_∈_» `c " ∈ " (Term.app `Icc [`a `b]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Core.«term_∈_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Icc [`a `b])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.exact "exact" (Term.app `is_lub_cSup [(Term.anonymousCtor "⟨" [`a "," `ha] "⟩") `sbd]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `is_lub_cSup [(Term.anonymousCtor "⟨" [`a "," `ha] "⟩") `sbd])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.proj `ha "." (fieldIdx "2")))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.exact "exact" (Term.anonymousCtor "⟨" [`b "," `hsb] "⟩"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.anonymousCtor "⟨" [`b "," `hsb] "⟩")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.anonymousCtor.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.have'' "have" [`sbd []] [(Term.typeSpec ":" (Term.app `BddAbove [`s]))])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.have''', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'optional.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.have'' "have" [`hsb []] [(Term.typeSpec ":" (Init.Core.«term_∈_» `b " ∈ " (Term.app `UpperBounds [`s])))])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.have''', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'optional.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Init.Core.«term_∈_» `b " ∈ " (Term.app `UpperBounds [`s]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Init.Core.«term_∈_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
            ...
            hcs
              ...
              by
                cases' hc . 1 . eq_or_lt with heq hlt
                  ...
                  exact
                    subset.trans
                      Icc_subset_Icc_union_Ioc union_subset_union subset.rfl $ Ioc_subset_Ioc_left hy . 1 . le
...
theorem ContinuousOn.image_interval_eq_Icc
    (h : ContinuousOn f $ "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)") :
    f '' "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)" =
      Icc (Inf (f '' "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)"))
        (Sup (f '' "././Mathport/Syntax/Translate/Basic.lean:669:47: unsupported (impossible)")) :=
  by
