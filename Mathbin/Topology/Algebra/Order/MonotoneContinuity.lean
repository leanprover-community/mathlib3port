...
`a = 0`. -/
theorem StrictMonoOnₓ.continuous_at_right_of_exists_between {f : α → β} {s : Set α} {a : α} (h_mono : StrictMonoOnₓ f s)
...
theorem continuous_at_right_of_monotone_on_of_exists_between {f : α → β} {s : Set α} {a : α} (h_mono : MonotoneOnₓ f s)
...
theorem continuous_at_right_of_monotone_on_of_closure_image_mem_nhds_within [DenselyOrdered β] {f : α → β} {s : Set α}
    {a : α} (h_mono : MonotoneOnₓ f s) (hs : s ∈ 𝓝[≥] a) (hfs : Closure (f '' s) ∈ 𝓝[≥] f a) :
...
theorem continuous_at_right_of_monotone_on_of_image_mem_nhds_within [DenselyOrdered β] {f : α → β} {s : Set α} {a : α}
    (h_mono : MonotoneOnₓ f s) (hs : s ∈ 𝓝[≥] a) (hfs : f '' s ∈ 𝓝[≥] f a) : ContinuousWithinAt f (Ici a) a :=
...
theorem StrictMonoOnₓ.continuous_at_right_of_closure_image_mem_nhds_within [DenselyOrdered β] {f : α → β} {s : Set α}
    {a : α} (h_mono : StrictMonoOnₓ f s) (hs : s ∈ 𝓝[≥] a) (hfs : Closure (f '' s) ∈ 𝓝[≥] f a) :
...
continuous at `a` from the right. -/
theorem StrictMonoOnₓ.continuous_at_right_of_image_mem_nhds_within [DenselyOrdered β] {f : α → β} {s : Set α} {a : α}
    (h_mono : StrictMonoOnₓ f s) (hs : s ∈ 𝓝[≥] a) (hfs : f '' s ∈ 𝓝[≥] f a) : ContinuousWithinAt f (Ici a) a :=
...
theorem StrictMonoOnₓ.continuous_at_right_of_surj_on {f : α → β} {s : Set α} {a : α} (h_mono : StrictMonoOnₓ f s)
...
function `f : ℝ → ℝ` given by `f x = if x < 0 then x else x + 1` would be a counter-example at
`a = 0`. -/
theorem StrictMonoOnₓ.continuous_at_left_of_exists_between {f : α → β} {s : Set α} {a : α} (h_mono : StrictMonoOnₓ f s)
...
theorem continuous_at_left_of_monotone_on_of_exists_between {f : α → β} {s : Set α} {a : α} (hf : MonotoneOnₓ f s)
...
theorem continuous_at_left_of_monotone_on_of_closure_image_mem_nhds_within [DenselyOrdered β] {f : α → β} {s : Set α}
    {a : α} (hf : MonotoneOnₓ f s) (hs : s ∈ 𝓝[≤] a) (hfs : Closure (f '' s) ∈ 𝓝[≤] f a) :
...
theorem continuous_at_left_of_monotone_on_of_image_mem_nhds_within [DenselyOrdered β] {f : α → β} {s : Set α} {a : α}
    (h_mono : MonotoneOnₓ f s) (hs : s ∈ 𝓝[≤] a) (hfs : f '' s ∈ 𝓝[≤] f a) : ContinuousWithinAt f (Iic a) a :=
...
theorem StrictMonoOnₓ.continuous_at_left_of_closure_image_mem_nhds_within [DenselyOrdered β] {f : α → β} {s : Set α}
    {a : α} (h_mono : StrictMonoOnₓ f s) (hs : s ∈ 𝓝[≤] a) (hfs : Closure (f '' s) ∈ 𝓝[≤] f a) :
    ContinuousWithinAt f (Iic a) a :=
...
continuous at `a` from the left. -/
theorem StrictMonoOnₓ.continuous_at_left_of_image_mem_nhds_within [DenselyOrdered β] {f : α → β} {s : Set α} {a : α}
    (h_mono : StrictMonoOnₓ f s) (hs : s ∈ 𝓝[≤] a) (hfs : f '' s ∈ 𝓝[≤] f a) : ContinuousWithinAt f (Iic a) a :=
...
theorem StrictMonoOnₓ.continuous_at_left_of_surj_on {f : α → β} {s : Set α} {a : α} (h_mono : StrictMonoOnₓ f s)
...
theorem StrictMonoOnₓ.continuous_at_of_exists_between {f : α → β} {s : Set α} {a : α} (h_mono : StrictMonoOnₓ f s)
...
continuous at `a`. -/
theorem StrictMonoOnₓ.continuous_at_of_closure_image_mem_nhds [DenselyOrdered β] {f : α → β} {s : Set α} {a : α}
    (h_mono : StrictMonoOnₓ f s) (hs : s ∈ 𝓝 a) (hfs : Closure (f '' s) ∈ 𝓝 (f a)) : ContinuousAt f a :=
  continuous_at_iff_continuous_left_right.2
...
theorem StrictMonoOnₓ.continuous_at_of_image_mem_nhds [DenselyOrdered β] {f : α → β} {s : Set α} {a : α}
    (h_mono : StrictMonoOnₓ f s) (hs : s ∈ 𝓝 a) (hfs : f '' s ∈ 𝓝 (f a)) : ContinuousAt f a :=
...
is continuous at `a`. -/
theorem continuous_at_of_monotone_on_of_exists_between {f : α → β} {s : Set α} {a : α} (h_mono : MonotoneOnₓ f s)
...
theorem continuous_at_of_monotone_on_of_closure_image_mem_nhds [DenselyOrdered β] {f : α → β} {s : Set α} {a : α}
    (h_mono : MonotoneOnₓ f s) (hs : s ∈ 𝓝 a) (hfs : Closure (f '' s) ∈ 𝓝 (f a)) : ContinuousAt f a :=
  continuous_at_iff_continuous_left_right.2
...
theorem continuous_at_of_monotone_on_of_image_mem_nhds [DenselyOrdered β] {f : α → β} {s : Set α} {a : α}
    (h_mono : MonotoneOnₓ f s) (hs : s ∈ 𝓝 a) (hfs : f '' s ∈ 𝓝 (f a)) : ContinuousAt f a :=
...
theorem Monotoneₓ.continuous_of_dense_range [DenselyOrdered β] {f : α → β} (h_mono : Monotoneₓ f)
...
theorem Monotoneₓ.continuous_of_surjective [DenselyOrdered β] {f : α → β} (h_mono : Monotoneₓ f)
