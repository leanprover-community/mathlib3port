...
instance (priority := 100) LinearOrder.Sup_convergence_class [TopologicalSpace α] [LinearOrder α] [OrderTopology α] :
...
-- see Note [lower instance priority]
instance (priority := 100) LinearOrder.Inf_convergence_class [TopologicalSpace α] [LinearOrder α] [OrderTopology α] :
...
instance Pi.Sup_convergence_class' {ι : Type _} [Preorder α] [TopologicalSpace α] [SupConvergenceClass α] :
    SupConvergenceClass (ι → α) :=
  Pi.Sup_convergence_class

instance Pi.Inf_convergence_class' {ι : Type _} [Preorder α] [TopologicalSpace α] [InfConvergenceClass α] :
    InfConvergenceClass (ι → α) :=
  Pi.Inf_convergence_class

theorem tendsto_of_monotone {ι α : Type _} [Preorder ι] [TopologicalSpace α] [ConditionallyCompleteLinearOrder α]
...
theorem tendsto_iff_tendsto_subseq_of_monotone {ι₁ ι₂ α : Type _} [SemilatticeSup ι₁] [Preorder ι₂] [Nonempty ι₁]
...
theorem Monotone.ge_of_tendsto [TopologicalSpace α] [Preorder α] [OrderClosedTopology α] [SemilatticeSup β] {f : β → α}
...
theorem Monotone.le_of_tendsto [TopologicalSpace α] [Preorder α] [OrderClosedTopology α] [SemilatticeInf β] {f : β → α}
    {a : α} (hf : Monotone f) (ha : Tendsto f atBot (𝓝 a)) (b : β) : a ≤ f b :=
  hf.dual.ge_of_tendsto ha b

theorem Antitone.le_of_tendsto [TopologicalSpace α] [Preorder α] [OrderClosedTopology α] [SemilatticeSup β] {f : β → α}
    {a : α} (hf : Antitone f) (ha : Tendsto f atTop (𝓝 a)) (b : β) : a ≤ f b :=
  hf.dual_right.ge_of_tendsto ha b

theorem Antitone.ge_of_tendsto [TopologicalSpace α] [Preorder α] [OrderClosedTopology α] [SemilatticeInf β] {f : β → α}
    {a : α} (hf : Antitone f) (ha : Tendsto f atBot (𝓝 a)) (b : β) : f b ≤ a :=
  hf.dual_right.le_of_tendsto ha b

theorem is_lub_of_tendsto_at_top [TopologicalSpace α] [Preorder α] [OrderClosedTopology α] [Nonempty β]
...
theorem is_glb_of_tendsto_at_bot [TopologicalSpace α] [Preorder α] [OrderClosedTopology α] [Nonempty β]
...
theorem is_lub_of_tendsto_at_bot [TopologicalSpace α] [Preorder α] [OrderClosedTopology α] [Nonempty β]
...
theorem is_glb_of_tendsto_at_top [TopologicalSpace α] [Preorder α] [OrderClosedTopology α] [Nonempty β]
