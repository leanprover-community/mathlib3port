       ...
       [(Term.typeSpec
         ...
         (Term.forall
          ...
          (Term.forall
           ...
           ","
           (Term.arrow (Init.Core.«term_∈_» `a " ∈ " (Term.app `sets_at [`x])) "→" (Term.app `MeasurableSet [`a])))))])
      [])
     (Command.structSimpleBinder
      (Command.declModifiers [] [] [] [] [] [])
      `nonempty_interior
      ...
      (Command.optDeclSig
       ...
       [(Term.typeSpec
         ...
         (Term.forall
          ...
          (Term.forall
           "∀"
           [(Term.simpleBinder [`y] [(Term.typeSpec ":" (Term.app `Set [`α]))])]
           ","
           (Term.arrow
            (Init.Core.«term_∈_» `y " ∈ " (Term.app `sets_at [`x]))
            "→"
            (Term.proj (Term.app `Interior [`y]) "." `Nonempty)))))])
      [])
     (Command.structSimpleBinder
      (Command.declModifiers [] [] [] [] [] [])
      `Nontrivial
          ...
          (Mathlib.ExtendedBinder.«term∀___,_»
           ...
           (Term.forall
            ...
            (Mathlib.ExtendedBinder.«term∃___,_»
             "∃"
             `y
             («binderTerm∈_» "∈" (Term.app `sets_at [`x]))
             ","
             (Init.Core.«term_⊆_» `y " ⊆ " (Term.app `closed_ball [`x `ε])))))))])
      [])
     (Command.structSimpleBinder
      (Command.declModifiers [] [] [] [] [] [])
      `covering
          ...
          (Term.arrow
           (Term.forall
            ...
            (Mathlib.ExtendedBinder.«term∀___,_»
             ...
             («binderTerm∈_» "∈" `s)
             ","
             (Term.forall "∀" [] "," (Init.Core.«term_⊆_» (Term.app `f [`x]) " ⊆ " (Term.app `sets_at [`x])))))
           "→"
           (Term.arrow
            (Term.forall
             "∀"
            ...
            («term∃_,_»
             ...
             («term_∧_»
              ...
              "∧"
              («term_∧_»
               (Term.app `t.pairwise_disjoint [`u])
               "∧"
               («term_∧_»
                (Term.forall
                 "∀"
                 ...
                 (Mathlib.ExtendedBinder.«term∀___,_»
                  ...
                  («binderTerm∈_» "∈" `t)
                  ","
                  (Term.forall "∀" [] "," (Init.Core.«term_∈_» (Term.app `u [`x]) " ∈ " (Term.app `f [`x])))))
                "∧"
                («term_=_»
                 (Term.app
                  `μ
   ...
   (Term.arrow
    ...
    (Term.arrow
     ...
     («term∃_,_»
      ...
      (Lean.explicitBinders
       [(Lean.bracketedExplicitBinders "(" [(Lean.binderIdent `t)] ":" (Term.app `Set [`α]) ")")
        (Lean.bracketedExplicitBinders "(" [(Lean.binderIdent `u)] ":" (Term.arrow `α "→" (Term.app `Set [`α])) ")")])
      ","
      («term_∧_»
       (Init.Core.«term_⊆_» `t " ⊆ " `s)
       "∧"
...
/--
  ...
  structure
    VitaliFamily
    { m : MeasurableSpace α } ( μ : Measureₓ α )
    where
              ...
              ∀ , ∀ x ∈ s , ∀ , f x ⊆ sets_at x
                ...
                ∀ , ∀ x ∈ s , ∀ , ∀ ε > ( 0 : ℝ ) , ∀ , ∃ a ∈ f x , a ⊆ closed_ball x ε
                  ...
                  ∃
                    ...
                    t ⊆ s
                      ∧
                      t.pairwise_disjoint u ∧ ∀ , ∀ x ∈ t , ∀ , u x ∈ f x ∧ μ s \ ⋃ ( x : _ ) ( _ : x ∈ t ) , u x = 0
         ...
         (Mathlib.ExtendedBinder.«term∀___,_»
          ...
          (Term.forall
           ...
           (Init.Core.«term_∈_»
            (Term.app `u [`x])
            " ∈ "
            (Init.Core.«term_∩_» (Term.app `v.sets_at [`x]) " ∩ " (Term.app `f [`x]))))))
        "∧"
        («term_=_»
         (Term.app
          `μ
...
theorem
  ...
  :
    ∃
      ...
      t ⊆ s
        ∧
        t.pairwise_disjoint u ∧ ∀ , ∀ x ∈ t , ∀ , u x ∈ v.sets_at x ∩ f x ∧ μ s \ ⋃ ( x : _ ) ( _ : x ∈ t ) , u x = 0
...
-- ././Mathport/Syntax/Translate/Basic.lean:477:2: warning: expanding binder collection (x «expr ∈ » h.index)
/- failed to parenthesize: parenthesize: uncaught backtrack exception
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers [] [] [] [] [] [])
 (Command.theorem
  "theorem"
  (Command.declId `measure_diff_bUnion [])
  (Command.declSig
   []
   (Term.typeSpec
    ":"
  ...
  (Command.declValSimple
   ":="
   (Term.proj
    (Term.proj (Term.proj `h.exists_disjoint_covering_ae.some_spec.some_spec "." (fieldIdx "2")) "." (fieldIdx "2"))
    "."
    (fieldIdx "2"))
   [])
  []
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.proj `h.exists_disjoint_covering_ae.some_spec.some_spec "." (fieldIdx "2"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  `h.exists_disjoint_covering_ae.some_spec.some_spec
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
   ...
   (Term.app
    ...
    [(Init.Core.«term_\_»
      ...
      (Set.Data.Set.Lattice.«term⋃_,_»
       ...
       (Lean.explicitBinders
        [(Lean.bracketedExplicitBinders "(" [(Lean.binderIdent `x)] ":" (Term.hole "_") ")")
         (Lean.bracketedExplicitBinders "(" [(Lean.binderIdent "_")] ":" (Init.Core.«term_∈_» `x " ∈ " `h.index) ")")])
       ", "
       (Term.app `h.covering [`x])))])
   "="
   (numLit "0"))
...
theorem
  measure_diff_bUnion
  : μ s \ ⋃ ( x : _ ) ( _ : x ∈ h.index ) , h.covering x = 0
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `measure_le_tsum_of_absolutely_continuous [])
  (Command.declSig
          ...
          (Tactic.tacticSeq1Indented
           [(group
             (Tactic.simp
              ...
              []
              ["only"]
              ["[" [(Tactic.simpLemma [] [] `subset_union_left) "," (Tactic.simpLemma [] [] `diff_union_self)] "]"]
              [])
             [])])))]))
     (calcStep
      («term_≤_»
        ...
        (Tactic.tacticSeq1Indented
         [(group
           (Tactic.rwSeq
            ...
            (Tactic.rwRuleSeq
             "["
             [(Tactic.rwRule [] (Term.app `hρ [`h.measure_diff_bUnion]))
              ","
              (Tactic.rwRule
               []
               (Term.app
                ...
                [`h.index_countable
                 ...
                 (Term.fun
                  "fun"
                  (Term.basicFun [(Term.simpleBinder [`x `hx] [])] "=>" (Term.app `h.measurable_set_u [`hx])))]))
              ","
    ...
    [(Tactic.rwRule [] (Term.app `hρ [`h.measure_diff_bUnion]))
     ...
     (Tactic.rwRule
      ...
      (Term.app
       ...
       [`h.index_countable
        `h.covering_disjoint
        (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`x `hx] [])] "=>" (Term.app `h.measurable_set_u [`hx])))]))
     ","
     (Tactic.rwRule [] `zero_addₓ)]
    "]")
   [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.basicFun.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `h.measurable_set_u [`hx])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `hρ [`h.measure_diff_bUnion])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `h.covering [`x]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `ρ
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
theorem
  measure_le_tsum_of_absolutely_continuous
  [ second_countable_topology α ] { ρ : Measureₓ α } ( hρ : ρ ≪ μ ) : ρ s ≤ ∑' x : h.index , ρ h.covering x
  :=
    calc
      ρ s ≤ ρ s \ ⋃ ( x : _ ) ( _ : x ∈ h.index ) , h.covering x ∪ ⋃ ( x : _ ) ( _ : x ∈ h.index ) , h.covering x
          :=
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `measure_le_tsum [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `second_countable_topology [`α]) "]")]
   (Term.typeSpec
    ":"
  ...
  (Command.declValSimple
   ":="
   (Term.app `h.measure_le_tsum_of_absolutely_continuous [`measure.absolutely_continuous.rfl])
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `measure.absolutely_continuous.rfl
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `h.measure_le_tsum_of_absolutely_continuous
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
...
theorem
  measure_le_tsum
  [ second_countable_topology α ] : μ s ≤ ∑' x : h.index , μ h.covering x
...
-- ././Mathport/Syntax/Translate/Basic.lean:477:2: warning: expanding binder collection (ε «expr ∈ » Ioi (0 : exprℝ()))
/- failed to parenthesize: parenthesize: uncaught backtrack exception
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers
  [(Command.docComment
 ...
 (Command.def
  "def"
  (Command.declId `filter_at [])
  (Command.optDeclSig
   [(Term.explicitBinder "(" [`x] [":" `α] [] ")")]
   [(Term.typeSpec ":" (Term.app `Filter [(Term.app `Set [`α])]))])
  (Command.declValSimple
   ":="
   (Order.CompleteLattice.«term⨅_,_»
    ...
    (Term.app
     ...
     [(Set.«term{_|_}_1»
       "{"
       («term_∈_» `a "∈" (Term.app `v.sets_at [`x]))
       "|"
       (Init.Core.«term_⊆_» `a " ⊆ " (Term.app `closed_ball [`x `ε]))
       "}")]))
   [])
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `eventually_filter_at_iff [])
  (Command.declSig
     ...
     (Mathlib.ExtendedBinder.«term∃___,_»
      ...
      (Term.forall
       ...
       (Mathlib.ExtendedBinder.«term∀___,_»
        "∀"
        `a
        («binderTerm∈_» "∈" (Term.app `v.sets_at [`x]))
        ","
        (Term.forall
         "∀"
         []
         ","
         (Term.arrow (Init.Core.«term_⊆_» `a " ⊆ " (Term.app `closed_ball [`x `ε])) "→" (Term.app `P [`a])))))))))
  (Command.declValSimple ":=" `v.mem_filter_at_iff [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `eventually_filter_at_mem_sets [])
  (Command.declSig
   [(Term.explicitBinder "(" [`x] [":" `α] [] ")")]
   (Term.typeSpec
    ":"
    (Filter.Order.Filter.Basic.«term∀ᶠ_in_,_»
     ...
     (Term.app `v.filter_at [`x])
     ", "
     (Init.Core.«term_∈_» `a " ∈ " (Term.app `v.sets_at [`x])))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.simp
         ...
         ["only"]
         ["["
          [(Tactic.simpLemma [] [] `eventually_filter_at_iff)
           ","
         ...
         [])
        [])
       (group (Tactic.exact "exact" (Term.anonymousCtor "⟨" [(numLit "1") "," `zero_lt_one] "⟩")) [])])))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.anonymousCtor "⟨" [(numLit "1") "," `zero_lt_one] "⟩"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.anonymousCtor "⟨" [(numLit "1") "," `zero_lt_one] "⟩")
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `frequently_filter_at_iff [])
  (Command.declSig
   [(Term.implicitBinder "{" [`x] [":" `α] "}")
    (Term.implicitBinder "{" [`P] [":" (Term.arrow (Term.app `Set [`α]) "→" (Term.prop "Prop"))] "}")]
   (Term.typeSpec
      ...
      (Mathlib.ExtendedBinder.«term∀___,_»
       ...
       (Term.forall
        ...
        (Mathlib.ExtendedBinder.«term∃___,_»
         ...
         («binderTerm∈_» "∈" (Term.app `v.sets_at [`x]))
         ","
         («term_∧_» (Init.Core.«term_⊆_» `a " ⊆ " (Term.app `closed_ball [`x `ε])) "∧" (Term.app `P [`a])))))))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.simp
         ...
         ["only"]
         ["["
          [(Tactic.simpLemma [] [] `Filter.Frequently)
           ","
           (Tactic.simpLemma [] [] `eventually_filter_at_iff)
           ","
...
theorem
  ...
  :=
    by
      simp
        only
        [ Filter.Frequently , eventually_filter_at_iff , not_exists , exists_prop , not_and , not_not , not_forall ]
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `eventually_filter_at_subset_of_nhds [])
  (Command.declSig
   [(Term.implicitBinder "{" [`x] [":" `α] "}")
    (Term.implicitBinder "{" [`o] [":" (Term.app `Set [`α])] "}")
    (Term.explicitBinder
     "("
     [`hx]
     [":" (Init.Core.«term_∈_» `o " ∈ " (Term.app (Topology.Basic.term𝓝 "𝓝") [`x]))]
     []
     ")")]
   (Term.typeSpec
    ":"
  ...
  (Command.declValSimple
   ...
   (Term.byTactic
    ...
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `eventually_filter_at_iff)] "]") []) [])
       (group
        (Tactic.rcases
         "rcases"
         [(Tactic.casesTarget [] (Term.app (Term.proj `Metric.mem_nhds_iff "." (fieldIdx "1")) [`hx]))]
         ["with"
         ...
         (Term.anonymousCtor
          ...
          [(«term_/_» `ε "/" (numLit "2"))
           ...
           (Term.fun
            "fun"
            (Term.basicFun
             [(Term.simpleBinder [`a `av `ha] [])]
             "=>"
             (Term.app
              `ha.trans
              [(Term.app
                (Term.proj (Term.app `closed_ball_subset_ball [(Term.app `half_lt_self [`εpos])]) "." `trans)
                [`hε])])))]
          "⟩"))
        [])])))
   [])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.fun
   ...
   (Term.basicFun
    ...
    (Term.app
     `ha.trans
     [(Term.app (Term.proj (Term.app `closed_ball_subset_ball [(Term.app `half_lt_self [`εpos])]) "." `trans) [`hε])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.fun.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.basicFun.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `closed_ball_subset_ball [(Term.app `half_lt_self [`εpos])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `closed_ball_subset_ball [(Term.paren "(" [(Term.app `half_lt_self [`εpos]) []] ")")]) []]
 ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.proj `Metric.mem_nhds_iff "." (fieldIdx "1")) [`hx])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `eventually_filter_at_iff)] "]") [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `eventually_filter_at_iff
...
theorem
  ...
  { x : α } { o : Set α } ( hx : o ∈ 𝓝 x ) : ∀ᶠ a in v.filter_at x , a ⊆ o
  :=
    by
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `fine_subfamily_on_of_frequently [])
  (Command.declSig
   [(Term.explicitBinder "(" [`v] [":" (Term.app `VitaliFamily [`μ])] [] ")")
    (Term.explicitBinder "(" [`f] [":" (Term.arrow `α "→" (Term.app `Set [(Term.app `Set [`α])]))] [] ")")
         ...
         [":"
          («term∃_,_»
           ...
           («term_∧_»
            ...
            (Init.Core.«term_∈_» `a " ∈ " (Term.app `f [`x]))))]
         [":="
          [(Term.app (Term.proj `v.frequently_filter_at_iff "." (fieldIdx "1")) [(Term.app `h [`x `hx]) `ε `εpos])]])
        [])
       (group
        (Tactic.exact "exact" (Term.anonymousCtor "⟨" [`a "," (Term.anonymousCtor "⟨" [`av "," `af] "⟩") "," `ha] "⟩"))
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.anonymousCtor "⟨" [`a "," (Term.anonymousCtor "⟨" [`av "," `af] "⟩") "," `ha] "⟩")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.anonymousCtor', expected 'Lean.Parser.Term.anonymousCtor.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj `v.frequently_filter_at_iff "." (fieldIdx "1"))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  `v.frequently_filter_at_iff
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (some 1024, term)
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.intro "intro" [`x `hx `ε `εpos])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, [anonymous]))
  (Term.app `v.fine_subfamily_on [`f `s])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
theorem
  ...
  ( v : VitaliFamily μ ) ( f : α → Set Set α ) ( s : Set α ) ( h : ∀ , ∀ x ∈ s , ∀ , ∃ᶠ a in v.filter_at x , a ∈ f x )
  ...
  :=
    by
      intro x hx ε εpos
        obtain
          ⟨ a , av , ha , af ⟩
          : ∃ ( a : Set α ) ( H : a ∈ v.sets_at x ) , a ⊆ closed_ball x ε ∧ a ∈ f x
