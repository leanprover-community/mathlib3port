...
/- ./././Mathport/Syntax/Translate/Basic.lean:628:2: warning: expanding binder collection (g «expr ≠ » (0 : G)) -/
...
@[protect_proj]
structure IsAddFundamentalDomain (G : Type _) {α : Type _} [Zero G] [HasVadd G α]
  [MeasurableSpace α] (s : Set α) (μ : Measure α := by exact MeasureTheory.MeasureSpace.volume) :
  Prop where
...
#align
  measure_theory.is_fundamental_domain.pairwise_ae_disjoint MeasureTheory.IsFundamentalDomain.pairwise_ae_disjoint
