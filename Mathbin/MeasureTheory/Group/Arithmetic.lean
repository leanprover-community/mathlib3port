...
variable {M α : Type _} [MeasurableSpace M] [Mul M] {m : MeasurableSpace α} {f g : α → M} {μ : Measure α}

include m

@[measurability, to_additive]
theorem Measurable.constMul [HasMeasurableMul M] (hf : Measurable f) (c : M) : Measurable fun x => c * f x :=
...
@[measurability, to_additive]
theorem Measurable.mulConst [HasMeasurableMul M] (hf : Measurable f) (c : M) : Measurable fun x => f x * c :=
...
@[to_additive]
instance (priority := 100) HasMeasurableMul₂.toHasMeasurableMul [HasMeasurableMul₂ M] : HasMeasurableMul M :=
...
theorem measurableDivConst' {G : Type _} [DivInvMonoid G] [MeasurableSpace G] [HasMeasurableMul G] (g : G) :
...
variable {G α : Type _} [MeasurableSpace G] [Div G] {m : MeasurableSpace α} {f g : α → G} {μ : Measure α}

include m

@[measurability, to_additive]
theorem Measurable.constDiv [HasMeasurableDiv G] (hf : Measurable f) (c : G) : Measurable fun x => c / f x :=
...
@[measurability, to_additive]
theorem Measurable.divConst [HasMeasurableDiv G] (hf : Measurable f) (c : G) : Measurable fun x => f x / c :=
...
@[to_additive]
instance (priority := 100) HasMeasurableDiv₂.toHasMeasurableDiv [HasMeasurableDiv₂ G] : HasMeasurableDiv G :=
...
@[measurability]
theorem measurableSetEqFun {m : MeasurableSpace α} {E} [MeasurableSpace E] [AddGroup E] [MeasurableSingletonClass E]
...
theorem measurableSetEqFunOfCountable {m : MeasurableSpace α} {E} [MeasurableSpace E] [MeasurableSingletonClass E]
...
@[to_additive]
instance (priority := 100) hasMeasurableDivOfMulInv (G : Type _) [MeasurableSpace G] [DivInvMonoid G]
...
@[simp, to_additive]
theorem measurable_inv_iff {G : Type _} [Group G] [MeasurableSpace G] [HasMeasurableInv G] {f : α → G} :
...
@[simp, to_additive]
theorem ae_measurable_inv_iff {G : Type _} [Group G] [MeasurableSpace G] [HasMeasurableInv G] {f : α → G} :
    AeMeasurable (fun x => (f x)⁻¹) μ ↔ AeMeasurable f μ :=
  ⟨fun h => by simpa only [inv_inv] using h.inv, fun h => h.inv⟩
#align ae_measurable_inv_iff ae_measurable_inv_iff

@[simp]
theorem measurable_inv_iff₀ {G₀ : Type _} [GroupWithZero G₀] [MeasurableSpace G₀] [HasMeasurableInv G₀] {f : α → G₀} :
    (Measurable fun x => (f x)⁻¹) ↔ Measurable f :=
  ⟨fun h => by simpa only [inv_inv] using h.inv, fun h => h.inv⟩
#align measurable_inv_iff₀ measurable_inv_iff₀

@[simp]
theorem ae_measurable_inv_iff₀ {G₀ : Type _} [GroupWithZero G₀] [MeasurableSpace G₀] [HasMeasurableInv G₀]
...
@[to_additive]
instance (priority := 100) hasMeasurableDiv₂OfMulInv (G : Type _) [MeasurableSpace G] [DivInvMonoid G]
...
@[to_additive]
instance hasMeasurableSmulOfMul (M : Type _) [Mul M] [MeasurableSpace M] [HasMeasurableMul M] : HasMeasurableSmul M M :=
...
@[to_additive]
instance Submonoid.hasMeasurableSmul {M α} [MeasurableSpace M] [MeasurableSpace α] [Monoid M] [MulAction M α]
...
@[to_additive]
instance Subgroup.hasMeasurableSmul {G α} [MeasurableSpace G] [MeasurableSpace α] [Group G] [MulAction G α]
...
@[measurability, to_additive]
theorem AeMeasurable.smul [HasMeasurableSmul₂ M β] {μ : Measure α} (hf : AeMeasurable f μ) (hg : AeMeasurable g μ) :
...
@[to_additive]
instance (priority := 100) HasMeasurableSmul₂.toHasMeasurableSmul [HasMeasurableSmul₂ M β] : HasMeasurableSmul M β :=
...
@[measurability, to_additive]
theorem AeMeasurable.smulConst (hf : AeMeasurable f μ) (y : β) : AeMeasurable (fun x => f x • y) μ :=
...
@[measurability, to_additive]
theorem AeMeasurable.constSmul' (hg : AeMeasurable g μ) (c : M) : AeMeasurable (fun x => c • g x) μ :=
...
instance AddMonoid.hasMeasurableSmulNat₂ (M : Type _) [AddMonoid M] [MeasurableSpace M] [HasMeasurableAdd₂ M] :
...
instance SubNegMonoid.hasMeasurableSmulInt₂ (M : Type _) [SubNegMonoid M] [MeasurableSpace M] [HasMeasurableAdd₂ M]
...
variable {M β α : Type _} [MeasurableSpace M] [MeasurableSpace β] [Monoid M] [MulAction M β] [HasMeasurableSmul M β]
  [MeasurableSpace α] {f : α → β} {μ : Measure α}
...
instance Units.hasMeasurableSmul : HasMeasurableSmul Mˣ β where
  ...
  measurableSmulConst x := (measurableSmulConst x : Measurable fun c : M => c • x).comp MeasurableSpace.le_map_comap
...
variable {G₀ : Type _} [GroupWithZero G₀] [MeasurableSpace G₀] [MulAction G₀ β] [HasMeasurableSmul G₀ β]
...
@[to_additive]
theorem measurableMulUnop {α : Type _} [MeasurableSpace α] : Measurable (unop : αᵐᵒᵖ → α) := fun s => id
...
@[to_additive]
instance {M : Type _} [Mul M] [MeasurableSpace M] [HasMeasurableMul₂ M] : HasMeasurableMul₂ Mᵐᵒᵖ :=
  ⟨measurableMulOp.comp ((measurableMulUnop.comp measurableSnd).mul (measurableMulUnop.comp measurableFst))⟩
...
@[to_additive]
instance hasMeasurableSmulOppositeOfMul {M : Type _} [Mul M] [MeasurableSpace M] [HasMeasurableMul M] :
...
@[to_additive]
instance hasMeasurableSmul₂OppositeOfMul {M : Type _} [Mul M] [MeasurableSpace M] [HasMeasurableMul₂ M] :
    HasMeasurableSmul₂ Mᵐᵒᵖ M :=
...
variable {M α : Type _} [Monoid M] [MeasurableSpace M] [HasMeasurableMul₂ M] {m : MeasurableSpace α} {μ : Measure α}

include m

@[measurability, to_additive]
theorem List.measurableProd' (l : List (α → M)) (hl : ∀ f ∈ l, Measurable f) : Measurable l.Prod := by
...
@[measurability, to_additive]
theorem List.aeMeasurableProd' (l : List (α → M)) (hl : ∀ f ∈ l, AeMeasurable f μ) : AeMeasurable l.Prod μ := by
  induction' l with f l ihl
...
variable {M ι α : Type _} [CommMonoid M] [MeasurableSpace M] [HasMeasurableMul₂ M] {m : MeasurableSpace α}
  {μ : Measure α} {f : ι → α → M}

include m

@[measurability, to_additive]
theorem Multiset.measurableProd' (l : Multiset (α → M)) (hl : ∀ f ∈ l, Measurable f) : Measurable l.Prod := by
  rcases l with ⟨l⟩
  simpa using l.measurable_prod' (by simpa using hl)
#align multiset.measurable_prod' Multiset.measurableProd'

@[measurability, to_additive]
theorem Multiset.aeMeasurableProd' (l : Multiset (α → M)) (hl : ∀ f ∈ l, AeMeasurable f μ) : AeMeasurable l.Prod μ := by
  rcases l with ⟨l⟩
...
@[measurability, to_additive]
theorem Finset.measurableProd' (s : Finset ι) (hf : ∀ i ∈ s, Measurable (f i)) : Measurable (∏ i in s, f i) :=
...
@[measurability, to_additive]
theorem Finset.measurableProd (s : Finset ι) (hf : ∀ i ∈ s, Measurable (f i)) : Measurable fun a => ∏ i in s, f i a :=
...
theorem Finset.aeMeasurableProd (s : Finset ι) (hf : ∀ i ∈ s, AeMeasurable (f i) μ) :
    AeMeasurable (fun a => ∏ i in s, f i a) μ := by simpa only [← Finset.prod_apply] using s.ae_measurable_prod' hf
#align finset.ae_measurable_prod Finset.aeMeasurableProd
