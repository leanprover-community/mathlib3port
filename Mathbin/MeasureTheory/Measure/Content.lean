...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `inner_content [])
  (Command.optDeclSig
   [(Term.explicitBinder "(" [`U] [":" (Term.app `opens [`G])] [] ")")]
  ...
  (Command.declValSimple
   ...
   (Order.CompleteLattice.«term⨆_,_»
    ...
    (Lean.explicitBinders
     [(Lean.bracketedExplicitBinders "(" [(Lean.binderIdent `K)] ":" (Term.app `compacts [`G]) ")")
      (Lean.bracketedExplicitBinders
       "("
       [(Lean.binderIdent `h)]
       ":"
       (Init.Core.«term_⊆_» (Term.proj `K "." (fieldIdx "1")) " ⊆ " `U)
       ")")])
    ", "
    (Term.app `μ [`K]))
   [])
...
/--
    Constructing the inner content of a content. From a content defined on the compact sets, we
      obtain a function defined on all open sets, by taking the supremum of the content of all compact
      subsets. -/
  def inner_content ( U : opens G ) : ℝ≥0∞ := ⨆ ( K : compacts G ) ( h : K . 1 ⊆ U ) , μ K
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `inner_content_Sup_nat [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `T2Space [`G]) "]")
    (Term.explicitBinder "(" [`U] [":" (Term.arrow (termℕ "ℕ") "→" (Term.app `opens [`G]))] [] ")")]
   (Term.typeSpec
    ":"
    («term_≤_»
     (Term.app
     ...
     (Topology.Algebra.InfiniteSum.«term∑'_,_»
      ...
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] [":" (termℕ "ℕ")]))
      ", "
      (Term.app `μ.inner_content [(Term.app `U [`i])])))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
     ...
     (Tactic.tacticSeq1Indented
      [(group
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           ...
           [(Term.typeSpec
             ...
             (Term.forall
              "∀"
              [(Term.simpleBinder [`t] [(Term.typeSpec ":" (Term.app `Finset [(termℕ "ℕ")]))])
               (Term.simpleBinder [`K] [(Term.typeSpec ":" (Term.arrow (termℕ "ℕ") "→" (Term.app `compacts [`G])))])]
              ","
              («term_≤_»
               (Term.app `μ [(Term.app `t.sup [`K])])
               "≤"
               (Term.app
                `t.sum
                [(Term.fun
                  "fun"
                  (Term.basicFun [(Term.simpleBinder [`i] [])] "=>" (Term.app `μ [(Term.app `K [`i])])))]))))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(group (Tactic.intro "intro" [`t `K]) [])
               (group
                (Tactic.refine' "refine'" (Term.app `Finset.induction_on [`t (Term.hole "_") (Term.hole "_")]))
                [])
               (group
                (Tactic.«tactic·._»
                 "·"
               ...
               (group
                (Tactic.«tactic·._»
                 ...
                 (Tactic.tacticSeq
                  (Tactic.tacticSeq1Indented
                   [(group (Tactic.intro "intro" [`n `s `hn `ih]) [])
                    (group
                     (Tactic.rwSeq
                      "rw"
                      []
                      (Tactic.rwRuleSeq
                       ...
                       [(Tactic.rwRule [] `Finset.sup_insert)
                        ","
                        (Tactic.rwRule [] (Term.app `Finset.sum_insert [`hn]))]
                       "]")
                      [])
                     [])
                    (group
                     (Tactic.exact
                      ...
                      (Term.app
                       `le_transₓ
                       [(Term.app `μ.sup_le [(Term.hole "_") (Term.hole "_")])
         ...
         [(Tactic.casesTarget
           ...
           (Term.app
            ...
            [(Term.proj `K "." (fieldIdx "2"))
             ...
             (Term.fun
              "fun"
              (Term.basicFun [(Term.simpleBinder [`i] [])] "=>" (Term.proj (Term.app `U [`i]) "." `Prop)))
             (Term.hole "_")]))]
         ["with"
           ...
           [(group (Tactic.convert "convert" [] `hK []) [])
            (group
             (Tactic.rwSeq
              "rw"
              []
              (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `opens.supr_def) "," (Tactic.rwRule [] `Subtype.coe_mk)] "]")
              [])
             [])])))
        [])
       (group
        (Tactic.rcases
         ...
         [(Tactic.casesTarget
           []
           (Term.app
            (Term.proj (Term.proj `K "." (fieldIdx "2")) "." `finite_compact_cover)
            [`t
             (Rel.Data.Rel.«term_∘_» `coeₓ " ∘ " `U)
             (Term.fun
              "fun"
              (Term.basicFun
               [(Term.simpleBinder [`i (Term.hole "_")] [])]
               "=>"
               (Term.proj (Term.app `U [(Term.hole "_")]) "." `Prop)))
             (Term.byTactic
              "by"
              (Tactic.tacticSeq
               (Tactic.tacticSeq1Indented
                [(group (Tactic.simp "simp" [] ["only"] ["[" [(Tactic.simpLemma [] [] `ht)] "]"] []) [])])))]))]
         ["with"
          (Tactic.rcasesPat.tuple
           "⟨"
       ...
       (group
        (Tactic.tacticLet_
         ...
         (Term.letDecl
          (Term.letIdDecl
           `L
           [(Term.typeSpec ":" (Term.arrow (termℕ "ℕ") "→" (Term.app `compacts [`G])))]
           ":="
           (Term.fun
            "fun"
            (Term.basicFun
             [(Term.simpleBinder [`n] [])]
             "=>"
             (Term.anonymousCtor "⟨" [(Term.app `K' [`n]) "," (Term.app `h1K' [`n])] "⟩"))))))
        [])
       (group (Tactic.convert "convert" [] (Term.app `le_transₓ [(Term.app `h3 [`t `L]) (Term.hole "_")]) []) [])
       (group
        (Tactic.«tactic·._»
         "·"
         (Tactic.tacticSeq
             ...
             (Tactic.simp
              ...
              ["["
               [(Tactic.simpLemma [] [] `h3K')
                ","
                (Tactic.simpLemma [] [] `compacts.finset_sup_val)
                ","
                (Tactic.simpLemma [] [] `Finset.sup_eq_supr)
                ","
                (Tactic.simpLemma [] [] `Set.supr_eq_Union)]
               "]"]
              [])
             [])])))
        [])
       (group
        (Tactic.refine'
         "refine'"
         (Term.app `le_transₓ [(Term.app `Finset.sum_le_sum [(Term.hole "_")]) (Term.app `Ennreal.sum_le_tsum [`t])]))
        [])
       (group (Tactic.intro "intro" [`i `hi]) [])
       (group
        (Tactic.refine'
         "refine'"
         (Term.app `le_transₓ [(Term.hole "_") (Term.app `le_supr [(Term.hole "_") (Term.app `L [`i])])]))
        [])
       (group
        (Tactic.refine'
         "refine'"
         (Term.app `le_transₓ [(Term.hole "_") (Term.app `le_supr [(Term.hole "_") (Term.app `h2K' [`i])])]))
        [])
       (group (Tactic.rfl' "rfl'") [])])))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
         ...
         (Term.haveIdDecl
          ...
          (Term.byTactic
           ...
           (Tactic.tacticSeq
            (Tactic.tacticSeq1Indented
             [(group (Tactic.intro "intro" [`t `K]) [])
              (group (Tactic.refine' "refine'" (Term.app `Finset.induction_on [`t (Term.hole "_") (Term.hole "_")])) [])
              (group
               (Tactic.«tactic·._»
                "·"
                (Tactic.tacticSeq
                  ...
                  [(group (Tactic.intro "intro" [`n `s `hn `ih]) [])
                   (group
                    (Tactic.rwSeq
                     ...
                     (Tactic.rwRuleSeq
                      "["
                      [(Tactic.rwRule [] `Finset.sup_insert) "," (Tactic.rwRule [] (Term.app `Finset.sum_insert [`hn]))]
                      "]")
                     [])
                    [])
                   (group
       ...
       (Tactic.rcases
        ...
        [(Tactic.casesTarget
          ...
          (Term.app
           ...
           [(Term.proj `K "." (fieldIdx "2"))
            (Term.hole "_")
            (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`i] [])] "=>" (Term.proj (Term.app `U [`i]) "." `Prop)))
            (Term.hole "_")]))]
        ["with"
         (Tactic.rcasesPat.tuple
          "⟨"
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.rfl' "rfl'")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rfl'', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `le_supr [(Term.hole "_") (Term.app `h2K' [`i])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `h2K' [`i]) []] ")")
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `le_supr [(Term.hole "_") (Term.paren "(" [(Term.app `h2K' [`i]) []] ")")]) []]
 ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `le_supr [(Term.hole "_") (Term.app `L [`i])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `le_supr [(Term.hole "_") (Term.paren "(" [(Term.app `L [`i]) []] ")")]) []]
 ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Ennreal.sum_le_tsum [`t])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Ennreal.sum_le_tsum [`t]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.convert "convert" [] (Term.app `le_transₓ [(Term.app `h3 [`t `L]) (Term.hole "_")]) [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.convert', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `le_transₓ [(Term.app `h3 [`t `L]) (Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `h3 [`t `L]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `le_transₓ
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.arrow (termℕ "ℕ") "→" (Term.app `compacts [`G]))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.simp "simp" [] ["only"] ["[" [(Tactic.simpLemma [] [] `ht)] "]"] [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simp', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«]»', expected 'optional.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simpLemma', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simpLemma', expected 'Lean.Parser.Tactic.simpStar'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `U [(Term.hole "_")]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.simpleBinder', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.simpleBinder', expected 'Lean.Parser.Term.strictImplicitBinder.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.simpleBinder', expected 'Lean.Parser.Term.strictImplicitBinder'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(Term.fun
   ...
   (Term.basicFun
    [(Term.simpleBinder [`i (Term.hole "_")] [])]
    "=>"
    (Term.proj (Term.paren "(" [(Term.app `U [(Term.hole "_")]) []] ")") "." `Prop)))
  []]
 ")")
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Rel.Data.Rel.«term_∘_» `coeₓ " ∘ " `U) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(Term.fun
   ...
   (Term.basicFun
    [(Term.simpleBinder [`i] [])]
    "=>"
    (Term.proj (Term.paren "(" [(Term.app `U [`i]) []] ")") "." `Prop)))
  []]
 ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
     ...
     [(Term.typeSpec
       ...
       (Term.forall
        ...
        («term_≤_»
         ...
         (Term.app
          `t.sum
          [(Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`i] [])] "=>" (Term.app `μ [(Term.app `K [`i])])))]))))]
     ":="
     (Term.byTactic
      "by"
      (Tactic.tacticSeq
     ...
     [(group (Tactic.intro "intro" [`n `s `hn `ih]) [])
      ...
      (group
       (Tactic.exact
        ...
        (Term.app
         `le_transₓ
         [(Term.app `μ.sup_le [(Term.hole "_") (Term.hole "_")]) (Term.app `add_le_add_left [`ih (Term.hole "_")])]))
       [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.«tactic·._»', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq', expected 'Lean.Parser.Tactic.tacticSeq.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq1Indented', expected 'Lean.Parser.Tactic.tacticSeqBracketed.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.refine'', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Finset.induction_on [`t (Term.hole "_") (Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `t.sup [`K]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `μ
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
/--
  ...
  theorem
    ...
    [ T2Space G ] ( U : ℕ → opens G ) : μ.inner_content ⨆ i : ℕ , U i ≤ ∑' i : ℕ , μ.inner_content U i
    :=
      by
        have
            h3
              : ∀ t : Finset ℕ K : ℕ → compacts G , μ t.sup K ≤ t.sum fun i => μ K i
              :=
              by
                intro t K
          ...
          rcases
            K . 2 . finite_compact_cover t coeₓ ∘ U fun i _ => U _ . Prop by simp only [ ht ]
            with ⟨ K' , h1K' , h2K' , h3K' ⟩
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `inner_content_Union_nat [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `T2Space [`G]) "]")
    (Term.strictImplicitBinder "⦃" [`U] [":" (Term.arrow (termℕ "ℕ") "→" (Term.app `Set [`G]))] "⦄")
    (Term.explicitBinder
     "("
     [`hU]
     [":"
   ...
   (Term.typeSpec
    ...
    («term_≤_»
     ...
     (Topology.Algebra.InfiniteSum.«term∑'_,_»
      ...
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] [":" (termℕ "ℕ")]))
      ", "
      (Term.app `μ.inner_content [(Term.anonymousCtor "⟨" [(Term.app `U [`i]) "," (Term.app `hU [`i])] "⟩")])))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
        ...
        (Tactic.tacticHave_
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           ...
           ":="
           (Term.app
            `μ.inner_content_Sup_nat
            [(Term.fun
              "fun"
              (Term.basicFun
               [(Term.simpleBinder [`i] [])]
               "=>"
               (Term.anonymousCtor "⟨" [(Term.app `U [`i]) "," (Term.app `hU [`i])] "⟩")))]))))
        [])
       (group
        (tacticRwa__
         "rwa"
         (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `opens.supr_def)] "]")
...
/--
  ...
  theorem
    ...
    [ T2Space G ] ⦃ U : ℕ → Set G ⦄ ( hU : ∀ i : ℕ , IsOpen U i )
      : μ.inner_content ⟨ ⋃ i : ℕ , U i , is_open_Union hU ⟩ ≤ ∑' i : ℕ , μ.inner_content ⟨ U i , hU i ⟩
    := by have := μ.inner_content_Sup_nat fun i => ⟨ U i , hU i ⟩ rwa [ opens.supr_def ] at this
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `inner_content_pos_of_is_mul_left_invariant [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `T2Space [`G]) "]")
     ...
     [":"
      (Term.forall
       ...
       [(Term.simpleBinder [`g] [(Term.typeSpec ":" `G)])
        (Term.implicitBinder "{" [`K] [":" (Term.app `compacts [`G])] "}")]
       ","
       («term_=_»
        (Term.app `μ [(«term_$__» (Term.app `K.map [(Term.hole "_")]) "$" (Term.app `continuous_mul_left [`g]))])
        "="
        (Term.app `μ [`K])))]
     []
     ")")
    (Term.explicitBinder "(" [`K] [":" (Term.app `compacts [`G])] [] ")")
    (Term.explicitBinder "(" [`hK] [":" («term_≠_» (Term.app `μ [`K]) "≠" (numLit "0"))] [] ")")
    (Term.explicitBinder "(" [`U] [":" (Term.app `opens [`G])] [] ")")
    (Term.explicitBinder
     "("
     [`hU]
     [":" (Term.proj (Term.paren "(" [`U [(Term.typeAscription ":" (Term.app `Set [`G]))]] ")") "." `Nonempty)]
     []
     ")")]
   (Term.typeSpec ":" («term_<_» (numLit "0") "<" (Term.app `μ.inner_content [`U]))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
      ...
      [(group
        (Tactic.have''
         ...
         [(Term.typeSpec
           ":"
           (Term.proj
            (Term.app `Interior [(Term.paren "(" [`U [(Term.typeAscription ":" (Term.app `Set [`G]))]] ")")])
            "."
            `Nonempty))])
        [])
       (group (tacticRwa__ "rwa" (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `U.prop.interior_eq)] "]") []) [])
       (group
        (Tactic.rcases
         "rcases"
         [(Tactic.casesTarget
           []
           (Term.app `compact_covered_by_mul_left_translates [(Term.proj `K "." (fieldIdx "2")) `this]))]
         ["with"
          (Tactic.rcasesPat.tuple
           "⟨"
        ...
        (Tactic.tacticSuffices_
         ...
         (Term.sufficesDecl
          ...
          («term_≤_»
           (Term.app `μ [`K])
           "≤"
           (Finset.Data.Finset.Fold.«term_*_» `s.card "*" (Term.app `μ.inner_content [`U])))
          (Term.byTactic
           "by"
           (Tactic.tacticSeq
            (Tactic.tacticSeq1Indented
             [(group
               (Tactic.exact
                "exact"
                (Term.proj
                 («term_$__» `ennreal.mul_pos_iff.mp "$" (Term.app `hK.bot_lt.trans_le [`this]))
                 "."
                 (fieldIdx "2")))
               [])])))))
        [])
                ...
                (Lean.explicitBinders
                 [(Lean.bracketedExplicitBinders "(" [(Lean.binderIdent `g)] ":" (Term.hole "_") ")")
                  (Lean.bracketedExplicitBinders
                   ...
                   ")")])
                ", "
                (Term.app `opens.comap [(Term.proj (Term.app `Homeomorph.mulLeft [`g]) "." `toContinuousMap) `U])))))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(group
                (Tactic.simpa
                 ...
                 ["only"]
                 ["["
                  [(Tactic.simpLemma [] [] `opens.supr_def)
                   ","
                   (Tactic.simpLemma [] [] `opens.coe_comap)
                   ","
       ...
       (group
        (Tactic.refine'
         "refine'"
         (Term.app
          (Term.proj (Term.app `μ.le_inner_content [(Term.hole "_") (Term.hole "_") `this]) "." `trans)
          [(Term.hole "_")]))
        [])
       (group
        (Tactic.refine'
       ...
       (group
        (Tactic.simp
         ...
         ["only"]
         ["["
          [(Tactic.simpLemma [] [] (Term.app `μ.is_mul_left_invariant_inner_content [`h3]))
           ","
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simpLemma', expected 'Lean.Parser.Tactic.simpErase'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `μ.is_mul_left_invariant_inner_content [`h3])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `μ.is_mul_left_invariant_inner_content
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `μ.le_inner_content [(Term.hole "_") (Term.hole "_") `this])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.proj (Term.app `Homeomorph.mulLeft [`g]) "." `toContinuousMap)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
    ...
    :=
      by
        have : Interior ( U : Set G ) . Nonempty
          ...
          have
            : K . 1 ⊆ ↑ ⨆ ( g : _ ) ( _ : g ∈ s ) , opens.comap Homeomorph.mulLeft g . toContinuousMap U
              :=
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `outer_measure_eq_infi [])
  (Command.declSig
   [(Term.explicitBinder "(" [`A] [":" (Term.app `Set [`G])] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app `μ.outer_measure [`A])
     "="
     (Order.CompleteLattice.«term⨅_,_»
      "⨅"
      (Lean.explicitBinders
       [(Lean.bracketedExplicitBinders "(" [(Lean.binderIdent `U)] ":" (Term.app `Set [`G]) ")")
      ...
      ", "
      (Term.app `μ.inner_content [(Term.anonymousCtor "⟨" [`U "," `hU] "⟩")])))))
  (Command.declValSimple
   ":="
   (Term.app `induced_outer_measure_eq_infi [(Term.hole "_") `μ.inner_content_Union_nat `μ.inner_content_mono `A])
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
theorem
  ...
  ( A : Set G ) : μ.outer_measure A = ⨅ ( U : Set G ) ( hU : IsOpen U ) ( h : A ⊆ U ) , μ.inner_content ⟨ U , hU ⟩
