...
theorem volume_univ : volume (univ : Set ℝ) = ∞ :=
  Ennreal.eq_top_of_forall_nnreal_le $ fun r =>
    calc (r : ℝ≥0∞) = volume (Icc (0 : ℝ) r) := by
      simp
...
theorem volume_Ioi {a : ℝ} : volume (Ioi a) = ∞ :=
  top_unique $
    le_of_tendsto' Ennreal.tendsto_nat_nhds_top $ fun n =>
      calc (n : ℝ≥0∞) = volume (Ioo a (a+n)) := by
        simp
...
theorem volume_Iio {a : ℝ} : volume (Iio a) = ∞ :=
  top_unique $
    le_of_tendsto' Ennreal.tendsto_nat_nhds_top $ fun n =>
      calc (n : ℝ≥0∞) = volume (Ioo (a - n) a) := by
        simp
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `volume_Icc_pi [])
  (Command.declSig
   [(Term.implicitBinder "{" [`a `b] [":" (Term.arrow `ι "→" (Data.Real.Basic.termℝ "ℝ"))] "}")]
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app `volume [(Term.app `Icc [`a `b])])
     "="
     (Algebra.BigOperators.Basic.«term∏_,_»
      "∏"
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
      ", "
      (Term.app `Ennreal.ofReal [(«term_-_» (Term.app `b [`i]) "-" (Term.app `a [`i]))])))))
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.rwSeq
         "rw"
         []
         (Tactic.rwRuleSeq "[" [(Tactic.rwRule ["←"] `pi_univ_Icc) "," (Tactic.rwRule [] `volume_pi_pi)] "]")
         [])
        [])
       (group (Tactic.simp "simp" [] ["only"] ["[" [(Tactic.simpLemma [] [] `Real.volume_Icc)] "]"] []) [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.simp "simp" [] ["only"] ["[" [(Tactic.simpLemma [] [] `Real.volume_Icc)] "]"] [])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_-_» (Term.app `b [`i]) "-" (Term.app `a [`i]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_-_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `a [`i])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
theorem
  volume_Icc_pi
  { a b : ι → ℝ } : volume Icc a b = ∏ i , Ennreal.ofReal b i - a i
  := by rw [ ← pi_univ_Icc , volume_pi_pi ] simp only [ Real.volume_Icc ]
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `volume_Icc_pi_to_real [])
  (Command.declSig
   [(Term.implicitBinder "{" [`a `b] [":" (Term.arrow `ι "→" (Data.Real.Basic.termℝ "ℝ"))] "}")
   ...
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.proj (Term.app `volume [(Term.app `Icc [`a `b])]) "." `toReal)
     "="
     (Algebra.BigOperators.Basic.«term∏_,_»
      "∏"
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.simp
         ...
         ["only"]
         ["["
          [(Tactic.simpLemma [] [] `volume_Icc_pi)
           ","
           (Tactic.simpLemma [] [] `Ennreal.to_real_prod)
           ","
           (Tactic.simpLemma
            []
            []
            (Term.app
             ...
             [(Term.app (Term.proj `sub_nonneg "." (fieldIdx "2")) [(Term.app `h [(Term.hole "_")])])]))]
          "]"]
         [])
        [])])))
   [])
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app (Term.proj `sub_nonneg "." (fieldIdx "2")) [(Term.paren "(" [(Term.app `h [(Term.hole "_")]) []] ")")]) []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `Ennreal.to_real_of_real
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
@[ simp ]
  theorem
    ...
    { a b : ι → ℝ } ( h : a ≤ b ) : volume Icc a b . toReal = ∏ i , b i - a i
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  ...
  (Command.declValSimple
   ":="
   (Term.app (Term.proj (Term.app `measure_congr [`measure.univ_pi_Ioo_ae_eq_Icc]) "." `trans) [`volume_Icc_pi])
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `measure_congr [`measure.univ_pi_Ioo_ae_eq_Icc]) "." `trans)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `measure_congr [`measure.univ_pi_Ioo_ae_eq_Icc])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
theorem
  volume_pi_Ioo
  { a b : ι → ℝ } : volume pi univ fun i => Ioo a i b i = ∏ i , Ennreal.ofReal b i - a i
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `volume_pi_Ioo_to_real [])
  (Command.declSig
   [(Term.implicitBinder "{" [`a `b] [":" (Term.arrow `ι "→" (Data.Real.Basic.termℝ "ℝ"))] "}")
    (Term.explicitBinder "(" [`h] [":" («term_≤_» `a "≤" `b)] [] ")")]
   (Term.typeSpec
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.simp
         ...
         ["only"]
         ["["
          [(Tactic.simpLemma [] [] `volume_pi_Ioo)
           ","
           (Tactic.simpLemma [] [] `Ennreal.to_real_prod)
           ","
           (Tactic.simpLemma
...
@[ simp ]
  theorem
    ...
    { a b : ι → ℝ } ( h : a ≤ b ) : volume pi univ fun i => Ioo a i b i . toReal = ∏ i , b i - a i
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  ...
  (Command.declValSimple
   ":="
   (Term.app (Term.proj (Term.app `measure_congr [`measure.univ_pi_Ioc_ae_eq_Icc]) "." `trans) [`volume_Icc_pi])
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `measure_congr [`measure.univ_pi_Ioc_ae_eq_Icc]) "." `trans)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `measure_congr [`measure.univ_pi_Ioc_ae_eq_Icc])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
theorem
  volume_pi_Ioc
  { a b : ι → ℝ } : volume pi univ fun i => Ioc a i b i = ∏ i , Ennreal.ofReal b i - a i
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `volume_pi_Ioc_to_real [])
  (Command.declSig
   [(Term.implicitBinder "{" [`a `b] [":" (Term.arrow `ι "→" (Data.Real.Basic.termℝ "ℝ"))] "}")
    (Term.explicitBinder "(" [`h] [":" («term_≤_» `a "≤" `b)] [] ")")]
   (Term.typeSpec
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.simp
         ...
         ["only"]
         ["["
          [(Tactic.simpLemma [] [] `volume_pi_Ioc)
           ","
           (Tactic.simpLemma [] [] `Ennreal.to_real_prod)
           ","
           (Tactic.simpLemma
...
@[ simp ]
  theorem
    ...
    { a b : ι → ℝ } ( h : a ≤ b ) : volume pi univ fun i => Ioc a i b i . toReal = ∏ i , b i - a i
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
        ...
        [`univ
         (Term.fun
          ...
          (Term.basicFun
           [(Term.simpleBinder [`i] [])]
           "=>"
           (Term.app `Ico [(Term.app `a [`i]) (Term.app `b [`i])])))])])
     "="
     (Algebra.BigOperators.Basic.«term∏_,_»
      "∏"
      (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
  ...
  (Command.declValSimple
   ":="
   (Term.app (Term.proj (Term.app `measure_congr [`measure.univ_pi_Ico_ae_eq_Icc]) "." `trans) [`volume_Icc_pi])
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `measure_congr [`measure.univ_pi_Ico_ae_eq_Icc]) "." `trans)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `measure_congr [`measure.univ_pi_Ico_ae_eq_Icc])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
   ...
   (Term.app
    ...
    [(Term.app
      ...
      [`univ
       (Term.fun
        "fun"
        (Term.basicFun [(Term.simpleBinder [`i] [])] "=>" (Term.app `Ico [(Term.app `a [`i]) (Term.app `b [`i])])))])])
   "="
   (Algebra.BigOperators.Basic.«term∏_,_»
    "∏"
    (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `i)] []))
...
theorem
  volume_pi_Ico
  { a b : ι → ℝ } : volume pi univ fun i => Ico a i b i = ∏ i , Ennreal.ofReal b i - a i
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `volume_pi_Ico_to_real [])
  (Command.declSig
   [(Term.implicitBinder "{" [`a `b] [":" (Term.arrow `ι "→" (Data.Real.Basic.termℝ "ℝ"))] "}")
    (Term.explicitBinder "(" [`h] [":" («term_≤_» `a "≤" `b)] [] ")")]
   (Term.typeSpec
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.simp
         ...
         ["only"]
         ["["
          [(Tactic.simpLemma [] [] `volume_pi_Ico)
           ","
           (Tactic.simpLemma [] [] `Ennreal.to_real_prod)
           ","
           (Tactic.simpLemma
...
@[ simp ]
  theorem
    ...
    { a b : ι → ℝ } ( h : a ≤ b ) : volume pi univ fun i => Ico a i b i . toReal = ∏ i , b i - a i
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `volume_pi_le_prod_diam [])
  (Command.declSig
   [(Term.explicitBinder "(" [`s] [":" (Term.app `Set [(Term.arrow `ι "→" (Data.Real.Basic.termℝ "ℝ"))])] [] ")")]
   (Term.typeSpec
    ":"
    («term_≤_»
     (Term.app `volume [`s])
     ...
     (Algebra.BigOperators.Basic.«term∏_,_»
      ...
      ", "
      (Term.app `Emetric.diam [(Set.Data.Set.Basic.term_''_ (Term.app `Function.eval [`i]) " '' " `s)])))))
  (Command.declValSimple
   ":="
   (calc
    "calc"
          ...
          [`univ
           (Term.fun
            ...
            (Term.basicFun
             [(Term.simpleBinder [`i] [])]
             "=>"
             (Term.app `Closure [(Set.Data.Set.Basic.term_''_ (Term.app `Function.eval [`i]) " '' " `s)])))])]))
      ":="
      («term_$__»
       (Term.proj `volume "." `mono)
       "$"
       («term_$__»
        (Term.app `subset.trans [(Term.app `subset_pi_eval_image [`univ `s])])
        "$"
        («term_$__»
         `pi_mono
         "$"
         (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`i `hi] [])] "=>" `subset_closure))))))
     (calcStep
      («term_=_»
       (Term.hole "_")
       "="
       (Algebra.BigOperators.Basic.«term∏_,_»
        ...
        (Term.app
         `volume
         [(«term_$__» `Closure "$" (Set.Data.Set.Basic.term_''_ (Term.app `Function.eval [`i]) " '' " `s))])))
      ":="
      (Term.app `volume_pi_pi [(Term.hole "_")]))
     (calcStep
      («term_≤_»
       (Term.hole "_")
       "≤"
      ...
      («term_$__»
       ...
       (Term.fun
        ...
        (Term.basicFun
         ...
         "=>"
         (Term.app
          (Term.proj (Term.app `volume_le_diam [(Term.hole "_")]) "." `trans_eq)
          [(Term.app `Emetric.diam_closure [(Term.hole "_")])])))))])
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Emetric.diam_closure [(Term.hole "_")]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `volume_le_diam [(Term.hole "_")]) "." `trans_eq)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `volume_le_diam [(Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `volume_le_diam [(Term.hole "_")]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Set.Data.Set.Basic.term_''_ (Term.app `Function.eval [`i]) " '' " `s)
...
theorem
  ...
  ( s : Set ι → ℝ ) : volume s ≤ ∏ i : ι , Emetric.diam Function.eval i '' s
  :=
    calc
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `volume_pi_le_diam_pow [])
  (Command.declSig
   [(Term.explicitBinder "(" [`s] [":" (Term.app `Set [(Term.arrow `ι "→" (Data.Real.Basic.termℝ "ℝ"))])] [] ")")]
   (Term.typeSpec
    ":"
    («term_≤_»
     (Term.app `volume [`s])
     "≤"
     (Cardinal.SetTheory.Cofinality.«term_^_» (Term.app `Emetric.diam [`s]) "^" (Term.app `Fintype.card [`ι])))))
  (Command.declValSimple
   ":="
   (calc
    "calc"
    [(calcStep
      («term_≤_»
       ...
       (Algebra.BigOperators.Basic.«term∏_,_»
        ...
        (Term.app `Emetric.diam [(Set.Data.Set.Basic.term_''_ (Term.app `Function.eval [`i]) " '' " `s)])))
      ":="
      (Term.app `volume_pi_le_prod_diam [`s]))
     (calcStep
      («term_≤_»
       (Term.hole "_")
       "≤"
       (Algebra.BigOperators.Basic.«term∏_,_»
        ...
        (Finset.Data.Finset.Fold.«term_*_»
         (Term.paren "(" [(numLit "1") [(Term.typeAscription ":" (Data.Real.Nnreal.«termℝ≥0» " ℝ≥0 "))]] ")")
         "*"
         (Term.app `Emetric.diam [`s]))))
      ":="
      («term_$__»
       `Finset.prod_le_prod'
       "$"
       (Term.fun
        ...
        (Term.basicFun
         [(Term.simpleBinder [`i `hi] [])]
         "=>"
         (Term.app (Term.proj (Term.app `LipschitzWith.eval [`i]) "." `ediam_image_le) [`s])))))
     (calcStep
      («term_=_»
       (Term.hole "_")
       "="
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `LipschitzWith.eval [`i]) "." `ediam_image_le)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `LipschitzWith.eval [`i])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `LipschitzWith.eval [`i]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.simpleBinder', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.simpleBinder', expected 'Lean.Parser.Term.strictImplicitBinder.antiquot'
...
theorem
  ...
  ( s : Set ι → ℝ ) : volume s ≤ Emetric.diam s ^ Fintype.card ι
  :=
    calc
      volume s ≤ ∏ i : ι , Emetric.diam Function.eval i '' s := volume_pi_le_prod_diam s
        ...
        _ = Emetric.diam s ^ Fintype.card ι
          :=
          by simp only [ Ennreal.coe_one , one_mulₓ , Finset.prod_const , Fintype.card ]
...
theorem volume_preimage_add_right (a : ℝ) (s : Set ℝ) : volume ((·+a) ⁻¹' s) = volume s :=
  calc volume ((·+a) ⁻¹' s) = measure.map (·+a) volume s := ((Homeomorph.addRight a).toMeasurableEquiv.map_apply s).symm
    _ = volume s := by
    rw [map_volume_add_right]
    

theorem smul_map_volume_mul_left {a : ℝ} (h : a ≠ 0) : Ennreal.ofReal |a| • measure.map ((·*·) a) volume = volume := by
...
theorem map_transvection_volume_pi [DecidableEq ι] (t : transvection_struct ι ℝ) :
  ...
  have B : measure_preserving F volume volume := by
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `Filter.Eventually.volume_pos_of_nhds_real [])
  (Command.declSig
   [(Term.implicitBinder "{" [`p] [":" (Term.arrow (Data.Real.Basic.termℝ "ℝ") "→" (Term.prop "Prop"))] "}")
   ...
   (Term.typeSpec
    ...
    («term_<_»
     ...
     "<"
     (Term.app `volume [(Set.«term{_|_}» "{" `x "|" (Term.app `p [`x]) "}")]))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.rcases
         "rcases"
         [(Tactic.casesTarget [] `h.exists_Ioo_subset)]
         ["with"
        ...
        [])
       (group
        (Tactic.refine' "refine'" (Term.app `lt_of_lt_of_leₓ [(Term.hole "_") (Term.app `measure_mono [`hs])]))
        [])
       (group
        (Tactic.simpa
         "simpa"
         []
         []
         ["[" [(Tactic.simpErase "-" `mem_Ioo)] "]"]
         []
         ["using"
          (Term.app (Term.proj (Term.proj `hx "." (fieldIdx "1")) "." `trans) [(Term.proj `hx "." (fieldIdx "2"))])])
        [])])))
   [])
  []
  []))
       ...
       (Tactic.rcases
        ...
        ["with"
         (Tactic.rcasesPat.tuple
          ...
          "⟩")])
       [])
      (group (Tactic.refine' "refine'" (Term.app `lt_of_lt_of_leₓ [(Term.hole "_") (Term.app `measure_mono [`hs])])) [])
      (group
       (Tactic.simpa
        "simpa"
        []
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.simpa
   ...
   ["[" [(Tactic.simpErase "-" `mem_Ioo)] "]"]
   []
   ["using" (Term.app (Term.proj (Term.proj `hx "." (fieldIdx "1")) "." `trans) [(Term.proj `hx "." (fieldIdx "2"))])])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `lt_of_lt_of_leₓ [(Term.hole "_") (Term.app `measure_mono [`hs])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `measure_mono [`hs]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `volume_region_between_eq_lintegral' [])
  (Command.declSig
   ...
   (Term.typeSpec
    ":"
    («term_=_»
     (Term.app `μ.prod [`volume (Term.app `RegionBetween [`f `g `s])])
     "="
     (MeasureTheory.MeasureTheory.Integral.Lebesgue.«term∫⁻_in_,_∂_»
      ...
      `s
      ", "
      (Term.app `Ennreal.ofReal [(Term.app («term_-_» `g "-" `f) [`y])])
      " ∂"
      `μ))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    ...
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `measure.prod_apply)] "]") []) [])
       (group
        (Tactic.«tactic·._»
         "·"
         (Tactic.tacticSeq
           ...
           [(group
                     ...
                     (Term.app
                      ...
                      [(Set.«term{_|_}»
                        ...
                        («term_∧_»
                         ...
                         "∧"
                         (Init.Core.«term_∈_» `a " ∈ " (Term.app `Ioo [(Term.app `f [`x]) (Term.app `g [`x])])))
                        "}")])))
                   "="
                   (Term.app
                    `s.indicator
                    [(Term.fun
                      ...
                      (Term.basicFun
                       [(Term.simpleBinder [`x] [])]
                       "=>"
                       (Term.app `Ennreal.ofReal [(«term_-_» (Term.app `g [`x]) "-" (Term.app `f [`x]))])))])))]
                ":="
                (Term.byTactic
                 "by"
                 (Tactic.tacticSeq
                  (Tactic.tacticSeq1Indented
                   [(group (tacticFunext__ "funext" [`x]) [])
                    (group
                     (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `indicator_apply)] "]") [])
                     [])
                                ...
                                (Set.«term{_|_}»
                                 ...
                                 («term_∧_»
                                  ...
                                  (Init.Core.«term_∈_»
                                   `a
                                   " ∈ "
                                   (Term.app `Ioo [(Term.app `f [`x]) (Term.app `g [`x])])))
                                 "}")
                                "="
                                (Term.app `Ioo [(Term.app `f [`x]) (Term.app `g [`x])])))]
                             ":="
                               ...
                               (Tactic.tacticSeq1Indented
                                [(group
                                  (Tactic.simp
                                   ...
                                   []
                                   []
                                   ["[" [(Tactic.simpLemma [] [] `h) "," (Tactic.simpLemma [] [] `Ioo)] "]"]
                                   [])
                                  [])]))))))
                          [])
                         (group
                          (Tactic.simp
                           ...
                           ["["
                            [(Tactic.simpLemma [] [] `hx)
                             ","
                             (Tactic.simpLemma [] [] `Real.volume_Ioo)
                             ","
                        ...
                        [(group
                         ...
                         (group
                          (Tactic.simp
                           ...
                           []
                           ["only"]
                           ["[" [(Tactic.simpLemma [] [] `hx) "," (Tactic.simpLemma [] [] `measure_empty)] "]"]
                           [])
                          [])])))
                     [])]))))))
             [])
            (group
             (Tactic.dsimp
              ...
              []
              ["only"]
              ["[" [(Tactic.simpLemma [] [] `RegionBetween) "," (Tactic.simpLemma [] [] `preimage_set_of_eq)] "]"]
              []
              [])
             [])
            (group
             (Tactic.«tactic_<;>_»
              (Tactic.rwSeq
               "rw"
               []
               (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `h) "," (Tactic.rwRule [] `lintegral_indicator)] "]")
               [])
              "<;>"
              (Tactic.simp
               "simp"
               []
               ["only"]
               ["[" [(Tactic.simpLemma [] [] `hs) "," (Tactic.simpLemma [] [] `Pi.sub_apply)] "]"]
               []))
             [])])))
        [])
       (group
        (Tactic.«tactic·._»
         ...
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group (Tactic.exact "exact" (Term.app `measurable_set_region_between [`hf `hg `hs])) [])])))
        [])])))
   [])
  []
  []))
              ...
              (Term.haveIdDecl
               ...
               (Term.byTactic
                ...
                (Tactic.tacticSeq
                 (Tactic.tacticSeq1Indented
                  [(group (tacticFunext__ "funext" [`x]) [])
                   (group (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `indicator_apply)] "]") []) [])
                   (group (Tactic.splitIfs "split_ifs" [] []) [])
                   (group
                    (Tactic.«tactic·._»
                     "·"
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `measurable_set_region_between [`hf `hg `hs]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `measurable_set_region_between [`hf `hg `hs])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
    ...
    by
      rw [ measure.prod_apply ]
        ·
          have
              h
                : fun x => volume { a | x ∈ s ∧ a ∈ Ioo f x g x } = s.indicator fun x => Ennreal.ofReal g x - f x
                :=
                by
                  funext x
                    rw [ indicator_apply ]
 ...
 (Command.theorem
  ...
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `sigma_finite [`μ]) "]")
    (Term.explicitBinder "(" [`hf] [":" (Term.app `AeMeasurable [`f (Term.app `μ.restrict [`s])])] [] ")")
    (Term.explicitBinder "(" [`hg] [":" (Term.app `AeMeasurable [`g (Term.app `μ.restrict [`s])])] [] ")")
    (Term.explicitBinder "(" [`hs] [":" (Term.app `MeasurableSet [`s])] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_»
              ...
              (Term.fun
               ...
               (Term.basicFun
                ...
                (Term.app
                 `Ennreal.ofReal
                 [(Term.app
                   («term_-_» (Term.app `AeMeasurable.mk [`g `hg]) "-" (Term.app `AeMeasurable.mk [`f `hf]))
                   [`y])])))))]
           ":="
           (Term.app (Term.proj (Term.app `hg.ae_eq_mk.sub [`hf.ae_eq_mk]) "." `fun_comp) [(Term.hole "_")]))))
        [])
       (group
        (Tactic.tacticHave_
         "have"
         (Term.haveDecl
          (Term.haveIdDecl
           ...
           [(Term.typeSpec
             ...
             («term_=_»
              (Term.app
               (Term.proj (Term.app `μ.restrict [`s]) "." `Prod)
               [`volume (Term.app `RegionBetween [`f `g `s])])
              "="
              (Term.app
               (Term.proj (Term.app `μ.restrict [`s]) "." `Prod)
               [`volume
                (Term.app
                 `RegionBetween
                 [(Term.app `AeMeasurable.mk [`f `hf]) (Term.app `AeMeasurable.mk [`g `hg]) `s])])))]
           ":="
           (Term.byTactic
            "by"
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(group (Tactic.apply "apply" `measure_congr) [])
               (group (Tactic.apply "apply" `eventually_eq.rfl.inter) [])
               (group
                (Tactic.exact
                 "exact"
                 (Term.app
                  (Term.proj
                   (Term.app
                    (Term.proj
                     (Term.app `ae_eq_comp' [`measurable_fst `hf.ae_eq_mk `measure.prod_fst_absolutely_continuous])
                     "."
                     `comp₂)
                    [(Term.hole "_") `eventually_eq.rfl])
                   "."
                   `inter)
                  [(Term.app
                    `eventually_eq.rfl.comp₂
                    [(Term.hole "_")
                     (Term.app `ae_eq_comp' [`measurable_fst `hg.ae_eq_mk `measure.prod_fst_absolutely_continuous])])]))
                [])]))))))
        [])
       (group
        (Tactic.rwSeq
         ...
         (Tactic.rwRuleSeq
          "["
          [(Tactic.rwRule [] (Term.app `lintegral_congr_ae [`h₁]))
           ","
           (Tactic.rwRule
            ["←"]
            (Term.app `volume_region_between_eq_lintegral' [`hf.measurable_mk `hg.measurable_mk `hs]))]
          "]")
         [])
        [])
       (group (Tactic.convert "convert" [] `h₂ ["using" (numLit "1")]) [])
       (group
        (Tactic.«tactic·._»
         "·"
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group
             (Tactic.rwSeq
              "rw"
              []
              (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `measure.restrict_prod_eq_prod_univ)] "]")
              [])
             [])
            (group
             (Tactic.exact
              ...
              (Term.proj
               (Term.app
                ...
                [(Term.app `hs.prod [`MeasurableSet.univ]) (Term.app `region_between_subset [`f `g `s])])
               "."
               `symm))
             [])])))
        [])
            ...
            (group
             (Tactic.exact
              ...
              (Term.proj
               (Term.app
                `measure.restrict_eq_self'
                [(Term.app `hs.prod [`MeasurableSet.univ])
                 (Term.app
        ...
        (Term.haveDecl
         (Term.haveIdDecl
          ...
          [(Term.typeSpec
            ":"
            («term_=_»
             (Term.app (Term.proj (Term.app `μ.restrict [`s]) "." `Prod) [`volume (Term.app `RegionBetween [`f `g `s])])
             "="
             (Term.app
              (Term.proj (Term.app `μ.restrict [`s]) "." `Prod)
              [`volume
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.«tactic·._»
   ...
   (Tactic.tacticSeq
    (Tactic.tacticSeq1Indented
     [(group
       (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `measure.restrict_prod_eq_prod_univ)] "]") [])
       [])
      (group
       (Tactic.exact
        "exact"
  ...
  (Tactic.exact
   ...
   (Term.proj
    (Term.app
     `measure.restrict_eq_self'
     [(Term.app `hs.prod [`MeasurableSet.univ])
      (Term.app `region_between_subset [(Term.app `AeMeasurable.mk [`f `hf]) (Term.app `AeMeasurable.mk [`g `hg]) `s])])
    "."
    `symm))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `AeMeasurable.mk [`g `hg]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `AeMeasurable.mk [`f `hf]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `region_between_subset
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(Term.app
   `region_between_subset
   [(Term.paren "(" [(Term.app `AeMeasurable.mk [`f `hf]) []] ")")
    (Term.paren "(" [(Term.app `AeMeasurable.mk [`g `hg]) []] ")")
    `s])
  []]
 ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `hs.prod [`MeasurableSet.univ]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `measure.restrict_eq_self'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(Term.app
   `measure.restrict_eq_self'
   [(Term.paren "(" [(Term.app `hs.prod [`MeasurableSet.univ]) []] ")")
    (Term.paren
     "("
     [(Term.app
       `region_between_subset
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `region_between_subset [`f `g `s])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `region_between_subset [`f `g `s]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(Term.app
   `measure.restrict_eq_self'
   [(Term.paren "(" [(Term.app `hs.prod [`MeasurableSet.univ]) []] ")")
    (Term.paren "(" [(Term.app `region_between_subset [`f `g `s]) []] ")")])
  []]
 ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.convert "convert" [] `h₂ ["using" (numLit "1")])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq
   ...
   (Tactic.rwRuleSeq
    ...
    [(Tactic.rwRule [] (Term.app `lintegral_congr_ae [`h₁]))
     ","
     (Tactic.rwRule ["←"] (Term.app `volume_region_between_eq_lintegral' [`hf.measurable_mk `hg.measurable_mk `hs]))]
    "]")
   [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
     ...
     [(Term.typeSpec
       ...
       («term_=_»
        ...
        (Term.app
         (Term.proj (Term.app `μ.restrict [`s]) "." `Prod)
         [`volume
          (Term.app `RegionBetween [(Term.app `AeMeasurable.mk [`f `hf]) (Term.app `AeMeasurable.mk [`g `hg]) `s])])))]
     ":="
     (Term.byTactic
      "by"
      (Tactic.tacticSeq
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app
   ...
   [(Term.app
     `eventually_eq.rfl.comp₂
     [(Term.hole "_") (Term.app `ae_eq_comp' [`measurable_fst `hg.ae_eq_mk `measure.prod_fst_absolutely_continuous])])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `measure.prod_fst_absolutely_continuous
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app
   (Term.proj (Term.app `ae_eq_comp' [`measurable_fst `hf.ae_eq_mk `measure.prod_fst_absolutely_continuous]) "." `comp₂)
   [(Term.hole "_") `eventually_eq.rfl])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.apply "apply" `eventually_eq.rfl.inter)
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.apply "apply" `measure_congr)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.apply', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `measure_congr
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_=_»
   ...
   (Term.app
    (Term.proj (Term.app `μ.restrict [`s]) "." `Prod)
    [`volume (Term.app `RegionBetween [(Term.app `AeMeasurable.mk [`f `hf]) (Term.app `AeMeasurable.mk [`g `hg]) `s])]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_=_»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app
   (Term.proj (Term.app `μ.restrict [`s]) "." `Prod)
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `RegionBetween [`f `g `s]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `hg.ae_eq_mk.sub [`hf.ae_eq_mk]) "." `fun_comp)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `hg.ae_eq_mk.sub [`hf.ae_eq_mk])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `hg.ae_eq_mk.sub [`hf.ae_eq_mk]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'optional.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
  ...
  (MeasureTheory.MeasureTheory.Measure.MeasureSpaceDef.«term_=ᵐ[_]_»
   ...
   (Term.fun
    ...
    (Term.basicFun
     ...
     (Term.app
      `Ennreal.ofReal
      [(Term.app («term_-_» (Term.app `AeMeasurable.mk [`g `hg]) "-" (Term.app `AeMeasurable.mk [`f `hf])) [`y])]))))
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app
   (Term.paren "(" [(«term_-_» (Term.app `AeMeasurable.mk [`g `hg]) "-" (Term.app `AeMeasurable.mk [`f `hf])) []] ")")
   [`y])
  []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app (Term.paren "(" [(«term_-_» `g "-" `f) []] ")") [`y]) []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `Ennreal.ofReal
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(Term.fun
   ...
   (Term.basicFun
    ...
    (Term.app
     `Ennreal.ofReal
     [(Term.paren "(" [(Term.app (Term.paren "(" [(«term_-_» `g "-" `f) []] ")") [`y]) []] ")")])))
  []]
 ")")
        ...
        have
            ...
            h₂
              ...
              by
                apply measure_congr
                  ...
                  exact
                    ae_eq_comp' measurable_fst hf.ae_eq_mk measure.prod_fst_absolutely_continuous . comp₂
                          _ eventually_eq.rfl
                        .
                        inter
                      eventually_eq.rfl.comp₂
                        _ ae_eq_comp' measurable_fst hg.ae_eq_mk measure.prod_fst_absolutely_continuous
          ...
          ·
            rw [ measure.restrict_prod_eq_prod_univ ]
              exact
                measure.restrict_eq_self'
                    hs.prod MeasurableSet.univ region_between_subset AeMeasurable.mk f hf AeMeasurable.mk g hg s
                  .
                  symm
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `volume_region_between_eq_integral' [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `sigma_finite [`μ]) "]")
    (Term.explicitBinder "(" [`f_int] [":" (Term.app `integrable_on [`f `s `μ])] [] ")")
    (Term.explicitBinder "(" [`g_int] [":" (Term.app `integrable_on [`g `s `μ])] [] ")")
    (Term.explicitBinder "(" [`hs] [":" (Term.app `MeasurableSet [`s])] [] ")")
    (Term.explicitBinder
     "("
     [`hfg]
     [":"
      (MeasureTheory.MeasureTheory.Measure.MeasureSpaceDef.«term_≤ᵐ[_]_» `f " ≤ᵐ[" (Term.app `μ.restrict [`s]) "] " `g)]
     []
     ")")]
   (Term.typeSpec
    ":"
           ...
           (MeasureTheory.MeasureTheory.Measure.MeasureSpaceDef.«term_=ᵐ[_]_»
            ...
            (Term.fun
             ...
             (Term.basicFun
              [(Term.simpleBinder [`x] [])]
              "=>"
              (Term.app `Real.toNnreal [(«term_-_» (Term.app `g [`x]) "-" (Term.app `f [`x]))])))))])
        [])
       (group
        (Tactic.exact
         "exact"
         (Term.app
          ...
          [(Term.fun
            ...
            (Term.basicFun
             ...
             (Term.proj
              («term_$__»
               (Term.app `Real.coe_to_nnreal [(Term.hole "_")])
               "$"
               (Term.app (Term.proj `sub_nonneg "." (fieldIdx "2")) [`hx]))
              "."
              `symm)))]))
        [])
       (group
        (Tactic.rwSeq
         ...
         (Tactic.rwRuleSeq
          ...
          [(Tactic.rwRule
            []
            (Term.app `volume_region_between_eq_lintegral [`f_int.ae_measurable `g_int.ae_measurable `hs]))
           ","
           (Tactic.rwRule [] (Term.app `integral_congr_ae [`h]))
           ","
           (Tactic.rwRule [] `lintegral_congr_ae)
           ","
           (Tactic.rwRule
            []
            (Term.app
             ...
             [(Term.hole "_")
              (Term.app (Term.proj (Term.app `integrable_congr [`h]) "." `mp) [(Term.app `g_int.sub [`f_int])])]))]
          "]")
         [])
        [])
       (group (Tactic.simpa "simpa" [] ["only"] [] [] []) [])])))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq
   ...
   (Tactic.rwRuleSeq
    "["
    [(Tactic.rwRule [] (Term.app `volume_region_between_eq_lintegral [`f_int.ae_measurable `g_int.ae_measurable `hs]))
     ","
     (Tactic.rwRule [] (Term.app `integral_congr_ae [`h]))
     ","
     (Tactic.rwRule [] `lintegral_congr_ae)
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app
   `lintegral_coe_eq_integral
   [(Term.hole "_") (Term.app (Term.proj (Term.app `integrable_congr [`h]) "." `mp) [(Term.app `g_int.sub [`f_int])])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `g_int.sub [`f_int]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app
   (Term.proj (Term.paren "(" [(Term.app `integrable_congr [`h]) []] ")") "." `mp)
   [(Term.paren "(" [(Term.app `g_int.sub [`f_int]) []] ")")])
  []]
 ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app
   ...
   [(MeasureTheory.MeasureTheory.Integral.Bochner.«term∫_in_,_∂_»
     ...
     `μ)])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'MeasureTheory.MeasureTheory.Integral.Bochner.«term∫_in_,_∂_»', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'MeasureTheory.MeasureTheory.Integral.Bochner.«term∫_in_,_∂_»', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'MeasureTheory.MeasureTheory.Integral.Bochner.«term∫_in_,_∂_»', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'MeasureTheory.MeasureTheory.Integral.Bochner.«term∫_in_,_∂_»', expected 'Lean.Parser.Term.ellipsis.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'MeasureTheory.MeasureTheory.Integral.Bochner.«term∫_in_,_∂_»', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (MeasureTheory.MeasureTheory.Integral.Bochner.«term∫_in_,_∂_»
   "∫"
   (Lean.explicitBinders (Lean.unbracketedExplicitBinders [(Lean.binderIdent `y)] []))
  ...
  :=
    by
      have h : g - f =ᵐ[ μ.restrict s ] fun x => Real.toNnreal g x - f x
        ...
        rw
          [
            volume_region_between_eq_lintegral f_int.ae_measurable g_int.ae_measurable hs
              ,
              integral_congr_ae h
              ,
              lintegral_congr_ae
  ...
  (Command.declValSimple
   ...
   (Term.app
    ...
    [`f_int
     `g_int
     `hs
     (Term.app (Term.proj (Term.app `ae_restrict_iff' [`hs]) "." `mpr) [(Term.app `eventually_of_forall [`hfg])])])
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `eventually_of_forall [`hfg])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `eventually_of_forall [`hfg]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `ae_restrict_iff' [`hs]) "." `mpr)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `ae_restrict_iff' [`hs]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app
   (Term.proj (Term.paren "(" [(Term.app `ae_restrict_iff' [`hs]) []] ")") "." `mpr)
   [(Term.paren "(" [(Term.app `eventually_of_forall [`hfg]) []] ")")])
  []]
 ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
