...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `sum_left [])
  (Command.declSig
   [(Term.implicitBinder "{" [`ι] [":" (Term.type "Type" [(Level.hole "_")])] "}")
    (Term.instBinder "[" [] (Term.app `Encodable [`ι]) "]")
    (Term.implicitBinder "{" [`μ] [":" (Term.arrow `ι "→" (Term.app `Measureₓ [`α]))] "}")]
   (Term.typeSpec
    ":"
    («term_↔_»
     (MeasureTheory.Measureₓ.MeasureTheory.Measure.MutuallySingular.«term_⊥ₘ_» (Term.app `Sum [`μ]) " ⊥ₘ " `ν)
     "↔"
     (Term.forall
      "∀"
      [(Term.simpleBinder [`i] [])]
      ","
      (MeasureTheory.Measureₓ.MeasureTheory.Measure.MutuallySingular.«term_⊥ₘ_» (Term.app `μ [`i]) " ⊥ₘ " `ν)))))
         ...
         (Term.anonymousCtor
          ...
          [(Term.fun
            ...
            (Term.basicFun
             ...
             "=>"
             (Term.app `h.mono [(Term.app `le_sum [(Term.hole "_") (Term.hole "_")]) `le_rfl])))
           ","
           (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`H] [])] "=>" (Term.hole "_")))]
          "⟩"))
        [])
       (group (Tactic.choose "choose" [`s `hsm `hsμ `hsν] ["using" `H]) [])
       (group
        (Tactic.refine'
         "refine'"
         (Term.anonymousCtor
          ...
          [(Set.Data.Set.Lattice.«term⋂_,_»
            ...
            (Term.app `s [`i]))
           ","
           (Term.app `MeasurableSet.Inter [`hsm])
           ","
           (Term.hole "_")
           ","
           (Term.hole "_")]
          ...
          (Tactic.tacticSeq1Indented
           [(group
             (Tactic.rwSeq
              ...
              (Tactic.rwRuleSeq
               "["
               [(Tactic.rwRule [] (Term.app `sum_apply [(Term.hole "_") (Term.app `MeasurableSet.Inter [`hsm])]))
                ","
                (Tactic.rwRule [] `Ennreal.tsum_eq_zero)]
               "]")
              [])
             [])
            (group
             (Tactic.exact
              ...
              (Term.fun
               ...
               (Term.basicFun
                ...
                (Term.app
                 `measure_mono_null
                 [(Term.app `Inter_subset [(Term.hole "_") (Term.hole "_")]) (Term.app `hsμ [`i])]))))
             [])])))
        [])
       (group
        (Tactic.«tactic·._»
          ...
          (Tactic.tacticSeq1Indented
           [(group
             (tacticRwa__
              ...
              (Tactic.rwRuleSeq
               "["
               [(Tactic.rwRule [] `compl_Inter) "," (Tactic.rwRule [] `measure_Union_null_iff)]
               "]")
              [])
             [])])))
        [])])))
        ...
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(group
            (tacticRwa__
             "rwa"
             (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `compl_Inter) "," (Tactic.rwRule [] `measure_Union_null_iff)] "]")
             [])
            [])])))
       [])])))
  ...
  (Tactic.exact
   ...
   (Term.fun
    ...
    (Term.basicFun
     [(Term.simpleBinder [`i] [])]
     "=>"
     (Term.app `measure_mono_null [(Term.app `Inter_subset [(Term.hole "_") (Term.hole "_")]) (Term.app `hsμ [`i])]))))
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `hsμ [`i]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `sum_apply [(Term.hole "_") (Term.app `MeasurableSet.Inter [`hsm])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `MeasurableSet.Inter [`hsm]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
@[ simp ]
  theorem
    sum_left
    { ι : Type _ } [ Encodable ι ] { μ : ι → Measureₓ α } : Sum μ ⊥ₘ ν ↔ ∀ i , μ i ⊥ₘ ν
    :=
      by
