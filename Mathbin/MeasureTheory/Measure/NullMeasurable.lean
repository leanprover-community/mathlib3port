...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.instance
  ...
  []
  []
  (Command.declSig [] (Term.typeSpec ":" (Term.app `MeasurableSpace [(Term.app `null_measurable_space [`α `μ])])))
     ...
     (Command.whereStructField
      (Term.letDecl
       (Term.letIdDecl
        ...
        (Term.anonymousCtor
         "⟨"
         [(«term∅» "∅") "," `MeasurableSet.empty "," (Term.app `ae_eq_refl [(Term.hole "_")])]
         "⟩"))))
     [])
    (group
     (Command.whereStructField
      (Term.letDecl
       (Term.letIdDecl
        ...
        [(Term.simpleBinder [(Term.simpleBinder [`s] []) (Term.anonymousCtor "⟨" [`t "," `htm "," `hts] "⟩")] [])]
        []
        ":="
        (Term.anonymousCtor "⟨" [(Order.BooleanAlgebra.«term_ᶜ» `t "ᶜ") "," `htm.compl "," `hts.compl] "⟩"))))
     [])
    (group
     (Command.whereStructField
      (Term.letDecl
       (Term.letIdDecl
        ...
        [(Term.simpleBinder [(Term.simpleBinder [`s `hs] [])] [])]
        []
        ":="
        (Term.byTactic
         "by"
         (Tactic.tacticSeq
          (Tactic.tacticSeq1Indented
           [(group (Tactic.choose "choose" [`t `htm `hts] ["using" `hs]) [])
            (group
             (Tactic.exact
              "exact"
              (Term.anonymousCtor
               ...
               [(Set.Data.Set.Lattice.«term⋃_,_»
                 ...
                 (Term.app `t [`i]))
                ","
                (Term.app `MeasurableSet.Union [`htm])
                ","
                (Term.app `EventuallyEq.countable_Union [`hts])]
               "⟩"))
             [])]))))))
     [])])
  []
...
instance
  : MeasurableSpace null_measurable_space α μ
  where
    MeasurableSet' s := ∃ t , MeasurableSet t ∧ s =ᵐ[ μ ] t
      measurable_set_empty := ⟨ ∅ , MeasurableSet.empty , ae_eq_refl _ ⟩
      measurable_set_compl s ⟨ t , htm , hts ⟩ := ⟨ t ᶜ , htm.compl , hts.compl ⟩
      measurable_set_Union
        s hs
        :=
        by choose t htm hts using hs exact ⟨ ⋃ i , t i , MeasurableSet.Union htm , EventuallyEq.countable_Union hts ⟩
  ...
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `Encodable [`ι]) "]")
    ...
    (Term.explicitBinder
     "("
     [`h]
     [":" (Term.forall "∀" [(Term.simpleBinder [`i] [])] "," (Term.app `null_measurable_set [(Term.app `s [`i]) `μ]))]
     []
     ")")]
   (Term.typeSpec
    ":"
...
protected
  theorem
    Union
    [ Encodable ι ] { s : ι → Set α } ( h : ∀ i , null_measurable_set s i μ ) : null_measurable_set ⋃ i , s i μ
    := MeasurableSet.Union h

-- ././Mathport/Syntax/Translate/Basic.lean:477:2: warning: expanding binder collection (b «expr ∈ » encodable.decode₂ ι n)
/- failed to parenthesize: parenthesize: uncaught backtrack exception
[PrettyPrinter.parenthesize.input] (Command.declaration
 (Command.declModifiers [] [] [(Command.protected "protected")] [] [] [])
 (Command.theorem
  "theorem"
  (Command.declId `bUnion_decode₂ [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `Encodable [`ι]) "]")
    (Term.strictImplicitBinder "⦃" [`f] [":" (Term.arrow `ι "→" (Term.app `Set [`α]))] "⦄")
    (Term.explicitBinder
     "("
     [`h]
     [":" (Term.forall "∀" [(Term.simpleBinder [`i] [])] "," (Term.app `null_measurable_set [(Term.app `f [`i]) `μ]))]
     []
     ")")
       ...
       (Lean.explicitBinders
        [(Lean.bracketedExplicitBinders "(" [(Lean.binderIdent `b)] ":" (Term.hole "_") ")")
         (Lean.bracketedExplicitBinders
          ...
          [(Lean.binderIdent "_")]
          ":"
          (Init.Core.«term_∈_» `b " ∈ " (Term.app `Encodable.decode₂ [`ι `n]))
          ")")])
       ", "
       (Term.app `f [`b]))
      `μ])))
  (Command.declValSimple ":=" (Term.app `MeasurableSet.bUnion_decode₂ [`h `n]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `MeasurableSet.bUnion_decode₂ [`h `n])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
protected
  theorem
    bUnion_decode₂
    [ Encodable ι ] ⦃ f : ι → Set α ⦄ ( h : ∀ i , null_measurable_set f i μ ) ( n : ℕ )
     ...
     [":"
      (Term.forall
       ...
       (Mathlib.ExtendedBinder.«term∀___,_»
        ...
        («binderTerm∈_» "∈" `s)
        ","
        (Term.forall "∀" [] "," (Term.app `null_measurable_set [(Term.app `f [`b]) `μ]))))]
     []
     ")")]
   (Term.typeSpec
    ":"
    (Term.app
     ...
     [(Set.Data.Set.Lattice.«term⋃_,_»
       ...
       (Term.app `f [`b]))
      `μ])))
  (Command.declValSimple ":=" (Term.app `MeasurableSet.bUnion [`hs `h]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `MeasurableSet.bUnion [`hs `h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
protected
  theorem
    bUnion
    { f : ι → Set α } { s : Set ι } ( hs : countable s ) ( h : ∀ , ∀ b ∈ s , ∀ , null_measurable_set f b μ )
      : null_measurable_set ⋃ ( b : _ ) ( _ : b ∈ s ) , f b μ
   ...
   (Term.typeSpec
    ...
    (Term.app
     ...
     [(Set.Data.Set.Lattice.«term⋃_,_»
       ...
       (Term.app `f [`i]))
      `μ])))
  (Command.declValSimple ":=" (Term.app `MeasurableSet.Union_Prop [`hf]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `MeasurableSet.Union_Prop [`hf])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
theorem
  Union_Prop
  { p : Prop } { f : p → Set α } ( hf : ∀ i , null_measurable_set f i μ ) : null_measurable_set ⋃ i , f i μ
  ...
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `Fintype [`ι]) "]")
    ...
    (Term.explicitBinder
     "("
     [`h]
     [":" (Term.forall "∀" [(Term.simpleBinder [`b] [])] "," (Term.app `null_measurable_set [(Term.app `f [`b]) `μ]))]
     []
     ")")]
   (Term.typeSpec
    ":"
    (Term.app
     ...
     [(Set.Data.Set.Lattice.«term⋃_,_»
       ...
       (Term.app `f [`b]))
      `μ])))
  (Command.declValSimple ":=" (Term.app `MeasurableSet.Union_fintype [`h]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `MeasurableSet.Union_fintype [`h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
theorem
  Union_fintype
  [ Fintype ι ] { f : ι → Set α } ( h : ∀ b , null_measurable_set f b μ ) : null_measurable_set ⋃ b , f b μ
...
protected
  theorem
    Inter
    [ Encodable ι ] { f : ι → Set α } ( h : ∀ i , null_measurable_set f i μ ) : null_measurable_set ⋂ i , f i μ
   ...
   (Term.typeSpec
    ...
    (Term.app
     ...
     [(Set.Data.Set.Lattice.«term⋂_,_»
       ...
       (Term.app `f [`b]))
      `μ])))
  (Command.declValSimple ":=" (Term.app `MeasurableSet.bInter [`hs `h]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `MeasurableSet.bInter [`hs `h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
protected
  theorem
    bInter
    { f : β → Set α } { s : Set β } ( hs : countable s ) ( h : ∀ , ∀ b ∈ s , ∀ , null_measurable_set f b μ )
      : null_measurable_set ⋂ ( b : _ ) ( _ : b ∈ s ) , f b μ
   ...
   (Term.typeSpec
    ...
    (Term.app
     ...
     [(Set.Data.Set.Lattice.«term⋂_,_»
       ...
       (Term.app `f [`b]))
      `μ])))
  (Command.declValSimple ":=" (Term.app `MeasurableSet.Inter_Prop [`hf]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `MeasurableSet.Inter_Prop [`hf])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
theorem
  Inter_Prop
  { p : Prop } { f : p → Set α } ( hf : ∀ b , null_measurable_set f b μ ) : null_measurable_set ⋂ b , f b μ
   ...
   (Term.typeSpec
    ...
    (Term.app
     ...
     [(Set.Data.Set.Lattice.«term⋂_,_»
       ...
       (Term.app `f [`b]))
      `μ])))
  (Command.declValSimple ":=" (Term.app `MeasurableSet.Inter_fintype [`h]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `MeasurableSet.Inter_fintype [`h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `measure_Union [])
  (Command.declSig
   [(Term.implicitBinder "{" [`m0] [":" (Term.app `MeasurableSpace [`α])] "}")
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.rwSeq
         ...
         (Tactic.rwRuleSeq
          "["
          [(Tactic.rwRule [] (Term.app `measure_eq_extend [(Term.app `MeasurableSet.Union [`h])]))
           ","
           (Tactic.rwRule
            []
            (Term.app
             `extend_Union
             [`MeasurableSet.empty (Term.hole "_") `MeasurableSet.Union (Term.hole "_") `hn `h]))]
          "]")
         [])
        [])
       (group
          ...
          (Tactic.tacticSeq1Indented
           [(group
             (Tactic.simp
              ...
              []
              []
              ["[" [(Tactic.simpLemma [] [] `measure_eq_extend) "," (Tactic.simpLemma [] [] `h)] "]"]
              [])
             [])])))
        [])
       (group
        (Tactic.«tactic·._»
         "·"
         (Tactic.tacticSeq (Tactic.tacticSeq1Indented [(group (Tactic.exact "exact" `μ.empty) [])])))
        [])
       (group
        (Tactic.«tactic·._»
         "·"
         (Tactic.tacticSeq (Tactic.tacticSeq1Indented [(group (Tactic.exact "exact" `μ.m_Union) [])])))
        [])])))
   [])
  []
  []))
       ...
       (Tactic.rwSeq
        ...
        (Tactic.rwRuleSeq
         ...
         [(Tactic.rwRule [] (Term.app `measure_eq_extend [(Term.app `MeasurableSet.Union [`h])]))
          ...
          (Tactic.rwRule
           []
           (Term.app `extend_Union [`MeasurableSet.empty (Term.hole "_") `MeasurableSet.Union (Term.hole "_") `hn `h]))]
         "]")
        [])
       [])
      (group
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.«tactic·._» "·" (Tactic.tacticSeq (Tactic.tacticSeq1Indented [(group (Tactic.exact "exact" `μ.m_Union) [])])))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.«tactic·._» "·" (Tactic.tacticSeq (Tactic.tacticSeq1Indented [(group (Tactic.exact "exact" `μ.empty) [])])))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.«tactic·._»', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq', expected 'Lean.Parser.Tactic.tacticSeq.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq1Indented', expected 'Lean.Parser.Tactic.tacticSeqBracketed.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.tacticSeq1Indented', expected 'Lean.Parser.Tactic.tacticSeqBracketed'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.simp "simp" [] [] ["[" [(Tactic.simpLemma [] [] `measure_eq_extend) "," (Tactic.simpLemma [] [] `h)] "]"] [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `measure_eq_extend [(Term.app `MeasurableSet.Union [`h])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `MeasurableSet.Union [`h]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `measure_eq_extend
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
    ...
    (Tactic.tacticSeq
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.refine'
         "refine'"
         (Term.app (Term.proj (Term.app `measure_Union_le [(Term.hole "_")]) "." `antisymm) [(Term.hole "_")]))
        [])
       (group
        (Tactic.choose
         "choose"
         ...
         ["using"
          (Term.fun
           ...
           (Term.basicFun
            [(Term.simpleBinder [`i] [])]
            "=>"
            (Term.proj (Term.app `h [`i]) "." `exists_measurable_subset_ae_eq)))])
        [])
       (group
        (Tactic.have''
         "have"
         [`hsd []]
         [(Term.typeSpec ":" (Term.app `Pairwise [(Function.Init.Function.term_on_ `Disjoint " on " `s)]))])
        [])
       (group
        (Tactic.exact
         "exact"
         (Term.app
          ...
          [(Term.fun
            "fun"
            (Term.basicFun
             [(Term.simpleBinder [`i `j `h] [])]
             "=>"
             (Term.app `h.mono [(Term.app `hsf [`i]) (Term.app `hsf [`j])])))]))
        [])
       (group
        (Tactic.simp
         "simp"
         ...
         ["only"]
         ["["
          [(Tactic.simpLemma [] ["←"] (Term.app `measure_congr [(Term.app `hs_eq [(Term.hole "_")])]))
           ","
           (Tactic.simpLemma [] ["←"] (Term.app `measure_Union [`hsd `hsm]))]
          "]"]
         [])
        [])
       (group (Tactic.exact "exact" (Term.app `measure_mono [(Term.app `Union_subset_Union [`hsf])])) [])])))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `measure_mono [(Term.app `Union_subset_Union [`hsf])]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `measure_mono [(Term.app `Union_subset_Union [`hsf])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Union_subset_Union [`hsf])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `Union_subset_Union [`hsf]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `measure_mono
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simpLemma', expected 'Lean.Parser.Tactic.simpErase'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `measure_Union [`hsd `hsm])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.simpLemma', expected 'Lean.Parser.Tactic.simpErase'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `measure_congr [(Term.app `hs_eq [(Term.hole "_")])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `hs_eq [(Term.hole "_")]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `measure_congr
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `hsf [`j]) []] ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `hsf [`i]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `h.mono
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Pairwise [(Function.Init.Function.term_on_ `Disjoint " on " `s)])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Function.Init.Function.term_on_ `Disjoint " on " `s)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Function.Init.Function.term_on_', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `s
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 3 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 2, (some 3, term) <=? (none, [anonymous])
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj (Term.app `measure_Union_le [(Term.hole "_")]) "." `antisymm)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `measure_Union_le [(Term.hole "_")]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 0, tactic) <=? (none, [anonymous])
...
theorem
  measure_Union₀
  [ Encodable ι ] { f : ι → Set α } ( hn : Pairwise Disjoint on f ) ( h : ∀ i , null_measurable_set f i μ )
    : μ ⋃ i , f i = ∑' i , μ f i
  :=
    by
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `null_measurable_set_eq [])
  (Command.declSig
   [(Term.implicitBinder "{" [`a] [":" `α] "}")]
   (Term.typeSpec ":" (Term.app `null_measurable_set [(Set.«term{_|_}» "{" `x "|" («term_=_» `x "=" `a) "}") `μ])))
  (Command.declValSimple ":=" (Term.app `null_measurable_set_singleton [`a]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `null_measurable_set_singleton [`a])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.typeSpec', expected 'Lean.Parser.Term.typeSpec.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, [anonymous]))
  (Term.app `null_measurable_set [(Set.«term{_|_}» "{" `x "|" («term_=_» `x "=" `a) "}") `μ])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `_root_.set.finite.null_measurable_set_bUnion [])
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.arrow `ι "→" (Term.app `Set [`α]))] "}")
    (Term.implicitBinder "{" [`s] [":" (Term.app `Set [`ι])] "}")
   ...
   (Term.typeSpec
    ...
    (Term.app
     ...
     [(Set.Data.Set.Lattice.«term⋃_,_»
       ...
       (Term.app `f [`b]))
      `μ])))
  (Command.declValSimple ":=" (Term.app `finite.measurable_set_bUnion [`hs `h]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `finite.measurable_set_bUnion [`hs `h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
theorem
  _root_.set.finite.null_measurable_set_bUnion
  { f : ι → Set α } { s : Set ι } ( hs : finite s ) ( h : ∀ , ∀ b ∈ s , ∀ , null_measurable_set f b μ )
    : null_measurable_set ⋃ ( b : _ ) ( _ : b ∈ s ) , f b μ
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `_root_.finset.null_measurable_set_bUnion [])
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.arrow `ι "→" (Term.app `Set [`α]))] "}")
   ...
   (Term.typeSpec
    ...
    (Term.app
     ...
     [(Set.Data.Set.Lattice.«term⋃_,_»
       ...
       (Term.app `f [`b]))
      `μ])))
  (Command.declValSimple ":=" (Term.app `Finset.measurable_set_bUnion [`s `h]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Finset.measurable_set_bUnion [`s `h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
theorem
  _root_.finset.null_measurable_set_bUnion
  { f : ι → Set α } ( s : Finset ι ) ( h : ∀ , ∀ b ∈ s , ∀ , null_measurable_set f b μ )
    : null_measurable_set ⋃ ( b : _ ) ( _ : b ∈ s ) , f b μ
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `_root_.set.finite.null_measurable_set_bInter [])
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.arrow `ι "→" (Term.app `Set [`α]))] "}")
    (Term.implicitBinder "{" [`s] [":" (Term.app `Set [`ι])] "}")
    (Term.explicitBinder "(" [`hs] [":" (Term.app `finite [`s])] [] ")")
   ...
   (Term.typeSpec
    ...
    (Term.app
     ...
     [(Set.Data.Set.Lattice.«term⋂_,_»
       ...
       (Term.app `f [`b]))
      `μ])))
  (Command.declValSimple ":=" (Term.app `finite.measurable_set_bInter [`hs `h]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `finite.measurable_set_bInter [`hs `h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
theorem
  _root_.set.finite.null_measurable_set_bInter
  { f : ι → Set α } { s : Set ι } ( hs : finite s ) ( h : ∀ , ∀ b ∈ s , ∀ , null_measurable_set f b μ )
    : null_measurable_set ⋂ ( b : _ ) ( _ : b ∈ s ) , f b μ
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `_root_.finset.null_measurable_set_bInter [])
  (Command.declSig
   [(Term.implicitBinder "{" [`f] [":" (Term.arrow `ι "→" (Term.app `Set [`α]))] "}")
    (Term.explicitBinder "(" [`s] [":" (Term.app `Finset [`ι])] [] ")")
    (Term.explicitBinder
   ...
   (Term.typeSpec
    ...
    (Term.app
     ...
     [(Set.Data.Set.Lattice.«term⋂_,_»
       ...
       (Term.app `f [`b]))
      `μ])))
  (Command.declValSimple ":=" (Term.app `s.finite_to_set.null_measurable_set_bInter [`h]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `s.finite_to_set.null_measurable_set_bInter [`h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `s.finite_to_set.null_measurable_set_bInter
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
theorem
  _root_.finset.null_measurable_set_bInter
  { f : ι → Set α } ( s : Finset ι ) ( h : ∀ , ∀ b ∈ s , ∀ , null_measurable_set f b μ )
    : null_measurable_set ⋂ ( b : _ ) ( _ : b ∈ s ) , f b μ
