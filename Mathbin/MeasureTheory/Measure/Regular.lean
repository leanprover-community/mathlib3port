...
-- ./././Mathport/Syntax/Translate/Basic.lean:701:2: warning: expanding binder collection (K «expr ⊆ » U)
...
-- ./././Mathport/Syntax/Translate/Basic.lean:701:2: warning: expanding binder collection (U «expr ⊇ » A)
...
-- ./././Mathport/Syntax/Translate/Basic.lean:701:2: warning: expanding binder collection (U «expr ⊇ » A n)
...
-- ./././Mathport/Syntax/Translate/Basic.lean:701:2: warning: expanding binder collection (ε «expr ≠ » 0)
...
-- ./././Mathport/Syntax/Translate/Basic.lean:701:2: warning: expanding binder collection (K «expr ⊆ » A)
/-- If `μ` is a regular measure, then any measurable set of finite measure can be approximated by a
...
-- ./././Mathport/Syntax/Translate/Basic.lean:701:2: warning: expanding binder collection (F «expr ⊆ » U)
...
-- ./././Mathport/Syntax/Translate/Basic.lean:701:2: warning: expanding binder collection (K «expr ⊆ » s)
...
-- ./././Mathport/Syntax/Translate/Basic.lean:701:2: warning: expanding binder collection (F «expr ⊆ » A)
