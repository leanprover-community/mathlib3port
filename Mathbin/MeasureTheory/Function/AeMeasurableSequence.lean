...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.def
  "def"
  (Command.declId `AeSeqSet [])
  (Command.optDeclSig
   [(Term.explicitBinder
     "("
     [`hf]
     [":" (Term.forall "∀" [(Term.simpleBinder [`i] [])] "," (Term.app `AeMeasurable [(Term.app `f [`i]) `μ]))]
     []
     ")")
    (Term.explicitBinder
     "("
     [`p]
     [":" (Term.arrow `α "→" (Term.arrow (Term.arrow `ι "→" `β) "→" (Term.prop "Prop")))]
     []
     ")")]
        ...
        («term_∧_»
         (Term.forall
          ...
          («term_=_»
           (Term.app `f [`i `x])
           "="
           (Term.app (Term.proj (Term.app `hf [`i]) "." `mk) [(Term.app `f [`i]) `x])))
         "∧"
         (Term.app `p [`x (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`n] [])] "=>" (Term.app `f [`n `x])))]))
        "}")
       "ᶜ")])
    "ᶜ")
   [])
   ...
   (Set.«term{_|_}»
    ...
    («term_∧_»
     (Term.forall
      ...
      [(Term.simpleBinder [`i] [])]
      ","
      («term_=_» (Term.app `f [`i `x]) "=" (Term.app (Term.proj (Term.app `hf [`i]) "." `mk) [(Term.app `f [`i]) `x])))
     "∧"
     (Term.app `p [`x (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`n] [])] "=>" (Term.app `f [`n `x])))]))
    "}")
   "ᶜ")
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(Term.forall
   ...
   («term_=_»
    ...
    "="
    (Term.app
     (Term.proj (Term.paren "(" [(Term.app `hf [`i]) []] ")") "." `mk)
     [(Term.paren "(" [(Term.app `f [`i]) []] ")") `x])))
  []]
 ")")
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `mk_eq_fun_of_mem_ae_seq_set [])
  (Command.declSig
   [(Term.explicitBinder
     "("
     [`hf]
    ...
    (Term.explicitBinder "(" [`hx] [":" (Init.Core.«term_∈_» `x " ∈ " (Term.app `AeSeqSet [`hf `p]))] [] ")")
    (Term.explicitBinder "(" [`i] [":" `ι] [] ")")]
   (Term.typeSpec
    ":"
    («term_=_» (Term.app (Term.proj (Term.app `hf [`i]) "." `mk) [(Term.app `f [`i]) `x]) "=" (Term.app `f [`i `x]))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
                   ...
                   (Tactic.rwRule
                    ...
                    (Term.app
                     ...
                     [(Set.«term{_|_}»
                       ...
                       "}")]))
                   ","
                   (Tactic.rwRule [] `Set.compl_subset_compl)]
                  "]")
                 [])
                [])
               (group
                ...
                [])
               (group (Tactic.exact "exact" (Term.proj `h "." (fieldIdx "1"))) [])]))))))
        [])
       (group (Tactic.exact "exact" (Term.proj (Term.app `h_ss [`hx `i]) "." `symm)) [])])))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.proj (Term.app `h_ss [`hx `i]) "." `symm))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Term.app `h_ss [`hx `i]) "." `symm)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `h_ss [`hx `i])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `h_ss [`hx `i]) []] ")")
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.proj `h "." (fieldIdx "1")))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
theorem
  ...
  :=
    by
      have
          h_ss
            : AeSeqSet hf p ⊆ { x | ∀ i , f i x = hf i . mk f i x }
            :=
            by
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `prop_of_mem_ae_seq_set [])
  (Command.declSig
   [(Term.explicitBinder
     "("
     [`hf]
   ...
   (Term.typeSpec
    ...
    (Term.app
     `p
     [`x (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`n] [])] "=>" (Term.app `aeSeq [`hf `p `n `x])))])))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.simp
         ...
         ["only"]
         ["["
          [(Tactic.simpLemma [] [] `aeSeq) "," (Tactic.simpLemma [] [] `hx) "," (Tactic.simpLemma [] [] `if_true)]
          "]"]
         [])
        [])
       (group
            ...
            (Term.app
             ...
             [(Term.fun
               ...
               (Term.basicFun
                [(Term.simpleBinder [`n] [])]
                "=>"
                (Term.app `mk_eq_fun_of_mem_ae_seq_set [`hf `hx `n])))]))]
          "]")
         [])
        [])
       (group
           ...
           [(Term.typeSpec
             ...
             (Init.Core.«term_⊆_»
              ...
              (Set.«term{_|_}»
               ...
               (Term.app
                `p
                [`x (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`n] [])] "=>" (Term.app `f [`n `x])))])
               "}")))]
           ":="
           (Term.byTactic
            "by"
              ...
              [(group
               ...
               (group
                (Tactic.refine'
                 ...
                 (Term.app
                  `Set.Subset.trans
                  [(Term.app `set.compl_subset_compl.mpr [(Term.hole "_")])
                   (Term.app `subset_to_measurable [(Term.hole "_") (Term.hole "_")])]))
                [])
               (group
                (Tactic.exact
       ...
       (group
        (Tactic.tacticHave_
         "have"
         (Term.haveDecl (Term.haveIdDecl [`hx' []] [] ":=" (Term.app `Set.mem_of_subset_of_mem [`h_ss `hx]))))
        [])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.haveIdDecl', expected 'Lean.Parser.Term.haveIdDecl.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Set.mem_of_subset_of_mem [`h_ss `hx])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `measure_compl_ae_seq_set_eq_zero [])
  (Command.declSig
   ...
   (Term.typeSpec
    ":"
    («term_=_» (Term.app `μ [(Order.BooleanAlgebra.«term_ᶜ» (Term.app `AeSeqSet [`hf `p]) "ᶜ")]) "=" (numLit "0"))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
        ...
        (Tactic.tacticHave_
         ...
         (Term.haveDecl
          (Term.haveIdDecl
           ...
           (Term.fun
            "fun"
            (Term.basicFun [(Term.simpleBinder [`i] [])] "=>" (Term.proj (Term.app `hf [`i]) "." `ae_eq_mk))))))
        [])
       (group
        (Tactic.simpRw
         "simp_rw"
         (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `Filter.EventuallyEq) "," (Tactic.rwRule ["←"] `ae_all_iff)] "]")
         [(Tactic.location "at" (Tactic.locationHyp [`hf_eq] []))])
        [])
       (group (Tactic.exact "exact" (Term.app `Filter.Eventually.and [`hf_eq `hp])) [])])))
   [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `Filter.Eventually.and [`hf_eq `hp]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Filter.Eventually.and [`hf_eq `hp])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.haveIdDecl', expected 'Lean.Parser.Term.haveIdDecl.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`i] [])] "=>" (Term.proj (Term.app `hf [`i]) "." `ae_eq_mk)))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.fun.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.basicFun', expected 'Lean.Parser.Term.basicFun.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.proj (Term.app `hf [`i]) "." `ae_eq_mk)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `hf [`i])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, tactic))
  (Tactic.rwSeq
   ...
   (Tactic.rwRuleSeq
    "["
    [(Tactic.rwRule [] `AeSeqSet) "," (Tactic.rwRule [] `compl_compl) "," (Tactic.rwRule [] `measure_to_measurable)]
    "]")
   [])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwSeq', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.rwRule', expected 'sepBy.antiquot_scope'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 50, term))
  (Term.app `μ [(Order.BooleanAlgebra.«term_ᶜ» (Term.app `AeSeqSet [`hf `p]) "ᶜ")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Order.BooleanAlgebra.«term_ᶜ»', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Order.BooleanAlgebra.«term_ᶜ»', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Order.BooleanAlgebra.«term_ᶜ»', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Order.BooleanAlgebra.«term_ᶜ»', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Order.BooleanAlgebra.«term_ᶜ» (Term.app `AeSeqSet [`hf `p]) "ᶜ")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Order.BooleanAlgebra.«term_ᶜ»', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 999, term))
  (Term.app `AeSeqSet [`hf `p])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
theorem
  ...
  [ Encodable ι ] ( hf : ∀ i , AeMeasurable f i μ ) ( hp : ∀ᵐ x ∂ μ , p x fun n => f n x ) : μ AeSeqSet hf p ᶜ = 0
  :=
    by
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `ae_seq_eq_mk_ae [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `Encodable [`ι]) "]")
    (Term.explicitBinder
     "("
   ...
   (Term.typeSpec
    ...
    (MeasureTheory.MeasureTheory.Measure.MeasureSpaceDef.«term∀ᵐ_∂_,_»
     ...
     (Term.forall
      ...
      ","
      («term_=_»
       (Term.app `aeSeq [`hf `p `i `a])
       "="
       (Term.app (Term.proj (Term.app `hf [`i]) "." `mk) [(Term.app `f [`i]) `a]))))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
       ...
       (group
        (Tactic.exact
         ...
         (Term.app
          ...
          [(Term.app
            `le_transₓ
            [(Term.app `measure_mono [(Term.app `set.compl_subset_compl.mpr [`h_ss])])
             (Term.app `le_of_eqₓ [(Term.app `measure_compl_ae_seq_set_eq_zero [`hf `hp])])])
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `measure_compl_ae_seq_set_eq_zero [`hf `hp])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `le_of_eqₓ [(Term.paren "(" [(Term.app `measure_compl_ae_seq_set_eq_zero [`hf `hp]) []] ")")]) []]
 ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `set.compl_subset_compl.mpr [`h_ss])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `set.compl_subset_compl.mpr [`h_ss]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `measure_mono
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 "("
 [(Term.app `measure_mono [(Term.paren "(" [(Term.app `set.compl_subset_compl.mpr [`h_ss]) []] ")")]) []]
 ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `le_transₓ
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
theorem
  ae_seq_eq_mk_ae
  [ Encodable ι ] ( hf : ∀ i , AeMeasurable f i μ ) ( hp : ∀ᵐ x ∂ μ , p x fun n => f n x )
    : ∀ᵐ a : α ∂ μ , ∀ i : ι , aeSeq hf p i a = hf i . mk f i a
  :=
    by
      have h_ss : AeSeqSet hf p ⊆ { a : α | ∀ i , aeSeq hf p i a = hf i . mk f i a }
        exact fun x hx i => by simp only [ aeSeq , hx , if_true ]
        exact
          le_antisymmₓ
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `ae_seq_eq_fun_ae [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `Encodable [`ι]) "]")
    (Term.explicitBinder
     "("
   ...
   (Term.typeSpec
    ...
    (MeasureTheory.MeasureTheory.Measure.MeasureSpaceDef.«term∀ᵐ_∂_,_»
     ...
     (Term.forall
      ...
      [(Term.simpleBinder [`i] [(Term.typeSpec ":" `ι)])]
      ","
      («term_=_» (Term.app `aeSeq [`hf `p `i `a]) "=" (Term.app `f [`i `a]))))))
  (Command.declValSimple
   ":="
   (Term.byTactic
    "by"
          ...
          (Term.basicFun
           ...
           (Term.app
            ...
            [(Term.fun
              "fun"
              (Term.basicFun
               [(Term.simpleBinder [`hx `i] [])]
               "=>"
               (Term.app `ae_seq_eq_fun_of_mem_ae_seq_set [`hf `hx `i])))]))))
        [])
       (group
        (Tactic.exact
         "exact"
         (Term.app `measure_mono_null [`h_ss (Term.app `measure_compl_ae_seq_set_eq_zero [`hf `hp])]))
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `measure_mono_null [`h_ss (Term.app `measure_compl_ae_seq_set_eq_zero [`hf `hp])]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `measure_mono_null [`h_ss (Term.app `measure_compl_ae_seq_set_eq_zero [`hf `hp])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app
   ...
   [(Term.fun
     "fun"
     (Term.basicFun [(Term.simpleBinder [`hx `i] [])] "=>" (Term.app `ae_seq_eq_fun_of_mem_ae_seq_set [`hf `hx `i])))])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.namedArgument'
...
theorem
  ...
  :=
    by
      have h_ss : { a : α | ¬ ∀ i : ι , aeSeq hf p i a = f i a } ⊆ AeSeqSet hf p ᶜ
...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `ae_seq_n_eq_fun_n_ae [])
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `Encodable [`ι]) "]")
    (Term.explicitBinder
     "("
   ...
   (Term.typeSpec
    ...
    (MeasureTheory.MeasureTheory.Measure.MeasureSpaceDef.«term_=ᵐ[_]_»
     (Term.app `aeSeq [`hf `p `n])
     " =ᵐ["
     `μ
     "] "
     (Term.app `f [`n]))))
  (Command.declValSimple ":=" (Term.app (Term.proj `ae_all_iff "." `mp) [(Term.app `ae_seq_eq_fun_ae [`hf `hp]) `n]) [])
  []
  []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declaration', expected 'Lean.Parser.Command.declaration.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.declValSimple', expected 'Lean.Parser.Command.declValSimple.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app (Term.proj `ae_all_iff "." `mp) [(Term.app `ae_seq_eq_fun_ae [`hf `hp]) `n])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Term.app `ae_seq_eq_fun_ae [`hf `hp])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `ae_seq_eq_fun_ae [`hf `hp]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  (Term.proj `ae_all_iff "." `mp)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.proj', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  `ae_all_iff
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
theorem
  ...
  [ Encodable ι ] ( hf : ∀ i , AeMeasurable f i μ ) ( hp : ∀ᵐ x ∂ μ , p x fun n => f n x ) ( n : ι )
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.simpRw
         ...
         (Tactic.rwRuleSeq
          "["
          [(Tactic.rwRule [] `Filter.EventuallyEq) "," (Tactic.rwRule [] `ae_iff) "," (Tactic.rwRule [] `supr_apply)]
          "]")
         [])
        [])
       (group
       ...
       (group
        (Tactic.exact
         ...
         (Term.app
          `measure_mono_null
          [(Term.app `set.compl_subset_compl.mpr [`h_ss]) (Term.app `measure_compl_ae_seq_set_eq_zero [`hf `hp])]))
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact
   ...
   (Term.app
    ...
    [(Term.fun
      "fun"
      (Term.basicFun [(Term.simpleBinder [`i] [])] "=>" (Term.app `ae_seq_eq_fun_of_mem_ae_seq_set [`hf `hx `i])))]))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Tactic.exact', expected 'antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app
   `funext
...
theorem
  supr
  [ CompleteLattice β ] [ Encodable ι ] ( hf : ∀ i , AeMeasurable f i μ ) ( hp : ∀ᵐ x ∂ μ , p x fun n => f n x )
  ...
  :=
    by
      simp_rw [ Filter.EventuallyEq , ae_iff , supr_apply ]
        have
          h_ss
            : AeSeqSet hf p ⊆ { a : α | ⨆ i : ι , aeSeq hf p i a = ⨆ i : ι , f i a }
            :=
            by intro x hx congr exact funext fun i => ae_seq_eq_fun_of_mem_ae_seq_set hf hx i
