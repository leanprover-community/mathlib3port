 ...
 (Command.theorem
  ...
  (Command.declSig
   [(Term.instBinder "[" [] (Term.app `TopologicalSpace [`β]) "]")
    ...
    (Term.explicitBinder "(" [`hf] [":" (Term.app `fin_strongly_measurable [`f `μ])] [] ")")]
   (Term.typeSpec
    ":"
    («term∃_,_»
     "∃"
      ...
      («term_∧_»
       (Term.forall
        ...
        (Mathlib.ExtendedBinder.«term∀___,_»
         "∀"
         `x
         («binderTerm∈_» "∈" (Order.BooleanAlgebra.«term_ᶜ» `t "ᶜ"))
         ","
         (Term.forall "∀" [] "," («term_=_» (Term.app `f [`x]) "=" (numLit "0")))))
       "∧"
       (Term.app `sigma_finite [(Term.app `μ.restrict [`t])]))))))
      ...
      [(group
       ...
       (group
        (Tactic.have''
         ...
         [(Term.typeSpec
           ":"
           (Term.forall "∀" [(Term.simpleBinder [`n] [])] "," (Term.app `MeasurableSet [(Term.app `T [`n])])))])
        [])
       (group
        (Tactic.exact
         "exact"
                  ...
                  (Term.forall
                   ...
                   (Term.forall
                    ...
                    (Mathlib.ExtendedBinder.«term∀___,_»
                     ...
                     («binderTerm∈_» "∈" (Order.BooleanAlgebra.«term_ᶜ» `t "ᶜ"))
                     ","
                     (Term.forall "∀" [] "," («term_=_» (Term.app `fs [`n `x]) "=" (numLit "0")))))))]
                ":="
                (Term.byTactic
                 "by"
                 (Tactic.tacticSeq
                 ...
                 [(Term.anonymousCtor
                   ...
                   [(Term.fun
                     ...
                     (Term.basicFun
                      [(Term.simpleBinder [`n] [])]
                      "=>"
                      (Init.Core.«term_∪_» (Order.BooleanAlgebra.«term_ᶜ» `t "ᶜ") " ∪ " (Term.app `T [`n]))))
                    ","
                    (Term.fun "fun" (Term.basicFun [(Term.simpleBinder [`n] [])] "=>" `trivialₓ))
                    ","
               ...
               (Tactic.tacticSeq1Indented
                [(group
                  (Tactic.rwSeq
                   ...
                   (Tactic.rwRuleSeq
                    "["
                    [(Tactic.rwRule ["←"] (Term.app `Set.union_Union [(Order.BooleanAlgebra.«term_ᶜ» `t "ᶜ") `T]))]
                    "]")
                   [])
                  [])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `Set.union_Union [(Order.BooleanAlgebra.«term_ᶜ» `t "ᶜ") `T])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
  (Order.BooleanAlgebra.«term_ᶜ» `t "ᶜ")
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Order.BooleanAlgebra.«term_ᶜ» `t "ᶜ") []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `Set.union_Union
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.forall', expected 'Lean.Parser.Term.forall.antiquot'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  («term_=_» (Term.app `fs [`n `x]) "=" (numLit "0"))
...
theorem
  ...
  [ TopologicalSpace β ] [ T2Space β ] ( hf : fin_strongly_measurable f μ )
    : ∃ t , MeasurableSet t ∧ ∀ , ∀ x ∈ t ᶜ , ∀ , f x = 0 ∧ sigma_finite μ.restrict t
  :=
    by
      rcases hf with ⟨ fs , hT_lt_top , h_approx ⟩
        ...
        ·
          have
            ...
            exact tendsto_const_nhds
        ·
          refine' ⟨ ⟨ ⟨ fun n => t ᶜ ∪ T n , fun n => trivialₓ , fun n => _ , _ ⟩ ⟩ ⟩
            ·
              rw
                  [
            ...
            · rw [ ← Set.union_Union t ᶜ T ] exact Set.compl_union_self _
