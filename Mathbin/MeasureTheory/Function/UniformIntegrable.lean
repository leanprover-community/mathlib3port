...
/- ./././Mathport/Syntax/Translate/Tactic/Builtin.lean:65:38: in filter_upwards #[[], [], []]: ./././Mathport/Syntax/Translate/Basic.lean:348:22: unsupported: parse error -/
...
theorem unifIntegrableOf' (hp : 1 ≤ p) (hp' : p ≠ ∞) {f : ι → α → β} (hf : ∀ i, StronglyMeasurable (f i))
  ...
  calc
    snorm (indicator s (f i)) p μ ≤
      ...
      · refine' (Disjoint.infRight' _ _).infLeft' _
