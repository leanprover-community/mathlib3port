...
theorem cardinal_generate_measurable_rec_le (s : Set (Set α)) (i : ω₁) :
    (#generateMeasurableRec s i) ≤ max (#s) 2 ^ aleph_0.{u} :=
  by
...
#align measurable_space.cardinal_generate_measurable_le_continuum MeasurableSpace.cardinal_generate_measurable_le_continuum
