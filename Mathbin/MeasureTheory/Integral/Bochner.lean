...
theorem weighted_smul_null {s : Set α} (h_zero : μ s = 0) : (weightedSmul μ s : F →L[ℝ] F) = 0 :=
  by
  ext1 x
...
theorem weighted_smul_nonneg (s : Set α) (x : ℝ) (hx : 0 ≤ x) : 0 ≤ weightedSmul μ s x :=
  by
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     (Command.declModifiers
      [(Command.docComment "/--" "Positive part of a simple function. -/")]
      []
      []
      []
      []
     ...
     (Command.def
      "def"
      (Command.declId `posPart [])
      (Command.optDeclSig
       [(Term.explicitBinder
         "("
         [`f]
         [":" (MeasureTheory.MeasureTheory.Integral.Bochner.«term_→ₛ_» `α " →ₛ " `E)]
         []
         ")")]
       [(Term.typeSpec ":" (MeasureTheory.MeasureTheory.Integral.Bochner.«term_→ₛ_» `α " →ₛ " `E))])
      (Command.declValSimple
       ":="
       (Term.app
        (Term.proj `f "." `map)
        [(Term.fun "fun" (Term.basicFun [`b] [] "=>" (Term.app `max [`b (num "0")])))])
       [])
      []
      []
      []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, [anonymous]))
      (MeasureTheory.MeasureTheory.Integral.Bochner.«term_→ₛ_» `α " →ₛ " `E)
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'MeasureTheory.MeasureTheory.Integral.Bochner.«term_→ₛ_»', expected 'MeasureTheory.MeasureTheory.Integral.Bochner.term_→ₛ_._@.MeasureTheory.Integral.Bochner._hyg.12'
...
/-- Positive part of a simple function. -/
  def posPart ( f : α →ₛ E ) : α →ₛ E := f . map fun b => max b 0
#align measure_theory.simple_func.pos_part MeasureTheory.SimpleFunc.posPart

/- failed to parenthesize: parenthesize: uncaught backtrack exception
[PrettyPrinter.parenthesize.input] (Command.declaration
     (Command.declModifiers
      [(Command.docComment "/--" "Negative part of a simple function. -/")]
      []
      []
      []
      []
     ...
     (Command.def
      "def"
      (Command.declId `negPart [])
      (Command.optDeclSig
       [(Term.instBinder "[" [] (Term.app `Neg [`E]) "]")
        (Term.explicitBinder
         "("
         [`f]
         [":" (MeasureTheory.MeasureTheory.Integral.Bochner.«term_→ₛ_» `α " →ₛ " `E)]
         ...
         ")")]
       [(Term.typeSpec ":" (MeasureTheory.MeasureTheory.Integral.Bochner.«term_→ₛ_» `α " →ₛ " `E))])
      (Command.declValSimple ":=" (Term.app `posPart [(«term-_» "-" `f)]) [])
      []
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.def', expected 'Lean.Parser.Command.abbrev'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `posPart [(«term-_» "-" `f)])
...
/-- Negative part of a simple function. -/
  def negPart [ Neg E ] ( f : α →ₛ E ) : α →ₛ E := posPart - f
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `pos_part_map_norm [])
      (Command.declSig
       [(Term.explicitBinder
         "("
         [`f]
         [":"
          (MeasureTheory.MeasureTheory.Integral.Bochner.«term_→ₛ_»
           `α
           " →ₛ "
       ...
       (Term.typeSpec
        ":"
        («term_=_»
         (Term.app (Term.proj (Term.app `posPart [`f]) "." `map) [`norm])
         "="
         (Term.app `posPart [`f]))))
      (Command.declValSimple
       ":="
         ...
         (Tactic.tacticSeq1Indented
          [(Std.Tactic.Ext.«tacticExt___:_» "ext" [] [])
           ...
           (Tactic.rwSeq
            ...
            (Tactic.rwRuleSeq
             "["
             [(Tactic.rwRule [] `map_apply)
              ","
              (Tactic.rwRule [] `Real.norm_eq_abs)
              ","
              (Tactic.rwRule [] `abs_of_nonneg)]
             "]")
            [])
           []
           (Tactic.exact "exact" (Term.app `le_max_right [(Term.hole "_") (Term.hole "_")]))])))
       [])
      []
      []))
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none,
     [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      (Term.proj (Term.app `posPart [`f]) "." `map)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      (Term.app `posPart [`f])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" (Term.app `posPart [`f]) ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none,
     [anonymous]) <=? (some 1022, term)
...
theorem
  pos_part_map_norm
  ( f : α →ₛ ℝ ) : posPart f . map norm = posPart f
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `neg_part_map_norm [])
      (Command.declSig
       [(Term.explicitBinder
         "("
         [`f]
       ...
       (Term.typeSpec
        ":"
        («term_=_»
         (Term.app (Term.proj (Term.app `negPart [`f]) "." `map) [`norm])
         "="
         (Term.app `negPart [`f]))))
      (Command.declValSimple
       ":="
        ...
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `neg_part)] "]") [])
           []
           (Tactic.exact "exact" (Term.app `pos_part_map_norm [(Term.hole "_")]))])))
       [])
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.abbrev'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Tactic.exact "exact" (Term.app `pos_part_map_norm [(Term.hole "_")]))
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `pos_part_map_norm [(Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.hole "_")
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none,
     [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      (Term.proj (Term.app `negPart [`f]) "." `map)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      (Term.app `negPart [`f])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none,
     [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" (Term.app `negPart [`f]) ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none,
     [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 51 >? 1022, (some 1023, term) <=? (some 50, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 50, (some 51,
...
theorem
  neg_part_map_norm
  ( f : α →ₛ ℝ ) : negPart f . map norm = negPart f
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `pos_part_sub_neg_part [])
      (Command.declSig
       [(Term.explicitBinder
         "("
         [`f]
       ...
       (Term.typeSpec
        ":"
        («term_=_» («term_-_» (Term.proj `f "." `posPart) "-" (Term.proj `f "." `negPart)) "=" `f)))
      (Command.declValSimple
       ":="
       (Term.byTactic
        "by"
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(Tactic.simp
            ...
            []
            ["only"]
            ["[" [(Tactic.simpLemma [] [] `pos_part) "," (Tactic.simpLemma [] [] `neg_part)] "]"]
            [])
           []
           (Std.Tactic.Ext.«tacticExt___:_»
            ...
            [])
           []
           (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `coe_sub)] "]") [])
           []
           (Tactic.exact "exact" (Term.app `max_zero_sub_eq_self [(Term.app `f [`a])]))])))
       [])
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.abbrev'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Tactic.exact "exact" (Term.app `max_zero_sub_eq_self [(Term.app `f [`a])]))
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `max_zero_sub_eq_self [(Term.app `f [`a])])
...
[PrettyPrinter.parenthesize] ...precedences are 51 >? 1024, (none,
     [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 50, term))
      («term_-_» (Term.proj `f "." `posPart) "-" (Term.proj `f "." `negPart))
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.proj `f "." `negPart)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      `f
...
theorem
  ...
  ( f : α →ₛ ℝ ) : f . posPart - f . negPart = f
  := by simp only [ pos_part , neg_part ] ext a rw [ coe_sub ] exact max_zero_sub_eq_self f a
#align
      ...
      (Command.optDeclSig
       [(Term.implicitBinder "{" [`m] [":" (Term.app `MeasurableSpace [`α])] "}")
        ...
        (Term.explicitBinder
         "("
         [`f]
         [":" (MeasureTheory.MeasureTheory.Integral.Bochner.«term_→ₛ_» `α " →ₛ " `F)]
         []
         ")")]
       [(Term.typeSpec ":" `F)])
      (Command.declValSimple
       ":="
       (Term.app (Term.proj `f "." `setToSimpleFunc) [(Term.app `weightedSmul [`μ])])
       [])
      []
      []
      []))
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023,
     term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" (Term.app `weightedSmul [`μ]) ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
...
/--
  ...
  def
    integral
    { m : MeasurableSpace α } ( μ : Measure α ) ( f : α →ₛ F ) : F
     ...
     (Command.theorem
      ...
      (Command.declSig
       ...
       (Term.typeSpec
        ":"
        («term_=_»
         (Term.app (Term.proj `f "." `integral) [`μ])
         "="
         (Term.app (Term.proj `f "." `setToSimpleFunc) [(Term.app `weightedSmul [`μ])]))))
...
theorem
  integral_def
  { m : MeasurableSpace α } ( μ : Measure α ) ( f : α →ₛ F )
        ...
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(Tactic.simp
            ...
            []
            ["["
             [(Tactic.simpLemma [] [] `integral)
              ","
              (Tactic.simpLemma [] [] `set_to_simple_func)
              ","
              (Tactic.simpLemma [] [] `weighted_smul_apply)]
             "]"]
            [])])))
       [])
      []
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `integral_eq_sum_filter [])
      (Command.declSig
       [(Term.instBinder
         "["
         []
         (Term.app
          ...
          [(Term.fun
            "fun"
            (Term.basicFun [`x] [(Term.typeSpec ":" `F)] "=>" («term_≠_» `x "≠" (num "0"))))])
         "]")
        (Term.implicitBinder "{" [`m] [":" (Term.app `MeasurableSpace [`α])] "}")
        (Term.explicitBinder
         "("
        ...
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(Tactic.rwSeq
            ...
            (Tactic.rwRuleSeq
             "["
             [(Tactic.rwRule [] `integral_def)
              ","
              (Tactic.rwRule [] `set_to_simple_func_eq_sum_filter)]
             "]")
            [])
           []
           (Mathlib.Tactic.tacticSimp_rw__
            "simp_rw"
            (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `weighted_smul_apply)] "]")
            [])
           []
           (Tactic.congr "congr" [])])))
       [])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Tactic.rwSeq
       ...
       (Tactic.rwRuleSeq
        "["
        [(Tactic.rwRule [] `integral_def) "," (Tactic.rwRule [] `set_to_simple_func_eq_sum_filter)]
        "]")
       [])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
...
theorem
  ...
  [ DecidablePred fun x : F => x ≠ 0 ] { m : MeasurableSpace α } ( f : α →ₛ F ) ( μ : Measure α )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `integral_eq_sum_of_subset [])
      (Command.declSig
       [(Term.instBinder
         "["
         []
        ...
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(Tactic.rwSeq
            ...
            (Tactic.rwRuleSeq
             "["
             [(Tactic.rwRule [] `simple_func.integral_eq_sum_filter)
              ","
              (Tactic.rwRule [] (Term.app `Finset.sum_subset [`hs]))]
             "]")
            [])
           []
           (Std.Tactic.rintro
           ...
           (Std.Tactic.seq_focus
            ...
            "<;>"
            "["
            [(Tactic.skip "skip") "," (Tactic.simp "simp" [] [] [] [] [])]
            "]")
           []
           (Tactic.rwSeq
            "rw"
            []
            (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `simple_func.mem_range)] "]")
            [(Tactic.location "at" (Tactic.locationHyp [`hx] []))])
           ";"
           (Tactic.«tactic_<;>_»
            (Tactic.rwSeq
             "rw"
             []
             (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `preimage_eq_empty)] "]")
             [])
            "<;>"
            (Tactic.simp
             "simp"
             ...
             []
             ["["
              [(Tactic.simpLemma [] [] `Set.disjoint_singleton_left)
               ","
               (Tactic.simpLemma [] [] `hx)]
              "]"]
             []))])))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Tactic.«tactic_<;>_»
       (Tactic.rwSeq "rw" [] (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `preimage_eq_empty)] "]") [])
       "<;>"
       (Tactic.simp
        "simp"
        []
        ...
        []
        ["["
         [(Tactic.simpLemma [] [] `Set.disjoint_singleton_left) "," (Tactic.simpLemma [] [] `hx)]
         "]"]
        []))
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Tactic.simp
         ...
         (Std.Tactic.RCases.rcasesPatLo
          (Std.Tactic.RCases.rcasesPatMed
           [(Std.Tactic.RCases.rcasesPat.paren
             ...
             (Std.Tactic.RCases.rcasesPatLo
              (Std.Tactic.RCases.rcasesPatMed
               [(Std.Tactic.RCases.rcasesPat.one `hx) "|" (Std.Tactic.RCases.rcasesPat.one `rfl)])
              [])
             ")")])
          [])])
       "<;>"
...
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `simple_func.integral_eq_sum_filter
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none,
     [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 0, tactic) <=? (none, [anonymous])
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `integral_piecewise_zero [])
      (Command.declSig
       [(Term.implicitBinder "{" [`m] [":" (Term.app `MeasurableSpace [`α])] "}")
        (Term.explicitBinder
         "("
       ...
       (Term.typeSpec
        ":"
        («term_=_»
         (Term.app (Term.proj (Term.app `piecewise [`s `hs `f (num "0")]) "." `integral) [`μ])
         "="
         (Term.app (Term.proj `f "." `integral) [(Term.app (Term.proj `μ "." `restrict) [`s])]))))
      (Command.declValSimple
       ":="
       (Term.byTactic
        "by"
            ...
            (Tactic.tacticSeq
             (Tactic.tacticSeq1Indented
              [(Tactic.refine'
                "refine'"
                (Term.app
                 (Term.proj (Term.app `integral_eq_sum_of_subset [(Term.hole "_")]) "." `trans)
                 [(Term.app
                   (Term.proj
                    (Term.app
                    ...
                    `trans)
                   [(Term.proj
                     (Term.app `integral_eq_sum_filter [(Term.hole "_") (Term.hole "_")])
                     "."
                     `symm)])]))
               []
               (tactic__
                ...
                [(Tactic.intro "intro" [`y `hy])
                 ...
                 (Tactic.simp
                  ...
                  ["["
                   [(Tactic.simpLemma [] [] `mem_filter)
                    ...
                    ","
                    (Tactic.simpLemma [] [] `mem_range_indicator)]
                   "]"]
                          ...
                          [(Std.Tactic.RCases.rcasesPat.tuple
                           ...
                           (Std.Tactic.RCases.rcasesPat.tuple
                            ...
                            [(Std.Tactic.RCases.rcasesPatLo
                             ...
                             (Std.Tactic.RCases.rcasesPatLo
                              (Std.Tactic.RCases.rcasesPatMed
                               [(Std.Tactic.RCases.rcasesPat.one `hxs)])
                              [])
                             ","
                             (Std.Tactic.RCases.rcasesPatLo
                              (Std.Tactic.RCases.rcasesPatMed
                 ...
                 (Std.Tactic.exacts
                  "exacts"
                  "["
                  [(Term.proj (Term.app `h₀ [`rfl]) "." `elim)
                   ","
                   (Term.anonymousCtor
                    "⟨"
                    [(Term.app `Set.mem_range_self [(Term.hole "_")]) "," `h₀]
                    "⟩")]
                  "]")])
               []
               (tactic__
                ...
                [(Tactic.dsimp "dsimp" [] [] [] [] [])
                 ...
                 (Tactic.rwSeq
                  ...
                  (Tactic.rwRuleSeq
                   "["
                   [(Tactic.rwRule [] `Set.piecewise_eq_indicator)
                    ","
                    (Tactic.rwRule [] `indicator_preimage_of_not_mem)
                    ","
                    (Tactic.rwRule
                     []
                     (Term.app
                      `measure.restrict_apply
                      [(Term.app `f.measurable_set_preimage [(Term.hole "_")])]))]
                   "]")
                  [])
                 []
                 (Tactic.exact
                  ...
                  (Term.fun
                   ...
                   (Term.basicFun
                    ...
                    (Term.app
                     (Term.proj
                      (Term.app (Term.proj `mem_filter "." (fieldIdx "1")) [`hy])
                      "."
                      (fieldIdx "2"))
                     [(Term.app `Eq.symm [`h₀])]))))])])))])))
       [])
      ...
      (Tactic.exact
       ...
       (Term.fun
        ...
        (Term.basicFun
         ...
         "=>"
         (Term.app
          (Term.proj (Term.app (Term.proj `mem_filter "." (fieldIdx "1")) [`hy]) "." (fieldIdx "2"))
          [(Term.app `Eq.symm [`h₀])]))))
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.fun
       "fun"
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023,
     term) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" (Term.app `Eq.symm [`h₀]) ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      (Term.proj (Term.app (Term.proj `mem_filter "." (fieldIdx "1")) [`hy]) "." (fieldIdx "2"))
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      (Term.app (Term.proj `mem_filter "." (fieldIdx "1")) [`hy])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Tactic.rwSeq
       ...
       [])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `measure.restrict_apply [(Term.app `f.measurable_set_preimage [(Term.hole "_")])])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `f.measurable_set_preimage [(Term.hole "_")])
      ...
      (tactic__
       ...
       [(Tactic.intro "intro" [`y `hy])
        ...
        (Std.Tactic.exacts
         ...
         [(Term.proj (Term.app `h₀ [`rfl]) "." `elim)
          ","
          (Term.anonymousCtor "⟨" [(Term.app `Set.mem_range_self [(Term.hole "_")]) "," `h₀] "⟩")]
         "]")])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Std.Tactic.exacts
       "exacts"
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app
       (Term.proj
        ...
        "."
        `trans)
       [(Term.proj (Term.app `integral_eq_sum_filter [(Term.hole "_") (Term.hole "_")]) "." `symm)])
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
     ...
     (Term.app
      (Term.proj
       ...
       `trans)
      [(Term.proj
        (Term.paren "(" (Term.app `integral_eq_sum_filter [(Term.hole "_") (Term.hole "_")]) ")")
        "."
        `symm)])
     ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      (Term.proj (Term.app `integral_eq_sum_of_subset [(Term.hole "_")]) "." `trans)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      (Term.app `integral_eq_sum_of_subset [(Term.hole "_")])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.hole', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.hole "_")
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none,
     [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      (Term.proj (Term.app `piecewise [`s `hs `f (num "0")]) "." `integral)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
     ...
     (Command.theorem
      ...
      (Command.declSig
       [(Term.explicitBinder
         ...
         []
         ")")
        (Term.explicitBinder "(" [`g] [":" (Term.arrow `E "→" `F)] [] ")")
       ...
       (Term.typeSpec
        ":"
        («term_=_»
         (Term.app (Term.proj (Term.app (Term.proj `f "." `map) [`g]) "." `integral) [`μ])
         "="
         (BigOperators.Algebra.BigOperators.Basic.finset.sum
          "∑"
          (Std.ExtendedBinder.extBinders (Std.ExtendedBinder.extBinder (Lean.binderIdent `x) []))
      ...
      (Command.declValSimple
       ":="
       (Term.app `map_set_to_simple_func [(Term.hole "_") `weighted_smul_union `hf `hg])
       [])
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.abbrev'
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none,
     [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      (Term.proj (Term.app (Term.proj `f "." `map) [`g]) "." `integral)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
...
/--
  ...
  theorem
    map_integral
    ( f : α →ₛ E ) ( g : E → F ) ( hf : Integrable f μ ) ( hg : g 0 = 0 )
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `integral_eq_lintegral' [])
      (Command.declSig
       [(Term.implicitBinder
         "{"
         [`f]
        ...
        (Term.implicitBinder
         "{"
         [`g]
         [":" (Term.arrow `E "→" (Ennreal.Data.Real.Ennreal.ennreal "ℝ≥0∞"))]
         "}")
        (Term.explicitBinder "(" [`hf] [":" (Term.app `Integrable [`f `μ])] [] ")")
        (Term.explicitBinder
         "("
        ...
        (Term.explicitBinder
         ...
         [":"
          (Term.forall
           ...
           []
           ","
           («term_≠_» (Term.app `g [`b]) "≠" (Ennreal.Data.Real.Ennreal.ennreal.top "∞")))]
         []
         ")")]
       (Term.typeSpec
        ":"
        («term_=_»
         (Term.app
          (Term.proj
           (Term.app (Term.proj `f "." `map) [(«term_∘_» `Ennreal.toReal "∘" `g)])
           "."
           `integral)
          [`μ])
         "="
         ...
         (Tactic.tacticSeq1Indented
          [(Tactic.tacticHave_
            ...
            (Term.haveDecl
             (Term.haveIdDecl
              [`hf' []]
              [(Term.typeSpec ":" (Term.app `f.fin_meas_supp [`μ]))]
              ":="
              (Term.app (Term.proj `integrable_iff_fin_meas_supp "." (fieldIdx "1")) [`hf]))))
           []
           (Tactic.simp
            "simp"
            []
            ...
            ["only"]
            ["["
             [(Tactic.simpLemma [] [(patternIgnore (token.«← » "←"))] (Term.app `map_apply [`g `f]))
              ","
              (Tactic.simpLemma [] [] `lintegral_eq_lintegral)]
             "]"]
            [])
           []
           (Tactic.rwSeq
            ...
            (Tactic.rwRuleSeq
             "["
             [(Tactic.rwRule [] (Term.app `map_integral [`f (Term.hole "_") `hf]))
              ","
           ...
           (tactic__
            ...
            [(Tactic.refine'
              ...
              (Term.app
               `Finset.sum_congr
               [`rfl (Term.fun "fun" (Term.basicFun [`b `hb] [] "=>" (Term.hole "_")))]))
             []
             (Tactic.rwSeq
              "rw"
              []
           ...
           (tactic__
            ...
            [(Tactic.intro "intro" [`a `ha])
             []
             (Classical.«tacticBy_cases_:_» "by_cases" [`a0 ":"] («term_=_» `a "=" (num "0")))
             []
             (tactic__
              (cdotTk (patternIgnore (token.«· » "·")))
              [(Tactic.rwSeq
                ...
                [])
               []
               (Tactic.exact "exact" `WithTop.zero_ne_top)])
             []
             (tactic__
              (cdotTk (patternIgnore (token.«· » "·")))
              [(Tactic.apply
                ...
                (Term.app
                 `mul_ne_top
                 [(Term.app `ht [`a])
                  (Term.proj (Term.app `hf'.meas_preimage_singleton_ne_zero [`a0]) "." `Ne)]))])])
           []
           (tactic__
            (cdotTk (patternIgnore (token.«· » "·")))
            [(Tactic.simp "simp" [] [] [] ["[" [(Tactic.simpLemma [] [] `hg0)] "]"] [])])])))
       [])
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.abbrev'
       ...
       [(Tactic.intro "intro" [`a `ha])
        ...
        (tactic__
         ...
         [(Tactic.rwSeq
           ...
           (Tactic.rwRuleSeq
            "["
            [(Tactic.rwRule [] `a0) "," (Tactic.rwRule [] `hg0) "," (Tactic.rwRule [] `zero_mul)]
            "]")
           [])
          []
          (Tactic.exact "exact" `WithTop.zero_ne_top)])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.proj (Term.app `hf'.meas_preimage_singleton_ne_zero [`a0]) "." `Ne)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      (Term.app `hf'.meas_preimage_singleton_ne_zero [`a0])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `a0
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023,
     term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" (Term.app `ht [`a]) ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      `mul_ne_top
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none,
     [anonymous]) <=? (some 1022, term)
...
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none,
     [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `map_integral [`f (Term.hole "_") `hf])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `hf
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none,
     [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      (Term.proj `integrable_iff_fin_meas_supp "." (fieldIdx "1"))
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" («term_∘_» `Ennreal.toReal "∘" `g) ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      (Term.proj `f "." `map)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      `f
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
     "("
     (Term.app (Term.proj `f "." `map) [(Term.paren "(" («term_∘_» `Ennreal.toReal "∘" `g) ")")])
     ")")
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none,
     [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 51 >? 1022, (some 1023, term) <=? (some 50, term)
...
/--
  ...
  theorem
    ...
    { f : α →ₛ E } { g : E → ℝ≥0∞ } ( hf : Integrable f μ ) ( hg0 : g 0 = 0 ) ( ht : ∀ b , g b ≠ ∞ )
    ...
    :=
      by
        have hf' : f.fin_meas_supp μ := integrable_iff_fin_meas_supp . 1 hf
          ...
          · refine' Finset.sum_congr rfl fun b hb => _ rw [ smul_eq_mul , to_real_mul , mul_comm ]
          ·
            intro a ha
              by_cases a0 : a = 0
      ...
      (Command.declSig
       ...
       (Term.typeSpec
        ...
        («term_=_»
         (Term.app (Term.proj `f "." `integral) [`μ])
         "="
         (Term.app (Term.proj `g "." `integral) [`μ]))))
      (Command.declValSimple
       ":="
       (Term.app
        `set_to_simple_func_congr
        [(Term.app `weightedSmul [`μ])
         (Term.fun "fun" (Term.basicFun [`s `hs] [] "=>" `weighted_smul_null))
         `weighted_smul_union
         `hf
         `h])
       [])
...
theorem
  integral_congr
  { f g : α →ₛ E } ( hf : Integrable f μ ) ( h : f =ᵐ[ μ ] g ) : f . integral μ = g . integral μ
        ...
        («term_=_»
         ...
         (Term.app
          ...
          [(MeasureTheory.MeasureTheory.Integral.Lebesgue.«term∫⁻_,_∂_»
            ...
            (Std.ExtendedBinder.extBinders (Std.ExtendedBinder.extBinder (Lean.binderIdent `a) []))
            ", "
            (Term.app `Ennreal.ofReal [(Term.app `f [`a])])
            " ∂"
            `μ)]))))
      (Command.declValSimple
       ":="
             ...
             (Term.haveIdDecl
              ...
              [(Term.typeSpec
                ...
                (MeasureTheory.MeasureTheory.Measure.MeasureSpaceDef.«term_=ᵐ[_]_»
                 ...
                 `μ
                 "] "
                 (Term.app `f.map [(«term_∘_» `Ennreal.toReal "∘" `Ennreal.ofReal)])))]
              ":="
              (Term.app
               `h_pos.mono
               [(Term.fun
                 ...
                 (Term.basicFun
                  ...
                  []
                  "=>"
                  (Term.proj (Term.app `Ennreal.to_real_of_real [`h]) "." `symm)))]))))
           []
           (Tactic.rwSeq
            "rw"
            []
            (Tactic.rwRuleSeq
             ...
             [(Tactic.rwRule
               [(patternIgnore (token.«← » "←"))]
               (Term.app `integral_eq_lintegral' [`hf]))]
             "]")
            [])
           []
           (Std.Tactic.exacts
            "exacts"
            "["
            [(Term.app `integral_congr [`hf `this])
             ","
             `Ennreal.of_real_zero
             ","
             (Term.fun "fun" (Term.basicFun [`b] [] "=>" `Ennreal.of_real_ne_top))]
            "]")])))
       [])
      []
      []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.proj (Term.app `Ennreal.to_real_of_real [`h]) "." `symm)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      (Term.app `Ennreal.to_real_of_real [`h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `h
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind '«term_∘_»', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      («term_∘_» `Ennreal.toReal "∘" `Ennreal.ofReal)
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `Ennreal.ofReal
[PrettyPrinter.parenthesize] ...precedences are 90 >? 1024, (none,
     [anonymous]) <=? (none, [anonymous])
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
     ...
     (MeasureTheory.MeasureTheory.Integral.Lebesgue.«term∫⁻_,_∂_»
      ...
      (Std.ExtendedBinder.extBinders (Std.ExtendedBinder.extBinder (Lean.binderIdent `a) []))
      ", "
      (Term.app `Ennreal.ofReal [(Term.paren "(" (Term.app `f [`a]) ")")])
      " ∂"
      `μ)
     ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
...
/--
  ...
  theorem
    integral_eq_lintegral
    { f : α →ₛ ℝ } ( hf : Integrable f μ ) ( h_pos : 0 ≤ᵐ[ μ ] f )
      : f . integral μ = Ennreal.toReal ∫⁻ a , Ennreal.ofReal f a ∂ μ
    :=
      by
        have
            : f =ᵐ[ μ ] f.map Ennreal.toReal ∘ Ennreal.ofReal
              :=
     ...
     (Command.theorem
      ...
      (Command.declSig
       ...
       (Term.typeSpec
        ":"
        («term_=_»
         (Term.app `integral [`μ («term_+_» `f "+" `g)])
         "="
         («term_+_» (Term.app `integral [`μ `f]) "+" (Term.app `integral [`μ `g])))))
      (Command.declValSimple
       ":="
       (Term.app `set_to_simple_func_add [(Term.hole "_") `weighted_smul_union `hf `hg])
       [])
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.abbrev'
     ...
     (Command.theorem
      ...
      (Command.declSig
       ...
       (Term.typeSpec
        ":"
        («term_=_»
         (Term.app `integral [`μ («term-_» "-" `f)])
         "="
         («term-_» "-" (Term.app `integral [`μ `f])))))
      (Command.declValSimple
       ":="
       (Term.app `set_to_simple_func_neg [(Term.hole "_") `weighted_smul_union `hf])
       [])
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.abbrev'
...
theorem
  integral_neg
  { f : α →ₛ E } ( hf : Integrable f μ ) : integral μ - f = - integral μ f
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      ...
      (Command.declValSimple
       ":="
       (Term.app `set_to_simple_func_sub [(Term.hole "_") `weighted_smul_union `hf `hg])
       [])
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.abbrev'
     ...
     (Command.theorem
      ...
      (Command.declSig
       ...
       (Term.typeSpec
        ":"
        («term_=_»
         (Term.app `integral [`μ (Algebra.Group.Defs.«term_•_» `c " • " `f)])
         "="
         (Algebra.Group.Defs.«term_•_» `c " • " (Term.app `integral [`μ `f])))))
      (Command.declValSimple
       ":="
       (Term.app
        `set_to_simple_func_smul
        [(Term.hole "_") `weighted_smul_union `weighted_smul_smul `c `hf])
       [])
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.abbrev'
...
theorem
  integral_smul
  ( c : 𝕜 ) { f : α →ₛ E } ( hf : Integrable f μ ) : integral μ c • f = c • integral μ f
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `norm_set_to_simple_func_le_integral_norm [])
      (Command.declSig
       [(Term.explicitBinder
         "("
         [`T]
       ...
       (Term.typeSpec
        ...
        («term_≤_»
         ...
         («term_*_»
          `C
          "*"
          (Term.app (Term.proj (Term.app (Term.proj `f "." `map) [`norm]) "." `integral) [`μ])))))
      (Command.declValSimple
       ":="
       (calc
        "calc"
        (calcStep
         ...
         ":="
         (Term.app `norm_set_to_simple_func_le_sum_mul_norm_of_integrable [`T `hT_norm `f `hf]))
        [(calcStep
          («term_=_»
           (Term.hole "_")
           "="
           ...
           (Tactic.tacticSeq
            (Tactic.tacticSeq1Indented
             [(Tactic.rwSeq
               ...
               (Tactic.rwRuleSeq
                "["
                [(Tactic.rwRule [] (Term.app `map_integral [`f `norm `hf `norm_zero]))]
                "]")
               [])
              []
              (Mathlib.Tactic.tacticSimp_rw__
               "simp_rw"
               (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `smul_eq_mul)] "]")
               [])]))))])
       [])
      []
      []))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Tactic.rwSeq
       ...
       [])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `map_integral [`f `norm `hf `norm_zero])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `norm_zero
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none,
     [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      (Term.proj (Term.app (Term.proj `f "." `map) [`norm]) "." `integral)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      (Term.app (Term.proj `f "." `map) [`norm])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `norm
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
theorem
  norm_set_to_simple_func_le_integral_norm
  ( T : Set α → E →L[ ℝ ] F )
      { C : ℝ }
  ...
  :=
    calc
      ...
      _ = C * f . map norm . integral μ
        :=
        by rw [ map_integral f norm hf norm_zero ] simp_rw [ smul_eq_mul ]
#align
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `norm_integral_le_integral_norm [])
      (Command.declSig
       [(Term.explicitBinder
         "("
         [`f]
             ...
             (Term.proj
              (Term.app
               ...
               [(Term.hole "_")
                (Term.fun
                 "fun"
                 (Term.basicFun [`s (Term.hole "_") (Term.hole "_")] [] "=>" (Term.hole "_")))
                `hf])
              "."
              `trans)
             [(Term.proj (Term.app `one_mul [(Term.hole "_")]) "." `le)]))
           []
           (Tactic.exact
            "exact"
            (Term.app
             (Term.proj (Term.app `norm_weighted_smul_le [`s]) "." `trans)
             [(Term.proj (Term.proj (Term.app `one_mul [(Term.hole "_")]) "." `symm) "." `le)]))])))
       [])
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.abbrev'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      (Term.proj (Term.app `norm_weighted_smul_le [`s]) "." `trans)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      (Term.app `norm_weighted_smul_le [`s])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `s
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.fun', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      (Term.fun "fun" (Term.basicFun [`s (Term.hole "_") (Term.hole "_")] [] "=>" (Term.hole "_")))
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.hole "_")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none,
     [anonymous]) <=? (none, [anonymous])
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, [anonymous]))
      («term_≤_»
       (Analysis.Normed.Group.Basic.«term‖_‖» "‖" (Term.app (Term.proj `f "." `integral) [`μ]) "‖")
       "≤"
       (Term.app (Term.proj (Term.app (Term.proj `f "." `map) [`norm]) "." `integral) [`μ]))
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app (Term.proj (Term.app (Term.proj `f "." `map) [`norm]) "." `integral) [`μ])
...
theorem
  ...
  ( f : α →ₛ E ) ( hf : Integrable f μ ) : ‖ f . integral μ ‖ ≤ f . map norm . integral μ
  :=
    by
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `integral_add_measure [])
      (Command.declSig
       [(Term.implicitBinder "{" [`ν] [] "}")
        ...
        (Term.explicitBinder
         "("
         [`hf]
         [":" (Term.app `Integrable [`f («term_+_» `μ "+" `ν)])]
         []
         ")")]
       (Term.typeSpec
        ":"
        («term_=_»
         (Term.app (Term.proj `f "." `integral) [(«term_+_» `μ "+" `ν)])
         "="
         («term_+_»
          (Term.app (Term.proj `f "." `integral) [`μ])
          "+"
          (Term.app (Term.proj `f "." `integral) [`ν])))))
      (Command.declValSimple
       ":="
       (Term.byTactic
        "by"
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(Mathlib.Tactic.tacticSimp_rw__
            "simp_rw"
            (Tactic.rwRuleSeq "[" [(Tactic.rwRule [] `integral_def)] "]")
            [])
           []
           (Tactic.refine'
            "refine'"
            (Term.app
             ...
             [(Term.app `weighted_smul [`μ])
              (Term.app `weighted_smul [`ν])
              (Term.app `weighted_smul [(«term_+_» `μ "+" `ν)])
              (Term.fun "fun" (Term.basicFun [`s `hs `hμνs] [] "=>" (Term.hole "_")))
              `hf]))
           []
           (Tactic.rwSeq
            "rw"
            ...
            (Tactic.rwRuleSeq
             ...
             "]")
            [(Tactic.location "at" (Tactic.locationHyp [`hμνs] []))])
           []
           (Tactic.rwSeq
            "rw"
            []
            (Tactic.rwRuleSeq
             ...
             [(Tactic.rwRule
               []
               (Term.app
                `weighted_smul_add_measure
                [(Term.hole "_")
                 (Term.hole "_")
                 (Term.proj `hμνs "." (fieldIdx "1"))
                 (Term.proj `hμνs "." (fieldIdx "2"))]))]
             "]")
            [])])))
       [])
      []
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
     "("
     (Term.app `weighted_smul [(Term.paren "(" («term_+_» `μ "+" `ν) ")")])
     ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023,
     term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" (Term.app `weighted_smul [`ν]) ")")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      (Term.app `weighted_smul [`μ])
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023,
     term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" (Term.app `weighted_smul [`μ]) ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      `set_to_simple_func_add_left'
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none,
     [anonymous]) <=? (some 1022, term)
  ...
  :=
    by
      simp_rw [ integral_def ]
        refine'
          set_to_simple_func_add_left'
            weighted_smul μ weighted_smul ν weighted_smul μ + ν fun s hs hμνs => _ hf
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `norm_Integral_le_one [])
      (Command.declSig
       []
       (Term.typeSpec
        ":"
        («term_≤_»
         (Analysis.Normed.Group.Basic.«term‖_‖»
          "‖"
          (MeasureTheory.L1Cat.SimpleFunc.MeasureTheory.Integral.Bochner.simple_func.integral_clm
           "Integral")
          "‖")
         "≤"
         (num "1"))))
      (Command.declValSimple
       ":="
       (Term.app `LinearMap.mk_continuous_norm_le [(Term.hole "_") `zero_le_one (Term.hole "_")])
       [])
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.abbrev'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (MeasureTheory.L1Cat.SimpleFunc.MeasureTheory.Integral.Bochner.simple_func.integral_clm
       "Integral")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'MeasureTheory.L1Cat.SimpleFunc.MeasureTheory.Integral.Bochner.simple_func.integral_clm', expected 'MeasureTheory.L1Cat.SimpleFunc.MeasureTheory.Integral.Bochner.simple_func.integral_clm._@.MeasureTheory.Integral.Bochner._hyg.569'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.opaque'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.instance'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.axiom'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.example'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.classInductive'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.structure'-/-- failed to format: format: uncaught backtrack exception
theorem norm_Integral_le_one : ‖ Integral ‖ ≤ 1 := LinearMap.mk_continuous_norm_le _ zero_le_one _
#align
      ...
      (Command.declSig
       ...
       (Term.typeSpec
        ...
        («term_≤_»
         (Analysis.Normed.Group.Basic.«term‖_‖»
          "‖"
          (MeasureTheory.L1Cat.MeasureTheory.Integral.Bochner.integral_clm "Integral")
          "‖")
         "≤"
         (num "1"))))
      (Command.declValSimple
       ...
       (Term.app
        `norm_set_to_L1_le
        [(Term.app `dominatedFinMeasAdditiveWeightedSmul [`μ]) `zero_le_one])
       [])
      []
      []))
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.abbrev'
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1024, term))
      (Term.app `dominatedFinMeasAdditiveWeightedSmul [`μ])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `μ
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none,
     [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      `dominatedFinMeasAdditiveWeightedSmul
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none,
     [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1022, (some 1023,
     term) <=? (some 1024, term)
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (MeasureTheory.L1Cat.MeasureTheory.Integral.Bochner.integral_clm "Integral")
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'MeasureTheory.L1Cat.MeasureTheory.Integral.Bochner.integral_clm', expected 'MeasureTheory.L1Cat.MeasureTheory.Integral.Bochner.integral_clm._@.MeasureTheory.Integral.Bochner._hyg.1329'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.opaque'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.instance'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.axiom'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Command.theorem', expected 'Lean.Parser.Command.example'
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `norm_integral_le [])
      (Command.declSig
       [(Term.explicitBinder
         "("
         [`f]
       ...
       (Term.typeSpec
        ":"
        («term_≤_»
         (Analysis.Normed.Group.Basic.«term‖_‖» "‖" (Term.app `integral [`f]) "‖")
         "≤"
        ...
        [(calcStep
         ...
         (calcStep
          («term_≤_»
           (Term.hole "_")
           "≤"
           («term_*_» (num "1") "*" (Analysis.Normed.Group.Basic.«term‖_‖» "‖" `f "‖")))
          ":="
          («term_<|_»
           (Term.app `mul_le_mul_of_nonneg_right [`norm_Integral_le_one])
           "<|"
...
theorem of_real_integral_eq_lintegral_of_real {f : α → ℝ} (hfi : Integrable f μ)
    (f_nn : 0 ≤ᵐ[μ] f) : Ennreal.ofReal (∫ x, f x ∂μ) = ∫⁻ x, Ennreal.ofReal (f x) ∂μ :=
  by
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `SimpleFunc.integral_eq_integral [])
      (Command.declSig
       [(Term.explicitBinder
         "("
         [`f]
        ...
        (Tactic.tacticSeq
         (Tactic.tacticSeq1Indented
          [(Tactic.rwSeq
            ...
            (Tactic.rwRuleSeq
             "["
             [(Tactic.rwRule [] (Term.app `integral_eq [`f `hfi]))
              ","
              (Tactic.rwRule [(patternIgnore (token.«← » "←"))] `L1.simple_func.to_Lp_one_eq_to_L1)
              ","
              (Tactic.rwRule [] `L1.simple_func.integral_L1_eq_integral)
              ","
              (Tactic.rwRule [] `L1.simple_func.integral_eq_integral)]
             "]")
            [])
           []
           (Tactic.exact
            "exact"
            (Term.app
             `simple_func.integral_congr
             [`hfi
              (Term.proj
               (Term.app `Lp.simple_func.to_simple_func_to_Lp [(Term.hole "_") (Term.hole "_")])
               "."
               `symm)]))])))
       [])
      []
...
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none,
     [anonymous]) <=? (some 1023, term)
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
      `Lp.simple_func.to_simple_func_to_Lp
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none,
     [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
...
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none,
     [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `L1.simple_func.integral_L1_eq_integral
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none,
     [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `L1.simple_func.to_Lp_one_eq_to_L1
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none,
     [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      (Term.app `integral_eq [`f `hfi])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.ellipsis'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
      `hfi
...
theorem
  ...
  ( f : α →ₛ E ) ( hfi : Integrable f μ ) : f . integral μ = ∫ x , f x ∂ μ
  :=
    by
      rw
          [
...
[PrettyPrinter.parenthesize.input] (Command.declaration
     ...
     (Command.theorem
      "theorem"
      (Command.declId `SimpleFunc.integral_eq_sum [])
      (Command.declSig
       [(Term.explicitBinder
         "("
         [`f]
         ...
         (Tactic.tacticSeq1Indented
          [(Tactic.rwSeq
            ...
            (Tactic.rwRuleSeq
             ...
             [(Tactic.rwRule
               [(patternIgnore (token.«← » "←"))]
               (Term.app `f.integral_eq_integral [`hfi]))
              ","
              (Tactic.rwRule [] `simple_func.integral)
              ","
              (Tactic.rwRule [(patternIgnore (token.«← » "←"))] `simple_func.integral_eq)]
             "]")
            [])
           []
...
theorem
  ...
  ( f : α →ₛ E ) ( hfi : Integrable f μ )
    : ∫ x , f x ∂ μ = ∑ x in f . range , Ennreal.toReal μ f ⁻¹' { x } • x
  := by rw [ ← f.integral_eq_integral hfi , simple_func.integral , ← simple_func.integral_eq ] rfl
