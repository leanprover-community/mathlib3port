...
[PrettyPrinter.parenthesize.input] (Command.declaration
 ...
 (Command.theorem
  "theorem"
  (Command.declId `with_density_rn_deriv_to_real_eq [])
  (Command.declSig
   [(Term.implicitBinder "{" [`μ `ν] [":" (Term.app `Measureₓ [`α])] "}")
    (Term.instBinder "[" [] (Term.app `is_finite_measure [`μ]) "]")
    (Term.instBinder "[" [] (Term.app `have_lebesgue_decomposition [`μ `ν]) "]")
    (Term.explicitBinder
     "("
     [`h]
     [":" (MeasureTheory.Measureₓ.MeasureTheory.Measure.MeasureSpace.«term_≪_» `μ " ≪ " `ν)]
     []
     ")")
   ...
   (Term.typeSpec
    ...
    («term_=_»
     (MeasureTheory.MeasureTheory.Integral.Bochner.«term∫_in_,_∂_»
      ...
      `i
      ", "
      (Term.proj (Term.app `μ.rn_deriv [`ν `x]) "." `toReal)
      " ∂"
      `ν)
     "="
     ...
     (Tactic.tacticSeq1Indented
      [(group
        (Tactic.rwSeq
         ...
         (Tactic.rwRuleSeq
          "["
          [(Tactic.rwRule [] `integral_to_real)
           ","
           (Tactic.rwRule ["←"] (Term.app `with_density_apply [(Term.hole "_") `hi]))
           ","
           (Tactic.rwRule [] (Term.app `with_density_rn_deriv_eq [`μ `ν `h]))]
          "]")
         [])
        [])
       (group
        (Tactic.«tactic·._»
         "·"
         (Tactic.tacticSeq (Tactic.tacticSeq1Indented [(group (Tactic.measurability "measurability" []) [])])))
        [])
       (group
        (Tactic.«tactic·._»
         "·"
          ...
          (Tactic.tacticSeq1Indented
           [(group
             (Tactic.refine'
              ...
              (Term.app
               `ae_lt_top
               [(Term.app `μ.measurable_rn_deriv [`ν])
                (Term.proj
                 (Term.app `lt_of_le_of_ltₓ [(Term.app `lintegral_mono_set [`i.subset_univ]) (Term.hole "_")])
                 "."
                 `Ne)]))
             [])
            (group
             (Tactic.rwSeq
              ...
              [])
             [])
            (group (Tactic.exact "exact" (Term.app `measure_lt_top [(Term.hole "_") (Term.hole "_")])) [])])))
        [])])))
   [])
  []
  []))
...
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'group', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Tactic.exact "exact" (Term.app `measure_lt_top [(Term.hole "_") (Term.hole "_")]))
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app `with_density_rn_deriv_eq [`μ `ν `h])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  (Term.app
   `ae_lt_top
   [(Term.app `μ.measurable_rn_deriv [`ν])
    (Term.proj (Term.app `lt_of_le_of_ltₓ [(Term.app `lintegral_mono_set [`i.subset_univ]) (Term.hole "_")]) "." `Ne)])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
...
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1023, term))
  (Term.app `lintegral_mono_set [`i.subset_univ])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'many.antiquot_scope'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument.antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'Lean.Parser.Term.namedArgument'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `lintegral_mono_set [`i.subset_univ]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `lt_of_le_of_ltₓ
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren
 ...
 [(Term.app
   `lt_of_le_of_ltₓ
   [(Term.paren "(" [(Term.app `lintegral_mono_set [`i.subset_univ]) []] ")") (Term.hole "_")])
  []]
 ")")
[PrettyPrinter.parenthesize] ...precedences are 1023 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'Lean.Parser.Term.app', expected 'many.antiquot_scope'
...
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `μ.measurable_rn_deriv [`ν]) []] ")")
[PrettyPrinter.parenthesize] parenthesizing (cont := (some 1022, term))
  `ae_lt_top
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'ident.antiquot'
...
[PrettyPrinter.parenthesize] ...precedences are 1024 >? 1024, (none, [anonymous]) <=? (some 1022, term)
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1022, (some 1023, term) <=? (some 1024, term)
[PrettyPrinter.parenthesize] parenthesized: (Term.paren "(" [(Term.app `μ.rn_deriv [`ν `x]) []] ")")
[PrettyPrinter.parenthesize] ...precedences are 0 >? 1024, (none, [anonymous]) <=? (none, [anonymous])
[PrettyPrinter.parenthesize] parenthesizing (cont := (none, [anonymous]))
  `i
[PrettyPrinter.parenthesize.backtrack] unexpected node kind 'ident', expected 'antiquot'
...
theorem
  ...
  { μ ν : Measureₓ α }
      ...
      { i : Set α }
      ( hi : MeasurableSet i )
    : ∫ x in i , μ.rn_deriv ν x . toReal ∂ ν = μ i . toReal
  :=
    by
